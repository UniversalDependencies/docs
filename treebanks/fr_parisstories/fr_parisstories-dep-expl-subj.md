...
3	me	moi	PRON	_	Case=Dat|Emph=No|Number=Sing|Person=1|PronType=Prs	4	iobj	_	_
...
7	mon	son	DET	_	Gender=Masc|Number=Sing|Number[psor]=Sing|Person[psor]=1|Poss=Yes|PronType=Prs	8	det	_	_
8	dieu	dieu	NOUN	_	ExtPos=INTJ	10	discourse	_	Gender[lex]=Masc|Number[ctxt]=Sing
...
14	il	lui	PRON	_	Case=Nom|Emph=No|Gender=Masc|Number=Sing|Person=3|PronType=Prs	17	nsubj	_	_
...
17	passé	passer	VERB	_	VerbForm=Part	10	advcl:cleft	_	Gender[ctxt]=Masc|Number[ctxt]=Sing|Tense[denom]=Past
