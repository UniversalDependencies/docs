...
There are 9 `SCONJ` lemmas (2%), 9 `SCONJ` types (2%) and 25 `SCONJ` tokens (1%).
Out of 15 observed tags, the rank of `SCONJ` is: 8 in number of lemmas, 8 in number of types and 11 in number of tokens.

The 10 most frequent `SCONJ` lemmas: <em>wamhã, da, tahawa, wa, ma, nherẽ, wamha, zarina, zô</em>
...
* <em>da</em>
  * <tt><a href="xav_xdt-pos-ADP.html">ADP</a></tt> 16: <em>Ti'ra te te sabu <b>da</b> ma wei wi .</em>
  * <tt><a href="xav_xdt-pos-SCONJ.html">SCONJ</a></tt> 4: <em>Wedenhõrõ , <b>da</b> te ĩré sizöri wa , ma te tiwi tirobzeiwʔõ</em>
...
* <em>wa</em>
  ...
  * <tt><a href="xav_xdt-pos-X.html">X</a></tt> 1: <em>Wedenhõrõ , da te ĩré sizöri <b>wa</b> , ma te tiwi tirobzeiwʔõ</em>
* <em>dama</em>
  * <tt><a href="xav_xdt-pos-PRON.html">PRON</a></tt> 2: <em>'Watébrémi , robta'a tõ ! Ĩhi marĩ na te te <b>dama</b> rowasu'u ré hã !</em>
  * <tt><a href="xav_xdt-pos-SCONJ.html">SCONJ</a></tt> 2: <em>Aihini wapté si'utu wamhã , te za sõ're za'ra , <b>dama</b> rowẽ da hã .</em>
  * <tt><a href="xav_xdt-pos-ADP.html">ADP</a></tt> 1: <em>Ãne za waʔrata ma hã ʔre wanhipi zaʔra <b>dama</b> ĩwẽ zeb u</em>
* <em>zô</em>
  * <tt><a href="xav_xdt-pos-ADP.html">ADP</a></tt> 8: <em>Aibö te wara pe'a <b>zô</b> .</em>
  * <tt><a href="xav_xdt-pos-SCONJ.html">SCONJ</a></tt> 1: <em>Rowahutu'wa ĩta'are te ta'a , 'watébrémi norĩ <b>zô</b> romnhoré u da hã .</em>
...
The 2nd highest number of forms (1) was observed with the lemma “ma”: <em>dama</em>.

The 3rd highest number of forms (1) was observed with the lemma “nherẽ”: <em>nherẽ</em>.

`SCONJ` occurs with 1 features: <tt><a href="xav_xdt-feat-Human.html">Human</a></tt> (2; 8% instances)

`SCONJ` occurs with 1 feature-value pairs: `Human=Yes`

`SCONJ` occurs with 2 feature combinations.
The most frequent feature combination is `_` (23 tokens).
Examples: <em>wamhã, Tahawa, da, wa, nherẽ, wamha, zarina, zô</em>


## Relations

`SCONJ` nodes are attached to their parents using 3 different relations: <tt><a href="xav_xdt-dep-mark.html">mark</a></tt> (23; 92% instances), <tt><a href="xav_xdt-dep-dep.html">dep</a></tt> (1; 4% instances), <tt><a href="xav_xdt-dep-flat.html">flat</a></tt> (1; 4% instances)

Parents of `SCONJ` nodes belong to 3 different parts of speech: <tt><a href="xav_xdt-pos-VERB.html">VERB</a></tt> (14; 56% instances), <tt><a href="xav_xdt-pos-NOUN.html">NOUN</a></tt> (9; 36% instances), <tt><a href="xav_xdt-pos-ADV.html">ADV</a></tt> (2; 8% instances)
