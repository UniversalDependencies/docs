...
2	آخر	آخَر	PRON	PDEM	Case=Nom|Gender=Masc|Number=Sing|PronType=Dem	3	det	_	LId=آخَر_1
3	كتب	كِتَاب	NOUN	NN	Case=Gen|Definite=Def|Gender=Masc|Number=Plur	1	nsubj	_	LId=كَتَب-ُ_1|SpaceAfter=No
4	ها	هُوَ	PRON	PRP	Case=Gen|Gender=Fem|Number=Sing|Person=3|PronType=Prs	3	nmod	_	_
