...
22394 tokens (8%) have a non-empty value of `Mood`.
2915 types (6%) occur at least once with a non-empty value of `Mood`.
1549 lemmas (4%) occur at least once with a non-empty value of `Mood`.
The feature is used with 13 part-of-speech tags: <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> (12362; 4% instances), <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> (9815; 3% instances), <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> (78; 0% instances), <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> (50; 0% instances), <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> (50; 0% instances), <tt><a href="de_gsd-pos-X.html">X</a></tt> (17; 0% instances), <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> (8; 0% instances), <tt><a href="de_gsd-pos-ADP.html">ADP</a></tt> (4; 0% instances), <tt><a href="de_gsd-pos-PART.html">PART</a></tt> (4; 0% instances), <tt><a href="de_gsd-pos-CCONJ.html">CCONJ</a></tt> (3; 0% instances), <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-PUNCT.html">PUNCT</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-SCONJ.html">SCONJ</a></tt> (1; 0% instances).

### `VERB`

12362 <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> tokens (60% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (12362; 100%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (11939; 97%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9774; 79%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (6418; 52%).

`VERB` tokens may have the following values of `Mood`:

* `Imp` (37; 0% of non-empty `Mood`): <em>siehe, laßt, vgl., Brecht, Gebt, Kenne, Laß, Schaut, lieh</em>
* `Ind` (12140; 98% of non-empty `Mood`): <em>wurde, gibt, hat, liegt, kam, hatte, gab, war, erhielt, befindet</em>
* `Sub` (185; 1% of non-empty `Mood`): <em>sei, habe, gebe, hätten, gehe, hätte, komme, wolle, liege, möchte</em>
* `EMPTY` (8350): <em>lassen, empfehlen, gegründet, genannt, machen, verwendet, eingesetzt, bezeichnet, genutzt, gebaut</em>
...
`Mood` seems to be **lexical feature** of `VERB`. 93% lemmas (1350) occur only with one value of `Mood`.

### `AUX`

9815 <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9815; 100%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9311; 95%), <tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (7326; 75%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7274; 74%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5569; 57%).

`AUX` tokens may have the following values of `Mood`:

* `Ind` (9238; 94% of non-empty `Mood`): <em>ist, wurde, war, sind, wird, wurden, kann, hat, werden, waren</em>
...
* `EMPTY` (30807): <em>Deutschland, de, of, US, Berlin, the, SPD, St., new, Oktober</em>
...
* `EMPTY` (327): <em>'s, B., u.a., %, etc., z.B., a, z., †, u</em>
...
<tt>VERB --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1049; 63%),
