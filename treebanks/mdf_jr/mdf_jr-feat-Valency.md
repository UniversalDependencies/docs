...
248 tokens (8%) have a non-empty value of `Valency`.
224 types (13%) occur at least once with a non-empty value of `Valency`.
156 lemmas (14%) occur at least once with a non-empty value of `Valency`.
The feature is used with 2 part-of-speech tags: <tt><a href="mdf_jr-pos-VERB.html">VERB</a></tt> (231; 7% instances), <tt><a href="mdf_jr-pos-AUX.html">AUX</a></tt> (17; 1% instances).

### `VERB`

231 <tt><a href="mdf_jr-pos-VERB.html">VERB</a></tt> tokens (39% of all `VERB` tokens) have a non-empty value of `Valency`.

The most frequent other feature values with which `VERB` and `Valency` co-occurred: <tt><a href="mdf_jr-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (214; 93%), <tt><a href="mdf_jr-feat-Number-obj.html">Number[obj]</a></tt><tt>=EMPTY</tt> (196; 85%), <tt><a href="mdf_jr-feat-Person-obj.html">Person[obj]</a></tt><tt>=EMPTY</tt> (196; 85%), <tt><a href="mdf_jr-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (185; 80%), <tt><a href="mdf_jr-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (162; 70%), <tt><a href="mdf_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt> (152; 66%), <tt><a href="mdf_jr-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (118; 51%).

`VERB` tokens may have the following values of `Valency`:

* `1` (131; 57% of non-empty `Valency`): <em>касан, ащи, кенярдсь, корхтай, лездсь, лиссть, лиссь, марявсь, мольсь, няевсь</em>
* `2` (100; 43% of non-empty `Valency`): <em>Арьсян, варжакстсь, сявонь, ёран, Арьсень, Варжакстонь, Ладяйне, Лихтезь, Няить, Панчк-ка</em>
...
<tt>VERB --[<tt><a href="mdf_jr-dep-advcl-tcl.html">advcl:tcl</a></tt>]--> VERB</tt> (3; 60%),
