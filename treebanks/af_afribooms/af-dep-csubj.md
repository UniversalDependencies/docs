---
layout: base
title:  'Statistics of csubj in UD_Afrikaans'
udver: '2'
---

## Treebank Statistics: UD_Afrikaans: Relations: `csubj`
...
The following 3 pairs of parts of speech are connected with `csubj`: <tt><a href="af-pos-PRON.html">PRON</a></tt>-<tt><a href="af-pos-ADJ.html">ADJ</a></tt> (1; 33% instances), <tt><a href="af-pos-VERB.html">VERB</a></tt>-<tt><a href="af-pos-AUX.html">AUX</a></tt> (1; 33% instances), <tt><a href="af-pos-VERB.html">VERB</a></tt>-<tt><a href="af-pos-VERB.html">VERB</a></tt> (1; 33% instances).
...
3	ongetwyfeld	ongetwyfeld	ADV	BS	Degree=Pos	2	advmod	_	_
...
11	is	is	AUX	VTHOK	Tense=Pres|VerbForm=Fin,Inf|VerbType=Cop	8	cop	_	SpaceAfter=No
...
26	solank	solank	SCONJ	KO	_	2	amod	_	_
...
30	lewe	lewe	VERB	VTHOO	Subcat=Intr|Tense=Pres|VerbForm=Fin,Inf	26	dep	_	SpaceAfter=No
...
34	ingekerker	inkerker	VERB	VVHOG	Subcat=Tran|Tense=Past|VerbForm=Part	32	dep	_	_
35	is	is	AUX	VVUOP	Tense=Past|VerbForm=Fin|VerbType=Pas	34	aux:pass	_	_
...
45	,	,	PUNCT	ZM	_	42	punct	_	_
46	op	op	ADP	SVS	AdpType=Prep	47	case	_	_
47	straat	straat	NOUN	NSE	Number=Sing	42	obl	_	_
48	en	en	CCONJ	KN	_	46	cc	_	_
49	op	op	ADP	SVS	AdpType=Prep	51	case	_	_
50	die	die	DET	LB	Definite=Def|PronType=Art	51	det	_	_
51	pad	pad	NOUN	NSE	Number=Sing	46	obl	_	_
...
58	nie	nie	ADV	BS	Degree=Pos	61	advmod	_	_
59	in	in	ADP	SVS	AdpType=Prep	60	case	_	_
60	staat	staat	NOUN	NSE	Number=Sing	55	conj	_	_
61	is	is	AUX	VTHOK	Tense=Pres|VerbForm=Fin,Inf|VerbType=Cop	60	cop	_	_
...
19	elektrisiteit	elektrisiteit	NOUN	NM	Number=Sing	17	obl	_	_
