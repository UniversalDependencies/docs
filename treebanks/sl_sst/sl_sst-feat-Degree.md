...
12028 tokens (12%) have a non-empty value of `Degree`.
3247 types (24%) occur at least once with a non-empty value of `Degree`.
1964 lemmas (26%) occur at least once with a non-empty value of `Degree`.
The feature is used with 3 part-of-speech tags: <tt><a href="sl_sst-pos-ADV.html">ADV</a></tt> (7045; 7% instances), <tt><a href="sl_sst-pos-ADJ.html">ADJ</a></tt> (4864; 5% instances), <tt><a href="sl_sst-pos-DET.html">DET</a></tt> (119; 0% instances).

### `ADV`

7045 <tt><a href="sl_sst-pos-ADV.html">ADV</a></tt> tokens (100% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (274; 4% of non-empty `Degree`): <em>bolj, prej, kasneje, boljše, večkrat, rajši, raje, lažje, pozneje, lepše</em>
* `Pos` (6668; 95% of non-empty `Degree`): <em>tako, zdaj, lahko, potem, zelo, kako, kar, tam, res, a</em>
...
`Degree` seems to be **lexical feature** of `ADV`. 96% lemmas (538) occur only with one value of `Degree`.

### `ADJ`

4864 <tt><a href="sl_sst-pos-ADJ.html">ADJ</a></tt> tokens (92% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="sl_sst-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (4201; 86%), <tt><a href="sl_sst-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (4056; 83%), <tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3427; 70%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (136; 3% of non-empty `Degree`): <em>boljši, manjši, boljše, mlajši, večja, večji, manjša, boljša, manjše, starejša</em>
* `Pos` (4663; 96% of non-empty `Degree`): <em>dobro, zanimivo, dober, sam, sami, lepa, pomembno, različne, lep, sama</em>
...
* `EMPTY` (408): <em>drugi, prvi, drugo, druga, drugega, drugih, prvo, druge, prva, prve</em>
...
119 <tt><a href="sl_sst-pos-DET.html">DET</a></tt> tokens (2% of all `DET` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `DET` and `Degree` co-occurred: <tt><a href="sl_sst-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (119; 100%), <tt><a href="sl_sst-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (119; 100%), <tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (119; 100%), <tt><a href="sl_sst-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (119; 100%).

`DET` tokens may have the following values of `Degree`:

* `Pos` (119; 100% of non-empty `Degree`): <em>pol, nekaj, nič, kaj</em>
* `EMPTY` (5408): <em>to, ta, vse, tega, tem, malo, pol, te, nekaj, več</em>

## Relations with Agreement in `Degree`

The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<tt><a href="sl_sst-dep-advmod.html">advmod</a></tt>]--> ADV</tt> (628; 84%),
<tt>ADV --[<tt><a href="sl_sst-dep-advmod.html">advmod</a></tt>]--> ADV</tt> (252; 85%),
<tt>ADJ --[<tt><a href="sl_sst-dep-conj.html">conj</a></tt>]--> ADJ</tt> (185; 95%),
<tt>ADV --[<tt><a href="sl_sst-dep-conj.html">conj</a></tt>]--> ADV</tt> (57; 97%),
<tt>ADV --[<tt><a href="sl_sst-dep-reparandum.html">reparandum</a></tt>]--> ADV</tt> (43; 100%),
