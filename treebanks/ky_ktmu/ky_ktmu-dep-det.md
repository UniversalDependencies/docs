...
## Treebank Statistics: UD_Kyrgyz-KTMU: Relations: `det`
...
1	Бул	Бул	DET	DET	_	2	det	_	_
2	суроолорго	суроо	NOUN	NN	Case=Dat|Number=Sing|Number[psor]=Sing|Person=3|Person[psor]=3	6	csubj	_	_
3	экономисттерден	экономист	NOUN	NN	Case=Abl|Number=Plur|Number[psor]=Sing|Person=3|Person[psor]=3	6	nmod	_	_
4	жооп	жооп	NOUN	NN	Case=Nom|Number=Sing|Number[psor]=Sing|Person=3|Person[psor]=3	5	nmod	_	_
5	издеп	изде	VERB	VB	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Part	6	ccomp	_	_
6	көрдүк	көр	VERB	VB	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Past|VerbForm=Fin	0	root	_	SpaceAfter=No
...
1	Баягында	Баягында	ADV	ADV	_	5	advmod	_	_
2	сексен	сексен	NUM	NUM	NumType=Card	3	compound	_	_
3	жети	жети	NUM	NUM	NumType=Card	4	nummod	_	_
4	күн	күн	NOUN	NN	Case=Nom|Number=Sing	5	nsubj	_	_
5	өтпөдү	өтпөдү	VERB	VB	Aspect=Perf|Mood=Ind|Person=3|Polarity=Neg|Tense=Past|VerbForm=Fin	0	root	_	_
6	беле	беле	DET	DET	_	5	det	_	SpaceAfter=No
7	.	.	PUNCT	PCT	_	6	punct	_	_
