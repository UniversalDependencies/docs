...
* `EMPTY` (5135): <em>1, 2, 3, două, 4, trei, 5, 6, doi, 7</em>
...
* `EMPTY` (11619): <em>o, un, a, al, ale, unei, unui, acest, lui, cel</em>

### `PROPN`

316 <tt><a href="ro_rrt-pos-PROPN.html">PROPN</a></tt> tokens (5% of all `PROPN` tokens) have a non-empty value of `Definite`.
...
`Definite` seems to be **lexical feature** of `PROPN`. 98% lemmas (97) occur only with one value of `Definite`.
