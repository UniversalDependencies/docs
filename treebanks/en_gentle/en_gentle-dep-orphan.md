...
2	Gabapentin	Gabapentin	PROPN	NNP	Number=Sing	0	root	0:root	Entity=(37-substance-new-snnnn-cf1-1-sgl-Gabapentin)
3	600	600	NUM	CD	NumForm=Digit|NumType=Card	4	nummod	4:nummod	Entity=(38-substance-new-nnnnn-cf2-2-sgl
4	mg	milligram	NOUN	NNS	Abbr=Yes|Number=Plur	2	orphan	2:orphan	Entity=38)
5	at	at	ADP	IN	_	6	case	6:case	_
6	night	night	NOUN	NN	Number=Sing	4	obl	4:obl:at	Entity=(39-time-new-nnnnn-cf3-1-coref)|SpaceAfter=No
...
5	I	I	PRON	PRP	Case=Nom|Number=Sing|Person=1|PronType=Prs	7	nsubj	7:nsubj	Entity=(67-person-giv:act-nnnnn-cf1-1-ana)
...
8	his	his	PRON	PRP$	Case=Gen|Gender=Masc|Number=Sing|Person=3|Poss=Yes|PronType=Prs	9	nmod:poss	9:nmod:poss	Entity=(78-person-giv:inact-snnns-cf4-2-coref(13-person-giv:act-sssss-cf2*-1-ana)
...
11	evaluation	evaluation	NOUN	NN	Number=Sing	7	obl	7:obl:for	Entity=(83-event-new-nnnnn-cf6-1-sgl)|MSeg=e-valu-at-ion
...
6	y	y	NOUN	NN	Number=Sing	1	conj	1:conj:and	Entity=(48-abstract-giv:act-nnnnn-cf1-1-coref)
7	⪯	⪯	SYM	SYM	_	6	orphan	6:orphan	_
8	x	x	NOUN	NN	Number=Sing	7	obl:unmarked	7:obl:unmarked	Entity=(47-abstract-giv:act-nnnnn-cf2-1-coref)|SpaceAfter=No
