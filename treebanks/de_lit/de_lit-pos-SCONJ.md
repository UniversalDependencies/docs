---
layout: base
title:  'Statistics of SCONJ in UD_German-LIT'
udver: '2'
---
...
* <em>wenn</em>
  * <tt><a href="de_lit-pos-SCONJ.html">SCONJ</a></tt> 100: <em>Er entsteht , <b>wenn</b> einer bloß den Geist hat , ohne den Buchstaben ;</em>
  * <tt><a href="de_lit-pos-CCONJ.html">CCONJ</a></tt> 2: <em>Die Schönheit ist also doch in England nicht käuflich und verkäuflich , <b>wenn</b> auch die Tugend .</em>
  * <tt><a href="de_lit-pos-ADV.html">ADV</a></tt> 1: <em>Besonders in Rücksicht der Höhe überbieten sie sich ordentlich , wie <b>wenn</b> zwei zugleich auf einer Auktion unbedingte Kommission haben .</em>
* <em>um</em>
...
* <em>damit</em>
  * <tt><a href="de_lit-pos-ADV.html">ADV</a></tt> 5: <em>In der Ausführung ist s <b>damit</b> aber ungefähr , wie mit der Vermischung der Dichtarten .</em>
  * <tt><a href="de_lit-pos-SCONJ.html">SCONJ</a></tt> 5: <em>Wer schreibt , <b>damit</b> ihn diese und jene lesen mögen , verdient , daß er nicht gelesen werde .</em>
* <em>dahingegen</em>
  * <tt><a href="de_lit-pos-SCONJ.html">SCONJ</a></tt> 2: <em>Daher ist der Verworrne so progressiv , so perfektibel , <b>dahingegen</b> der Ordentliche so früh als Philister aufhört .</em>
  * <tt><a href="de_lit-pos-ADV.html">ADV</a></tt> 1: <em><b>dahingegen</b> die geordneten Köpfe trachten müssen , wahre Gelehrte , gründliche Encyklopädisten zu werden .</em>
* <em>statt</em>
  * <tt><a href="de_lit-pos-ADP.html">ADP</a></tt> 2: <em>Der Witz ist wie einer , der nach der Regel repräsentieren sollte , und <b>statt</b> dessen bloß handelt .</em>
  * <tt><a href="de_lit-pos-SCONJ.html">SCONJ</a></tt> 1: <em>Der Ton , <b>statt</b> sich zu erheben , muß , um die Wirkung durch ein andres Mittel hervorzubringen , gedämpft , in der Tiefe gehalten und der Akzent nur so bezeichnet werden , daß das Verstehen dessen was man liest angedeutet wird , ohne das Gelesene ganz auszudrücken .</em>
...
The 2nd highest number of forms (1) was observed with the lemma “bevor”: <em>bevor</em>.

The 3rd highest number of forms (1) was observed with the lemma “bis”: <em>bis</em>.

`SCONJ` occurs with 1 features: <tt><a href="de_lit-feat-Foreign.html">Foreign</a></tt> (1; 0% instances)
