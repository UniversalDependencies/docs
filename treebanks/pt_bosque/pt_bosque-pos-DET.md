...
There are 50 `DET` lemmas (0%), 104 `DET` types (0%) and 34865 `DET` tokens (15%).
...
The form / lemma ratio of `DET` is 2.080000 (the average of all parts of speech is 1.423840).
