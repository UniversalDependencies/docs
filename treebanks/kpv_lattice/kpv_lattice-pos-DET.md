...
* <em>ас</em>
  * <tt><a href="kpv_lattice-pos-PRON.html">PRON</a></tt> 9: <em>Быд мортлӧн , шуӧны тунъяс , Енвевтын <b>ас</b> Кодзув эм ...</em>
...
* <em>мыйта</em>
  * <tt><a href="kpv_lattice-pos-ADV.html">ADV</a></tt> 1: <em>Ӧд сійӧ <b>мыйта</b> жӧ нин кыйліс черитӧ — гурина и бадькормык , кыз мык , кельчи и сын ...</em>
  * <tt><a href="kpv_lattice-pos-DET.html">DET</a></tt> 1: <em>Кутшӧм сӧмын книгаяс сэні абуӧсь , <b>мыйта</b> быдсяма журналыс да газетыс быд лун локтӧ .</em>
  * <tt><a href="kpv_lattice-pos-PRON.html">PRON</a></tt> 1: <em>— Да эськӧ , тэ коддьӧмыс кӧ ставӧн вӧліны гортынӧсь , <b>мыйта</b> содтӧд бурыс вӧлі эськӧ чужан мулы ! — шуис Жельнӧг Вась .</em>

## Morphology

The form / lemma ratio of `DET` is 1.666667 (the average of all parts of speech is 1.465770).
...
The 3rd highest number of forms (2) was observed with the lemma “кыкнан”: <em>кыкнан, кыкнанныс</em>.

`DET` occurs with 8 features: <tt><a href="kpv_lattice-feat-Case.html">Case</a></tt> (30; 67% instances), <tt><a href="kpv_lattice-feat-Number.html">Number</a></tt> (30; 67% instances), <tt><a href="kpv_lattice-feat-NumType.html">NumType</a></tt> (8; 18% instances), <tt><a href="kpv_lattice-feat-PronType.html">PronType</a></tt> (8; 18% instances), <tt><a href="kpv_lattice-feat-Number-psor.html">Number[psor]</a></tt> (7; 16% instances), <tt><a href="kpv_lattice-feat-Person-psor.html">Person[psor]</a></tt> (7; 16% instances), <tt><a href="kpv_lattice-feat-Reflex.html">Reflex</a></tt> (4; 9% instances), <tt><a href="kpv_lattice-feat-Definite.html">Definite</a></tt> (1; 2% instances)
...
`DET` nodes are attached to their parents using 6 different relations: <tt><a href="kpv_lattice-dep-det.html">det</a></tt> (32; 71% instances), <tt><a href="kpv_lattice-dep-nsubj.html">nsubj</a></tt> (7; 16% instances), <tt><a href="kpv_lattice-dep-conj.html">conj</a></tt> (3; 7% instances), <tt><a href="kpv_lattice-dep-nmod.html">nmod</a></tt> (1; 2% instances), <tt><a href="kpv_lattice-dep-obj.html">obj</a></tt> (1; 2% instances), <tt><a href="kpv_lattice-dep-obl.html">obl</a></tt> (1; 2% instances)

Parents of `DET` nodes belong to 3 different parts of speech: <tt><a href="kpv_lattice-pos-NOUN.html">NOUN</a></tt> (32; 71% instances), <tt><a href="kpv_lattice-pos-VERB.html">VERB</a></tt> (12; 27% instances), <tt><a href="kpv_lattice-pos-PRON.html">PRON</a></tt> (1; 2% instances)

37 (82%) `DET` nodes are leaves.
