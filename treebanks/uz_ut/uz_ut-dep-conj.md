---
layout: base
title:  'Statistics of conj in UD_Uzbek-UT'
udver: '2'
---

## Treebank Statistics: UD_Uzbek-UT: Relations: `conj`
...
1	Soʻz	soʻz	NOUN	_	Case=Nom|Number=Sing	6	nsubj	_	SpaceAfter=No
2	,	,	PUNCT	_	_	3	punct	_	_
3	til	til	NOUN	_	Case=Nom|Number=Sing	1	conj	_	_
4	benihoya	benihoya	ADV	_	_	5	advmod	_	_
5	buyuk	buyuk	ADJ	_	_	6	amod	_	_
6	qudratdir	qudrat	NOUN	_	Case=Nom|Number=Sing	0	root	_	SpaceAfter=No
...
1	Haydovchilar	haydovchi	NOUN	_	Case=Nom|Number=Plur	3	nsubj	_	_
...
1	Suxsurov	Suxsurov	PROPN	_	Case=Nom|Number=Sing	8	nsubj	_	_
2	baland	baland	ADJ	_	_	8	advmod	_	SpaceAfter=No
3	,	,	PUNCT	_	_	4	punct	_	_
4	Yusuf	Yusuf	PROPN	_	Case=Nom|Number=Sing	1	conj	_	_
5	undan	u	PRON	_	Case=Abl|Number=Sing|Person=3|PronType=Prs	6	obl	_	_
6	pastroq	past	ADJ	_	Degree=Cmp	2	conj	_	_
7	xurrak	xurrak	NOUN	_	Case=Nom|Number=Sing	8	compound:lvc	_	_
8	tortmoqda	tort	VERB	_	Aspect=Prog|Mood=Ind|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	SpaceAfter=No
