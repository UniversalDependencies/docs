...
* `Plur` (160; 16% of non-empty `Number`): <em>de, alla, dessa, några, båda, inga</em>
* `Sing` (836; 84% of non-empty `Number`): <em>en, den, ett, det, denna, varje, detta, någon, något, ingen</em>
* `EMPTY` (19): <em>the, a, Die, El, Le, That, las</em>
...
878 <tt><a href="sv_pud-pos-PRON.html">PRON</a></tt> tokens (67% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="sv_pud-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (762; 87%), <tt><a href="sv_pud-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (743; 85%), <tt><a href="sv_pud-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (513; 58%), <tt><a href="sv_pud-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (501; 57%).
