---
layout: base
title:  'Statistics of ExtPos in UD_Erzya-JR'
udver: '2'
---

## Treebank Statistics: UD_Erzya-JR: Features: `ExtPos`

This feature is language-specific.
It occurs with 5 different values: `ADJ`, `ADV`, `AUX`, `INTJ`, `PRON`.
...
19 <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> tokens (1% of all `ADV` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `ADV` and `ExtPos` co-occurred: <tt><a href="myv_jr-feat-AdvType.html">AdvType</a></tt><tt>=EMPTY</tt> (11; 58%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (11; 58%), <tt><a href="myv_jr-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (10; 53%).

`ADV` tokens may have the following values of `ExtPos`:

* `ADV` (19; 100% of non-empty `ExtPos`): <em>косто, яла, зяро, истя, кода, коть, зняро, козонь, лиякс, мельга</em>

`ExtPos` seems to be **lexical feature** of `ADV`. 100% lemmas (12) occur only with one value of `ExtPos`.
...
* `ADJ` (8; 67% of non-empty `ExtPos`): <em>эрьва</em>
* `ADV` (2; 17% of non-empty `ExtPos`): <em>эрьва</em>
* `PRON` (2; 17% of non-empty `ExtPos`): <em>эрьва</em>
...
8 <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `NOUN` and `ExtPos` co-occurred: <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (8; 100%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Plur,Sing</tt> (8; 100%), <tt><a href="myv_jr-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (8; 100%), <tt><a href="myv_jr-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (8; 100%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Abl</tt> (5; 63%).

`NOUN` tokens may have the following values of `ExtPos`:

* `ADV` (8; 100% of non-empty `ExtPos`): <em>иеде, кудодо, мельс, прясто, судодо, уголдо, шкань</em>
...
* `AUX` (1; 25% of non-empty `ExtPos`): <em>а</em>
* `INTJ` (3; 75% of non-empty `ExtPos`): <em>А</em>

<table>
  <tr><th>Paradigm <i>а</i></th><th><tt>AUX</tt></th><th><tt>INTJ</tt></th></tr>
  <tr><td><tt></tt></td><td><em>а</em></td><td><em>А</em></td></tr>
</table>

### `ADJ`

3 <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> tokens (0% of all `ADJ` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `ADJ` and `ExtPos` co-occurred: <tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (2; 67%).

`ADJ` tokens may have the following values of `ExtPos`:

* `ADJ` (1; 33% of non-empty `ExtPos`): <em>истят</em>
* `ADV` (2; 67% of non-empty `ExtPos`): <em>мазы, Истямс</em>

<table>
  <tr><th>Paradigm <i>истямо</i></th><th><tt>ADJ</tt></th><th><tt>ADV</tt></th></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Ill</tt>|<tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Plur,Sing</tt></tt></td><td></td><td><em>Истямс</em></td></tr>
...
* `INTJ` (2; 100% of non-empty `ExtPos`): <em>Ох, Угу</em>

### `NUM`

2 <tt><a href="myv_jr-pos-NUM.html">NUM</a></tt> tokens (1% of all `NUM` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `NUM` and `ExtPos` co-occurred: <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (2; 100%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (2; 100%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2; 100%).
...
The most frequent other feature values with which `ADP` and `ExtPos` co-occurred: <tt><a href="myv_jr-feat-AdpType.html">AdpType</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="myv_jr-feat-AdvType.html">AdvType</a></tt><tt>=Loc</tt> (1; 100%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Prl</tt> (1; 100%), <tt><a href="myv_jr-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="myv_jr-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (1; 100%).

`ADP` tokens may have the following values of `ExtPos`:

* `ADV` (1; 100% of non-empty `ExtPos`): <em>Мельга</em>
...
* `ADV` (1; 100% of non-empty `ExtPos`): <em>теке</em>
