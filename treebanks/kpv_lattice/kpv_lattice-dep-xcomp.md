...
55 nodes (2%) are attached to their parents as `xcomp`.

47 instances of `xcomp` (85%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.54545454545455.

The following 4 pairs of parts of speech are connected with `xcomp`: <tt><a href="kpv_lattice-pos-VERB.html">VERB</a></tt>-<tt><a href="kpv_lattice-pos-VERB.html">VERB</a></tt> (52; 95% instances), <tt><a href="kpv_lattice-pos-ADJ.html">ADJ</a></tt>-<tt><a href="kpv_lattice-pos-VERB.html">VERB</a></tt> (1; 2% instances), <tt><a href="kpv_lattice-pos-VERB.html">VERB</a></tt>-<tt><a href="kpv_lattice-pos-ADJ.html">ADJ</a></tt> (1; 2% instances), <tt><a href="kpv_lattice-pos-VERB.html">VERB</a></tt>-<tt><a href="kpv_lattice-pos-NOUN.html">NOUN</a></tt> (1; 2% instances).
...
2	заводитліс	заводітны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past	0	root	_	_
...
2	пыр	пыр	ADV	Adv	_	4	advmod:tmod	_	_
3	жӧ	жӧ	PART	Pcle	_	2	advmod	_	_
4	гижис	гижны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past	0	root	_	_
5	Максимлы	Максим	PROPN	N	Case=Dat|Number=Sing	4	obl	_	_
6	зэв	зэв	ADV	Adv	_	7	advmod:deg	_	_
7	кузь	кузь	ADJ	A	Case=Nom|Number=Sing	11	amod	_	_
8	да	да	CCONJ	CC	_	9	cc	_	_
9	зэв	зэв	ADV	Adv	_	10	advmod:deg	_	_
...
18	нимтіс	нимтыны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past	11	acl:relcl	_	_
