...
There are 12 `PUNCT` lemmas (0%), 12 `PUNCT` types (0%) and 4507 `PUNCT` tokens (15%).
...
The form / lemma ratio of `PUNCT` is 1.000000 (the average of all parts of speech is 2.101803).
