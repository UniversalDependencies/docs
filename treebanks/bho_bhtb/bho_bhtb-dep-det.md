...
## Treebank Statistics: UD_Bhojpuri-BHTB: Relations: `det`
...
# visual-style 9 5 det	color:blue
1	एह	एह	DET	DM_DMD	NumType=Card	2	det	_	Translit=eha|LTranslit=eha
2	कार्यक्रम	कार्यक्रम	NOUN	N_NN	Case=Acc|Gender=Masc|Number=Sing|Person=3	4	nmod	_	Translit=kāryakrama|LTranslit=kāryakrama
3	में	में	ADP	PSP	AdpType=Post	2	case	_	Translit=meṁ|LTranslit=meṁ
4	रउरा	रउरा	PRON	PR_PRP	Case=Nom|Gender=Masc|Number=Sing|Person=3	9	nsubj	_	Translit=raurā|LTranslit=raurā
...
# visual-style 2 1 det	color:blue
1	एह	एह	DET	DM_DMD	NumType=Card	2	det	_	Translit=eha|LTranslit=eha
2	प	प	ADJ	JJ	_	7	amod	_	Translit=pa|LTranslit=pa
3	अगर	अगर	NOUN	N_NN	Case=Nom|Gender=Masc|Number=Sing|Person=3	5	compound	_	Translit=agara|LTranslit=agara
4	कवनो	कवनो	DET	DM_DMI	Case=Nom|Gender=Masc|Number=Sing|Person=3	5	compound	_	Translit=kavano|LTranslit=kavano
5	अटकर	अटकर	NOUN	N_NN	Case=Nom|Gender=Masc|Number=Sing|Person=3	7	nsubj	_	Translit=aṭakara|LTranslit=aṭakara
6	पचीसा	पचीसा	NOUN	N_NN	Case=Nom|Gender=Fem|Number=Sing|Person=3	7	compound	_	Translit=pacīsā|LTranslit=pacīsā
7	लगाईं	लगा	VERB	V_VM	Aspect=Perf|Gender=Fem|Number=Sing|Person=3|Polite=Form|VerbForm=Part|Voice=Act	14	xcomp	_	Translit=lagāīṁ|LTranslit=lagā
8	त	त	PART	RP_RPD	Case=Nom|Gender=Fem|Number=Sing|Person=3	14	compound	_	Translit=ta|LTranslit=ta
9	ओकरा	ओकरा	PRON	PR_PRP	Aspect=Perf|Number=Plur|VerbForm=Part	14	acl	_	Translit=okarā|LTranslit=okarā
10	गलत	गलत	NOUN	N_NN	Case=Nom|Gender=Fem|Number=Sing|Person=3	11	compound	_	Translit=galata|LTranslit=galata
11	होखे	हो	VERB	V_VM	Case=Acc|Gender=Masc|Number=Sing|Person=3	14	nmod	_	Translit=hokhe|LTranslit=ho
12	के	का	ADP	PSP	AdpType=Post|Case=Acc|Gender=Masc|Number=Sing	11	case	_	Translit=ke|LTranslit=kā
13	पूरा	पूरा	ADJ	JJ	Case=Nom|Gender=Masc|Number=Sing	14	amod	_	Translit=pūrā|LTranslit=pūrā
14	अनेसा	अनेसा	VERB	V_VM	Case=Nom|Gender=Fem|Number=Sing|Person=3	0	root	_	Translit=anesā|LTranslit=anesā
15	रही	रह	AUX	V_VAUX	Aspect=Perf|Gender=Fem|Number=Sing|VerbForm=Part|Voice=Act	14	aux	_	SpacesAfter=\s\s|Translit=rahī|LTranslit=raha
16	।	।	PUNCT	RD_PUNC	_	14	punct	_	SpacesAfter=\n|Translit=.|LTranslit=.
