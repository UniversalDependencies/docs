...
The most frequent other feature values with which `DET` and `Case` co-occurred: <tt><a href="Number[psor].html">Number[psor]</a>=EMPTY</tt> (10; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (10; 100%), <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (10; 100%), <tt><a href="PronType.html">PronType</a>=Ind</tt> (7; 70%), <tt><a href="Number.html">Number</a>=Plur</tt> (6; 60%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (6; 60%).
...
The most frequent other feature values with which `VERB` and `Case` co-occurred: <tt><a href="Tense.html">Tense</a>=Past</tt> (1; 100%), <tt><a href="Number.html">Number</a>=Plur</tt> (1; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (1; 100%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (1; 100%), <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (1; 100%), <tt><a href="Voice.html">Voice</a>=EMPTY</tt> (1; 100%).
