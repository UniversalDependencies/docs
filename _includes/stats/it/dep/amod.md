...
15836 nodes (5%) are attached to their parents as `amod`.

10886 instances of `amod` (69%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.26225056832533.

The following 14 pairs of parts of speech are connected with `amod`: [it-pos/NOUN]()-[it-pos/ADJ]() (15013; 95% instances), [it-pos/PROPN]()-[it-pos/ADJ]() (411; 3% instances), [it-pos/VERB]()-[it-pos/ADJ]() (160; 1% instances), [it-pos/PRON]()-[it-pos/ADJ]() (147; 1% instances), [it-pos/ADJ]()-[it-pos/ADJ]() (62; 0% instances), [it-pos/NUM]()-[it-pos/ADJ]() (21; 0% instances), [it-pos/ADV]()-[it-pos/ADJ]() (10; 0% instances), [it-pos/SYM]()-[it-pos/ADJ]() (4; 0% instances), [it-pos/X]()-[it-pos/ADJ]() (3; 0% instances), [it-pos/ADP]()-[it-pos/ADJ]() (1; 0% instances), [it-pos/CONJ]()-[it-pos/ADJ]() (1; 0% instances), [it-pos/NOUN]()-[it-pos/NOUN]() (1; 0% instances), [it-pos/PUNCT]()-[it-pos/ADJ]() (1; 0% instances), [it-pos/X]()-[it-pos/X]() (1; 0% instances).
...
3	no	no	INTJ	I	_	2	discourse	_	SpaceAfter=No
4	,	,	PUNCT	FF	_	2	punct	_	_
5	come	come	ADV	B	_	2	conj	_	_
6	no	no	INTJ	I	_	5	discourse	_	SpaceAfter=No
...
1	C'	ci	PRON	PC	PronType=Clit	2	expl	_	SpaceAfter=No
...
8	pista	pista	NOUN	S	Gender=Fem|Number=Sing	2	nmod	_	SpaceAfter=No
