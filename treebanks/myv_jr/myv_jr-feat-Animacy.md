...
470 <tt><a href="myv_jr-pos-PROPN.html">PROPN</a></tt> tokens (66% of all `PROPN` tokens) have a non-empty value of `Animacy`.
...
* `EMPTY` (247): <em>Палько, Волчок, Пальконень, Цярданев, Бертяз, Обран, Пальконь, Юрченко, Дёбаень, Елеськань</em>

`Animacy` seems to be **lexical feature** of `PROPN`. 100% lemmas (80) occur only with one value of `Animacy`.

### `NOUN`

81 <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt> tokens (2% of all `NOUN` tokens) have a non-empty value of `Animacy`.

The most frequent other feature values with which `NOUN` and `Animacy` co-occurred: <tt><a href="myv_jr-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (76; 94%), <tt><a href="myv_jr-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (76; 94%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (46; 57%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (45; 56%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (41; 51%).
...
* `EMPTY` (5061): <em>лангс, ёнов, лангсо, бандитэсь, партизантнэ, ланга, кедензэ, кудов, прянзо, тев</em>

`Animacy` seems to be **lexical feature** of `NOUN`. 100% lemmas (44) occur only with one value of `Animacy`.

### `PRON`

31 <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> tokens (3% of all `PRON` tokens) have a non-empty value of `Animacy`.

The most frequent other feature values with which `PRON` and `Animacy` co-occurred: <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (31; 100%), <tt><a href="myv_jr-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (31; 100%), <tt><a href="myv_jr-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (31; 100%), <tt><a href="myv_jr-feat-PronType.html">PronType</a></tt><tt>=Int</tt> (30; 97%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (21; 68%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (18; 58%).
