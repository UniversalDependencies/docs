---
layout: base
title:  'Statistics of expl:pass in UD_Slovak-SNK'
udver: '2'
---

## Treebank Statistics: UD_Slovak-SNK: Relations: `expl:pass`

This relation is a language-specific subtype of .
There are also 1 other language-specific subtypes of `expl`: <tt><a href="sk_snk-dep-expl-pv.html">expl:pv</a></tt>.
...
The following 1 pairs of parts of speech are connected with `expl:pass`: <tt><a href="sk_snk-pos-VERB.html">VERB</a></tt>-<tt><a href="sk_snk-pos-PRON.html">PRON</a></tt> (221; 100% instances).
