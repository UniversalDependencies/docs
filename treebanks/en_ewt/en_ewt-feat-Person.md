...
37873 tokens (15%) have a non-empty value of `Person`.
1845 types (9%) occur at least once with a non-empty value of `Person`.
985 lemmas (6%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="en_ewt-pos-PRON.html">PRON</a></tt> (18820; 7% instances), <tt><a href="en_ewt-pos-VERB.html">VERB</a></tt> (9540; 4% instances), <tt><a href="en_ewt-pos-AUX.html">AUX</a></tt> (9513; 4% instances).

### `PRON`

18820 <tt><a href="en_ewt-pos-PRON.html">PRON</a></tt> tokens (82% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="en_ewt-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (18773; 100%), <tt><a href="en_ewt-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (15090; 80%), <tt><a href="en_ewt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13983; 74%), <tt><a href="en_ewt-feat-Case.html">Case</a></tt><tt>=Nom</tt> (11793; 63%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11121; 59%).
...
* `EMPTY` (4179): <em>that, this, what, there, who, which, anyone, something, anything, nothing</em>

`Person` seems to be **lexical feature** of `PRON`. 100% lemmas (27) occur only with one value of `Person`.

### `VERB`

9540 <tt><a href="en_ewt-pos-VERB.html">VERB</a></tt> tokens (34% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="en_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9539; 100%), <tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9507; 100%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7187; 75%), <tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5421; 57%).

`VERB` tokens may have the following values of `Person`:

* `1` (2962; 31% of non-empty `Person`): <em>have, had, think, thank, know, need, hope, got, want, love</em>
* `2` (801; 8% of non-empty `Person`): <em>have, want, need, get, know, think, go, got, do, take</em>
* `3` (5777; 61% of non-empty `Person`): <em>said, has, is, are, had, have, came, took, told, says</em>
* `EMPTY` (18483): <em>have, get, know, go, do, going, see, take, let, make</em>
...
9513 <tt><a href="en_ewt-pos-AUX.html">AUX</a></tt> tokens (60% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="en_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9513; 100%), <tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9503; 100%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7387; 78%), <tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (7200; 76%).

`AUX` tokens may have the following values of `Person`:

* `1` (1717; 18% of non-empty `Person`): <em>have, am, 'm, do, 've, are, was, did, were, had</em>
* `2` (597; 6% of non-empty `Person`): <em>are, do, 're, have, did, were, 've, r, re, be</em>
* `3` (7199; 76% of non-empty `Person`): <em>is, was, are, has, 's, were, have, does, do, did</em>
* `EMPTY` (6268): <em>be, will, can, would, been, could, should, may, 'll, being</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Past</tt>|<tt><a href="en_ewt-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td></td><td></td><td><em>wase</em></td></tr>
  ...
  <tr><td><tt><tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt>|<tt><a href="en_ewt-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td><em>',, m</em></td><td><em>r, re</em></td><td><em>s, `s, i, iis, in, it, r, se</em></td></tr>
  <tr><td><tt><tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>am, 'm, m, are, ´m, ’m</em></td><td><em>are, 're, r, re</em></td><td><em>is, 's, s, ’s, `s</em></td></tr>
  <tr><td><tt><tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Past</tt>|<tt><a href="en_ewt-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td></td><td></td><td><em>where, we</em></td></tr>
  ...
  <tr><td><tt><tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt>|<tt><a href="en_ewt-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td></td><td></td><td><em>re, are</em></td></tr>
  <tr><td><tt><tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>are, 're</em></td><td></td><td><em>are, 're, r, re</em></td></tr>
...
<tt>VERB --[<tt><a href="en_ewt-dep-acl.html">acl</a></tt>]--> PRON</tt> (1; 100%).
