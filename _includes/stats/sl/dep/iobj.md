...
91 nodes (0%) are attached to their parents as `iobj`.

83 instances of `iobj` (91%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.65934065934066.

The following 8 pairs of parts of speech are connected with `iobj`: [sl-pos/VERB]()-[sl-pos/PRON]() (76; 84% instances), [sl-pos/VERB]()-[sl-pos/NOUN]() (6; 7% instances), [sl-pos/AUX]()-[sl-pos/PRON]() (2; 2% instances), [sl-pos/NOUN]()-[sl-pos/PRON]() (2; 2% instances), [sl-pos/VERB]()-[sl-pos/PROPN]() (2; 2% instances), [sl-pos/ADJ]()-[sl-pos/PRON]() (1; 1% instances), [sl-pos/NOUN]()-[sl-pos/NOUN]() (1; 1% instances), [sl-pos/X]()-[sl-pos/PRON]() (1; 1% instances).
...
1	to	ta	PRON	Pd-nsa	Case=Acc|Gender=Neut|Number=Sing|PronType=Dem	3	dobj	_	word=to|msd=Zk-set
