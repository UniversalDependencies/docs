...
2663 tokens (9%) have a non-empty value of `Aspect`.
1933 types (19%) occur at least once with a non-empty value of `Aspect`.
912 lemmas (20%) occur at least once with a non-empty value of `Aspect`.
The feature is used with 3 part-of-speech tags: <tt><a href="la_perseus-pos-VERB.html">VERB</a></tt> (2661; 9% instances), <tt><a href="la_perseus-pos-NOUN.html">NOUN</a></tt> (1; 0% instances), <tt><a href="la_perseus-pos-X.html">X</a></tt> (1; 0% instances).

### `VERB`

2661 <tt><a href="la_perseus-pos-VERB.html">VERB</a></tt> tokens (43% of all `VERB` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `VERB` and `Aspect` co-occurred: <tt><a href="la_perseus-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (2624; 99%), <tt><a href="la_perseus-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1939; 73%), <tt><a href="la_perseus-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (1838; 69%), <tt><a href="la_perseus-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1837; 69%), <tt><a href="la_perseus-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (1800; 68%), <tt><a href="la_perseus-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1765; 66%), <tt><a href="la_perseus-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1422; 53%), <tt><a href="la_perseus-feat-Person.html">Person</a></tt><tt>=3</tt> (1399; 53%).
...
* `Perf` (2068; 78% of non-empty `Aspect`): <em>dixit, fuit, vidi, inquit, audivi, fecit, iussit, coepit, dedit, potuit</em>
* `EMPTY` (3499): <em>est, esse, habet, sunt, habere, sit, dicere, potest, erit, facere</em>
...
1 <tt><a href="la_perseus-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `NOUN` and `Aspect` co-occurred: <tt><a href="la_perseus-feat-Case.html">Case</a></tt><tt>=Gen</tt> (1; 100%), <tt><a href="la_perseus-feat-Gender.html">Gender</a></tt><tt>=Neut</tt> (1; 100%), <tt><a href="la_perseus-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1; 100%).
...
1 <tt><a href="la_perseus-pos-X.html">X</a></tt> tokens (2% of all `X` tokens) have a non-empty value of `Aspect`.

`X` tokens may have the following values of `Aspect`:

* `Perf` (1; 100% of non-empty `Aspect`): <em>vomuit</em>
* `EMPTY` (53): <em>c, ,, L, M, A, Aefulanum, Cn, Q, Ti, Trimalchio</em>

## Relations with Agreement in `Aspect`

The 10 most frequent relations where parent and child node agree in `Aspect`:
<tt>VERB --[<tt><a href="la_perseus-dep-conj.html">conj</a></tt>]--> VERB</tt> (196; 69%),
<tt>VERB --[<tt><a href="la_perseus-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (42; 53%),
