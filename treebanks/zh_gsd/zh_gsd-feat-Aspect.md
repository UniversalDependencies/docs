...
955 <tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> tokens (25% of all `AUX` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `AUX` and `Aspect` co-occurred: <tt><a href="zh_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (955; 100%).
