...
The feature is used with 2 part-of-speech tags: <tt><a href="lt_hse-pos-VERB.html">VERB</a></tt> (527; 10% instances), <tt><a href="lt_hse-pos-AUX.html">AUX</a></tt> (91; 2% instances).

### `VERB`

527 <tt><a href="lt_hse-pos-VERB.html">VERB</a></tt> tokens (74% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="lt_hse-feat-Reflex.html">Reflex</a></tt><tt>=No</tt> (488; 93%), <tt><a href="lt_hse-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (452; 86%), <tt><a href="lt_hse-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (449; 85%), <tt><a href="lt_hse-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (387; 73%), <tt><a href="lt_hse-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (367; 70%), <tt><a href="lt_hse-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (366; 69%), <tt><a href="lt_hse-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (355; 67%), <tt><a href="lt_hse-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (353; 67%), <tt><a href="lt_hse-feat-Number.html">Number</a></tt><tt>=Sing</tt> (351; 67%), <tt><a href="lt_hse-feat-Person.html">Person</a></tt><tt>=3</tt> (299; 57%).
...
91 <tt><a href="lt_hse-pos-AUX.html">AUX</a></tt> tokens (84% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="lt_hse-feat-Reflex.html">Reflex</a></tt><tt>=No</tt> (91; 100%), <tt><a href="lt_hse-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (90; 99%), <tt><a href="lt_hse-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (88; 97%), <tt><a href="lt_hse-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (88; 97%), <tt><a href="lt_hse-feat-Person.html">Person</a></tt><tt>=3</tt> (82; 90%), <tt><a href="lt_hse-feat-Number.html">Number</a></tt><tt>=Sing</tt> (74; 81%), <tt><a href="lt_hse-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (73; 80%).
