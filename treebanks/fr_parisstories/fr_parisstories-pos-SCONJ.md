...
There are 15 `SCONJ` lemmas (1%), 15 `SCONJ` types (0%) and 949 `SCONJ` tokens (2%).
...
* <em>pourquoi</em>
  * <tt><a href="fr_parisstories-pos-ADV.html">ADV</a></tt> 22: <em>je vois pas <b>pourquoi</b> maintenant ça changerait .</em>
...
The form / lemma ratio of `SCONJ` is 1.000000 (the average of all parts of speech is 1.326909).
