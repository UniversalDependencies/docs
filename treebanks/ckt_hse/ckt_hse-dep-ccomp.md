---
layout: base
title:  'Statistics of ccomp in UD_Chukchi-HSE'
udver: '2'
---

## Treebank Statistics: UD_Chukchi-HSE: Relations: `ccomp`

This relation is universal.

6 nodes (0%) are attached to their parents as `ccomp`.

6 instances of `ccomp` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 3.33333333333333.

The following 2 pairs of parts of speech are connected with `ccomp`: <tt><a href="ckt_hse-pos-VERB.html">VERB</a></tt>-<tt><a href="ckt_hse-pos-VERB.html">VERB</a></tt> (5; 83% instances), <tt><a href="ckt_hse-pos-PRON.html">PRON</a></tt>-<tt><a href="ckt_hse-pos-NOUN.html">NOUN</a></tt> (1; 17% instances).
