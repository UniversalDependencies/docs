...
1	Kaukasian	Kaukasia	PROPN	_	Case=Gen|Number=Sing	2	nmod:poss	_	_
2	pohjoisosa	pohjois#osa	NOUN	_	Case=Nom|Number=Sing	3	obj	_	_
3	tunnetaan	tuntea	VERB	_	Mood=Ind|Tense=Pres|VerbForm=Fin|Voice=Pass	0	root	_	_
...
1	Ensin	ensin	ADV	_	_	4	advmod	_	_
2	yksi	yksi	PRON	_	Case=Nom|Number=Sing|PronType=Ind	4	nsubj	_	_
3	jesidinaisista	jesidi#nainen	NOUN	_	Case=Ela|Number=Plur	2	nmod	_	_
4	alkoi	alkaa	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	0	root	_	_
5	itkeä	itkeä	VERB	_	InfForm=1|Number=Sing|VerbForm=Inf|Voice=Act	4	xcomp	_	SpaceAfter=No
6	,	,	PUNCT	_	_	9	punct	11.1:punct	_
7	sen	se	PRON	_	Case=Gen|Number=Sing|PronType=Dem	9	orphan	11.1:obl	_
8	jälkeen	jälkeen	ADP	_	AdpType=Post	7	case	_	_
