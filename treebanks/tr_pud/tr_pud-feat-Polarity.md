...
`Polarity` seems to be **lexical feature** of `NOUN`. 99% lemmas (179) occur only with one value of `Polarity`.
...
`Polarity` seems to be **lexical feature** of `VERB`. 91% lemmas (70) occur only with one value of `Polarity`.
