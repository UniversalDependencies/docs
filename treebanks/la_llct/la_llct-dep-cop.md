...
987 instances of `cop` (64%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.01753246753247.

The following 8 pairs of parts of speech are connected with `cop`: <tt><a href="la_llct-pos-NOUN.html">NOUN</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (636; 41% instances), <tt><a href="la_llct-pos-ADJ.html">ADJ</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (467; 30% instances), <tt><a href="la_llct-pos-PROPN.html">PROPN</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (187; 12% instances), <tt><a href="la_llct-pos-DET.html">DET</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (116; 8% instances), <tt><a href="la_llct-pos-ADV.html">ADV</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (82; 5% instances), <tt><a href="la_llct-pos-PRON.html">PRON</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (42; 3% instances), <tt><a href="la_llct-pos-VERB.html">VERB</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (8; 1% instances), <tt><a href="la_llct-pos-NUM.html">NUM</a></tt>-<tt><a href="la_llct-pos-AUX.html">AUX</a></tt> (2; 0% instances).
...
3	duobus	duo	NUM	a|a|-|p|-|-|-|m|b|-	Case=Abl|Gender=Masc|Number=Plur|NumForm=Word|NumType=Card	4	nummod	_	_
4	germanis	germanus	NOUN	n|n|-|p|-|-|-|m|b|-	Case=Abl|Gender=Masc|Number=Plur	6	obl	_	_
5	nihil	nihil	PRON	p|p|-|s|-|-|-|n|a|-	Case=Acc|Polarity=Neg|PronType=Ind	6	obj	_	_
...
13	sint	sum	AUX	v|v|3|p|p|s|a|-|-|-	Aspect=Imp|Mood=Sub|Number=Plur|Person=3|Tense=Pres|VerbForm=Fin	11	cop	_	SpaceAfter=No|TraditionalMood=Subiunctivus|TraditionalTense=Praesens
...
1	i	hic	DET	p|p|-|p|-|-|-|m|n|-	Case=Nom|Gender=Masc|Number=Plur|PronType=Dem	3	nsubj	_	_
...
3	Alateo	Alateus	PROPN	Propn|n|-|s|-|-|-|m|a|-	Case=Acc|Gender=Masc|Number=Sing	0	root	_	_
4	et	et	CCONJ	c|c|-|-|-|-|-|-|-|-	_	5	cc	_	_
5	Ermiteo	Ermiteus	PROPN	Propn|n|-|s|-|-|-|m|a|-	Case=Acc|Gender=Masc|Number=Sing	3	conj	_	SpaceAfter=No
