...
-*να* is assigned the tag <code>SCONJ</code> when it is used any type of subordinate clause:
--	verb complement, e.g. *Του είπα <b>να</b> έρθει*.[ccomp]() *εδώ΄*``I told him <b>to</b> come.[ccomp]()  here'  *Το Λιμενικό είναι και το μόνο ικανό να.Sconj ξεδιαλύνει[xcomp] την υπόθεση*,   *Έτυχε να.Sconj τον συναντήσετε[csubj] ποτέ μόνο του;*
--	ίδιο με (a) αλλά σε πολυλεκτικά, αν και η σχέση μεταξύ των λέξεων είναι η [fixed], πχ πάει να πει
--	Sconj  όταν εισάγει προτάσεις που προσδιορίζουν όνομα πχ Η μόνη δυνατότητα να.Sconj πλευρίσει[acl] σκάφος στην περιοχή είναι η Σκάλα Ωρωπού.
--	Sconj όταν εισάγει προτάσεις που επιτελούν ρόλο επιρρηματικού προσδιορισμού ρήματος [advcl]. Σε κάποιες  τελικές το να εμφανίζεται μόνο του και σε κάποιες μετά τη adp για ενώ σε όλες τις υπόλοιπες μαζί με κάποιο άλλο άκλιτο μέρος του λόγου, πχ προθέσεις “σαν”, “αντί”, “χωρίς” και το  “που”. Ο Τζάρτζανος αναγνωρίζει αυτά τα δίλεκτα ως συνδέσμους (Τόμος Β: 94). 
○	-τελικές προτάσεις: μόνο του ή σε συνεμφάνιση με την για; η για παραμένει adp εξαρτώμενη από τον να σε συντακτικό επίπεδο με σχέση πολυλεκτικού fixed, πχ Σηκώνεται (για.adp) να.Sconj[fixed] με υποδεχτεί[advcl]. 
