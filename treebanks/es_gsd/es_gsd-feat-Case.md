...
9970 tokens (2%) have a non-empty value of `Case`.
55 types (0%) occur at least once with a non-empty value of `Case`.
9 lemmas (0%) occur at least once with a non-empty value of `Case`.
The feature is used with 1 part-of-speech tags: <tt><a href="es_gsd-pos-PRON.html">PRON</a></tt> (9970; 2% instances).

### `PRON`

9970 <tt><a href="es_gsd-pos-PRON.html">PRON</a></tt> tokens (71% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="es_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (9970; 100%), <tt><a href="es_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (8984; 90%), <tt><a href="es_gsd-feat-PrepCase.html">PrepCase</a></tt><tt>=Npr</tt> (8240; 83%), <tt><a href="es_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (7104; 71%), <tt><a href="es_gsd-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (5404; 54%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (5306; 53%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (2224; 22% of non-empty `Case`): <em>lo, la, los, las, sí, mí, ti, se, Me, em</em>
* `Acc,Dat` (5527; 55% of non-empty `Case`): <em>se, me, nos, te, os, ﻿Se</em>
...
* `Dat` (1415; 14% of non-empty `Case`): <em>le, me, les, nos, te, os, la, lo</em>
* `Nom` (99; 1% of non-empty `Case`): <em>yo, tú, I, You, él</em>
* `EMPTY` (4074): <em>que, uno, cual, una, esto, quien, todo, tanto, algo, nada</em>
