...
1	سال	سال	NOUN	N_IANM	Number=Sing	3	nsubj	_	LTranslit=sāl|Translit=sāl
2	نو	نو	ADJ	ADJ_AJP	_	1	amod	_	LTranslit=nū|Translit=nū
3	آمد	آمد	VERB	V_ACT	Number=Sing|Person=3|Tense=Past|Voice=Act	0	root	_	LTranslit=Āmd|OrigLemma=آمد#آ|Translit=Āmd
4	و	و	CCONJ	CONJ	_	8	cc	_	LTranslit=ū|Translit=ū
5	کنار	کنار	NOUN	N_IANM	_	8	obl	_	LTranslit=knār|Translit=knār
6	سفرهٔ	سفره	NOUN	N_IANM	Number=Sing	5	nmod	_	LTranslit=sfrh|Translit=sfrhٔ
7	هفت‌سین	هفت‌سین	NOUN	N_IANM	Number=Sing	6	nmod	_	LTranslit=hftsīn|Translit=hftsīn
8	نشست	نشست	VERB	V_ACT	Number=Sing|Person=3|Tense=Past|Voice=Act	3	conj	_	LTranslit=nšst|OrigLemma=نشست#نشین|SpaceAfter=No|Translit=nšst
