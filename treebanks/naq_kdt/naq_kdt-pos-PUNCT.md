...
## Treebank Statistics: UD_Khoekhoe-KDT: POS Tags: `PUNCT`

There are 15 `PUNCT` lemmas (1%), 15 `PUNCT` types (0%) and 4144 `PUNCT` tokens (14%).
...
The most frequent feature combination is `_` (4142 tokens).
Examples: <em>., ,, ?, ", !, …, [, ], ', ...</em>
