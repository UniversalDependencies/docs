...
6196 tokens (2%) have a non-empty value of `NumType`.
1307 types (3%) occur at least once with a non-empty value of `NumType`.
1149 lemmas (5%) occur at least once with a non-empty value of `NumType`.
The feature is used with 2 part-of-speech tags: <tt><a href="sl_ssj-pos-NUM.html">NUM</a></tt> (5584; 2% instances), <tt><a href="sl_ssj-pos-ADJ.html">ADJ</a></tt> (612; 0% instances).

### `NUM`

5584 <tt><a href="sl_ssj-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="sl_ssj-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (4571; 82%), <tt><a href="sl_ssj-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (4116; 74%), <tt><a href="sl_ssj-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (4116; 74%), <tt><a href="sl_ssj-feat-NumForm.html">NumForm</a></tt><tt>=Digit</tt> (4043; 72%).

`NUM` tokens may have the following values of `NumType`:

* `Card` (4896; 88% of non-empty `NumType`): <em>2, eno, 1, dve, dva, dveh, tri, ena, eden, 10</em>
...
`NumType` seems to be **lexical feature** of `NUM`. 100% lemmas (1119) occur only with one value of `NumType`.
...
<tt>NUM --[<tt><a href="sl_ssj-dep-conj.html">conj</a></tt>]--> NUM</tt> (420; 100%),
...
<tt>ADJ --[<tt><a href="sl_ssj-dep-parataxis.html">parataxis</a></tt>]--> ADJ</tt> (2; 67%),
