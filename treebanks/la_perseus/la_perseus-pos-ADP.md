...
There are 34 `ADP` lemmas (1%), 40 `ADP` types (0%) and 1348 `ADP` tokens (5%).
...
The form / lemma ratio of `ADP` is 1.176471 (the average of all parts of speech is 2.101803).
...
The most frequent feature combination is `_` (1331 tokens).
Examples: <em>in, ad, de, a, per, ex, cum, ab, super, pro</em>


## Relations

`ADP` nodes are attached to their parents using 2 different relations: <tt><a href="la_perseus-dep-case.html">case</a></tt> (1335; 99% instances), <tt><a href="la_perseus-dep-mark.html">mark</a></tt> (13; 1% instances)
