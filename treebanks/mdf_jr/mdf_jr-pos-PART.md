...
The form / lemma ratio of `PART` is 1.250000 (the average of all parts of speech is 1.498347).
...
Examples: <em>вдь, улема, хоть, дяряй, нльне, нльня, хуш, шять</em>


## Relations

`PART` nodes are attached to their parents using 6 different relations: <tt><a href="mdf_jr-dep-advmod.html">advmod</a></tt> (5; 33% instances), <tt><a href="mdf_jr-dep-advmod-deg.html">advmod:deg</a></tt> (3; 20% instances), <tt><a href="mdf_jr-dep-advmod-eval.html">advmod:eval</a></tt> (3; 20% instances), <tt><a href="mdf_jr-dep-discourse.html">discourse</a></tt> (2; 13% instances), <tt><a href="mdf_jr-dep-dep.html">dep</a></tt> (1; 7% instances), <tt><a href="mdf_jr-dep-mark.html">mark</a></tt> (1; 7% instances)
...
12 (80%) `PART` nodes are leaves.

0 (0%) `PART` nodes have one child.

3 (20%) `PART` nodes have two children.

The highest child degree of a `PART` node is 2.

Children of `PART` nodes are attached using 1 different relations: <tt><a href="mdf_jr-dep-punct.html">punct</a></tt> (6; 100% instances)

Children of `PART` nodes belong to 1 different parts of speech: <tt><a href="mdf_jr-pos-PUNCT.html">PUNCT</a></tt> (6; 100% instances)
