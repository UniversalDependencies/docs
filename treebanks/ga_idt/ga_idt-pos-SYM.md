...
The form / lemma ratio of `SYM` is 1.000000 (the average of all parts of speech is 1.449191).

The 1st highest number of forms (1) was observed with the lemma “post@clubsult.com”: <em>post@clubsult.com</em>.

`SYM` occurs with 1 features: <tt><a href="ga_idt-feat-Abbr.html">Abbr</a></tt> (1; 100% instances)
...
`SYM` nodes are attached to their parents using 1 different relations: <tt><a href="ga_idt-dep-compound.html">compound</a></tt> (1; 100% instances)

Parents of `SYM` nodes belong to 1 different parts of speech: <tt><a href="ga_idt-pos-NOUN.html">NOUN</a></tt> (1; 100% instances)
...
Children of `SYM` nodes are attached using 1 different relations: <tt><a href="ga_idt-dep-punct.html">punct</a></tt> (2; 100% instances)

Children of `SYM` nodes belong to 1 different parts of speech: <tt><a href="ga_idt-pos-PUNCT.html">PUNCT</a></tt> (2; 100% instances)
