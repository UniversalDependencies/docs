...
3	filios	filius	NOUN	B1|grn1|casM|gen1	Case=Acc|Gender=Masc|Number=Plur	1	obj	_	_
4	tuos	tuus	DET	B1|grn1|casM|gen1	Case=Acc|Gender=Masc|Number=Plur|Number[psor]=Sing|Person[psor]=2|Poss=Yes|PronType=Prs	3	det	_	_
...
7	domino	dominus	NOUN	B1|grn1|casF|gen1	Case=Abl|Gender=Masc|Number=Sing	5	obl:arg	_	SpaceAfter=No
...
2	hoc	hic	PRON	F1|grn1|casA|gen3	Case=Nom|Gender=Neut|Number=Sing|PronType=Dem	3	obl:arg	_	_
...
4	deum	deus	NOUN	F1|grn1|casD|gen1	Case=Acc|Gender=Masc|Number=Sing	3	xcomp	_	SpaceAfter=No
