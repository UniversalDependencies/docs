...
The feature is used with 2 part-of-speech tags: <tt><a href="ga_idt-pos-NUM.html">NUM</a></tt> (164; 1% instances), <tt><a href="ga_idt-pos-NOUN.html">NOUN</a></tt> (1; 0% instances).

### `NUM`

164 <tt><a href="ga_idt-pos-NUM.html">NUM</a></tt> tokens (51% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="ga_idt-feat-Form.html">Form</a></tt><tt>=EMPTY</tt> (124; 76%).
