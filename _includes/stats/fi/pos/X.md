...
Out of 15 observed tags, the rank of `X` is: 7 in number of lemmas, 8 in number of types and 14 in number of tokens.
...
The most frequent feature combination is `Foreign=Foreign` (249 tokens).
