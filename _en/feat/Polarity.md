...
In English, it pertains to only three function words:

- the [particle](u-pos/PART) _not_ receives `Polarity=Neg`
- the [interjection](u-pos/INTJ) _no_ receives `Polarity=Neg`
- the [interjection](u-pos/INTJ) _yes_ receives `Polarity=Pos`
