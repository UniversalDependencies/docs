---
layout: base
title:  'Statistics of PART in UD_French-FTB'
udver: '2'
---

## Treebank Statistics: UD_French-FTB: POS Tags: `PART`

There are 1 `PART` lemmas (0%), 1 `PART` types (0%) and 239 `PART` tokens (0%).
...
The form / lemma ratio of `PART` is 1.000000 (the average of all parts of speech is 1.170225).
...
`PART` nodes are attached to their parents using 3 different relations: <tt><a href="fr_ftb-dep-expl.html">expl</a></tt> (237; 99% instances), <tt><a href="fr_ftb-dep-advmod.html">advmod</a></tt> (1; 0% instances), <tt><a href="fr_ftb-dep-fixed.html">fixed</a></tt> (1; 0% instances)

Parents of `PART` nodes belong to 3 different parts of speech: <tt><a href="fr_ftb-pos-PRON.html">PRON</a></tt> (236; 99% instances), <tt><a href="fr_ftb-pos-VERB.html">VERB</a></tt> (2; 1% instances), <tt><a href="fr_ftb-pos-ADJ.html">ADJ</a></tt> (1; 0% instances)

239 (100%) `PART` nodes are leaves.
