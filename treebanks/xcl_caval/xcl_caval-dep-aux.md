...
445 nodes (0%) are attached to their parents as `aux`.

339 instances of `aux` (76%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.31910112359551.

The following 4 pairs of parts of speech are connected with `aux`: <tt><a href="xcl_caval-pos-VERB.html">VERB</a></tt>-<tt><a href="xcl_caval-pos-AUX.html">AUX</a></tt> (435; 98% instances), <tt><a href="xcl_caval-pos-AUX.html">AUX</a></tt>-<tt><a href="xcl_caval-pos-AUX.html">AUX</a></tt> (6; 1% instances), <tt><a href="xcl_caval-pos-ADJ.html">ADJ</a></tt>-<tt><a href="xcl_caval-pos-AUX.html">AUX</a></tt> (3; 1% instances), <tt><a href="xcl_caval-pos-PRON.html">PRON</a></tt>-<tt><a href="xcl_caval-pos-AUX.html">AUX</a></tt> (1; 0% instances).
...
10	նոքա	նա	PRON	_	Case=Nom|Deixis=Remt|Number=Plur|PronType=Dem	11	nsubj	_	Translit=nokʻa|LTranslit=na|Gloss=he/she/it
...
2	նա	նա	PRON	_	Case=Nom|Deixis=Remt|Number=Sing|PronType=Dem	4	nsubj	_	Translit=na|LTranslit=na|Gloss=he/she/it
...
6	որ	որ	PRON	_	Case=Nom|Number=Sing|PronType=Rel	10	nsubj	_	Translit=or|LTranslit=or|Gloss=who
7	ընդ	ընդ	ADP	_	_	8	case	_	Translit=ənd|LTranslit=ənd|Gloss=with/during/for
8	նմայ	նա	PRON	_	Case=Loc|Deixis=Remt|Number=Sing|PronType=Dem	10	obl	_	SpaceAfter=No|Translit=nmay|LTranslit=na|Gloss=he/she/it
9	ն	ն	DET	_	Definite=Def|Deixis=Remt|PronType=Art	8	det	_	Translit=n|LTranslit=n|Gloss=that
10	լիեալ	լինել	AUX	_	Case=Nom|Number=Sing|Tense=Past|VerbForm=Part	5	acl	_	Translit=lieal|LTranslit=linel|Gloss=become
...
8	լիեալ	լինել	AUX	_	Case=Nom|Number=Sing|Tense=Past|VerbForm=Part	7	cop	_	Translit=lieal|LTranslit=linel|Gloss=become
