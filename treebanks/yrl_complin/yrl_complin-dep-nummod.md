...
33 nodes (0%) are attached to their parents as `nummod`.

32 instances of `nummod` (97%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.03030303030303.

The following 2 pairs of parts of speech are connected with `nummod`: <tt><a href="yrl_complin-pos-NOUN.html">NOUN</a></tt>-<tt><a href="yrl_complin-pos-NUM.html">NUM</a></tt> (32; 97% instances), <tt><a href="yrl_complin-pos-PRON.html">PRON</a></tt>-<tt><a href="yrl_complin-pos-NUM.html">NUM</a></tt> (1; 3% instances).
...
3	umbué	mbué	VERB	V	Person=3|VerbForm=Fin	4	acl:relcl	_	TokenRange=10:15
...
6	umbeú	mbeú	VERB	V	Person=3|VerbForm=Fin	0	root	_	TokenRange=30:35
7	i	i	PRON	PRON2	Case=Gen|Number=Sing|Person=3|PronType=Prs	6	obl	_	TokenRange=36:37
8	xupé	xupé	ADP	ADP	_	7	case	_	TokenRange=38:42
9	Jesus	jesus	PROPN	PROPN	_	10	nsubj	_	TokenRange=43:48
10	umunhã	munhã	VERB	V	Person=3|VerbForm=Fin	11	acl:relcl	_	TokenRange=49:55
11	waá-itá	waá	PRON	REL	Number=Plur|PronType=Rel	6	obl	_	TokenRange=56:63
12	resewara	resewara	ADP	ADP	Rel=Cont	11	case	_	TokenRange=64:72
...
17	usenúi	senúi	VERB	V	Person=3|VerbForm=Fin	6	conj	_	TokenRange=90:96
18	i	i	PRON	PRON2	Case=Gen|Number=Sing|Person=3|PronType=Prs	17	obl	_	TokenRange=97:98
19	piri	piri	ADP	ADP	_	18	case	_	TokenRange=99:103
20	mukũi	mukũi	NUM	CARD	NumType=Card	22	nummod	_	TokenRange=104:109
21	umbué	mbué	VERB	V	Person=3|VerbForm=Fin	22	acl:relcl	_	TokenRange=110:115
