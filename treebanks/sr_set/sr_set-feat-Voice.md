...
1094 <tt><a href="sr_set-pos-ADJ.html">ADJ</a></tt> tokens (10% of all `ADJ` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `ADJ` and `Voice` co-occurred: <tt><a href="sr_set-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (1094; 100%), <tt><a href="sr_set-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (1094; 100%), <tt><a href="sr_set-feat-Case.html">Case</a></tt><tt>=Nom</tt> (946; 86%), <tt><a href="sr_set-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (800; 73%), <tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (777; 71%).
