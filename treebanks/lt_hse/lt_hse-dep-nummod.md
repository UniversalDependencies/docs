---
layout: base
title:  'Statistics of nummod in UD_Lithuanian-HSE'
udver: '2'
---

## Treebank Statistics: UD_Lithuanian-HSE: Relations: `nummod`

This relation is universal.
There are 1 language-specific subtypes of `nummod`: <tt><a href="lt_hse-dep-nummod-gov.html">nummod:gov</a></tt>.

11 nodes (0%) are attached to their parents as `nummod`.

11 instances of `nummod` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.54545454545455.

The following 1 pairs of parts of speech are connected with `nummod`: <tt><a href="lt_hse-pos-NOUN.html">NOUN</a></tt>-<tt><a href="lt_hse-pos-NUM.html">NUM</a></tt> (11; 100% instances).
