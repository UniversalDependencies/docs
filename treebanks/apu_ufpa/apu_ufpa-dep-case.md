...
6 nodes (1%) are attached to their parents as `case`.

5 instances of `case` (83%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.16666666666667.

The following 2 pairs of parts of speech are connected with `case`: <tt><a href="apu_ufpa-pos-VERB.html">VERB</a></tt>-<tt><a href="apu_ufpa-pos-ADP.html">ADP</a></tt> (4; 67% instances), <tt><a href="apu_ufpa-pos-NOUN.html">NOUN</a></tt>-<tt><a href="apu_ufpa-pos-ADP.html">ADP</a></tt> (2; 33% instances).
