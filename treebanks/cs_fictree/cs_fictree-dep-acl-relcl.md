...
1	Lekci	lekce	NOUN	NNFS4-----A----	Case=Acc|Gender=Fem|Number=Sing	10	obj	6:obj|10:obj	SpaceAfter=No
...
5	šéf	šéf	NOUN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|Number=Sing	6	nsubj	6:nsubj	_
...
8	jsem	být	AUX	VB-S---1P-AA---	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	10	aux	10:aux	_
...
12	života	život	NOUN	NNIS2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Sing	10	obl	10:obl:do:gen	SpaceAfter=No
...
5	příběh	příběh	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	6	obj	6:obj	_
...
10	poslání	poslání	NOUN	NNNS6-----A----	Case=Loc|Gender=Neut|Number=Sing	8	obl:arg	8:obl:arg:v:loc	SpaceAfter=No
...
5	způsob	způsob	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	3	obj	3:obj|9:obl:ins	SpaceAfter=No
...
8	byly	být	AUX	VpIP----R-AA---	Animacy=Inan|Aspect=Imp|Gender=Masc|Number=Plur|Polarity=Pos|Tense=Past|VerbForm=Part|Voice=Act	9	cop	9:cop	_
9	potrhány	potrhaný	ADJ	VsIP------AP---	Animacy=Inan|Degree=Pos|Gender=Masc|Number=Plur|Polarity=Pos|Variant=Short|VerbForm=Part|Voice=Pass	5	acl:relcl	5:acl:relcl	SpaceAfter=No|LDeriv=potrhat
