...
`NOUN` occurs with 4 features: <tt><a href="say_autogramm-feat-Definite.html">Definite</a></tt> (328; 17% instances), <tt><a href="say_autogramm-feat-Number.html">Number</a></tt> (103; 5% instances), <tt><a href="say_autogramm-feat-Deixis.html">Deixis</a></tt> (97; 5% instances), <tt><a href="say_autogramm-feat-ExtPos.html">ExtPos</a></tt> (6; 0% instances)

`NOUN` occurs with 8 feature-value pairs: `Definite=Cons`, `Definite=Def`, `Definite=Ind`, `Deixis=Prox`, `Deixis=Remt`, `ExtPos=ADJ`, `ExtPos=NOUN`, `Number=Plur`
