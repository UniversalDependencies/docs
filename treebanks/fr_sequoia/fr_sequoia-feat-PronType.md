...
The feature is used with 4 part-of-speech tags: <tt><a href="fr_sequoia-pos-DET.html">DET</a></tt> (9725; 14% instances), <tt><a href="fr_sequoia-pos-PRON.html">PRON</a></tt> (776; 1% instances), <tt><a href="fr_sequoia-pos-ADV.html">ADV</a></tt> (38; 0% instances), <tt><a href="fr_sequoia-pos-PART.html">PART</a></tt> (12; 0% instances).

### `DET`

9725 <tt><a href="fr_sequoia-pos-DET.html">DET</a></tt> tokens (93% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="fr_sequoia-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (7442; 77%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7171; 74%).

`DET` tokens may have the following values of `PronType`:

* `Art` (9267; 95% of non-empty `PronType`): <em>le, les, la, l', une, un, des, de, d', quelques</em>
...
* `EMPTY` (2117): <em>il, nous, se, je, s', vous, elle, ce, ils, y</em>
...
* `EMPTY` (2548): <em>pas, n', ne, plus, moins, très, également, aussi, bien, non</em>

### `PART`

12 <tt><a href="fr_sequoia-pos-PART.html">PART</a></tt> tokens (63% of all `PART` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PART` and `PronType` co-occurred: <tt><a href="fr_sequoia-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (12; 100%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (12; 100%).

`PART` tokens may have the following values of `PronType`:

* `Art` (12; 100% of non-empty `PronType`): <em>l'</em>
* `EMPTY` (7): <em>-t</em>
