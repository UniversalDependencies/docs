...
There are 7154 `PROPN` lemmas (35%), 7190 `PROPN` types (25%) and 18781 `PROPN` tokens (8%).
...
* <em>ministério</em>
  * <tt><a href="pt_bosque-pos-NOUN.html">NOUN</a></tt> 8: <em>JOSÉ CALÇADA -- As relações entre o sindicato e o <b>ministério</b> não existem .</em>
  * <tt><a href="pt_bosque-pos-PROPN.html">PROPN</a></tt> 1: <em>Contrariamente a o que esperavam Luís Rodrigues e os seus correligionários , o caso , porém , ficou adormecido em o <b>ministério</b> de as Finanças .</em>

## Morphology

The form / lemma ratio of `PROPN` is 1.005032 (the average of all parts of speech is 1.421073).
...
`PROPN` occurs with 6 features: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (18775; 100% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (11542; 61% instances), <tt><a href="pt_bosque-feat-ExtPos.html">ExtPos</a></tt> (4112; 22% instances), <tt><a href="pt_bosque-feat-Abbr.html">Abbr</a></tt> (79; 0% instances), <tt><a href="pt_bosque-feat-PronType.html">PronType</a></tt> (26; 0% instances), <tt><a href="pt_bosque-feat-Typo.html">Typo</a></tt> (1; 0% instances)
