...
There are 2 language-specific subtypes of `csubj`: <tt><a href="la_llct-dep-csubj-pass.html">csubj:pass</a></tt>, <tt><a href="la_llct-dep-csubj-relcl.html">csubj:relcl</a></tt>.
...
12	nulla	nullus	DET	a|a|-|s|-|-|-|f|n|-	Case=Nom|Gender=Fem|Number=Sing|Polarity=Neg|PronType=Ind	13	det	_	_
...
18	non	non	PART	d|d|-|-|-|-|-|-|-|-	Polarity=Neg	19	advmod:neg	_	_
19	abeo	habeo	VERB	v|v|1|s|p|i|a|-|-|-	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	46	advcl	_	SpaceAfter=No|TraditionalMood=Indicativus|TraditionalTense=Praesens
...
37	,	,	PUNCT	Punc	_	27	punct	_	_
38	per	per	ADP	r|r|-|-|-|-|-|-|-|-	_	39	case	_	_
39	cartula	chartula	NOUN	n|n|-|s|-|-|-|f|a|-	Case=Acc|Degree=Dim|Gender=Fem|Number=Sing	46	obl	_	_
...
59	pertinens	pertineo	VERB	t|t|-|s|p|p|a|f|n|-	Aspect=Imp|Case=Nom|Gender=Fem|Number=Sing|VerbForm=Part|Voice=Act	51	acl	_	TraditionalMood=Participium|TraditionalTense=Praesens
...
66	dicitur	dico	VERB	v|v|3|s|p|i|p|-|-|-	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Pass	60	acl:relcl	_	TraditionalMood=Indicativus|TraditionalTense=Praesens
