---
layout: base
title:  'Statistics of obj in UD_Cappadocian-AMGiC'
udver: '2'
---

## Treebank Statistics: UD_Cappadocian-AMGiC: Relations: `obj`

This relation is universal.

44 nodes (10%) are attached to their parents as `obj`.

31 instances of `obj` (70%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.86363636363636.

The following 2 pairs of parts of speech are connected with `obj`: <tt><a href="cpg_amgic-pos-VERB.html">VERB</a></tt>-<tt><a href="cpg_amgic-pos-NOUN.html">NOUN</a></tt> (29; 66% instances), <tt><a href="cpg_amgic-pos-VERB.html">VERB</a></tt>-<tt><a href="cpg_amgic-pos-PRON.html">PRON</a></tt> (15; 34% instances).
