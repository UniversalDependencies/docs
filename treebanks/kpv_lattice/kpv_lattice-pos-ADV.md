...
There are 264 `ADV` lemmas (11%), 281 `ADV` types (8%) and 874 `ADV` tokens (11%).
...
The form / lemma ratio of `ADV` is 1.064394 (the average of all parts of speech is 1.467100).
