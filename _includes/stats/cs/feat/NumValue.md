...
* `1,2,3` (8050; 100% of non-empty `NumValue`): _dva, tři, jeden, dvě, tisíc, dvou, čtyři, obou, jednoho, jedné_
...
The most frequent other feature values with which `ADJ` and `NumValue` co-occurred: <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (30; 100%), <tt><a href="Number.html">Number</a>=Plur</tt> (30; 100%), <tt><a href="Negative.html">Negative</a>=EMPTY</tt> (30; 100%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (19; 63%).

`ADJ` tokens may have the following values of `NumValue`:

* `1` (30; 100% of non-empty `NumValue`): _jedny, jedni, jedněch, jedněm, jedněmi_
