---
layout: base
title:  'Statistics of iobj in UD_Ukrainian-ParlaMint'
udver: '2'
---

## Treebank Statistics: UD_Ukrainian-ParlaMint: Relations: `iobj`
...
1	Будь	бути	VERB	VERB	Aspect=Imp|ExtPos=INTJ|Mood=Imp|Number=Sing|Person=2|VerbForm=Fin	5	parataxis	_	_
2	ласка	ласка	NOUN	NOUN	Animacy=Inan|Case=Nom|Gender=Fem|Number=Sing	1	fixed	_	SpaceAfter=No
3	,	,	PUNCT	PUNCT	_	1	punct	_	_
4	слово	слово	NOUN	NOUN	Animacy=Inan|Case=Nom|Gender=Neut|Number=Sing	5	nsubj	_	_
5	надається	надаватися	VERB	VERB	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Reflex=Yes|Tense=Pres|VerbForm=Fin	0	root	_	_
6	народному	народний	ADJ	ADJ	Case=Dat|Gender=Masc|Number=Sing	7	amod	_	_
7	депутату	депутат	NOUN	NOUN	Animacy=Anim|Case=Dat|Gender=Masc|Number=Sing	5	iobj	_	_
8	Чорному	Чорний	PROPN	ADJ	Animacy=Anim|Case=Dat|Gender=Masc|NameType=Sur|Number=Sing	7	appos	_	SpaceAfter=No
...
1	Політики	політика	NOUN	NOUN	Animacy=Anim|Case=Nom|Gender=Masc|Number=Plur	3	nsubj	_	_
2	нікому	ніхто	PRON	PRON	Animacy=Anim|Case=Dat|PronType=Neg	3	iobj	_	_
3	платити	платити	VERB	VERB	Aspect=Imp|VerbForm=Inf	0	root	_	_
4	не	не	PART	PART	Polarity=Neg	3	advmod:neg	_	_
5	будуть	бути	AUX	AUX	Aspect=Imp|Mood=Ind|Number=Plur|Person=3|Tense=Fut|VerbForm=Fin	3	aux	_	SpaceAfter=No
