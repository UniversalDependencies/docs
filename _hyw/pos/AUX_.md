...
Western Armenian has the following auxiliary verbs: _եմ_/_em_ “be”, _լինիմ (ըլլալ)_/_linim (ěllal)_ “be repeatedly / habitually”,  _պիտի (պիտ, տի)_/_bidi (bid, di)_ or _պէտք է_/_bēdkʿ ē_“must/will”, _կը (կու, կ', կ-)/gě (gu, g'-, g-)_ “do/will”, _կոր_/_gor_.
The most commonly used auxiliary is _եմ/em_ with its conjugation paradigms in present and imperfect.


(_ունիմ/ownim_ “have”, _կամ/kam_ “exist”, 
and the negative auxiliaries _չի (չ-)/či (č-)_ “do(es) not”, _ոչ/oč_ “do(es) not”.)
