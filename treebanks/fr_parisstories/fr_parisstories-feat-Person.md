...
10161 tokens (24%) have a non-empty value of `Person`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="fr_parisstories-pos-PRON.html">PRON</a></tt> (5578; 13% instances), <tt><a href="fr_parisstories-pos-VERB.html">VERB</a></tt> (2439; 6% instances), <tt><a href="fr_parisstories-pos-AUX.html">AUX</a></tt> (2034; 5% instances), <tt><a href="fr_parisstories-pos-DET.html">DET</a></tt> (110; 0% instances).

### `PRON`

5578 <tt><a href="fr_parisstories-pos-PRON.html">PRON</a></tt> tokens (87% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="fr_parisstories-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4772; 86%), <tt><a href="fr_parisstories-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (3631; 65%).

`PRON` tokens may have the following values of `Person`:

* `1` (1576; 28% of non-empty `Person`): <em>je, j', me, moi, nous, m', toi, -moi, moi-même</em>
* `2` (344; 6% of non-empty `Person`): <em>tu, vous, te, t', toi</em>
* `3` (3658; 66% of non-empty `Person`): <em>on, c', il, ça, elle, y, ils, s', se, l'</em>
...
2034 <tt><a href="fr_parisstories-pos-AUX.html">AUX</a></tt> tokens (97% of all `AUX` tokens) have a non-empty value of `Person`.
...
* `EMPTY` (70): <em>été, être, faire, avoir, fait, étais, ai, eu, refaire</em>
...
* `EMPTY` (3366): <em>le, la, un, les, une, l', des, mon, ma, mes</em>
...
<tt>VERB --[<tt><a href="fr_parisstories-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (1843; 63%),
<tt>VERB --[<tt><a href="fr_parisstories-dep-expl-subj.html">expl:subj</a></tt>]--> PRON</tt> (203; 77%),
<tt>VERB --[<tt><a href="fr_parisstories-dep-expl-comp.html">expl:comp</a></tt>]--> PRON</tt> (195; 68%),
