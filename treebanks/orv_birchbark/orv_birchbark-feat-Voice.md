...
2947 tokens (11%) have a non-empty value of `Voice`.
2136 types (18%) occur at least once with a non-empty value of `Voice`.
677 lemmas (14%) occur at least once with a non-empty value of `Voice`.
The feature is used with 2 part-of-speech tags: <tt><a href="orv_birchbark-pos-VERB.html">VERB</a></tt> (2578; 9% instances), <tt><a href="orv_birchbark-pos-AUX.html">AUX</a></tt> (369; 1% instances).

### `VERB`

2578 <tt><a href="orv_birchbark-pos-VERB.html">VERB</a></tt> tokens (98% of all `VERB` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `VERB` and `Voice` co-occurred: <tt><a href="orv_birchbark-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1931; 75%), <tt><a href="orv_birchbark-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (1799; 70%), <tt><a href="orv_birchbark-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1752; 68%), <tt><a href="orv_birchbark-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1476; 57%).

`VERB` tokens may have the following values of `Voice`:

* `Act` (2319; 90% of non-empty `Voice`): <em>возми, даи, далъ, пришли, шло, възьми, посли, присъли, възѧле, дале</em>
* `Mid` (199; 8% of non-empty `Voice`): <em>кланѧюсѧ, покланѧю, молисѧ, кланѧю, диꙗлось, за…, молю, порꙋчи(‐), потоснисѧ, (соро)<lbr/>слосѧ</em>
* `Pass` (60; 2% of non-empty `Voice`): <em>куплено, [п]окладено, [ѿ](им)ана, битъ, блг҃ословлено, взѧтъ, вода[н]о, водано, возѧто, возѧтъ</em>
* `EMPTY` (63): <em>нѣ, надоби, надобе, нѣту, надобь, надобѣ, не, нету, ниту, нѣтъ</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="orv_birchbark-feat-Analyt.html">Analyt</a></tt><tt>=Yes</tt>|<tt><a href="orv_birchbark-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="orv_birchbark-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="orv_birchbark-feat-Tense.html">Tense</a></tt><tt>=Past</tt>|<tt><a href="orv_birchbark-feat-VerbForm.html">VerbForm</a></tt><tt>=PartRes</tt></tt></td><td><em>взѧла</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="orv_birchbark-feat-Fragment.html">Fragment</a></tt><tt>=Yes</tt>|<tt><a href="orv_birchbark-feat-VerbForm.html">VerbForm</a></tt><tt>=Inf</tt></tt></td><td><em>во…</em></td><td></td></tr>
...
`Voice` seems to be **lexical feature** of `VERB`. 95% lemmas (640) occur only with one value of `Voice`.

### `AUX`

369 <tt><a href="orv_birchbark-pos-AUX.html">AUX</a></tt> tokens (96% of all `AUX` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `AUX` and `Voice` co-occurred: <tt><a href="orv_birchbark-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (344; 93%), <tt><a href="orv_birchbark-feat-Analyt.html">Analyt</a></tt><tt>=Yes</tt> (326; 88%), <tt><a href="orv_birchbark-feat-Number.html">Number</a></tt><tt>=Sing</tt> (312; 85%), <tt><a href="orv_birchbark-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (289; 78%).

`AUX` tokens may have the following values of `Voice`:

* `Act` (369; 100% of non-empty `Voice`): <em>еси, ѥси, есмь, ѥсмь, есте, есть, есемо, бꙑ, бꙑло, ѥсме</em>
* `EMPTY` (15): <em>бꙑ, бъ, б(у)[д](е, би, есем-, есо<lbr/>(мо</em>

## Relations with Agreement in `Voice`

The 10 most frequent relations where parent and child node agree in `Voice`:
<tt>VERB --[<tt><a href="orv_birchbark-dep-conj.html">conj</a></tt>]--> VERB</tt> (312; 84%),
<tt>VERB --[<tt><a href="orv_birchbark-dep-aux.html">aux</a></tt>]--> AUX</tt> (244; 93%),
<tt>VERB --[<tt><a href="orv_birchbark-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (238; 87%),
<tt>VERB --[<tt><a href="orv_birchbark-dep-xcomp.html">xcomp</a></tt>]--> VERB</tt> (77; 87%),
<tt>VERB --[<tt><a href="orv_birchbark-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (71; 76%),
