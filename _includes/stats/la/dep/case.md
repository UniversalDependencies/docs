...
2494 nodes (5%) are attached to their parents as `case`.

2418 instances of `case` (97%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.26383319967923.

The following 19 pairs of parts of speech are connected with `case`: [la-pos/NOUN]()-[la-pos/ADP]() (1967; 79% instances), [la-pos/PRON]()-[la-pos/ADP]() (303; 12% instances), [la-pos/ADJ]()-[la-pos/ADP]() (103; 4% instances), [la-pos/VERB]()-[la-pos/ADP]() (42; 2% instances), [la-pos/ADV]()-[la-pos/ADP]() (35; 1% instances), [la-pos/PUNCT]()-[la-pos/ADP]() (13; 1% instances), [la-pos/NOUN]()-[la-pos/CONJ]() (8; 0% instances), [la-pos/NUM]()-[la-pos/ADP]() (5; 0% instances), [la-pos/ADV]()-[la-pos/CONJ]() (3; 0% instances), [la-pos/ADJ]()-[la-pos/CONJ]() (2; 0% instances), [la-pos/CONJ]()-[la-pos/ADP]() (2; 0% instances), [la-pos/NOUN]()-[la-pos/ADV]() (2; 0% instances), [la-pos/PUNCT]()-[la-pos/ADV]() (2; 0% instances), [la-pos/X]()-[la-pos/ADP]() (2; 0% instances), [la-pos/ADJ]()-[la-pos/ADV]() (1; 0% instances), [la-pos/PRON]()-[la-pos/CONJ]() (1; 0% instances), [la-pos/PUNCT]()-[la-pos/CONJ]() (1; 0% instances), [la-pos/VERB]()-[la-pos/ADV]() (1; 0% instances), [la-pos/VERB]()-[la-pos/CONJ]() (1; 0% instances).
...
# visual-style 4	fgColor:white
# visual-style 4 3 case	color:blue
1	Et	et1	CONJ	c--------	_	6	cc	_	_
2	ideo	ideo1	ADV	d--------	_	6	advmod	_	_
3	ante	ante1	ADP	r--------	_	4	case	_	_
4	omnia	omnis1	ADJ	a-p---na-	Case=Acc|Gender=Neut|Number=Plur	6	advmod	_	_
5	adici	adicio1	VERB	v--pna---	Tense=Pres|VerbForm=Inf|Voice=Act	6	xcomp	_	_
6	volo	volo1	VERB	v1spia---	Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
...
13045 nodes (8%) are attached to their parents as `case`.

12881 instances of `case` (99%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.17585281717133.

The following 9 pairs of parts of speech are connected with `case`: [la-pos/NOUN]()-[la-pos/ADP]() (7924; 61% instances), [la-pos/PRON]()-[la-pos/ADP]() (2424; 19% instances), [la-pos/PROPN]()-[la-pos/ADP]() (1296; 10% instances), [la-pos/ADJ]()-[la-pos/ADP]() (975; 7% instances), [la-pos/VERB]()-[la-pos/ADP]() (230; 2% instances), [la-pos/ADV]()-[la-pos/ADP]() (104; 1% instances), [la-pos/NUM]()-[la-pos/ADP]() (70; 1% instances), [la-pos/ADP]()-[la-pos/ADP]() (13; 0% instances), [la-pos/X]()-[la-pos/ADP]() (9; 0% instances).
