...
There are also 1 other language-specific subtypes of `flat`: <tt><a href="la_udante-dep-flat-foreign.html">flat:foreign</a></tt>.
...
5	poetando	poetor	VERB	va1fgb	Aspect=Imp|Case=Abl|Gender=Neut|InflClass=LatA|InflClass[noun]=IndEurO|Number=Sing|Tense=Fut|VerbForm=Ger|Voice=Pass	6	obl:arg	_	_
6	divertisse	diuerto	VERB	va3fr	Aspect=Perf|InflClass=LatX|InflClass[noun]=Ind|Tense=Past|VerbForm=Inf|Voice=Act	7	ccomp	_	_
...
4	exprobrare	exprobro	VERB	va1fp	Aspect=Imp|InflClass=LatA|InflClass[noun]=Ind|Tense=Pres|VerbForm=Inf|Voice=Act	1	xcomp	_	_
...
19	utroque	uterque	DET	dpmsb	Case=Abl|Emphatic=Yes|Gender=Masc|InflClass=LatPron|Number=Sing|PronType=Ind	20	det	_	_
...
23	comprobasse	comprobo	VERB	va1xfr	Aspect=Perf|InflClass=LatA|InflClass[noun]=Ind|Tense=Past|VerbForm=Inf|Voice=Act	13	ccomp	_	SpaceAfter=No
...
6	motu	motus	NOUN	sms4b	Case=Abl|Gender=Masc|InflClass=IndEurU|Number=Sing|VerbForm=Part	21	obl	_	SpaceAfter=No
...
27	motibus	motus	NOUN	smp4b	Case=Abl|Gender=Masc|InflClass=IndEurU|Number=Plur|VerbForm=Part	25	conj	_	_
...
32	phylosophando	philosophor	VERB	vd1fgb	Aspect=Imp|Case=Abl|Gender=Neut|InflClass=LatA|InflClass[noun]=IndEurO|Number=Sing|Tense=Fut|VerbForm=Ger|Voice=Pass	36	advcl	_	_
...
40	sillogizatum	syllogizo	VERB	vp1*irs3	Aspect=Perf|Case=Nom|Degree=Pos|Gender=Neut|InflClass=LatA|InflClass[noun]=IndEurO|Number=Sing|Tense=Past|VerbForm=Part|Voice=Pass	36	advcl	_	_
...
64	motu	motus	NOUN	sms4b	Case=Abl|Gender=Masc|InflClass=IndEurU|Number=Sing|VerbForm=Part	61	conj	_	SpaceAfter=No
...
70	motibus	motus	NOUN	smp4b	Case=Abl|Gender=Masc|InflClass=IndEurU|Number=Plur|VerbForm=Part	68	conj	_	_
