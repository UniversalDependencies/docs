---
layout: base
title:  'Statistics of ADJ in UD_Old_Turkish-Clausal'
udver: '2'
---

## Treebank Statistics: UD_Old_Turkish-Clausal: POS Tags: `ADJ`
...
`ADJ` nodes are attached to their parents using 1 different relations: <tt><a href="otk_clausal-dep-amod.html">amod</a></tt> (1; 100% instances)

Parents of `ADJ` nodes belong to 1 different parts of speech: <tt><a href="otk_clausal-pos-NOUN.html">NOUN</a></tt> (1; 100% instances)
...
Children of `ADJ` nodes are attached using 1 different relations: <tt><a href="otk_clausal-dep-punct.html">punct</a></tt> (1; 100% instances)

Children of `ADJ` nodes belong to 1 different parts of speech: <tt><a href="otk_clausal-pos-PUNCT.html">PUNCT</a></tt> (1; 100% instances)
