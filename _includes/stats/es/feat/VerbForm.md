...
The feature is used with 7 part-of-speech tags: [es-pos/VERB]() (40991; 9% instances), [es-pos/AUX]() (6043; 1% instances), [es-pos/ADJ]() (2000; 0% instances), [es-pos/NOUN]() (448; 0% instances), [es-pos/PROPN]() (211; 0% instances), [es-pos/X]() (42; 0% instances), [es-pos/SYM]() (12; 0% instances).

### `VERB`

40991 [es-pos/VERB]() tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (33473; 82%), <tt><a href="Number.html">Number</a>=Sing</tt> (24732; 60%), <tt><a href="Person.html">Person</a>=3</tt> (24021; 59%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (23243; 57%).
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Past</tt></td><td><em>fue, Fui, ES</em></td><td></td><td></td><td></td></tr>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Person.html">Person</a>=1|<a href="Tense.html">Tense</a>=Past</tt></td><td><em>somos</em></td><td></td><td></td><td></td></tr>
...
6043 [es-pos/AUX]() tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="Person.html">Person</a>=3</tt> (4889; 81%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (4819; 80%), <tt><a href="Number.html">Number</a>=Sing</tt> (4048; 67%).
...
2000 [es-pos/ADJ]() tokens (8% of all `ADJ` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `ADJ` and `VerbForm` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (1349; 67%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (1121; 56%).
...
448 [es-pos/NOUN]() tokens (1% of all `NOUN` tokens) have a non-empty value of `VerbForm`.
...
211 [es-pos/PROPN]() tokens (1% of all `PROPN` tokens) have a non-empty value of `VerbForm`.
...
42 [es-pos/X]() tokens (2% of all `X` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `X` and `VerbForm` co-occurred: <tt><a href="Number.html">Number</a>=EMPTY</tt> (30; 71%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (30; 71%).
...
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (2654; 76%),
<tt>VERB --[<a href="../dep/ccomp.html">ccomp</a>]--> VERB</tt> (689; 58%),
<tt>VERB --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (501; 61%),
<tt>VERB --[<a href="../dep/mark.html">mark</a>]--> VERB</tt> (25; 52%),
...
68301 tokens (12%) have a non-empty value of `VerbForm`.
13010 types (33%) occur at least once with a non-empty value of `VerbForm`.
3752 lemmas (14%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 5 part-of-speech tags: [es-pos/VERB]() (46065; 8% instances), [es-pos/AUX]() (15723; 3% instances), [es-pos/ADJ]() (6510; 1% instances), [es-pos/ADV]() (2; 0% instances), [es-pos/NOUN]() (1; 0% instances).

### `VERB`

46065 [es-pos/VERB]() tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (41449; 90%), <tt><a href="Person.html">Person</a>=3</tt> (28204; 61%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (27293; 59%), <tt><a href="Number.html">Number</a>=Sing</tt> (26758; 58%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (30076; 65% of non-empty `VerbForm`): <em>tiene, dijo, está, tienen, aseguró, están, explicó, afirmó, señaló, hizo</em>
* `Ger` (1213; 3% of non-empty `VerbForm`): <em>haciendo, dando, trabajando, teniendo, hablando, jugando, perdiendo, esperando, luchando, tocando</em>
* `Inf` (10161; 22% of non-empty `VerbForm`): <em>hacer, dar, tener, ganar, estar, poner, ver, jugar, mantener, conseguir</em>
* `Part` (4615; 10% of non-empty `VerbForm`): <em>hecho, tenido, dado, visto, conseguido, ganado, pasado, perdido, logrado, puesto</em>
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Fut</tt></td><td><em>tendrá</em></td><td></td><td></td><td></td></tr>
...
15723 [es-pos/AUX]() tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="Person.html">Person</a>=3</tt> (12425; 79%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (11840; 75%), <tt><a href="Number.html">Number</a>=Sing</tt> (10648; 68%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (9158; 58%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (13084; 83% of non-empty `VerbForm`): <em>es, ha, han, fue, son, había, hay, puede, era, hace</em>
* `Ger` (193; 1% of non-empty `VerbForm`): <em>siendo, diciendo, intentando, teniendo, pensando, habiendo, tratando, dejando, gritando, afirmando</em>
* `Inf` (1819; 12% of non-empty `VerbForm`): <em>ser, haber, poder, estar, seguir, volver, hacer, decir, dejar, evitar</em>
* `Part` (627; 4% of non-empty `VerbForm`): <em>sido, podido, habido, ido, hecho, llegado, empezado, estado, dejado, vuelto</em>
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Past</tt></td><td><em>fue</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>es</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Person.html">Person</a>=1|<a href="Tense.html">Tense</a>=Imp</tt></td><td><em>éramos</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Person.html">Person</a>=1|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>somos</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Fut</tt></td><td><em>serán</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Imp</tt></td><td><em>eran</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Past</tt></td><td><em>fueron</em></td><td></td><td></td><td></td></tr>
...
6510 [es-pos/ADJ]() tokens (18% of all `ADJ` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `ADJ` and `VerbForm` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (4500; 69%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (4086; 63%).
...
* `EMPTY` (29934): <em>primer, gran, nuevo, primera, mayor, próximo, nueva, últimos, mejor, general</em>
...
The most frequent other feature values with which `ADV` and `VerbForm` co-occurred: <tt><a href="Negative.html">Negative</a>=EMPTY</tt> (2; 100%).
...
* `EMPTY` (17890): <em>no, más, también, ya, hoy, ayer, muy, sólo, después, ahora</em>
...
* `EMPTY` (100653): <em>años, presidente, millones, año, equipo, partido, país, parte, vez, pesetas</em>

## Relations with Agreement in `VerbForm`

The 10 most frequent relations where parent and child node agree in `VerbForm`:
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (3192; 75%),
<tt>VERB --[<a href="../dep/ccomp.html">ccomp</a>]--> VERB</tt> (2538; 69%),
<tt>VERB --[<a href="../dep/cop.html">cop</a>]--> AUX</tt> (304; 55%),
<tt>VERB --[<a href="../dep/ccomp.html">ccomp</a>]--> AUX</tt> (169; 86%),
<tt>VERB --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (112; 61%),
<tt>VERB --[<a href="../dep/advcl.html">advcl</a>]--> AUX</tt> (65; 61%),
<tt>AUX --[<a href="../dep/advcl.html">advcl</a>]--> VERB</tt> (57; 53%),
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> AUX</tt> (38; 67%),
<tt>VERB --[<a href="../dep/compound.html">compound</a>]--> VERB</tt> (19; 100%),
<tt>AUX --[<a href="../dep/csubj.html">csubj</a>]--> VERB</tt> (16; 73%).
