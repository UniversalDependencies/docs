...
`SCONJ` nodes are attached to their parents using 2 different relations: <tt><a href="tt_nmctt-dep-cc.html">cc</a></tt> (4; 50% instances), <tt><a href="tt_nmctt-dep-mark.html">mark</a></tt> (4; 50% instances)

Parents of `SCONJ` nodes belong to 2 different parts of speech: <tt><a href="tt_nmctt-pos-VERB.html">VERB</a></tt> (7; 88% instances), <tt><a href="tt_nmctt-pos-ADJ.html">ADJ</a></tt> (1; 13% instances)

7 (88%) `SCONJ` nodes are leaves.

1 (13%) `SCONJ` nodes have one child.
