...
The most frequent other feature values with which `ADP` and `AdpType` co-occurred: <tt><a href="ca-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (73302; 83%), <tt><a href="ca-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (73302; 83%).
...
The most frequent other feature values with which `ADJ` and `AdpType` co-occurred: <tt><a href="ca-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="ca-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="ca-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1; 100%).
