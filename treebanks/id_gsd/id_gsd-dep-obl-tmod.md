...
658 nodes (1%) are attached to their parents as `obl:tmod`.

395 instances of `obl:tmod` (60%) are left-to-right (parent precedes child).
Average distance between parent and child is 5.52887537993921.

The following 5 pairs of parts of speech are connected with `obl:tmod`: <tt><a href="id_gsd-pos-VERB.html">VERB</a></tt>-<tt><a href="id_gsd-pos-NOUN.html">NOUN</a></tt> (490; 74% instances), <tt><a href="id_gsd-pos-VERB.html">VERB</a></tt>-<tt><a href="id_gsd-pos-NUM.html">NUM</a></tt> (135; 21% instances), <tt><a href="id_gsd-pos-VERB.html">VERB</a></tt>-<tt><a href="id_gsd-pos-PROPN.html">PROPN</a></tt> (21; 3% instances), <tt><a href="id_gsd-pos-ADJ.html">ADJ</a></tt>-<tt><a href="id_gsd-pos-NOUN.html">NOUN</a></tt> (11; 2% instances), <tt><a href="id_gsd-pos-NUM.html">NUM</a></tt>-<tt><a href="id_gsd-pos-NOUN.html">NOUN</a></tt> (1; 0% instances).
...
4	disebut	sebut	VERB	VSP	Voice=Pass	0	root	_	Morf=^di+sebut<v>_VSP$
...
7	mulai	mulai	VERB	VSA	Voice=Act	0	root	_	Morf=^mulai<v>_VSA$
8	tersebar	sebar	VERB	VSP	Voice=Pass	7	xcomp	_	SpaceAfter=No|Morf=^ter+sebar<v>_VSP$
...
4	dibuat	buat	VERB	VSP	Voice=Pass	0	root	_	Morf=^di+buat<v>_VSP$
