...
148383 tokens (59%) have a non-empty value of `Number`.
...
* `Sing` (41513; 72% of non-empty `Number`): <em>óleo, água, figura, fluido, petróleo, gás, produção, área, argila, processo</em>
* `EMPTY` (13): <em>place, ,, cima, cm, d’água, e, hk, Å</em>
...
* `Sing` (10335; 64% of non-empty `Number`): <em>pode, devido, apresenta, utilizado, tem, deve, mostra, ocorre, possui, seja</em>
...
The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="pt_petrogold-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (2287; 65%), <tt><a href="pt_petrogold-feat-PronType.html">PronType</a></tt><tt>=Rel</tt> (1987; 57%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (1116; 32% of non-empty `Number`): <em>que, eles, estes, elas, os, quais, outros, as, estas, aqueles</em>
* `Sing` (2396; 68% of non-empty `Number`): <em>que, o, isso, a, isto, este, qual, um, uma, esta</em>
...
218 <tt><a href="pt_petrogold-pos-ADV.html">ADV</a></tt> tokens (3% of all `ADV` tokens) have a non-empty value of `Number`.

`ADV` tokens may have the following values of `Number`:

* `Plur` (44; 20% of non-empty `Number`): <em>onde</em>
* `Sing` (174; 80% of non-empty `Number`): <em>onde, Antes, SIM, melhor</em>
...
<tt>NOUN --[<tt><a href="pt_petrogold-dep-det.html">det</a></tt>]--> DET</tt> (32951; 100%),
<tt>NOUN --[<tt><a href="pt_petrogold-dep-amod.html">amod</a></tt>]--> ADJ</tt> (14486; 99%),
<tt>NOUN --[<tt><a href="pt_petrogold-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (13127; 64%),
...
<tt>VERB --[<tt><a href="pt_petrogold-dep-nsubj-pass.html">nsubj:pass</a></tt>]--> NOUN</tt> (2649; 90%).
