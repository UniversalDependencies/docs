---
layout: base
title:  'Statistics of Clusivity in UD_Mbya_Guarani-Dooley'
udver: '2'
---

## Treebank Statistics: UD_Mbya_Guarani-Dooley: Features: `Clusivity`
...
27 <tt><a href="gun_dooley-pos-PRON.html">PRON</a></tt> tokens (2% of all `PRON` tokens) have a non-empty value of `Clusivity`.

The most frequent other feature values with which `PRON` and `Clusivity` co-occurred: <tt><a href="gun_dooley-feat-Number.html">Number</a></tt><tt>=Plur</tt> (27; 100%), <tt><a href="gun_dooley-feat-Person.html">Person</a></tt><tt>=1</tt> (27; 100%), <tt><a href="gun_dooley-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (27; 100%).
...
* `Ex` (1; 100% of non-empty `Clusivity`): <em>_</em>
