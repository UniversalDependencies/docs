...
A symbol is a word-like entity that differs from ordinary words by form, function, or both. Symbols are distinct from [punctuation](PUNCT) that delimit linguistic units in printed text and do not have any semantic function. What makes them different from punctuation is that they can be substituted by normal words, as in currency symbols (e.g. _<b>€</b>_) and mathematical operators (e.g. _<b>+</b>_). Symbols also include emoticons and emoji, URL and e-mail addresses, hasthags and similar.
