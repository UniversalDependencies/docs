...
1	Ils	eux	PRON	_	Emph=No|Gender=Masc|Number=Plur|Person=3|PronType=Prs	5	nsubj:caus	_	_
2	lui	lui	PRON	_	Emph=No|Number=Sing|Person=3|PronType=Prs	5	iobj:agent	_	_
