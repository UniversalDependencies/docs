...
526 tokens (2%) have a non-empty value of `Case`.
33 types (1%) occur at least once with a non-empty value of `Case`.
5 lemmas (0%) occur at least once with a non-empty value of `Case`.
The feature is used with 1 part-of-speech tags: <tt><a href="es_pud-pos-PRON.html">PRON</a></tt> (526; 2% instances).
...
* `Acc` (105; 20% of non-empty `Case`): <em>lo, la, me, los, sí, las, mí, te</em>
* `Acc,Dat` (322; 61% of non-empty `Case`): <em>se, me, nos, os, te</em>
...
* `EMPTY` (520): <em>que, su, sus, cual, cuales, quien, tanto, cuál, qué, quienes</em>
