...
There are 310 `VERB` lemmas (13%), 694 `VERB` types (19%) and 1171 `VERB` tokens (12%).
...
The 10 most frequent ambiguous types:  என்றார் ([VERB]() 15, [AUX]() 1), செய்து ([VERB]() 12, [AUX]() 6), செய்யப் ([VERB]() 11, [AUX]() 3), உள்ளது ([AUX]() 78, [VERB]() 10), கூறினார் ([VERB]() 10, [AUX]() 1), கொண்டு ([VERB]() 10, [AUX]() 9), நடைபெறும் ([ADJ]() 7, [VERB]() 6), செய்த் ([VERB]() 5, [AUX]() 5), செய்ய ([VERB]() 5, [AUX]() 3), வந்த் ([VERB]() 5, [AUX]() 2)
...
`VERB` occurs with 11 features: [ta-feat/Negative]() (1171; 100% instances), [ta-feat/VerbForm]() (1171; 100% instances), [ta-feat/Voice]() (1155; 99% instances), [ta-feat/Number]() (438; 37% instances), [ta-feat/Person]() (438; 37% instances), [ta-feat/Gender]() (426; 36% instances), [ta-feat/Tense]() (405; 35% instances), [ta-feat/Mood]() (316; 27% instances), [ta-feat/Polite]() (143; 12% instances), [ta-feat/Case]() (137; 12% instances), [ta-feat/Animacy]() (12; 1% instances)

`VERB` occurs with 29 feature-value pairs: `Animacy=Anim`, `Case=Acc`, `Case=Dat`, `Case=Gen`, `Case=Ins`, `Case=Loc`, `Case=Nom`, `Gender=Com`, `Gender=Neut`, `Mood=Cnd`, `Mood=Imp`, `Mood=Ind`, `Negative=Neg`, `Negative=Pos`, `Number=Plur`, `Number=Sing`, `Person=1`, `Person=2`, `Person=3`, `Polite=Pol`, `Tense=Fut`, `Tense=Past`, `Tense=Pres`, `VerbForm=Fin`, `VerbForm=Ger`, `VerbForm=Inf`, `VerbForm=Part`, `Voice=Act`, `Voice=Pass`

`VERB` occurs with 48 feature combinations.
The most frequent feature combination is `Negative=Pos|VerbForm=Part|Voice=Act` (379 tokens).
