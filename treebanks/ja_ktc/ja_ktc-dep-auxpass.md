---
layout: base
title:  'Statistics of auxpass in UD_Japanese-KTC'
udver: '2'
---

## Treebank Statistics: UD_Japanese-KTC: Relations: `auxpass`
...
The following 1 pairs of parts of speech are connected with `auxpass`: <tt><a href="ja_ktc-pos-VERB.html">VERB</a></tt>-<tt><a href="ja_ktc-pos-AUX.html">AUX</a></tt> (1360; 100% instances).
