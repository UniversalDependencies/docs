...
The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="Definite.html">Definite</a>=Def</tt> (16; 100%), <tt><a href="PronType.html">PronType</a>=EMPTY</tt> (16; 100%).
