...
7	улезэ	улемс	AUX	V	Mood=Opt|Number[subj]=Sing|Person[subj]=3|VerbForm=Fin	8	cop	_	GTtags=Opt,ScSg3
8	сень	се	PRON	Pron	Case=Gen|PronType=Ind	0	root	_	GTtags=Indef,Gen|SpaceAfter=No
9	,	,	PUNCT	CLB	_	11	punct	_	_
10	кие	кие	PRON	Pron	Case=Nom|Definite=Ind|Number=Sing|PronType=Rel	11	nsubj	_	GTtags=Sg,Nom,Indef
11	кунды	кундамс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Pres|VerbForm=Fin	8	acl:relcl	_	GTtags=Ind,Prs,ScSg3
12	те	те	DET	Det	Case=Nom|Definite=Ind|Number=Sing|PronType=Dem	13	det	_	GTtags=Sg,Nom,Indef
...
11	уш	уш	ADV	Adv	_	12	advmod	_	CGdephead=#11-&gt;10|CGdeprel=@ADVL|GTtags=
