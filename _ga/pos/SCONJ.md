...
There is also a special case of using _agus_ "and" (normally [CCONJ]()) as a subordinate conjunction, where the subordinate clause is missing a surface verb `to be', yet will have a subject in use with a progressive aspectual phrase, an adjective, a past participle  or locative adverb.
