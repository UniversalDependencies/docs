---
layout: base
title:  'Statistics of mark in UD_Apurina-UFPA'
udver: '2'
---

## Treebank Statistics: UD_Apurina-UFPA: Relations: `mark`
...
3	sary	sa	VERB	V	Gender[subj]=Masc|Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past,Pres|VerbForm=Fin|VerbType=Vido	0	root	_	gloss[pt]=ir-3SG.M.O
...
9	awary	awa	VERB	V	Gender[obj]=Masc|Mood=Ind|Number[obj]=Sing|Person[obj]=3|Tense=Past,Pres|VerbForm=Fin	3	conj	_	gloss[pt]=existir-3SG.M.O
