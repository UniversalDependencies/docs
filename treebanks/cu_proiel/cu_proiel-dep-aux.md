...
1417 nodes (2%) are attached to their parents as `aux`.

1261 instances of `aux` (89%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.12067748764996.

The following 3 pairs of parts of speech are connected with `aux`: <tt><a href="cu_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="cu_proiel-pos-AUX.html">AUX</a></tt> (1218; 86% instances), <tt><a href="cu_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="cu_proiel-pos-VERB.html">VERB</a></tt> (198; 14% instances), <tt><a href="cu_proiel-pos-ADV.html">ADV</a></tt>-<tt><a href="cu_proiel-pos-VERB.html">VERB</a></tt> (1; 0% instances).
...
5	ѩ	и	PRON	Pp	Case=Acc|Gender=Masc|Number=Plur|Person=3|PronType=Prs	4	obj	_	ref=LUKE_24.51
