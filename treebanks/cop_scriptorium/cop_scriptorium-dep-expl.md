---
layout: base
title:  'Statistics of expl in UD_Coptic-Scriptorium'
udver: '2'
---

## Treebank Statistics: UD_Coptic-Scriptorium: Relations: `expl`

This relation is universal.

296 nodes (1%) are attached to their parents as `expl`.

282 instances of `expl` (95%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.52364864864865.

The following 1 pairs of parts of speech are connected with `expl`: <tt><a href="cop_scriptorium-pos-VERB.html">VERB</a></tt>-<tt><a href="cop_scriptorium-pos-PRON.html">PRON</a></tt> (296; 100% instances).
...
# visual-style 8 10 expl	color:blue
