...
3	ego	ego	PRON	p|p|1|s|-|-|-|m|n|-	Case=Nom|Number=Sing|Person=1|PronType=Prs	19	obl:arg	_	_
...
18	nos	nos	PRON	p|p|1|p|-|-|-|m|a|-	Case=Acc|Number=Plur|Person=1|PronType=Prs	19	obl	_	_
...
20	fuerit	sum	AUX	v|v|3|s|t|i|a|-|-|-	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin	19	aux:pass	_	TraditionalMood=Indicativus|TraditionalTense=Futurum
...
32	tres	tres	NUM	a|a|-|p|-|-|-|m|a|-	Case=Acc|Gender=Masc|Number=Plur|NumForm=Word|NumType=Card	31	nummod	_	_
33	et	et	CCONJ	c|c|-|-|-|-|-|-|-|-	_	34	cc	_	_
34	pauperes	pauper	NOUN	n|n|-|p|-|-|-|m|a|-	Case=Acc|Gender=Masc|Number=Plur	31	conj	_	_
35	sex	sex	NUM	m|m|-|-|-|-|-|-|-|-	NumForm=Word|NumType=Card	34	nummod	_	SpaceAfter=No
...
45	tres	tres	NUM	a|a|-|p|-|-|-|m|a|-	Case=Acc|Gender=Masc|Number=Plur|NumForm=Word|NumType=Card	46	nummod	_	_
...
49	duo	duo	NUM	a|a|-|p|-|-|-|n|a|-	Case=Acc|Gender=Neut|Number=Plur|NumForm=Word|NumType=Card	50	nummod	_	_
...
36	nos	nos	PRON	p|p|1|p|-|-|-|m|a|-	Case=Acc|Number=Plur|Person=1|PronType=Prs	40	obl:agent	_	_
...
39	fuerint	sum	AUX	v|v|3|p|t|i|a|-|-|-	Aspect=Perf|Mood=Ind|Number=Plur|Person=3|Tense=Fut|VerbForm=Fin	40	aux:pass	_	TraditionalMood=Indicativus|TraditionalTense=Futurum
...
47	foris	foris	ADV	d|d|-|-|-|-|-|-|-|-	AdvType=Loc	48	advmod:lmod	_	_
...
49	presumserimus	praesumo	VERB	v|v|1|p|t|i|a|-|-|-	Aspect=Perf|Mood=Ind|Number=Plur|Person=1|Tense=Fut|VerbForm=Fin|Voice=Act	40	conj	_	TraditionalMood=Indicativus|TraditionalTense=Futurum
...
57	nos	nos	PRON	p|p|1|p|-|-|-|m|n|-	Case=Nom|Number=Plur|Person=1|PronType=Prs	56	nsubj	_	_
...
69	viginti	uiginti	NUM	m|m|-|-|-|-|-|-|-|-	NumForm=Word|NumType=Card	68	nummod	_	SpaceAfter=No
