...
There are 9 `PART` lemmas (1%), 11 `PART` types (0%) and 16 `PART` tokens (0%).
...
The form / lemma ratio of `PART` is 1.222222 (the average of all parts of speech is 1.555478).
