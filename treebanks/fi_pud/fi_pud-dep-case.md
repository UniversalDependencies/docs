...
1	Kaikki	kaikki	PRON	_	Case=Nom|Number=Sing|PronType=Ind	2	det	_	_
2	lääkintämiehet	lääkintä#mies	NOUN	_	Case=Nom|Number=Plur	4	nsubj:cop	_	_
3	olivat	olla	AUX	_	Mood=Ind|Number=Plur|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	4	cop	_	_
4	aseistettuja	aseistaa	VERB	_	Case=Par|Degree=Pos|Number=Plur|PartForm=Past|VerbForm=Part|Voice=Pass	0	root	_	SpaceAfter=No
5	,	,	PUNCT	_	_	7	punct	_	_
6	paitsi	paitsi	ADP	_	AdpType=Prep	7	case	_	_
7	minä	minä	PRON	_	Case=Nom|Number=Sing|Person=1|PronType=Prs	4	conj	_	SpaceAfter=No
