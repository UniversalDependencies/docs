...
There are 2335 `ADJ` lemmas (10%), 3214 `ADJ` types (11%) and 13685 `ADJ` tokens (7%).
...
The form / lemma ratio of `ADJ` is 1.376445 (the average of all parts of speech is 1.220969).
...
`ADJ` occurs with 1 features: <tt><a href="nl_alpino-feat-Degree.html">Degree</a></tt> (13098; 96% instances)

`ADJ` occurs with 3 feature-value pairs: `Degree=Cmp`, `Degree=Pos`, `Degree=Sup`

`ADJ` occurs with 4 feature combinations.
The most frequent feature combination is `Degree=Pos` (11845 tokens).
Examples: <em>nieuwe, grote, andere, goed, Nederlandse, heel, groot, Amerikaanse, eigen, goede</em>


## Relations

`ADJ` nodes are attached to their parents using 24 different relations: <tt><a href="nl_alpino-dep-amod.html">amod</a></tt> (7804; 57% instances), <tt><a href="nl_alpino-dep-advmod.html">advmod</a></tt> (2386; 17% instances), <tt><a href="nl_alpino-dep-root.html">root</a></tt> (759; 6% instances), <tt><a href="nl_alpino-dep-xcomp.html">xcomp</a></tt> (681; 5% instances), <tt><a href="nl_alpino-dep-conj.html">conj</a></tt> (435; 3% instances), <tt><a href="nl_alpino-dep-nmod.html">nmod</a></tt> (285; 2% instances), <tt><a href="nl_alpino-dep-advcl.html">advcl</a></tt> (238; 2% instances), <tt><a href="nl_alpino-dep-obl.html">obl</a></tt> (223; 2% instances), <tt><a href="nl_alpino-dep-fixed.html">fixed</a></tt> (203; 1% instances), <tt><a href="nl_alpino-dep-compound-prt.html">compound:prt</a></tt> (173; 1% instances), <tt><a href="nl_alpino-dep-nsubj.html">nsubj</a></tt> (104; 1% instances), <tt><a href="nl_alpino-dep-parataxis.html">parataxis</a></tt> (89; 1% instances), <tt><a href="nl_alpino-dep-ccomp.html">ccomp</a></tt> (66; 0% instances), <tt><a href="nl_alpino-dep-acl-relcl.html">acl:relcl</a></tt> (59; 0% instances), <tt><a href="nl_alpino-dep-obj.html">obj</a></tt> (48; 0% instances), <tt><a href="nl_alpino-dep-appos.html">appos</a></tt> (29; 0% instances), <tt><a href="nl_alpino-dep-acl.html">acl</a></tt> (28; 0% instances), <tt><a href="nl_alpino-dep-nsubj-pass.html">nsubj:pass</a></tt> (23; 0% instances), <tt><a href="nl_alpino-dep-csubj.html">csubj</a></tt> (21; 0% instances), <tt><a href="nl_alpino-dep-flat.html">flat</a></tt> (11; 0% instances), <tt><a href="nl_alpino-dep-obl-agent.html">obl:agent</a></tt> (8; 0% instances), <tt><a href="nl_alpino-dep-case.html">case</a></tt> (5; 0% instances), <tt><a href="nl_alpino-dep-iobj.html">iobj</a></tt> (4; 0% instances), <tt><a href="nl_alpino-dep-orphan.html">orphan</a></tt> (3; 0% instances)

Parents of `ADJ` nodes belong to 14 different parts of speech: <tt><a href="nl_alpino-pos-NOUN.html">NOUN</a></tt> (7729; 56% instances), <tt><a href="nl_alpino-pos-VERB.html">VERB</a></tt> (3482; 25% instances), <tt><a href="nl_alpino-pos-ADJ.html">ADJ</a></tt> (786; 6% instances),  (759; 6% instances), <tt><a href="nl_alpino-pos-PROPN.html">PROPN</a></tt> (335; 2% instances), <tt><a href="nl_alpino-pos-ADV.html">ADV</a></tt> (177; 1% instances), <tt><a href="nl_alpino-pos-ADP.html">ADP</a></tt> (97; 1% instances), <tt><a href="nl_alpino-pos-DET.html">DET</a></tt> (96; 1% instances), <tt><a href="nl_alpino-pos-PRON.html">PRON</a></tt> (85; 1% instances), <tt><a href="nl_alpino-pos-NUM.html">NUM</a></tt> (82; 1% instances), <tt><a href="nl_alpino-pos-SYM.html">SYM</a></tt> (49; 0% instances), <tt><a href="nl_alpino-pos-INTJ.html">INTJ</a></tt> (3; 0% instances), <tt><a href="nl_alpino-pos-X.html">X</a></tt> (3; 0% instances), <tt><a href="nl_alpino-pos-CCONJ.html">CCONJ</a></tt> (2; 0% instances)

10150 (74%) `ADJ` nodes are leaves.

1677 (12%) `ADJ` nodes have one child.

542 (4%) `ADJ` nodes have two children.

1316 (10%) `ADJ` nodes have three or more children.

The highest child degree of a `ADJ` node is 10.

Children of `ADJ` nodes are attached using 31 different relations: <tt><a href="nl_alpino-dep-advmod.html">advmod</a></tt> (1686; 19% instances), <tt><a href="nl_alpino-dep-punct.html">punct</a></tt> (1366; 16% instances), <tt><a href="nl_alpino-dep-cop.html">cop</a></tt> (1040; 12% instances), <tt><a href="nl_alpino-dep-nsubj.html">nsubj</a></tt> (899; 10% instances), <tt><a href="nl_alpino-dep-obl.html">obl</a></tt> (753; 9% instances), <tt><a href="nl_alpino-dep-conj.html">conj</a></tt> (438; 5% instances), <tt><a href="nl_alpino-dep-cc.html">cc</a></tt> (363; 4% instances), <tt><a href="nl_alpino-dep-det.html">det</a></tt> (340; 4% instances), <tt><a href="nl_alpino-dep-advcl.html">advcl</a></tt> (285; 3% instances), <tt><a href="nl_alpino-dep-mark.html">mark</a></tt> (284; 3% instances), <tt><a href="nl_alpino-dep-case.html">case</a></tt> (265; 3% instances), <tt><a href="nl_alpino-dep-fixed.html">fixed</a></tt> (182; 2% instances), <tt><a href="nl_alpino-dep-parataxis.html">parataxis</a></tt> (164; 2% instances), <tt><a href="nl_alpino-dep-csubj.html">csubj</a></tt> (109; 1% instances), <tt><a href="nl_alpino-dep-expl.html">expl</a></tt> (88; 1% instances), <tt><a href="nl_alpino-dep-ccomp.html">ccomp</a></tt> (87; 1% instances), <tt><a href="nl_alpino-dep-nmod.html">nmod</a></tt> (85; 1% instances), <tt><a href="nl_alpino-dep-aux.html">aux</a></tt> (81; 1% instances), <tt><a href="nl_alpino-dep-amod.html">amod</a></tt> (65; 1% instances), <tt><a href="nl_alpino-dep-flat.html">flat</a></tt> (51; 1% instances), <tt><a href="nl_alpino-dep-obj.html">obj</a></tt> (38; 0% instances), <tt><a href="nl_alpino-dep-nummod.html">nummod</a></tt> (31; 0% instances), <tt><a href="nl_alpino-dep-acl-relcl.html">acl:relcl</a></tt> (19; 0% instances), <tt><a href="nl_alpino-dep-cc-preconj.html">cc:preconj</a></tt> (15; 0% instances), <tt><a href="nl_alpino-dep-expl-pv.html">expl:pv</a></tt> (15; 0% instances), <tt><a href="nl_alpino-dep-nmod-poss.html">nmod:poss</a></tt> (15; 0% instances), <tt><a href="nl_alpino-dep-iobj.html">iobj</a></tt> (10; 0% instances), <tt><a href="nl_alpino-dep-acl.html">acl</a></tt> (6; 0% instances), <tt><a href="nl_alpino-dep-appos.html">appos</a></tt> (6; 0% instances), <tt><a href="nl_alpino-dep-orphan.html">orphan</a></tt> (6; 0% instances), <tt><a href="nl_alpino-dep-xcomp.html">xcomp</a></tt> (3; 0% instances)

Children of `ADJ` nodes belong to 16 different parts of speech: <tt><a href="nl_alpino-pos-PUNCT.html">PUNCT</a></tt> (1366; 16% instances), <tt><a href="nl_alpino-pos-ADV.html">ADV</a></tt> (1362; 15% instances), <tt><a href="nl_alpino-pos-NOUN.html">NOUN</a></tt> (1253; 14% instances), <tt><a href="nl_alpino-pos-AUX.html">AUX</a></tt> (1121; 13% instances), <tt><a href="nl_alpino-pos-ADJ.html">ADJ</a></tt> (786; 9% instances), <tt><a href="nl_alpino-pos-PRON.html">PRON</a></tt> (633; 7% instances), <tt><a href="nl_alpino-pos-VERB.html">VERB</a></tt> (582; 7% instances), <tt><a href="nl_alpino-pos-CCONJ.html">CCONJ</a></tt> (401; 5% instances), <tt><a href="nl_alpino-pos-DET.html">DET</a></tt> (360; 4% instances), <tt><a href="nl_alpino-pos-ADP.html">ADP</a></tt> (328; 4% instances), <tt><a href="nl_alpino-pos-PROPN.html">PROPN</a></tt> (245; 3% instances), <tt><a href="nl_alpino-pos-SCONJ.html">SCONJ</a></tt> (237; 3% instances), <tt><a href="nl_alpino-pos-NUM.html">NUM</a></tt> (88; 1% instances), <tt><a href="nl_alpino-pos-SYM.html">SYM</a></tt> (21; 0% instances), <tt><a href="nl_alpino-pos-INTJ.html">INTJ</a></tt> (6; 0% instances), <tt><a href="nl_alpino-pos-X.html">X</a></tt> (6; 0% instances)
