---
layout: base
title:  'Statistics of compound:prt in UD_Afrikaans-AfriBooms'
udver: '2'
---

## Treebank Statistics: UD_Afrikaans-AfriBooms: Relations: `compound:prt`

This relation is a language-specific subtype of .

324 nodes (1%) are attached to their parents as `compound:prt`.

204 instances of `compound:prt` (63%) are right-to-left (child precedes parent).
Average distance between parent and child is 3.46296296296296.

The following 1 pairs of parts of speech are connected with `compound:prt`: <tt><a href="af_afribooms-pos-VERB.html">VERB</a></tt>-<tt><a href="af_afribooms-pos-ADV.html">ADV</a></tt> (324; 100% instances).
...
# visual-style 4 2 compound:prt	color:blue
