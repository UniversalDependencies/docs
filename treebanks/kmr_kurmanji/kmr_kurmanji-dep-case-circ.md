---
layout: base
title:  'Statistics of case:circ in UD_Kurmanji-MG'
udver: '2'
---

## Treebank Statistics: UD_Kurmanji-MG: Relations: `case:circ`

This relation is a language-specific subtype of <tt><a href="kmr_mg-dep-case.html">case</a></tt>.

2 nodes (0%) are attached to their parents as `case:circ`.

2 instances of `case:circ` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 2 pairs of parts of speech are connected with `case:circ`: <tt><a href="kmr_mg-pos-NOUN.html">NOUN</a></tt>-<tt><a href="kmr_mg-pos-ADP.html">ADP</a></tt> (1; 50% instances), <tt><a href="kmr_mg-pos-PRON.html">PRON</a></tt>-<tt><a href="kmr_mg-pos-ADP.html">ADP</a></tt> (1; 50% instances).
...
# visual-style 2 3 case:circ	color:blue
