---
layout: base
title:  'Statistics of advcl in UD_Haitian_Creole-Autogramm'
udver: '2'
---

## Treebank Statistics: UD_Haitian_Creole-Autogramm: Relations: `advcl`

This relation is universal.
There are 1 language-specific subtypes of `advcl`: <tt><a href="ht_autogramm-dep-advcl-cleft.html">advcl:cleft</a></tt>.
...
7	lontan	lontan	ADV	_	_	5	advmod	_	Gloss=longtemps
...
# visual-style 12 13 advcl	color:blue
...
11	gentan	gentan	VERB	_	_	6	advcl	_	Gloss=avoir_le_temps
12	pale	pale	VERB	_	_	11	ccomp	_	Gloss=parler
13	avè	avè	ADP	_	_	14	case	_	Gloss=avec
14	l	li	PRON	_	Number=Sing|Person=3|PronType=Prs	12	obl	_	Gloss=3SG
15	pou	pou	ADP	_	_	17	mark	_	Gloss=pour
16	m	mwen	PRON	_	Number=Sing|Person=1|PronType=Prs	17	nsubj	_	Gloss=1SG
17	konnen	konnen	VERB	_	_	12	dep	_	Gloss=connaître
18	l	li	PRON	_	Number=Sing|Person=3|PronType=Prs	17	obj	_	Gloss=3SG
19	plis	plis	ADV	_	_	17	advmod	_	Gloss=plus|SpaceAfter=No
