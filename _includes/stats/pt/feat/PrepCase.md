...
The feature is used with 1 part-of-speech tags: [pt-pos/PRON]() (190; 0% instances).
...
* `Pre` (190; 100% of non-empty `PrepCase`): <em>ele, ela, eles, mim, elas, si, nós, ti, você, vós</em>
