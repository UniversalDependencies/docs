...
7	نزرع	زَرَع	VERB	VISA-1MP--	Aspect=Imp|Gender=Masc|Mood=Sub|Number=Plur|Person=1|VerbForm=Fin|Voice=Act	4	advcl	4:advcl:مِن_أَن	Vform=نَزرَعَ|Gloss=plant,implant,cultivate|Root=z r `|Translit=nazraʿa|LTranslit=zaraʿ
