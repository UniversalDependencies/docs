...
15 nodes (0%) are attached to their parents as `ccomp:pred`.

15 instances of `ccomp:pred` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 7.53333333333333.

The following 5 pairs of parts of speech are connected with `ccomp:pred`: [hu-pos/PRON]()-[hu-pos/VERB]() (6; 40% instances), [hu-pos/NOUN]()-[hu-pos/VERB]() (4; 27% instances), [hu-pos/PRON]()-[hu-pos/ADJ]() (2; 13% instances), [hu-pos/PRON]()-[hu-pos/PRON]() (2; 13% instances), [hu-pos/VERB]()-[hu-pos/VERB]() (1; 7% instances).
