---
layout: base
title:  'Statistics of INTJ in UD_Georgian-GNC'
udver: '2'
---
...
* <em>სიცოცხლე</em>
  ...
  * <tt><a href="ka_gnc-pos-INTJ.html">INTJ</a></tt> 1: <em>რა უსამართლობა ა , რომ <b>სიცოცხლე</b> უნდა შეწყდეს !</em>
...
The 2nd highest number of forms (1) was observed with the lemma “აა”: <em>აა</em>.

The 3rd highest number of forms (1) was observed with the lemma “აბა”: <em>აბა</em>.

`INTJ` occurs with 1 features: <tt><a href="ka_gnc-feat-ExtPos.html">ExtPos</a></tt> (1; 3% instances)

`INTJ` occurs with 1 feature-value pairs: `ExtPos=INTJ`

`INTJ` occurs with 2 feature combinations.
The most frequent feature combination is `_` (28 tokens).
Examples: <em>აბა, რა, ოჰ, ა, აა, ახ, აჰა, გამარჯობა, გეთაყვა, დეე</em>


## Relations

`INTJ` nodes are attached to their parents using 3 different relations: <tt><a href="ka_gnc-dep-discourse.html">discourse</a></tt> (27; 93% instances), <tt><a href="ka_gnc-dep-fixed.html">fixed</a></tt> (1; 3% instances), <tt><a href="ka_gnc-dep-nsubj.html">nsubj</a></tt> (1; 3% instances)

Parents of `INTJ` nodes belong to 6 different parts of speech: <tt><a href="ka_gnc-pos-VERB.html">VERB</a></tt> (19; 66% instances), <tt><a href="ka_gnc-pos-NOUN.html">NOUN</a></tt> (4; 14% instances), <tt><a href="ka_gnc-pos-ADJ.html">ADJ</a></tt> (2; 7% instances), <tt><a href="ka_gnc-pos-PROPN.html">PROPN</a></tt> (2; 7% instances), <tt><a href="ka_gnc-pos-INTJ.html">INTJ</a></tt> (1; 3% instances), <tt><a href="ka_gnc-pos-PRON.html">PRON</a></tt> (1; 3% instances)

25 (86%) `INTJ` nodes are leaves.

4 (14%) `INTJ` nodes have one child.

The highest child degree of a `INTJ` node is 1.

Children of `INTJ` nodes are attached using 2 different relations: <tt><a href="ka_gnc-dep-punct.html">punct</a></tt> (3; 75% instances), <tt><a href="ka_gnc-dep-fixed.html">fixed</a></tt> (1; 25% instances)

Children of `INTJ` nodes belong to 2 different parts of speech: <tt><a href="ka_gnc-pos-PUNCT.html">PUNCT</a></tt> (3; 75% instances), <tt><a href="ka_gnc-pos-INTJ.html">INTJ</a></tt> (1; 25% instances)
