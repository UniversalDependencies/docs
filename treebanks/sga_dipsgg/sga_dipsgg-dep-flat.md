---
layout: base
title:  'Statistics of flat in UD_Old_Irish-DipSGG'
udver: '2'
---

## Treebank Statistics: UD_Old_Irish-DipSGG: Relations: `flat`

This relation is universal.
There are 1 language-specific subtypes of `flat`: <tt><a href="sga_dipsgg-dep-flat-foreign.html">flat:foreign</a></tt>.
...
The following 1 pairs of parts of speech are connected with `flat`: <tt><a href="sga_dipsgg-pos-X.html">X</a></tt>-<tt><a href="sga_dipsgg-pos-X.html">X</a></tt> (2; 100% instances).
