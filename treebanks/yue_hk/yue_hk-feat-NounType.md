...
479 tokens (3%) have a non-empty value of `NounType`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="yue_hk-pos-NOUN.html">NOUN</a></tt> (479; 3% instances).

### `NOUN`

479 <tt><a href="yue_hk-pos-NOUN.html">NOUN</a></tt> tokens (23% of all `NOUN` tokens) have a non-empty value of `NounType`.

`NOUN` tokens may have the following values of `NounType`:

* `Clf` (479; 100% of non-empty `NounType`): 個、 啲、 蚊、 條、 位、 年、 次、 點、 份、 封
...
<tt>NOUN --[<tt><a href="yue_hk-dep-clf.html">clf</a></tt>]--> NOUN</tt> (1; 100%),
