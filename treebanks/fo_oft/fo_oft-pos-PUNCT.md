...
Children of `PUNCT` nodes are attached using 1 different relations: <tt><a href="fo_oft-dep-case.html">case</a></tt> (2; 100% instances)

Children of `PUNCT` nodes belong to 1 different parts of speech: <tt><a href="fo_oft-pos-ADP.html">ADP</a></tt> (2; 100% instances)
