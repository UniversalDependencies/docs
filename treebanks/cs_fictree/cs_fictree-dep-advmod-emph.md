...
2229 nodes (1%) are attached to their parents as `advmod:emph`.

2195 instances of `advmod:emph` (98%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.67160161507402.
...
7	a	a	CCONJ	J^-------------	_	8	cc	6.1:cc	_
8	večerní	večerní	ADJ	AAIS1----1A----	Animacy=Inan|Case=Nom|Degree=Pos|Gender=Masc|Number=Sing|Polarity=Pos	6	conj	6.1:dep	_
9	taky	taky	ADV	Db-------------	_	8	orphan	6.1:advmod	_
10	ne	ne	PART	TT-------------	_	8	orphan	6.1:dep	SpaceAfter=No
