...
The 10 most frequent `DET` types:  <em>ܐܵܗܵܐ, ܚܲܕ݇, ܚܲܕ, ܐܲܢܹܐ, ܕ, ܗ̇ܘ, ܚܕܵܐ, ܚܕ݇, ܟܠ</em>
...
The form / lemma ratio of `DET` is 1.000000 (the average of all parts of speech is 1.044000).

The 1st highest number of forms (2) was observed with the lemma “ܚܲܕ”: <em>ܚܲܕ, ܚܲܕ݇</em>.

The 2nd highest number of forms (1) was observed with the lemma “ܐܲܢܹܐ”: <em>ܐܲܢܹܐ</em>.

The 3rd highest number of forms (1) was observed with the lemma “ܐܵܗܵܐ”: <em>ܐܵܗܵܐ</em>.

`DET` occurs with 4 features: <tt><a href="aii_as-feat-Number.html">Number</a></tt> (13; 81% instances), <tt><a href="aii_as-feat-PronType.html">PronType</a></tt> (10; 63% instances), <tt><a href="aii_as-feat-Definite.html">Definite</a></tt> (9; 56% instances), <tt><a href="aii_as-feat-Gender.html">Gender</a></tt> (8; 50% instances)
...
The most frequent feature combination is `Definite=Ind|Gender=Masc|Number=Sing|PronType=Art` (6 tokens).
Examples: <em>ܚܲܕ݇, ܚܲܕ, ܚܕ݇</em>


## Relations

`DET` nodes are attached to their parents using 1 different relations: <tt><a href="aii_as-dep-det.html">det</a></tt> (16; 100% instances)

Parents of `DET` nodes belong to 2 different parts of speech: <tt><a href="aii_as-pos-NOUN.html">NOUN</a></tt> (14; 88% instances), <tt><a href="aii_as-pos-ADJ.html">ADJ</a></tt> (2; 13% instances)

16 (100%) `DET` nodes are leaves.
