...
13 <tt><a href="ceb_gja-pos-ADV.html">ADV</a></tt> tokens (18% of all `ADV` tokens) have a non-empty value of `PronType`.
...
* `EMPTY` (61): <em>na, karon, wala, kaayo, Pila, didto, labi, lang, ugma, Ari</em>
