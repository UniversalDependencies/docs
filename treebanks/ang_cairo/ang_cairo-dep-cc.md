---
layout: base
title:  'Statistics of cc in UD_Old_English-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Old_English-Cairo: Relations: `cc`

This relation is universal.
There are 1 language-specific subtypes of `cc`: <tt><a href="ang_cairo-dep-cc-preconj.html">cc:preconj</a></tt>.

9 nodes (5%) are attached to their parents as `cc`.

8 instances of `cc` (89%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.22222222222222.

The following 4 pairs of parts of speech are connected with `cc`: <tt><a href="ang_cairo-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ang_cairo-pos-CCONJ.html">CCONJ</a></tt> (4; 44% instances), <tt><a href="ang_cairo-pos-VERB.html">VERB</a></tt>-<tt><a href="ang_cairo-pos-CCONJ.html">CCONJ</a></tt> (3; 33% instances), <tt><a href="ang_cairo-pos-ADJ.html">ADJ</a></tt>-<tt><a href="ang_cairo-pos-CCONJ.html">CCONJ</a></tt> (1; 11% instances), <tt><a href="ang_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ang_cairo-pos-CCONJ.html">CCONJ</a></tt> (1; 11% instances).
