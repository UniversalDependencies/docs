...
There are 216 `ADV` lemmas (12%), 219 `ADV` types (8%) and 1342 `ADV` tokens (13%).
...
The form / lemma ratio of `ADV` is 1.013889 (the average of all parts of speech is 1.474576).
