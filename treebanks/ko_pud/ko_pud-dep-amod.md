...
1	세계	_	NOUN	NN	_	2	compound	_	Translit=.se.gye
2	최고	_	NOUN	NN	_	3	obl	_	SpaceAfter=No|Translit=.choe.go
3	라는	_	VERB	VV	Form=Adn	6	acl:relcl	_	Translit=.ra.neun
...
5	신성한	_	NOUN	NN	_	6	amod	_	SpaceAfter=No|Translit=.sin.seong.han
6	권리는	권리	NOUN	NN+CM	Case=Nom|Polite=Form	11	nsubj	_	MSeg=권리-는|Translit=.gweon.ri.neun|LTranslit=.gweon.ri
7	더	_	ADV	RB	_	8	advmod	_	Translit=.deo
8	이상	_	NOUN	NN	_	10	obl	_	Translit=.i.sang
9	보장받지	_	NOUN	NN	_	10	obl	_	OrigDeprel=aux|SpaceAfter=No|Translit=.bo.jang.bad.ji
10	못하게	_	VERB	VX	Form=Compl	11	advcl	_	Translit=.mos.ha.ge
11	되었나	_	VERB	VV	PronType=Int|Tense=Past|VerbForm=Fin	0	root	_	SpaceAfter=No|Translit=.doe.eoss.na
...
2	통해	_	VERB	VV	Form=Compl	17	advcl	_	Translit=.tong.hae
3	화공	_	NOUN	NN	_	4	compound	_	Translit=.hwa.gong
4	산업	_	NOUN	NN	_	11	nsubj	_	Translit=.san.eob
5	및	_	CCONJ	CC	_	6	cc	_	ToDo=cc-after-conj|Translit=.mich
...
7	그	_	DET	DT	_	8	det	_	Translit=.geu
8	책에	책	NOUN	NN+CM	Polite=Form	10	obl	_	MSeg=책-에|Translit=.chaeg.e|LTranslit=.chaeg
9	관심을	관심	NOUN	NN+CM	Case=Acc|Polite=Form	10	obj	_	MSeg=관심-을|Translit=.gwan.sim.eul|LTranslit=.gwan.sim
10	갖게	_	VERB	VV	Form=Compl	11	advcl	_	Translit=.gaj.ge
11	됨은	됨	PART	VV+CM	Case=Nom|Polite=Form|VerbForm=Ger	12	csubj	_	MSeg=됨-은|Translit=.doem.eun|LTranslit=.doem
12	물론	_	NOUN	NN	_	17	obl	_	Translit=.mul.ron
13	많은	_	ADJ	JJ	Form=Adn	14	amod	_	Translit=.manh.eun
...
16	또한	_	ADV	RB	_	17	advmod	_	Translit=.ddo.han
17	불러일으켰다	_	VERB	VV	Mood=Ind|Tense=Past|VerbForm=Fin	0	root	_	SpaceAfter=No|Translit=.bul.reo.il.eu.kyeoss.da
