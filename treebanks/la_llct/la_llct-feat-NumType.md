...
* `EMPTY` (10163): <em>sancti, quondam, integrum, sancte, bone, manifestu, livellario, Lucane, bonos, humilis</em>
...
The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="la_llct-feat-NumForm.html">NumForm</a></tt><tt>=Word</tt> (1499; 100%), <tt><a href="la_llct-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (872; 58%), <tt><a href="la_llct-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (872; 58%), <tt><a href="la_llct-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (872; 58%).

`NUM` tokens may have the following values of `NumType`:

* `Card` (1501; 100% of non-empty `NumType`): <em>duas, duo, viginti, triginta, tres, quinquaginta, decem, sex, quattuor, quinque</em>
...
* `EMPTY` (18990): <em>ipsa, qui, mea, suprascripta, nostro, ipsius, tuis, omnia, hanc, meis</em>
...
* `EMPTY` (7811): <em>supra, una, exinde, ubi, taliter, sic, unde, superius, ibi, hic</em>
...
<tt>NUM --[<tt><a href="la_llct-dep-flat.html">flat</a></tt>]--> NUM</tt> (59; 100%),
