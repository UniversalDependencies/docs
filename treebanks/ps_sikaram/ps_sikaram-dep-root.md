---
layout: base
title:  'Statistics of root in UD_Pashto-Sikaram'
udver: '2'
---

## Treebank Statistics: UD_Pashto-Sikaram: Relations: `root`

This relation is universal.

40 nodes (4%) are attached to their parents as `root`.

40 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 8.975.

The following 5 pairs of parts of speech are connected with `root`: -<tt><a href="ps_sikaram-pos-VERB.html">VERB</a></tt> (30; 75% instances), -<tt><a href="ps_sikaram-pos-NOUN.html">NOUN</a></tt> (7; 18% instances), -<tt><a href="ps_sikaram-pos-ADJ.html">ADJ</a></tt> (1; 3% instances), -<tt><a href="ps_sikaram-pos-PRON.html">PRON</a></tt> (1; 3% instances), -<tt><a href="ps_sikaram-pos-PROPN.html">PROPN</a></tt> (1; 3% instances).
