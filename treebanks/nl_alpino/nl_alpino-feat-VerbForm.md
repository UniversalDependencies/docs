...
31735 tokens (15%) have a non-empty value of `VerbForm`.
5183 types (19%) occur at least once with a non-empty value of `VerbForm`.
2683 lemmas (12%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 2 part-of-speech tags: <tt><a href="nl_alpino-pos-VERB.html">VERB</a></tt> (21911; 11% instances), <tt><a href="nl_alpino-pos-AUX.html">AUX</a></tt> (9824; 5% instances).

### `VERB`

21911 <tt><a href="nl_alpino-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="nl_alpino-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (11250; 51%), <tt><a href="nl_alpino-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (11250; 51%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (10661; 49% of non-empty `VerbForm`): <em>heeft, komt, heet, wil, is, gaat, zei, kwam, noemt, hebben</em>
* `Inf` (4730; 22% of non-empty `VerbForm`): <em>komen, gaan, maken, zien, doen, nemen, laten, zeggen, worden, geven</em>
* `Part` (6520; 30% of non-empty `VerbForm`): <em>gemaakt, gehouden, genoemd, genomen, gedaan, gezien, afgelopen, gegeven, gekomen, geworden</em>
...
9824 <tt><a href="nl_alpino-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="nl_alpino-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6832; 70%), <tt><a href="nl_alpino-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (6254; 64%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (8676; 88% of non-empty `VerbForm`): <em>is, was, heeft, zijn, werd, wordt, zal, zou, kan, hebben</em>
* `Inf` (1079; 11% of non-empty `VerbForm`): <em>worden, zijn, kunnen, moeten, hebben, zullen, mogen, krijgen, wezen</em>
...
<tt>VERB --[<tt><a href="nl_alpino-dep-conj.html">conj</a></tt>]--> VERB</tt> (857; 73%),
<tt>VERB --[<tt><a href="nl_alpino-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (269; 57%),
