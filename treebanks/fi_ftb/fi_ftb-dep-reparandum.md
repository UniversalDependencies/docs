---
layout: base
title:  'Statistics of reparandum in UD_Finnish-FTB'
udver: '2'
---

## Treebank Statistics: UD_Finnish-FTB: Relations: `reparandum`
...
1	ja	ja	CCONJ	Pcle,CC	_	4	cc	_	_
...
8	olet	olla	AUX	V,Act,Ind,Pres,Sg2	Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin|Voice=Act	9	cop	_	Missed-Rel=advl
...
1	Niin	niin	ADV	Adv,Pcle	_	5	advmod	_	_
...
8	aikaan	aika	NOUN	N,Sg,Ill	Case=Ill|Number=Sing	6	obl	_	_
9	kun	kun	SCONJ	Pcle,CS	_	14	mark	_	_
10	kun	kun	SCONJ	Pcle,CS	_	9	conj	_	_
11	taas	taas	ADV	Adv,Pcle	_	14	advmod	_	_
12	esimes	esimerkiksi	ADV	Adv	Style=Coll	13	advmod	_	_
13	Usassa	usa	PROPN	N,Prop,Sg,Ine	Case=Ine|Number=Sing	14	obl	_	_
...
27	käsitteenä	käsite	NOUN	N,Sg,Ess	Case=Ess|Number=Sing	21	obl	_	_
...
1	Ihan	ihan	ADV	Adv,Pcle	_	3	advmod	_	_
2	niillä	ne	DET	Pron,Dem,Pl,Ade	Case=Ade|Number=Plur|PronType=Dem	3	det	_	_
3	semmosilla	semmoinen	ADJ	A,Dem,Pl,Ade	Case=Ade|Number=Plur|PronType=Dem|Style=Coll	41	obl	_	_
...
10	nyt	nyt	ADV	Adv,Pcle	_	15	advmod	_	_
...
24	iha	ihan	ADV	Adv,Pcle	Style=Coll	25	advmod	_	_
...
31	iham	ihan	ADV	Adv,Pcle	Style=Coll	32	advmod	_	_
...
66	puoleej	puoli	NUM	Num,Card,Sg,Ill	Case=Ill|Number=Sing|NumType=Card|Style=Coll	63	obl	_	_
