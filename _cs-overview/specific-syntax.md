...
~~~ sdparse
ROOT Ale v každém případě podstatně vyšší , než při hodnocení " od boku " .
root:coord(ROOT-1, Ale-2)
case:auxp:member(Ale-2, v-3)
amod(případě-5, každém-4)
dep(v-3, případě-5)
advmod(vyšší-7, podstatně-6)
dep:member(Ale-2, vyšší-7)
punct(než-9, ,-8)
mark:auxc(vyšší-7, než-9)
case:auxp(než-9, při-10)
dep(při-10, hodnocení-11)
punct(od-13, "-12)
case:auxp(hodnocení-11, od-13)
nmod(od-13, boku-14)
punct(od-13, "-15)
root:auxk(ROOT-1, .-16)
~~~
...
advmod(vyšší-7, podstatně-6)
conj(v-3, vyšší-7)
punct(hodnocení-11, ,-8)
mark(hodnocení-11, než-9)
case(hodnocení-11, při-10)
dep(vyšší-7, hodnocení-11)
punct(boku-14, "-12)
case(boku-14, od-13)
nmod(hodnocení-11, boku-14)
punct(boku-14, "-15)
root:auxk(ROOT-1, .-16)
~~~
...
case(případě-5, v-3)
amod(případě-5, každém-4)
root(ROOT-1, případě-5)
advmod(vyšší-7, podstatně-6)
conj(případě-5, vyšší-7)
punct(hodnocení-11, ,-8)
mark(hodnocení-11, než-9)
case(hodnocení-11, při-10)
dep(vyšší-7, hodnocení-11)
