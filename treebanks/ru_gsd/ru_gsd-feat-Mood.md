...
5278 <tt><a href="ru_gsd-pos-VERB.html">VERB</a></tt> tokens (62% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="ru_gsd-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (5278; 100%), <tt><a href="ru_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (5278; 100%), <tt><a href="ru_gsd-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (5278; 100%), <tt><a href="ru_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (5278; 100%), <tt><a href="ru_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3996; 76%), <tt><a href="ru_gsd-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (3678; 70%), <tt><a href="ru_gsd-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (3289; 62%), <tt><a href="ru_gsd-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (3158; 60%), <tt><a href="ru_gsd-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (3158; 60%), <tt><a href="ru_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2827; 54%).

`VERB` tokens may have the following values of `Mood`:

* `Imp` (21; 0% of non-empty `Mood`): <em>см., Будь, Откроем, ПРосыпайся, Пощадите, Создай, Ср., балуйтесь, введи, выходите</em>
* `Ind` (5257; 100% of non-empty `Mood`): <em>является, стал, составляет, может, находится, входит, получил, родился, имеет, начал</em>
* `EMPTY` (3216): <em>можно, назначен, расположен, основана, начиная, основан, быть, награждён, расположена, заниматься</em>
...
`Mood` seems to be **lexical feature** of `VERB`. 99% lemmas (1351) occur only with one value of `Mood`.

### `AUX`

753 <tt><a href="ru_gsd-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="ru_gsd-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (753; 100%), <tt><a href="ru_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (753; 100%), <tt><a href="ru_gsd-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (713; 95%), <tt><a href="ru_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (607; 81%).
...
<tt>VERB --[<tt><a href="ru_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (609; 82%),
<tt>VERB --[<tt><a href="ru_gsd-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (213; 75%),
<tt>VERB --[<tt><a href="ru_gsd-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (114; 70%),
