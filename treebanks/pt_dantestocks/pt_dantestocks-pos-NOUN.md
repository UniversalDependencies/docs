...
There are 1720 `NOUN` lemmas (19%), 2276 `NOUN` types (20%) and 12001 `NOUN` tokens (15%).
...
The form / lemma ratio of `NOUN` is 1.323256 (the average of all parts of speech is 1.238049).
