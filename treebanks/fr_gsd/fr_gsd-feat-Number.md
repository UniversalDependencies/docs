...
208009 tokens (52%) have a non-empty value of `Number`.
24366 types (57%) occur at least once with a non-empty value of `Number`.
14424 lemmas (44%) occur at least once with a non-empty value of `Number`.
The feature is used with 8 part-of-speech tags: <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> (74773; 19% instances), <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> (61592; 15% instances), <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (25093; 6% instances), <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> (22827; 6% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (12045; 3% instances), <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (11666; 3% instances), <tt><a href="fr_gsd-pos-NUM.html">NUM</a></tt> (10; 0% instances), <tt><a href="fr_gsd-pos-PROPN.html">PROPN</a></tt> (3; 0% instances).

### `NOUN`

74773 <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> tokens (99% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (41631; 56%).

`NOUN` tokens may have the following values of `Number`:

* `Plur` (18619; 25% of non-empty `Number`): <em>ans, années, pays, enfants, habitants, personnes, jours, droits, points, hommes</em>
* `Sing` (56154; 75% of non-empty `Number`): <em>ville, partie, nom, monde, région, commune, groupe, temps, famille, année</em>
* `EMPTY` (423): <em>A, Co., Company, League, Mt, Panther, Trail, blackface, facto, night</em>
...
61592 <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (53370; 87%), <tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (43268; 70%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (32503; 53%).

`DET` tokens may have the following values of `Number`:

* `Plur` (14536; 24% of non-empty `Number`): <em>les, des, ses, ces, de, plusieurs, leurs, tous, quelques, d'</em>
* `Sing` (47056; 76% of non-empty `Number`): <em>le, la, l', un, une, son, sa, cette, ce, leur</em>
* `EMPTY` (136): <em>the, d', de, no, your, All, Il, las, His, Leur</em>

<table>
  <tr><th>Paradigm <i>le</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>le, l', l</em></td><td><em>les</em></td></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt></tt></td><td><em>la, l', l, Les, là</em></td><td><em>les, L'</em></td></tr>
  <tr><td><tt></tt></td><td><em>l'</em></td><td><em>les</em></td></tr>
</table>

### `VERB`

25093 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (78% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13858; 55%), <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13858; 55%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13250; 53%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (13119; 52%).

`VERB` tokens may have the following values of `Number`:

* `Plur` (5141; 20% of non-empty `Number`): <em>ont, peuvent, font, doivent, sont, prennent, trouvent, vont, permettent, utilisés</em>
* `Sing` (19952; 80% of non-empty `Number`): <em>a, fait, peut, né, située, est, situé, trouve, devient, doit</em>
* `EMPTY` (7237): <em>faire, partir, voir, prendre, avoir, mettre, passer, trouver, aller, dire</em>
...
22827 <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> tokens (99% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (12068; 53%).

`ADJ` tokens may have the following values of `Number`:

* `Plur` (6268; 27% of non-empty `Number`): <em>autres, nombreux, nombreuses, grands, premières, premiers, différents, grandes, français, nouveaux</em>
* `Sing` (16559; 73% of non-empty `Number`): <em>première, premier, même, français, française, grande, grand, nouveau, autre, politique</em>
* `EMPTY` (177): <em>live, new, Blue, complete, American, Great, Last, 3e, Black, Dead</em>
...
12045 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11153; 93%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10808; 90%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (10707; 89%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9469; 79%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (2310; 19% of non-empty `Number`): <em>sont, ont, étaient, avons, furent, avaient, seront, sommes, soient, auraient</em>
* `Sing` (9735; 81% of non-empty `Number`): <em>est, a, été, était, fut, avait, ai, sera, fait, soit</em>
* `EMPTY` (838): <em>être, avoir, étant, faire, ayant, faisant, be, 'll, 's, Do</em>
...
11666 <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> tokens (65% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (8491; 73%), <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (8078; 69%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (6231; 53%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (2050; 18% of non-empty `Number`): <em>ils, nous, vous, autres, les, elles, ceux, eux, leur, tous</em>
* `Sing` (9616; 82% of non-empty `Number`): <em>il, elle, on, c', lui, ce, je, le, l', j'</em>
* `EMPTY` (6360): <em>qui, se, s', dont, où, en, qu', y, que, quoi</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=2</tt></tt></td><td><em>tu</em></td><td></td></tr>
</table>

### `NUM`

10 <tt><a href="fr_gsd-pos-NUM.html">NUM</a></tt> tokens (0% of all `NUM` tokens) have a non-empty value of `Number`.

`NUM` tokens may have the following values of `Number`:

* `Plur` (10; 100% of non-empty `Number`): <em>00H30, 12H30, 14h25, 15H00, 18h, 18h40, 20h40, 22h, 23h, 48H</em>
* `EMPTY` (10657): <em>deux, trois, 2, 3, 5, quatre, 4, 2010, 2009, 2008</em>

`Number` seems to be **lexical feature** of `NUM`. 100% lemmas (10) occur only with one value of `Number`.

### `PROPN`

3 <tt><a href="fr_gsd-pos-PROPN.html">PROPN</a></tt> tokens (0% of all `PROPN` tokens) have a non-empty value of `Number`.

`PROPN` tokens may have the following values of `Number`:

* `Sing` (3; 100% of non-empty `Number`): <em>Italie, Palais, mémorique</em>
* `EMPTY` (30360): <em>France, Paris, Europe, États-Unis, Jean, Maroc, Espagne, la, New, York</em>

## Relations with Agreement in `Number`

The 10 most frequent relations where parent and child node agree in `Number`:
<tt>NOUN --[<tt><a href="fr_gsd-dep-det.html">det</a></tt>]--> DET</tt> (54340; 100%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-amod.html">amod</a></tt>]--> ADJ</tt> (18504; 98%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (13065; 64%),
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (5932; 74%),
<tt>VERB --[<tt><a href="fr_gsd-dep-obl.html">obl</a></tt>]--> NOUN</tt> (5663; 59%),
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (5505; 92%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> NOUN</tt> (4351; 81%),
<tt>VERB --[<tt><a href="fr_gsd-dep-aux.html">aux</a></tt>]--> AUX</tt> (3655; 80%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-acl.html">acl</a></tt>]--> VERB</tt> (3005; 71%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-cop.html">cop</a></tt>]--> AUX</tt> (2713; 91%).
