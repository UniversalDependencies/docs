...
67 instances of `iobj` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.14925373134328.

The following 2 pairs of parts of speech are connected with `iobj`: <tt><a href="cop_scriptorium-pos-VERB.html">VERB</a></tt>-<tt><a href="cop_scriptorium-pos-PRON.html">PRON</a></tt> (62; 93% instances), <tt><a href="cop_scriptorium-pos-VERB.html">VERB</a></tt>-<tt><a href="cop_scriptorium-pos-NOUN.html">NOUN</a></tt> (5; 7% instances).
...
8	ⲥⲱⲧⲙ	ⲥⲱⲧⲙ	VERB	V	VerbForm=Inf	3	xcomp	_	Entity=person)
...
7	ⲕⲁ	ⲕⲱ	VERB	V	VerbForm=Fin	1	xcomp	_	_
