...
8	منطقة	مِنطَقَة	NOUN	NN	Case=Gen|Definite=Def|Gender=Fem|Number=Sing	7	nmod	_	LId=مِنْطَقَة_1
9	فونتفيل	فونتفيل	PROPN	NNP	Gender=Fem|Number=Sing	8	nmod	_	LId=فونتفيل_0|SpaceAfter=No
10	.	.	PUNCT	.	_	1	punct	_	LId=._0
...
7	ديفيس	دِيفِيس	PROPN	NNP	Gender=Masc|Number=Sing	6	nmod	_	LId=دِيفِيس_1
8	قد	قَد	PART	RP	_	9	compound:prt	_	LId=قَدْ_1
9	لعب	لَعِب	VERB	VBC	Aspect=Perf|Gender=Masc|Number=Sing|Person=3|Tense=Past|Voice=Act	1	advcl	_	LId=لَعِب-َ_1
10	دوراً	دَور	NOUN	NN	Case=Acc|Definite=Ind|Gender=Masc|Number=Sing	9	obj	_	LId=دَوْر_1|SpaceAfter=No
