---
layout: base
title:  'Statistics of reparandum in UD_Armenian-BSUT'
udver: '2'
---
...
The following 1 pairs of parts of speech are connected with `reparandum`: <tt><a href="hy_bsut-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hy_bsut-pos-ADJ.html">ADJ</a></tt> (1; 100% instances).
...
10	որոնք	որ	PRON	_	Case=Nom|Number=Plur|PronType=Rel	12	nsubj	_	Translit=oronk’|LTranslit=or
...
24	ոչ	ոչ	PART	_	ExtPos=CCONJ|Polarity=Neg	26	cc	_	Translit=oč|LTranslit=oč
25	միայն	միայն	ADV	_	_	24	fixed	_	Translit=miayn|LTranslit=miayn
26	մեկնարկի	մեկնարկ	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Coll	28	obl	_	Translit=meknarki|LTranslit=meknark
...
36	որոնք	որ	PRON	_	Case=Nom|Number=Plur|PronType=Rel	42	nsubj	_	Translit=oronk’|LTranslit=or
37	առաջիկա	առաջիկա	ADJ	_	_	40	amod	_	Translit=aṙaǰika|LTranslit=aṙaǰika
38	մի	մի	DET	_	ExtPos=DET|PronType=Art	40	det	_	Translit=mi|LTranslit=mi
39	քանի	քանի	DET	_	PronType=Int	38	fixed	_	Translit=k’ani|LTranslit=k’ani
