---
layout: base
title:  'Statistics of dislocated in UD_Skolt_Sami-Giellagas'
udver: '2'
---

## Treebank Statistics: UD_Skolt_Sami-Giellagas: Relations: `dislocated`
...
2	šõõddi	šõddâd	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt,Sg3
...
3	mõõni	mõõnnâd	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	_
4	kuâŋŋa	kuâŋŋa	ADV	Adv	_	3	advmod	_	SpaceAfter=No
5	,	,	PUNCT	CLB	_	6	punct	_	_
6	ceälkk	ceäʹlǩǩed	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	3	conj	_	SpaceAfter=No
7	:	:	PUNCT	_	_	11	punct	_	_
8	”	”	PUNCT	_	_	11	punct	_	SpaceAfter=No
9	Mâiʹd	mâiʹd	PRON	Pron	PronType=Int	11	obj	_	_
10	ooumaž	ooumaž	NOUN	N	Animacy=Hum|Case=Nom|Number=Sing	11	nsubj	_	_
11	tuejjad	tuejjeed	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	6	parataxis	_	SpaceAfter=No
...
2	teâđsti	teâđsted	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt,Sg3
3	di	di	CCONJ	CC	_	5	cc	_	GTtags=@CVP
4	tõid	tõt	PRON	Pron	Case=Acc|Number=Plur|PronType=Dem	5	obj	_	GTtags=Dem,Pl,Acc
5	teâđstââll	teâđstõõllâd	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	2	conj	_	GTtags=Ind,Prs,Sg3
6	što	što	SCONJ	CS	_	10	mark	_	GTtags=@CVP
7	mâiʹd	mâiʹd	PRON	Pron	PronType=Int	10	obj	_	_
8	tõt	tõt	PRON	Pron	Case=Nom|Number=Sing|PronType=Dem	9	det	_	GTtags=Dem,Sg,Nom
9	nijdd	nijdd	NOUN	N	Animacy=Hum|Case=Nom|Number=Sing	10	nsubj	_	GTtags=Sem/Kin,Sg,Nom
10	rõssad	rõsseed	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	5	dislocated	_	GTtags=Ind,Prs,Sg3|SpaceAfter=No
