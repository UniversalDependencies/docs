...
## Treebank Statistics: UD_Armenian-BSUT: Relations: `case`
...
1	Կոմիքսների	կոմիքս	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Plur	2	nmod:poss	_	Translit=Komik’sneri|LTranslit=komik’s
2	գիրք	գիրք	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	0	root	_	Translit=girk’|LTranslit=girk’
3	սուպերհերոսների	սուպերհերոս	NOUN	_	Animacy=Hum|Case=Dat|Definite=Ind|Number=Plur	2	nmod:npmod	_	Translit=sowperherosneri|LTranslit=sowperheros
4	վերաբերյալ	վերաբերյալ	ADP	_	AdpType=Post	3	case	_	Translit=veraberyal|LTranslit=veraberyal
