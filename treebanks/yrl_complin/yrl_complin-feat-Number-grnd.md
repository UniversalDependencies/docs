...
35 tokens (0%) have a non-empty value of `Number[grnd]`.
7 types (0%) occur at least once with a non-empty value of `Number[grnd]`.
...
35 <tt><a href="yrl_complin-pos-ADP.html">ADP</a></tt> tokens (3% of all `ADP` tokens) have a non-empty value of `Number[grnd]`.

The most frequent other feature values with which `ADP` and `Number[grnd]` co-occurred: <tt><a href="yrl_complin-feat-Rel.html">Rel</a></tt><tt>=NCont</tt> (35; 100%), <tt><a href="yrl_complin-feat-AdpType.html">AdpType</a></tt><tt>=Post</tt> (32; 91%).
