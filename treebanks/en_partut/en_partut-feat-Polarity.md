---
layout: base
title:  'Statistics of Polarity in UD_English-ParTUT'
udver: '2'
---

## Treebank Statistics: UD_English-ParTUT: Features: `Polarity`
...
235 <tt><a href="en_partut-pos-PART.html">PART</a></tt> tokens (18% of all `PART` tokens) have a non-empty value of `Polarity`.
...
1 <tt><a href="en_partut-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Polarity`.

`ADV` tokens may have the following values of `Polarity`:

* `Neg` (1; 100% of non-empty `Polarity`): <em>no</em>
* `EMPTY` (1945): <em>more, also, there, so, now, only, how, however, well, very</em>
