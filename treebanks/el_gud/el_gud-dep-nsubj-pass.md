...
2	κατάνυξη	κατάνυξη	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	3	nsubj:pass	_	_
3	περιορίζεται	περιορίζω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Pass	0	root	_	_
4	εντός	εντός	ADP	_	_	6	case	_	_
5	της	ο	DET	_	Case=Gen|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	6	det	_	_
6	εκκλησίας	εκκλησία	NOUN	_	Case=Gen|Gender=Fem|Number=Sing	3	obl	_	SpaceAfter=No
7	.	.	PUNCT	_	_	3	punct	_	PunctType=Peri
