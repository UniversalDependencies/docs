...
* <em>но</em>
  * <tt><a href="ru_taiga-pos-CCONJ.html">CCONJ</a></tt> 856: <em>они меня пугают , <b>но</b> в жизни надо побывать хоть раз</em>
  * <tt><a href="ru_taiga-pos-X.html">X</a></tt> 1: <em>Нормаль <b>но</b> ли сейчас ( с погодой в Москве ) надеть высокие осенние сапоги с платьем ?</em>
* <em>а</em>
...
* <em>да</em>
  ...
  * <tt><a href="ru_taiga-pos-PART.html">PART</a></tt> 52: <em>@screened-172 <b>да</b> !</em>
  * <tt><a href="ru_taiga-pos-INTJ.html">INTJ</a></tt> 1: <em>Вот это <b>да</b> ааа ! 🤗😋</em>
* <em>ни</em>
...
`CCONJ` occurs with 2 features: <tt><a href="ru_taiga-feat-Polarity.html">Polarity</a></tt> (89; 1% instances), <tt><a href="ru_taiga-feat-Typo.html">Typo</a></tt> (9; 0% instances)
