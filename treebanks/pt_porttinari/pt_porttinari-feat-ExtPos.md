---
layout: base
title:  'Statistics of ExtPos in UD_Portuguese-Porttinari'
udver: '2'
---
...
504 <tt><a href="pt_porttinari-pos-ADP.html">ADP</a></tt> tokens (2% of all `ADP` tokens) have a non-empty value of `ExtPos`.

`ADP` tokens may have the following values of `ExtPos`:

* `ADP` (36; 7% of non-empty `ExtPos`): <em>em, por, de, para</em>
* `ADV` (67; 13% of non-empty `ExtPos`): <em>a, por, de, em</em>
* `CCONJ` (46; 9% of non-empty `ExtPos`): <em>em, de</em>
* `SCONJ` (355; 70% of non-empty `ExtPos`): <em>de, a, para, com, desde, até, sem, em, por</em>

<table>
  <tr><th>Paradigm <i>de</i></th><th><tt>ADP</tt></th><th><tt>ADV</tt></th><th><tt>CCONJ</tt></th><th><tt>SCONJ</tt></th></tr>
  <tr><td><tt></tt></td><td><em>de</em></td><td><em>de</em></td><td><em>de</em></td><td><em>de</em></td></tr>
</table>

### `ADV`

274 <tt><a href="pt_porttinari-pos-ADV.html">ADV</a></tt> tokens (4% of all `ADV` tokens) have a non-empty value of `ExtPos`.

`ADV` tokens may have the following values of `ExtPos`:

* `ADP` (4; 1% of non-empty `ExtPos`): <em>quanto, Frente</em>
* `ADV` (166; 61% of non-empty `ExtPos`): <em>mais, cerca, ainda, menos, Enquanto, onde</em>
* `CCONJ` (17; 6% of non-empty `ExtPos`): <em>tanto, bem, só, assim</em>
* `SCONJ` (87; 32% of non-empty `ExtPos`): <em>assim, ainda, depois, já, mesmo, antes, sempre, logo, tanto</em>

<table>
  <tr><th>Paradigm <i>ainda</i></th><th><tt>ADV</tt></th><th><tt>SCONJ</tt></th></tr>
  <tr><td><tt></tt></td><td><em>ainda</em></td><td><em>ainda</em></td></tr>
</table>
...
24 <tt><a href="pt_porttinari-pos-SCONJ.html">SCONJ</a></tt> tokens (1% of all `SCONJ` tokens) have a non-empty value of `ExtPos`.
...
* `CCONJ` (13; 100% of non-empty `ExtPos`): <em>ou</em>
