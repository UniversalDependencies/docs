...
2972 nodes (2%) are attached to their parents as `expl`.

2778 instances of `expl` (93%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.05652759084791.

The following 1 pairs of parts of speech are connected with `expl`: <tt><a href="orv_torot-pos-VERB.html">VERB</a></tt>-<tt><a href="orv_torot-pos-PRON.html">PRON</a></tt> (2972; 100% instances).
