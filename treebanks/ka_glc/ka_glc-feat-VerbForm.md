...
It occurs with 3 different values: `Fin`, `Part`, `Vnoun`.
...
* `Fin` (3634; 90% of non-empty `VerbForm`): <em>შეისწავლის, აქვს, შეიძლება, წარმოადგენს, გამოიყენება, მოიცავს, არსებობს, სწავლობს, ჩამოყალიბდა, იყენებენ</em>
* `Part` (322; 8% of non-empty `VerbForm`): <em>დაკავშირებული, შესაძლებელი, დანალექი, აღსანიშნავი, გავრცელებული, დაფარული, მიმართული, განპირობებული, დაკავებული, ასახული</em>
...
<tt>VERB --[<tt><a href="ka_glc-dep-conj.html">conj</a></tt>]--> VERB</tt> (371; 94%),
<tt>VERB --[<tt><a href="ka_glc-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (137; 91%),
<tt>VERB --[<tt><a href="ka_glc-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (136; 88%),
<tt>VERB --[<tt><a href="ka_glc-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (118; 91%),
<tt>VERB --[<tt><a href="ka_glc-dep-acl.html">acl</a></tt>]--> VERB</tt> (27; 68%),
