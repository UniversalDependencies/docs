...
~~~ sdparse
ROOT Asi tak , jako když potřebujete rychle taxík a vezmete jej , i když je drahý .
advmod:emph(tak-3, Asi-2)
root:exd(ROOT-1, tak-3)
punct(když-6, ,-4)
mark(když-6, jako-5)
root:auxc(ROOT-1, když-6)
dep:member(a-10, potřebujete-7)
advmod(potřebujete-7, rychle-8)
dobj(potřebujete-7, taxík-9)
cc:coord(když-6, a-10)
dep:member(a-10, vezmete-11)
dobj(vezmete-11, jej-12)
punct(když-15, ,-13)
cc(když-15, i-14)
mark:auxc(vezmete-11, když-15)
advcl(když-15, je-16)
dep:pnom(je-16, drahý-17)
root:auxk(ROOT-1, .-18)
~~~
...
advmod:emph(tak-3, Asi-2)
root:exd(ROOT-1, tak-3)
punct(potřebujete-7, ,-4)
mark(potřebujete-7, jako-5)
mark(potřebujete-7, když-6)
root(ROOT-1, potřebujete-7)
advmod(potřebujete-7, rychle-8)
dobj(potřebujete-7, taxík-9)
cc(potřebujete-7, a-10)
conj(potřebujete-7, vezmete-11)
dobj(vezmete-11, jej-12)
punct(je-16, ,-13)
cc(je-16, i-14)
mark(je-16, když-15)
advcl(vezmete-11, je-16)
dep:pnom(je-16, drahý-17)
root:auxk(ROOT-1, .-18)
~~~
