...
There are 1 `SCONJ` lemmas (6%), 63 `SCONJ` types (1%) and 340 `SCONJ` tokens (2%).
...
The 10 most frequent `SCONJ` types:  <em>dass, wenn, wia, das, wej, ois, wos, wo, waun, bis</em>
...
* <em>wos</em>
  ...
  * <tt><a href="bar_maibaam-pos-SCONJ.html">SCONJ</a></tt> 22: <em>Es gibd owa a Fladnbrod , des <b>wos</b> ohne Treibmiddl gmochd wiad .</em>
...
The form / lemma ratio of `SCONJ` is 63.000000 (the average of all parts of speech is 280.823529).

The 1st highest number of forms (63) was observed with the lemma “_”: <em>Bål, Fois, Oijs, Seid, Waal, Waunn, Wen, Wui, als, bevor, bis, damit, das, das'ma, das's, das'sd, das'st, dass, dass', dassd, daß, derwei, dos, doss, dàß, indem, ob, obb, ohne, ois, owa, sodass, sodaß, um, wai, wal, wann, wanns, wannst, waum, waun, weand, wei, weil, wej, weja, wem, wenn, weu, weul, wia, wiar, wiast, wie, wo, wonn, wos, wou, wous, wàl, wänn, wäu, wòs</em>.
...
Examples: <em>dass, wenn, wia, wej, das, ois, wos, wo, waun, bis</em>
