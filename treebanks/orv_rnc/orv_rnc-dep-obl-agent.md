...
10 nodes (0%) are attached to their parents as `obl:agent`.

5 instances of `obl:agent` (50%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.8.

The following 3 pairs of parts of speech are connected with `obl:agent`: <tt><a href="orv_rnc-pos-VERB.html">VERB</a></tt>-<tt><a href="orv_rnc-pos-NOUN.html">NOUN</a></tt> (8; 80% instances), <tt><a href="orv_rnc-pos-VERB.html">VERB</a></tt>-<tt><a href="orv_rnc-pos-PRON.html">PRON</a></tt> (1; 10% instances), <tt><a href="orv_rnc-pos-VERB.html">VERB</a></tt>-<tt><a href="orv_rnc-pos-PROPN.html">PROPN</a></tt> (1; 10% instances).
...
1	По	по	ADP	_	_	2	case	_	Norm=По|SpaceAfter=Yes
2	лѣте	лѣто	NOUN	_	Case=Loc|Gender=Neut|Number=Sing	16	obl	_	Norm=лѣте|SpaceAfter=Yes
3	же	же	PART	_	_	2	advmod	_	Norm=же|SpaceAfter=Yes
4	единомъ	единый	NUM	_	Case=Loc|Gender=Masc|Number=Sing	2	nummod	_	Norm=единомъ|SpaceAfter=Yes
5	и	и	CCONJ	_	_	16	cc	_	Norm=и|SpaceAfter=Yes
6	церковь	церковь	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	16	nsubj:pass	_	Norm=церковь|SpaceAfter=Yes
7	Святыя	святой	ADJ	_	Case=Gen|Degree=Pos|Gender=Fem|Number=Sing	8	amod	_	Norm=Святыя|SpaceAfter=Yes
8	Богородица	Богородица	NOUN	_	Case=Gen|Gender=Fem|Number=Sing	6	nmod	_	Norm=Богородица|SpaceAfter=No
9	,	,	PUNCT	_	_	12	punct	_	Norm=,|SpaceAfter=Yes
10	иже	иже	PRON	_	Case=Nom|Gender=Masc|Number=Sing|PronType=Rel	12	nsubj	_	Norm=иже|SpaceAfter=Yes
11	въ	въ	ADP	_	_	12	case	_	Norm=въ|SpaceAfter=Yes
12	Кіевѣ	Киевъ	PROPN	_	Case=Loc|Gender=Masc|Number=Sing	6	acl:relcl	_	Norm=Кіевѣ|SpaceAfter=Yes
13	{л._304}	_	X	_	_	14	dep	_	Norm={л._304}|SpaceAfter=Yes
14	Феопентомъ	Феопентъ	PROPN	_	Case=Ins|Gender=Masc|Number=Sing	16	obl:agent	_	Norm=Феопентомъ|SpaceAfter=Yes
15	митрополитомъ	митрополитъ	NOUN	_	Case=Ins|Gender=Masc|Number=Sing	14	appos	_	Norm=митрополитомъ|SpaceAfter=Yes
16	освящена	освятити	VERB	_	Aspect=Perf|Case=Nom|Gender=Fem|Number=Sing|Tense=Past|Variant=Short|VerbForm=Part|Voice=Pass	0	root	_	Norm=освящена|SpaceAfter=Yes
...
18	,	,	PUNCT	_	_	27	punct	_	Norm=,|SpaceAfter=Yes
19	юже	иже	PRON	_	Case=Acc|Gender=Fem|Number=Sing|PronType=Rel	27	obj	_	Norm=юже|SpaceAfter=Yes
20	святый	святой	ADJ	_	Case=Nom|Degree=Pos|Gender=Masc|Number=Sing	21	amod	_	Norm=святый|SpaceAfter=Yes
21	Владимеръ	Владимиръ	PROPN	_	Case=Nom|Gender=Masc|Number=Sing	27	nsubj	_	Norm=Владимеръ|SpaceAfter=No
22	,	,	PUNCT	_	_	23	punct	_	Norm=,|SpaceAfter=Yes
23	отецъ	отецъ	NOUN	_	Case=Nom|Gender=Masc|Number=Sing	21	appos	_	Norm=отецъ|SpaceAfter=Yes
...
25	,	,	PUNCT	_	_	23	punct	_	Norm=,|SpaceAfter=Yes
26	велику	великий	ADJ	_	Case=Acc|Degree=Pos|Gender=Fem|Number=Sing|Variant=Short	19	amod	_	Norm=велику|SpaceAfter=Yes
...
28	.	.	PUNCT	_	_	16	punct	_	Norm=.|SpaceAfter=Yes
