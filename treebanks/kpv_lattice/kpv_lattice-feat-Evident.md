...
18 tokens (1%) have a non-empty value of `Evident`.
16 types (1%) occur at least once with a non-empty value of `Evident`.
16 lemmas (2%) occur at least once with a non-empty value of `Evident`.
The feature is used with 2 part-of-speech tags: <tt><a href="kpv_lattice-pos-VERB.html">VERB</a></tt> (17; 1% instances), <tt><a href="kpv_lattice-pos-AUX.html">AUX</a></tt> (1; 0% instances).
