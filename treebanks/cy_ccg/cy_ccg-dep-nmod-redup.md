...
105 nodes (0%) are attached to their parents as `nmod:redup`.

92 instances of `nmod:redup` (88%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.19047619047619.

The following 2 pairs of parts of speech are connected with `nmod:redup`: <tt><a href="cy_ccg-pos-NOUN.html">NOUN</a></tt>-<tt><a href="cy_ccg-pos-PRON.html">PRON</a></tt> (96; 91% instances), <tt><a href="cy_ccg-pos-ADJ.html">ADJ</a></tt>-<tt><a href="cy_ccg-pos-PRON.html">PRON</a></tt> (9; 9% instances).
