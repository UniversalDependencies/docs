...
We treat localizers (方位詞 _fāngwèicí_) as postpositions which typically denote spatial locations analogous to prepositions in some languages, although a few localizers have further grammaticalized functions denoting temporal and other non-spatial concepts. (See [ADP]() for a list of localizers.)
