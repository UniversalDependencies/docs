...
192 <tt><a href="fa_seraji-pos-ADV.html">ADV</a></tt> tokens (5% of all `ADV` tokens) have a non-empty value of `Polarity`.

The most frequent other feature values with which `ADV` and `Polarity` co-occurred: <tt><a href="fa_seraji-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (192; 100%).
...
<tt>AUX --[<tt><a href="fa_seraji-dep-conj.html">conj</a></tt>]--> AUX</tt> (2; 100%).
