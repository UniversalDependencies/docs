...
246290 tokens (46%) have a non-empty value of `Number`.
20427 types (63%) occur at least once with a non-empty value of `Number`.
11517 lemmas (49%) occur at least once with a non-empty value of `Number`.
The feature is used with 8 part-of-speech tags: <tt><a href="ca_ancora-pos-NOUN.html">NOUN</a></tt> (88899; 17% instances), <tt><a href="ca_ancora-pos-DET.html">DET</a></tt> (72502; 14% instances), <tt><a href="ca_ancora-pos-ADJ.html">ADJ</a></tt> (29667; 6% instances), <tt><a href="ca_ancora-pos-VERB.html">VERB</a></tt> (25199; 5% instances), <tt><a href="ca_ancora-pos-AUX.html">AUX</a></tt> (20546; 4% instances), <tt><a href="ca_ancora-pos-PRON.html">PRON</a></tt> (6822; 1% instances), <tt><a href="ca_ancora-pos-NUM.html">NUM</a></tt> (2654; 0% instances), <tt><a href="ca_ancora-pos-PROPN.html">PROPN</a></tt> (1; 0% instances).

### `NOUN`

88899 <tt><a href="ca_ancora-pos-NOUN.html">NOUN</a></tt> tokens (90% of all `NOUN` tokens) have a non-empty value of `Number`.
...
* `Sing` (61706; 69% of non-empty `Number`): <em>any, president, part, terme, grup, projecte, cap, lloc, cas, portaveu</em>
* `EMPTY` (9805): <em>pessetes, any, través, temps, euros, juny, partir, dia, fa, tal</em>
...
* `EMPTY` (102): <em>meva, prou, gaire, massa, meves, cada, força, teus, teva, Armats</em>
...
* `EMPTY` (411): <em>baix, gran, clau, especial, directe, nord, pilot, límit, xàrter, sud</em>
...
25199 <tt><a href="ca_ancora-pos-VERB.html">VERB</a></tt> tokens (61% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (18432; 73%), <tt><a href="ca_ancora-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (18432; 73%), <tt><a href="ca_ancora-feat-Person.html">Person</a></tt><tt>=3</tt> (17588; 70%), <tt><a href="ca_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (16128; 64%), <tt><a href="ca_ancora-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (13027; 52%).

`VERB` tokens may have the following values of `Number`:

* `Plur` (5320; 21% of non-empty `Number`): <em>tenen, fan, tenim, faran, volen, van, formen, consideren, destaquen, volem</em>
* `Sing` (19879; 79% of non-empty `Number`): <em>té, ha, fa, fet, explicat, dit, considera, cal, farà, vol</em>
* `EMPTY` (16383): <em>fer, tenir, dir, donar, arribar, aconseguir, passar, veure, presentar, deixar</em>
...
20546 <tt><a href="ca_ancora-pos-AUX.html">AUX</a></tt> tokens (92% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="ca_ancora-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (19850; 97%), <tt><a href="ca_ancora-feat-Person.html">Person</a></tt><tt>=3</tt> (19303; 94%), <tt><a href="ca_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (18765; 91%), <tt><a href="ca_ancora-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (17578; 86%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (4907; 24% of non-empty `Number`): <em>van, han, són, estan, hem, poden, havien, seran, podran, eren</em>
* `Sing` (15639; 76% of non-empty `Number`): <em>va, ha, és, estat, està, havia, pot, serà, era, sigui</em>
* `EMPTY` (1808): <em>ser, haver, poder, estar, sent, saber, anar, veure, dir, fer</em>
...
6822 <tt><a href="ca_ancora-pos-PRON.html">PRON</a></tt> tokens (29% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="ca_ancora-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (6822; 100%), <tt><a href="ca_ancora-feat-PrepCase.html">PrepCase</a></tt><tt>=EMPTY</tt> (6597; 97%), <tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (3918; 57%), <tt><a href="ca_ancora-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (3660; 54%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (1873; 27% of non-empty `Number`): <em>els, ens, quals, altres, uns, ells, les, los, alguns, nosaltres</em>
* `Sing` (4949; 73% of non-empty `Number`): <em>un, li, tot, això, ho, qual, la, el, l', ell</em>
* `EMPTY` (16634): <em>que, es, s', hi, se, on, què, qui, n', com</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>la, el, lo, 'l, -lo</em></td><td></td></tr>
  <tr><td><tt><tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=Fem</tt></tt></td><td><em>-la</em></td><td><em>les</em></td></tr>
  <tr><td><tt><tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td><em>ho</em></td><td></td></tr>
  <tr><td><tt><tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=Dat</tt></tt></td><td><em>li</em></td><td></td></tr>
  <tr><td><tt><tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>ell</em></td><td><em>ells</em></td></tr>
  <tr><td><tt><tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=Fem</tt></tt></td><td></td><td><em>elles</em></td></tr>
  <tr><td><tt><tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>ella</em></td><td></td></tr>
...
* `EMPTY` (6574): <em>cent, 10, 15, 30, 20, 5, 4, 12, 2, 2000</em>
...
<tt>NOUN --[<tt><a href="ca_ancora-dep-det.html">det</a></tt>]--> DET</tt> (56443; 96%),
...
<tt>NOUN --[<tt><a href="ca_ancora-dep-cop.html">cop</a></tt>]--> AUX</tt> (1480; 70%),
