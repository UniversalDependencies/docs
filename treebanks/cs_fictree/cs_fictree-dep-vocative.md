...
7	Honzovi	Honza	PROPN	NNMS3-----A----	Animacy=Anim|Case=Dat|Gender=Masc|Number=Sing|Polarity=Pos	8	obl	8:obl	_
...
1	Miloši	Miloš	PROPN	NNMS5-----A----	Animacy=Anim|Case=Voc|Gender=Masc|Number=Sing|Polarity=Pos	3	vocative	3:vocative	SpaceAfter=No
