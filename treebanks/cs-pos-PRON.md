...
There are 53 `PRON` lemmas (0%), 196 `PRON` types (0%) and 44922 `PRON` tokens (3%).
...
The form / lemma ratio of `PRON` is 3.698113 (the average of all parts of speech is 2.181829).
...
36836 (82%) `PRON` nodes are leaves.

6997 (16%) `PRON` nodes have one child.
