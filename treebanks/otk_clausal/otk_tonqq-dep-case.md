...
12 nodes (8%) are attached to their parents as `case`.
...
The following 2 pairs of parts of speech are connected with `case`: <tt><a href="otk_tonqq-pos-NOUN.html">NOUN</a></tt>-<tt><a href="otk_tonqq-pos-ADP.html">ADP</a></tt> (8; 67% instances), <tt><a href="otk_tonqq-pos-PROPN.html">PROPN</a></tt>-<tt><a href="otk_tonqq-pos-ADP.html">ADP</a></tt> (4; 33% instances).
