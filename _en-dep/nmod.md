...
Nominal modifiers not introduced by a preposition or not 's genitives are tagged *npmod*, a subtype of *nmod*. Temporal nominal modifiers are also marked with a separate relation *tmod*. See the definitions of these relations.
