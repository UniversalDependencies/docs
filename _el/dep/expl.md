...
The `expl` relation is used in UD Greek for cases of clitic doubling. As a rule of thumb, clitics are assigned the [expl]() dependency when a coreferring core argument of the verb (object, indirect object) exists, otherwise clitics are assigned the core dependencies [obj]() and [iobj](). 
