...
688 nodes (0%) are attached to their parents as `flat:name`.

688 instances of `flat:name` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.04360465116279.

The following 1 pairs of parts of speech are connected with `flat:name`: <tt><a href="sl_ssj-pos-PROPN.html">PROPN</a></tt>-<tt><a href="sl_ssj-pos-PROPN.html">PROPN</a></tt> (688; 100% instances).
