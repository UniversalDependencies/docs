...
2	de	de	DET	LID|bep|stan|rest	Definite=Def|PronType=Art	3	det	3:det	_
...
5	zicht	zicht	NOUN	N|soort|ev|basis|onz|stan	Gender=Neut|Number=Sing	3	nmod	3:nmod:in	_
6	sloegen	toe_slaan	VERB	WW|pv|verl|mv	Mood=Ind|Number=Plur|Tense=Past|VerbForm=Fin	0	root	0:root	_
7	de	de	DET	LID|bep|stan|rest	Definite=Def|PronType=Art	8	det	8:det	_
8	zenuwen	zenuw	NOUN	N|soort|mv|basis	Number=Plur	6	nsubj	6:nsubj	_
9	toe	toe	ADP	VZ|fin	_	6	compound:prt	6:compound:prt	SpaceAfter=No
...
1	Daarin	daarin	ADV	BW	_	2	advmod	2:advmod	_
2	verloor	verliezen	VERB	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	0	root	0:root	_
...
6	7	7	NUM	TW|hoofd|vrij	ExtPos=PRON	2	obl	2:obl:met	_
7	-	-	SYM	LET	_	6	fixed	6:fixed	_
8	1	1	NUM	TW|hoofd|vrij	_	6	fixed	6:fixed	_
9	van	van	ADP	VZ|init	_	10	case	10:case	_
10	Argentinië	Argentinië	PROPN	N|eigen|ev|basis|onz|stan	Gender=Neut|Number=Sing	2	obl:arg	2:obl:arg:van	SpaceAfter=No
