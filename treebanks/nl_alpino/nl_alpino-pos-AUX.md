...
There are 8 `AUX` lemmas (0%), 54 `AUX` types (0%) and 9816 `AUX` tokens (5%).
...
`AUX` occurs with 3 features: <tt><a href="nl_alpino-feat-VerbForm.html">VerbForm</a></tt> (9816; 100% instances), <tt><a href="nl_alpino-feat-Number.html">Number</a></tt> (8669; 88% instances), <tt><a href="nl_alpino-feat-Tense.html">Tense</a></tt> (8669; 88% instances)
