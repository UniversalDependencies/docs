---
layout: base
title:  'Statistics of flat in UD_French-PUD'
udver: '2'
---

## Treebank Statistics: UD_French-PUD: Relations: `flat`

This relation is universal.
There are 1 language-specific subtypes of `flat`: <tt><a href="fr_pud-dep-flat-name.html">flat:name</a></tt>.
...
The following 1 pairs of parts of speech are connected with `flat`: <tt><a href="fr_pud-pos-X.html">X</a></tt>-<tt><a href="fr_pud-pos-X.html">X</a></tt> (17; 100% instances).
...
12	Greco	_	X	GW	Foreign=Yes	11	flat	_	Proper=True|SpaceAfter=No
