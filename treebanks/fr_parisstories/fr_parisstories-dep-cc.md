...
# visual-style 5 1 cc	color:blue
1	et	et	CCONJ	_	_	5	cc	_	_
2	elle	lui	PRON	_	Case=Nom|Emph=No|Gender=Fem|Number=Sing|Person=3|PronType=Prs	5	nsubj	_	_
3	était	être	AUX	_	Mood=Ind|Number=Sing|Person=3|Tense=Imp|VerbForm=Fin	5	cop	_	_
4	toute	toute	ADV	_	_	5	advmod	_	_
5	seule	seul	ADJ	_	_	0	root	_	Gender[ctxt]=Fem|Number[ctxt]=Sing
...
8	cage	cage	NOUN	_	_	5	obl:mod	_	Gender[lex]=Fem|Number[ctxt]=Sing|SpaceAfter=No
