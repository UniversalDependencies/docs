...
1	amor	amor	NOUN	n-s---mn-	Case=Nom|Gender=Masc|Number=Sing	4	nsubj	_	LId=amor1
...
3	mihi	ego	PRON	p-s---md-	Case=Dat|Number=Sing|Person=1|PronType=Prs	4	nmod	_	LId=ego1
4	causa	causa	NOUN	n-s---fn-	Case=Nom|Gender=Fem|Number=Sing	0	root	_	LId=causa1
5	sequendi	sequor	VERB	v-spgpng-	Aspect=Prosp|Case=Gen|Gender=Neut|Number=Sing|VerbForm=Part|Voice=Pass	4	nmod	_	LId=sequor1|SpaceAfter=No|TraditionalMood=Gerundivum
