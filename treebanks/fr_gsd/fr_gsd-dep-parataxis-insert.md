...
Average distance between parent and child is 17.2295081967213.
...
1	Il	lui	PRON	_	Case=Nom|Emph=No|Gender=Masc|Number=Sing|Person=3|PronType=Prs	2	expl:subj	_	wordform=il
...
5	temps	temps	NOUN	_	Gender=Masc|Number=Sing	2	obj	_	Exponence[Gender]=Inherent|Exponence[Number]=Absent
...
9	-il	lui	PRON	_	Case=Nom|Emph=No|Gender=Masc|Number=Sing|Person=3|PronType=Prs	10	nsubj	_	wordform=il
10	déclaré	déclarer	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part|Voice=Act	2	parataxis:insert	_	SpaceAfter=No|Tense[denom]=Past
...
4	génocide	génocide	NOUN	_	Gender=Masc|Number=Sing	0	root	_	Exponence[Gender]=Inherent
5	silencieux	silencieux	ADJ	_	Gender=Masc|Number=Sing	4	amod	_	Exponence[Number]=Absent
...
10	soutenu	soutenir	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part|Voice=Act	4	parataxis:insert	_	SpaceAfter=No|Tense[denom]=Past
...
2	route	route	NOUN	_	Gender=Fem|Number=Sing	4	nsubj	_	Exponence[Gender]=Inherent
...
8	représentant	représentant	NOUN	_	Gender=Masc|Number=Sing	6	nsubj	_	Exponence[Gender]=Inherent
9	de	de	ADP	_	_	11	case	_	_
10	le	le	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	11	det	_	_
11	pape	pape	NOUN	_	Gender=Masc|Number=Sing	8	nmod	_	Exponence[Gender]=Inherent|SpaceAfter=No
