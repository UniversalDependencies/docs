...
- Demonstrative determiners
  - 這 / _zhè_ "this", 這些 / _zhèxiē_ "these", 此 / _cǐ_ "this", 那 / _nà_ "that", 那些 / _nàxiē_ "those", 該 / _gāi_ "that", 本 / _běn_ "our", 上 / _shàng_ "the previous", 下 / _xià_ "the next", 前 / _qián_ "the previous", 後 / _hòu_ "the following", 頭 / _tóu_ "the first", 另 / _lìng_ "another", 其餘 / _qíyú_ "the rest", 其他 / _qítā_ "other", 某 / _mǒu_ "certain (singular)", 某些 / _mǒuxiē_ "certain (plural)"
