---
layout: base
title:  'Statistics of advmod in UD_Bhojpuri-BHTB'
udver: '2'
---

## Treebank Statistics: UD_Bhojpuri-BHTB: Relations: `advmod`

This relation is universal.

29 nodes (0%) are attached to their parents as `advmod`.

29 instances of `advmod` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 3.27586206896552.

The following 5 pairs of parts of speech are connected with `advmod`: <tt><a href="bho_bhtb-pos-VERB.html">VERB</a></tt>-<tt><a href="bho_bhtb-pos-ADV.html">ADV</a></tt> (15; 52% instances), <tt><a href="bho_bhtb-pos-VERB.html">VERB</a></tt>-<tt><a href="bho_bhtb-pos-PART.html">PART</a></tt> (11; 38% instances), <tt><a href="bho_bhtb-pos-AUX.html">AUX</a></tt>-<tt><a href="bho_bhtb-pos-CCONJ.html">CCONJ</a></tt> (1; 3% instances), <tt><a href="bho_bhtb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="bho_bhtb-pos-PART.html">PART</a></tt> (1; 3% instances), <tt><a href="bho_bhtb-pos-PRON.html">PRON</a></tt>-<tt><a href="bho_bhtb-pos-CCONJ.html">CCONJ</a></tt> (1; 3% instances).
...
# visual-style 8 4 advmod	color:blue
1	इटली	इटली	NOUN	N_NN	Case=Acc|Gender=Masc|Number=Sing|Person=3	8	nsubj	_	_
2	के	को	ADP	PSP	AdpType=Post|Case=Nom|Gender=Masc|Number=Plur	1	case	_	_
3	नागरिकता	नागरिकता	NOUN	N_NN	Case=Nom|Gender=Fem|Number=Sing|Person=3	8	obj	_	_
4	शायद	शायद	ADV	RB	_	8	advmod	_	_
5	आजु	आजु	NOUN	N_NST	Case=Nom|Gender=Fem|Number=Sing|Person=3	6	obj	_	_
6	ले	ले	ADP	PSP	Number=Sing	8	advcl	_	_
7	नइखी	नइखा	PART	RP_NEG	Case=Nom|Gender=Fem|Number=Sing|Person=3	8	compound	_	_
8	छोड़ले	छोड़ला	VERB	V_VM	Aspect=Perf|Gender=Masc|Number=Sing|Person=3|Polite=Form|VerbForm=Part|Voice=Act	0	root	_	_
...
1	आजुओ	आजुओ	ADV	RB	Case=Nom|Gender=Masc|Number=Sing|Person=3	10	advmod	_	_
2	लेखक	लेखक	NOUN	N_NN	Case=Acc|Gender=Masc|Number=Plur|Person=3	10	obl	_	_
3	लोगन	लोगन	NOUN	N_NN	Case=Acc|Gender=Masc|Number=Sing|Person=3	2	compound	_	_
4	पर	पर	ADP	PSP	AdpType=Post	3	case	_	_
5	से	से	ADP	PSP	AdpType=Post	3	case	_	_
6	लोगन	लोगन	NOUN	N_NN	Case=Acc|Gender=Masc|Number=Sing|Person=3	8	nmod	_	_
7	के	का	ADP	PSP	AdpType=Post|Case=Nom|Gender=Masc|Number=Sing	6	case	_	_
8	भरोसा	भरोसा	NOUN	N_NN	Case=Nom|Gender=Masc|Number=Sing|Person=3	10	obj	_	_
9	नइखे	नइखे	PART	RP_NEG	Polarity=Neg|PronType=Neg	10	advmod	_	_
10	हटल	हटा	VERB	V_VM	_	0	root	_	_
