---
layout: base
title:  'Statistics of Compound in UD_Latin-Perseus'
udver: '2'
---

## Treebank Statistics: UD_Latin-Perseus: Features: `Compound`

This feature is language-specific.
It occurs with 1 different values: `Yes`.

4 tokens (0%) have a non-empty value of `Compound`.
1 types (0%) occur at least once with a non-empty value of `Compound`.
1 lemmas (0%) occur at least once with a non-empty value of `Compound`.
The feature is used with 1 part-of-speech tags: <tt><a href="la_perseus-pos-PRON.html">PRON</a></tt> (4; 0% instances).
...
* `Yes` (4; 100% of non-empty `Compound`): <em>invicem</em>
