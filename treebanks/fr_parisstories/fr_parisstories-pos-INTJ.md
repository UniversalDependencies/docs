...
There are 33 `INTJ` lemmas (1%), 32 `INTJ` types (1%) and 2312 `INTJ` tokens (5%).
...
The form / lemma ratio of `INTJ` is 0.969697 (the average of all parts of speech is 1.324273).
...
1453 (63%) `INTJ` nodes have one child.
