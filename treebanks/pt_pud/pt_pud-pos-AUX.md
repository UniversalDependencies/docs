...
There are 9 `AUX` lemmas (0%), 116 `AUX` types (2%) and 807 `AUX` tokens (3%).
Out of 16 observed tags, the rank of `AUX` is: 10 in number of lemmas, 7 in number of types and 10 in number of tokens.

The 10 most frequent `AUX` lemmas: <em>_, ser, estar, ter, poder, ir, dever, haver, vir</em>
...
`AUX` nodes are attached to their parents using 3 different relations: <tt><a href="pt_pud-dep-cop.html">cop</a></tt> (316; 39% instances), <tt><a href="pt_pud-dep-aux.html">aux</a></tt> (250; 31% instances), <tt><a href="pt_pud-dep-aux-pass.html">aux:pass</a></tt> (241; 30% instances)
