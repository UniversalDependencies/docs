...
There are 2657 `ADJ` lemmas (13%), 3885 `ADJ` types (13%) and 11388 `ADJ` tokens (5%).
...
The form / lemma ratio of `ADJ` is 1.462175 (the average of all parts of speech is 1.421073).
