---
layout: base
title:  'Statistics of advmod in UD_English-Pronouns'
udver: '2'
---

## Treebank Statistics: UD_English-Pronouns: Relations: `advmod`

This relation is universal.

85 nodes (5%) are attached to their parents as `advmod`.

45 instances of `advmod` (53%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 3 pairs of parts of speech are connected with `advmod`: <tt><a href="en_pronouns-pos-VERB.html">VERB</a></tt>-<tt><a href="en_pronouns-pos-ADV.html">ADV</a></tt> (45; 53% instances), <tt><a href="en_pronouns-pos-PRON.html">PRON</a></tt>-<tt><a href="en_pronouns-pos-PART.html">PART</a></tt> (30; 35% instances), <tt><a href="en_pronouns-pos-PRON.html">PRON</a></tt>-<tt><a href="en_pronouns-pos-ADV.html">ADV</a></tt> (10; 12% instances).
