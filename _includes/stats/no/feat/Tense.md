...
The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="Mood.html">Mood</a>=Ind</tt> (13281; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (13281; 100%).
