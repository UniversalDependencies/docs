...
There are 51 `DET` lemmas (0%), 104 `DET` types (0%) and 34862 `DET` tokens (15%).
...
* <em>a</em>
  ...
  * <tt><a href="pt_bosque-pos-ADP.html">ADP</a></tt> 3090: <em>Mulher morre em rio presa <b>a</b> o cinto de o carro</em>
  ...
  * <tt><a href="pt_bosque-pos-PROPN.html">PROPN</a></tt> 8: <em>Ministério de a Ciência e de a Tecnologia assina protocolo com a Comissão para <b>a</b> Igualdade e os Direitos de as Mulheres</em>
...
The form / lemma ratio of `DET` is 2.039216 (the average of all parts of speech is 1.420809).
...
`DET` occurs with 7 features: <tt><a href="pt_bosque-feat-PronType.html">PronType</a></tt> (34833; 100% instances), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (34582; 99% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (34559; 99% instances), <tt><a href="pt_bosque-feat-Definite.html">Definite</a></tt> (30874; 89% instances), <tt><a href="pt_bosque-feat-ExtPos.html">ExtPos</a></tt> (19; 0% instances), <tt><a href="pt_bosque-feat-Typo.html">Typo</a></tt> (16; 0% instances), <tt><a href="pt_bosque-feat-NumType.html">NumType</a></tt> (2; 0% instances)

`DET` occurs with 20 feature-value pairs: `Definite=Def`, `Definite=Ind`, `ExtPos=ADP`, `ExtPos=PROPN`, `ExtPos=SCONJ`, `Gender=Fem`, `Gender=Masc`, `NumType=Card`, `Number=Plur`, `Number=Sing`, `PronType=Art`, `PronType=Dem`, `PronType=Emp`, `PronType=Ind`, `PronType=Int`, `PronType=Neg`, `PronType=Prs`, `PronType=Rel`, `PronType=Tot`, `Typo=Yes`
