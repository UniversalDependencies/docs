...
37 types (2%) occur at least once with a non-empty value of `PronType`.
1 lemmas (0) occur at least once with a non-empty value of `PronType`.
The feature is used with 4 part-of-speech tags: <tt><a href="bej_autogramm-pos-DET.html">DET</a></tt> (283; 2% instances), <tt><a href="bej_autogramm-pos-SCONJ.html">SCONJ</a></tt> (174; 1% instances), <tt><a href="bej_autogramm-pos-PRON.html">PRON</a></tt> (63; 1% instances), <tt><a href="bej_autogramm-pos-ADV.html">ADV</a></tt> (1; 0% instances).
...
* `EMPTY` (1453): <em>=t, i=, oː=, w=, ti=, uː=, t=, j=, =b, toː=</em>

### `SCONJ`

174 <tt><a href="bej_autogramm-pos-SCONJ.html">SCONJ</a></tt> tokens (29% of all `SCONJ` tokens) have a non-empty value of `PronType`.

`SCONJ` tokens may have the following values of `PronType`:

* `Rel` (174; 100% of non-empty `PronType`): <em>=eːb, =eː, =i, =jeːb, =jeː, =eːt, =jeːt, =ji, =t, =b</em>
* `EMPTY` (420): <em>=hoːb, =ajt, =eːk, =aj, =it, =jeːk, =eːb, =eːt, =jeːb, akoː</em>

### `PRON`

63 <tt><a href="bej_autogramm-pos-PRON.html">PRON</a></tt> tokens (8% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="bej_autogramm-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (63; 100%), <tt><a href="bej_autogramm-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (63; 100%), <tt><a href="bej_autogramm-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (61; 97%), <tt><a href="bej_autogramm-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (41; 65%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (2; 3% of non-empty `PronType`): <em>beːn, oːn</em>
* `Int` (14; 22% of non-empty `PronType`): <em>naːn, naː, ʔaːw</em>
* `Rel` (47; 75% of non-empty `PronType`): <em>ti=, wi=, i=, w=, t=, ji=</em>
