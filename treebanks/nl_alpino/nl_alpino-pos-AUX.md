...
There are 8 `AUX` lemmas (0%), 53 `AUX` types (0%) and 9825 `AUX` tokens (5%).
...
The form / lemma ratio of `AUX` is 6.625000 (the average of all parts of speech is 1.206032).

The 1st highest number of forms (12) was observed with the lemma “zijn”: <em>Wees, ben, bent, geweest, is, ware, waren, was, wezen, zij, zijn, zijnde</em>.
...
`AUX` occurs with 3 features: <tt><a href="nl_alpino-feat-VerbForm.html">VerbForm</a></tt> (9825; 100% instances), <tt><a href="nl_alpino-feat-Number.html">Number</a></tt> (8679; 88% instances), <tt><a href="nl_alpino-feat-Tense.html">Tense</a></tt> (8679; 88% instances)
...
Children of `AUX` nodes are attached using 4 different relations: <tt><a href="nl_alpino-dep-punct.html">punct</a></tt> (50; 71% instances), <tt><a href="nl_alpino-dep-conj.html">conj</a></tt> (10; 14% instances), <tt><a href="nl_alpino-dep-cc.html">cc</a></tt> (9; 13% instances), <tt><a href="nl_alpino-dep-obl.html">obl</a></tt> (1; 1% instances)

Children of `AUX` nodes belong to 5 different parts of speech: <tt><a href="nl_alpino-pos-PUNCT.html">PUNCT</a></tt> (50; 71% instances), <tt><a href="nl_alpino-pos-CCONJ.html">CCONJ</a></tt> (9; 13% instances), <tt><a href="nl_alpino-pos-AUX.html">AUX</a></tt> (7; 10% instances), <tt><a href="nl_alpino-pos-PRON.html">PRON</a></tt> (2; 3% instances), <tt><a href="nl_alpino-pos-VERB.html">VERB</a></tt> (2; 3% instances)
