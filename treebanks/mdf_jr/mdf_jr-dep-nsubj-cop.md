...
1	Ня	ня	PRON	Pron	PronType=Dem	2	det	_	_
...
8	кенярдсь	кенярдемс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	3	advcl	_	GTtags=IV,Ind,Prt1,ScSg3|SpaceAfter=No
...
4	тиеда-арада	тиемс-арамс	VERB	V	Mood=Imp|Number[subj]=Plur|Person[subj]=2|VerbForm=Fin	2	conj	_	GTtags=Imprt,ScPl2|SpaceAfter=No
