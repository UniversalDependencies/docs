...
In Armenian, negation is mostly done using the bound morpheme _չ-_; an independent negating particle (equivalent to English “not”) is rarely seen. Words that can take the morpheme of negation have the feature of polarity.
...
Note that in Armenian [adjectives](ADJ), sometimes also [adverbs](ADV) can be negated by adding the negating particle _ոչ_, denote the complement of the original adjective or adverb: e.g. _պաշտոնական_ “official” vs. _ոչ պաշտոնական_/_oč paštonakan_ “unofficial” (lit: “not official (something)”).
