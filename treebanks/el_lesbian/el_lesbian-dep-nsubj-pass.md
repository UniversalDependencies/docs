...
5 instances of `nsubj:pass` (56%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.

The following 4 pairs of parts of speech are connected with `nsubj:pass`: <tt><a href="el_lesbian-pos-VERB.html">VERB</a></tt>-<tt><a href="el_lesbian-pos-NOUN.html">NOUN</a></tt> (4; 44% instances), <tt><a href="el_lesbian-pos-VERB.html">VERB</a></tt>-<tt><a href="el_lesbian-pos-DET.html">DET</a></tt> (2; 22% instances), <tt><a href="el_lesbian-pos-VERB.html">VERB</a></tt>-<tt><a href="el_lesbian-pos-PROPN.html">PROPN</a></tt> (2; 22% instances), <tt><a href="el_lesbian-pos-VERB.html">VERB</a></tt>-<tt><a href="el_lesbian-pos-PRON.html">PRON</a></tt> (1; 11% instances).
...
1	Σιγά	σιγά	ADV	_	_	5	advmod	_	_
2	τώρα	τώρα	ADV	_	_	5	advmod	_	_
3	π’	που	SCONJ	_	PronType=Rel	5	mark	_	_
...
9	μουρά	μουρό	NOUN	_	Case=Nom|Gender=Neut|Number=Plur	7	nsubj:pass	_	SpaceAfter=No
10	!	!	PUNCT	_	PunctType=Excl	5	punct	_	_
...
5	ήνταν	είμι	AUX	_	Aspect=Imp|Mood=Ind|Number=Plur|Person=3|Tense=Past|VerbForm=Fin	3	cop	_	Voicing=Voiced
...
10	κανένας	κανένας	DET	_	Case=Nom|Gender=Masc|Number=Sing|PronType=Neg	9	nsubj:pass	_	SpaceAfter=No
