...
1660 nodes (1%) are attached to their parents as `fixed`.

1660 instances of `fixed` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.28253012048193.
