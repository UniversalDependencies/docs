...
There are 1 `VERB` lemmas (7%), 268 `VERB` types (20%) and 399 `VERB` tokens (11%).
...
The form / lemma ratio of `VERB` is 268.000000 (the average of all parts of speech is 97.571429).
