...
1	Daarvoor	daarvoor	ADV	BW	_	4	advmod	4:advmod	_
2	was	zijn	AUX	WW|pv|verl|ev	Number=Sing|Tense=Past|VerbForm=Fin	4	cop	4:cop	_
3	hij	hij	PRON	VNW|pers|pron|nomin|vol|3|ev|masc	Case=Nom|Person=3|PronType=Prs	4	nsubj	4:nsubj	_
4	directeur-generaal	directeur-generaal	NOUN	N|soort|ev|basis|zijd|stan	Gender=Com|Number=Sing	0	root	0:root	_
5	Rijksluchtvaartdienst	rijksluchtvaartdienst	NOUN	N|soort|ev|basis|zijd|stan	Gender=Com|Number=Sing	4	appos	4:appos	SpaceAfter=No
6	.	.	PUNCT	LET	_	4	punct	4:punct	_
...
2	Miller	Miller	PROPN	SPEC|deeleigen	_	1	flat:name	1:flat:name	SpaceAfter=No
...
6	afgetreden	aftreden	VERB	WW|vd|prenom|zonder	VerbForm=Part	7	acl	7:acl	_
