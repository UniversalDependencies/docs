...
3	քիչ	քիչ	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	1	compound:redup	_	Translit=k’ič|LTranslit=k’ič
...
4	վատ	վատ	ADV	_	_	2	compound:redup	_	Translit=vat|LTranslit=vat
...
6	Տ	տ.	NOUN	_	Abbr=Yes|Animacy=Hum|Case=Nom|Definite=Ind|Number=Sing	4	compound:redup	_	Translit=T|LTranslit=t.|SpaceAfter=No
