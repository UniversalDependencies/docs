---
layout: base
title:  'Statistics of discourse in UD_Portuguese-PetroGold'
udver: '2'
---

## Treebank Statistics: UD_Portuguese-PetroGold: Relations: `discourse`
...
6	valores	valor	NOUN	_	Gender=Masc|Number=Plur	9	obl	_	_
7	que	que	PRON	_	Gender=Masc|Number=Plur|PronType=Rel	9	discourse	_	_
8	será	ser	AUX	_	Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin	9	aux:pass	_	_
9	calculado	calcular	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part|Voice=Pass	0	root	_	_
10	a	o	DET	_	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	11	det	_	_
11	quantidade	quantidade	NOUN	_	Gender=Fem|Number=Sing	9	nsubj:pass	_	_
12	capturada	capturar	VERB	_	Gender=Fem|Number=Sing|VerbForm=Part	11	acl	_	_
13	de	de	ADP	_	_	14	case	_	_
14	gás	gás	NOUN	_	Gender=Masc|Number=Sing	11	nmod	_	_
15	carbônico	carbônico	ADJ	_	Gender=Masc|Number=Sing	14	amod	_	SpaceAfter=No
...
1	Somente	somente	ADV	_	_	4	advmod	_	_
2	a	a	ADP	_	_	4	mark	_	_
3	o	o	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	4	det	_	_
4	misturar	misturar	VERB	_	VerbForm=Inf	11	advcl	_	_
...
14	modificador	modificador	ADJ	_	Gender=Masc|Number=Sing	13	amod	_	SpaceAfter=No
