...
6	работа	работа	NOUN	Ncfsi	Definite=Ind|Gender=Fem|Number=Sing	4	iobj	_	_
7	,	,	PUNCT	punct	_	4	punct	_	_
8	трионът	трион	NOUN	Ncmsf	Definite=Def|Gender=Masc|Number=Sing	9	nsubj	_	_
9	заскрибуца	заскрибуцам	VERB	Vppif-o3s	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	4	conj	_	_
