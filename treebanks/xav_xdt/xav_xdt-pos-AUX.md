...
* <em>wate</em>
  * <tt><a href="xav_xdt-pos-AUX.html">AUX</a></tt> 3: <em>Höiwahö wa za we <b>wate</b> simro wa'ranorĩhã</em>
...
The most frequent feature combination is `Person=Non1` (105 tokens).
Examples: <em>te, ma</em>
...
Children of `AUX` nodes are attached using 2 different relations: <tt><a href="xav_xdt-dep-dep.html">dep</a></tt> (2; 67% instances), <tt><a href="xav_xdt-dep-advmod.html">advmod</a></tt> (1; 33% instances)

Children of `AUX` nodes belong to 3 different parts of speech: <tt><a href="xav_xdt-pos-ADV.html">ADV</a></tt> (1; 33% instances), <tt><a href="xav_xdt-pos-DET.html">DET</a></tt> (1; 33% instances), <tt><a href="xav_xdt-pos-NOUN.html">NOUN</a></tt> (1; 33% instances)
