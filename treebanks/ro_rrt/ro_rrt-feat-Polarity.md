...
The feature is used with 4 part-of-speech tags: <tt><a href="ro_rrt-pos-CCONJ.html">CCONJ</a></tt> (6929; 3% instances), <tt><a href="ro_rrt-pos-SCONJ.html">SCONJ</a></tt> (1984; 1% instances), <tt><a href="ro_rrt-pos-PART.html">PART</a></tt> (1626; 1% instances), <tt><a href="ro_rrt-pos-ADV.html">ADV</a></tt> (4; 0% instances).
...
1984 <tt><a href="ro_rrt-pos-SCONJ.html">SCONJ</a></tt> tokens (100% of all `SCONJ` tokens) have a non-empty value of `Polarity`.

`SCONJ` tokens may have the following values of `Polarity`:

* `Pos` (1984; 100% of non-empty `Polarity`): <em>că, dacă, până, încât, deoarece, deși, fără, fiindcă, întrucât, de</em>
