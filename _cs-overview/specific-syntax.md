...
~~~ sdparse
ROOT Vybrané cestovní kanceláře jsme požádali , aby nám ze své nabídky navrhly vhodný zájezd na začátku sezony pro dva dospělé s dítětem do 5 let do ubytovacího zařízení , které odpovídá kategorii * * nebo * * * , a to do oblasti , kterou samy zpracovávají .
amod(kanceláře-4, Vybrané-2)
amod(kanceláře-4, cestovní-3)
dobj(požádali-6, kanceláře-4)
aux(požádali-6, jsme-5)
root(ROOT-1, požádali-6)
punct(aby-8, ,-7)
mark:auxc(požádali-6, aby-8)
dobj(navrhly-13, nám-9)
case:auxp(navrhly-13, ze-10)
det(nabídky-12, své-11)
nmod(ze-10, nabídky-12)
ccomp(aby-8, navrhly-13)
amod(zájezd-15, vhodný-14)
dobj(navrhly-13, zájezd-15)
case:auxp(zájezd-15, na-16)
nmod(na-16, začátku-17)
nmod(začátku-17, sezony-18)
case:auxp(zájezd-15, pro-19)
nummod(dospělé-21, dva-20)
nmod(pro-19, dospělé-21)
case:auxp(dospělé-21, s-22)
nmod(s-22, dítětem-23)
case:auxp(dítětem-23, do-24)
nummod(let-26, 5-25)
nmod(do-24, let-26)
case:auxp(zájezd-15, do-27)
amod(zařízení-29, ubytovacího-28)
nmod(do-27, zařízení-29)
punct(odpovídá-32, ,-30)
nsubj(odpovídá-32, které-31)
acl(zařízení-29, odpovídá-32)
dobj(odpovídá-32, kategorii-33)
punct:member(nebo-36, *-34)
punct(*-34, *-35)
cc:coord(kategorii-33, nebo-36)
punct:member(nebo-36, *-37)
punct(*-37, *-38)
punct(*-37, *-39)
punct(do-43, ,-40)
cc(to-42, a-41)
cc(oblasti-44, to-42)
case:auxp(zájezd-15, do-43)
nmod(do-43, oblasti-44)
punct(zpracovávají-48, ,-45)
dobj(zpracovávají-48, kterou-46)
xcomp(zpracovávají-48, samy-47)
acl(oblasti-44, zpracovávají-48)
root:auxk(ROOT-1, .-49)
~~~
...
root(ROOT-1, požádali-6)
punct(navrhly-13, ,-7)
mark(navrhly-13, aby-8)
dobj(navrhly-13, nám-9)
case(nabídky-12, ze-10)
det(nabídky-12, své-11)
nmod(navrhly-13, nabídky-12)
ccomp(požádali-6, navrhly-13)
amod(zájezd-15, vhodný-14)
dobj(navrhly-13, zájezd-15)
case(začátku-17, na-16)
nmod(zájezd-15, začátku-17)
nmod(začátku-17, sezony-18)
case(dospělé-21, pro-19)
nummod(dospělé-21, dva-20)
nmod(zájezd-15, dospělé-21)
case(dítětem-23, s-22)
nmod(dospělé-21, dítětem-23)
case(let-26, do-24)
nummod(let-26, 5-25)
nmod(dítětem-23, let-26)
case(zařízení-29, do-27)
amod(zařízení-29, ubytovacího-28)
nmod(zájezd-15, zařízení-29)
punct(odpovídá-32, ,-30)
nsubj(odpovídá-32, které-31)
acl(zařízení-29, odpovídá-32)
dobj(odpovídá-32, kategorii-33)
punct(kategorii-33, *-34)
punct(*-34, *-35)
cc(*-34, nebo-36)
punct(*-34, *-37)
punct(*-37, *-38)
...
cc(to-42, a-41)
cc(oblasti-44, to-42)
case(oblasti-44, do-43)
nmod(zájezd-15, oblasti-44)
punct(zpracovávají-48, ,-45)
dobj(zpracovávají-48, kterou-46)
xcomp(zpracovávají-48, samy-47)
acl(oblasti-44, zpracovávají-48)
