...
252 tokens (1%) have a non-empty value of `NumType`.
126 types (2%) occur at least once with a non-empty value of `NumType`.
116 lemmas (2%) occur at least once with a non-empty value of `NumType`.
The feature is used with 5 part-of-speech tags: <tt><a href="pl_pud-pos-NUM.html">NUM</a></tt> (90; 0% instances), <tt><a href="pl_pud-pos-DET.html">DET</a></tt> (75; 0% instances), <tt><a href="pl_pud-pos-ADJ.html">ADJ</a></tt> (66; 0% instances), <tt><a href="pl_pud-pos-NOUN.html">NOUN</a></tt> (14; 0% instances), <tt><a href="pl_pud-pos-PROPN.html">PROPN</a></tt> (7; 0% instances).

### `NUM`

90 <tt><a href="pl_pud-pos-NUM.html">NUM</a></tt> tokens (49% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="pl_pud-feat-NumForm.html">NumForm</a></tt><tt>=Digit</tt> (90; 100%), <tt><a href="pl_pud-feat-Number.html">Number</a></tt><tt>=Plur</tt> (89; 99%), <tt><a href="pl_pud-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (77; 86%), <tt><a href="pl_pud-feat-Animacy.html">Animacy</a></tt><tt>=Inan</tt> (63; 70%).

`NUM` tokens may have the following values of `NumType`:

* `Card` (90; 100% of non-empty `NumType`): <em>3, 100, 5, 10, 2, 20, 10000, 14, 16, 330</em>
...
66 <tt><a href="pl_pud-pos-ADJ.html">ADJ</a></tt> tokens (3% of all `ADJ` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="pl_pud-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (66; 100%), <tt><a href="pl_pud-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (66; 100%), <tt><a href="pl_pud-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (66; 100%), <tt><a href="pl_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (66; 100%), <tt><a href="pl_pud-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (66; 100%), <tt><a href="pl_pud-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (61; 92%), <tt><a href="pl_pud-feat-Animacy.html">Animacy</a></tt><tt>=Inan</tt> (60; 91%), <tt><a href="pl_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (48; 73%), <tt><a href="pl_pud-feat-Case.html">Case</a></tt><tt>=Gen</tt> (41; 62%).

`ADJ` tokens may have the following values of `NumType`:

* `Ord` (66; 100% of non-empty `NumType`): <em>1, 60, 30, 31, 70, 10, 11, 21, 4, 50</em>
* `EMPTY` (2120): <em>jednym, ostatnich, nowych, pierwszy, wielkiej, inne, dużą, innych, innymi, jeden</em>
...
* `EMPTY` (4505): <em>lat, roku, części, miejsce, wojny, latach, ludzi, raz, wieku, większość</em>
...
* `EMPTY` (1314): <em>USA, Brytanii, Clinton, Chiny, Trumpa, Azji, BBC, Danevirke, Europy, Francji</em>

## Relations with Agreement in `NumType`

The 10 most frequent relations where parent and child node agree in `NumType`:
<tt>ADJ --[<tt><a href="pl_pud-dep-conj.html">conj</a></tt>]--> ADJ</tt> (4; 100%),
<tt>NUM --[<tt><a href="pl_pud-dep-conj.html">conj</a></tt>]--> NUM</tt> (3; 100%),
