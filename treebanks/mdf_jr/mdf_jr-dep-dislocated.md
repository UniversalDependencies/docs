...
4	кенярдсть	кенярдемс	VERB	V	Mood=Ind|Number[subj]=Plur|Person[subj]=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt1,ScPl3
5	сонь	сон	PRON	Pron	Case=Gen|Number=Sing|Person=3|PronType=Prs	6	nmod	_	GTtags=Pers,Sg3,Gen
6	саманцты	самс	VERB	V	Case=Dat|Number=Sing|Number[psor]=Sing|Person[psor]=3|VerbForm=Vnoun	4	advcl	_	GTtags=NomAct,Sg,Dat,PxSg3|SpaceAfter=No
...
10	кунара	кунара	ADV	Adv	AdvType=Tim	12	advmod	_	_
11	ни	ни	ADV	Adv	AdvType=Tim	10	advmod	_	GTtags=Sem/Time
12	тусь	тумс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	7	acl:relcl	_	GTtags=Ind,Prt1,ScSg3
13	велеста	веле	NOUN	N	Case=Ela|Definite=Ind|Number=Plur,Sing	12	obl	_	GTtags=SP,Ela,Indef
14	и	и	CCONJ	CC	_	15	cc	_	_
15	эряй-ащи	-ащемс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Pres|VerbForm=Fin	12	conj	_	GTtags=Ind,Prs,ScSg3
16	косовок	косовок	ADV	Adv	Case=Ine|Definite=Ind	18	advmod	_	GTtags=Indef,Ine
17	пяк	пяк	ADV	Adv	AdvType=Deg	18	advmod	_	GTtags=Deg
18	ичкозе	ичкозе	ADV	Adv	Case=Loc	15	advmod	_	GTtags=Loc|SpaceAfter=No
