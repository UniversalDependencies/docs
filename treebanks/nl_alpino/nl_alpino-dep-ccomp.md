...
1	Dit	dit	DET	VNW|aanw|det|stan|prenom|zonder|evon	PronType=Dem	2	det	2:det	_
...
2	zegt	zeggen	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	_
...
7	is	zijn	AUX	WW|pv|tgw|ev	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	6	cop	6:cop	SpaceAfter=No
