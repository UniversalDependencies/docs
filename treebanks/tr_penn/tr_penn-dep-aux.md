...
# visual-style 6	fgColor:white
# visual-style 6 7 aux	color:blue
1	Ortalamalar	ortalama	NOUN	_	Case=Nom|Number=Plur|Person=3	2	nmod	_	_
2	yasasının	yasa	NOUN	_	Case=Gen|Number=Sing|Number[psor]=Sing|Person=3|Person[psor]=3	5	nsubj	_	_
3	ne	ne	PRON	_	PronType=Int	5	obj	_	_
4	demek	de	NOUN	_	Case=Nom|Number=Sing|Person=3	5	compound	_	_
5	olduğunu	ol	NOUN	_	Case=Acc|Number=Sing|Number[psor]=Sing|Person=3|Person[psor]=3	6	ccomp	_	_
6	biliyorsun	bile	VERB	_	Aspect=Prog|Mood=Ind|Number=Sing|Person=2|Polarity=Pos|Tense=Pres|VerbForm=Fin	0	root	_	_
7	değil	değil	AUX	_	_	6	aux	_	_
8	mi	mi	AUX	_	PronType=Int	6	aux	_	_
