...
3788 tokens (7%) have a non-empty value of `Degree`.
1086 types (14%) occur at least once with a non-empty value of `Degree`.
797 lemmas (16%) occur at least once with a non-empty value of `Degree`.
The feature is used with 1 part-of-speech tags: <tt><a href="cy_ccg-pos-ADJ.html">ADJ</a></tt> (3788; 7% instances).

### `ADJ`

3788 <tt><a href="cy_ccg-pos-ADJ.html">ADJ</a></tt> tokens (100% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="cy_ccg-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (3408; 90%), <tt><a href="cy_ccg-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (3357; 89%), <tt><a href="cy_ccg-feat-Mutation.html">Mutation</a></tt><tt>=EMPTY</tt> (2647; 70%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (197; 5% of non-empty `Degree`): <em>mwy, fwy, well, uwch, bellach, gwell, nes, hŷn, ehangach, pellach</em>
* `Equ` (31; 1% of non-empty `Degree`): <em>ogystal, cystal, belled, rhated, gryfed, gynted, gystal</em>
* `Pos` (3302; 87% of non-empty `Degree`): <em>newydd, Cymraeg, lleol, mawr, pob, Gymraeg, arall, holl, prif, bob</em>
* `Sup` (258; 7% of non-empty `Degree`): <em>mwyaf, nesaf, cyntaf, diwethaf, uchaf, fwyaf, gorau, olaf, gyntaf, gwaethaf</em>
...
`Degree` seems to be **lexical feature** of `ADJ`. 95% lemmas (760) occur only with one value of `Degree`.

## Relations with Agreement in `Degree`

The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<tt><a href="cy_ccg-dep-conj.html">conj</a></tt>]--> ADJ</tt> (86; 98%),
...
<tt>ADJ --[<tt><a href="cy_ccg-dep-parataxis.html">parataxis</a></tt>]--> ADJ</tt> (2; 100%),
