...
2444 <tt><a href="en_lines-pos-PRON.html">PRON</a></tt> tokens (31% of all `PRON` tokens) have a non-empty value of `Gender`.
...
* `EMPTY` (5568): <em>it, I, you, that, they, we, what, there, their, my</em>
