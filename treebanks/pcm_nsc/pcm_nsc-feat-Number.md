...
* `EMPTY` (3960): <em>you, wetin, everybody, all, some, everyting, anyting, who, someting, everything</em>

`Number` seems to be **lexical feature** of `PRON`. 100% lemmas (29) occur only with one value of `Number`.

### `NOUN`

1906 <tt><a href="pcm_nsc-pos-NOUN.html">NOUN</a></tt> tokens (13% of all `NOUN` tokens) have a non-empty value of `Number`.

`NOUN` tokens may have the following values of `Number`:

* `Plur` (1906; 100% of non-empty `Number`): <em>people, tings, women, things, children, years, men, tins, girls, months</em>
* `EMPTY` (12838): <em>one, money, ting, school, time, man, person, house, work, life</em>

`Number` seems to be **lexical feature** of `NOUN`. 100% lemmas (308) occur only with one value of `Number`.
...
* `EMPTY` (3969): <em>di, all, one, some, a, any, anoder, which, every, the</em>
...
* `EMPTY` (1315): <em>o, sef, no, sha, not, ma, n't, shey, ni, ba</em>
