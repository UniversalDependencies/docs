...
The most frequent other feature values with which `PRON` and `Degree` co-occurred: <tt><a href="es-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (11; 100%), <tt><a href="es-feat-PronType.html">PronType</a></tt><tt>=Ind</tt> (11; 100%), <tt><a href="es-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (11; 100%), <tt><a href="es-feat-PrepCase.html">PrepCase</a></tt><tt>=EMPTY</tt> (11; 100%), <tt><a href="es-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (11; 100%), <tt><a href="es-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (10; 91%), <tt><a href="es-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (10; 91%).
...
The most frequent other feature values with which `DET` and `Degree` co-occurred: <tt><a href="es-feat-Number.html">Number</a></tt><tt>=Plur</tt> (3; 100%), <tt><a href="es-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="es-feat-PronType.html">PronType</a></tt><tt>=Ind</tt> (3; 100%), <tt><a href="es-feat-Gender.html">Gender</a></tt><tt>=Fem</tt> (3; 100%).
