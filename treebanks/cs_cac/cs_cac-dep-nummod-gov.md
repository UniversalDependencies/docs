...
6	dolů	dolů	ADV	Db-------------	_	5	orphan	5:orphan	SpaceAfter=No
7	,	,	PUNCT	Z:-------------	_	5	punct	5:punct	_
8	a	a	CCONJ	J^-------------	_	5	cc	5:cc	LId=a-1
9	hned	hned	ADV	Db-------------	_	10	advmod	10:advmod	_
10	je	být	VERB	VB-S---3P-AA---	Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	5	orphan	5:orphan	_
...
7	sobě	se	PRON	P6-X6----------	Case=Loc|PronType=Prs|Reflex=Yes	5	obl	5:obl	LGloss=(zvr._zájmeno/částice)
8	od	od	ADP	RR--2----------	AdpType=Prep|Case=Gen	9	case	9:case	LId=od-1
9	rána	ráno	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos	5	obl	5:obl	LId=ráno-1
...
4	oblasti	oblast	NOUN	NNFS6-----A----	Case=Loc|Gender=Fem|Number=Sing|Polarity=Pos	5	obl	5:obl	_
