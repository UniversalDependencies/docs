...
26231 tokens (10%) have a non-empty value of `Person`.
559 types (3%) occur at least once with a non-empty value of `Person`.
452 lemmas (3%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="en_ewt-pos-PRON.html">PRON</a></tt> (18683; 7% instances), <tt><a href="en_ewt-pos-AUX.html">AUX</a></tt> (5235; 2% instances), <tt><a href="en_ewt-pos-VERB.html">VERB</a></tt> (2313; 1% instances).

### `PRON`

18683 <tt><a href="en_ewt-pos-PRON.html">PRON</a></tt> tokens (81% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="en_ewt-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (18683; 100%), <tt><a href="en_ewt-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (15023; 80%), <tt><a href="en_ewt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13864; 74%), <tt><a href="en_ewt-feat-Case.html">Case</a></tt><tt>=Nom</tt> (11783; 63%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11047; 59%).
...
* `3` (7099; 38% of non-empty `Person`): <em>it, they, he, their, his, them, him, she, her, its</em>
...
* `EMPTY` (10178): <em>be, are, will, can, have, would, do, were, been, could</em>
...
* `EMPTY` (26093): <em>have, get, know, had, go, do, want, said, see, going</em>
