...
4103 tokens (9%) have a non-empty value of `Tense`.
206 types (10%) occur at least once with a non-empty value of `Tense`.
86 lemmas (9%) occur at least once with a non-empty value of `Tense`.
The feature is used with 1 part-of-speech tags: <tt><a href="tr_atis-pos-VERB.html">VERB</a></tt> (4103; 9% instances).

### `VERB`

4103 <tt><a href="tr_atis-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="tr_atis-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (4056; 99%), <tt><a href="tr_atis-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3449; 84%), <tt><a href="tr_atis-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (3446; 84%), <tt><a href="tr_atis-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (2619; 64%).
...
* `Pres` (4088; 100% of non-empty `Tense`): <em>göster, istiyorum, nedir, listeleyin, gösterin, listele, nelerdir, uçuyor, bul, ver</em>
...
<tt>VERB --[<tt><a href="tr_atis-dep-conj.html">conj</a></tt>]--> VERB</tt> (59; 98%),
<tt>VERB --[<tt><a href="tr_atis-dep-csubj.html">csubj</a></tt>]--> VERB</tt> (8; 100%),
<tt>VERB --[<tt><a href="tr_atis-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (7; 88%),
