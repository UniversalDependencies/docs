...
2	bu	bu	PRON	_	Case=Nom|Number=Sing|PronType=Dem	5	nsubj	_	LangID=TR
...
8	ben	ben	PRON	_	Case=Nom|Number=Sing|Person=1|PronType=Prs	11	nsubj	_	LangID=TR
9	Statistik	Statistik	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	11	obl	_	LangID=DE
10	ona	o	PRON	_	Case=Dat|Number=Sing|Person=3|PronType=Prs	9	appos	_	LangID=TR
