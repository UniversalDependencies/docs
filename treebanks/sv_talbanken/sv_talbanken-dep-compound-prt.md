...
801 nodes (1%) are attached to their parents as `compound:prt`.

800 instances of `compound:prt` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.32334581772784.

The following 5 pairs of parts of speech are connected with `compound:prt`: <tt><a href="sv_talbanken-pos-VERB.html">VERB</a></tt>-<tt><a href="sv_talbanken-pos-ADV.html">ADV</a></tt> (535; 67% instances), <tt><a href="sv_talbanken-pos-VERB.html">VERB</a></tt>-<tt><a href="sv_talbanken-pos-ADP.html">ADP</a></tt> (227; 28% instances), <tt><a href="sv_talbanken-pos-VERB.html">VERB</a></tt>-<tt><a href="sv_talbanken-pos-NOUN.html">NOUN</a></tt> (32; 4% instances), <tt><a href="sv_talbanken-pos-VERB.html">VERB</a></tt>-<tt><a href="sv_talbanken-pos-ADJ.html">ADJ</a></tt> (6; 1% instances), <tt><a href="sv_talbanken-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sv_talbanken-pos-ADV.html">ADV</a></tt> (1; 0% instances).
...
2	gick	gå	VERB	VB|PRT|AKT	Mood=Ind|Tense=Past|VerbForm=Fin|Voice=Act	0	root	0:root	ParsemeMWE=1:IVPC.full;2:VID
3	ut	ut	ADV	PL	_	2	compound:prt	2:compound:prt	ParsemeMWE=1;2
4	över	över	ADP	PP	_	5	case	5:case	ParsemeMWE=2
...
1	Undra	undra	VERB	VB|INF|AKT	VerbForm=Inf|Voice=Act	0	root	0:root	ParsemeMWE=1:IVPC.semi
2	på	på	ADP	PL	_	1	compound:prt	1:compound:prt	ParsemeMWE=1
...
1	Så	så	ADV	AB	_	2	advmod	2:advmod	ParsemeMWE=1:ConjID
2	länge	länge	ADV	AB|POS	Degree=Pos	11	advmod	11:advmod	ParsemeMWE=1
3	mamma	mamma	NOUN	NN|UTR|SIN|IND|NOM	Case=Nom|Definite=Ind|Gender=Com|Number=Sing	4	nsubj	4:nsubj	_
4	har	ha	VERB	VB|PRS|AKT	Mood=Ind|Tense=Pres|VerbForm=Fin|Voice=Act	2	advcl	2:advcl	ParsemeMWE=2:VID
5	hand	hand	NOUN	NN|UTR|SIN|IND|NOM	Case=Nom|Definite=Ind|Gender=Com|Number=Sing	4	compound:prt	4:compound:prt	ParsemeMWE=2
6	om	om	ADP	PP	_	7	case	7:case	ParsemeMWE=2
