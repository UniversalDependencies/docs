---
layout: base
title:  'Statistics of acl in UD_Pashto-Sikaram'
udver: '2'
---
...
10	نامساعد	نامساعد	ADJ	_	Case=Nom|Gender=Masc|Number=Sing	3	acl	_	Translit=nâmusâ‘íd|LTranslit=nâmusâ‘íd|Gloss=unfavorable
11	وي	ول	AUX	_	Mood=Sub|Number=Sing|Person=3|VerbForm=Fin	10	cop	_	Translit=wi|LTranslit=wël|Gloss=is
...
24	ګنې	ګڼ	ADJ	_	Case=Nom|Gender=Masc|Number=Sing|Typo=Yes	26	amod	_	Translit=gáne|LTranslit=gaṇ|Gloss=big|CFTranslit=gaṇ|CorrectForm=ګڼ
