---
layout: base
title:  'Statistics of ExtPos in UD_Italian-ISDT'
udver: '2'
---

## Treebank Statistics: UD_Italian-ISDT: Features: `ExtPos`
...
<table>
  ...
  <tr><td><tt></tt></td><td><em>oltre</em></td><td><em>oltre</em></td><td><em>oltre</em></td><td><em>oltre</em></td></tr>
</table>
...
96 <tt><a href="it_isdt-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `NOUN` and `ExtPos` co-occurred: <tt><a href="it_isdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (58; 60%), <tt><a href="it_isdt-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (53; 55%).
...
3 <tt><a href="it_isdt-pos-PRON.html">PRON</a></tt> tokens (0% of all `PRON` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `PRON` and `ExtPos` co-occurred: <tt><a href="it_isdt-feat-Clitic.html">Clitic</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="it_isdt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="it_isdt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2; 67%), <tt><a href="it_isdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2; 67%), <tt><a href="it_isdt-feat-PronType.html">PronType</a></tt><tt>=Ind</tt> (2; 67%).
...
2 <tt><a href="it_isdt-pos-ADJ.html">ADJ</a></tt> tokens (0% of all `ADJ` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `ADJ` and `ExtPos` co-occurred: <tt><a href="it_isdt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2; 100%), <tt><a href="it_isdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2; 100%).

`ADJ` tokens may have the following values of `ExtPos`:

* `ADV` (2; 100% of non-empty `ExtPos`): <em>tutt'</em>

### `INTJ`

1 <tt><a href="it_isdt-pos-INTJ.html">INTJ</a></tt> tokens (2% of all `INTJ` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `INTJ` and `ExtPos` co-occurred: <tt><a href="it_isdt-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (1; 100%).

`INTJ` tokens may have the following values of `ExtPos`:

* `SCONJ` (1; 100% of non-empty `ExtPos`): <em>sì</em>

### `VERB`

1 <tt><a href="it_isdt-pos-VERB.html">VERB</a></tt> tokens (0% of all `VERB` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `VERB` and `ExtPos` co-occurred: <tt><a href="it_isdt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="it_isdt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1; 100%), <tt><a href="it_isdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1; 100%), <tt><a href="it_isdt-feat-Person.html">Person</a></tt><tt>=3</tt> (1; 100%), <tt><a href="it_isdt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1; 100%), <tt><a href="it_isdt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1; 100%).

`VERB` tokens may have the following values of `ExtPos`:

* `ADV` (1; 100% of non-empty `ExtPos`): <em>vale</em>

## Relations with Agreement in `ExtPos`

The 10 most frequent relations where parent and child node agree in `ExtPos`:
<tt>ADP --[<tt><a href="it_isdt-dep-conj.html">conj</a></tt>]--> ADP</tt> (1; 100%).
