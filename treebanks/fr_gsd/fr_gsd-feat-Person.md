...
37327 tokens (9%) have a non-empty value of `Person`.
3515 types (8%) occur at least once with a non-empty value of `Person`.
1371 lemmas (4%) occur at least once with a non-empty value of `Person`.
The feature is used with 4 part-of-speech tags: <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (13725; 3% instances), <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (12445; 3% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (11154; 3% instances), <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> (3; 0% instances).

### `VERB`

13725 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (43% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13724; 100%), <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13723; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13132; 96%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (10941; 80%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10809; 79%).
...
* `3` (12989; 95% of non-empty `Person`): <em>a, peut, fait, est, devient, doit, ont, trouve, permet, agit</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt>|<tt><a href="fr_gsd-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td></td><td></td><td><em>à</em></td></tr>
...
The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (10293; 83%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8245; 66%).
...
* `EMPTY` (5331): <em>qui, y, dont, qu', que, un, cela, une, celle, lequel</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt></tt></td><td><em>je, j'</em></td><td><em>tu, -tu, -vous</em></td><td></td></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt></tt></td><td><em>nous</em></td><td><em>vous, -vous</em></td><td></td></tr>
</table>

### `AUX`

11154 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (87% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11154; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10796; 97%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9458; 85%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8845; 79%).
...
* `3` (10709; 96% of non-empty `Person`): <em>est, a, sont, ont, était, fut, avait, sera, étaient, soit</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt>|<tt><a href="fr_gsd-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td></td><td></td><td><em>est</em></td></tr>
...
* `EMPTY` (61238): <em>le, la, les, l', un, une, des, son, sa, cette</em>

## Relations with Agreement in `Person`

The 10 most frequent relations where parent and child node agree in `Person`:
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (4028; 58%),
<tt>VERB --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1226; 67%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-comp.html">expl:comp</a></tt>]--> PRON</tt> (603; 56%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-pass.html">expl:pass</a></tt>]--> PRON</tt> (569; 75%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-subj.html">expl:subj</a></tt>]--> PRON</tt> (509; 92%),
<tt>PRON --[<tt><a href="fr_gsd-dep-acl-relcl.html">acl:relcl</a></tt>]--> VERB</tt> (163; 58%),
<tt>VERB --[<tt><a href="fr_gsd-dep-parataxis.html">parataxis</a></tt>]--> PRON</tt> (28; 55%),
<tt>PRON --[<tt><a href="fr_gsd-dep-fixed.html">fixed</a></tt>]--> VERB</tt> (21; 100%),
<tt>PRON --[<tt><a href="fr_gsd-dep-advcl-cleft.html">advcl:cleft</a></tt>]--> VERB</tt> (12; 52%),
