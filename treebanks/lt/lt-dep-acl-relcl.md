---
layout: base
title:  'Statistics of acl:relcl in UD_Lithuanian'
udver: '2'
---

## Treebank Statistics: UD_Lithuanian: Relations: `acl:relcl`

This relation is a language-specific subtype of <tt><a href="lt-dep-acl.html">acl</a></tt>.
