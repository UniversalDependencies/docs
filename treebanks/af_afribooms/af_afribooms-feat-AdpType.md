---
layout: base
title:  'Statistics of AdpType in UD_Afrikaans-AfriBooms'
udver: '2'
---

## Treebank Statistics: UD_Afrikaans-AfriBooms: Features: `AdpType`
...
6286 <tt><a href="af_afribooms-pos-ADP.html">ADP</a></tt> tokens (100% of all `ADP` tokens) have a non-empty value of `AdpType`.
...
<tt>ADP --[<tt><a href="af_afribooms-dep-conj.html">conj</a></tt>]--> ADP</tt> (5; 100%).
