...
2	Caja	Caja	PROPN	np00000	_	7	nsubj	7:nsubj	MWE=Caja_San_Fernando|MWEPOS=PROPN|ArgTem=arg0:agt
...
12	vida	vida	NOUN	ncfs000	Gender=Fem|Number=Sing	9	obj	9:obj	ArgTem=arg1:pat
13	a	a	ADP	spcms	_	15	case	15:case	_
14	el	el	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	15	det	15:det	_
15	Joventut	Joventut	PROPN	np00000	_	9	obl:arg	9:obl:arg	ArgTem=arg2:ben|Entity=(CESSCASTP20001201176c18--1)
16	en	en	ADP	sps00	_	17	case	17:case	_
17	Badalona	Badalona	PROPN	np00000	_	15	nmod	15:nmod	ArgTem=argM:loc|Entity=(NOCOREF:Spec.location-place-1-gstype:spec)
...
22	triunfo	triunfo	NOUN	ncms000	Gender=Masc|Number=Sing	20	obj	20:obj	ArgTem=arg1:pat|Entity=CESSCASTP20001201176c23)
23	en	en	ADP	sps00	_	25	case	25:case	_
24	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	25	det	25:det	Entity=(NOCOREF:Gen--2-gstype:gen
25	prórroga	prórroga	NOUN	ncfs000	Gender=Fem|Number=Sing	20	obl	20:obl	ArgTem=argM:tmp|Entity=NOCOREF:Gen)
26	(	(	PUNCT	fpa	PunctSide=Ini|PunctType=Brck	27	punct	27:punct	SpaceAfter=No|Entity=(NOCOREF:Spec.number-number-2-gstype:spec
27	85-79	85-79	NUM	_	NumForm=Digit|NumType=Card	20	dep	20:dep	SpaceAfter=No
28	)	)	PUNCT	fpt	PunctSide=Fin|PunctType=Brck	27	punct	27:punct	Entity=NOCOREF:Spec.number)
29	después	después	ADV	rg	_	20	advmod	20:advmod	ArgTem=argM:tmp
30	de	de	ADP	sps00	_	34	mark	34:mark	_
31	que	que	SCONJ	cs	_	34	mark	34:mark	_
32	el	el	DET	da0ms0	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	33	det	33:det	Entity=(NOCOREF:Gen--2-gstype:gen
33	partido	partido	NOUN	ncms000	Gender=Masc|Number=Sing	34	nsubj	34:nsubj	ArgTem=arg1:tem|Entity=NOCOREF:Gen)
34	acabara	acabar	VERB	vmsi3s0	Mood=Sub|Number=Sing|Person=3|Tense=Imp|VerbForm=Fin	29	advcl	29:advcl	_
35	empatado	empatado	ADJ	aq0msp	Gender=Masc|Number=Sing|VerbForm=Part	34	obj	34:obj	ArgTem=arg2:atr
36	a	a	ADP	sps00	_	37	case	37:case	_
37	72	72	NUM	_	NumForm=Digit|NumType=Card	35	obl	35:obl	SpaceAfter=No|ArgTem=argM:adv|Entity=(NOCOREF:Spec.number-number-1-gstype:spec)
