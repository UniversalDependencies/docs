...
14685 tokens (62%) have a non-empty value of `Number`.
5429 types (89%) occur at least once with a non-empty value of `Number`.
4250 lemmas (91%) occur at least once with a non-empty value of `Number`.
The feature is used with 10 part-of-speech tags: <tt><a href="it_pud-pos-NOUN.html">NOUN</a></tt> (4385; 18% instances), <tt><a href="it_pud-pos-DET.html">DET</a></tt> (3785; 16% instances), <tt><a href="it_pud-pos-PROPN.html">PROPN</a></tt> (1755; 7% instances), <tt><a href="it_pud-pos-ADJ.html">ADJ</a></tt> (1606; 7% instances), <tt><a href="it_pud-pos-VERB.html">VERB</a></tt> (1353; 6% instances), <tt><a href="it_pud-pos-AUX.html">AUX</a></tt> (919; 4% instances), <tt><a href="it_pud-pos-PRON.html">PRON</a></tt> (824; 3% instances), <tt><a href="it_pud-pos-ADP.html">ADP</a></tt> (54; 0% instances), <tt><a href="it_pud-pos-ADV.html">ADV</a></tt> (2; 0% instances), <tt><a href="it_pud-pos-CCONJ.html">CCONJ</a></tt> (2; 0% instances).

### `NOUN`

4385 <tt><a href="it_pud-pos-NOUN.html">NOUN</a></tt> tokens (100% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="it_pud-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (2485; 57%).

`NOUN` tokens may have the following values of `Number`:

* `Plur` (1296; 30% of non-empty `Number`): <em>anni, persone, dati, dollari, mesi, agenti, città, giorni, membri, effetti</em>
* `Sing` (3089; 70% of non-empty `Number`): <em>parte, anno, governo, volta, guerra, città, stato, tempo, giorno, mondo</em>
...
* `Plur` (945; 25% of non-empty `Number`): <em>i, le, gli, molti, alcuni, altri, altre, molte, queste, questi</em>
...
1755 <tt><a href="it_pud-pos-PROPN.html">PROPN</a></tt> tokens (100% of all `PROPN` tokens) have a non-empty value of `Number`.
...
* `Sing` (1614; 92% of non-empty `Number`): <em>Cina, Mar, Trump, America, Francia, Mediterraneo, Nord, guerra, Europa, Gran</em>
* `EMPTY` (1): <em>Tre</em>
...
`Number` seems to be **lexical feature** of `PROPN`. 100% lemmas (1198) occur only with one value of `Number`.
...
1353 <tt><a href="it_pud-pos-VERB.html">VERB</a></tt> tokens (66% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="it_pud-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (948; 70%), <tt><a href="it_pud-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (932; 69%), <tt><a href="it_pud-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (904; 67%), <tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt> (858; 63%), <tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (849; 63%), <tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (844; 62%).

`VERB` tokens may have the following values of `Number`:

* `Plur` (413; 31% of non-empty `Number`): <em>sono, hanno, avevano, considerate, fanno, inclusi, affermano, cominciarono, comprendono, cresciute</em>
* `Sing` (940; 69% of non-empty `Number`): <em>ha, afferma, aveva, iniziò, sembra, ebbe, fatto, riguarda, dichiarò, diventò</em>
* `EMPTY` (701): <em>affermato, avere, detto, far, avuto, fare, fatto, partire, portare, deciso</em>

<table>
  <tr><th>Paradigm <i>avere</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="it_pud-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt>|<tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td><em>aveva</em></td><td><em>avevano</em></td></tr>
  <tr><td><tt><tt><a href="it_pud-feat-Aspect.html">Aspect</a></tt><tt>=Perf</tt>|<tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td><em>ebbe</em></td><td><em>ebbero</em></td></tr>
  <tr><td><tt><tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>Ho</em></td><td><em>abbiamo</em></td></tr>
  <tr><td><tt><tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Fut</tt></tt></td><td><em>avrà</em></td><td></td></tr>
  <tr><td><tt><tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>ha</em></td><td><em>hanno</em></td></tr>
  <tr><td><tt><tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Sub</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td></td><td><em>avessero</em></td></tr>
  <tr><td><tt><tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Sub</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>abbia</em></td><td></td></tr>
</table>

### `AUX`

919 <tt><a href="it_pud-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt> (824; 90%), <tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (757; 82%), <tt><a href="it_pud-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (695; 76%), <tt><a href="it_pud-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (682; 74%), <tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (591; 64%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (250; 27% of non-empty `Number`): <em>sono, hanno, erano, vennero, furono, possono, avevano, stati, vengono, fossero</em>
* `Sing` (669; 73% of non-empty `Number`): <em>è, ha, era, fu, stato, venne, può, aveva, stata, fosse</em>
* `EMPTY` (66): <em>essere, aver, esser, potuto, avendo, Essendo, potendo, poter</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Cnd</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt>|<tt><a href="it_pud-feat-Voice.html">Voice</a></tt><tt>=Act</tt></tt></td><td><em>Sarei</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="it_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_pud-feat-Tense.html">Tense</a></tt><tt>=Past</tt>|<tt><a href="it_pud-feat-Voice.html">Voice</a></tt><tt>=Pass</tt></tt></td><td></td><td><em>Furono</em></td></tr>
...
824 <tt><a href="it_pud-pos-PRON.html">PRON</a></tt> tokens (96% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="it_pud-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (717; 87%), <tt><a href="it_pud-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (599; 73%), <tt><a href="it_pud-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (583; 71%), <tt><a href="it_pud-feat-Person.html">Person</a></tt><tt>=3</tt> (478; 58%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (223; 27% of non-empty `Number`): <em>che, si, sue, suoi, loro, quali, cui, propri, quelli, ci</em>
* `Sing` (601; 73% of non-empty `Number`): <em>si, che, sua, suo, loro, lo, cui, questo, quella, gli</em>
* `EMPTY` (37): <em>ci, c', ne, Chi, cosa, quanto, vi</em>

<table>
  <tr><th>Paradigm <i>si</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt></tt></td><td><em>si, s'</em></td><td><em>si</em></td></tr>
</table>

### `ADP`

54 <tt><a href="it_pud-pos-ADP.html">ADP</a></tt> tokens (1% of all `ADP` tokens) have a non-empty value of `Number`.

`ADP` tokens may have the following values of `Number`:

* `Plur` (5; 9% of non-empty `Number`): <em>Da, ai, alle, dagli, dai</em>
* `Sing` (49; 91% of non-empty `Number`): <em>al, alla, dell', del, all', della, Sulla, allo, dal, dall'</em>
...
2 <tt><a href="it_pud-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADV` and `Number` co-occurred: <tt><a href="it_pud-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (2; 100%).

`ADV` tokens may have the following values of `Number`:

* `Sing` (2; 100% of non-empty `Number`): <em>più</em>
* `EMPTY` (847): <em>non, più, anche, Tuttavia, solo, ancora, inoltre, dove, già, prima</em>

### `CCONJ`

2 <tt><a href="it_pud-pos-CCONJ.html">CCONJ</a></tt> tokens (0% of all `CCONJ` tokens) have a non-empty value of `Number`.

`CCONJ` tokens may have the following values of `Number`:

* `Sing` (2; 100% of non-empty `Number`): <em>che</em>
* `EMPTY` (580): <em>e, ma, o, ed, sia, che, mentre, quindi, né, oppure</em>

## Relations with Agreement in `Number`

The 10 most frequent relations where parent and child node agree in `Number`:
<tt>NOUN --[<tt><a href="it_pud-dep-det.html">det</a></tt>]--> DET</tt> (3026; 100%),
<tt>NOUN --[<tt><a href="it_pud-dep-amod.html">amod</a></tt>]--> ADJ</tt> (1218; 99%),
<tt>NOUN --[<tt><a href="it_pud-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (646; 58%),
<tt>PROPN --[<tt><a href="it_pud-dep-det.html">det</a></tt>]--> DET</tt> (517; 100%),
<tt>PROPN --[<tt><a href="it_pud-dep-flat.html">flat</a></tt>]--> PROPN</tt> (412; 100%),
<tt>VERB --[<tt><a href="it_pud-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (355; 73%),
...
<tt>VERB --[<tt><a href="it_pud-dep-aux-pass.html">aux:pass</a></tt>]--> AUX</tt> (200; 90%),
