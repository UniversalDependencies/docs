...
* [Aspect](https://universaldependencies.org/u/feat/all.html#al-u-feat/Aspect) has 4 possible values: `Perf` (perfective), `Imp` (imperfective), `Prosp` (prospective), `Hab` (Habitual).
