...
The feature is used with 2 part-of-speech tags: <tt><a href="fi_ftb-pos-AUX.html">AUX</a></tt> (2910; 2% instances), <tt><a href="fi_ftb-pos-VERB.html">VERB</a></tt> (228; 0% instances).
...
* `Neg` (2910; 100% of non-empty `Polarity`): <em>ei, en, eivät, eikä, et, älä, eikö, emme, enkä, eihän</em>
...
* `Neg` (228; 100% of non-empty `Polarity`): <em>ei, en, eivät, Älä, eikä, eikö, Eipäs, eihän, et, ette</em>
* `EMPTY` (27098): <em>on, oli, ole, tulee, olla, tuli, ollut, saa, sanoi, tehdä</em>
