---
layout: base
title:  'Statistics of xcomp in UD_Old_Irish-DipWBG'
udver: '2'
---

## Treebank Statistics: UD_Old_Irish-DipWBG: Relations: `xcomp`
...
The following 1 pairs of parts of speech are connected with `xcomp`: <tt><a href="sga_dipwbg-pos-VERB.html">VERB</a></tt>-<tt><a href="sga_dipwbg-pos-PRON.html">PRON</a></tt> (1; 100% instances).
