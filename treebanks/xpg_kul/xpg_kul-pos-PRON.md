...
There are 10 `PRON` lemmas (4%), 41 `PRON` types (6%) and 150 `PRON` tokens (9%).
...
* <em>ται</em>
  * <tt><a href="xpg_kul-pos-DET.html">DET</a></tt> 1: <em>ξ̣ε̣υνε ιοσος κε δετον̣ [ο?υ]ψοδ̣αν κε τα̣ν σαυναμαν [.?] κ̣νο̣υμαν κ' ακροδμαν κε λο̣δ̣ιμ̣ον μειομον ριδιτι <b>ται</b> τοα̣ μ̣ε̣ ο̣ν̣ομανιας εναρκε⟨ς⟩ ερμω[λ]α̣ο̣ς̣ κναικο⟨ς⟩ εκατηας ο̣μ̣ο̣υσασαι ποσεκανες ακα[.?]δ̣εο ποκ γονιον τευτωσι ιε[.]ν̣ο̣υταις εδαες πινκε τας δ̣[α?]κ̣ερης ονομανιαις μ̣ι̣ρου ικ[.] κ̣ναικαν εδαες , ις αργμενα[.?] ο̣π̣αρικο οαν οεαυται ις κε εν̣ τοισ̣ινιοι κνουμαν τιαν τε [.]</em>
...
The form / lemma ratio of `PRON` is 4.100000 (the average of all parts of speech is 2.934959).
...
The 2nd highest number of forms (7) was observed with the lemma “τος”: <em>τ̣[ος], τ̣ο̣ς̣, ται, ταν, το[ς], τος, του</em>.

The 3rd highest number of forms (5) was observed with the lemma “αυτος”: <em>αυ̣τος, αυταη, αυτον, αυτος, αυτω</em>.

`PRON` occurs with 7 features: <tt><a href="xpg_kul-feat-Case.html">Case</a></tt> (150; 100% instances), <tt><a href="xpg_kul-feat-Number.html">Number</a></tt> (150; 100% instances), <tt><a href="xpg_kul-feat-PronType.html">PronType</a></tt> (150; 100% instances), <tt><a href="xpg_kul-feat-Gender.html">Gender</a></tt> (148; 99% instances), <tt><a href="xpg_kul-feat-ExtPos.html">ExtPos</a></tt> (69; 46% instances), <tt><a href="xpg_kul-feat-Poss.html">Poss</a></tt> (3; 2% instances), <tt><a href="xpg_kul-feat-Reflex.html">Reflex</a></tt> (1; 1% instances)

`PRON` occurs with 18 feature-value pairs: `Case=Acc`, `Case=Dat`, `Case=Gen`, `Case=Nom`, `ExtPos=DET`, `ExtPos=PRON`, `Gender=Fem`, `Gender=Masc`, `Gender=Neut`, `Number=Plur`, `Number=Sing`, `Poss=Yes`, `PronType=Dem`, `PronType=Emp`, `PronType=Ind`, `PronType=Prs`, `PronType=Rel`, `Reflex=Yes`

`PRON` occurs with 24 feature combinations.
The most frequent feature combination is `Case=Nom|ExtPos=PRON|Gender=Masc|Number=Sing|PronType=Rel` (61 tokens).
Examples: <em>ιος, [ιος, [ι]ος, [ι]ο̣ς, [ιο]ς, ειος, ι̣ος, ι̣ς̣, ιο[ς, ιο̣ς̣</em>


## Relations

`PRON` nodes are attached to their parents using 8 different relations: <tt><a href="xpg_kul-dep-nsubj.html">nsubj</a></tt> (114; 76% instances), <tt><a href="xpg_kul-dep-dep.html">dep</a></tt> (12; 8% instances), <tt><a href="xpg_kul-dep-iobj.html">iobj</a></tt> (10; 7% instances), <tt><a href="xpg_kul-dep-det.html">det</a></tt> (9; 6% instances), <tt><a href="xpg_kul-dep-obj.html">obj</a></tt> (2; 1% instances), <tt><a href="xpg_kul-dep-conj.html">conj</a></tt> (1; 1% instances), <tt><a href="xpg_kul-dep-obl.html">obl</a></tt> (1; 1% instances), <tt><a href="xpg_kul-dep-root.html">root</a></tt> (1; 1% instances)

Parents of `PRON` nodes belong to 9 different parts of speech: <tt><a href="xpg_kul-pos-VERB.html">VERB</a></tt> (115; 77% instances), <tt><a href="xpg_kul-pos-NOUN.html">NOUN</a></tt> (9; 6% instances), <tt><a href="xpg_kul-pos-SYM.html">SYM</a></tt> (9; 6% instances), <tt><a href="xpg_kul-pos-PROPN.html">PROPN</a></tt> (5; 3% instances), <tt><a href="xpg_kul-pos-X.html">X</a></tt> (5; 3% instances), <tt><a href="xpg_kul-pos-ADJ.html">ADJ</a></tt> (3; 2% instances), <tt><a href="xpg_kul-pos-AUX.html">AUX</a></tt> (2; 1% instances), <tt><a href="xpg_kul-pos-PRON.html">PRON</a></tt> (1; 1% instances),  (1; 1% instances)

66 (44%) `PRON` nodes are leaves.

77 (51%) `PRON` nodes have one child.
