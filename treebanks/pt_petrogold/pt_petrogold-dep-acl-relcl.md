...
2113 nodes (1%) are attached to their parents as `acl:relcl`.

2113 instances of `acl:relcl` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 5.60293421675343.
