...
There are 323 `ADJ` lemmas (13%), 404 `ADJ` types (12%) and 1215 `ADJ` tokens (3%).
...
The form / lemma ratio of `ADJ` is 1.250774 (the average of all parts of speech is 1.353739).
