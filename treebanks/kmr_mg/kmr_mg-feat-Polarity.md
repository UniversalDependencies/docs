...
* `Neg` (34; 100% of non-empty `Polarity`): <em>meke, nîne, nikarî bû, nizanî, tune, xuya dikir, ceza dikir, dernexist, maye, nade</em>
* `EMPTY` (1008): <em>da, kir, gote, kirin, dike, got, hebû, kiriye, heye, divêt</em>
...
* `Neg` (7; 100% of non-empty `Polarity`): <em>nayê, nehatiye, nehatine</em>
* `EMPTY` (424): <em>e, ye, bû, tê, hatiye, bûn, dibe, dê, bûye, hate</em>
