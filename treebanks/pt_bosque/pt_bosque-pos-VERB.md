...
There are 1915 `VERB` lemmas (9%), 7125 `VERB` types (25%) and 20766 `VERB` tokens (9%).
...
The form / lemma ratio of `VERB` is 3.720627 (the average of all parts of speech is 1.423840).
