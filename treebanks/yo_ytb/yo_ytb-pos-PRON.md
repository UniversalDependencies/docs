...
There are 85 `PRON` lemmas (5%), 86 `PRON` types (5%) and 1354 `PRON` tokens (16%).
...
The form / lemma ratio of `PRON` is 1.011765 (the average of all parts of speech is 1.007366).
...
`PRON` occurs with 5 features: <tt><a href="yo_ytb-feat-PronType.html">PronType</a></tt> (1316; 97% instances), <tt><a href="yo_ytb-feat-Case.html">Case</a></tt> (988; 73% instances), <tt><a href="yo_ytb-feat-Number.html">Number</a></tt> (988; 73% instances), <tt><a href="yo_ytb-feat-Person.html">Person</a></tt> (988; 73% instances), <tt><a href="yo_ytb-feat-Typo.html">Typo</a></tt> (5; 0% instances)
