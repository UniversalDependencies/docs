...
2	1912	_	NUM	CD	Gender=Masc|NumType=Card	4	obl	_	_
3	fue	ser	AUX	VBC	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Pass	4	aux:pass	_	_
4	fundada	_	VERB	VBN	Gender=Fem|Number=Sing|VerbForm=Fin	0	root	_	_
...
12	Film	_	NOUN	NN	Number=Sing	11	flat:name	_	SpaceAfter=No|Proper=True
13	)	_	PUNCT	)	_	11	punct	_	_
14	y	_	CCONJ	CC	_	16	cc	_	_
15	en	_	ADP	IN	_	16	case	_	orig_deprel=obl
16	1916	_	NUM	CD	Gender=Masc|NumType=Card	2	conj	_	SpaceAfter=No
17	,	_	PUNCT	,	_	18	punct	_	_
18	Asty	_	PROPN	NNP	Number=Sing	15	orphan	_	_
19	Film	_	NOUN	NN	Number=Sing	18	flat:name	_	SpaceAfter=No|orig_deprel=nsubj:pass|Proper=True
...
15	este	_	DET	DT	Gender=Masc|Number=Sing|PronType=Dem	16	det	_	_
...
19	dormir	_	VERB	VB	Aspect=Imp|VerbForm=Fin|Voice=Act	18	xcomp	_	_
...
7	conoce	_	VERB	VBC	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Pass	0	root	_	_
