...
3	ҿан	а-ҿазаара́	VERB	V_Stat_Fin_Impf_S:3_S:Ad_[LO:3SgNH]	Dyn=No|Gender[lo]=Neut|Number[lo]=Sing|Person[lo]=3|Person[subj]=3|Tense=Imp|VerbForm=Fin	0	root	_	LMSeg:а-ҿа-заа-ра́|SpaceAfter=No
...
7	иатәын	а-тәы́заара	VERB	V_Stat_Fin_Impf_S:3_IO:3SgNH	Dyn=No|Gender[io]=Neut|Number[io]=Sing|Person[io]=3|Person[subj]=3|Tense=Imp|VerbForm=Fin	3	conj	_	LMSeg:а-тәы́-заа-ра|SpaceAfter=No
