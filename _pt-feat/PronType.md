...
41927 tokens (19%) have a non-empty value of `PronType`.
...
The feature is used with 6 part-of-speech tags: [pt-pos/DET]() (33410; 15% instances), [pt-pos/PRON]() (6021; 3% instances), [pt-pos/ADV]() (2352; 1% instances), [pt-pos/ADP]() (142; 0% instances), [pt-pos/CONJ]() (1; 0% instances), [pt-pos/SCONJ]() (1; 0% instances).

### `DET`

33410 [pt-pos/DET]() tokens (97% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: .

`DET` tokens may have the following values of `PronType`:

* `Art` (29307; 88% of non-empty `PronType`): __
* `Dem` (1286; 4% of non-empty `PronType`): __
* `Ind,Neg,Tot` (1394; 4% of non-empty `PronType`): __
* `Int` (57; 0% of non-empty `PronType`): __
* `Prs` (1292; 4% of non-empty `PronType`): __
* `Rel` (74; 0% of non-empty `PronType`): __
...
<table>
  ...
  <tr><td><tt><a href="Definite.html">Definite</a>=Def|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td><i>o, Os, a</i></td><td></td></tr>
  ...
  <tr><td><tt><a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td><i>o</i></td><td><i>o, os</i></td></tr>
...
6021 [pt-pos/PRON]() tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: .

`PRON` tokens may have the following values of `PronType`:

* `Dem` (245; 4% of non-empty `PronType`): __
* `Ind` (133; 2% of non-empty `PronType`): __
* `Ind,Neg,Tot` (179; 3% of non-empty `PronType`): __
* `Int` (75; 1% of non-empty `PronType`): __
* `Prs` (2739; 45% of non-empty `PronType`): __
* `Rcp` (4; 0% of non-empty `PronType`): __
* `Rel` (2646; 44% of non-empty `PronType`): __

<table>
  <tr><th>Paradigm <i>que</i></th><th><tt>Int</tt></th><th><tt>Rel</tt></th><th><tt>Ind</tt></th></tr>
  <tr><td><tt>_</tt></td><td></td><td><i>que</i></td><td><i>que</i></td></tr>
...
142 [pt-pos/ADP]() tokens (0% of all `ADP` tokens) have a non-empty value of `PronType`.
...
* `Ind,Neg,Tot` (1; 1% of non-empty `PronType`): __
* `Rel` (141; 99% of non-empty `PronType`): __
...
1 [pt-pos/CONJ]() tokens (0% of all `CONJ` tokens) have a non-empty value of `PronType`.

`CONJ` tokens may have the following values of `PronType`:

* `Ind,Neg,Tot` (1; 100% of non-empty `PronType`): __
