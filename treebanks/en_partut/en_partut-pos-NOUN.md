...
There are 2431 `NOUN` lemmas (38%), 2948 `NOUN` types (39%) and 10571 `NOUN` tokens (21%).
...
`NOUN` occurs with 2 features: <tt><a href="en_partut-feat-Number.html">Number</a></tt> (10504; 99% instances), <tt><a href="en_partut-feat-Gender.html">Gender</a></tt> (403; 4% instances)
