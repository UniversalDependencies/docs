...
The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="Tense.html">Tense</a>=EMPTY</tt> (7634; 100%), <tt><a href="VerbType.html">VerbType</a>=EMPTY</tt> (6829; 89%), <tt><a href="Negative.html">Negative</a>=EMPTY</tt> (6829; 89%), <tt><a href="Person.html">Person</a>=1,2,3</tt> (4232; 55%).
...
The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="Tense.html">Tense</a>=EMPTY</tt> (114; 100%), <tt><a href="VerbType.html">VerbType</a>=Mod</tt> (114; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (96; 84%), <tt><a href="Person.html">Person</a>=1,2,3</tt> (94; 82%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (65; 57%).
