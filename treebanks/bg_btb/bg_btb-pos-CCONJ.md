...
There are 25 `CCONJ` lemmas (0%), 29 `CCONJ` types (0%) and 4861 `CCONJ` tokens (3%).
...
The form / lemma ratio of `CCONJ` is 1.160000 (the average of all parts of speech is 1.727244).
