---
layout: base
title:  'Statistics of Definite in UD_Beja-Autogramm'
udver: '2'
---

## Treebank Statistics: UD_Beja-Autogramm: Features: `Definite`

This feature is universal.
It occurs with 2 different values: `Def`, `Ind`.

1072 tokens (9%) have a non-empty value of `Definite`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="bej_autogramm-pos-DET.html">DET</a></tt> (1034; 9% instances), <tt><a href="bej_autogramm-pos-PRON.html">PRON</a></tt> (34; 0% instances), <tt><a href="bej_autogramm-pos-SCONJ.html">SCONJ</a></tt> (4; 0% instances).
...
* `Def` (1007; 97% of non-empty `Definite`): <em>i=, oː=, w=, ti=, uː=, t=, j=, toː=, aː=, tuː=</em>
* `Ind` (27; 3% of non-empty `Definite`): <em>=t, =b</em>
* `EMPTY` (702): <em>=t, oːn, uːn, =b, eːn, aːn, beːn, oːt, eːt, toːt</em>
