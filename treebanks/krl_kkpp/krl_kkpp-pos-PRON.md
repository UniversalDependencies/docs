...
There are 23 `PRON` lemmas (2%), 86 `PRON` types (6%) and 288 `PRON` tokens (9%).
...
The form / lemma ratio of `PRON` is 3.739130 (the average of all parts of speech is 1.497382).
