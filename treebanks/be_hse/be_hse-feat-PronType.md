...
16985 tokens (6%) have a non-empty value of `PronType`.
637 types (1%) occur at least once with a non-empty value of `PronType`.
117 lemmas (0%) occur at least once with a non-empty value of `PronType`.
The feature is used with 2 part-of-speech tags: <tt><a href="be_hse-pos-PRON.html">PRON</a></tt> (10302; 3% instances), <tt><a href="be_hse-pos-DET.html">DET</a></tt> (6683; 2% instances).

### `PRON`

10302 <tt><a href="be_hse-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="be_hse-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (7135; 69%), <tt><a href="be_hse-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6592; 64%), <tt><a href="be_hse-feat-Case.html">Case</a></tt><tt>=Nom</tt> (5479; 53%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (1267; 12% of non-empty `PronType`): <em>гэта, тое, таго, тым, гэтым, гэтага, то, нечага, таму, Т.</em>
...
* `EMPTY` (20): <em>што, то, яго, Гэта, беларуска, т., якая, якую, ён, ёю</em>
...
6683 <tt><a href="be_hse-pos-DET.html">DET</a></tt> tokens (99% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="be_hse-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (5916; 89%), <tt><a href="be_hse-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (5302; 79%), <tt><a href="be_hse-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4274; 64%), <tt><a href="be_hse-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (4143; 62%).
...
* `Prs` (2506; 37% of non-empty `PronType`): <em>яго, наш, яе, свой, іх, сваю, свае, сваёй, нашай, нашым</em>
...
<tt>DET --[<tt><a href="be_hse-dep-conj.html">conj</a></tt>]--> DET</tt> (18; 56%),
<tt>PRON --[<tt><a href="be_hse-dep-conj.html">conj</a></tt>]--> PRON</tt> (15; 83%),
<tt>DET --[<tt><a href="be_hse-dep-fixed.html">fixed</a></tt>]--> DET</tt> (9; 90%),
