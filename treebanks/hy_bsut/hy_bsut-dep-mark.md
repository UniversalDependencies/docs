---
layout: base
title:  'Statistics of mark in UD_Armenian-BSUT'
udver: '2'
---

## Treebank Statistics: UD_Armenian-BSUT: Relations: `mark`
...
1	Համաձայնեք	համաձայնել	VERB	_	Aspect=Prosp|Mood=Imp|Number=Plur|Person=2|Subcat=Intr|VerbForm=Fin|Voice=Mid	0	root	_	Translit=Hamajaynek’|LTranslit=hamajaynel|SpaceAfter=No
2	,	,	PUNCT	_	_	5	punct	_	Translit=,|LTranslit=,
3	որ	որ	SCONJ	_	_	5	mark	_	Translit=or|LTranslit=or
4	հիանալի	հիանալի	ADJ	_	_	5	amod	_	Translit=hianali|LTranslit=hianali
5	գաղափար	գաղափար	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	1	advcl	_	Translit=gaġap’ar|LTranslit=gaġap’ar
