...
1	ใคร	_	PRON	WP	PronType=Int	3	nsubj	_	SpaceAfter=No|Translit=gʰair
2	จะ	_	AUX	MD	_	3	aux	_	SpaceAfter=No|Translit=ča
3	หยุด	_	VERB	VV	_	0	root	_	SpaceAfter=No|Translit=hyud
4	ฝั่ง	_	NOUN	NN	_	3	obj	_	SpaceAfter=No|Translit=fʰâ¹ŋ
5	ออสเตรเลีย	_	PROPN	NNP	_	4	compound	_	SpaceAfter=No|Translit='ɔːstérlíá
6	นี้	_	DET	DT	_	4	det	_	SpaceAfter=No|Translit=ní²
7	ได้	_	AUX	MD	_	3	aux	_	SpaceAfter=No|Translit=dai²
8	?	_	PUNCT	.	_	3	punct	_	Translit=?
...
1	แน่นอน	_	ADJ	JJ	_	0	root	_	SpaceAfter=No|Translit=nǽ¹nɔːn
2	ว่า	_	ADP	IN	_	5	mark	_	SpaceAfter=No|Translit=wá¹
3	นี่	_	PRON	PRD	_	5	nsubj	_	SpaceAfter=No|Translit=ní¹
4	คือ	_	AUX	VC	_	5	cop	_	SpaceAfter=No|Translit=gʰű'
5	การเลือกตั้ง	_	VERB	VV	_	1	ccomp	_	Translit=kárlűáktâ²ŋ
6	ไม่	_	PART	NEG	Polarity=Neg	9	advmod	_	SpaceAfter=No|Translit=mai¹
7	ใช่	_	AUX	VC	_	9	cop	_	Translit=ćʰai¹
8	"	_	PUNCT	``	_	9	punct	_	SpaceAfter=No|Translit="
9	มหาศึก	_	NOUN	NN	_	5	acl	_	Proper=True|SpaceAfter=No|Translit=mháśük
10	ชิง	_	VERB	VV	_	9	acl	_	Proper=True|SpaceAfter=No|Translit=ćʰiŋ
11	บัลลังก์	_	NOUN	NN	_	10	obj	_	Proper=True|SpaceAfter=No|Translit=bâllâŋk
...
1	เพลง	_	NOUN	NN	_	5	nsubj	_	SpaceAfter=No|Translit=bʰélŋ
2	ฮิต	_	ADJ	JJ	_	1	amod	_	SpaceAfter=No|Translit=ḥit
3	คือ	_	AUX	VC	_	5	cop	_	Translit=gʰű'
4	“	_	PUNCT	``	_	5	punct	_	SpaceAfter=No|Translit=“
