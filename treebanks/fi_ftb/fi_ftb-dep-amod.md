...
6889 nodes (4%) are attached to their parents as `amod`.

6790 instances of `amod` (99%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.17448105675715.
