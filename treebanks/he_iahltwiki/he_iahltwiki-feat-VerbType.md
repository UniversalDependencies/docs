---
layout: base
title:  'Statistics of VerbType in UD_Hebrew-IAHLTwiki'
udver: '2'
---

## Treebank Statistics: UD_Hebrew-IAHLTwiki: Features: `VerbType`

This feature is language-specific.
It occurs with 2 different values: `Cop`, `Mod`.

405 tokens (0%) have a non-empty value of `VerbType`.
51 types (0%) occur at least once with a non-empty value of `VerbType`.
22 lemmas (0%) occur at least once with a non-empty value of `VerbType`.
The feature is used with 2 part-of-speech tags: <tt><a href="he_iahltwiki-pos-AUX.html">AUX</a></tt> (340; 0% instances), <tt><a href="he_iahltwiki-pos-VERB.html">VERB</a></tt> (65; 0% instances).
...
* `Cop` (266; 78% of non-empty `VerbType`): היה, הייתה, היו, תהיה, יהיה, להיות, יהיו, אינה, אינו, הייתי
* `Mod` (74; 22% of non-empty `VerbType`): יכולים, יכולה, יכול, תוכל, עלול, עלולים, צריך, מוכן, מסוגלת, עשויה

`VerbType` seems to be **lexical feature** of `AUX`. 100% lemmas (14) occur only with one value of `VerbType`.
...
* `Mod` (65; 100% of non-empty `VerbType`): ניתן, אפשר, יש, ייתכן, אין, אסור, זכאים, יכול, ניתנות, צריך
