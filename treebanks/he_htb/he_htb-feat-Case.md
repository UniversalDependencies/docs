...
2585 <tt><a href="he_htb-pos-PRON.html">PRON</a></tt> tokens (34% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="he_htb-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (2585; 100%), <tt><a href="he_htb-feat-Person.html">Person</a></tt><tt>=3</tt> (2460; 95%), <tt><a href="he_htb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1946; 75%), <tt><a href="he_htb-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (1879; 73%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (48; 2% of non-empty `Case`): _הוא, _הם, _היא, _הן, _אני, _אתה, _אתם
* `Gen` (2537; 98% of non-empty `Case`): _הוא, _היא, _הם, _הן, _אני, _אנחנו, _אתה, _אתם, _את
* `EMPTY` (5121): הוא, _הוא, זה, _הם, היא, _היא, הם, זו, כך, אלה
...
112 <tt><a href="he_htb-pos-SCONJ.html">SCONJ</a></tt> tokens (2% of all `SCONJ` tokens) have a non-empty value of `Case`.

`SCONJ` tokens may have the following values of `Case`:

* `Tem` (112; 100% of non-empty `Case`): כש, מש
* `EMPTY` (5408): ש, ה, כי, אם, כאשר, אשר, משום, כפי, ככל, שכן
...
* `Tem` (26; 100% of non-empty `Case`): 20.30, 20.00, 01.00, 1.2.19, 1.6.90, 13.00, 13.11, 14.3.89, 16.11, 2.3.3
* `EMPTY` (3262): אחד, שני, אחת, שתי, 1, 0, מיליון, אלף, 2, שלושה
...
<tt>PRON --[<tt><a href="he_htb-dep-case.html">case</a></tt>]--> ADP</tt> (48; 98%).
