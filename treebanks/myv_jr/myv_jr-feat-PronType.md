...
The feature is used with 5 part-of-speech tags: <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> (840; 5% instances), <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> (161; 1% instances), <tt><a href="myv_jr-pos-DET.html">DET</a></tt> (82; 0% instances), <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> (32; 0% instances), <tt><a href="myv_jr-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances).

### `PRON`

840 <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> tokens (89% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (739; 88%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (563; 67%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (547; 65%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (504; 60%).
...
* `Int` (96; 11% of non-empty `PronType`): <em>мезе, кие, ки, месть, мейсь, кинь, мезень, мезть, мезес, кинень</em>
* `Prs` (452; 54% of non-empty `PronType`): <em>сон, мон, сонзэ, сонсь, минь, тензэ, сынь, минек, тон, сынст</em>
...
161 <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> tokens (11% of all `ADV` tokens) have a non-empty value of `PronType`.
...
* `Int` (99; 61% of non-empty `PronType`): <em>кода, ков, косто, косо, зняро, зярдо, мекс, козонь, Мезекс, зяро</em>
...
* `EMPTY` (1292): <em>ансяк, пек, истя, мейле, ней, уш, седе, прок, яла, курок</em>
...
82 <tt><a href="myv_jr-pos-DET.html">DET</a></tt> tokens (43% of all `DET` tokens) have a non-empty value of `PronType`.
...
* `Prs` (4; 5% of non-empty `PronType`): <em>эсь, эсинзэ</em>
* `Rel` (4; 5% of non-empty `PronType`): <em>конань, конат</em>
* `Tot` (11; 13% of non-empty `PronType`): <em>эрьва</em>
* `EMPTY` (108): <em>эрьва, те, ве, ламо, лия, эсь, аламо, зяро, кона, ламотне</em>
...
* `EMPTY` (632): <em>од, паро, покш, якстере, мазый, сэрей, омбоце, пиже, васень, тусто</em>
