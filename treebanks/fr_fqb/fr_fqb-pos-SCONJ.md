---
layout: base
title:  'Statistics of SCONJ in UD_French-FQB'
udver: '2'
---

## Treebank Statistics: UD_French-FQB: POS Tags: `SCONJ`

There are 4 `SCONJ` lemmas (0%), 5 `SCONJ` types (0%) and 180 `SCONJ` tokens (1%).
Out of 16 observed tags, the rank of `SCONJ` is: 13 in number of lemmas, 14 in number of types and 12 in number of tokens.

The 10 most frequent `SCONJ` lemmas: <em>que, _, si, lorsque</em>
...
The form / lemma ratio of `SCONJ` is 1.250000 (the average of all parts of speech is 1.164665).
...
The 3rd highest number of forms (1) was observed with the lemma “_”: <em>que</em>.
...
`SCONJ` nodes are attached to their parents using 2 different relations: <tt><a href="fr_fqb-dep-mark.html">mark</a></tt> (170; 94% instances), <tt><a href="fr_fqb-dep-fixed.html">fixed</a></tt> (10; 6% instances)

Parents of `SCONJ` nodes belong to 8 different parts of speech: <tt><a href="fr_fqb-pos-NOUN.html">NOUN</a></tt> (128; 71% instances), <tt><a href="fr_fqb-pos-VERB.html">VERB</a></tt> (26; 14% instances), <tt><a href="fr_fqb-pos-PROPN.html">PROPN</a></tt> (13; 7% instances), <tt><a href="fr_fqb-pos-ADV.html">ADV</a></tt> (6; 3% instances), <tt><a href="fr_fqb-pos-ADP.html">ADP</a></tt> (4; 2% instances), <tt><a href="fr_fqb-pos-ADJ.html">ADJ</a></tt> (1; 1% instances), <tt><a href="fr_fqb-pos-PRON.html">PRON</a></tt> (1; 1% instances), <tt><a href="fr_fqb-pos-X.html">X</a></tt> (1; 1% instances)

180 (100%) `SCONJ` nodes are leaves.
