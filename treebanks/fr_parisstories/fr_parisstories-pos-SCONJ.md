...
There are 10 `SCONJ` lemmas (0%), 13 `SCONJ` types (0%) and 946 `SCONJ` tokens (2%).
...
The form / lemma ratio of `SCONJ` is 1.300000 (the average of all parts of speech is 1.353739).
