...
* `Dem` (88; 10% of non-empty `PronType`): <em>_, wan, ev, ew, vê</em>
* `Ind` (13; 1% of non-empty `PronType`): <em>tukesî, yekî, Gelek, Herçî, gelekê, heryekê, hevdu, ve, vê</em>
* `Int` (13; 1% of non-empty `PronType`): <em>çi, Kî</em>
* `Prs` (759; 87% of non-empty `PronType`): <em>xwe, min, me, wî, em, ez, ew, wê, te, tu</em>
* `Rcp` (1; 0% of non-empty `PronType`): <em>hevûdin</em>
* `Rel` (2; 0% of non-empty `PronType`): <em>kû</em>
...
* `Dem` (102; 33% of non-empty `PronType`): <em>demê, derê, navê, şanî, armancê, awayî, babetê, beşdarî, caran, gundî</em>
* `Ind` (203; 67% of non-empty `PronType`): <em>dengekî, tiştek, tiştekî, carekê, kesekî, malbateke, meymûnek, mirovekî, nişkekê, odeke</em>
* `EMPTY` (2348): <em>sala, oda, Dr., xweha, zirbavê, gund, navê, serê, zimanê, kurdan</em>
...
* `Dem` (103; 46% of non-empty `PronType`): <em>vê, ev, wê, ew, vî, van, wî, wan, _</em>
* `Ind` (114; 51% of non-empty `PronType`): <em>her, hin, gelek, çend, tu, hinek, heman, hemî, hemû, ti</em>
* `Int` (5; 2% of non-empty `PronType`): <em>çi, çiqas</em>
* `Prs` (1; 0% of non-empty `PronType`): <em>wî</em>
