...
There are 842 `NUM` lemmas (4%), 855 `NUM` types (3%) and 4660 `NUM` tokens (2%).
...
The form / lemma ratio of `NUM` is 1.015439 (the average of all parts of speech is 1.423840).
...
`NUM` occurs with 4 features: <tt><a href="pt_bosque-feat-NumType.html">NumType</a></tt> (4642; 100% instances), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (183; 4% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (166; 4% instances), <tt><a href="pt_bosque-feat-ExtPos.html">ExtPos</a></tt> (14; 0% instances)
