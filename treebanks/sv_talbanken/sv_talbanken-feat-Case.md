...
The most frequent other feature values with which `NOUN` and `Case` co-occurred: <tt><a href="sv_talbanken-feat-Gender.html">Gender</a></tt><tt>=Com</tt> (15646; 70%), <tt><a href="sv_talbanken-feat-Number.html">Number</a></tt><tt>=Sing</tt> (15352; 68%), <tt><a href="sv_talbanken-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (14739; 66%).
...
* `EMPTY` (564): <em>kr, %, dr, s., kap., proc, KPI, milj, mån, kl</em>
...
`Case` seems to be **lexical feature** of `NOUN`. 95% lemmas (5539) occur only with one value of `Case`.

### `ADJ`

8472 <tt><a href="sv_talbanken-pos-ADJ.html">ADJ</a></tt> tokens (99% of all `ADJ` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `ADJ` and `Case` co-occurred: <tt><a href="sv_talbanken-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (7464; 88%), <tt><a href="sv_talbanken-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (7198; 85%), <tt><a href="sv_talbanken-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (7198; 85%), <tt><a href="sv_talbanken-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (5532; 65%), <tt><a href="sv_talbanken-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (5119; 60%).
...
* `Nom` (8452; 100% of non-empty `Case`): <em>olika, andra, nya, många, stora, stor, samma, större, vissa, första</em>
* `EMPTY` (81): <em>s k, s.k., European, New, S:t, ev, resp, American, Boiling, Central</em>

<table>
  <tr><th>Paradigm <i>annan</i></th><th><tt>Nom</tt></th><th><tt>Gen</tt></th></tr>
  <tr><td><tt><tt><a href="sv_talbanken-feat-Definite.html">Definite</a></tt><tt>=Def</tt></tt></td><td><em>andra, andre</em></td><td></td></tr>
...
`Case` seems to be **lexical feature** of `ADJ`. 99% lemmas (1790) occur only with one value of `Case`.

### `PRON`

2609 <tt><a href="sv_talbanken-pos-PRON.html">PRON</a></tt> tokens (39% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="sv_talbanken-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (2609; 100%), <tt><a href="sv_talbanken-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (1929; 74%), <tt><a href="sv_talbanken-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1888; 72%), <tt><a href="sv_talbanken-feat-Gender.html">Gender</a></tt><tt>=Com</tt> (1681; 64%).
...
1733 <tt><a href="sv_talbanken-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `NUM` and `Case` co-occurred: <tt><a href="sv_talbanken-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (1733; 100%).

`NUM` tokens may have the following values of `Case`:

* `Nom` (1733; 100% of non-empty `Case`): <em>två, tre, en, 1, 20, 2, ett, 1970, 3, 10</em>
* `EMPTY` (7): <em>ett-, 1700-, 1950-, två-</em>

`Case` seems to be **lexical feature** of `NUM`. 100% lemmas (479) occur only with one value of `Case`.

### `PROPN`

1334 <tt><a href="sv_talbanken-pos-PROPN.html">PROPN</a></tt> tokens (98% of all `PROPN` tokens) have a non-empty value of `Case`.

`PROPN` tokens may have the following values of `Case`:

* `Gen` (153; 11% of non-empty `Case`): <em>Sveriges, EEC:s, Guds, Stockholms, FN:s, Kristi, KF:s, Parsons, Europas, Jesu</em>
* `Nom` (1181; 89% of non-empty `Case`): <em>Sverige, EEC, Stockholm, USA, ATP, Gud, Göteborg, Horn, Danmark, Indien</em>
* `EMPTY` (26): <em>A, AF, Atlantic, B, Belgien, CH, D, DK, Danmark, F</em>
...
`Case` seems to be **lexical feature** of `PROPN`. 92% lemmas (474) occur only with one value of `Case`.

### `VERB`

49 <tt><a href="sv_talbanken-pos-VERB.html">VERB</a></tt> tokens (1% of all `VERB` tokens) have a non-empty value of `Case`.
...
<tt>NOUN --[<tt><a href="sv_talbanken-dep-amod.html">amod</a></tt>]--> ADJ</tt> (5797; 97%),
<tt>NOUN --[<tt><a href="sv_talbanken-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (3052; 95%),
<tt>NOUN --[<tt><a href="sv_talbanken-dep-conj.html">conj</a></tt>]--> NOUN</tt> (1926; 92%),
<tt>NOUN --[<tt><a href="sv_talbanken-dep-nummod.html">nummod</a></tt>]--> NUM</tt> (941; 80%),
<tt>ADJ --[<tt><a href="sv_talbanken-dep-obl.html">obl</a></tt>]--> NOUN</tt> (547; 97%),
<tt>ADJ --[<tt><a href="sv_talbanken-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (486; 100%),
<tt>ADJ --[<tt><a href="sv_talbanken-dep-conj.html">conj</a></tt>]--> ADJ</tt> (375; 99%),
<tt>NOUN --[<tt><a href="sv_talbanken-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (255; 94%),
<tt>NOUN --[<tt><a href="sv_talbanken-dep-appos.html">appos</a></tt>]--> NOUN</tt> (245; 90%),
<tt>PROPN --[<tt><a href="sv_talbanken-dep-conj.html">conj</a></tt>]--> PROPN</tt> (220; 96%).
