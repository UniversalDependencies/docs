...
The form / lemma ratio of `PUNCT` is 1.000000 (the average of all parts of speech is 1.200484).
...
`PUNCT` nodes are attached to their parents using 1 different relations: <tt><a href="hi_hdtb-dep-punct.html">punct</a></tt> (23455; 100% instances)
