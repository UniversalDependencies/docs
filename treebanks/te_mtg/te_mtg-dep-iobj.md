---
layout: base
title:  'Statistics of iobj in UD_Telugu-MTG'
udver: '2'
---

## Treebank Statistics: UD_Telugu-MTG: Relations: `iobj`

This relation is universal.

38 nodes (1%) are attached to their parents as `iobj`.

38 instances of `iobj` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.39473684210526.

The following 3 pairs of parts of speech are connected with `iobj`: <tt><a href="te_mtg-pos-VERB.html">VERB</a></tt>-<tt><a href="te_mtg-pos-PRON.html">PRON</a></tt> (23; 61% instances), <tt><a href="te_mtg-pos-VERB.html">VERB</a></tt>-<tt><a href="te_mtg-pos-NOUN.html">NOUN</a></tt> (9; 24% instances), <tt><a href="te_mtg-pos-VERB.html">VERB</a></tt>-<tt><a href="te_mtg-pos-PROPN.html">PROPN</a></tt> (6; 16% instances).
