---
layout: base
title:  'Statistics of punct in UD_Old_English-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Old_English-Cairo: Relations: `punct`

This relation is universal.

25 nodes (15%) are attached to their parents as `punct`.

20 instances of `punct` (80%) are left-to-right (parent precedes child).
Average distance between parent and child is 4.84.

The following 4 pairs of parts of speech are connected with `punct`: <tt><a href="ang_cairo-pos-VERB.html">VERB</a></tt>-<tt><a href="ang_cairo-pos-PUNCT.html">PUNCT</a></tt> (20; 80% instances), <tt><a href="ang_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ang_cairo-pos-PUNCT.html">PUNCT</a></tt> (2; 8% instances), <tt><a href="ang_cairo-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ang_cairo-pos-PUNCT.html">PUNCT</a></tt> (2; 8% instances), <tt><a href="ang_cairo-pos-ADJ.html">ADJ</a></tt>-<tt><a href="ang_cairo-pos-PUNCT.html">PUNCT</a></tt> (1; 4% instances).
...
3	micel	micel	ADJ	JJ	Case=Nom|Gender=Masc|Number=Sing	4	amod	_	Gloss=big|Hyperlemma=much|Root=*méǵh₂s
4	rice	rice	NOUN	NN	Case=Nom|Gender=Masc|Number=Sing	0	root	_	Gloss=country|Hyperlemma=rich|Root=*rīkī
5	oþþe	oþþe	CCONJ	CC	_	6	cc	_	Gloss=or|Hyperlemma=or|Root=*efþau
6	lytel	lytel	ADJ	JJ	Case=Nom|Gender=Masc|Number=Sing	4	conj	_	Gloss=small|Hyperlemma=little|Root=*lūtil|SpaceAfter=No
