...
There are 98 `ADP` lemmas (0%), 100 `ADP` types (0%) and 36611 `ADP` tokens (16%).
...
The form / lemma ratio of `ADP` is 1.020408 (the average of all parts of speech is 1.418361).

The 1st highest number of forms (4) was observed with the lemma “_”: <em>a, com, de, por</em>.

The 2nd highest number of forms (3) was observed with the lemma “a”: <em>As, a, e</em>.
