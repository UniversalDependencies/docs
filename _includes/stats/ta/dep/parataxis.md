...
The following 4 pairs of parts of speech are connected with `parataxis`: [ta-pos/VERB]()-[ta-pos/AUX]() (2; 40% instances), [ta-pos/NOUN]()-[ta-pos/AUX]() (1; 20% instances), [ta-pos/NOUN]()-[ta-pos/VERB]() (1; 20% instances), [ta-pos/VERB]()-[ta-pos/VERB]() (1; 20% instances).
...
1	இது	இது	PRON	RpN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3|PronType=Prs	6	nsubj	_	Translit=itu|LTranslit=itu
2	சர்வதேச	சர்வதேசம்	PROPN	NO--3SN--	Gender=Neut|Number=Sing|Person=3	3	nmod	_	Translit=carvatēca|LTranslit=carvatēcam
3	விதிமுறைகளைக்	விதிமுறை	NOUN	NNA-3PN--	Case=Acc|Gender=Neut|Number=Plur|Person=3	4	obj	_	Translit=vitimuraikaḷaik|LTranslit=vitimurai
4	காட்டிலும்	காட்டிலும்	PART	Tb-------	_	6	advmod	_	Translit=kāṭṭilum|LTranslit=kāṭṭilum
5	முற்றிலும்	முற்றிலும்	ADV	AA-------	_	6	advmod	_	Translit=murrilum|LTranslit=murrilum
6	மாறுபட்ட்	மாறுபடு	VERB	Vt-T---AA	Polarity=Pos|VerbForm=Part|Voice=Act	0	root	_	Translit=mārupaṭṭ|LTranslit=mārupaṭu
7	உள்ளது	உள்	AUX	VR-T3SNAA	Gender=Neut|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|VerbForm=Fin|Voice=Act	6	parataxis	_	Translit=uḷḷatu|LTranslit=uḷ
...
1	எனக்கு	என்	PRON	RpD-1SA--	Animacy=Anim|Case=Dat|Gender=Com|Number=Sing|Person=1|PronType=Prs	4	obj	_	Translit=enakku|LTranslit=en
2	ஆயுள்	ஆயுள்	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	3	nmod	_	Translit=āyuḷ|LTranslit=āyuḷ
3	தண்டனை	தண்டனை	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	4	obj	_	Translit=taṇṭanai|LTranslit=taṇṭanai
4	விதித்தால்	விதி	VERB	Vw-T---AA	Mood=Cnd|Polarity=Pos|VerbForm=Fin|Voice=Act	20	advcl	_	Translit=vitittāl|LTranslit=viti
5	உம்	உம்	PART	Ts-------	_	4	mark	_	Translit=um|LTranslit=um
6	அல்லது	அல்லது	CCONJ	CC-------	_	11	cc	_	Translit=allatu|LTranslit=allatu
7	சாகும்	சாகு	ADJ	Jd-F----A	Polarity=Pos|Tense=Fut|VerbForm=Part	8	amod	_	Translit=cākum|LTranslit=cāku
8	வரை	வரை	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	11	obl	_	Translit=varai|LTranslit=varai
9	சிறையில்	சிறை	NOUN	NNL-3SN--	Case=Loc|Gender=Neut|Number=Sing|Person=3	11	obl	_	Translit=ciraiyil|LTranslit=cirai
10	ஏயே	ஏயே	PART	Tk-------	_	9	advmod:emph	_	Translit=ēyē|LTranslit=ēyē
11	அடைத்து	அதை	VERB	Vt-T---AA	Polarity=Pos|VerbForm=Part|Voice=Act	4	conj	_	Translit=aṭaittu|LTranslit=atai
12	வைத்தால்	வை	AUX	VW-T---AA	Mood=Cnd|Polarity=Pos|VerbForm=Fin|Voice=Act	11	aux	_	Translit=vaittāl|LTranslit=vai
13	உம்	உம்	PART	Ts-------	_	11	mark	_	Translit=um|LTranslit=um
14	செய்யாத	செய்	ADJ	Jd-T----N	Polarity=Neg|VerbForm=Part	15	amod	_	Translit=ceyyāta|LTranslit=cey
15	குற்றத்துக்க்	குற்றம்	NOUN	NND-3SN--	Case=Dat|Gender=Neut|Number=Sing|Person=3	16	obl	_	Translit=kurrattukk|LTranslit=kurram
16	ஆக	ஆக	ADV	AA-------	_	20	advmod	_	Translit=āka|LTranslit=āka
17	யார்	யார்	PRON	RiN-3SA--	Animacy=Anim|Case=Nom|Gender=Com|Number=Sing|Person=3|PronType=Int	20	obl	_	Translit=yār|LTranslit=yār
18	இடம்	இடம்	ADP	PP-------	AdpType=Post	17	case	_	Translit=iṭam|LTranslit=iṭam
19	உம்	உம்	PART	Tv-------	_	17	advmod:emph	_	Translit=um|LTranslit=um
20	மன்னிப்பு	மன்னிப்பு	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	0	root	_	Translit=mannippu|LTranslit=mannippu
