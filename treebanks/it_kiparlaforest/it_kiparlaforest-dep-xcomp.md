---
layout: base
title:  'Statistics of xcomp in UD_Italian-KIParlaForest'
udver: '2'
---

## Treebank Statistics: UD_Italian-KIParlaForest: Relations: `xcomp`
...
1	tanto	tanto	ADV	_	_	3	advmod	_	Begin=1542.335|KID=977-0
2	ti	ti	PRON	_	Number=Sing|Person=2|PronType=Prs	3	iobj	_	Clitic=Yes|KID=977-1
3	fa	fare	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	KID=977-2
4	pure	pure	ADV	_	_	5	advmod	_	KID=977-3
5	schifo	schifo	NOUN	_	Gender=Masc|Number=Sing	3	xcomp	_	KID=977-4
6	perché	perché	ADV	_	_	8	advmod	_	KID=977-5
7	lo	lo	PRON	_	Gender=Masc|Number=Sing|Person=3|PronType=Prs	8	det	_	Clitic=Yes|KID=977-6
8	magni	mangere	VERB	_	Mood=Imp|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin	3	parataxis	_	End=1544.449|KID=977-7|OverlappingGroup=165|Prolonged=Yes|Variation=Yes
