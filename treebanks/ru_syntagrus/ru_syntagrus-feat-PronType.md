...
27807 <tt><a href="ru_syntagrus-pos-DET.html">DET</a></tt> tokens (68% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="ru_syntagrus-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (19049; 69%), <tt><a href="ru_syntagrus-feat-Number.html">Number</a></tt><tt>=Sing</tt> (16426; 59%).

`DET` tokens may have the following values of `PronType`:

* `Dem` (11178; 40% of non-empty `PronType`): <em>эти, этот, этой, такой, этом, этого, тех, этих, это, эта</em>
...
`PronType` seems to be **lexical feature** of `DET`. 100% lemmas (29) occur only with one value of `PronType`.
...
<tt>DET --[<tt><a href="ru_syntagrus-dep-cc.html">cc</a></tt>]--> PRON</tt> (12; 86%),
<tt>PRON --[<tt><a href="ru_syntagrus-dep-parataxis.html">parataxis</a></tt>]--> PRON</tt> (8; 53%),
<tt>DET --[<tt><a href="ru_syntagrus-dep-expl.html">expl</a></tt>]--> PRON</tt> (6; 75%),
