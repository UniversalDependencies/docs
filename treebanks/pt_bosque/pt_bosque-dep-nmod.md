...
# visual-style 4	fgColor:white
# visual-style 4 7 nmod	color:blue
1	Promoção	promoção	NOUN	_	Gender=Fem|Number=Sing	8	nsubj	_	_
2	de	de	ADP	_	_	4	case	_	_
3	o	o	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	4	det	_	_
4	Dia	Dia	PROPN	_	Gender=Fem|Number=Sing	1	nmod	_	MWE=Dia_das_Mães
5	de	de	ADP	_	_	7	case	_	_
6	as	o	DET	_	Definite=Def|Gender=Fem|Number=Plur|PronType=Art	7	det	_	_
7	Mães	Mães	PROPN	_	Number=Sing	4	nmod	_	_
8	começa	começar	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	_
9	com	com	ADP	_	_	10	case	_	_
10	desfiles	desfile	NOUN	_	Gender=Masc|Number=Plur	8	obl	_	_
