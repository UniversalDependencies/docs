...
833 tokens (28%) have a non-empty value of `Person`.
295 types (39%) occur at least once with a non-empty value of `Person`.
148 lemmas (29%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> (536; 18% instances), <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> (154; 5% instances), <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> (143; 5% instances).
...
* `1` (33; 6% of non-empty `Person`): <em>ǩiõzzam, vääldam, čuõlmmääm, vuâlǥam, roʹttjam, vuõʹlǧǧem, Joordam, jieʹlim, jieʹllem, piâzzam</em>
* `2` (44; 8% of non-empty `Person`): <em>mõõnnâd, tiâr, mõõnsââʹst, puäʹđ, Mõõnžiǩ, puõʹttiǩ, Haaʹlääk-a, joordak, kooʹddid, kueʹst</em>
* `3` (459; 86% of non-empty `Person`): <em>ceälkk, mõõni, puõʹđi, šõõddi, vaaʹldi, jälste, ǩieʹzzi, leäi, lij, vuõʹlji</em>
* `EMPTY` (122): <em>jieʹlled, kooǯǯted, välddam, väʹldded, hiâvted, jååʹtted, kuâddam, mõõnnâd, teâđstam, vueʹtǩǩmen</em>
...
154 <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> tokens (50% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="sms_giellagas-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (154; 100%), <tt><a href="sms_giellagas-feat-Number.html">Number</a></tt><tt>=Sing</tt> (134; 87%), <tt><a href="sms_giellagas-feat-Case.html">Case</a></tt><tt>=Nom</tt> (109; 71%).
...
* `3` (98; 69% of non-empty `Person`): <em>lij, ij, leäi, liâ, iʹlla, iʹlleäk, jeäʹla, jiâ, lij-a, Ij-ǥo</em>
