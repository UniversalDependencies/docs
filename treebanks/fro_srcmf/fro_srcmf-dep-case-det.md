---
layout: base
title:  'Statistics of case:det in UD_Old_French-SRCMF'
udver: '2'
---

## Treebank Statistics: UD_Old_French-SRCMF: Relations: `case:det`
...
# visual-style 6 3 case:det	color:blue
...
# visual-style 6	bgColor:blue
# visual-style 6	fgColor:white
# visual-style 6 5 case:det	color:blue
1	La	_	ADV	ADVgen	_	4	advmod	_	_
2	u	_	ADV	ADVsub	_	4	advmod	_	_
3	cist	_	PRON	PROdem	PronType=Dem	4	nsubj	_	_
4	furent	_	VERB	VERcjg	VerbForm=Fin	8	advcl	_	_
5	des	_	ADP	PRE.DETdef	Definite=Def|PronType=Art	6	case:det	_	_
6	altres	_	PRON	PROind	PronType=Ind	8	obj	_	_
7	i	_	ADV	PROadv	PronType=Dem	8	obl	_	_
8	out	_	VERB	VERcjg	VerbForm=Fin	0	root	_	_
9	bien	_	ADV	ADVgen	_	8	advmod	_	_
...
# visual-style 5	bgColor:blue
# visual-style 5	fgColor:white
# visual-style 5 4 case:det	color:blue
1	E	_	CCONJ	CONcoo	_	3	cc:nc	_	_
2	jo	_	PRON	PROper	PronType=Prs	3	nsubj	_	_
3	irai	_	VERB	VERcjg	VerbForm=Fin	0	root	_	_
4	al	_	ADP	PRE.DETdef	Definite=Def|PronType=Art	5	case:det	_	_
5	Sarazin	_	PROPN	NOMpro	_	3	obl	_	_
6	espan	_	ADJ	ADJqua	_	5	amod	_	_
