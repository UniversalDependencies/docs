...
1	تمرکز	تمرکز	NOUN	N_IANM	Number=Sing	10	nsubj	_	LTranslit=tmrkz|Translit=tmrkz
2	بر	بر	ADP	PREP	_	3	case	_	LTranslit=br|Translit=br
3	داستان	داستان	NOUN	N_IANM	Number=Sing	1	nmod	_	LTranslit=dāstān|Translit=dāstān
4	ممکن	ممکن	ADJ	ADJ_AJP	_	0	root	_	LTranslit=mmkn|Translit=mmkn
5	است	است	AUX	AUX	Number=Sing|Person=3	4	cop	_	LTranslit=āst|OrigLemma=#است|Translit=āst
6	شما	شما	PRON	PR_SEPER	Number=Plur|Person=2|PronType=Prs	10	obj	_	LTranslit=šmā|Translit=šmā
7	را	را	ADP	POSTP	_	6	case	_	LTranslit=rā|Translit=rā
8	فردی	فرد	NOUN	N_ANM	Number=Sing	10	xcomp	_	LTranslit=frd|Translit=frdī
9	تک‌بعدی	تک‌بعدی	ADJ	ADJ_AJP	_	8	amod	_	LTranslit=tkbʿdī|Translit=tkbʿdī
10	کند	کرد	VERB	V_ACT	Number=Sing|Person=3|Voice=Act	4	csubj	_	LTranslit=krd|OrigLemma=کرد#کن|SpaceAfter=No|Translit=knd
...
1	پس	پس	ADV	ADV_SADV	_	2	advmod	_	LTranslit=ps|Translit=ps
2	ارزنده	ارزنده	ADJ	ADJ_AJP	_	0	root	_	LTranslit=ārzndh|Translit=ārzndh
3	است	است	AUX	AUX	Number=Sing|Person=3	2	cop	_	LTranslit=āst|OrigLemma=#است|Translit=āst
4	که	که	SCONJ	SUBR	_	2	csubj	_	LTranslit=kh|Translit=kh
...
12	دارد	داشت	VERB	V_ACT	Number=Sing|Person=3|Tense=Pres|Voice=Act	9	acl	_	LTranslit=dāšt|OrigLemma=داشت#دار|SpaceAfter=No|Translit=dārd
13	،	،	PUNCT	PUNC	_	12	punct	_	LTranslit=,|Translit=,
14	به	به	ADP	PREP	_	15	case	_	LTranslit=bh|Translit=bh
15	کار	کار	NOUN	N_IANM	Number=Sing	16	compound:lvc	_	LTranslit=kār|Translit=kār
16	بندد	بست	VERB	V_ACT	Number=Sing|Person=3|Voice=Act	4	ccomp	_	LTranslit=bst|OrigLemma=بست#بند|SpaceAfter=No|Translit=bndd
17	.	.	PUNCT	PUNC	_	2	punct	_	LTranslit=.|Translit=.
...
6	ما	ما	PRON	PR_SEPER	Number=Sing|Person=1|PronType=Prs	14	nsubj	_	LTranslit=mā|Translit=mā
7	نیز	نیز	ADV	ADV_SADV	_	6	dep	_	LTranslit=nīz|Translit=nīz
...
16	.	.	PUNCT	PUNC	_	3	punct	_	LTranslit=.|Translit=.
