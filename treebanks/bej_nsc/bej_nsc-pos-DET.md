...
The form / lemma ratio of `DET` is 19.000000 (the average of all parts of speech is 19.625000).

The 1st highest number of forms (19) was observed with the lemma “_”: <em>=b, =t, aː=, aːn, beːn, eː=, eːn, i=, j=, kass, oː=, oːn, t=, ti=, toː=, toːt, uː=, uːn, w=</em>.

`DET` occurs with 6 features: <tt><a href="bej_nsc-feat-Gender.html">Gender</a></tt> (122; 99% instances), <tt><a href="bej_nsc-feat-Definite.html">Definite</a></tt> (108; 88% instances), <tt><a href="bej_nsc-feat-Case.html">Case</a></tt> (70; 57% instances), <tt><a href="bej_nsc-feat-Number.html">Number</a></tt> (54; 44% instances), <tt><a href="bej_nsc-feat-Deixis.html">Deixis</a></tt> (14; 11% instances), <tt><a href="bej_nsc-feat-PronType.html">PronType</a></tt> (14; 11% instances)

`DET` occurs with 11 feature-value pairs: `Case=Acc`, `Case=Nom`, `Definite=Def`, `Definite=Ind`, `Deixis=Prox`, `Deixis=Remt`, `Gender=Fem`, `Gender=Masc`, `Number=Plur`, `Number=Sing`, `PronType=Dem`

`DET` occurs with 18 feature combinations.
The most frequent feature combination is `Case=Acc|Definite=Ind|Gender=Masc` (23 tokens).
Examples: <em>=b</em>
