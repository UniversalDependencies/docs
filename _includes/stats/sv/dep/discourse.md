...
20 nodes (3%) are attached to their parents as `discourse`.

12 instances of `discourse` (60%) are left-to-right (parent precedes child).
Average distance between parent and child is 5.

The following 4 pairs of parts of speech are connected with `discourse`: [sv-pos/VERB]()-[sv-pos/INTJ]() (11; 55% instances), [sv-pos/VERB]()-[sv-pos/X]() (7; 35% instances), [sv-pos/VERB]()-[sv-pos/ADJ]() (1; 5% instances), [sv-pos/X]()-[sv-pos/INTJ]() (1; 5% instances).
