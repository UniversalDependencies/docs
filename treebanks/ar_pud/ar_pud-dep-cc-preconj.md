...
1	و	و	CCONJ	RP	_	3	cc	_	SpaceAfter=No
...
5	تقول	قَال	VERB	VBC	Aspect=Imp|Gender=Fem|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	4	acl:relcl	_	LId=قال-ُ_1
6	أن	أَنَّ	SCONJ	IN	_	10	mark	_	LId=أَنَّ_1|SpaceAfter=No
7	ه	هُوَ	PRON	PRP	Case=Acc|Gender=Masc|Number=Sing|Person=3|PronType=Prs	10	nsubj	_	_
8	إما	أَمّا	PART	RP	_	10	cc:preconj	_	LId=أَمّا_1
9	س	سَ	PART	RP	_	10	compound:prt	_	SpaceAfter=No
10	يموت	مات	VERB	VBC	Aspect=Imp|Gender=Masc|Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin|Voice=Act	5	ccomp	_	LId=مات-ُ_1
...
19	يموت	مات	VERB	VBC	Aspect=Imp|Gender=Masc|Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin|Voice=Act	10	conj	_	LId=مات-ُ_1
...
26	يكتسب	ٱِكتَسَب	VERB	VBC	Aspect=Imp|Gender=Masc|Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin|Voice=Act	19	conj	_	LId=ٱِكْتَسَب_1
27	الخلود	خُلُود	NOUN	NN	Case=Acc|Definite=Def|Gender=Masc|Number=Sing	26	obj	_	LId=خُلُود_1
28	من	مِن	ADP	IN	ExtPos=ADP	30	case	_	LId=مِن_1
