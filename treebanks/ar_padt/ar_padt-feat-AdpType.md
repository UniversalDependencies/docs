...
The feature is used with 1 part-of-speech tags: <tt><a href="ar_padt-pos-ADP.html">ADP</a></tt> (41879; 15% instances).

### `ADP`

41879 <tt><a href="ar_padt-pos-ADP.html">ADP</a></tt> tokens (100% of all `ADP` tokens) have a non-empty value of `AdpType`.

The most frequent other feature values with which `ADP` and `AdpType` co-occurred: <tt><a href="ar_padt-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (35908; 86%).

`ADP` tokens may have the following values of `AdpType`:

* `Prep` (41879; 100% of non-empty `AdpType`): في، ل، ب، من، على، الى، إلى، عن، فى، مع
...
<tt>ADP --[<tt><a href="ar_padt-dep-fixed.html">fixed</a></tt>]--> ADP</tt> (542; 100%),
