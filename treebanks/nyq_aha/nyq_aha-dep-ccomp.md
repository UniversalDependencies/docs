---
layout: base
title:  'Statistics of ccomp in UD_Nayini-AHA'
udver: '2'
---

## Treebank Statistics: UD_Nayini-AHA: Relations: `ccomp`

This relation is universal.

4 nodes (5%) are attached to their parents as `ccomp`.

4 instances of `ccomp` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 4.25.

The following 1 pairs of parts of speech are connected with `ccomp`: <tt><a href="nyq_aha-pos-VERB.html">VERB</a></tt>-<tt><a href="nyq_aha-pos-VERB.html">VERB</a></tt> (4; 100% instances).
