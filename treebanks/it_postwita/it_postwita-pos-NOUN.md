...
There are 3466 `NOUN` lemmas (24%), 4360 `NOUN` types (23%) and 17595 `NOUN` tokens (14%).
...
The form / lemma ratio of `NOUN` is 1.257934 (the average of all parts of speech is 1.310744).
...
994 (6%) `NOUN` nodes are leaves.

3979 (23%) `NOUN` nodes have one child.
