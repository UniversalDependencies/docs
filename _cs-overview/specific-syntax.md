...
~~~ sdparse
ROOT Pro zajímavost - v naší republice je 18 procent lidí neschopných pro jakoukoliv efektivní práci .
case:auxp:member(--4, Pro-2)
dep(Pro-2, zajímavost-3)
root:coord(ROOT-1, --4)
case:auxp(je-8, v-5)
det(republice-7, naší-6)
nmod(v-5, republice-7)
parataxis:member(--4, je-8)
nsubj(je-8, 18-9)
nmod(18-9, procent-10)
nmod(procent-10, lidí-11)
amod(lidí-11, neschopných-12)
case:auxp(neschopných-12, pro-13)
det(práci-16, jakoukoliv-14)
amod(práci-16, efektivní-15)
nmod(pro-13, práci-16)
root:auxk(ROOT-1, .-17)
~~~
...
dep(Pro-2, zajímavost-3)
punct(Pro-2, --4)
case(republice-7, v-5)
det(republice-7, naší-6)
nmod(je-8, republice-7)
conj(Pro-2, je-8)
nsubj(je-8, 18-9)
nmod(18-9, procent-10)
nmod(procent-10, lidí-11)
amod(lidí-11, neschopných-12)
case(práci-16, pro-13)
det(práci-16, jakoukoliv-14)
amod(práci-16, efektivní-15)
nmod(neschopných-12, práci-16)
root:auxk(ROOT-1, .-17)
~~~
...
~~~ sdparse
ROOT Pro zajímavost - v naší republice je 18 procent lidí neschopných pro jakoukoliv efektivní práci .
case(zajímavost-3, Pro-2)
root(ROOT-1, zajímavost-3)
punct(zajímavost-3, --4)
case(republice-7, v-5)
det(republice-7, naší-6)
nmod(je-8, republice-7)
conj(zajímavost-3, je-8)
nsubj(je-8, 18-9)
nmod(18-9, procent-10)
nmod(procent-10, lidí-11)
amod(lidí-11, neschopných-12)
