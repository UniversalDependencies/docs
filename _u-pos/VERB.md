...
Note that the VERB tag covers main verbs _(content verbs)_ and _copulas_ but it does not cover _auxiliary verbs,_ for which there is the <a href="AUX.html">AUX</a> tag. _Modal verbs_ may be considered VERB or AUX, depending on their behavior in the given language. Language-specific documentation should specify which verbs are tagged AUX in which contexts.
