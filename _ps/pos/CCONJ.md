...
layout: postag
title: 'CCONJ'
redirect_from: "ps/pos/CONJ.html"
...
The coordinating conjunctio usually depend on the head of the second constituent with the [cc]() relation.
...
* copulative relation: “and”
  * <!-- a -->او _aw_
  * <!-- a -->و _wë_
* disjunctive relation: “or”
  * <!-- a -->یا _yâ_
  * <!-- a -->کۀ _kë_ (not to confuse with subordinating conjunction کۀ _kë_ “if”)
