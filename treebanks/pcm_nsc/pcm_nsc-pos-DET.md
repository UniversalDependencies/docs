...
* <em>a</em>
  * <tt><a href="pcm_nsc-pos-DET.html">DET</a></tt> 1: <em>dem just dey donate money //+ { one million | so so so million | one point million | half <b>a</b> million } //</em>
  * <tt><a href="pcm_nsc-pos-PRON.html">PRON</a></tt> 1: <em># so I believe sey dese thing wey I don tell you < { im go fit help us || # it will go <b>a</b> long way } make im just guide us on how we suppose dey use di road so dat accident no go dey happen //</em>
