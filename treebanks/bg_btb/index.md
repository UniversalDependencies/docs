...
Language: [Bulgarian](/bg/index.html) (code: `bg`)<br/>
...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udbg_btb212)<br />
...
<ul>
<li>This corpus contains 24 lemmas tagged as pronouns (PRON): аз, ваш, всеки, всичкия, един, защо, какъвто, кой, който, мой, наш, негов, неин, неколцина, никой, някой, няколко, свой, се, себе, си, твой, техен, този</li>
</ul>

<ul>
<li>This corpus contains 23 lemmas tagged as determiners (DET): ваш, всеки, всякакъв, един, каквото, какъв, какъвто, кой, който, мой, наш, негов, нечий, никакъв, никой, ничий, някакъв, някой, свой, такъв, този, чий, чийто</li>
</ul>

<ul>
<li>Out of the above, 13 lemmas occurred sometimes as PRON and sometimes as DET: ваш, всеки, един, какъвто, кой, който, мой, наш, негов, никой, някой, свой, този</li>
</ul>

<ul>
<li>This corpus contains 6 lemmas tagged as auxiliaries (AUX): би, бивам, бъда, да, съм, ще</li>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <li>AUX: бил, били, била, било</li>
    <li>VERB: имало, направил, дал, трябвало, заминал, направено, искал, казал, направили, дошъл</li>
  </ul>
  </li>
</ul>
...
<ul>
  <li>Fem
    <ul>
      <li>ADJ: българската, нова, европейската, цялата, 2001, 2000, голяма, миналата, националната, новата</li>
      <li>ADJ-Part: миналата, следващата, обединена, организираната, приета, изминалата, предстоящата, водеща, организирана, потъналата</li>
      <li>AUX-Part: била</li>
      <li>DET: тази, една, всяка, каква, нашата, такава, тая, неговата, своята, някаква</li>
      <li>NOUN: г., година, години, част, страната, страна, политика, пари, страни, работа</li>
...
<ul>
  <li>Masc
    <ul>
      ...
      <li>ADJ-Part: миналия, цитиран, определен, следващия, уморен, водещ, водещият, действащ, избран, организиран</li>
      <li>AUX-Part: бил</li>
      <li>DET: този, един, всеки, такъв, своя, какъв, тоя, никакъв, някой, някакъв</li>
      <li>NOUN: %, лв., млн., президентът, път, края, съвет, човек, министър, ден</li>
      <li>NUM: един, два, 2, двата, 1, 22, Единият, 32, 4162, 62</li>
      <li>PRON: той, го, който, му, него, кой, никой, някой, кого, всеки</li>
      <li>PROPN: Иван, ЕС, СДС, Петър, Стоянов, Костов, Георги, САЩ, Димитър, Йордан</li>
...
<ul>
  <li>Neut
    <ul>
      ...
      <li>ADJ-Part: фокусирано, следващото, ускорено, извършено, казано, квалифицирано, написаното, очакваното, управляващото, взето</li>
      <li>ADP: сравнение</li>
      <li>AUX-Part: било</li>
      <li>DET: това, какво, едно, всяко, такова, своето, тяхното, негово, някакво, нашето</li>
      <li>NOUN: време, събрание, решение, място, правителството, право, началото, времето, решението, делото</li>
...
<ul>
  <li>Anim
    <ul>
      <li>DET: никого</li>
      <li>NUM: мнозина, малцина</li>
      <li>PRON: кого, когото, никого, някого, всекиго, никому</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Plur
    <ul>
      ...
      <li>ADJ-Part: въоръжените, останалите, свързани, управляващите, определени, пострадали, следващите, запознати, задържаните, водещи</li>
      <li>ADV: много, повече, малко, повечето, по-малко, най-много, най-малко, малкото, Многая, Най-малкото</li>
      <li>AUX-Fin: са, бяха, бъдат, сме, сте, бъдем, биха, бихте, бяхте, биват</li>
      <li>AUX-Part: били</li>
      <li>DET: тези, всички, нашите, някои, какви, своите, такива, техните, наши, тия</li>
      <li>NOUN: г., години, пари, страни, проблеми, представители, сили, промени, фирми, парите</li>
...
<ul>
  <li>Acc
    <ul>
      <li>DET: никого</li>
      <li>PRON: се, го, него, я, ги, тях, нас, ме, нея, ни</li>
      <li>PROPN: Петка</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Voc
    <ul>
      ...
      <li>PROPN: Нови, Господи, Калине, Янке</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Def
    <ul>
      <li>ADJ: народното, българската, другите, европейската, последните, цялата, новия, миналата, националната, новата</li>
      <li>ADJ-Part: миналата, следващата, въоръжените, останалите, миналия, управляващите, следващите, следващия, организираната, задържаните</li>
      <li>ADV: повечето, малкото, Най-малкото, многото, по-малкото</li>
      <li>DET: нашите, своите, нашата, своя, техните, неговата, своята, своето, тяхното, нейните</li>
      <li>NOUN: хората, президентът, страната, края, държавата, правителството, закона, отбраната, шефът, началото</li>
      <li>NUM: двамата, двете, двата, тримата, трите, четиримата, Единият, четирите, десетте, едното</li>
      <li>PRON: нещата, всичкото, Единият, Едната, нищото</li>
      <li>PROPN: Балканите, ЕС, СДС, Конституцията, НИС, Дяволът, Евросъюза, ЦСКА, Евролевицата, САЩ</li>
...
<ul>
  <li>Ind
    <ul>
      ...
      <li>ADJ-Part: свързани, определени, цитиран, определен, пострадали, обединена, запознати, приета, фокусирано, водещи</li>
      <li>ADP: сравнение</li>
      <li>ADV: много, повече, малко, по-малко, най-много, най-малко, Многая, немалко, Повечко</li>
      <li>AUX-Part: бил, били, била, било</li>
      <li>DET: един, една, едно, наши, негово, своя, нищо, нещо, свой, свои</li>
      <li>NOUN: г., време, година, години, част, събрание, хора, път, страна, съвет</li>
      <li>NUM: две, един, два, 2, една, 1, 3, три, 10, едно</li>
      <li>PRON: нищо, нещо, неколцина, няколко, един, едно</li>
      <li>PROPN: България, София, Иван, Европа, Петър, ЕС, Стоянов, СДС, Костов, Георги</li>
      <li>VERB-Part: имало, направил, дал, трябвало, заминал, направено, искал, казал, направили, дошъл</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Cmp
    <ul>
      <li>ADJ: по-голяма, по-голямата, по-голямо, по-големи, по-голям, по-висок, по-големите, по-нататъшно, по-широка, по-бедни</li>
      <li>ADJ-Part: По-впечатляващо, по-депресирани, по-изостанала, по-изострени, по-корумпирана, по-намаляващото, по-напреднал, по-обичан, по-отдалечените, по-превръщащото</li>
      <li>ADV: по-късно, по-добре, по-малко, по-рано, по-скоро, по-бързо, по-лесно, по-силно, по-трудно, по-често</li>
...
<ul>
  <li>Sup
    <ul>
      ...
      <li>ADJ-Part: Най-разпространената, най-желаните, най-засегнатите, най-коментираните, най-корумпираните, най-обичащата, най-обучените, най-преуспелия, най-прогресиращ, най-радващото</li>
      <li>ADV: най-вече, най-сетне, най-често, най-добре, най-много, най-после, най-вероятно, най-малко, най-късно, най-напред</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Pass
    <ul>
      ...
      <li>VERB-Part: направено, избран, изправени, обвинен, открити, показани, представена, приета, избрана, изнесени</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Ind
    <ul>
      ...
      <li>DET: един, една, едно, някои, някой, някакъв, някаква, някакво, нещо, неща</li>
...
<ul>
  <li>Int
    <ul>
      ...
      <li>DET: какво, какви, каква, какъв, кой, кои, коя, чия, К'ва</li>
...
<ul>
  <li>Neg
    <ul>
      ...
      <li>DET: никакви, никакъв, нищо, никой, никаква, никакво, Никоя, никого, ничия</li>
...
<ul>
  <li>Tot
    <ul>
      ...
      <li>DET: всички, всеки, всяка, всяко, всичко, всякакви, всякакъв, Вси, всякаква, всякакво</li>
      <li>PRON: всичко, всички, всеки, всичкото, всекиго</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Card
    <ul>
      <li>ADV: много, повече, толкова, малко, повечето, колко, колкото, по-малко, най-много, доколкото</li>
...
<ul>
  <li>Yes
    <ul>
      <li>DET: нашите, своите, своя, нашата, техните, наши, неговата, своята, своето, тяхното</li>
      <li>PRON: си, му, ни, й, им, ми, ви, ти</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Yes
    <ul>
      <li>DET: своите, своя, своята, своето, свой, свои, свое</li>
      <li>PRON: се, си, себе, с...</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>1
    <ul>
      <li>AUX-Fin: съм, сме, бих, бях, бъдем, бъда, бихме, бяхме</li>
      <li>DET: нашите, нашата, наши, нашето, моя, моята, нашия, моето, нашият, Моят</li>
      <li>PRON: ни, ми, аз, нас, ние, ме, мен, мене, ний</li>
...
<ul>
  <li><a>obj</a>
    <ul>
      ...
      <li>VERB-Part--NOUN-ADP(към) (1)</li>
      <li>VERB-Part--NOUN-ADP(на) (2)</li>
      <li>VERB-Part--NOUN-ADP(от) (4)</li>
      <li>VERB-Part--NOUN-ADP(с) (1)</li>
      <li>VERB-Part--PRON (1)</li>
...
<ul>
  <li><a>iobj</a>
    <ul>
      ...
      <li>VERB-Fin--NOUN-ADP(като) (22)</li>
      ...
      <li>VERB-Fin--PRON-Acc-ADP(пред) (2)</li>
      <li>VERB-Fin--PRON-Acc-ADP(при) (10)</li>
      <li>VERB-Fin--PRON-Acc-ADP(с) (32)</li>
      <li>VERB-Fin--PRON-Acc-ADP(според) (2)</li>
      ...
      <li>VERB-Fin--PRON-Nom-ADP(до) (1)</li>
      <li>VERB-Fin--PRON-Nom-ADP(за) (15)</li>
      <li>VERB-Fin--PRON-Nom-ADP(зад) (1)</li>
      <li>VERB-Fin--PRON-Nom-ADP(на) (6)</li>
      <li>VERB-Fin--PRON-Nom-ADP(над) (1)</li>
      <li>VERB-Fin--PRON-Nom-ADP(от) (5)</li>
      <li>VERB-Fin--PRON-Nom-ADP(по) (2)</li>
      ...
      <li>VERB-Part--NOUN-ADP(до) (12)</li>
      <li>VERB-Part--NOUN-ADP(за) (65)</li>
      <li>VERB-Part--NOUN-ADP(зад) (4)</li>
      <li>VERB-Part--NOUN-ADP(извън) (1)</li>
      <li>VERB-Part--NOUN-ADP(изпод) (1)</li>
      <li>VERB-Part--NOUN-ADP(като) (6)</li>
      <li>VERB-Part--NOUN-ADP(като)-ADP(в) (1)</li>
      <li>VERB-Part--NOUN-ADP(край) (1)</li>
      <li>VERB-Part--NOUN-ADP(към) (17)</li>
      <li>VERB-Part--NOUN-ADP(между) (2)</li>
      <li>VERB-Part--NOUN-ADP(на) (82)</li>
      <li>VERB-Part--NOUN-ADP(над) (2)</li>
      <li>VERB-Part--NOUN-ADP(около) (2)</li>
      <li>VERB-Part--NOUN-ADP(от) (165)</li>
      <li>VERB-Part--NOUN-ADP(по) (13)</li>
      <li>VERB-Part--NOUN-ADP(под) (2)</li>
      <li>VERB-Part--NOUN-ADP(пред) (13)</li>
      <li>VERB-Part--NOUN-ADP(през) (5)</li>
      <li>VERB-Part--NOUN-ADP(при) (5)</li>
      <li>VERB-Part--NOUN-ADP(с) (46)</li>
      <li>VERB-Part--NOUN-ADP(сред) (2)</li>
      <li>VERB-Part--NOUN-ADP(срещу) (4)</li>
      <li>VERB-Part--NOUN-ADP(със) (4)</li>
      <li>VERB-Part--NOUN-ADP(чрез) (1)</li>
      <li>VERB-Part--PRON-Acc-ADP(в) (3)</li>
      <li>VERB-Part--PRON-Acc-ADP(за) (8)</li>
      <li>VERB-Part--PRON-Acc-ADP(към) (1)</li>
      <li>VERB-Part--PRON-Acc-ADP(на) (3)</li>
      <li>VERB-Part--PRON-Acc-ADP(от) (6)</li>
      <li>VERB-Part--PRON-Acc-ADP(с) (5)</li>
      <li>VERB-Part--PRON-Acc-ADP(у) (2)</li>
      <li>VERB-Part--PRON-Dat (51)</li>
      <li>VERB-Part--PRON-Nom-ADP(в) (1)</li>
      <li>VERB-Part--PRON-Nom-ADP(за) (3)</li>
      <li>VERB-Part--PRON-Nom-ADP(към) (2)</li>
      <li>VERB-Part--PRON-Nom-ADP(на) (4)</li>
      <li>VERB-Part--PRON-Nom-ADP(от) (2)</li>
      <li>VERB-Part--PRON-Nom-ADP(с) (2)</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>This corpus contains 21 lemmas that occur at least once with a reflexive core object (<a>obj</a> or <a>iobj</a>). Examples: обичам себе, смятам свой, възприемам себе, гледам себе, грижа-се себе, завися себе, мамя с..., надмина себе, надценявам-(се) себе, намирам-(се) себе, обвинявам себе, одраскам-(се) себе, открия-(се) себе, погна своите, похваля-(се) се, притисна-(се) себе, приютя-(се) себе, разчитам себе, разчитам-(се) себе, сам себе, чувствам-(се) себе</li>
</ul>
