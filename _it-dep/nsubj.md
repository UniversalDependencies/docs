...
~~~ sdparse
Ai balconi si affacciano donne anziane.
nsubj(affacciano, donne)
~~~
~~~ sdparse
Chi ha ucciso l'ingegner Reali?
nsubj(ucciso, Chi)
~~~
~~~ sdparse
...
When the subject is clausal other specialized relations are used instead ([csubj]() or [csubjpass]()).
