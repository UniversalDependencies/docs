...
2431 instances of `discourse` (75%) are right-to-left (child precedes parent).
Average distance between parent and child is 4.91402157164869.
...
1	XXX	XXX	X	_	_	6	discourse	_	ExtPos=X|wordform=xxx
