...
The form / lemma ratio of `SYM` is 1.000000 (the average of all parts of speech is 1.783262).
...
`SYM` nodes are attached to their parents using 1 different relations: <tt><a href="el_gdt-dep-dep.html">dep</a></tt> (1; 100% instances)

Parents of `SYM` nodes belong to 1 different parts of speech: <tt><a href="el_gdt-pos-PRON.html">PRON</a></tt> (1; 100% instances)
