---
layout: base
title:  'Statistics of dislocated in UD_Hungarian-Szeged'
udver: '2'
---

## Treebank Statistics: UD_Hungarian-Szeged: Relations: `dislocated`
...
The following 1 pairs of parts of speech are connected with `dislocated`: <tt><a href="hu_szeged-pos-PRON.html">PRON</a></tt>-<tt><a href="hu_szeged-pos-NOUN.html">NOUN</a></tt> (1; 100% instances).
...
1	Valami	valami	PRON	_	Case=Nom|Number=Sing|Person=3|PronType=Ind	5	nsubj	_	_
2	tudat	tudat	NOUN	_	Case=Nom|Number=Sing	5	obl	_	_
...
6	bennem	én	PRON	_	Case=Ine|Number=Sing|Person=1|PronType=Prs	5	obl	_	SpaceAfter=No
7	,	,	PUNCT	_	_	9	punct	_	_
8	valami	valami	ADJ	_	Case=Nom|Degree=Pos|Number=Sing	9	amod:att	_	_
9	megérzés	megérzés	NOUN	_	Case=Nom|Number=Sing	1	dislocated	_	SpaceAfter=No
10	,	,	PUNCT	_	_	14	punct	_	_
11	hogy	hogy	SCONJ	_	_	14	mark	_	_
12	mikor	mikor	ADV	_	PronType=Int	14	advmod:tlocy	_	_
13	mit	mi	PRON	_	Case=Acc|Number=Sing|Person=3|PronType=Int	14	obj	_	_
...
19	ennek	ez	PRON	_	Case=Dat|Number=Sing|Person=3|PronType=Dem	20	obl	_	_
