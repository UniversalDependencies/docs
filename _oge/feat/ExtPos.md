...
The `ExtPos` feature applies to [NOUN](_oge/pos/NOUN), [PROPN](_oge/pos/PROPN), [ADJ](_oge/pos/ADJ), [PRON](_oge/pos/PRON), [NUM](_oge/pos/NUM), [ADV](_oge/pos/ADV). In Old Georgian ExtPos is used for fixed functional multiword expressions. 
...
* _ამის გამო_ 'for this reason'

### <a name="ADV">`ADV`</a>: adverb-like expression

#### Examples

* _ვითარცა მას_ 'as to that'
