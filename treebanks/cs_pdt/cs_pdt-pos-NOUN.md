...
There are 17791 `NOUN` lemmas (30%), 40083 `NOUN` types (31%) and 372359 `NOUN` tokens (25%).
...
The form / lemma ratio of `NOUN` is 2.252993 (the average of all parts of speech is 2.182017).
