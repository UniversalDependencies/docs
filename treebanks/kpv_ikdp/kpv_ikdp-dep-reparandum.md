...
6	из	оз	AUX	V	Mood=Ind|Number=Sing|Person=3|Polarity=Neg|Tense=Past|VerbForm=Fin	8	reparandum	_	SpaceAfter=No
7	,	,	PUNCT	CLB	_	8	punct	_	_
8	абу	абу	AUX	Pcle	Polarity=Neg	9	aux	_	_
9	понравитчема	понравитчыны	VERB	V	Evident=Nfh|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	3	acl	_	OrigLang=ru|SpaceAfter=No|Note=Check
...
7	куті	кутны	VERB	V	Mood=Ind|Number=Sing|Person=1|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt,Sg1
...
16	кӧсйысис	кӧсйысьны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	7	conj	_	GTtags=Refl,Ind,Prt1,Sg3
...
4	ветлала	ветлыны	VERB	V	Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin	0	root	_	SpaceAfter=No
...
18	воссис	воссьыны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	4	advcl	_	_
