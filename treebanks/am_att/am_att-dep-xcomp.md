---
layout: base
title:  'Statistics of xcomp in UD_Amharic-ATT'
udver: '2'
---

## Treebank Statistics: UD_Amharic-ATT: Relations: `xcomp`
...
Average distance between parent and child is 2.63235294117647.
...
1	ከ	ከ	ADP	ADP	_	2	mark	_	LTranslit=kä|Translit=kä
2	መጣ	መጣ	VERB	VERB	Mood=Ind|VerbForm=Fin	13	advcl	_	LTranslit=mäţa|Translit=mäţa
3	ኧ	እሱ	PRON	SUBJC	Gender=Masc|Number=Sing|Person=3|PronType=Prs	2	expl	_	LTranslit='əsu|Translit='ă
4	ኣል	ኣል	PART	NEG	Polarity=Neg	6	advmod	_	LTranslit='alə|Translit='alə
5	ይ	እሱ	PRON	SUBJC	Gender=Masc|Number=Sing|Person=3|PronType=Prs	6	expl	_	LTranslit='əsu|Translit=jə
6	ቀር	ቀር	VERB	VERB	Mood=Ind|VerbForm=Fin	2	xcomp	_	LTranslit=qärə|Translit=qärə
7	ጓዝ	ጓዝ	NOUN	NOUN	_	10	advcl	_	LTranslit=gwazə|Translit=gwazə
...
10	ይዝ	ይዝ	VERB	VERB	Mood=Ind|VerbForm=Fin	13	advcl	_	LTranslit=jəzə|Translit=jəzə
...
13	ምጣ	ምጣ	VERB	VERB	Mood=Ind|VerbForm=Fin	0	root	_	LTranslit=məţa|Translit=məţa
...
1	ውድድር	ውድድር	NOUN	NOUN	_	6	obj	_	LTranslit=wədədərə|Translit=wədədərə
2	ኡ	ኡ	DET	DET	PronType=Art	1	det	_	LTranslit='u|Translit='u
3	ን	ን	PART	ACC	_	1	case	_	LTranslit=nə|Translit=nə
4	ማሸነፍ	ማሸነፍ	NOUN	NOUN	VerbForm=Vnoun	6	xcomp	_	LTranslit=mašänäfə|Translit=mašänäfə
5	ኡ	እሱ	PRON	POSM	Gender=Masc|Number=Sing|Person=3|Poss=Yes|PronType=Prs	4	nmod	_	LTranslit='əsu|Translit='u
6	አስደሰት	አስደሰት	VERB	VERB	Mood=Ind|VerbForm=Fin|Voice=Cau	0	root	_	LTranslit='äsədäsätə|Translit='äsədäsätə
...
1	ምናልባት	ምናልባት	ADV	ADV	_	9	advmod	_	Translit=mənaləbatə|LTranslit=mənaləbatə
2	ይህን	ይህን	DET	DET	PronType=Dem	3	det	_	Translit=jəhənə|LTranslit=jəhənə
3	መጽሐፍ	መጽሐፍ	NOUN	NOUN	_	5	xcomp	_	Translit=mäcəħäfə|LTranslit=mäcəħäfə
4	ለ	ለ	ADP	ADP	_	5	case	_	LTranslit=lä|Translit=lä
5	ማሳተም	ማሳተም	NOUN	NOUN	VerbForm=Vnoun	9	obl	_	LTranslit=masatämə|Translit=masatämə
6	የ	የ	PART	RLP	_	9	mark	_	LTranslit=jä|Translit=jä
7	እም	እም	PART	IRLP	_	9	mark	_	LTranslit='əmə|Translit='əmə
8	ት	እሱ	PRON	SUBJC	Gender=Fem|Number=Sing|Person=3|PronType=Prs	9	expl	_	LTranslit='əsu|Translit=tə
9	ፈልግ	ፈልግ	VERB	VERB	Mood=Ind|VerbForm=Fin	15	advcl	_	LTranslit=fäləgə|Translit=fäləgə
10	ኡ	እሱ	PRON	SUBJC	Number=Plur|Person=3|PronType=Prs	9	nsubj	_	LTranslit='əsu|Translit='u
11	ከ	ከ	SCONJ	SCONJ	_	12	mark	_	LTranslit=kä|Translit=kä
12	ሆን	ሆን	VERB	VERB	Mood=Ind|VerbForm=Fin	9	advcl	_	LTranslit=honə|Translit=honə
13	ኧ	እሱ	PRON	SUBJC	Gender=Masc|Number=Sing|Person=3|PronType=Prs	12	nsubj	_	LTranslit='əsu|Translit='ă
14	እ	እኔ	PRON	SUBJC	Number=Sing|Person=1|PronType=Prs	15	expl	_	LTranslit='əne|Translit='ə
15	ልክ	ልክ	VERB	VERB	Mood=Ind|VerbForm=Fin	0	root	_	LTranslit=ləkə|Translit=ləkə
16	ኣል	ኣል	AUX	AUX	_	15	aux	_	LTranslit='alə|Translit='alə
17	ኧሁ	እኔ	PRON	SUBJC	Gender=Neut|Number=Sing|Person=1|PronType=Prs	15	nsubj	_	LTranslit='əne|Translit='ăhu
