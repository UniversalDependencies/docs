...
4	geeft	geven	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	_
5	dit	dit	DET	VNW|aanw|det|stan|prenom|zonder|evon	PronType=Dem	6	det	6:det	_
...
3	doe	doen	VERB	WW|pv|tgw|ev	Mood=Imp|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	_
...
8	een	een	DET	LID|onbep|stan|agr	Definite=Ind|PronType=Art	9	det	9:det	_
...
2	vertelt	vertellen	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	_
...
11	heeft	hebben	AUX	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	12	aux	12:aux	_
