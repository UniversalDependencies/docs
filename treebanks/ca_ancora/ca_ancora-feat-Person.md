...
52581 tokens (10%) have a non-empty value of `Person`.
4642 types (14%) occur at least once with a non-empty value of `Person`.
1372 lemmas (6%) occur at least once with a non-empty value of `Person`.
The feature is used with 4 part-of-speech tags: <tt><a href="ca_ancora-pos-AUX.html">AUX</a></tt> (19851; 4% instances), <tt><a href="ca_ancora-pos-VERB.html">VERB</a></tt> (18432; 3% instances), <tt><a href="ca_ancora-pos-PRON.html">PRON</a></tt> (11158; 2% instances), <tt><a href="ca_ancora-pos-DET.html">DET</a></tt> (3140; 1% instances).

### `AUX`

19851 <tt><a href="ca_ancora-pos-AUX.html">AUX</a></tt> tokens (89% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="ca_ancora-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (19851; 100%), <tt><a href="ca_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (18765; 95%), <tt><a href="ca_ancora-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (17578; 89%), <tt><a href="ca_ancora-feat-Number.html">Number</a></tt><tt>=Sing</tt> (14958; 75%).

`AUX` tokens may have the following values of `Person`:

* `1` (530; 3% of non-empty `Person`): <em>hem, he, estem, vaig, podem, som, sóc, vam, estic, puc</em>
* `2` (18; 0% of non-empty `Person`): <em>has, pots, esteu, heu, ets, haureu, podeu</em>
* `3` (19303; 97% of non-empty `Person`): <em>va, ha, és, van, han, són, està, havia, pot, serà</em>
...
18432 <tt><a href="ca_ancora-pos-VERB.html">VERB</a></tt> tokens (44% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (18432; 100%), <tt><a href="ca_ancora-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (18432; 100%), <tt><a href="ca_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (16128; 88%), <tt><a href="ca_ancora-feat-Number.html">Number</a></tt><tt>=Sing</tt> (13348; 72%), <tt><a href="ca_ancora-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (13027; 71%).

`VERB` tokens may have the following values of `Person`:

* `1` (801; 4% of non-empty `Person`): <em>tenim, crec, volem, sé, tinc, vull, estem, penso, dic, sabem</em>
* `2` (43; 0% of non-empty `Person`): <em>fas, estrena, voleu, Escolta, Obres, acabes, acuses, afirma, aturis, busqueu</em>
* `3` (17588; 95% of non-empty `Person`): <em>té, ha, fa, tenen, considera, cal, farà, vol, tracta, demana</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="ca_ancora-feat-Mood.html">Mood</a></tt><tt>=Sub</tt>|<tt><a href="ca_ancora-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="ca_ancora-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td></td><td><em>feu</em></td><td><em>facin</em></td></tr>
</table>

### `PRON`

11158 <tt><a href="ca_ancora-pos-PRON.html">PRON</a></tt> tokens (48% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="ca_ancora-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (10586; 95%), <tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (9799; 88%), <tt><a href="ca_ancora-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (7996; 72%), <tt><a href="ca_ancora-feat-Case.html">Case</a></tt><tt>=Acc,Dat</tt> (6548; 59%), <tt><a href="ca_ancora-feat-PrepCase.html">PrepCase</a></tt><tt>=Npr</tt> (5899; 53%), <tt><a href="ca_ancora-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (5725; 51%).

`PRON` tokens may have the following values of `Person`:

* `1` (610; 5% of non-empty `Person`): <em>ens, nosaltres, em, jo, m', nos, mi, me, 'ns, 'm</em>
* `2` (83; 1% of non-empty `Person`): <em>vostè, et, t', 't, vostès, tu, us, te, vosaltres, ti</em>
* `3` (10465; 94% of non-empty `Person`): <em>es, s', hi, se, li, ho, els, la, el, l'</em>
* `EMPTY` (12298): <em>que, un, tot, on, què, això, qual, se, qui, quals</em>
...
<tt>VERB --[<tt><a href="ca_ancora-dep-conj.html">conj</a></tt>]--> VERB</tt> (1095; 62%),
<tt>VERB --[<tt><a href="ca_ancora-dep-expl-pass.html">expl:pass</a></tt>]--> PRON</tt> (278; 58%),
<tt>AUX --[<tt><a href="ca_ancora-dep-csubj.html">csubj</a></tt>]--> VERB</tt> (40; 55%),
<tt>VERB --[<tt><a href="ca_ancora-dep-compound.html">compound</a></tt>]--> VERB</tt> (24; 73%),
<tt>VERB --[<tt><a href="ca_ancora-dep-advcl.html">advcl</a></tt>]--> AUX</tt> (21; 51%),
