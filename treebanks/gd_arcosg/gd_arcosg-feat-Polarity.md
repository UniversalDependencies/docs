...
The most frequent other feature values with which `PART` and `Polarity` co-occurred: <tt><a href="gd_arcosg-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (966; 93%), <tt><a href="gd_arcosg-feat-PartType.html">PartType</a></tt><tt>=Vb</tt> (825; 79%).
...
* `EMPTY` (1057): <em>'s, is, b', chaidh, bu, as, deach, thèid, tèid, b’</em>
