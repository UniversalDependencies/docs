...
* `Fem` (18330; 45% of non-empty `Gender`): <em>pessoas, parte, semana, empresa, empresas, forma, cidade, casa, vida, vez</em>
* `Masc` (22468; 55% of non-empty `Gender`): <em>anos, milhões, ano, presidente, dia, país, contos, tempo, grupo, governo</em>
...
`Gender` seems to be **lexical feature** of `NOUN`. 97% lemmas (6608) occur only with one value of `Gender`.

### `DET`

33679 <tt><a href="pt_bosque-pos-DET.html">DET</a></tt> tokens (96% of all `DET` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `DET` and `Gender` co-occurred: <tt><a href="pt_bosque-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (29817; 89%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (26551; 79%), <tt><a href="pt_bosque-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (26494; 79%).

`DET` tokens may have the following values of `Gender`:

* `Fem` (14803; 44% of non-empty `Gender`): <em>a, as, uma, sua, esta, suas, essa, toda, outras, algumas</em>
* `Masc` (18862; 56% of non-empty `Gender`): <em>o, os, um, seu, este, seus, esse, todos, outros, outro</em>
...
11746 <tt><a href="pt_bosque-pos-PROPN.html">PROPN</a></tt> tokens (62% of all `PROPN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PROPN` and `Gender` co-occurred: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11331; 96%).
...
* `Masc` (7749; 66% of non-empty `Gender`): <em>São, Portugal, Brasil, José, Governo, EUA, Rio, Estados, João, PÚBLICO</em>
...
* `EMPTY` (7266): <em>Paulo, Nacional, Unidos, Silva, Porto, e, Henrique, Lisboa, Sul, Costa</em>
...
`Gender` seems to be **lexical feature** of `PROPN`. 94% lemmas (4457) occur only with one value of `Gender`.

### `ADJ`

11129 <tt><a href="pt_bosque-pos-ADJ.html">ADJ</a></tt> tokens (99% of all `ADJ` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `ADJ` and `Gender` co-occurred: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8015; 72%).

`ADJ` tokens may have the following values of `Gender`:

* `Fem` (5032; 45% of non-empty `Gender`): <em>primeira, nova, maior, grande, última, mesma, segunda, boa, política, novas</em>
...
7202 <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PRON` and `Gender` co-occurred: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5067; 70%), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (4798; 67%), <tt><a href="pt_bosque-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (4669; 65%).

`PRON` tokens may have the following values of `Gender`:

* `Fem` (1851; 26% of non-empty `Gender`): <em>que, se, ela, a, as, elas, lhe, esta, eu, qual</em>
* `Masc` (4649; 65% of non-empty `Gender`): <em>que, se, o, ele, isso, tudo, eles, lhe, os, isto</em>
...
* `EMPTY` (15839): <em>há, disse, tem, fazer, diz, ter, é, ver, fez, afirmou</em>
...
The most frequent other feature values with which `SYM` and `Gender` co-occurred: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Plur</tt> (406; 98%).
...
`Gender` seems to be **lexical feature** of `ADV`. 92% lemmas (11) occur only with one value of `Gender`.
...
* `EMPTY` (2207): <em>que, se, porque, embora, pois, como, caso, Senão, assim, e</em>
...
<tt>NOUN --[<tt><a href="pt_bosque-dep-det.html">det</a></tt>]--> DET</tt> (26908; 95%),
