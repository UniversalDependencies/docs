...
There are 9 `PUNCT` lemmas (2%), 9 `PUNCT` types (2%) and 208 `PUNCT` tokens (23%).
...
The form / lemma ratio of `PUNCT` is 1.000000 (the average of all parts of speech is 1.228365).
