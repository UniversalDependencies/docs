---
layout: base
title:  'Statistics of Definite in UD_Javanese-CSUI'
udver: '2'
---

## Treebank Statistics: UD_Javanese-CSUI: Features: `Definite`
...
364 <tt><a href="jv_csui-pos-DET.html">DET</a></tt> tokens (52% of all `DET` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `DET` and `Definite` co-occurred: <tt><a href="jv_csui-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (364; 100%), <tt><a href="jv_csui-feat-Polite.html">Polite</a></tt><tt>=Infm</tt> (332; 91%).
