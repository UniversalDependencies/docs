...
12	preesse	praesum	VERB	va5fp	Aspect=Imp|Tense=Pres|VerbForm=Inf|Voice=Act	11	xcomp	_	SpaceAfter=No|TraditionalMood=Infinitivus|TraditionalTense=Praesens
...
43	initi	innitor	VERB	vd3fp	Aspect=Imp|Tense=Pres|VerbForm=Inf|Voice=Pass	42	csubj:pass	_	TraditionalMood=Infinitivus|TraditionalTense=Praesens
