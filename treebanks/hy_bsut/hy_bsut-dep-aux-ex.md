---
layout: base
title:  'Statistics of aux:ex in UD_Armenian-BSUT'
udver: '2'
---

## Treebank Statistics: UD_Armenian-BSUT: Relations: `aux:ex`

This relation is a language-specific subtype of <tt><a href="hy_bsut-dep-aux.html">aux</a></tt>.

1 nodes (0%) are attached to their parents as `aux:ex`.

1 instances of `aux:ex` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `aux:ex`: <tt><a href="hy_bsut-pos-VERB.html">VERB</a></tt>-<tt><a href="hy_bsut-pos-AUX.html">AUX</a></tt> (1; 100% instances).
...
# visual-style 2 3 aux:ex	color:blue
