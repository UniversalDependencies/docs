---
layout: base
title:  'Statistics of goeswith in UD_Nheengatu-CompLin'
udver: '2'
---

## Treebank Statistics: UD_Nheengatu-CompLin: Relations: `goeswith`
...
1	Kũi	sú	AUX	AUXFR	Mood=Imp|Number=Sing|Person=2|VerbForm=Fin	4	aux	_	TokenRange=0:3
2	aé	aé	PRON	PRON	Case=Acc,Nom|Number=Sing|Person=3|PronType=Prs	4	obj	_	TokenRange=4:6
3	wana	wana	PART	PFV	Aspect=Perf	4	advmod	_	TokenRange=7:11
4	resikari	sikari	VERB	V	Mood=Imp|Number=Sing|Person=2|VerbForm=Fin	0	root	_	TokenRange=12:20
5	n	ne	PRON	PRON2	Case=Gen|Number=Sing|Person=2|PronType=Prs|Typo=Yes	6	nsubj	_	CorrectForm=ne|CorrectSpaceAfter=Yes|SpaceAfter=No|TokenRange=21:22
6	a	ateíma	VERB	V2	Mood=Ind|Typo=Yes|VerbForm=Fin	4	parataxis	_	CorrectForm=ateíma|TokenRange=23:24
7	teíma	_	X	X	_	6	goeswith	_	TokenRange=25:30
8	reté	reté	ADV	ADVS	AdvType=Deg	6	advmod	_	SpaceAfter=No|TokenRange=31:35
9	.	.	PUNCT	PUNCT	_	4	punct	_	SpaceAfter=No|TokenRange=35:36
...
# visual-style 6	fgColor:white
# visual-style 6 7 goeswith	color:blue
1	Rerikú	rikú	VERB	V	Mood=Ind|Number=Sing|Person=2|VerbForm=Fin	0	root	_	TokenRange=0:6
2	será	será	PART	PQ	PartType=Int	1	advmod	_	TokenRange=7:11
3	kunhã	kunhã	NOUN	N	Number=Sing	4	nmod:poss	_	TokenRange=12:17
4	xapewa	xapewa	NOUN	N	Number=Sing	1	obj	_	TokenRange=18:24
5	pinawa	pinawa	NOUN	N	Number=Sing	4	nmod	_	TokenRange=25:31
