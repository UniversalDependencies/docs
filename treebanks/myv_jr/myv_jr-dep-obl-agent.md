...
2	лиседе	лисемс	VERB	V	Mood=Ind|Number[subj]=Plur|Person[subj]=2|Valency=1	0	root	_	CGdephead=#2-&gt;2|CGdeprel=@-FADVL-partitive&gt;|GTtags=SP,Abl,Indef
...
6	лексемс	лексемс	VERB	V	Valency=1|VerbForm=Inf	2	conj	_	CGdephead=#6-&gt;6|CGdeprel=@IMV|GTtags=IV,Inf
