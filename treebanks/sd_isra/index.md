...
Language: [Sindhi](/sd/index.html) (code: `sd`)<br/>
Family: IE
...
Questions, comments?
General annotation questions (either Sindhi-specific or cross-linguistic) can be raised in the [main UD issue tracker](https://github.com/UniversalDependencies/docs/issues).
You can report bugs in this treebank in the [treebank-specific issue tracker on Github](https://github.com/UniversalDependencies/UD_Sindhi-Isra/issues).
If you want to collaborate, please contact [muteeurahman&nbsp;(æt)&nbsp;gmail&nbsp;•&nbsp;com].
...
# Statistics of UD Sindhi Isra

## POS Tags

[ADJ](sd_isra-pos-ADJ.html) – [ADP](sd_isra-pos-ADP.html) – [ADV](sd_isra-pos-ADV.html) – [AUX](sd_isra-pos-AUX.html) – [CCONJ](sd_isra-pos-CCONJ.html) – [DET](sd_isra-pos-DET.html) – [INTJ](sd_isra-pos-INTJ.html) – [NOUN](sd_isra-pos-NOUN.html) – [NUM](sd_isra-pos-NUM.html) – [PART](sd_isra-pos-PART.html) – [PRON](sd_isra-pos-PRON.html) – [PROPN](sd_isra-pos-PROPN.html) – [PUNCT](sd_isra-pos-PUNCT.html) – [SCONJ](sd_isra-pos-SCONJ.html) – [VERB](sd_isra-pos-VERB.html)
...
<ul>
  <li>Sub
    <ul>
      <li>AUX: ها, ھا</li>
      <li>VERB: اڇجانءِ, وينداسين, پيئجي</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li><a>Number[obj]</a>
    <ul>
      <li>Plur
        <ul>
          <li>VERB: ٿين, چيومانو, ڏيکاريانوَ</li>
        </ul>
      </li>
      <li>Sing
        <ul>
...
<ul>
<li>This corpus uses 1 lemmas as copulas (<a>cop</a>). Examples: آهي.</li>
</ul>
