...
297 lemmas (10%) occur at least once with a non-empty value of `Mood`.
...
1142 <tt><a href="fr_partut-pos-VERB.html">VERB</a></tt> tokens (42% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="fr_partut-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1142; 100%), <tt><a href="fr_partut-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1140; 100%), <tt><a href="fr_partut-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1017; 89%), <tt><a href="fr_partut-feat-Person.html">Person</a></tt><tt>=3</tt> (808; 71%), <tt><a href="fr_partut-feat-Number.html">Number</a></tt><tt>=Sing</tt> (719; 63%).
...
* `Ind` (972; 85% of non-empty `Mood`): <em>a, peut, doit, est, convient, ont, peuvent, fait, pouvez, concerne</em>
