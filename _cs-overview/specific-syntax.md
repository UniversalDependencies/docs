...
auxpass(dotazován-4, Jsem-2)
cc(dotazován-4, například-3)
root(ROOT-1, dotazován-4)
case(stav-8, na-5)
det(stav-8, svůj-6)
amod(stav-8, zdravotní-7)
dobj(dotazován-4, stav-8)
punct(stav-8, ,-9)
conj(stav-8, nemoci-10)
punct(léčil-16, ,-11)
case(které-13, pro-12)
advmod(léčil-16, které-13)
aux(léčil-16, jsem-14)
auxpass:reflex(léčil-16, se-15)
acl(nemoci-10, léčil-16)
cc(léčil-16, nebo-17)
case(době-20, v-18)
amod(době-20, současné-19)
nmod(léčím-21, době-20)
conj(léčil-16, léčím-21)
punct(léčil-16, ,-22)
cc(dotazován-4, a-23)
advmod:emph(je-25, dokonce-24)
conj(dotazován-4, je-25)
advmod(je-25, zde-26)
nsubj(je-25, otázka-27)
punct(podrobil-32, ,-28)
mark(podrobil-32, zda-29)
aux(podrobil-32, jsem-30)
compound:reflex(podrobil-32, se-31)
acl(otázka-27, podrobil-32)
dobj(podrobil-32, testu-33)
case(AIDS-35, na-34)
nmod(testu-33, AIDS-35)
cc(podrobil-32, a-36)
