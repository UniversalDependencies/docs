...
9 <tt><a href="xav_xdt-pos-NOUN.html">NOUN</a></tt> tokens (2% of all `NOUN` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `NOUN` and `PronType` co-occurred: <tt><a href="xav_xdt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (9; 100%), <tt><a href="xav_xdt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (6; 67%).
...
The most frequent other feature values with which `VERB` and `PronType` co-occurred: <tt><a href="xav_xdt-feat-Person-abs.html">Person[abs]</a></tt><tt>=3</tt> (1; 100%).
