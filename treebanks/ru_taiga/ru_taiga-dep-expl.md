...
1	Это	это	PART	_	_	4	expl	_	_
2	в	в	ADP	_	_	4	case	_	_
3	каком	какой	DET	_	Case=Loc|Gender=Masc|Number=Sing|PronType=Int	4	det	_	_
4	номере	номер	NOUN	_	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	0	root	_	SpaceAfter=No
