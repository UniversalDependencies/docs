...
There are 836 `NUM` lemmas (4%), 849 `NUM` types (3%) and 4638 `NUM` tokens (2%).
...
The form / lemma ratio of `NUM` is 1.015550 (the average of all parts of speech is 1.414631).
...
`NUM` occurs with 3 features: <tt><a href="pt_bosque-feat-NumType.html">NumType</a></tt> (4622; 100% instances), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (165; 4% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (158; 3% instances)
