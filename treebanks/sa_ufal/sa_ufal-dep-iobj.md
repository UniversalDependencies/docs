---
layout: base
title:  'Statistics of iobj in UD_Sanskrit-UFAL'
udver: '2'
---

## Treebank Statistics: UD_Sanskrit-UFAL: Relations: `iobj`

This relation is universal.

10 nodes (1%) are attached to their parents as `iobj`.

8 instances of `iobj` (80%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.3.

The following 3 pairs of parts of speech are connected with `iobj`: <tt><a href="sa_ufal-pos-VERB.html">VERB</a></tt>-<tt><a href="sa_ufal-pos-NOUN.html">NOUN</a></tt> (4; 40% instances), <tt><a href="sa_ufal-pos-VERB.html">VERB</a></tt>-<tt><a href="sa_ufal-pos-PRON.html">PRON</a></tt> (4; 40% instances), <tt><a href="sa_ufal-pos-ADJ.html">ADJ</a></tt>-<tt><a href="sa_ufal-pos-PRON.html">PRON</a></tt> (2; 20% instances).
...
1	तत्	तद्	PRON	_	Case=Acc|Gender=Neut|Number=Sing|PronType=Dem	2	obj	_	Translit=tat|LTranslit=tad|Gloss=it
2	श्रुत्वा	श्रु	VERB	_	VerbForm=Conv	10	advcl	_	Translit=śrutvā|LTranslit=śru|Gloss=after-having-heard
3	सा	तद्	PRON	_	Case=Nom|Gender=Fem|Number=Sing|PronType=Dem	10	nsubj	_	Translit=sā|LTranslit=tad|Gloss=she
4	पुलकित	पुलकित	ADJ	_	Compound=Yes	6	amod	_	Translit=pulakita|LTranslit=pulakita|Gloss=thrilling-for-joy
5	सर्व	सर्व	ADJ	_	Compound=Yes	6	amod	_	Translit=sarva|LTranslit=sarva|Gloss=all
6	अङ्गी	अङ्गिन्	ADJ	_	Case=Nom|Gender=Neut|Number=Sing	3	amod	_	Translit=aṅgī|LTranslit=aṅgin|Gloss=having-limbs
7	सत्वरम्	सत्वर	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	8	obl	_	Translit=satvaram|LTranslit=satvara|Gloss=in-a-hurry
8	गत्वा	गम्	VERB	_	VerbForm=Conv	10	advcl	_	Translit=gatvā|LTranslit=gam|Gloss=after-having-gone
9	राजानम्	राजन्	NOUN	_	Case=Acc|Gender=Masc|Number=Sing	10	iobj	_	Translit=rājānam|LTranslit=rājan|Gloss=king
10	ऊचे	वच्	VERB	_	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|VerbForm=Fin|Voice=Mid	0	root	_	SpaceAfter=No|Translit=ūce|LTranslit=vac|Gloss=said
...
1	तस्मै	तद्	PRON	_	Case=Dat|Gender=Masc|Number=Sing|PronType=Dem	2	iobj	_	Translit=tasmai|LTranslit=tad|Gloss=him
2	समर्पय	सम्-ऋ	VERB	_	Mood=Imp|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin|Voice=Act,Cau	0	root	_	Translit=samarpaya|LTranslit=sam-r̥|Gloss=make-to-go
3	एतान्	एतद्	PRON	_	Case=Acc|Gender=Masc|Number=Plur|PronType=Dem	2	obj	_	Translit=etān|LTranslit=etad|Gloss=these
