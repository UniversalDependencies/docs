---
layout: base
title:  'Statistics of Poss in UD_French-PUD'
udver: '2'
---

## Treebank Statistics: UD_French-PUD: Features: `Poss`

This feature is universal.
It occurs with 1 different values: `Yes`.

275 tokens (1%) have a non-empty value of `Poss`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="fr_pud-pos-DET.html">DET</a></tt> (275; 1% instances).
...
* `EMPTY` (3612): <em>le, la, les, l', un, une, des, cette, ce, de</em>
