---
layout: base
title:  'Statistics of aux:q in UD_Hebrew-HTB'
udver: '2'
---

## Treebank Statistics: UD_Hebrew-HTB: Relations: `aux:q`

This relation is a language-specific subtype of <tt><a href="he_htb-dep-aux.html">aux</a></tt>.
...
# visual-style 20 16 aux:q	color:blue
...
10	ון	ון	PROPN	PROPN	_	9	appos	_	SpaceAfter=No
11	-	-	PUNCT	PUNCT	_	10	flat:name	_	SpaceAfter=No
...
16	ה	ה	DET	DET	PronType=Art	20	aux:q	_	_
17	יהיה	היה	VERB	VERB	VerbType=Cop	20	aux	_	_
...
33	אסף	אסף	PROPN	PROPN	_	30	appos	_	_
34	רזין	רזין	PROPN	PROPN	_	33	flat:name	_	_
...
39	של	של	PART	PART	Case=Gen	41	case:gen	_	_
...
43	עתיד_	עתיד	NOUN	NOUN	Definite=Def|Gender=Masc|Number=Sing	28	iobj	_	_
...
46	של	של	PART	PART	Case=Gen	48	case:gen	_	_
