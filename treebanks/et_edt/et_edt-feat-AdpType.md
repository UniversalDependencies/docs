...
9209 <tt><a href="et_edt-pos-ADP.html">ADP</a></tt> tokens (100% of all `ADP` tokens) have a non-empty value of `AdpType`.

`ADP` tokens may have the following values of `AdpType`:

* `Post` (7245; 79% of non-empty `AdpType`): <em>eest, kohta, vahel, järgi, jooksul, vastu, korral, puhul, all, pärast</em>
* `Prep` (1964; 21% of non-empty `AdpType`): <em>üle, pärast, enne, koos, ilma, läbi, mööda, peale, alates, kuni</em>
