...
The feature is used with 1 part-of-speech tags: <tt><a href="cs_cltt-pos-NUM.html">NUM</a></tt> (58; 0% instances).

### `NUM`

58 <tt><a href="cs_cltt-pos-NUM.html">NUM</a></tt> tokens (13% of all `NUM` tokens) have a non-empty value of `NumValue`.

The most frequent other feature values with which `NUM` and `NumValue` co-occurred: <tt><a href="cs_cltt-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (58; 100%), <tt><a href="cs_cltt-feat-NumForm.html">NumForm</a></tt><tt>=Word</tt> (58; 100%), <tt><a href="cs_cltt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (38; 66%).
