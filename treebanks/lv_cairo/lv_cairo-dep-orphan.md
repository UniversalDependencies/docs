---
layout: base
title:  'Statistics of orphan in UD_Latvian-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Latvian-Cairo: Relations: `orphan`
...
The following 2 pairs of parts of speech are connected with `orphan`: <tt><a href="lv_cairo-pos-PROPN.html">PROPN</a></tt>-<tt><a href="lv_cairo-pos-NOUN.html">NOUN</a></tt> (2; 67% instances), <tt><a href="lv_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="lv_cairo-pos-NOUN.html">NOUN</a></tt> (1; 33% instances).
...
6	viņa	viņš	PRON	pp3msgn	Case=Gen|Gender=Masc|Number=Sing|Person=3|PronType=Prs	7	det	7:det	LvtbNodeId=a-c70-Cairo-p15s1w6
7	brālis	brālis	NOUN	ncmsn2	Case=Nom|Gender=Masc|Number=Sing	2	conj	7.1:nsubj	LvtbNodeId=a-c70-Cairo-p15s1w7
8	tikai	tikai	PART	q	_	9	discourse	9:discourse	LvtbNodeId=a-c70-Cairo-p15s1w8
