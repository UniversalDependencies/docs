...
1244 lemmas (13%) occur at least once with a non-empty value of `Tense`.
The feature is used with 3 part-of-speech tags: <tt><a href="sr_set-pos-VERB.html">VERB</a></tt> (7777; 8% instances), <tt><a href="sr_set-pos-AUX.html">AUX</a></tt> (6038; 6% instances), <tt><a href="sr_set-pos-ADV.html">ADV</a></tt> (280; 0% instances).

### `VERB`

7777 <tt><a href="sr_set-pos-VERB.html">VERB</a></tt> tokens (92% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5376; 69%), <tt><a href="sr_set-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (4425; 57%), <tt><a href="sr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (4425; 57%), <tt><a href="sr_set-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (4425; 57%), <tt><a href="sr_set-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (4425; 57%), <tt><a href="sr_set-feat-Person.html">Person</a></tt><tt>=3</tt> (4039; 52%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (117; 2% of non-empty `Tense`): <em>biće, doneće, imaće, moraće, predstavljaće, zavisiće, dobiće, otvoriće, Ostvarićemo, Preduzećemo</em>
* `Past` (3353; 43% of non-empty `Tense`): <em>rekao, izjavio, trebalo, rekla, dodao, mogla, saopštila, sastao, dobila, pozvao</em>
* `Pres` (4307; 55% of non-empty `Tense`): <em>kaže, ima, može, treba, mora, mogu, navodi, postoji, kažu, očekuje</em>
...
6038 <tt><a href="sr_set-pos-AUX.html">AUX</a></tt> tokens (98% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="sr_set-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (5734; 95%), <tt><a href="sr_set-feat-Person.html">Person</a></tt><tt>=3</tt> (5540; 92%), <tt><a href="sr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (5327; 88%), <tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4588; 76%).

`AUX` tokens may have the following values of `Tense`:

* `Fut` (26; 0% of non-empty `Tense`): <em>biće</em>
* `Past` (711; 12% of non-empty `Tense`): <em>bi, bio, bilo, bila, bili, bile, bih, bismo</em>
* `Pres` (5301; 88% of non-empty `Tense`): <em>je, su, će, nije, bude, smo, nisu, neće, sam, budu</em>
* `EMPTY` (150): <em>biti, Hajde</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="sr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="sr_set-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="sr_set-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>smo, budemo</em></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="sr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="sr_set-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="sr_set-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>su, budu, Nisu, budi, jesu</em></td><td><em>biće</em></td><td></td></tr>
</table>
...
* `EMPTY` (3160): <em>takođe, kada, međutim, više, još, samo, odsto, sada, nekoliko, oko</em>
...
<tt>AUX --[<tt><a href="sr_set-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (23; 85%),
