...
4	через	через	ADP	Pr	_	5	case	_	Lang=ru
5	плечо	плечо	NOUN	N	Case=Acc|Number=Sing	8	obl	_	Lang=ru
6	дӧраысь	дӧра	NOUN	N	Case=Ela|Number=Sing	7	nmod	_	_
7	сумка	сумка	NOUN	N	Case=Nom|Number=Sing	8	obj	_	OrigLang=ru
