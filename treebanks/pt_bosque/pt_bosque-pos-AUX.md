...
There are 7 `AUX` lemmas (0%), 105 `AUX` types (0%) and 5026 `AUX` tokens (2%).
...
The form / lemma ratio of `AUX` is 15.000000 (the average of all parts of speech is 1.421073).
...
`AUX` occurs with 7 features: <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt> (4987; 99% instances), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (4209; 84% instances), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt> (4196; 83% instances), <tt><a href="pt_bosque-feat-Mood.html">Mood</a></tt> (4109; 82% instances), <tt><a href="pt_bosque-feat-Tense.html">Tense</a></tt> (3899; 78% instances), <tt><a href="pt_bosque-feat-ExtPos.html">ExtPos</a></tt> (35; 1% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (9; 0% instances)

`AUX` occurs with 21 feature-value pairs: `ExtPos=AUX`, `ExtPos=INTJ`, `Gender=Masc`, `Mood=Cnd`, `Mood=Imp`, `Mood=Ind`, `Mood=Sub`, `Number=Plur`, `Number=Sing`, `Person=1`, `Person=2`, `Person=3`, `Tense=Fut`, `Tense=Imp`, `Tense=Past`, `Tense=Pqp`, `Tense=Pres`, `VerbForm=Fin`, `VerbForm=Ger`, `VerbForm=Inf`, `VerbForm=Part`
