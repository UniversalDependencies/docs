...
465 lemmas (19%) occur at least once with a non-empty value of `VerbForm`.
...
The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="fr_parisstories-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3309; 77%), <tt><a href="fr_parisstories-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (3160; 73%), <tt><a href="fr_parisstories-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (2335; 54%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (2433; 56% of non-empty `VerbForm`): <em>avait, a, est, sais, fait, était, dit, va, avais, vois</em>
* `Inf` (749; 17% of non-empty `VerbForm`): <em>faire, aller, dire, voir, parler, prendre, avoir, manger, être, rentrer</em>
* `Part` (1128; 26% of non-empty `VerbForm`): <em>fait, dit, eu, vu, passé, allée, mis, pris, allé, parlé</em>
...
<tt>VERB --[<tt><a href="fr_parisstories-dep-reparandum.html">reparandum</a></tt>]--> VERB</tt> (137; 77%),
