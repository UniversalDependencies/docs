...
4	نفس	نَفس	NOUN	N------S1R	Case=Nom|Definite=Cons|Number=Sing	3	nmod	3:nmod:nom	Vform=نَفسُ|Gloss=same,self|Root=n_f_s|Translit=nafsu|LTranslit=nafs
5	ه	هُوَ	PRON	SP---3MS2-	Case=Gen|Gender=Masc|Number=Sing|Person=3|PronType=Prs	4	nmod	4:nmod:gen	Vform=هُ|Gloss=he,she,it|Translit=hu|LTranslit=huwa
