...
2761 tokens (10%) have a non-empty value of `NameType`.
2451 types (22%) occur at least once with a non-empty value of `NameType`.
1434 lemmas (30%) occur at least once with a non-empty value of `NameType`.
The feature is used with 1 part-of-speech tags: <tt><a href="orv_birchbark-pos-PROPN.html">PROPN</a></tt> (2761; 10% instances).

### `PROPN`

2761 <tt><a href="orv_birchbark-pos-PROPN.html">PROPN</a></tt> tokens (100% of all `PROPN` tokens) have a non-empty value of `NameType`.

The most frequent other feature values with which `PROPN` and `NameType` co-occurred: <tt><a href="orv_birchbark-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2595; 94%), <tt><a href="orv_birchbark-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (2197; 80%).
...
* `Hus` (42; 2% of non-empty `NameType`): <em>-----тковье, безѹевее, борише<lbr/>ковее, боришьковее, ва<lbr/>сильеви·и, волотъковѣи, говѣновое, городьшинее, гюрегевее, дав)ꙑжею</em>
...
`NameType` seems to be **lexical feature** of `PROPN`. 100% lemmas (1433) occur only with one value of `NameType`.
...
<tt>PROPN --[<tt><a href="orv_birchbark-dep-orphan.html">orphan</a></tt>]--> PROPN</tt> (130; 94%),
