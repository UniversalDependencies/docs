...
2	흡연에	흡연	NOUN	NN+CM	Case=Advb|Polite=Form	5	advmod	_	MSeg=흡연-에|Translit=.heub.yeon.e|LTranslit=.heub.yeon
...
8	조직에서	조직	NOUN	NN+CM	Case=Advb|Polite=Form	14	advmod	_	SpaceAfter=No|MSeg=조직-에서|Translit=.jo.jig.e.seo|LTranslit=.jo.jig
9	는	는	PART	AP	_	8	dep:prt	_	Translit=.neun|LTranslit=_
10	이와	이	PRON	PRD+CM	Case=Advb|Polite=Form	11	advmod	_	MSeg=이-와|Translit=.i.wa|LTranslit=.i
...
3	가	가	PART	CM	Case=Nom|Polite=Form	1	dep:prt	_	Translit=.ga|LTranslit=_
...
9	지금보다	지금	NOUN	NN+CM	Case=Advb|Polite=Form	12	advmod	_	MSeg=지금-보다|Translit=.ji.geum.bo.da|LTranslit=.ji.geum
