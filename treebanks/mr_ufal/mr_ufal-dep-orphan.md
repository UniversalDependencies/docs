...
1	आईला	आई	NOUN	_	Case=Dat|Gender=Fem|Number=Sing	6	advcl	_	Translit=āīlā|LTranslit=āī
2	किती	किती	ADJ	_	Case=Nom	3	amod	_	Translit=kitī|LTranslit=kitī
3	चिंता	चिंता	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	1	orphan	_	Translit=ciṁtā|LTranslit=ciṁtā
4	ते	तो	PRON	_	Case=Nom|Deixis=Remt|Gender=Neut|Number=Sing|Person=3|PronType=Dem	5	det	_	Translit=te|LTranslit=to
5	मनात	मन	NOUN	_	Case=Loc|Gender=Neut|Number=Sing	6	obl	_	Translit=manāta|LTranslit=mana
6	येऊन	येणे	VERB	_	Aspect=Perf|VerbForm=Conv	10	advcl	_	Translit=yeūna|LTranslit=yeṇe
7	त्या	तो	PRON	_	Deixis=Remt|Gender=Masc|Number=Sing|Person=3|PronType=Dem	9	nmod:poss	_	Translit=tyā|LTranslit=to
