...
There are also 2 other language-specific subtypes of `mark`: [mark:advb](), [mark:comp]().

2193 nodes (2%) are attached to their parents as `mark:relcl`.

2192 instances of `mark:relcl` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.18923848609211.

The following 8 pairs of parts of speech are connected with `mark:relcl`: [zh-pos/VERB]()-[zh-pos/PART]() (1488; 68% instances), [zh-pos/ADJ]()-[zh-pos/PART]() (674; 31% instances), [zh-pos/NOUN]()-[zh-pos/PART]() (13; 1% instances), [zh-pos/PART]()-[zh-pos/PART]() (10; 0% instances), [zh-pos/ADP]()-[zh-pos/PART]() (5; 0% instances), [zh-pos/AUX]()-[zh-pos/PART]() (1; 0% instances), [zh-pos/NOUN]()-[zh-pos/NOUN]() (1; 0% instances), [zh-pos/PROPN]()-[zh-pos/PART]() (1; 0% instances).
