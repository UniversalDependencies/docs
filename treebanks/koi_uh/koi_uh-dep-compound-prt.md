---
layout: base
title:  'Statistics of compound:prt in UD_Komi_Permyak-UH'
udver: '2'
---
...
1 instances of `compound:prt` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `compound:prt`: <tt><a href="koi_uh-pos-VERB.html">VERB</a></tt>-<tt><a href="koi_uh-pos-INTJ.html">INTJ</a></tt> (1; 100% instances).
...
# visual-style 19 18 compound:prt	color:blue
