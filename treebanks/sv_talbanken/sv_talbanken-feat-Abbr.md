...
378 <tt><a href="sv_talbanken-pos-ADV.html">ADV</a></tt> tokens (5% of all `ADV` tokens) have a non-empty value of `Abbr`.

The most frequent other feature values with which `ADV` and `Abbr` co-occurred: <tt><a href="sv_talbanken-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (378; 100%).

`ADV` tokens may have the following values of `Abbr`:

* `Yes` (378; 100% of non-empty `Abbr`): <em>t.ex., ca, t ex, bl.a., etc, bl a, dvs, osv, t o m, resp</em>
* `EMPTY` (6550): <em>också, så, hur, där, här, nu, bara, ut, mycket, även</em>

`Abbr` seems to be **lexical feature** of `ADV`. 100% lemmas (21) occur only with one value of `Abbr`.

### `NOUN`

347 <tt><a href="sv_talbanken-pos-NOUN.html">NOUN</a></tt> tokens (2% of all `NOUN` tokens) have a non-empty value of `Abbr`.

The most frequent other feature values with which `NOUN` and `Abbr` co-occurred: <tt><a href="sv_talbanken-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (347; 100%), <tt><a href="sv_talbanken-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (347; 100%), <tt><a href="sv_talbanken-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (347; 100%), <tt><a href="sv_talbanken-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (347; 100%).
...
57 <tt><a href="sv_talbanken-pos-ADJ.html">ADJ</a></tt> tokens (1% of all `ADJ` tokens) have a non-empty value of `Abbr`.

The most frequent other feature values with which `ADJ` and `Abbr` co-occurred: <tt><a href="sv_talbanken-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (57; 100%), <tt><a href="sv_talbanken-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (57; 100%), <tt><a href="sv_talbanken-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (57; 100%), <tt><a href="sv_talbanken-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (57; 100%), <tt><a href="sv_talbanken-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (57; 100%), <tt><a href="sv_talbanken-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (57; 100%), <tt><a href="sv_talbanken-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (55; 96%).

`ADJ` tokens may have the following values of `Abbr`:

* `Yes` (57; 100% of non-empty `Abbr`): <em>s k, s.k., ev, resp, Kungl, Kungl., S:t, Teol, a., fil</em>
* `EMPTY` (8496): <em>olika, andra, nya, många, stora, stor, samma, större, vissa, första</em>
...
* `EMPTY` (11175): <em>i, av, på, för, till, med, om, från, vid, under</em>

## Relations with Agreement in `Abbr`

The 10 most frequent relations where parent and child node agree in `Abbr`:
<tt>NOUN --[<tt><a href="sv_talbanken-dep-conj.html">conj</a></tt>]--> NOUN</tt> (18; 72%).
