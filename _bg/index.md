...
* In general, words are delimited by whitespace characters. In our original treebank we use MWEs, such as compound subordinators, adverbs or composite pronouns. However, in UD every single token is segmented separately. For example: _за да_ / za da "in order to", _може би_ / mozhe bi "maybe", _се забавям_ / se zabavyam"slow myself". For indicating the common POS meaning, we use the relation `fixed`.
...
* A finite subordinate clause can serve the role of a subject. In such a case it is labeled as clausal subject, [csubj](). There is no infinitive in Bulgarian. The inheritant cosnstruction is finite - _да идвам_ / da idvam "to come".
...
* In Bulgarian the Yes-No questions are formed with the question particle _ли_ / li. At the moment this particle is annotated with the [discourse]() relation.
