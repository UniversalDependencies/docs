...
1374 tokens (6%) have a non-empty value of `Person`.
151 types (3%) occur at least once with a non-empty value of `Person`.
127 lemmas (3%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="en_pud-pos-PRON.html">PRON</a></tt> (745; 4% instances), <tt><a href="en_pud-pos-AUX.html">AUX</a></tt> (436; 2% instances), <tt><a href="en_pud-pos-VERB.html">VERB</a></tt> (193; 1% instances).

### `PRON`

745 <tt><a href="en_pud-pos-PRON.html">PRON</a></tt> tokens (71% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="en_pud-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (745; 100%), <tt><a href="en_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (545; 73%), <tt><a href="en_pud-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (490; 66%), <tt><a href="en_pud-feat-Case.html">Case</a></tt><tt>=Nom</tt> (382; 51%).

`PRON` tokens may have the following values of `Person`:

* `1` (110; 15% of non-empty `Person`): <em>I, we, our, my, us, me, ’s</em>
* `2` (21; 3% of non-empty `Person`): <em>you, your, 'Ya</em>
* `3` (614; 82% of non-empty `Person`): <em>it, he, his, their, they, her, its, she, him, them</em>
* `EMPTY` (299): <em>that, which, who, there, this, what, those, someone, these, whose</em>
