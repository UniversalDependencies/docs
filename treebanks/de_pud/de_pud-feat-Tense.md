...
2327 tokens (11%) have a non-empty value of `Tense`.
962 types (15%) occur at least once with a non-empty value of `Tense`.
613 lemmas (11%) occur at least once with a non-empty value of `Tense`.
The feature is used with 2 part-of-speech tags: <tt><a href="de_pud-pos-VERB.html">VERB</a></tt> (1497; 7% instances), <tt><a href="de_pud-pos-AUX.html">AUX</a></tt> (830; 4% instances).
...
830 <tt><a href="de_pud-pos-AUX.html">AUX</a></tt> tokens (95% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="de_pud-feat-Person.html">Person</a></tt><tt>=3</tt> (770; 93%), <tt><a href="de_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (719; 87%), <tt><a href="de_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (569; 69%).

`AUX` tokens may have the following values of `Tense`:

* `Past` (437; 53% of non-empty `Tense`): <em>war, wurde, worden, wurden, hatte, waren, würde, hatten, könnte, sollte</em>
* `Pres` (393; 47% of non-empty `Tense`): <em>ist, wird, sind, hat, kann, werden, haben, können, muss, sei</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="de_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_pud-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="de_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td></td><td><em>war</em></td></tr>
...
<tt>VERB --[<tt><a href="de_pud-dep-conj.html">conj</a></tt>]--> VERB</tt> (138; 79%),
<tt>VERB --[<tt><a href="de_pud-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (85; 57%),
