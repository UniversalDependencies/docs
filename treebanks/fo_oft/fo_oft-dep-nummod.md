---
layout: base
title:  'Statistics of nummod in UD_Faroese-OFT'
udver: '2'
---

## Treebank Statistics: UD_Faroese-OFT: Relations: `nummod`
...
1	Flogskiparin	flogskipari	NOUN	N	Case=Nom|Definite=Def|Gender=Masc|Number=Sing	5	nsubj	_	_
2	og	og	CCONJ	CC	_	4	cc	_	_
3	7	7	NUM	Num	Case=Nom	4	nummod	_	_
4	ferðafólk	ferðafólk	NOUN	N	Case=Nom|Definite=Ind|Gender=Neut|Number=Plur	1	conj	_	_
5	doyðu	doyða	VERB	V	Mood=Ind|Number=Plur|Tense=Past	0	root	_	SpaceAfter=No
...
1	Á	á	ADP	Pr	_	3	case	_	_
2	triðja	triðji	ADJ	A	Case=Dat|Definite=Def|Gender=Neut|Number=Sing	3	amod	_	_
3	plássi	pláss	NOUN	N	Case=Dat|Definite=Ind|Gender=Neut|Number=Sing	4	nmod	_	_
4	kom	koma	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past	0	root	_	_
5	makrelur	makrelur	NOUN	N	Case=Nom|Definite=Ind|Gender=Masc|Number=Sing	4	nsubj	_	_
6	við	við	ADP	Pr	_	9	case	_	_
7	61	61	NUM	Num	Case=Dat	8	nummod	_	_
8	milliónum	millión	NOUN	N	Case=Dat|Definite=Ind|Gender=Fem|Number=Plur	9	nummod	_	_
9	krónum	króna	NOUN	N	Case=Dat|Definite=Ind|Gender=Fem|Number=Plur	4	obl	_	SpaceAfter=No
