...
1	Referiram	referir	VERB	V	Mood=Ind|Number=Plur|Person=3|Tense=Pres	0	root	_	_
2	que	que	SCONJ	CJ	_	4	mark	_	_
3	foi	ser	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past	4	cop	_	_
4	solicitado	solicitar,solicitado	VERB	PPA	Gender=Masc|Number=Sing	1	ccomp	_	_
5	que	que	SCONJ	CJ	_	7	mark	_	_
6	isso	isso	DET	DEM	Gender=Masc|Number=Sing	7	nsubj	_	_
7	acontecesse	acontecer	VERB	V	Mood=Sub|Number=Sing|Person=3|Tense=Imp	4	csubj:pass	_	_
...
1	Foi	ser	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past	2	cop	_	_
2	dito	dizer,do	VERB	PPA	Gender=Masc|Number=Sing	0	root	_	_
3	que	que	SCONJ	CJ	_	8	mark	_	_
4	os	os	DET	DA	Gender=Masc|Number=Plur	5	det	_	_
5	japoneses	japonês	ADJ	ADJ	Gender=Masc|Number=Plur	8	nsubj	_	_
6	eram	ser	AUX	V	Mood=Ind|Number=Plur|Person=3|Tense=Imp	8	cop	_	_
