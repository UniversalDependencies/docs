...
The most frequent other feature values with which `NOUN` and `Gender` co-occurred: <tt><a href="fr_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3369; 72%).
...
* `Masc` (2018; 52% of non-empty `Gender`): <em>le, les, un, l', des, l’, son, ce, ses, ces</em>
...
1618 <tt><a href="fr_pud-pos-ADJ.html">ADJ</a></tt> tokens (100% of all `ADJ` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `ADJ` and `Gender` co-occurred: <tt><a href="fr_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1085; 67%).

`ADJ` tokens may have the following values of `Gender`:

* `Fem` (794; 49% of non-empty `Gender`): <em>première, grande, nouvelle, dernière, dernières, plusieurs, nombreuses, nouvelles, autres, deuxième</em>
...
838 <tt><a href="fr_pud-pos-VERB.html">VERB</a></tt> tokens (37% of all `VERB` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `VERB` and `Gender` co-occurred: <tt><a href="fr_pud-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (838; 100%), <tt><a href="fr_pud-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (838; 100%), <tt><a href="fr_pud-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (838; 100%), <tt><a href="fr_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (838; 100%), <tt><a href="fr_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (692; 83%).

`VERB` tokens may have the following values of `Gender`:

* `Fem` (182; 22% of non-empty `Gender`): <em>composée, dirigée, apparue, devenue, utilisée, considérée, considérées, déroulée, détruite, faite</em>
* `Masc` (656; 78% of non-empty `Gender`): <em>eu, déclaré, dit, fait, commencé, indiqué, décidé, joué, utilisé, compris</em>
...
588 <tt><a href="fr_pud-pos-PRON.html">PRON</a></tt> tokens (55% of all `PRON` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PRON` and `Gender` co-occurred: <tt><a href="fr_pud-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (542; 92%), <tt><a href="fr_pud-feat-Person.html">Person</a></tt><tt>=3</tt> (523; 89%), <tt><a href="fr_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (449; 76%).

`PRON` tokens may have the following values of `Gender`:

* `Fem` (137; 23% of non-empty `Gender`): <em>elle, se, s', elles, s’, l', laquelle, celle, lesquelles, lui</em>
* `Masc` (451; 77% of non-empty `Gender`): <em>il, ils, se, s', lui, le, s’, un, eux, je</em>
* `EMPTY` (483): <em>qui, y, on, ce, nous, je, c', cela, c’, que</em>
...
* `EMPTY` (3869): <em>de, à, en, dans, d', pour, par, d’, sur, avec</em>

<table>
  <tr><th>Paradigm <i>dont</i></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th></tr>
  <tr><td><tt><tt><a href="fr_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>dont</em></td><td><em>dont</em></td></tr>
  <tr><td><tt><tt><a href="fr_pud-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>dont</em></td><td><em>dont</em></td></tr>
</table>
...
1 <tt><a href="fr_pud-pos-X.html">X</a></tt> tokens (1% of all `X` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `X` and `Gender` co-occurred: <tt><a href="fr_pud-feat-Foreign.html">Foreign</a></tt><tt>=EMPTY</tt> (1; 100%).

`X` tokens may have the following values of `Gender`:

* `Masc` (1; 100% of non-empty `Gender`): <em>Garden</em>
* `EMPTY` (179): <em>of, the, a, Association, City, El, Ground, My, Punta, Really</em>

## Relations with Agreement in `Gender`

The 10 most frequent relations where parent and child node agree in `Gender`:
<tt>NOUN --[<tt><a href="fr_pud-dep-det.html">det</a></tt>]--> DET</tt> (3457; 100%),
...
<tt>NOUN --[<tt><a href="fr_pud-dep-acl.html">acl</a></tt>]--> VERB</tt> (104; 71%),
