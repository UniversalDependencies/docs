...
categories={(u"Documentation status",u"stub"):"""<span class="widespan" style="color:gray"><span class="hint--top hint--info" data-hint="No documentation">-</span></span>""",
            ...
            (u"Data available since",u"UD v1.3"):"""<span class="widespan"><span class="hint--top hint--info" data-hint="Schedule for release in UD version 1.3 (May 2016)"><i class="fa fa-hourglass-end"></i></span></span>""",
