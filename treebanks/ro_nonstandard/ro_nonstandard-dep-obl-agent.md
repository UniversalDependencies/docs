...
534 nodes (0%) are attached to their parents as `obl:agent`.

430 instances of `obl:agent` (81%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.78277153558052.
