...
The feature is used with 4 part-of-speech tags: [es-pos/NUM]() (11017; 3% instances), [es-pos/ADJ]() (941; 0% instances), [es-pos/PRON]() (539; 0% instances), [es-pos/DET]() (408; 0% instances).

### `NUM`

11017 [es-pos/NUM]() tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="Number.html">Number</a>=EMPTY</tt> (9390; 85%).
...
941 [es-pos/ADJ]() tokens (4% of all `ADJ` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (833; 89%).
...
408 [es-pos/DET]() tokens (1% of all `DET` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `DET` and `NumType` co-occurred: <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (408; 100%), <tt><a href="PronType.html">PronType</a>=Ind</tt> (314; 77%), <tt><a href="Number.html">Number</a>=Plur</tt> (294; 72%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (209; 51%).
...
<tt>NUM --[<a href="../dep/conj.html">conj</a>]--> NUM</tt> (354; 100%),
<tt>NUM --[<a href="../dep/nummod.html">nummod</a>]--> NUM</tt> (113; 100%),
<tt>NUM --[<a href="../dep/nmod.html">nmod</a>]--> NUM</tt> (102; 100%),
...
The feature is used with 4 part-of-speech tags: [es-pos/NUM]() (4904; 1% instances), [es-pos/ADJ]() (1956; 0% instances), [es-pos/SYM]() (288; 0% instances), [es-pos/DET]() (16; 0% instances).

### `NUM`

4904 [es-pos/NUM]() tokens (56% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="NumForm.html">NumForm</a>=EMPTY</tt> (3505; 71%), <tt><a href="Number.html">Number</a>=Plur</tt> (2735; 56%).
...
1956 [es-pos/ADJ]() tokens (5% of all `ADJ` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=EMPTY</tt> (1956; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (1534; 78%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (1099; 56%).
...
288 [es-pos/SYM]() tokens (59% of all `SYM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `SYM` and `NumType` co-occurred: <tt><a href="NumForm.html">NumForm</a>=Digit</tt> (288; 100%).

`SYM` tokens may have the following values of `NumType`:

* `Frac` (288; 100% of non-empty `NumType`): <em>%, 50%, 10%, 30%, 60%, 20%, 80%, 25%, 5%, 3%</em>
* `EMPTY` (203): <em>', 20%, /, 25%, 0,2%, 10%, 15%, 2,2%, 3,1%, 3,9%</em>
...
* `EMPTY` (85517): <em>el, la, los, un, las, una, su, sus, lo, este</em>

## Relations with Agreement in `NumType`

The 10 most frequent relations where parent and child node agree in `NumType`:
<tt>NUM --[<a href="../dep/compound.html">compound</a>]--> NUM</tt> (604; 96%),
<tt>NUM --[<a href="../dep/conj.html">conj</a>]--> NUM</tt> (65; 68%),
