...
The form / lemma ratio of `NUM` is 1.071429 (the average of all parts of speech is 1.383234).
...
`NUM` occurs with 2 features: <tt><a href="fr_parisstories-feat-Number.html">Number</a></tt> (188; 77% instances), <tt><a href="fr_parisstories-feat-Gender.html">Gender</a></tt> (6; 2% instances)
