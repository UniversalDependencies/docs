...
The feature is used with 6 part-of-speech tags: <tt><a href="sr_set-pos-NOUN.html">NOUN</a></tt> (1497; 2% instances), <tt><a href="sr_set-pos-ADJ.html">ADJ</a></tt> (496; 1% instances), <tt><a href="sr_set-pos-PROPN.html">PROPN</a></tt> (224; 0% instances), <tt><a href="sr_set-pos-DET.html">DET</a></tt> (160; 0% instances), <tt><a href="sr_set-pos-NUM.html">NUM</a></tt> (21; 0% instances), <tt><a href="sr_set-pos-PRON.html">PRON</a></tt> (1; 0% instances).
...
496 <tt><a href="sr_set-pos-ADJ.html">ADJ</a></tt> tokens (4% of all `ADJ` tokens) have a non-empty value of `Animacy`.

The most frequent other feature values with which `ADJ` and `Animacy` co-occurred: <tt><a href="sr_set-feat-Case.html">Case</a></tt><tt>=Acc</tt> (496; 100%), <tt><a href="sr_set-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (496; 100%), <tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (496; 100%), <tt><a href="sr_set-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (469; 95%), <tt><a href="sr_set-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (347; 70%).
...
* `Inan` (433; 87% of non-empty `Animacy`): <em>prvi, novi, ekonomski, veliki, drugi, politički, veći, međunarodni, socijalni, važan</em>
* `EMPTY` (11165): <em>prošle, inostranih, novi, srpske, bivši, drugi, političke, drugim, nove, evropske</em>
...
`Animacy` seems to be **lexical feature** of `ADJ`. 95% lemmas (272) occur only with one value of `Animacy`.
...
* `EMPTY` (7188): <em>EU, BiH, Kosova, Srbije, Kosovo, Srbija, Kosovu, Srbiji, UN, Beogradu</em>
...
The most frequent other feature values with which `DET` and `Animacy` co-occurred: <tt><a href="sr_set-feat-Case.html">Case</a></tt><tt>=Acc</tt> (160; 100%), <tt><a href="sr_set-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (160; 100%), <tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (160; 100%), <tt><a href="sr_set-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (141; 88%), <tt><a href="sr_set-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (141; 88%), <tt><a href="sr_set-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (83; 52%).
...
* `EMPTY` (3477): <em>koji, to, koje, koja, svoje, ove, sve, toga, nekoliko, koju</em>
...
21 <tt><a href="sr_set-pos-NUM.html">NUM</a></tt> tokens (2% of all `NUM` tokens) have a non-empty value of `Animacy`.

The most frequent other feature values with which `NUM` and `Animacy` co-occurred: <tt><a href="sr_set-feat-Case.html">Case</a></tt><tt>=Acc</tt> (21; 100%), <tt><a href="sr_set-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (21; 100%), <tt><a href="sr_set-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (21; 100%), <tt><a href="sr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (21; 100%).

`NUM` tokens may have the following values of `Animacy`:

* `Anim` (3; 14% of non-empty `Animacy`): <em>jednog</em>
* `Inan` (18; 86% of non-empty `Animacy`): <em>jedan, dva</em>
* `EMPTY` (1257): <em>tri, jedan, dve, dva, pet, četiri, 20, jedna, deset, šest</em>
...
* `EMPTY` (2404): <em>se, on, što, ona, oni, ga, mi, ih, šta, im</em>

## Relations with Agreement in `Animacy`

The 10 most frequent relations where parent and child node agree in `Animacy`:
<tt>NOUN --[<tt><a href="sr_set-dep-amod.html">amod</a></tt>]--> ADJ</tt> (439; 97%),
...
<tt>NOUN --[<tt><a href="sr_set-dep-nummod.html">nummod</a></tt>]--> NUM</tt> (14; 64%),
<tt>PROPN --[<tt><a href="sr_set-dep-conj.html">conj</a></tt>]--> PROPN</tt> (10; 56%),
<tt>PROPN --[<tt><a href="sr_set-dep-amod.html">amod</a></tt>]--> ADJ</tt> (7; 70%),
