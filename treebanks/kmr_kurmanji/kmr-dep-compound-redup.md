---
layout: base
title:  'Statistics of compound:redup in UD_Kurmanji'
udver: '2'
---

## Treebank Statistics: UD_Kurmanji: Relations: `compound:redup`

This relation is a language-specific subtype of <tt><a href="kmr-dep-compound.html">compound</a></tt>.
There are also 2 other language-specific subtypes of `compound`: <tt><a href="kmr-dep-compound-lvc.html">compound:lvc</a></tt>, <tt><a href="kmr-dep-compound-nn.html">compound:nn</a></tt>.
...
The following 1 pairs of parts of speech are connected with `compound:redup`: <tt><a href="kmr-pos-ADV.html">ADV</a></tt>-<tt><a href="kmr-pos-ADV.html">ADV</a></tt> (1; 100% instances).
