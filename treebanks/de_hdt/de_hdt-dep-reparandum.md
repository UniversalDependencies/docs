...
7	die	die	PRON	PRELS	Case=Nom|Gender=Fem|Number=Sing|Person=3|PronType=Rel	11	nsubj:pass	_	_
8	zur	zur	ADP	APPRART	AdpType=Prep|Case=Dat|Gender=Fem|PronType=Art	9	reparandum	_	_
9	zur	zur	ADP	APPRART	AdpType=Prep|Case=Dat|Gender=Fem|PronType=Art	10	case	_	_
10	Diskussion	Diskussion	NOUN	NN	Gender=Fem|Number=Sing|Person=3	11	obl	_	_
11	gestellt	stellen	VERB	VVPP	Aspect=Perf|VerbForm=Part	5	acl	_	_
12	worden	werden	AUX	VAPP	Aspect=Perf|VerbForm=Part	11	aux:pass	_	_
13	sei	sein	AUX	VAFIN	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	11	aux	_	_
