---
layout: base
title:  'Statistics of VerbType in UD_Low_Saxon-LSDC'
udver: '2'
---

## Treebank Statistics: UD_Low_Saxon-LSDC: Features: `VerbType`
...
51 <tt><a href="nds_lsdc-pos-AUX.html">AUX</a></tt> tokens (46% of all `AUX` tokens) have a non-empty value of `VerbType`.
...
* `Aux` (32; 63% of non-empty `VerbType`): <em>het, is, wil, hadde, kan, skölde, willet, hadden, hebben, hevt</em>
* `Cop` (14; 27% of non-empty `VerbType`): <em>is, was, weer, sint, weren</em>
* `Mod` (5; 10% of non-empty `VerbType`): <em>kun, künne, möcht, sul, wul</em>
