---
layout: base
title:  'Statistics of Reflex in UD_Buryat-BDT'
udver: '2'
---

## Treebank Statistics: UD_Buryat-BDT: Features: `Reflex`
...
229 <tt><a href="bxr_bdt-pos-NOUN.html">NOUN</a></tt> tokens (7% of all `NOUN` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `NOUN` and `Reflex` co-occurred: <tt><a href="bxr_bdt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (217; 95%).
...
27 <tt><a href="bxr_bdt-pos-PRON.html">PRON</a></tt> tokens (9% of all `PRON` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `PRON` and `Reflex` co-occurred: <tt><a href="bxr_bdt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (27; 100%), <tt><a href="bxr_bdt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (27; 100%), <tt><a href="bxr_bdt-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (26; 96%).

`PRON` tokens may have the following values of `Reflex`:

* `Yes` (27; 100% of non-empty `Reflex`): <em>өөрынгөө, өөрөө, өөрын, Өөһэнөө, өөрөөшье, өөһэдын, өөһэдөө, бултадаа, өөдөө, өөһэд</em>
* `EMPTY` (261): <em>би, минии, манай, намда, намайе, бидэ, эдэ, тэрэ, тэрэнэй, энэшни</em>
...
8 <tt><a href="bxr_bdt-pos-PROPN.html">PROPN</a></tt> tokens (1% of all `PROPN` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `PROPN` and `Reflex` co-occurred: <tt><a href="bxr_bdt-feat-Case.html">Case</a></tt><tt>=Nom</tt> (6; 75%).
...
1 <tt><a href="bxr_bdt-pos-ADJ.html">ADJ</a></tt> tokens (0% of all `ADJ` tokens) have a non-empty value of `Reflex`.
...
<tt>NOUN --[<tt><a href="bxr_bdt-dep-parataxis.html">parataxis</a></tt>]--> NOUN</tt> (1; 100%).
