...
18 nodes (4%) are attached to their parents as `discourse`.
...
3	it	it	PRON	_	Case=Acc|Gender=Neut|Number=Sing|Person=3|PronType=Prs	1	obl	_	Lang=en
4	o	o	DET	_	PronType=Dem	5	det	_	Lang=tr
