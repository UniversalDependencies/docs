...
29221 [ar-pos/ADJ]() tokens (100% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="Case.html">Case</a>=Gen</tt> (19101; 65%), <tt><a href="Definite.html">Definite</a>=Def</tt> (18902; 65%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (15039; 51%).
...
1442 [ar-pos/NUM]() tokens (19% of all `NUM` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NUM` and `Number` co-occurred: <tt><a href="NumForm.html">NumForm</a>=Word</tt> (1442; 100%), <tt><a href="Definite.html">Definite</a>=Red</tt> (1117; 77%), <tt><a href="Case.html">Case</a>=Gen</tt> (747; 52%).
