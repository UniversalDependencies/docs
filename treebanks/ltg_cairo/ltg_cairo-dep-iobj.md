---
layout: base
title:  'Statistics of iobj in UD_Latgalian-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Latgalian-Cairo: Relations: `iobj`

This relation is universal.

2 nodes (1%) are attached to their parents as `iobj`.

2 instances of `iobj` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.5.

The following 1 pairs of parts of speech are connected with `iobj`: <tt><a href="ltg_cairo-pos-VERB.html">VERB</a></tt>-<tt><a href="ltg_cairo-pos-NOUN.html">NOUN</a></tt> (2; 100% instances).
