...
8 instances of `iobj` (67%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.08333333333333.

The following 3 pairs of parts of speech are connected with `iobj`: <tt><a href="cs_pud-pos-VERB.html">VERB</a></tt>-<tt><a href="cs_pud-pos-PROPN.html">PROPN</a></tt> (5; 42% instances), <tt><a href="cs_pud-pos-VERB.html">VERB</a></tt>-<tt><a href="cs_pud-pos-PRON.html">PRON</a></tt> (4; 33% instances), <tt><a href="cs_pud-pos-VERB.html">VERB</a></tt>-<tt><a href="cs_pud-pos-NOUN.html">NOUN</a></tt> (3; 25% instances).
...
6	bylo	být	AUX	VpNS---XR-AA---	Aspect=Imp|Gender=Neut|Number=Sing|Polarity=Pos|Tense=Past|VerbForm=Part|Voice=Act	4	cop	4:cop	SpaceAfter=No
...
9	rozhovor	rozhovor	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	8	obj	8:obj	_
10	CNN	CNN	PROPN	NNNXX-----A---8	Abbr=Yes|Foreign=Yes|Gender=Neut|NameType=Com	8	iobj	8:iobj	LId=CNN-1|LGloss=(Cable_News_Network,_USA_TV)
11	Style	Style	PROPN	NNISX-----A----	Animacy=Inan|Gender=Masc|NameType=Com|Number=Sing	10	flat	10:flat	SpaceAfter=No
...
7	novinky	novinka	NOUN	NNFP4-----A----	Case=Acc|Gender=Fem|Number=Plur	5	obj	5:obj	SpaceAfter=No
...
3	případě	případ	NOUN	NNIS6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	6	obl	6:obl:v:loc	_
4	je	být	AUX	VB-S---3P-AA---	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	6	cop	6:cop	_
...
10	případě	případ	NOUN	NNIS6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	14	obl	14:obl:v:loc	_
11	by	být	AUX	Vc-------------	Aspect=Imp|Mood=Cnd|VerbForm=Fin	14	aux	14:aux	_
12	lovecké	lovecký	ADJ	AAFP3----1A----	Case=Dat|Degree=Pos|Gender=Fem|Number=Plur|Polarity=Pos	13	amod	13:amod	_
13	lobby	lobby	NOUN	NNFXX-----A----	Gender=Fem	14	iobj	14:iobj	_
...
16	starosti	starost	NOUN	NNFP1-----A----	Case=Nom|Gender=Fem|Number=Plur	14	nsubj	14:nsubj	SpaceAfter=No|LId=starost-1
