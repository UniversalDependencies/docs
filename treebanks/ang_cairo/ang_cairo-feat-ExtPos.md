---
layout: base
title:  'Statistics of ExtPos in UD_Old_English-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Old_English-Cairo: Features: `ExtPos`

This feature is language-specific.
It occurs with 1 different values: `PRON`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="ang_cairo-pos-PRON.html">PRON</a></tt> (1; 1% instances).
...
* `PRON` (1; 100% of non-empty `ExtPos`): <em>heom</em>
