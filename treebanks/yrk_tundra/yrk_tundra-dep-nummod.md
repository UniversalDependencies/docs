---
layout: base
title:  'Statistics of nummod in UD_Nenets-Tundra'
udver: '2'
---

## Treebank Statistics: UD_Nenets-Tundra: Relations: `nummod`

This relation is universal.

18 nodes (1%) are attached to their parents as `nummod`.

18 instances of `nummod` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.44444444444444.

The following 1 pairs of parts of speech are connected with `nummod`: <tt><a href="yrk_tundra-pos-NOUN.html">NOUN</a></tt>-<tt><a href="yrk_tundra-pos-NUM.html">NUM</a></tt> (18; 100% instances).
