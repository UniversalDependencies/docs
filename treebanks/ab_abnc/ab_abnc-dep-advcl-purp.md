...
16 nodes (0%) are attached to their parents as `advcl:purp`.

14 instances of `advcl:purp` (88%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.75.

The following 1 pairs of parts of speech are connected with `advcl:purp`: <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt>-<tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> (16; 100% instances).
