...
2	ένι	είμι	AUX	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	1	cop	_	_
3	μαγευτήρας	μαγευτήρας	NOUN	_	Case=Nom|Gender=Masc|Number=Sing	1	nsubj	_	_
4	βρε	βρε	INTJ	_	_	5	discourse	_	_
5	κόρ’	κόρ	NOUN	_	Case=Voc|Gender=Fem|Number=Sing	1	vocative	_	SpaceAfter=No
6	;	;	PUNCT	_	PunctType=Qest	1	punct	_	_
