---
layout: base
title:  'Statistics of orphan in UD_French-FQB'
udver: '2'
---

## Treebank Statistics: UD_French-FQB: Relations: `orphan`
...
The following 1 pairs of parts of speech are connected with `orphan`: <tt><a href="fr_fqb-pos-PROPN.html">PROPN</a></tt>-<tt><a href="fr_fqb-pos-VERB.html">VERB</a></tt> (1; 100% instances).
