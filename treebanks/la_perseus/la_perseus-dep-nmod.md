...
1311 nodes (4%) are attached to their parents as `nmod`.

759 instances of `nmod` (58%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.70404271548436.
