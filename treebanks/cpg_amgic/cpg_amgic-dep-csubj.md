---
layout: base
title:  'Statistics of csubj in UD_Cappadocian-AMGiC'
udver: '2'
---

## Treebank Statistics: UD_Cappadocian-AMGiC: Relations: `csubj`
...
The following 1 pairs of parts of speech are connected with `csubj`: <tt><a href="cpg_amgic-pos-ADJ.html">ADJ</a></tt>-<tt><a href="cpg_amgic-pos-VERB.html">VERB</a></tt> (1; 100% instances).
