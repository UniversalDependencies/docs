...
1	Dar	dar	CCONJ	Ccssp	Polarity=Pos	8	cc	_	_
2	pin	prin	ADP	Spca	AdpType=Prep|Case=Acc|Compound=Yes	3	case	_	_
3	târg	târg	NOUN	Ncmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	8	obl	_	_
4	pin	prin	ADP	Spca	AdpType=Prep|Case=Acc|Compound=Yes	5	case	_	_
5	Bolgrad	Belgrad	PROPN	Npmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	3	appos	_	Rhyme=ID10|Type=Imperf
6	Mi	eu	PRON	Pp1-sd--------w	Case=Dat|Number=Sing|Person=1|PronType=Prs|Strength=Weak	8	iobj	_	_
7	se	sine	PRON	Px3--a--------w	Case=Acc|Person=3|PronType=Prs|Strength=Weak	8	expl:pv	_	_
8	primblă	plimba	VERB	Vmip3s	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	_
9	Inciu	Inciu	PROPN	Npmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	8	nsubj	_	_
10	beat	beat	ADJ	Afpmsrn	Case=Acc,Nom|Definite=Ind|Degree=Pos|Gender=Masc|Number=Sing	8	xcomp	_	Rhyme=ID5|SpaceAfter=No|Type=Imperf
