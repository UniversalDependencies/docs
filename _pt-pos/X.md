...
`X` nodes are attached to their parents using 2 different relations: [pt-dep/conj]() (1; 50% tokens), [pt-dep/advmod]() (1; 50% tokens)
...
Children of `X` nodes are attached using 2 different relations: [pt-dep/case]() (1; 50% tokens), [pt-dep/nmod]() (1; 50% tokens)
