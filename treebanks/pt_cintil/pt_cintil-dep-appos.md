---
layout: base
title:  'Statistics of appos in UD_Portuguese-CINTIL'
udver: '2'
---

## Treebank Statistics: UD_Portuguese-CINTIL: Relations: `appos`

This relation is universal.

54 nodes (0%) are attached to their parents as `appos`.

54 instances of `appos` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 3.27777777777778.

The following 2 pairs of parts of speech are connected with `appos`: <tt><a href="pt_cintil-pos-NOUN.html">NOUN</a></tt>-<tt><a href="pt_cintil-pos-PRON.html">PRON</a></tt> (53; 98% instances), <tt><a href="pt_cintil-pos-PROPN.html">PROPN</a></tt>-<tt><a href="pt_cintil-pos-PRON.html">PRON</a></tt> (1; 2% instances).
