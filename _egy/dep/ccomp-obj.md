...
~~~ conllu
# text = śtt ꞽr ⸗ś ꜥnḫ ⸗f
# trans = “She is the one who will enable him to live.”
1	śtt	śtt	PRON	_	Gender=Fem|Number=Sing|Person=3|PronType=Prs	2	dislocated:nsubj	_	Hiero=𓋴(𓏏:𓏏)|Pron=Ind
2	ꞽr	ꞽri̯	VERB	_	Mood=Ind|SubForm=Pred|Tense=Fut|VerbClass=3aeinf|VerbForm=Fin|Voice=Act	0	root	_	Hiero=𓁹|SPC=Fut
