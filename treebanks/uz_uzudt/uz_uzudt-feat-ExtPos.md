---
layout: base
title:  'Statistics of ExtPos in UD_Uzbek-UzUDT'
udver: '2'
---

## Treebank Statistics: UD_Uzbek-UzUDT: Features: `ExtPos`

This feature is language-specific.
It occurs with 1 different values: `ADP`.

8 tokens (0%) have a non-empty value of `ExtPos`.
3 types (0%) occur at least once with a non-empty value of `ExtPos`.
2 lemmas (0%) occur at least once with a non-empty value of `ExtPos`.
The feature is used with 1 part-of-speech tags: <tt><a href="uz_uzudt-pos-PRON.html">PRON</a></tt> (8; 0% instances).
