...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udfi_ood214)<br />
...
You can report bugs in this treebank in the [treebank-specific issue tracker on Github](https://github.com/UniversalDependencies/UD_Finnish-OOD/issues).
If you want to collaborate, please contact [jmnybl&nbsp;(æt)&nbsp;utu&nbsp;•&nbsp;fi].
...
[ADJ](fi_ood-pos-ADJ.html) – [ADP](fi_ood-pos-ADP.html) – [ADV](fi_ood-pos-ADV.html) – [AUX](fi_ood-pos-AUX.html) – [CCONJ](fi_ood-pos-CCONJ.html) – [INTJ](fi_ood-pos-INTJ.html) – [NOUN](fi_ood-pos-NOUN.html) – [NUM](fi_ood-pos-NUM.html) – [PRON](fi_ood-pos-PRON.html) – [PROPN](fi_ood-pos-PROPN.html) – [PUNCT](fi_ood-pos-PUNCT.html) – [SCONJ](fi_ood-pos-SCONJ.html) – [SYM](fi_ood-pos-SYM.html) – [VERB](fi_ood-pos-VERB.html) – [X](fi_ood-pos-X.html)

## Features

[Abbr](fi_ood-feat-Abbr.html) – [AdpType](fi_ood-feat-AdpType.html) – [Case](fi_ood-feat-Case.html) – [Clitic](fi_ood-feat-Clitic.html) – [Connegative](fi_ood-feat-Connegative.html) – [Degree](fi_ood-feat-Degree.html) – [Derivation](fi_ood-feat-Derivation.html) – [Foreign](fi_ood-feat-Foreign.html) – [InfForm](fi_ood-feat-InfForm.html) – [Mood](fi_ood-feat-Mood.html) – [Number](fi_ood-feat-Number.html) – [Number[psor]](fi_ood-feat-Number-psor.html) – [NumType](fi_ood-feat-NumType.html) – [PartForm](fi_ood-feat-PartForm.html) – [Person](fi_ood-feat-Person.html) – [Person[psor]](fi_ood-feat-Person-psor.html) – [Polarity](fi_ood-feat-Polarity.html) – [PronType](fi_ood-feat-PronType.html) – [Reflex](fi_ood-feat-Reflex.html) – [Style](fi_ood-feat-Style.html) – [Tense](fi_ood-feat-Tense.html) – [Typo](fi_ood-feat-Typo.html) – [VerbForm](fi_ood-feat-VerbForm.html) – [Voice](fi_ood-feat-Voice.html)
