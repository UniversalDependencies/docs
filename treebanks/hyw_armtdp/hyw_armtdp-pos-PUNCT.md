...
There are 24 `PUNCT` lemmas (0%), 23 `PUNCT` types (0%) and 22576 `PUNCT` tokens (18%).
...
`PUNCT` occurs with 1 features: <tt><a href="hyw_armtdp-feat-Foreign.html">Foreign</a></tt> (2113; 9% instances)

`PUNCT` occurs with 1 feature-value pairs: `Foreign=Yes`

`PUNCT` occurs with 2 feature combinations.
The most frequent feature combination is `_` (20463 tokens).
Examples: <em>,, ։, ՝, ., «, », ՞, -, ՛, –</em>
