...
32 nodes (0%) are attached to their parents as `case:loc`.

32 instances of `case:loc` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.375.

The following 3 pairs of parts of speech are connected with `case:loc`: <tt><a href="hy_armtdp-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hy_armtdp-pos-ADP.html">ADP</a></tt> (24; 75% instances), <tt><a href="hy_armtdp-pos-PRON.html">PRON</a></tt>-<tt><a href="hy_armtdp-pos-ADP.html">ADP</a></tt> (7; 22% instances), <tt><a href="hy_armtdp-pos-PROPN.html">PROPN</a></tt>-<tt><a href="hy_armtdp-pos-ADP.html">ADP</a></tt> (1; 3% instances).
...
85	ձեռքներիցս	ձեռք	NOUN	_	Animacy=Nhum|Case=Abl|Number=Sing|Number[psor]=Plur|Person[psor]=1	86	obl	_	Translit=jeṙk’neric’s|LTranslit=jeṙk’
