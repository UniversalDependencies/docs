...
There are 501 `ADV` lemmas (2%), 508 `ADV` types (2%) and 8385 `ADV` tokens (4%).
...
* <em>mais</em>
  ...
  * <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> 16: <em>Houve <b>mais</b> que um olhar :</em>
...
* <em>muito</em>
  * <tt><a href="pt_bosque-pos-ADV.html">ADV</a></tt> 187: <em>« Foi um ato <b>muito</b> rigoroso .</em>
...
The form / lemma ratio of `ADV` is 1.013972 (the average of all parts of speech is 1.413768).
