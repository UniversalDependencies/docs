...
## Treebank Statistics: UD_Old_Turkish-Tonqq: Relations: `det`

This relation is universal.

5 nodes (3%) are attached to their parents as `det`.

5 instances of `det` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `det`: <tt><a href="otk_tonqq-pos-NOUN.html">NOUN</a></tt>-<tt><a href="otk_tonqq-pos-DET.html">DET</a></tt> (5; 100% instances).
