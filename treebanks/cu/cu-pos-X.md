---
layout: base
title:  'Statistics of X in UD_Old_Church_Slavonic'
udver: '2'
---

## Treebank Statistics: UD_Old_Church_Slavonic: POS Tags: `X`
...
`X` nodes are attached to their parents using 2 different relations: <tt><a href="cu-dep-vocative.html">vocative</a></tt> (6; 60% instances), <tt><a href="cu-dep-root.html">root</a></tt> (4; 40% instances)

Parents of `X` nodes belong to 2 different parts of speech: <tt><a href="cu-pos-X.html">X</a></tt> (6; 60% instances),  (4; 40% instances)
...
Children of `X` nodes are attached using 2 different relations: <tt><a href="cu-dep-vocative.html">vocative</a></tt> (6; 75% instances), <tt><a href="cu-dep-advcl.html">advcl</a></tt> (2; 25% instances)

Children of `X` nodes belong to 2 different parts of speech: <tt><a href="cu-pos-X.html">X</a></tt> (6; 75% instances), <tt><a href="cu-pos-VERB.html">VERB</a></tt> (2; 25% instances)
