...
220 tokens (0%) have a non-empty value of `Case`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="pt_petrogold-pos-PRON.html">PRON</a></tt> (220; 0% instances).

### `PRON`

220 <tt><a href="pt_petrogold-pos-PRON.html">PRON</a></tt> tokens (4% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="pt_petrogold-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (218; 99%), <tt><a href="pt_petrogold-feat-Number.html">Number</a></tt><tt>=Sing</tt> (143; 65%), <tt><a href="pt_petrogold-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (139; 63%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (111; 50% of non-empty `Case`): <em>o, a, lo, los, la, las, as, os, nos, </em>
* `Dat` (12; 5% of non-empty `Case`): <em>lhes, lhe</em>
* `Nom` (97; 44% of non-empty `Case`): <em>ele, eles, ela, elas, EU, ηapp</em>
* `EMPTY` (5179): <em>se, que, o, isso, isto, este, qual, a, um, uma</em>
