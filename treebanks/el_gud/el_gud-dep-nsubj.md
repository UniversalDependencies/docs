---
layout: base
title:  'Statistics of nsubj in UD_Greek-GUD'
udver: '2'
---

## Treebank Statistics: UD_Greek-GUD: Relations: `nsubj`

This relation is universal.
There are 2 language-specific subtypes of `nsubj`: <tt><a href="el_gud-dep-nsubj-outer.html">nsubj:outer</a></tt>, <tt><a href="el_gud-dep-nsubj-pass.html">nsubj:pass</a></tt>.
