...
There are 350 `ADV` lemmas (3%), 353 `ADV` types (2%) and 6441 `ADV` tokens (3%).
...
The form / lemma ratio of `ADV` is 1.008571 (the average of all parts of speech is 1.452422).
