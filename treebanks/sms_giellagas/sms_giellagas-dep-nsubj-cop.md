...
4	lij	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	3	cop	_	GTtags=Ind,Prs,Sg3
...
# visual-style 4 5 nsubj:cop	color:blue
1	Son	son	PRON	Pron	Case=Nom|Number=Sing|Person=3|PronType=Prs	2	nsubj	_	GTtags=Pers,Sg3,Nom
2	dõnnääkk	dõnnääkk	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	GTtags=Ind,Prs,Sg3|SpaceAfter=No
3	,	,	PUNCT	CLB	_	4	punct	_	_
4	mii	mii	PRON	Pron	Case=Nom|Number=Sing|PronType=Rel	2	conj	_	GTtags=Rel,Sg,Nom
5	son	son	PRON	Pron	Case=Nom|Number=Sing|Person=3|PronType=Prs	4	nsubj:cop	_	GTtags=Pers,Sg3,Nom
6	lij	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	4	cop	_	GTtags=Ind,Prs,Sg3
7	ko	ko	SCONJ	CS	_	10	mark	_	_
8	toʹb	toʹb	ADV	Adv	_	10	advmod	_	_
9	ij	ij	AUX	V	Mood=Ind|Number=Sing|Person=3|Polarity=Neg|VerbForm=Fin	10	aux	_	GTtags=Neg,Ind,Sg3,@+FAUXV
10	lueʹšt	lueʹštted	VERB	V	Connegative=Yes|Mood=Ind|Tense=Pres|VerbForm=Fin	4	advcl	_	GTtags=Ind,Prs,ConNeg
11	jååʹtted	jååʹtted	VERB	V	VerbForm=Inf	10	xcomp	_	GTtags=Inf|SpaceAfter=No
