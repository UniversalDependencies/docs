---
layout: base
title:  'Statistics of nummod in UD_Amharic-ATT'
udver: '2'
---

## Treebank Statistics: UD_Amharic-ATT: Relations: `nummod`
...
1	ከ	ከ	ADP	ADP	Case=Loc	4	case	_	LTranslit=kä|Translit=kä
2	አንድ	አንድ	NUM	NUM	NumType=Card	4	nummod	_	LTranslit='änədə|Translit='änədə
3	ኡ	ኡ	DET	DET	PronType=Art	4	det	_	LTranslit='u|Translit='u
4	አገር	አገር	NOUN	NOUN	_	9	obl	_	Translit='ägärə|LTranslit='ägärə
5	ወደ	ወደ	ADP	ADP	_	8	case	_	LTranslit=wädä|Translit=wädä
6	አንድ	አንድ	NOUN	NOUN	_	8	nummod	_	LTranslit='änədə|Translit='änədə
7	ኡ	ኡ	DET	DET	PronType=Art	8	det	_	LTranslit='u|Translit='u
8	አገር	አገር	NOUN	NOUN	_	9	obl	_	Translit='ägärə|LTranslit='ägärə
9	እየ_ዞርክ	እየ_ዞርክ	VERB	VERB	Mood=Ind|VerbForm=Fin	12	advcl	_	LTranslit='əjä_zorəkə|Translit='əjä_zorəkə
10	ኡ	እሱ	PRON	SUBJC	Number=Plur|Person=3|PronType=Prs	9	nsubj	_	LTranslit='əsu|Translit='u
11	እ	እኔ	PRON	SUBJC	Number=Sing|Person=1|PronType=Prs	12	expl	_	LTranslit='əne|Translit='ə
12	ኖር	ኖር	VERB	VERB	Mood=Ind|VerbForm=Fin	0	root	_	LTranslit=norə|Translit=norə
13	ኣል	ኣል	AUX	AUX	_	12	aux	_	LTranslit='alə|Translit='alə
...
2	ሳምንት	ሳምንት	NOUN	NOUN	_	6	obl	_	LTranslit=samənətə|Translit=samənətə
...
6	አገኝ	አገኝ	VERB	VERB	Mood=Ind|VerbForm=Fin	11	ccomp	_	LTranslit='ägäňə|Translit='ägäňə
...
9	ስ	ስ	SCONJ	SCONJ	_	11	mark	_	LTranslit=sə|Translit=sə
10	ይ	እሱ	PRON	SUBJC	Gender=Masc|Number=Sing|Person=3|PronType=Prs	11	nsubj	_	LTranslit='əsu|Translit=jə
11	ል	ል	VERB	VERB	Mood=Ind|VerbForm=Fin	12	advcl	_	LTranslit=lə|Translit=lə
12	ተጠራጠር	ተጠራጠር	VERB	VERB	Mood=Ind|VerbForm=Fin	0	root	_	LTranslit=täţäraţärə|Translit=täţäraţärə
