...
5	Λιμενικό	λιμενικό	ADJ	_	Case=Nom|Gender=Neut|Number=Sing	6	nsubj:outer	_	_
6	μπορεί	μπορώ	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	13	ccomp	_	_
...
9	.	.	PUNCT	_	_	8	punct	_	PunctType=Peri
