---
layout: base
title:  'Statistics of Reflex in UD_Tupinamba-TuDeT'
udver: '2'
---

## Treebank Statistics: UD_Tupinamba-TuDeT: Features: `Reflex`
...
4 <tt><a href="tpn_tudet-pos-ADP.html">ADP</a></tt> tokens (3% of all `ADP` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `ADP` and `Reflex` co-occurred: <tt><a href="tpn_tudet-feat-Rel.html">Rel</a></tt><tt>=EMPTY</tt> (3; 75%).
...
3 <tt><a href="tpn_tudet-pos-PRON.html">PRON</a></tt> tokens (4% of all `PRON` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `PRON` and `Reflex` co-occurred: <tt><a href="tpn_tudet-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (3; 100%).

`PRON` tokens may have the following values of `Reflex`:

* `Yes` (3; 100% of non-empty `Reflex`): <em>o</em>
* `EMPTY` (64): <em>asé, amõ, marã, aβá, jandé, mbaʔepe, iʃé, jepé, Aβáaβápe, Aβápe</em>
...
<tt>NOUN --[<tt><a href="tpn_tudet-dep-appos.html">appos</a></tt>]--> NOUN</tt> (1; 100%).
