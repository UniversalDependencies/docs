...
8961 <tt><a href="gd_arcosg-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="gd_arcosg-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (8961; 100%).
...
4220 <tt><a href="gd_arcosg-pos-NOUN.html">NOUN</a></tt> tokens (23% of all `NOUN` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `NOUN` and `VerbForm` co-occurred: <tt><a href="gd_arcosg-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (4220; 100%), <tt><a href="gd_arcosg-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (4220; 100%), <tt><a href="gd_arcosg-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (4220; 100%).

`NOUN` tokens may have the following values of `VerbForm`:

* `Inf` (1561; 37% of non-empty `VerbForm`): <em>bhith, chur, dhèanamh, thoirt, dhol, feuchainn, cur, ràdh, toirt, thogail</em>
* `Vnoun` (2659; 63% of non-empty `VerbForm`): <em>dol, ràdh, tighinn, feuchainn, iarraidh, faighinn, dèanamh, cur, ruith, coimhead</em>
* `EMPTY` (14442): <em>duine, fear, fhios, taobh, ais, rud, daoine, latha, àite, bliadhna</em>
