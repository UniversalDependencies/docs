...
13557 tokens (17%) have a non-empty value of `VerbForm`.
3063 types (24%) occur at least once with a non-empty value of `VerbForm`.
1528 lemmas (17%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 3 part-of-speech tags: <tt><a href="sv_lines-pos-VERB.html">VERB</a></tt> (9988; 13% instances), <tt><a href="sv_lines-pos-AUX.html">AUX</a></tt> (3462; 4% instances), <tt><a href="sv_lines-pos-ADJ.html">ADJ</a></tt> (107; 0% instances).

### `VERB`

9988 <tt><a href="sv_lines-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="sv_lines-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (8799; 88%), <tt><a href="sv_lines-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (6363; 64%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (5989; 60% of non-empty `VerbForm`): <em>var, har, sa, hade, gick, kom, såg, sade, är, vet</em>
* `Inf` (2904; 29% of non-empty `VerbForm`): <em>göra, ta, se, gå, använda, få, komma, bli, säga, ha</em>
* `Part` (228; 2% of non-empty `VerbForm`): <em>tvungen, taget, leende, tvungna, flåsande, gjort, sittande, svävande, tröstande, överraskande</em>
* `Sup` (867; 9% of non-empty `VerbForm`): <em>kommit, gjort, varit, blivit, fått, gått, sett, sagt, hört, tagit</em>
* `EMPTY` (33): <em>höll, närvarande, taget, förfogande, följande, gillande, gående, Beroende, betydande, fantasieggande</em>
...
3462 <tt><a href="sv_lines-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="sv_lines-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (3462; 100%), <tt><a href="sv_lines-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3072; 89%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (3091; 89% of non-empty `VerbForm`): <em>är, var, hade, kan, har, skulle, måste, kunde, vill, ska</em>
* `Inf` (279; 8% of non-empty `VerbForm`): <em>vara, ha, kunna, få, bli, vilja, komma</em>
* `Sup` (92; 3% of non-empty `VerbForm`): <em>varit, kunnat, fått, blivit, velat, kommit</em>
...
* `EMPTY` (5441): <em>andra, själv, hela, samma, annat, första, flera, många, nya, stor</em>
...
<tt>VERB --[<tt><a href="sv_lines-dep-conj.html">conj</a></tt>]--> VERB</tt> (1318; 85%),
<tt>VERB --[<tt><a href="sv_lines-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (169; 66%),
<tt>VERB --[<tt><a href="sv_lines-dep-appos.html">appos</a></tt>]--> VERB</tt> (17; 68%),
<tt>VERB --[<tt><a href="sv_lines-dep-acl-cleft.html">acl:cleft</a></tt>]--> VERB</tt> (7; 78%),
<tt>VERB --[<tt><a href="sv_lines-dep-ccomp.html">ccomp</a></tt>]--> AUX</tt> (6; 55%),
