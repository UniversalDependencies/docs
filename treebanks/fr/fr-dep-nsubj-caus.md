---
layout: base
title:  'Statistics of nsubj:caus in UD_French'
udver: '2'
---

## Treebank Statistics: UD_French: Relations: `nsubj:caus`

This relation is a language-specific subtype of <tt><a href="fr-dep-nsubj.html">nsubj</a></tt>.
There are also 1 other language-specific subtypes of `nsubj`: <tt><a href="fr-dep-nsubj-pass.html">nsubj:pass</a></tt>.

145 nodes (0%) are attached to their parents as `nsubj:caus`.

144 instances of `nsubj:caus` (99%) are right-to-left (child precedes parent).
Average distance between parent and child is 4.88965517241379.

The following 3 pairs of parts of speech are connected with `nsubj:caus`: <tt><a href="fr-pos-VERB.html">VERB</a></tt>-<tt><a href="fr-pos-PRON.html">PRON</a></tt> (66; 46% instances), <tt><a href="fr-pos-VERB.html">VERB</a></tt>-<tt><a href="fr-pos-NOUN.html">NOUN</a></tt> (52; 36% instances), <tt><a href="fr-pos-VERB.html">VERB</a></tt>-<tt><a href="fr-pos-PROPN.html">PROPN</a></tt> (27; 19% instances).
...
2	s'	se	PRON	_	Person=3|PronType=Prs	5	obj	_	SpaceAfter=No
