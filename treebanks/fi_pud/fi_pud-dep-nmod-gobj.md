...
1	Hitchcockin	Hitchcock	PROPN	_	Case=Gen|Number=Sing	3	nmod:poss	_	_
2	heikentyvä	heikentyä	ADJ	_	Case=Nom|Degree=Pos|Number=Sing	3	amod	_	_
3	terveys	terveys	NOUN	_	Case=Nom|Number=Sing	4	nsubj	_	_
4	vähensi	vähentää	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	0	root	_	_
5	hänen	hän	PRON	_	Case=Gen|Number=Sing|Person=3|PronType=Prs	6	nmod:poss	_	_
6	tuotteliaisuuttaan	tuotteliaisuus	NOUN	_	Case=Par|Derivation=Vs|Number=Sing|Person[psor]=3	4	obj	_	_
7	hänen	hän	PRON	_	Case=Gen|Number=Sing|Person=3|PronType=Prs	11	nmod:gobj	_	_
8	elämänsä	elämä	NOUN	_	Case=Gen|Number=Sing|Person[psor]=3	11	nmod:poss	_	_
9	kahden	kaksi	NUM	_	Case=Gen|Number=Sing|NumType=Card	11	nummod	_	_
10	viimeisen	viimeinen	ADJ	_	Case=Gen|Degree=Pos|Derivation=Inen|Number=Sing	11	amod	_	_
11	vuosikymmenen	vuosikymmen	NOUN	_	Case=Gen|Number=Sing	12	nmod:poss	_	_
12	aikana	aika	NOUN	_	Case=Ess|Number=Sing	4	obl	_	SpaceAfter=No
