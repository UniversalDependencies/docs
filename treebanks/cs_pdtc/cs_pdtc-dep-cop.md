---
layout: base
title:  'Statistics of cop in UD_Czech-PDTC'
udver: '2'
---

## Treebank Statistics: UD_Czech-PDTC: Relations: `cop`

This relation is universal.

71019 nodes (2%) are attached to their parents as `cop`.

55692 instances of `cop` (78%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.27975612160126.

The following 15 pairs of parts of speech are connected with `cop`: <tt><a href="cs_pdtc-pos-NOUN.html">NOUN</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (29903; 42% instances), <tt><a href="cs_pdtc-pos-ADJ.html">ADJ</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (23138; 33% instances), <tt><a href="cs_pdtc-pos-ADV.html">ADV</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (8731; 12% instances), <tt><a href="cs_pdtc-pos-PRON.html">PRON</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (2547; 4% instances), <tt><a href="cs_pdtc-pos-DET.html">DET</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (2290; 3% instances), <tt><a href="cs_pdtc-pos-PROPN.html">PROPN</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (2176; 3% instances), <tt><a href="cs_pdtc-pos-NUM.html">NUM</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (1186; 2% instances), <tt><a href="cs_pdtc-pos-PART.html">PART</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (907; 1% instances), <tt><a href="cs_pdtc-pos-X.html">X</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (60; 0% instances), <tt><a href="cs_pdtc-pos-ADP.html">ADP</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (37; 0% instances), <tt><a href="cs_pdtc-pos-SYM.html">SYM</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (30; 0% instances), <tt><a href="cs_pdtc-pos-VERB.html">VERB</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (7; 0% instances), <tt><a href="cs_pdtc-pos-CCONJ.html">CCONJ</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (4; 0% instances), <tt><a href="cs_pdtc-pos-INTJ.html">INTJ</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (2; 0% instances), <tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt>-<tt><a href="cs_pdtc-pos-AUX.html">AUX</a></tt> (1; 0% instances).
...
2	Takže	takže	CCONJ	J^-------------	_	3	cc	3:cc	Functor=3:PREC
...
6	tom	ten	DET	PDZS6----------	Case=Loc|Gender=Masc,Neut|Number=Sing|PronType=Dem	3	obl:arg	3:obl:arg:na:loc	Functor=3:DPHR
...
10	pro	pro	ADP	RR--4----------	AdpType=Prep|Case=Acc	11	case	11:case	Entity=(cmpr9410019e1--2-gstype:spec|LId=pro-1
11	Evropu	Evropa	PROPN	NNFS4-----A----	Case=Acc|Gender=Fem|NameType=Geo,Giv|Number=Sing	9	obl	9:obl:pro:acc	Entity=cmpr9410019e1)|Functor=9:BEN|SpaceAfter=No
