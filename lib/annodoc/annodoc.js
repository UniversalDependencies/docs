...
//                    '</span></span>';
    ...
    var createDocumentationLink = function(e, collections) {
        ...
        if (e.attr('href')) {
            ...
            // "old-style" collection structure (e.g. _zh-dep/) with
            // equivalends in "new-style" structure (e.g. _zh/dep/)
            s = s.replace(/^_([a-z]{2,3})-(pos|dep|feat)/, '$1/$2');
        }
        ...
        if (collDocByName[s] !== null) {
            ...
            e.css('color', 'red');
            if (e.attr('title') === undefined) {
                e.attr('title', 'failed to link to any entry in any collection')
            }
        }
    };
