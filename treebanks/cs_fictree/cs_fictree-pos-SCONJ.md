...
There are 36 `SCONJ` lemmas (0%), 37 `SCONJ` types (0%) and 4760 `SCONJ` tokens (3%).
...
The form / lemma ratio of `SCONJ` is 1.027778 (the average of all parts of speech is 1.973298).
