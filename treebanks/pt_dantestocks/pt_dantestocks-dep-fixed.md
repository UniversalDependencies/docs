---
layout: base
title:  'Statistics of fixed in UD_Portuguese-DANTEStocks'
udver: '2'
---

## Treebank Statistics: UD_Portuguese-DANTEStocks: Relations: `fixed`
...
1	OIBR4	OIBR4	PROPN	_	_	2	nsubj	_	_
2	foi	ir	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	_
3	para	para	ADP	_	_	5	case	_	_
4	o	o	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	5	det	_	_
5	leilão	leilão	NOUN	_	Gender=Masc|Number=Sing	2	obl	_	_
...
5	região	região	NOUN	_	Gender=Fem|Number=Sing	3	obj	_	_
6	de	de	ADP	_	_	8	case	_	_
7	os	o	DET	_	Definite=Def|Gender=Masc|Number=Plur|PronType=Art	8	det	_	_
8	R$	R$	SYM	_	_	5	nmod	_	SpaceAfter=No
9	15,70	15,70	NUM	_	NumType=Card	8	nummod	_	_
10	...	...	PUNCT	_	_	3	punct	_	_
11	Vai	ir	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	3	parataxis	_	_
