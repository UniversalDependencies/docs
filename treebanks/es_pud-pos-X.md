...
There are 1 `X` lemmas (6%), 18 `X` types (0%) and 20 `X` tokens (0%).
Out of 14 observed tags, the rank of `X` is: 14 in number of lemmas, 11 in number of types and 14 in number of tokens.
...
The form / lemma ratio of `X` is 18.000000 (the average of all parts of speech is 362.705882).
