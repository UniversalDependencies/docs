...
2082 tokens (10%) have a non-empty value of `Form`.
...
The feature is used with 5 part-of-speech tags: <tt><a href="gv_cadhan-pos-VERB.html">VERB</a></tt> (1032; 5% instances), <tt><a href="gv_cadhan-pos-NOUN.html">NOUN</a></tt> (874; 4% instances), <tt><a href="gv_cadhan-pos-ADJ.html">ADJ</a></tt> (95; 0% instances), <tt><a href="gv_cadhan-pos-PROPN.html">PROPN</a></tt> (57; 0% instances), <tt><a href="gv_cadhan-pos-NUM.html">NUM</a></tt> (24; 0% instances).

### `VERB`

1032 <tt><a href="gv_cadhan-pos-VERB.html">VERB</a></tt> tokens (38% of all `VERB` tokens) have a non-empty value of `Form`.

The most frequent other feature values with which `VERB` and `Form` co-occurred: <tt><a href="gv_cadhan-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1011; 98%), <tt><a href="gv_cadhan-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (845; 82%).

`VERB` tokens may have the following values of `Form`:

* `Ecl` (173; 17% of non-empty `Form`): <em>vel, nod, dug, ver, vod, naik, daink, Verym, darragh, dooar</em>
...
* `Len` (851; 82% of non-empty `Form`): <em>hug, va, haink, v', hooar, hie, Huitt, ghow, cheau, Hayrn</em>
...
874 <tt><a href="gv_cadhan-pos-NOUN.html">NOUN</a></tt> tokens (21% of all `NOUN` tokens) have a non-empty value of `Form`.
...
* `Len` (825; 94% of non-empty `Form`): <em>ghooinney, chione, yannoo, chooid, chur, valley, ghoaill, gholl, vlein, akin</em>
