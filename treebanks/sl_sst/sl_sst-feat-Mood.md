...
772 types (13%) occur at least once with a non-empty value of `Mood`.
...
`Mood` seems to be **lexical feature** of `VERB`. 92% lemmas (417) occur only with one value of `Mood`.
...
<tt>VERB --[<tt><a href="sl_sst-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (198; 54%),
<tt>VERB --[<tt><a href="sl_sst-dep-conj.html">conj</a></tt>]--> VERB</tt> (142; 72%),
<tt>VERB --[<tt><a href="sl_sst-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (90; 59%),
<tt>VERB --[<tt><a href="sl_sst-dep-reparandum.html">reparandum</a></tt>]--> VERB</tt> (35; 90%),
