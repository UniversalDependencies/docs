...
14731 tokens (10%) have a non-empty value of `Case`.
...
The feature is used with 7 part-of-speech tags: <tt><a href="pcm_nsc-pos-PRON.html">PRON</a></tt> (14709; 10% instances), <tt><a href="pcm_nsc-pos-X.html">X</a></tt> (6; 0% instances), <tt><a href="pcm_nsc-pos-NOUN.html">NOUN</a></tt> (5; 0% instances), <tt><a href="pcm_nsc-pos-PROPN.html">PROPN</a></tt> (5; 0% instances), <tt><a href="pcm_nsc-pos-AUX.html">AUX</a></tt> (4; 0% instances), <tt><a href="pcm_nsc-pos-PART.html">PART</a></tt> (1; 0% instances), <tt><a href="pcm_nsc-pos-SCONJ.html">SCONJ</a></tt> (1; 0% instances).

### `PRON`

14709 <tt><a href="pcm_nsc-pos-PRON.html">PRON</a></tt> tokens (81% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="pcm_nsc-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (14709; 100%), <tt><a href="pcm_nsc-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (14691; 100%), <tt><a href="pcm_nsc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8140; 55%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (2818; 19% of non-empty `Case`): <em>am, me, dem, us, una, yourself, mysef, oursef, yoursef, myself</em>
* `Nom` (11891; 81% of non-empty `Case`): <em>I, you, e, we, de, im, dem, me, she, una</em>
* `EMPTY` (3550): <em>my, your, wetin, dat, our, deir, dis, everybody, some, everyting</em>
...
* `EMPTY` (14760): <em>people, one, money, ting, school, time, man, person, house, work</em>
...
* `EMPTY` (2175): <em>God, Nigeria, Jesus, Pidgin, English, Lagos, Alaska, Jos, Abuja, WAEC</em>

### `AUX`

4 <tt><a href="pcm_nsc-pos-AUX.html">AUX</a></tt> tokens (0% of all `AUX` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `AUX` and `Case` co-occurred: <tt><a href="pcm_nsc-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (3; 75%), <tt><a href="pcm_nsc-feat-PartType.html">PartType</a></tt><tt>=EMPTY</tt> (3; 75%).

`AUX` tokens may have the following values of `Case`:

* `Nom` (4; 100% of non-empty `Case`): <em>'m, Don, be</em>
* `EMPTY` (12266): <em>dey, go, na, con, don, be, make, fit, come, meh</em>
...
* `EMPTY` (3017): <em>no, o, sef, sha, not, dem, ma, n't, shey, ni</em>
...
<tt>PRON --[<tt><a href="pcm_nsc-dep-reparandum.html">reparandum</a></tt>]--> PRON</tt> (112; 93%),
