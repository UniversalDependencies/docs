...
6	кирвайсь	кирваземс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past	0	root	_	GTtags=IV,Ind,Prt1,ScSg3|SpaceAfter=No
7	,	,	PUNCT	CLB	_	9	punct	_	_
8	ды	ды	CCONJ	CC	_	9	cc	_	_
9	тулкадизе	тулкадемс	VERB	V	Mood=Ind|Number[obj]=Sing|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Tense=Past	6	conj	_	GTtags=TV,Ind,Prt1,ScSg3,OcSg3
...
15	палсесть	палсемс	VERB	V	Mood=Ind|Number[subj]=Plur|Person[subj]=3|Tense=Past	7	conj	_	GTtags=TV,Ind,Prt1,ScPl3|SpaceAfter=No
