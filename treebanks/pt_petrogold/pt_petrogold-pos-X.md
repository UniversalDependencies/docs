...
There are 102 `X` lemmas (1%), 115 `X` types (1%) and 217 `X` tokens (0%).
...
The form / lemma ratio of `X` is 1.127451 (the average of all parts of speech is 1.452422).
