...
There are 31 `DET` lemmas (0%), 83 `DET` types (1%) and 6721 `DET` tokens (8%).
...
The form / lemma ratio of `DET` is 2.677419 (the average of all parts of speech is 1.238049).
...
`DET` occurs with 7 features: <tt><a href="pt_dantestocks-feat-PronType.html">PronType</a></tt> (6721; 100% instances), <tt><a href="pt_dantestocks-feat-Number.html">Number</a></tt> (6672; 99% instances), <tt><a href="pt_dantestocks-feat-Gender.html">Gender</a></tt> (6615; 98% instances), <tt><a href="pt_dantestocks-feat-Definite.html">Definite</a></tt> (5896; 88% instances), <tt><a href="pt_dantestocks-feat-Poss.html">Poss</a></tt> (311; 5% instances), <tt><a href="pt_dantestocks-feat-ExtPos.html">ExtPos</a></tt> (13; 0% instances), <tt><a href="pt_dantestocks-feat-Typo.html">Typo</a></tt> (6; 0% instances)
