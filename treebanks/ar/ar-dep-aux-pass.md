---
layout: base
title:  'Statistics of aux:pass in UD_Arabic'
udver: '2'
---

## Treebank Statistics: UD_Arabic: Relations: `aux:pass`

This relation is a language-specific subtype of <tt><a href="ar-dep-aux.html">aux</a></tt>.

113 nodes (0%) are attached to their parents as `aux:pass`.

110 instances of `aux:pass` (97%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.0353982300885.

The following 1 pairs of parts of speech are connected with `aux:pass`: <tt><a href="ar-pos-VERB.html">VERB</a></tt>-<tt><a href="ar-pos-PART.html">PART</a></tt> (113; 100% instances).
