---
layout: base
title:  'Statistics of ccomp in UD_Western_Sierra_Puebla_Nahuatl-ITML'
udver: '2'
---

## Treebank Statistics: UD_Western_Sierra_Puebla_Nahuatl-ITML: Relations: `ccomp`
...
1	O	o	AUX	_	_	2	aux	2:aux	Orig=Onechnotzkej|Gloss=me.avisaron|NormalizedForm=o|NormalizedLemma=o
2	nechnotzkej	notza	VERB	_	Aspect=Perf|Mood=Ind|Number[obj]=Sing|Number[subj]=Plur|Person[obj]=1|Person[subj]=3|Subcat=Tran|Tense=Past|VerbForm=Fin	0	root	0:root	NormalizedForm=nechnotskeh|NormalizedLemma=notsa
3	mach	mach	AUX	_	_	11	aux	11:aux	Orig=mach|Gloss=cita|NormalizedForm=mach|NormalizedLemma=mach
4	itich	tich	NOUN	_	NounType=Relat|Number=Sing|Number[psor]=Sing|Number[subj]=Plur|Person[psor]=3|Person[subj]=1	11	obl	11:obl	Orig=itich|Gloss=en|NormalizedForm=itich|NormalizedLemma=tich
...
11	porobes	pobre	ADJ	_	_	2	ccomp	2:ccomp	Gloss=pobres|Orig=porobes|SpaceAfter=No|NormalizedForm=porobes|NormalizedLemma=pobre
12	.	.	PUNCT	_	_	2	punct	2:punct	Orig=.|Gloss=.|NormalizedForm=.|NormalizedLemma=.
...
1	Bueno	bueno	ADV	_	Foreign=Yes	4	advmod	4:advmod	NormalizedForm=Bueno|NormalizedLemma=bueno
2	yeh	yehwatl	PRON	_	Number=Sing|Person=3|PronType=Prs	4	nsubj	4:nsubj	NormalizedForm=yeh|NormalizedLemma=yehwatl
3	o	o	AUX	_	_	4	aux	4:aux	NormalizedForm=o|NormalizedLemma=o
4	kimatia	mati	VERB	_	Aspect=Imp|Mood=Ind|Number[obj]=Sing|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Subcat=Tran|Tense=Past|VerbForm=Fin	0	root	0:root	NormalizedForm=kimatia|NormalizedLemma=mati
...
7	motlakitskilia	motlakitskilia	VERB	_	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Subcat=Tran|Tense=Pres|VerbForm=Fin	4	conj	4:conj	SpaceAfter=No|NormalizedForm=motlakitskilia|NormalizedLemma=motlakitskilia
