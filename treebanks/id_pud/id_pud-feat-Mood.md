---
layout: base
title:  'Statistics of Mood in UD_Indonesian-PUD'
udver: '2'
---

## Treebank Statistics: UD_Indonesian-PUD: Features: `Mood`

This feature is universal.
It occurs with 1 different values: `Ind`.

2395 tokens (12%) have a non-empty value of `Mood`.
982 types (21%) occur at least once with a non-empty value of `Mood`.
627 lemmas (17%) occur at least once with a non-empty value of `Mood`.
...
* `Ind` (2395; 100% of non-empty `Mood`): <em>menjadi, ada, memiliki, membuat, mulai, mengatakan, merupakan, ujar, digunakan, mendapatkan</em>

`Mood` seems to be **lexical feature** of `VERB`. 100% lemmas (627) occur only with one value of `Mood`.
