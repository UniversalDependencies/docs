...
668 instances of `amod` (70%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.21097046413502.

The following 3 pairs of parts of speech are connected with `amod`: <tt><a href="fr_fqb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="fr_fqb-pos-ADJ.html">ADJ</a></tt> (914; 96% instances), <tt><a href="fr_fqb-pos-PROPN.html">PROPN</a></tt>-<tt><a href="fr_fqb-pos-ADJ.html">ADJ</a></tt> (33; 3% instances), <tt><a href="fr_fqb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="fr_fqb-pos-ADP.html">ADP</a></tt> (1; 0% instances).
...
11	-t-il	il	PRON	_	Gender=Masc|Number=Sing|Person=3|PronType=Prs	12	expl:subj	_	_
...
11	le	le	DET	_	Definite=Def|ExtPos=PRON|Gender=Masc|Number=Sing|PronType=Art	10	obj	_	_
12	plus	plus	ADV	_	_	11	fixed	_	_
13	de	de	ADP	_	_	14	case	_	_
14	victoires	victoire	NOUN	_	Gender=Fem|Number=Plur	11	obl:arg	_	_
