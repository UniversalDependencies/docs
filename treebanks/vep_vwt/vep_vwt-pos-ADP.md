...
The 10 most frequent `ADP` lemmas: <em>täht, jälʼghe, taga, abu, edel, kacmata, keskes, möto, polhe, polʼ</em>

The 10 most frequent `ADP` types:  <em>täht, jälʼghe, polhe, taga, Kacmata, abul, edel, keskes, möto, päle</em>

The 10 most frequent ambiguous lemmas: <em>edel</em> (<tt><a href="vep_vwt-pos-ADP.html">ADP</a></tt> 1, <tt><a href="vep_vwt-pos-ADV.html">ADV</a></tt> 1), <em>polʼ</em> (<tt><a href="vep_vwt-pos-ADP.html">ADP</a></tt> 1, <tt><a href="vep_vwt-pos-NOUN.html">NOUN</a></tt> 1)
...
The form / lemma ratio of `ADP` is 0.916667 (the average of all parts of speech is 1.550649).
...
The 3rd highest number of forms (1) was observed with the lemma “jälʼghe”: <em>jälʼghe</em>.
...
Examples: <em>täht, polhe, taga, abul, edel, jälʼghe, keskes, möto, päle</em>
