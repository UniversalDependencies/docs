...
26410 tokens (9%) have a non-empty value of `AdpType`.
...
The feature is used with 1 part-of-speech tags: [la-pos/ADP]() (26410; 9% instances).

### `ADP`

26410 [la-pos/ADP]() tokens (100% of all `ADP` tokens) have a non-empty value of `AdpType`.

`ADP` tokens may have the following values of `AdpType`:

* `Prep` (26410; 100% of non-empty `AdpType`): <em>in, ad, per, ex, secundum, de, a, ab, propter, supra</em>
...
<tt>ADP --[<a href="../dep/mwe.html">mwe</a>]--> ADP</tt> (44; 100%),
