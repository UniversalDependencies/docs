...
In UD_Classical_Armenian-CAVaL, `X` is used for code-switching where it is not meaningful to analyze the intervening language grammatically. Such words have the morphological feature [Foreign=Yes](xcl-feat/Foreign). Sequences of multiple foreign words are joined together by the <code>flat</code> relation.
...
<!-- Interlanguage links updated Po 29. června 2026, 17:57:49 CEST -->
