...
* `Pres` (6132; 55% of non-empty `Tense`): <em>tem, há, pode, diz, é, deve, está, têm, podem, faz</em>
* `EMPTY` (9543): <em>fazer, ter, ver, dar, dizer, feito, partir, falar, feita, saber</em>
...
3892 <tt><a href="pt_bosque-pos-AUX.html">AUX</a></tt> tokens (78% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (3891; 100%), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt><tt>=3</tt> (3737; 96%), <tt><a href="pt_bosque-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3671; 94%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2999; 77%).
...
* `Pres` (2442; 63% of non-empty `Tense`): <em>é, são, está, vai, estão, tem, seja, vão, têm, tenha</em>
