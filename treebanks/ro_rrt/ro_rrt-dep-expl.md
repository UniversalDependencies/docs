...
555 nodes (0%) are attached to their parents as `expl`.

488 instances of `expl` (88%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.34234234234234.
