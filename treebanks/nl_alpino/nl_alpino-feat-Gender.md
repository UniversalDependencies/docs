...
33755 tokens (16%) have a non-empty value of `Gender`.
11463 types (42%) occur at least once with a non-empty value of `Gender`.
11093 lemmas (50%) occur at least once with a non-empty value of `Gender`.
The feature is used with 2 part-of-speech tags: <tt><a href="nl_alpino-pos-NOUN.html">NOUN</a></tt> (27312; 13% instances), <tt><a href="nl_alpino-pos-PROPN.html">PROPN</a></tt> (6443; 3% instances).

### `NOUN`

27312 <tt><a href="nl_alpino-pos-NOUN.html">NOUN</a></tt> tokens (77% of all `NOUN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NOUN` and `Gender` co-occurred: <tt><a href="nl_alpino-feat-Number.html">Number</a></tt><tt>=Sing</tt> (27312; 100%).

`NOUN` tokens may have the following values of `Gender`:

* `Com` (18563; 68% of non-empty `Gender`): <em>heer, plaats, tijd, minister, flo, stad, man, dag, week, politie</em>
...
* `EMPTY` (8289): <em>mensen, kinderen, jaren, problemen, zaken, landen, boeken, dagen, vrouwen, weken</em>
...
`Gender` seems to be **lexical feature** of `NOUN`. 99% lemmas (8111) occur only with one value of `Gender`.
...
<tt>NOUN --[<tt><a href="nl_alpino-dep-acl-relcl.html">acl:relcl</a></tt>]--> NOUN</tt> (23; 55%),
