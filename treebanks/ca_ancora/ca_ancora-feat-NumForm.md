...
The feature is used with 4 part-of-speech tags: <tt><a href="ca_ancora-pos-NUM.html">NUM</a></tt> (6061; 1% instances), <tt><a href="ca_ancora-pos-NOUN.html">NOUN</a></tt> (832; 0% instances), <tt><a href="ca_ancora-pos-SYM.html">SYM</a></tt> (806; 0% instances), <tt><a href="ca_ancora-pos-ADJ.html">ADJ</a></tt> (21; 0% instances).

### `NUM`

6061 <tt><a href="ca_ancora-pos-NUM.html">NUM</a></tt> tokens (66% of all `NUM` tokens) have a non-empty value of `NumForm`.

The most frequent other feature values with which `NUM` and `NumForm` co-occurred: <tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (6061; 100%), <tt><a href="ca_ancora-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (6061; 100%), <tt><a href="ca_ancora-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (6047; 100%).

`NUM` tokens may have the following values of `NumForm`:

* `Digit` (6061; 100% of non-empty `NumForm`): <em>10, 15, 30, 20, 5, 4, 12, 2, 2000, 25</em>

`NumForm` seems to be **lexical feature** of `NUM`. 100% lemmas (1605) occur only with one value of `NumForm`.
...
806 <tt><a href="ca_ancora-pos-SYM.html">SYM</a></tt> tokens (17% of all `SYM` tokens) have a non-empty value of `NumForm`.
...
<tt>NUM --[<tt><a href="ca_ancora-dep-nmod.html">nmod</a></tt>]--> SYM</tt> (206; 94%),
<tt>NUM --[<tt><a href="ca_ancora-dep-conj.html">conj</a></tt>]--> NUM</tt> (201; 98%),
