...
42 nodes (0%) are attached to their parents as `dep:comp`.

32 instances of `dep:comp` (76%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.95238095238095.
