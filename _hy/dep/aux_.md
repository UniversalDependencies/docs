...
Note that in Armenian auxiliary verb _տալ_ used to construct causative constructions is labeled [aux:caus](). We use [aux:ex](aux:ex) for finite form of existentials _կամ&nbsp;_ “be, exist” and _ունեմ&nbsp;_ “have” in combination with resultative participle.
