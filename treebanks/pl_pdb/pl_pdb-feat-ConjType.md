...
1459 tokens (0%) have a non-empty value of `ConjType`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="pl_pdb-pos-SCONJ.html">SCONJ</a></tt> (1455; 0% instances), <tt><a href="pl_pdb-pos-CCONJ.html">CCONJ</a></tt> (4; 0% instances).

### `SCONJ`

1455 <tt><a href="pl_pdb-pos-SCONJ.html">SCONJ</a></tt> tokens (19% of all `SCONJ` tokens) have a non-empty value of `ConjType`.

`SCONJ` tokens may have the following values of `ConjType`:

* `Comp` (890; 61% of non-empty `ConjType`): <em>jak, niż, jakby, niczym, jakoby, aniżeli, niby</em>
* `Pred` (565; 39% of non-empty `ConjType`): <em>jako</em>
