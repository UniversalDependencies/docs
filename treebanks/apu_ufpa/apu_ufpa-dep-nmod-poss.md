...
7 nodes (1%) are attached to their parents as `nmod:poss`.
...
The following 2 pairs of parts of speech are connected with `nmod:poss`: <tt><a href="apu_ufpa-pos-NOUN.html">NOUN</a></tt>-<tt><a href="apu_ufpa-pos-NOUN.html">NOUN</a></tt> (6; 86% instances), <tt><a href="apu_ufpa-pos-NOUN.html">NOUN</a></tt>-<tt><a href="apu_ufpa-pos-PRON.html">PRON</a></tt> (1; 14% instances).
...
8	ithupytymary	ithu	VERB	XPOS=ter.muito-ENF-FRUSTR	Gender[obj]=Masc|Mood=Ind|Number[obj]=Sing|Person[obj]=3|Tense=Past,Pres|VerbForm=Fin	4	conj	_	gloss[pt]=ter.muito-ENF-FRUSTR-3SG.M.O
