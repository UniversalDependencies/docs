...
2	пиялэны	пиявны	VERB	V	Mood=Ind|Number=Plur|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	GTtags=V,IV,Ind,Prs,Pl3|SpaceAfter=No
...
6	пиялэ	пиявны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	2	conj	_	GTtags=V,IV,Ind,Prs,Sg3
