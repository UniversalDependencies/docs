...
The relation `aux` is  used between an auxiliary verb and a predicate (verb, adverb, adjective...). Auxiliaries are used to express TAME (Time, Aspect, Mood, Evidentiality). In Bambara auxiliaries precede the predicate and there can be several of them attached to the same governor.
...
The auxiliaries of Bambara include :
