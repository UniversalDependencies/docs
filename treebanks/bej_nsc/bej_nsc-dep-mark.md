...
47 instances of `mark` (98%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.6875.

The following 2 pairs of parts of speech are connected with `mark`: <tt><a href="bej_nsc-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_nsc-pos-SCONJ.html">SCONJ</a></tt> (46; 96% instances), <tt><a href="bej_nsc-pos-AUX.html">AUX</a></tt>-<tt><a href="bej_nsc-pos-SCONJ.html">SCONJ</a></tt> (2; 4% instances).
