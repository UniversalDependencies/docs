---
layout: base
title:  'Statistics of parataxis in UD_Danish'
udver: '2'
---

## Treebank Statistics: UD_Danish: Relations: `parataxis`
...
The following 1 pairs of parts of speech are connected with `parataxis`: <tt><a href="da-pos-INTJ.html">INTJ</a></tt>-<tt><a href="da-pos-VERB.html">VERB</a></tt> (1; 100% instances).
