---
layout: base
title:  'Statistics of advcl:tmod in UD_Moksha-JR'
udver: '2'
---

## Treebank Statistics: UD_Moksha-JR: Relations: `advcl:tmod`
...
# visual-style 6 4 advcl:tmod	color:blue
...
# visual-style 6	bgColor:blue
# visual-style 6	fgColor:white
# visual-style 6 3 advcl:tmod	color:blue
1	А	а	CCONJ	CC	_	3	cc	_	_
2	къда	кда	SCONJ	CS	Style=Ped	3	mark	_	ModernForm=кда
3	токади	токадемс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Pres|Valency=1	6	advcl:tmod	_	GTtags=IV,Ind,Prs,ScSg3
