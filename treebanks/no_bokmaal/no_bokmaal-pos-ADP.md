...
The form / lemma ratio of `ADP` is 1.049383 (the average of all parts of speech is 1.381919).
...
35519 (98%) `ADP` nodes are leaves.

350 (1%) `ADP` nodes have one child.
