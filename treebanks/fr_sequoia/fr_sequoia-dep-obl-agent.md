...
2	mobilier	mobilier	NOUN	_	Gender=Masc|Number=Sing	4	nsubj:pass	_	Exponence[Gender]=Inherent
3	est	être	AUX	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	4	aux:pass	_	_
4	subventionné	subventionner	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part|Voice=Pass	0	root	_	Tense[denom]=Past
5	à	à	ADP	_	_	7	case	_	_
6	50	50	NUM	_	Number=Plur|NumType=Card	7	nummod	_	Exponence[Number]=Inherent|SpaceAfter=No
7	%	%	SYM	_	ExtPos=NOUN|Number=Plur	4	obl:mod	_	_
8	par	par	ADP	_	_	10	case	_	_
9	le	le	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	10	det	_	_
10	conseil	conseil	NOUN	_	Gender=Masc|Number=Sing	4	obl:agent	_	Exponence[Gender]=Inherent
...
4	bénéfice	bénéfice	NOUN	_	Gender=Masc|Number=Sing	1	nsubj	_	Exponence[Gender]=Inherent
5	démontré	démontrer	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part|Voice=Pass	4	acl	_	Tense[denom]=Past
6	par	par	ADP	_	_	7	case	_	_
7	Aclasta	Aclasta	PROPN	_	_	5	obl:agent	_	_
8	à	à	ADP	_	_	10	case	_	_
9	le	le	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	10	det	_	_
10	cours	cours	NOUN	_	Gender=Masc	5	obl:mod	_	Exponence[Gender]=Inherent
11	de	de	ADP	_	_	13	case	_	_
12	les	le	DET	_	Definite=Def|Number=Plur|PronType=Art	13	det	_	_
13	études	étude	NOUN	_	Gender=Fem|Number=Plur	10	nmod	_	Exponence[Gender]=Inherent
...
6	fauché	faucher	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part|Voice=Pass	4	xcomp	_	Tense[denom]=Past
...
16	feu	feu	NOUN	_	Gender=Masc|Number=Sing	11	conj	_	Exponence[Gender]=Inherent
17	de	de	ADP	_	_	19	case	_	_
18	les	le	DET	_	Definite=Def|Number=Plur|PronType=Art	19	det	_	_
19	mitrailleurs	mitrailleur	NOUN	_	Gender=Masc|Number=Plur	16	nmod	_	Exponence[Gender]=Inherent
...
25	caporal	caporal	NOUN	_	Gender=Masc|Number=Sing	23	nsubj	_	Exponence[Gender]=Inherent
26	Maupas	Maupas	PROPN	_	Gender=Masc|Number=Sing	25	nmod	_	Exponence[Gender]=Inherent
27	lors	lors	ADV	_	_	23	advmod	_	_
28	de	de	ADP	_	_	30	case	_	_
29	son	son	DET	_	Gender=Masc|Number=Sing|Number[psor]=Sing|Person[psor]=3|Poss=Yes|PronType=Prs	30	det	_	Exponence[Gender]=Absent
30	interrogatoire	interrogatoire	NOUN	_	Gender=Masc|Number=Sing	27	obl:arg	_	Exponence[Gender]=Inherent|SpaceAfter=No
