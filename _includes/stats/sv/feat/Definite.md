...
The feature is used with 6 part-of-speech tags: [sv-pos/NOUN]() (22428; 23% instances), [sv-pos/DET]() (5479; 6% instances), [sv-pos/PRON]() (4857; 5% instances), [sv-pos/ADJ]() (4562; 5% instances), [sv-pos/NUM]() (92; 0% instances), [sv-pos/VERB]() (27; 0% instances).

### `NOUN`

22428 [sv-pos/NOUN]() tokens (98% of all `NOUN` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `NOUN` and `Definite` co-occurred: <tt><a href="Case.html">Case</a>=Nom</tt> (21443; 96%), <tt><a href="Gender.html">Gender</a>=Com</tt> (15646; 70%), <tt><a href="Number.html">Number</a>=Sing</tt> (15356; 68%).
...
* `EMPTY` (557): <em>kr, %, dr, s., kap., proc, KPI, milj, mån, sid</em>
...
5479 [sv-pos/DET]() tokens (97% of all `DET` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `DET` and `Definite` co-occurred: <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (4776; 87%), <tt><a href="Number.html">Number</a>=Sing</tt> (4178; 76%), <tt><a href="PronType.html">PronType</a>=Art</tt> (3844; 70%), <tt><a href="Gender.html">Gender</a>=Com</tt> (2797; 51%).
...
4857 [sv-pos/PRON]() tokens (81% of all `PRON` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `PRON` and `Definite` co-occurred: <tt><a href="PronType.html">PronType</a>=Prs</tt> (3409; 70%), <tt><a href="Number.html">Number</a>=Sing</tt> (3288; 68%).
...
4562 [sv-pos/ADJ]() tokens (54% of all `ADJ` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `ADJ` and `Definite` co-occurred: <tt><a href="Case.html">Case</a>=Nom</tt> (4556; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (4129; 91%), <tt><a href="Tense.html">Tense</a>=EMPTY</tt> (3919; 86%), <tt><a href="VerbForm.html">VerbForm</a>=EMPTY</tt> (3919; 86%), <tt><a href="Degree.html">Degree</a>=Pos</tt> (3632; 80%).
...
* `EMPTY` (3936): <em>olika, andra, många, större, första, vissa, stora, nya, egen, högre</em>
...
<table>
  ...
  <tr><td><tt><a href="Degree.html">Degree</a>=Sup|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td><em>störste</em></td></tr>
</table>

### `NUM`

92 [sv-pos/NUM]() tokens (5% of all `NUM` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `NUM` and `Definite` co-occurred: <tt><a href="NumType.html">NumType</a>=Card</tt> (92; 100%), <tt><a href="Case.html">Case</a>=Nom</tt> (92; 100%).
...
27 [sv-pos/VERB]() tokens (0% of all `VERB` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `VERB` and `Definite` co-occurred: <tt><a href="Voice.html">Voice</a>=EMPTY</tt> (27; 100%), <tt><a href="Tense.html">Tense</a>=Past</tt> (27; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (27; 100%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (27; 100%).
...
<tt>NOUN --[<a href="../dep/det.html">det</a>]--> DET</tt> (3734; 82%),
<tt>NOUN --[<a href="../dep/nmod.html">nmod</a>]--> NOUN</tt> (1863; 59%),
<tt>NOUN --[<a href="../dep/conj.html">conj</a>]--> NOUN</tt> (1818; 88%),
<tt>NOUN --[<a href="../dep/appos.html">appos</a>]--> NOUN</tt> (192; 67%),
<tt>ADJ --[<a href="../dep/det.html">det</a>]--> DET</tt> (163; 59%),
<tt>ADJ --[<a href="../dep/conj.html">conj</a>]--> ADJ</tt> (153; 78%),
<tt>NOUN --[<a href="../dep/acl.html">acl</a>]--> NOUN</tt> (55; 57%),
<tt>PRON --[<a href="../dep/mwe.html">mwe</a>]--> PRON</tt> (23; 66%),
<tt>PRON --[<a href="../dep/nsubj.html">nsubj</a>]--> NOUN</tt> (23; 59%),
<tt>DET --[<a href="../dep/mwe.html">mwe</a>]--> ADJ</tt> (19; 79%).
