...
4685 tokens (2%) have a non-empty value of `Clitic`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="it_isdt-pos-PRON.html">PRON</a></tt> (4685; 2% instances).

### `PRON`

4685 <tt><a href="it_isdt-pos-PRON.html">PRON</a></tt> tokens (41% of all `PRON` tokens) have a non-empty value of `Clitic`.

The most frequent other feature values with which `PRON` and `Clitic` co-occurred: <tt><a href="it_isdt-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (4683; 100%), <tt><a href="it_isdt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (3834; 82%), <tt><a href="it_isdt-feat-Person.html">Person</a></tt><tt>=3</tt> (3456; 74%), <tt><a href="it_isdt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (3287; 70%).

`PRON` tokens may have the following values of `Clitic`:

* `Yes` (4685; 100% of non-empty `Clitic`): <em>si, ci, lo, ne, c', mi, la, li, gli, le</em>
