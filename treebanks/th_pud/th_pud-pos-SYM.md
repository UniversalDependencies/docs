...
There are 1 `SYM` lemmas (6%), 3 `SYM` types (0%) and 134 `SYM` tokens (1%).
...
The form / lemma ratio of `SYM` is 3.000000 (the average of all parts of speech is 269.375000).

The 1st highest number of forms (3) was observed with the lemma “_”: %, /, ๆ.
