...
153 nodes (0%) are attached to their parents as `advcl:abs`.

119 instances of `advcl:abs` (78%) are right-to-left (child precedes parent).
Average distance between parent and child is 7.03267973856209.

The following 6 pairs of parts of speech are connected with `advcl:abs`: <tt><a href="la_udante-pos-VERB.html">VERB</a></tt>-<tt><a href="la_udante-pos-VERB.html">VERB</a></tt> (130; 85% instances), <tt><a href="la_udante-pos-ADJ.html">ADJ</a></tt>-<tt><a href="la_udante-pos-VERB.html">VERB</a></tt> (10; 7% instances), <tt><a href="la_udante-pos-NOUN.html">NOUN</a></tt>-<tt><a href="la_udante-pos-VERB.html">VERB</a></tt> (7; 5% instances), <tt><a href="la_udante-pos-VERB.html">VERB</a></tt>-<tt><a href="la_udante-pos-ADJ.html">ADJ</a></tt> (3; 2% instances), <tt><a href="la_udante-pos-PRON.html">PRON</a></tt>-<tt><a href="la_udante-pos-VERB.html">VERB</a></tt> (2; 1% instances), <tt><a href="la_udante-pos-VERB.html">VERB</a></tt>-<tt><a href="la_udante-pos-PROPN.html">PROPN</a></tt> (1; 1% instances).
...
5	humentibus	umeo	VERB	va2pppfb	Aspect=Imp|Case=Abl|Degree=Pos|Gender=Fem|InflClass=LatE|InflClass[noun]=IndEurI|Number=Plur|Tense=Pres|VerbForm=Part|Voice=Act	3	advcl:abs	_	_
...
9	esse	sum	AUX	va5fp	Aspect=Imp|InflClass=LatAnom|InflClass[noun]=Ind|Tense=Pres|VerbForm=Inf	7	cop	_	_
...
16	sensus	sensus	NOUN	smp4n	Case=Nom|Gender=Masc|InflClass=IndEurU|Number=Plur|VerbForm=Part	14	nsubj	_	SpaceAfter=No
...
12	volventibus	uoluo	VERB	va3pppmb	Aspect=Imp|Case=Abl|Degree=Pos|Gender=Masc|InflClass=LatX|InflClass[noun]=IndEurI|Number=Plur|Tense=Pres|VerbForm=Part|Voice=Act	16	advcl:abs	_	_
...
15	fore	sum	AUX	va5ff	Aspect=Perf|InflClass=LatAnom|InflClass[noun]=Ind|Tense=Fut|VerbForm=Inf	16	cop	_	_
...
18	revocato	reuoco	VERB	vp1prsmb	Aspect=Perf|Case=Abl|Degree=Pos|Gender=Masc|InflClass=LatA|InflClass[noun]=IndEurO|Number=Sing|Tense=Past|VerbForm=Part|Voice=Pass	20	acl	_	_
