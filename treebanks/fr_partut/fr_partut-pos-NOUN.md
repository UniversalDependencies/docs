...
There are 1271 `NOUN` lemmas (41%), 1534 `NOUN` types (35%) and 6052 `NOUN` tokens (21%).
...
The form / lemma ratio of `NOUN` is 1.206924 (the average of all parts of speech is 1.409310).
