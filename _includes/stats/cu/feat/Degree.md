...
2745 tokens (5%) have a non-empty value of `Degree`.
1277 types (13%) occur at least once with a non-empty value of `Degree`.
478 lemmas (16%) occur at least once with a non-empty value of `Degree`.
The feature is used with 2 part-of-speech tags: [cu-pos/ADJ]() (2572; 4% instances), [cu-pos/ADV]() (173; 0% instances).

### `ADJ`

2572 [cu-pos/ADJ]() tokens (64% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (1831; 71%), <tt><a href="Strength.html">Strength</a>=Strong</tt> (1678; 65%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (134; 5% of non-empty `Degree`): <em>болеи, болии, боле, оудобѣе, оунѣе, вꙑшънѣаго, добрѣа, лише, старѣи, больши</em>
* `Pos` (2438; 95% of non-empty `Degree`): <em>мъноѕи, вьсѣкъ, б҃жие, мъногꙑ, б҃жии, мъногъ, добро, б҃жиѣ, мрътвꙑхъ, б҃жіи</em>
* `EMPTY` (1468): <em>онъ, си, тъ, се, сь, сего, они, сихъ, самъ, томоу</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Fem,Masc|<a href="Number.html">Number</a>=Plur|<a href="Strength.html">Strength</a>=Strong</tt></td><td><em>мъногꙑ, мьногꙑ</em></td><td><em>мъножаишѧ</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing|<a href="Strength.html">Strength</a>=Strong</tt></td><td><em>мъного, много, мьного</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Ins|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Plur|<a href="Strength.html">Strength</a>=Strong</tt></td><td><em>мъногꙑ</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Loc|<a href="Number.html">Number</a>=Plur|<a href="Strength.html">Strength</a>=Strong</tt></td><td><em>мноѕѣхъ, мьнозѣхъ</em></td><td></td></tr>
...
`Degree` seems to be **lexical feature** of `ADJ`. 97% lemmas (433) occur only with one value of `Degree`.

### `ADV`

173 [cu-pos/ADV]() tokens (3% of all `ADV` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADV` and `Degree` co-occurred: <tt><a href="PronType.html">PronType</a>=EMPTY</tt> (173; 100%).

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (63; 36% of non-empty `Degree`): <em>паче, отърадьнѣе, вѧште, вꙑше, поздѣ, мъножѣе, боле, дале, лише, мьножѣе</em>
* `Pos` (110; 64% of non-empty `Degree`): <em>мъного, мало, далече, добрѣ, поздѣ, не.оудобь, ѩдро, зълѣ, лютѣ, скоро</em>
* `EMPTY` (5723): <em>же, не, бо, и, ли, егда, оубо, ѣко, ѣкоже, пакꙑ</em>
...
<tt>ADJ --[<a href="../dep/conj.html">conj</a>]--> ADJ</tt> (67; 97%),
<tt>ADJ --[<a href="../dep/remnant.html">remnant</a>]--> ADJ</tt> (18; 64%),
<tt>ADJ --[<a href="../dep/advmod.html">advmod</a>]--> ADJ</tt> (9; 100%),
<tt>ADJ --[<a href="../dep/remnant.html">remnant</a>]--> ADV</tt> (3; 75%),
<tt>ADJ --[<a href="../dep/nsubj.html">nsubj</a>]--> ADV</tt> (2; 100%),
