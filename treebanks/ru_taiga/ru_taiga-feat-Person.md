...
17079 tokens (9%) have a non-empty value of `Person`.
4041 types (11%) occur at least once with a non-empty value of `Person`.
2126 lemmas (11%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="ru_taiga-pos-VERB.html">VERB</a></tt> (10203; 5% instances), <tt><a href="ru_taiga-pos-PRON.html">PRON</a></tt> (6399; 3% instances), <tt><a href="ru_taiga-pos-AUX.html">AUX</a></tt> (477; 0% instances).
...
6399 <tt><a href="ru_taiga-pos-PRON.html">PRON</a></tt> tokens (57% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="ru_taiga-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (6399; 100%), <tt><a href="ru_taiga-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (6398; 100%), <tt><a href="ru_taiga-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4744; 74%), <tt><a href="ru_taiga-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (4329; 68%), <tt><a href="ru_taiga-feat-Case.html">Case</a></tt><tt>=Nom</tt> (3345; 52%).
...
* `3` (2737; 43% of non-empty `Person`): <em>он, она, они, его, ему, их, них, ей, него, им</em>
* `EMPTY` (4815): <em>это, что, все, всё, кто, то, ничего, себя, себе, этого</em>
