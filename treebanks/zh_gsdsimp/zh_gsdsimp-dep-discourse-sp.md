---
layout: base
title:  'Statistics of discourse:sp in UD_Chinese-GSDSimp'
udver: '2'
---

## Treebank Statistics: UD_Chinese-GSDSimp: Relations: `discourse:sp`

This relation is a language-specific subtype of <tt><a href="zh_gsdsimp-dep-discourse.html">discourse</a></tt>.
...
The following 2 pairs of parts of speech are connected with `discourse:sp`: <tt><a href="zh_gsdsimp-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsdsimp-pos-PART.html">PART</a></tt> (7; 88% instances), <tt><a href="zh_gsdsimp-pos-ADJ.html">ADJ</a></tt>-<tt><a href="zh_gsdsimp-pos-PART.html">PART</a></tt> (1; 13% instances).
...
16	吗	吗	PART	UH	PartType=Int	9	discourse:sp	_	SpaceAfter=No|Translit=ma|LTranslit=ma
...
2	悲观	悲观	NOUN	NN	_	6	nsubj	_	SpaceAfter=No|Translit=bēiguān|LTranslit=bēiguān
3	则	则	ADV	RB	_	6	mark	_	SpaceAfter=No|Translit=zé|LTranslit=zé
4	与	与	ADP	IN	_	5	case	_	SpaceAfter=No|Translit=yǔ|LTranslit=yǔ
5	消极	消极	NOUN	NN	_	6	obl	_	SpaceAfter=No|Translit=xiāojí|LTranslit=xiāojí
6	相连	相连	VERB	VV	_	0	root	_	SpaceAfter=No|Translit=xiānglián|LTranslit=xiānglián
7	，	，	PUNCT	,	_	25	punct	_	SpaceAfter=No|Translit=,|LTranslit=,
8	对	对	ADP	IN	_	9	case	_	SpaceAfter=No|Translit=duì|LTranslit=duì
9	前景	前景	NOUN	NN	_	10	nmod	_	SpaceAfter=No|Translit=qiánjǐng|LTranslit=qiánjǐng
10	悲观	悲观	ADJ	JJ	_	25	advcl	_	SpaceAfter=No|Translit=bēiguān|LTranslit=bēiguān
11	，	，	PUNCT	,	_	10	punct	_	SpaceAfter=No|Translit=,|LTranslit=,
12	觉得	觉得	VERB	VV	_	25	advcl	_	SpaceAfter=No|Translit=juéde|LTranslit=juéde
...
17	不会	会	AUX	MD	Polarity=Neg	18	aux	_	SpaceAfter=No|Translit=bùhuì|LTranslit=huì
18	达到	达到	VERB	VV	_	12	xcomp	_	SpaceAfter=No|Translit=dádào|LTranslit=dádào
19	预期	预期	NOUN	NN	_	20	nmod	_	SpaceAfter=No|Translit=yùqī|LTranslit=yùqī
20	目标	目标	NOUN	NN	_	18	obj	_	SpaceAfter=No|Translit=mùbiāo|LTranslit=mùbiāo
...
24	会	会	AUX	MD	_	25	aux	_	SpaceAfter=No|Translit=huì|LTranslit=huì
25	积极	积极	ADJ	JJ	_	6	parataxis	_	SpaceAfter=No|Translit=jījí|LTranslit=jījí
