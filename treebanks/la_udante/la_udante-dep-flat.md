...
There are 2 language-specific subtypes of `flat`: <tt><a href="la_udante-dep-flat-foreign.html">flat:foreign</a></tt>, <tt><a href="la_udante-dep-flat-name.html">flat:name</a></tt>.
...
2	ergo	ergo	CCONJ	co	_	3	cc	_	_
...
21	circumloqui	circumloquor	VERB	vd3fp	Aspect=Imp|InflClass=LatX|InflClass[noun]=Ind|Tense=Pres|VerbForm=Inf|Voice=Pass	20	ccomp	_	_
...
5	eodem	idem	DET	dpmsb	Case=Abl|Emphatic=Yes|Gender=Masc|InflClass=LatPron|Number=Sing|PronType=Emp	6	det	_	_
...
10	dependere	dependeo	VERB	va2fp	Aspect=Imp|InflClass=LatE|InflClass[noun]=Ind|Tense=Pres|VerbForm=Inf|Voice=Act	9	xcomp	_	_
