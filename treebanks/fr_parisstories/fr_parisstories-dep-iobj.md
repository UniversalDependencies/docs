...
351 nodes (1%) are attached to their parents as `iobj`.

346 instances of `iobj` (99%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.50712250712251.

The following 1 pairs of parts of speech are connected with `iobj`: <tt><a href="fr_parisstories-pos-VERB.html">VERB</a></tt>-<tt><a href="fr_parisstories-pos-PRON.html">PRON</a></tt> (351; 100% instances).
