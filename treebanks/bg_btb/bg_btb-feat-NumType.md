...
The feature is used with 3 part-of-speech tags: <tt><a href="bg_btb-pos-NUM.html">NUM</a></tt> (2104; 1% instances), <tt><a href="bg_btb-pos-ADJ.html">ADJ</a></tt> (906; 1% instances), <tt><a href="bg_btb-pos-ADV.html">ADV</a></tt> (619; 0% instances).

### `NUM`

2104 <tt><a href="bg_btb-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="bg_btb-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (1956; 93%), <tt><a href="bg_btb-feat-Number.html">Number</a></tt><tt>=Plur</tt> (1862; 88%), <tt><a href="bg_btb-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1589; 76%).
...
<tt>NUM --[<tt><a href="bg_btb-dep-conj.html">conj</a></tt>]--> NUM</tt> (39; 100%),
