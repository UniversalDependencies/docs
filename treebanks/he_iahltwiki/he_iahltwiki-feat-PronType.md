...
It occurs with 8 different values: `Art`, `Dem`, `Emp`, `Ind`, `Int`, `Neg`, `Prs`, `Tot`.

22010 tokens (16%) have a non-empty value of `PronType`.
76 types (1%) occur at least once with a non-empty value of `PronType`.
37 lemmas (0%) occur at least once with a non-empty value of `PronType`.
The feature is used with 4 part-of-speech tags: <tt><a href="he_iahltwiki-pos-DET.html">DET</a></tt> (13889; 10% instances), <tt><a href="he_iahltwiki-pos-PRON.html">PRON</a></tt> (5544; 4% instances), <tt><a href="he_iahltwiki-pos-ADP.html">ADP</a></tt> (2569; 2% instances), <tt><a href="he_iahltwiki-pos-ADV.html">ADV</a></tt> (8; 0% instances).

### `DET`

13889 <tt><a href="he_iahltwiki-pos-DET.html">DET</a></tt> tokens (98% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (13629; 98%).

`DET` tokens may have the following values of `PronType`:

* `Art` (13629; 98% of non-empty `PronType`): ה, אל, הַ, ְהַ, א, ב, הָ, לה
* `Neg` (7; 0% of non-empty `PronType`): אף
* `Tot` (253; 2% of non-empty `PronType`): כל
* `EMPTY` (288): מספר, רוב, כמה, מרבית, עוד, כלל, מדי, שאר, יתר, לא

`PronType` seems to be **lexical feature** of `DET`. 100% lemmas (11) occur only with one value of `PronType`.

### `PRON`

5544 <tt><a href="he_iahltwiki-pos-PRON.html">PRON</a></tt> tokens (98% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt> (5126; 92%), <tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3993; 72%), <tt><a href="he_iahltwiki-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (3412; 62%), <tt><a href="he_iahltwiki-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (3389; 61%), <tt><a href="he_iahltwiki-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (3362; 61%), <tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (3235; 58%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (1072; 19% of non-empty `PronType`): כך, זה, זו, זאת, אלו, כן, אלה, הללו, זהו, זוהי
...
* `Prs` (4385; 79% of non-empty `PronType`): ו, ה, הם, ם, הוא, היא, הן, אותה, ן, י
* `EMPTY` (89): מה, מי, כן, אותה, איזה, דנן, כולו, כמה, You, Your
...
<table>
  ...
  <tr><td><tt><tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="he_iahltwiki-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td>אותן, אותם</td><td></td></tr>
...
2569 <tt><a href="he_iahltwiki-pos-ADP.html">ADP</a></tt> tokens (11% of all `ADP` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADP` and `PronType` co-occurred: <tt><a href="he_iahltwiki-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (2569; 100%), <tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (2569; 100%).

`ADP` tokens may have the following values of `PronType`:

* `Art` (2569; 100% of non-empty `PronType`): ב, ל, כ
* `EMPTY` (20440): ב, ל, של, מ, על, את, כ, עם, בין, לאחר

### `ADV`

8 <tt><a href="he_iahltwiki-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="he_iahltwiki-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (8; 100%).

`ADV` tokens may have the following values of `PronType`:

* `Int` (8; 100% of non-empty `PronType`): כיצד, כמה, האם, למה, מדוע
* `EMPTY` (3520): לא, גם, כ, יותר, כן, רק, אף, ביותר, אז, עוד
...
<tt>DET --[<tt><a href="he_iahltwiki-dep-conj.html">conj</a></tt>]--> DET</tt> (1; 100%),
