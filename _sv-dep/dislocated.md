...
for and are subtyped by the relation of this dependent.

~~~ sdparse
Peter , honom gillar jag inte \n Peter, I don't like him
dislocated:dobj(gillar, Peter)
dobj(gillar, honom)
~~~
...
rather of the predicate in the relative clause making up the second part of the cleft construction. We therefore
use a special subtype `dislocated:cleft` in this case.

~~~ sdparse
Det var Peter som gjorde det \n It was Peter who did it
dislocated:cleft(var, Peter)
expletive(var, Det)
