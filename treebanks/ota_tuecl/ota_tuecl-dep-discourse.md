---
layout: base
title:  'Statistics of discourse in UD_Ottoman_Turkish-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Ottoman_Turkish-TueCL: Relations: `discourse`
...
The following 1 pairs of parts of speech are connected with `discourse`: <tt><a href="ota_tuecl-pos-PRON.html">PRON</a></tt>-<tt><a href="ota_tuecl-pos-INTJ.html">INTJ</a></tt> (1; 100% instances).
