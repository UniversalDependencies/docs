---
layout: base
title:  'Statistics of obj in UD_Old_Turkish-Tonqq'
udver: '2'
---

## Treebank Statistics: UD_Old_Turkish-Tonqq: Relations: `obj`

This relation is universal.

5 nodes (3%) are attached to their parents as `obj`.

5 instances of `obj` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 3.8.

The following 1 pairs of parts of speech are connected with `obj`: <tt><a href="otk_tonqq-pos-VERB.html">VERB</a></tt>-<tt><a href="otk_tonqq-pos-NOUN.html">NOUN</a></tt> (5; 100% instances).
