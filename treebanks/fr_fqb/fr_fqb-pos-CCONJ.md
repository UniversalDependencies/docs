...
There are 4 `CCONJ` lemmas (0%), 6 `CCONJ` types (0%) and 98 `CCONJ` tokens (0%).
Out of 16 observed tags, the rank of `CCONJ` is: 12 in number of lemmas, 13 in number of types and 14 in number of tokens.

The 10 most frequent `CCONJ` lemmas: <em>et, ou, mais, puis</em>
...
The form / lemma ratio of `CCONJ` is 1.500000 (the average of all parts of speech is 1.169482).
...
`CCONJ` nodes are attached to their parents using 2 different relations: <tt><a href="fr_fqb-dep-cc.html">cc</a></tt> (97; 99% instances), <tt><a href="fr_fqb-dep-conj.html">conj</a></tt> (1; 1% instances)
...
96 (98%) `CCONJ` nodes are leaves.

2 (2%) `CCONJ` nodes have one child.

The highest child degree of a `CCONJ` node is 1.

Children of `CCONJ` nodes are attached using 2 different relations: <tt><a href="fr_fqb-dep-cc.html">cc</a></tt> (1; 50% instances), <tt><a href="fr_fqb-dep-conj.html">conj</a></tt> (1; 50% instances)
