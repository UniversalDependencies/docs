---
layout: base
title:  'Statistics of advmod:emph in UD_Ottoman_Turkish-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Ottoman_Turkish-TueCL: Relations: `advmod:emph`

This relation is a language-specific subtype of <tt><a href="ota_tuecl-dep-advmod.html">advmod</a></tt>.
...
The following 4 pairs of parts of speech are connected with `advmod:emph`: <tt><a href="ota_tuecl-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ota_tuecl-pos-ADV.html">ADV</a></tt> (2; 40% instances), <tt><a href="ota_tuecl-pos-PRON.html">PRON</a></tt>-<tt><a href="ota_tuecl-pos-ADV.html">ADV</a></tt> (1; 20% instances), <tt><a href="ota_tuecl-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ota_tuecl-pos-ADV.html">ADV</a></tt> (1; 20% instances), <tt><a href="ota_tuecl-pos-VERB.html">VERB</a></tt>-<tt><a href="ota_tuecl-pos-ADV.html">ADV</a></tt> (1; 20% instances).
...
1	Ḳutsal	ḳutsal	ADJ	_	_	2	amod	_	_
2	kitābsız	kitāb	NOUN	_	Number=Sing|Polarity=Neg	3	amod	_	_
3	dīnler	dīn	NOUN	_	Case=Nom|Number=Plur	5	nsubj	_	_
...
6	degil	degil	AUX	_	Polarity=Neg	4	aux	_	_
