...
3390 tokens (3%) have a non-empty value of `Reflex`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="sk_snk-pos-PRON.html">PRON</a></tt> (3066; 3% instances), <tt><a href="sk_snk-pos-DET.html">DET</a></tt> (324; 0% instances).

### `PRON`

3066 <tt><a href="sk_snk-pos-PRON.html">PRON</a></tt> tokens (48% of all `PRON` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `PRON` and `Reflex` co-occurred: <tt><a href="sk_snk-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (3066; 100%), <tt><a href="sk_snk-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (3066; 100%), <tt><a href="sk_snk-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (3066; 100%), <tt><a href="sk_snk-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (3066; 100%), <tt><a href="sk_snk-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (2958; 96%), <tt><a href="sk_snk-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (2958; 96%).

`PRON` tokens may have the following values of `Reflex`:

* `Yes` (3066; 100% of non-empty `Reflex`): <em>sa, si, seba, sebe, sebou, a, se, za</em>
* `EMPTY` (3367): <em>mi, ho, ma, mu, čo, ju, ja, jej, ich, niečo</em>
...
* `EMPTY` (4080): <em>to, jeho, jej, ktoré, ktorý, ten, ich, ktorá, tom, toho</em>
