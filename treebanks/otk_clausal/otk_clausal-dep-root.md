---
layout: base
title:  'Statistics of root in UD_Old_Turkish-Clausal'
udver: '2'
---

## Treebank Statistics: UD_Old_Turkish-Clausal: Relations: `root`
...
The following 4 pairs of parts of speech are connected with `root`: -<tt><a href="otk_clausal-pos-VERB.html">VERB</a></tt> (14; 70% instances), -<tt><a href="otk_clausal-pos-NOUN.html">NOUN</a></tt> (3; 15% instances), -<tt><a href="otk_clausal-pos-NUM.html">NUM</a></tt> (2; 10% instances), -<tt><a href="otk_clausal-pos-PROPN.html">PROPN</a></tt> (1; 5% instances).
