...
The following 2 pairs of parts of speech are connected with `nsubj:outer`: <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-NOUN.html">NOUN</a></tt> (2; 50% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-PRON.html">PRON</a></tt> (2; 50% instances).
...
5	tifirʔa	_	VERB	V1	Aspect=Perf|Gender=Masc|Number=Sing|VerbClass=1	6	dep:comp	_	AlignBegin=263495|AlignEnd=263661|Gloss=take_out\PFV|MGloss=2SG.M-take_out\PFV|MSeg=ti-firʔa|RelRole=Obj|RX=[PNG]-[V1]|TokenType=Root
...
11	amraːj	_	VERB	V1	Mood=Opt|Number=Sing|VerbClass=1	12	acl:relcl	_	AlignBegin=264557|AlignEnd=264798|Gloss=find\NEG.OPT|MGloss=1SG-find\NEG.OPT|MSeg=a-mraːj|RelRole=Obj|RX=[PNG]-[V1].[DER]|TokenType=Root
