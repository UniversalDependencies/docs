---
layout: base
title:  'Statistics of SCONJ in UD_Neapolitan-RB'
udver: '2'
---

## Treebank Statistics: UD_Neapolitan-RB: POS Tags: `SCONJ`
...
`SCONJ` nodes are attached to their parents using 1 different relations: <tt><a href="nap_rb-dep-mark.html">mark</a></tt> (2; 100% instances)

Parents of `SCONJ` nodes belong to 1 different parts of speech: <tt><a href="nap_rb-pos-VERB.html">VERB</a></tt> (2; 100% instances)
