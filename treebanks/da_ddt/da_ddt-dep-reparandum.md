---
layout: base
title:  'Statistics of reparandum in UD_Danish-DDT'
udver: '2'
---

## Treebank Statistics: UD_Danish-DDT: Relations: `reparandum`
...
The following 2 pairs of parts of speech are connected with `reparandum`: <tt><a href="da_ddt-pos-PRON.html">PRON</a></tt>-<tt><a href="da_ddt-pos-PRON.html">PRON</a></tt> (1; 50% instances), <tt><a href="da_ddt-pos-VERB.html">VERB</a></tt>-<tt><a href="da_ddt-pos-VERB.html">VERB</a></tt> (1; 50% instances).
...
1	Jeg	jeg	PRON	_	Case=Nom|Gender=Com|Number=Sing|Person=1|PronType=Prs	6	reparandum	_	SpaceAfter=No
...
15	hjerne	hjerne	NOUN	_	Definite=Ind|Gender=Com|Number=Sing	10	obl	_	SpaceAfter=No
...
2	du	du	PRON	_	Case=Nom|Gender=Com|Number=Sing|Person=2|PronType=Prs	1	nsubj	_	SpaceAfter=No
