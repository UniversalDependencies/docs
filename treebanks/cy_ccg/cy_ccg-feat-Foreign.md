---
layout: base
title:  'Statistics of Foreign in UD_Welsh-CCG'
udver: '2'
---

## Treebank Statistics: UD_Welsh-CCG: Features: `Foreign`
...
13 <tt><a href="cy_ccg-pos-PROPN.html">PROPN</a></tt> tokens (1% of all `PROPN` tokens) have a non-empty value of `Foreign`.

The most frequent other feature values with which `PROPN` and `Foreign` co-occurred: <tt><a href="cy_ccg-feat-Mutation.html">Mutation</a></tt><tt>=EMPTY</tt> (13; 100%), <tt><a href="cy_ccg-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (10; 77%), <tt><a href="cy_ccg-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9; 69%).
...
9 <tt><a href="cy_ccg-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Foreign`.

The most frequent other feature values with which `NOUN` and `Foreign` co-occurred: <tt><a href="cy_ccg-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (8; 89%), <tt><a href="cy_ccg-feat-Mutation.html">Mutation</a></tt><tt>=EMPTY</tt> (8; 89%), <tt><a href="cy_ccg-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8; 89%), <tt><a href="cy_ccg-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (8; 89%).
