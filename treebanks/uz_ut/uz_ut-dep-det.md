...
## Treebank Statistics: UD_Uzbek-UT: Relations: `det`
...
1	Ushbu	Ushbu	DET	_	PronType=Dem	2	det	_	_
2	kitob	kitob	NOUN	_	Case=Nom|Number=Sing	8	nsubj	_	_
...
1	Bu	bu	DET	_	PronType=Dem	3	det	_	_
2	halovatsiz	halovatsiz	ADJ	_	_	3	amod	_	_
3	it	it	NOUN	_	Case=Nom|Number=Sing	8	nsubj	_	_
4	qaysi	qaysi	PRON	_	PronType=Int	5	det	_	_
5	arslonning	arslon	NOUN	_	Case=Gen|Number=Sing|Poss=Yes	6	nmod:poss	_	_
6	kitobini	kitob	NOUN	_	Case=Acc|Number=Sing	8	obj	_	_
7	tanqid	tanqid	NOUN	_	Case=Nom|Number=Sing	8	compound:lvc	_	_
8	qilyaptiykin	qil	VERB	_	Aspect=Prog|Mood=Int|Person=3|VerbForm=Fin	0	root	_	SpaceAfter=No
...
# visual-style 2	fgColor:white
# visual-style 2 1 det	color:blue
1	Shu	shu	DET	_	PronType=Dem	2	det	_	_
2	sababli	sababli	ADV	_	_	8	advmod	_	SpaceAfter=No
3	,	,	PUNCT	_	_	2	punct	_	_
4	dronlardan	dron	NOUN	_	Case=Abl|Number=Plur	8	obj	_	_
5	faqat	faqat	ADV	_	_	6	advmod	_	_
6	razvedka	razvedka	NOUN	_	Case=Nom|Number=Sing	8	obl	_	_
7	maqsadida	maqsad	NOUN	_	Case=Loc|Number=Sing	6	case	_	_
8	foydalanilmoqda	foydalan	VERB	_	Aspect=Prog|Mood=Ind|Tense=Pres|VerbForm=Fin|Voice=Pass	0	root	_	SpaceAfter=No
9	.	.	PUNCT	_	_	8	punct	_	_
