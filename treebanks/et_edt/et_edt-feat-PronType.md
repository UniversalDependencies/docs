...
30273 tokens (7%) have a non-empty value of `PronType`.
...
The feature is used with 5 part-of-speech tags: <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> (22813; 5% instances), <tt><a href="et_edt-pos-DET.html">DET</a></tt> (7181; 2% instances), <tt><a href="et_edt-pos-ADJ.html">ADJ</a></tt> (276; 0% instances), <tt><a href="et_edt-pos-PROPN.html">PROPN</a></tt> (2; 0% instances), <tt><a href="et_edt-pos-ADV.html">ADV</a></tt> (1; 0% instances).

### `PRON`

22813 <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (17428; 76%), <tt><a href="et_edt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (13776; 60%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (5127; 22% of non-empty `PronType`): <em>see, seda, selle, sellest, nende, need, neid, selleks, sellega, sellele</em>
* `Ind` (1255; 6% of non-empty `PronType`): <em>midagi, keegi, muud, üks, muu, paljud, kedagi, igaüks, kellelegi, miski</em>
...
* `Prs` (11716; 51% of non-empty `PronType`): <em>ta, oma, ma, tema, nad, meie, me, sa, nende, minu</em>
* `Rcp` (59; 0% of non-empty `PronType`): <em>teineteist, teineteise, teineteisest, üksteist, üksteise, üksteisest, teineteisele, üksteisele, iseenda, üksteisega</em>
* `Rel` (54; 0% of non-empty `PronType`): <em>mis, kes, mida, mille, milline, millised, kelle, kellel, keda, kellele</em>
* `Tot` (406; 2% of non-empty `PronType`): <em>kõik, kõike, kõigile, mõlemad, igal, kõiki, kõigil, kõigi, kõigele, kõigest</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="et_edt-feat-Case.html">Case</a></tt><tt>=Gen</tt></tt></td><td><em>kummagi</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="et_edt-feat-Case.html">Case</a></tt><tt>=Nom</tt></tt></td><td></td><td><em>kumbki</em></td><td><em>kumbki</em></td><td></td></tr>
</table>

### `DET`

7181 <tt><a href="et_edt-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4630; 64%).

`DET` tokens may have the following values of `PronType`:

* `Art` (29; 0% of non-empty `PronType`): <em>the, der, A</em>
* `Dem` (3373; 47% of non-empty `PronType`): <em>see, selle, need, seda, sel, nende, samal, sama, teiste, selline</em>
* `Ind` (2166; 30% of non-empty `PronType`): <em>üks, ühe, mitu, mingi, mingit, mõne, mõni, mõned, paljud, ühel</em>
...
* `Rel` (32; 0% of non-empty `PronType`): <em>millise, millist, milline, millised, milliseid, millises, kumb, kumma, kummas, millisest</em>
* `Tot` (1530; 21% of non-empty `PronType`): <em>kogu, kõik, iga, igal, kõigi, kõiki, terve, igas, mõlemad, kõikide</em>
...
276 <tt><a href="et_edt-pos-ADJ.html">ADJ</a></tt> tokens (1% of all `ADJ` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADJ` and `PronType` co-occurred: <tt><a href="et_edt-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (276; 100%), <tt><a href="et_edt-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (276; 100%), <tt><a href="et_edt-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (276; 100%), <tt><a href="et_edt-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (275; 100%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (199; 72%), <tt><a href="et_edt-feat-Case.html">Case</a></tt><tt>=Nom</tt> (167; 61%).

`ADJ` tokens may have the following values of `PronType`:

* `Dem` (144; 52% of non-empty `PronType`): <em>selline, sama, samasugune, sellised, sellist, säärane, selliseid, niisugune, samad, samasugused</em>
* `Ind` (4; 1% of non-empty `PronType`): <em>mingisugust, muu, muud, muul</em>
* `Int` (1; 0% of non-empty `PronType`): <em>millised</em>
* `Int,Rel` (11; 4% of non-empty `PronType`): <em>missugune, kumb, Missugust, milline, missugused, mitmendal</em>
* `Rel` (114; 41% of non-empty `PronType`): <em>milline, millised, millist, millise, milliseid, millises, kumb, millisesse, milliste, milliseks</em>
* `Tot` (2; 1% of non-empty `PronType`): <em>kogu-, mõlemas</em>
* `EMPTY` (36605): <em>suur, hea, võimalik, eesti, suurem, uue, suure, raske, esimene, oluline</em>
...
1 <tt><a href="et_edt-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `PronType`.

`ADV` tokens may have the following values of `PronType`:

* `Rel` (1; 100% of non-empty `PronType`): <em>kus</em>
* `EMPTY` (42090): <em>ka, siis, nii, kas, juba, välja, aga, veel, väga, mitte</em>

## Relations with Agreement in `PronType`

The 10 most frequent relations where parent and child node agree in `PronType`:
<tt>PRON --[<tt><a href="et_edt-dep-nmod.html">nmod</a></tt>]--> PRON</tt> (126; 59%),
<tt>PRON --[<tt><a href="et_edt-dep-conj.html">conj</a></tt>]--> PRON</tt> (39; 64%),
