...
* `Cop` (1557; 100% of non-empty `VerbForm`): <em>is, ba, ní, gur, b', nach, ar, gurb, nár, an</em>
...
79 <tt><a href="ga_idt-pos-SCONJ.html">SCONJ</a></tt> tokens (5% of all `SCONJ` tokens) have a non-empty value of `VerbForm`.

`SCONJ` tokens may have the following values of `VerbForm`:

* `Cop` (79; 100% of non-empty `VerbForm`): <em>más, ós, mura, arb, dar, murab, murar, Sular</em>
* `EMPTY` (1550): <em>ach, nuair, má, mar, agus, ná, go, dá, cé, is</em>
...
2 <tt><a href="ga_idt-pos-PRON.html">PRON</a></tt> tokens (0% of all `PRON` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `PRON` and `VerbForm` co-occurred: <tt><a href="ga_idt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2; 100%), <tt><a href="ga_idt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (2; 100%), <tt><a href="ga_idt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (2; 100%), <tt><a href="ga_idt-feat-PronType.html">PronType</a></tt><tt>=Int</tt> (2; 100%).
