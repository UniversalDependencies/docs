...
There are 977 `VERB` lemmas (14%), 2530 `VERB` types (26%) and 5886 `VERB` tokens (8%).
...
The form / lemma ratio of `VERB` is 2.589560 (the average of all parts of speech is 1.407386).
