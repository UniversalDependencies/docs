---
layout: base
title:  'Statistics of mark in UD_Japanese-Modern'
udver: '2'
---

## Treebank Statistics: UD_Japanese-Modern: Relations: `mark`

This relation is universal.

483 nodes (3%) are attached to their parents as `mark`.

483 instances of `mark` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.351966873706.

The following 4 pairs of parts of speech are connected with `mark`: <tt><a href="ja_modern-pos-VERB.html">VERB</a></tt>-<tt><a href="ja_modern-pos-SCONJ.html">SCONJ</a></tt> (386; 80% instances), <tt><a href="ja_modern-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ja_modern-pos-SCONJ.html">SCONJ</a></tt> (68; 14% instances), <tt><a href="ja_modern-pos-PRON.html">PRON</a></tt>-<tt><a href="ja_modern-pos-SCONJ.html">SCONJ</a></tt> (21; 4% instances), <tt><a href="ja_modern-pos-PART.html">PART</a></tt>-<tt><a href="ja_modern-pos-SCONJ.html">SCONJ</a></tt> (8; 2% instances).
...
8	僧俗	僧俗	NOUN	名詞-普通名詞-一般	_	10	nmod	_	BunsetuBILabel=B|BunsetuPositionType=SEM_HEAD|LUWBILabel=B|LUWPOS=名詞-普通名詞-一般|SpaceAfter=No
9	の	の	ADP	助詞-格助詞	_	8	case	_	BunsetuBILabel=I|BunsetuPositionType=SYN_HEAD|LUWBILabel=B|LUWPOS=助詞-格助詞|SpaceAfter=No
10	區別	區別	NOUN	名詞-普通名詞-サ変可能	_	11	nmod	_	BunsetuBILabel=B|BunsetuPositionType=SEM_HEAD|LUWBILabel=B|LUWPOS=名詞-普通名詞-一般|SpaceAfter=No
11	ある	あり	VERB	動詞-非自立可能	_	13	obj	_	BunsetuBILabel=B|BunsetuPositionType=SEM_HEAD|LUWBILabel=B|LUWPOS=動詞-一般|SpaceAfter=No
12	を	を	ADP	助詞-格助詞	_	11	case	_	BunsetuBILabel=I|BunsetuPositionType=SYN_HEAD|LUWBILabel=B|LUWPOS=助詞-格助詞|SpaceAfter=No
13	知ら	知る	VERB	動詞-一般	_	0	root	_	BunsetuBILabel=B|BunsetuPositionType=ROOT|LUWBILabel=B|LUWPOS=動詞-一般|SpaceAfter=No
14	ず	ず	AUX	助動詞	Polarity=Neg	13	aux	_	BunsetuBILabel=I|BunsetuPositionType=SYN_HEAD|LUWBILabel=B|LUWPOS=助動詞|SpaceAfter=No
