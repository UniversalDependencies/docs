...
The most frequent other feature values with which `DET` and `Person` co-occurred: <tt><a href="PronType.html">PronType</a>=Prs</tt> (144; 100%), <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (144; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (103; 72%), <tt><a href="Gender.html">Gender</a>=Fem</tt> (83; 58%).
