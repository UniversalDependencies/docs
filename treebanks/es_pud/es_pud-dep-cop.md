...
1	Tenemos	_	VERB	VBC	Aspect=Imp|Mood=Ind|Number=Plur|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
...
6	es	_	AUX	VBC	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	8	cop	_	_
...
10	progresar	_	VERB	VB	Aspect=Imp|VerbForm=Fin|Voice=Act	8	xcomp	_	SpaceAfter=No
...
1	Fueran	_	VERB	VBC	Aspect=Imp|Mood=Sub|Number=Plur|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	11	advcl	_	_
2	cuales	_	PRON	REL	Gender=Fem|Number=Plur|PronType=Int,Rel	1	ccomp	_	_
3	fueran	_	AUX	VBC	Aspect=Imp|Mood=Sub|Number=Plur|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	2	cop	_	_
4	las	el	DET	DT	Definite=Def|Gender=Fem|Number=Plur|PronType=Art	5	det	_	_
5	reglas	_	NOUN	NN	Gender=Fem|Number=Plur	2	nsubj	_	SpaceAfter=No
6	,	_	PUNCT	,	_	1	punct	_	_
7	las	el	DET	DT	Definite=Def|Gender=Fem|Number=Plur|PronType=Art	8	det	_	_
...
11	tenían	_	VERB	VBC	Aspect=Imp|Mood=Ind|Number=Plur|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	0	root	_	_
12	como	_	ADP	IN	_	13	case	_	_
13	resultado	_	NOUN	NN	Gender=Masc|Number=Sing	11	obl	_	_
14	la	el	DET	DT	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	15	det	_	_
