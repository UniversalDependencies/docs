...
2	то	то	PRON	_	Animacy=Inan|Case=Nom|Gender=Neut|Number=Sing	11	nsubj	_	_
...
7	нас	мы	PRON	_	Case=Gen|Number=Plur|Person=1	8	obl	_	_
8	нет	нет	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	2	acl	_	SpaceAfter=No
9	,	,	PUNCT	_	_	8	punct	_	_
10	это	это	PART	_	_	11	expl	_	_
11	да	д	PART	_	_	0	root	_	SpaceAfter=No
...
1	но	но	CCONJ	CONJ	_	3	cc	_	_
2	птичка	птичка	NOUN	NOUN	Animacy=Anim|Case=Nom|Gender=Fem|Number=Sing	3	nsubj	_	_
3	говорит	говорить	VERB	VERB	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
4	позволь	позволить	VERB	VERB	Aspect=Perf|Mood=Imp|Number=Sing|Person=2|VerbForm=Fin|Voice=Act	3	parataxis	_	_
5	и	и	CCONJ	CONJ	_	7	cc	_	_
6	вдруг	вдруг	ADV	ADV	Degree=Pos	7	advmod	_	_
7	летает	летать	VERB	VERB	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	3	conj	_	_
8	безголова	безголовый	ADJ	ADJ	Degree=Pos|Gender=Fem|Number=Sing|Variant=Short	7	acl	_	_
