...
1	ՀՀ	ՀՀ	PROPN	_	Abbr=Yes|Animacy=Nhum|Case=Nom|Definite=Ind|NameType=Geo|Number=Sing	3	nmod	_	Translit=HH|LTranslit=HH
2	սահմանադրական	սահմանադրական	ADJ	_	Degree=Pos	3	amod	_	Translit=sahmanadrakan|LTranslit=sahmanadrakan
3	դատարան	դատարան	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	4	obl	_	Translit=dataran|LTranslit=dataran
4	ներկայացված	ներկայանալ	VERB	_	Aspect=Perf|Polarity=Pos|Subcat=Intr|VerbForm=Part|Voice=Pass	5	acl	_	Translit=nerkayac’vaç|LTranslit=nerkayanal
5	փաստարկների	փաստարկ	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Plur	6	nmod:poss	_	Translit=p’astarkneri|LTranslit=p’astark
6	շրջանակներում	շրջանակ	NOUN	_	Animacy=Nhum|Case=Loc|Definite=Ind|Number=Plur	22	obl	_	Translit=šrǰanaknerowm|LTranslit=šrǰanak
7	2008	2008	NUM	_	NumForm=Digit|NumType=Card	8	nummod	_	Translit=2008|LTranslit=2008|SpaceAfter=No
8	թ	թվական	NOUN	_	Abbr=Yes|Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	10	nmod:poss	_	Translit=t’|LTranslit=t’vakan|SpaceAfter=No
9	.	.	PUNCT	_	_	8	punct	_	Translit=.|LTranslit=.
10	փետրվարի	փետրվար	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Sing	11	nmod:poss	_	Translit=p’etrvari|LTranslit=p’etrvar
11	6-ին	6	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Def|Number=Sing|NumForm=Digit	22	obl	_	Translit=6-in|LTranslit=6
12	ՀՀ	ՀՀ	PROPN	_	Abbr=Yes|Animacy=Nhum|Case=Nom|Definite=Ind|NameType=Geo|Number=Sing	13	nmod	_	Translit=HH|LTranslit=HH
13	Նախագահի	նախագահ	NOUN	_	Animacy=Hum|Case=Dat|Definite=Ind|Number=Sing	14	nmod:poss	_	Translit=Naxagahi|LTranslit=naxagah
14	թեկնածուի	թեկնածու	NOUN	_	Animacy=Hum|Case=Dat|Definite=Ind|Number=Sing	16	nmod:poss	_	Translit=t’eknaçowi|LTranslit=t’eknaçow
15	վստահված	վստահել	VERB	_	Aspect=Perf|Polarity=Pos|Subcat=Intr|VerbForm=Part|Voice=Pass	16	compound	_	Translit=vstahvaç|LTranslit=vstahel
16	անձի	անձ	NOUN	_	Animacy=Hum|Case=Dat|Definite=Ind|Number=Sing	22	obl:agent	_	Translit=anji|LTranslit=anj
17	կողմից	կողմից	ADP	_	AdpType=Post	16	case	_	Translit=koġmic’|LTranslit=koġmic’
18	դիմում	դիմում	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	22	nsubj:pass	_	Translit=dimowm|LTranslit=dimowm|SpaceAfter=No
19	-	-	PUNCT	_	_	20	punct	_	Translit=-|LTranslit=-|SpaceAfter=No
20	առաջարկություն	առաջարկություն	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	18	compound	_	Translit=aṙaǰarkowt’yown|LTranslit=aṙaǰarkowt’yown
21	է	եմ	AUX	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin	22	aux	_	Translit=ē|LTranslit=em
22	ներկայացվել	ներկայանալ	VERB	_	Aspect=Perf|Subcat=Intr|VerbForm=Part|Voice=Pass	0	root	_	Translit=nerkayac’vel|LTranslit=nerkayanal
23	նաև	նաև	CCONJ	_	ConjType=Comp	27	advmod:emph	_	Translit=naew|LTranslit=naew
24	ՀՀ	ՀՀ	PROPN	_	Abbr=Yes|Animacy=Nhum|Case=Nom|Definite=Ind|NameType=Geo|Number=Sing	27	nmod	_	Translit=HH|LTranslit=HH
25	կենտրոնական	կենտրոնական	ADJ	_	Degree=Pos	27	amod	_	Translit=kentronakan|LTranslit=kentronakan
26	ընտրական	ընտրական	ADJ	_	_	27	amod	_	Translit=ëntrakan|LTranslit=ëntrakan
27	հանձնաժողով	հանձնաժողով	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	22	obl	_	Translit=hanjnažoġov|LTranslit=hanjnažoġov|SpaceAfter=No
28	:	:	PUNCT	_	_	22	punct	_	Translit=.|LTranslit=.
