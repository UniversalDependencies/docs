...
The most frequent other feature values with which `VERB` and `Dialect` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=EMPTY</tt> (2; 100%), <tt><a href="Tense.html">Tense</a>=Past</tt> (2; 100%), <tt><a href="Voice.html">Voice</a>=EMPTY</tt> (2; 100%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (2; 100%), <tt><a href="Form.html">Form</a>=Len</tt> (2; 100%).
