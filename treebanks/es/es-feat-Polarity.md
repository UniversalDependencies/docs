---
layout: base
title:  'Statistics of Polarity in UD_Spanish'
udver: '2'
---

## Treebank Statistics: UD_Spanish: Features: `Polarity`
...
The feature is used with 6 part-of-speech tags: <tt><a href="es-pos-ADV.html">ADV</a></tt> (1723; 0% instances), <tt><a href="es-pos-CCONJ.html">CCONJ</a></tt> (28; 0% instances), <tt><a href="es-pos-PROPN.html">PROPN</a></tt> (8; 0% instances), <tt><a href="es-pos-X.html">X</a></tt> (3; 0% instances), <tt><a href="es-pos-ADJ.html">ADJ</a></tt> (1; 0% instances), <tt><a href="es-pos-ADP.html">ADP</a></tt> (1; 0% instances).

### `ADV`

1723 <tt><a href="es-pos-ADV.html">ADV</a></tt> tokens (14% of all `ADV` tokens) have a non-empty value of `Polarity`.

The most frequent other feature values with which `ADV` and `Polarity` co-occurred: <tt><a href="es-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (1723; 100%).
...
28 <tt><a href="es-pos-CCONJ.html">CCONJ</a></tt> tokens (0% of all `CCONJ` tokens) have a non-empty value of `Polarity`.

`CCONJ` tokens may have the following values of `Polarity`:

* `Neg` (28; 100% of non-empty `Polarity`): <em>ni</em>
* `EMPTY` (13794): <em>y, o, pero, que, e, como, ni, sino, mientras, si</em>

### `PROPN`

8 <tt><a href="es-pos-PROPN.html">PROPN</a></tt> tokens (0% of all `PROPN` tokens) have a non-empty value of `Polarity`.

The most frequent other feature values with which `PROPN` and `Polarity` co-occurred: <tt><a href="es-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (8; 100%).
