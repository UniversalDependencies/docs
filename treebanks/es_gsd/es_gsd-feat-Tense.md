...
32625 tokens (8%) have a non-empty value of `Tense`.
6474 types (14%) occur at least once with a non-empty value of `Tense`.
2321 lemmas (7%) occur at least once with a non-empty value of `Tense`.
The feature is used with 2 part-of-speech tags: <tt><a href="es_gsd-pos-VERB.html">VERB</a></tt> (22998; 5% instances), <tt><a href="es_gsd-pos-AUX.html">AUX</a></tt> (9627; 2% instances).

### `VERB`

22998 <tt><a href="es_gsd-pos-VERB.html">VERB</a></tt> tokens (63% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="es_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (19920; 87%), <tt><a href="es_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (19920; 87%), <tt><a href="es_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (19222; 84%), <tt><a href="es_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (18977; 83%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (17544; 76%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (632; 3% of non-empty `Tense`): <em>será, tendrá, hará, permitirá, tendrán, contará, llegará, habrá, celebrará, saldrá</em>
* `Imp` (2500; 11% of non-empty `Tense`): <em>tenía, era, eran, había, pertenecían, estaba, tenían, encontraba, contaba, estaban</em>
* `Past` (9613; 42% of non-empty `Tense`): <em>fue, tuvo, hizo, comenzó, nació, dijo, dio, ganó, convirtió, recibió</em>
* `Pres` (10253; 45% of non-empty `Tense`): <em>tiene, es, encuentra, hay, hace, tienen, está, cuenta, da, dice</em>
* `EMPTY` (13282): <em>hacer, ubicado, ver, debido, tener, decir, dar, partir, conocido, llegar</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="es_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="es_gsd-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="es_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>tiene, tenia, Tuve, tenéis</em></td><td><em>tendrá</em></td><td><em>tuvo</em></td><td><em>tenía</em></td></tr>
  ...
  <tr><td><tt><tt><a href="es_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="es_gsd-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="es_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>tienen, tengan, tienes</em></td><td><em>tendrán</em></td><td><em>tuvieron, tenia</em></td><td><em>tenían, tengan</em></td></tr>
...
9627 <tt><a href="es_gsd-pos-AUX.html">AUX</a></tt> tokens (90% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="es_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9360; 97%), <tt><a href="es_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9081; 94%), <tt><a href="es_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9062; 94%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7356; 76%).

`AUX` tokens may have the following values of `Tense`:

* `Fut` (180; 2% of non-empty `Tense`): <em>será, podrá, podrán, serán, deberá, estará, deberán, estarán, podremos, Habría</em>
* `Imp` (1411; 15% of non-empty `Tense`): <em>eran, era, había, estaba, habían, podía, estaban, debía, fuese, fuera</em>
* `Past` (2007; 21% of non-empty `Tense`): <em>fue, fueron, sido, pudo, estuvo, pudieron, estado, podido, Son, debió</em>
* `Pres` (6029; 63% of non-empty `Tense`): <em>es, ha, son, han, está, puede, pueden, están, he, sea</em>
* `EMPTY` (1127): <em>ser, siendo, haber, sería, podría, poder, estar, esta, habría, fuera</em>
...
<tt>VERB --[<tt><a href="es_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1720; 61%),
