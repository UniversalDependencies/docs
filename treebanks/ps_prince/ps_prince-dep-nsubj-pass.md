---
layout: base
title:  'Statistics of nsubj:pass in UD_Pashto-Prince'
udver: '2'
---

## Treebank Statistics: UD_Pashto-Prince: Relations: `nsubj:pass`

This relation is a language-specific subtype of <tt><a href="ps_prince-dep-nsubj.html">nsubj</a></tt>.
...
The following 1 pairs of parts of speech are connected with `nsubj:pass`: <tt><a href="ps_prince-pos-VERB.html">VERB</a></tt>-<tt><a href="ps_prince-pos-NOUN.html">NOUN</a></tt> (3; 100% instances).
