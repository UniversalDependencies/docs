...
The feature is used with 2 part-of-speech tags: [es-pos/VERB]() (27390; 6% instances), [es-pos/AUX]() (5237; 1% instances).

### `VERB`

27390 [es-pos/VERB]() tokens (67% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (24267; 89%), <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (24267; 89%), <tt><a href="Person.html">Person</a>=3</tt> (23582; 86%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (23243; 85%), <tt><a href="Number.html">Number</a>=Sing</tt> (21041; 77%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (665; 2% of non-empty `Tense`): <em>será, tendrá, serán, hará, permitirá, estará, contará, habrá, llegará, celebrará</em>
* `Imp` (3205; 12% of non-empty `Tense`): <em>eran, era, tenía, estaba, había, pertenecían, tenían, estaban, encontraba, contaba</em>
* `Past` (10167; 37% of non-empty `Tense`): <em>fue, hizo, fueron, tuvo, sido, nació, dijo, dio, ganó, convirtió</em>
* `Pres` (13353; 49% of non-empty `Tense`): <em>es, son, tiene, encuentra, está, hay, hace, tienen, están, sea</em>
...
5237 [es-pos/AUX]() tokens (87% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (5015; 96%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (4819; 92%), <tt><a href="Person.html">Person</a>=3</tt> (4704; 90%), <tt><a href="Number.html">Number</a>=Sing</tt> (3861; 74%).
...
47249 tokens (8%) have a non-empty value of `Tense`.
...
The feature is used with 3 part-of-speech tags: [es-pos/VERB]() (33994; 6% instances), [es-pos/AUX]() (13254; 2% instances), [es-pos/ADV]() (1; 0% instances).

### `VERB`

33994 [es-pos/VERB]() tokens (74% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (29379; 86%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (29378; 86%), <tt><a href="Person.html">Person</a>=3</tt> (27687; 81%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (27293; 80%), <tt><a href="Number.html">Number</a>=Sing</tt> (26240; 77%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (2107; 6% of non-empty `Tense`): <em>tendrá, estará, hará, permitirá, tendrán, celebrará, disputará, presentará, estarán, dará</em>
* `Imp` (2731; 8% of non-empty `Tense`): <em>estaba, tenía, estaban, tenían, decía, quería, sabía, encontraba, hacía, parecía</em>
* `Past` (15573; 46% of non-empty `Tense`): <em>dijo, aseguró, explicó, afirmó, señaló, hizo, anunció, añadió, tuvo, hecho</em>
* `Pres` (13583; 40% of non-empty `Tense`): <em>tiene, está, tienen, están, quiere, hace, dice, parece, creo, considera</em>
* `EMPTY` (12071): <em>hacer, dar, tener, ganar, estar, poner, ver, jugar, mantener, conseguir</em>
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Sub|<a href="Number.html">Number</a>=Plur|<a href="Person.html">Person</a>=3|<a href="VerbForm.html">VerbForm</a>=Fin</tt></td><td><em>tengan</em></td><td></td><td></td><td><em>tuvieran, tuviesen</em></td></tr>
</table>

### `AUX`

13254 [es-pos/AUX]() tokens (84% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (12627; 95%), <tt><a href="Person.html">Person</a>=3</tt> (11996; 91%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (11840; 89%), <tt><a href="Number.html">Number</a>=Sing</tt> (10289; 78%).

`AUX` tokens may have the following values of `Tense`:

* `Fut` (672; 5% of non-empty `Tense`): <em>será, serán, habrá, deberá, podrá, deberán, podrán, seguirá, volverá, podremos</em>
* `Imp` (1437; 11% of non-empty `Tense`): <em>había, era, habían, eran, hubiera, podía, fuera, iba, pudiera, debía</em>
* `Past` (1987; 15% of non-empty `Tense`): <em>fue, sido, fueron, pudo, hubo, podido, volvió, llegó, habido, pudieron</em>
* `Pres` (9158; 69% of non-empty `Tense`): <em>es, ha, han, son, hay, puede, hace, debe, sea, pueden</em>
* `EMPTY` (2469): <em>ser, haber, sería, podría, poder, siendo, habría, estar, seguir, volver</em>
...
The most frequent other feature values with which `ADV` and `Tense` co-occurred: <tt><a href="Negative.html">Negative</a>=EMPTY</tt> (1; 100%).
...
The 10 most frequent relations where parent and child node agree in `Tense`:
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (2346; 65%),
<tt>VERB --[<a href="../dep/compound.html">compound</a>]--> VERB</tt> (14; 100%),
<tt>AUX --[<a href="../dep/csubj.html">csubj</a>]--> VERB</tt> (13; 62%),
<tt>AUX --[<a href="../dep/ccomp.html">ccomp</a>]--> VERB</tt> (12; 80%),
<tt>AUX --[<a href="../dep/conj.html">conj</a>]--> AUX</tt> (9; 56%),
