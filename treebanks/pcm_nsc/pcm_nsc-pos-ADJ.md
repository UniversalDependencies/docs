...
There are 475 `ADJ` lemmas (10%), 483 `ADJ` types (9%) and 3540 `ADJ` tokens (3%).
...
The form / lemma ratio of `ADJ` is 1.016842 (the average of all parts of speech is 1.162960).
