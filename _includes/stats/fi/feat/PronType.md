...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Ill|<a href="Number.html">Number</a>=Plur</tt></td><td><em>joihin</em></td><td></td></tr>
...
The feature is used with 4 part-of-speech tags: [fi-pos/PRON]() (10269; 6% instances), [fi-pos/DET]() (4088; 3% instances), [fi-pos/ADV]() (2320; 1% instances), [fi-pos/ADJ]() (292; 0% instances).

### `PRON`

10269 [fi-pos/PRON]() tokens (97% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (7646; 74%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (5834; 57%), <tt><a href="Case.html">Case</a>=Nom</tt> (5307; 52%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Par|<a href="Clitic.html">Clitic</a>=Han|<a href="Style.html">Style</a>=Coll</tt></td><td><em>mitähäl</em></td><td></td><td></td></tr>
...
4088 [fi-pos/DET]() tokens (99% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (2627; 64%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=All</tt></td><td><em>Mille</em></td><td></td><td><em>mille</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Plur</tt></td><td><em>mitkä</em></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Par</tt></td><td><em>mitä</em></td><td><em>mitä-</em></td><td><em>mitä</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Par|<a href="Clitic.html">Clitic</a>=Han</tt></td><td><em>Mitähän</em></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Par|<a href="Clitic.html">Clitic</a>=S</tt></td><td><em>mitäs</em></td><td></td><td></td></tr>
</table>
...
2320 [fi-pos/ADV]() tokens (23% of all `ADV` tokens) have a non-empty value of `PronType`.
...
292 [fi-pos/ADJ]() tokens (3% of all `ADJ` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADJ` and `PronType` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (215; 74%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Ade|<a href="Number.html">Number</a>=Plur</tt></td><td><em>millaisilla</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=All|<a href="Number.html">Number</a>=Sing</tt></td><td><em>millaiselle</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Par|<a href="Number.html">Number</a>=Sing</tt></td><td><em>Millaista</em></td><td></td></tr>
...
The 10 most frequent relations where parent and child node agree in `PronType`:
<tt>PRON --[<a href="../dep/conj.html">conj</a>]--> PRON</tt> (56; 81%),
<tt>DET --[<a href="../dep/det.html">det</a>]--> DET</tt> (27; 75%),
<tt>ADV --[<a href="../dep/conj.html">conj</a>]--> ADV</tt> (21; 81%),
<tt>ADV --[<a href="../dep/mwe.html">mwe</a>]--> ADV</tt> (15; 94%),
