...
There are 1 `NUM` lemmas (6%), 1 `NUM` types (0%) and 1 `NUM` tokens (0%).
Out of 16 observed tags, the rank of `NUM` is: 9 in number of lemmas, 16 in number of types and 16 in number of tokens.

The 10 most frequent `NUM` lemmas: <em>_</em>

The 10 most frequent `NUM` types:  <em>mhaj</em>
...
The form / lemma ratio of `NUM` is 1.000000 (the average of all parts of speech is 19.625000).

The 1st highest number of forms (1) was observed with the lemma “_”: <em>mhaj</em>.
...
`NUM` nodes are attached to their parents using 1 different relations: <tt><a href="bej_nsc-dep-nummod-det.html">nummod:det</a></tt> (1; 100% instances)

Parents of `NUM` nodes belong to 1 different parts of speech: <tt><a href="bej_nsc-pos-NOUN.html">NOUN</a></tt> (1; 100% instances)
