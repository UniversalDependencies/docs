...
15956 tokens (17%) have a non-empty value of `VerbForm`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="en_lines-pos-VERB.html">VERB</a></tt> (10792; 11% instances), <tt><a href="en_lines-pos-AUX.html">AUX</a></tt> (5162; 5% instances), <tt><a href="en_lines-pos-ADJ.html">ADJ</a></tt> (2; 0% instances).

### `VERB`

10792 <tt><a href="en_lines-pos-VERB.html">VERB</a></tt> tokens (97% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="en_lines-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (9596; 89%), <tt><a href="en_lines-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (5710; 53%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (5083; 47% of non-empty `VerbForm`): <em>said, was, had, is, came, seemed, looked, went, know, made</em>
* `Inf` (2511; 23% of non-empty `VerbForm`): <em>see, know, do, make, go, have, get, say, take, be</em>
* `Part` (3198; 30% of non-empty `VerbForm`): <em>going, using, done, made, looking, trying, come, moving, taken, used</em>
...
5162 <tt><a href="en_lines-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="en_lines-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (3437; 67%), <tt><a href="en_lines-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (3437; 67%), <tt><a href="en_lines-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3354; 65%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (4512; 87% of non-empty `VerbForm`): <em>was, had, is, can, would, could, will, were, are, must</em>
* `Inf` (357; 7% of non-empty `VerbForm`): <em>be, have, get, do</em>
* `Part` (293; 6% of non-empty `VerbForm`): <em>been, being, having</em>
...
* `EMPTY` (5937): <em>other, white, old, new, good, same, own, first, black, great</em>

## Relations with Agreement in `VerbForm`

The 10 most frequent relations where parent and child node agree in `VerbForm`:
<tt>VERB --[<tt><a href="en_lines-dep-conj.html">conj</a></tt>]--> VERB</tt> (1098; 73%),
<tt>VERB --[<tt><a href="en_lines-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (137; 52%),
<tt>VERB --[<tt><a href="en_lines-dep-advcl.html">advcl</a></tt>]--> AUX</tt> (16; 57%),
<tt>VERB --[<tt><a href="en_lines-dep-obj.html">obj</a></tt>]--> VERB</tt> (16; 57%),
...
<tt>AUX --[<tt><a href="en_lines-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (3; 75%),
