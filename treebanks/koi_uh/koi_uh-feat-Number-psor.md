...
86 tokens (7%) have a non-empty value of `Number[psor]`.
72 types (12%) occur at least once with a non-empty value of `Number[psor]`.
62 lemmas (13%) occur at least once with a non-empty value of `Number[psor]`.
The feature is used with 3 part-of-speech tags: <tt><a href="koi_uh-pos-NOUN.html">NOUN</a></tt> (80; 7% instances), <tt><a href="koi_uh-pos-ADP.html">ADP</a></tt> (4; 0% instances), <tt><a href="koi_uh-pos-PRON.html">PRON</a></tt> (2; 0% instances).

### `NOUN`

80 <tt><a href="koi_uh-pos-NOUN.html">NOUN</a></tt> tokens (31% of all `NOUN` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `NOUN` and `Number[psor]` co-occurred: <tt><a href="koi_uh-feat-Number.html">Number</a></tt><tt>=Sing</tt> (72; 90%), <tt><a href="koi_uh-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (69; 86%), <tt><a href="koi_uh-feat-Person-psor.html">Person[psor]</a></tt><tt>=3</tt> (66; 83%).

`NOUN` tokens may have the following values of `Number[psor]`:


`Number[psor]` seems to be **lexical feature** of `NOUN`. 100% lemmas (56) occur only with one value of `Number[psor]`.
