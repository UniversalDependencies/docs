---
layout: base
title:  'Statistics of amod in UD_Old_East_Slavic-Birchbark'
udver: '2'
---

## Treebank Statistics: UD_Old_East_Slavic-Birchbark: Relations: `amod`
...
# visual-style 3	fgColor:white
# visual-style 3 4 amod	color:blue
1	…<lbr/>ль	_	VERB	_	Analyt=Yes|Gender=Masc|Number=Sing|Tense=Past|VerbForm=PartRes|Voice=Act	0	root	_	wf="…ль"|tense=perf|comment="lex_unknown"|addr="231:1"|SpaceAfter=Yes
2	есьмъ	быти	AUX	_	Analyt=Yes|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	1	aux	_	wf="есьмъ"|addr="231:2"|line_id=2|SpaceAfter=Yes
3	ньжиль	Нѣжилъ	PROPN	_	Case=Nom|Gender=Masc|NameType=Giv|Number=Sing	7	nsubj	_	wf="ньжиль"|addr="231:2"|SpaceAfter=Yes
4	пъпъвь	поповъ	ADJ	_	Case=Nom|Gender=Masc|Number=Sing|Poss=Yes	3	amod	_	wf="пъпъвь"|addr="231:2"|SpaceAfter=Yes
5	дъвь	два	NUM	_	Case=Acc|Gender=Fem|NumType=Card	6	nummod:gov	_	wf="дъвь"|addr="231:3"|line_id=3|SpaceAfter=Yes
6	гривьнь	гривна	NOUN	_	Case=Acc|Gender=Fem|Number=Count	7	obj	_	wf="гривьнь"|addr="231:3"|SpaceAfter=Yes
7	въдаль	вдати	VERB	_	Gender=Masc|Number=Sing|Tense=Past|VerbForm=PartRes|Voice=Act	1	parataxis	_	wf="въдаль"|tense=perf|addr="231:3"|SpaceAfter=Yes
8	за	за	ADP	_	_	9	case	_	wf="за"|addr="231:3"|SpaceAfter=Yes
9	та	ты	PRON	_	Case=Acc|Clitic=Yes|Number=Sing|Person=2	7	obl	_	wf="та"|comment=lemma_unsure|addr="231:3"|SpaceAfter=Yes
...
1	послало	послати	VERB	_	Gender=Masc|Number=Sing|Tense=Past|VerbForm=PartRes|Voice=Act	0	root	_	wf="послало"|tense=perf|addr="259/265:_259:1а"|SpaceAfter=Yes
2	ѥсьмо	быти	AUX	_	Analyt=Yes|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	1	aux	_	wf="ѥсьмо"|addr="259/265:_259:2а"|line_id=2а|SpaceAfter=Yes
3	к	къ	ADP	_	_	4	case	_	wf="к"|addr="259/265:_259:2а"|SpaceAfter=Yes
4	тобѣ	ты	PRON	_	Case=Dat|Number=Sing|Person=2	1	obl	_	wf="тобѣ"|comment="clitic_ton"|addr="259/265:_259:2а"|SpaceAfter=Yes
5	вѣ[дѣ]роко	вѣдерко	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	1	obj	_	wf="вѣдѣроко"|addr="259/265:_259:2а"|SpaceAfter=Yes
6	ѡ[се]тринѣ	осетрина	NOUN	_	Case=Gen|Gender=Fem|Number=Sing	5	nmod	_	wf="ѡсетринѣ"|addr="259/265:_259:2а"|SpaceAfter=Yes
7	зап[е]<lbr/>…	запечатати	VERB	_	Case=Acc|Gender=Neut|Number=Sing|Tense=Past|VerbForm=Part|Voice=Pass	5	amod	_	wf="запе…"|comment=lemma_unsure|addr="259/265:_259:2а"|after:line_id=3а|SpaceAfter=Yes
