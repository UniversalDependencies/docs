---
layout: base
title:  'Statistics of Person in UD_Nenets-Tundra'
udver: '2'
---

## Treebank Statistics: UD_Nenets-Tundra: Features: `Person`

This feature is universal.
It occurs with 3 different values: `1`, `2`, `3`.

44 tokens (3%) have a non-empty value of `Person`.
24 types (5%) occur at least once with a non-empty value of `Person`.
20 lemmas (6%) occur at least once with a non-empty value of `Person`.
...
28 <tt><a href="yrk_tundra-pos-NOUN.html">NOUN</a></tt> tokens (8% of all `NOUN` tokens) have a non-empty value of `Person`.
...
8 <tt><a href="yrk_tundra-pos-VERB.html">VERB</a></tt> tokens (3% of all `VERB` tokens) have a non-empty value of `Person`.
...
4 <tt><a href="yrk_tundra-pos-ADP.html">ADP</a></tt> tokens (4% of all `ADP` tokens) have a non-empty value of `Person`.
