---
layout: base
title:  'Statistics of root in UD_Old_Russian-RNC'
udver: '2'
---

## Treebank Statistics: UD_Old_Russian-RNC: Relations: `root`

This relation is universal.

405 nodes (3%) are attached to their parents as `root`.

405 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 9.44444444444444.

The following 9 pairs of parts of speech are connected with `root`: -<tt><a href="orv_rnc-pos-VERB.html">VERB</a></tt> (352; 87% instances), -<tt><a href="orv_rnc-pos-NOUN.html">NOUN</a></tt> (31; 8% instances), -<tt><a href="orv_rnc-pos-ADJ.html">ADJ</a></tt> (6; 1% instances), -<tt><a href="orv_rnc-pos-ADV.html">ADV</a></tt> (5; 1% instances), -<tt><a href="orv_rnc-pos-PROPN.html">PROPN</a></tt> (5; 1% instances), -<tt><a href="orv_rnc-pos-DET.html">DET</a></tt> (2; 0% instances), -<tt><a href="orv_rnc-pos-PRON.html">PRON</a></tt> (2; 0% instances), -<tt><a href="orv_rnc-pos-INTJ.html">INTJ</a></tt> (1; 0% instances), -<tt><a href="orv_rnc-pos-X.html">X</a></tt> (1; 0% instances).
...
1	Писанъ	писати	VERB	OOV|Transit=Tran	Aspect=Imp|Case=Nom|Gender=Masc|Number=Sing|Tense=Past|Variant=Short|VerbForm=Part|Voice=Pass	0	root	_	_
...
6	7206	7206	ADJ	OOV	Case=Gen|Gender=Neut|Number=Sing	5	amod	_	SpaceAfter=No
7	,	,	PUNCT	_	_	8	punct	_	_
8	маія	май	NOUN	OOV|Animacy[lex]=Inan	Case=Gen|Gender=Masc|Number=Sing	5	nmod	_	_
9	во	въ	ADP	_	_	11	case	_	_
10	2	2	ADJ	OOV	_	11	amod	_	_
...
# visual-style 0	fgColor:white
# visual-style 0 1 root	color:blue
1	Подлинникъ	подлинникъ	NOUN	OOV|Animacy[lex]=Inan	Case=Nom|Gender=Masc|Number=Sing	0	root	_	SpaceAfter=No
