...
The feature is used with 2 part-of-speech tags: [sl-pos/DET]() (804; 1% instances), [sl-pos/PRON]() (23; 0% instances).
...
23 [sl-pos/PRON]() tokens (0% of all `PRON` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `PRON` and `Number[psor]` co-occurred: <tt><a href="Variant.html">Variant</a>=EMPTY</tt> (23; 100%), <tt><a href="Reflex.html">Reflex</a>=EMPTY</tt> (23; 100%), <tt><a href="PronType.html">PronType</a>=Prs</tt> (22; 96%), <tt><a href="Number.html">Number</a>=Sing</tt> (15; 65%), <tt><a href="Person.html">Person</a>=3</tt> (12; 52%).
...
The feature is used with 2 part-of-speech tags: [sl-pos/DET]() (113; 0% instances), [sl-pos/PRON]() (20; 0% instances).
...
20 [sl-pos/PRON]() tokens (1% of all `PRON` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `PRON` and `Number[psor]` co-occurred: <tt><a href="Variant.html">Variant</a>=EMPTY</tt> (20; 100%), <tt><a href="PronType.html">PronType</a>=Prs</tt> (20; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (18; 90%), <tt><a href="Person.html">Person</a>=1</tt> (15; 75%), <tt><a href="Gender.html">Gender</a>=Neut</tt> (11; 55%).
