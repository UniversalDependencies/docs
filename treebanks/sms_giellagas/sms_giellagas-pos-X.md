---
layout: base
title:  'Statistics of X in UD_Skolt_Sami-Giellagas'
udver: '2'
---

## Treebank Statistics: UD_Skolt_Sami-Giellagas: POS Tags: `X`
...
The form / lemma ratio of `X` is 1.000000 (the average of all parts of speech is 1.472015).
...
`X` nodes are attached to their parents using 1 different relations: <tt><a href="sms_giellagas-dep-goeswith.html">goeswith</a></tt> (1; 100% instances)

Parents of `X` nodes belong to 1 different parts of speech: <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> (1; 100% instances)
