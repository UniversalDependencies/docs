---
layout: base
title:  'Statistics of nmod:tmod in UD_Chinese-GSDSimp'
udver: '2'
---

## Treebank Statistics: UD_Chinese-GSDSimp: Relations: `nmod:tmod`

This relation is a language-specific subtype of <tt><a href="zh_gsdsimp-dep-nmod.html">nmod</a></tt>.
...
2	官话	官话	NOUN	NN	_	9	nsubj	_	SpaceAfter=No|Translit=guānhuà|LTranslit=guānhuà
3	曾经	曾经	ADV	RB	_	9	advmod	_	SpaceAfter=No|Translit=céngjīng|LTranslit=céngjīng
4	长期	长期	NOUN	NN	_	9	nmod:tmod	_	SpaceAfter=No|Translit=zhǎngqī|LTranslit=zhǎngqī
5	是	是	AUX	VC	_	9	cop	_	SpaceAfter=No|Translit=shì|LTranslit=shì
6	中国	中国	PROPN	NNP	_	9	nmod	_	SpaceAfter=No|Translit=zhōngguó|LTranslit=zhōngguó
...
9	语言	语言	NOUN	NN	_	0	root	_	SpaceAfter=No|Translit=yǔyán|LTranslit=yǔyán
...
9	乔治	乔治	PROPN	NNP	_	10	nmod	_	SpaceAfter=No|Translit=乔zhì|LTranslit=乔zhì
...
13	岁	岁	NOUN	NNB	_	11	nmod:tmod	_	SpaceAfter=No|Translit=suì|LTranslit=suì
