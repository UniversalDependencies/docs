---
layout: base
title:  'Statistics of obj:agent in UD_Apurina-UFPA'
udver: '2'
---

## Treebank Statistics: UD_Apurina-UFPA: Relations: `obj:agent`

This relation is a language-specific subtype of <tt><a href="apu_ufpa-dep-obj.html">obj</a></tt>.

1 nodes (0%) are attached to their parents as `obj:agent`.

1 instances of `obj:agent` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `obj:agent`: <tt><a href="apu_ufpa-pos-VERB.html">VERB</a></tt>-<tt><a href="apu_ufpa-pos-NOUN.html">NOUN</a></tt> (1; 100% instances).
