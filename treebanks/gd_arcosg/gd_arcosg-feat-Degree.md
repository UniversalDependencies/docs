...
224 <tt><a href="gd_arcosg-pos-ADJ.html">ADJ</a></tt> tokens (6% of all `ADJ` tokens) have a non-empty value of `Degree`.
...
The most frequent other feature values with which `ADV` and `Degree` co-occurred: <tt><a href="gd_arcosg-feat-AdvType.html">AdvType</a></tt><tt>=Tim</tt> (1; 100%), <tt><a href="gd_arcosg-feat-ExtPos.html">ExtPos</a></tt><tt>=EMPTY</tt> (1; 100%).
