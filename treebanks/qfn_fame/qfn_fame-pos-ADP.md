...
There are 1 `ADP` lemmas (7%), 51 `ADP` types (4%) and 440 `ADP` tokens (12%).
...
* <em>yn</em>
  * <tt><a href="qfn_fame-pos-ADP.html">ADP</a></tt> 71: <em>de ontwikkeling in hoofdlijnen foar it <b>yn</b> it plan begrepen gebied</em>
  * <tt><a href="qfn_fame-pos-ADV.html">ADV</a></tt> 1: <em>mar wy he hjoed he we <b>yn</b> ieder gefal eh hûndert fyftich tenten he we binnenkrigen</em>
* <em>mei</em>
...
The form / lemma ratio of `ADP` is 51.000000 (the average of all parts of speech is 97.642857).
