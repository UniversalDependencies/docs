...
* <em>once</em>
  * <tt><a href="en_partut-pos-ADV.html">ADV</a></tt> 10: <em>Therefore , the Commission should address the issue <b>once</b> and for all .</em>
  * <tt><a href="en_partut-pos-SCONJ.html">SCONJ</a></tt> 2: <em>Your public updates will appear in people 's News Feeds <b>once</b> they click this button .</em>
...
`SCONJ` occurs with 1 features: <tt><a href="en_partut-feat-ExtPos.html">ExtPos</a></tt> (10; 1% instances)
...
Children of `SCONJ` nodes are attached using 5 different relations: <tt><a href="en_partut-dep-fixed.html">fixed</a></tt> (12; 63% instances), <tt><a href="en_partut-dep-case.html">case</a></tt> (2; 11% instances), <tt><a href="en_partut-dep-nmod.html">nmod</a></tt> (2; 11% instances), <tt><a href="en_partut-dep-punct.html">punct</a></tt> (2; 11% instances), <tt><a href="en_partut-dep-conj.html">conj</a></tt> (1; 5% instances)

Children of `SCONJ` nodes belong to 6 different parts of speech: <tt><a href="en_partut-pos-SCONJ.html">SCONJ</a></tt> (10; 53% instances), <tt><a href="en_partut-pos-PART.html">PART</a></tt> (3; 16% instances), <tt><a href="en_partut-pos-ADP.html">ADP</a></tt> (2; 11% instances), <tt><a href="en_partut-pos-PUNCT.html">PUNCT</a></tt> (2; 11% instances), <tt><a href="en_partut-pos-NOUN.html">NOUN</a></tt> (1; 5% instances), <tt><a href="en_partut-pos-PRON.html">PRON</a></tt> (1; 5% instances)
