...
1832 nodes (0%) are attached to their parents as `aux:pass`.

1828 instances of `aux:pass` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.13810043668122.

The following 10 pairs of parts of speech are connected with `aux:pass`: [es-pos/VERB]()-[es-pos/AUX]() (1711; 93% instances), [es-pos/NOUN]()-[es-pos/AUX]() (58; 3% instances), [es-pos/ADJ]()-[es-pos/AUX]() (23; 1% instances), [es-pos/PROPN]()-[es-pos/AUX]() (19; 1% instances), [es-pos/VERB]()-[es-pos/VERB]() (15; 1% instances), [es-pos/PRON]()-[es-pos/AUX]() (2; 0% instances), [es-pos/ADP]()-[es-pos/AUX]() (1; 0% instances), [es-pos/PROPN]()-[es-pos/PROPN]() (1; 0% instances), [es-pos/X]()-[es-pos/AUX]() (1; 0% instances), [es-pos/X]()-[es-pos/X]() (1; 0% instances).
