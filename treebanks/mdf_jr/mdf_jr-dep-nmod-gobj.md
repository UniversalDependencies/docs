...
4	суван	сувамс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=1|Tense=Pres|VerbForm=Fin	0	root	_	CGdephead=#4-&gt;0|CGdeprel=@SPRED|GTtags=SP,Prl,PxSg1|SpaceAfter=No
...
# visual-style 3	fgColor:white
# visual-style 3 2 nmod:gobj	color:blue
1	Лувонтт	лувондомс	VERB	V	Mood=Imp|Number[subj]=Sing|Person[subj]=2|VerbForm=Fin	0	root	_	CGdephead=#1-&gt;0|CGdeprel=@FMV|GTtags=Imprt,ScSg2
