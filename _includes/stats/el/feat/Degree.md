...
290 tokens (0%) have a non-empty value of `Degree`.
134 types (1%) occur at least once with a non-empty value of `Degree`.
65 lemmas (1%) occur at least once with a non-empty value of `Degree`.
The feature is used with 2 part-of-speech tags: [el-pos/ADJ]() (221; 0% instances), [el-pos/ADV]() (69; 0% instances).

### `ADJ`

221 [el-pos/ADJ]() tokens (5% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="Case.html">Case</a>=Acc</tt> (122; 55%), <tt><a href="Number.html">Number</a>=Sing</tt> (116; 52%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (186; 84% of non-empty `Degree`): <em>μεγαλύτερο, μεγαλύτερη, περισσότερα, περισσότερες, περισσότεροι, καλύτερη, μεγαλύτερες, μικρότερες, σημαντικότερο, καλύτερο</em>
* `Sup` (35; 16% of non-empty `Degree`): <em>σοβαρότατες, ελάχιστες, ελάχιστο, Ανώτατο, ανώτατων, ελάχιστα, μέγιστη, Γαληνότατης, Δριμύτατη, άριστων</em>
* `EMPTY` (4472): <em>ευρωπαϊκή, ευρωπαϊκό, νέα, σημαντικό, όλα, όλες, ευρωπαϊκής, μεγάλη, ευρωπαϊκού, πολλές</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Plur</tt></td><td><em>μεγαλύτερα, μείζονα</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td><em>μεγαλύτερου</em></td><td></td></tr>
...
69 [el-pos/ADV]() tokens (3% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (65; 94% of non-empty `Degree`): <em>περισσότερο, αργότερα, νωρίτερα, καλύτερα, λιγότερο, ειδικότερα, παλαιότερα, Παλιότερα, αυστηρότερα, βορειότερα</em>
* `Sup` (4; 6% of non-empty `Degree`): <em>πιθανότατα, ελάχιστα, πρώτιστα</em>
* `EMPTY` (2573): <em>ως, επίσης, όπως, σχετικά, σήμερα, μόνο, εδώ, πολύ, σύμφωνα, πιο</em>
...
`Degree` seems to be **lexical feature** of `ADV`. 95% lemmas (20) occur only with one value of `Degree`.
