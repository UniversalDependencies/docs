---
layout: base
title:  'Statistics of Polarity in UD_Makurap-TuDeT'
udver: '2'
---

## Treebank Statistics: UD_Makurap-TuDeT: Features: `Polarity`

This feature is universal.
It occurs with 1 different values: `Neg`.

3 tokens (2%) have a non-empty value of `Polarity`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="mpu_tudet-pos-PRON.html">PRON</a></tt> (3; 2% instances).
