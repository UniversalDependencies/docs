---
layout: base
title:  'Statistics of det:numgov in UD_Polish-SZ'
udver: '2'
---

## Treebank Statistics: UD_Polish-SZ: Relations: `det:numgov`

This relation is a language-specific subtype of <tt><a href="pl_sz-dep-det.html">det</a></tt>.
There are also 1 other language-specific subtypes of `det`: <tt><a href="pl_sz-dep-det-nummod.html">det:nummod</a></tt>.
...
The following 2 pairs of parts of speech are connected with `det:numgov`: <tt><a href="pl_sz-pos-NOUN.html">NOUN</a></tt>-<tt><a href="pl_sz-pos-DET.html">DET</a></tt> (75; 99% instances), <tt><a href="pl_sz-pos-PRON.html">PRON</a></tt>-<tt><a href="pl_sz-pos-DET.html">DET</a></tt> (1; 1% instances).
