...
10537 tokens (15%) have a non-empty value of `PronType`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="fr_sequoia-pos-DET.html">DET</a></tt> (9723; 14% instances), <tt><a href="fr_sequoia-pos-PRON.html">PRON</a></tt> (776; 1% instances), <tt><a href="fr_sequoia-pos-ADV.html">ADV</a></tt> (38; 0% instances).

### `DET`

9723 <tt><a href="fr_sequoia-pos-DET.html">DET</a></tt> tokens (93% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="fr_sequoia-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (7439; 77%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7130; 73%).

`DET` tokens may have the following values of `PronType`:

* `Art` (9265; 95% of non-empty `PronType`): <em>le, les, la, l', une, un, des, de, d', quelques</em>
