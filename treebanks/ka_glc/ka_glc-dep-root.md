---
layout: base
title:  'Statistics of root in UD_Georgian-GLC'
udver: '2'
---

## Treebank Statistics: UD_Georgian-GLC: Relations: `root`
...
# visual-style 0	fgColor:white
# visual-style 0 5 root	color:blue
1	მანქანათმშენებლობა	მანქანათმშენებლობა	NOUN	Noun	Animacy=Inan|Case=Nom|Number=Sing	5	nsubj	_	Translit=mankʻanatʻmšenebloba
2	—	—	PUNCT	F	PunctType=Dash	1	punct	_	Translit=—
3	კლასიკური	კლასიკური	ADJ	Adj	Case=Nom|Number=Sing	5	amod	_	Translit=klasikuri
4	საინჟინრო	საინჟინრო	ADJ	Adj	Case=Nom|Number=Sing	5	amod	_	Translit=sainžinro
5	დარგი	დარგი	NOUN	Noun	Animacy=Inan|Case=Nom|Number=Sing	0	root	_	Translit=dargi
6	და	და	CCONJ	Conj	_	8	cc	_	Translit=da
7	ინდუსტრიის	ინდუსტრია	NOUN	Noun	Animacy=Inan|Case=Gen|Number=Sing	8	nmod	_	Translit=industriis
8	ფუნდამენტი	ფუნდამენტი	NOUN	Noun	Animacy=Inan|Case=Nom|Number=Sing	5	conj	_	SpaceAfter=No|Translit=pʻundamenti
...
1	ბანკი	ბანკი	NOUN	Noun	Animacy=Inan|Case=Nom|Number=Sing	3	nsubj	_	Translit=banki
2	სრულიად	სრულიად	ADV	Adv	AdvType=Man	3	advmod	_	Translit=sruliad
3	დამოუკიდებელი	დამოუკიდებელი	ADJ	Adj	Case=Nom|Number=Sing	0	root	_	Translit=damoukidebeli
4	ა	არის	AUX	Aux	Mood=Ind|Number[subj]=Sing|Person[subj]=2|Subcat=Intr|Tense=Pres	3	cop	_	Translit=a
5	ევროკავშირის	ევროკავშირი	PROPN	Prop	Case=Gen|NameType=Geo|Number=Sing	8	nmod	_	Translit=evrokavširis
6	ყველა	ყველა	PRON	Pron	Case=Gen|Number=Sing|PronType=Tot	7	det	_	Translit=qvela
7	დანარჩენ	დანარჩენი	ADJ	Adj	Case=Gen|Number=Sing	8	amod	_	Translit=danarčʻen
8	ორგანოს	ორგანო	NOUN	Noun	Animacy=Inan|Case=Gen|Number=Sing	3	obl	_	Translit=organos
9	გან	გან	ADP	Post	AdpType=Post|Case=Gen	8	case	_	Translit=gan
