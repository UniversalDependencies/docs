---
layout: base
title:  'Statistics of goeswith in UD_Skolt_Sami-Giellagas'
udver: '2'
---

## Treebank Statistics: UD_Skolt_Sami-Giellagas: Relations: `goeswith`
...
3	šõllneškuõʹđež	šõllned	VERB	V	Derivation=InchL|Mood=Pot|Number=Sing|Person=3|VerbForm=Fin	0	root	_	GTtags=Der/InchL,Pot,Sg3
4	di	di	CCONJ	CC	_	6	cc	_	_
5	reiʹǧǧruʹvdd	reiʹǧǧruʹvdd	NOUN	N	Case=Nom|Number=Sing	6	nsubj	_	GTtags=Sg,Nom
6	poouǩeškueʹđež	poouǩeškueʹhted	VERB	V	Mood=Pot|Number=Sing|Person=3|VerbForm=Fin	3	conj	_	GTtags=Pot,Sg3|SpaceAfter=No
