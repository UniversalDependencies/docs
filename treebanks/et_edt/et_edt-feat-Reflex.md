...
1164 tokens (0%) have a non-empty value of `Reflex`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> (1163; 0% instances), <tt><a href="et_edt-pos-DET.html">DET</a></tt> (1; 0% instances).

### `PRON`

1163 <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> tokens (5% of all `PRON` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `PRON` and `Reflex` co-occurred: <tt><a href="et_edt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (1163; 100%), <tt><a href="et_edt-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1103; 95%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1086; 93%).

`PRON` tokens may have the following values of `Reflex`:

* `Yes` (1163; 100% of non-empty `Reflex`): <em>ise, end, endale, enda, ennast, endast, endal, iseenda, enese, endaga</em>
