...
The feature is used with 3 part-of-speech tags: <tt><a href="cs-pos-DET.html">DET</a></tt> (56466; 4% instances), <tt><a href="cs-pos-PRON.html">PRON</a></tt> (44924; 3% instances), <tt><a href="cs-pos-ADV.html">ADV</a></tt> (12441; 1% instances).

### `DET`

56466 <tt><a href="cs-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="cs-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (49479; 88%), <tt><a href="cs-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (47051; 83%), <tt><a href="cs-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (47049; 83%), <tt><a href="cs-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (42149; 75%), <tt><a href="cs-feat-Number.html">Number</a></tt><tt>=Sing</tt> (36209; 64%).
...
* `Ind` (3894; 7% of non-empty `PronType`): <em>několik, některé, některých, několika, mnoho, někteří, mnoha, nějaké, nějaký, málo</em>
...
`PronType` seems to be **lexical feature** of `DET`. 100% lemmas (71) occur only with one value of `PronType`.

### `PRON`

44924 <tt><a href="cs-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="cs-feat-PrepCase.html">PrepCase</a></tt><tt>=EMPTY</tt> (39999; 89%), <tt><a href="cs-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (36991; 82%), <tt><a href="cs-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (33794; 75%), <tt><a href="cs-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (31314; 70%), <tt><a href="cs-feat-Case.html">Case</a></tt><tt>=Acc</tt> (27395; 61%), <tt><a href="cs-feat-Variant.html">Variant</a></tt><tt>=Short</tt> (27181; 61%), <tt><a href="cs-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (25786; 57%).

`PRON` tokens may have the following values of `PronType`:

* `Ind` (1110; 2% of non-empty `PronType`): <em>něco, někdo, někoho, cosi, něčeho, cokoli, něčím, někomu, málokdo, něčem</em>
