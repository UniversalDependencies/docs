---
layout: base
title:  'Statistics of flat in UD_Tatar-NMCTT'
udver: '2'
---

## Treebank Statistics: UD_Tatar-NMCTT: Relations: `flat`
...
2	фикерен	фикер	NOUN	_	Case=Acc|Number=Sing	15	obj	_	LangID=TT
3	ул	ул	PRON	_	Case=Nom|Number=Sing|Person=3|PronType=Prs	15	nsubj	_	LangID=TT
4	Татарстан	Татарстан	PROPN	_	Case=Nom|Number=Sing	5	nmod	_	LangID=TT
5	Президенты	президент	NOUN	_	Case=Nom|Number=Sing|Person[psor]=3	13	nmod	_	CSPoint=Президент§ы|LangID=MIXED[RU§TT]
6	Рөстәм	Рөстәм	PROPN	_	Case=Nom|Number=Sing	5	flat	_	LangID=TT
7	Миңнеханов	Миңнеханов	PROPN	_	Case=Nom|Number=Sing	5	flat	_	CSPoint=Миңнехан§ов|LangID=MIXED[TT§RU]
8	Дәүләт	дәүләт	NOUN	_	Case=Nom|Number=Sing	9	nmod	_	LangID=TT
9	Советына	совет	NOUN	_	Case=Dat|Number=Sing|Person[psor]=3	13	nmod	_	CSPoint=Совет§ына|LangID=MIXED[RU§TT]
10	еллык	еллык	ADJ	_	_	11	amod	_	LangID=TT
11	юллама	юллама	NOUN	_	Case=Nom|Number=Sing	13	nmod	_	LangID=TT
12	белән	белән	ADP	_	_	11	case	_	LangID=TT
13	чыгышыннан	чыгыш	NOUN	_	Case=Abl|Number=Sing|Person[psor]=3	15	obl	_	LangID=TT
