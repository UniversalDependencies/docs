---
layout: base
title:  'Statistics of nummod in UD_Greek-GUD'
udver: '2'
---

## Treebank Statistics: UD_Greek-GUD: Relations: `nummod`
...
1	Και	και	CCONJ	_	_	5	cc	_	_
2	σ	σε	ADP	_	_	5	case	_	_
3	τα	ο	DET	_	Case=Acc|Definite=Def|Gender=Neut|Number=Plur|PronType=Art	5	det	_	_
4	δύο	δύο	NUM	_	Case=Acc|Gender=Neut|Number=Plur|NumType=Card	5	nummod	_	_
5	δωμάτια	δωμάτιο	NOUN	_	Case=Acc|Gender=Neut|Number=Plur	6	obl	_	_
6	υπάρχει	υπάρχω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
7	από	από	ADP	_	_	9	case	_	_
8	ένα	ένας	DET	_	Case=Acc|Definite=Ind|Gender=Neut|Number=Sing|PronType=Art	9	det	_	_
9	κρεβάτι	κρεβάτι	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	6	obl	_	SpaceAfter=No
10	.	.	PUNCT	_	_	6	punct	_	PunctType=Peri
