...
There are 1 `AUX` lemmas (0%), 19 `AUX` types (1%) and 112 `AUX` tokens (2%).
...
The form / lemma ratio of `AUX` is 19.000000 (the average of all parts of speech is 1.442977).
...
`AUX` nodes are attached to their parents using 4 different relations: <tt><a href="lt_hse-dep-cop.html">cop</a></tt> (76; 68% instances), <tt><a href="lt_hse-dep-aux.html">aux</a></tt> (33; 29% instances), <tt><a href="lt_hse-dep-aux-pass.html">aux:pass</a></tt> (2; 2% instances), <tt><a href="lt_hse-dep-root.html">root</a></tt> (1; 1% instances)
