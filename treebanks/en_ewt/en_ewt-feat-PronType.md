...
41419 tokens (16%) have a non-empty value of `PronType`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="en_ewt-pos-PRON.html">PRON</a></tt> (21677; 9% instances), <tt><a href="en_ewt-pos-DET.html">DET</a></tt> (17906; 7% instances), <tt><a href="en_ewt-pos-ADV.html">ADV</a></tt> (1836; 1% instances).

### `PRON`

21677 <tt><a href="en_ewt-pos-PRON.html">PRON</a></tt> tokens (94% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="en_ewt-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (18003; 83%), <tt><a href="en_ewt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (16859; 78%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11918; 55%), <tt><a href="en_ewt-feat-Case.html">Case</a></tt><tt>=Nom</tt> (11781; 54%).
...
* `Prs` (18681; 86% of non-empty `PronType`): <em>i, you, it, they, my, we, he, your, me, their</em>
* `Rel` (1284; 6% of non-empty `PronType`): <em>that, who, which, whom, what, whose</em>
* `EMPTY` (1284): <em>there, anyone, something, anything, nothing, someone, everything, everyone, one, mine</em>
...
1836 <tt><a href="en_ewt-pos-ADV.html">ADV</a></tt> tokens (14% of all `ADV` tokens) have a non-empty value of `PronType`.

`ADV` tokens may have the following values of `PronType`:

* `Dem` (769; 42% of non-empty `PronType`): <em>then, there, here, that</em>
