...
There are 6441 `PROPN` lemmas (28%), 6588 `PROPN` types (23%) and 15390 `PROPN` tokens (7%).
...
The form / lemma ratio of `PROPN` is 1.022823 (the average of all parts of speech is 1.221985).
...
`PROPN` occurs with 3 features: <tt><a href="nl_alpino-feat-Number.html">Number</a></tt> (7103; 46% instances), <tt><a href="nl_alpino-feat-Gender.html">Gender</a></tt> (6691; 43% instances), <tt><a href="nl_alpino-feat-ExtPos.html">ExtPos</a></tt> (16; 0% instances)

`PROPN` occurs with 7 feature-value pairs: `ExtPos=ADV`, `ExtPos=PROPN`, `Gender=Com`, `Gender=Com,Neut`, `Gender=Neut`, `Number=Plur`, `Number=Sing`

`PROPN` occurs with 10 feature combinations.
The most frequent feature combination is `_` (8287 tokens).
Examples: <em>van, de, J., den, der, mr., dr., Jan, H., a.</em>


## Relations

`PROPN` nodes are attached to their parents using 22 different relations: <tt><a href="nl_alpino-dep-flat.html">flat</a></tt> (5089; 33% instances), <tt><a href="nl_alpino-dep-nmod.html">nmod</a></tt> (2805; 18% instances), <tt><a href="nl_alpino-dep-nsubj.html">nsubj</a></tt> (2311; 15% instances), <tt><a href="nl_alpino-dep-appos.html">appos</a></tt> (1615; 10% instances), <tt><a href="nl_alpino-dep-obl.html">obl</a></tt> (1435; 9% instances), <tt><a href="nl_alpino-dep-conj.html">conj</a></tt> (846; 5% instances), <tt><a href="nl_alpino-dep-obj.html">obj</a></tt> (310; 2% instances), <tt><a href="nl_alpino-dep-obl-arg.html">obl:arg</a></tt> (172; 1% instances), <tt><a href="nl_alpino-dep-nsubj-pass.html">nsubj:pass</a></tt> (166; 1% instances), <tt><a href="nl_alpino-dep-root.html">root</a></tt> (149; 1% instances), <tt><a href="nl_alpino-dep-parataxis.html">parataxis</a></tt> (129; 1% instances), <tt><a href="nl_alpino-dep-nmod-poss.html">nmod:poss</a></tt> (102; 1% instances), <tt><a href="nl_alpino-dep-obl-agent.html">obl:agent</a></tt> (96; 1% instances), <tt><a href="nl_alpino-dep-iobj.html">iobj</a></tt> (59; 0% instances), <tt><a href="nl_alpino-dep-advcl.html">advcl</a></tt> (45; 0% instances), <tt><a href="nl_alpino-dep-xcomp.html">xcomp</a></tt> (30; 0% instances), <tt><a href="nl_alpino-dep-acl.html">acl</a></tt> (11; 0% instances), <tt><a href="nl_alpino-dep-acl-relcl.html">acl:relcl</a></tt> (9; 0% instances), <tt><a href="nl_alpino-dep-orphan.html">orphan</a></tt> (8; 0% instances), <tt><a href="nl_alpino-dep-amod.html">amod</a></tt> (1; 0% instances), <tt><a href="nl_alpino-dep-ccomp.html">ccomp</a></tt> (1; 0% instances), <tt><a href="nl_alpino-dep-nsubj-outer.html">nsubj:outer</a></tt> (1; 0% instances)

Parents of `PROPN` nodes belong to 13 different parts of speech: <tt><a href="nl_alpino-pos-PROPN.html">PROPN</a></tt> (5959; 39% instances), <tt><a href="nl_alpino-pos-NOUN.html">NOUN</a></tt> (4283; 28% instances), <tt><a href="nl_alpino-pos-VERB.html">VERB</a></tt> (4192; 27% instances), <tt><a href="nl_alpino-pos-ADJ.html">ADJ</a></tt> (249; 2% instances), <tt><a href="nl_alpino-pos-NUM.html">NUM</a></tt> (206; 1% instances), <tt><a href="nl_alpino-pos-PRON.html">PRON</a></tt> (195; 1% instances),  (149; 1% instances), <tt><a href="nl_alpino-pos-ADV.html">ADV</a></tt> (54; 0% instances), <tt><a href="nl_alpino-pos-X.html">X</a></tt> (41; 0% instances), <tt><a href="nl_alpino-pos-DET.html">DET</a></tt> (23; 0% instances), <tt><a href="nl_alpino-pos-ADP.html">ADP</a></tt> (19; 0% instances), <tt><a href="nl_alpino-pos-SYM.html">SYM</a></tt> (15; 0% instances), <tt><a href="nl_alpino-pos-INTJ.html">INTJ</a></tt> (5; 0% instances)

7161 (47%) `PROPN` nodes are leaves.

4040 (26%) `PROPN` nodes have one child.

2129 (14%) `PROPN` nodes have two children.

2060 (13%) `PROPN` nodes have three or more children.

The highest child degree of a `PROPN` node is 16.

Children of `PROPN` nodes are attached using 23 different relations: <tt><a href="nl_alpino-dep-flat.html">flat</a></tt> (4944; 31% instances), <tt><a href="nl_alpino-dep-case.html">case</a></tt> (4255; 26% instances), <tt><a href="nl_alpino-dep-det.html">det</a></tt> (2075; 13% instances), <tt><a href="nl_alpino-dep-punct.html">punct</a></tt> (1425; 9% instances), <tt><a href="nl_alpino-dep-conj.html">conj</a></tt> (877; 5% instances), <tt><a href="nl_alpino-dep-nmod.html">nmod</a></tt> (576; 4% instances), <tt><a href="nl_alpino-dep-cc.html">cc</a></tt> (539; 3% instances), <tt><a href="nl_alpino-dep-amod.html">amod</a></tt> (346; 2% instances), <tt><a href="nl_alpino-dep-appos.html">appos</a></tt> (239; 1% instances), <tt><a href="nl_alpino-dep-acl-relcl.html">acl:relcl</a></tt> (202; 1% instances), <tt><a href="nl_alpino-dep-advmod.html">advmod</a></tt> (114; 1% instances), <tt><a href="nl_alpino-dep-nummod.html">nummod</a></tt> (95; 1% instances), <tt><a href="nl_alpino-dep-mark.html">mark</a></tt> (90; 1% instances), <tt><a href="nl_alpino-dep-parataxis.html">parataxis</a></tt> (90; 1% instances), <tt><a href="nl_alpino-dep-acl.html">acl</a></tt> (69; 0% instances), <tt><a href="nl_alpino-dep-cop.html">cop</a></tt> (46; 0% instances), <tt><a href="nl_alpino-dep-nsubj.html">nsubj</a></tt> (45; 0% instances), <tt><a href="nl_alpino-dep-orphan.html">orphan</a></tt> (19; 0% instances), <tt><a href="nl_alpino-dep-nmod-poss.html">nmod:poss</a></tt> (18; 0% instances), <tt><a href="nl_alpino-dep-cc-preconj.html">cc:preconj</a></tt> (14; 0% instances), <tt><a href="nl_alpino-dep-obl.html">obl</a></tt> (9; 0% instances), <tt><a href="nl_alpino-dep-aux.html">aux</a></tt> (5; 0% instances), <tt><a href="nl_alpino-dep-advcl.html">advcl</a></tt> (2; 0% instances)

Children of `PROPN` nodes belong to 16 different parts of speech: <tt><a href="nl_alpino-pos-PROPN.html">PROPN</a></tt> (5959; 37% instances), <tt><a href="nl_alpino-pos-ADP.html">ADP</a></tt> (4249; 26% instances), <tt><a href="nl_alpino-pos-DET.html">DET</a></tt> (2081; 13% instances), <tt><a href="nl_alpino-pos-PUNCT.html">PUNCT</a></tt> (1425; 9% instances), <tt><a href="nl_alpino-pos-CCONJ.html">CCONJ</a></tt> (549; 3% instances), <tt><a href="nl_alpino-pos-NOUN.html">NOUN</a></tt> (545; 3% instances), <tt><a href="nl_alpino-pos-ADJ.html">ADJ</a></tt> (338; 2% instances), <tt><a href="nl_alpino-pos-VERB.html">VERB</a></tt> (299; 2% instances), <tt><a href="nl_alpino-pos-NUM.html">NUM</a></tt> (187; 1% instances), <tt><a href="nl_alpino-pos-ADV.html">ADV</a></tt> (178; 1% instances), <tt><a href="nl_alpino-pos-SCONJ.html">SCONJ</a></tt> (87; 1% instances), <tt><a href="nl_alpino-pos-AUX.html">AUX</a></tt> (51; 0% instances), <tt><a href="nl_alpino-pos-X.html">X</a></tt> (51; 0% instances), <tt><a href="nl_alpino-pos-SYM.html">SYM</a></tt> (46; 0% instances), <tt><a href="nl_alpino-pos-PRON.html">PRON</a></tt> (45; 0% instances), <tt><a href="nl_alpino-pos-INTJ.html">INTJ</a></tt> (4; 0% instances)
