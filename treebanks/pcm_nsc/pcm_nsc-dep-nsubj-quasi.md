---
layout: base
title:  'Statistics of nsubj:quasi in UD_Naija-NSC'
udver: '2'
---

## Treebank Statistics: UD_Naija-NSC: Relations: `nsubj:quasi`

This relation is a language-specific subtype of <tt><a href="pcm_nsc-dep-nsubj.html">nsubj</a></tt>.
There are also 2 other language-specific subtypes of `nsubj`: <tt><a href="pcm_nsc-dep-nsubj-expl.html">nsubj:expl</a></tt>, <tt><a href="pcm_nsc-dep-nsubj-pass.html">nsubj:pass</a></tt>.

10 nodes (0%) are attached to their parents as `nsubj:quasi`.

10 instances of `nsubj:quasi` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.

The following 1 pairs of parts of speech are connected with `nsubj:quasi`: <tt><a href="pcm_nsc-pos-VERB.html">VERB</a></tt>-<tt><a href="pcm_nsc-pos-NOUN.html">NOUN</a></tt> (10; 100% instances).
