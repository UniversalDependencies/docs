...
6	said	say	VERB	VBN	Tense=Past|VerbForm=Part|Voice=Pass	0	root	0:root	Supersense=v.communication
7	that	that	SCONJ	IN	_	12	mark	12:mark	_
8	Stuart	Stuart	PROPN	NNP	Number=Sing	12	nsubj	12:nsubj	Supersense=n.PERSON
9	is	be	AUX	VBZ	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	12	cop	12:cop	Supersense=v.stative
10	a	a	DET	DT	Definite=Ind|PronType=Art	12	det	12:det	_
11	fantastic	fantastic	ADJ	JJ	Degree=Pos	12	amod	12:amod	_
12	person	person	NOUN	NN	Number=Sing	6	csubj:pass	6:csubj:pass	Supersense=n.PERSON
13	to	to	PART	TO	_	14	mark	14:mark	PRel[config]=subordinating|PRel[gov]=12:person|PRel[obj]=14:work|Supersense=p.Purpose
14	work	work	VERB	VB	VerbForm=Inf	12	acl	12:acl:to	MWELemma[weak]=work with|MWELen[weak]=2|Supersense=v.social
15	with	with	ADP	IN	_	14	obl	14:obl	PRel[config]=stranded|PRel[gov]=14:work|PRel[obj]=12:person|Promoted=Yes|SpaceAfter=No|Supersense[coding]=p.Ancillary|Supersense[scene]=p.SocialRel
16	,	,	PUNCT	,	_	21	punct	21:punct	_
17	because	because	ADP	IN	ExtPos=ADP	21	case	21:case	MWECat=P|MWELemma=because of|MWELen=2|PRel[config]=default|PRel[gov]=14:work|PRel[obj]=21:strategy|Supersense=p.Explanation
18	of	of	ADP	IN	_	17	fixed	17:fixed	_
19	his	his	PRON	PRP$	Case=Gen|Gender=Masc|Number=Sing|Person=3|Poss=Yes|PronType=Prs	21	nmod:poss	21:nmod:poss	PRel[config]=possessive|PRel[gov]=21:strategy|Supersense=p.Gestalt
20	solid	solid	ADJ	JJ	Degree=Pos	21	amod	21:amod	_
21	strategies	strategy	NOUN	NNS	Number=Plur	14	obl	14:obl:because_of	Supersense=n.COGNITION
22	and	and	CCONJ	CC	_	32	cc	32:cc	_
23	equally	equally	ADV	RB	_	32	advmod	32:advmod	_
24	as	as	ADP	IN	_	25	case	25:case	PRel[config]=default|PRel[gov]=23:equally|PRel[obj]=25:importantly|Supersense[coding]=p.Extent|Supersense[scene]=p.Manner
...
28	is	be	AUX	VBZ	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	32	cop	32:cop	Supersense=v.stative
...
32	person	person	NOUN	NN	Number=Sing	21	conj	14:obl:because_of|21:conj:and	Supersense=n.PERSON
...
36	communicator	communicator	NOUN	NN	Number=Sing	32	conj	32:conj:and	SpaceAfter=No|Supersense=n.PERSON
