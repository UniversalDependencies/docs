...
6	उठा	उठ	VERB	VM	Aspect=Perf|Gender=Masc|Number=Sing|VerbForm=Part|Voice=Act	7	acl:relcl	_	Vib=या|Tam=yA|ChunkId=VGF|ChunkType=head|Stype=declarative|Translit=uṭhā
...
14	थीं	था	VERB	VM	Gender=Fem|Mood=Ind|Number=Sing|Person=3|Polite=Form|Tense=Past|VerbForm=Fin|Voice=Act	0	root	_	Vib=था|Tam=WA|ChunkId=VGF2|ChunkType=head|Stype=declarative|Translit=thīṁ
