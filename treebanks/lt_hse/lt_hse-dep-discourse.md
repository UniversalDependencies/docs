---
layout: base
title:  'Statistics of discourse in UD_Lithuanian-HSE'
udver: '2'
---

## Treebank Statistics: UD_Lithuanian-HSE: Relations: `discourse`
...
The following 2 pairs of parts of speech are connected with `discourse`: <tt><a href="lt_hse-pos-VERB.html">VERB</a></tt>-<tt><a href="lt_hse-pos-PART.html">PART</a></tt> (2; 67% instances), <tt><a href="lt_hse-pos-NOUN.html">NOUN</a></tt>-<tt><a href="lt_hse-pos-INTJ.html">INTJ</a></tt> (1; 33% instances).
...
8	krentame	kristi	VERB	VBC	Mood=Ind|Number=Plur|Person=1|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	2	parataxis	_	En=drop|SpaceAfter=No
...
14	buvo	būti	AUX	VBC	Mood=Ind|Number=Plur|Person=3|Polarity=Pos|Tense=Past|VerbForm=Fin|Voice=Act	13	cop	_	En=be
...
25	įrašė	įrašyti	VERB	VBC	Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Past|VerbForm=Fin|Voice=Act	16	acl:relcl	_	En=write
