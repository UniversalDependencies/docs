...
There are 9 `SCONJ` lemmas (0%), 12 `SCONJ` types (0%) and 943 `SCONJ` tokens (2%).
Out of 15 observed tags, the rank of `SCONJ` is: 14 in number of lemmas, 15 in number of types and 12 in number of tokens.

The 10 most frequent `SCONJ` lemmas: <em>que, quand, si, comme, puisque, parce, après, avant, lorsque</em>

The 10 most frequent `SCONJ` types:  <em>que, qu', quand, si, comme, puisque, parce, puisqu', s', après</em>
...
`SCONJ` occurs with 2 features: <tt><a href="fr_parisstories-feat-ExtPos.html">ExtPos</a></tt> (46; 5% instances), <tt><a href="fr_parisstories-feat-Polarity.html">Polarity</a></tt> (3; 0% instances)

`SCONJ` occurs with 3 feature-value pairs: `ExtPos=ADV`, `ExtPos=SCONJ`, `Polarity=Neg`

`SCONJ` occurs with 4 feature combinations.
The most frequent feature combination is `_` (894 tokens).
Examples: <em>que, qu', quand, si, comme, puisque, puisqu', s', parce, après</em>
