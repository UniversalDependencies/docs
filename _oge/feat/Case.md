...
`Case` is an inflectional feature of [nouns](_oge/pos/NOUN), [proper nouns](_oge/pos/PROPN), [pronouns](_oge/pos/PRON), [adjectives](_oge/pos/ADJ), [numerals](_oge/pos/NUM) and [verbs](_oge/pos/VERB) that mark agreement with nouns or verbs.

`Case` can also be a lexical feature of [adpositions](_oge/pos/ADP) and describe the case meaning that the adposition contributes to the nominal in which it appears. 
...
Prototypical meaning of genitive is that the noun phrase somehow belongs to its governor. In Old Georgian the genitive case is generally used to mark the dependent of a nominal and, it was also used as a base for secondary cases (so-called
