...
There are also 2 other language-specific subtypes of `csubj`: <tt><a href="xcl_caval-dep-csubj-caus.html">csubj:caus</a></tt>, <tt><a href="xcl_caval-dep-csubj-pass.html">csubj:pass</a></tt>.
...
3	նոսա	նա	PRON	_	Case=Acc|Deixis=Remt|Number=Plur|PronType=Dem	1	obl:arg	_	Translit=nosa|LTranslit=na|LId=նա-1|Gloss=he/she/it/that
...
9	ձեզ	դուք	PRON	_	Case=Acc|Number=Plur|Person=2|PronType=Prs	6	obl:arg	_	Translit=jez|LTranslit=dowkʻ|Gloss=you_(pl)
10	զինչ	զինչ	PRON	_	Animacy=Inan|Case=Nom|Number=Sing|PronType=Int	12	nsubj	_	Translit=zinčʻ|LTranslit=zinčʻ|LId=զինչ-1|Gloss=what
...
14	ի	ի	ADP	_	_	15	case	_	Translit=i|LTranslit=i|LId=ի-2|Gloss=in
...
22	եթե	եթե	SCONJ	_	_	24	cc	_	Translit=etʻe|LTranslit=tʻe|LId=եթե-1|Gloss=whether
...
30	թե	թե	CCONJ	_	_	31	cc	_	Translit=tʻe|LTranslit=tʻe|LId=թե-2|Gloss=or
...
8	ի	ի	ADP	_	_	9	case	_	Translit=i|LTranslit=i|LId=ի-1|Gloss=to
...
18	նմա	նա	PRON	_	Case=Loc|Deixis=Remt|Number=Sing|PronType=Dem	16	obl	_	Translit=nma|LTranslit=na|LId=նա-1|Gloss=he/she/it/that
19	եւ	եւ	CCONJ	_	_	16	cc	_	Translit=ew|LTranslit=ew|Gloss=and
20	աշակերտք	աշակերտ	NOUN	_	Case=Nom|Number=Plur	16	nsubj	_	Translit=ašakertkʻ|LTranslit=ašakert|Gloss=disciple
21	նորա	նա	PRON	_	Case=Gen|Deixis=Remt|Number=Sing|PronType=Dem	20	nmod	_	SpaceAfter=No|Translit=nora|LTranslit=na|LId=նա-1|Gloss=he/she/it/that
...
3	յ	ի	ADP	_	_	4	case	_	SpaceAfter=No|Translit=y|LTranslit=i|LId=ի-2|Gloss=in
...
18	ոչ	ոչ	PART	_	Polarity=Neg	19	advmod	_	Translit=očʻ|LTranslit=očʻ|LId=ոչ-1|Gloss=not
...
26	ի	ի	ADP	_	_	27	case	_	Translit=i|LTranslit=i|LId=ի-2|Gloss=in
