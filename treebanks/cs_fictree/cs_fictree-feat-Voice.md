...
27106 tokens (16%) have a non-empty value of `Voice`.
9395 types (35%) occur at least once with a non-empty value of `Voice`.
3708 lemmas (27%) occur at least once with a non-empty value of `Voice`.
The feature is used with 3 part-of-speech tags: <tt><a href="cs_fictree-pos-VERB.html">VERB</a></tt> (21337; 13% instances), <tt><a href="cs_fictree-pos-AUX.html">AUX</a></tt> (5187; 3% instances), <tt><a href="cs_fictree-pos-ADJ.html">ADJ</a></tt> (582; 0% instances).

### `VERB`

21337 <tt><a href="cs_fictree-pos-VERB.html">VERB</a></tt> tokens (86% of all `VERB` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `VERB` and `Voice` co-occurred: <tt><a href="cs_fictree-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (18783; 88%), <tt><a href="cs_fictree-feat-Number.html">Number</a></tt><tt>=Sing</tt> (17949; 84%), <tt><a href="cs_fictree-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (14515; 68%), <tt><a href="cs_fictree-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (14515; 68%), <tt><a href="cs_fictree-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (14466; 68%), <tt><a href="cs_fictree-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (14463; 68%), <tt><a href="cs_fictree-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (12754; 60%).

`VERB` tokens may have the following values of `Voice`:

* `Act` (21337; 100% of non-empty `Voice`): <em>je, řekl, má, měl, mám, bylo, měla, řekla, mohl, chtěl</em>
...
5187 <tt><a href="cs_fictree-pos-AUX.html">AUX</a></tt> tokens (79% of all `AUX` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `AUX` and `Voice` co-occurred: <tt><a href="cs_fictree-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (4920; 95%), <tt><a href="cs_fictree-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4450; 86%), <tt><a href="cs_fictree-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (4176; 81%), <tt><a href="cs_fictree-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (4176; 81%), <tt><a href="cs_fictree-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (4176; 81%), <tt><a href="cs_fictree-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (3870; 75%), <tt><a href="cs_fictree-feat-Person.html">Person</a></tt><tt>=1</tt> (2684; 52%).

`AUX` tokens may have the following values of `Voice`:

* `Act` (5187; 100% of non-empty `Voice`): <em>jsem, je, byl, jsme, byla, bylo, jsi, bude, jsou, jste</em>
...
<tt>VERB --[<tt><a href="cs_fictree-dep-conj.html">conj</a></tt>]--> VERB</tt> (4880; 97%),
<tt>VERB --[<tt><a href="cs_fictree-dep-aux.html">aux</a></tt>]--> AUX</tt> (2650; 65%),
...
<tt>VERB --[<tt><a href="cs_fictree-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (74; 87%),
