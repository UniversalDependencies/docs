...
There are 266 `ADV` lemmas (4%), 268 `ADV` types (3%) and 2586 `ADV` tokens (4%).
...
The form / lemma ratio of `ADV` is 1.007519 (the average of all parts of speech is 1.399096).
