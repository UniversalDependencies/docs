---
layout: base
title:  'Statistics of name in UD_Japanese-KTC'
udver: '2'
---

## Treebank Statistics: UD_Japanese-KTC: Relations: `name`
...
The following 1 pairs of parts of speech are connected with `name`: <tt><a href="ja_ktc-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ja_ktc-pos-PROPN.html">PROPN</a></tt> (476; 100% instances).
