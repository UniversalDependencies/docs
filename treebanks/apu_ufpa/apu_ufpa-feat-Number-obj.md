...
54 tokens (8%) have a non-empty value of `Number[obj]`.
18 types (8%) occur at least once with a non-empty value of `Number[obj]`.
17 lemmas (9%) occur at least once with a non-empty value of `Number[obj]`.
...
49 <tt><a href="apu_ufpa-pos-VERB.html">VERB</a></tt> tokens (33% of all `VERB` tokens) have a non-empty value of `Number[obj]`.

The most frequent other feature values with which `VERB` and `Number[obj]` co-occurred: <tt><a href="apu_ufpa-feat-Person-obj.html">Person[obj]</a></tt><tt>=3</tt> (49; 100%), <tt><a href="apu_ufpa-feat-Gender-obj.html">Gender[obj]</a></tt><tt>=Masc</tt> (45; 92%).
...
`Number[obj]` seems to be **lexical feature** of `VERB`. 94% lemmas (15) occur only with one value of `Number[obj]`.

### `CCONJ`

5 <tt><a href="apu_ufpa-pos-CCONJ.html">CCONJ</a></tt> tokens (83% of all `CCONJ` tokens) have a non-empty value of `Number[obj]`.
