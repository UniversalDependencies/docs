---
layout: base
title:  'Statistics of cc in UD_Greek-Lesbian'
udver: '2'
---

## Treebank Statistics: UD_Greek-Lesbian: Relations: `cc`
...
1	Σ’κώθκι	σκώνου	VERB	_	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Pass	0	root	_	_
2	ανιφιρτός	ανιφιρτός	ADJ	_	Case=Nom|Gender=Masc|Number=Sing	1	advcl	_	_
3	τσι	τσι	CCONJ	_	_	5	cc	_	_
...
1	Τσι	τσι	CCONJ	_	_	3	cc	_	_
2	μια	ένας	DET	_	Case=Acc|Definite=Ind|Gender=Fem|Number=Sing|PronType=Art	3	det	_	_
3	μέρα	μέρα	NOUN	_	Case=Acc|Gender=Fem|Number=Sing	8	obl	_	_
4	τα	η	DET	_	Case=Nom|Definite=Def|Gender=Neut|Number=Plur|PronType=Art	5	det	_	_
5	μουρά	μουρό	NOUN	_	Case=Nom|Gender=Neut|Number=Plur	8	nsubj	_	_
6	τσ’	η	DET	_	Case=Gen|Definite=Def|Gender=Fem|Number=Sing|PronType=Art|Typo=Yes	7	det	_	CorrectForm=τς
7	ιγτουνιάσ’	γτουνιά	NOUN	_	Case=Gen|Gender=Fem|Number=Sing	5	nmod	_	CorrectForm=ιγτουνιάς|MGloss=euphonic-neighborhood|MSeg=ι-γτουνιάς
