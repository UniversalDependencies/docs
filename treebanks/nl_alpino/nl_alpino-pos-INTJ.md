...
There are 24 `INTJ` lemmas (0%), 24 `INTJ` types (0%) and 103 `INTJ` tokens (0%).
Out of 16 observed tags, the rank of `INTJ` is: 13 in number of lemmas, 15 in number of types and 16 in number of tokens.
...
* <em>Wel</em>
  ...
  * <tt><a href="nl_alpino-pos-NOUN.html">NOUN</a></tt> 1: <em>Dit was een van de stellingen in de rede van prof. dr. D. J. Kuenen die in Leiden de tentoonstelling <b>Wel</b> en Wee heeft geopend , die wordt gehouden in het Museum van oudheden ter gelegenheid van het universitaire lustrum .</em>

## Morphology

The form / lemma ratio of `INTJ` is 1.000000 (the average of all parts of speech is 1.220969).

The 1st highest number of forms (1) was observed with the lemma “ach”: <em>ach</em>.

The 2nd highest number of forms (1) was observed with the lemma “goedenmorgen”: <em>goedemorgen</em>.
...
Children of `INTJ` nodes are attached using 11 different relations: <tt><a href="nl_alpino-dep-punct.html">punct</a></tt> (80; 66% instances), <tt><a href="nl_alpino-dep-fixed.html">fixed</a></tt> (14; 12% instances), <tt><a href="nl_alpino-dep-flat.html">flat</a></tt> (11; 9% instances), <tt><a href="nl_alpino-dep-parataxis.html">parataxis</a></tt> (4; 3% instances), <tt><a href="nl_alpino-dep-case.html">case</a></tt> (3; 2% instances), <tt><a href="nl_alpino-dep-amod.html">amod</a></tt> (2; 2% instances), <tt><a href="nl_alpino-dep-cc.html">cc</a></tt> (2; 2% instances), <tt><a href="nl_alpino-dep-det.html">det</a></tt> (2; 2% instances), <tt><a href="nl_alpino-dep-conj.html">conj</a></tt> (1; 1% instances), <tt><a href="nl_alpino-dep-mark.html">mark</a></tt> (1; 1% instances), <tt><a href="nl_alpino-dep-nmod.html">nmod</a></tt> (1; 1% instances)
