---
layout: base
title:  'Statistics of aux in UD_Ottoman_Turkish-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Ottoman_Turkish-TueCL: Relations: `aux`

This relation is universal.
There are 1 language-specific subtypes of `aux`: <tt><a href="ota_tuecl-dep-aux-q.html">aux:q</a></tt>.

28 nodes (3%) are attached to their parents as `aux`.
...
The following 3 pairs of parts of speech are connected with `aux`: <tt><a href="ota_tuecl-pos-VERB.html">VERB</a></tt>-<tt><a href="ota_tuecl-pos-AUX.html">AUX</a></tt> (19; 68% instances), <tt><a href="ota_tuecl-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ota_tuecl-pos-AUX.html">AUX</a></tt> (6; 21% instances), <tt><a href="ota_tuecl-pos-ADJ.html">ADJ</a></tt>-<tt><a href="ota_tuecl-pos-AUX.html">AUX</a></tt> (3; 11% instances).
