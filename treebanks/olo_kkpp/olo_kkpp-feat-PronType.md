---
layout: base
title:  'Statistics of PronType in UD_Livvi-KKPP'
udver: '2'
---

## Treebank Statistics: UD_Livvi-KKPP: Features: `PronType`

This feature is universal.
It occurs with 4 different values: `Dem`, `Ind`, `Prs`, `Rel`.

71 tokens (4%) have a non-empty value of `PronType`.
39 types (5%) occur at least once with a non-empty value of `PronType`.
18 lemmas (3%) occur at least once with a non-empty value of `PronType`.
The feature is used with 1 part-of-speech tags: <tt><a href="olo_kkpp-pos-PRON.html">PRON</a></tt> (71; 4% instances).
...
* `Dem` (25; 35% of non-empty `PronType`): <em>tämän, se, tämä, net, Niilöin, Tädä, niidy, nämmis, sen, sil</em>
