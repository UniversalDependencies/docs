...
* <em>Los</em>
  * <tt><a href="pt_bosque-pos-PROPN.html">PROPN</a></tt> 8: <em>O sismo de segunda-feira em <b>Los</b> Angeles não poupou ninguém , nem mesmo as estrelas .</em>
...
The form / lemma ratio of `X` is 1.000000 (the average of all parts of speech is 1.414899).
...
`X` occurs with 2 features: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (31; 19% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (18; 11% instances)
...
65 (40%) `X` nodes have three or more children.
