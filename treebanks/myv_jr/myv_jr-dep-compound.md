...
218 nodes (1%) are attached to their parents as `compound`.

174 instances of `compound` (80%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.14678899082569.
