...
* `EMPTY` (13322): <em>no, també, ja, després, ahir, molt, avui, només, ara, així</em>
...
* `EMPTY` (29837): <em>passat, gran, primer, nou, primera, general, nova, catalana, espanyol, grans</em>
