...
513 nodes (0%) are attached to their parents as `compound`.

299 instances of `compound` (58%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.01949317738791.
