...
2	შეიძლება	შეძლება	VERB	V_Pass_Pres_Pv_S:3Sg	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Pres|VerbForm=Fin	0	root	_	LMSeg:შე·ძლებ[ა]/ძლ|SpaceAfter=No
...
7	ეარსება	არსებობა	VERB	V_MedAct_PluPerf_S:3Sg	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Pqp|VerbForm=Fin	2	csubj	_	LMSeg:არსებობ[ა]/არსებ|SpaceAfter=No
...
4	იყო	ყოფნა	AUX	V_Pass_Aor_S:3Sg	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	3	cop	_	LMSeg:ყოფნ[ა]/ყ[ავ]|SpaceAfter=No
...
8	ჰქონდა	ქონა	AUX	V_MedPass_Inv_Impf_S:3Sg_DO:3	Mood=Ind|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Tense=Imp|VerbForm=Fin|Voice=Inv	9	aux	_	LMSeg:ქონ[ა]/ქონ
...
8	შეწყდეს	შეწყდომა	VERB	V_Pass_Opt_Pv_S:3Sg	Mood=Sub|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	2	csubj	_	LMSeg:შე·წყდომ[ა]/წყდ|SpaceAfter=No
