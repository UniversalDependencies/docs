...
3867 types (15%) occur at least once with a non-empty value of `Tense`.
1281 lemmas (7%) occur at least once with a non-empty value of `Tense`.
The feature is used with 3 part-of-speech tags: <tt><a href="pt_bosque-pos-VERB.html">VERB</a></tt> (10107; 4% instances), <tt><a href="pt_bosque-pos-AUX.html">AUX</a></tt> (5003; 2% instances), <tt><a href="pt_bosque-pos-INTJ.html">INTJ</a></tt> (1; 0% instances).

### `VERB`

10107 <tt><a href="pt_bosque-pos-VERB.html">VERB</a></tt> tokens (52% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (10107; 100%), <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (10107; 100%), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt><tt>=3</tt> (9419; 93%), <tt><a href="pt_bosque-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9402; 93%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7956; 79%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (488; 5% of non-empty `Tense`): <em>terá, haverá, será, terão, quiser, ficará, houver, fará, for, permitirá</em>
* `Imp` (852; 8% of non-empty `Tense`): <em>tinha, havia, fazia, dizia, era, encontrava, estavam, parecia, tinham, conseguia</em>
* `Past` (3322; 33% of non-empty `Tense`): <em>disse, fez, afirmou, foi, teve, deu, ficou, chegou, conseguiu, aconteceu</em>
...
* `EMPTY` (9238): <em>fazer, ter, ver, dar, dizer, feito, falar, feita, saber, manter</em>
...
The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (5002; 100%), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt><tt>=3</tt> (4775; 95%), <tt><a href="pt_bosque-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (4701; 94%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3808; 76%).

`AUX` tokens may have the following values of `Tense`:

* `Fut` (484; 10% of non-empty `Tense`): <em>será, poderá, deverá, serão, terá, for, irá, estará, deverão, poderão</em>
* `Imp` (483; 10% of non-empty `Tense`): <em>era, estava, tinha, eram, estavam, fosse, havia, tinham, haviam, ia</em>
* `Past` (854; 17% of non-empty `Tense`): <em>foi, foram, esteve, acabou, fui, voltou, começou, chegou, passou, teve</em>
* `Pqp` (15; 0% of non-empty `Tense`): <em>fora, acabara, foram, começara, tiveram</em>
* `Pres` (3167; 63% of non-empty `Tense`): <em>é, são, está, vai, pode, estão, tem, deve, podem, seja</em>
* `EMPTY` (1306): <em>ser, ter, sido, foram, seria, estar, sendo, poderia, serem, tendo</em>
...
1 <tt><a href="pt_bosque-pos-INTJ.html">INTJ</a></tt> tokens (3% of all `INTJ` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `INTJ` and `Tense` co-occurred: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1; 100%).
...
<tt>VERB --[<tt><a href="pt_bosque-dep-conj.html">conj</a></tt>]--> VERB</tt> (603; 60%),
