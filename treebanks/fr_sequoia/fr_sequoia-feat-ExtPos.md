...
The most frequent other feature values with which `PRON` and `ExtPos` co-occurred: <tt><a href="fr_sequoia-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (35; 100%), <tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt> (34; 97%), <tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (27; 77%), <tt><a href="fr_sequoia-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (25; 71%), <tt><a href="fr_sequoia-feat-Emph.html">Emph</a></tt><tt>=EMPTY</tt> (25; 71%), <tt><a href="fr_sequoia-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (23; 66%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (21; 60%).

`PRON` tokens may have the following values of `ExtPos`:

* `ADP` (11; 31% of non-empty `ExtPos`): <em>il, Y</em>
* `ADV` (12; 34% of non-empty `ExtPos`): <em>c', il</em>
* `CCONJ` (11; 31% of non-empty `ExtPos`): <em>y</em>
* `PRON` (1; 3% of non-empty `ExtPos`): <em>qui</em>

<table>
  <tr><th>Paradigm <i>lui</i></th><th><tt>ADP</tt></th><th><tt>ADV</tt></th></tr>
  <tr><td><tt><tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>il</em></td><td><em>il</em></td></tr>
  <tr><td><tt></tt></td><td><em>il</em></td><td></td></tr>
</table>

### `SCONJ`

14 <tt><a href="fr_sequoia-pos-SCONJ.html">SCONJ</a></tt> tokens (2% of all `SCONJ` tokens) have a non-empty value of `ExtPos`.

`SCONJ` tokens may have the following values of `ExtPos`:

* `ADV` (2; 14% of non-empty `ExtPos`): <em>quand, si</em>
* `SCONJ` (12; 86% of non-empty `ExtPos`): <em>parce</em>

### `DET`

8 <tt><a href="fr_sequoia-pos-DET.html">DET</a></tt> tokens (0% of all `DET` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `DET` and `ExtPos` co-occurred: <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8; 100%), <tt><a href="fr_sequoia-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (8; 100%), <tt><a href="fr_sequoia-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (6; 75%), <tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (6; 75%).

`DET` tokens may have the following values of `ExtPos`:

* `ADV` (7; 88% of non-empty `ExtPos`): <em>un, une, le</em>
* `PRON` (1; 13% of non-empty `ExtPos`): <em>le</em>
...
1 <tt><a href="fr_sequoia-pos-INTJ.html">INTJ</a></tt> tokens (20% of all `INTJ` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `INTJ` and `ExtPos` co-occurred: <tt><a href="fr_sequoia-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (1; 100%).
