...
There are 43 `NUM` lemmas (2%), 46 `NUM` types (1%) and 239 `NUM` tokens (1%).
...
* <em>deux</em>
  * <tt><a href="fr_parisstories-pos-NUM.html">NUM</a></tt> 57: <em>et euh , de le coup , bah , j' ai réussi à faire les <b>deux</b> .</em>
...
`NUM` occurs with 2 features: <tt><a href="fr_parisstories-feat-Number.html">Number</a></tt> (184; 77% instances), <tt><a href="fr_parisstories-feat-Gender.html">Gender</a></tt> (6; 3% instances)
