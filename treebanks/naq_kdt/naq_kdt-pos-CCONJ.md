---
layout: base
title:  'Statistics of CCONJ in UD_Khoekhoe-KDT'
udver: '2'
---

## Treebank Statistics: UD_Khoekhoe-KDT: POS Tags: `CCONJ`

There are 6 `CCONJ` lemmas (0%), 5 `CCONJ` types (0%) and 652 `CCONJ` tokens (2%).
Out of 16 observed tags, the rank of `CCONJ` is: 14 in number of lemmas, 15 in number of types and 12 in number of tokens.

The 10 most frequent `CCONJ` lemmas: <em>tsî, xawe, of, _, maar, en</em>
...
* <em>xawe</em>
  * <tt><a href="naq_kdt-pos-CCONJ.html">CCONJ</a></tt> 76: <em>ǀÛba te re <b>xawe</b> ǁnâi tita ge ǃgāsabahe tama hâ .</em>
  * <tt><a href="naq_kdt-pos-ADV.html">ADV</a></tt> 7: <em>ǂÂi-oa tsâ re xū-i hoa-e , ǀgui xū-i ga <b>xawe</b> .</em>
  * <tt><a href="naq_kdt-pos-SCONJ.html">SCONJ</a></tt> 3: <em>ai [ hui ] a ǃkhoe ǁkhā ta <b>xawe</b> ta ge nî ǀkhī</em>
* <em>maar</em>
  * <tt><a href="naq_kdt-pos-CCONJ.html">CCONJ</a></tt> 2: <em><b>maar</b> tita tsîna ǂhau hâ s ǀguisa hî hâ</em>
  * <tt><a href="naq_kdt-pos-ADV.html">ADV</a></tt> 1: <em>ǁnāpa i ge ra ǂâibasen o ts ge <b>maar</b> nî ǀawore kai of nî dromgu ǃnâ nî xūna ge of ǁnā ǀgauba nî ǀkhī-ū</em>
...
The 3rd highest number of forms (1) was observed with the lemma “maar”: <em>maar</em>.

`CCONJ` occurs with 1 features: <tt><a href="naq_kdt-feat-Foreign.html">Foreign</a></tt> (1; 0% instances)

`CCONJ` occurs with 1 feature-value pairs: `Foreign=Yes`

`CCONJ` occurs with 2 feature combinations.
The most frequent feature combination is `_` (651 tokens).
Examples: <em>tsî, xawe, of, maar</em>
...
Children of `CCONJ` nodes are attached using 2 different relations: <tt><a href="naq_kdt-dep-punct.html">punct</a></tt> (2; 67% instances), <tt><a href="naq_kdt-dep-discourse.html">discourse</a></tt> (1; 33% instances)

Children of `CCONJ` nodes belong to 2 different parts of speech: <tt><a href="naq_kdt-pos-PUNCT.html">PUNCT</a></tt> (2; 67% instances), <tt><a href="naq_kdt-pos-INTJ.html">INTJ</a></tt> (1; 33% instances)
