---
layout: base
title:  'Statistics of root in UD_Bhojpuri-BHTB'
udver: '2'
---

## Treebank Statistics: UD_Bhojpuri-BHTB: Relations: `root`
...
1	लोकरंजन	लोकरंजन	NOUN	N_NN	Case=Nom|Gender=Masc|Number=Sing|Person=3	4	compound	_	Translit=lokaraṁjana|LTranslit=lokaraṁjana
2	आ	आ	CCONJ	CC_CCD	_	3	cc	_	Translit=ā|LTranslit=ā
3	सांस्कृतिक	सांस्कृतिक	ADJ	JJ	Case=Nom	1	conj	_	Translit=sāṁskr̥tika|LTranslit=sāṁskr̥tika
4	गीत	गीत	NOUN	N_NN	Case=Nom|Gender=Masc|Number=Sing|Person=3	0	root	_	Translit=gīta|LTranslit=gīta
5	-	-	PUNCT	RD_SYM	_	4	punct	_	Translit=-|LTranslit=-
...
1	ओकरा	ओकरा	PRON	PR_PRP	Aspect=Perf|Number=Plur|VerbForm=Part	8	nmod	_	Translit=okarā|LTranslit=okarā
2	में	में	ADP	PSP	AdpType=Post	1	mark	_	Translit=meṁ|LTranslit=meṁ
3	लागल	लग	VERB	V_VM	_	4	amod	_	Translit=lāgala|LTranslit=laga
4	लोग	लोग	NOUN	N_NN	Case=Nom|Gender=Masc|Number=Plur|Person=3	8	nsubj	_	Translit=loga|LTranslit=loga
5	के	का	ADP	PSP	AdpType=Post|Case=Nom|Gender=Masc|Number=Sing|Person=3|Polite=Form	4	case	_	Translit=ke|LTranslit=kā
6	उत्साह	उत्साह	NOUN	N_NN	Case=Nom|Gender=Masc|Number=Sing|Person=3	8	nmod	_	Translit=utsāha|LTranslit=utsāha
7	बढ़ावल	बढ़ावल	VERB	V_VM	Case=Nom|Gender=Masc|Number=Sing|Person=3	8	compound	_	Translit=baṛhāvala|LTranslit=baṛhāvala
8	जाव	जा	AUX	V_VAUX	Case=Nom|Number=Sing|Person=3	0	root	_	Translit=jāva|LTranslit=jā
