...
The form / lemma ratio of `SCONJ` is 1.000000 (the average of all parts of speech is 1.287914).
...
`SCONJ` occurs with 1 features: <tt><a href="es_gsd-feat-Foreign.html">Foreign</a></tt> (2; 0% instances)

`SCONJ` occurs with 1 feature-value pairs: `Foreign=Yes`

`SCONJ` occurs with 2 feature combinations.
The most frequent feature combination is `_` (8177 tokens).
