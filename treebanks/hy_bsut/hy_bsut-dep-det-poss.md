---
layout: base
title:  'Statistics of det:poss in UD_Armenian-BSUT'
udver: '2'
---

## Treebank Statistics: UD_Armenian-BSUT: Relations: `det:poss`

This relation is a language-specific subtype of <tt><a href="hy_bsut-dep-det.html">det</a></tt>.

436 nodes (1%) are attached to their parents as `det:poss`.

435 instances of `det:poss` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.53669724770642.

The following 6 pairs of parts of speech are connected with `det:poss`: <tt><a href="hy_bsut-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (426; 98% instances), <tt><a href="hy_bsut-pos-PRON.html">PRON</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (5; 1% instances), <tt><a href="hy_bsut-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hy_bsut-pos-PRON.html">PRON</a></tt> (2; 0% instances), <tt><a href="hy_bsut-pos-NUM.html">NUM</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="hy_bsut-pos-SYM.html">SYM</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="hy_bsut-pos-VERB.html">VERB</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances).
...
1	Մեր	մեր	DET	_	Number=Plur|Person=1|Poss=Yes|PronType=Prs	3	det:poss	_	Translit=Mer|LTranslit=mer
...
8	Այնինչը	այնինչ	PRON	_	Case=Nom|Definite=Def|Deixis=Remt|Number=Sing|PronType=Ind	5	compound	_	Translit=Ayninčë|LTranslit=ayninč|SpaceAfter=No
...
13	մեր	մեր	DET	_	Number=Plur|Person=1|Poss=Yes|PronType=Prs	14	det:poss	_	Translit=mer|LTranslit=mer
...
2	ինքն	ինքը	PRON	_	Case=Nom|ExtPos=DET|Number=Sing|Person=3|PronType=Emp|Reflex=Yes	4	det:poss	_	Translit=ink’n|LTranslit=ink’ë
3	իր	իր	DET	_	Number=Sing|Person=3|Poss=Yes|PronType=Emp|Reflex=Yes	2	fixed	_	Translit=ir|LTranslit=ir
4	ներսում	ներս	NOUN	_	Animacy=Nhum|Case=Loc|Definite=Ind|Number=Sing	7	obl	_	Translit=nersowm|LTranslit=ners
