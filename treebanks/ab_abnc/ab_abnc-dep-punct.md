---
layout: base
title:  'Statistics of punct in UD_Abkhaz-AbNC'
udver: '2'
---

## Treebank Statistics: UD_Abkhaz-AbNC: Relations: `punct`

This relation is universal.

1947 nodes (31%) are attached to their parents as `punct`.

1064 instances of `punct` (55%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.26142783769902.

The following 9 pairs of parts of speech are connected with `punct`: <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (1703; 87% instances), <tt><a href="ab_abnc-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (111; 6% instances), <tt><a href="ab_abnc-pos-ADV.html">ADV</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (65; 3% instances), <tt><a href="ab_abnc-pos-PRON.html">PRON</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (27; 1% instances), <tt><a href="ab_abnc-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (16; 1% instances), <tt><a href="ab_abnc-pos-AUX.html">AUX</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (15; 1% instances), <tt><a href="ab_abnc-pos-INTJ.html">INTJ</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (6; 0% instances), <tt><a href="ab_abnc-pos-NUM.html">NUM</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (2; 0% instances), <tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt>-<tt><a href="ab_abnc-pos-PUNCT.html">PUNCT</a></tt> (2; 0% instances).
...
2	Измааноу	а́-маана	VERB	Noun_NH_Sg_Pred_NonFin_Pres_S:3_Rel_Poss:Rel	Animacy=Nhum|Dyn=No|Number=Sing|Person[psor]=Rel|Person[subj]=3|Tense=Pres|VerbForm=NonFin	3	ccomp:obj	_	LMSeg:а́-маана
3	умбои	а-бара́	VERB	V_Dyn_Tr_NonFin_Pres_Neg_Q_S:2SgM_DO:3_DO:Ad	Dyn=Yes|Gender[subj]=Masc|Mood=Int|Number[subj]=Sing|Person[obj]=3|Person[subj]=2|Polarity=Neg|Subcat=Tran|Tense=Pres|VerbForm=NonFin	0	root	_	LMSeg:а-ба-ра́
4	,	,	PUNCT	Punct_Comma	_	5	punct	_	LMSeg:,
5	сыхаара	а́-хаара	NOUN	Noun_NH_Sg_Poss:1Sg	Animacy=Nhum|Number=Sing|Number[psor]=Sing|Person[psor]=1	3	vocative	_	LMSeg:а́-хаара
6	Абгахәыҷы	а-бгахәыҷы́	NOUN	Noun_NH_Sg_Det	Animacy=Nhum|Definite=Def|Number=Sing	5	appos	_	LMSeg:а-бгахәыҷы́
7	!	!	PUNCT	Punct_ExclPoint	_	3	punct	_	LMSeg:!
