...
3072 <tt><a href="en_lines-pos-PROPN.html">PROPN</a></tt> tokens (100% of all `PROPN` tokens) have a non-empty value of `Number`.

`PROPN` tokens may have the following values of `Number`:

* `Plur` (109; 4% of non-empty `Number`): <em>Dursleys, Hogwarts, Weasleys, Mets, States, Beatles, Bayleys, Cloughs, Pettigrews, Masons</em>
* `Sing` (2963; 96% of non-empty `Number`): <em>Harry, Quinn, Stillman, XML, Access, Auster, Bray, SQL, Ron, Mweta</em>
* `EMPTY` (8): <em>J, Bassam, Liverpool, Smith, den, des, von</em>
...
`Number` seems to be **lexical feature** of `PROPN`. 98% lemmas (740) occur only with one value of `Number`.
...
<table>
  ...
  <tr><td><tt><tt><a href="en_lines-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="en_lines-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td><em>was</em></td><td></td></tr>
  <tr><td><tt><tt><a href="en_lines-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="en_lines-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>am, 'm</em></td><td></td></tr>
  <tr><td><tt><tt><a href="en_lines-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="en_lines-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td><em>was</em></td><td></td></tr>
  <tr><td><tt><tt><a href="en_lines-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="en_lines-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>is, 's</em></td><td></td></tr>
  <tr><td><tt><tt><a href="en_lines-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td></td><td><em>were</em></td></tr>
</table>
...
13 <tt><a href="en_lines-pos-NUM.html">NUM</a></tt> tokens (2% of all `NUM` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NUM` and `Number` co-occurred: <tt><a href="en_lines-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (9; 69%).

`NUM` tokens may have the following values of `Number`:

* `Plur` (3; 23% of non-empty `Number`): <em>fifteen, forty-one, two</em>
* `Sing` (10; 77% of non-empty `Number`): <em>one</em>
* `EMPTY` (678): <em>one, two, three, 2002, five, six, ten, four, 2000, 2</em>
