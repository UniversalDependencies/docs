---
layout: base
title:  'Statistics of ADV in UD_Old_Turkish-Clausal'
udver: '2'
---

## Treebank Statistics: UD_Old_Turkish-Clausal: POS Tags: `ADV`

There are 1 `ADV` lemmas (8%), 1 `ADV` types (1%) and 1 `ADV` tokens (1%).
Out of 13 observed tags, the rank of `ADV` is: 3 in number of lemmas, 9 in number of types and 10 in number of tokens.

The 10 most frequent `ADV` lemmas: <em>_</em>

The 10 most frequent `ADV` types:  <em>𐰖𐰣𐰀</em>
...
The form / lemma ratio of `ADV` is 1.000000 (the average of all parts of speech is 5.923077).

The 1st highest number of forms (1) was observed with the lemma “_”: <em>𐰖𐰣𐰀</em>.
...
`ADV` nodes are attached to their parents using 1 different relations: <tt><a href="otk_clausal-dep-advmod.html">advmod</a></tt> (1; 100% instances)

Parents of `ADV` nodes belong to 1 different parts of speech: <tt><a href="otk_clausal-pos-VERB.html">VERB</a></tt> (1; 100% instances)

1 (100%) `ADV` nodes are leaves.
