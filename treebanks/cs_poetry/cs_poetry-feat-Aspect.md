---
layout: base
title:  'Statistics of Aspect in UD_Czech-Poetry'
udver: '2'
---

## Treebank Statistics: UD_Czech-Poetry: Features: `Aspect`
...
* `Imp` (486; 65% of non-empty `Aspect`): <em>jdou, letí, měl, chce, jde, zdá, chcem, chtěl, hledá, mám</em>
* `Perf` (257; 35% of non-empty `Aspect`): <em>poznali, stojí, dáš, nech, padne, stát, Rozhučela, dal, dej, dejte</em>

`Aspect` seems to be **lexical feature** of `VERB`. 100% lemmas (450) occur only with one value of `Aspect`.
...
* `Imp` (1; 100% of non-empty `Aspect`): <em>roztávání</em>
* `EMPTY` (1465): <em>duše, žití, den, oči, svět, boha, duši, srdce, bože, bůh</em>
