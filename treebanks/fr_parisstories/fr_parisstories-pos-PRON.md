...
There are 44 `PRON` lemmas (2%), 71 `PRON` types (2%) and 6436 `PRON` tokens (15%).
...
The form / lemma ratio of `PRON` is 1.613636 (the average of all parts of speech is 1.332572).
