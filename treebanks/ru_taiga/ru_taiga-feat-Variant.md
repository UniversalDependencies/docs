...
2362 <tt><a href="ru_taiga-pos-ADJ.html">ADJ</a></tt> tokens (14% of all `ADJ` tokens) have a non-empty value of `Variant`.

The most frequent other feature values with which `ADJ` and `Variant` co-occurred: <tt><a href="ru_taiga-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (2362; 100%), <tt><a href="ru_taiga-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (2351; 100%), <tt><a href="ru_taiga-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2108; 89%), <tt><a href="ru_taiga-feat-Gender.html">Gender</a></tt><tt>=Neut</tt> (1571; 67%).

`ADJ` tokens may have the following values of `Variant`:

* `Short` (2362; 100% of non-empty `Variant`): <em>нужно, хорошо, дорого, вкусно, удобно, чисто, интересно, нужен, должен, равно</em>

`Variant` seems to be **lexical feature** of `ADJ`. 100% lemmas (442) occur only with one value of `Variant`.
...
* `Short` (9; 100% of non-empty `Variant`): <em>какова, такова, Каков, о́но, таков</em>

### `PRON`

1 <tt><a href="ru_taiga-pos-PRON.html">PRON</a></tt> tokens (0% of all `PRON` tokens) have a non-empty value of `Variant`.

The most frequent other feature values with which `PRON` and `Variant` co-occurred: <tt><a href="ru_taiga-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="ru_taiga-feat-Case.html">Case</a></tt><tt>=Dat</tt> (1; 100%), <tt><a href="ru_taiga-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="ru_taiga-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1; 100%), <tt><a href="ru_taiga-feat-Person.html">Person</a></tt><tt>=2</tt> (1; 100%), <tt><a href="ru_taiga-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1; 100%).

`PRON` tokens may have the following values of `Variant`:

* `Short` (1; 100% of non-empty `Variant`): <em>те</em>

## Relations with Agreement in `Variant`

The 10 most frequent relations where parent and child node agree in `Variant`:
<tt>ADJ --[<tt><a href="ru_taiga-dep-conj.html">conj</a></tt>]--> ADJ</tt> (250; 80%),
<tt>ADJ --[<tt><a href="ru_taiga-dep-advcl.html">advcl</a></tt>]--> ADJ</tt> (5; 71%),
<tt>ADJ --[<tt><a href="ru_taiga-dep-advmod.html">advmod</a></tt>]--> ADJ</tt> (1; 100%),
<tt>VERB --[<tt><a href="ru_taiga-dep-obl.html">obl</a></tt>]--> VERB</tt> (1; 100%).
