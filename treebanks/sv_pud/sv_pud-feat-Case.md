...
3920 <tt><a href="sv_pud-pos-NOUN.html">NOUN</a></tt> tokens (97% of all `NOUN` tokens) have a non-empty value of `Case`.
...
* `Nom` (3797; 97% of non-empty `Case`): <em>år, havet, personer, fall, miljoner, grund, oktober, världen, del, delen</em>
* `EMPTY` (115): <em>%, f.Kr., md, University, morse, Association, Council, Ground, nr, AIDS</em>
...
1201 <tt><a href="sv_pud-pos-PROPN.html">PROPN</a></tt> tokens (99% of all `PROPN` tokens) have a non-empty value of `Case`.
...
* `Nom` (1099; 92% of non-empty `Case`): <em>Kina, Storbritannien, Trump, USA, Frankrike, Hong, Italien, Medelhavet, Albanien, Donald</em>
* `EMPTY` (14): <em>B.C., Mps, North, Punta, Carolina, RHS, Rasa, Victorias, de, del</em>
...
`Case` seems to be **lexical feature** of `PROPN`. 95% lemmas (816) occur only with one value of `Case`.

### `PRON`

430 <tt><a href="sv_pud-pos-PRON.html">PRON</a></tt> tokens (33% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="sv_pud-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (430; 100%), <tt><a href="sv_pud-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (424; 99%), <tt><a href="sv_pud-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (347; 81%), <tt><a href="sv_pud-feat-Gender.html">Gender</a></tt><tt>=Com</tt> (281; 65%), <tt><a href="sv_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (237; 55%).
...
<tt>PROPN --[<tt><a href="sv_pud-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (102; 93%),
