---
layout: base
title:  'Statistics of Evident in UD_Turkish_English-BUTR'
udver: '2'
---

## Treebank Statistics: UD_Turkish_English-BUTR: Features: `Evident`

This feature is universal but the values `Fh` are language-specific.
It occurs with 2 different values: `Fh`, `Nfh`.

5 tokens (1%) have a non-empty value of `Evident`.
5 types (2%) occur at least once with a non-empty value of `Evident`.
5 lemmas (2%) occur at least once with a non-empty value of `Evident`.
The feature is used with 1 part-of-speech tags: <tt><a href="qti_butr-pos-VERB.html">VERB</a></tt> (5; 1% instances).
