...
20665 tokens (8%) have a non-empty value of `Mood`.
1993 types (10%) occur at least once with a non-empty value of `Mood`.
1029 lemmas (7%) occur at least once with a non-empty value of `Mood`.
The feature is used with 2 part-of-speech tags: <tt><a href="en_ewt-pos-VERB.html">VERB</a></tt> (10990; 4% instances), <tt><a href="en_ewt-pos-AUX.html">AUX</a></tt> (9675; 4% instances).

### `VERB`

10990 <tt><a href="en_ewt-pos-VERB.html">VERB</a></tt> tokens (39% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="en_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (10989; 100%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7187; 65%), <tt><a href="en_ewt-feat-Person.html">Person</a></tt><tt>=3</tt> (5777; 53%).

`VERB` tokens may have the following values of `Mood`:

* `Imp` (1438; 13% of non-empty `Mood`): <em>let, go, see, take, try, get, make, give, call, put</em>
* `Ind` (9519; 87% of non-empty `Mood`): <em>have, had, said, has, is, want, need, are, know, think</em>
* `Sub` (33; 0% of non-empty `Mood`): <em>go, get, have, take, build, buy, call, compare, comply, consume</em>
* `EMPTY` (17033): <em>have, get, know, do, go, going, make, see, take, like</em>
...
9675 <tt><a href="en_ewt-pos-AUX.html">AUX</a></tt> tokens (61% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="en_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9674; 100%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7388; 76%), <tt><a href="en_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (7211; 75%), <tt><a href="en_ewt-feat-Person.html">Person</a></tt><tt>=3</tt> (7199; 74%).

`AUX` tokens may have the following values of `Mood`:

* `Imp` (149; 2% of non-empty `Mood`): <em>do, be, get</em>
* `Ind` (9515; 98% of non-empty `Mood`): <em>is, was, are, have, do, has, were, 's, am, 'm</em>
* `Sub` (11; 0% of non-empty `Mood`): <em>be, do</em>
* `EMPTY` (6106): <em>be, will, can, would, been, could, should, may, 'll, being</em>
