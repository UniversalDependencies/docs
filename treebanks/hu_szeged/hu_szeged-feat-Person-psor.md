...
2789 tokens (7%) have a non-empty value of `Person[psor]`.
2050 types (15%) occur at least once with a non-empty value of `Person[psor]`.
1349 lemmas (15%) occur at least once with a non-empty value of `Person[psor]`.
...
2761 <tt><a href="hu_szeged-pos-NOUN.html">NOUN</a></tt> tokens (28% of all `NOUN` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `NOUN` and `Person[psor]` co-occurred: <tt><a href="hu_szeged-feat-Number-psor.html">Number[psor]</a></tt><tt>=Sing</tt> (2587; 94%), <tt><a href="hu_szeged-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2391; 87%).

`NOUN` tokens may have the following values of `Person[psor]`:


<table>
  <tr><th>Paradigm <i>kormány</i></th><th><tt>1</tt></th><th><tt>3</tt></th></tr>
...
`Person[psor]` seems to be **lexical feature** of `NOUN`. 97% lemmas (1287) occur only with one value of `Person[psor]`.

### `PROPN`

13 <tt><a href="hu_szeged-pos-PROPN.html">PROPN</a></tt> tokens (0% of all `PROPN` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `PROPN` and `Person[psor]` co-occurred: <tt><a href="hu_szeged-feat-Number.html">Number</a></tt><tt>=Sing</tt> (13; 100%).

`PROPN` tokens may have the following values of `Person[psor]`:


`Person[psor]` seems to be **lexical feature** of `PROPN`. 100% lemmas (12) occur only with one value of `Person[psor]`.

### `ADJ`

7 <tt><a href="hu_szeged-pos-ADJ.html">ADJ</a></tt> tokens (0% of all `ADJ` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `ADJ` and `Person[psor]` co-occurred: <tt><a href="hu_szeged-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (5; 71%), <tt><a href="hu_szeged-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5; 71%), <tt><a href="hu_szeged-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (4; 57%).
...
5 <tt><a href="hu_szeged-pos-NUM.html">NUM</a></tt> tokens (0% of all `NUM` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `NUM` and `Person[psor]` co-occurred: <tt><a href="hu_szeged-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5; 100%), <tt><a href="hu_szeged-feat-NumType.html">NumType</a></tt><tt>=Frac</tt> (4; 80%).
...
3 <tt><a href="hu_szeged-pos-PRON.html">PRON</a></tt> tokens (0% of all `PRON` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `PRON` and `Person[psor]` co-occurred: <tt><a href="hu_szeged-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3; 100%), <tt><a href="hu_szeged-feat-Person.html">Person</a></tt><tt>=3</tt> (3; 100%), <tt><a href="hu_szeged-feat-PronType.html">PronType</a></tt><tt>=Ind</tt> (3; 100%).
...
<tt>NUM --[<tt><a href="hu_szeged-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (1; 100%).
