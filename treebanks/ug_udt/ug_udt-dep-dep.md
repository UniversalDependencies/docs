---
layout: base
title:  'Statistics of dep in UD_Uyghur-UDT'
udver: '2'
---

## Treebank Statistics: UD_Uyghur-UDT: Relations: `dep`
...
2	سېزىپ	سەز	VERB	V	Aspect=Perf|VerbForm=Conv	3	compound:lvc	_	Translit=sëzip
3	قالغان	قال	VERB	V	Case=Nom|Tense=Past|VerbForm=Ger	4	dep	_	Translit=qalghan
4	ئەپەندىم	ئەپەندى	NOUN	N	Case=Nom|Number[psor]=Sing|Person[psor]=1	7	nsubj	_	Translit=ependim
5	خەتنىڭ	خەت	NOUN	N	Case=Gen	6	nmod:poss	_	Translit=xetning
6	ئاخىرىغا	ئاخىر	NOUN	D	Case=Dat|Number[psor]=Plur,Sing|Person[psor]=3	7	obl	_	Translit=axirigha
7	يېزىپتۇ	_	VERB	V	_	0	root	_	SpaceAfter=No|Translit=yëziptu|Morf=Unknown
