...
1	Вячеслав	Вячеслав	PROPN	_	Animacy=Anim|Case=Nom|Gender=Masc|NameType=Giv|Number=Sing	7	vocative	_	SpaceAfter=No
2	,	,	PUNCT	_	_	1	punct	_	_
3	почему	почему	ADV	_	Degree=Pos|PronType=Rel	7	advmod	_	_
4	бы	бы	AUX	_	Mood=Cnd	7	aux	_	_
5	Вам	вы	PRON	_	Case=Dat|Number=Plur|Person=2|PronType=Prs	7	iobj	_	_
6	не	не	PART	_	Polarity=Neg	7	advmod	_	_
7	возглавить	возглавить	VERB	_	Aspect=Perf|VerbForm=Inf|Voice=Act	0	root	_	_
8	КПРФ	КПРФ	PROPN	_	Abbr=Yes|NameType=Com	7	obj	_	_
9	Пока	пока	SCONJ	_	_	12	mark	_	_
10	оно	оно	PRON	_	Case=Nom|Gender=Neut|Number=Sing|Person=3|PronType=Prs	12	nsubj	_	_
