---
layout: base
title:  'Statistics of flat:foreign in UD_Slovak'
udver: '2'
---

## Treebank Statistics: UD_Slovak: Relations: `flat:foreign`

This relation is a language-specific subtype of <tt><a href="sk-dep-flat.html">flat</a></tt>.

81 nodes (0%) are attached to their parents as `flat:foreign`.

54 instances of `flat:foreign` (67%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.45679012345679.

The following 1 pairs of parts of speech are connected with `flat:foreign`: <tt><a href="sk-pos-X.html">X</a></tt>-<tt><a href="sk-pos-X.html">X</a></tt> (81; 100% instances).
