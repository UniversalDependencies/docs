---
layout: base
title:  'Statistics of orphan in UD_Sanskrit-UFAL'
udver: '2'
---

## Treebank Statistics: UD_Sanskrit-UFAL: Relations: `orphan`
...
The following 5 pairs of parts of speech are connected with `orphan`: <tt><a href="sa_ufal-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sa_ufal-pos-NOUN.html">NOUN</a></tt> (3; 43% instances), <tt><a href="sa_ufal-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sa_ufal-pos-ADV.html">ADV</a></tt> (1; 14% instances), <tt><a href="sa_ufal-pos-PRON.html">PRON</a></tt>-<tt><a href="sa_ufal-pos-PROPN.html">PROPN</a></tt> (1; 14% instances), <tt><a href="sa_ufal-pos-PROPN.html">PROPN</a></tt>-<tt><a href="sa_ufal-pos-ADV.html">ADV</a></tt> (1; 14% instances), <tt><a href="sa_ufal-pos-VERB.html">VERB</a></tt>-<tt><a href="sa_ufal-pos-NOUN.html">NOUN</a></tt> (1; 14% instances).
...
1	मम	अस्मद्	PRON	_	Case=Gen|Number=Sing|Person=1|PronType=Prs	3	nsubj	_	Translit=mama|LTranslit=asmad|Gloss=me
2	अशीति	अशीति	NUM	_	Compound=Yes|NumType=Card	3	nummod	_	Translit=aśīti|LTranslit=aśīti|Gloss=eighty
3	वर्षस्य	वर्ष	NOUN	_	Case=Gen|Gender=Masc|Number=Sing	11	advcl	_	Translit=varṣasya|LTranslit=varṣa|Gloss=year
4	व्यावृत्त	व्य्-आ-वृत्	VERB	_	Compound=Yes|Tense=Past|VerbForm=Part|Voice=Pass	11	advcl	_	Translit=vyāvr̥tta|LTranslit=vy-ā-vr̥t|Gloss=liberated
5	सर्व	सर्व	ADJ	_	Compound=Yes	6	amod	_	Translit=sarva|LTranslit=sarva|Gloss=all
6	इन्द्रिय	इन्द्रिय	ADJ	_	Compound=Yes	4	obl	_	Translit=indriya|LTranslit=indriya|Gloss=sense
7	अर्थस्य	अर्थ	NOUN	_	Case=Gen|Gender=Masc|Number=Sing	4	nsubj	_	Translit=arthasya|LTranslit=artha|Gloss=reason
8	न	न	PART	_	Polarity=Neg	11	advmod	_	Translit=na|LTranslit=na|Gloss=not
9	किंचिद्	किम्-चिद्	DET	_	Case=Nom|Gender=Neut|Number=Sing|PronType=Ind	11	det	_	LId=क-१|Translit=kiṁcid|LTranslit=kiṁ|Gloss=any
10	अर्थेन	अर्थ	NOUN	_	Case=Ins|Gender=Masc|Number=Sing	11	orphan	_	Translit=arthena|LTranslit=artha|Gloss=posession
11	प्रयोजनम्	प्रयोजन	NOUN	_	Case=Nom|Gender=Neut|Number=Sing	0	root	_	SpaceAfter=No|Translit=prayojanam|LTranslit=prayojana|Gloss=need
...
# visual-style 22 23 orphan	color:blue
...
7	अपि	अपि	ADV	_	_	6	advmod	_	Translit=api|LTranslit=api|Gloss=only
8	कर्हिचित्	कर्हि-चिद्	ADV	_	PronType=Ind	4	advmod	_	SpaceAfter=No|Translit=karhicit|LTranslit=karhi-cid|Gloss=sometimes
