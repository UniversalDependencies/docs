...
This is a <a href="../../u/overview/feat-layers.html">layered feature</a> with the following layers: <tt><a href="la_perseus-feat-Person.html">Person</a></tt>, <tt><a href="la_perseus-feat-Person-psor.html">Person[psor]</a></tt>.

4980 tokens (17%) have a non-empty value of `Person`.
2753 types (28%) occur at least once with a non-empty value of `Person`.
1040 lemmas (22%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="la_perseus-pos-VERB.html">VERB</a></tt> (3786; 13% instances), <tt><a href="la_perseus-pos-PRON.html">PRON</a></tt> (881; 3% instances), <tt><a href="la_perseus-pos-AUX.html">AUX</a></tt> (313; 1% instances).

### `VERB`

3786 <tt><a href="la_perseus-pos-VERB.html">VERB</a></tt> tokens (65% of all `VERB` tokens) have a non-empty value of `Person`.
...
881 <tt><a href="la_perseus-pos-PRON.html">PRON</a></tt> tokens (60% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="la_perseus-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (881; 100%), <tt><a href="la_perseus-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (687; 78%), <tt><a href="la_perseus-feat-Number.html">Number</a></tt><tt>=Sing</tt> (679; 77%).

`PRON` tokens may have the following values of `Person`:

* `1` (357; 41% of non-empty `Person`): <em>mihi, me, ego, nos, nobis, nostrum, mi, mei, mih, milli</em>
* `2` (200; 23% of non-empty `Person`): <em>te, tibi, tu, vos, vobis, uos</em>
* `3` (324; 37% of non-empty `Person`): <em>se, eius, sibi, ea, eos, eorum, eum, id, sese, is</em>
* `EMPTY` (599): <em>qui, quae, quod, quid, quem, quis, nihil, quam, quibus, quo</em>

### `AUX`

313 <tt><a href="la_perseus-pos-AUX.html">AUX</a></tt> tokens (85% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="la_perseus-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (313; 100%), <tt><a href="la_perseus-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (267; 85%), <tt><a href="la_perseus-feat-Number.html">Number</a></tt><tt>=Sing</tt> (259; 83%), <tt><a href="la_perseus-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (255; 81%), <tt><a href="la_perseus-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (178; 57%).

`AUX` tokens may have the following values of `Person`:

* `1` (29; 9% of non-empty `Person`): <em>sum, sim, essem, fui, eram, ero, sumus, erimus, essemus, fueram</em>
* `2` (23; 7% of non-empty `Person`): <em>es, eris, eras, esto, sis, sitis</em>
* `3` (261; 83% of non-empty `Person`): <em>est, erat, fuit, sunt, sit, esset, erit, fuerunt, erant, foret</em>
