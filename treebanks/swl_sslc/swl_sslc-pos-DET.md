...
## Treebank Statistics: UD_Swedish_Sign_Language-SSLC: POS Tags: `DET`

There are 1 `DET` lemmas (9%), 5 `DET` types (1%) and 39 `DET` tokens (2%).
Out of 11 observed tags, the rank of `DET` is: 5 in number of lemmas, 11 in number of types and 8 in number of tokens.

The 10 most frequent `DET` lemmas: <em>_</em>

The 10 most frequent `DET` types:  <em>PEK, PEK>långf, PEK>pekf, PEK>ringf, PEK(J)</em>
...
The form / lemma ratio of `DET` is 5.000000 (the average of all parts of speech is 63.454545).

The 1st highest number of forms (5) was observed with the lemma “_”: <em>PEK, PEK(J), PEK>långf, PEK>pekf, PEK>ringf</em>.
...
`DET` nodes are attached to their parents using 2 different relations: <tt><a href="swl_sslc-dep-det.html">det</a></tt> (38; 97% instances), <tt><a href="swl_sslc-dep-conj.html">conj</a></tt> (1; 3% instances)

Parents of `DET` nodes belong to 5 different parts of speech: <tt><a href="swl_sslc-pos-NOUN.html">NOUN</a></tt> (32; 82% instances), <tt><a href="swl_sslc-pos-VERB.html">VERB</a></tt> (3; 8% instances), <tt><a href="swl_sslc-pos-PRON.html">PRON</a></tt> (2; 5% instances), <tt><a href="swl_sslc-pos-ADJ.html">ADJ</a></tt> (1; 3% instances), <tt><a href="swl_sslc-pos-X.html">X</a></tt> (1; 3% instances)
...
Children of `DET` nodes are attached using 1 different relations: <tt><a href="swl_sslc-dep-reparandum.html">reparandum</a></tt> (1; 100% instances)

Children of `DET` nodes belong to 1 different parts of speech: <tt><a href="swl_sslc-pos-PRON.html">PRON</a></tt> (1; 100% instances)
