...
There are 1 language-specific subtypes of `det`: <tt><a href="pcm_nsc-dep-det-predet.html">det:predet</a></tt>.

531 nodes (4%) are attached to their parents as `det`.
