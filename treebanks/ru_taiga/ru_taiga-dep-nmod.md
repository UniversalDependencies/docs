...
# visual-style 1	fgColor:white
# visual-style 1 3 nmod	color:blue
1	Два	два	NUM	_	Case=Nom|Gender=Masc|NumForm=Word|NumType=Card	0	root	_	_
2	на	на	ADP	_	_	3	case	_	_
3	два	два	NUM	_	Animacy=Inan|Case=Acc|Gender=Masc|NumForm=Word|NumType=Card	1	nmod	_	_
