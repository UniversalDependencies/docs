...
1	1	1	NUM	CD	NumForm=Digit|NumType=Card	2	nummod	2:nummod	Discourse=restatement-partial:47->41:3:_|Entity=(46-time-giv:inact-cf2-2-coref
...
6	"	''	PUNCT	``	_	7	punct	7:punct	Discourse=adversative-concession:32->36:3:_|SpaceAfter=No
...
10	said	say	VERB	VBD	Mood=Ind|Number=Sing|Person=1|Tense=Past|VerbForm=Fin	21	parataxis	21:parataxis	Discourse=attribution-positive:33->34:0:_|MSeg=sai-d
...
13	"	''	PUNCT	``	_	10	punct	10:punct	Discourse=same-unit_m:34->32:0:_|SpaceAfter=No
...
1	More	more	ADJ	JJR	Degree=Cmp	0	root	0:root	Discourse=joint-other_m:28->4:2:_
