...
322 tokens (19%) have a non-empty value of `Voice`.
182 types (26%) occur at least once with a non-empty value of `Voice`.
27 lemmas (12%) occur at least once with a non-empty value of `Voice`.
The feature is used with 2 part-of-speech tags: <tt><a href="xpg_kul-pos-VERB.html">VERB</a></tt> (230; 14% instances), <tt><a href="xpg_kul-pos-AUX.html">AUX</a></tt> (92; 5% instances).

### `VERB`

230 <tt><a href="xpg_kul-pos-VERB.html">VERB</a></tt> tokens (98% of all `VERB` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `VERB` and `Voice` co-occurred: <tt><a href="xpg_kul-feat-Number.html">Number</a></tt><tt>=Sing</tt> (221; 96%), <tt><a href="xpg_kul-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (135; 59%), <tt><a href="xpg_kul-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (133; 58%), <tt><a href="xpg_kul-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (133; 58%), <tt><a href="xpg_kul-feat-Person.html">Person</a></tt><tt>=3</tt> (133; 58%), <tt><a href="xpg_kul-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (133; 58%), <tt><a href="xpg_kul-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (121; 53%).

`VERB` tokens may have the following values of `Voice`:

* `Act` (108; 47% of non-empty `Voice`): <em>αδδακετ, αδακετ, δακετ, αββερετ, αδδακ[ετ, τευτους, [α]δδακετ, [α]δδακεττ, [αδ]δ[ακετ], [αδακετ</em>
...
* `EMPTY` (4): <em>αδικες, εδαες, ουρν̣ουσαεν, ριδιτι</em>
