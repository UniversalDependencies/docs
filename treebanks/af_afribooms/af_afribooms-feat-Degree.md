...
5333 tokens (11%) have a non-empty value of `Degree`.
1339 types (22%) occur at least once with a non-empty value of `Degree`.
1011 lemmas (19%) occur at least once with a non-empty value of `Degree`.
The feature is used with 3 part-of-speech tags: <tt><a href="af_afribooms-pos-ADJ.html">ADJ</a></tt> (3173; 6% instances), <tt><a href="af_afribooms-pos-ADV.html">ADV</a></tt> (2145; 4% instances), <tt><a href="af_afribooms-pos-NOUN.html">NOUN</a></tt> (15; 0% instances).
...
* `Cmp` (63; 2% of non-empty `Degree`): <em>beter, hoër, groter, ouer, sterker, laer, minder, jonger, langer, stadiger</em>
...
2145 <tt><a href="af_afribooms-pos-ADV.html">ADV</a></tt> tokens (100% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (72; 3% of non-empty `Degree`): <em>verder, beter, later, langer, vinniger, harder, vroeër, minder, sterker, armer</em>
* `Pos` (2061; 96% of non-empty `Degree`): <em>nie, ook, in, saam, nog, uit, aan, egter, reeds, slegs</em>
...
`Degree` seems to be **lexical feature** of `ADV`. 97% lemmas (350) occur only with one value of `Degree`.
...
* `EMPTY` (10443): <em>jaar, regering, mense, aansoek, inligting, land, leerders, departement, staat, dienste</em>

## Relations with Agreement in `Degree`

The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<tt><a href="af_afribooms-dep-conj.html">conj</a></tt>]--> ADJ</tt> (172; 99%),
<tt>ADJ --[<tt><a href="af_afribooms-dep-advmod.html">advmod</a></tt>]--> ADV</tt> (145; 89%),
