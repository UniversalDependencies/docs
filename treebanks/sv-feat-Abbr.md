---
layout: base
title:  'Statistics of Abbr in UD_Swedish'
udver: '2'
---

## Treebank Statistics: UD_Swedish: Features: `Abbr`
...
The feature is used with 5 part-of-speech tags: <tt><a href="sv-pos-ADV.html">ADV</a></tt> (426; 0% instances), <tt><a href="sv-pos-NOUN.html">NOUN</a></tt> (346; 0% instances), <tt><a href="sv-pos-ADJ.html">ADJ</a></tt> (9; 0% instances), <tt><a href="sv-pos-VERB.html">VERB</a></tt> (7; 0% instances), <tt><a href="sv-pos-ADP.html">ADP</a></tt> (1; 0% instances).

### `ADV`

426 <tt><a href="sv-pos-ADV.html">ADV</a></tt> tokens (5% of all `ADV` tokens) have a non-empty value of `Abbr`.

The most frequent other feature values with which `ADV` and `Abbr` co-occurred: <tt><a href="sv-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (426; 100%).

`ADV` tokens may have the following values of `Abbr`:

* `Yes` (426; 100% of non-empty `Abbr`): <em>t.ex., ca, t ex, bl.a., s k, etc, bl a, dvs, osv, s.k.</em>
* `EMPTY` (7567): <em>inte, så, också, när, hur, där, då, här, nu, bara</em>
...
1 <tt><a href="sv-pos-ADP.html">ADP</a></tt> tokens (0% of all `ADP` tokens) have a non-empty value of `Abbr`.

`ADP` tokens may have the following values of `Abbr`:

* `Yes` (1; 100% of non-empty `Abbr`): <em>f</em>
* `EMPTY` (11116): <em>i, av, på, för, till, med, om, från, vid, under</em>

## Relations with Agreement in `Abbr`

The 10 most frequent relations where parent and child node agree in `Abbr`:
<tt>NOUN --[<tt><a href="sv-dep-conj.html">conj</a></tt>]--> NOUN</tt> (17; 68%),
<tt>NOUN --[<tt><a href="sv-dep-amod.html">amod</a></tt>]--> ADJ</tt> (3; 60%),
<tt>ADJ --[<tt><a href="sv-dep-fixed.html">fixed</a></tt>]--> NOUN</tt> (2; 100%),
<tt>NOUN --[<tt><a href="sv-dep-fixed.html">fixed</a></tt>]--> ADV</tt> (1; 100%).
