...
13 tokens (4%) have a non-empty value of `Number[obj]`.
5 types (5%) occur at least once with a non-empty value of `Number[obj]`.
...
13 <tt><a href="wbp_ufal-pos-AUX.html">AUX</a></tt> tokens (28% of all `AUX` tokens) have a non-empty value of `Number[obj]`.

The most frequent other feature values with which `AUX` and `Number[obj]` co-occurred: <tt><a href="wbp_ufal-feat-Person-dat.html">Person[dat]</a></tt><tt>=EMPTY</tt> (13; 100%), <tt><a href="wbp_ufal-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (13; 100%), <tt><a href="wbp_ufal-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8; 62%).
