...
1	The	the	DET	DT	Definite=Def|PronType=Art	2	det	2:det	Discourse=joint-other_m:37->36:1:_|Entity=(32-organization-giv:act-nnnnn-cf1*-2-coref-United_States_District_Court_for_the_Northern_District_of_Texas|PDTB=Implicit:Expansion.Conjunction:further:_:188-220:221-230
2	court	court	NOUN	NN	Number=Sing	3	nsubj	3:nsubj	Entity=32)
...
4	the	the	DET	DT	Definite=Def|PronType=Art	5	det	5:det	Entity=(22-event-giv:inact-snnnn-cf2-4-coref(23-person-giv:inact-nnnnn-cf3-2-coref
5	Does	Doe	PROPN	NNPS	Number=Plur	7	nmod:poss	7:nmod:poss	MSeg=Doe-s
6	'	's	PART	POS	_	5	case	5:case	Entity=23)
7	complaint	complaint	NOUN	NN	Number=Sing	3	obj	3:obj|9:nsubj:xsubj	Entity=22)|MSeg=complain-t
...
1	We	we	PRON	PRP	Case=Nom|Number=Plur|Person=1|PronType=Prs	2	nsubj	2:nsubj	Discourse=joint-sequence_m:19->8:1:_|Entity=(4-person-giv:inact-nnnnn-cf1-1-ana)
...
11	the	the	DET	DT	Definite=Def|PronType=Art	12	det	12:det	Entity=(24-place-new-snnnn-cf2-2-coref
