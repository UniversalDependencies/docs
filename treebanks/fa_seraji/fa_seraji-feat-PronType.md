...
<table>
  ...
  <tr><td><tt><tt><a href="fa_seraji-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td>آن, دان, اش</td></tr>
  <tr><td><tt><tt><a href="fa_seraji-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="fa_seraji-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td>ش, اش</td><td></td></tr>
...
260 <tt><a href="fa_seraji-pos-ADV.html">ADV</a></tt> tokens (7% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="fa_seraji-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (260; 100%).
...
216 <tt><a href="fa_seraji-pos-DET.html">DET</a></tt> tokens (6% of all `DET` tokens) have a non-empty value of `PronType`.

`DET` tokens may have the following values of `PronType`:

* `Int` (84; 39% of non-empty `PronType`): چه
* `Neg` (132; 61% of non-empty `PronType`): هیچ، غیر
* `EMPTY` (3543): این، آن، هر، همان، همین، برخی، تمام، تمامی، دیگر، همهٔ

## Relations with Agreement in `PronType`

The 10 most frequent relations where parent and child node agree in `PronType`:
<tt>PRON --[<tt><a href="fa_seraji-dep-nmod-poss.html">nmod:poss</a></tt>]--> PRON</tt> (151; 90%),
<tt>PRON --[<tt><a href="fa_seraji-dep-conj.html">conj</a></tt>]--> PRON</tt> (9; 75%),
<tt>PRON --[<tt><a href="fa_seraji-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (5; 71%),
