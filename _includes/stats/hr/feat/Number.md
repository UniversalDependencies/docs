...
* `Plur` (1009; 24% of non-empty `Number`): <em>koje, koji, svoje, kojima, oni, neki, svojih, ih, neke, im</em>
...
513 [hr-pos/NUM]() tokens (28% of all `NUM` tokens) have a non-empty value of `Number`.
