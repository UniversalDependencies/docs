---
layout: base
title:  'Statistics of compound:prt in UD_Tamil'
udver: '2'
---

## Treebank Statistics: UD_Tamil: Relations: `compound:prt`

This relation is a language-specific subtype of <tt><a href="ta-dep-compound.html">compound</a></tt>.
...
The following 1 pairs of parts of speech are connected with `compound:prt`: <tt><a href="ta-pos-VERB.html">VERB</a></tt>-<tt><a href="ta-pos-PART.html">PART</a></tt> (1; 100% instances).
