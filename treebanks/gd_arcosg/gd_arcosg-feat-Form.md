...
55 <tt><a href="gd_arcosg-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Form`.

The most frequent other feature values with which `NOUN` and `Form` co-occurred: <tt><a href="gd_arcosg-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (53; 96%), <tt><a href="gd_arcosg-feat-Number.html">Number</a></tt><tt>=Sing</tt> (49; 89%), <tt><a href="gd_arcosg-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (39; 71%), <tt><a href="gd_arcosg-feat-Case.html">Case</a></tt><tt>=Dat</tt> (36; 65%).

`NOUN` tokens may have the following values of `Form`:

* `Emp` (55; 100% of non-empty `Form`): <em>taobh-sa, shon-sa, bheachd-sa, ìre-sa, bheachd-san, bliadhna-sa, dheidhinn-sa, aobhar-sa, athair-san, bhràithrean-sa</em>

`Form` seems to be **lexical feature** of `NOUN`. 100% lemmas (21) occur only with one value of `Form`.
