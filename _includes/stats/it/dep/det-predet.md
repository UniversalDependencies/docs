...
390 nodes (0%) are attached to their parents as `det:predet`.

390 instances of `det:predet` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.12564102564103.

The following 6 pairs of parts of speech are connected with `det:predet`: [it-pos/NOUN]()-[it-pos/DET]() (367; 94% instances), [it-pos/PROPN]()-[it-pos/DET]() (16; 4% instances), [it-pos/PRON]()-[it-pos/DET]() (3; 1% instances), [it-pos/ADJ]()-[it-pos/DET]() (2; 1% instances), [it-pos/NUM]()-[it-pos/DET]() (1; 0% instances), [it-pos/VERB]()-[it-pos/DET]() (1; 0% instances).
...
12	deciso	decidere	VERB	V	Gender=Masc|Number=Sing|Tense=Past|VerbForm=Part	4	conj	_	SpaceAfter=No
