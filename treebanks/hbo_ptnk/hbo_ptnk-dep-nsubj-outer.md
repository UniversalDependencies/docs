---
layout: base
title:  'Statistics of nsubj:outer in UD_Ancient_Hebrew-PTNK'
udver: '2'
---

## Treebank Statistics: UD_Ancient_Hebrew-PTNK: Relations: `nsubj:outer`

This relation is a language-specific subtype of <tt><a href="hbo_ptnk-dep-nsubj.html">nsubj</a></tt>.
...
The following 1 pairs of parts of speech are connected with `nsubj:outer`: <tt><a href="hbo_ptnk-pos-VERB.html">VERB</a></tt>-<tt><a href="hbo_ptnk-pos-PRON.html">PRON</a></tt> (7; 100% instances).
