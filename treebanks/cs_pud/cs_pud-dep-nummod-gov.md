...
3	obvodem	obvod	NOUN	NNIS7-----A----	Animacy=Inan|Case=Ins|Gender=Masc|Number=Sing	0	root	0:root	_
...
5	oblast	oblast	NOUN	NNFS1-----A----	Case=Nom|Gender=Fem|Number=Sing	3	nsubj	3:nsubj|14:obl	_
6	North	North	PROPN	NNXXX-----A----	NameType=Geo	5	nmod	5:nmod	LId=North-2
7	Kesteven	Kesteven	PROPN	NNXXX-----A----	NameType=Geo	6	flat	6:flat	SpaceAfter=No
...
13	voličů	volič	NOUN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|Number=Plur	12	nmod	12:nmod:gen	_
...
16	odchod	odchod	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	14	obl:arg	14:obl:arg:pro:acc	_
17	z	z	ADP	RR--2----------	AdpType=Prep|Case=Gen	18	case	18:case	LId=z-1
18	EU	EU	PROPN	NNFXX-----A---8	Abbr=Yes|Gender=Fem|NameType=Com	16	nmod	16:nmod:z:gen	SpaceAfter=No|LId=EU-1|LGloss=(Evropská_Unie)
