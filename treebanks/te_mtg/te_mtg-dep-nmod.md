---
layout: base
title:  'Statistics of nmod in UD_Telugu-MTG'
udver: '2'
---

## Treebank Statistics: UD_Telugu-MTG: Relations: `nmod`

This relation is universal.
There are 2 language-specific subtypes of `nmod`: <tt><a href="te_mtg-dep-nmod-poss.html">nmod:poss</a></tt>, <tt><a href="te_mtg-dep-nmod-tmod.html">nmod:tmod</a></tt>.
...
1	మా	_	PRON	PRON	_	2	nmod	_	Translit=mā
2	అబ్బాయి	_	NOUN	NOUN	_	6	nsubj	_	Translit=abbāyi
3	ఎడమ	_	ADJ	ADJ	_	4	amod	_	Translit=eḍama
4	చేతితో	_	NOUN	NOUN	_	6	obl	_	Translit=cētitō
5	అన్నం	_	NOUN	NOUN	_	6	obj	_	Translit=annaṁ
6	తింటాడు	_	VERB	VERB	_	0	root	_	Translit=tiṁṭāḍu
...
1	నెల	_	NOUN	NOUN	_	2	compound:redup	_	Translit=nela
2	నెలా	_	NOUN	NOUN	_	7	obl:tmod	_	Translit=nelā
3	జీతం	_	NOUN	NOUN	_	4	nmod	_	Translit=jītaṁ
4	డబ్బులోనుంచి	_	NOUN	NOUN	_	7	obl	_	Translit=ḍabbulōnuṁci
5	భార్యకు	_	NOUN	NOUN	_	7	iobj	_	Translit=bhāryaku
6	కాసులు	_	NOUN	NOUN	_	7	obj	_	Translit=kāsulu
7	కొనేవాడు	_	VERB	VERB	_	0	root	_	Translit=konēvāḍu
...
# visual-style 2	fgColor:white
# visual-style 2 1 nmod	color:blue
1	ఇంటికి	_	NOUN	NOUN	_	2	nmod	_	Translit=iṁṭiki
2	వచ్చిన	_	VERB	VERB	_	3	acl:relcl	_	Translit=vaccina
3	అబ్బాయి	_	NOUN	NOUN	_	0	root	_	Translit=abbāyi
