...
5	célèbre	célèbre	ADJ	_	Gender=Masc|Number=Sing	6	amod	_	Exponence[Gender]=Absent
6	retraité	retraité	NOUN	_	Gender=Masc|Number=Sing	15	nsubj	_	Exponence[Gender]=Inherent
...
11	John	John	PROPN	_	Gender=Masc|Number=Sing	10	nmod	_	Exponence[Gender]=Inherent
12	Glenn	Glenn	PROPN	_	Gender=Masc|Number=Sing	11	flat:name	_	Exponence[Gender]=Inherent|SpaceAfter=No
13	,	,	PUNCT	_	_	10	punct	_	_
14	est	être	AUX	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	15	aux:tense	_	_
15	parti	partir	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part|Voice=Act	0	root	_	Tense[denom]=Past
...
18	espace	espace	NOUN	_	Gender=Masc|Number=Sing	15	obl:arg	_	Exponence[Gender]=Inherent
19	à	à	ADP	_	_	21	case	_	_
20	l'	le	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	21	det	_	Exponence[Gender]=Absent|SpaceAfter=No
21	âge	âge	NOUN	_	Gender=Masc|Number=Sing	15	obl:mod	_	Exponence[Gender]=Inherent
22	de	de	ADP	_	_	24	case	_	_
23	69	69	NUM	_	Number=Plur|NumType=Card	24	nummod	_	Exponence[Number]=Inherent
24	ans	an	NOUN	_	Gender=Masc|Number=Plur	21	nmod	_	Exponence[Gender]=Inherent|SpaceAfter=No
...
2	ce	ce	PRON	_	Gender=Masc|Number=Sing|Person=3|PronType=Dem	6	nsubj	_	_
