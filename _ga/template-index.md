...
2002). A mapping from this tagest to the UD tagset for use in the IUDT is given in: Lynn, Teresa and Jennifer Foster, _Universal Dependencies for Irish_ In Proceedings of the 2nd Celtic Language Technology Workshop 2016, Paris, France.

The Irish data (IUDT) makes use of all 17 Universal POS tags. Some unintuitive choices (made to conform to UD v2) are explained here:
