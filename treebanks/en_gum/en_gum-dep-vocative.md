...
1	What	what	PRON	WP	PronType=Int	4	obj	4:obj	Discourse=question:1->2|SpaceAfter=No
2	'd	do	AUX	VBD	Mood=Ind|Number=Sing|Person=2|Tense=Past|VerbForm=Fin	4	aux	4:aux	_
3	you	you	PRON	PRP	Case=Nom|Number=Sing|Person=2|PronType=Prs	4	nsubj	4:nsubj	Entity=(person-1)
4	do	do	VERB	VB	VerbForm=Inf	0	root	0:root	_
5	Sabrina	Sabrina	PROPN	NNP	Number=Sing	4	vocative	4:vocative	Entity=(person-1)|SpaceAfter=No
...
1	Well	well	INTJ	UH	_	4	discourse	4:discourse	Discourse=preparation:97->107|SpaceAfter=No
2	,	,	PUNCT	,	_	1	punct	1:punct	_
3	everybody	everybody	NOUN	NN	Number=Sing	4	vocative	4:vocative	Entity=(person-1)
4	count	count	VERB	VB	Mood=Imp|Person=2|VerbForm=Fin	0	root	0:root	Entity=(event-54
5	together	together	ADV	RB	Degree=Pos	4	advmod	4:advmod	Entity=event-54)|SpaceAfter=No
6	.	.	PUNCT	.	_	4	punct	4:punct	_
...
1	Ramon	Ramon	PROPN	NNP	Number=Sing	8	vocative	8:vocative	Discourse=concession:54->52|Entity=(person-60)|SpaceAfter=No
2	,	,	PUNCT	,	_	1	punct	1:punct	_
3	the	the	DET	DT	Definite=Def|PronType=Art	4	det	4:det	Entity=(time-64
4	equinox	equinox	NOUN	NN	Number=Sing	8	nsubj	8:nsubj|10:nsubj	Entity=time-64)
...
8	weeks	week	NOUN	NNS	Number=Plur	0	root	0:root	Entity=(time-65)
9	and	and	CCONJ	CC	_	10	cc	10:cc	_
10	weeks	week	NOUN	NNS	Number=Plur	8	conj	8:conj:and	Entity=(time-66)|SpaceAfter=No
