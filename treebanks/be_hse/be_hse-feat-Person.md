...
17726 tokens (6%) have a non-empty value of `Person`.
4237 types (8%) occur at least once with a non-empty value of `Person`.
2124 lemmas (7%) occur at least once with a non-empty value of `Person`.
The feature is used with 4 part-of-speech tags: <tt><a href="be_hse-pos-VERB.html">VERB</a></tt> (11763; 4% instances), <tt><a href="be_hse-pos-PRON.html">PRON</a></tt> (5241; 2% instances), <tt><a href="be_hse-pos-AUX.html">AUX</a></tt> (720; 0% instances), <tt><a href="be_hse-pos-NOUN.html">NOUN</a></tt> (2; 0% instances).

### `VERB`

11763 <tt><a href="be_hse-pos-VERB.html">VERB</a></tt> tokens (38% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="be_hse-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11762; 100%), <tt><a href="be_hse-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (11761; 100%), <tt><a href="be_hse-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10198; 87%), <tt><a href="be_hse-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (9345; 79%), <tt><a href="be_hse-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (9274; 79%), <tt><a href="be_hse-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (8433; 72%), <tt><a href="be_hse-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6532; 56%).

`VERB` tokens may have the following values of `Person`:

* `1` (1862; 16% of non-empty `Person`): <em>чакаем, ведаю, запрашаем, хочам, прапануем, віншуем, думаю, можам, хачу, размаўляем</em>
...
* `EMPTY` (19320): <em>можна, трэба, няма, стала, затрымалі, сказаў, пачалі, стаў, падтрымаць, зрабіць</em>
...
* `EMPTY` (5081): <em>гэта, што, якія, які, хто, якая, тое, таго, сябе, якіх</em>

`Person` seems to be **lexical feature** of `PRON`. 100% lemmas (21) occur only with one value of `Person`.

### `AUX`

720 <tt><a href="be_hse-pos-AUX.html">AUX</a></tt> tokens (35% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="be_hse-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (720; 100%), <tt><a href="be_hse-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (720; 100%), <tt><a href="be_hse-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (720; 100%), <tt><a href="be_hse-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (717; 100%), <tt><a href="be_hse-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (706; 98%), <tt><a href="be_hse-feat-Tense.html">Tense</a></tt><tt>=Fut</tt> (613; 85%), <tt><a href="be_hse-feat-Number.html">Number</a></tt><tt>=Sing</tt> (470; 65%).

`AUX` tokens may have the following values of `Person`:

* `1` (111; 15% of non-empty `Person`): <em>будзем, буду, Будзьма</em>
* `2` (13; 2% of non-empty `Person`): <em>будзеш, будзеце, будзьце</em>
* `3` (596; 83% of non-empty `Person`): <em>будзе, будуць, ёсць, ёсьць, буду</em>
...
* `EMPTY` (72694): <em>дзень, людзей, чалавек, арт, годзе, гадоў, час, людзі, года, год</em>

## Relations with Agreement in `Person`

The 10 most frequent relations where parent and child node agree in `Person`:
<tt>VERB --[<tt><a href="be_hse-dep-conj.html">conj</a></tt>]--> VERB</tt> (1001; 59%),
