...
9	каштом-латко	каштом-латко	NOUN	N	Case=Nom|Definite=Ind|Number=Sing	7	appos	_	GTtags=Sem/Inanim_Cnt,Sg,Nom,Indef
10	потсо	потмо	NOUN	N	Case=Ine|Definite=Ind|Number=Plur,Sing	9	case	_	GTtags=Sem/Inanim_Cnt,SP,Ine,Indef|SpaceAfter=No
