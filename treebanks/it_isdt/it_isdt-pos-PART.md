...
The form / lemma ratio of `PART` is 1.000000 (the average of all parts of speech is 1.481812).
...
`PART` nodes are attached to their parents using 3 different relations: <tt><a href="it_isdt-dep-case.html">case</a></tt> (24; 92% instances), <tt><a href="it_isdt-dep-flat-name.html">flat:name</a></tt> (1; 4% instances), <tt><a href="it_isdt-dep-nmod.html">nmod</a></tt> (1; 4% instances)
