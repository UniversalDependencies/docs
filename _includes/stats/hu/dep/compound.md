...
107 nodes (0%) are attached to their parents as `compound`.

107 instances of `compound` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 3 pairs of parts of speech are connected with `compound`: [hu-pos/NUM]()-[hu-pos/NUM]() (104; 97% instances), [hu-pos/NOUN]()-[hu-pos/X]() (2; 2% instances), [hu-pos/ADJ]()-[hu-pos/NUM]() (1; 1% instances).
