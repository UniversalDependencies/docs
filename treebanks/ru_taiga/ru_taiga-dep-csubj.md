...
7459 nodes (0%) are attached to their parents as `csubj`.

6204 instances of `csubj` (83%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.47700764177504.
