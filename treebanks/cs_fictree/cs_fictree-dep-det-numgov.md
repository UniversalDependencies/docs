...
6	životě	život	NOUN	NNIS6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	3	obl	3:obl:v:loc	_
7	hodně	hodně	DET	Ca--1----------	Case=Nom|NumType=Card|PronType=Ind	8	det:numgov	8:det:numgov	_
8	věcí	věc	NOUN	NNFP2-----A----	Case=Gen|Gender=Fem|Number=Plur	3	nsubj	3:nsubj	SpaceAfter=No
...
9	zem	země	NOUN	NNFS4-----A---1	Case=Acc|Gender=Fem|Number=Sing	7	obl	7:obl:na:acc	SpaceAfter=No
...
2	byla	být	AUX	VpFS----R-AA---	Aspect=Imp|Gender=Fem|Number=Sing|Polarity=Pos|Tense=Past|VerbForm=Part|Voice=Act	1	cop	1:cop	_
3	velká	velký	ADJ	AAFS1----1A----	Case=Nom|Degree=Pos|Gender=Fem|Number=Sing|Polarity=Pos	4	amod	4:amod	_
4	nouze	nouze	NOUN	NNFS1-----A----	Case=Nom|Gender=Fem|Number=Sing	1	nsubj	1:nsubj	_
5	o	o	ADP	RR--4----------	AdpType=Prep|Case=Acc	6	case	6:case	_
6	byty	byt	NOUN	NNIP4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Plur	4	nmod	4:nmod:o:acc	SpaceAfter=No
...
12	Čechů	Čech	PROPN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|NameType=Nat|Number=Plur	8	nsubj	8:nsubj	_
13	z	z	ADP	RR--2----------	AdpType=Prep|Case=Gen	14	case	14:case	_
14	pohraničí	pohraničí	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing	12	nmod	12:nmod:z:gen	_
15	i	i	CCONJ	J^-------------	_	16	cc	16:cc	_
16	emigrantů	emigrant	NOUN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|Number=Plur	12	conj	8:nsubj|12:conj	_
...
19	zemí	země	NOUN	NNFP2-----A----	Case=Gen|Gender=Fem|Number=Plur	16	nmod	16:nmod:z:gen	SpaceAfter=No
