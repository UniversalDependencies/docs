...
2247 instances of `clf` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.00267022696929.

The following 2 pairs of parts of speech are connected with `clf`: <tt><a href="zh_gsd-pos-NUM.html">NUM</a></tt>-<tt><a href="zh_gsd-pos-NOUN.html">NOUN</a></tt> (2033; 90% instances), <tt><a href="zh_gsd-pos-DET.html">DET</a></tt>-<tt><a href="zh_gsd-pos-NOUN.html">NOUN</a></tt> (214; 10% instances).
...
# visual-style 17 18 clf	color:blue
