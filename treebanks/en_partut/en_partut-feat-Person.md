...
The feature is used with 3 part-of-speech tags: <tt><a href="en_partut-pos-AUX.html">AUX</a></tt> (1598; 3% instances), <tt><a href="en_partut-pos-PRON.html">PRON</a></tt> (1264; 3% instances), <tt><a href="en_partut-pos-VERB.html">VERB</a></tt> (1225; 2% instances).
...
* `3` (1532; 96% of non-empty `Person`): <em>is, was, has, would, should, shall, can, will, may, had</em>
* `EMPTY` (840): <em>be, are, have, been, were, being, do, 're, 've, had</em>
...
* `EMPTY` (3498): <em>like, have, make, including, see, take, given, based, made, taken</em>
...
`Person` seems to be **lexical feature** of `VERB`. 93% lemmas (426) occur only with one value of `Person`.
