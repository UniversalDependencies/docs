...
The feature is used with 2 part-of-speech tags: [-pos/ADJ]() (288; 1% instances), [-pos/VERB]() (1; 0% instances).

### `ADJ`

288 [-pos/ADJ]() tokens (4% of all `ADJ` tokens) have a non-empty value of `Aspect`.
...
1 [-pos/VERB]() tokens (0% of all `VERB` tokens) have a non-empty value of `Aspect`.
