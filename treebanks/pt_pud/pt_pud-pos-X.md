---
layout: base
title:  'Statistics of X in UD_Portuguese-PUD'
udver: '2'
---

## Treebank Statistics: UD_Portuguese-PUD: POS Tags: `X`

There are 1 `X` lemmas (0%), 3 `X` types (0%) and 5 `X` tokens (0%).
...
* <em>americano</em>
  * <tt><a href="pt_pud-pos-ADJ.html">ADJ</a></tt> 1: <em>Em janeiro de 2011 , Blunt começou a gravar um filme <b>americano</b> de ficção científica , Looper , realizado por Rian Johnson e coprotagonizado por Bruce Willis e Joseph Gordon-Levitt ; o filme foi lançado em setembro de 2012 .</em>
...
`X` nodes are attached to their parents using 1 different relations: <tt><a href="pt_pud-dep-compound.html">compound</a></tt> (5; 100% instances)

Parents of `X` nodes belong to 3 different parts of speech: <tt><a href="pt_pud-pos-PROPN.html">PROPN</a></tt> (3; 60% instances), <tt><a href="pt_pud-pos-ADJ.html">ADJ</a></tt> (1; 20% instances), <tt><a href="pt_pud-pos-NOUN.html">NOUN</a></tt> (1; 20% instances)
