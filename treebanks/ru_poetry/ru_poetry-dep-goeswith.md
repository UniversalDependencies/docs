---
layout: base
title:  'Statistics of goeswith in UD_Russian-Poetry'
udver: '2'
---

## Treebank Statistics: UD_Russian-Poetry: Relations: `goeswith`
...
The following 1 pairs of parts of speech are connected with `goeswith`: <tt><a href="ru_poetry-pos-ADV.html">ADV</a></tt>-<tt><a href="ru_poetry-pos-X.html">X</a></tt> (1; 100% instances).
...
1	Когда	когда-нибудь	ADV	_	Degree=Pos|PronType=Ind|Typo=Yes	4	advmod	_	before=<p_class="verse"><line_meter="Я5ж"/><se>
2	нибудь	_	X	_	_	1	goeswith	_	SpaceAfter=No
...
10	жизнь	жизнь	NOUN	_	Animacy=Inan|Case=Acc|Gender=Fem|Number=Sing	9	obj	_	_
11	в	в	ADP	_	_	12	case	_	_
12	цвету	цвет	NOUN	_	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	10	nmod	_	before=<rhyme-zone/>|after=<br/>
13	Ну	ну	PART	_	_	17	discourse	_	before=<line_meter="Я5ж"/>
14	а	а	CCONJ	_	_	17	cc	_	_
15	пока	пока	ADV	_	Degree=Pos	17	advmod	_	SpaceAfter=No
16	,	,	PUNCT	_	_	15	punct	_	_
17	глумитеся	глумиться	VERB	_	Aspect=Perf|Mood=Imp|Number=Plur|Person=2|VerbForm=Fin|Voice=Mid	4	conj	_	_
18	над	над	ADP	_	_	19	case	_	_
