...
27217 tokens (12%) have a non-empty value of `VerbForm`.
7168 types (23%) occur at least once with a non-empty value of `VerbForm`.
1885 lemmas (11%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 2 part-of-speech tags: <tt><a href="ro_rrt-pos-VERB.html">VERB</a></tt> (22999; 11% instances), <tt><a href="ro_rrt-pos-AUX.html">AUX</a></tt> (4218; 2% instances).

### `VERB`

22999 <tt><a href="ro_rrt-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="ro_rrt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (15363; 67%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (12283; 53% of non-empty `VerbForm`): <em>poate, trebuie, pot, are, avea, era, putea, există, au, face</em>
...
* `Inf` (2089; 9% of non-empty `VerbForm`): <em>putea, trebui, avea, face, aduce, lua, asigura, fi, permite, vedea</em>
* `Part` (7636; 33% of non-empty `VerbForm`): <em>avut, prevăzute, făcut, spus, putut, rupt, dat, murit, devenit, luat</em>
...
4218 <tt><a href="ro_rrt-pos-AUX.html">AUX</a></tt> tokens (49% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="ro_rrt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (2912; 69%), <tt><a href="ro_rrt-feat-Person.html">Person</a></tt><tt>=3</tt> (2698; 64%), <tt><a href="ro_rrt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (2564; 61%), <tt><a href="ro_rrt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2463; 58%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (2781; 66% of non-empty `VerbForm`): <em>este, sunt, era, fie, e, erau, fusese, avea, -i, sunteți</em>
...
<tt>VERB --[<tt><a href="ro_rrt-dep-ccomp-pmod.html">ccomp:pmod</a></tt>]--> VERB</tt> (90; 52%),
