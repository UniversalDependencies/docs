...
There are 478 `ADV` lemmas (4%), 503 `ADV` types (3%) and 3886 `ADV` tokens (3%).
...
The form / lemma ratio of `ADV` is 1.052301 (the average of all parts of speech is 1.372220).
