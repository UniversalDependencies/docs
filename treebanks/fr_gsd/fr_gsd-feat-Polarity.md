...
2918 tokens (1%) have a non-empty value of `Polarity`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="fr_gsd-pos-ADV.html">ADV</a></tt> (2795; 1% instances), <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> (110; 0% instances), <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (10; 0% instances), <tt><a href="fr_gsd-pos-PART.html">PART</a></tt> (3; 0% instances).

### `ADV`

2795 <tt><a href="fr_gsd-pos-ADV.html">ADV</a></tt> tokens (19% of all `ADV` tokens) have a non-empty value of `Polarity`.

`ADV` tokens may have the following values of `Polarity`:

* `Neg` (2795; 100% of non-empty `Polarity`): <em>pas, n', ne, plus, jamais, non, qu', point, guère, not</em>
* `EMPTY` (11711): <em>plus, très, aussi, alors, ainsi, bien, également, lors, y, peu</em>
...
* `EMPTY` (18016): <em>il, qui, se, s', elle, on, c', ils, lui, ce</em>

### `PART`

3 <tt><a href="fr_gsd-pos-PART.html">PART</a></tt> tokens (1% of all `PART` tokens) have a non-empty value of `Polarity`.

`PART` tokens may have the following values of `Polarity`:

* `Neg` (3; 100% of non-empty `Polarity`): <em>n', ne, not</em>
* `EMPTY` (305): <em>l', -t, 's, -ci, n', ci, ex, ne, to, up</em>
