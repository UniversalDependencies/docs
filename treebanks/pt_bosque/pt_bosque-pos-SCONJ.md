...
There are 46 `SCONJ` lemmas (0%), 48 `SCONJ` types (0%) and 5357 `SCONJ` tokens (2%).
...
The form / lemma ratio of `SCONJ` is 1.043478 (the average of all parts of speech is 1.421073).
