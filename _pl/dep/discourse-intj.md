...
1	Cóż	cóż	INTJ	interj	_	9	discourse:intj	9:discourse:intj	SpaceAfter=No
2	,	,	PUNCT	interp	PunctType=Comm	1	punct	1:punct	_
3	dobrze	dobrze	ADV	adv:pos	Degree=Pos	4	advmod	4:advmod	_
4	wychowany	wychować	ADJ	ppas:sg:nom:m1:perf:aff	Animacy=Hum|Aspect=Perf|Case=Nom|Gender=Masc|Number=Sing|Polarity=Pos|VerbForm=Part|Voice=Pass	5	acl	5:acl	_
5	człowiek	człowiek	NOUN	subst:sg:nom:m1	Animacy=Hum|Case=Nom|Gender=Masc|Number=Sing	9	nsubj	9:nsubj	_
6	po	po	ADP	prep:acc	AdpType=Prep	7	case	7:case	Case=Acc
7	prostu	prosty	ADJ	adjp	PrepCase=Pre	9	obl	9:obl	_
8	nie	nie	PART	part	Polarity=Neg	9	advmod:neg	9:advmod:neg	_
9	zadaje	zadawać	VERB	fin:sg:ter:imperf	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	0:root	_
10	takich	taki	DET	adj:pl:gen:n:pos	Case=Gen|Gender=Neut|Number=Plur|PronType=Dem	11	det	11:det	_
11	pytań	pytanie	NOUN	subst:pl:gen:n:ncol	Case=Gen|Gender=Neut|Number=Plur	9	obj	9:obj	SpaceAfter=No
