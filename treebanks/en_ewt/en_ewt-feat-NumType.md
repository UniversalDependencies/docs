...
The feature is used with 5 part-of-speech tags: <tt><a href="en_ewt-pos-NUM.html">NUM</a></tt> (4921; 2% instances), <tt><a href="en_ewt-pos-ADJ.html">ADJ</a></tt> (256; 0% instances), <tt><a href="en_ewt-pos-ADV.html">ADV</a></tt> (155; 0% instances), <tt><a href="en_ewt-pos-NOUN.html">NOUN</a></tt> (105; 0% instances), <tt><a href="en_ewt-pos-DET.html">DET</a></tt> (9; 0% instances).

### `NUM`

4921 <tt><a href="en_ewt-pos-NUM.html">NUM</a></tt> tokens (98% of all `NUM` tokens) have a non-empty value of `NumType`.

`NUM` tokens may have the following values of `NumType`:

* `Card` (4921; 100% of non-empty `NumType`): <em>one, two, 2, 3, 5, 1, 10, 4, three, 20</em>
* `EMPTY` (122): <em>1, 2, 3, 4, a, b, 5, ii, 10, 6</em>

`NumType` seems to be **lexical feature** of `NUM`. 100% lemmas (1236) occur only with one value of `NumType`.
...
* `EMPTY` (16567): <em>good, great, new, other, best, many, more, last, same, few</em>
...
* `EMPTY` (11602): <em>so, just, very, also, now, even, then, there, only, here</em>
...
* `EMPTY` (42989): <em>time, people, service, place, thanks, food, way, year, day, number</em>
...
<tt>NUM --[<tt><a href="en_ewt-dep-conj.html">conj</a></tt>]--> NUM</tt> (60; 100%),
...
<tt>NUM --[<tt><a href="en_ewt-dep-parataxis.html">parataxis</a></tt>]--> NUM</tt> (2; 100%),
