...
There are 533 `ADV` lemmas (7%), 551 `ADV` types (5%) and 4568 `ADV` tokens (6%).
...
The form / lemma ratio of `ADV` is 1.033771 (the average of all parts of speech is 1.244910).
...
`ADV` occurs with 4 features: <tt><a href="en_lines-feat-PronType.html">PronType</a></tt> (453; 10% instances), <tt><a href="en_lines-feat-Degree.html">Degree</a></tt> (167; 4% instances), <tt><a href="en_lines-feat-Case.html">Case</a></tt> (125; 3% instances), <tt><a href="en_lines-feat-NumType.html">NumType</a></tt> (59; 1% instances)
