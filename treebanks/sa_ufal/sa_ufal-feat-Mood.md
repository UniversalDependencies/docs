...
The feature is used with 3 part-of-speech tags: <tt><a href="sa_ufal-pos-VERB.html">VERB</a></tt> (164; 9% instances), <tt><a href="sa_ufal-pos-AUX.html">AUX</a></tt> (14; 1% instances), <tt><a href="sa_ufal-pos-ADJ.html">ADJ</a></tt> (1; 0% instances).

### `VERB`

164 <tt><a href="sa_ufal-pos-VERB.html">VERB</a></tt> tokens (52% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="sa_ufal-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (163; 99%), <tt><a href="sa_ufal-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (163; 99%), <tt><a href="sa_ufal-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (163; 99%), <tt><a href="sa_ufal-feat-Number.html">Number</a></tt><tt>=Sing</tt> (146; 89%), <tt><a href="sa_ufal-feat-Person.html">Person</a></tt><tt>=3</tt> (128; 78%), <tt><a href="sa_ufal-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (114; 70%).

`VERB` tokens may have the following values of `Mood`:

* `Imp` (21; 13% of non-empty `Mood`): अनुष्ठीयताम्, गृहाण, अस्तु, आगच्छ, कथ्यताम्, कुरु, क्रियताम्, गच्छतु, चिन्त्यताम्, जीवतु
* `Ind` (136; 83% of non-empty `Mood`): अब्रवीत्, आह, भवति, करिष्यामि, उच्यते, करोमि, प्रोवाच, अस्ति, उवाच, करिष्यति
...
14 <tt><a href="sa_ufal-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="sa_ufal-feat-Number.html">Number</a></tt><tt>=Sing</tt> (14; 100%), <tt><a href="sa_ufal-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (14; 100%), <tt><a href="sa_ufal-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (14; 100%), <tt><a href="sa_ufal-feat-Person.html">Person</a></tt><tt>=3</tt> (13; 93%), <tt><a href="sa_ufal-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (12; 86%).

`AUX` tokens may have the following values of `Mood`:

* `Imp` (1; 7% of non-empty `Mood`): अस्तु
* `Ind` (12; 86% of non-empty `Mood`): अस्ति, अस्मि, भवति
