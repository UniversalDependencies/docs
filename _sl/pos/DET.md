...
The traditional grammar of Slovenian does not define determiners as a separate word class. Instead, words that perform the syntactic function of determiners are either categorizied as quantifying adverbs (_nekaj_ "some", _veliko_ "a lot of", _dovolj_ "enough of" etc.) or various kinds of pronouns (_ta_ "this", _ves_ "all", _moj_ "my", _vsak_ "each" etc.).
