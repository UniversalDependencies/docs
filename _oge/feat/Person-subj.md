...
`Person[subj]` is feature of [verbs](_oge/pos/VERB). It is an agreement feature that marks the person of the verb's subject. Person[subj] marked on verbs makes it unnecessary to add a personal pronoun as subject and thus subjects may be dropped. 

### <a name="1">`1`</a>: first person subject

#### Examples

* _ვიტყჳ_ 'I say', _ვწერ_ 'I write' etc.
* _ვიტყჳთ_ 'we say', _ვწერთ_ 'we write' etc.

### <a name="2">`2`</a>: second person subject

#### Examples

* _(ხ/ჰ)წერ_ 'you write in singular' etc.
* _(ხ/ჰ)წერენ_ 'you write in plural', _შჭამოთ_ 'you eat in plural' etc.
