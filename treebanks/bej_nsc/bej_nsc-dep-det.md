...
117 nodes (11%) are attached to their parents as `det`.

74 instances of `det` (63%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.31623931623932.

The following 7 pairs of parts of speech are connected with `det`: <tt><a href="bej_nsc-pos-NOUN.html">NOUN</a></tt>-<tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (82; 70% instances), <tt><a href="bej_nsc-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (21; 18% instances), <tt><a href="bej_nsc-pos-PRON.html">PRON</a></tt>-<tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (7; 6% instances), <tt><a href="bej_nsc-pos-ADJ.html">ADJ</a></tt>-<tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (4; 3% instances), <tt><a href="bej_nsc-pos-ADV.html">ADV</a></tt>-<tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (1; 1% instances), <tt><a href="bej_nsc-pos-PROPN.html">PROPN</a></tt>-<tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (1; 1% instances), <tt><a href="bej_nsc-pos-SCONJ.html">SCONJ</a></tt>-<tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (1; 1% instances).
...
1	ontʔa	_	PART	PTCL	_	4	discourse	_	AlignBegin=131136|AlignEnd=131391|GE=now|Gloss=now|RX=[PTCL]|TokenType=Stem
2	/	_	PUNCT	PUNCT	_	1	punct	_	AlignBegin=131391|AlignEnd=131979|TokenType=Break
3	kak	_	ADV	ADV	_	4	advmod	_	AlignBegin=131979|AlignEnd=132265|GE=how|Gloss=how|RX=[ADV].[Q]|TokenType=Stem
4	jʔ	_	VERB	V2,IRG	VerbClass=2	0	root	_	AlignBegin=132265|AlignEnd=132336|GE=come|Gloss=come|RX=[V2].[IRG]|TokenType=Stem
5	-aː	_	SCONJ	CVB	Aspect=Perf|VerbForm=Conv	4	mark:aff	_	AlignBegin=132336|AlignEnd=132408|GE=-[CVB].[MNR]|RX=-[PRF]|TokenType=InflAff
6	=b	_	DET	DET	Case=Acc|Definite=Ind|Gender=Masc	4	det	_	AlignBegin=132408|AlignEnd=132479|GE==[INDF].[M].[ACC]|RX==[DET]|TokenType=Clit
7	=wa	_	AUX	N,COP	Gender=Masc|Number=Sing|Person=2|VerbType=Cop	4	cop	_	AlignBegin=132479|AlignEnd=132551|GE==[COP].[2SG].[M]|RX==[PRED].[N]|TokenType=Clit
8	?	_	PUNCT	PUNCT	_	4	punct	_	AlignBegin=132551|AlignEnd=132837|RX=[?]
