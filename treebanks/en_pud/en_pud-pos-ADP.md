...
There are 64 `ADP` lemmas (1%), 64 `ADP` types (1%) and 2493 `ADP` tokens (12%).
...
The form / lemma ratio of `ADP` is 1.000000 (the average of all parts of speech is 1.138338).
