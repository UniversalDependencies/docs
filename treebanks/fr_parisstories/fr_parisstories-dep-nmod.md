...
1	c'	ce	PRON	_	Gender=Masc|Number=Sing|Person=3|PronType=Dem	4	nsubj	_	Exponence[Gender]=Inherent|Exponence[Number]=Inherent|Exponence[Person]=Inherent|SpaceAfter=No
2	était	être	AUX	_	Mood=Ind|Number=Sing|Person=3|Tense=Imp|VerbForm=Fin	4	cop	_	_
3	l'	le	DET	_	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	4	det	_	Exponence[Gender]=Absent|HasSpokenGender=OnlySingExceptWithLiaison|LiaisonAfter=Yes|SpaceAfter=No
4	année	année	NOUN	_	Gender=Fem|Number=Sing	0	root	_	Exponence[Gender]=Inherent|Exponence[Number]=Absent|LiaisonPossibleBefore=Yes
5	de	des	ADP	_	_	7	case	_	wordform=des
6	les	le	DET	_	Definite=Def|Number=Plur|PronType=Art	7	det	_	_
7	M	M	PROPN	_	Gender=Masc|Number=Sing	4	nmod	_	Exponence[Gender]=Inherent|SpaceAfter=No
8	,	,	PUNCT	_	_	9	punct	_	_
9	euh	euh	INTJ	_	_	4	discourse	_	SpaceAfter=No
