...
<table>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>hann, ann</em></td><td></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>honum, þeim, honum.</em></td><td></td><td><em>þeim, hönum</em></td><td><em>hönum, þeirra</em></td></tr>
...
* `Dem` (15185; 49% of non-empty `PronType`): <em>þetta, sá, þessi, þann, þessu, það, þeim, þessa, þá, þessum</em>
* `Ind` (14440; 46% of non-empty `PronType`): <em>allt, allir, öllum, alla, öllu, ekkert, öll, allra, enginn, nokkuð</em>
* `Int` (278; 1% of non-empty `PronType`): <em>hver, hvaða, hvað, hverju, hverjir, hvers, hvern, hverjar, hverja, hvert</em>
* `Prs` (1381; 4% of non-empty `PronType`): <em>það, þeim, því, þeir, þess, þau, þeirra, þá, þær, Þessir</em>
* `EMPTY` (13663): <em>einn, mikið, hinn, eitt, mikill, hið, margir, meira, meir, miklu</em>

<table>
  <tr><th>Paradigm <i>þessi</i></th><th><tt>Prs</tt></th><th><tt>Int</tt></th><th><tt>Dem</tt></th><th><tt>Ind</tt></th></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>þenna, þennan, Þann</em></td><td></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td></td><td><em>þessa</em></td><td></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>þessa</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>þessum</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td></td><td><em>þessara</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>þetta, Þessi</em></td><td></td></tr>
...
867 <tt><a href="is_icepahc-pos-ADV.html">ADV</a></tt> tokens (1% of all `ADV` tokens) have a non-empty value of `PronType`.

`ADV` tokens may have the following values of `PronType`:

* `Dem` (193; 22% of non-empty `PronType`): <em>þá, hvílík, sama, sjálfum, glöggvasta, hvorsu, hvílíka, sjálfa, öðruvís, því</em>
* `Ind` (226; 26% of non-empty `PronType`): <em>allir, allt, nokkuð, einn, hver, öll, alls, báðir, enginn, hvert</em>
...
252 <tt><a href="is_icepahc-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `NOUN` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (252; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (215; 85%).
...
`PronType` seems to be **lexical feature** of `NOUN`. 94% lemmas (47) occur only with one value of `PronType`.
...
`PronType` seems to be **lexical feature** of `PROPN`. 91% lemmas (20) occur only with one value of `PronType`.
...
* `EMPTY` (103468): <em>í, á, til, af, með, um, fyrir, að, við, upp</em>
