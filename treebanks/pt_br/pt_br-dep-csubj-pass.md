---
layout: base
title:  'Statistics of csubj:pass in UD_Portuguese-BR'
udver: '2'
---

## Treebank Statistics: UD_Portuguese-BR: Relations: `csubj:pass`

This relation is a language-specific subtype of <tt><a href="pt_br-dep-csubj.html">csubj</a></tt>.
...
The following 2 pairs of parts of speech are connected with `csubj:pass`: <tt><a href="pt_br-pos-VERB.html">VERB</a></tt>-<tt><a href="pt_br-pos-VERB.html">VERB</a></tt> (7; 88% instances), <tt><a href="pt_br-pos-VERB.html">VERB</a></tt>-<tt><a href="pt_br-pos-PROPN.html">PROPN</a></tt> (1; 13% instances).
