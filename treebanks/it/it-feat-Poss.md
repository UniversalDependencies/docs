---
layout: base
title:  'Statistics of Poss in UD_Italian'
udver: '2'
---

## Treebank Statistics: UD_Italian: Features: `Poss`
...
1 <tt><a href="it-pos-ADJ.html">ADJ</a></tt> tokens (0% of all `ADJ` tokens) have a non-empty value of `Poss`.

The most frequent other feature values with which `ADJ` and `Poss` co-occurred: <tt><a href="it-feat-Gender.html">Gender</a></tt><tt>=Fem</tt> (1; 100%), <tt><a href="it-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1; 100%).
...
<tt>PRON --[<tt><a href="it-dep-conj.html">conj</a></tt>]--> PRON</tt> (1; 100%).
