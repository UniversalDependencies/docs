---
layout: base
title:  'Statistics of dislocated in UD_Latvian-LVTB'
udver: '2'
---

## Treebank Statistics: UD_Latvian-LVTB: Relations: `dislocated`
...
1	Nu	nu	PART	q	_	3	advmod:emph	3:advmod:emph	LvtbNodeId=a-s9-p21s6w1
...
5	to	tas	DET	pd3msan	Case=Acc|Gender=Masc|Number=Sing|Person=3|PronType=Dem	7	obj	7:obj	LvtbNodeId=a-s9-p21s6w5
...
1	Un	un	CCONJ	cc	_	10	cc	10:cc	LvtbNodeId=a-d60-p79s5w1
2	vispār	vispār	ADV	r0n	_	10	advmod	10:advmod	LvtbNodeId=a-d60-p79s5w2|SpaceAfter=No
3	,	,	PUNCT	zc	_	4	punct	4:punct	LvtbNodeId=a-d60-p79s5w3
4	žīds	žīds	NOUN	ncmsn1	Case=Nom|Gender=Masc|Number=Sing	7	dislocated	7:dislocated	LvtbNodeId=a-d60-p79s5w4|SpaceAfter=No
5	,	,	PUNCT	zc	_	4	punct	4:punct	LvtbNodeId=a-d60-p79s5w5
6	-	-	PUNCT	zd	_	4	punct	4:punct	LvtbNodeId=a-d60-p79s5w6
7	viņš	viņš	PRON	pp3msnn	Case=Nom|Gender=Masc|Number=Sing|Person=3|PronType=Prs	10	nsubj	10:nsubj	LvtbNodeId=a-d60-p79s5w7
8	arī	arī	PART	q	_	10	discourse	10:discourse	LvtbNodeId=a-d60-p79s5w8
9	ir	būt	AUX	vcnipii30an	Evident=Fh|Mood=Ind|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	10	cop	10:cop	LvtbNodeId=a-d60-p79s5w9
10	cilvēks	cilvēks	NOUN	ncmsn1	Case=Nom|Gender=Masc|Number=Sing	0	root	0:root	LvtbNodeId=a-d60-p79s5w10|SpaceAfter=No
11	.	.	PUNCT	zs	_	10	punct	10:punct	LvtbNodeId=a-d60-p79s5w11
