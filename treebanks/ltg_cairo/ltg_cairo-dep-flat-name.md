---
layout: base
title:  'Statistics of flat:name in UD_Latgalian-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Latgalian-Cairo: Relations: `flat:name`

This relation is a language-specific subtype of .

2 nodes (1%) are attached to their parents as `flat:name`.

2 instances of `flat:name` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `flat:name`: <tt><a href="ltg_cairo-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ltg_cairo-pos-PROPN.html">PROPN</a></tt> (2; 100% instances).
