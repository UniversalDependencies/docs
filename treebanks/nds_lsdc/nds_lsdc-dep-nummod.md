---
layout: base
title:  'Statistics of nummod in UD_Low_Saxon-LSDC'
udver: '2'
---

## Treebank Statistics: UD_Low_Saxon-LSDC: Relations: `nummod`
...
1	Ik	ik	PRON	_	Case=Nom|Number=Sing|Person=1|PronType=Prs	8	nsubj	_	lemma_gml=ik
2	wil	willen	AUX	_	Mood=Ind|Number=Sing|Person=1|Tense=Pres	8	aux	_	lemma_gml=willen
3	uns	wy	PRON	_	Case=Acc,Dat|Number=Plur|Person=1|PronType=Prs	8	obj	_	lemma_gml=wî
4	dree	dree	NUM	_	NumType=Card	3	nummod	_	lemma_gml=drê
5	wol	wol	ADV	_	_	8	advmod	_	lemma_gml=wol
6	boaven	boaven	ADP	_	AdpType=Prep	7	case	_	lemma_gml=bōven
7	waters	water	NOUN	_	Case=Gen|Gender=Masc|Number=Sing	8	obl	_	lemma_gml=wāter
8	holden	holden	VERB	_	VerbForm=Inf	0	root	_	lemma_gml=hōlden
9	un	un	CCONJ	_	_	10	cc	_	lemma_gml=unde
10	dy	du	PRON	_	Case=Acc,Dat|Number=Sing|Person=2|PronType=Prs	8	obj	_	lemma_gml=dû
11	ouk	ouk	ADV	_	_	10	advmod	_	lemma_gml=ôk|SpaceAfter=No
12	,	,	PUNCT	_	_	13	punct	_	_
13	Anna	Anna	PROPN	_	Number=Sing	8	vocative	_	_
14	Susanna	Susanna	PROPN	_	Number=Sing	13	flat	_	SpaceAfter=No
15	,	,	PUNCT	_	_	13	punct	_	_
16	låt	låten	VERB	_	Mood=Imp|Number=Sing	8	parataxis	_	lemma_gml=lâten
17	my	ik	PRON	_	Case=Acc,Dat|Number=Sing|Person=1|PronType=Prs	16	obj	_	lemma_gml=ik
18	man	men	ADV	_	_	16	advmod	_	lemma_gml=men
19	kyken	kyken	VERB	_	VerbForm=Inf	16	xcomp	_	lemma_gml=kîken|SpaceAfter=No
