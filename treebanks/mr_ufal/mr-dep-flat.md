---
layout: base
title:  'Statistics of flat in UD_Marathi'
udver: '2'
---

## Treebank Statistics: UD_Marathi: Relations: `flat`
...
The following 3 pairs of parts of speech are connected with `flat`: <tt><a href="mr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="mr-pos-NOUN.html">NOUN</a></tt> (4; 50% instances), <tt><a href="mr-pos-NUM.html">NUM</a></tt>-<tt><a href="mr-pos-NUM.html">NUM</a></tt> (3; 38% instances), <tt><a href="mr-pos-ADV.html">ADV</a></tt>-<tt><a href="mr-pos-ADV.html">ADV</a></tt> (1; 13% instances).
...
10	आली	येणे	VERB	_	Aspect=Perf|Gender=Fem|Number=Sing|Person=3|VerbForm=Fin	0	root	_	_
...
15	होती	असणे	AUX	_	Gender=Masc|Number=Plur|Person=3|Tense=Past|VerbForm=Fin	14	aux	_	_
...
14	गेली	जाणे	VERB	_	Aspect=Perf|Gender=Fem|Number=Sing|Person=3|VerbForm=Fin	13	compound:svc	_	_
