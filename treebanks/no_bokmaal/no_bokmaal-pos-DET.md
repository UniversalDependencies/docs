...
The form / lemma ratio of `DET` is 1.736842 (the average of all parts of speech is 1.381975).
...
13452 (94%) `DET` nodes are leaves.

619 (4%) `DET` nodes have one child.
