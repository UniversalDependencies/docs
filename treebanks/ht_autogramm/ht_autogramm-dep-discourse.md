---
layout: base
title:  'Statistics of discourse in UD_Haitian_Creole-Autogramm'
udver: '2'
---

## Treebank Statistics: UD_Haitian_Creole-Autogramm: Relations: `discourse`
...
The following 1 pairs of parts of speech are connected with `discourse`: <tt><a href="ht_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="ht_autogramm-pos-INTJ.html">INTJ</a></tt> (1; 100% instances).
