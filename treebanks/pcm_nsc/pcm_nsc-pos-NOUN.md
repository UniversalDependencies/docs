...
There are 1907 `NOUN` lemmas (42%), 2141 `NOUN` types (41%) and 14743 `NOUN` tokens (10%).
...
The form / lemma ratio of `NOUN` is 1.122706 (the average of all parts of speech is 1.162376).
