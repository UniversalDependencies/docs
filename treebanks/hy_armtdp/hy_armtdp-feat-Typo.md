...
50 tokens (0%) have a non-empty value of `Typo`.
49 types (0%) occur at least once with a non-empty value of `Typo`.
49 lemmas (1%) occur at least once with a non-empty value of `Typo`.
The feature is used with 8 part-of-speech tags: <tt><a href="hy_armtdp-pos-NUM.html">NUM</a></tt> (20; 0% instances), <tt><a href="hy_armtdp-pos-NOUN.html">NOUN</a></tt> (18; 0% instances), <tt><a href="hy_armtdp-pos-ADJ.html">ADJ</a></tt> (4; 0% instances), <tt><a href="hy_armtdp-pos-VERB.html">VERB</a></tt> (4; 0% instances), <tt><a href="hy_armtdp-pos-ADV.html">ADV</a></tt> (1; 0% instances), <tt><a href="hy_armtdp-pos-PRON.html">PRON</a></tt> (1; 0% instances), <tt><a href="hy_armtdp-pos-PROPN.html">PROPN</a></tt> (1; 0% instances), <tt><a href="hy_armtdp-pos-X.html">X</a></tt> (1; 0% instances).

### `NUM`

20 <tt><a href="hy_armtdp-pos-NUM.html">NUM</a></tt> tokens (3% of all `NUM` tokens) have a non-empty value of `Typo`.

The most frequent other feature values with which `NUM` and `Typo` co-occurred: <tt><a href="hy_armtdp-feat-NumForm.html">NumForm</a></tt><tt>=Digit</tt> (20; 100%), <tt><a href="hy_armtdp-feat-NumType.html">NumType</a></tt><tt>=Frac</tt> (20; 100%).

`NUM` tokens may have the following values of `Typo`:

* `Yes` (20; 100% of non-empty `Typo`): <em>3.2, 0.2, 0.863004, 176.7, 201.5, 210.4, 218.6, 327.5, 329.9, 338.39</em>

`Typo` seems to be **lexical feature** of `NUM`. 100% lemmas (19) occur only with one value of `Typo`.

### `NOUN`

18 <tt><a href="hy_armtdp-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Typo`.

The most frequent other feature values with which `NOUN` and `Typo` co-occurred: <tt><a href="hy_armtdp-feat-Animacy.html">Animacy</a></tt><tt>=Nhum</tt> (15; 83%), <tt><a href="hy_armtdp-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (11; 61%), <tt><a href="hy_armtdp-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10; 56%).

`NOUN` tokens may have the following values of `Typo`:

* `Yes` (18; 100% of non-empty `Typo`): <em>Գործակալութոյւնը, ալեկսիա, աողջապահությունում, առաջնությա, արատադրանքի, գանահատման, գործընկներներ, դասկարգման, էյշելոնն, ծավալերն</em>
...
4 <tt><a href="hy_armtdp-pos-VERB.html">VERB</a></tt> tokens (0% of all `VERB` tokens) have a non-empty value of `Typo`.

The most frequent other feature values with which `VERB` and `Typo` co-occurred: <tt><a href="hy_armtdp-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hy_armtdp-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hy_armtdp-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hy_armtdp-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hy_armtdp-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (3; 75%), <tt><a href="hy_armtdp-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (3; 75%).

`VERB` tokens may have the following values of `Typo`:

* `Yes` (4; 100% of non-empty `Typo`): <em>զարամանում, հաջոդրում, հրապարկել, փխել</em>
...
* `Yes` (1; 100% of non-empty `Typo`): <em>varitas</em>
