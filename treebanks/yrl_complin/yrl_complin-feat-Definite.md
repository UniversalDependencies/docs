...
158 <tt><a href="yrl_complin-pos-DET.html">DET</a></tt> tokens (19% of all `DET` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `DET` and `Definite` co-occurred: <tt><a href="yrl_complin-feat-Deixis.html">Deixis</a></tt><tt>=EMPTY</tt> (158; 100%), <tt><a href="yrl_complin-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (158; 100%), <tt><a href="yrl_complin-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (158; 100%).
