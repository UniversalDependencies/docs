---
layout: base
title:  'Statistics of case in UD_Tamil-MWTT'
udver: '2'
---

## Treebank Statistics: UD_Tamil-MWTT: Relations: `case`
...
# visual-style 1	fgColor:white
# visual-style 1 2 case	color:blue
1	குமார்	குமார்	PROPN	_	Case=Nom|Number=Sing|Person=3	4	obl	4:obl	Translit=kumār|LTranslit=kumār
2	அல்லாமல்	அல்லாமல்	ADP	_	AdpType=Post	1	case	1:case	Translit=allāmal|LTranslit=allāmal
3	எல்லோரும்	எல்லோரும்	PRON	_	Case=Nom|Number=Plur	4	nsubj	4:nsubj	Translit=ellōrum|LTranslit=ellōrum
4	வந்தார்கள்	வா	VERB	_	Gender=Com|Number=Plur|Person=3|Tense=Past	0	root	0:root	Translit=vantārkaḷ|LTranslit=vā
