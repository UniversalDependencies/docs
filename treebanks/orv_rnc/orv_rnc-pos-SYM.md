...
The form / lemma ratio of `SYM` is 1.000000 (the average of all parts of speech is 2.481722).
...
1 (4%) `SYM` nodes have three or more children.

The highest child degree of a `SYM` node is 5.

Children of `SYM` nodes are attached using 2 different relations: <tt><a href="orv_rnc-dep-punct.html">punct</a></tt> (4; 67% instances), <tt><a href="orv_rnc-dep-conj.html">conj</a></tt> (2; 33% instances)

Children of `SYM` nodes belong to 3 different parts of speech: <tt><a href="orv_rnc-pos-PUNCT.html">PUNCT</a></tt> (4; 67% instances), <tt><a href="orv_rnc-pos-NOUN.html">NOUN</a></tt> (1; 17% instances), <tt><a href="orv_rnc-pos-VERB.html">VERB</a></tt> (1; 17% instances)
