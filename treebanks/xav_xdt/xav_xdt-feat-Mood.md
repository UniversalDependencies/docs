---
layout: base
title:  'Statistics of Mood in UD_Xavante-XDT'
udver: '2'
---

## Treebank Statistics: UD_Xavante-XDT: Features: `Mood`

This feature is universal.
It occurs with 2 different values: `Des`, `Sub`.

2 tokens (0%) have a non-empty value of `Mood`.
2 types (0%) occur at least once with a non-empty value of `Mood`.
2 lemmas (1%) occur at least once with a non-empty value of `Mood`.
The feature is used with 2 part-of-speech tags: <tt><a href="xav_xdt-pos-PART.html">PART</a></tt> (1; 0% instances), <tt><a href="xav_xdt-pos-X.html">X</a></tt> (1; 0% instances).
...
* `EMPTY` (57): <em>di, wa'wa, ni, wamhã, 'wa, na, wei</em>
