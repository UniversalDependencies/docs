---
layout: base
title:  'Statistics of compound:lvc in UD_Kazakh-KTB'
udver: '2'
---

## Treebank Statistics: UD_Kazakh-KTB: Relations: `compound:lvc`

This relation is a language-specific subtype of <tt><a href="kk_ktb-dep-compound.html">compound</a></tt>.
...
The following 1 pairs of parts of speech are connected with `compound:lvc`: <tt><a href="kk_ktb-pos-VERB.html">VERB</a></tt>-<tt><a href="kk_ktb-pos-NOUN.html">NOUN</a></tt> (7; 100% instances).
