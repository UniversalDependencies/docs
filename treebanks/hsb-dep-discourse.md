---
layout: base
title:  'Statistics of discourse in UD_Upper_Sorbian'
udver: '2'
---

## Treebank Statistics: UD_Upper_Sorbian: Relations: `discourse`
...
The following 1 pairs of parts of speech are connected with `discourse`: <tt><a href="hsb-pos-VERB.html">VERB</a></tt>-<tt><a href="hsb-pos-VERB.html">VERB</a></tt> (1; 100% instances).
