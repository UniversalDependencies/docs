...
10357 nodes (3%) are attached to their parents as `aux`.

10342 instances of `aux` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.0068552669692.

The following 5 pairs of parts of speech are connected with `aux`: [hi-pos/VERB]()-[hi-pos/AUX]() (10342; 100% instances), [hi-pos/ADJ]()-[hi-pos/ADJ]() (7; 0% instances), [hi-pos/NUM]()-[hi-pos/NUM]() (5; 0% instances), [hi-pos/PRON]()-[hi-pos/PRON]() (2; 0% instances), [hi-pos/SCONJ]()-[hi-pos/SCONJ]() (1; 0% instances).
