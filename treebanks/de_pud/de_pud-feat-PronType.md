...
* `Neg` (26; 1% of non-empty `PronType`): <em>keine, kein, keinen, keinerlei</em>
* `Prs` (223; 7% of non-empty `PronType`): <em>seine, ihre, ihrer, seiner, ihr, sein, ihren, seinen, seines, ihrem</em>
* `Tot` (60; 2% of non-empty `PronType`): <em>alle, beiden, allem, jedes, alles, jede, jeder, jeden, all, allen</em>

`PronType` seems to be **lexical feature** of `DET`. 100% lemmas (35) occur only with one value of `PronType`.

### `PRON`

928 <tt><a href="de_pud-pos-PRON.html">PRON</a></tt> tokens (95% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="de_pud-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (793; 85%), <tt><a href="de_pud-feat-Case.html">Case</a></tt><tt>=Nom</tt> (618; 67%), <tt><a href="de_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (585; 63%), <tt><a href="de_pud-feat-Person.html">Person</a></tt><tt>=3</tt> (573; 62%).

`PRON` tokens may have the following values of `PronType`:

* `Dem,Rel` (244; 26% of non-empty `PronType`): <em>die, der, das, denen, dem, dessen, deren, den</em>
* `Ind` (20; 2% of non-empty `PronType`): <em>man, etwas</em>
* `Int,Rel` (25; 3% of non-empty `PronType`): <em>was, wer</em>
* `Neg` (5; 1% of non-empty `PronType`): <em>nichts</em>
* `Prs` (627; 68% of non-empty `PronType`): <em>es, sich, er, sie, wir, ihm, ihn, uns, ihr, ihnen</em>
* `Rcp` (6; 1% of non-empty `PronType`): <em>mich, mir</em>
* `Tot` (1; 0% of non-empty `PronType`): <em>alldem</em>
* `EMPTY` (52): <em>ich, mich, mir</em>
