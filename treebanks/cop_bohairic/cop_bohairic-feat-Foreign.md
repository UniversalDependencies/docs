---
layout: base
title:  'Statistics of Foreign in UD_Coptic-Bohairic'
udver: '2'
---

## Treebank Statistics: UD_Coptic-Bohairic: Features: `Foreign`
...
442 <tt><a href="cop_bohairic-pos-PART.html">PART</a></tt> tokens (43% of all `PART` tokens) have a non-empty value of `Foreign`.
...
51 <tt><a href="cop_bohairic-pos-ADP.html">ADP</a></tt> tokens (1% of all `ADP` tokens) have a non-empty value of `Foreign`.
...
7 <tt><a href="cop_bohairic-pos-X.html">X</a></tt> tokens (88% of all `X` tokens) have a non-empty value of `Foreign`.

The most frequent other feature values with which `X` and `Foreign` co-occurred: <tt><a href="cop_bohairic-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (6; 86%).

`X` tokens may have the following values of `Foreign`:

* `Yes` (7; 100% of non-empty `Foreign`): ⲉⲡⲫⲁⲑⲁ, ⲕⲉ, ⲕⲟⲩⲙ, ⲙⲟⲛⲟⲛ, ⲣⲁⲃⲃⲓ, ⲧⲁⲩⲧⲁ, ⲟⲩ
* `EMPTY` (1): ⲁⲡⲗⲱⲥ

### `ADJ`

2 <tt><a href="cop_bohairic-pos-ADJ.html">ADJ</a></tt> tokens (100% of all `ADJ` tokens) have a non-empty value of `Foreign`.

`ADJ` tokens may have the following values of `Foreign`:

* `Yes` (2; 100% of non-empty `Foreign`): ϩⲁⲅⲓⲟⲥ, ϩⲟⲥⲟⲛ
...
1 <tt><a href="cop_bohairic-pos-NUM.html">NUM</a></tt> tokens (1% of all `NUM` tokens) have a non-empty value of `Foreign`.

The most frequent other feature values with which `NUM` and `Foreign` co-occurred: <tt><a href="cop_bohairic-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (1; 100%).

`NUM` tokens may have the following values of `Foreign`:

* `Yes` (1; 100% of non-empty `Foreign`): ⲇ
* `EMPTY` (161): ⲟⲩⲁⲓ, ⲃ, ⲓⲃ, ⲅ, ⲟⲩⲓ, ϣⲟ, ⲍ, ⲣ, ⲉ, ⲋ

### `PRON`

1 <tt><a href="cop_bohairic-pos-PRON.html">PRON</a></tt> tokens (0% of all `PRON` tokens) have a non-empty value of `Foreign`.

The most frequent other feature values with which `PRON` and `Foreign` co-occurred: <tt><a href="cop_bohairic-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="cop_bohairic-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="cop_bohairic-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="cop_bohairic-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="cop_bohairic-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (1; 100%).
...
<tt>PROPN --[<tt><a href="cop_bohairic-dep-cc.html">cc</a></tt>]--> CCONJ</tt> (3; 75%),
<tt>NOUN --[<tt><a href="cop_bohairic-dep-amod.html">amod</a></tt>]--> ADJ</tt> (1; 100%),
<tt>NOUN --[<tt><a href="cop_bohairic-dep-dislocated.html">dislocated</a></tt>]--> PROPN</tt> (1; 100%),
<tt>NOUN --[<tt><a href="cop_bohairic-dep-parataxis.html">parataxis</a></tt>]--> PROPN</tt> (1; 100%),
<tt>PROPN --[<tt><a href="cop_bohairic-dep-amod.html">amod</a></tt>]--> ADJ</tt> (1; 100%).
