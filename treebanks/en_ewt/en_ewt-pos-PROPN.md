...
There are 4810 `PROPN` lemmas (26%), 4986 `PROPN` types (22%) and 16103 `PROPN` tokens (6%).
...
The form / lemma ratio of `PROPN` is 1.036590 (the average of all parts of speech is 1.234270).
...
`PROPN` occurs with 4 features: <tt><a href="en_ewt-feat-Number.html">Number</a></tt> (16103; 100% instances), <tt><a href="en_ewt-feat-Abbr.html">Abbr</a></tt> (121; 1% instances), <tt><a href="en_ewt-feat-Typo.html">Typo</a></tt> (27; 0% instances), <tt><a href="en_ewt-feat-Style.html">Style</a></tt> (2; 0% instances)
