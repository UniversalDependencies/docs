...
* `Card` (366; 100% of non-empty `NumType`): <em>2, 1, 6, 4, 3, 5, 7, 000, 10, 100</em>
...
The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="hsb-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (49; 100%), <tt><a href="hsb-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (49; 100%), <tt><a href="hsb-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (49; 100%), <tt><a href="hsb-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (43; 88%), <tt><a href="hsb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (36; 73%).

`ADJ` tokens may have the following values of `NumType`:

* `Mult` (2; 4% of non-empty `NumType`): <em>dwójnu, trójnu</em>
* `Ord` (47; 96% of non-empty `NumType`): <em>prěni, prěnje, druhe, druhich, Třećeho, druhi, druhej, 50tych, Druheje, Druhu</em>
* `EMPTY` (1327): <em>serbski, najwjetše, serbskeje, Serbskeho, wulke, wulki, wulku, ablawtowych, dalše, wjacore</em>
...
* `Card` (36; 100% of non-empty `NumType`): <em>wjele, wjace, mjenje, tróšku, najwjace, mjeńše</em>
* `EMPTY` (485): <em>tež, tak, zwjetša, hišće, něhdźe, hižo, tu, najprjedy, potom, zaso</em>
...
* `EMPTY` (2434): <em>l, př, město, woda, rěč, rěčow, lěta, stolica, lěće, kilometrow</em>

### `DET`

4 <tt><a href="hsb-pos-DET.html">DET</a></tt> tokens (1% of all `DET` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `DET` and `NumType` co-occurred: <tt><a href="hsb-feat-Abbr.html">Abbr</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hsb-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hsb-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hsb-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="hsb-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (4; 100%).

`DET` tokens may have the following values of `NumType`:

* `Card` (4; 100% of non-empty `NumType`): <em>Wobě, mnoho, tójšto, woběmaj</em>
* `EMPTY` (290): <em>n, kotrež, jeho, jich, tute, kotryž, tutón, kotraž, swoje, tuta</em>
