---
layout: base
title:  'Statistics of amod in UD_Sanskrit-UFAL'
udver: '2'
---

## Treebank Statistics: UD_Sanskrit-UFAL: Relations: `amod`
...
1	मानुषी	मानुष	ADJ	_	Case=Nom|Gender=Fem|Number=Sing	0	root	_	Translit=mānuṣī|LTranslit=mānuṣa|Gloss=human
2	कन्या	कन	ADJ	_	Case=Nom|Degree=Sup|Gender=Fem|Number=Sing	1	amod	_	Translit=kanyā|LTranslit=kana|Gloss=smallest
3	अहम्	अहम्	PRON	_	Case=Nom|Number=Sing|Person=1|PronType=Prs	1	nsubj	_	SpaceAfter=No|Translit=aham|LTranslit=aham|Gloss=I
4	।	।	PUNCT	_	_	1	punct	_	Translit=.|LTranslit=.|Gloss=.
