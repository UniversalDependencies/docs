...
The feature is used with 2 part-of-speech tags: <tt><a href="hr_set-pos-DET.html">DET</a></tt> (1541; 1% instances), <tt><a href="hr_set-pos-ADJ.html">ADJ</a></tt> (367; 0% instances).

### `DET`

1541 <tt><a href="hr_set-pos-DET.html">DET</a></tt> tokens (21% of all `DET` tokens) have a non-empty value of `Poss`.

The most frequent other feature values with which `DET` and `Poss` co-occurred: <tt><a href="hr_set-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1463; 95%), <tt><a href="hr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1121; 73%).
...
367 <tt><a href="hr_set-pos-ADJ.html">ADJ</a></tt> tokens (2% of all `ADJ` tokens) have a non-empty value of `Poss`.

The most frequent other feature values with which `ADJ` and `Poss` co-occurred: <tt><a href="hr_set-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (367; 100%), <tt><a href="hr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (260; 71%).
