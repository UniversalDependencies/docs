...
There are 41 `SCONJ` lemmas (0%), 50 `SCONJ` types (0%) and 3049 `SCONJ` tokens (1%).
...
The form / lemma ratio of `SCONJ` is 1.219512 (the average of all parts of speech is 1.480641).
