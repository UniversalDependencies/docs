...
* `EMPTY` (1748): <em>présent, européen, présente, structurels, grande, technique, communautaire, dangereuses, possible, telle</em>
...
* `EMPTY` (1615): <em>qui, nous, il, je, vous, ce, s', se, c', que</em>
