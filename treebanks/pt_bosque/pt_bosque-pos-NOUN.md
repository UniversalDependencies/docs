...
There are 6781 `NOUN` lemmas (33%), 8629 `NOUN` types (30%) and 41386 `NOUN` tokens (18%).
...
The form / lemma ratio of `NOUN` is 1.272526 (the average of all parts of speech is 1.423132).
