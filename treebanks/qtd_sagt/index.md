...
Language: [Turkish German](/qtd/index.html) (code: `qtd`)<br/>
...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udqtd_sagt213)<br />
...
Questions, comments?
General annotation questions (either Turkish German-specific or cross-linguistic) can be raised in the [main UD issue tracker](https://github.com/UniversalDependencies/docs/issues).
You can report bugs in this treebank in the [treebank-specific issue tracker on Github](https://github.com/UniversalDependencies/UD_Turkish_German-SAGT/issues).
If you want to collaborate, please contact [ozlem&nbsp;(æt)&nbsp;ims&nbsp;•&nbsp;uni-stuttgart&nbsp;•&nbsp;de].
...
[ADJ](qtd_sagt-pos-ADJ.html) – [ADP](qtd_sagt-pos-ADP.html) – [ADV](qtd_sagt-pos-ADV.html) – [AUX](qtd_sagt-pos-AUX.html) – [CCONJ](qtd_sagt-pos-CCONJ.html) – [DET](qtd_sagt-pos-DET.html) – [INTJ](qtd_sagt-pos-INTJ.html) – [NOUN](qtd_sagt-pos-NOUN.html) – [NUM](qtd_sagt-pos-NUM.html) – [PART](qtd_sagt-pos-PART.html) – [PRON](qtd_sagt-pos-PRON.html) – [PROPN](qtd_sagt-pos-PROPN.html) – [PUNCT](qtd_sagt-pos-PUNCT.html) – [SCONJ](qtd_sagt-pos-SCONJ.html) – [SYM](qtd_sagt-pos-SYM.html) – [VERB](qtd_sagt-pos-VERB.html) – [X](qtd_sagt-pos-X.html)
...
<ul>
  <li>Equ
    <ul>
      <li>NOUN: milyonlarca</li>
      <li>PRON: bence</li>
      <li>PROPN: Türkçe, İngilizce</li>
      <li>VERB-Part: gittikçe</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Prosp
    <ul>
      <li>VERB: diyecektim, gidecektiniz, girecekti</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Nec
    <ul>
      <li>VERB: bilmeli, düşünmelisin</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Prs
    <ul>
      <li>VERB: düşünsene, kapatsana, yollasana</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Pqp
    <ul>
      <li>VERB: gitmiştik, gelmişti, gitmiştim, konuşmuştuk, yapmıştın, bakmıştım, başlamıştım, gitmişti, yapmıştım, Sormadıydım</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>CauPass
    <ul>
      <li>VERB: bekletildik, kısaltıldı</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>PassPass
    <ul>
      <li>VERB: deniliyor, deniliyordu, izleniliyor</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Rfl
    <ul>
      <li>VERB: sevineceğim, giyinebiliyorsun, giyinirdi, giyinişle, giyinmek, sevinemiyorum</li>
      <li>VERB-Vnoun: giyinişle, giyinmek</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Ord
    <ul>
      <li>NUM: 19., 6., ikincisi, Birincisi</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Yes
    <ul>
      <li>PRON: mir, mich, sich, dich, dir, uns, euch</li>
    </ul>
  </li>
</ul>
