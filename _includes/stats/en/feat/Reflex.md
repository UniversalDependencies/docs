...
The most frequent other feature values with which `PRON` and `Reflex` co-occurred: <tt><a href="Case.html">Case</a>=Acc</tt> (121; 100%), <tt><a href="PronType.html">PronType</a>=Prs</tt> (121; 100%), <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (121; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (95; 79%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (85; 70%).

`PRON` tokens may have the following values of `Reflex`:

* `Yes` (121; 100% of non-empty `Reflex`): <em>yourself, myself, themselves, itself, himself, ourselves, herself, yourselves</em>
* `EMPTY` (21107): <em>i, you, it, they, my, we, he, your, me, this</em>
