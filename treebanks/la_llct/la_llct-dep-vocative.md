---
layout: base
title:  'Statistics of vocative in UD_Latin-LLCT'
udver: '2'
---

## Treebank Statistics: UD_Latin-LLCT: Relations: `vocative`
...
The following 1 pairs of parts of speech are connected with `vocative`: <tt><a href="la_llct-pos-DET.html">DET</a></tt>-<tt><a href="la_llct-pos-NOUN.html">NOUN</a></tt> (1; 100% instances).
...
8	magister	magister	NOUN	n|n|-|s|-|-|-|m|n|-	Case=Nom|Gender=Masc|Number=Sing	4	appos	_	_
...
24	episcope	episcopus	NOUN	n|n|-|s|-|-|-|m|v|-	Case=Voc|Gender=Masc|Number=Sing	22	appos	_	SpaceAfter=No
25	,	,	PUNCT	Punc	_	27	punct	_	_
26	sancti	sanctus	ADJ	a|a|-|s|-|-|-|m|g|-	Case=Gen|Gender=Masc|Number=Sing	27	amod	_	_
27	Martini	Martinus	PROPN	Propn|n|-|s|-|-|-|m|g|-	Case=Gen|Gender=Masc|Number=Sing	19	nmod	_	_
28	infra	infra	ADP	r|r|-|-|-|-|-|-|-|-	_	30	case	_	_
