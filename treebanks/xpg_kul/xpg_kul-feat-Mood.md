...
225 tokens (13%) have a non-empty value of `Mood`.
112 types (16%) occur at least once with a non-empty value of `Mood`.
19 lemmas (8%) occur at least once with a non-empty value of `Mood`.
The feature is used with 2 part-of-speech tags: <tt><a href="xpg_kul-pos-VERB.html">VERB</a></tt> (133; 8% instances), <tt><a href="xpg_kul-pos-AUX.html">AUX</a></tt> (92; 5% instances).

### `VERB`

133 <tt><a href="xpg_kul-pos-VERB.html">VERB</a></tt> tokens (57% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="xpg_kul-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (133; 100%), <tt><a href="xpg_kul-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (133; 100%), <tt><a href="xpg_kul-feat-Person.html">Person</a></tt><tt>=3</tt> (133; 100%), <tt><a href="xpg_kul-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (133; 100%), <tt><a href="xpg_kul-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (131; 98%), <tt><a href="xpg_kul-feat-Number.html">Number</a></tt><tt>=Sing</tt> (127; 95%), <tt><a href="xpg_kul-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (121; 91%), <tt><a href="xpg_kul-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (108; 81%).

`VERB` tokens may have the following values of `Mood`:

* `Imp` (17; 13% of non-empty `Mood`): <em>εγεδου, τευτους, εγεδ[ου, εγεδ]ου, εγεδο[υ], εγουννου, ισνιο[υ], οουιτετου, τευτωσι</em>
* `Ind` (107; 80% of non-empty `Mood`): <em>αδδακετ, αδακετ, δακετ, αββερετ, αββερετοι, αδδακ[ετ, [α]δδακετ, [α]δδακεττ, [αδ]δ[ακετ], [αδακετ</em>
* `Sub` (9; 7% of non-empty `Mood`): <em>[αββ]ε̣ρετορ, βερε[τ], βερετ, δεδασσιννι, ιδετοι, ιστ?εικετ, τοτο]σσει[τι, τοτοσσει?τ?ι, τοτοσσειτι</em>
* `EMPTY` (101): <em>τιττετικμενος, τιτετικμενος, γεγρειμεναν, τιτετικμ[ενος, [γ]εγ̣[αριτ]με[ν]ος, [τ]ε̣ιττετικμενος, [τ]ετικμε[νο]ς, [τ]ιτετικμεν̣ος, [τιτ]τετικμενος, [τιττ]ετικμενος</em>
