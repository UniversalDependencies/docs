...
The following 3 pairs of parts of speech are connected with `goeswith`: <tt><a href="en_gentle-pos-PRON.html">PRON</a></tt>-<tt><a href="en_gentle-pos-X.html">X</a></tt> (3; 60% instances), <tt><a href="en_gentle-pos-DET.html">DET</a></tt>-<tt><a href="en_gentle-pos-X.html">X</a></tt> (1; 20% instances), <tt><a href="en_gentle-pos-VERB.html">VERB</a></tt>-<tt><a href="en_gentle-pos-X.html">X</a></tt> (1; 20% instances).
...
19	jail	jail	NOUN	NN	Number=Sing	16	xcomp	16:xcomp	Entity=(17-place-giv:inact-ssnsn-cf3-1-coref-Prison)
20	like	like	ADP	IN	_	21	case	21:case	_
21	me	I	PRON	PRP	Case=Acc|Number=Sing|Person=1|PronType=Prs	16	obl	16:obl:like	Entity=(8-person-giv:act-sssss-cf2-1-ana)31)30)|SpaceAfter=No
...
5	uh	uh	INTJ	UH	_	10	discourse	10:discourse	Discourse=joint-sequence_m:90->61:0:_
...
9	Alderweireld	Alderweireld	PROPN	NNP	Number=Sing	10	nsubj	10:nsubj	Entity=(57-person-giv:inact-nnnnn-cf2-1-coref-Toby_Alderweireld)
10	clipped	clip	VERB	VBD	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	3	parataxis	3:parataxis	MSeg=clipp-ed
11	Favilli	Favilli	PROPN	NNP	Number=Sing	10	obj	10:obj	Entity=(80-person-giv:act-snnnn-cf1*-1-coref)|SpaceAfter=No
...
5	Actions	action	NOUN	NNS	Number=Plur	1	obl	1:obl:of	Entity=52)|MSeg=Action-s
6	South	South	PROPN	NNP	Number=Sing	7	compound	7:compound	Discourse=evaluation-comment:49->47:2:_|Entity=(53-person-new-nnnnn-cf2-1,2,3-sgl-White_South_Africans
...
8	Europeans	European	PROPN	NNPS	Number=Plur	5	compound	5:compound	Entity=53)|MSeg=Europe-an-s
