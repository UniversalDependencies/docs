...
421 lemmas (4%) occur at least once with a non-empty value of `NumType`.
The feature is used with 4 part-of-speech tags: <tt><a href="et_ewt-pos-NUM.html">NUM</a></tt> (1402; 2% instances), <tt><a href="et_ewt-pos-ADJ.html">ADJ</a></tt> (283; 0% instances), <tt><a href="et_ewt-pos-PROPN.html">PROPN</a></tt> (2; 0% instances), <tt><a href="et_ewt-pos-SYM.html">SYM</a></tt> (1; 0% instances).

### `NUM`

1402 <tt><a href="et_ewt-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="et_ewt-feat-NumForm.html">NumForm</a></tt><tt>=Digit</tt> (1067; 76%), <tt><a href="et_ewt-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (1024; 73%), <tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (1019; 73%).

`NUM` tokens may have the following values of `NumType`:

* `Card` (1344; 96% of non-empty `NumType`): <em>2, 10, 3, 1, 100, kaks, paar, 4, ühe, üks</em>
* `Frac` (21; 1% of non-empty `NumType`): <em>poole, kolmandiku, pool, pooled, 3/4, kolmveerand, neljandik, pooleks</em>
...
`NumType` seems to be **lexical feature** of `NUM`. 96% lemmas (337) occur only with one value of `NumType`.
...
* `EMPTY` (4980): <em>hea, suur, võimalik, õige, huvitav, head, parem, vana, uus, lihtne</em>
...
1 <tt><a href="et_ewt-pos-SYM.html">SYM</a></tt> tokens (0% of all `SYM` tokens) have a non-empty value of `NumType`.

`SYM` tokens may have the following values of `NumType`:

* `Card` (1; 100% of non-empty `NumType`): <em>011100110101010</em>
* `EMPTY` (353): <em>@, %, :), :D, ;), :s, :/, =), :(, :lol:</em>

## Relations with Agreement in `NumType`

The 10 most frequent relations where parent and child node agree in `NumType`:
<tt>NUM --[<tt><a href="et_ewt-dep-conj.html">conj</a></tt>]--> NUM</tt> (71; 99%),
<tt>NUM --[<tt><a href="et_ewt-dep-compound.html">compound</a></tt>]--> NUM</tt> (36; 100%),
