...
104 <tt><a href="sv_lines-pos-ADV.html">ADV</a></tt> tokens (2% of all `ADV` tokens) have a non-empty value of `Polarity`.

The most frequent other feature values with which `ADV` and `Polarity` co-occurred: <tt><a href="sv_lines-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (99; 95%).

`ADV` tokens may have the following values of `Polarity`:

* `Neg` (104; 100% of non-empty `Polarity`): <em>aldrig, ingalunda, knappast</em>
* `EMPTY` (6669): <em>så, ut, där, upp, in, bara, här, hur, också, till</em>
