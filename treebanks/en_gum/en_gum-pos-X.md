...
There are 224 `X` lemmas (1%), 240 `X` types (1%) and 362 `X` tokens (0%).
...
The form / lemma ratio of `X` is 1.071429 (the average of all parts of speech is 1.236974).
