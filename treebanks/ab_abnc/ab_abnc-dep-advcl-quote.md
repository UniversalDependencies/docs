...
3	баҳаит	аҳара́	VERB	V_Dyn_Intr_Fin_Aor_S:3_S:Ad_IO:2SgF	Dyn=Yes|Gender[io]=Fem|Mood=Ind|Number[io]=Sing|Person[io]=2|Person[subj]=3|Subcat=Intr|Tense=Aor|VerbForm=Fin	9	advcl:quote	_	LMSeg:аҳа-ра́|SpaceAfter=No
...
9	длықәҳәҳәеит	а́-қәҳәҳәара	VERB	V_Dyn_Intr_Fin_Aor_S:3SgH_LO:3SgF	Dyn=Yes|Gender[lo]=Fem|Gender[subj]=Com|Mood=Ind|Number[lo]=Sing|Number[subj]=Sing|Person[lo]=3|Person[subj]=3|Subcat=Intr|Tense=Aor|VerbForm=Fin	0	root	_	LMSeg:а́-қә·ҳәҳәа-ра|SpaceAfter=No
...
6	шьақәирҕәҕәеит	а́-шьақәырҕәҕәара	VERB	V_Dyn_Intr_Caus_Fin_Aor_S:3SgM_DO:3_DO:Ad	Dyn=Yes|Gender[subj]=Masc|Mood=Ind|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Subcat=Intr|Tense=Aor|VerbForm=Fin|Voice=Cau	0	root	_	LMSeg:а́-шьақәы·р:ҕәҕәа-ра
