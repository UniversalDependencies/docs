...
There are 56 `DET` lemmas (0%), 129 `DET` types (0%) and 84425 `DET` tokens (15%).
...
The form / lemma ratio of `DET` is 2.303571 (the average of all parts of speech is 1.505790).
