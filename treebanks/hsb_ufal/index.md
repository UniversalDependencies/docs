...
Language: [Upper Sorbian](/hsb/index.html) (code: `hsb`)<br/>
...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udhsb_ufal210)<br />
...
You can report bugs in this treebank in the [treebank-specific issue tracker on Github](https://github.com/UniversalDependencies/UD_Upper_Sorbian-UFAL/issues).
...
[ADJ](hsb_ufal-pos-ADJ.html) – [ADP](hsb_ufal-pos-ADP.html) – [ADV](hsb_ufal-pos-ADV.html) – [AUX](hsb_ufal-pos-AUX.html) – [CCONJ](hsb_ufal-pos-CCONJ.html) – [DET](hsb_ufal-pos-DET.html) – [NOUN](hsb_ufal-pos-NOUN.html) – [NUM](hsb_ufal-pos-NUM.html) – [PART](hsb_ufal-pos-PART.html) – [PRON](hsb_ufal-pos-PRON.html) – [PROPN](hsb_ufal-pos-PROPN.html) – [PUNCT](hsb_ufal-pos-PUNCT.html) – [SCONJ](hsb_ufal-pos-SCONJ.html) – [SYM](hsb_ufal-pos-SYM.html) – [VERB](hsb_ufal-pos-VERB.html) – [X](hsb_ufal-pos-X.html)
...
<ul>
<li>This corpus contains 29 lemmas tagged as determiners (DET): jeho, jeje, jeju, jich, kajki, kotry, kotryž, kóždy, kóždyžkuli, mało, mnoho, naš, někajki, někotry, swój, tajki, tróšku, tudyši, tutón, twój, tójšto, tón, waš, wjele, wobaj, wšelaki, wšitki, wšě, žadyn</li>
</ul>
...
<ul>
  <li>Masc
    <ul>
      ...
      <li>NUM: jedyn, dwaj, Mio, dweju, jedneho, jedny, traje, štyrjoch</li>
...
<ul>
  <li>Loc
    <ul>
      ...
      <li>NUM: dwěmaj, jednym, woběmaj</li>
...
<ul>
  <li>Pos
    <ul>
      ...
      <li>ADV: němsce, často, cirka, jara, geografisce, hłownje, awtomatisce, cyle, dołho, grjeksce</li>
      <li>DET: wjele, mnoho</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Ind
    <ul>
      <li>ADV: něhdźe, druhdy, wjace, něhdy, wjele, mjenje, tróšku, mjeńše, najwjace</li>
      <li>DET: wjele, někotrych, někotre, někotři, mnoho, wšelake, kóždychžkuli, mjenje, najwjace, někajke</li>
      <li>PRON: něšto</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Tot
    <ul>
      <li>DET: wšě, wšěch, kóžde, kóždy, Kóždu, Wobě, kóždym, wšeho, wšemu, wšitke</li>
      <li>NUM: woběmaj</li>
      <li>PRON: wšitko</li>
    </ul>
  </li>
...
<ul>
  <li>Card
    <ul>
      <li>ADV: wjace, wjele, mjenje, tróšku, mjeńše, najwjace</li>
      <li>DET: wjele, mnoho, Wobě, mjenje, najwjace, tróšku, tójšto, wjace</li>
      <li>NOUN: stopjeń, třoch</li>
