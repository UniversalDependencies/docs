...
`NUM` occurs with 2 features: <tt><a href="fr_parisstories-feat-Number.html">Number</a></tt> (16; 7% instances), <tt><a href="fr_parisstories-feat-Gender.html">Gender</a></tt> (6; 2% instances)
...
Examples: <em>deux, trois, six, cinq, mille, quatre, dix, huit, quatorze, sept</em>
