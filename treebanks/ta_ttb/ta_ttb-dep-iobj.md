---
layout: base
title:  'Statistics of iobj in UD_Tamil-TTB'
udver: '2'
---

## Treebank Statistics: UD_Tamil-TTB: Relations: `iobj`

This relation is universal.

27 nodes (0%) are attached to their parents as `iobj`.

27 instances of `iobj` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 5.40740740740741.

The following 4 pairs of parts of speech are connected with `iobj`: <tt><a href="ta_ttb-pos-VERB.html">VERB</a></tt>-<tt><a href="ta_ttb-pos-NOUN.html">NOUN</a></tt> (23; 85% instances), <tt><a href="ta_ttb-pos-VERB.html">VERB</a></tt>-<tt><a href="ta_ttb-pos-PRON.html">PRON</a></tt> (2; 7% instances), <tt><a href="ta_ttb-pos-VERB.html">VERB</a></tt>-<tt><a href="ta_ttb-pos-ADJ.html">ADJ</a></tt> (1; 4% instances), <tt><a href="ta_ttb-pos-VERB.html">VERB</a></tt>-<tt><a href="ta_ttb-pos-NUM.html">NUM</a></tt> (1; 4% instances).
...
2	இருவர்	இருவர்	NOUN	NNN-3PA--	Animacy=Anim|Case=Nom|Gender=Com|Number=Plur|Person=3	6	iobj	6:iobj	Translit=iruvar|LTranslit=iruvar
...
5	ஏமாற்றத்துக்குள்ளாக்கிய்	ஏமாற்றத்துக்குள்ளாக்கு	VERB	Vt-T---AA	Polarity=Pos|VerbForm=Part|Voice=Act	0	root	0:root	Translit=ēmārrattukkuḷḷākkiy|LTranslit=ēmārrattukkuḷḷākku
6	உள்ளது	உள்	AUX	VR-T3SNAA	Gender=Neut|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|VerbForm=Fin|Voice=Act	5	aux	5:aux	Translit=uḷḷatu|LTranslit=uḷ
