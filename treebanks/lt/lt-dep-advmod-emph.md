---
layout: base
title:  'Statistics of advmod:emph in UD_Lithuanian'
udver: '2'
---

## Treebank Statistics: UD_Lithuanian: Relations: `advmod:emph`

This relation is a language-specific subtype of <tt><a href="lt-dep-advmod.html">advmod</a></tt>.
