...
8759 tokens (4%) have a non-empty value of `Voice`.
3558 types (10%) occur at least once with a non-empty value of `Voice`.
1435 lemmas (8%) occur at least once with a non-empty value of `Voice`.
The feature is used with 3 part-of-speech tags: <tt><a href="hr_set-pos-VERB.html">VERB</a></tt> (6090; 3% instances), <tt><a href="hr_set-pos-ADJ.html">ADJ</a></tt> (2054; 1% instances), <tt><a href="hr_set-pos-AUX.html">AUX</a></tt> (615; 0% instances).
