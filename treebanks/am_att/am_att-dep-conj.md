---
layout: base
title:  'Statistics of conj in UD_Amharic-ATT'
udver: '2'
---

## Treebank Statistics: UD_Amharic-ATT: Relations: `conj`
...
1	እህት	እህት	NOUN	NOUN	_	4	nsubj	_	Translit='əhətə|LTranslit='əhətə
2	ና	ና	CCONJ	CCONJ	_	3	cc	_	Translit=na|LTranslit=na
3	ወንድም	ወንድም	NOUN	NOUN	_	1	conj	_	Translit=wänədəmə|LTranslit=wänədəmə
4	ተደባደብ	ተደባደብ	VERB	VERB	Mood=Ind|VerbForm=Fin|Voice=Rcp	0	root	_	Translit=tädäbadäbə|LTranslit=tädäbadäbə
5	ኡ	እሱ	PRON	SUBJC	Number=Plur|Person=3|PronType=Prs	4	expl	_	LTranslit='əsu|Translit='u
...
1	ሦስት	ሦስት	NUM	NUM	NumType=Card	2	nummod	_	Translit=śosətə|LTranslit=śosətə
2	ሰዎች	ሰዎች	NOUN	NOUN	_	3	nsubj	_	Translit=säwočə|LTranslit=säwočə
3	መጥ	መጥ	VERB	VERB	Mood=Ind|VerbForm=Fin	0	root	_	Translit=mäţə|LTranslit=mäţə
4	ኡ	እሱ	PRON	SUBJC	Number=Plur|Person=3|PronType=Prs	3	expl	_	LTranslit='əsu|Translit='u
5	እነሱ	እሱ	PRON	PRON	Number=Plur|Person=3|PronType=Prs	7	nsubj	_	LTranslit='əsu|Translit='ənäsu
6	ም	ም	CCONJ	CCONJ	_	3	cc	_	Translit=mə|LTranslit=mə
7	ታደሰ	ታደሰ	PROPN	PROPN	_	3	conj	_	Translit=tadäsä|LTranslit=tadäsä
8	፣	፣	PUNCT	PUNCT	_	7	punct	_	Translit=,|LTranslit=,
9	ኃይሉ	ኃይሉ	PROPN	PROPN	_	7	conj	_	Translit=chajəlu|LTranslit=chajəlu
10	ና	ና	CCONJ	CCONJ	_	7	cc	_	Translit=na|LTranslit=na
11	ተፈራ	ተፈራ	PROPN	PROPN	_	7	conj	_	Translit=täfära|LTranslit=täfära
12	ን	ን	AUX	AUX	_	7	aux	_	Translit=nə|LTranslit=nə
13	ኣቸው	እሱ	PRON	SUBJC	Number=Plur|Person=3|PronType=Prs	7	expl	_	LTranslit='əsu|Translit='ačäwə
14	።	።	PUNCT	PUNCT	_	3	punct	_	Translit=.|LTranslit=.
