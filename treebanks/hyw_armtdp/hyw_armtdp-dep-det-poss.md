---
layout: base
title:  'Statistics of det:poss in UD_Western_Armenian-ArmTDP'
udver: '2'
---

## Treebank Statistics: UD_Western_Armenian-ArmTDP: Relations: `det:poss`
...
1	Ամէնքը	ամէնքը	PRON	_	Case=Nom|PronType=Tot	4	nsubj	_	Translit=Amēnk’ë|LTranslit=amēnk’ë
2	իրենց	իրենք	PRON	_	Case=Dat|Number=Plur|Person=3|PronType=Emp|Reflex=Yes	3	det:poss	_	Translit=irenc’|LTranslit=irenk’
3	մտածածները	մտածած	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Def|Number=Plur	4	obj	_	Translit=mtaçaçnerë|LTranslit=mtaçaç
4	ըսին	ըսել	VERB	_	Aspect=Perf|Mood=Ind|Number=Plur|Person=3|Polarity=Pos|Subcat=Tran|Tense=Past|VerbForm=Fin|Voice=Act	0	root	_	Translit=ësin|LTranslit=ësel|SpaceAfter=No
...
1	Ալ	ալ	ADV	_	_	6	advmod:emph	_	Translit=Al|LTranslit=al
...
17	անոր	ան	PRON	_	Case=Dat|Number=Sing|Person=3|PronType=Prs	19	iobj	_	Translit=anor|LTranslit=an
18	կ՚	կը	AUX	_	Aspect=Imp|Mood=Ind	19	aux	_	Translit=k,|LTranslit=kë|SpaceAfter=No
19	ըսէ	ըսել	VERB	_	Aspect=Prosp|Mood=Sub|Number=Sing|Person=3|Polarity=Pos|Subcat=Tran|Tense=Pres|VerbForm=Fin|Voice=Act	6	conj	_	Translit=ësē|LTranslit=ësel|SpaceAfter=No
20	,	,	PUNCT	_	_	24	punct	_	Translit=,|LTranslit=,
21	անոր	ան	PRON	_	Case=Dat|Number=Sing|Person=3|PronType=Prs	24	obl	_	Translit=anor|LTranslit=an
22	հետ	հետ	ADP	_	AdpType=Post	21	case	_	Translit=het|LTranslit=het
23	կը	կը	AUX	_	Aspect=Imp|Mood=Ind	24	aux	_	Translit=kë|LTranslit=kë
24	խօսի	խօսիլ	VERB	_	Aspect=Prosp|Mood=Sub|Number=Sing|Person=3|Polarity=Pos|Subcat=Intr|Tense=Pres|VerbForm=Fin|Voice=Mid	19	conj	_	Translit=xòsi|LTranslit=xòsil|SpaceAfter=No
25	.	.	PUNCT	_	_	6	punct	_	Translit=.|LTranslit=.
