---
layout: base
title:  'Statistics of nummod in UD_Ottoman_Turkish-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Ottoman_Turkish-TueCL: Relations: `nummod`
...
The following 2 pairs of parts of speech are connected with `nummod`: <tt><a href="ota_tuecl-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ota_tuecl-pos-NUM.html">NUM</a></tt> (4; 67% instances), <tt><a href="ota_tuecl-pos-ADV.html">ADV</a></tt>-<tt><a href="ota_tuecl-pos-NUM.html">NUM</a></tt> (2; 33% instances).
...
2	arḳadaşınıñ	arkadaş	NOUN	_	Case=Gen|Number=Sing|Number[psor]=Sing|Person[psor]=3	3	nsubj	_	_
3	yapdıġı	yap	VERB	_	Aspect=Perf|Mood=Ind|Number[psor]=Sing|Person[psor]=3|Tense=Past|VerbForm=Part	4	acl	_	_
4	yemekden	yemek	NOUN	_	Case=Abl|Number=Sing	7	obl	_	_
5	iki	iki	NUM	_	NumType=Card	6	nummod	_	_
6	ṭabaḳ	ṭabaḳ	NOUN	_	Case=Nom|Number=Sing	7	obj	_	_
7	yidi	yi	VERB	_	Aspect=Perf|Evident=Fh|Mood=Ind|Number=Sing|Person=3|Tense=Past	0	root	_	SpaceAfter=No
