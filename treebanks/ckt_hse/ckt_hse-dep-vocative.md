---
layout: base
title:  'Statistics of vocative in UD_Chukchi-HSE'
udver: '2'
---

## Treebank Statistics: UD_Chukchi-HSE: Relations: `vocative`

This relation is universal.

36 nodes (1%) are attached to their parents as `vocative`.

33 instances of `vocative` (92%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.36111111111111.

The following 3 pairs of parts of speech are connected with `vocative`: <tt><a href="ckt_hse-pos-VERB.html">VERB</a></tt>-<tt><a href="ckt_hse-pos-NOUN.html">NOUN</a></tt> (22; 61% instances), <tt><a href="ckt_hse-pos-VERB.html">VERB</a></tt>-<tt><a href="ckt_hse-pos-PROPN.html">PROPN</a></tt> (12; 33% instances), <tt><a href="ckt_hse-pos-ADV.html">ADV</a></tt>-<tt><a href="ckt_hse-pos-NOUN.html">NOUN</a></tt> (2; 6% instances).
