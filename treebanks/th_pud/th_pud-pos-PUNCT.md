...
There are 1 `PUNCT` lemmas (6%), 17 `PUNCT` types (0%) and 272 `PUNCT` tokens (1%).
Out of 16 observed tags, the rank of `PUNCT` is: 12 in number of lemmas, 13 in number of types and 13 in number of tokens.
...
The form / lemma ratio of `PUNCT` is 17.000000 (the average of all parts of speech is 269.375000).
