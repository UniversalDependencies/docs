...
8459 tokens (24%) have a non-empty value of `PronType`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="fr_spoken-pos-DET.html">DET</a></tt> (4244; 12% instances), <tt><a href="fr_spoken-pos-PRON.html">PRON</a></tt> (4215; 12% instances).

### `DET`

4244 <tt><a href="fr_spoken-pos-DET.html">DET</a></tt> tokens (95% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="fr_spoken-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3323; 78%), <tt><a href="fr_spoken-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (2755; 65%).

`DET` tokens may have the following values of `PronType`:

* `Art` (3700; 87% of non-empty `PronType`): <em>le, la, les, l', un, une, des</em>
...
4215 <tt><a href="fr_spoken-pos-PRON.html">PRON</a></tt> tokens (77% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="fr_spoken-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3046; 72%), <tt><a href="fr_spoken-feat-Person.html">Person</a></tt><tt>=3</tt> (2778; 66%).

`PRON` tokens may have the following values of `PronType`:

* `Art` (1; 0% of non-empty `PronType`): <em>un</em>
* `Dem` (1002; 24% of non-empty `PronType`): <em>c', ça, -ce, ceux, cela, celui, celle, ceci, celles</em>
* `Ind` (377; 9% of non-empty `PronType`): <em>on, tout, un, tous, une, chacun, -on, chacune, quelqu'un, aucune</em>
* `Prs` (2798; 66% of non-empty `PronType`): <em>je, il, vous, y, j', ils, se, tu, elle, s'</em>
* `Rel` (37; 1% of non-empty `PronType`): <em>dont, lequel, laquelle, lesquelles</em>
* `EMPTY` (1271): <em>qui, ce, nous, que, me, où, qu', m', autre, autres</em>
...
<tt>PRON --[<tt><a href="fr_spoken-dep-reparandum.html">reparandum</a></tt>]--> PRON</tt> (81; 84%),
