...
The feature is used with 2 part-of-speech tags: <tt><a href="qtd_sagt-pos-PRON.html">PRON</a></tt> (3800; 10% instances), <tt><a href="qtd_sagt-pos-DET.html">DET</a></tt> (1085; 3% instances).

### `PRON`

3800 <tt><a href="qtd_sagt-pos-PRON.html">PRON</a></tt> tokens (91% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="qtd_sagt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3324; 87%), <tt><a href="qtd_sagt-feat-Case.html">Case</a></tt><tt>=Nom</tt> (2630; 69%), <tt><a href="qtd_sagt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2424; 64%).

`PRON` tokens may have the following values of `PronType`:

* `Art` (34; 1% of non-empty `PronType`): <em>das, die, des, Einem</em>
* `Dem` (511; 13% of non-empty `PronType`): <em>das, die, bu, der, diese, bunu, şu, diesen, bunlar, dem</em>
...
* `Prs` (2738; 72% of non-empty `PronType`): <em>ich, es, du, ben, o, wir, ondan, mir, sie, mich</em>
...
1085 <tt><a href="qtd_sagt-pos-DET.html">DET</a></tt> tokens (64% of all `DET` tokens) have a non-empty value of `PronType`.
