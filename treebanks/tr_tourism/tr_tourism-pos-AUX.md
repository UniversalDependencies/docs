...
There are 2 `AUX` lemmas (0%), 12 `AUX` types (0%) and 1305 `AUX` tokens (1%).
...
The 10 most frequent `AUX` types:  <em>DEĞİLDİ, DEĞİL, DEĞİLİM, DEĞİLLERDİ, DEĞİLLER, DEĞİLDİM, DEĞİLDİK, DEĞİLDİLER, MİYİM, DEĞİLDİR</em>
...
The 2nd highest number of forms (3) was observed with the lemma “mi”: <em>MU, MİYDİ, MİYİM</em>.

`AUX` occurs with 10 features: <tt><a href="tr_tourism-feat-Number.html">Number</a></tt> (1190; 91% instances), <tt><a href="tr_tourism-feat-Person.html">Person</a></tt> (1190; 91% instances), <tt><a href="tr_tourism-feat-Tense.html">Tense</a></tt> (1168; 90% instances), <tt><a href="tr_tourism-feat-Mood.html">Mood</a></tt> (1163; 89% instances), <tt><a href="tr_tourism-feat-VerbForm.html">VerbForm</a></tt> (1163; 89% instances), <tt><a href="tr_tourism-feat-Aspect.html">Aspect</a></tt> (1096; 84% instances), <tt><a href="tr_tourism-feat-Case.html">Case</a></tt> (22; 2% instances), <tt><a href="tr_tourism-feat-Number-psor.html">Number[psor]</a></tt> (20; 2% instances), <tt><a href="tr_tourism-feat-Person-psor.html">Person[psor]</a></tt> (20; 2% instances), <tt><a href="tr_tourism-feat-PronType.html">PronType</a></tt> (4; 0% instances)
