...
There are 39 `ADP` lemmas (1%), 36 `ADP` types (1%) and 3470 `ADP` tokens (8%).
...
The form / lemma ratio of `ADP` is 0.923077 (the average of all parts of speech is 1.332953).
...
`ADP` occurs with 1 features: <tt><a href="fr_parisstories-feat-ExtPos.html">ExtPos</a></tt> (166; 5% instances)
