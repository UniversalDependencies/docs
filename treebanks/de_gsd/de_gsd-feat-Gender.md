...
The feature is used with 15 part-of-speech tags: <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> (50908; 17% instances), <tt><a href="de_gsd-pos-DET.html">DET</a></tt> (35836; 12% instances), <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> (27635; 9% instances), <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> (14423; 5% instances), <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> (9502; 3% instances), <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> (207; 0% instances), <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> (117; 0% instances), <tt><a href="de_gsd-pos-X.html">X</a></tt> (105; 0% instances), <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> (64; 0% instances), <tt><a href="de_gsd-pos-ADP.html">ADP</a></tt> (30; 0% instances), <tt><a href="de_gsd-pos-CCONJ.html">CCONJ</a></tt> (24; 0% instances), <tt><a href="de_gsd-pos-SCONJ.html">SCONJ</a></tt> (19; 0% instances), <tt><a href="de_gsd-pos-PART.html">PART</a></tt> (11; 0% instances), <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> (5; 0% instances), <tt><a href="de_gsd-pos-PUNCT.html">PUNCT</a></tt> (1; 0% instances).

### `NOUN`

50908 <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> tokens (97% of all `NOUN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NOUN` and `Gender` co-occurred: <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (36853; 72%).

`NOUN` tokens may have the following values of `Gender`:

* `Fem` (21159; 42% of non-empty `Gender`): <em>Zeit, Stadt, Familie, Gemeinde, Saison, Frau, Gruppe, Region, Geschichte, Kirche</em>
* `Masc` (18423; 36% of non-empty `Gender`): <em>Teil, Ort, Menschen, Platz, Sohn, km, Namen, Anfang, Titel, Meter</em>
* `Neut` (11326; 22% of non-empty `Gender`): <em>jahr, Jahre, Jahren, Prozent, Ende, %, Unternehmen, Kinder, Leben, Mitglied</em>
* `EMPTY` (1385): <em>mm, Eltern, Jahrhundert, Leute, Kosten, °, m, mal, meisten, Deutschen</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>Tag</em></td><td><em>Tage</em></td><td></td></tr>
</table>

`Gender` seems to be **lexical feature** of `NOUN`. 94% lemmas (17022) occur only with one value of `Gender`.

### `DET`

35836 <tt><a href="de_gsd-pos-DET.html">DET</a></tt> tokens (98% of all `DET` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `DET` and `Gender` co-occurred: <tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (33760; 94%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (31321; 87%), <tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (28574; 80%).

`DET` tokens may have the following values of `Gender`:

* `Fem` (15208; 42% of non-empty `Gender`): <em>der, die, eine, einer, den, seine, seiner, ihre, ihrer, seinen</em>
* `Masc` (12824; 36% of non-empty `Gender`): <em>dem, der, den, des, die, ein, einen, einem, eines, seinen</em>
* `Neut` (7804; 22% of non-empty `Gender`): <em>dem, das, ein, des, die, den, einem, der, sein, eines</em>
* `EMPTY` (576): <em>die, den, der, deren, seine, ein, ihre, all, einem, ihren</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>des</em></td><td><em>der</em></td><td><em>des, der</em></td></tr>
...
27635 <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> tokens (88% of all `PROPN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PROPN` and `Gender` co-occurred: <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (26432; 96%).

`PROPN` tokens may have the following values of `Gender`:

* `Fem` (6183; 22% of non-empty `Gender`): <em>der, SPD, Mark, University, of, die, Universität, Schweiz, US, Maria</em>
* `Masc` (13371; 48% of non-empty `Gender`): <em>Oktober, US, de, August, Mai, November, September, Juli, Peter, der</em>
* `Neut` (8081; 29% of non-empty `Gender`): <em>Deutschland, Berlin, Frankreich, München, London, Paris, New, St., Wien, Italien</em>
* `EMPTY` (3881): <em>von, the, für, of, in, a, de, an, II, Wiener</em>

<table>
  <tr><th>Paradigm <i>d</i></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th><th><tt>Neut</tt></th></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td></td><td></td><td><em>die</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>den</em></td><td><em>den</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>Den</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td></td><td><em>der</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>des</em></td><td><em>der, Die</em></td><td><em>des</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>der</em></td><td><em>der</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>der</em></td><td><em>die</em></td><td><em>Das</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>die</em></td><td></td><td><em>Die</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>d</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Dem</tt></tt></td><td></td><td></td><td><em>das</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>der</em></td><td><em>die</em></td><td></td></tr>
</table>

`Gender` seems to be **lexical feature** of `PROPN`. 90% lemmas (13545) occur only with one value of `Gender`.

### `ADJ`

14423 <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> tokens (69% of all `ADJ` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `ADJ` and `Gender` co-occurred: <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9899; 69%).

`ADJ` tokens may have the following values of `Gender`:

* `Fem` (6517; 45% of non-empty `Gender`): <em>erste, ersten, neue, weitere, große, gute, deutschen, anderen, andere, verschiedenen</em>
* `Masc` (4808; 33% of non-empty `Gender`): <em>ersten, anderen, neuen, großen, erste, weiteren, weitere, heutigen, viele, amerikanischen</em>
* `Neut` (3098; 21% of non-empty `Gender`): <em>ersten, erste, anderen, letzten, weitere, selben, neuen, gleichen, andere, neues</em>
* `EMPTY` (6522): <em>später, bekannt, gut, kurz, freundlich, lang, möglich, neu, stark, tätig</em>

<table>
  <tr><th>Paradigm <i>groß</i></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th><th><tt>Neut</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>großen, größten, größeren, grossen</em></td><td><em>große, größere, größte, grosse</em></td><td><em>großes, große, größeres</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>große, größere</em></td><td><em>große, größten, großen, größere, grössere</em></td><td><em>größere, große</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>großen, großem, größten, größerem</em></td><td><em>großen, großer, größten, größter, größerer</em></td><td><em>großen, großem, größeren, größerem, größten</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>großer, großen, größten, größerer</em></td><td><em>größten, großen, größerer, größeren</em></td><td><em>größerer, größten, großen</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>großer, größte, große, größter, größerer, grosser, grosse</em></td><td><em>große, größte, größere</em></td><td><em>großes, größte, große, grösste, größeres</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>große, größere, großen, größten</em></td><td><em>große, großen, größten, größere</em></td><td><em>große, großen, grosse</em></td></tr>
</table>

### `PRON`

9502 <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> tokens (65% of all `PRON` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PRON` and `Gender` co-occurred: <tt><a href="de_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (9501; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8341; 88%), <tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (7718; 81%), <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt> (6108; 64%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (5305; 56%).

`PRON` tokens may have the following values of `Gender`:

* `Fem` (2565; 27% of non-empty `Gender`): <em>sie, die, diese, dieser, keine, der, ihr, meine, alle, beiden</em>
* `Masc` (4147; 44% of non-empty `Gender`): <em>er, der, ihm, ihn, diesem, dieser, dem, diesen, einer, beiden</em>
* `Neut` (2790; 29% of non-empty `Gender`): <em>es, das, was, dies, dieses, allem, alles, anderem, dem, diesem</em>
* `EMPTY` (5193): <em>sich, ich, die, sie, man, wir, uns, mir, mich, denen</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Dem</tt></tt></td><td><em>der</em></td><td><em>die</em></td><td><em>das, die, des</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>der</em></td><td><em>die</em></td><td><em>das</em></td></tr>
...
207 <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> tokens (3% of all `NUM` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NUM` and `Gender` co-occurred: <tt><a href="de_gsd-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (207; 100%).

`NUM` tokens may have the following values of `Gender`:

* `Fem` (69; 33% of non-empty `Gender`): <em>eine, einer, Millionen, 15, Million, zweier, 30, 35, 6, 1.681.469</em>
* `Masc` (80; 39% of non-empty `Gender`): <em>ein, 5., einen, 6., einem, 50, 10, 24., 28, 7</em>
* `Neut` (58; 28% of non-empty `Gender`): <em>ein, einem, 3, 10, 1:1, ², +7,6, 100, 1000, 17</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>einen, ein</em></td><td><em>eine</em></td><td><em>ein</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>einem, ein</em></td><td><em>einer</em></td><td><em>einem</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td></td><td><em>einer</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>ein</em></td><td><em>eine</em></td><td><em>ein</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Ind</tt></tt></td><td></td><td><em>eine</em></td><td><em>eines</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt></tt></td><td></td><td><em>eine</em></td><td></td></tr>
</table>
...
105 <tt><a href="de_gsd-pos-X.html">X</a></tt> tokens (28% of all `X` tokens) have a non-empty value of `Gender`.
...
* `Fem` (7; 23% of non-empty `Gender`): <em>de, Fur, Gleichwie, Mitte, lt., names</em>
...
The most frequent other feature values with which `PART` and `Gender` co-occurred: <tt><a href="de_gsd-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (10; 91%).
...
<tt>NOUN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (26936; 95%),
<tt>NOUN --[<tt><a href="de_gsd-dep-amod.html">amod</a></tt>]--> ADJ</tt> (12220; 92%),
<tt>PROPN --[<tt><a href="de_gsd-dep-flat.html">flat</a></tt>]--> PROPN</tt> (4828; 81%),
<tt>PROPN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (4811; 89%),
...
<tt>NOUN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> PRON</tt> (1615; 88%),
...
<tt>PROPN --[<tt><a href="de_gsd-dep-flat.html">flat</a></tt>]--> NOUN</tt> (676; 84%).
