...
There are 41 `ADP` lemmas (2%), 36 `ADP` types (1%) and 3471 `ADP` tokens (8%).
...
* <em>d'</em>
  * <tt><a href="fr_parisstories-pos-ADP.html">ADP</a></tt> 234: <em>le sujet c' était peut-on se mettre à la place <b>d'</b> autrui ?</em>
...
The form / lemma ratio of `ADP` is 0.878049 (the average of all parts of speech is 1.324273).
