...
1	Asal	asal	NOUN	NSD	Number=Sing	7	nsubj:pass	_	MorphInd=^asal<n>_NSD$
2	-	-	PUNCT	Z--	_	1	punct	_	MorphInd=^-<z>_Z--$
3	usulnya	usul	NOUN	VSA+PS3	Number=Sing|Number[psor]=Sing|Person[psor]=3|Voice=Act	1	fixed	_	MorphInd=^usul<v>_VSA+dia<p>_PS3$
4	tari	tari	NOUN	NSD	Number=Sing	1	det	_	MorphInd=^tari<n>_NSD$
5	ini	ini	DET	B--	PronType=Dem	1	det	_	MorphInd=^ini<b>_B--$
6	tidak	tidak	PART	G--	Polarity=Neg	7	advmod	_	MorphInd=^tidak<g>_G--$
7	diketahui	diketahui	VERB	VSP	Number=Sing|Voice=Pass	0	root	_	MorphInd=^di+ketahui<v>_VSP$
8	secara	secara	ADP	R--	_	9	case	_	MorphInd=^secara<r>_R--$
9	jelas	jelas	ADJ	ASP	Degree=Pos|Number=Sing	7	xcomp	_	SpaceAfter=No|MorphInd=^jelas<a>_ASP$
10	.	.	PUNCT	Z--	_	7	punct	_	MorphInd=^.<z>_Z--$
...
# visual-style 4	fgColor:white
# visual-style 4 5 xcomp	color:blue
1	Yang	yang	PRON	S--	_	8	nsubj	_	MorphInd=^yang<s>_S--$
2	tidak	tidak	PART	G--	Polarity=Neg	3	advmod	_	MorphInd=^tidak<g>_G--$
3	mendapat	mendapat	VERB	VSA	Number=Sing|Voice=Act	1	acl	_	MorphInd=^meN+dapat<v>_VSA$
4	giliran	giliran	NOUN	NSD	Number=Sing	3	obj	_	MorphInd=^gilir<v>+an_NSD$
5	mengelola	menkelola	VERB	VSA	Number=Sing|Voice=Act	4	xcomp	_	MorphInd=^meN+kelola<v>_VSA$
...
8	bertani	bertani	VERB	VSA	Number=Sing|Voice=Act	0	root	_	MorphInd=^ber+tani<n>_VSA$
9	di	di	ADP	R--	_	10	case	_	MorphInd=^di<r>_R--$
10	kampung	kampung	NOUN	NSD	Number=Sing	8	obl	_	MorphInd=^kampung<n>_NSD$
11	halamannya	halaman	NOUN	NSD+PS3	Number=Sing|Number[psor]=Sing|Person[psor]=3	10	compound	_	SpaceAfter=No|MorphInd=^halaman<n>_NSD+dia<p>_PS3$
12	.	.	PUNCT	Z--	_	8	punct	_	MorphInd=^.<z>_Z--$
