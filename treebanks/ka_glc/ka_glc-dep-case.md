...
## Treebank Statistics: UD_Georgian-GLC: Relations: `case`
...
1	ამას	ეს	PRON	Pron	Case=Dat|Number=Sing|Person=3|PronType=Dem	3	obl	_	Translit=amas
2	გარდა	გარდა	ADP	Post	AdpType=Post|Case=Gen	1	case	_	Translit=garda
3	შესაძლო	შესაძლო	ADJ	Adj	Case=Nom|Number=Sing	0	root	_	Translit=šesażlo
4	ა	არის	AUX	Aux	Mood=Ind|Number[subj]=Sing|Person[subj]=2|Subcat=Intr|Tense=Pres	3	cop	_	Translit=a
5	სხვა	სხვა	PRON	Pron	Case=Gen|Number=Sing|PronType=Tot	6	det	_	Translit=sxva
6	პროდუქტების	პროდუქტი	NOUN	Noun	Animacy=Inan|Case=Gen|Number=Plur	9	nmod	_	Translit=produkʻtebis
7	—	—	PUNCT	F	PunctType=Dash	8	punct	_	Translit=—
8	ფერმენტების	ფერმენტი	NOUN	Noun	Animacy=Inan|Case=Gen|Number=Plur	6	conj	_	Translit=pʻermentebis
9	დამზადებაც	დამზადება	NOUN	Noun	Animacy=Inan|Case=Nom|Number=Plur	3	nsubj	_	SpaceAfter=No|Translit=damzadebacʻ
