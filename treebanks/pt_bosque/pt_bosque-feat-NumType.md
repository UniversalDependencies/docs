...
5417 tokens (2%) have a non-empty value of `NumType`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="pt_bosque-pos-NUM.html">NUM</a></tt> (4623; 2% instances), <tt><a href="pt_bosque-pos-ADJ.html">ADJ</a></tt> (790; 0% instances), <tt><a href="pt_bosque-pos-NOUN.html">NOUN</a></tt> (3; 0% instances), <tt><a href="pt_bosque-pos-PROPN.html">PROPN</a></tt> (1; 0% instances).

### `NUM`

4623 <tt><a href="pt_bosque-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

`NUM` tokens may have the following values of `NumType`:

* `Card` (4474; 97% of non-empty `NumType`): <em>um, dois, três, milhões, mil, uma, duas, quatro, cinco, 15</em>
...
* `EMPTY` (14): <em>milhões, milhares, 14, 185/60, 2, 3, 94, II, Um, dezenas</em>
...
* `EMPTY` (10538): <em>maior, grande, novo, nova, mesmo, grandes, nacional, melhor, passado, mesma</em>
...
* `EMPTY` (41307): <em>anos, presidente, ano, dia, país, pessoas, estado, parte, tempo, contos</em>
...
* `EMPTY` (18931): <em>Paulo, São, Portugal, Brasil, José, Porto, Governo, Lisboa, Nacional, João</em>

## Relations with Agreement in `NumType`

The 10 most frequent relations where parent and child node agree in `NumType`:
<tt>NUM --[<tt><a href="pt_bosque-dep-flat.html">flat</a></tt>]--> NUM</tt> (444; 98%),
