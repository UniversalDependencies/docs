...
See the link [iobj]() for dative objects of the verb when a verb has more than one object or [ccomp:cleft]() for oblique complements which are core arguments but unlike direct objects are introduced by a preposition.
