...
5	κουράγιο	κουράγιο	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	3	obj	_	_
6	να	να	SCONJ	_	_	9	mark	_	_
7	σου	εγώ	PRON	_	Case=Gen|Gender=Fem|Number=Sing|Person=2|PronType=Prs	9	iobj	_	_
...
1	Μπαίνω	μπαίνω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
2	σ	σε	ADP	_	_	4	case	_	_
3	το	ο	DET	_	Case=Acc|Definite=Def|Gender=Neut|Number=Sing|PronType=Art	4	det	_	_
4	γραφείο	γραφείο	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	1	obl	_	_
5	μου	εγώ	PRON	_	Case=Gen|Number=Sing|Person=1|Poss=Yes|PronType=Prs	4	nmod	_	_
6	με	με	ADP	_	_	9	case	_	_
7	τη	ο	DET	_	Case=Acc|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	9	det	_	_
8	δυσάρεστη	δυσάρεστος	ADJ	_	Case=Acc|Gender=Fem|Number=Sing	9	amod	_	_
9	αίσθηση	αίσθηση	NOUN	_	Case=Acc|Gender=Fem|Number=Sing	1	obl	_	_
10	ότι	ότι	SCONJ	_	_	17	mark	_	_
11	η	ο	DET	_	Case=Nom|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	12	det	_	_
...
20	αδιέξοδο	αδιέξοδο	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	17	obl	_	SpaceAfter=No
21	.	.	PUNCT	_	_	1	punct	_	PunctType=Peri
...
7	φοβόταν	φοβούμαι	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Pass	3	acl	_	SpaceAfter=No
8	.	.	PUNCT	_	_	3	punct	_	PunctType=Peri
