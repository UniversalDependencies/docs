...
The nominative case is written outside of the brackets, whereas the accusative (oblique) case is the form which combines the first part (before the dash) with the second part as written in the brackets (e.g. _satsa_ for the second person masculine singular). If nothing is written in the brackets, the nominative and the accusative case forms are identical (e.g. _tita_ for the first person singular).
