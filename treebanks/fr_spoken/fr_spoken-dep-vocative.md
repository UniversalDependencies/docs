---
layout: base
title:  'Statistics of vocative in UD_French-Spoken'
udver: '2'
---

## Treebank Statistics: UD_French-Spoken: Relations: `vocative`

This relation is universal.

5 nodes (0%) are attached to their parents as `vocative`.

4 instances of `vocative` (80%) are left-to-right (parent precedes child).
Average distance between parent and child is 3.4.

The following 3 pairs of parts of speech are connected with `vocative`: <tt><a href="fr_spoken-pos-VERB.html">VERB</a></tt>-<tt><a href="fr_spoken-pos-PROPN.html">PROPN</a></tt> (3; 60% instances), <tt><a href="fr_spoken-pos-NOUN.html">NOUN</a></tt>-<tt><a href="fr_spoken-pos-PROPN.html">PROPN</a></tt> (1; 20% instances), <tt><a href="fr_spoken-pos-VERB.html">VERB</a></tt>-<tt><a href="fr_spoken-pos-NOUN.html">NOUN</a></tt> (1; 20% instances).
...
4	bien	bien	ADV	_	_	3	advmod	_	_
5	Marguerite	Marguerite	PROPN	_	_	3	vocative	_	_
6	Duras	Duras	PROPN	_	_	5	flat	_	_
7	que	que	SCONJ	_	_	14	mark	_	_
8	v~	v~	X	_	_	14	nsubj	_	_
9	c'	ce	PRON	_	_	11	nsubj	_	_
