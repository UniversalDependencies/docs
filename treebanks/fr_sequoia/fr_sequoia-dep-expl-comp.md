...
4	l'	le	DET	_	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	5	det	_	Exponence[Gender]=Absent|SpaceAfter=No
5	actualité	actualité	NOUN	_	Gender=Fem|Number=Sing	1	obl:arg	_	Exponence[Gender]=Inherent|SpaceAfter=No
...
3	réalisation	réalisation	NOUN	_	Gender=Fem|Number=Sing	4	nsubj	_	Exponence[Gender]=Inherent
...
10	dessertes	desserte	NOUN	_	Gender=Fem|Number=Plur	8	obj	_	Exponence[Gender]=Inherent
11	de	de	ADP	_	_	12	case	_	_
12	voiries	voirie	NOUN	_	Gender=Fem|Number=Plur	10	nmod	_	Exponence[Gender]=Inherent
