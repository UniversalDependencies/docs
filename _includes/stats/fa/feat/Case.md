...
1 lemmas (8%) occur at least once with a non-empty value of `Case`.
...
* `EMPTY` (2992): چه، هیچ، خیلی، نه، حتی، بسیار، مثل، البته، چنین، چرا
...
* `EMPTY` (57551): ایران، سال، مردم، کشور، روز، کار، قرار، دست، انقلاب، تهران
