...
This relation is a language-specific subtype of <tt><a href="zh_gsdsimp-dep-flat.html">flat</a></tt>.
There are also 1 other language-specific subtypes of `flat`: <tt><a href="zh_gsdsimp-dep-flat-name.html">flat:name</a></tt>.

323 nodes (0%) are attached to their parents as `flat:foreign`.

323 instances of `flat:foreign` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.58204334365325.

The following 1 pairs of parts of speech are connected with `flat:foreign`: <tt><a href="zh_gsdsimp-pos-X.html">X</a></tt>-<tt><a href="zh_gsdsimp-pos-X.html">X</a></tt> (323; 100% instances).
