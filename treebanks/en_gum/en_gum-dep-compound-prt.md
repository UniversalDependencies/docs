...
509 nodes (0%) are attached to their parents as `compound:prt`.

507 instances of `compound:prt` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.25147347740668.

The following 6 pairs of parts of speech are connected with `compound:prt`: <tt><a href="en_gum-pos-VERB.html">VERB</a></tt>-<tt><a href="en_gum-pos-ADP.html">ADP</a></tt> (483; 95% instances), <tt><a href="en_gum-pos-VERB.html">VERB</a></tt>-<tt><a href="en_gum-pos-ADV.html">ADV</a></tt> (17; 3% instances), <tt><a href="en_gum-pos-NOUN.html">NOUN</a></tt>-<tt><a href="en_gum-pos-ADP.html">ADP</a></tt> (3; 1% instances), <tt><a href="en_gum-pos-VERB.html">VERB</a></tt>-<tt><a href="en_gum-pos-NOUN.html">NOUN</a></tt> (3; 1% instances), <tt><a href="en_gum-pos-VERB.html">VERB</a></tt>-<tt><a href="en_gum-pos-VERB.html">VERB</a></tt> (2; 0% instances), <tt><a href="en_gum-pos-NOUN.html">NOUN</a></tt>-<tt><a href="en_gum-pos-ADV.html">ADV</a></tt> (1; 0% instances).
...
6	that	that	PRON	DT	Number=Sing|PronType=Dem	3	obl	_	Entity=(event-45)
7	in	in	ADP	IN	_	9	case	_	_
8	an	a	DET	DT	Definite=Ind|PronType=Art	9	det	_	Entity=(event-47
9	exam	exam	NOUN	NN	Number=Sing	3	obl	_	Entity=event-47)|SpaceAfter=No
10	,	,	PUNCT	,	_	3	punct	_	_
11	I	I	PRON	PRP	Case=Nom|Number=Sing|Person=1|PronType=Prs	14	nsubj:pass	_	Entity=(person-6)|SpaceAfter=No
...
1	We	we	PRON	PRP	Case=Nom|Number=Plur|Person=1|PronType=Prs	3	nsubj	_	Entity=(event-29(organization-7)
...
13	out	out	ADP	RP	_	12	compound:prt	_	_
14	at	at	ADP	IN	_	17	case	_	_
15	the	the	DET	DT	Definite=Def|PronType=Art	17	det	_	Entity=(event-30
16	World	World	PROPN	NNP	Number=Sing	17	compound	_	_
17	Cup	Cup	PROPN	NNP	Number=Sing	12	nmod	_	Entity=event-30)|SpaceAfter=No
18	.	.	PUNCT	.	_	3	punct	_	Entity=event-29)
