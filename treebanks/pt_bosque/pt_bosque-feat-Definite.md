...
30907 tokens (14%) have a non-empty value of `Definite`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="pt_bosque-pos-DET.html">DET</a></tt> (30867; 14% instances), <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> (38; 0% instances), <tt><a href="pt_bosque-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances).

### `DET`

30867 <tt><a href="pt_bosque-pos-DET.html">DET</a></tt> tokens (89% of all `DET` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `DET` and `Definite` co-occurred: <tt><a href="pt_bosque-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (30867; 100%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (23916; 77%), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (16646; 54%).

`DET` tokens may have the following values of `Definite`:

* `Def` (27717; 90% of non-empty `Definite`): <em>o, a, os, as, esta, o(s), um, uma</em>
* `Ind` (3150; 10% of non-empty `Definite`): <em>um, uma, outra, Nada, o</em>
* `EMPTY` (3997): <em>sua, seu, este, esta, seus, suas, esse, todos, qualquer, cada</em>
...
* `EMPTY` (5356): <em>que, a, de, para, se, porque, por, como, em, quando</em>
