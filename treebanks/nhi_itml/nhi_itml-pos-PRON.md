...
The form / lemma ratio of `PRON` is 0.955056 (the average of all parts of speech is 1.484055).

The 1st highest number of forms (4) was observed with the lemma “_”: <em>Tlen, akin, ciqui, nochi</em>.

The 2nd highest number of forms (4) was observed with the lemma “nikanka”: <em>Nikanka, Nikankatej, Ninkankaj, nikankaj</em>.

The 3rd highest number of forms (4) was observed with the lemma “nin”: <em>nin, ninih, ninkej, ninqueh</em>.
