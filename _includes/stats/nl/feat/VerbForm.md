...
The feature is used with 4 part-of-speech tags: [nl-pos/VERB]() (20112; 10% instances), [nl-pos/AUX]() (11430; 5% instances), [nl-pos/X]() (191; 0% instances), [nl-pos/PUNCT]() (1; 0% instances).
...
* `Fin` (11700; 58% of non-empty `VerbForm`): <em>zal, heeft, kan, zou, moet, komt, wil, gaat, zullen, hebben</em>
* `Inf` (4761; 24% of non-empty `VerbForm`): <em>kunnen, gaan, komen, maken, moeten, zien, doen, laten, nemen, geven</em>
* `Part` (3651; 18% of non-empty `VerbForm`): <em>afgelopen, gedaan, volgende, gemaakt, gehad, gezien, gekregen, komende, bestaande, gegeven</em>
...
* `Fin` (7410; 65% of non-empty `VerbForm`): <em>is, was, werd, heeft, zijn, wordt, hebben, had, waren, heb</em>
* `Inf` (1128; 10% of non-empty `VerbForm`): <em>worden, zijn, hebben, blijven, gaan, komen, staan, kunnen, zitten, liggen</em>
* `Part` (2892; 25% of non-empty `VerbForm`): <em>geweest, genoemd, gehouden, geworden, gekomen, gemaakt, genomen, opgenomen, gegaan, gebruikt</em>
...
<table>
  ...
  <tr><td><tt><a href="Aspect.html">Aspect</a>=Imp|<a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>is</em></td><td></td><td></td></tr>
  <tr><td><tt><a href="Aspect.html">Aspect</a>=Imp|<a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Pres|<a href="VerbType.html">VerbType</a>=Aux,Cop</tt></td><td><em>is, Da's</em></td><td></td><td></td></tr>
...
191 [nl-pos/X]() tokens (4% of all `X` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `X` and `VerbForm` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (181; 95%), <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (172; 90%), <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (146; 76%), <tt><a href="Number.html">Number</a>=Sing</tt> (110; 58%).
...
<table>
  ...
  <tr><td><tt><a href="Definite.html">Definite</a>=Def|<a href="Degree.html">Degree</a>=Pos|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing|<a href="Tense.html">Tense</a>=Pres</tt></td><td></td><td></td><td><em>het</em></td></tr>
  <tr><td><tt><a href="Gender.html">Gender</a>=Neut</tt></td><td></td><td><em>het</em></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Sub</tt></td><td><em>het</em></td><td></td><td></td></tr>
</table>
...
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (691; 86%),
<tt>VERB --[<a href="../dep/ccomp.html">ccomp</a>]--> VERB</tt> (326; 53%),
<tt>VERB --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (270; 82%),
<tt>X --[<a href="../dep/compound.html">compound</a>]--> X</tt> (91; 100%),
<tt>AUX --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (82; 80%),
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> AUX</tt> (70; 74%),
<tt>VERB --[<a href="../dep/ccomp.html">ccomp</a>]--> AUX</tt> (61; 59%),
<tt>VERB --[<a href="../dep/advcl.html">advcl</a>]--> AUX</tt> (53; 53%),
...
6392 tokens (7%) have a non-empty value of `VerbForm`.
2302 types (15%) occur at least once with a non-empty value of `VerbForm`.
1276 lemmas (10%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 1 part-of-speech tags: [nl-pos/VERB]() (6392; 7% instances).

### `VERB`

6392 [nl-pos/VERB]() tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (3456; 54% of non-empty `VerbForm`): <em>zie, heeft, kwam, is, zijn, komt, telt, was, wint, ontstond</em>
* `Inf` (962; 15% of non-empty `VerbForm`): <em>maken, tekenen, geven, houden, bestaan, zien, nemen, gaan, hebben, komen</em>
* `Part` (1974; 31% of non-empty `VerbForm`): <em>genoemd, volgende, opgericht, gemaakt, gebruikt, gekozen, gelegen, verkozen, bestaande, gevestigd</em>
...
The 10 most frequent relations where parent and child node agree in `VerbForm`:
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (343; 66%),
<tt>VERB --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (80; 63%),
