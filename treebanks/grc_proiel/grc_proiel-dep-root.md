...
17082 nodes (8%) are attached to their parents as `root`.

17082 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 5.37138508371385.

The following 12 pairs of parts of speech are connected with `root`: -<tt><a href="grc_proiel-pos-VERB.html">VERB</a></tt> (14471; 85% instances), -<tt><a href="grc_proiel-pos-NOUN.html">NOUN</a></tt> (930; 5% instances), -<tt><a href="grc_proiel-pos-ADJ.html">ADJ</a></tt> (720; 4% instances), -<tt><a href="grc_proiel-pos-PRON.html">PRON</a></tt> (326; 2% instances), -<tt><a href="grc_proiel-pos-AUX.html">AUX</a></tt> (252; 1% instances), -<tt><a href="grc_proiel-pos-PROPN.html">PROPN</a></tt> (142; 1% instances), -<tt><a href="grc_proiel-pos-ADV.html">ADV</a></tt> (124; 1% instances), -<tt><a href="grc_proiel-pos-INTJ.html">INTJ</a></tt> (70; 0% instances), -<tt><a href="grc_proiel-pos-NUM.html">NUM</a></tt> (42; 0% instances), -<tt><a href="grc_proiel-pos-CCONJ.html">CCONJ</a></tt> (2; 0% instances), -<tt><a href="grc_proiel-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances), -<tt><a href="grc_proiel-pos-ADP.html">ADP</a></tt> (1; 0% instances).
...
4	ἐστὶ	εἰμί	AUX	V-	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	5	cop	_	LId=1|Ref=6.7.1
5	νῆσος	νῆσος	NOUN	Nb	Case=Nom|Gender=Fem|Number=Sing	0	root	_	Ref=6.7.1
6	μικρὴ	μικρός	ADJ	A-	Case=Nom|Degree=Pos|Gender=Fem|Number=Sing	5	amod	_	Ref=6.7.1
