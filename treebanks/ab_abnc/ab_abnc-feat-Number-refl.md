---
layout: base
title:  'Statistics of Number[refl] in UD_Abkhaz-AbNC'
udver: '2'
---

## Treebank Statistics: UD_Abkhaz-AbNC: Features: `Number[refl]`
...
26 tokens (0%) have a non-empty value of `Number[refl]`.
26 types (1%) occur at least once with a non-empty value of `Number[refl]`.
19 lemmas (1%) occur at least once with a non-empty value of `Number[refl]`.
The feature is used with 1 part-of-speech tags: <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> (26; 0% instances).

### `VERB`

26 <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> tokens (1% of all `VERB` tokens) have a non-empty value of `Number[refl]`.

The most frequent other feature values with which `VERB` and `Number[refl]` co-occurred: <tt><a href="ab_abnc-feat-Dyn.html">Dyn</a></tt><tt>=Yes</tt> (26; 100%), <tt><a href="ab_abnc-feat-Person-io.html">Person[io]</a></tt><tt>=EMPTY</tt> (26; 100%), <tt><a href="ab_abnc-feat-Person-obj.html">Person[obj]</a></tt><tt>=EMPTY</tt> (26; 100%), <tt><a href="ab_abnc-feat-RelType.html">RelType</a></tt><tt>=EMPTY</tt> (26; 100%), <tt><a href="ab_abnc-feat-Person-lo.html">Person[lo]</a></tt><tt>=EMPTY</tt> (25; 96%), <tt><a href="ab_abnc-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (24; 92%), <tt><a href="ab_abnc-feat-Subcat.html">Subcat</a></tt><tt>=Tran</tt> (21; 81%), <tt><a href="ab_abnc-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (17; 65%), <tt><a href="ab_abnc-feat-Gender-subj.html">Gender[subj]</a></tt><tt>=EMPTY</tt> (15; 58%), <tt><a href="ab_abnc-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt> (14; 54%).

`VERB` tokens may have the following values of `Number[refl]`:


<table>
  <tr><th>Paradigm <i>а-ҽаанкы́лара</i></th><th><tt>Plur</tt></th><th><tt>Sing</tt></th></tr>
...
`Number[refl]` seems to be **lexical feature** of `VERB`. 95% lemmas (18) occur only with one value of `Number[refl]`.
