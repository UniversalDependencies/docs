...
The feature is used with 1 part-of-speech tags: [sl-pos/NUM]() (499; 2% instances).

### `NUM`

499 [sl-pos/NUM]() tokens (100% of all `NUM` tokens) have a non-empty value of `NumForm`.

The most frequent other feature values with which `NUM` and `NumForm` co-occurred: <tt><a href="NumType.html">NumType</a>=Card</tt> (498; 100%), <tt><a href="Number.html">Number</a>=Plur</tt> (287; 58%).
