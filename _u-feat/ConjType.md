...
are other subtypes that are not yet accounted for.
...
### <a name="Pred">`Pred`</a>: subordinating conjunction introducing a secondary predicate

Examples: [pl] jako (as)


<!-- Interlanguage links updated Po 11. listopadu 2024, 20:09:35 CET -->
