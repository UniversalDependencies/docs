...
1566 lemmas (20%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 3 part-of-speech tags: <tt><a href="en_lines-pos-VERB.html">VERB</a></tt> (10791; 11% instances), <tt><a href="en_lines-pos-AUX.html">AUX</a></tt> (5163; 5% instances), <tt><a href="en_lines-pos-ADJ.html">ADJ</a></tt> (2; 0% instances).
...
* `Part` (3197; 30% of non-empty `VerbForm`): <em>going, using, done, made, looking, trying, come, moving, taken, used</em>
* `EMPTY` (317): <em>filter, group, burst, shut, edit, pleased, 'm, crossing, copying, laid</em>
...
5163 <tt><a href="en_lines-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="en_lines-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (3438; 67%), <tt><a href="en_lines-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (3438; 67%), <tt><a href="en_lines-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3354; 65%).
...
* `Part` (294; 6% of non-empty `VerbForm`): <em>been, being, having</em>
