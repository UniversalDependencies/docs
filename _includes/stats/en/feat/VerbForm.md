...
34072 [en-pos/VERB]() tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="Person.html">Person</a>=EMPTY</tt> (28392; 83%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (28381; 83%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (18082; 53%).
...
<table>
  ...
  <tr><td><tt>_</tt></td><td></td><td><em>be, are</em></td><td></td><td><em>being</em></td></tr>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>is, 's, s, ai</em></td><td></td><td></td><td></td></tr>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>are, 'm, 're, m, r, re, is</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Tense.html">Tense</a>=Past</tt></td><td></td><td></td><td><em>been</em></td><td></td></tr>
</table>

### `AUX`

9746 [en-pos/AUX]() tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="Person.html">Person</a>=EMPTY</tt> (7878; 81%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (7875; 81%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (5061; 52%), <tt><a href="Tense.html">Tense</a>=EMPTY</tt> (4934; 51%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (8737; 90% of non-empty `VerbForm`): <em>will, can, would, could, do, should, have, is, was, are</em>
...
<table>
  <tr><th>Paradigm <i>be</i></th><th><tt>Fin</tt></th><th><tt>Inf</tt></th><th><tt>Part</tt></th><th><tt>Ger</tt></th></tr>
  <tr><td><tt>_</tt></td><td></td><td><em>be, am</em></td><td></td><td><em>being</em></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Imp</tt></td><td><em>be</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=1|<a href="Tense.html">Tense</a>=Past</tt></td><td><em>was</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=1|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>am</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Past</tt></td><td><em>was</em></td><td></td><td></td><td></td></tr>
...
2 [en-pos/NOUN]() tokens (0% of all `NOUN` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `NOUN` and `VerbForm` co-occurred: <tt><a href="Number.html">Number</a>=EMPTY</tt> (2; 100%).
...
1 [en-pos/ADV]() tokens (0% of all `ADV` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `ADV` and `VerbForm` co-occurred: <tt><a href="PronType.html">PronType</a>=EMPTY</tt> (1; 100%).
...
1 [en-pos/ADP]() tokens (0% of all `ADP` tokens) have a non-empty value of `VerbForm`.
