...
There are 46 `ADP` lemmas (0%), 42 `ADP` types (0%) and 88047 `ADP` tokens (16%).
...
The form / lemma ratio of `ADP` is 0.913043 (the average of all parts of speech is 1.502206).
