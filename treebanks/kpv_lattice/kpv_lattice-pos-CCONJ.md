...
There are 13 `CCONJ` lemmas (1%), 13 `CCONJ` types (0%) and 335 `CCONJ` tokens (4%).
...
The form / lemma ratio of `CCONJ` is 1.000000 (the average of all parts of speech is 1.468128).
...
The most frequent feature combination is `_` (331 tokens).
Examples: <em>да, и, a, но, а, либӧ, дай, ни, ли, Ho</em>
