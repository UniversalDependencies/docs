...
1005 tokens (12%) have a non-empty value of `Person`.
85 types (6%) occur at least once with a non-empty value of `Person`.
82 lemmas (6%) occur at least once with a non-empty value of `Person`.
...
988 <tt><a href="yo_ytb-pos-PRON.html">PRON</a></tt> tokens (73% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="yo_ytb-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (988; 100%), <tt><a href="yo_ytb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (657; 66%), <tt><a href="yo_ytb-feat-Case.html">Case</a></tt><tt>=Nom</tt> (548; 55%).

`PRON` tokens may have the following values of `Person`:

* `1` (176; 18% of non-empty `Person`): <em>a, mi, èmi, mo, mí, wa, bíi, àwa, à, Nnaji</em>
* `2` (213; 22% of non-empty `Person`): <em>ẹ, yín, ìwọ, rẹ, ẹ̀yin, ọ, ọ́, alàtúnkọ, jọ, mọ</em>
* `3` (599; 61% of non-empty `Person`): <em>ó, rẹ̀, wọn, wọ́n, un, i, òun, a, tirẹ̀, á</em>
...
`Person` seems to be **lexical feature** of `PRON`. 93% lemmas (69) occur only with one value of `Person`.

### `ADJ`

4 <tt><a href="yo_ytb-pos-ADJ.html">ADJ</a></tt> tokens (2% of all `ADJ` tokens) have a non-empty value of `Person`.

`ADJ` tokens may have the following values of `Person`:

* `1` (4; 100% of non-empty `Person`): <em>gidi, tíkòsi´</em>
