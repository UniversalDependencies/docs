...
There are 11 `PRON` lemmas (1%), 37 `PRON` types (1%) and 2637 `PRON` tokens (11%).
...
`PRON` occurs with 4 features: <tt><a href="akk_riao-feat-Number.html">Number</a></tt> (2362; 90% instances), <tt><a href="akk_riao-feat-Person.html">Person</a></tt> (2362; 90% instances), <tt><a href="akk_riao-feat-Gender.html">Gender</a></tt> (1610; 61% instances), <tt><a href="akk_riao-feat-Case.html">Case</a></tt> (2; 0% instances)
...
The most frequent feature combination is `Number=Sing|Person=1` (752 tokens).
Examples: <em>ya, ī, ni, anāku, anni, wa, a, nim, ā, ayyâši</em>
