...
There are 555 `ADV` lemmas (2%), 582 `ADV` types (1%) and 14158 `ADV` tokens (4%).
...
The form / lemma ratio of `ADV` is 1.048649 (the average of all parts of speech is 1.307295).
...
`ADV` occurs with 4 features: <tt><a href="fr_gsd-feat-Polarity.html">Polarity</a></tt> (3225; 23% instances), <tt><a href="fr_gsd-feat-ExtPos.html">ExtPos</a></tt> (1063; 8% instances), <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt> (103; 1% instances), <tt><a href="fr_gsd-feat-Typo.html">Typo</a></tt> (32; 0% instances)
