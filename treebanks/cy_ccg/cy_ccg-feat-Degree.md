...
3322 tokens (7%) have a non-empty value of `Degree`.
1002 types (14%) occur at least once with a non-empty value of `Degree`.
738 lemmas (16%) occur at least once with a non-empty value of `Degree`.
The feature is used with 1 part-of-speech tags: <tt><a href="cy_ccg-pos-ADJ.html">ADJ</a></tt> (3322; 7% instances).

### `ADJ`

3322 <tt><a href="cy_ccg-pos-ADJ.html">ADJ</a></tt> tokens (100% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="cy_ccg-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2950; 89%), <tt><a href="cy_ccg-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (2897; 87%), <tt><a href="cy_ccg-feat-Mutation.html">Mutation</a></tt><tt>=EMPTY</tt> (2316; 70%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (162; 5% of non-empty `Degree`): <em>mwy, fwy, well, uwch, nes, bellach, hŷn, ehangach, gwell, amlach</em>
* `Equ` (30; 1% of non-empty `Degree`): <em>ogystal, cystal, belled, rhated, gryfed, gynted, gystal</em>
* `Pos` (2909; 88% of non-empty `Degree`): <em>newydd, Cymraeg, lleol, arall, pob, mawr, Gymraeg, holl, hen, bob</em>
* `Sup` (221; 7% of non-empty `Degree`): <em>mwyaf, nesaf, uchaf, cyntaf, diwethaf, fwyaf, olaf, gorau, gwaethaf, gyntaf</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="cy_ccg-feat-Mutation.html">Mutation</a></tt><tt>=SM</tt></tt></td><td><em>dda, well</em></td><td><em>well</em></td><td><em>gorau, orau</em></td><td></td></tr>
  <tr><td><tt><tt><a href="cy_ccg-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td></td><td><em>cystal</em></td></tr>
</table>

`Degree` seems to be **lexical feature** of `ADJ`. 95% lemmas (702) occur only with one value of `Degree`.

## Relations with Agreement in `Degree`

The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<tt><a href="cy_ccg-dep-conj.html">conj</a></tt>]--> ADJ</tt> (70; 99%),
...
<tt>ADJ --[<tt><a href="cy_ccg-dep-nmod.html">nmod</a></tt>]--> ADJ</tt> (1; 100%),
