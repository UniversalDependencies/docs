...
There are 21 `CCONJ` lemmas (0%), 23 `CCONJ` types (0%) and 6352 `CCONJ` tokens (3%).
...
The form / lemma ratio of `CCONJ` is 1.095238 (the average of all parts of speech is 1.452422).
