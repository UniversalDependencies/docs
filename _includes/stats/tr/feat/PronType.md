...
The feature is used with 1 part-of-speech tags: [tr-pos/PRON]() (1706; 3% instances).

### `PRON`

1706 [tr-pos/PRON]() tokens (79% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="Person[psor].html">Person[psor]</a>=EMPTY</tt> (1548; 91%), <tt><a href="Number[psor].html">Number[psor]</a>=EMPTY</tt> (1548; 91%), <tt><a href="Number.html">Number</a>=Sing</tt> (1301; 76%).
