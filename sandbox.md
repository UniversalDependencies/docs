...
mark(sváděl, Aby)
aux(sváděl, by)
advcl(ukazuje, sváděl)
advmod(odvrácené, ctnostně)
amod(zraky, odvrácené)
obj(sváděl, zraky)
punct(sváděl, ,)
nsubj(vlnu, Ty)
amod(vlnu, potměšilou)
obj(rozléváš, vlnu)
nmod(vlnu, ňader)
punct(tajících, ,)
advmod(tajících, Tak)
advmod(tajících, měkce)
amod(ňader, tajících)
punct(tajících, ,)
advmod(rozléváš, teď)
advmod(rozléváš, svůdně)
punct(obnažuješ, ,)
det(tělo, Své)
obj(obnažuješ, tělo)
advmod(obnažuješ, zase)
conj(rozléváš, obnažuješ)
punct(tknuté, ,)
det(milenci, tolika)
dep(tělo, tknuté)
obl:arg(tknuté, milenci)
punct(dráždíš, ,)
cc(dráždíš, A)
conj(rozléváš, dráždíš)
obl(dráždíš, pletí)
det:nummod(ústy, tolika)
obl(zlíbanou, ústy)
amod(pletí, zlíbanou)
cc(klínem, A)
conj(pletí, klínem)
punct(rozrývaným, ,)
det:nummod(vášněmi, tolika)
obl(rozrývaným, vášněmi)
amod(klínem, rozrývaným)
punct(rozrývaným, ,)
cc(očima, A)
conj(pletí, očima)
nmod(očima, samice)
