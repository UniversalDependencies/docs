---
layout: base
title:  'Statistics of PronType in UD_Beja-NSC'
udver: '2'
---

## Treebank Statistics: UD_Beja-NSC: Features: `PronType`
...
14 <tt><a href="bej_nsc-pos-DET.html">DET</a></tt> tokens (11% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="bej_nsc-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (14; 100%), <tt><a href="bej_nsc-feat-Deixis.html">Deixis</a></tt><tt>=Prox</tt> (13; 93%), <tt><a href="bej_nsc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (13; 93%), <tt><a href="bej_nsc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10; 71%).

`DET` tokens may have the following values of `PronType`:

* `Dem` (14; 100% of non-empty `PronType`): <em>uːn, oːn, aːn, eːn, beːn, toːt</em>
* `EMPTY` (109): <em>=b, =t, i=, oː=, uː=, toː=, w=, ti=, t=, eː=</em>
