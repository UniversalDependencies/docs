...
The 10 most frequent `INTJ` lemmas: <em>hey, ıyyk</em>
...
The form / lemma ratio of `INTJ` is 1.000000 (the average of all parts of speech is 1.517067).

The 1st highest number of forms (1) was observed with the lemma “hey”: <em>Hey</em>.

The 2nd highest number of forms (1) was observed with the lemma “ıyyk”: <em>ıyyk</em>.
