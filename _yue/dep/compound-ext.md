...
This relation is used for two closely related constructions known in Chinese linguistics as "descriptive complements" and "complements of extent". We treat them both in the same way with regards to the particles 得 _dak1_ (for descriptive complements) and 到 _dou3_ (for extent complements), where the particle is a `compound:ext` dependent of the verb it follows (with the idea that the addition of 得 or 到 changes the valence structure of the verb such that it takes a(n additional) clause or secondary predicate as its complement.
...
3	到	_	PART	_	_	2	compound:ext	_	DE
4	想	_	AUX	_	_	5	aux	_	want
5	嘔	_	VERB	_	_	2	xcomp	_	vomit
6	嘑	_	PART	_	_	5	discourse:sp	_	SP
...
2	到	_	PART	_	_	1	compound:ext	_	DE
3	連	_	ADV	_	_	6	advmod	_	even
4	膠袋	_	NOUN	_	_	6	nsubj	_	plastic-bag
5	都	_	ADV	_	_	6	advmod	_	also
6	出汗	_	VERB	_	_	1	ccomp	_	sweat
7	嘑	_	PART	_	_	6	discourse:sp	_	SP
...
Objects of the matrix verb usually cannot occur in their regular postverbal position after the V + 得/到 compound and instead must be expressed through a "verb-copying" strategy where [verb + object] is first mentioned in an adverbial clause, as illustrated in (4). 
...
1	你	_	PRON	_	_	2	nsubj	_	2SG
2	飲	_	VERB	_	_	4	advcl	_	drink
3	湯	_	NOUN	_	_	2	obj	_	soup
4	飲	_	VERB	_	_	0	root	_	drink
5	得	_	PART	_	_	4	compound:ext	_	DE
6	咁	_	ADV	_	_	7	advmod	_	so
...
~~~
<!-- Interlanguage links updated Po 29. června 2026, 18:12:01 CEST -->
