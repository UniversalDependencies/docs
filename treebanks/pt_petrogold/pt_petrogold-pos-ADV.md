...
There are 350 `ADV` lemmas (3%), 353 `ADV` types (2%) and 6443 `ADV` tokens (3%).
...
* <em>onde</em>
  * <tt><a href="pt_petrogold-pos-ADV.html">ADV</a></tt> 212: <em>Temperatura a região <b>onde</b> os hidratos são termodinamicamente estáveis .</em>
  * <tt><a href="pt_petrogold-pos-PRON.html">PRON</a></tt> 32: <em><b>onde</b></em>
* <em>muito</em>
...
The form / lemma ratio of `ADV` is 1.008571 (the average of all parts of speech is 1.452181).
...
`ADV` occurs with 5 features: <tt><a href="pt_petrogold-feat-Polarity.html">Polarity</a></tt> (565; 9% instances), <tt><a href="pt_petrogold-feat-Number.html">Number</a></tt> (218; 3% instances), <tt><a href="pt_petrogold-feat-Gender.html">Gender</a></tt> (217; 3% instances), <tt><a href="pt_petrogold-feat-PronType.html">PronType</a></tt> (213; 3% instances), <tt><a href="pt_petrogold-feat-Typo.html">Typo</a></tt> (2; 0% instances)
