...
# visual-style 2	fgColor:white
# visual-style 2 1 det	color:blue
1	Todos	todo	DET	_	Gender=Masc|Number=Plur|PronType=Tot	2	det	_	_
2	eles	eles	PRON	_	Case=Nom|Gender=Masc|Number=Plur|Person=3|PronType=Prs	3	nsubj	_	_
3	estarão	estar	VERB	_	Mood=Ind|Number=Plur|Person=3|Tense=Fut|VerbForm=Fin	0	root	_	_
4	esta	este	DET	_	Gender=Fem|Number=Sing|PronType=Dem	5	det	_	_
5	noite	noite	NOUN	_	Gender=Fem|Number=Sing	3	obl	_	_
6	em	em	ADP	_	_	7	case	_	_
7	Minneapolis	Minneapolis	PROPN	_	Gender=Masc|Number=Sing	3	obl	_	SpaceAfter=No
