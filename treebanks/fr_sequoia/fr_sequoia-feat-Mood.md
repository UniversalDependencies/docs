...
* `EMPTY` (3768): <em>voir, mis, eu, faire, traités, utilisé, atteints, administré, reçu, concernant</em>
...
* `EMPTY` (538): <em>été, être, avoir, ayant, étant, faire, fait, ETRE, faisant</em>
