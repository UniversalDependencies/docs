---
layout: base
title:  'Statistics of iobj:agent in UD_French'
udver: '2'
---

## Treebank Statistics: UD_French: Relations: `iobj:agent`

This relation is a language-specific subtype of <tt><a href="fr-dep-iobj.html">iobj</a></tt>.
...
The following 1 pairs of parts of speech are connected with `iobj:agent`: <tt><a href="fr-pos-VERB.html">VERB</a></tt>-<tt><a href="fr-pos-PRON.html">PRON</a></tt> (20; 100% instances).
