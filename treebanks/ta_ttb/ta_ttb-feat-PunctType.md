---
layout: base
title:  'Statistics of PunctType in UD_Tamil-TTB'
udver: '2'
---

## Treebank Statistics: UD_Tamil-TTB: Features: `PunctType`
...
The feature is used with 1 part-of-speech tags: <tt><a href="ta_ttb-pos-PUNCT.html">PUNCT</a></tt> (1000; 10% instances).

### `PUNCT`

1000 <tt><a href="ta_ttb-pos-PUNCT.html">PUNCT</a></tt> tokens (100% of all `PUNCT` tokens) have a non-empty value of `PunctType`.
