...
37143 tokens (11%) have a non-empty value of `AdpType`.
138 types (0%) occur at least once with a non-empty value of `AdpType`.
70 lemmas (0%) occur at least once with a non-empty value of `AdpType`.
The feature is used with 1 part-of-speech tags: <tt><a href="pl_pdb-pos-ADP.html">ADP</a></tt> (37143; 11% instances).

### `ADP`

37143 <tt><a href="pl_pdb-pos-ADP.html">ADP</a></tt> tokens (100% of all `ADP` tokens) have a non-empty value of `AdpType`.
...
* `Prep` (37074; 100% of non-empty `AdpType`): <em>na, w, do, z, o, po, za, dla, od, przez</em>
...
<tt>ADP --[<tt><a href="pl_pdb-dep-fixed.html">fixed</a></tt>]--> ADP</tt> (264; 100%),
