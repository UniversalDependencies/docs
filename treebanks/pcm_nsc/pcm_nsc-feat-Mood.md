...
1680 tokens (1%) have a non-empty value of `Mood`.
52 types (1%) occur at least once with a non-empty value of `Mood`.
33 lemmas (1%) occur at least once with a non-empty value of `Mood`.
The feature is used with 3 part-of-speech tags: <tt><a href="pcm_nsc-pos-AUX.html">AUX</a></tt> (1569; 1% instances), <tt><a href="pcm_nsc-pos-VERB.html">VERB</a></tt> (109; 0% instances), <tt><a href="pcm_nsc-pos-PRON.html">PRON</a></tt> (2; 0% instances).

### `AUX`

1569 <tt><a href="pcm_nsc-pos-AUX.html">AUX</a></tt> tokens (13% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="pcm_nsc-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (1569; 100%), <tt><a href="pcm_nsc-feat-PartType.html">PartType</a></tt><tt>=EMPTY</tt> (1569; 100%).

`AUX` tokens may have the following values of `Mood`:

* `Cnd` (40; 3% of non-empty `Mood`): <em>for</em>
* `Ind` (278; 18% of non-empty `Mood`): <em>is, are, do, was, 's, 'm, were, have, am, did</em>
* `Nec` (19; 1% of non-empty `Mood`): <em>gats, gast</em>
* `Opt` (844; 54% of non-empty `Mood`): <em>make, meh, mah, moh, mey</em>
* `Pot` (388; 25% of non-empty `Mood`): <em>fit</em>
* `EMPTY` (10701): <em>dey, go, na, con, don, be, come, bin, will, never</em>
...
* `EMPTY` (17656): <em>go, dey, do, get, say, come, know, see, tell, wan</em>
...
* `EMPTY` (18257): <em>I, you, e, we, am, de, me, my, dem, im</em>

## Relations with Agreement in `Mood`

The 10 most frequent relations where parent and child node agree in `Mood`:
<tt>AUX --[<tt><a href="pcm_nsc-dep-reparandum.html">reparandum</a></tt>]--> AUX</tt> (12; 80%).
