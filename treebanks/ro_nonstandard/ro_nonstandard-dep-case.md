...
1	Și	și	CCONJ	Ccssp	Polarity=Pos	3	cc	_	ref=MATT 3.6
2	să	sine	PRON	Px3--a--------w	Case=Acc|Person=3|PronType=Refl|Strength=Weak	3	expl:pass	_	ref=MATT 3.6
3	boteza	boteza	VERB	Vmii3s	Mood=Ind|Number=Sing|Person=3|Tense=Imp|VerbForm=Fin	0	root	_	ref=MATT 3.6
4	de	de	ADP	Spsa	AdpType=Prep|Case=Acc	6	case	_	ref=MATT 3.6
5	la	la	ADP	Spsa	AdpType=Prep|Case=Acc	4	fixed	_	ref=MATT 3.6
6	el	el	PRON	Pp3msa--------s 	Case=Acc|Gender=Masc|Number=Sing|Person=3|PronType=Prs|Strength=Strong	3	obl	_	ref=MATT 3.6
7	în	în	ADP	Spsa	AdpType=Prep|Case=Acc	8	case	_	ref=MATT 3.6
8	Iordan	Iordan	PROPN	Npmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	3	obl	_	ref=MATT 3.6
9	,	,	PUNCT	COMMA	_	10	punct	_	ref=MATT 3.6
10	ispoveduindu-	spovedi	VERB	Vmg-----p	Mood=Ger|Polarity=Pos|VerbForm=Fin	3	advcl	_	ref=MATT 3.6
11	și	sine	PRON	Px3--d--------w	Case=Dat|Person=3|PronType=Refl|Strength=Weak	10	expl:poss	_	ref=MATT 3.6
12	păcatele	păcat	NOUN	Ncfpry	Case=Acc,Nom|Definite=Def|Gender=Fem|Number=Plur	10	obj	_	ref=MATT 3.6
13	lor	el	PRON	Pp3-po	Case=Dat, Gen|Number=Plur|Person=3|PronType=Prs	12	nmod	_	ref=MATT 3.6
14	.	.	PUNCT	PERIOD	_	3	punct	_	ref=MATT 3.6
