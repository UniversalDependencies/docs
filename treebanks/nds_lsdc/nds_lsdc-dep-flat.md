---
layout: base
title:  'Statistics of flat in UD_Low_Saxon-LSDC'
udver: '2'
---

## Treebank Statistics: UD_Low_Saxon-LSDC: Relations: `flat`
...
1	Oaver	öäver	ADP	_	AdpType=Prep	3	case	_	_
2	de	de	DET	_	Case=Acc|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	3	det	_	lemma_gml=dê¹
3	kunst	kunst	NOUN	_	Case=Acc|Gender=Fem|Number=Sing	0	root	_	_
4	gesund	gesund	ADJ	_	Degree=Pos	3	acl	_	_
5	te	to	PART	_	PartType=Inf	4	mark	_	_
6	syn	weasen	AUX	_	VerbForm=Inf	4	cop	_	lemma_gml=wēsen²
7	van	van	ADP	_	AdpType=Prep	8	case	_	lemma_gml=van¹
...
1	Sou	sou	ADV	_	_	2	advmod	_	_
2	segt	seggen	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres	0	root	_	_
3	de	de	DET	_	Case=Nom|Definite=Def|Gender=Masc|Number=Sing|PronType=Art	4	det	_	lemma_gml=dê¹
4	apostel	apostel	NOUN	_	Case=Nom|Gender=Masc|Number=Sing	2	nsubj	_	_
5	Paulus	Paulus	PROPN	_	Gender=Masc|Number=Sing	4	flat	_	_
6	Röm.	Röm.	PROPN	_	_	2	parataxis	_	_
7	10	10	NUM	_	_	6	flat	_	SpaceAfter=No
8	,	,	PUNCT	_	_	9	punct	_	_
9	14	14	NUM	_	_	7	flat	_	SpaceAfter=No
...
13	der	der	X	_	Foreign=Yes	12	flat	_	_
14	Personalien	Personalien	X	_	Foreign=Yes	12	flat	_	SpaceAfter=No
15	«	«	PUNCT	_	_	12	punct	_	_
16	up	up	ADP	_	AdpType=Prep	19	case	_	lemma_gml=uppe
17	den	de	DET	_	Case=Acc,Dat|Definite=Def|Gender=Masc|Number=Sing|PronType=Art	19	det	_	lemma_gml=dê,dê,dat
18	vryen	vry	ADJ	_	Case=Acc,Dat|Degree=Pos|Gender=Masc|Number=Sing	19	amod	_	lemma_gml=vrî
19	voot	voot	NOUN	_	Case=Acc,Dat|Gender=Masc|Number=Sing	20	obl	_	lemma_gml=vôt
20	bleaven	blyven	VERB	_	Tense=Past|VerbForm=Part	0	root	_	lemma_gml=blîven
21	un	un	CCONJ	_	_	27	cc	_	lemma_gml=unde
22	hadden	hebben	AUX	_	Mood=Ind,Sub|Number=Plur|Person=3|Tense=Past	27	aux	_	lemma_gml=hebben
23	nåsten	nåsten	ADV	_	_	27	advmod	_	lemma_gml=nâsten
24	en	en	DET	_	Case=Acc|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	26	det	_	lemma_gml=êin,êine,êin
25	lütte	lüt	ADJ	_	Case=Nom|Degree=Pos|Gender=Fem|Number=Sing	26	amod	_	lemma_gml=lüttik
26	bröäke	bröäke	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	27	obj	_	lemma_gml=brȫke
27	betaald	betalen	VERB	_	Tense=Past|VerbForm=Part	20	conj	_	lemma_gml=betālen|SpaceAfter=No
