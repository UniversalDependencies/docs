...
In accordance with the UD guidelines, only cardinal numbers are tagged as NUM, whether they are adjective or substivized adjectives. Ordinal numbers are, following the UD guidelines, tagged as adjectives, while adverb numerals receive the PoS <a href="https://github.com/UniversalDependencies/docs/blob/pages-source/_grc-pos/ADV.md" target="_blank">ADV</a>.
