...
* <em>que</em>
  ...
  * <tt><a href="pt_bosque-pos-ADP.html">ADP</a></tt> 5: <em>Mas são escassas as informações sobre as várias frentes de combate , desconhecendo se até <b>que</b> ponto as forças governamentais progridem em o terreno .</em>
...
The form / lemma ratio of `PRON` is 1.852459 (the average of all parts of speech is 1.414227).
...
`PRON` occurs with 8 features: <tt><a href="pt_bosque-feat-PronType.html">PronType</a></tt> (7457; 100% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (7393; 99% instances), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (7098; 95% instances), <tt><a href="pt_bosque-feat-Case.html">Case</a></tt> (2540; 34% instances), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt> (2428; 33% instances), <tt><a href="pt_bosque-feat-Definite.html">Definite</a></tt> (38; 1% instances), <tt><a href="pt_bosque-feat-Reflex.html">Reflex</a></tt> (1; 0% instances), <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt> (1; 0% instances)

`PRON` occurs with 24 feature-value pairs: `Case=Acc`, `Case=Dat`, `Case=Nom`, `Definite=Def`, `Definite=Ind`, `Gender=Fem`, `Gender=Masc`, `Gender=Unsp`, `Number=Plur`, `Number=Sing`, `Number=Unsp`, `Person=1`, `Person=2`, `Person=3`, `PronType=Art`, `PronType=Dem`, `PronType=Ind`, `PronType=Int`, `PronType=Neg`, `PronType=Prs`, `PronType=Rel`, `PronType=Tot`, `Reflex=Yes`, `VerbForm=Ger`
