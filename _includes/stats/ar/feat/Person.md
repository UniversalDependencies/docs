...
`Person` seems to be **lexical feature** of `AUX`. 93% lemmas (43) occur only with one value of `Person`.
...
30517 [ar-pos/PRON]() tokens (98% of all `PRON` tokens) have a non-empty value of `Person`.
