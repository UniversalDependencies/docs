...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udtt_nmctt213)<br />
...
Questions, comments?
General annotation questions (either Tatar-specific or cross-linguistic) can be raised in the [main UD issue tracker](https://github.com/UniversalDependencies/docs/issues).
You can report bugs in this treebank in the [treebank-specific issue tracker on Github](https://github.com/UniversalDependencies/UD_Tatar-NMCTT/issues).
If you want to collaborate, please contact [c&nbsp;•&nbsp;taguchi&nbsp;(æt)&nbsp;sms&nbsp;•&nbsp;ed&nbsp;•&nbsp;ac&nbsp;•&nbsp;uk].
...
[ADJ](tt_nmctt-pos-ADJ.html) – [ADP](tt_nmctt-pos-ADP.html) – [ADV](tt_nmctt-pos-ADV.html) – [AUX](tt_nmctt-pos-AUX.html) – [CCONJ](tt_nmctt-pos-CCONJ.html) – [DET](tt_nmctt-pos-DET.html) – [NOUN](tt_nmctt-pos-NOUN.html) – [NUM](tt_nmctt-pos-NUM.html) – [PRON](tt_nmctt-pos-PRON.html) – [PROPN](tt_nmctt-pos-PROPN.html) – [PUNCT](tt_nmctt-pos-PUNCT.html) – [SCONJ](tt_nmctt-pos-SCONJ.html) – [SYM](tt_nmctt-pos-SYM.html) – [VERB](tt_nmctt-pos-VERB.html)

## Features

[Aspect](tt_nmctt-feat-Aspect.html) – [Case](tt_nmctt-feat-Case.html) – [Degree](tt_nmctt-feat-Degree.html) – [Foreign](tt_nmctt-feat-Foreign.html) – [Mood](tt_nmctt-feat-Mood.html) – [Number](tt_nmctt-feat-Number.html) – [Number[psor]](tt_nmctt-feat-Number-psor.html) – [NumType](tt_nmctt-feat-NumType.html) – [Person](tt_nmctt-feat-Person.html) – [Person[psor]](tt_nmctt-feat-Person-psor.html) – [Polarity](tt_nmctt-feat-Polarity.html) – [PronType](tt_nmctt-feat-PronType.html) – [Reflex](tt_nmctt-feat-Reflex.html) – [Tense](tt_nmctt-feat-Tense.html) – [VerbForm](tt_nmctt-feat-VerbForm.html) – [Voice](tt_nmctt-feat-Voice.html)

## Relations

[acl](tt_nmctt-dep-acl.html) – [advcl](tt_nmctt-dep-advcl.html) – [advmod](tt_nmctt-dep-advmod.html) – [advmod:emph](tt_nmctt-dep-advmod-emph.html) – [amod](tt_nmctt-dep-amod.html) – [appos](tt_nmctt-dep-appos.html) – [aux](tt_nmctt-dep-aux.html) – [case](tt_nmctt-dep-case.html) – [cc](tt_nmctt-dep-cc.html) – [ccomp](tt_nmctt-dep-ccomp.html) – [compound](tt_nmctt-dep-compound.html) – [compound:lvc](tt_nmctt-dep-compound-lvc.html) – [conj](tt_nmctt-dep-conj.html) – [dep](tt_nmctt-dep-dep.html) – [det](tt_nmctt-dep-det.html) – [discourse](tt_nmctt-dep-discourse.html) – [fixed](tt_nmctt-dep-fixed.html) – [flat](tt_nmctt-dep-flat.html) – [mark](tt_nmctt-dep-mark.html) – [nmod](tt_nmctt-dep-nmod.html) – [nsubj](tt_nmctt-dep-nsubj.html) – [nummod](tt_nmctt-dep-nummod.html) – [obj](tt_nmctt-dep-obj.html) – [obl](tt_nmctt-dep-obl.html) – [parataxis](tt_nmctt-dep-parataxis.html) – [punct](tt_nmctt-dep-punct.html) – [root](tt_nmctt-dep-root.html) – [xcomp](tt_nmctt-dep-xcomp.html)
...
<ul>
<li>This corpus contains 6 lemmas tagged as determiners (DET): бернинди, берничә, бу, ул, һәр, һәрбер</li>
</ul>

<ul>
<li>Out of the above, 2 lemmas occurred sometimes as PRON and sometimes as DET: бу, ул</li>
</ul>
...
<ul>
  <li>Equ
    <ul>
      <li>NOUN: сүзләренчә</li>
      <li>VERB-Part: иткәнчә, ачыклаганча</li>
      <li>VERB-Vnoun: итүенчә, әйтүенчә</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Ind
    <ul>
      <li>VERB-Part: арттырылачак, булачак, кертеләчәк, төшәчәк</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>This corpus contains 1 lemmas that occur at least once with a reflexive core object (<a>obj</a> or <a>iobj</a>). Examples: сакла үзебезне</li>
</ul>

<h3>Relations Overview</h3>

<ul>
<li>This corpus uses 2 relation subtypes: <a>advmod:emph</a>, <a>compound:lvc</a></li>
<li>The following 11 relation types are not used in this corpus at all: <a>iobj</a>, <a>csubj</a>, <a>vocative</a>, <a>expl</a>, <a>dislocated</a>, <a>cop</a>, <a>clf</a>, <a>list</a>, <a>orphan</a>, <a>goeswith</a>, <a>reparandum</a></li>
</ul>
