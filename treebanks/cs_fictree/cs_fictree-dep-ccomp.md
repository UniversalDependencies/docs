...
2	jsem	být	AUX	VB-S---1P-AA---	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	1	aux	1:aux	_
...
6	dítě	dítě	NOUN	NNNS1-----A----	Case=Nom|Gender=Neut|Number=Sing	7	nsubj	7:nsubj	_
...
4	baráku	barák	NOUN	NNIS3-----A----	Animacy=Inan|Case=Dat|Gender=Masc|Number=Sing	1	obl	1:obl:k:dat	_
...
7	jsem	být	AUX	VB-S---1P-AA---	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	6	aux	6:aux	SpaceAfter=No
...
12	holek	holka	NOUN	NNFP2-----A----	Case=Gen|Gender=Fem|Number=Plur	11	obl:arg	11:obl:arg:gen	SpaceAfter=No
...
9	štěstí	štěstí	NOUN	NNNS1-----A----	Case=Nom|Gender=Neut|Number=Sing	4	ccomp	4:ccomp	SpaceAfter=No
