...
5	ça	ça	PRON	PDEM	PronType=Dem	1	dislocated	_	_
...
9	la	le	DET	DT	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	10	det	_	_
...
16	les	le	DET	_	Definite=Def|Gender=Masc|Number=Plur|PronType=Art	17	det	_	_
17	États-Unis	États-Unis	PROPN	NN	Gender=Masc|Number=Plur	12	obl	_	Proper=True|SpaceAfter=No
18	,	,	PUNCT	,	_	12	punct	_	_
19	la	le	DET	DT	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	20	det	_	_
...
9	la	le	DET	DT	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	11	det	_	_
