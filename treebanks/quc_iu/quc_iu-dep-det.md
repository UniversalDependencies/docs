...
## Treebank Statistics: UD_Kiche-IU: Relations: `det`
...
1	Utzalaj	utz	ADJ	_	Degree=Ints	2	amod	_	_
2	ajchak	ajchak	NOUN	_	_	0	root	_	SpaceAfter=No
3	,	,	PUNCT	_	_	5	punct	_	_
4	ri	ri	DET	_	Definite=Def|PronType=Art	5	det	_	_
5	Wel	Wel	PROPN	_	Gender=Masc	2	dislocated	_	SpaceAfter=No
...
2	unan	nan¹	NOUN	_	Number[psor]=Sing|Person[psor]=3	3	nsubj	_	_
3	kukʼol	kʼol	VERB	_	Aspect=Imp|Number[obj]=Sing|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Subcat=Tran|VerbForm=Fin	0	root	_	_
4	ronojel	onojel	NOUN	_	NounType=Relat|Number[psor]=Sing|Person[psor]=3	3	obj	_	_
5	we	we	DET	_	Definite=Def|PronType=Art	6	det	_	_
6	jastaq	jastaq	NOUN	_	_	4	nmod	_	_
7	riʼ	riʼ	PRON	_	PronType=Dem	6	det	_	_
8	pa	pa	ADP	_	_	10	case	_	_
9	ri	ri	DET	_	Definite=Def|PronType=Art	10	det	_	_
10	ranimaʼ	animaʼ	NOUN	_	Number[psor]=Sing|Person[psor]=3	3	obl	_	SpaceAfter=No
