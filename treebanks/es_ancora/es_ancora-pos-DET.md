...
There are 56 `DET` lemmas (0%), 129 `DET` types (0%) and 84434 `DET` tokens (15%).
Out of 16 observed tags, the rank of `DET` is: 8 in number of lemmas, 9 in number of types and 3 in number of tokens.
...
The form / lemma ratio of `DET` is 2.303571 (the average of all parts of speech is 1.510625).

The 1st highest number of forms (6) was observed with the lemma “el”: <em>el, els, la, las, les, los</em>.
...
`DET` occurs with 11 features: <tt><a href="es_ancora-feat-PronType.html">PronType</a></tt> (84434; 100% instances), <tt><a href="es_ancora-feat-Number.html">Number</a></tt> (84357; 100% instances), <tt><a href="es_ancora-feat-Gender.html">Gender</a></tt> (78760; 93% instances), <tt><a href="es_ancora-feat-Definite.html">Definite</a></tt> (71583; 85% instances), <tt><a href="es_ancora-feat-Poss.html">Poss</a></tt> (5562; 7% instances), <tt><a href="es_ancora-feat-Person.html">Person</a></tt> (5407; 6% instances), <tt><a href="es_ancora-feat-NumType.html">NumType</a></tt> (496; 1% instances), <tt><a href="es_ancora-feat-Number-psor.html">Number[psor]</a></tt> (496; 1% instances), <tt><a href="es_ancora-feat-ExtPos.html">ExtPos</a></tt> (73; 0% instances), <tt><a href="es_ancora-feat-Foreign.html">Foreign</a></tt> (33; 0% instances), <tt><a href="es_ancora-feat-Degree.html">Degree</a></tt> (4; 0% instances)

`DET` occurs with 26 feature-value pairs: `Definite=Def`, `Definite=Ind`, `Degree=Abs`, `ExtPos=ADV`, `ExtPos=SCONJ`, `Foreign=Yes`, `Gender=Fem`, `Gender=Masc`, `NumType=Card`, `Number=Plur`, `Number=Sing`, `Number[psor]=Plur`, `Number[psor]=Sing`, `Person=1`, `Person=2`, `Person=3`, `Poss=Yes`, `PronType=Art`, `PronType=Dem`, `PronType=Exc`, `PronType=Ind`, `PronType=Int`, `PronType=Neg`, `PronType=Prs`, `PronType=Rel`, `PronType=Tot`

`DET` occurs with 88 feature combinations.
The most frequent feature combination is `Definite=Def|Gender=Masc|Number=Sing|PronType=Art` (27894 tokens).
Examples: <em>el, o</em>


## Relations

`DET` nodes are attached to their parents using 21 different relations: <tt><a href="es_ancora-dep-det.html">det</a></tt> (83205; 99% instances), <tt><a href="es_ancora-dep-fixed.html">fixed</a></tt> (454; 1% instances), <tt><a href="es_ancora-dep-nmod.html">nmod</a></tt> (210; 0% instances), <tt><a href="es_ancora-dep-nsubj.html">nsubj</a></tt> (138; 0% instances), <tt><a href="es_ancora-dep-obl.html">obl</a></tt> (112; 0% instances), <tt><a href="es_ancora-dep-conj.html">conj</a></tt> (64; 0% instances), <tt><a href="es_ancora-dep-advmod.html">advmod</a></tt> (56; 0% instances), <tt><a href="es_ancora-dep-compound.html">compound</a></tt> (45; 0% instances), <tt><a href="es_ancora-dep-appos.html">appos</a></tt> (37; 0% instances), <tt><a href="es_ancora-dep-obj.html">obj</a></tt> (26; 0% instances), <tt><a href="es_ancora-dep-root.html">root</a></tt> (21; 0% instances), <tt><a href="es_ancora-dep-mark.html">mark</a></tt> (17; 0% instances), <tt><a href="es_ancora-dep-ccomp.html">ccomp</a></tt> (14; 0% instances), <tt><a href="es_ancora-dep-acl-relcl.html">acl:relcl</a></tt> (12; 0% instances), <tt><a href="es_ancora-dep-flat.html">flat</a></tt> (7; 0% instances), <tt><a href="es_ancora-dep-advcl.html">advcl</a></tt> (6; 0% instances), <tt><a href="es_ancora-dep-obl-arg.html">obl:arg</a></tt> (5; 0% instances), <tt><a href="es_ancora-dep-xcomp.html">xcomp</a></tt> (2; 0% instances), <tt><a href="es_ancora-dep-acl.html">acl</a></tt> (1; 0% instances), <tt><a href="es_ancora-dep-csubj.html">csubj</a></tt> (1; 0% instances), <tt><a href="es_ancora-dep-parataxis.html">parataxis</a></tt> (1; 0% instances)

Parents of `DET` nodes belong to 13 different parts of speech: <tt><a href="es_ancora-pos-NOUN.html">NOUN</a></tt> (68934; 82% instances), <tt><a href="es_ancora-pos-PROPN.html">PROPN</a></tt> (9233; 11% instances), <tt><a href="es_ancora-pos-NUM.html">NUM</a></tt> (1637; 2% instances), <tt><a href="es_ancora-pos-PRON.html">PRON</a></tt> (1409; 2% instances), <tt><a href="es_ancora-pos-ADJ.html">ADJ</a></tt> (1208; 1% instances), <tt><a href="es_ancora-pos-VERB.html">VERB</a></tt> (990; 1% instances), <tt><a href="es_ancora-pos-ADP.html">ADP</a></tt> (462; 1% instances), <tt><a href="es_ancora-pos-SYM.html">SYM</a></tt> (330; 0% instances), <tt><a href="es_ancora-pos-DET.html">DET</a></tt> (105; 0% instances), <tt><a href="es_ancora-pos-ADV.html">ADV</a></tt> (94; 0% instances),  (21; 0% instances), <tt><a href="es_ancora-pos-AUX.html">AUX</a></tt> (9; 0% instances), <tt><a href="es_ancora-pos-CCONJ.html">CCONJ</a></tt> (2; 0% instances)

83691 (99%) `DET` nodes are leaves.

272 (0%) `DET` nodes have one child.

143 (0%) `DET` nodes have two children.

328 (0%) `DET` nodes have three or more children.

The highest child degree of a `DET` node is 11.

Children of `DET` nodes are attached using 27 different relations: <tt><a href="es_ancora-dep-case.html">case</a></tt> (453; 25% instances), <tt><a href="es_ancora-dep-punct.html">punct</a></tt> (248; 14% instances), <tt><a href="es_ancora-dep-nmod.html">nmod</a></tt> (198; 11% instances), <tt><a href="es_ancora-dep-nsubj.html">nsubj</a></tt> (100; 6% instances), <tt><a href="es_ancora-dep-fixed.html">fixed</a></tt> (98; 5% instances), <tt><a href="es_ancora-dep-flat.html">flat</a></tt> (95; 5% instances), <tt><a href="es_ancora-dep-mark.html">mark</a></tt> (89; 5% instances), <tt><a href="es_ancora-dep-advmod.html">advmod</a></tt> (86; 5% instances), <tt><a href="es_ancora-dep-cc.html">cc</a></tt> (65; 4% instances), <tt><a href="es_ancora-dep-det.html">det</a></tt> (62; 3% instances), <tt><a href="es_ancora-dep-obl.html">obl</a></tt> (61; 3% instances), <tt><a href="es_ancora-dep-cop.html">cop</a></tt> (51; 3% instances), <tt><a href="es_ancora-dep-compound.html">compound</a></tt> (42; 2% instances), <tt><a href="es_ancora-dep-conj.html">conj</a></tt> (32; 2% instances), <tt><a href="es_ancora-dep-obj.html">obj</a></tt> (32; 2% instances), <tt><a href="es_ancora-dep-acl-relcl.html">acl:relcl</a></tt> (20; 1% instances), <tt><a href="es_ancora-dep-acl.html">acl</a></tt> (16; 1% instances), <tt><a href="es_ancora-dep-advcl.html">advcl</a></tt> (6; 0% instances), <tt><a href="es_ancora-dep-appos.html">appos</a></tt> (6; 0% instances), <tt><a href="es_ancora-dep-dep.html">dep</a></tt> (6; 0% instances), <tt><a href="es_ancora-dep-parataxis.html">parataxis</a></tt> (6; 0% instances), <tt><a href="es_ancora-dep-aux.html">aux</a></tt> (5; 0% instances), <tt><a href="es_ancora-dep-amod.html">amod</a></tt> (4; 0% instances), <tt><a href="es_ancora-dep-obl-arg.html">obl:arg</a></tt> (3; 0% instances), <tt><a href="es_ancora-dep-csubj.html">csubj</a></tt> (2; 0% instances), <tt><a href="es_ancora-dep-nummod.html">nummod</a></tt> (2; 0% instances), <tt><a href="es_ancora-dep-orphan.html">orphan</a></tt> (1; 0% instances)

Children of `DET` nodes belong to 13 different parts of speech: <tt><a href="es_ancora-pos-ADP.html">ADP</a></tt> (469; 26% instances), <tt><a href="es_ancora-pos-NOUN.html">NOUN</a></tt> (296; 17% instances), <tt><a href="es_ancora-pos-PUNCT.html">PUNCT</a></tt> (248; 14% instances), <tt><a href="es_ancora-pos-PROPN.html">PROPN</a></tt> (220; 12% instances), <tt><a href="es_ancora-pos-ADV.html">ADV</a></tt> (125; 7% instances), <tt><a href="es_ancora-pos-DET.html">DET</a></tt> (105; 6% instances), <tt><a href="es_ancora-pos-SCONJ.html">SCONJ</a></tt> (97; 5% instances), <tt><a href="es_ancora-pos-CCONJ.html">CCONJ</a></tt> (63; 4% instances), <tt><a href="es_ancora-pos-AUX.html">AUX</a></tt> (56; 3% instances), <tt><a href="es_ancora-pos-PRON.html">PRON</a></tt> (43; 2% instances), <tt><a href="es_ancora-pos-VERB.html">VERB</a></tt> (42; 2% instances), <tt><a href="es_ancora-pos-ADJ.html">ADJ</a></tt> (21; 1% instances), <tt><a href="es_ancora-pos-NUM.html">NUM</a></tt> (4; 0% instances)
