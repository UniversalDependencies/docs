...
9	laudatum	laudo	VERB	vp1c+s3	Aspect=Perf|Case=Nom|Degree=Pos|Gender=Neut|InflClass=LatA|InflClass[noun]=IndEurO|Number=Sing|Tense=Past|VerbForm=Part|Voice=Pass	13	advcl	_	SpaceAfter=No
...
13	ymitatus	imitor	VERB	vd1c+s3	Aspect=Perf|Case=Nom|Degree=Pos|Gender=Masc|InflClass=LatA|InflClass[noun]=IndEurO|Number=Sing|Tense=Past|VerbForm=Part|Voice=Pass	0	root	_	_
14	quarto	quartus	ADJ	aums1b	Case=Abl|Degree=Pos|Gender=Masc|InflClass=IndEurO|Number=Sing|NumType=Ord	15	amod	_	_
15	consulatu	consulatus	NOUN	sms4b	Case=Abl|Gender=Masc|InflClass=IndEurU|Number=Sing|VerbForm=Part	13	obl	_	_
...
23	natus	nascor	VERB	vd3prsmn	Aspect=Perf|Case=Nom|Degree=Pos|Gender=Masc|InflClass=LatX|InflClass[noun]=IndEurO|Number=Sing|Tense=Past|VerbForm=Part|Voice=Pass	32	nsubj	_	SpaceAfter=No
...
28	gerens	gero	VERB	va3ppsmn	Aspect=Imp|Case=Nom|Degree=Pos|Gender=Masc|InflClass=LatX|InflClass[noun]=IndEurI|Number=Sing|Tense=Pres|VerbForm=Part|Voice=Act	32	advcl:pred	_	SpaceAfter=No
...
38	continenti	contineo	VERB	ans2b	Aspect=Imp|Case=Abl|Degree=Pos|Gender=Neut|InflClass=LatE|InflClass[noun]=IndEurI|Number=Sing|Tense=Pres|VerbForm=Part|Voice=Act	39	acl	_	_
