...
8 nodes (2%) are attached to their parents as `mark`.

5 instances of `mark` (63%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.75.

The following 3 pairs of parts of speech are connected with `mark`: <tt><a href="qti_butr-pos-VERB.html">VERB</a></tt>-<tt><a href="qti_butr-pos-SCONJ.html">SCONJ</a></tt> (6; 75% instances), <tt><a href="qti_butr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="qti_butr-pos-SCONJ.html">SCONJ</a></tt> (1; 13% instances), <tt><a href="qti_butr-pos-VERB.html">VERB</a></tt>-<tt><a href="qti_butr-pos-PART.html">PART</a></tt> (1; 13% instances).
...
3	bu	bu	DET	_	PronType=Dem	4	det	_	Lang=tr
4	gece	gece	NOUN	_	Case=Nom|Number=Sing|Person=3	6	obl	_	Lang=tr
5	burada	bura	PRON	_	Case=Loc|Number=Sing|Person=3|PronType=Dem	6	obl	_	Lang=tr
...
1	Bunu	bu	PRON	_	Case=Acc|Number=Sing|Person=3|PronType=Dem	2	obj	_	Lang=tr
...
6	my	my	DET	_	Poss=Yes|PronType=Prs	8	det	_	Lang=en
...
11	bir	bir	DET	_	PronType=Art	12	det	_	Lang=tr
...
1	You're	you	PRON	_	PronType=Prs	3	nsubj	_	Lang=en
...
5	onu	o	PRON	_	Case=Acc|Number=Sing|Person=3|PronType=Prs	6	obj	_	Lang=tr
6	yapmak	yap	VERB	_	Case=Nom|Polarity=Pos|VerbForm=Vnoun	3	xcomp	_	Lang=tr
7	bu	bu	DET	_	PronType=Dem	8	det	_	Lang=tr
