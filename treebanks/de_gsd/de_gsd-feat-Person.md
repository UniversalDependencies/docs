...
12429 <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> tokens (60% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (12429; 100%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (12240; 98%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9769; 79%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (6472; 52%).
...
* `3` (12023; 97% of non-empty `Person`): <em>wurde, gibt, hat, liegt, kam, hatte, gab, befindet, erhielt, war</em>
* `EMPTY` (8213): <em>empfehlen, lassen, gegründet, genannt, machen, verwendet, eingesetzt, genutzt, bezeichnet, gebaut</em>
...
`Person` seems to be **lexical feature** of `VERB`. 93% lemmas (1348) occur only with one value of `Person`.

### `AUX`

9877 <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9877; 100%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9296; 94%), <tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (7382; 75%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7325; 74%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5619; 57%).
...
* `3` (9364; 95% of non-empty `Person`): <em>ist, wurde, war, sind, wird, wurden, hat, werden, kann, waren</em>
...
<tt>VERB --[<tt><a href="de_gsd-dep-acl-relcl.html">acl:relcl</a></tt>]--> VERB</tt> (37; 56%),
