---
layout: base
title:  'Statistics of PronType in UD_Turkish-Penn'
udver: '2'
---

## Treebank Statistics: UD_Turkish-Penn: Features: `PronType`
...
* `Rcp` (18; 1% of non-empty `PronType`): <em>birbirine, birbirinden, birbirlerine, birbirini, birbirinin, birbirlerini, birbirlerinin</em>
* `EMPTY` (1): <em>Birçokları</em>

<table>
  <tr><th>Paradigm <i>o</i></th><th><tt>Prs</tt></th><th><tt>Dem</tt></th></tr>
  <tr><td><tt></tt></td><td><em>onun, o, onlar, onu, ona, onların, onları, onlara, onlardan, onunla, ondan, olarak</em></td><td><em>onlar, onun, onların, onları, onlara, onu, o, ona, onlardan, onlarla, Lord, Ondan, onunla</em></td></tr>
</table>

`PronType` seems to be **lexical feature** of `PRON`. 96% lemmas (25) occur only with one value of `PronType`.

### `AUX`

125 <tt><a href="tr_penn-pos-AUX.html">AUX</a></tt> tokens (23% of all `AUX` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `AUX` and `PronType` co-occurred: <tt><a href="tr_penn-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (125; 100%), <tt><a href="tr_penn-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (125; 100%), <tt><a href="tr_penn-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (125; 100%), <tt><a href="tr_penn-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (125; 100%), <tt><a href="tr_penn-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (125; 100%), <tt><a href="tr_penn-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (125; 100%).
...
99 <tt><a href="tr_penn-pos-ADV.html">ADV</a></tt> tokens (1% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="tr_penn-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (99; 100%).
...
<tt>DET --[<tt><a href="tr_penn-dep-det.html">det</a></tt>]--> DET</tt> (15; 100%),
