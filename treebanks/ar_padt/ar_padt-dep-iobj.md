...
11	كراكاس	كراكاس	X	U---------	_	10	nmod	10:nmod	Vform=كراكاس|Root=OOV|Translit=krākās
...
7	الحرب	حَرب	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	5	nmod	5:nmod	Vform=اَلحَربِ|Gloss=war,warfare|Root=.h_r_b|Translit=al-ḥarbi|LTranslit=ḥarb
...
10	شكل	شَكل	NOUN	N------S2I	Case=Gen|Definite=Ind|Number=Sing	7	obl	7:obl|13:obl	Vform=شَكلٍ|Gloss=manner,form,configuration,type|Root=^s_k_l|Translit=šaklin|LTranslit=šakl
...
14	العالم	عَالَم	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	13	nmod	13:nmod	Vform=اَلعَالَمِ|Gloss=world|Root=`_l_m|Translit=al-ʿālami|LTranslit=ʿālam
...
9	جيم	جيم	X	U---------	_	6	obl:arg	6:obl:arg	Vform=جيم|Root=OOV|Translit=ǧym
