...
1	Эн	эн	PRON	pron	Case=Nom|Number=Sing|Person=2|PronType=Prs	4	nsubj	_	you
2	тыс	тыс	NOUN	n	Case=Nom|Number=Sing	3	nmod	_	furskin
3	этэрбэһи	этэрбэс	NOUN	n	Case=Acc|Number=Sing	4	obj	_	boots
4	кэтэҕин	кэт	VERB	v	Number=Sing|Person=2|Tense=Pres	0	root	_	wear
5	дуо	дуо	PART	part	_	4	discourse	_	?
...
1	Атын	атын	ADJ	adj	_	2	amod	_	other
2	эт	эт	NOUN	n	Case=Nom|Number=Sing	0	root	_	meat
3	баар	баар	AUX	aux	_	2	aux	_	isthere
4	дуо	дуо	PART	part	_	2	discourse	_	?
...
3	бары	бары	PRON	pron	Case=Nom|Number=Sing|Person=3|PronType=Tot	4	nsubj	_	_
4	туруҥ	тур	VERB	vi	Mood=Imp|Number=Plur|Person=2|Tense=Pres	0	root	_	_
