...
There are 70 `ADP` lemmas (0%), 69 `ADP` types (0%) and 71083 `ADP` tokens (16%).
...
The form / lemma ratio of `ADP` is 0.985714 (the average of all parts of speech is 1.287875).
...
The most frequent feature combination is `_` (71078 tokens).
