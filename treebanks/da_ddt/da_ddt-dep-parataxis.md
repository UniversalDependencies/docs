...
The following 1 pairs of parts of speech are connected with `parataxis`: <tt><a href="da_ddt-pos-INTJ.html">INTJ</a></tt>-<tt><a href="da_ddt-pos-VERB.html">VERB</a></tt> (1; 100% instances).
...
26	kålhøgent	kålhøgen	ADJ	_	Definite=Ind|Degree=Pos|Gender=Neut|Number=Sing	20	amod	_	SpaceAfter=No
