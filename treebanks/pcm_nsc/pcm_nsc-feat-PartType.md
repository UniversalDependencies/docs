...
2787 <tt><a href="pcm_nsc-pos-AUX.html">AUX</a></tt> tokens (20% of all `AUX` tokens) have a non-empty value of `PartType`.

The most frequent other feature values with which `AUX` and `PartType` co-occurred: <tt><a href="pcm_nsc-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (2787; 100%), <tt><a href="pcm_nsc-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (2787; 100%), <tt><a href="pcm_nsc-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (2787; 100%).

`AUX` tokens may have the following values of `PartType`:

* `Cop` (2787; 100% of non-empty `PartType`): <em>na, be, it's, dat's</em>
...
* `Cop` (1; 0% of non-empty `PartType`): <em>naim</em>
