...
### <a name="Emp">`Emp`</a>: emphatic (deprecated)
...
Bearing the grammatical categories of [person](la-feat/Person) without further deictic value.
...
### <a name="Tot">`Tot`</a>: total (collective) 
