...
66 nodes (2%) are attached to their parents as `mark`.

65 instances of `mark` (98%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.45454545454545.

The following 11 pairs of parts of speech are connected with `mark`: <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt>-<tt><a href="sms_giellagas-pos-SCONJ.html">SCONJ</a></tt> (47; 71% instances), <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt>-<tt><a href="sms_giellagas-pos-SCONJ.html">SCONJ</a></tt> (5; 8% instances), <tt><a href="sms_giellagas-pos-ADJ.html">ADJ</a></tt>-<tt><a href="sms_giellagas-pos-SCONJ.html">SCONJ</a></tt> (4; 6% instances), <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt>-<tt><a href="sms_giellagas-pos-CCONJ.html">CCONJ</a></tt> (3; 5% instances), <tt><a href="sms_giellagas-pos-ADV.html">ADV</a></tt>-<tt><a href="sms_giellagas-pos-SCONJ.html">SCONJ</a></tt> (1; 2% instances), <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sms_giellagas-pos-ADV.html">ADV</a></tt> (1; 2% instances), <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sms_giellagas-pos-SCONJ.html">SCONJ</a></tt> (1; 2% instances), <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt>-<tt><a href="sms_giellagas-pos-ADV.html">ADV</a></tt> (1; 2% instances), <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt>-<tt><a href="sms_giellagas-pos-SCONJ.html">SCONJ</a></tt> (1; 2% instances), <tt><a href="sms_giellagas-pos-PROPN.html">PROPN</a></tt>-<tt><a href="sms_giellagas-pos-SCONJ.html">SCONJ</a></tt> (1; 2% instances), <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt>-<tt><a href="sms_giellagas-pos-ADV.html">ADV</a></tt> (1; 2% instances).
...
4	lij	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	10	reparandum	_	GTtags=Ind,Prs,Sg3,@+FMAINV|SpaceAfter=No
5	...	...	PUNCT	CLB	_	4	punct	_	_
6	nuʹt	nuʹtt	ADV	Adv	_	10	advmod	_	GTtags=Err/Orth,@ADVL>
7	še	še	ADV	Adv	_	6	discourse	_	GTtags=@ADVL>
8	lij	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	10	cop	_	GTtags=Ind,Prs,Sg3,@+FMAINV
...
12	lij	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	17	cop	_	GTtags=Ind,Prs,Sg3,@+FMAINV
...
16	puk-i	puk	PRON	Pron	Case=Nom|Clitic=AddI|Number=Sing|PronType=Tot	17	obj	_	GTtags=Pron,Sg,Nom,Clt
17	vääldam	väʹldded	VERB	V	Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin	10	conj	_	GTtags=Ind,Prs,Sg1,@+FMAINV|SpaceAfter=No
