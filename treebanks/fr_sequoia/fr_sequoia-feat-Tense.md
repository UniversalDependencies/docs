...
6766 tokens (10%) have a non-empty value of `Tense`.
2120 types (23%) occur at least once with a non-empty value of `Tense`.
859 lemmas (13%) occur at least once with a non-empty value of `Tense`.
The feature is used with 2 part-of-speech tags: <tt><a href="fr_sequoia-pos-VERB.html">VERB</a></tt> (4667; 7% instances), <tt><a href="fr_sequoia-pos-AUX.html">AUX</a></tt> (2099; 3% instances).

### `VERB`

4667 <tt><a href="fr_sequoia-pos-VERB.html">VERB</a></tt> tokens (79% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="fr_sequoia-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (3172; 68%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3020; 65%), <tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (2563; 55%), <tt><a href="fr_sequoia-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (2562; 55%), <tt><a href="fr_sequoia-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (2562; 55%), <tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2472; 53%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (144; 3% of non-empty `Tense`): <em>devra, pourra, aura, pourront, aurons, auront, durera, déterminera, informera, aurai</em>
* `Imp` (224; 5% of non-empty `Tense`): <em>devait, avait, pouvait, avaient, agissait, faisaient, faisait, travaillait, fallait, souhaitait</em>
* `Past` (2328; 50% of non-empty `Tense`): <em>mis, eu, traités, utilisé, atteints, administré, reçu, pris, agit, pu</em>
* `Pres` (1971; 42% of non-empty `Tense`): <em>doit, a, peut, doivent, faut, est, peuvent, concernant, voudrais, pense</em>
* `EMPTY` (1208): <em>voir, faire, prendre, avoir, utiliser, dire, partir, savoir, obtenir, recevoir</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="fr_sequoia-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt>|<tt><a href="fr_sequoia-feat-Voice.html">Voice</a></tt><tt>=Pass</tt></tt></td><td></td><td></td><td><em>dues</em></td><td></td></tr>
...
2099 <tt><a href="fr_sequoia-pos-AUX.html">AUX</a></tt> tokens (91% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="fr_sequoia-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1778; 85%), <tt><a href="fr_sequoia-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1675; 80%), <tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt> (1666; 79%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1253; 60%).

`AUX` tokens may have the following values of `Tense`:

* `Fut` (58; 3% of non-empty `Tense`): <em>sera, seront, aura, auront, aurons, fera, verront</em>
* `Imp` (194; 9% of non-empty `Tense`): <em>était, avait, étaient, avaient, étais, Etaient, avais, avions</em>
* `Past` (308; 15% of non-empty `Tense`): <em>été, fut, fait, furent, eut</em>
* `Pres` (1539; 73% of non-empty `Tense`): <em>est, a, ont, sont, ayant, ai, soit, avez, avons, aurait</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_sequoia-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="fr_sequoia-feat-Typo.html">Typo</a></tt><tt>=Yes</tt>|<tt><a href="fr_sequoia-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td></td><td></td><td></td><td><em>était</em></td></tr>
  ...
  <tr><td><tt><tt><a href="fr_sequoia-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="fr_sequoia-feat-Typo.html">Typo</a></tt><tt>=Yes</tt>|<tt><a href="fr_sequoia-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>sont</em></td><td></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="fr_sequoia-feat-Mood.html">Mood</a></tt><tt>=Sub</tt>|<tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="fr_sequoia-feat-Typo.html">Typo</a></tt><tt>=Yes</tt>|<tt><a href="fr_sequoia-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>soit</em></td><td></td><td></td><td></td></tr>
...
<tt>VERB --[<tt><a href="fr_sequoia-dep-conj.html">conj</a></tt>]--> VERB</tt> (245; 73%),
