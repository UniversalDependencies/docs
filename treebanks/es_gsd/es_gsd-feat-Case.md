...
The feature is used with 2 part-of-speech tags: <tt><a href="es_gsd-pos-PRON.html">PRON</a></tt> (9955; 2% instances), <tt><a href="es_gsd-pos-INTJ.html">INTJ</a></tt> (3; 0% instances).

### `PRON`

9955 <tt><a href="es_gsd-pos-PRON.html">PRON</a></tt> tokens (71% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="es_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (9955; 100%), <tt><a href="es_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (8971; 90%), <tt><a href="es_gsd-feat-PrepCase.html">PrepCase</a></tt><tt>=Npr</tt> (8235; 83%), <tt><a href="es_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (7089; 71%), <tt><a href="es_gsd-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (5392; 54%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (5293; 53%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (2218; 22% of non-empty `Case`): <em>lo, la, los, las, sí, mí, ti</em>
