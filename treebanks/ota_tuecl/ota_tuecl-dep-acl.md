---
layout: base
title:  'Statistics of acl in UD_Ottoman_Turkish-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Ottoman_Turkish-TueCL: Relations: `acl`
...
The following 2 pairs of parts of speech are connected with `acl`: <tt><a href="ota_tuecl-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ota_tuecl-pos-VERB.html">VERB</a></tt> (5; 83% instances), <tt><a href="ota_tuecl-pos-VERB.html">VERB</a></tt>-<tt><a href="ota_tuecl-pos-VERB.html">VERB</a></tt> (1; 17% instances).
...
4	ahdāfı	hedef	NOUN	_	Case=Acc|Gender=Fem|Number=Plur	6	obj	_	_
...
1	Muʿallim	muʿallim	NOUN	_	Case=Nom|Number=Sing	5	nsubj	_	_
2	kitābı	kitāb	NOUN	_	Case=Acc|Number=Sing	3	obj	_	_
3	alub	al	VERB	_	Mood=Ind|VerbForm=Conv	5	acl	_	_
4	mektebe	mekteb	NOUN	_	Case=Dat|Number=Sing	5	obl	_	_
