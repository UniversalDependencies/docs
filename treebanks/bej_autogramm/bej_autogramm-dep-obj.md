---
layout: base
title:  'Statistics of obj in UD_Beja-Autogramm'
udver: '2'
---

## Treebank Statistics: UD_Beja-Autogramm: Relations: `obj`

This relation is universal.

732 nodes (6%) are attached to their parents as `obj`.

588 instances of `obj` (80%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.37021857923497.

The following 10 pairs of parts of speech are connected with `obj`: <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-NOUN.html">NOUN</a></tt> (519; 71% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-PRON.html">PRON</a></tt> (181; 25% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-PROPN.html">PROPN</a></tt> (8; 1% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-INTJ.html">INTJ</a></tt> (7; 1% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-X.html">X</a></tt> (5; 1% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-ADJ.html">ADJ</a></tt> (4; 1% instances), <tt><a href="bej_autogramm-pos-NOUN.html">NOUN</a></tt>-<tt><a href="bej_autogramm-pos-NOUN.html">NOUN</a></tt> (3; 0% instances), <tt><a href="bej_autogramm-pos-NOUN.html">NOUN</a></tt>-<tt><a href="bej_autogramm-pos-PRON.html">PRON</a></tt> (2; 0% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-NUM.html">NUM</a></tt> (2; 0% instances), <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-ADV.html">ADV</a></tt> (1; 0% instances).
...
8	ini	_	VERB	V1,IRG	Aspect=Perf|Gender=Masc|Number=Sing|VerbClass=1	10	dep:comp	_	AlignBegin=36971|AlignEnd=37089|Gloss=say\PFV|MGloss=3SG.M-say\PFV|MSeg=i-ni|RX=[PNG]-[V1].[IRG]|TokenType=Root
...
1	deːm	_	PROPN	N	_	2	nmod	_	AlignBegin=40975|AlignEnd=41223|Gloss=Deem|RX=[N].[PROP]|TokenType=Root
2	sawaːkin	_	PROPN	N	_	3	obj	_	AlignBegin=41223|AlignEnd=41471|Gloss=Souakin|RX=[N].[PROP]|TokenType=Root
3	aba	_	VERB	V1	Aspect=Perf|Number=Sing|VerbClass=1	4	ccomp	_	AlignBegin=41471|AlignEnd=41719|Gloss=go\INT.PFV|MGloss=1SG-go\INT.PFV|MSeg=a-ba|Reported=Yes|RX=[PNG]-[V1].[DER].[IRG]|TokenType=Root
4	ini	_	VERB	V1	Aspect=Perf|Gender=Masc|Number=Sing|VerbClass=1	0	root	_	AlignBegin=41719|AlignEnd=41967|Gloss=say\PFV|MGloss=3SG.M-say\PFV|MSeg=i-ni|RX=[PNG]-[V1].[IRG]|TokenType=Root
5	//	_	PUNCT	PUNCT	_	4	punct	_	AlignBegin=41967|AlignEnd=42214|Gloss=//|TokenType=Break
