...
1422 tokens (7%) have a non-empty value of `PronType`.
...
The feature is used with 5 part-of-speech tags: <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> (1063; 5% instances), <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> (201; 1% instances), <tt><a href="myv_jr-pos-DET.html">DET</a></tt> (118; 1% instances), <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> (38; 0% instances), <tt><a href="myv_jr-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances).

### `PRON`

1063 <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> tokens (90% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (928; 87%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (725; 68%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (710; 67%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (611; 57%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (152; 14% of non-empty `PronType`): <em>те, неть, истямо, тень, теке, тона, се, секе, теде, истят</em>
* `Ind` (47; 4% of non-empty `PronType`): <em>кияк, мезеяк, киненьгак, киньгак, мень-бути, кодамо, конат, мезде-бути, мезе-бути, мезтькак</em>
...
* `EMPTY` (116): <em>весе, эрьва, кияк, кона, конат, сь, вейкесь, весемень, мельганзо, нть</em>
...
* `Rel` (29; 14% of non-empty `PronType`): <em>зярдо, кода, косо, козонь, зняро, кува, знярдо, зярс, ков, мекс</em>
* `Tot` (6; 3% of non-empty `PronType`): <em>свал</em>
* `EMPTY` (1504): <em>ансяк, пек, истя, мейле, ней, уш, седе, прок, яла, курок</em>
...
118 <tt><a href="myv_jr-pos-DET.html">DET</a></tt> tokens (47% of all `DET` tokens) have a non-empty value of `PronType`.
...
* `EMPTY` (131): <em>эрьва, ламо, эсь, те, лия, ве, зяро, аламо, весе, зярыя</em>
...
38 <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> tokens (4% of all `ADJ` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADJ` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=EMPTY</tt> (38; 100%), <tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=EMPTY</tt> (38; 100%), <tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (38; 100%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (32; 84%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (25; 66%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (23; 61%).

`ADJ` tokens may have the following values of `PronType`:

* `Ind` (7; 18% of non-empty `PronType`): <em>кодамояк, кодаткак</em>
* `Int` (28; 74% of non-empty `PronType`): <em>кодамо, кодат, кодмо, мень</em>
* `Rel` (3; 8% of non-empty `PronType`): <em>кодамо</em>
* `EMPTY` (857): <em>од, паро, покш, арась, якстере, мазый, сэрей, лембе, омбоце, васень</em>
...
* `EMPTY` (65): <em>зярдо, бути, теке, што, куш, кода, штобу, прок, хоть, Коли</em>
