...
1131 tokens (7%) have a non-empty value of `PronType`.
...
The feature is used with 5 part-of-speech tags: <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> (850; 5% instances), <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> (164; 1% instances), <tt><a href="myv_jr-pos-DET.html">DET</a></tt> (83; 0% instances), <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> (32; 0% instances), <tt><a href="myv_jr-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances).

### `PRON`

850 <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> tokens (89% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (747; 88%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (570; 67%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (554; 65%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (508; 60%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (120; 14% of non-empty `PronType`): <em>те, истямо, неть, тень, теке, тона, истят, теде, се, нетне</em>
...
* `Prs` (457; 54% of non-empty `PronType`): <em>сон, мон, сонзэ, сонсь, минь, тензэ, сынь, минек, тон, сынст</em>
...
164 <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> tokens (11% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (97; 59%).
...
* `Int` (101; 62% of non-empty `PronType`): <em>кода, ков, косто, косо, зняро, зярдо, мекс, козонь, Мезекс, зяро</em>
* `Rel` (28; 17% of non-empty `PronType`): <em>зярдо, кода, козонь, косо, зняро, кува, знярдо, зярс, ков, мекс</em>
* `Tot` (6; 4% of non-empty `PronType`): <em>свал</em>
* `EMPTY` (1299): <em>ансяк, пек, истя, мейле, ней, уш, седе, прок, яла, курок</em>
...
83 <tt><a href="myv_jr-pos-DET.html">DET</a></tt> tokens (42% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (67; 81%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (44; 53%).

`DET` tokens may have the following values of `PronType`:

* `Dem` (59; 71% of non-empty `PronType`): <em>те, не, се, истямо, Нона, васенце, некень, теке</em>
...
* `EMPTY` (638): <em>од, паро, покш, якстере, мазый, сэрей, омбоце, пиже, васень, тусто</em>
...
* `EMPTY` (60): <em>зярдо, бути, теке, што, кода, штобу, куш, прок, хоть, Коли</em>
