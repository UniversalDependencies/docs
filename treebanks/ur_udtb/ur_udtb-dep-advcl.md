---
layout: base
title:  'Statistics of advcl in UD_Urdu-UDTB'
udver: '2'
---

## Treebank Statistics: UD_Urdu-UDTB: Relations: `advcl`
...
1	میرے	میرے	PRON	PRP	Case=Acc,Dat|PronType=Prs	6	obl	_	Vib=کو|Tam=ko|ChunkId=NP|ChunkType=head
...
8	,	,	PUNCT	SYM	_	11	punct	_	ChunkId=VGF|ChunkType=child
...
11	احکام	حکم	NOUN	NNZ	Case=Nom|Gender=Masc|Number=Sing|Person=3	15	obl	_	Vib=0|Tam=0|ChunkId=NP4|ChunkType=head
...
17	ہی	ہی	PART	RP	_	15	dep	_	ChunkId=VGNF|ChunkType=child
...
20	۔	۔	PUNCT	SYM	_	18	punct	_	ChunkId=VGF2|ChunkType=child
