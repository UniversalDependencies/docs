...
The most frequent other feature values with which `NUM` and `NumForm` co-occurred: <tt><a href="en_ewt-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (4885; 97%).

`NUM` tokens may have the following values of `NumForm`:

* `Digit` (3927; 78% of non-empty `NumForm`): <em>2, 1, 3, 5, 4, 10, 20, 6, 2005, 2003</em>
