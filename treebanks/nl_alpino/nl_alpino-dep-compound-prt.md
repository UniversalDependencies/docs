...
1989 nodes (1%) are attached to their parents as `compound:prt`.

1167 instances of `compound:prt` (59%) are left-to-right (parent precedes child).
Average distance between parent and child is 3.52890899949723.
...
3	hij	hij	PRON	VNW|pers|pron|nomin|vol|3|ev|masc	Case=Nom|Person=3|PronType=Prs	2	nsubj	2:nsubj|8:nsubj	_
...
9	liefhebbers	liefhebber	NOUN	N|soort|mv|basis	Number=Plur	6	obl	6:obl	SpaceAfter=No
