...
1	καὶ	καί	CCONJ	_	_	6	cc	_	Gloss=and,also,even,then,next
2	ἦν	εἰμί	AUX	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	6	cop	_	Gloss=to-be
3	πᾶσα	πᾶς	ADJ	_	Case=Nom|Gender=Fem|Number=Sing	5	amod	_	Gloss=all,every
4	ἡ	ὁ	DET	_	Case=Nom|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	5	det	_	Gloss=the
5	γῆ	γῆ	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	6	nsubj	_	Gloss=earth
6	χεῖλος	χεῖλος	NOUN	_	Case=Acc,Nom|Gender=Neut|Number=Sing	0	root	_	Gloss=lip,shore
7	ἕν	εἷς	NUM	_	Case=Acc,Nom|Gender=Neut|Number=Sing|NumType=Card	6	nummod	_	Gloss=one|SpaceAfter=No
8	,	,	PUNCT	_	_	9	punct	_	_
9	καὶ	καί	CCONJ	_	_	10	cc	_	Gloss=and,also,even,then,next
10	φωνὴ	φωνή	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	6	conj	_	Gloss=voice,sound,noise
11	μία	εἷς	NUM	_	Case=Nom|Gender=Fem|Number=Sing|NumType=Card	10	nummod	_	Gloss=one
12	πᾶσιν	πᾶς	ADJ	_	Case=Dat|Gender=Masc,Neut|Number=Plur	10	iobj	_	Gloss=all,every|SpaceAfter=No
...
2	ἦν	εἰμί	AUX	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	4	cop	_	Gloss=to-be
3	Σάρα	Σάρα	PROPN	_	Case=Nom|Gender=Fem|Number=Sing	4	nsubj	_	Gloss=Sarai
4	στεῖρα	στεῖρος	ADJ	_	Case=Nom|Gender=Fem|Number=Sing	0	root	_	Gloss=barren-woman;-keel
5	καὶ	καί	CCONJ	_	_	7	cc	_	Gloss=and,also,even,then,next
6	οὐκ	οὐ	ADV	_	Polarity=Neg	7	advmod	_	Gloss=no,not
7	ἐτεκνοποίει	τεκνοποιέω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	4	conj	_	Gloss=to-produce-children|SpaceAfter=No
