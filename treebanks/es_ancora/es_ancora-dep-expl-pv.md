...
7	protejan	proteger	VERB	vmsp3p0	Mood=Sub|Number=Plur|Person=3|Tense=Pres|VerbForm=Fin	4	ccomp	4:ccomp	ArgTem=arg1:pat|SpaceAfter=No
...
18	recomendaba	recomendar	VERB	vmii3s0	Mood=Ind|Number=Sing|Person=3|Tense=Imp|VerbForm=Fin	14	acl:relcl	14:acl:relcl	_
...
23	caminando	caminar	VERB	vmg0000	VerbForm=Ger	22	advcl	22:advcl	ArgTem=argM:mnr|Entity=CESSCASTP2001030245c11)|SpaceAfter=No
...
15	apoyo	apoyo	NOUN	ncms000	Gender=Masc|Number=Sing	7	obl	7:obl	ArgTem=argM:adv|Entity=NOCOREF:Gen)|SpaceAfter=No
...
33	malos	mal	ADJ	aq0mp0	Gender=Masc|Number=Plur	30	conj	30:conj	Entity=NOCOREF:Gen)|SpaceAfter=No
