...
* `Card` (218; 100% of non-empty `NumType`): <em>du, yek, yekê, 4, siseyan, yekem, sê, 1, 10, 15'ê</em>

`NumType` seems to be **lexical feature** of `NUM`. 100% lemmas (117) occur only with one value of `NumType`.
