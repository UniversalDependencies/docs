---
layout: base
title:  'Statistics of Clitic in UD_Latin-UDante'
udver: '2'
---

## Treebank Statistics: UD_Latin-UDante: Features: `Clitic`
...
* `Yes` (33; 100% of non-empty `Clitic`): <em>ne, met, ni</em>

### `ADP`

21 <tt><a href="la_udante-pos-ADP.html">ADP</a></tt> tokens (1% of all `ADP` tokens) have a non-empty value of `Clitic`.

The most frequent other feature values with which `ADP` and `Clitic` co-occurred: <tt><a href="la_udante-feat-AdpType.html">AdpType</a></tt><tt>=Post</tt> (21; 100%).

`ADP` tokens may have the following values of `Clitic`:

* `Yes` (21; 100% of non-empty `Clitic`): <em>cum</em>

### `ADV`

5 <tt><a href="la_udante-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Clitic`.

The most frequent other feature values with which `ADV` and `Clitic` co-occurred: <tt><a href="la_udante-feat-Compound.html">Compound</a></tt><tt>=EMPTY</tt> (5; 100%), <tt><a href="la_udante-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (5; 100%), <tt><a href="la_udante-feat-PronType.html">PronType</a></tt><tt>=Int</tt> (5; 100%).

`ADV` tokens may have the following values of `Clitic`:

* `Yes` (5; 100% of non-empty `Clitic`): <em>quid</em>
...
* `Yes` (3; 100% of non-empty `Clitic`): <em>ipsum, ipsos</em>
