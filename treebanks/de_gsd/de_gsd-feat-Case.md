...
`Case` seems to be **lexical feature** of `VERB`. 97% lemmas (105) occur only with one value of `Case`.
...
<tt>PROPN --[<tt><a href="de_gsd-dep-flat.html">flat</a></tt>]--> PROPN</tt> (5161; 86%),
