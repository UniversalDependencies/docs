...
There are also 2 other language-specific subtypes of `nmod`: <tt><a href="kpv_lattice-dep-nmod-obj.html">nmod:obj</a></tt>, <tt><a href="kpv_lattice-dep-nmod-poss.html">nmod:poss</a></tt>.
...
2	ылысмӧм	ылысмыны	VERB	V	Case=Nom|Number=Sing|VerbForm=Vnoun	5	advcl	_	GTtags=IV,Der,Der/ӧм,Der/NomAct,N,Sg,Nom
...
5	лэччис	лэччыны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=IV,Ind,Prt1,Sg3
6	тшӧтш	тшӧтш	ADV	Adv	_	5	advmod	_	_
7	пыж	пыж	NOUN	N	Case=Nom|Number=Sing	5	obl	_	GTtags=Sg,Nom
...
2	мунӧм	мунӧм	NOUN	N	Case=Nom|Number=Sing	6	advcl	_	GTtags=Sg,Nom
...
6	видзӧдлісны	видзӧдлыны	VERB	V	Mood=Ind|Number=Plur|Person=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=TV,Ind,Prt1,Pl3
7	мӧда-мӧд	мӧда-мӧд	PRON	Pron	PronType=Rcp	6	obl	_	GTtags=Recipr,Cmpl
...
10	буракӧ	буракӧ	ADV	Adv	_	13	advmod	_	GTtags=Parenthetic|SpaceAfter=No
11	,	,	PUNCT	PUNCT	_	13	punct	_	_
12	эз	оз	AUX	V	Mood=Ind|Number=Plur|Person=3|Polarity=Neg|Tense=Past|VerbForm=Fin	13	aux	_	GTtags=Neg,Ind,Prt1,Pl3
...
17	мунас	мунны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin	13	ccomp	_	GTtags=IV,Ind,Fut,Sg3
