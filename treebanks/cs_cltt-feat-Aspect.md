...
The feature is used with 2 part-of-speech tags: [ADJ](cs_cltt-pos-ADJ.html) (288; 1% instances), [VERB](cs_cltt-pos-VERB.html) (1; 0% instances).

### `ADJ`

288 [ADJ](cs_cltt-pos-ADJ.html) tokens (4% of all `ADJ` tokens) have a non-empty value of `Aspect`.
