...
There are 58 `DET` lemmas (0%), 327 `DET` types (1%) and 5700 `DET` tokens (3%).
...
The form / lemma ratio of `DET` is 5.637931 (the average of all parts of speech is 1.875784).
