---
layout: base
title:  'Statistics of expl in UD_Moksha-JR'
udver: '2'
---

## Treebank Statistics: UD_Moksha-JR: Relations: `expl`
...
The following 1 pairs of parts of speech are connected with `expl`: <tt><a href="mdf_jr-pos-ADJ.html">ADJ</a></tt>-<tt><a href="mdf_jr-pos-DET.html">DET</a></tt> (1; 100% instances).
...
3	въдь	вдь	PART	Pcle	Style=Ped	5	advmod	_	ModernForm=вдь
