---
layout: base
title:  'Statistics of acl in UD_Kazakh'
udver: '2'
---

## Treebank Statistics: UD_Kazakh: Relations: `acl`

This relation is universal.
There are 2 language-specific subtypes of `acl`: <tt><a href="kk-dep-acl-poss.html">acl:poss</a></tt>, <tt><a href="kk-dep-acl-relcl.html">acl:relcl</a></tt>.
