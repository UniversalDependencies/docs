...
13008 types (33%) occur at least once with a non-empty value of `VerbForm`.
3752 lemmas (14%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 5 part-of-speech tags: <tt><a href="es_ancora-pos-VERB.html">VERB</a></tt> (44872; 8% instances), <tt><a href="es_ancora-pos-AUX.html">AUX</a></tt> (16916; 3% instances), <tt><a href="es_ancora-pos-ADJ.html">ADJ</a></tt> (6510; 1% instances), <tt><a href="es_ancora-pos-ADV.html">ADV</a></tt> (2; 0% instances), <tt><a href="es_ancora-pos-NOUN.html">NOUN</a></tt> (1; 0% instances).

### `VERB`

44872 <tt><a href="es_ancora-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="es_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (40291; 90%), <tt><a href="es_ancora-feat-Person.html">Person</a></tt><tt>=3</tt> (27249; 61%), <tt><a href="es_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (26285; 59%), <tt><a href="es_ancora-feat-Number.html">Number</a></tt><tt>=Sing</tt> (25966; 58%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (29004; 65% of non-empty `VerbForm`): <em>tiene, dijo, tienen, aseguró, explicó, afirmó, señaló, hizo, anunció, añadió</em>
* `Ger` (1200; 3% of non-empty `VerbForm`): <em>haciendo, dando, trabajando, teniendo, hablando, jugando, perdiendo, luchando, tocando, esperando</em>
* `Inf` (10088; 22% of non-empty `VerbForm`): <em>hacer, dar, tener, ganar, poner, ver, jugar, mantener, conseguir, llegar</em>
* `Part` (4580; 10% of non-empty `VerbForm`): <em>hecho, tenido, dado, visto, conseguido, ganado, pasado, perdido, logrado, puesto</em>
...
16916 <tt><a href="es_ancora-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="es_ancora-feat-Person.html">Person</a></tt><tt>=3</tt> (13380; 79%), <tt><a href="es_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (12848; 76%), <tt><a href="es_ancora-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11440; 68%), <tt><a href="es_ancora-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9905; 59%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (14156; 84% of non-empty `VerbForm`): <em>es, ha, han, fue, son, está, había, hay, puede, era</em>
* `Ger` (206; 1% of non-empty `VerbForm`): <em>siendo, diciendo, intentando, teniendo, pensando, habiendo, estando, tratando, dejando, gritando</em>
* `Inf` (1892; 11% of non-empty `VerbForm`): <em>ser, haber, estar, poder, seguir, volver, hacer, decir, dejar, evitar</em>
* `Part` (662; 4% of non-empty `VerbForm`): <em>sido, podido, estado, habido, ido, hecho, llegado, empezado, dejado, vuelto</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="es_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="es_ancora-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="es_ancora-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="es_ancora-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>somos</em></td><td></td><td></td><td></td></tr>
...
2 <tt><a href="es_ancora-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `ADV` and `VerbForm` co-occurred: <tt><a href="es_ancora-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (2; 100%).
...
* `EMPTY` (17886): <em>no, más, también, ya, hoy, ayer, muy, sólo, después, ahora</em>

<table>
  <tr><th>Paradigm <i>de</i></th><th><tt>Fin</tt></th><th><tt>Inf</tt></th></tr>
  <tr><td><tt>_</tt></td><td></td><td><em>menos</em></td></tr>
  <tr><td><tt><tt><a href="es_ancora-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="es_ancora-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="es_ancora-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="es_ancora-feat-Tense.html">Tense</a></tt><tt>=Imp</tt></tt></td><td><em>menos</em></td><td></td></tr>
</table>

### `NOUN`

1 <tt><a href="es_ancora-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `NOUN` and `VerbForm` co-occurred: <tt><a href="es_ancora-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (1; 100%), <tt><a href="es_ancora-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1; 100%).
...
<tt>VERB --[<tt><a href="es_ancora-dep-conj.html">conj</a></tt>]--> VERB</tt> (3169; 76%),
<tt>VERB --[<tt><a href="es_ancora-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (2529; 69%),
<tt>AUX --[<tt><a href="es_ancora-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (312; 59%),
<tt>VERB --[<tt><a href="es_ancora-dep-ccomp.html">ccomp</a></tt>]--> AUX</tt> (256; 88%),
<tt>VERB --[<tt><a href="es_ancora-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (110; 62%),
<tt>AUX --[<tt><a href="es_ancora-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (95; 61%),
<tt>VERB --[<tt><a href="es_ancora-dep-advcl.html">advcl</a></tt>]--> AUX</tt> (86; 63%),
<tt>VERB --[<tt><a href="es_ancora-dep-conj.html">conj</a></tt>]--> AUX</tt> (68; 74%),
<tt>AUX --[<tt><a href="es_ancora-dep-csubj.html">csubj</a></tt>]--> VERB</tt> (65; 63%),
<tt>AUX --[<tt><a href="es_ancora-dep-conj.html">conj</a></tt>]--> AUX</tt> (24; 89%).
