...
`ADP` nodes are attached to their parents using 2 different relations: <tt><a href="ja_gsd-dep-case.html">case</a></tt> (41285; 99% instances), <tt><a href="ja_gsd-dep-fixed.html">fixed</a></tt> (579; 1% instances)
