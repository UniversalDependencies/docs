...
8	ашесть	аш	AUX	_	Mood=Ind|Number[subj]=Plur|Person[subj]=3|Polarity=Neg|Tense=Past|VerbForm=Fin|VerbType=Aux	9	aux	_	GTtags=Aux,Neg,Ind,Prt1,ScPl3
...
3	ули	улемс	AUX	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|VerbForm=Fin	1	cop	_	CGdephead=#3-&gt;4|CGdeprel=@&gt;N|GTtags=Der/NomAg,N,Sg,Nom,Indef
