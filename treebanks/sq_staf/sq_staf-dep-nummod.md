---
layout: base
title:  'Statistics of nummod in UD_Albanian-STAF'
udver: '2'
---

## Treebank Statistics: UD_Albanian-STAF: Relations: `nummod`

This relation is universal.

14 nodes (0%) are attached to their parents as `nummod`.

13 instances of `nummod` (93%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.28571428571429.

The following 1 pairs of parts of speech are connected with `nummod`: <tt><a href="sq_staf-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sq_staf-pos-NUM.html">NUM</a></tt> (14; 100% instances).
...
8	.	.	PUNCT	_	_	4	punct	_	end_char=544|start_char=543
