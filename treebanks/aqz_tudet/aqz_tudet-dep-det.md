...
6 nodes (1%) are attached to their parents as `det`.

4 instances of `det` (67%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 3 pairs of parts of speech are connected with `det`: <tt><a href="aqz_tudet-pos-ADV.html">ADV</a></tt>-<tt><a href="aqz_tudet-pos-PRON.html">PRON</a></tt> (2; 33% instances), <tt><a href="aqz_tudet-pos-DET.html">DET</a></tt>-<tt><a href="aqz_tudet-pos-PRON.html">PRON</a></tt> (2; 33% instances), <tt><a href="aqz_tudet-pos-PRON.html">PRON</a></tt>-<tt><a href="aqz_tudet-pos-PRON.html">PRON</a></tt> (2; 33% instances).
