...
There are 4 `DET` lemmas (1%), 4 `DET` types (1%) and 4 `DET` tokens (1%).
Out of 14 observed tags, the rank of `DET` is: 13 in number of lemmas, 13 in number of types and 13 in number of tokens.
...
The form / lemma ratio of `DET` is 1.000000 (the average of all parts of speech is 1.186186).
