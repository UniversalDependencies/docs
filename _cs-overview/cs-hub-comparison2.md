...
<ul>
<li>This corpus uses 37 lemmas as copulas (cop): *, být, bývat, determinační, dlouhý, doktrína, doprovázený, dosažitelný, dále, faktor, impuls, jeden, krásný, lhostejný, metoda, moci, muset, mít, měkký, nabubřování, naopak, nebo, náboženství, odolný, pohyblivost, prostředek, pěstovat, připadat, souhrn, titul, uhlí, vyžadovat, výhodný, zahrada, znak, značka, řehole.</li>
<li>This corpus uses 9 lemmas as auxiliaries (aux): &camount;, *, být, bývat, jako, rozdělený, ten, třeba, vytištěný.</li>
<li>This corpus uses 5 lemmas as passive auxiliaries (aux:pass): &camount;, *, být, bývat, rámec.</li>
</ul>
...
<ul>
<li>This corpus uses 6 lemmas as copulas (cop): byt, být, je-li, jsou-li, nejsou-li, není-li.</li>
<li>This corpus uses 4 lemmas as auxiliaries (aux): být, ocenit, oprávnit, stanovit.</li>
<li>This corpus uses 2 lemmas as passive auxiliaries (aux:pass): být, není-li.</li>
</ul>
...
<li>This corpus uses 1 lemmas as passive auxiliaries (aux:pass): být.</li>
</ul>
...
<ul>
<li>This corpus uses 8 relation subtypes: advmod:emph, aux:pass, csubj:pass, det:nummod, expl:pass, expl:pv, nsubj:pass, nummod:gov</li>
<li>The following 1 main types are not used alone, they are always subtyped: expl</li>
<li>The following 7 relation types are not used in this corpus at all: vocative, dislocated, discourse, clf, list, goeswith, reparandum</li>
</ul>
...
<ul>
<li>This corpus uses 10 relation subtypes: advmod:emph, aux:pass, csubj:pass, det:numgov, det:nummod, expl:pass, expl:pv, nsubj:pass, nummod:gov, obl:agent</li>
<li>The following 1 main types are not used alone, they are always subtyped: expl</li>
<li>The following 6 relation types are not used in this corpus at all: dislocated, clf, list, goeswith, reparandum, dep</li>
</ul>
