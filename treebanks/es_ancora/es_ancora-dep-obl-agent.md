...
3	'	'	PUNCT	fz	PunctType=Quot	5	punct	5:punct	Entity=(NOCOREF:Spec.other-other-3-gstype:spec|SpaceAfter=No
...
6	'	'	PUNCT	fz	PunctType=Quot	5	punct	5:punct	Entity=NOCOREF:Spec.other)CESSCASTP19991201135_cc1)|SpaceAfter=No
...
13	censura	censura	NOUN	ncfs000	Gender=Fem|Number=Sing	8	obl:agent	8:obl:agent	ArgTem=arg0:agt|Entity=NOCOREF:Gen)|SpaceAfter=No
...
7	Occidente	Occidente	PROPN	np00000	_	5	obl:agent	5:obl:agent	ArgTem=arg0:agt|Entity=(CESSCASTP1999090211c6-organization-1-CorefType:ident,gstype:spec)|SpaceAfter=No
...
8	leridano	leridano	ADJ	aq0ms0	Gender=Masc|Number=Sing	7	amod	7:amod	Entity=NOCOREF:Gen)|SpaceAfter=No
