---
layout: base
title:  'Statistics of nmod:dat in UD_Kurmanji-MG'
udver: '2'
---

## Treebank Statistics: UD_Kurmanji-MG: Relations: `nmod:dat`

This relation is a language-specific subtype of <tt><a href="kmr_mg-dep-nmod.html">nmod</a></tt>.
There are also 1 other language-specific subtypes of `nmod`: <tt><a href="kmr_mg-dep-nmod-poss.html">nmod:poss</a></tt>.

115 nodes (1%) are attached to their parents as `nmod:dat`.

114 instances of `nmod:dat` (99%) are left-to-right (parent precedes child).
