...
A numeric modifier is a modifier that is a numeral word or phrase preceding the noun or noun phrase it modifies. Ordinal numbers such as 第一 / _dìyī_ "first" and 第二 / _dìèr_ "second", however, should be treated with [`amod`]() (and tagged [`ADJ`]()) to conform to UD guidelines. 
...
~~~
<!-- Interlanguage links updated Po 29. června 2026, 17:44:33 CEST -->
