...
14 nodes (0%) are attached to their parents as `nsubj:pass`.

14 instances of `nsubj:pass` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 6.21428571428571.

The following 4 pairs of parts of speech are connected with `nsubj:pass`: [gl-pos/VERB]()-[gl-pos/NOUN]() (7; 50% instances), [gl-pos/VERB]()-[gl-pos/PRON]() (4; 29% instances), [gl-pos/VERB]()-[gl-pos/PROPN]() (2; 14% instances), [gl-pos/ADJ]()-[gl-pos/PROPN]() (1; 7% instances).
