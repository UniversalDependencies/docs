...
There are 2646 `ADJ` lemmas (13%), 3865 `ADJ` types (13%) and 11328 `ADJ` tokens (5%).
...
The form / lemma ratio of `ADJ` is 1.460695 (the average of all parts of speech is 1.414227).
