...
## Treebank Statistics: UD_Armenian-BSUT: Relations: `det`

This relation is universal.
There are 1 language-specific subtypes of `det`: <tt><a href="hy_bsut-dep-det-poss.html">det:poss</a></tt>.

989 nodes (2%) are attached to their parents as `det`.

989 instances of `det` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.4216380182002.

The following 10 pairs of parts of speech are connected with `det`: <tt><a href="hy_bsut-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (938; 95% instances), <tt><a href="hy_bsut-pos-PRON.html">PRON</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (24; 2% instances), <tt><a href="hy_bsut-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hy_bsut-pos-PART.html">PART</a></tt> (17; 2% instances), <tt><a href="hy_bsut-pos-PROPN.html">PROPN</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (4; 0% instances), <tt><a href="hy_bsut-pos-ADJ.html">ADJ</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="hy_bsut-pos-ADJ.html">ADJ</a></tt>-<tt><a href="hy_bsut-pos-PRON.html">PRON</a></tt> (1; 0% instances), <tt><a href="hy_bsut-pos-ADV.html">ADV</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="hy_bsut-pos-NUM.html">NUM</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="hy_bsut-pos-SCONJ.html">SCONJ</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="hy_bsut-pos-VERB.html">VERB</a></tt>-<tt><a href="hy_bsut-pos-DET.html">DET</a></tt> (1; 0% instances).
...
1	Մեկ	մեկ	DET	_	PronType=Ind	2	det	_	Translit=Mek|LTranslit=mek
2	ուրիշն	ուրիշ	PRON	_	Case=Nom|Definite=Def|Number=Sing|PronType=Ind	6	nsubj	_	Translit=owrišn|LTranslit=owriš
3	այս	այս	DET	_	Deixis=Prox|PronType=Dem	4	det	_	Translit=ays|LTranslit=ays
4	գրության	գրություն	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Sing	6	obl	_	Translit=growt’yan|LTranslit=growt’yown
5	տակ	տակ	ADP	_	AdpType=Post	4	case	_	Translit=tak|LTranslit=tak
6	ավելացրել	ավելացնել	VERB	_	Aspect=Perf|Subcat=Tran|VerbForm=Part|Voice=Act	0	root	_	Translit=avelac’rel|LTranslit=avelac’nel
7	էր	եմ	AUX	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Imp|VerbForm=Fin	6	aux	_	Translit=ēr|LTranslit=em|SpaceAfter=No
