---
layout: base
title:  'Statistics of NumType in UD_North_Sami-Giella'
udver: '2'
---
...
348 <tt><a href="sme_giella-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="sme_giella-feat-Number.html">Number</a></tt><tt>=Sing</tt> (331; 95%).
...
<tt>NUM --[<tt><a href="sme_giella-dep-amod.html">amod</a></tt>]--> NUM</tt> (3; 100%),
<tt>NUM --[<tt><a href="sme_giella-dep-conj.html">conj</a></tt>]--> NUM</tt> (1; 100%).
