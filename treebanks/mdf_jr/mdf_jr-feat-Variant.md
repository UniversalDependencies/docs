...
24 tokens (1%) have a non-empty value of `Variant`.
15 types (1%) occur at least once with a non-empty value of `Variant`.
4 lemmas (0%) occur at least once with a non-empty value of `Variant`.
The feature is used with 1 part-of-speech tags: <tt><a href="mdf_jr-pos-PRON.html">PRON</a></tt> (24; 1% instances).
...
* `Long` (4; 17% of non-empty `Variant`): <em>Мондейне, Сондеенза, Сондейнза, тондейть</em>
* `Short` (20; 83% of non-empty `Variant`): <em>тейнза, тейть, Тейне, теень, тейст, теенза, теест, тейнть, эсезост</em>
