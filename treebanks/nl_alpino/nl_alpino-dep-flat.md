...
2	het	het	DET	LID|bep|stan|evon	Definite=Def|PronType=Art	3	det	3:det	_
...
5	de	de	DET	LID|bep|stan|rest	Definite=Def|PronType=Art	7	det	7:det	_
...
9	werd	worden	AUX	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	10	aux:pass	10:aux:pass	_
...
2	Ich	Ich	X	SPEC|vreemd	ExtPos=PROPN|Foreign=Yes	0	root	0:root	_
3	bin	bin	X	SPEC|vreemd	Foreign=Yes	2	flat	2:flat	_
4	Weltmeister	Weltmeister	X	SPEC|vreemd	Foreign=Yes	2	flat	2:flat	SpaceAfter=No
...
2	dan	dan	ADV	BW	ExtPos=ADV	1	obl	1:obl	_
...
7	'69	'69	PROPN	SPEC|deeleigen	_	6	flat	6:flat	_
8	gaat	door_gaan	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	1	parataxis	1:parataxis	_
...
13	31	31	NUM	TW|hoofd|vrij	ExtPos=PRON	11	nmod	11:nmod:van	_
