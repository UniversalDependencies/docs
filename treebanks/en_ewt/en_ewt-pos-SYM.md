...
There are 83 `SYM` lemmas (0%), 83 `SYM` types (0%) and 768 `SYM` tokens (0%).
...
The form / lemma ratio of `SYM` is 1.000000 (the average of all parts of speech is 1.191858).
