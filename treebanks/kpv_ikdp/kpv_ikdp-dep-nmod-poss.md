---
layout: base
title:  'Statistics of nmod:poss in UD_Komi_Zyrian-IKDP'
udver: '2'
---

## Treebank Statistics: UD_Komi_Zyrian-IKDP: Relations: `nmod:poss`

This relation is a language-specific subtype of <tt><a href="kpv_ikdp-dep-nmod.html">nmod</a></tt>.
There are also 1 other language-specific subtypes of `nmod`: <tt><a href="kpv_ikdp-dep-nmod-prp.html">nmod:prp</a></tt>.
...
The following 3 pairs of parts of speech are connected with `nmod:poss`: <tt><a href="kpv_ikdp-pos-NOUN.html">NOUN</a></tt>-<tt><a href="kpv_ikdp-pos-PRON.html">PRON</a></tt> (3; 50% instances), <tt><a href="kpv_ikdp-pos-NOUN.html">NOUN</a></tt>-<tt><a href="kpv_ikdp-pos-NOUN.html">NOUN</a></tt> (2; 33% instances), <tt><a href="kpv_ikdp-pos-VERB.html">VERB</a></tt>-<tt><a href="kpv_ikdp-pos-PRON.html">PRON</a></tt> (1; 17% instances).
...
4	вылэджык	выв	NOUN	N	Case=Ill|Degree=Cmp|NounType=Relat|Number=Sing	5	obl	_	GTtags=Relat,Sg,Err/Dial,Ill,Comp
...
29	бы	бы	AUX	_	Mood=Cnd	30	aux	_	_
...
39	корке	коркӧ	ADV	Adv	AdvType=Tim|Definite=Ind|Derivation=Ko	37	advmod	_	GTtags=Indef,Sem/Time,Der/кӧ|SpaceAfter=No
