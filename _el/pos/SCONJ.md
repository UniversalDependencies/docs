...
- *να* is assigned the tag <code>SCONJ</code> when it introduces  subordinate clauses:
   ...
   -  all other cases where the *να*-introduced clauses function as adverbial modifiers and *να* co-occurs with other uniflected words, e.g.,  *αντί να, δίχως να, που να, πριν να, σαν να, χωρίς να, ώσπου να,  ώστε να*. The uniflected words are assigned their original tags and depend on *να* with the [fixed]() dependency, e.g.,  *Αντί να της δώσει τα παπούτσια στο χέρι, έκανε και παιδί μαζί της.* "Rather than sending her packing, he had a child with her", *Με ακούει δίχως.adp να.Sconj[fixed] με διακόψει με ερωτήσεις* "He hears me without interrupting me with questions", *τη ρωτάω, χωρίς να μπω σε συζήτηση για την ανεπάρκεια του σιναφιού μας* "I ask her without opening a discussion about our trade's insufficiency", *Σαν να μη μου έφτανε η κούραση, νιώθω και το στομάχι μου ασήκωτο"*, 
