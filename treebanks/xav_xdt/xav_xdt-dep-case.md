...
## Treebank Statistics: UD_Xavante-XDT: Relations: `case`
...
1	Taha	taha	PRON	pron	_	7	dislocated	_	that;isso
2	pari	pari	ADP	posp	_	1	case	_	after,then;depois,em.seguida
3	,	,	PUNCT	punct	_	7	punct	_	_
4	õnorĩhã	õnorĩhã	PRON	pron	Number=Plur|Person=3	7	nsubj	_	_
5	te	te	PART	prcl	Htp=Yes|Tense=Pres	7	dep	_	heterophoric.marker;marcardor.heterofórico
6	aba	aba	PART	prcl	Number=Coll	7	dep	_	collective.marker
7	tineb	ne	VERB	v	Person[abs]=3	0	root	_	walk;andar,caminhar
8	dzahuré	dzahuré	NUM	num	Number=Dual	7	dep	_	_
...
# visual-style 17 18 case	color:blue
1	Ari'iwi	ari'iwi	NOUN	n	_	0	root	_	in.silence,quiet;em.silêncio,quieto
2	!	!	PUNCT	punct	_	1	punct	_	_
3	Ĩhi	ĩhi	NOUN	n	_	5	nsubj	_	old,aged,elderly;velho,idoso,ancião
4	te	te	PART	prcl	Htp=Yes|Tense=Pres	5	dep	_	heterophoric.marker;marcardor.heterofórico
5	rotsa'rata	rotsa'rata	VERB	v	_	1	parataxis	_	think;pensar
6	marĩ	marĩ	NOUN	n	_	5	obl	_	something,what;algo,o.que,alguma.coisa
7	na	na	ADP	posp	_	6	case	_	in,from;em,de
8	te	te	PART	prcl	Htp=Yes|Tense=Pres	11	dep	_	heterophoric.marker;marcardor.heterofórico
...
16	höimanadzé	höimanadzé	NOUN	n	_	11	dislocated	_	life,existence;vida,existência
17	duréi	duréi	ADV	adv	_	11	dislocated	_	for.a.long.time;por.muito.tempo
18	na	na	ADP	posp	_	17	case	_	in,from;em,de
19	hã	hã	PART	prcl	Emph=Yes	17	discourse	_	_
