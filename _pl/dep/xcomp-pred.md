...
The `xcomp:pred` relation is used in the Polish [PDB-UD](http://universaldependencies.org/treebanks/pl_pdb/index.html) and [PUD](http://universaldependencies.org/treebanks/pl_pud/index.html) treebanks for predicative adjectives and nominals depending on verbs, e.g. _czuć się_ ('to feel'), _zostać_ ('to became') which are not considered copular verbs.


~~~ conllu
# visual-style 6 8 xcomp:pred color:blue
1	W	w	ADP	prep:loc:nwok	AdpType=Prep|Variant=Short	2	case	2:case	Case=Loc
2	depresjach	depresja	NOUN	subst:pl:loc:f	Case=Loc|Gender=Fem|Number=Plur	6	obl	6:obl	_
3	organicznych	organiczny	ADJ	adj:pl:loc:f:pos	Case=Loc|Degree=Pos|Gender=Fem|Number=Plur	2	amod	2:amod	_
4	chory	chory	NOUN	subst:sg:nom:m1	Animacy=Hum|Case=Nom|Gender=Masc|Number=Sing	6	nsubj	6:nsubj	_
5	często	często	ADV	adv:pos	Degree=Pos	6	advmod	6:advmod	_
6	czuje	czuć	VERB	fin:sg:ter:imperf	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	0:root	_
7	się	się	PRON	part	PronType=Prs|Reflex=Yes	6	expl:pv	6:expl:pv	_
8	zagubiony	zagubiony	ADJ	adj:sg:nom:m1:pos	Animacy=Hum|Case=Nom|Degree=Pos|Gender=Masc|Number=Sing	6	xcomp:pred	6:xcomp:pred	SpaceAfter=No
