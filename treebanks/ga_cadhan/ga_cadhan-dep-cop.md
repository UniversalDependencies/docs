---
layout: base
title:  'Statistics of cop in UD_Irish-Cadhan'
udver: '2'
---

## Treebank Statistics: UD_Irish-Cadhan: Relations: `cop`
...
# visual-style 2	fgColor:white
# visual-style 2 1 cop	color:blue
1	Ag	is	AUX	_	Tense=Pres|VerbForm=Cop	2	cop	_	_
2	so	seo	PRON	_	PronType=Dem	0	root	_	_
3	an	an	DET	_	Definite=Def|Number=Sing|PronType=Art	5	det	_	_
4	dara	dara	NUM	_	NumType=Ord	5	amod	_	_
5	comhartha	comhartha	NOUN	_	Case=Nom|Definite=Def|Gender=Masc|Number=Sing	2	nsubj	_	_
6	do	a	PART	_	Form=Direct|PartType=Vb|PronType=Rel	7	obj	_	_
7	rinne	déan	VERB	_	Mood=Ind|Tense=Past	5	acl:relcl	_	_
8	Iósa	Íosa	PROPN	_	Definite=Def|Gender=Masc|Number=Sing	7	nsubj	_	_
9	arís	arís	ADV	_	_	7	advmod	_	SpaceAfter=No
10	,	,	PUNCT	_	_	12	punct	_	_
11	an	an	DET	_	Definite=Def|Number=Sing|PronType=Art	12	det	_	_
12	tan	tan	NOUN	_	Case=Nom|Definite=Def|Number=Sing	7	obl	_	_
13	taínig	tar	VERB	_	Mood=Ind|Tense=Past	12	acl:relcl	_	_
14	sé	sé	PRON	_	Gender=Masc|Number=Sing|Person=3	13	nsubj	_	_
15	ón	ó	ADP	_	Number=Sing|PronType=Art	16	case	_	_
16	Iudéa	Iúdáia	PROPN	_	Case=Nom|Definite=Def|Gender=Masc|Number=Sing	13	obl	_	_
17	don	do	ADP	_	Number=Sing|PronType=Art	18	case	_	_
18	Ghalilé	Gailíl	PROPN	_	Case=Nom|Definite=Def|Form=Len|Gender=Fem|Number=Sing	13	obl	_	SpaceAfter=No
