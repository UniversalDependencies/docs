...
<table>
  ...
  <tr><td><tt><a href="Animacy.html">Animacy</a>=Inan|<a href="Case.html">Case</a>=Ins|<a href="Degree.html">Degree</a>=Pos|<a href="Negative.html">Negative</a>=Pos|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td></td><td><em>známým</em></td><td></td><td></td></tr>
...
The most frequent other feature values with which `DET` and `Gender` co-occurred: <tt><a href="Gender[psor].html">Gender[psor]</a>=EMPTY</tt> (16859; 94%), <tt><a href="Number.html">Number</a>=Sing</tt> (14995; 83%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (14612; 81%), <tt><a href="Number[psor].html">Number[psor]</a>=EMPTY</tt> (14612; 81%), <tt><a href="Reflex.html">Reflex</a>=EMPTY</tt> (14010; 78%), <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (10624; 59%).
...
The most frequent other feature values with which `NUM` and `Gender` co-occurred: <tt><a href="NumForm.html">NumForm</a>=Word</tt> (4417; 93%), <tt><a href="NumType.html">NumType</a>=Card</tt> (4417; 93%), <tt><a href="NumValue.html">NumValue</a>=1,2,3</tt> (4417; 93%), <tt><a href="Number.html">Number</a>=Sing</tt> (2795; 59%).
...
* `EMPTY` (36751): <em>1, 2, 3, tři, 4, 6, tisíc, 5, dvou, 1992</em>
...
The most frequent other feature values with which `AUX` and `Gender` co-occurred: <tt><a href="Tense.html">Tense</a>=Past</tt> (3252; 100%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (3252; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (3252; 100%), <tt><a href="Voice.html">Voice</a>=Act</tt> (3252; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (3252; 100%), <tt><a href="Negative.html">Negative</a>=Pos</tt> (2982; 92%), <tt><a href="Number.html">Number</a>=Sing</tt> (1704; 52%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Dat|<a href="Degree.html">Degree</a>=Pos|<a href="Negative.html">Negative</a>=Pos|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td></td><td></td><td><em>známé</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Dat|<a href="Degree.html">Degree</a>=Pos|<a href="Negative.html">Negative</a>=Pos|<a href="Number.html">Number</a>=Plur</tt></td><td></td><td></td><td></td><td></td><td><em>známým</em></td></tr>
...
The most frequent other feature values with which `VERB` and `Gender` co-occurred: <tt><a href="Person.html">Person</a>=EMPTY</tt> (15966; 100%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (15966; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (15931; 100%), <tt><a href="Negative.html">Negative</a>=Pos</tt> (15012; 94%), <tt><a href="Voice.html">Voice</a>=Act</tt> (11700; 73%), <tt><a href="Tense.html">Tense</a>=Past</tt> (11666; 73%).
...
The most frequent other feature values with which `PRON` and `Gender` co-occurred: <tt><a href="Reflex.html">Reflex</a>=EMPTY</tt> (10846; 100%), <tt><a href="Variant.html">Variant</a>=EMPTY</tt> (10557; 97%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (9565; 88%), <tt><a href="Number.html">Number</a>=Sing</tt> (8206; 75%), <tt><a href="Case.html">Case</a>=Nom</tt> (5491; 51%).

`PRON` tokens may have the following values of `Gender`:

* `Fem` (2536; 23% of non-empty `Gender`): <em>které, která, ji, kterou, všechny, níž, ní, sama, jí, jež</em>
* `Fem,Neut` (9; 0% of non-empty `Gender`): <em>naše, moje</em>
* `Masc` (2783; 26% of non-empty `Gender`): <em>který, které, kteří, všechny, sám, všichni, kdo, sami, ten, někdo</em>
* `Masc,Neut` (2614; 24% of non-empty `Gender`): <em>tím, tomu, tom, toho, mu, ho, němž, jej, něm, něho</em>
* `Neut` (2927; 27% of non-empty `Gender`): <em>to, které, všechno, která, vše, je, všechna, jež, toto, totéž</em>
* `EMPTY` (13520): <em>se, si, co, všech, nás, je, nám, nich, nichž, jim</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Loc|<a href="Number.html">Number</a>=Sing|<a href="Number[psor].html">Number[psor]</a>=Plur</tt></td><td></td><td></td><td><em>našem</em></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Sing|<a href="Number[psor].html">Number[psor]</a>=Plur</tt></td><td><em>naše</em></td><td><em>náš</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Sing|<a href="Number[psor].html">Number[psor]</a>=Sing</tt></td><td><em>moje</em></td><td></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Plur|<a href="Number[psor].html">Number[psor]</a>=Plur</tt></td><td><em>naše</em></td><td></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Plur|<a href="Number[psor].html">Number[psor]</a>=Sing</tt></td><td><em>moje</em></td><td></td><td></td><td></td><td></td></tr>
</table>
...
The most frequent other feature values with which `PROPN` and `Gender` co-occurred: <tt><a href="Negative.html">Negative</a>=Pos</tt> (9803; 100%), <tt><a href="Abbr.html">Abbr</a>=EMPTY</tt> (7931; 81%), <tt><a href="Number.html">Number</a>=Sing</tt> (7187; 73%).
...
The most frequent other feature values with which `DET` and `Gender` co-occurred: <tt><a href="Gender[psor].html">Gender[psor]</a>=EMPTY</tt> (6514; 93%), <tt><a href="Reflex.html">Reflex</a>=EMPTY</tt> (5833; 84%), <tt><a href="Number.html">Number</a>=Sing</tt> (5772; 83%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (5486; 79%), <tt><a href="Number[psor].html">Number[psor]</a>=EMPTY</tt> (5486; 79%), <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (4341; 62%), <tt><a href="PronType.html">PronType</a>=Dem</tt> (3494; 50%).

`DET` tokens may have the following values of `Gender`:

* `Fem` (2935; 42% of non-empty `Gender`): <em>této, své, naší, tato, svou, tyto, tuto, její, té, některé</em>
* `Fem,Neut` (127; 2% of non-empty `Gender`): <em>naše, moje, vaše, tvoje</em>
* `Masc` (1410; 20% of non-empty `Gender`): <em>tento, tyto, svůj, některé, své, náš, takový, ty, naši, ten</em>
* `Masc,Neut` (2000; 29% of non-empty `Gender`): <em>tohoto, tomto, našeho, svého, našem, svým, svém, tímto, její, jejím</em>
* `Neut` (506; 7% of non-empty `Gender`): <em>toto, své, tato, to, takové, její, některá, naše, nějaké, taková</em>
* `EMPTY` (4110): <em>jejich, jeho, těchto, některých, několik, svých, našich, jehož, jejichž, mnoho</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Sing|<a href="Number[psor].html">Number[psor]</a>=Sing</tt></td><td><em>moje</em></td><td><em>můj</em></td><td></td><td><em>má</em></td><td><em>mé</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Plur|<a href="Number[psor].html">Number[psor]</a>=Plur</tt></td><td><em>naše</em></td><td></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number.html">Number</a>=Plur|<a href="Number[psor].html">Number[psor]</a>=Sing</tt></td><td></td><td></td><td></td><td><em>Mé</em></td><td></td></tr>
</table>
...
The most frequent other feature values with which `AUX` and `Gender` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (1313; 100%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (1313; 100%), <tt><a href="Tense.html">Tense</a>=Past</tt> (1313; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (1313; 100%), <tt><a href="Voice.html">Voice</a>=Act</tt> (1313; 100%), <tt><a href="Negative.html">Negative</a>=Pos</tt> (1244; 95%).

`AUX` tokens may have the following values of `Gender`:

* `Fem,Masc` (304; 23% of non-empty `Gender`): <em>byly, nebyly</em>
* `Fem,Neut` (327; 25% of non-empty `Gender`): <em>byla, nebyla</em>
* `Masc` (353; 27% of non-empty `Gender`): <em>byl, byli, nebyl, býval</em>
* `Neut` (329; 25% of non-empty `Gender`): <em>bylo, nebylo, bývalo</em>
* `EMPTY` (4844): <em>by, je, jsme, bude, jsem, jsou, být, budou, bychom, budeme</em>
...
The most frequent other feature values with which `NUM` and `Gender` co-occurred: <tt><a href="NumForm.html">NumForm</a>=Word</tt> (1139; 95%), <tt><a href="NumType.html">NumType</a>=Card</tt> (1139; 95%), <tt><a href="NumValue.html">NumValue</a>=1,2,3</tt> (1139; 95%), <tt><a href="Number.html">Number</a>=Sing</tt> (798; 67%).
...
The 10 most frequent relations where parent and child node agree in `Gender`:
<tt>NOUN --[<a href="../dep/amod.html">amod</a>]--> ADJ</tt> (59660; 99%),
<tt>NOUN --[<a href="../dep/conj.html">conj</a>]--> NOUN</tt> (7204; 50%),
<tt>ADJ --[<a href="../dep/conj.html">conj</a>]--> ADJ</tt> (3444; 95%),
<tt>ADJ --[<a href="../dep/nsubj.html">nsubj</a>]--> NOUN</tt> (1550; 95%),
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (1429; 50%),
<tt>PROPN --[<a href="../dep/name.html">name</a>]--> PROPN</tt> (838; 99%),
<tt>PROPN --[<a href="../dep/conj.html">conj</a>]--> PROPN</tt> (807; 64%),
<tt>PROPN --[<a href="../dep/nmod.html">nmod</a>]--> NOUN</tt> (756; 85%),
<tt>VERB --[<a href="../dep/nsubj.html">nsubj</a>]--> PROPN</tt> (738; 54%),
<tt>NOUN --[<a href="../dep/appos.html">appos</a>]--> NOUN</tt> (692; 50%).
...
1647 lemmas (62%) occur at least once with a non-empty value of `Gender`.
The feature is used with 7 part-of-speech tags: [cs-pos/NOUN]() (11303; 32% instances), [cs-pos/ADJ]() (6524; 19% instances), [cs-pos/PRON]() (610; 2% instances), [cs-pos/VERB]() (384; 1% instances), [cs-pos/DET]() (354; 1% instances), [cs-pos/AUX]() (51; 0% instances), [cs-pos/NUM]() (46; 0% instances).

### `NOUN`

11303 [cs-pos/NOUN]() tokens (100% of all `NOUN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NOUN` and `Gender` co-occurred: <tt><a href="Negative.html">Negative</a>=Pos</tt> (11288; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (7969; 71%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (6755; 60%).
...
The most frequent other feature values with which `ADJ` and `Gender` co-occurred: <tt><a href="Negative.html">Negative</a>=Pos</tt> (6344; 97%), <tt><a href="Degree.html">Degree</a>=Pos</tt> (6028; 92%), <tt><a href="Number.html">Number</a>=Sing</tt> (4114; 63%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (3902; 60%).
...
<table>
  <tr><th>Paradigm <i>známý</i></th><th><tt>Fem,Masc</tt></th><th><tt>Fem,Neut</tt></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th><th><tt>Neut</tt></th></tr>
  <tr><td><tt><a href="Animacy.html">Animacy</a>=Inan|<a href="Case.html">Case</a>=Nom|<a href="Degree.html">Degree</a>=Pos|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td></td><td><em>známý</em></td><td></td><td></td></tr>
...
The most frequent other feature values with which `VERB` and `Gender` co-occurred: <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (384; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (384; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (383; 100%), <tt><a href="Negative.html">Negative</a>=Pos</tt> (371; 97%), <tt><a href="Tense.html">Tense</a>=EMPTY</tt> (260; 68%), <tt><a href="Voice.html">Voice</a>=Pass</tt> (260; 68%).

`VERB` tokens may have the following values of `Gender`:

* `Fem` (3; 1% of non-empty `Gender`): <em>ověřenu</em>
* `Fem,Masc` (143; 37% of non-empty `Gender`): <em>zahrnuty, obchodovány, přestaly, uvedeny, vykázány, účtovány, nastaly, staly, uzavřeny, vyjádřeny</em>
* `Fem,Neut` (101; 26% of non-empty `Gender`): <em>sestavena, zavedena, nabyla, určila, uvedena, dotčena, oprávněna, překročila, sestavila, stanovila</em>
...
* `Neut` (65; 17% of non-empty `Gender`): <em>stanoveno, došlo, bylo, trvalo, započalo, účtováno, dodrženo, dosaženo, dotčeno, mohlo</em>
* `EMPTY` (2133): <em>je, jsou, obsahuje, rozumí, může, uvede, mohou, není, nejsou, použijí</em>
...
The most frequent other feature values with which `DET` and `Gender` co-occurred: <tt><a href="Gender[psor].html">Gender[psor]</a>=EMPTY</tt> (322; 91%), <tt><a href="Number[psor].html">Number[psor]</a>=EMPTY</tt> (322; 91%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (322; 91%), <tt><a href="Number.html">Number</a>=Sing</tt> (306; 86%), <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (301; 85%), <tt><a href="PronType.html">PronType</a>=Dem</tt> (292; 82%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td></td><td><em>tuto</em></td><td><em>toto</em></td></tr>
...
The most frequent other feature values with which `AUX` and `Gender` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (51; 100%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (51; 100%), <tt><a href="Tense.html">Tense</a>=Past</tt> (51; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (51; 100%), <tt><a href="Voice.html">Voice</a>=Act</tt> (51; 100%), <tt><a href="Negative.html">Negative</a>=Pos</tt> (41; 80%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (26; 51%).

`AUX` tokens may have the following values of `Gender`:

* `Fem,Masc` (25; 49% of non-empty `Gender`): <em>byly, nebyly</em>
* `Fem,Neut` (7; 14% of non-empty `Gender`): <em>byla, nebyla</em>
* `Masc` (14; 27% of non-empty `Gender`): <em>byl, nebyl</em>
* `Neut` (5; 10% of non-empty `Gender`): <em>bylo</em>
* `EMPTY` (119): <em>být, by, je, nejsou, jsou, bude, budou, není</em>

<table>
  <tr><th>Paradigm <i>být</i></th><th><tt>Fem,Masc</tt></th><th><tt>Fem,Neut</tt></th><th><tt>Masc</tt></th><th><tt>Neut</tt></th></tr>
  <tr><td><tt><a href="Animacy.html">Animacy</a>=Inan|<a href="Negative.html">Negative</a>=Neg|<a href="Number.html">Number</a>=Plur</tt></td><td><em>nebyly</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Animacy.html">Animacy</a>=Inan|<a href="Negative.html">Negative</a>=Pos|<a href="Number.html">Number</a>=Plur</tt></td><td><em>byly</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Negative.html">Negative</a>=Neg|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td></td><td><em>nebyl</em></td><td></td></tr>
  <tr><td><tt><a href="Negative.html">Negative</a>=Neg|<a href="Number.html">Number</a>=Plur,Sing</tt></td><td></td><td><em>nebyla</em></td><td></td><td></td></tr>
  <tr><td><tt><a href="Negative.html">Negative</a>=Pos|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td></td><td><em>byl</em></td><td><em>bylo</em></td></tr>
  <tr><td><tt><a href="Negative.html">Negative</a>=Pos|<a href="Number.html">Number</a>=Plur,Sing</tt></td><td></td><td><em>byla</em></td><td></td><td></td></tr>
</table>
...
<table>
  ...
  <tr><td><tt><a href="Animacy.html">Animacy</a>=Inan|<a href="Case.html">Case</a>=Acc</tt></td><td><em>jeden</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Acc</tt></td><td></td><td></td><td><em>jednu</em></td><td><em>jedno</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Dat</tt></td><td></td><td><em>jednomu</em></td><td></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Gen</tt></td><td></td><td><em>jednoho</em></td><td><em>jedné</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Ins</tt></td><td></td><td><em>jedním</em></td><td><em>jednou</em></td><td></td></tr>
...
<tt>NOUN --[<a href="../dep/conj.html">conj</a>]--> NOUN</tt> (983; 54%),
...
<tt>ADJ --[<a href="../dep/dobj.html">dobj</a>]--> PRON</tt> (7; 58%),
