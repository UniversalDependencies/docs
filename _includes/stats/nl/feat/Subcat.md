...
<table>
  ...
  <tr><td><tt><a href="Aspect.html">Aspect</a>=Imp|<a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Sing|<a href="Tense.html">Tense</a>=Past|<a href="VerbForm.html">VerbForm</a>=Fin</tt></td><td><em>plaatshad, hebbe</em></td><td><em>had</em></td></tr>
...
The most frequent other feature values with which `X` and `Subcat` co-occurred: <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (57; 100%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (57; 100%), <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (38; 67%), <tt><a href="Number.html">Number</a>=Sing</tt> (35; 61%).
