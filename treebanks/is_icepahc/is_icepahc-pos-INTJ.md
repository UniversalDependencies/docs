...
There are 77 `INTJ` lemmas (0%), 77 `INTJ` types (0%) and 1198 `INTJ` tokens (0%).
...
The form / lemma ratio of `INTJ` is 1.000000 (the average of all parts of speech is 1.856953).
