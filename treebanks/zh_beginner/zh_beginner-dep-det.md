...
## Treebank Statistics: UD_Chinese-Beginner: Relations: `det`
...
6	没	没	ADV	_	_	7	advmod	_	Gloss=NEG|Grammar_Target=Yes|SpaceAfter=No|Tone=2|Translit=méi
7	有	有	VERB	_	_	0	root	_	Grammar_Target=Yes|SpaceAfter=No|Tone=3|Translit=yǒu
8	时间	时间	NOUN	_	_	7	obj	_	SpaceAfter=No|Tone=2_1|Translit=shí_jiān
9	吗	吗	PART	_	_	7	discourse:sp	_	SpaceAfter=No|Tone=5|Translit=ma
10	？	？	PUNCT	_	_	7	punct	_	SpaceAfter=No|Translit=？
...
2	几	几	NUM	_	NumType=Card	3	nummod	_	SpaceAfter=No|Tone=1|Translit=jī
3	天	天	NOUN	_	_	4	obl	_	Gloss=day|SpaceAfter=No|Tone=1|Translit=tiān
4	忙	忙	ADJ	_	_	0	root	_	SpaceAfter=No|Tone=2|Translit=máng
5	死	死	ADV	_	_	4	advmod	_	Grammar_Target=Yes|SpaceAfter=No|Tone=3|Translit=sǐ
6	了	了	PART	_	_	4	discourse	_	Gloss=PRF|Grammar_Target=Yes|SpaceAfter=No|Tone=5|Translit=le
...
2	什么	什么	PRON	_	PronType=Ind	3	det	_	Grammar_Target=Yes|SpaceAfter=No|Tone=2_5|Translit=shén_me
3	果汁	果汁	NOUN	_	_	5	obj	_	SpaceAfter=No|Tone=3_1|Translit=guǒ_zhī
4	都	都	ADV	_	_	5	advmod	_	Grammar_Target=Yes|SpaceAfter=No|Tone=1|Translit=dū
5	喝	喝	VERB	_	_	0	root	_	SpaceAfter=No|Tone=1|Translit=hē
