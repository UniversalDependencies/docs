...
The copulas depend on the lexical verb with [cop](deps/cop.html) relation.
The relation of all other auxiliaries is always [aux](deps/aux.html), mostly with a subtype.
See the dependency relation pages for details.
