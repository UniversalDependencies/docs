...
There are 122 `ADP` lemmas (1%), 240 `ADP` types (1%) and 66983 `ADP` tokens (12%).
...
* <em>la</em>
  * <tt><a href="ro_nonstandard-pos-ADP.html">ADP</a></tt> 7398: <em>Zise Pătru lui : De <b>la</b> streini .</em>
...
The form / lemma ratio of `ADP` is 1.967213 (the average of all parts of speech is 2.492163).
