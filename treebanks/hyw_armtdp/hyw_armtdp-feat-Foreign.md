...
2481 tokens (2%) have a non-empty value of `Foreign`.
274 types (1%) occur at least once with a non-empty value of `Foreign`.
267 lemmas (2%) occur at least once with a non-empty value of `Foreign`.
The feature is used with 4 part-of-speech tags: <tt><a href="hyw_armtdp-pos-PUNCT.html">PUNCT</a></tt> (2110; 2% instances), <tt><a href="hyw_armtdp-pos-X.html">X</a></tt> (363; 0% instances), <tt><a href="hyw_armtdp-pos-ADJ.html">ADJ</a></tt> (7; 0% instances), <tt><a href="hyw_armtdp-pos-PROPN.html">PROPN</a></tt> (1; 0% instances).

### `PUNCT`

2110 <tt><a href="hyw_armtdp-pos-PUNCT.html">PUNCT</a></tt> tokens (9% of all `PUNCT` tokens) have a non-empty value of `Foreign`.

`PUNCT` tokens may have the following values of `Foreign`:

* `Yes` (2110; 100% of non-empty `Foreign`): <em>:, `, !</em>
* `EMPTY` (20436): <em>,, ։, ՝, ., «, », ՞, -, ՛, –</em>

### `X`

363 <tt><a href="hyw_armtdp-pos-X.html">X</a></tt> tokens (80% of all `X` tokens) have a non-empty value of `Foreign`.

`X` tokens may have the following values of `Foreign`:

* `Yes` (363; 100% of non-empty `Foreign`): <em>Ապու, la, de, of, et, օղլու, Disaster, Writers, le, the</em>
* `EMPTY` (90): <em>նկատի, մտիկ, հակա, Պոստան, թոյլ, Myth, der, Ալնիս, Ակուլ, Բալնիս</em>

`Foreign` seems to be **lexical feature** of `X`. 100% lemmas (258) occur only with one value of `Foreign`.
...
* `EMPTY` (9597): <em>մեծ, նոր, առաջին, կարելի, վերջին, ազգային, հայ, տարբեր, քաղաքական, կարեւոր</em>
...
* `EMPTY` (4409): <em>Հայաստանի, Թուրքիոյ, Արցախի, Հայաստան, Պոլսոյ, Յակոբ, Լիբանանի, Թուրքիան, Պոլիս, Սահակ</em>

## Relations with Agreement in `Foreign`

The 10 most frequent relations where parent and child node agree in `Foreign`:
<tt>X --[<tt><a href="hyw_armtdp-dep-flat.html">flat</a></tt>]--> X</tt> (131; 96%),
<tt>X --[<tt><a href="hyw_armtdp-dep-flat-name.html">flat:name</a></tt>]--> X</tt> (11; 100%),
