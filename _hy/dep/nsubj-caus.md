...
The infinitive verb governs the causative auxiliary with an [aux:caus](aux-caus) relation. The true agent of the action described by the sentence is annotated with an [iobj:agent]().
