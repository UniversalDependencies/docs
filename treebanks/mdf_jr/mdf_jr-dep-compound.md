---
layout: base
title:  'Statistics of compound in UD_Moksha-JR'
udver: '2'
---

## Treebank Statistics: UD_Moksha-JR: Relations: `compound`
...
4	цифтордсть	цифтордомс	VERB	V	Mood=Ind|Number[subj]=Plur|Person[subj]=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=IV,Ind,Prt1,ScPl3|SpaceAfter=No
...
8	тяштенят	тяште	NOUN	N	Case=Nom|Definite=Ind|Degree=Dim|Number=Plur	4	conj	_	GTtags=mwe,Pl,Nom,Indef|SpaceAfter=No
...
2	туцяс	туця	NOUN	N	Case=Ill|Definite=Ind|Number=Plur,Sing	3	obl	_	GTtags=SP,Ill,Indef
3	повсь	повомс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=IV,Ind,Prt1,ScSg3
4	варьхмодема	варьхмодемс	VERB	V	Case=Nom|Definite=Ind|Number=Sing|VerbForm=Vnoun	5	compound	_	GTtags=IV,Der/NomAct,Sg,Nom,Indef
5	ёткова	ётка	NOUN	N	Case=Prl|Definite=Ind|Number=Plur,Sing	3	obl	_	GTtags=SP,Prl,Indef|SpaceAfter=No
