...
There are 359 `ADV` lemmas (6%), 385 `ADV` types (3%) and 2640 `ADV` tokens (4%).
...
The 10 most frequent `ADV` types:  <em>ως, επίσης, όπως, σχετικά, σήμερα, μόνο, εδώ, πολύ, σύμφωνα, πιο</em>

The 10 most frequent ambiguous lemmas: <em>ως</em> ([ADV]() 123, [ADP]() 1), <em>σχετικά</em> ([ADV]() 72, [ADJ]() 1), <em>μόνο</em> ([ADV]() 65, [ADJ]() 1), <em>καθώς</em> ([ADV]() 41, [CONJ]() 38), <em>μετά</em> ([ADP]() 51, [ADV]() 31), <em>που</em> ([PRON]() 591, [ADV]() 29, [CONJ]() 7), <em>πριν</em> ([ADV]() 21, [ADP]() 10, [CONJ]() 4), <em>μόλις</em> ([ADV]() 12, [CONJ]() 3), <em>λίγο</em> ([ADV]() 11, [ADJ]() 2), <em>σημαντικά</em> ([ADV]() 10, [ADJ]() 1)

The 10 most frequent ambiguous types:  <em>ως</em> ([ADV]() 112, [ADP]() 1), <em>σχετικά</em> ([ADV]() 71, [ADJ]() 3), <em>μόνο</em> ([ADV]() 54, [ADJ]() 5), <em>πολύ</em> ([ADV]() 48, [ADJ]() 1), <em>σύμφωνα</em> ([ADV]() 26, [NOUN]() 1), <em>καθώς</em> ([ADV]() 41, [CONJ]() 34), <em>όσο</em> ([ADV]() 34, [ADJ]() 1), <em>μετά</em> ([ADP]() 39, [ADV]() 28), <em>που</em> ([PRON]() 591, [ADV]() 29, [CONJ]() 7), <em>πριν</em> ([ADV]() 19, [ADP]() 8, [CONJ]() 4)
...
* <em>σχετικά</em>
  * [ADV]() 71: <em>Δεν είπατε τι πιστεύετε <b>σχετικά</b> με το " περισσότερη Ευρώπη " .</em>
...
* <em>μόνο</em>
  * [ADV]() 54: <em>Έχει <b>μόνο</b> μειονεκτήματα και κοστίζει ακριβά σε όλους .</em>
  * [ADJ]() 5: <em>Δεν είναι το <b>μόνο</b> παράδειγμα .</em>
* <em>πολύ</em>
  * [ADV]() 48: <em>Έτσι , οι ΗΠΑ έγιναν <b>πολύ</b> εχθρικές έναντι του Κάστρο κατά το 1959 .</em>
  * [ADJ]() 1: <em>Το περιεχόμενο αυτής της έκθεσης Watson , την οποία η Προεδρία συμμερίζεται , δημιούργησε το απαραίτητο πολιτικό περιβάλλον για να μπορέσει η Ευρωπαϊκή Επιτροπή , η οποία εργαζόταν <b>πολύ</b> καιρό ήδη για την προετοιμασία των αποφάσεων-πλαίσιο σχετικά με την καταπολέμηση της τρομοκρατίας και το ευρωπαϊκό ένταλμα σύλληψης , να παρουσιάσει επειγόντως , μετά τις 11_Σεπτεμβρίου , και τα δύο νομοθετικά σχέδια , τα οποία μπόρεσαν να αποτελέσουν αντικείμενο συμβιβασμού στο Συμβούλιο Δικαιοσύνης και Εσωτερικών Υποθέσεων στις 6 και 7_Δεκεμβρίου και τα οποία επικυρώθηκαν πολιτικά στο Ευρωπαϊκό Συμβούλιο του Λάκεν .</em>
* <em>σύμφωνα</em>
  * [ADV]() 26: <em>Τίποτε δεν λειτούργησε <b>σύμφωνα</b> με το σχέδιο .</em>
...
* <em>όσο</em>
  * [ADV]() 34: <em>Το χαντάκι έχει βάθος <b>όσο</b> το ύψος ενός ανθρώπου και διπλάσιο πλάτος .</em>
...
The form / lemma ratio of `ADV` is 1.072423 (the average of all parts of speech is 1.776033).
...
`ADV` occurs with 1 features: [el-feat/Degree]() (69; 3% instances)

`ADV` occurs with 2 feature-value pairs: `Degree=Cmp`, `Degree=Sup`

`ADV` occurs with 3 feature combinations.
The most frequent feature combination is `_` (2571 tokens).
Examples: <em>ως, επίσης, όπως, σχετικά, σήμερα, μόνο, εδώ, πολύ, σύμφωνα, πιο</em>


## Relations

`ADV` nodes are attached to their parents using 18 different relations: [el-dep/advmod]() (2249; 85% instances), [el-dep/amod]() (104; 4% instances), [el-dep/case]() (92; 3% instances), [el-dep/cc]() (51; 2% instances), [el-dep/remnant]() (44; 2% instances), [el-dep/conj]() (36; 1% instances), [el-dep/dep]() (21; 1% instances), [el-dep/mark]() (15; 1% instances), [el-dep/root]() (7; 0% instances), [el-dep/dobj]() (6; 0% instances), [el-dep/appos]() (4; 0% instances), [el-dep/nsubj]() (4; 0% instances), [el-dep/ccomp]() (2; 0% instances), [el-dep/acl]() (1; 0% instances), [el-dep/acl:relcl]() (1; 0% instances), [el-dep/advcl]() (1; 0% instances), [el-dep/csubj]() (1; 0% instances), [el-dep/mwe]() (1; 0% instances)

Parents of `ADV` nodes belong to 11 different parts of speech: [VERB]() (1614; 61% instances), [NOUN]() (452; 17% instances), [ADJ]() (278; 11% instances), [ADV]() (116; 4% instances), [CONJ]() (89; 3% instances), [NUM]() (49; 2% instances), [PRON]() (18; 1% instances), [ADP]() (13; 0% instances), [ROOT]() (7; 0% instances), [PUNCT]() (3; 0% instances), [DET]() (1; 0% instances)

1839 (70%) `ADV` nodes are leaves.

558 (21%) `ADV` nodes have one child.

181 (7%) `ADV` nodes have two children.
...
Children of `ADV` nodes belong to 11 different parts of speech: [NOUN]() (457; 40% instances), [PUNCT]() (253; 22% instances), [ADV]() (116; 10% instances), [ADP]() (98; 9% instances), [CONJ]() (78; 7% instances), [VERB]() (43; 4% instances), [PRON]() (38; 3% instances), [DET]() (21; 2% instances), [PART]() (16; 1% instances), [ADJ]() (11; 1% instances), [NUM]() (9; 1% instances)
