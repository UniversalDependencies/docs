---
layout: base
title:  'Statistics of INTJ in UD_Korean-KSL'
udver: '2'
---
...
The 10 most frequent `INTJ` types:  네, 야, 그래요, 뭘, 아, 어, 어머, 하하하
...
The 2nd highest number of forms (1) was observed with the lemma “네”: 네.

The 3rd highest number of forms (1) was observed with the lemma “뭘”: 뭘.
...
`INTJ` nodes are attached to their parents using 7 different relations: <tt><a href="ko_ksl-dep-root.html">root</a></tt> (4; 40% instances), <tt><a href="ko_ksl-dep-advcl.html">advcl</a></tt> (1; 10% instances), <tt><a href="ko_ksl-dep-ccomp.html">ccomp</a></tt> (1; 10% instances), <tt><a href="ko_ksl-dep-discourse.html">discourse</a></tt> (1; 10% instances), <tt><a href="ko_ksl-dep-nmod.html">nmod</a></tt> (1; 10% instances), <tt><a href="ko_ksl-dep-parataxis.html">parataxis</a></tt> (1; 10% instances), <tt><a href="ko_ksl-dep-vocative.html">vocative</a></tt> (1; 10% instances)

Parents of `INTJ` nodes belong to 3 different parts of speech: <tt><a href="ko_ksl-pos-VERB.html">VERB</a></tt> (5; 50% instances),  (4; 40% instances), <tt><a href="ko_ksl-pos-ADV.html">ADV</a></tt> (1; 10% instances)

2 (20%) `INTJ` nodes are leaves.

5 (50%) `INTJ` nodes have one child.

2 (20%) `INTJ` nodes have two children.

1 (10%) `INTJ` nodes have three or more children.

The highest child degree of a `INTJ` node is 3.

Children of `INTJ` nodes are attached using 4 different relations: <tt><a href="ko_ksl-dep-punct.html">punct</a></tt> (8; 67% instances), <tt><a href="ko_ksl-dep-nsubj.html">nsubj</a></tt> (2; 17% instances), <tt><a href="ko_ksl-dep-advcl.html">advcl</a></tt> (1; 8% instances), <tt><a href="ko_ksl-dep-case.html">case</a></tt> (1; 8% instances)

Children of `INTJ` nodes belong to 5 different parts of speech: <tt><a href="ko_ksl-pos-PUNCT.html">PUNCT</a></tt> (8; 67% instances), <tt><a href="ko_ksl-pos-ADP.html">ADP</a></tt> (1; 8% instances), <tt><a href="ko_ksl-pos-NOUN.html">NOUN</a></tt> (1; 8% instances), <tt><a href="ko_ksl-pos-PRON.html">PRON</a></tt> (1; 8% instances), <tt><a href="ko_ksl-pos-VERB.html">VERB</a></tt> (1; 8% instances)
