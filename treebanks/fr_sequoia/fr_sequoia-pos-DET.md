...
There are 44 `DET` lemmas (1%), 77 `DET` types (1%) and 10458 `DET` tokens (15%).
...
The form / lemma ratio of `DET` is 1.750000 (the average of all parts of speech is 1.404382).
