...
165592 tokens (57%) have a non-empty value of `Number`.
44157 types (87%) occur at least once with a non-empty value of `Number`.
36938 lemmas (88%) occur at least once with a non-empty value of `Number`.
The feature is used with 11 part-of-speech tags: <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> (51463; 18% instances), <tt><a href="de_gsd-pos-DET.html">DET</a></tt> (40923; 14% instances), <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> (27154; 9% instances), <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> (14245; 5% instances), <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> (12456; 4% instances), <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> (9876; 3% instances), <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> (9202; 3% instances), <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> (108; 0% instances), <tt><a href="de_gsd-pos-X.html">X</a></tt> (96; 0% instances), <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> (59; 0% instances), <tt><a href="de_gsd-pos-SYM.html">SYM</a></tt> (10; 0% instances).
...
The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="de_gsd-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (35279; 86%), <tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (34776; 85%), <tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (29311; 72%).

`DET` tokens may have the following values of `Number`:

* `Plur` (6913; 17% of non-empty `Number`): <em>die, den, der, alle, diese, seine, viele, beiden, anderen, einige</em>
* `Sing` (34010; 83% of non-empty `Number`): <em>der, dem, die, das, des, eine, ein, den, einer, einen</em>
* `EMPTY` (282): <em>the, mehr, viel, wenig, weniger, selber, all, keinerlei, ein, einig</em>

<table>
  <tr><th>Paradigm <i>der</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>den</em></td><td><em>den</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>des, der</em></td><td><em>der</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt></tt></td><td><em>der</em></td><td><em>der</em></td></tr>
...
* `Plur` (4314; 30% of non-empty `Number`): <em>weitere, ersten, verschiedenen, verschiedene, zahlreiche, neue, großen, letzten, weiteren, besten</em>
* `Sing` (9931; 70% of non-empty `Number`): <em>ersten, erste, zweiten, neuen, neue, deutschen, großen, große, heutigen, zweite</em>
* `EMPTY` (7495): <em>später, gut, bekannt, kurz, freundlich, schnell, lang, neu, direkt, super</em>
...
12456 <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> tokens (60% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (12456; 100%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (12238; 98%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (12023; 97%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (6472; 52%).

`VERB` tokens may have the following values of `Number`:

* `Plur` (2658; 21% of non-empty `Number`): <em>haben, stehen, gehören, hatten, kamen, kommen, sind, fanden, finden, liegen</em>
* `Sing` (9798; 79% of non-empty `Number`): <em>wurde, gibt, hat, liegt, kam, hatte, gab, war, erhielt, befindet</em>
...
9876 <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9876; 100%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9364; 95%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9295; 94%), <tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (7381; 75%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5618; 57%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (2551; 26% of non-empty `Number`): <em>sind, wurden, werden, waren, haben, können, sollen, hatten, konnten, müssen</em>
* `Sing` (7325; 74% of non-empty `Number`): <em>ist, wurde, war, wird, kann, hat, hatte, konnte, habe, sei</em>
...
9202 <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> tokens (85% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="de_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (9101; 99%), <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt> (7149; 78%), <tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (6050; 66%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (4740; 52%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (1679; 18% of non-empty `Number`): <em>die, sie, wir, uns, denen, deren, ihnen, ihr, euch, den</em>
* `Sing` (7523; 82% of non-empty `Number`): <em>er, es, sie, ich, der, die, man, das, was, ihm</em>
...
* `EMPTY` (7228): <em>zwei, drei, vier, 2007, 2006, fünf, 2009, 2010, sechs, 2008</em>
...
* `EMPTY` (216): <em>'s, u.a., etc., z.B., z., a, †, z, *, u</em>
...
59 <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Number`.

`ADV` tokens may have the following values of `Number`:

* `Plur` (7; 12% of non-empty `Number`): <em>Katzelmacher, Wenige, aufgetretene, leibeigene, längerer, mehrere, verbundenen</em>
* `Sing` (52; 88% of non-empty `Number`): <em>ca, was, super, SEHR, lange, vorallem, Abends, Allzeit, Anfangs, Dort</em>
* `EMPTY` (13786): <em>auch, nur, noch, sehr, so, dort, wieder, hier, mehr, heute</em>
...
`Number` seems to be **lexical feature** of `ADV`. 98% lemmas (48) occur only with one value of `Number`.
...
<tt>NOUN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (30569; 98%),
<tt>NOUN --[<tt><a href="de_gsd-dep-amod.html">amod</a></tt>]--> ADJ</tt> (12326; 93%),
<tt>NOUN --[<tt><a href="de_gsd-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (6371; 62%),
<tt>PROPN --[<tt><a href="de_gsd-dep-flat.html">flat</a></tt>]--> PROPN</tt> (5481; 93%),
<tt>PROPN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (5184; 92%),
<tt>VERB --[<tt><a href="de_gsd-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (4448; 79%),
...
<tt>NOUN --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> NOUN</tt> (3006; 73%),
