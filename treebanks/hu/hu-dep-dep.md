---
layout: base
title:  'Statistics of dep in UD_Hungarian'
udver: '2'
---

## Treebank Statistics: UD_Hungarian: Relations: `dep`
...
The following 1 pairs of parts of speech are connected with `dep`: <tt><a href="hu-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hu-pos-VERB.html">VERB</a></tt> (1; 100% instances).
