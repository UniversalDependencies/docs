...
- _двое, трое, четверо, пятеро&nbsp;_ “four, five”: collective numerals (see http://universaldependencies.org/ru/overview/specific-syntax.html#collectives on their morphosyntactic behavior).
