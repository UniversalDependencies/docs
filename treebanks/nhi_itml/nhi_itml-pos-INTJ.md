...
The form / lemma ratio of `INTJ` is 1.150000 (the average of all parts of speech is 1.458263).

The 1st highest number of forms (3) was observed with the lemma “ay”: <em>Ayayay, aay, ay</em>.

The 2nd highest number of forms (2) was observed with the lemma “ah”: <em>Ah, Ahh</em>.
...
21 (34%) `INTJ` nodes are leaves.

14 (23%) `INTJ` nodes have one child.
