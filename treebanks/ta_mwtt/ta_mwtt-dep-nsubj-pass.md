---
layout: base
title:  'Statistics of nsubj:pass in UD_Tamil-MWTT'
udver: '2'
---

## Treebank Statistics: UD_Tamil-MWTT: Relations: `nsubj:pass`

This relation is a language-specific subtype of <tt><a href="ta_mwtt-dep-nsubj.html">nsubj</a></tt>.
There are also 1 other language-specific subtypes of `nsubj`: <tt><a href="ta_mwtt-dep-nsubj-nc.html">nsubj:nc</a></tt>.
...
The following 1 pairs of parts of speech are connected with `nsubj:pass`: <tt><a href="ta_mwtt-pos-VERB.html">VERB</a></tt>-<tt><a href="ta_mwtt-pos-PROPN.html">PROPN</a></tt> (4; 100% instances).
