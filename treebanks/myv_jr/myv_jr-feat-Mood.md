...
2048 <tt><a href="myv_jr-pos-VERB.html">VERB</a></tt> tokens (71% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (2048; 100%), <tt><a href="myv_jr-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (2047; 100%), <tt><a href="myv_jr-feat-Derivation.html">Derivation</a></tt><tt>=EMPTY</tt> (2005; 98%), <tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=3</tt> (1715; 84%), <tt><a href="myv_jr-feat-Number-obj.html">Number[obj]</a></tt><tt>=EMPTY</tt> (1641; 80%), <tt><a href="myv_jr-feat-Person-obj.html">Person[obj]</a></tt><tt>=EMPTY</tt> (1637; 80%), <tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt> (1445; 71%), <tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=Prt1</tt> (1191; 58%).
...
* `Cnj` (12; 1% of non-empty `Mood`): <em>кандоволь, кирдевель, ладяволь, маняволь, маштовлидизь, миевлик, пачкодевель, пештявлизь, рамавлить, чавовледезь</em>
...
* `Imp` (92; 4% of non-empty `Mood`): <em>адя, вант, азё, ванодо, кирдть, Ёвтак, кадык, учок, чийть, ютак</em>
* `Ind` (1919; 94% of non-empty `Mood`): <em>кармась, мерсь, лиссь, кармасть, мольсь, совась, ашти, ютась, неяви, саизе</em>
* `Opt` (5; 0% of non-empty `Mood`): <em>лоподезэ, лоткаст, маряст, содаст, эцест</em>
* `EMPTY` (823): <em>кортамо, молемс, оймсеме, тееме, теемс, чиезь, пелезь, сёрмадомо, учо, жаля</em>
...
`Mood` seems to be **lexical feature** of `VERB`. 90% lemmas (564) occur only with one value of `Mood`.
...
8 <tt><a href="myv_jr-pos-SCONJ.html">SCONJ</a></tt> tokens (15% of all `SCONJ` tokens) have a non-empty value of `Mood`.
...
* `EMPTY` (44): <em>зярдо, што, бути, теке, кода, куш, прок, штобу, хоть, Коли</em>
...
* `EMPTY` (115): <em>жо, бути, прок, вана, эно, буто, паряк, весемеде, ялатеке, Бульчом</em>

## Relations with Agreement in `Mood`

The 10 most frequent relations where parent and child node agree in `Mood`:
<tt>VERB --[<tt><a href="myv_jr-dep-conj.html">conj</a></tt>]--> VERB</tt> (505; 84%),
