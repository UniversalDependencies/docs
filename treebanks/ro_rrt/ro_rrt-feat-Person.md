...
* `1` (647; 5% of non-empty `Person`): <em>știu, putem, avem, cred, rog, spun, așteptam, rugăm, vedem, văd</em>
* `2` (853; 7% of non-empty `Person`): <em>luați, vezi, aveți, utilizați, poți, puteai, spuneți, puteți, știți, lăsați</em>
* `3` (10773; 88% of non-empty `Person`): <em>poate, trebuie, pot, are, avea, era, putea, există, au, face</em>
* `EMPTY` (10717): <em>avut, prevăzute, putea, făcut, trebui, având, avea, face, spus, putut</em>
...
<tt>VERB --[<tt><a href="ro_rrt-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (1606; 75%),
