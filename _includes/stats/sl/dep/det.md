...
3299 nodes (2%) are attached to their parents as `det`.

3299 instances of `det` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.33343437405274.

The following 2 pairs of parts of speech are connected with `det`: [sl-pos/NOUN]()-[sl-pos/DET]() (3278; 99% instances), [sl-pos/PROPN]()-[sl-pos/DET]() (21; 1% instances).
