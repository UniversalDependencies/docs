...
4	оз	оз	AUX	V	Mood=Ind|Person=3|Polarity=Neg|Tense=Pres|VerbForm=Fin	3	aux	_	_
...
2	унасӧ	уна	PRON	Pron	Case=Acc|Number=Sing|Number[psor]=Sing|Person[psor]=3|PronType=Ind	5	obj	_	GTtags=Sg,Acc,PxSg3
3	нинӧм	нинӧм	PRON	Pron	Case=Nom|Number=Sing|Polarity=Neg|PronType=Ind	2	det	_	GTtags=Neg,Sg,Nom
