---
layout: base
title:  'Statistics of parataxis in UD_Cappadocian-AMGiC'
udver: '2'
---

## Treebank Statistics: UD_Cappadocian-AMGiC: Relations: `parataxis`
...
Average distance between parent and child is 7.18181818181818.

The following 1 pairs of parts of speech are connected with `parataxis`: <tt><a href="cpg_amgic-pos-VERB.html">VERB</a></tt>-<tt><a href="cpg_amgic-pos-VERB.html">VERB</a></tt> (11; 100% instances).
