...
1085 <tt><a href="et_edt-pos-AUX.html">AUX</a></tt> tokens (5% of all `AUX` tokens) have a non-empty value of `Connegative`.

The most frequent other feature values with which `AUX` and `Connegative` co-occurred: <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (1085; 100%), <tt><a href="et_edt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (1085; 100%), <tt><a href="et_edt-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (1085; 100%), <tt><a href="et_edt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1041; 96%), <tt><a href="et_edt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (1034; 95%), <tt><a href="et_edt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (965; 89%), <tt><a href="et_edt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (889; 82%).

`AUX` tokens may have the following values of `Connegative`:

* `Yes` (1085; 100% of non-empty `Connegative`): <em>ole, saa, olnud, ei, tohi, pea, tohiks, saanud, oleks, peaks</em>
