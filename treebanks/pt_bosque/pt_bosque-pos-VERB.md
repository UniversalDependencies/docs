...
There are 1955 `VERB` lemmas (10%), 7131 `VERB` types (25%) and 20782 `VERB` tokens (9%).
...
The form / lemma ratio of `VERB` is 3.647570 (the average of all parts of speech is 1.414227).
