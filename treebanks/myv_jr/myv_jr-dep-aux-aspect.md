...
95 instances of `aux:aspect` (89%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.37383177570093.

The following 3 pairs of parts of speech are connected with `aux:aspect`: <tt><a href="myv_jr-pos-VERB.html">VERB</a></tt>-<tt><a href="myv_jr-pos-AUX.html">AUX</a></tt> (104; 97% instances), <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt>-<tt><a href="myv_jr-pos-AUX.html">AUX</a></tt> (2; 2% instances), <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="myv_jr-pos-AUX.html">AUX</a></tt> (1; 1% instances).
...
3	ловныцянзо	ловныця	NOUN	N	Case=Nom|Number=Plur|Number[psor]=Sing|Person[psor]=3|VerbForm=NomAg	7	nsubj	_	GTtags=Pl,Nom,PxSg3|Gloss=reader
