...
The form / lemma ratio of `VERB` is 2.165209 (the average of all parts of speech is 1.381641).
...
`VERB` occurs with 13 feature-value pairs: `Abbr=Yes`, `Definite=Ind`, `Gender=Com`, `Mood=Imp`, `Mood=Ind`, `Number=Sing`, `Tense=Past`, `Tense=Pres`, `VerbForm=Fin`, `VerbForm=Fin,Part`, `VerbForm=Inf`, `VerbForm=Part`, `Voice=Pass`
