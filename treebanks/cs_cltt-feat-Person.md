...
The feature is used with 4 part-of-speech tags: [-pos/VERB]() (1426; 4% instances), [-pos/AUX]() (454; 1% instances), [-pos/DET]() (216; 1% instances), [-pos/PRON]() (71; 0% instances).

### `VERB`

1426 [-pos/VERB]() tokens (67% of all `VERB` tokens) have a non-empty value of `Person`.
...
454 [-pos/AUX]() tokens (75% of all `AUX` tokens) have a non-empty value of `Person`.
...
216 [-pos/DET]() tokens (36% of all `DET` tokens) have a non-empty value of `Person`.
...
71 [-pos/PRON]() tokens (6% of all `PRON` tokens) have a non-empty value of `Person`.
