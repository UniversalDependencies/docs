---
layout: base
title:  'Statistics of fixed in UD_Ottoman_Turkish-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Ottoman_Turkish-TueCL: Relations: `fixed`
...
The following 2 pairs of parts of speech are connected with `fixed`: <tt><a href="ota_tuecl-pos-CCONJ.html">CCONJ</a></tt>-<tt><a href="ota_tuecl-pos-ADV.html">ADV</a></tt> (1; 50% instances), <tt><a href="ota_tuecl-pos-PRON.html">PRON</a></tt>-<tt><a href="ota_tuecl-pos-PRON.html">PRON</a></tt> (1; 50% instances).
