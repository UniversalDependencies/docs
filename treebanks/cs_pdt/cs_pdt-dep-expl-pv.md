...
5	mezník	mezník	NOUN	NNIS1-----A----	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing|Polarity=Pos	1	nsubj:pass	1:nsubj:pass|13:obl	Functor=1:PAT|SpaceAfter=No
...
10	nevidomý	nevidomý	NOUN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|Number=Sing|Polarity=Pos	13	nsubj	13:nsubj	Entity=(ln9420736c74--1-gstype:gen)|Functor=13:ACT.cop|LId=nevidomý-2
...
6	renesanci	renesance	NOUN	NNFS6-----A----	Case=Loc|Gender=Fem|Number=Sing|Polarity=Pos	7	obl	7:obl:v:loc	LGloss=(^DD**renezance)
...
9	ztotožnění	ztotožnění	NOUN	NNNS3-----A----	Case=Dat|Gender=Neut|Number=Sing|Polarity=Pos|VerbForm=Vnoun	7	obl:arg	7:obl:arg:k:dat	LDeriv=ztotožnit
...
19	uvědomění	uvědomění	NOUN	NNNS3-----A----	Case=Dat|Gender=Neut|Number=Sing|Polarity=Pos|VerbForm=Vnoun	9	conj	7:obl:arg:k:dat|9:conj	LDeriv=uvědomit
...
34	řečeno	řečený	ADJ	VsNS----X-APP--	Aspect=Perf|Gender=Neut|Number=Sing|Polarity=Pos|Variant=Short|VerbForm=Part|Voice=Pass	19	obl	19:obl|37:obl	SpaceAfter=No|LDeriv=říci
...
39	těžení	těžení	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos|VerbForm=Vnoun	37	nmod	37:nmod:gen	LDeriv=těžit
