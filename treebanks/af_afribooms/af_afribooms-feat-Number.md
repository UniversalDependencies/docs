...
3116 lemmas (59%) occur at least once with a non-empty value of `Number`.
The feature is used with 3 part-of-speech tags: <tt><a href="af_afribooms-pos-NOUN.html">NOUN</a></tt> (10458; 21% instances), <tt><a href="af_afribooms-pos-PRON.html">PRON</a></tt> (2144; 4% instances), <tt><a href="af_afribooms-pos-PROPN.html">PROPN</a></tt> (591; 1% instances).

### `NOUN`

10458 <tt><a href="af_afribooms-pos-NOUN.html">NOUN</a></tt> tokens (100% of all `NOUN` tokens) have a non-empty value of `Number`.

`NOUN` tokens may have the following values of `Number`:

* `Plur` (2932; 28% of non-empty `Number`): <em>mense, leerders, dienste, opsigte, Suid-Afrikaners, pogings, lande, sake, uitdagings, dokumente</em>
* `Sing` (7526; 72% of non-empty `Number`): <em>jaar, regering, aansoek, inligting, land, departement, staat, toegang, webwerf, persoon</em>
...
2144 <tt><a href="af_afribooms-pos-PRON.html">PRON</a></tt> tokens (59% of all `PRON` tokens) have a non-empty value of `Number`.
...
* `EMPTY` (1463): <em>wat, enige, daar, almal, elke, daarvan, waar, wanneer, watter, wie</em>

`Number` seems to be **lexical feature** of `PRON`. 100% lemmas (21) occur only with one value of `Number`.

### `PROPN`

591 <tt><a href="af_afribooms-pos-PROPN.html">PROPN</a></tt> tokens (100% of all `PROPN` tokens) have a non-empty value of `Number`.

`PROPN` tokens may have the following values of `Number`:

* `Sing` (591; 100% of non-empty `Number`): <em>Suid-Afrika, Afrika, Februarie, Madiba, Crime, Mandela, of, Bafana, Maart, Tambo</em>
...
<tt>NOUN --[<tt><a href="af_afribooms-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (1598; 63%),
<tt>NOUN --[<tt><a href="af_afribooms-dep-conj.html">conj</a></tt>]--> NOUN</tt> (943; 78%),
...
<tt>NOUN --[<tt><a href="af_afribooms-dep-obl.html">obl</a></tt>]--> NOUN</tt> (25; 58%),
