...
1	et	et	CCONJ	C-	_	6	cc	_	ref=MARK_6.51
2	plus	multum	ADV	Df	Degree=Cmp	3	advmod	_	ref=MARK_6.51
3	magis	magis	ADV	Df	Degree=Cmp	6	advmod	_	ref=MARK_6.51
4	intra	intra	ADP	R-	_	5	case	_	ref=MARK_6.51
5	se	se	PRON	Pk	Case=Acc|Gender=Masc|Number=Plur|Person=3|PronType=Prs|Reflex=Yes	6	dep	_	ref=MARK_6.51
6	stupebant	stupeo	VERB	V-	Aspect=Imp|Mood=Ind|Number=Plur|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	0	root	_	ref=MARK_6.51
...
6	illo	ille	ADJ	Pd	Case=Abl|Gender=Masc|Number=Sing	3	dep	_	ref=MARK_6.14
