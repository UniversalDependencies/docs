---
layout: base
title:  'Statistics of xcomp in UD_Pashto-Sikaram'
udver: '2'
---

## Treebank Statistics: UD_Pashto-Sikaram: Relations: `xcomp`
...
6	د	د	ADP	_	Case=Acc	7	case	_	Translit=dë|LTranslit=dë|Gloss=of
7	دفتر	دفتر	NOUN	_	Case=Acc|Gender=Masc|Number=Sing	15	nmod	_	Translit=daftár|LTranslit=daftár|Gloss=office
8	او	او	CCONJ	_	_	10	cc	_	Translit=aw|LTranslit=aw|Gloss=and
9	رسمي	رسمي	ADJ	_	Case=Acc|Gender=Fem|Number=Plur	10	amod	_	Translit=rasmí|LTranslit=rasmí|Gloss=official
10	ادارو	اداره	NOUN	_	Case=Acc|Gender=Fem|Number=Plur	7	conj	_	Translit=idâró|LTranslit=idârá|Gloss=institutions|SpaceAfter=No
11	،	،	PUNCT	_	_	12	punct	_	Translit=,|LTranslit=,|Gloss=,
12	دربار	دربار	NOUN	_	Case=Acc|Gender=Masc|Number=Sing	7	conj	_	Translit=darbấr|LTranslit=darbấr|Gloss=court
...
# visual-style 13 5 xcomp	color:blue
