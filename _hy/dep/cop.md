...
the copular verb _<b>եմ</b>,_ “to be” (or its variants (with separate lemma) _լինել_). The verbs _դառնալ, թվալ, երևալ, ձևանալ, մնալ, հաշվել_ etc. “to become”, despite being counted among copular verbs by some authors (_ստորոգելիական վերադիր, վերադրառու բայեր_),
