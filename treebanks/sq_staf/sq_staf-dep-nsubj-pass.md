---
layout: base
title:  'Statistics of nsubj:pass in UD_Albanian-STAF'
udver: '2'
---
...
There are also 1 other language-specific subtypes of `nsubj`: <tt><a href="sq_staf-dep-nsubj-outer.html">nsubj:outer</a></tt>.
...
The following 1 pairs of parts of speech are connected with `nsubj:pass`: <tt><a href="sq_staf-pos-VERB.html">VERB</a></tt>-<tt><a href="sq_staf-pos-NOUN.html">NOUN</a></tt> (1; 100% instances).
