...
<ul>
<li>This corpus uses 37 lemmas as copulas (<a>cop</a>): *, být, bývat, determinační, dlouhý, doktrína, doprovázený, dosažitelný, dále, faktor, impuls, jeden, krásný, lhostejný, metoda, moci, muset, mít, měkký, nabubřování, naopak, nebo, náboženství, odolný, pohyblivost, prostředek, pěstovat, připadat, souhrn, titul, uhlí, vyžadovat, výhodný, zahrada, znak, značka, řehole.</li>
<li>This corpus uses 9 lemmas as auxiliaries (<a>aux</a>): &camount;, *, být, bývat, jako, rozdělený, ten, třeba, vytištěný.</li>
<li>This corpus uses 5 lemmas as passive auxiliaries (<a>aux:pass</a>): &camount;, *, být, bývat, rámec.</li>
</ul>
