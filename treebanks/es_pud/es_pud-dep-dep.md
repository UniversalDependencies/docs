...
10	rompió	romper	VERB	VBC	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	_
...
22	afirmó	afirmar	VERB	VBC	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	10	conj	_	_
...
1	Empezó	empezar	VERB	VBC	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	_
2	en	en	ADP	IN	_	3	case	_	_
3	RSC	RSC	PROPN	NNP	Number=Sing	1	obl	_	_
4	a	a	ADP	IN	_	5	case	_	_
5	mediados	mediado	NOUN	NN	Gender=Masc|Number=Plur	1	obl	_	_
6	de	de	ADP	IN	_	8	case	_	_
7	los	el	DET	DT	Definite=Def|Gender=Masc|Number=Plur|PronType=Art	8	det	_	_
8	años	año	NOUN	NN	Gender=Masc|Number=Plur	5	nmod	_	_
