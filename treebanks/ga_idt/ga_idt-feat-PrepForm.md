...
The feature is used with 1 part-of-speech tags: <tt><a href="ga_idt-pos-ADP.html">ADP</a></tt> (166; 1% instances).

### `ADP`

166 <tt><a href="ga_idt-pos-ADP.html">ADP</a></tt> tokens (4% of all `ADP` tokens) have a non-empty value of `PrepForm`.

The most frequent other feature values with which `ADP` and `PrepForm` co-occurred: <tt><a href="ga_idt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (166; 100%), <tt><a href="ga_idt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (166; 100%), <tt><a href="ga_idt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (166; 100%), <tt><a href="ga_idt-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (166; 100%).
