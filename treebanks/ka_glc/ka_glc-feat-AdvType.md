...
1663 tokens (3%) have a non-empty value of `AdvType`.
399 types (3%) occur at least once with a non-empty value of `AdvType`.
378 lemmas (4%) occur at least once with a non-empty value of `AdvType`.
The feature is used with 1 part-of-speech tags: <tt><a href="ka_glc-pos-ADV.html">ADV</a></tt> (1663; 3% instances).

### `ADV`

1663 <tt><a href="ka_glc-pos-ADV.html">ADV</a></tt> tokens (97% of all `ADV` tokens) have a non-empty value of `AdvType`.
...
* `Tim` (308; 19% of non-empty `AdvType`): <em>შემდეგ, პირველად, ზოგჯერ, ჯერ, ამჟამად, უკვე, თავდაპირველად, დღეს, მოგვიანებით, ბოლოს</em>
...
`AdvType` seems to be **lexical feature** of `ADV`. 97% lemmas (368) occur only with one value of `AdvType`.
