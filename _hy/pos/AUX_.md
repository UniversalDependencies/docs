...
The most commonly used auxiliary verb in Armenian is _եմ_/_em_ “be”, and its variant (with separate lemma) _լինեմ (լինել)_/_linem_.
...
- mood auxiliary, used to form periphrastic necessitative mood with _պիտի_/_piti_ “to be necessary, useful” or _պետք է_/_petk’ ē_ lit. is needed.

### Examples

- Present tense. The finite present form of _եմ_/_em_ is combined with imperfective and resultative participles of the lexical verb. The auxiliary expresses aspect, person, number, mood and tense, participles express aspect and voice:
...
- Imperfect tense. The finite imperfect form of _էի_/_ēi_ is combined with imperfective, perfect and resultative participles of the lexical verb. The auxiliary expresses aspect, person, number, mood and tense, participles express aspect and voice:
...
Note that the finite present and imperfect forms of _եմ_/_em_ and _էի_/_ēi_ are also used with the perfect and future participles of the lexical verbs to form periphrastic present perfect (e.g. _վազել <b>եմ</b>_/_vazel <b>em</b>_ “I have run”), (present-)future (e.g. _վազելու <b>եմ</b>_/_vazelow em_ “I shall run”) and future-in-the-past (_վազելու <b>էի</b>_/_vazelow ēi_  “I would (intended to) run”). The auxiliaries express aspect, person, number, mood and tense (`Tense=Pres` and `Tense=Imp` accordingly), participles express aspect and voice.
...
Since there is no generally accepted approach in Armenian grammar to the analysis of finite forms of the verb _լինել_/_linel_ “be” as either auxiliary or lexical verbs, the Armenian UD treebank adopts the following principle: the aorist and the present and imperfect forms of the subjunctive and conditional moods of _լինեմ_/_linem_ (_եղավ_/_eġav_ "was", _լինի_/_lini_ "if-it-is", _լիներ_/_liner_ "if-it-was", _կլինի_/_klini_ "will-be", and _կլիներ_/_kliner_ "would-be") are analyzed as lexical verbs whenever they occur with nominal predicates, and as auxiliaries only when they combine with participles.
...
With a nominal predicate, _եմ_/_em_ functions as a copula, making the nominal predicate (noun, adjective, etc.) the head of the clause, and is attached to it via the `cop` relation. Note that in Armenian copulas are also tagged `AUX` and the definition of copular clauses has been extended to location-existentials (_Առավոտյան ստվերն այս կողմում է_/_Aṙavotyan stvern ays koġmowm ē_ “In the morning, the shadow is on this side.”). Only non-copular existential uses of _լինել_/_linel_ and _կամ_/_kam_ are tagged `VERB` (_Այն <b>եղել</b> է ու <b>կա</b> որպես հուշ։_/_Ayn <b>eġel</b> ē ow <b>ka</b> orpes howš_ “It existed then and still exists as a memory.”).
...
Armenian modal verbs are not considered auxiliaries and are tagged `VERB`. Their behavior is only slightly different from other content verbs.
