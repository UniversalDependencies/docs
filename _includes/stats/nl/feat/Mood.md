...
The feature is used with 3 part-of-speech tags: [nl-pos/VERB]() (11700; 6% instances), [nl-pos/AUX]() (7410; 4% instances), [nl-pos/X]() (102; 0% instances).

### `VERB`

11700 [nl-pos/VERB]() tokens (58% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (11700; 100%), <tt><a href="Aspect.html">Aspect</a>=Imp</tt> (11536; 99%), <tt><a href="Number.html">Number</a>=Sing</tt> (9183; 78%), <tt><a href="VerbType.html">VerbType</a>=EMPTY</tt> (8510; 73%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (7090; 61%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (6107; 52%).

`VERB` tokens may have the following values of `Mood`:

* `Imp` (152; 1% of non-empty `Mood`): <em>Noem, geef, kijk, kom, zie, Doe, ga, Eet, denk, stel</em>
* `Ind` (11536; 99% of non-empty `Mood`): <em>zal, heeft, kan, zou, moet, komt, wil, gaat, zullen, hebben</em>
* `Sub` (12; 0% of non-empty `Mood`): <em>moge, Leve, geve, inslape, mijde, oordele, ware, zegge</em>
* `EMPTY` (8412): <em>kunnen, gaan, komen, maken, moeten, zien, doen, laten, nemen, geven</em>
...
`Mood` seems to be **lexical feature** of `VERB`. 97% lemmas (1224) occur only with one value of `Mood`.

### `AUX`

7410 [nl-pos/AUX]() tokens (65% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (7410; 100%), <tt><a href="Aspect.html">Aspect</a>=Imp</tt> (7398; 100%), <tt><a href="Subcat.html">Subcat</a>=EMPTY</tt> (7204; 97%), <tt><a href="VerbType.html">VerbType</a>=Aux,Cop</tt> (5970; 81%), <tt><a href="Number.html">Number</a>=Sing</tt> (5903; 80%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (5337; 72%), <tt><a href="Person.html">Person</a>=3</tt> (3857; 52%).

`AUX` tokens may have the following values of `Mood`:

* `Imp` (4; 0% of non-empty `Mood`): <em>Wees, Word</em>
* `Ind` (7398; 100% of non-empty `Mood`): <em>is, was, werd, heeft, zijn, wordt, hebben, had, waren, heb</em>
* `Sub` (8; 0% of non-empty `Mood`): <em>zij, ware</em>
* `EMPTY` (4020): <em>worden, zijn, geweest, hebben, genoemd, gehouden, geworden, gekomen, gemaakt, blijven</em>
...
<table>
  ...
  <tr><td><tt><a href="Aspect.html">Aspect</a>=Imp|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>is</em></td><td></td><td></td></tr>
  <tr><td><tt><a href="Aspect.html">Aspect</a>=Imp|<a href="Number.html">Number</a>=Sing|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Pres|<a href="VerbType.html">VerbType</a>=Aux,Cop</tt></td><td><em>is, Da's</em></td><td></td><td></td></tr>
  ...
  <tr><td><tt><a href="VerbType.html">VerbType</a>=Aux,Cop</tt></td><td></td><td><em>Wees</em></td><td><em>zij, ware</em></td></tr>
</table>

`Mood` seems to be **lexical feature** of `AUX`. 98% lemmas (91) occur only with one value of `Mood`.

### `X`

102 [nl-pos/X]() tokens (2% of all `X` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `X` and `Mood` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (102; 100%), <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (94; 92%), <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (82; 80%), <tt><a href="Number.html">Number</a>=Sing</tt> (70; 69%).
...
<tt>VERB --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (247; 77%),
...
<tt>X --[<a href="../dep/compound.html">compound</a>]--> X</tt> (50; 100%),
<tt>AUX --[<a href="../dep/conj.html">conj</a>]--> AUX</tt> (44; 96%),
<tt>AUX --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (39; 89%).
