...
Out of 14 observed tags, the rank of `CCONJ` is: 13 in number of lemmas, 13 in number of types and 8 in number of tokens.
...
The form / lemma ratio of `CCONJ` is 1.000000 (the average of all parts of speech is 1.749612).
