---
layout: base
title:  'Statistics of dep in UD_Skolt_Sami-Giellagas'
udver: '2'
---

## Treebank Statistics: UD_Skolt_Sami-Giellagas: Relations: `dep`
...
3	koozz	koss	ADV	Adv	Case=Ill	4	advmod	_	GTtags=N,Pl,Nom
4	vueʹlǧǧe	vueʹlǧǧed	VERB	V	Mood=Ind|Number=Plur|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	GTtags=Ind,Prs,Pl3|SpaceAfter=No
...
9	poʹhtte	puʹhtted	VERB	V	Mood=Ind|Number=Plur|Person=3|Tense=Pres|VerbForm=Fin	4	conj	_	GTtags=Ind,Prs,Pl3
10	põʹrtte	põrtt	NOUN	N	Case=Ill|Number=Sing	9	obl	_	GTtags=Sg,Ill,@<ADVL|SpaceAfter=No
