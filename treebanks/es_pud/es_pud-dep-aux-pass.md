...
The following 3 pairs of parts of speech are connected with `aux:pass`: <tt><a href="es_pud-pos-VERB.html">VERB</a></tt>-<tt><a href="es_pud-pos-AUX.html">AUX</a></tt> (88; 94% instances), <tt><a href="es_pud-pos-NOUN.html">NOUN</a></tt>-<tt><a href="es_pud-pos-AUX.html">AUX</a></tt> (5; 5% instances), <tt><a href="es_pud-pos-ADJ.html">ADJ</a></tt>-<tt><a href="es_pud-pos-AUX.html">AUX</a></tt> (1; 1% instances).
...
4	fue	ser	AUX	VBC	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Pass	7	aux:pass	_	_
5	nombrado	_	AUX	VBN	Gender=Masc|Number=Sing|VerbForm=Fin	7	cop	_	_
...
8	más	_	ADV	RBR	Degree=Cmp	9	advmod	_	_
...
13	XX	_	NUM	CD	Gender=Masc|NumType=Card	12	appos	_	_
14	en	_	ADP	IN	_	16	case	_	_
15	los	el	DET	DT	Definite=Def|Gender=Masc|Number=Plur|PronType=Art	16	det	_	_
...
20	Siglo	_	NOUN	NN	Gender=Masc|Number=Sing	17	nmod	_	SpaceAfter=No|Proper=True
...
9	1911	_	NUM	CD	Gender=Masc|NumType=Card	3	nmod	_	SpaceAfter=No
10	,	_	PUNCT	,	_	3	punct	_	_
11	Mongolia	_	PROPN	NNP	Number=Sing	14	nsubj:pass	_	_
12	fue	ser	AUX	VBC	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Pass	14	aux:pass	_	_
13	declarada	_	AUX	VBN	Gender=Fem|Number=Sing|VerbForm=Fin	14	cop	_	_
