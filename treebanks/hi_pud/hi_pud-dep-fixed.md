...
2	ग्रेजुएट	_	NOUN	NN	Animacy=Anim|Case=Acc|Number=Sing	3	obj	_	Translit=grejueṭa
...
9	एम	_	NOUN	NN	Animacy=Inan|Gender=Masc|Number=Sing	14	nmod:poss	_	SpaceAfter=No|Proper=True|Translit=ema
10	.	_	PUNCT	NFP	_	9	punct	_	SpaceAfter=No|Translit=.
11	ए	_	NOUN	NN	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	9	fixed	_	SpaceAfter=No|Proper=True|Translit=e
