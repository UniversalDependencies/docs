---
layout: base
title:  'Statistics of CCONJ in UD_Japanese-BCCWJLUW'
udver: '2'
---

## Treebank Statistics: UD_Japanese-BCCWJLUW: POS Tags: `CCONJ`

There are 1 `CCONJ` lemmas (6%), 1 `CCONJ` types (6%) and 5646 `CCONJ` tokens (1%).
Out of 17 observed tags, the rank of `CCONJ` is: 5 in number of lemmas, 5 in number of types and 15 in number of tokens.
