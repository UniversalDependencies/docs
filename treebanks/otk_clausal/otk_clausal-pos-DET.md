---
layout: base
title:  'Statistics of DET in UD_Old_Turkish-Clausal'
udver: '2'
---

## Treebank Statistics: UD_Old_Turkish-Clausal: POS Tags: `DET`
...
`DET` nodes are attached to their parents using 2 different relations: <tt><a href="otk_clausal-dep-det.html">det</a></tt> (5; 71% instances), <tt><a href="otk_clausal-dep-cop.html">cop</a></tt> (2; 29% instances)

Parents of `DET` nodes belong to 2 different parts of speech: <tt><a href="otk_clausal-pos-NOUN.html">NOUN</a></tt> (6; 86% instances), <tt><a href="otk_clausal-pos-PROPN.html">PROPN</a></tt> (1; 14% instances)
