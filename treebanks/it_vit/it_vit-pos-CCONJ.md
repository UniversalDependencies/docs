...
There are 77 `CCONJ` lemmas (0%), 80 `CCONJ` types (0%) and 8269 `CCONJ` tokens (3%).
...
The form / lemma ratio of `CCONJ` is 1.038961 (the average of all parts of speech is 1.497845).
