---
layout: base
title:  'Statistics of nmod:cau in UD_Uyghur-UDT'
udver: '2'
---
...
# visual-style 9 5 nmod:cau	color:blue
1	دادا	دادا	NOUN	N	Case=Nom	9	nsubj	_	Translit=dada
2	رازى	رازى	ADJ	A	_	3	compound	_	Translit=razi
3	بولمىغان	بول	VERB	V	Mood=Ind|Number=Plur|Person=3|Polarity=Neg|Tense=Past|VerbForm=Fin	4	acl	_	Translit=bolmighan
4	مىسرالارنى	_	NOUN	N	_	9	obj	_	Translit=misralarni|Morf=Unknown
5	قىزىغا	قىز	NOUN	N	Case=Dat|Number[psor]=Plur,Sing|Person[psor]=3	9	nmod:cau	_	Translit=qizigha
6	قايتا	قايتا	ADV	D	_	8	compound:redup	_	Translit=qayta
7	-	-	PUNCT	Y	_	6	punct	_	Translit=-
8	قايتا	قايتا	ADV	D	_	9	advmod	_	Translit=qayta
9	ئوقۇتتى	ئوقۇت	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	SpaceAfter=No|Translit=oqutti
...
# visual-style 3 2 nmod:cau	color:blue
1	ئەگەر	ئەگەر	SCONJ	C	_	8	cc	_	Translit=eger
2	قۇياشقا	قۇياش	NOUN	N	Case=Dat	3	nmod:cau	_	Translit=quyashqa
