...
There are 18 `PUNCT` lemmas (1%), 17 `PUNCT` types (0%) and 1576 `PUNCT` tokens (20%).
...
The form / lemma ratio of `PUNCT` is 0.944444 (the average of all parts of speech is 1.467100).
