...
1	Ӧдва	ӧдва	ADV	Adv	ExtPos=ADV	4	advmod	_	_
2	кӧ	кӧ	SCONJ	CS	_	1	fixed	_	_
3	и	и	ADV	Adv	_	4	advmod	_	_
4	ӧзъяс	ӧзйыны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin	0	root	_	GTtags=IV,Ind,Fut,Sg3|SpaceAfter=No
...
9	гораа	гораа	ADV	Adv	_	10	advmod	_	_
10	сёрнитіс	сёрнитны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	4	parataxis	_	GTtags=IV,Ind,Prt1,Sg3
...
14	пондіс	пондыны	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	15	aux	_	GTtags=IV,Ind,Prt1,Sg3
...
25	самӧварӧ	самӧвар	NOUN	N	Case=Ill|Number=Sing	23	obl	_	GTtags=Sg,Ill|SpaceAfter=No
