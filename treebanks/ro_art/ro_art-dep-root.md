---
layout: base
title:  'Statistics of root in UD_Romanian-ArT'
udver: '2'
---

## Treebank Statistics: UD_Romanian-ArT: Relations: `root`

This relation is universal.

50 nodes (9%) are attached to their parents as `root`.

50 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 4.44.

The following 2 pairs of parts of speech are connected with `root`: -<tt><a href="ro_art-pos-VERB.html">VERB</a></tt> (49; 98% instances), -<tt><a href="ro_art-pos-ADJ.html">ADJ</a></tt> (1; 2% instances).
