---
layout: base
title:  'Statistics of list in UD_Romanian'
udver: '2'
---

## Treebank Statistics: UD_Romanian: Relations: `list`
...
The following 2 pairs of parts of speech are connected with `list`: <tt><a href="ro-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ro-pos-NOUN.html">NOUN</a></tt> (9; 90% instances), <tt><a href="ro-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ro-pos-PROPN.html">PROPN</a></tt> (1; 10% instances).
