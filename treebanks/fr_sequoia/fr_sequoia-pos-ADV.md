...
There are 270 `ADV` lemmas (4%), 272 `ADV` types (3%) and 2634 `ADV` tokens (4%).
...
The form / lemma ratio of `ADV` is 1.007407 (the average of all parts of speech is 1.406068).
