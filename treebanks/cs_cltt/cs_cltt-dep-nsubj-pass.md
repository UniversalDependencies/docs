...
9	obdobích	období	NOUN	NNNP6-----A----	Case=Loc|Gender=Neut|Number=Plur	6	obl	6:obl:v:loc|13:obl	SpaceAfter=No
...
13	zaúčtovány	zaúčtovaný	ADJ	VsTP---XX-AP---	Animacy=Inan|Degree=Pos|Gender=Fem,Masc|Number=Plur|Polarity=Pos|Variant=Short|VerbForm=Part|Voice=Pass	9	acl:relcl	9:acl:relcl	LDeriv=zaúčtovat
