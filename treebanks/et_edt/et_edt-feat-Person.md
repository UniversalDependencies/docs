...
48675 tokens (11%) have a non-empty value of `Person`.
5907 types (7%) occur at least once with a non-empty value of `Person`.
1836 lemmas (4%) occur at least once with a non-empty value of `Person`.
The feature is used with 5 part-of-speech tags: <tt><a href="et_edt-pos-VERB.html">VERB</a></tt> (25213; 6% instances), <tt><a href="et_edt-pos-AUX.html">AUX</a></tt> (14419; 3% instances), <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> (9037; 2% instances), <tt><a href="et_edt-pos-DET.html">DET</a></tt> (5; 0% instances), <tt><a href="et_edt-pos-PROPN.html">PROPN</a></tt> (1; 0% instances).

### `VERB`

25213 <tt><a href="et_edt-pos-VERB.html">VERB</a></tt> tokens (53% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="et_edt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (25213; 100%), <tt><a href="et_edt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (25202; 100%), <tt><a href="et_edt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (24425; 97%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (19457; 77%), <tt><a href="et_edt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (14025; 56%).

`VERB` tokens may have the following values of `Person`:

* `1` (2849; 11% of non-empty `Person`): <em>arvan, sain, mõtlesin, tean, ütlesin, nägin, tegin, mäletan, vaatan, läksin</em>
* `2` (1126; 4% of non-empty `Person`): <em>vaata, tule, tahad, mine, tead, lähed, kuule, saad, näe, pane</em>
* `3` (21238; 84% of non-empty `Person`): <em>on, tuleb, ütles, sai, tuli, saab, jääb, läks, ütleb, jäi</em>
* `EMPTY` (22765): <em>teha, saada, saanud, teada, võtta, näha, öelda, pole, minna, jäänud</em>
...
14419 <tt><a href="et_edt-pos-AUX.html">AUX</a></tt> tokens (65% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="et_edt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (14419; 100%), <tt><a href="et_edt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (14413; 100%), <tt><a href="et_edt-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (14381; 100%), <tt><a href="et_edt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (14140; 98%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11409; 79%), <tt><a href="et_edt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (11353; 79%).

`AUX` tokens may have the following values of `Person`:

* `1` (688; 5% of non-empty `Person`): <em>olen, oleme, olin, pean, peame, olime, võime, saame, peaksime, oleksin</em>
* `2` (266; 2% of non-empty `Person`): <em>oled, olete, olid, ära, võid, ole, pead, ärge, võite, peate</em>
* `3` (13465; 93% of non-empty `Person`): <em>on, oli, võib, olid, saab, peab, võivad, ongi, pidi, võis</em>
* `EMPTY` (7907): <em>ei, pole, ole, oleks, olnud, olla, peaks, saa, olema, polnud</em>
...
* `EMPTY` (13769): <em>see, oma, mis, kes, seda, mida, selle, midagi, mille, sellest</em>
...
* `EMPTY` (7179): <em>see, kõik, kogu, selle, üks, iga, need, seda, sel, ühe</em>
...
<tt>VERB --[<tt><a href="et_edt-dep-conj.html">conj</a></tt>]--> VERB</tt> (2565; 62%),
