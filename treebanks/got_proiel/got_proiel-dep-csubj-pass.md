...
3	weseima	wisan	VERB	V-	Mood=Opt|Number=Plur|Person=1|Tense=Past|VerbForm=Fin|Voice=Act	0	root	_	LId=1|Ref=2COR_1.8
...
2	ist	wisan	VERB	V-	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	LId=1|Ref=LUKE_4.4
