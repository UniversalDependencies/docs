...
The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (394; 90%), <tt><a href="NumValue.html">NumValue</a>=EMPTY</tt> (382; 87%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (371; 84%), <tt><a href="Case.html">Case</a>=EMPTY</tt> (371; 84%), <tt><a href="NumForm.html">NumForm</a>=Roman</tt> (371; 84%).
...
The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (43; 100%), <tt><a href="Polarity.html">Polarity</a>=EMPTY</tt> (43; 100%), <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (43; 100%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (24; 56%).
...
The most frequent other feature values with which `ADV` and `NumType` co-occurred: <tt><a href="Polarity.html">Polarity</a>=EMPTY</tt> (14; 100%), <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (14; 100%).
...
The most frequent other feature values with which `DET` and `NumType` co-occurred: <tt><a href="PronType.html">PronType</a>=Dem,Ind</tt> (1; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (1; 100%), <tt><a href="Gender[psor].html">Gender[psor]</a>=EMPTY</tt> (1; 100%), <tt><a href="Case.html">Case</a>=Ins</tt> (1; 100%), <tt><a href="Number[psor].html">Number[psor]</a>=EMPTY</tt> (1; 100%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (1; 100%), <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (1; 100%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (1; 100%).
...
The most frequent other feature values with which `PRON` and `NumType` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (1; 100%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (1; 100%), <tt><a href="Reflex.html">Reflex</a>=EMPTY</tt> (1; 100%), <tt><a href="PronType.html">PronType</a>=Dem,Ind</tt> (1; 100%), <tt><a href="Variant.html">Variant</a>=EMPTY</tt> (1; 100%), <tt><a href="Case.html">Case</a>=Ins</tt> (1; 100%).
