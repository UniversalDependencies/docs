...
There are 502 `ADV` lemmas (2%), 509 `ADV` types (2%) and 8386 `ADV` tokens (4%).
...
The form / lemma ratio of `ADV` is 1.013944 (the average of all parts of speech is 1.414227).
