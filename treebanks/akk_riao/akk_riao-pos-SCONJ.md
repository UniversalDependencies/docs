---
layout: base
title:  'Statistics of SCONJ in UD_Akkadian-RIAO'
udver: '2'
---

## Treebank Statistics: UD_Akkadian-RIAO: POS Tags: `SCONJ`

There are 8 `SCONJ` lemmas (0%), 8 `SCONJ` types (0%) and 35 `SCONJ` tokens (0%).
Out of 13 observed tags, the rank of `SCONJ` is: 10 in number of lemmas, 10 in number of types and 12 in number of tokens.

The 10 most frequent `SCONJ` lemmas: <em>kī, ša, inūma, ašru, ašāru, aššu, warki, šumma</em>
...
The form / lemma ratio of `SCONJ` is 1.000000 (the average of all parts of speech is 1.795510).

The 1st highest number of forms (1) was observed with the lemma “ašru”: <em>ašar</em>.

The 2nd highest number of forms (1) was observed with the lemma “ašāru”: <em>ašur</em>.

The 3rd highest number of forms (1) was observed with the lemma “aššu”: <em>aššu</em>.
...
`SCONJ` nodes are attached to their parents using 1 different relations: <tt><a href="akk_riao-dep-mark.html">mark</a></tt> (35; 100% instances)

Parents of `SCONJ` nodes belong to 2 different parts of speech: <tt><a href="akk_riao-pos-VERB.html">VERB</a></tt> (34; 97% instances), <tt><a href="akk_riao-pos-NOUN.html">NOUN</a></tt> (1; 3% instances)

35 (100%) `SCONJ` nodes are leaves.
