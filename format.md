...
Sentences consist of one or more word lines, and word lines contain the following fields:
 ...
 8. DEPREL: [Universal dependency relation](u/dep/index.html) to the HEAD (root iff HEAD = 0) or a defined language-specific subtype of one.
...
Here is an example, showing the first nine fields for the English sentence _They buy and sell books_:
    ...
    1    They     they    PRON    PRP    Case=Nom|Number=Plur               2    nsubj    4:nsubj
