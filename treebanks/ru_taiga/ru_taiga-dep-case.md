...
4	чего	что	PRON	_	Case=Gen	1	ccomp	_	_
5	еще	еще	ADV	_	Degree=Pos	4	advmod	_	_
6	маски	маска	NOUN	_	Animacy=Inan|Case=Acc|Gender=Fem|Number=Plur	4	nsubj	_	SpaceAfter=No
7	!!!	!!!	PUNCT	_	_	1	punct	_	SpaceAfter=No
8	))))	))))	SYM	_	_	1	discourse	_	_
9	заинтриговала	интриговать	VERB	_	Aspect=Perf|Gender=Fem|Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin|Voice=Act	1	parataxis	_	SpaceAfter=No
