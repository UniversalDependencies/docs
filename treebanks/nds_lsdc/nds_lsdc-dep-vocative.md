---
layout: base
title:  'Statistics of vocative in UD_Low_Saxon-LSDC'
udver: '2'
---

## Treebank Statistics: UD_Low_Saxon-LSDC: Relations: `vocative`
...
The following 3 pairs of parts of speech are connected with `vocative`: <tt><a href="nds_lsdc-pos-VERB.html">VERB</a></tt>-<tt><a href="nds_lsdc-pos-NOUN.html">NOUN</a></tt> (5; 45% instances), <tt><a href="nds_lsdc-pos-VERB.html">VERB</a></tt>-<tt><a href="nds_lsdc-pos-PROPN.html">PROPN</a></tt> (5; 45% instances), <tt><a href="nds_lsdc-pos-ADJ.html">ADJ</a></tt>-<tt><a href="nds_lsdc-pos-NOUN.html">NOUN</a></tt> (1; 9% instances).
...
9	legen	legen	VERB	_	VerbForm=Inf	6	parataxis	_	lemma_gml=lêgen
10	do	doon	AUX	_	Mood=Ind|Number=Sing|Person=1|Tense=Pres	9	aux	_	lemma_gml=dôn
11	ik	ik	PRON	_	Case=Nom|Number=Sing|Person=1|PronType=Prs	9	nsubj	_	lemma_gml=ik
12	nooit	nooit	ADV	_	_	9	advmod	_	lemma_gml=nôit|SpaceAfter=No
...
2	Wat	wat	PRON	_	Case=Nom|Gender=Neut|Number=Sing|PronType=Prs	4	nsubj	_	lemma_gml=wat(te)³
3	my	ik	PRON	_	Case=Acc,Dat|Number=Sing|Person=1|PronType=Prs	4	obj	_	lemma_gml=ik
4	mankeert	mankeren	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres	0	root	_	SpaceAfter=No
5	,	,	PUNCT	_	_	6	punct	_	_
6	Treeze	Treeze	PROPN	_	Number=Sing	4	vocative	_	SpaceAfter=No
