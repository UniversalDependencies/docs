---
layout: base
title:  'Statistics of root in UD_Tamil-MWTT'
udver: '2'
---

## Treebank Statistics: UD_Tamil-MWTT: Relations: `root`

This relation is universal.

534 nodes (21%) are attached to their parents as `root`.

534 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 3.62734082397004.

The following 6 pairs of parts of speech are connected with `root`: -<tt><a href="ta_mwtt-pos-VERB.html">VERB</a></tt> (445; 83% instances), -<tt><a href="ta_mwtt-pos-NOUN.html">NOUN</a></tt> (71; 13% instances), -<tt><a href="ta_mwtt-pos-PRON.html">PRON</a></tt> (7; 1% instances), -<tt><a href="ta_mwtt-pos-PROPN.html">PROPN</a></tt> (7; 1% instances), -<tt><a href="ta_mwtt-pos-ADJ.html">ADJ</a></tt> (2; 0% instances), -<tt><a href="ta_mwtt-pos-NUM.html">NUM</a></tt> (2; 0% instances).
