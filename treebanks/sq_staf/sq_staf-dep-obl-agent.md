---
layout: base
title:  'Statistics of obl:agent in UD_Albanian-STAF'
udver: '2'
---

## Treebank Statistics: UD_Albanian-STAF: Relations: `obl:agent`

This relation is a language-specific subtype of <tt><a href="sq_staf-dep-obl.html">obl</a></tt>.
There are also 1 other language-specific subtypes of `obl`: <tt><a href="sq_staf-dep-obl-tmod.html">obl:tmod</a></tt>.
...
The following 1 pairs of parts of speech are connected with `obl:agent`: <tt><a href="sq_staf-pos-VERB.html">VERB</a></tt>-<tt><a href="sq_staf-pos-NOUN.html">NOUN</a></tt> (1; 100% instances).
...
# visual-style 12 16 obl:agent	color:blue
