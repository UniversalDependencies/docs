...
101 types (0%) occur at least once with a non-empty value of `Position`.
...
* `Prenom` (1798; 94% of non-empty `Position`): <em>acest, orice, această, aceste, alte, fiecare, același, acestor, unele, altă</em>
