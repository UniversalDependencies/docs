---
layout: base
title:  'Statistics of compound:lvc in UD_Western_Armenian-ArmTDP'
udver: '2'
---

## Treebank Statistics: UD_Western_Armenian-ArmTDP: Relations: `compound:lvc`
...
8	անկէ	անիկա	PRON	_	Case=Abl|Deixis=Remt|Number=Sing|PronType=Dem	6	obl	_	Translit=ankē|LTranslit=anika|SpaceAfter=No
...
2	օրերուն	օր	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Def|Number=Plur	6	obl	_	Translit=òrerown|LTranslit=òr
3	անիկա	անիկա	PRON	_	Case=Nom|Deixis=Remt|Number=Sing|PronType=Dem	6	nsubj	_	Translit=anika|LTranslit=anika
4	հիւանդ	հիւանդ	ADJ	_	Degree=Pos	6	compound:lvc	_	Translit=hiwand|LTranslit=hiwand
5	կ՚	կը	AUX	_	Aspect=Imp|Mood=Ind	6	aux	_	Translit=k,|LTranslit=kë|SpaceAfter=No
6	ընէր	ընել	VERB	_	Aspect=Prosp|Mood=Sub|Number=Sing|Person=3|Polarity=Pos|Subcat=Tran|Tense=Imp|VerbForm=Fin|Voice=Act	0	root	_	Translit=ënēr|LTranslit=ënel
7	արբունքի	արբունք	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Coll	8	obj	_	Translit=arbownk’i|LTranslit=arbownk’
8	հասած	հասնիլ	VERB	_	Aspect=Perf|Polarity=Pos|Subcat=Intr|VerbForm=Part|Voice=Mid	9	acl	_	Translit=hasaç|LTranslit=hasnil
9	տղաքը	տղայ	NOUN	_	Animacy=Hum|Case=Nom|Definite=Def|Number=Plur	6	obj	_	Translit=tġak’ë|LTranslit=tġay|SpaceAfter=No
