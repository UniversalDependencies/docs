...
There are 5 `AUX` lemmas (1%), 19 `AUX` types (2%) and 69 `AUX` tokens (4%).
Out of 14 observed tags, the rank of `AUX` is: 12 in number of lemmas, 7 in number of types and 9 in number of tokens.

The 10 most frequent `AUX` lemmas: <em>olla, ei, voija, pidiä, rotie</em>

The 10 most frequent `AUX` types:  <em>oli, ei, on, ollah, voibi, emmogo, ole, olen, pidää, En</em>

The 10 most frequent ambiguous lemmas: <em>olla</em> (<tt><a href="olo_kkpp-pos-AUX.html">AUX</a></tt> 40, <tt><a href="olo_kkpp-pos-VERB.html">VERB</a></tt> 11), <em>voija</em> (<tt><a href="olo_kkpp-pos-AUX.html">AUX</a></tt> 7, <tt><a href="olo_kkpp-pos-VERB.html">VERB</a></tt> 2), <em>pidiä</em> (<tt><a href="olo_kkpp-pos-VERB.html">VERB</a></tt> 6, <tt><a href="olo_kkpp-pos-AUX.html">AUX</a></tt> 3)
...
The form / lemma ratio of `AUX` is 3.800000 (the average of all parts of speech is 1.337308).
...
`AUX` occurs with 10 features: <tt><a href="olo_kkpp-feat-Person.html">Person</a></tt> (61; 88% instances), <tt><a href="olo_kkpp-feat-Number.html">Number</a></tt> (60; 87% instances), <tt><a href="olo_kkpp-feat-Mood.html">Mood</a></tt> (49; 71% instances), <tt><a href="olo_kkpp-feat-VerbForm.html">VerbForm</a></tt> (49; 71% instances), <tt><a href="olo_kkpp-feat-Tense.html">Tense</a></tt> (48; 70% instances), <tt><a href="olo_kkpp-feat-Voice.html">Voice</a></tt> (46; 67% instances), <tt><a href="olo_kkpp-feat-Polarity.html">Polarity</a></tt> (16; 23% instances), <tt><a href="olo_kkpp-feat-Connegative.html">Connegative</a></tt> (5; 7% instances), <tt><a href="olo_kkpp-feat-Clitic.html">Clitic</a></tt> (3; 4% instances), <tt><a href="olo_kkpp-feat-Case.html">Case</a></tt> (1; 1% instances)

`AUX` occurs with 20 feature-value pairs: `Case=Ine`, `Clitic=Go`, `Clitic=Ko`, `Connegative=Yes`, `Mood=Cnd`, `Mood=Ind`, `Mood=Pot`, `Number=Plur`, `Number=Sing`, `Person=0`, `Person=1`, `Person=2`, `Person=3`, `Polarity=Neg`, `Tense=Past`, `Tense=Pres`, `VerbForm=Fin`, `VerbForm=Ger`, `VerbForm=Inf`, `Voice=Act`
...
`AUX` nodes are attached to their parents using 3 different relations: <tt><a href="olo_kkpp-dep-aux.html">aux</a></tt> (35; 51% instances), <tt><a href="olo_kkpp-dep-cop.html">cop</a></tt> (31; 45% instances), <tt><a href="olo_kkpp-dep-cop-own.html">cop:own</a></tt> (3; 4% instances)

Parents of `AUX` nodes belong to 6 different parts of speech: <tt><a href="olo_kkpp-pos-VERB.html">VERB</a></tt> (34; 49% instances), <tt><a href="olo_kkpp-pos-NOUN.html">NOUN</a></tt> (19; 28% instances), <tt><a href="olo_kkpp-pos-ADJ.html">ADJ</a></tt> (11; 16% instances), <tt><a href="olo_kkpp-pos-PRON.html">PRON</a></tt> (3; 4% instances), <tt><a href="olo_kkpp-pos-NUM.html">NUM</a></tt> (1; 1% instances), <tt><a href="olo_kkpp-pos-X.html">X</a></tt> (1; 1% instances)

67 (97%) `AUX` nodes are leaves.
...
Children of `AUX` nodes are attached using 2 different relations: <tt><a href="olo_kkpp-dep-punct.html">punct</a></tt> (2; 67% instances), <tt><a href="olo_kkpp-dep-conj.html">conj</a></tt> (1; 33% instances)

Children of `AUX` nodes belong to 2 different parts of speech: <tt><a href="olo_kkpp-pos-PUNCT.html">PUNCT</a></tt> (2; 67% instances), <tt><a href="olo_kkpp-pos-VERB.html">VERB</a></tt> (1; 33% instances)
