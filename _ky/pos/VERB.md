...
In Kyrgyz, verbs can get a complex set of inflections which assign _voice_, _tense_, _aspect_, _mood_, , _person_ and _number_.
Some feature assignments are ambiguous or non-trivial.
See the section on verbal features in [ky-overview/specific-syntax]().

### Examples

- _күт_, _оку_ "wait, read"
