---
layout: base
title:  'Statistics of csubj in UD_Chinese-GSDSimp'
udver: '2'
---

## Treebank Statistics: UD_Chinese-GSDSimp: Relations: `csubj`

This relation is universal.
There are 1 language-specific subtypes of `csubj`: <tt><a href="zh_gsdsimp-dep-csubj-pass.html">csubj:pass</a></tt>.
...
2	语	语	PART	SFN	_	6	nsubj	_	SpaceAfter=No|Translit=yǔ|LTranslit=yǔ
3	和	和	CCONJ	CC	_	5	cc	_	SpaceAfter=No|Translit=hé|LTranslit=hé
4	吴	吴	PROPN	NNP	_	5	compound	_	SpaceAfter=No|Translit=吴|LTranslit=吴
5	语	语	PART	SFN	_	2	conj	_	SpaceAfter=No|Translit=yǔ|LTranslit=yǔ
6	融合	融合	VERB	VV	_	9	csubj	_	SpaceAfter=No|Translit=rónghé|LTranslit=rónghé
7	，	，	PUNCT	,	_	6	punct	_	SpaceAfter=No|Translit=,|LTranslit=,
8	逐渐	逐渐	ADV	RB	_	9	advmod	_	SpaceAfter=No|Translit=zhújiàn|LTranslit=zhújiàn
9	形成	形成	VERB	VV	_	0	root	_	SpaceAfter=No|Translit=xíngchéng|LTranslit=xíngchéng
10	南方	南方	NOUN	NN	_	13	nmod	_	SpaceAfter=No|Translit=nánfāng|LTranslit=nánfāng
11	的	的	PART	DEC	Case=Gen	10	case	_	SpaceAfter=No|Translit=de|LTranslit=de
12	江淮	江淮	PROPN	NNP	_	13	nmod	_	SpaceAfter=No|Translit=jiāng淮|LTranslit=jiāng淮
13	官话	官话	NOUN	NN	_	9	obj	_	SpaceAfter=No|Translit=guānhuà|LTranslit=guānhuà
...
2	句	句	NOUN	NNB	_	3	nmod	_	SpaceAfter=No|Translit=jù|LTranslit=jù
3	话	话	NOUN	NN	_	1	obj	_	SpaceAfter=No|Translit=huà|LTranslit=huà
4	说	说	VERB	VV	_	0	root	_	SpaceAfter=No|Translit=shuō|LTranslit=shuō
5	，	，	PUNCT	,	_	26	punct	_	SpaceAfter=No|Translit=,|LTranslit=,
6	如果	如果	ADP	IN	_	12	case	_	SpaceAfter=No|Translit=rúguǒ|LTranslit=rúguǒ
7	每个	每个	DET	DT	_	10	det	_	SpaceAfter=No|Translit=měigè|LTranslit=měigè
8	标注	标注	VERB	VV	_	10	acl:relcl	_	SpaceAfter=No|Translit=biāozhù|LTranslit=biāozhù
9	的	的	PART	DEC	_	8	mark:rel	_	SpaceAfter=No|Translit=de|LTranslit=de
10	点	点	NOUN	NN	_	12	nsubj	_	SpaceAfter=No|Translit=diǎn|LTranslit=diǎn
...
18	这	这	DET	DT	_	19	det	_	SpaceAfter=No|Translit=zhè|LTranslit=zhè
19	条	条	NOUN	NNB	_	20	clf	_	SpaceAfter=No|Translit=tiáo|LTranslit=tiáo
20	线	线	NOUN	NN	_	21	nsubj	_	SpaceAfter=No|Translit=xiàn|LTranslit=xiàn
...
2	结晶	结晶	VERB	VV	_	3	advcl	_	SpaceAfter=No|Translit=jiéjīng|LTranslit=jiéjīng
...
14	比较	比较	ADV	RB	_	15	advmod	_	SpaceAfter=No|Translit=bǐjiào|LTranslit=bǐjiào
15	繁琐	繁琐	ADJ	JJ	_	6	parataxis	_	SpaceAfter=No|Translit=fánsuǒ|LTranslit=fánsuǒ
