...
38564 tokens (55%) have a non-empty value of `Number`.
7726 types (82%) occur at least once with a non-empty value of `Number`.
5072 lemmas (75%) occur at least once with a non-empty value of `Number`.
The feature is used with 7 part-of-speech tags: <tt><a href="fr_sequoia-pos-NOUN.html">NOUN</a></tt> (14583; 21% instances), <tt><a href="fr_sequoia-pos-DET.html">DET</a></tt> (10399; 15% instances), <tt><a href="fr_sequoia-pos-ADJ.html">ADJ</a></tt> (4237; 6% instances), <tt><a href="fr_sequoia-pos-VERB.html">VERB</a></tt> (4219; 6% instances), <tt><a href="fr_sequoia-pos-PRON.html">PRON</a></tt> (1800; 3% instances), <tt><a href="fr_sequoia-pos-AUX.html">AUX</a></tt> (1788; 3% instances), <tt><a href="fr_sequoia-pos-PROPN.html">PROPN</a></tt> (1538; 2% instances).

### `NOUN`

14583 <tt><a href="fr_sequoia-pos-NOUN.html">NOUN</a></tt> tokens (96% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (7300; 50%).

`NOUN` tokens may have the following values of `Number`:

* `Plur` (4095; 28% of non-empty `Number`): <em>patients, ans, enfants, effets, jours, millions, mois, hommes, fractures, francs</em>
* `Sing` (10488; 72% of non-empty `Number`): <em>affaire, bivalirudine, commission, perfusion, traitement, président, M., conseil, administration, solution</em>
* `EMPTY` (636): <em>%, mg, ml, cours, cas, D, HLM, °C, B, ICP</em>
...
The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="fr_sequoia-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (9264; 89%), <tt><a href="fr_sequoia-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (7439; 72%).

`DET` tokens may have the following values of `Number`:

* `Plur` (2829; 27% of non-empty `Number`): <em>les, des, ces, plusieurs, ses, de, d', leurs, quelques, nos</em>
...
4237 <tt><a href="fr_sequoia-pos-ADJ.html">ADJ</a></tt> tokens (96% of all `ADJ` tokens) have a non-empty value of `Number`.

`ADJ` tokens may have the following values of `Number`:

* `Plur` (1386; 33% of non-empty `Number`): <em>autres, indésirables, tous, politiques, cliniques, toutes, occultes, âgés, fréquents, graves</em>
* `Sing` (2851; 67% of non-empty `Number`): <em>autre, politique, même, clinique, ancien, zolédronique, européenne, jeune, première, rénale</em>
* `EMPTY` (162): <em>français, osseux, nombreux, compris, faux, chinois, intraveineux, taïwanais, précis, libanais</em>

<table>
  <tr><th>Paradigm <i>autre</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt></tt></td><td><em>autre</em></td><td><em>autres</em></td></tr>
</table>
...
* `Plur` (1199; 28% of non-empty `Number`): <em>doivent, traités, atteints, peuvent, devons, ont, avez, veuillez, devez, présentent</em>
* `Sing` (3020; 72% of non-empty `Number`): <em>doit, a, peut, eu, utilisé, faut, est, fait, administré, reçu</em>
* `EMPTY` (1656): <em>voir, mis, faire, concernant, pris, prendre, avoir, utiliser, pu, dire</em>
...
The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="fr_sequoia-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (1756; 98%), <tt><a href="fr_sequoia-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1340; 74%), <tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt> (1145; 64%), <tt><a href="fr_sequoia-feat-Emph.html">Emph</a></tt><tt>=No</tt> (965; 54%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (509; 28% of non-empty `Number`): <em>nous, vous, ils, les, eux, ceux, elles, lesquelles, leur, lesquels</em>
* `Sing` (1291; 72% of non-empty `Number`): <em>il, je, elle, ce, c', j', cela, on, un, le</em>
* `EMPTY` (1008): <em>qui, se, s', y, que, dont, où, en, qu', -en</em>

<table>
  <tr><th>Paradigm <i>vous</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt></tt></td><td><em>vous</em></td><td><em>vous, -vous</em></td></tr>
  <tr><td><tt><tt><a href="fr_sequoia-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt></tt></td><td></td><td><em>vous, -vous</em></td></tr>
</table>
...
1538 <tt><a href="fr_sequoia-pos-PROPN.html">PROPN</a></tt> tokens (47% of all `PROPN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PROPN` and `Number` co-occurred: <tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (1050; 68%).
...
* `Sing` (1500; 98% of non-empty `Number`): <em>Paris, Jacques, France, Chirac, Taïwan, Francis, Michel, Paget, Didier, Alain</em>
* `EMPTY` (1723): <em>Aclasta, Angiox, RPR, Halphen, Jean-Claude, Méry, Schuller, Thomson, Éric, Roussin</em>
...
`Number` seems to be **lexical feature** of `PROPN`. 100% lemmas (483) occur only with one value of `Number`.

## Relations with Agreement in `Number`

The 10 most frequent relations where parent and child node agree in `Number`:
<tt>NOUN --[<tt><a href="fr_sequoia-dep-det.html">det</a></tt>]--> DET</tt> (9561; 99%),
<tt>NOUN --[<tt><a href="fr_sequoia-dep-amod.html">amod</a></tt>]--> ADJ</tt> (3536; 96%),
<tt>NOUN --[<tt><a href="fr_sequoia-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (2820; 57%),
<tt>VERB --[<tt><a href="fr_sequoia-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (899; 84%),
<tt>VERB --[<tt><a href="fr_sequoia-dep-obl-mod.html">obl:mod</a></tt>]--> NOUN</tt> (859; 50%),
<tt>NOUN --[<tt><a href="fr_sequoia-dep-conj.html">conj</a></tt>]--> NOUN</tt> (800; 79%),
...
<tt>PROPN --[<tt><a href="fr_sequoia-dep-det.html">det</a></tt>]--> DET</tt> (373; 79%).
