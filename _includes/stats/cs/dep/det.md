...
10517 nodes (2%) are attached to their parents as `det`.

10480 instances of `det` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.33726347817819.

The following 4 pairs of parts of speech are connected with `det`: [cs-pos/NOUN]()-[cs-pos/DET]() (10419; 99% instances), [cs-pos/ADJ]()-[cs-pos/DET]() (47; 0% instances), [cs-pos/PROPN]()-[cs-pos/DET]() (32; 0% instances), [cs-pos/PRON]()-[cs-pos/DET]() (19; 0% instances).
...
3	žádná	žádný	DET	PWFS1----------	Case=Nom|Gender=Fem|Negative=Neg|Number=Sing|PronType=Neg	4	det	_	_
4	dršťková	dršťkový	ADJ	AAFS1----1A----	Case=Nom|Degree=Pos|Gender=Fem|Negative=Pos|Number=Sing	1	conj	_	SpaceAfter=No
5	,	,	PUNCT	Z:-------------	_	1	punct	_	_
6	žádné	žádný	DET	PWNS1----------	Case=Nom|Gender=Neut|Negative=Neg|Number=Sing|PronType=Neg	7	det	_	_
7	pivčo	pivčo_,h	NOUN	NNNS1-----A----	Case=Nom|Gender=Neut|Negative=Pos|Number=Sing	1	conj	_	SpaceAfter=No
8	.	.	PUNCT	Z:-------------	_	1	punct	_	_
...
2	Drahuška	Drahuška_,h	PROPN	NNFS1-----A----	Case=Nom|Gender=Fem|NameType=Giv|Negative=Pos|Number=Sing	7	nsubj	_	_
3	se	se	PRON	P7-X4----------	Case=Acc|PronType=Prs|Reflex=Yes|Variant=Short	7	expl	_	LGloss=(zvr._zájmeno/částice)
4	na	na	ADP	RR--4----------	AdpType=Prep|Case=Acc	5	case	_	LId=na-1
5	mne	já	PRON	PP-S4--1-------	Case=Acc|Number=Sing|Person=1|PronType=Prs	7	dobj	_	LGloss=(2./4.pád)
6	významně	významně	ADV	Dg-------1A----	Degree=Pos|Negative=Pos	7	advmod	_	LDeriv=významný
7	podívala	podívat	VERB	VpQW---XR-AA---	Aspect=Perf|Gender=Fem,Neut|Negative=Pos|Number=Plur,Sing|Tense=Past|VerbForm=Part|Voice=Act	0	root	_	SpaceAfter=No
...
The following 2 pairs of parts of speech are connected with `det`: [cs-pos/NOUN]()-[cs-pos/DET]() (592; 100% instances), [cs-pos/ADJ]()-[cs-pos/DET]() (1; 0% instances).
...
1	Právnické	právnický	ADJ	AAFP1----1A----	Case=Nom|Degree=Pos|Gender=Fem|Negative=Pos|Number=Plur	2	amod	_	_
2	osoby	osoba	NOUN	NNFP1-----A----	Case=Nom|Gender=Fem|Negative=Pos|Number=Plur	23	nsubj	_	_
3	založené	založený	ADJ	AAFP1----1A----	Case=Nom|Degree=Pos|Gender=Fem|Negative=Pos|Number=Plur	2	amod	_	_
4	za	za	ADP	RR--7----------	AdpType=Prep|Case=Ins	5	case	_	LId=za-1
5	účelem	účel	NOUN	NNIS7-----A----	Animacy=Inan|Case=Ins|Gender=Masc|Negative=Pos|Number=Sing	3	nmod	_	SpaceAfter=No
6	,	,	PUNCT	Z:-------------	_	10	punct	_	_
7	aby	aby	SCONJ	J,-------------	_	10	mark	_	_
8	by	být	AUX	Vc-------------	Mood=Cnd|Person=3|VerbForm=Fin	10	aux	_	_
9	se	se	PRON	P7-X4----------	Case=Acc|PronType=Prs|Reflex=Yes|Variant=Short	10	expl	_	_
10	staly	stát	VERB	VpTP---XR-AA---	Animacy=Inan|Gender=Fem,Masc|Negative=Pos|Number=Plur|Tense=Past|VerbForm=Part|Voice=Act	5	acl	_	LId=stát-2
11	vlastníkem	vlastník	NOUN	NNMS7-----A----	Animacy=Anim|Case=Ins|Gender=Masc|Negative=Pos|Number=Sing	10	dobj	_	_
12	domu	dům	NOUN	NNIS2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Negative=Pos|Number=Sing	11	nmod	_	_
13	s	s	ADP	RR--7----------	AdpType=Prep|Case=Ins	14	case	_	LId=s-1
14	byty	byt	NOUN	NNIP7-----A----	Animacy=Inan|Case=Ins|Gender=Masc|Negative=Pos|Number=Plur	12	nmod	_	_
15	v	v	ADP	RR--6----------	AdpType=Prep|Case=Loc	16	case	_	LId=v-1
16	nájmu	nájem	NOUN	NNIS6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Negative=Pos|Number=Sing	14	nmod	_	_
17	společníků	společník	NOUN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|Negative=Pos|Number=Plur	16	nmod	_	SpaceAfter=No
18	,	,	PUNCT	Z:-------------	_	17	punct	_	_
19	členů	člen	NOUN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|Negative=Pos|Number=Plur	17	conj	_	_
20	nebo	nebo	CONJ	J^-------------	_	17	cc	_	_
21	zakladatelů	zakladatel	NOUN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|Negative=Pos|Number=Plur	17	conj	_	SpaceAfter=No
22	,	,	PUNCT	Z:-------------	_	10	punct	_	_
23	nemusí	muset	VERB	VB-S---3P-NA---	Mood=Ind|Negative=Neg|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
24	tento	tento	DET	PDYS1----------	Case=Nom|Gender=Masc|Number=Sing|PronType=Dem	25	det	_	_
25	dlouhodobý	dlouhodobý	ADJ	AAIS1----1A----	Animacy=Inan|Case=Nom|Degree=Pos|Gender=Masc|Negative=Pos|Number=Sing	29	amod	_	_
26	nehmotný	hmotný	ADJ	AAIS4----1N----	Animacy=Inan|Case=Acc|Degree=Pos|Gender=Masc|Negative=Neg|Number=Sing	29	amod	_	_
27	a	a	CONJ	J^-------------	_	26	cc	_	LId=a-1
28	hmotný	hmotný	ADJ	AAIS4----1A----	Animacy=Inan|Case=Acc|Degree=Pos|Gender=Masc|Negative=Pos|Number=Sing	26	conj	_	_
29	majetek	majetek	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Negative=Pos|Number=Sing	30	dobj	_	_
30	odpisovat	odpisovat	VERB	Vf--------A----	Negative=Pos|VerbForm=Inf	23	xcomp	_	SpaceAfter=No
31	,	,	PUNCT	Z:-------------	_	33	punct	_	_
32	pokud	pokud	SCONJ	J,-------------	_	33	mark	_	_
33	neslouží	sloužit	VERB	VB-S---3P-NA---	Mood=Ind|Negative=Neg|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	23	advcl	_	_
34	k	k	ADP	RR--3----------	AdpType=Prep|Case=Dat	35	case	_	LId=k-1
35	podnikání	podnikání	NOUN	NNNS3-----A----	Case=Dat|Gender=Neut|Negative=Pos|Number=Sing	33	nmod	_	SpaceAfter=No
