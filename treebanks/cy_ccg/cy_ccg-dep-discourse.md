...
The following 3 pairs of parts of speech are connected with `discourse`: <tt><a href="cy_ccg-pos-VERB.html">VERB</a></tt>-<tt><a href="cy_ccg-pos-NOUN.html">NOUN</a></tt> (2; 50% instances), <tt><a href="cy_ccg-pos-NOUN.html">NOUN</a></tt>-<tt><a href="cy_ccg-pos-NOUN.html">NOUN</a></tt> (1; 25% instances), <tt><a href="cy_ccg-pos-VERB.html">VERB</a></tt>-<tt><a href="cy_ccg-pos-PRON.html">PRON</a></tt> (1; 25% instances).
...
3	rwyf	bod	VERB	verb	Mood=Ind|Number=Sing|Person=1|Tense=Pres	0	root	_	_
...
6	mae	bod	AUX	aux	Mood=Ind|Number=Sing|Person=3|Tense=Pres	18	cop	_	_
...
10	gafodd	cael	VERB	verb	Mood=Ind|Mutation=SM|Number=Sing|Person=3|Tense=Past	7	acl:relcl	_	_
11	bum	pum	NUM	num	Mutation=SM	12	nummod	_	_
12	mlynedd	blwyddyn	NOUN	noun	Gender=Masc|Mutation=NM|Number=Plur	10	nsubj	_	_
...
21	ffyniannus	ffyniannus	NOUN	noun	Gender=Masc|Number=Sing	19	conj	_	_
...
16	ydym	bod	VERB	verb	Mood=Ind|Number=Plur|Person=1|Tense=Pres	4	conj	_	_
...
22	ein	ein	PRON	dep	Number=Plur|Person=1|Poss=Yes|PronType=Prs	23	nmod:poss	_	_
