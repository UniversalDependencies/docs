...
1801 nodes (1%) are attached to their parents as `aux:pass`.

1502 instances of `aux:pass` (83%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.15991116046641.

The following 1 pairs of parts of speech are connected with `aux:pass`: <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-AUX.html">AUX</a></tt> (1801; 100% instances).
