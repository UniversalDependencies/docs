...
Moreover, the relation `aux` is used with a marker of retrospective _tùn_, which formally behaves as a particle. We chose a relation `aux` for it, as semantically it is a TAM auxiliary. 
