...
1	Чоловеку	чоловекъ	NOUN	_	Case=Dat|Gender=Masc|Number=Sing	2	orphan	_	wf="Ч(о)л(ове)ку"|before=<p>
2	двор	дворъ	NOUN	_	Case=Nom|Gender=Masc|Number=Sing	0	root	_	wf="дво<i>р</i>"
3	у	въ	ADP	_	_	4	case	_	wf="у"
4	Берестьи	Берестье	PROPN	_	Case=Loc|Gender=Neut|NameType=Geo|Number=Sing	2	nmod	_	wf="Берестьи"|SpaceAfter=No
5	,	,	PUNCT	_	_	8	punct	_	wf=","
6	што	што	PRON	_	Case=Acc|Gender=Neut|Number=Sing|PronType=Rel	8	obj	_	wf="што"
7	бискупъ	бискупъ	NOUN	_	Case=Nom|Gender=Masc|Number=Sing	8	nsubj	_	wf="бискупъ"
8	забавил	забавити	VERB	_	Gender=Masc|Number=Sing|Tense=Past|VerbForm=PartRes|Voice=Act	2	acl:relcl	_	wf="забави<i>л</i>"|SpaceAfter=No
9	.	.	PUNCT	_	_	2	punct	_	wf="."|after=</p>
...
# visual-style 9 7 acl:relcl	color:blue
1	А	а	CCONJ	СС	_	12	cc	_	wf="А"
2	нынѣ	ныне	ADV	RB	Degree=Pos	12	advmod	_	wf="нынѣ"|SpaceAfter=No
3	,	,	PUNCT	-COMMA-	_	7	punct	_	_
4	што	што	PRON	WP	Case=Acc|Gender=Neut|Number=Sing|PronType=Rel	7	obj	_	wf="што"
5	дѣтемъ	детя	NOUN	NNA	Case=Dat|Gender=Neut|Number=Plur	7	iobj	_	wf="дѣтемъ"
6	моимъ	мой	DET	PRP$	Case=Dat|Gender=Neut|Number=Plur|Poss=Yes|PronType=Prs	5	det	_	wf="моимъ"
7	надобѣ	надобе	VERB	PRED	_	9	acl:relcl	_	wf="надобѣ"|SpaceAfter=No
8	,	,	PUNCT	-COMMA-	_	7	punct	_	_
9	того	то	PRON	DT	Case=Gen|Gender=Neut|Number=Sing|PronType=Dem	12	obj	_	wf="того"
10	имъ	они	PRON	PRP	Case=Dat|Gender=Masc|Number=Plur|Person=3|PronType=Prs	12	iobj	_	wf="имъ"
11	не	не	PART	NEG	Polarity=Neg	12	advmod	_	wf="не"
12	бороните	боронити	VERB	VBC	Aspect=Imp|Mood=Imp|Number=Plur|Person=2|VerbForm=Fin|Voice=Act	0	root	_	wf="бороните"|SpaceAfter=No
