---
layout: base
title:  'Statistics of acl:relcl in UD_Marathi'
udver: '2'
---

## Treebank Statistics: UD_Marathi: Relations: `acl:relcl`

This relation is a language-specific subtype of <tt><a href="mr-dep-acl.html">acl</a></tt>.
...
The following 2 pairs of parts of speech are connected with `acl:relcl`: <tt><a href="mr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="mr-pos-VERB.html">VERB</a></tt> (4; 80% instances), <tt><a href="mr-pos-PRON.html">PRON</a></tt>-<tt><a href="mr-pos-VERB.html">VERB</a></tt> (1; 20% instances).
...
11	आले	येणे	VERB	_	Aspect=Perf|Gender=Masc|Number=Plur|Person=3|VerbForm=Fin	10	compound:svc	_	_
...
10	नाही	नाही	AUX	_	Number=Sing|Person=3|Polarity=Neg|VerbForm=Fin	9	aux	_	_
