---
layout: base
title:  'Statistics of vocative in UD_Sindhi-Isra'
udver: '2'
---

## Treebank Statistics: UD_Sindhi-Isra: Relations: `vocative`
...
1	هلڻ	هلڻ	VERB	VM	Aspect=Imp|VerbForm=Inf	6	advcl	_	_
2	وقت	وقت	NOUN	NN	Case=Nom|Gender=Masc|Number=Sing	6	obl	_	_
3	گداڙيءَ	گداڙي	NOUN	NN	Case=Nom|Gender=Fem|Number=Sing	6	nsubj	_	_
...
1	تڏهن	تڏهن	ADV	ADT	_	3	advcl	_	_
2	شينهڻ	شينهڻ	NOUN	NN	Case=Nom|Gender=Fem|Number=Sing	3	nsubj	_	_
3	پڇيس	پڇ	VERB	VMX	Aspect=Perf|Case=Acc|Person=3|Voice=Act	0	root	_	_
4	ته	ته	SCONJ	CS	_	3	mark	_	_
5	:	:	PUNCT	PUNCT	_	3	punct	_	_
6	ميرخان	ميرخان	PROPN	NNP	Case=Nom|Gender=Masc	3	vocative	_	_
