...
There are 166 `ADP` lemmas (1%), 166 `ADP` types (1%) and 5632 `ADP` tokens (5%).
...
The form / lemma ratio of `ADP` is 1.000000 (the average of all parts of speech is 1.004572).
