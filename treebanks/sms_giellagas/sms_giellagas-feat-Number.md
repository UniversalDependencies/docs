...
1265 tokens (48%) have a non-empty value of `Number`.
530 types (76%) occur at least once with a non-empty value of `Number`.
308 lemmas (65%) occur at least once with a non-empty value of `Number`.
The feature is used with 9 part-of-speech tags: <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> (481; 18% instances), <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> (344; 13% instances), <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> (261; 10% instances), <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> (130; 5% instances), <tt><a href="sms_giellagas-pos-ADJ.html">ADJ</a></tt> (14; 1% instances), <tt><a href="sms_giellagas-pos-NUM.html">NUM</a></tt> (14; 1% instances), <tt><a href="sms_giellagas-pos-PROPN.html">PROPN</a></tt> (12; 0% instances), <tt><a href="sms_giellagas-pos-DET.html">DET</a></tt> (6; 0% instances), <tt><a href="sms_giellagas-pos-ADV.html">ADV</a></tt> (3; 0% instances).

### `VERB`

481 <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> tokens (82% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (480; 100%), <tt><a href="sms_giellagas-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (436; 91%), <tt><a href="sms_giellagas-feat-Person.html">Person</a></tt><tt>=3</tt> (409; 85%).

`VERB` tokens may have the following values of `Number`:

* `Plur` (82; 17% of non-empty `Number`): <em>jälste, ceäʹlǩǩe, mõõnnâd, puõʹtte, räʹjje, vaʹldde, kâʹčče, mõʹnne, aʹhtte, koll’je</em>
* `Sing` (399; 83% of non-empty `Number`): <em>ceälkk, mõõni, puõʹđi, vaaʹldi, šõõddi, ǩieʹzzi, lij, vuõʹlji, ǩiõzzam, jåått</em>
* `EMPTY` (104): <em>jieʹlled, kooǯǯted, välddam, väʹldded, jååʹtted, kuâddam, mõõnnâd, teâđstam, vueʹtǩǩmen, hiâvted</em>
...
344 <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> tokens (93% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (305; 89%), <tt><a href="sms_giellagas-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (305; 89%), <tt><a href="sms_giellagas-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (250; 73%).

`NOUN` tokens may have the following values of `Number`:

* `Plur` (41; 12% of non-empty `Number`): <em>muõrid, kooʹddid, kåʹllkåʹđđnjõõzzid, oummu, peästtõõǥǥ, päärna, aaiʹtid, jurddi, järraz, kaappi</em>
* `Sing` (303; 88% of non-empty `Number`): <em>ooumaž, tueʹllj, mieʹccest, heävaš, nijdd, stäʹlmmstääll, ääkka, eččad, niõđ, niõđâž</em>
...
`Number` seems to be **lexical feature** of `NOUN`. 90% lemmas (122) occur only with one value of `Number`.

### `PRON`

261 <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> tokens (97% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-Case.html">Case</a></tt><tt>=Nom</tt> (170; 65%), <tt><a href="sms_giellagas-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (142; 54%).

`PRON` tokens may have the following values of `Number`:

* `Dual` (3; 1% of non-empty `Number`): <em>muännaid, suäna, suännast</em>
* `Plur` (29; 11% of non-empty `Number`): <em>miʹjjid, seeʹst, tõid, tuk, dõõk, jiijj, måttam, Täk, mij, sij</em>
* `Sing` (229; 88% of non-empty `Number`): <em>son, tõn, tõt, ton, mon, suu, mii, muu, puk, mâiʹd</em>
* `EMPTY` (9): <em>mâiʹd, jiânnai-a, måttam</em>
...
130 <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> tokens (87% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (127; 98%), <tt><a href="sms_giellagas-feat-Valency.html">Valency</a></tt><tt>=EMPTY</tt> (103; 79%), <tt><a href="sms_giellagas-feat-Person.html">Person</a></tt><tt>=3</tt> (88; 68%), <tt><a href="sms_giellagas-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (85; 65%), <tt><a href="sms_giellagas-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (69; 53%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (17; 13% of non-empty `Number`): <em>liâ, jeäʹla, jeäʹp, Jeäʹled, jiâ, lee</em>
* `Sing` (113; 87% of non-empty `Number`): <em>lij, ij, leäi, jiõk, õõk, jiõm, leäk, iʹlla, iʹlleäk, leäm</em>
...
14 <tt><a href="sms_giellagas-pos-ADJ.html">ADJ</a></tt> tokens (50% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (14; 100%), <tt><a href="sms_giellagas-feat-Case.html">Case</a></tt><tt>=Nom</tt> (10; 71%).

`ADJ` tokens may have the following values of `Number`:

* `Sing` (14; 100% of non-empty `Number`): <em>jõnn, nuʹbb, tiõrvâs, jåʹttel, kuuʹǩǩ, lääʹđesmiõllsab, muʹvddem, nuuʹbb, occkaž, šurr</em>
* `EMPTY` (14): <em>kuälmad, šiõǥǥ, ekksaž, jõnn, kaađâš, nåkkam, siõm, uʹcc, viʹlǧǧes, šoora</em>
...
* `EMPTY` (271): <em>âʹtte, âʹpet, kâʹl, de, tok, mäʹhtt, teâđast, še, pâi, tõʹst</em>

## Relations with Agreement in `Number`

The 10 most frequent relations where parent and child node agree in `Number`:
<tt>VERB --[<tt><a href="sms_giellagas-dep-conj.html">conj</a></tt>]--> VERB</tt> (207; 81%),
<tt>VERB --[<tt><a href="sms_giellagas-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (100; 84%),
<tt>VERB --[<tt><a href="sms_giellagas-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (78; 79%),
<tt>NOUN --[<tt><a href="sms_giellagas-dep-det.html">det</a></tt>]--> PRON</tt> (41; 98%),
<tt>VERB --[<tt><a href="sms_giellagas-dep-obl-lmod.html">obl:lmod</a></tt>]--> NOUN</tt> (23; 62%),
<tt>NOUN --[<tt><a href="sms_giellagas-dep-cop.html">cop</a></tt>]--> AUX</tt> (13; 93%),
<tt>VERB --[<tt><a href="sms_giellagas-dep-obl.html">obl</a></tt>]--> NOUN</tt> (11; 73%),
