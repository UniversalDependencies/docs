...
The form / lemma ratio of `VERB` is 5.275862 (the average of all parts of speech is 2.934959).
...
`VERB` occurs with 10 features: <tt><a href="xpg_kul-feat-Number.html">Number</a></tt> (232; 99% instances), <tt><a href="xpg_kul-feat-VerbForm.html">VerbForm</a></tt> (230; 98% instances), <tt><a href="xpg_kul-feat-Voice.html">Voice</a></tt> (230; 98% instances), <tt><a href="xpg_kul-feat-Tense.html">Tense</a></tt> (224; 96% instances), <tt><a href="xpg_kul-feat-Person.html">Person</a></tt> (135; 58% instances), <tt><a href="xpg_kul-feat-Mood.html">Mood</a></tt> (133; 57% instances), <tt><a href="xpg_kul-feat-Case.html">Case</a></tt> (97; 41% instances), <tt><a href="xpg_kul-feat-Gender.html">Gender</a></tt> (97; 41% instances), <tt><a href="xpg_kul-feat-Aspect.html">Aspect</a></tt> (95; 41% instances), <tt><a href="xpg_kul-feat-Typo.html">Typo</a></tt> (1; 0% instances)
...
The most frequent feature combination is `Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act` (87 tokens).
Examples: <em>αδδακετ, αδακετ, δακετ, αββερετ, αδδακ[ετ, [α]δδακετ, [α]δδακεττ, [αδ]δ[ακετ], [αδακετ, [αδδακ]εν</em>
...
19 (8%) `VERB` nodes are leaves.

8 (3%) `VERB` nodes have one child.
