...
* `EMPTY` (42696): <em>il, la, l', i, le, un, gli, una, lo, questo</em>
...
* `EMPTY` (9732): <em>che, si, cui, ci, lo, quello, c', ne, mi, quella</em>
...
* `EMPTY` (20156): <em>primo, precedente, altri, nuovo, grande, economico, stesso, altre, nuova, nuovi</em>
