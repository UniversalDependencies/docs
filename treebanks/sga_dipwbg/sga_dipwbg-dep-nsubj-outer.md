---
layout: base
title:  'Statistics of nsubj:outer in UD_Old_Irish-DipWBG'
udver: '2'
---

## Treebank Statistics: UD_Old_Irish-DipWBG: Relations: `nsubj:outer`

This relation is a language-specific subtype of <tt><a href="sga_dipwbg-dep-nsubj.html">nsubj</a></tt>.
...
The following 1 pairs of parts of speech are connected with `nsubj:outer`: <tt><a href="sga_dipwbg-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sga_dipwbg-pos-PRON.html">PRON</a></tt> (1; 100% instances).
...
# visual-style 6 7 nsubj:outer	color:blue
