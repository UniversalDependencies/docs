...
* `3` (397; 71% of non-empty `Person`): <em>ha, era, è, aveva, sono, stava, e, voleva, erano, a</em>
...
* `3` (292; 81% of non-empty `Person`): <em>era, portava, aveva, sembrava, leggeva, gridava, pensava, piace, faceva, sapeva</em>
