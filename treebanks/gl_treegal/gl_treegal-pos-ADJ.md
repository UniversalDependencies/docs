...
There are 691 `ADJ` lemmas (17%), 906 `ADJ` types (16%) and 1722 `ADJ` tokens (7%).
...
The form / lemma ratio of `ADJ` is 1.311143 (the average of all parts of speech is 1.384861).
...
`ADJ` occurs with 3 features: <tt><a href="gl_treegal-feat-Number.html">Number</a></tt> (1700; 99% instances), <tt><a href="gl_treegal-feat-Gender.html">Gender</a></tt> (1696; 98% instances), <tt><a href="gl_treegal-feat-Degree.html">Degree</a></tt> (40; 2% instances)
