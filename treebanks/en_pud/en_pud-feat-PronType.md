...
2073 <tt><a href="en_pud-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="en_pud-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (1441; 70%).
...
* `Tot` (45; 2% of non-empty `PronType`): <em>all, each, both, every</em>
* `EMPTY` (10): <em>each, there, All, Both, Every</em>
