...
Average distance between parent and child is 6.29910714285714.
...
1	Netflix	Netflix	PROPN	_	Foreign=Yes	2	nsubj	_	CSID=LANG3|Lang=en
2	macht	machen	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	CSID=DE|Lang=de
...
10	mi	mi	AUX	_	Number=Sing|Person=3	9	aux:q	_	CSID=TR|Lang=tr|SpaceAfter=No
11	?	?	PUNCT	_	_	2	punct	_	CSID=OTHER
...
1	Hani	hani	ADV	_	_	2	discourse	_	CSID=TR|Lang=tr
2	yemek	yemek	NOUN	_	Case=Nom|Number=Sing	0	root	_	CSID=TR|Lang=tr
3	de	de	ADV	_	_	2	advmod:emph	_	CSID=TR|Lang=tr
4	değil	değil	PART	_	_	9	cc	_	CSID=TR|Lang=tr
5	weißt	wissen	VERB	_	Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin	2	parataxis:discourse	_	CSID=DE|Lang=de
6	du	du	PRON	_	Case=Nom|Number=Sing|Person=2|PronType=Prs	5	nsubj	_	CSID=DE|Lang=de
7	einfach	einfach	ADJ	_	_	9	advmod	_	CSID=DE|Lang=de
8	nur	nur	ADV	_	_	9	advmod	_	CSID=DE|Lang=de
9	Wasser	Wasser	NOUN	_	Case=Nom|Gender=Neut|Number=Sing	5	xcomp	_	CSID=DE|Lang=de|SpaceAfter=No
10	.	.	PUNCT	_	_	2	punct	_	CSID=OTHER
