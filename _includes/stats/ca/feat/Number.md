...
260814 tokens (48%) have a non-empty value of `Number`.
20444 types (63%) occur at least once with a non-empty value of `Number`.
11538 lemmas (49%) occur at least once with a non-empty value of `Number`.
The feature is used with 10 part-of-speech tags: [ca-pos/NOUN]() (88924; 16% instances), [ca-pos/DET]() (87211; 16% instances), [ca-pos/ADJ]() (29655; 5% instances), [ca-pos/VERB]() (25769; 5% instances), [ca-pos/AUX]() (19980; 4% instances), [ca-pos/PRON]() (6427; 1% instances), [ca-pos/NUM]() (2666; 0% instances), [ca-pos/ADP]() (121; 0% instances), [ca-pos/ADV]() (60; 0% instances), [ca-pos/PROPN]() (1; 0% instances).

### `NOUN`

88924 [ca-pos/NOUN]() tokens (90% of all `NOUN` tokens) have a non-empty value of `Number`.
...
87211 [ca-pos/DET]() tokens (100% of all `DET` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="PronType.html">PronType</a>=Art</tt> (68461; 79%), <tt><a href="Definite.html">Definite</a>=Def</tt> (68257; 78%).

`DET` tokens may have the following values of `Number`:

* `Plur` (18389; 21% of non-empty `Number`): <em>els, les, seus, altres, aquests, seves, tots, aquestes, uns, diferents</em>
* `Sing` (68822; 79% of non-empty `Number`): <em>el, la, l', un, una, aquest, seva, aquesta, seu, tot</em>
...
29655 [ca-pos/ADJ]() tokens (99% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=EMPTY</tt> (24066; 81%).
...
* `Plur` (5514; 21% of non-empty `Number`): <em>tenen, estan, són, fan, tenim, faran, volen, van, formen, estem</em>
* `Sing` (20255; 79% of non-empty `Number`): <em>té, ha, està, és, fet, explicat, dit, fa, considera, cal</em>
* `EMPTY` (15682): <em>fer, tenir, donar, dir, arribar, aconseguir, passar, presentar, veure, anar</em>
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Cnd|<a href="Person.html">Person</a>=1|<a href="VerbForm.html">VerbForm</a>=Fin</tt></td><td><em>faria</em></td><td><em>faríem</em></td></tr>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Person.html">Person</a>=1|<a href="Tense.html">Tense</a>=Pres|<a href="VerbForm.html">VerbForm</a>=Fin</tt></td><td><em>faig</em></td><td><em>fem</em></td></tr>
...
19980 [ca-pos/AUX]() tokens (89% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (19266; 96%), <tt><a href="Person.html">Person</a>=3</tt> (18738; 94%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (18214; 91%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (17118; 86%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (4713; 24% of non-empty `Number`): <em>van, han, són, hem, poden, havien, seran, podran, puguin, eren</em>
* `Sing` (15267; 76% of non-empty `Number`): <em>va, ha, és, estat, havia, pot, fa, serà, era, està</em>
* `EMPTY` (2509): <em>ser, haver, poder, fer, tornar, començar, deixar, intentar, sent, arribar</em>
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Person.html">Person</a>=3|<a href="Tense.html">Tense</a>=Fut|<a href="VerbForm.html">VerbForm</a>=Fin</tt></td><td><em>haurà</em></td><td><em>hauran</em></td></tr>
...
6427 [ca-pos/PRON]() tokens (28% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="Person.html">Person</a>=EMPTY</tt> (3663; 57%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (1844; 29% of non-empty `Number`): <em>els, quals, ens, altres, uns, ells, -los, alguns, nosaltres, tots</em>
* `Sing` (4583; 71% of non-empty `Number`): <em>un, li, tot, això, qual, el, l', ell, una, la</em>
* `EMPTY` (16942): <em>que, es, s', hi, -se, on, se, què, ho, qui</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Fem</tt></td><td><em>la, -la</em></td><td><em>les, -les</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Acc</tt></td><td><em>l'</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Dat</tt></td><td><em>li, -li</em></td><td></td></tr>
...
`Number` seems to be **lexical feature** of `NUM`. 95% lemmas (63) occur only with one value of `Number`.

### `ADP`

121 [ca-pos/ADP]() tokens (0% of all `ADP` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADP` and `Number` co-occurred: <tt><a href="AdpType.html">AdpType</a>=Preppron</tt> (121; 100%).

`ADP` tokens may have the following values of `Number`:

* `Plur` (102; 84% of non-empty `Number`): <em>dels, als</em>
* `Sing` (19; 16% of non-empty `Number`): <em>Del, al, do, da, DEL</em>
* `EMPTY` (87854): <em>de, a, d', per, en, amb, entre, sobre, segons, des</em>

`Number` seems to be **lexical feature** of `ADP`. 100% lemmas (11) occur only with one value of `Number`.

### `ADV`

60 [ca-pos/ADV]() tokens (0% of all `ADV` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADV` and `Number` co-occurred: <tt><a href="Negative.html">Negative</a>=EMPTY</tt> (60; 100%).
...
<tt>NOUN --[<a href="../dep/det.html">det</a>]--> DET</tt> (64799; 96%),
<tt>NOUN --[<a href="../dep/amod.html">amod</a>]--> ADJ</tt> (22797; 97%),
<tt>NOUN --[<a href="../dep/nmod.html">nmod</a>]--> NOUN</tt> (13364; 52%),
<tt>VERB --[<a href="../dep/nsubj.html">nsubj</a>]--> NOUN</tt> (8108; 64%),
<tt>NOUN --[<a href="../dep/acl.html">acl</a>]--> VERB</tt> (3961; 51%),
<tt>NOUN --[<a href="../dep/conj.html">conj</a>]--> NOUN</tt> (3933; 78%),
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (1540; 66%),
<tt>DET --[<a href="../dep/det.html">det</a>]--> DET</tt> (1497; 98%),
<tt>NOUN --[<a href="../dep/appos.html">appos</a>]--> NOUN</tt> (1333; 65%),
<tt>NOUN --[<a href="../dep/cop.html">cop</a>]--> AUX</tt> (1159; 72%).
