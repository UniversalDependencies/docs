...
There are 1 `PRON` lemmas (7%), 55 `PRON` types (4%) and 440 `PRON` tokens (12%).
...
The form / lemma ratio of `PRON` is 55.000000 (the average of all parts of speech is 97.642857).
