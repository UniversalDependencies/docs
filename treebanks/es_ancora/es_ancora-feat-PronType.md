...
110162 tokens (20%) have a non-empty value of `PronType`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="es_ancora-pos-DET.html">DET</a></tt> (84247; 15% instances), <tt><a href="es_ancora-pos-PRON.html">PRON</a></tt> (25905; 5% instances), <tt><a href="es_ancora-pos-SCONJ.html">SCONJ</a></tt> (10; 0% instances).

### `DET`

84247 <tt><a href="es_ancora-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="es_ancora-feat-Number.html">Number</a></tt><tt>=Sing</tt> (66145; 79%), <tt><a href="es_ancora-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (62495; 74%), <tt><a href="es_ancora-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (46278; 55%).

`DET` tokens may have the following values of `PronType`:

* `Art` (72074; 86% of non-empty `PronType`): <em>el, la, los, un, las, una, unos, unas, els, a</em>
...
* `Int,Rel` (79; 0% of non-empty `PronType`): <em>qué, cuantos, cuántos, cuánto, cual, cuantas, cuánta</em>
* `Neg` (174; 0% of non-empty `PronType`): <em>ningún, ninguna</em>
...
25905 <tt><a href="es_ancora-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="es_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (19946; 77%), <tt><a href="es_ancora-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (19217; 74%), <tt><a href="es_ancora-feat-PrepCase.html">PrepCase</a></tt><tt>=EMPTY</tt> (15825; 61%), <tt><a href="es_ancora-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (15573; 60%), <tt><a href="es_ancora-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (13832; 53%), <tt><a href="es_ancora-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (13288; 51%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (780; 3% of non-empty `PronType`): <em>eso, esto, éste, ésta, mismo, este, misma, mismos, éstos, tal</em>
* `Ind` (2331; 9% of non-empty `PronType`): <em>donde, uno, cómo, cuando, una, algo, unos, otros, otro, algunos</em>
* `Int,Rel` (9405; 36% of non-empty `PronType`): <em>que, quien, qué, quienes, cual, cuyo, cuya, cuales, quién, cuál</em>
* `Neg` (364; 1% of non-empty `PronType`): <em>nada, nadie, ninguno, ninguna</em>
* `Prs` (12609; 49% of non-empty `PronType`): <em>se, lo, le, me, nos, la, les, él, ellos, yo</em>
...
* `EMPTY` (12468): <em>que, como, si, porque, cuando, aunque, según, mientras, pues, donde</em>
