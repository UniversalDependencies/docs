...
12054 tokens (15%) have a non-empty value of `PronType`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="en_gum-pos-DET.html">DET</a></tt> (6467; 8% instances), <tt><a href="en_gum-pos-PRON.html">PRON</a></tt> (5050; 6% instances), <tt><a href="en_gum-pos-SCONJ.html">SCONJ</a></tt> (360; 0% instances), <tt><a href="en_gum-pos-ADV.html">ADV</a></tt> (177; 0% instances).

### `DET`

6467 <tt><a href="en_gum-pos-DET.html">DET</a></tt> tokens (94% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="en_gum-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (4273; 66%).

`DET` tokens may have the following values of `PronType`:

* `Art` (6080; 94% of non-empty `PronType`): <em>the, a, an</em>
...
* `EMPTY` (400): <em>some, all, no, any, each, every, another, both, The, either</em>
...
5050 <tt><a href="en_gum-pos-PRON.html">PRON</a></tt> tokens (93% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="en_gum-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (4043; 80%), <tt><a href="en_gum-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (3498; 69%), <tt><a href="en_gum-feat-Case.html">Case</a></tt><tt>=Nom</tt> (2557; 51%).

`PRON` tokens may have the following values of `PronType`:

* `Art` (10; 0% of non-empty `PronType`): <em>a, the</em>
* `Dem` (295; 6% of non-empty `PronType`): <em>this, that, those, these</em>
* `Int` (172; 3% of non-empty `PronType`): <em>what, which, who, whatever, whose, whoever, whom</em>
* `Prs` (4146; 82% of non-empty `PronType`): <em>you, it, i, your, they, we, he, her, she, his</em>
...
* `EMPTY` (1276): <em>that, if, as, because, by, while, after, of, in, for</em>
...
* `EMPTY` (2673): <em>also, so, very, just, as, more, even, well, only, most</em>
