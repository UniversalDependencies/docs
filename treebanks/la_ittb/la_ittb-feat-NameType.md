---
layout: base
title:  'Statistics of NameType in UD_Latin-ITTB'
udver: '2'
---
...
* `Let` (2; 2% of non-empty `NameType`): <em>alpha, omega</em>
* `Lit` (83; 87% of non-empty `NameType`): <em>prouerb., act., deut., prou., thren., psalm., comment., deuteron., dialog., epist.</em>
* `Nat` (10; 11% of non-empty `NameType`): <em>galat., gal.</em>

`NameType` seems to be **lexical feature** of `NOUN`. 100% lemmas (11) occur only with one value of `NameType`.
...
<tt>NOUN --[<tt><a href="la_ittb-dep-conj.html">conj</a></tt>]--> NOUN</tt> (1; 100%).
