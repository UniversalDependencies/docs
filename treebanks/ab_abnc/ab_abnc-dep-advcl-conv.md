...
381 nodes (4%) are attached to their parents as `advcl:conv`.

356 instances of `advcl:conv` (93%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.1496062992126.

The following 4 pairs of parts of speech are connected with `advcl:conv`: <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt>-<tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> (378; 99% instances), <tt><a href="ab_abnc-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> (1; 0% instances), <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt>-<tt><a href="ab_abnc-pos-ADJ.html">ADJ</a></tt> (1; 0% instances), <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt>-<tt><a href="ab_abnc-pos-NUM.html">NUM</a></tt> (1; 0% instances).
...
3	ҟарҵаӡом	а́-ҟаҵара	VERB	V_Dyn_Tr_Fin_Pres_Neg_Emph_S:3Pl_DO:3_DO:Ad	Dyn=Yes|Mood=Ind|Number[subj]=Plur|Person[obj]=3|Person[subj]=3|Polarity=Neg|Subcat=Tran|Tense=Pres|VerbForm=Fin	0	root	_	LMSeg:а́-ҟа·ҵа-ра|SpaceAfter=No
...
7	иазыҧшуп	а-зыҧшра́	VERB	V_Stat_Fin_Pres_S:3_RO:3SgNH_Reln:For	Dyn=No|Gender[ro]=Neut|Mood=Ind|Number[ro]=Sing|Person[ro]=3|Person[subj]=3|Reln=Ben|Tense=Pres|VerbForm=Fin	3	conj	_	LMSeg:а-зы·ҧш-ра́|SpaceAfter=No
...
12	ирфоит	а́-фара	VERB	V_Dyn_Tr_Fin_Pres_S:3Pl_DO:3	Dyn=Yes|Mood=Ind|Number[subj]=Plur|Person[obj]=3|Person[subj]=3|Subcat=Tran|Tense=Pres|VerbForm=Fin	3	conj	_	LMSeg:а́-фа-ра|SpaceAfter=No
13	,	,	PUNCT	Punct_Comma	_	14	punct	_	LMSeg:,
14	иржәуеит	а́-жәра	VERB	V_Dyn_Tr_Fin_Pres_S:3Pl_DO:3	Dyn=Yes|Mood=Ind|Number[subj]=Plur|Person[obj]=3|Person[subj]=3|Subcat=Tran|Tense=Pres|VerbForm=Fin	12	conj	_	LMSeg:а́-жә-ра|SpaceAfter=No
