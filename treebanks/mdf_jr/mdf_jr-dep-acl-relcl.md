...
3	лядсь	лядемс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt1,ScSg3
...
8	лувозе	лувомс	VERB	V	Mood=Ind|Number[obj]=Sing|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Tense=Past|VerbForm=Fin	5	acl:relcl	_	GTtags=Ind,Prt1,ScSg3,OcSg3
9	аф	аф	AUX	V	Polarity=Neg|VerbType=Aux	10	aux:neg	_	GTtags=Aux,Neg
10	кунара	кунара	ADV	Adv	AdvType=Tim	8	advmod:tmod	_	SpaceAfter=No
