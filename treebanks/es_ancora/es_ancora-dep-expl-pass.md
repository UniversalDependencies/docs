...
1	Ello	él	PRON	pp3ns000	Case=Acc,Nom|Gender=Masc|Number=Sing|Person=3|PronType=Prs	2	nsubj	2:nsubj	Entity=(CESSCASTP199901023c32--1-CorefType:dx.prop)
...
4	los	el	DET	da0mp0	Definite=Def|Gender=Masc|Number=Plur|PronType=Art	5	det	5:det	Entity=(CESSCASTP199901023s16.sn.10-number-3-gstype:spec
5	26	26	NUM	_	NumForm=Digit|NumType=Card	6	nummod	6:nummod	_
6	cents	cent	NOUN	ncmp000	Gender=Masc|Number=Plur	23	nsubj	23:nsubj	_
...
10	las	el	DET	da0fp0	Definite=Def|Gender=Fem|Number=Plur|PronType=Art	12	det	12:det	Entity=(CESSCASTP199901023s16.sn.25--3-gstype:gen,HomoDD
11	dos	dos	NUM	dn0cp0	Number=Plur|NumType=Card	10	nummod	10:nummod	_
12	hamburguesas	hamburguesa	NOUN	ncfp000	Gender=Fem|Number=Plur	8	nmod	8:nmod	_
...
22	,	,	PUNCT	fc	PunctType=Comm	14	punct	14:punct	Entity=CESSCASTP199901023s16.sn.25)CESSCASTP199901023s16.sn.10)
...
25	más	más	ADV	rg	Degree=Cmp	28	advmod	28:advmod	Entity=(CESSCASTP199901023s16.sn.62-number-4-gstype:spec(CESSCASTP199901023s16.sn.63-number-4-gstype:spec
26	de	de	ADP	sps00	_	25	case	25:case	_
27	43	43	NUM	_	NumForm=Digit|NumType=Card	25	nummod	25:nummod	_
28	pesetas	peseta	NOUN	zm	NumForm=Digit	24	conj	24:conj	SpaceAfter=No|ClusterId[1]=CESS-CAST-P-19990102-3-s16.sn.63|ClusterType[1]=Spec.number|MentionSpan[1]=25-28|ClusterId[2]=CESS-CAST-P-19990102-3-s16.sn.62|ClusterType[2]=Spec.number|MentionSpan[2]=25-43|Entity=CESSCASTP199901023s16.sn.63)
...
36	que	que	PRON	pr0cn000	PronType=Int,Rel	35	obl	35:obl	Entity=(CESSCASTP199901023c18-number-1-CorefType:ident,gstype:spec)
...
40	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	41	det	41:det	Entity=(CESSCASTP199901023s16.sn.90--2-gstype:gen,HomoDD
41	comparación	comparación	NOUN	ncfs000	Gender=Fem|Number=Sing	36	obj	36:obj	Entity=CESSCASTP199901023s16.sn.90)
42	en	en	ADP	sps00	_	43	case	43:case	_
43	pesetas	peseta	NOUN	ncfp000	Gender=Fem|Number=Plur	36	obl	36:obl	SpaceAfter=No|Entity=(CESSCASTP199901023c19--1-CorefType:ident,gstype:gen)CESSCASTP199901023c18)CESSCASTP199901023s16.sn.62)
...
2	grupo	grupo	NOUN	ncms000	Gender=Masc|Number=Sing	6	nsubj	6:nsubj	_
...
11	conciertos	concierto	NOUN	ncmp000	Gender=Masc|Number=Plur	9	obj	9:obj	_
12	que	que	PRON	pr0cn000	PronType=Int,Rel	13	iobj	13:iobj	Entity=(CESSCASTP20020202115c1--1-CorefType:ident,gstype:gen)
...
16	el	el	DET	da0ms0	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	18	det	18:det	Entity=(CESSCASTP20020202115s2.sn.43-time-3-gstype:spec
17	próximo	próximo	ADJ	aq0ms0	Gender=Masc|Number=Sing	18	amod	18:amod	_
18	martes	martes	NOUN	_	AdvType=Tim	24	obl	24:obl	Entity=CESSCASTP20020202115s2.sn.43)
19	en	en	ADP	sps00	_	20	case	20:case	_
20	Razzmatazz	Razzmatazz	PROPN	np00000	_	24	obl	24:obl	Entity=(CESSCASTP20020202115s2.sn.54-place-1-gstype:spec)
21	(	(	PUNCT	fpa	PunctSide=Ini|PunctType=Brck	22	punct	22:punct	SpaceAfter=No
22	que	que	PRON	pr0cn000	PronType=Int,Rel	24	nsubj:pass	24:nsubj:pass	Entity=(CESSCASTP20020202115c1--1-CorefType:ident,gstype:gen)
...
27	25	25	NUM	_	NumForm=Digit|NumType=Card	24	obl	24:obl	MWE=25_de_abril|MWEPOS=NOUN|Entity=(CESSCASTP20020202115s2.sn.68-time-1-gstype:spec
28	de	de	ADP	_	_	29	case	29:case	_
29	abril	abril	NOUN	_	_	27	compound	27:compound	SpaceAfter=No|Entity=CESSCASTP20020202115s2.sn.68)
...
38	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	39	det	39:det	Entity=(CESSCASTP20020202115s2.sn.89-place-2-gstype:spec
...
42	Zaragoza	Zaragoza	PROPN	np00000	_	39	nmod	39:nmod	SpaceAfter=No|Entity=(CESSCASTP20020202115s2.sn.97-place-1-gstype:spec)CESSCASTP20020202115s2.sn.89)CESSCASTP20020202115c1)
