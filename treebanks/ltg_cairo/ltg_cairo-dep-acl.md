---
layout: base
title:  'Statistics of acl in UD_Latgalian-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Latgalian-Cairo: Relations: `acl`
...
The following 1 pairs of parts of speech are connected with `acl`: <tt><a href="ltg_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ltg_cairo-pos-VERB.html">VERB</a></tt> (1; 100% instances).
