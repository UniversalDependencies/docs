...
There are 42 `ADP` lemmas (1%), 46 `ADP` types (1%) and 4666 `ADP` tokens (16%).
...
The form / lemma ratio of `ADP` is 1.095238 (the average of all parts of speech is 1.431974).
