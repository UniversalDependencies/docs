...
573 types (18%) occur at least once with a non-empty value of `Person`.
288 lemmas (12%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="fr_parisstories-pos-PRON.html">PRON</a></tt> (5951; 14% instances), <tt><a href="fr_parisstories-pos-VERB.html">VERB</a></tt> (2447; 6% instances), <tt><a href="fr_parisstories-pos-AUX.html">AUX</a></tt> (2031; 5% instances).

### `PRON`

5951 <tt><a href="fr_parisstories-pos-PRON.html">PRON</a></tt> tokens (92% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="fr_parisstories-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5013; 84%), <tt><a href="fr_parisstories-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (3941; 66%), <tt><a href="fr_parisstories-feat-Emph.html">Emph</a></tt><tt>=No</tt> (2990; 50%).
...
* `3` (3921; 66% of non-empty `Person`): <em>on, c', il, ça, y, elle, s', se, lui, ils</em>
* `EMPTY` (486): <em>qui, que, où, qu', quoi, rien, personne, j~, dont, le</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_parisstories-feat-Emph.html">Emph</a></tt><tt>=No</tt>|<tt><a href="fr_parisstories-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>m'</em></td><td><em>j'</em></td></tr>
  <tr><td><tt><tt><a href="fr_parisstories-feat-Emph.html">Emph</a></tt><tt>=No</tt></tt></td><td><em>je, j', me, m'</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="fr_parisstories-feat-Emph.html">Emph</a></tt><tt>=Yes</tt>|<tt><a href="fr_parisstories-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td></td><td><em>moi</em></td></tr>
  <tr><td><tt><tt><a href="fr_parisstories-feat-Emph.html">Emph</a></tt><tt>=Yes</tt></tt></td><td><em>moi, -moi</em></td><td></td></tr>
</table>
...
2447 <tt><a href="fr_parisstories-pos-VERB.html">VERB</a></tt> tokens (55% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="fr_parisstories-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (2433; 99%), <tt><a href="fr_parisstories-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2389; 98%), <tt><a href="fr_parisstories-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (2335; 95%), <tt><a href="fr_parisstories-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2292; 94%), <tt><a href="fr_parisstories-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1586; 65%).
...
* `3` (1546; 63% of non-empty `Person`): <em>avait, a, est, fait, était, dit, va, faisait, faut, allait</em>
* `EMPTY` (1970): <em>voilà, faire, fait, aller, dit, eu, vu, dire, voir, parler</em>
...
<tt>VERB --[<tt><a href="fr_parisstories-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (1859; 63%),
<tt>VERB --[<tt><a href="fr_parisstories-dep-expl-subj.html">expl:subj</a></tt>]--> PRON</tt> (252; 94%),
<tt>VERB --[<tt><a href="fr_parisstories-dep-expl-comp.html">expl:comp</a></tt>]--> PRON</tt> (248; 85%),
...
<tt>VERB --[<tt><a href="fr_parisstories-dep-dislocated.html">dislocated</a></tt>]--> PRON</tt> (64; 57%),
<tt>PRON --[<tt><a href="fr_parisstories-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (57; 67%),
<tt>PRON --[<tt><a href="fr_parisstories-dep-acl-relcl.html">acl:relcl</a></tt>]--> VERB</tt> (43; 54%).
