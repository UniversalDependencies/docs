...
2	leäi	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	4	aux	_	GTtags=IV,Ind,Prt,Sg3
...
12	leežž	leeʹd	AUX	Aux	Mood=Pot|Number=Sing|Person=3|VerbForm=Fin	13	aux	_	GTtags=IV,Pot,Sg3
13	šõddâm	šõddâd	VERB	V	Aspect=Perf|VerbForm=Part	4	advcl	_	GTtags=Act,PrfPrc
14	ǥu	ǥu	SCONJ	CS	_	18	mark	_	_
15	ij	ij	AUX	Aux	Mood=Ind|Number=Sing|Person=3|Polarity=Neg|VerbForm=Fin	18	aux	_	GTtags=Neg,Ind,Sg3
