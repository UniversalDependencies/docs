...
* _<b>շատ մը</b>_/_<b>šat më</b>_ (a multiword adjective paraphrasable as “a lot of”, lit. “many some”; here the first node is the technical head and it is an adjective itself, so UPOS = `ExtPos`)
...
* _<b>ի տարբերութիւն</b>_/_<b>i tarberowtʼiwn</b>_ “<b>as opposed to</b>” (here the first node is the technical head and it is a preposition itself, so UPOS = `ExtPos`)
* _<b>նախ քան</b>_/_<b>nax kʼan</b>_ “before” (_նախ_/_nax_ = [ADV]())

### <a name="ADV">`ADV`</a>: adverb-like expression

#### Examples

* _<b>առ նուազն</b>_/_<b>aṙ nowazn</b>_ (a multiword adverb paraphrasable as “at least”; the first node _առ_/_aṙ_ is [ADP]())

### <a name="CCONJ">`CCONJ`</a>: coordinating conjunction-like expression

#### Examples

* _<b>ինչպէս նաեւ</b>_/_<b>inčpēs naew</b> “as well” (_ինչպէս_/_inčpēs_ = [ADV]())

### <a name="DET">`DET`</a>: determiner-like expression

#### Examples

* _<b>ոչ մի</b>_/_<b>oč mi</b>_ “not any” (_ոչ_ = [PART]())

### <a name="PRON">`PRON`</a>: pronoun-like expression

#### Examples

* _<b>ամէն ինչ</b>_/_<b>amēn inč</b>_ (a multiword determiner paraphrasable as “everything”, _ամէն_/_amēn_ = [DET]())

### <a name="PROPN">`PROPN`</a>: proper noun-like expression

#### Examples

* _<b>Camilla՚s Garden</b>_ (_Camilla_ = [X]())

### <a name="SCONJ">`SCONJ`</a>: subordinator-like expression

#### Examples

* _<b>այնպէս որ</b>_/_<b>aynpēs or</b>_ “so, so that” (_այնպէս_/_aynpēs_ = [ADV]())

### <a name="PART">`PART`</a>: particle-like expression

#### Examples

* _<b>դժուար թէ</b>_/_<b>džowar tʼē</b>_ (a multiword particle paraphrasable as “hardly”; _դժուար_/_džowar_ = [ADJ]())

### <a name="INTJ">`INTJ`</a>: interjection-like expression

#### Examples

* _<b>ափսոս որ</b>_/_apʼsos vor_ (a multiword interjection paraphrasable as “it's a pity that”; _ափսոս_/_apʼsos_ = [INTJ]())
