---
layout: base
title:  'Statistics of X in UD_Swedish-Talbanken'
udver: '2'
---

## Treebank Statistics: UD_Swedish-Talbanken: POS Tags: `X`
...
The 10 most frequent `X` types:  <em>som</em>
...
`X` nodes are attached to their parents using 1 different relations: <tt><a href="sv_talbanken-dep-goeswith.html">goeswith</a></tt> (1; 100% instances)

Parents of `X` nodes belong to 1 different parts of speech: <tt><a href="sv_talbanken-pos-ADP.html">ADP</a></tt> (1; 100% instances)
