...
6	§_1_odst._2_písm._f)	§_1_odst._2_písm._f)	X	X@-------------	_	4	obl	_	_
...
10	účetnictví	účetnictví	NOUN	NNNS4-----A----	Case=Acc|Gender=Neut|Number=Sing|Polarity=Pos	9	obj	_	_
...
13	dne	den	NOUN	NNIS2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Sing|Polarity=Pos	9	obl	_	_
14	účetního	účetní	ADJ	AANS2----1A----	Case=Gen|Degree=Pos|Gender=Neut|Number=Sing|Polarity=Pos	15	amod	_	LId=účetní-1
15	období	období	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos	13	nmod	_	_
16	následujícího	následující	ADJ	AGNS2-----A----	Aspect=Imp|Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos|Tense=Pres|VerbForm=Part|Voice=Act	15	amod	_	_
17	po	po	ADP	RR--6----------	AdpType=Prep|Case=Loc	18	case	_	LId=po-1
18	období	období	NOUN	NNNS6-----A----	Case=Loc|Gender=Neut|Number=Sing|Polarity=Pos	16	obl	_	SpaceAfter=No
...
27	nerozhodnou-li	nerozhodnou-li	X	X@-------------	_	8	obl	_	_
28	se	se	PRON	P7-X4----------	Case=Acc|PronType=Prs|Reflex=Yes|Variant=Short	27	expl:pv	_	_
29	vést	vést	VERB	Vf--------A----	Polarity=Pos|VerbForm=Inf	27	xcomp	_	LId=vést-1
30	účetnictví	účetnictví	NOUN	NNNS1-----A----	Case=Nom|Gender=Neut|Number=Sing|Polarity=Pos	29	obj	_	_
31	již	již	ADV	Db-------------	_	33	advmod:emph	_	_
32	ode	od	ADP	RV--2----------	AdpType=Voc|Case=Gen	33	case	_	LId=od-1
33	dne	den	NOUN	NNIS2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Sing|Polarity=Pos	29	obl	_	_
34	zahájení	zahájení	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos	33	nmod	_	_
35	podnikání	podnikání	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos	34	nmod	_	_
36	nebo	nebo	CCONJ	J^-------------	_	40	cc	_	_
37	jiné	jiný	ADJ	AAFS2----1A----	Case=Gen|Degree=Pos|Gender=Fem|Number=Sing|Polarity=Pos	40	amod	_	_
38	samostatné	samostatný	ADJ	AAFS2----1A----	Case=Gen|Degree=Pos|Gender=Fem|Number=Sing|Polarity=Pos	40	amod	_	_
39	výdělečné	výdělečný	ADJ	AAFS2----1A----	Case=Gen|Degree=Pos|Gender=Fem|Number=Sing|Polarity=Pos	40	amod	_	_
40	činnosti	činnost	NOUN	NNFS2-----A----	Case=Gen|Gender=Fem|Number=Sing|Polarity=Pos	35	conj	_	SpaceAfter=No
...
44	dne	den	NOUN	NNIS2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Sing|Polarity=Pos	29	obl	_	_
45	ukončení	ukončení	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos	44	nmod	_	_
46	uvedených	uvedený	ADJ	AAFP2----1A----	Case=Gen|Degree=Pos|Gender=Fem|Number=Plur|Polarity=Pos	47	amod	_	_
47	činností	činnost	NOUN	NNFP2-----A----	Case=Gen|Gender=Fem|Number=Plur|Polarity=Pos	45	nmod	_	_
48	nebo	nebo	CCONJ	J^-------------	_	44	cc	_	_
49	do	do	ADP	RR--2----------	AdpType=Prep|Case=Gen	51	case	_	LId=do-1
50	posledního	poslední	ADJ	AAIS2----1A----	Animacy=Inan|Case=Gen|Degree=Pos|Gender=Masc|Number=Sing|Polarity=Pos	51	amod	_	_
51	dne	den	NOUN	NNIS2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Sing|Polarity=Pos	44	obl	_	_
52	účetního	účetní	ADJ	AANS2----1A----	Case=Gen|Degree=Pos|Gender=Neut|Number=Sing|Polarity=Pos	53	amod	_	LId=účetní-1
53	období	období	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing|Polarity=Pos	51	nmod	_	SpaceAfter=No
...
70	§_1_odst._2_písm._d),_e),_g)	§_1_odst._2_písm._d),_e),_g)	X	X@-------------	_	67	obl	_	_
