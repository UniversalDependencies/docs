...
There are 1 `NUM` lemmas (3%), 230 `NUM` types (4%) and 435 `NUM` tokens (2%).
Out of 14 observed tags, the rank of `NUM` is: 10 in number of lemmas, 5 in number of types and 12 in number of tokens.
...
The form / lemma ratio of `NUM` is 230.000000 (the average of all parts of speech is 171.916667).
