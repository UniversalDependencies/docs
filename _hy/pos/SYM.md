...
Strings that consists entirely of alphanumeric characters are not symbols but they may be [proper nouns](PROPN): _130XE_, _DC10_; others may be tagged `PROPN` (rather than `SYM`) even if they contain special characters: _DC-10_. Similarly, abbreviations for single words are not symbols but are assigned the part of speech of the full form. For example, _պրն_ (պարոն "Mr.; Mister"), _կգ_ (կիլոգրամ "kg; kilogramm"), _կմ_ (կիլոմետր "km; kilometer") should be tagged [nouns](NOUN). Acronyms for proper names such as _ՄԱԿ_ "OSN" and _ՆԱՏՕ_ "NATO" should be tagged as [proper nouns](PROPN).
