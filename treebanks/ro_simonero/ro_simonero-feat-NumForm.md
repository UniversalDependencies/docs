...
The feature is used with 2 part-of-speech tags: <tt><a href="ro_simonero-pos-NUM.html">NUM</a></tt> (4568; 3% instances), <tt><a href="ro_simonero-pos-ADJ.html">ADJ</a></tt> (4; 0% instances).

### `NUM`

4568 <tt><a href="ro_simonero-pos-NUM.html">NUM</a></tt> tokens (99% of all `NUM` tokens) have a non-empty value of `NumForm`.

The most frequent other feature values with which `NUM` and `NumForm` co-occurred: <tt><a href="ro_simonero-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (4126; 90%), <tt><a href="ro_simonero-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4053; 89%).

`NUM` tokens may have the following values of `NumForm`:

* `Combi` (2; 0% of non-empty `NumForm`): <em>31.12.2012</em>
* `Digit` (3890; 85% of non-empty `NumForm`): <em>2, 1, 3, 4, 5, 30, 10, 20, 6, 15</em>
* `Roman` (182; 4% of non-empty `NumForm`): <em>II, iv, III, i, V, l, VII, XIX, I-, VIII</em>
* `Word` (494; 11% of non-empty `NumForm`): <em>două, trei, primul, prima, primele, doua, doilea, patru, primă, cinci</em>
