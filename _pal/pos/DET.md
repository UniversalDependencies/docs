...
### Examples
- article-like numeral _ēw_ "one" (e.g., 'a certain')
- possessive determiners (if preposed): _man_ "my", _xwēš_ (possessive pronoun of whatever person number features of the subject or topic)
