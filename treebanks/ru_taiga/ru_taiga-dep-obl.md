...
1	Фото	фото	NOUN	_	Animacy=Inan|Case=Nom|Gender=Neut|InflClass=Ind|Number=Sing	0	root	_	_
...
6	Сочи	Сочи	PROPN	_	Animacy=Inan|Case=Loc|Gender=Masc|InflClass=Ind|NameType=Geo|Number=Sing	7	obl	_	_
