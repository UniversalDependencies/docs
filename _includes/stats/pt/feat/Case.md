...
* `Acc` (1894; 69% of non-empty `Case`): __
* `Acc,Dat` (4; 0% of non-empty `Case`): __
* `Acc,Nom` (71; 3% of non-empty `Case`): __
* `Dat` (227; 8% of non-empty `Case`): __
* `Nom` (530; 19% of non-empty `Case`): __
