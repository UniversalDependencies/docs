...
1598 tokens (0%) have a non-empty value of `Poss`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> (1596; 0% instances), <tt><a href="et_edt-pos-ADJ.html">ADJ</a></tt> (1; 0% instances), <tt><a href="et_edt-pos-ADV.html">ADV</a></tt> (1; 0% instances).

### `PRON`

1596 <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> tokens (7% of all `PRON` tokens) have a non-empty value of `Poss`.

The most frequent other feature values with which `PRON` and `Poss` co-occurred: <tt><a href="et_edt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (1596; 100%), <tt><a href="et_edt-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1596; 100%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1578; 99%), <tt><a href="et_edt-feat-Case.html">Case</a></tt><tt>=Gen</tt> (1440; 90%).

`PRON` tokens may have the following values of `Poss`:

* `Yes` (1596; 100% of non-empty `Poss`): <em>oma, omal, omad, omaks, omast, omaenda, omaga, omalt, omas, omadega</em>
* `EMPTY` (21440): <em>ta, see, mis, ma, kes, seda, tema, mida, nad, selle</em>
...
* `EMPTY` (36760): <em>suur, hea, võimalik, eesti, suurem, uue, suure, raske, oluline, esimene</em>
...
* `Yes` (1; 100% of non-empty `Poss`): <em>oma</em>
* `EMPTY` (42051): <em>ka, siis, nii, kas, juba, välja, aga, veel, väga, mitte</em>
