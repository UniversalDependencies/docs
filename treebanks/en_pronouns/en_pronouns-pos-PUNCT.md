...
## Treebank Statistics: UD_English-Pronouns: POS Tags: `PUNCT`

There are 4 `PUNCT` lemmas (6%), 4 `PUNCT` types (5%) and 320 `PUNCT` tokens (19%).
Out of 13 observed tags, the rank of `PUNCT` is: 6 in number of lemmas, 8 in number of types and 2 in number of tokens.
...
The form / lemma ratio of `PUNCT` is 1.000000 (the average of all parts of speech is 1.212121).
