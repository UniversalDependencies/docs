...
There are 322 `ADJ` lemmas (12%), 403 `ADJ` types (11%) and 1213 `ADJ` tokens (3%).
...
The form / lemma ratio of `ADJ` is 1.251553 (the average of all parts of speech is 1.324273).
