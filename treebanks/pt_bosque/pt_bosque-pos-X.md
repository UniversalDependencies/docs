...
There are 128 `X` lemmas (1%), 128 `X` types (0%) and 157 `X` tokens (0%).
...
* <em>centers</em>
  * <tt><a href="pt_bosque-pos-NOUN.html">NOUN</a></tt> 1: <em>Importados por a Céramus , os pisos de uso comercial ( para hotéis e shopping <b>centers</b> ) destacam se por a grande resistência .</em>
  * <tt><a href="pt_bosque-pos-X.html">X</a></tt> 1: <em>O grupo Sendas entra com o terreno de 154 mil metros quadrados , e o Nacional Iguatemi Empreendimentos , dono de shoppings <b>centers</b> em o Nordeste e sócio de Tasso Jereissati em o Iguatemi de São Paulo , com os recursos para bancar o empreendimento .</em>

## Morphology

The form / lemma ratio of `X` is 1.000000 (the average of all parts of speech is 1.417416).
...
`X` occurs with 2 features: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (31; 20% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (18; 11% instances)
