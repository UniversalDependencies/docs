...
There are 54 `DET` lemmas (0%), 105 `DET` types (0%) and 34869 `DET` tokens (15%).
...
The form / lemma ratio of `DET` is 1.944444 (the average of all parts of speech is 1.414899).
