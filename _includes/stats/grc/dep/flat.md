...
68 nodes (0%) are attached to their parents as `flat`.

68 instances of `flat` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.52941176470588.

The following 4 pairs of parts of speech are connected with `flat`: [grc-pos/NUM]()-[grc-pos/NUM]() (59; 87% instances), [grc-pos/PRON]()-[grc-pos/PRON]() (6; 9% instances), [grc-pos/ADJ]()-[grc-pos/ADJ]() (2; 3% instances), [grc-pos/PROPN]()-[grc-pos/PROPN]() (1; 1% instances).
