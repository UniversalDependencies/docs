---
layout: base
title:  'Statistics of acl in UD_Tamil-TTB'
udver: '2'
---
...
The following 4 pairs of parts of speech are connected with `acl`: <tt><a href="ta_ttb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ta_ttb-pos-VERB.html">VERB</a></tt> (22; 63% instances), <tt><a href="ta_ttb-pos-PART.html">PART</a></tt>-<tt><a href="ta_ttb-pos-VERB.html">VERB</a></tt> (8; 23% instances), <tt><a href="ta_ttb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ta_ttb-pos-AUX.html">AUX</a></tt> (4; 11% instances), <tt><a href="ta_ttb-pos-NUM.html">NUM</a></tt>-<tt><a href="ta_ttb-pos-VERB.html">VERB</a></tt> (1; 3% instances).
...
3	கொண்டதற்க்	கொள்	AUX	VZDD3SNAA	Case=Dat|Gender=Neut|Number=Sing|Person=3|Polarity=Pos|Tense=Past|VerbForm=Ger|Voice=Act	2	aux	2:aux	Translit=koṇṭatark|LTranslit=koḷ
4	ஆன	ஆன	PART	Tg-------	_	5	nmod	5:nmod	Translit=āna|LTranslit=āna
5	காரணம்	காரணம்	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	8	obj	8:obj	Translit=kāraṇam|LTranslit=kāraṇam
6	எதுவும்	எது	PRON	RBN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3|PronType=Ind	5	nmod	5:nmod	Translit=etuvum|LTranslit=etu
...
1	குஜராத்	குஜராத்	PROPN	NEN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	3	nmod	3:nmod	Translit=kujarāt|LTranslit=kujarāt
2	உள்ளாட்சித்	உள்ளாட்சி	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	3	nmod	3:nmod	Translit=uḷḷāṭcit|LTranslit=uḷḷāṭci
3	தேர்தலில்	தேர்தல்	NOUN	NNL-3SN--	Case=Loc|Gender=Neut|Number=Sing|Person=3	7	obl	7:obl	Translit=tērtalil|LTranslit=tērtal
4	பெரும்பான்மையான	பெரும்பான்மை	ADJ	JJ-------	_	5	amod	5:amod	Translit=perumpānmaiyāna|LTranslit=perumpānmai
5	இடங்களில்	இடம்	NOUN	NNL-3PN--	Case=Loc|Gender=Neut|Number=Plur|Person=3	7	obl	7:obl	Translit=iṭaṅkaḷil|LTranslit=iṭam
...
8	பெற்றுள்ளது	பெறு	AUX	VR-T3SNAA	Gender=Neut|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|VerbForm=Fin|Voice=Act	7	acl	7:acl	SpaceAfter=No|Translit=perruḷḷatu|LTranslit=peru
