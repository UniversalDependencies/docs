...
There are 41 `PRON` lemmas (2%), 71 `PRON` types (2%) and 6437 `PRON` tokens (15%).
...
The form / lemma ratio of `PRON` is 1.731707 (the average of all parts of speech is 1.353739).
