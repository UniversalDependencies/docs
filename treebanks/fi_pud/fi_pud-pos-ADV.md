...
There are 306 `ADV` lemmas (6%), 316 `ADV` types (4%) and 965 `ADV` tokens (6%).
...
* <em>näin</em>
  * <tt><a href="fi_pud-pos-ADV.html">ADV</a></tt> 1: <em>On helppoa vain sivuuttaa peli , jota ensin hallitsi , mutta joka päättyi tasapeliin . Jos <b>näin</b> käy kolme kertaa peräkkäin , tilanne vaikuttaa heikkoudelta .</em>
  * <tt><a href="fi_pud-pos-VERB.html">VERB</a></tt> 1: <em>Pjongjangissa <b>näin</b> jokusia ihmisiä älypuhelimiensa kanssa , mutta paljon vähemmän .</em>

## Morphology

The form / lemma ratio of `ADV` is 1.032680 (the average of all parts of speech is 1.525677).
