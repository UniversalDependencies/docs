...
The feature is used with 4 part-of-speech tags: <tt><a href="it_vit-pos-X.html">X</a></tt> (398; 0% instances), <tt><a href="it_vit-pos-NOUN.html">NOUN</a></tt> (5; 0% instances), <tt><a href="it_vit-pos-ADJ.html">ADJ</a></tt> (1; 0% instances), <tt><a href="it_vit-pos-ADP.html">ADP</a></tt> (1; 0% instances).

### `X`

398 <tt><a href="it_vit-pos-X.html">X</a></tt> tokens (98% of all `X` tokens) have a non-empty value of `Foreign`.
...
* `Yes` (398; 100% of non-empty `Foreign`): <em>joint, venture, baby, cd, sitter, rom, condicio, par, est, facile</em>
* `EMPTY` (7): <em>equ, 25%, 60%, e, m3, star</em>

`Foreign` seems to be **lexical feature** of `X`. 100% lemmas (218) occur only with one value of `Foreign`.
...
* `EMPTY` (58075): <em>anni, miliardi, anno, n, parte, legge, società, posti, presidente, art</em>
...
* `EMPTY` (20035): <em>primo, precedente, altri, nuovo, grande, economico, stesso, altre, nuova, nuovi</em>
...
* `EMPTY` (45523): <em>di, a, in, per, da, con, su, tra, ad, come</em>
