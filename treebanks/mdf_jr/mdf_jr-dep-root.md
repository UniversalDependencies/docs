---
layout: base
title:  'Statistics of root in UD_Moksha-JR'
udver: '2'
---

## Treebank Statistics: UD_Moksha-JR: Relations: `root`

This relation is universal.

65 nodes (12%) are attached to their parents as `root`.

65 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.96923076923077.

The following 7 pairs of parts of speech are connected with `root`: -<tt><a href="mdf_jr-pos-VERB.html">VERB</a></tt> (51; 78% instances), -<tt><a href="mdf_jr-pos-NOUN.html">NOUN</a></tt> (7; 11% instances), -<tt><a href="mdf_jr-pos-ADJ.html">ADJ</a></tt> (3; 5% instances), -<tt><a href="mdf_jr-pos-ADV.html">ADV</a></tt> (1; 2% instances), -<tt><a href="mdf_jr-pos-AUX.html">AUX</a></tt> (1; 2% instances), -<tt><a href="mdf_jr-pos-PRON.html">PRON</a></tt> (1; 2% instances), -<tt><a href="mdf_jr-pos-PROPN.html">PROPN</a></tt> (1; 2% instances).
...
9	пацяняц	пацяня	NOUN	N	Case=Nom|Number=Sing|Number[psor]=Sing|Person[psor]=3	11	obj	_	_
