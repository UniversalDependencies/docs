...
6616 tokens (1%) have a non-empty value of `Reflex`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="ca_ancora-pos-PRON.html">PRON</a></tt> (6616; 1% instances).
...
* `Yes` (6616; 100% of non-empty `Reflex`): <em>es, s', se, si, s, 's, -se, se'n</em>
* `EMPTY` (16846): <em>que, hi, un, li, tot, on, què, això, ho, qual</em>
