---
layout: base
title:  'Statistics of nummod in UD_Coptic-Scriptorium'
udver: '2'
---

## Treebank Statistics: UD_Coptic-Scriptorium: Relations: `nummod`

This relation is universal.

129 nodes (0%) are attached to their parents as `nummod`.

105 instances of `nummod` (81%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.86821705426357.

The following 2 pairs of parts of speech are connected with `nummod`: <tt><a href="cop_scriptorium-pos-NOUN.html">NOUN</a></tt>-<tt><a href="cop_scriptorium-pos-NUM.html">NUM</a></tt> (125; 97% instances), <tt><a href="cop_scriptorium-pos-NUM.html">NUM</a></tt>-<tt><a href="cop_scriptorium-pos-NUM.html">NUM</a></tt> (4; 3% instances).
...
7	ϣⲟⲩⲟ	ϣⲟⲩⲟ	VERB	V	Mood=Ind|VerbForm=Fin	3	acl:relcl	_	_
...
# visual-style 8 5 nummod	color:blue
1	ⲛⲉ	ⲛⲉⲣⲉ	AUX	CPRET	_	4	aux	_	Orig=[..]
2	ⲩ	ⲛⲧⲟⲟⲩ	PRON	PPERS	Definite=Def|Number=Plur|Person=3|PronType=Prs	4	nsubj	_	_
3	ⲛⲁ	ⲛⲁ	AUX	FUT	_	4	aux	_	_
4	ⲣ	ⲉⲓⲣⲉ	VERB	V	Mood=Cnd|VerbForm=Fin	0	root	_	_
...
12	ⲕⲁⲁ	ⲕⲱ	VERB	V	Mood=Ind|VerbForm=Fin	4	conj	_	_
13	ⲩ	ⲛⲧⲟⲟⲩ	PRON	PPERO	Definite=Def|Number=Plur|Person=3|PronType=Prs	12	obj	_	_
14	ⲉⲃⲟⲗ	ⲉⲃⲟⲗ	ADV	ADV	_	12	advmod	_	_
