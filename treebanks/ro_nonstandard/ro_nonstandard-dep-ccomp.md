...
1	Fată	fată	NOUN	Ncfsrn	Case=Acc,Nom|Definite=Ind|Gender=Fem|Number=Sing	7	vocative	_	SpaceAfter=No
2	,	,	PUNCT	COMMA	_	1	punct	_	_
3	ce	ce	PRON	Pw3--r	Case=Acc,Nom|Person=3|PronType=Int,Rel	7	obj	_	_
4	eu	eu	PRON	Pp1-sr	Case=Nom|Number=Sing|Person=1|PronType=Prs	7	nsubj	_	_
5	te	tu	PRON	Pp2-sa--------w	Case=Acc|Number=Sing|Person=2|PronType=Prs|Strength=Weak	7	expl	_	SpaceAfter=No
6	-aș	avea	AUX	Vaip1s	Mood=Ind|Number=Sing|Person=1|Tense=Pres	7	aux	_	_
7	ruga	ruga	VERB	Vmn	VerbForm=Inf	0	root	_	SpaceAfter=No
...
13	bănat	bănat	NOUN	Ncmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	7	ccomp	_	Rhyme=ID19|SpaceAfter=No|Type=Paired
14	,	,	PUNCT	COMMA	_	16	punct	_	_
15	Unde	unde	ADV	Rw	PronType=Int,Rel	16	advmod	_	_
...
19	sat	sat	NOUN	Ncmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	16	obl	_	Rhyme=ID13|SpaceAfter=No|Type=Paired
...
1	Vare	oare-	DET	Di3fsr	Case=Acc,Nom|Gender=Fem|Number=Sing|Person=3|PronType=Ind	4	det	_	ref=MATT10.11
2	în	în	ADP	Spsa	AdpType=Prep|Case=Acc	4	case	_	ref=MATT10.11
3	ce	ce	DET	Dw3--r	Case=Acc,Nom|Person=3|PronType=Int,Rel	4	det	_	ref=MATT10.11
4	oraș	oraș	NOUN	Ncmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	8	obl	_	ref=MATT10.11
5	au	sau	CCONJ	Ccssp	Polarity=Pos	6	cc	_	ref=MATT10.11
6	sat	sat	NOUN	Ncmsrn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Sing	4	conj	_	ref=MATT10.11
7	veți	vrea	AUX	Vaip2p	Mood=Ind|Number=Plur|Person=2|Tense=Pres	8	aux	_	ref=MATT10.11
8	întra	intra	VERB	Vmn	VerbForm=Inf	10	advcl	_	ref=MATT10.11
9	,	,	PUNCT	COMMA	_	8	punct	_	ref=MATT10.11
10	întrebați	întreba	VERB	Vmm-2p	Mood=Imp|Number=Plur|Person=2|VerbForm=Fin	0	root	_	ref=MATT10.11
11	cine	cine	PRON	Pw3--r	Case=Acc,Nom|Person=3|PronType=Int,Rel	15	nsubj	_	ref=MATT10.11
12	iaste	fi	VERB	Vmip3s	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	15	cop	_	ref=MATT10.11
13	într-	întru	ADP	Spsa	AdpType=Prep|Case=Acc	14	case	_	ref=MATT10.11
14	însa	îns	NOUN	Ncfsry	Case=Acc,Nom|Definite=Def|Gender=Fem|Number=Sing	15	obl	_	ref=MATT10.11
15	harnic	harnic	ADJ	Afpmsrn	Case=Acc,Nom|Definite=Ind|Degree=Pos|Gender=Masc|Number=Sing	10	ccomp	_	ref=MATT10.11
16	și	și	CCONJ	Ccssp	Polarity=Pos	18	cc	_	ref=MATT10.11
17	acolo	acolo	ADV	Rg	_	18	advmod	_	ref=MATT10.11
18	mîneți	mânea	VERB	Vmm-2p	Mood=Imp|Number=Plur|Person=2|VerbForm=Fin	10	conj	_	ref=MATT10.11
19	pînă	până	SCONJ	Csssp	Polarity=Pos	21	mark	_	ref=MATT10.11
20	veți	vrea	AUX	Vaip2p	Mood=Ind|Number=Plur|Person=2|Tense=Pres	21	aux	_	ref=MATT10.11
21	eși	ieși	VERB	Vmn	VerbForm=Inf	18	advcl:tcl	_	ref=MATT10.11|SpaceAfter=No
22	.	.	PUNCT	PERIOD	_	10	punct	_	ref=MATT10.11
