...
6	beragama	agama	VERB	VSA	Mood=Ind|Voice=Act	0	root	_	MorphInd=^ber+agama<n>_VSA$
7	tradisional	tradisional	ADJ	ASP	_	6	amod	_	MorphInd=^tradisional<a>_ASP$
