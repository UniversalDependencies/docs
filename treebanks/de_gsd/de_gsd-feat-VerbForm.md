...
31923 tokens (11%) have a non-empty value of `VerbForm`.
...
The feature is used with 15 part-of-speech tags: <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> (20477; 7% instances), <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> (10590; 4% instances), <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> (662; 0% instances), <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> (69; 0% instances), <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> (60; 0% instances), <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> (27; 0% instances), <tt><a href="de_gsd-pos-X.html">X</a></tt> (18; 0% instances), <tt><a href="de_gsd-pos-ADP.html">ADP</a></tt> (5; 0% instances), <tt><a href="de_gsd-pos-CCONJ.html">CCONJ</a></tt> (4; 0% instances), <tt><a href="de_gsd-pos-PART.html">PART</a></tt> (4; 0% instances), <tt><a href="de_gsd-pos-DET.html">DET</a></tt> (3; 0% instances), <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-PUNCT.html">PUNCT</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-SCONJ.html">SCONJ</a></tt> (1; 0% instances).

### `VERB`

20477 <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> tokens (99% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (12187; 60%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (11981; 59%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (12409; 61% of non-empty `VerbForm`): <em>wurde, gibt, hat, liegt, kam, hatte, gab, war, erhielt, befindet</em>
* `Inf` (2995; 15% of non-empty `VerbForm`): <em>lassen, empfehlen, machen, werden, erreichen, finden, sehen, haben, kommen, sagen</em>
* `Part` (5073; 25% of non-empty `VerbForm`): <em>gegründet, genannt, verwendet, eingesetzt, bezeichnet, genutzt, gebaut, aufgenommen, gewählt, gemacht</em>
...
10590 <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9311; 88%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9245; 87%), <tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (7619; 72%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7281; 69%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5577; 53%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (9822; 93% of non-empty `VerbForm`): <em>ist, wurde, war, sind, wird, wurden, kann, hat, werden, waren</em>
...
* `EMPTY` (19941): <em>ersten, später, erste, weitere, anderen, neue, bekannt, neuen, großen, große</em>
...
* `EMPTY` (30714): <em>Deutschland, de, of, US, Berlin, the, SPD, St., new, Oktober</em>
...
* `EMPTY` (14829): <em>auch, nur, noch, sehr, so, dort, wieder, hier, mehr, heute</em>
...
* `EMPTY` (37388): <em>der, die, dem, den, das, des, eine, ein, einer, einem</em>
...
<tt>VERB --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1645; 71%),
<tt>VERB --[<tt><a href="de_gsd-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (142; 54%),
