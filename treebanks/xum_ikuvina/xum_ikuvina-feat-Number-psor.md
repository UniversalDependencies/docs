---
layout: base
title:  'Statistics of Number[psor] in UD_Umbrian-IKUVINA'
udver: '2'
---

## Treebank Statistics: UD_Umbrian-IKUVINA: Features: `Number[psor]`
...
1 lemmas (6%) occur at least once with a non-empty value of `Number[psor]`.
The feature is used with 1 part-of-speech tags: <tt><a href="xum_ikuvina-pos-DET.html">DET</a></tt> (1; 0% instances).

### `DET`

1 <tt><a href="xum_ikuvina-pos-DET.html">DET</a></tt> tokens (17% of all `DET` tokens) have a non-empty value of `Number[psor]`.
