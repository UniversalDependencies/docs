...
40802 tokens (8%) have a non-empty value of `PronType`.
720 types (1%) occur at least once with a non-empty value of `PronType`.
138 lemmas (0%) occur at least once with a non-empty value of `PronType`.
The feature is used with 3 part-of-speech tags: <tt><a href="cs_cac-pos-DET.html">DET</a></tt> (19810; 4% instances), <tt><a href="cs_cac-pos-PRON.html">PRON</a></tt> (15986; 3% instances), <tt><a href="cs_cac-pos-ADV.html">ADV</a></tt> (5006; 1% instances).

### `DET`

19810 <tt><a href="cs_cac-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="cs_cac-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (17383; 88%), <tt><a href="cs_cac-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (15879; 80%), <tt><a href="cs_cac-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (15879; 80%), <tt><a href="cs_cac-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (14439; 73%), <tt><a href="cs_cac-feat-Number.html">Number</a></tt><tt>=Sing</tt> (12218; 62%).

`DET` tokens may have the following values of `PronType`:

* `Dem` (7912; 40% of non-empty `PronType`): <em>to, tím, této, těchto, tyto, tom, toho, tento, tohoto, tomu</em>
* `Emp` (332; 2% of non-empty `PronType`): <em>sám, sama, sami, samo, samy, samé, samého, samých, samém, samu</em>
...
The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="cs_cac-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13175; 82%), <tt><a href="cs_cac-feat-PrepCase.html">PrepCase</a></tt><tt>=EMPTY</tt> (13129; 82%), <tt><a href="cs_cac-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (12532; 78%), <tt><a href="cs_cac-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (10280; 64%), <tt><a href="cs_cac-feat-Case.html">Case</a></tt><tt>=Acc</tt> (9779; 61%), <tt><a href="cs_cac-feat-Variant.html">Variant</a></tt><tt>=Short</tt> (9196; 58%), <tt><a href="cs_cac-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (9042; 57%).

`PRON` tokens may have the following values of `PronType`:

* `Ind` (233; 1% of non-empty `PronType`): <em>něco, někdo, někomu, něčeho, něčemu, kdekdo, cosi, ledacos, málokdo, někoho</em>
* `Int,Rel` (639; 4% of non-empty `PronType`): <em>co, kdo, čím, čem, čeho, copak, kdož, koho, čemu, komu</em>
...
5006 <tt><a href="cs_cac-pos-ADV.html">ADV</a></tt> tokens (18% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="cs_cac-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (5006; 100%), <tt><a href="cs_cac-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (5006; 100%).

`ADV` tokens may have the following values of `PronType`:

* `Dem` (2629; 53% of non-empty `PronType`): <em>tak, proto, zde, tam, tu, dosud, nyní, tehdy, tady, teď</em>
...
* `Rel` (53; 1% of non-empty `PronType`): <em>přičemž, jak</em>
* `Tot` (271; 5% of non-empty `PronType`): <em>vždy, všude, odjakživa, navždy, odevždy</em>
* `EMPTY` (23069): <em>také, již, už, ještě, pak, tedy, velmi, třeba, především, zejména</em>
...
`PronType` seems to be **lexical feature** of `ADV`. 98% lemmas (50) occur only with one value of `PronType`.
...
<tt>DET --[<tt><a href="cs_cac-dep-fixed.html">fixed</a></tt>]--> ADV</tt> (1; 100%),
