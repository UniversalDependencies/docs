...
There are 1 `X` lemmas (6%), 3 `X` types (1%) and 7 `X` tokens (1%).
Out of 16 observed tags, the rank of `X` is: 16 in number of lemmas, 13 in number of types and 13 in number of tokens.
...
The form / lemma ratio of `X` is 3.000000 (the average of all parts of speech is 19.625000).

The 1st highest number of forms (3) was observed with the lemma “_”: <em>-i, -n, aː#</em>.
...
`X` nodes are attached to their parents using 2 different relations: <tt><a href="bej_nsc-dep-dep-aff.html">dep:aff</a></tt> (6; 86% instances), <tt><a href="bej_nsc-dep-reparandum.html">reparandum</a></tt> (1; 14% instances)

Parents of `X` nodes belong to 2 different parts of speech: <tt><a href="bej_nsc-pos-VERB.html">VERB</a></tt> (6; 86% instances), <tt><a href="bej_nsc-pos-DET.html">DET</a></tt> (1; 14% instances)
