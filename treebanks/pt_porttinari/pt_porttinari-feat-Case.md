...
## Treebank Statistics: UD_Portuguese-Porttinari: Features: `Case`
...
<table>
  ...
  <tr><td><tt></tt></td><td><em>se</em></td><td><em>se</em></td><td><em>se</em></td></tr>
</table>

## Relations with Agreement in `Case`

The 10 most frequent relations where parent and child node agree in `Case`:
<tt>PRON --[<tt><a href="pt_porttinari-dep-conj.html">conj</a></tt>]--> PRON</tt> (2; 67%).
