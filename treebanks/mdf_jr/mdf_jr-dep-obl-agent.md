...
2	кеподев	кеподевомс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=2|VerbForm=Fin	0	root	_	_
3	теест	сон	PRON	Pron	Case=Dat|Number=Plur|Person=3|PronType=Prs|Variant=Short	2	obl:agent	_	SpaceAfter=No
4	,	,	PUNCT	CLB	_	6	punct	_	_
5	эрявсь	эрявомс	AUX	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	6	aux	_	_
...
3	улема	улема	VERB	V	Mood=Nec|Number[subj]=Sing|Person[subj]=3|VerbForm=Fin	11	advcl	_	GTtags=Epist|SpaceAfter=No
...
10	сашендови	сашендовомс	AUX	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Pres|VerbForm=Fin	11	aux	_	GTtags=IV,Ind,Prs,ScSg3
