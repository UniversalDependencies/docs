...
21655 tokens (15%) have a non-empty value of `PronType`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="he_iahltwiki-pos-DET.html">DET</a></tt> (13621; 10% instances), <tt><a href="he_iahltwiki-pos-PRON.html">PRON</a></tt> (5454; 4% instances), <tt><a href="he_iahltwiki-pos-ADP.html">ADP</a></tt> (2572; 2% instances), <tt><a href="he_iahltwiki-pos-ADV.html">ADV</a></tt> (8; 0% instances).
...
5454 <tt><a href="he_iahltwiki-pos-PRON.html">PRON</a></tt> tokens (97% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt> (5125; 94%), <tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3991; 73%), <tt><a href="he_iahltwiki-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (3385; 62%), <tt><a href="he_iahltwiki-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (3323; 61%), <tt><a href="he_iahltwiki-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (3272; 60%), <tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (3146; 58%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (982; 18% of non-empty `PronType`): זה, זו, זאת, כך, אלו, כן, אלה, הללו, זהו, זוהי
...
* `Prs` (4385; 80% of non-empty `PronType`): ו, ה, הם, ם, הוא, היא, הן, אותה, ן, י
* `EMPTY` (179): כך, מה, מי, כן, אותה, זה, איזה, דנן, כולו, כמה
...
The most frequent other feature values with which `ADP` and `PronType` co-occurred: <tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (2572; 100%), <tt><a href="he_iahltwiki-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (2568; 100%).
