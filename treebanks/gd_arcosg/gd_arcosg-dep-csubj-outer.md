...
6	bha	bi	VERB	V-s	CleftType=Verb|Mood=Ind|Tense=Past|VerbForm=Fin	0	root	_	_
7	Uilleam	Uilleam	PROPN	Nn-mn	Case=Nom|Gender=Masc|NounType=Prs	6	nsubj	_	_
8	is	is	CCONJ	Cc	_	9	cc	_	_
9	Màiri	Màiri	PROPN	Nn-fn	Case=Nom|Gender=Fem|NounType=Prs	6	conj	_	_
10	Anna	Anna	PROPN	Nn-fn	Case=Nom|Gender=Fem|NounType=Prs	9	flat:name	_	FlatType=Name
11	pòsda	pòs	ADJ	Av	_	6	xcomp:pred	_	_
12	ann	an	ADP	Sp	ExtPos=ADP	14	case	_	_
13	an	an	ADP	Sp	_	12	fixed	_	_
14	Glaschu	Glaschu	PROPN	Nt	NounType=Top	11	obl	_	_
15	a	a	PART	Q-r	PartType=Vb|PronType=Rel	16	advmod	_	_
16	chuireadh	cuir	VERB	V-s0	Mood=Ind|Person=0|Tense=Past|VerbForm=Fin	6	csubj:outer	_	_
17	eòlas	eòlas	NOUN	Ncsmn	Case=Nom|Gender=Masc|Number=Sing	16	nsubj	_	_
18	an	an	ADV	Rt	AdvType=Tim|ExtPos=ADV	16	advmod	_	_
19	toiseach	toiseach	ADV	Rt	AdvType=Tim	18	fixed	_	_
20	air	air	ADP	Sp	_	21	case	_	_
21	iad	iad	PRON	Pp3p	Number=Plur|Person=3|PronType=Prs	16	obl	_	_
...
4	fhéin	féin	PRON	Px	PronType=Prs|Reflex=Yes	3	nmod:unmarked	_	_
...
13	na	na	PART	Uc	ExtPos=PART|PartType=Comp	15	mark:prt	_	_
...
20	eil	bi	VERB	V-p--d	Mood=Ind|Tense=Pres|VerbForm=Fin	9	conj	_	_
21	aig	aig	ADP	Sp	_	22	case	_	_
22	thusa	thu	PRON	Pp2s--e	Form=Emp|Number=Sing|Person=2|PronType=Prs	20	xcomp:pred	_	_
23	,	,	PUNCT	Fi	_	20	punct	_	SpaceAfter=No
24	"	"	PUNCT	Fz	_	20	punct	_	_
25	as	arsa	VERB	V-s	Mood=Ind|Tense=Past|VerbForm=Fin	2	parataxis	_	_
26	ise	i	PRON	Pp3sf-e	Form=Emp|Gender=Fem|Number=Sing|Person=3|PronType=Prs	25	nsubj	_	SpaceAfter=No
...
31	tha	bi	VERB	V-p	Mood=Ind|Tense=Pres|VerbForm=Fin	2	parataxis	_	_
32	thu	thu	PRON	Pp2s	Number=Sing|Person=2|PronType=Prs	31	nsubj	_	_
...
37	do	do	DET	Dp2s	Number=Sing|Person=2|Poss=Yes|PronType=Prs	38	nmod:poss	_	_
...
44	dealaich	dealaich	VERB	Vm-2s	Mood=Ind|Person=2|VerbForm=Fin	2	parataxis	_	_
...
53	faodaidh	faod	VERB	V-f	Mood=Ind|Tense=Fut|VerbForm=Fin	44	conj	_	_
54	gun	gu	PART	Qa	PartType=Cmpl	55	mark:prt	_	_
55	dèan	dèan	VERB	V-f--d	Mood=Ind|Tense=Fut|VerbForm=Fin	53	ccomp	_	_
56	iad	iad	PRON	Pp3p	Number=Plur|Person=3|PronType=Prs	55	nsubj	_	_
...
60	thu	thu	PRON	Pp2s	Number=Sing|Person=2|PronType=Prs	55	obl	_	_
...
2	thachair	tachair	VERB	V-f--d	Mood=Ind|Tense=Fut|VerbForm=Fin	0	root	_	_
3	e	e	PRON	Pp3sm	Gender=Masc|Number=Sing|Person=3|PronType=Prs	2	nsubj	_	_
4	a	a	ADV	Rt	AdvType=Tim|ExtPos=ADV	2	advmod	_	_
5	chaoidh	chaoidh	ADV	Rt	AdvType=Tim	4	fixed	_	_
6	agus	agus	CCONJ	Cc	_	7	cc	_	_
7	tha	bi	VERB	V-p	Mood=Ind|Tense=Pres|VerbForm=Fin	2	conj	_	_
...
18	bhios	bi	VERB	V-f--r	Mood=Ind|Tense=Fut|VerbForm=Fin	13	csubj:outer	_	_
19	daoine	duine	NOUN	Ncpmn	Case=Nom|Gender=Masc|Number=Plur	18	nsubj	_	_
20	an	an	ADV	Rs	AdvType=Loc|ExtPos=ADV	19	advmod	_	_
21	seo	seo	ADV	Rs	AdvType=Loc	20	fixed	_	_
22	mu	mu	ADP	Sp	ExtPos=ADP	24	case	_	_
23	dheidhinn	deidhinn	ADP	Nf	_	22	fixed	_	_
24	seo	seo	PRON	Pd	PronType=Dem	18	xcomp:pred	_	_
25	an	an	ADV	Rt	AdvType=Tim|ExtPos=ADV	18	advmod	_	_
26	dràsda	dràsda	ADV	Rt	AdvType=Tim	25	fixed	_	_
...
30	Hearadh	Hearadh	PROPN	Nt	NounType=Top	27	nmod	_	_
31	agus	agus	CCONJ	Cc	_	32	cc	_	_
32	Uibhist-a-Tuath	Uibhist-a-Tuath	PROPN	Nt	NounType=Top	30	conj	_	_
