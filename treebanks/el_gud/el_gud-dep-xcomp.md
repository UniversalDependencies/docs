...
1	Γυρίζω	γυρίζω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
2	ποδαράτος	ποδαράτος	ADJ	_	Case=Nom|Gender=Masc|Number=Sing	1	xcomp	_	_
3	από	από	ADP	_	_	5	case	_	_
4	την	ο	DET	_	Case=Acc|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	5	det	_	_
5	Κηφισίας	Κηφισίας	PROPN	_	Case=Gen|Gender=Fem|Number=Sing	1	obl	_	_
6	σ	σε	ADP	_	_	8	case	_	_
7	το	ο	DET	_	Case=Acc|Definite=Def|Gender=Neut|Number=Sing|PronType=Art	8	det	_	_
8	γραφείο	γραφείο	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	1	obl	_	SpaceAfter=No
