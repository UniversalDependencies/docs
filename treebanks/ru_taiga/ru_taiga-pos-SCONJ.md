...
There are 64 `SCONJ` lemmas (0%), 70 `SCONJ` types (0%) and 25140 `SCONJ` tokens (1%).
...
The form / lemma ratio of `SCONJ` is 1.093750 (the average of all parts of speech is 2.706171).
