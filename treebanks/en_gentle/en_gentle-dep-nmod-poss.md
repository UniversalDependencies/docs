...
There are also 2 other language-specific subtypes of `nmod`: <tt><a href="en_gentle-dep-nmod-desc.html">nmod:desc</a></tt>, <tt><a href="en_gentle-dep-nmod-unmarked.html">nmod:unmarked</a></tt>.
...
1	Our	our	PRON	PRP$	Case=Gen|Number=Plur|Person=1|Poss=Yes|PronType=Prs	2	nmod:poss	2:nmod:poss	Discourse=explanation-evidence:101->98:3:_|Entity=(124-person-new-nnnnn-cf2-2-sgl(125-person-acc:com-nnnnn-cf1-1-ana)|PDTB=NoRel:NoRel:_:_:485-501:502-511
...
4	a	a	DET	DT	Definite=Ind|PronType=Art	6	det	6:det	Entity=(126-organization-new-nnnnn-cf3-3-sgl
...
8	our	our	PRON	PRP$	Case=Gen|Number=Plur|Person=1|Poss=Yes|PronType=Prs	9	nmod:poss	9:nmod:poss	Entity=(127-place-new-nnnnn-cf4-2-sgl(125-person-giv:act-nnnnn-cf1-1-ana)
