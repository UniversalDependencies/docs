...
The form / lemma ratio of `SCONJ` is 1.021277 (the average of all parts of speech is 1.414227).
...
`SCONJ` occurs with 5 features: <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (4; 0% instances), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (4; 0% instances), <tt><a href="pt_bosque-feat-Definite.html">Definite</a></tt> (2; 0% instances), <tt><a href="pt_bosque-feat-PronType.html">PronType</a></tt> (2; 0% instances), <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt> (1; 0% instances)

`SCONJ` occurs with 6 feature-value pairs: `Definite=Ind`, `Gender=Fem`, `Gender=Masc`, `Number=Sing`, `PronType=Art`, `VerbForm=Ger`

`SCONJ` occurs with 4 feature combinations.
The most frequent feature combination is `_` (5353 tokens).
