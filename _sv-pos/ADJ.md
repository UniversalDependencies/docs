...
attributive and predicative position), e.g. _en stor skillnad_ "a big difference" (common singular), 
_ett stort problem_ "a big problem" (neuter singual) and _stora delar_ "big parts" (plural). 
