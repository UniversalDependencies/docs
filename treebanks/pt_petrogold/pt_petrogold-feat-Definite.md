...
31768 tokens (13%) have a non-empty value of `Definite`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> (31767; 13% instances), <tt><a href="pt_petrogold-pos-PRON.html">PRON</a></tt> (1; 0% instances).

### `DET`

31767 <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> tokens (87% of all `DET` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `DET` and `Definite` co-occurred: <tt><a href="pt_petrogold-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (31748; 100%), <tt><a href="pt_petrogold-feat-Number.html">Number</a></tt><tt>=Sing</tt> (25201; 79%), <tt><a href="pt_petrogold-feat-Gender.html">Gender</a></tt><tt>=Fem</tt> (16023; 50%).

`DET` tokens may have the following values of `Definite`:

* `Def` (29007; 91% of non-empty `Definite`): <em>a, o, os, as, esta, Do, µ, á</em>
...
* `EMPTY` (5399): <em>se, que, o, isso, a, isto, este, qual, um, uma</em>
