...
There are 19 `SYM` lemmas (0%), 19 `SYM` types (0%) and 101 `SYM` tokens (0%).
...
* <em>×</em>
  * <tt><a href="de_gsd-pos-SYM.html">SYM</a></tt> 6: <em>Es bestand aus einem Rost aus Eichenpfählen von 13 <b>×</b> 18 m Größe .</em>
  * <tt><a href="de_gsd-pos-X.html">X</a></tt> 2: <em>Die Hasselblad XPan Kamera produziert Panorama - Negative mit einem Format von 65 mm <b>×</b> 24 mm Größe , kann aber auch durch einen manuellen Schalter in der klassischen Kleinbild - Größe 36 mm <b>×</b> 24 mm verwendet werden .</em>
...
The form / lemma ratio of `SYM` is 1.000000 (the average of all parts of speech is 1.193317).
