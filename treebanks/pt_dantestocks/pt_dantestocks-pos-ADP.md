...
There are 31 `ADP` lemmas (0%), 43 `ADP` types (0%) and 8759 `ADP` tokens (11%).
...
The form / lemma ratio of `ADP` is 1.387097 (the average of all parts of speech is 1.238183).
...
The most frequent feature combination is `_` (8663 tokens).
