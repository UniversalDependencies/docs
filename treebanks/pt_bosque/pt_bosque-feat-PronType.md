...
42324 tokens (19%) have a non-empty value of `PronType`.
232 types (1%) occur at least once with a non-empty value of `PronType`.
83 lemmas (0%) occur at least once with a non-empty value of `PronType`.
The feature is used with 7 part-of-speech tags: <tt><a href="pt_bosque-pos-DET.html">DET</a></tt> (34828; 15% instances), <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> (7457; 3% instances), <tt><a href="pt_bosque-pos-PROPN.html">PROPN</a></tt> (26; 0% instances), <tt><a href="pt_bosque-pos-ADV.html">ADV</a></tt> (8; 0% instances), <tt><a href="pt_bosque-pos-SCONJ.html">SCONJ</a></tt> (3; 0% instances), <tt><a href="pt_bosque-pos-ADJ.html">ADJ</a></tt> (1; 0% instances), <tt><a href="pt_bosque-pos-ADP.html">ADP</a></tt> (1; 0% instances).

### `DET`

34828 <tt><a href="pt_bosque-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="pt_bosque-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (27717; 80%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (26516; 76%), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (18791; 54%).

`DET` tokens may have the following values of `PronType`:

* `Art` (31040; 89% of non-empty `PronType`): <em>o, a, os, as, um, uma, uns, esta, umas, outra</em>
* `Dem` (971; 3% of non-empty `PronType`): <em>este, esta, esse, essa, estes, estas, esses, aquele, essas, aquela</em>
* `Emp` (54; 0% of non-empty `PronType`): <em>próprio, própria, próprios, próprias</em>
* `Ind` (972; 3% of non-empty `PronType`): <em>qualquer, outros, outro, mais, outras, alguns, algumas, outra, muitos, vários</em>
...
* `Prs` (1288; 4% of non-empty `PronType`): <em>sua, seu, seus, suas, meu, nossa, nosso, minha, nossos, nossas</em>
* `Rel` (59; 0% of non-empty `PronType`): <em>cujo, cuja, cujas, cujos, qual, quais, Quantos, quanto</em>
* `Tot` (384; 1% of non-empty `PronType`): <em>todos, cada, toda, todo, todas, ambos, ambas, tudo</em>
* `EMPTY` (36): <em>cada, a, um, The, o, que, tal, dezenas, muitas, seu</em>
...
7457 <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5213; 70%), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (5028; 67%), <tt><a href="pt_bosque-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (4915; 66%), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (4742; 64%).

`PRON` tokens may have the following values of `PronType`:

* `Art` (24; 0% of non-empty `PronType`): <em>o, os, a, as, que, um</em>
* `Dem` (1046; 14% of non-empty `PronType`): <em>o, isso, isto, os, a, este, as, esta, mesmo, aquilo</em>
* `Ind` (514; 7% of non-empty `PronType`): <em>tudo, nada, outros, ninguém, que, alguns, outro, algo, outras, alguém</em>
...
* `Rel` (2918; 39% of non-empty `PronType`): <em>que, onde, quem, qual, quais, tudo, o, quanto, Nada, cuja</em>
* `Tot` (75; 1% of non-empty `PronType`): <em>todos, ambos, todas, todo, cada, Ambas</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>que</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Unsp</tt></tt></td><td></td><td></td><td></td><td></td><td><em>que</em></td></tr>
</table>
...
The most frequent other feature values with which `PROPN` and `PronType` co-occurred: <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (26; 100%), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (24; 92%).

`PROPN` tokens may have the following values of `PronType`:

* `Art` (26; 100% of non-empty `PronType`): <em>O, A</em>
* `EMPTY` (18899): <em>Paulo, São, Portugal, Brasil, José, Porto, Governo, Lisboa, Nacional, João</em>

### `ADV`

8 <tt><a href="pt_bosque-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="pt_bosque-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (8; 100%).

`ADV` tokens may have the following values of `PronType`:

* `Art` (1; 13% of non-empty `PronType`): <em>um</em>
* `Ind` (2; 25% of non-empty `PronType`): <em>quanto, tal</em>
* `Int` (4; 50% of non-empty `PronType`): <em>quanto</em>
* `Rel` (1; 13% of non-empty `PronType`): <em>quanto</em>
* `EMPTY` (8372): <em>não, mais, já, também, ainda, ontem, só, depois, muito, como</em>
...
3 <tt><a href="pt_bosque-pos-SCONJ.html">SCONJ</a></tt> tokens (0% of all `SCONJ` tokens) have a non-empty value of `PronType`.

`SCONJ` tokens may have the following values of `PronType`:

* `Art` (2; 67% of non-empty `PronType`): <em>Uma, uns</em>
* `Rel` (1; 33% of non-empty `PronType`): <em>que</em>
* `EMPTY` (5355): <em>que, a, de, para, se, porque, por, como, em, quando</em>
...
* `EMPTY` (33787): <em>de, em, a, por, com, para, como, entre, sobre, até</em>
...
<tt>PRON --[<tt><a href="pt_bosque-dep-parataxis.html">parataxis</a></tt>]--> PRON</tt> (2; 67%).
