---
layout: base
title:  'Statistics of Person in UD_German-LIT'
udver: '2'
---

## Treebank Statistics: UD_German-LIT: Features: `Person`
...
1593 <tt><a href="de_lit-pos-PRON.html">PRON</a></tt> tokens (58% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="de_lit-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1593; 100%), <tt><a href="de_lit-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (1249; 78%), <tt><a href="de_lit-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (891; 56%), <tt><a href="de_lit-feat-Number.html">Number</a></tt><tt>=Sing</tt> (803; 50%).
...
6 <tt><a href="de_lit-pos-VERB.html">VERB</a></tt> tokens (0% of all `VERB` tokens) have a non-empty value of `Person`.
...
5 <tt><a href="de_lit-pos-AUX.html">AUX</a></tt> tokens (0% of all `AUX` tokens) have a non-empty value of `Person`.
...
<tt>PRON --[<tt><a href="de_lit-dep-conj.html">conj</a></tt>]--> PRON</tt> (2; 67%).
