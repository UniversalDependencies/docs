...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td><em>dem</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>der</em></td><td><em>deren</em></td><td><em>deren, dessen, derer</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt></tt></td><td><em>den, Die</em></td><td></td><td></td></tr>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td><em>die</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td><em>das</em></td><td><em>das</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td><em>die</em></td><td><em>die</em></td></tr>
...
281 <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> tokens (2% of all `ADV` tokens) have a non-empty value of `PronType`.

`ADV` tokens may have the following values of `PronType`:

* `Art` (1; 0% of non-empty `PronType`): <em>ein</em>
* `Ind` (64; 23% of non-empty `PronType`): <em>mehr, etwas, viel, wenig, allem, genug, alles, anderem, ausreichend, zuviel</em>
* `Int` (215; 77% of non-empty `PronType`): <em>wo, wie, warum, wobei, wohin, wovon, wodurch, woraufhin, Wozu, was</em>
* `Prs` (1; 0% of non-empty `PronType`): <em>einander</em>
* `EMPTY` (14478): <em>auch, nur, noch, sehr, so, dort, wieder, hier, heute, jedoch</em>

`PronType` seems to be **lexical feature** of `ADV`. 100% lemmas (36) occur only with one value of `PronType`.

### `SCONJ`

101 <tt><a href="de_gsd-pos-SCONJ.html">SCONJ</a></tt> tokens (6% of all `SCONJ` tokens) have a non-empty value of `PronType`.

`SCONJ` tokens may have the following values of `PronType`:

* `Art` (3; 3% of non-empty `PronType`): <em>das</em>
* `Dem` (9; 9% of non-empty `PronType`): <em>das</em>
* `Int` (83; 82% of non-empty `PronType`): <em>wobei, wie, weshalb, woraufhin, warum, wohingegen, worauf, wo, wodurch, wonach</em>
* `Rel` (6; 6% of non-empty `PronType`): <em>das, den</em>
* `EMPTY` (1701): <em>dass, da, wenn, als, daß, nachdem, weil, während, wie, ob</em>

<table>
  <tr><th>Paradigm <i>d</i></th><th><tt>Art</tt></th><th><tt>Rel</tt></th><th><tt>Dem</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td></td><td><em>den</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td></td><td><em>das</em></td><td><em>das</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td><em>das</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td></td><td></td><td><em>das</em></td></tr>
</table>
...
* `EMPTY` (19911): <em>gibt, hat, kam, liegt, hatte, gab, war, erhielt, befindet, ist</em>

### `X`

10 <tt><a href="de_gsd-pos-X.html">X</a></tt> tokens (3% of all `X` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `X` and `PronType` co-occurred: <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8; 80%).

`X` tokens may have the following values of `PronType`:

* `Art` (3; 30% of non-empty `PronType`): <em>Min, Mio, dem</em>
* `Int` (1; 10% of non-empty `PronType`): <em>&amp;</em>
* `Prs` (5; 50% of non-empty `PronType`): <em>'s, er, :-)</em>
* `Rel` (1; 10% of non-empty `PronType`): <em>die</em>
* `EMPTY` (359): <em>z.B., u.a., =, %, B., etc., †, *, a, z.</em>

<table>
  <tr><th>Paradigm <i>d</i></th><th><tt>Art</tt></th><th><tt>Rel</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>dem</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td><em>die</em></td></tr>
</table>

### `AUX`

7 <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> tokens (0% of all `AUX` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `AUX` and `PronType` co-occurred: <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (7; 100%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (7; 100%), <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (7; 100%), <tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (7; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6; 86%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (5; 71%).

`AUX` tokens may have the following values of `PronType`:

* `Art` (2; 29% of non-empty `PronType`): <em>Bin, den</em>
* `Int` (3; 43% of non-empty `PronType`): <em>Bin</em>
* `Prs` (2; 29% of non-empty `PronType`): <em>Bin, wir</em>
* `EMPTY` (11389): <em>ist, wurde, war, sind, werden, wird, wurden, kann, hat, waren</em>
...
* `EMPTY` (8859): <em>und, oder, sowie, aber, als, sondern, wie, sowohl, doch, and</em>

### `PART`

6 <tt><a href="de_gsd-pos-PART.html">PART</a></tt> tokens (0% of all `PART` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PART` and `PronType` co-occurred: <tt><a href="de_gsd-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (4; 67%).

`PART` tokens may have the following values of `PronType`:

* `Art` (1; 17% of non-empty `PronType`): <em>'s</em>
* `Neg` (2; 33% of non-empty `PronType`): <em>keine, keinerlei</em>
* `Prs` (3; 50% of non-empty `PronType`): <em>'s</em>
* `EMPTY` (2160): <em>nicht, zu, aus, an, ja, nein, Hallo, hin, her, to</em>

<table>
  <tr><th>Paradigm <i>es</i></th><th><tt>Prs</tt></th><th><tt>Art</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt></tt></td><td></td><td><em>'s</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td><em>'s</em></td><td></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td><em>'s</em></td><td></td></tr>
</table>
