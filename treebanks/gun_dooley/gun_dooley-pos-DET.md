---
layout: base
title:  'Statistics of DET in UD_Mbya_Guarani-Dooley'
udver: '2'
---

## Treebank Statistics: UD_Mbya_Guarani-Dooley: POS Tags: `DET`

There are 3 `DET` lemmas (2%), 3 `DET` types (2%) and 13 `DET` tokens (0%).
Out of 16 observed tags, the rank of `DET` is: 11 in number of lemmas, 11 in number of types and 14 in number of tokens.

The 10 most frequent `DET` lemmas: <em>_, opa, peva'e</em>

The 10 most frequent `DET` types:  <em>_, Opa, peva'e</em>
...
The form / lemma ratio of `DET` is 1.000000 (the average of all parts of speech is 1.056000).

The 1st highest number of forms (1) was observed with the lemma “_”: <em>_</em>.

The 2nd highest number of forms (1) was observed with the lemma “opa”: <em>Opa</em>.

The 3rd highest number of forms (1) was observed with the lemma “peva'e”: <em>peva'e</em>.

`DET` occurs with 1 features: <tt><a href="gun_dooley-feat-PronType.html">PronType</a></tt> (13; 100% instances)
...
`DET` nodes are attached to their parents using 1 different relations: <tt><a href="gun_dooley-dep-det.html">det</a></tt> (13; 100% instances)

Parents of `DET` nodes belong to 1 different parts of speech: <tt><a href="gun_dooley-pos-NOUN.html">NOUN</a></tt> (13; 100% instances)
