...
~~~ sdparse
ROOT V posledních letech se srovnávání rozšiřuje , přinejmenším pokud jde o platy , na sousední státy .
case:auxp(rozšiřuje-7, V-2)
amod(letech-4, posledních-3)
nmod(V-2, letech-4)
auxpass:reflex(rozšiřuje-7, se-5)
nsubj(rozšiřuje-7, srovnávání-6)
root(ROOT-1, rozšiřuje-7)
punct(pokud-10, ,-8)
advmod:emph(pokud-10, přinejmenším-9)
mark:auxc(rozšiřuje-7, pokud-10)
advcl(pokud-10, jde-11)
case:auxp(jde-11, o-12)
dobj(o-12, platy-13)
punct(pokud-10, ,-14)
case:auxp(rozšiřuje-7, na-15)
amod(státy-17, sousední-16)
nmod(na-15, státy-17)
root:auxk(ROOT-1, .-18)
~~~
...
case(letech-4, V-2)
amod(letech-4, posledních-3)
nmod(rozšiřuje-7, letech-4)
auxpass:reflex(rozšiřuje-7, se-5)
nsubj(rozšiřuje-7, srovnávání-6)
root(ROOT-1, rozšiřuje-7)
punct(jde-11, ,-8)
advmod:emph(jde-11, přinejmenším-9)
mark(jde-11, pokud-10)
advcl(rozšiřuje-7, jde-11)
case(platy-13, o-12)
dobj(jde-11, platy-13)
punct(jde-11, ,-14)
case(státy-17, na-15)
amod(státy-17, sousední-16)
nmod(rozšiřuje-7, státy-17)
root:auxk(ROOT-1, .-18)
~~~
...
nsubj(rozšiřuje-7, srovnávání-6)
root(ROOT-1, rozšiřuje-7)
punct(přinejmenším-9, ,-8)
advmod:emph(rozšiřuje-7, přinejmenším-9)
mark(přinejmenším-9, pokud-10)
advcl(přinejmenším-9, jde-11)
case(platy-13, o-12)
dobj(jde-11, platy-13)
punct(přinejmenším-9, ,-14)
case(státy-17, na-15)
amod(státy-17, sousední-16)
nmod(rozšiřuje-7, státy-17)
root:auxk(ROOT-1, .-18)
