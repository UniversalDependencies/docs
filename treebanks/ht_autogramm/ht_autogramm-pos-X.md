---
layout: base
title:  'Statistics of X in UD_Haitian_Creole-Autogramm'
udver: '2'
---

## Treebank Statistics: UD_Haitian_Creole-Autogramm: POS Tags: `X`

There are 1 `X` lemmas (0%), 4 `X` types (0%) and 6 `X` tokens (0%).
...
The 10 most frequent `X` types:  <em>Eta, kouran, Ayiti, m</em>
...
`X` nodes are attached to their parents using 1 different relations: <tt><a href="ht_autogramm-dep-goeswith.html">goeswith</a></tt> (6; 100% instances)

Parents of `X` nodes belong to 3 different parts of speech: <tt><a href="ht_autogramm-pos-NOUN.html">NOUN</a></tt> (3; 50% instances), <tt><a href="ht_autogramm-pos-ADJ.html">ADJ</a></tt> (2; 33% instances), <tt><a href="ht_autogramm-pos-PROPN.html">PROPN</a></tt> (1; 17% instances)
