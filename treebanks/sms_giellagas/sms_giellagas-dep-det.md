...
## Treebank Statistics: UD_Skolt_Sami-Giellagas: Relations: `det`

This relation is universal.

57 nodes (2%) are attached to their parents as `det`.

55 instances of `det` (96%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.14035087719298.

The following 3 pairs of parts of speech are connected with `det`: <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> (49; 86% instances), <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sms_giellagas-pos-DET.html">DET</a></tt> (7; 12% instances), <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt>-<tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> (1; 2% instances).
...
1	Mon	mon	PRON	Pron	Case=Nom|Number=Sing|Person=1|PronType=Prs	3	nsubj	_	CGdephead=#1-&gt;0|CGdeprel=@SUBJ&gt;|GTtags=Pers,Sg1,Nom
2	leäm	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin	3	aux	_	CGdephead=#2-&gt;0|CGdeprel=@X|GTtags=IV,Act,PrfPrc
3	leämmaž	leeʹd	VERB	V	Aspect=Perf|VerbForm=Part	0	root	_	CGdephead=#3-&gt;0|CGdeprel=@X|GTtags=IV,Act,PrfPrc
4	määŋg	mäŋgg	DET	A	Case=Acc|Number=Sing|PronType=Ind	5	det	_	CGdephead=#4-&gt;0|CGdeprel=@&lt;SUBJ|GTtags=Pl,Nom
...
3	nuʹbb	nuʹbb	PRON	Pron	Case=Nom|Number=Sing|PronType=Ind	5	nsubj	_	GTtags=Sg,Nom
4	âʹtte	âʹte	ADV	Adv	AdvType=Tim	5	advmod	_	GTtags=Sem/Time
5	lueʹšti	lueʹštted	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt,Sg3|SpaceAfter=No
6	,	,	PUNCT	CLB	_	7	punct	_	_
7	lueʹšti	lueʹštted	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	5	conj	_	GTtags=Ind,Prt,Sg3|SpaceAfter=No
8	,	,	PUNCT	CLB	_	9	punct	_	_
9	lueʹšti	lueʹštted	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	5	conj	_	GTtags=Ind,Prt,Sg3
10	di	di	CCONJ	CC	_	12	cc	_	_
11	peästtõõǥǥ	peästtõk	NOUN	N	Case=Nom|Number=Plur	12	obj	_	GTtags=Pl,Nom
12	puʹtte	puuttâd	VERB	V	Mood=Ind|Number=Plur|Person=3|Tense=Past|VerbForm=Fin	5	conj	_	GTtags=Ind,Prt,Pl3|SpaceAfter=No
