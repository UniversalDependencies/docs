...
## Treebank Statistics: UD_Karelian-KKPP: POS Tags: `PUNCT`

There are 12 `PUNCT` lemmas (1%), 12 `PUNCT` types (1%) and 569 `PUNCT` tokens (18%).
...
The form / lemma ratio of `PUNCT` is 1.000000 (the average of all parts of speech is 1.497382).
