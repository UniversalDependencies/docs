...
1	Москуста	Моску	NOUN	N	Case=Ela|Definite=Ind|Number=Plur,Sing	2	obl	_	GTtags=Prop,SP,Ela,Indef
2	тумозонза	тумс	VERB	V	Case=Ill|Number=Plur,Sing|Number[psor]=Sing|Person[psor]=3|VerbForm=Vnoun	4	advcl	_	GTtags=NomAct,SP,Ill,PxSg3
3	Тишка	Тишка	NOUN	N	Case=Nom|Definite=Ind|Number=Sing	4	nsubj	_	GTtags=Prop,Sg,Nom,Indef
4	аноклазень	анокламс	VERB	V	Mood=Ind|Number[obj]=Plur|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt1,ScSg3,OcPl3
5	сембонь	сембе	PRON	Pron	Case=Gen|Definite=Ind|Number=Plur,Sing|PronType=Tot	4	obj	_	GTtags=SP,Gen,Indef|SpaceAfter=No
