---
layout: base
title:  'Statistics of flat:foreign in UD_Upper_Sorbian'
udver: '2'
---

## Treebank Statistics: UD_Upper_Sorbian: Relations: `flat:foreign`

This relation is a language-specific subtype of <tt><a href="hsb-dep-flat.html">flat</a></tt>.
...
The following 1 pairs of parts of speech are connected with `flat:foreign`: <tt><a href="hsb-pos-PROPN.html">PROPN</a></tt>-<tt><a href="hsb-pos-X.html">X</a></tt> (2; 100% instances).
