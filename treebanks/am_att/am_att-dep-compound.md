---
layout: base
title:  'Statistics of compound in UD_Amharic-ATT'
udver: '2'
---

## Treebank Statistics: UD_Amharic-ATT: Relations: `compound`

This relation is universal.
There are 1 language-specific subtypes of `compound`: <tt><a href="am_att-dep-compound-svc.html">compound:svc</a></tt>.

46 nodes (0%) are attached to their parents as `compound`.

43 instances of `compound` (93%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.08695652173913.

The following 6 pairs of parts of speech are connected with `compound`: <tt><a href="am_att-pos-NOUN.html">NOUN</a></tt>-<tt><a href="am_att-pos-NOUN.html">NOUN</a></tt> (25; 54% instances), <tt><a href="am_att-pos-VERB.html">VERB</a></tt>-<tt><a href="am_att-pos-VERB.html">VERB</a></tt> (17; 37% instances), <tt><a href="am_att-pos-ADV.html">ADV</a></tt>-<tt><a href="am_att-pos-ADV.html">ADV</a></tt> (1; 2% instances), <tt><a href="am_att-pos-INTJ.html">INTJ</a></tt>-<tt><a href="am_att-pos-VERB.html">VERB</a></tt> (1; 2% instances), <tt><a href="am_att-pos-PROPN.html">PROPN</a></tt>-<tt><a href="am_att-pos-ADJ.html">ADJ</a></tt> (1; 2% instances), <tt><a href="am_att-pos-PROPN.html">PROPN</a></tt>-<tt><a href="am_att-pos-ADP.html">ADP</a></tt> (1; 2% instances).
...
3	አስኬድ	አስኬድ	VERB	VERB	Mood=Ind|VerbForm=Fin|Voice=Cau	0	root	_	LTranslit='äsəkedə|Translit='äsəkedə
...
1	ከፊት	ከፊት	NOUN	NOUN	_	4	obl	_	LTranslit=käfitə|Translit=käfitə
...
4	ኣል	ኣል	VERB	VERB	Mood=Ind|VerbForm=Fin	3	compound	_	LTranslit='alə|Translit='alə
...
1	ፈረስ	ፈረስ	NOUN	NOUN	_	5	nsubj	_	LTranslit=färäsə|Translit=färäsə
