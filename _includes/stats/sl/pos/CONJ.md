...
There are 23 `CONJ` lemmas (1%), 23 `CONJ` types (0%) and 1631 `CONJ` tokens (6%).
Out of 16 observed tags, the rank of `CONJ` is: 13 in number of lemmas, 14 in number of types and 9 in number of tokens.

The 10 most frequent `CONJ` lemmas: <em>pa, in, ali, ampak, saj, tako, oziroma, torej, sicer, vendarle</em>

The 10 most frequent `CONJ` types:  <em>pa, in, ali, ampak, saj, tako, oziroma, torej, sicer, vendarle</em>
...
* <em>in</em>
  * [CONJ]() 414: <em>tako življenje je bilo prej <b>in</b> <b>in</b> sedaj je</em>
...
* <em>ali</em>
  * [CONJ]() 113: <em>saj še ne vem kam v avstralijo <b>ali</b> pa v ameriko</em>
  * [ADV]() 12: <em>torej paul david hewson … si ugibal <b>ali</b> veš kdo je to ?</em>
* <em>tako</em>
...
* <em>torej</em>
  * [CONJ]() 28: <em><b>torej</b> pač iz eee pač tozadevnega specialista no … mhm mhm mhm</em>
  * [ADV]() 11: <em>vode kaj <b>torej</b> tiste puščice pomenijo ?</em>
* <em>sicer</em>
...
* <em>zato</em>
  * [ADV]() 20: <em><b>zato</b> ker mestni avtobusi imajo zelo slab izkoristek</em>
  * [CONJ]() 6: <em>se zelo s [gap] <b>zato</b> je zelo slab izkoristek a ne</em>
* <em>a</em>
...
`CONJ` nodes are attached to their parents using 10 different relations: [sl-dep/cc]() (1069; 66% instances), [sl-dep/advmod]() (444; 27% instances), [sl-dep/mwe]() (43; 3% instances), [sl-dep/reparandum]() (20; 1% instances), [sl-dep/discourse]() (19; 1% instances), [sl-dep/root]() (19; 1% instances), [sl-dep/cc:preconj]() (13; 1% instances), [sl-dep/parataxis]() (2; 0% instances), [sl-dep/case]() (1; 0% instances), [sl-dep/parataxis:restart]() (1; 0% instances)
...
Children of `CONJ` nodes are attached using 10 different relations: [sl-dep/mwe]() (90; 60% instances), [sl-dep/reparandum]() (28; 19% instances), [sl-dep/discourse]() (13; 9% instances), [sl-dep/discourse:filler]() (7; 5% instances), [sl-dep/punct]() (5; 3% instances), [sl-dep/cc]() (2; 1% instances), [sl-dep/advcl]() (1; 1% instances), [sl-dep/mark]() (1; 1% instances), [sl-dep/parataxis]() (1; 1% instances), [sl-dep/vocative]() (1; 1% instances)
