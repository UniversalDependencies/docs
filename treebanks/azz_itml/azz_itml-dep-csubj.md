...
3	xtechtapowi	tapohui	VERB	_	Mood=Imp|Number[obj]=Plur|Number[subj]=Sing|Person[obj]=1|Person[subj]=2|Subcat=Tran|Tense=Pres|VerbForm=Fin	0	root	0:root	NormalizedForm=xtechtapowi
4	keniw	keni	ADV	_	_	3	ccomp	3:ccomp	NormalizedForm=keniw
5	n'	in	SCONJ	_	_	6	mark	6:mark	NormalizedForm=n'
6	kichihchiwah	chijchihua	VERB	_	Mood=Ind|Number[obj]=Sing|Number[subj]=Plur|Person[obj]=3|Person[subj]=3|Subcat=Tran|Tense=Pres|VerbForm=Fin	4	csubj	4:csubj	NormalizedForm=kichihchiwah
7	nen	nen	PRON	_	_	6	discourse	6:discourse	NormalizedForm=nen
8	tikihtowa	ijtohua	VERB	_	Mood=Ind|Number[obj]=Sing|Number[subj]=Sing|Person[obj]=3|Person[subj]=2|Subcat=Tran|Tense=Pres|VerbForm=Fin	7	acl:relcl	7:acl:relcl	NormalizedForm=tikihtowa
...
5	timonohnotstokeh	monojnotsa	VERB	_	Aspect=Prog|Mood=Ind|Number[subj]=Plur|Person[subj]=1|Subcat=Intr|Tense=Pres|VerbForm=Fin	2	csubj	2:csubj	NormalizedForm=timonohnotstokeh|SpaceAfter=No
