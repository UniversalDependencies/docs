...
Average distance between parent and child is 8.19230769230769.
...
1	2015	2015	NUM	CD	NumType=Card	2	nummod	_	SpaceAfter=No|Translit=2015|LTranslit=2015
2	년	_	NOUN	NNB	_	16	obl:tmod	_	Translit=.nyeon
...
6	6	6	NUM	CD	NumType=Card	7	nummod	_	SpaceAfter=No|Translit=6|LTranslit=6
7	%	%	NOUN	NNB	_	8	nsubj	_	Translit=%|LTranslit=%
8	상승한	_	NOUN	NN	_	15	acl:relcl	_	SpaceAfter=No|Translit=.sang.seung.han
9	2	2	NUM	CD	NumType=Card	10	nummod	_	SpaceAfter=No|Translit=2|LTranslit=2
10	천	_	NUM	CD	NumType=Card	12	nummod	_	SpaceAfter=No|Translit=.cheon
11	2	2	NUM	CD	NumType=Card	12	nummod	_	SpaceAfter=No|Translit=2|LTranslit=2
12	백	_	NUM	CD	NumType=Card	14	nummod	_	SpaceAfter=No|Translit=.baeg
13	1	1	NUM	CD	NumType=Card	14	nummod	_	SpaceAfter=No|Translit=1|LTranslit=1
14	십억	_	DET	DT	_	15	det	_	OrigDeprel=nummod|Translit=.sib.eog
15	달러를	달러	NOUN	NNB+CM	Case=Acc|Polite=Form	16	obj	_	MSeg=달러-를|Translit=.dal.reo.reul|LTranslit=.dal.reo
16	기록했다	_	NOUN	NN	_	0	root	_	SpaceAfter=No|Translit=.gi.rog.haess.da
...
1	이와	이	PRON	PRD+CM	Polite=Form	2	obl	_	MSeg=이-와|Translit=.i.wa|LTranslit=.i
2	관련해서	_	NOUN	NN	_	13	advcl	_	SpaceAfter=No|Translit=.gwan.ryeon.hae.seo
3	토요일	_	NOUN	NN	_	13	obl:tmod	_	Translit=.to.yo.il
4	모로코에서	모로코	PROPN	NNP+CM	Polite=Form	13	obl	_	MSeg=모로코-에서|Translit=.mo.ro.ko.e.seo|LTranslit=.mo.ro.ko
...
7	계획과	계획	NOUN	NN+CP	Polite=Form	9	obl	_	MSeg=계획-과|Translit=.gye.hoeg.gwa|LTranslit=.gye.hoeg
8	야심에	야심	NOUN	NN+CM	Polite=Form	7	conj	_	MSeg=야심-에|Translit=.ya.sim.e|LTranslit=.ya.sim
9	대해	_	VERB	VV	Form=Compl	12	advcl	_	Translit=.dae.hae
10	공개적으로	공개적	NOUN	NN+CM	Polite=Form	12	obl	_	MSeg=공개적-으로|Translit=.gong.gae.jeog.eu.ro|LTranslit=.gong.gae.jeog
11	문제를	문제	NOUN	NN+CM	Case=Acc|Polite=Form	12	obj	_	MSeg=문제-를|Translit=.mun.je.reul|LTranslit=.mun.je
12	제기하게	_	NOUN	NN	_	13	advcl	_	SpaceAfter=No|Translit=.je.gi.ha.ge
13	되었다	_	VERB	VV	Mood=Ind|Tense=Past|VerbForm=Fin	0	root	_	SpaceAfter=No|Translit=.doe.eoss.da
...
1	화요일	_	NOUN	NN	_	9	obl:tmod	_	Translit=.hwa.yo.il
...
3	역사상	_	NOUN	NN	_	4	compound	_	Translit=.yeog.sa.sang
4	최초의	최초	NOUN	NN+CM	Case=Gen|Polite=Form	6	nmod:poss	_	MSeg=최초-의|Translit=.choe.cho.yi|LTranslit=.choe.cho
5	여성	_	NOUN	NN	_	6	compound	_	Translit=.yeo.seong
6	대통령을	대통령	NOUN	NN+CM	Case=Acc|Polite=Form	7	obj	_	MSeg=대통령-을|Translit=.dae.tong.ryeong.eul|LTranslit=.dae.tong.ryeong
7	선출할	_	NOUN	NN	_	8	acl:relcl	_	SpaceAfter=No|Translit=.seon.chul.hal
8	수	_	NOUN	NNB	_	9	nsubj	_	Translit=.su
9	있었다	_	ADJ	JJ	Mood=Ind|Tense=Past|VerbForm=Fin	0	root	_	SpaceAfter=No|Translit=.iss.eoss.da
