...
~~~ sdparse
ROOT * Není problém v něčem jiném , třeba v tom , že je hodně prodavaček prostě levých ?
punct(Není-3, *-2)
root(ROOT-1, Není-3)
nsubj(Není-3, problém-4)
case:auxp(Není-3, v-5)
nmod(v-5, něčem-6)
amod(něčem-6, jiném-7)
punct(v-10, ,-8)
cc(v-10, třeba-9)
case:auxp(v-5, v-10)
appos(v-10, tom-11)
punct(že-13, ,-12)
mark:auxc(tom-11, že-13)
acl(že-13, je-14)
nsubj(je-14, hodně-15)
nmod(hodně-15, prodavaček-16)
advmod(je-14, prostě-17)
dep:pnom(je-14, levých-18)
root:auxk(ROOT-1, ?-19)
~~~
