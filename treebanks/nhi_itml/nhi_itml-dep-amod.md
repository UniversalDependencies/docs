---
layout: base
title:  'Statistics of amod in UD_Western_Sierra_Puebla_Nahuatl-ITML'
udver: '2'
---

## Treebank Statistics: UD_Western_Sierra_Puebla_Nahuatl-ITML: Relations: `amod`

This relation is universal.

41 nodes (0%) are attached to their parents as `amod`.

21 instances of `amod` (51%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.09756097560976.

The following 3 pairs of parts of speech are connected with `amod`: <tt><a href="nhi_itml-pos-NOUN.html">NOUN</a></tt>-<tt><a href="nhi_itml-pos-ADJ.html">ADJ</a></tt> (38; 93% instances), <tt><a href="nhi_itml-pos-PRON.html">PRON</a></tt>-<tt><a href="nhi_itml-pos-ADJ.html">ADJ</a></tt> (2; 5% instances), <tt><a href="nhi_itml-pos-PRON.html">PRON</a></tt>-<tt><a href="nhi_itml-pos-ADV.html">ADV</a></tt> (1; 2% instances).
...
3	kah	katki	VERB	_	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Subcat=Intr|Tense=Pres|VerbForm=Fin	0	root	0:root	NormalizedForm=kah|NormalizedLemma=katki
4	se	se	DET	_	_	5	det	5:det	NormalizedForm=se|NormalizedLemma=se
5	telpukatl	telpukatl	NOUN	_	Case=Abs|Number=Sing	3	nsubj	3:nsubj	SpaceAfter=No|NormalizedForm=telpukatl|NormalizedLemma=telpukatl
6	,	,	PUNCT	_	_	7	punct	7:punct	NormalizedForm=,|NormalizedLemma=,
7	ika	ka	NOUN	_	NounType=Relat|Number=Sing|Number[psor]=Sing|Person[psor]=3	3	obl	3:obl	NormalizedForm=ika|NormalizedLemma=ka
8	ibotas	bota	NOUN	_	Foreign=Yes|Gender=Fem|Number=Plur|Number[psor]=Sing|Person[psor]=3	7	nmod	7:nmod	NormalizedForm=ibotas|NormalizedLemma=bota
9	wihwinyeh	winyeh	ADJ	_	Number=Plur	8	amod	8:amod	SpaceAfter=No|NormalizedForm=wihwinyeh|NormalizedLemma=winyeh
...
3	cnanquilih	nanquilia	VERB	_	Aspect=Perf|Mood=Ind|Number[obj]=Sing|Number[subj]=Sing|Person[obj]=3|Person[subj]=3|Subcat=Tran|Tense=Past|VerbForm=Fin	0	root	0:root	_|NormalizedForm=knankilih|NormalizedLemma=nankilia
...
9	ixtlaocoya	tlaocoya	VERB	_	Mood=Imp|Number[subj]=Sing|Person[subj]=2|Subcat=Intr|VerbForm=Fin	3	parataxis	3:parataxis	SpaceAfter=No|NormalizedForm=ixtlaokoya|NormalizedLemma=tlaokoya
10	!	!	PUNCT	_	_	9	punct	9:punct	NormalizedForm=!|NormalizedLemma=!
11	Itlah	itlah	PRON	_	_	13	obj	13:obj	_|NormalizedForm=itlah|NormalizedLemma=itlah
12	cualli	cualli	ADV	_	_	11	amod	11:amod	NormalizedForm=kwali|NormalizedLemma=kwali
13	inchiuas	chiua	VERB	_	Mood=Ind|Number[subj]=Sing|Person[subj]=1|Subcat=Tran|Tense=Fut|VerbForm=Fin	9	parataxis	9:parataxis	NormalizedForm=inchiwas|NormalizedLemma=chiwa
14	ica	ca	NOUN	_	NounType=Relat|Number=Sing|Number[psor]=Sing|Person[psor]=3	13	obl	13:obl	NormalizedForm=ika|NormalizedLemma=ka
15	mopiluan	pilli	NOUN	_	Number=Plur|Number[psor]=Sing|Person[psor]=2	14	nmod	14:nmod	SpaceAfter=No|NormalizedForm=mopilwan|NormalizedLemma=pili
