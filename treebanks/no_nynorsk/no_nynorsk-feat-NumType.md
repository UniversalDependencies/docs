...
4048 tokens (1%) have a non-empty value of `NumType`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="no_nynorsk-pos-NUM.html">NUM</a></tt> (4048; 1% instances).

### `NUM`

4048 <tt><a href="no_nynorsk-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="no_nynorsk-feat-Number.html">Number</a></tt><tt>=Plur</tt> (3655; 90%).

`NUM` tokens may have the following values of `NumType`:

* `Card` (4048; 100% of non-empty `NumType`): <em>to, tre, 1, einaste, fire, eine, ti, fem, 20, seks</em>
