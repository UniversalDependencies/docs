...
3 <tt><a href="kpv_ikdp-pos-AUX.html">AUX</a></tt> tokens (6% of all `AUX` tokens) have a non-empty value of `Voice`.
...
* `EMPTY` (47): <em>вӧлі, из, абу, выйым, ог, вӧліс, оз, вӧв, лоас, он</em>
