...
2013 tokens (8%) have a non-empty value of `Mood`.
1048 types (19%) occur at least once with a non-empty value of `Mood`.
473 lemmas (12%) occur at least once with a non-empty value of `Mood`.
The feature is used with 2 part-of-speech tags: <tt><a href="gl_treegal-pos-VERB.html">VERB</a></tt> (1456; 6% instances), <tt><a href="gl_treegal-pos-AUX.html">AUX</a></tt> (557; 2% instances).

### `VERB`

1456 <tt><a href="gl_treegal-pos-VERB.html">VERB</a></tt> tokens (61% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="gl_treegal-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1456; 100%), <tt><a href="gl_treegal-feat-Person.html">Person</a></tt><tt>=3</tt> (1322; 91%), <tt><a href="gl_treegal-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1044; 72%), <tt><a href="gl_treegal-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (951; 65%).

`VERB` tokens may have the following values of `Mood`:

* `Cnd,Ind` (17; 1% of non-empty `Mood`): <em>gustaría, tería, Diría, Quedaría, correspondería, empobrecería, escluiría, faltaría, gostaría, instalaría</em>
* `Imp` (2; 0% of non-empty `Mood`): <em>Explica, Imaxina</em>
* `Ind` (1300; 89% of non-empty `Mood`): <em>hai, ten, teñen, fai, fixo, quere, considera, di, vén, dá</em>
* `Sub` (137; 9% of non-empty `Mood`): <em>sexa, fagan, diga, cumpran, faga, fixese, haxa, inclúa, mostren, pese</em>
* `EMPTY` (923): <em>facer, ter, ver, falar, dar, pasar, traballar, seguir, dicir, gañar</em>
...
557 <tt><a href="gl_treegal-pos-AUX.html">AUX</a></tt> tokens (91% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="gl_treegal-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (556; 100%), <tt><a href="gl_treegal-feat-Person.html">Person</a></tt><tt>=3</tt> (527; 95%), <tt><a href="gl_treegal-feat-Number.html">Number</a></tt><tt>=Sing</tt> (421; 76%), <tt><a href="gl_treegal-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (393; 71%).

`AUX` tokens may have the following values of `Mood`:

* `Cnd,Ind` (28; 5% of non-empty `Mood`): <em>sería, debería, podería, habería, poderían, tería, deberiamos</em>
* `Ind` (491; 88% of non-empty `Mood`): <em>é, foi, está, son, pode, están, era, vai, será, poden</em>
* `Sub` (38; 7% of non-empty `Mood`): <em>sexa, fose, sexan, estea, estivese, poidan, teña, estean, for, fosen</em>
* `EMPTY` (52): <em>ser, sendo, poder, estar, ter, acabar, ir, podendo, quedar, seren</em>
...
<tt>VERB --[<tt><a href="gl_treegal-dep-conj.html">conj</a></tt>]--> VERB</tt> (117; 77%),
<tt>VERB --[<tt><a href="gl_treegal-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (17; 59%),
