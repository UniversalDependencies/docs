...
## Treebank Statistics: UD_Latgalian-Cairo: Relations: `det`

This relation is universal.

6 nodes (4%) are attached to their parents as `det`.

6 instances of `det` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `det`: <tt><a href="ltg_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ltg_cairo-pos-PRON.html">PRON</a></tt> (6; 100% instances).
