...
5583 tokens (3%) have a non-empty value of `Case`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="nl_alpino-pos-PRON.html">PRON</a></tt> (5583; 3% instances).
...
* `Acc` (1433; 26% of non-empty `Case`): <em>zich, hem, me, ons, mij, elkaar, haar, hen, je, zichzelf</em>
...
<table>
  ...
  <tr><td><tt></tt></td><td><em>u</em></td><td><em>u</em></td><td><em>uwer</em></td></tr>
</table>

`Case` seems to be **lexical feature** of `PRON`. 94% lemmas (30) occur only with one value of `Case`.
