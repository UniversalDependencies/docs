...
5529 tokens (35%) have a non-empty value of `Number`.
2904 types (57%) occur at least once with a non-empty value of `Number`.
1343 lemmas (54%) occur at least once with a non-empty value of `Number`.
The feature is used with 12 part-of-speech tags: <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt> (3615; 23% instances), <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> (793; 5% instances), <tt><a href="myv_jr-pos-PROPN.html">PROPN</a></tt> (575; 4% instances), <tt><a href="myv_jr-pos-VERB.html">VERB</a></tt> (132; 1% instances), <tt><a href="myv_jr-pos-DET.html">DET</a></tt> (128; 1% instances), <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> (125; 1% instances), <tt><a href="myv_jr-pos-NUM.html">NUM</a></tt> (106; 1% instances), <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> (27; 0% instances), <tt><a href="myv_jr-pos-ADP.html">ADP</a></tt> (14; 0% instances), <tt><a href="myv_jr-pos-PART.html">PART</a></tt> (9; 0% instances), <tt><a href="myv_jr-pos-AUX.html">AUX</a></tt> (4; 0% instances), <tt><a href="myv_jr-pos-INTJ.html">INTJ</a></tt> (1; 0% instances).

### `NOUN`

3615 <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt> tokens (99% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="myv_jr-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (3028; 84%), <tt><a href="myv_jr-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (3028; 84%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (1867; 52%).
...
* `Plur,Sing` (1043; 29% of non-empty `Number`): <em>кудов, лангс, велень, каськас, ёнов, кудос, шкане, ёндо, вайгельсэ, мельс</em>
* `Sing` (1803; 50% of non-empty `Number`): <em>бандитэсь, прянзо, авазо, кенкшенть, ломань, ведь, тайганть, тев, тол, веленть</em>
* `EMPTY` (20): <em>Пазось, ялгай, шлямо, А., Валскень, П., Я., керяз, кр-кр, лелякай</em>
...
793 <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> tokens (94% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="myv_jr-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (708; 89%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (500; 63%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (469; 59%), <tt><a href="myv_jr-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (406; 51%).
...
* `Sing` (546; 69% of non-empty `Number`): <em>сон, весе, те, мон, сонзэ, сонсь, тензэ, мезе, тон, кона</em>
* `EMPTY` (51): <em>эсь, тень, весенень, весень, кинь, мельганзо, сень, вейкест-вейкест, ки, мельгаст</em>
...
* `EMPTY` (2739): <em>кармась, мерсь, лиссь, кармасть, мольсь, совась, ютась, ашти, неяви, саизе</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Tra</tt>|<tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt>|<tt><a href="myv_jr-feat-Derivation.html">Derivation</a></tt><tt>=NomAg</tt>|<tt><a href="myv_jr-feat-Valency.html">Valency</a></tt><tt>=1</tt></tt></td><td><em>молицякс</em></td><td></td><td></td></tr>
</table>
...
128 <tt><a href="myv_jr-pos-DET.html">DET</a></tt> tokens (88% of all `DET` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (89; 70%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (87; 68%), <tt><a href="myv_jr-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (73; 57%).

`DET` tokens may have the following values of `Number`:

* `Plur` (8; 6% of non-empty `Number`): <em>ламотне, лиятне, лият, лиятнень, некень</em>
* `Plur,Sing` (7; 5% of non-empty `Number`): <em>конань, ламонь, аламнеде, лиякс, лиянь</em>
* `Sing` (113; 88% of non-empty `Number`): <em>эрьва, те, се, лия, истямо, кона, ламо, аламо, зяро, зярыя</em>
* `EMPTY` (18): <em>эсь, не, Ламо, Нона, Эрьва, вейте-вейте, секе</em>

<table>
  <tr><th>Paradigm <i>лия</i></th><th><tt>Plur,Sing</tt></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Def</tt></tt></td><td></td><td></td><td><em>лиятнень</em></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt></tt></td><td><em>лиянь</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Def</tt></tt></td><td></td><td></td><td><em>лиятне</em></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt></tt></td><td></td><td><em>лия</em></td><td><em>лият</em></td></tr>
</table>

### `ADJ`

125 <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> tokens (22% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (95; 76%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (83; 66%).
...
* `Sing` (78; 62% of non-empty `Number`): <em>кодамо, васень, омбоце, рижой, пешксе, валдо, васенце, кадовикс, кондямо, меельце</em>
...
106 <tt><a href="myv_jr-pos-NUM.html">NUM</a></tt> tokens (63% of all `NUM` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NUM` and `Number` co-occurred: <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (97; 92%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (93; 88%), <tt><a href="myv_jr-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (69; 65%).

`NUM` tokens may have the following values of `Number`:

* `Plur` (10; 9% of non-empty `Number`): <em>вейкеть, Веенстнэнь, Кавтотне, Колмосят, ветесят, колмоценстнэ, тысщат</em>
* `Plur,Sing` (7; 7% of non-empty `Number`): <em>колоньгеменьшка, сядошка, кавтов, кеменьшка, сядодо</em>
* `Sing` (89; 84% of non-empty `Number`): <em>вейке, кавто, колмо, вейкесь, ниле, омбоцесь, Комсь, Кавто-колмо, Комсьсисемге, Сисемь</em>
...
27 <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> tokens (2% of all `ADV` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADV` and `Number` co-occurred: <tt><a href="myv_jr-feat-AdvType.html">AdvType</a></tt><tt>=EMPTY</tt> (23; 85%), <tt><a href="myv_jr-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (23; 85%).

`ADV` tokens may have the following values of `Number`:

* `Plur,Sing` (8; 30% of non-empty `Number`): <em>аламодо, алкуксонь, вакска, ваксстост, колмоцеде, ламос, мейлес, парынестэ</em>
* `Sing` (19; 70% of non-empty `Number`): <em>истямо, ламо, мекев, секе, Кодашка, алкукскак, байтяк, истякак, теске</em>
* `EMPTY` (1331): <em>ансяк, кода, пек, истя, уш, ней, мейле, седе, прок, яла</em>
...
`Number` seems to be **lexical feature** of `ADV`. 94% lemmas (15) occur only with one value of `Number`.
...
* `EMPTY` (521): <em>марто, лангс, лангсо, мельга, кис, ёнов, ланга, эйстэ, ланкс, мартонзо</em>
...
The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="myv_jr-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="myv_jr-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (4; 100%), <tt><a href="myv_jr-feat-Valency.html">Valency</a></tt><tt>=EMPTY</tt> (4; 100%).
...
<tt>NOUN --[<tt><a href="myv_jr-dep-conj.html">conj</a></tt>]--> NOUN</tt> (104; 79%),
<tt>NOUN --[<tt><a href="myv_jr-dep-compound.html">compound</a></tt>]--> NOUN</tt> (95; 62%),
<tt>NOUN --[<tt><a href="myv_jr-dep-nmod.html">nmod</a></tt>]--> PRON</tt> (23; 53%),
<tt>NOUN --[<tt><a href="myv_jr-dep-appos.html">appos</a></tt>]--> NOUN</tt> (18; 78%),
<tt>NOUN --[<tt><a href="myv_jr-dep-obl.html">obl</a></tt>]--> NOUN</tt> (18; 55%),
...
<tt>PROPN --[<tt><a href="myv_jr-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (10; 53%),
