...
2	эзь	а	AUX	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Polarity=Neg|Tense=Past|VerbForm=Fin|VerbType=Aux	3	aux	_	CGdephead=#2-&gt;0|CGdeprel=@FAUX|CGdephead=#2-&gt;0|CGdeprel=@FAUX|GTtags=Aux,Neg,Ind,Prt1,ScSg3
...
10	чийсь	чиемс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	5	conj	_	CGdephead=#10-&gt;2|CGdeprel=@FMV|CGdephead=#10-&gt;2|CGdeprel=@FMV|GTtags=Ind,Prt1,ScSg3|SpaceAfter=No
...
4	удыть	удомс	VERB	V	Mood=Ind|Number[subj]=Plur|Person[subj]=3|Tense=Pres|VerbForm=Fin	0	root	_	CGdephead=#4-&gt;0|CGdeprel=@FMV|GTtags=IV,Ind,Prs,ScPl3
...
8	тнеяк	ось	PRON	Pron	Case=Nom|Clitic=Add|Definite=Def|Number=Plur|PronType=Art	4	nsubj	_	_
...
4	содавсь	содавомс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=IV,Ind,Prt1,ScSg3
