---
layout: base
title:  'Statistics of SCONJ in UD_Ottoman_Turkish-BOUN'
udver: '2'
---
...
`SCONJ` nodes are attached to their parents using 1 different relations: <tt><a href="ota_boun-dep-mark.html">mark</a></tt> (25; 100% instances)

Parents of `SCONJ` nodes belong to 4 different parts of speech: <tt><a href="ota_boun-pos-VERB.html">VERB</a></tt> (14; 56% instances), <tt><a href="ota_boun-pos-NOUN.html">NOUN</a></tt> (9; 36% instances), <tt><a href="ota_boun-pos-ADJ.html">ADJ</a></tt> (1; 4% instances), <tt><a href="ota_boun-pos-PRON.html">PRON</a></tt> (1; 4% instances)
