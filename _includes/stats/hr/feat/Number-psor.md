...
The most frequent other feature values with which `DET` and `Number[psor]` co-occurred: <tt><a href="PronType.html">PronType</a>=Prs</tt> (754; 100%), <tt><a href="Poss.html">Poss</a>=Yes</tt> (754; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (575; 76%), <tt><a href="Person.html">Person</a>=3</tt> (502; 67%).
