...
Average distance between parent and child is 1.72739541160594.
...
1	Norton	Norton	PROPN	NNP	Number=Sing	4	nsubj	_	Entity=(person-1)
...
6	Protector	Protector	PROPN	NNP	Number=Sing	4	obj	_	Entity=(abstract-103
7	of	of	ADP	IN	_	8	case	_	_
8	Mexico	Mexico	PROPN	NNP	Number=Sing	6	nmod	_	Entity=(place-11)abstract-103)|SpaceAfter=No
9	"	''	PUNCT	''	_	6	punct	_	_
10	to	to	ADP	IN	_	12	case	_	_
11	this	this	DET	DT	Number=Sing|PronType=Dem	12	det	_	Entity=(abstract-89
12	title	title	NOUN	NN	Number=Sing	4	obl	_	Entity=abstract-89)|SpaceAfter=No
...
1	They	they	PRON	PRP	Case=Nom|Number=Plur|Person=3|PronType=Prs	2	nsubj	_	Entity=(person-117)
2	say	say	VERB	VBP	Mood=Ind|Tense=Pres|VerbForm=Fin	0	root	_	_
3	you	you	PRON	PRP	Case=Nom|Person=2|PronType=Prs	6	nsubj	_	Entity=(person-118)
...
1	The	the	DET	DT	Definite=Def|PronType=Art	2	det	_	Entity=(event-116
2	rustling	rustling	NOUN	NN	Number=Sing	6	nsubj	_	Entity=event-116)
...
6	mice	mouse	NOUN	NNS	Number=Plur	0	root	_	Entity=(animal-121)|SpaceAfter=No
