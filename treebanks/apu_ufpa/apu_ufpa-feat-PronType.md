...
3 <tt><a href="apu_ufpa-pos-ADV.html">ADV</a></tt> tokens (5% of all `ADV` tokens) have a non-empty value of `PronType`.

`ADV` tokens may have the following values of `PronType`:

* `Int` (3; 100% of non-empty `PronType`): <em>Nanhikiripa, Natuku, Natukupa</em>
* `EMPTY` (58): <em>apaka, inhinhiã, atuku, kaiãũpuku, Kutxi, wai, watxa, Ikanapiriãsaaky, Ipinanyra, Kitxaka</em>
