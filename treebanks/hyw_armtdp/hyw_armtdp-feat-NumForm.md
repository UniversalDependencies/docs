---
layout: base
title:  'Statistics of NumForm in UD_Western_Armenian-ArmTDP'
udver: '2'
---

## Treebank Statistics: UD_Western_Armenian-ArmTDP: Features: `NumForm`
...
282 <tt><a href="hyw_armtdp-pos-ADJ.html">ADJ</a></tt> tokens (3% of all `ADJ` tokens) have a non-empty value of `NumForm`.

The most frequent other feature values with which `ADJ` and `NumForm` co-occurred: <tt><a href="hyw_armtdp-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (172; 61%).

`ADJ` tokens may have the following values of `NumForm`:

* `Armenian` (64; 23% of non-empty `NumForm`): <em>Բ, Ա, Գ, ԺԹ, Ե, Դ, Զ, Ը, ի, Է</em>
* `Combi` (50; 18% of non-empty `NumForm`): <em>44-օրեայ, 113-րդ, 20-րդ, 44օրեայ, 106-րդ, 12-ամեայ, 12-րդ, 1860-ական, 18ամեայ, 1950-ական</em>
* `Word` (168; 60% of non-empty `NumForm`): <em>առաջին, երկրորդ, երրորդ, առջի, չորրորդ, եօթանասուննոց, քսաներորդ, առաջի, երկուքուկէսնոց, եօթանասուներորդ</em>

`NumForm` seems to be **lexical feature** of `ADJ`. 100% lemmas (60) occur only with one value of `NumForm`.

## Relations with Agreement in `NumForm`

The 10 most frequent relations where parent and child node agree in `NumForm`:
<tt>NUM --[<tt><a href="hyw_armtdp-dep-flat.html">flat</a></tt>]--> NUM</tt> (50; 100%),
<tt>NUM --[<tt><a href="hyw_armtdp-dep-flat-range.html">flat:range</a></tt>]--> NUM</tt> (48; 100%),
<tt>NUM --[<tt><a href="hyw_armtdp-dep-conj.html">conj</a></tt>]--> NUM</tt> (12; 100%),
