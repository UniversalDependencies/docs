---
layout: base
title:  'Statistics of compound in UD_Slovak'
udver: '2'
---

## Treebank Statistics: UD_Slovak: Relations: `compound`
...
The following 1 pairs of parts of speech are connected with `compound`: <tt><a href="sk-pos-VERB.html">VERB</a></tt>-<tt><a href="sk-pos-VERB.html">VERB</a></tt> (5; 100% instances).
