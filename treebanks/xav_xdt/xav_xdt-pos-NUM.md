...
The form / lemma ratio of `NUM` is 1.000000 (the average of all parts of speech is 1.294461).
...
`NUM` nodes are attached to their parents using 3 different relations: <tt><a href="xav_xdt-dep-nummod.html">nummod</a></tt> (8; 62% instances), <tt><a href="xav_xdt-dep-dep.html">dep</a></tt> (3; 23% instances), <tt><a href="xav_xdt-dep-nsubj.html">nsubj</a></tt> (2; 15% instances)

Parents of `NUM` nodes belong to 3 different parts of speech: <tt><a href="xav_xdt-pos-VERB.html">VERB</a></tt> (9; 69% instances), <tt><a href="xav_xdt-pos-NOUN.html">NOUN</a></tt> (3; 23% instances), <tt><a href="xav_xdt-pos-PRON.html">PRON</a></tt> (1; 8% instances)
