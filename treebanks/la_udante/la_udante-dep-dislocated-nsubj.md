...
There are also 2 other language-specific subtypes of `dislocated`: <tt><a href="la_udante-dep-dislocated-csubj.html">dislocated:csubj</a></tt>, <tt><a href="la_udante-dep-dislocated-obj.html">dislocated:obj</a></tt>.
...
2	quoque	quoque	ADV	r	Form=Emp	11	discourse	_	SpaceAfter=No
...
12	preesse	praesum	VERB	va5fp	Aspect=Imp|InflClass=LatAnom|InflClass[nominal]=Ind|Tense=Pres|VerbForm=Inf|Voice=Act	11	ccomp	_	SpaceAfter=No
...
21	poetati	poetor	VERB	vd1irp3	Aspect=Perf|Case=Nom|Degree=Pos|Gender=Masc|InflClass=LatA|InflClass[nominal]=IndEurO|Number=Plur|Tense=Past|VerbForm=Part|Voice=Pass	17	acl:relcl	_	_
...
43	initi	innitor	VERB	vd3fp	Aspect=Imp|InflClass=LatX|InflClass[nominal]=Ind|Tense=Pres|VerbForm=Inf|Voice=Pass	42	csubj:pass	_	_
...
51	inspicientibus	inspicio	VERB	va3pppmd	Aspect=Imp|Case=Dat|Degree=Pos|Gender=Masc|InflClass=LatI2|InflClass[nominal]=IndEurI|Number=Plur|Tense=Pres|VerbForm=Part|Voice=Act	52	obl:arg	_	_
...
2	quicunque	quicumque	DET	prismn	Case=Nom|Compound=Yes|Form=Emp|Gender=Masc|InflClass=LatPron|Number=Sing|PronType=Rel	23	dislocated:nsubj	_	_
...
13	esse	sum	AUX	va5fp	Aspect=Imp|InflClass=LatAnom|InflClass[nominal]=Ind|Tense=Pres|VerbForm=Inf	11	cop	_	_
