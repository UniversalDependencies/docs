...
There are 33 `PRON` lemmas (0%), 148 `PRON` types (1%) and 14105 `PRON` tokens (8%).
...
The form / lemma ratio of `PRON` is 4.484848 (the average of all parts of speech is 1.973661).
