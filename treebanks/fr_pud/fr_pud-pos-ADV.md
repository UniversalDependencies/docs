...
There are 180 `ADV` lemmas (4%), 186 `ADV` types (3%) and 1001 `ADV` tokens (4%).
...
The form / lemma ratio of `ADV` is 1.033333 (the average of all parts of speech is 1.299853).
