---
layout: base
title:  'Statistics of root in UD_Albanian-STAF'
udver: '2'
---

## Treebank Statistics: UD_Albanian-STAF: Relations: `root`

This relation is universal.

200 nodes (6%) are attached to their parents as `root`.

200 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 4.68.

The following 6 pairs of parts of speech are connected with `root`: -<tt><a href="sq_staf-pos-VERB.html">VERB</a></tt> (158; 79% instances), -<tt><a href="sq_staf-pos-NOUN.html">NOUN</a></tt> (23; 12% instances), -<tt><a href="sq_staf-pos-ADJ.html">ADJ</a></tt> (10; 5% instances), -<tt><a href="sq_staf-pos-PRON.html">PRON</a></tt> (4; 2% instances), -<tt><a href="sq_staf-pos-ADV.html">ADV</a></tt> (3; 2% instances), -<tt><a href="sq_staf-pos-PROPN.html">PROPN</a></tt> (2; 1% instances).
