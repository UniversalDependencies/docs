...
The feature is used with 3 part-of-speech tags: <tt><a href="ca_ancora-pos-NUM.html">NUM</a></tt> (6082; 1% instances), <tt><a href="ca_ancora-pos-NOUN.html">NOUN</a></tt> (832; 0% instances), <tt><a href="ca_ancora-pos-SYM.html">SYM</a></tt> (806; 0% instances).

### `NUM`

6082 <tt><a href="ca_ancora-pos-NUM.html">NUM</a></tt> tokens (66% of all `NUM` tokens) have a non-empty value of `NumForm`.

The most frequent other feature values with which `NUM` and `NumForm` co-occurred: <tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (6082; 100%), <tt><a href="ca_ancora-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (6082; 100%), <tt><a href="ca_ancora-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (4053; 67%).
...
The most frequent other feature values with which `SYM` and `NumForm` co-occurred: <tt><a href="ca_ancora-feat-NumType.html">NumType</a></tt><tt>=Frac</tt> (793; 98%).
...
<tt>NUM --[<tt><a href="ca_ancora-dep-conj.html">conj</a></tt>]--> NUM</tt> (200; 98%),
...
<tt>NUM --[<tt><a href="ca_ancora-dep-nummod.html">nummod</a></tt>]--> NUM</tt> (14; 78%),
