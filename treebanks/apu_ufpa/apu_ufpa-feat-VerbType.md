...
* `Vido` (15; 100% of non-empty `VerbType`): <em>sary, kaiãury, Kuaxary, Kunakamunyry, Naãtyru, Waikai, awaika, kasunakyry, kaxinhiry, mitxiry</em>

`VerbType` seems to be **lexical feature** of `VERB`. 100% lemmas (10) occur only with one value of `VerbType`.

### `NOUN`

3 <tt><a href="apu_ufpa-pos-NOUN.html">NOUN</a></tt> tokens (1% of all `NOUN` tokens) have a non-empty value of `VerbType`.

The most frequent other feature values with which `NOUN` and `VerbType` co-occurred: <tt><a href="apu_ufpa-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="apu_ufpa-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="apu_ufpa-feat-Gender-psor.html">Gender[psor]</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="apu_ufpa-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="apu_ufpa-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="apu_ufpa-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="apu_ufpa-feat-Possessed.html">Possessed</a></tt><tt>=EMPTY</tt> (3; 100%).

`NOUN` tokens may have the following values of `VerbType`:

* `Vido` (3; 100% of non-empty `VerbType`): <em>myramanery, Kataparaxinery</em>
