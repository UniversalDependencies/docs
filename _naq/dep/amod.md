...
An `amod` dependent may have its own modifiers (e.g., _kaise ǁkhurisa goman_ "very wild cows") but the dependent should not be a clause. If it is a clause, then [acl]() should be used.
