...
4	psaníčko	psaníčko	NOUN	NNNS4-----A----	Case=Acc|Gender=Neut|Number=Sing	1	obl:arg	1:obl:arg:na:acc	_
...
7	pocit	pocit	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	6	obj	6:obj	SpaceAfter=No
...
13	je	být	AUX	VB-S---3P-AA---	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	16	cop	16:cop	_
...
16	napsáno	napsaný	ADJ	VsNS------AP---	Degree=Pos|Gender=Neut|Number=Sing|Polarity=Pos|Variant=Short|VerbForm=Part|Voice=Pass	10	ccomp	10:ccomp	SpaceAfter=No|LDeriv=napsat
...
10	zbraní	zbraň	NOUN	NNFP2-----A----	Case=Gen|Gender=Fem|Number=Plur	8	obl:arg	8:obl:arg:gen	SpaceAfter=No
...
2	není	být	AUX	VB-S---3P-NA---	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Polarity=Neg|Tense=Pres|VerbForm=Fin|Voice=Act	4	cop	4:cop	_
3	v	v	ADP	RR--6----------	AdpType=Prep|Case=Loc	4	case	4:case	_
4	tom	ten	DET	PDNS6----------	Case=Loc|Gender=Neut|Number=Sing|PronType=Dem	0	root	0:root	SpaceAfter=No
5	,	,	PUNCT	Z:-------------	_	8	punct	8:punct	_
...
12	leta	rok	NOUN	NNNP4-----A---6	Case=Acc|Gender=Neut|Number=Plur|Style=Coll	10	obj	10:obj	SpaceAfter=No
