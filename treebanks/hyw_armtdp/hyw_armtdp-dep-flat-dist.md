---
layout: base
title:  'Statistics of flat:dist in UD_Western_Armenian-ArmTDP'
udver: '2'
---
...
The following 1 pairs of parts of speech are connected with `flat:dist`: <tt><a href="hyw_armtdp-pos-NUM.html">NUM</a></tt>-<tt><a href="hyw_armtdp-pos-NUM.html">NUM</a></tt> (3; 100% instances).
...
13	մէկ	մէկ	NUM	_	NumForm=Word|NumType=Card	11	flat:dist	_	Translit=mēk|LTranslit=mēk
14	մարդ	մարդ	NOUN	_	Animacy=Hum|Case=Nom|Definite=Ind|Number=Sing	16	nsubj	_	Translit=mard|LTranslit=mard
...
24	կ՚	կը	AUX	_	Aspect=Imp|Mood=Ind	25	aux	_	Translit=k,|LTranslit=kë|SpaceAfter=No
25	երթային	երթալ	VERB	_	Aspect=Prosp|Mood=Sub|Number=Plur|Person=3|Polarity=Pos|Subcat=Intr|Tense=Imp|VerbForm=Fin|Voice=Mid	0	root	_	Translit=ert’ayin|LTranslit=ert’al
26	նկուղ	նկուղ	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	25	obl	_	Translit=nkowġ|LTranslit=nkowġ
27	եւ	եւ	CCONJ	_	_	30	cc	_	Translit=ew|LTranslit=ew
28	յիմարապահներուն	յիմարապահ	NOUN	_	Animacy=Hum|Case=Dat|Definite=Def|Number=Plur	30	iobj	_	Translit=yimarapahnerown|LTranslit=yimarapah
29	կը	կը	AUX	_	Aspect=Imp|Mood=Ind	30	aux	_	Translit=kë|LTranslit=kë
30	պատուիրէին	պատուիրել	VERB	_	Aspect=Prosp|Mood=Sub|Number=Plur|Person=3|Polarity=Pos|Subcat=Tran|Tense=Imp|VerbForm=Fin|Voice=Act	25	conj	_	Translit=patowirēin|LTranslit=patowirel
31	«	«	PUNCT	_	_	32	punct	_	Translit=«|LTranslit=«|SpaceAfter=No
32	սատկեցնել	սատկեցնել	VERB	_	Polarity=Pos|Subcat=Tran|VerbForm=Inf|Voice=Act	30	ccomp	_	Translit=satkec’nel|LTranslit=satkec’nel
33	այդ	այդ	DET	_	Deixis=Med|PronType=Dem	34	det	_	Translit=ayd|LTranslit=ayd
34	շուները	շուն	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Def|Number=Plur	32	obj	_	Translit=šownerë|LTranslit=šown|SpaceAfter=No
35	»	»	PUNCT	_	_	32	punct	_	Translit=»|LTranslit=»|SpaceAfter=No
36	։	։	PUNCT	_	_	25	punct	_	Translit=.|LTranslit=.
