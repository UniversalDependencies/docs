...
9221 tokens (2%) have a non-empty value of `AdpType`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="et_edt-pos-ADP.html">ADP</a></tt> (9220; 2% instances), <tt><a href="et_edt-pos-ADV.html">ADV</a></tt> (1; 0% instances).

### `ADP`

9220 <tt><a href="et_edt-pos-ADP.html">ADP</a></tt> tokens (99% of all `ADP` tokens) have a non-empty value of `AdpType`.

`ADP` tokens may have the following values of `AdpType`:

* `Post` (7246; 79% of non-empty `AdpType`): <em>eest, kohta, vahel, järgi, jooksul, vastu, korral, puhul, all, pärast</em>
* `Prep` (1974; 21% of non-empty `AdpType`): <em>üle, pärast, enne, koos, ilma, läbi, mööda, alates, peale, kuni</em>
