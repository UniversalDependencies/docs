---
layout: base
title:  'Statistics of fixed in UD_Azerbaijani-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Azerbaijani-TueCL: Relations: `fixed`
...
The following 1 pairs of parts of speech are connected with `fixed`: <tt><a href="az_tuecl-pos-CCONJ.html">CCONJ</a></tt>-<tt><a href="az_tuecl-pos-ADV.html">ADV</a></tt> (1; 100% instances).
