...
44524 tokens (10%) have a non-empty value of `Person`.
5712 types (13%) occur at least once with a non-empty value of `Person`.
2189 lemmas (6%) occur at least once with a non-empty value of `Person`.
The feature is used with 7 part-of-speech tags: <tt><a href="es_gsd-pos-VERB.html">VERB</a></tt> (20408; 5% instances), <tt><a href="es_gsd-pos-PRON.html">PRON</a></tt> (9984; 2% instances), <tt><a href="es_gsd-pos-AUX.html">AUX</a></tt> (9616; 2% instances), <tt><a href="es_gsd-pos-DET.html">DET</a></tt> (4361; 1% instances), <tt><a href="es_gsd-pos-X.html">X</a></tt> (90; 0% instances), <tt><a href="es_gsd-pos-SYM.html">SYM</a></tt> (62; 0% instances), <tt><a href="es_gsd-pos-INTJ.html">INTJ</a></tt> (3; 0% instances).

### `VERB`

20408 <tt><a href="es_gsd-pos-VERB.html">VERB</a></tt> tokens (56% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="es_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (20408; 100%), <tt><a href="es_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (20406; 100%), <tt><a href="es_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (19023; 93%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (15164; 74%), <tt><a href="es_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (10227; 50%).
...
* `3` (19649; 96% of non-empty `Person`): <em>tiene, es, encuentra, hay, hace, tenía, tienen, era, fue, tuvo</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="es_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="es_gsd-feat-Tense.html">Tense</a></tt><tt>=Imp</tt>|<tt><a href="es_gsd-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td></td><td></td><td><em>tenia</em></td></tr>
...
`Person` seems to be **lexical feature** of `VERB`. 92% lemmas (1938) occur only with one value of `Person`.

### `PRON`

9984 <tt><a href="es_gsd-pos-PRON.html">PRON</a></tt> tokens (71% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="es_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (9980; 100%), <tt><a href="es_gsd-feat-PrepCase.html">PrepCase</a></tt><tt>=Npr</tt> (8234; 82%), <tt><a href="es_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (7107; 71%), <tt><a href="es_gsd-feat-Case.html">Case</a></tt><tt>=Acc,Dat</tt> (6069; 61%), <tt><a href="es_gsd-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (5392; 54%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (5294; 53%).

`PRON` tokens may have the following values of `Person`:

* `1` (746; 7% of non-empty `Person`): <em>me, nos, yo, nosotros, mí, mi, I, conmigo, nuestro, nuestros</em>
* `2` (257; 3% of non-empty `Person`): <em>te, os, tú, usted, vosotros, ti, ustedes, You, contigo</em>
* `3` (8981; 90% of non-empty `Person`): <em>se, lo, le, la, los, les, él, ellos, ella, las</em>
* `EMPTY` (4034): <em>que, uno, cual, una, quien, esto, todo, tanto, algo, nada</em>
...
9616 <tt><a href="es_gsd-pos-AUX.html">AUX</a></tt> tokens (89% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="es_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9611; 100%), <tt><a href="es_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9104; 95%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7290; 76%), <tt><a href="es_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (6047; 63%).
...
* `3` (9295; 97% of non-empty `Person`): <em>es, fue, ha, son, eran, era, han, está, puede, fueron</em>
* `EMPTY` (1162): <em>ser, sido, siendo, haber, poder, estar, esta, fuera, estado, podido</em>
...
* `EMPTY` (56521): <em>el, la, los, un, las, una, este, esta, otras, otros</em>
...
90 <tt><a href="es_gsd-pos-X.html">X</a></tt> tokens (5% of all `X` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `X` and `Person` co-occurred: <tt><a href="es_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (88; 98%), <tt><a href="es_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (76; 84%).

`X` tokens may have the following values of `Person`:

* `1` (13; 14% of non-empty `Person`): <em>'s, mi, hoc, lobster, ne, of, què, sulo, to</em>
* `2` (11; 12% of non-empty `Person`): <em>'s, des, £, s, t, tu, x</em>
* `3` (66; 73% of non-empty `Person`): <em>'s, es, and, oa, of, Fauve, Kage, League, Reguleses, Tsurugi</em>
* `EMPTY` (1798): <em>ex, hab, ya, etc., C, 's, x, i, mm, C.</em>
...
`Person` seems to be **lexical feature** of `X`. 96% lemmas (64) occur only with one value of `Person`.
...
<tt>VERB --[<tt><a href="es_gsd-dep-iobj.html">iobj</a></tt>]--> PRON</tt> (4568; 69%),
<tt>VERB --[<tt><a href="es_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1720; 66%),
<tt>VERB --[<tt><a href="es_gsd-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (573; 51%),
<tt>VERB --[<tt><a href="es_gsd-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (435; 55%),
<tt>PRON --[<tt><a href="es_gsd-dep-acl-relcl.html">acl:relcl</a></tt>]--> VERB</tt> (221; 58%),
...
<tt>AUX --[<tt><a href="es_gsd-dep-iobj.html">iobj</a></tt>]--> PRON</tt> (4; 100%).
