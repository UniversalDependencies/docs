...
There are 61 `PRON` lemmas (0%), 114 `PRON` types (0%) and 7467 `PRON` tokens (3%).
...
The form / lemma ratio of `PRON` is 1.868852 (the average of all parts of speech is 1.414631).
