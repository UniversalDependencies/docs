...
1	Diya	dî	NOUN	n	Case=Con|Definite=Def|Gender=Fem|Number=Sing	5	nsubj	_	_
2	me	em	PRON	prn	Case=Obl|Gender=Fem,Masc|Number=Plur|Person=1|PronType=Prs	1	nmod:poss	_	_
3	em	em	PRON	prn	Case=Nom|Gender=Fem,Masc|Number=Plur|Person=1|PronType=Prs	5	obj	_	_
4	cêwik	cêwik	NOUN	n	Case=Nom|Definite=Def|Gender=Fem|Number=Sing	5	nmod	_	_
5	anî bûn	anîn	VERB	vblex	Mood=Ind|Number=Plur|Person=1|Tense=Pqp|VerbForm=Fin	0	root	_	SpaceAfter=No
...
# visual-style 13 6 obj	color:blue
