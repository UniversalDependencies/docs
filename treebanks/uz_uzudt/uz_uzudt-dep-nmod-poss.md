...
189 nodes (2%) are attached to their parents as `nmod:poss`.
...
1	sen	sen	PRON	P	Case=Nom|Number=Sing|Person=2|PronType=Prs	4	nsubj	_	_
2	hayotning	hayot	NOUN	N	_	4	nmod:poss	_	_
3	aks	aks	NOUN	N	_	4	amod	_	_
...
1	ularning	u	PRON	P	Case=Gen|Number=Plur|Person=3|PronType=Prs	2	nmod:poss	_	_
2	orasida	ora	NOUN	N	Case=Loc|Number[psor]=Plur,Sing|Person[psor]=3	6	nmod	_	_
3	oʻn	oʻn	NUM	M	Case=Nom|NumType=Ord	4	compound	_	_
