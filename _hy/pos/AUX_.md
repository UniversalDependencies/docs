...
Note that in Armenian copulas are also tagged `AUX` and the definition of copula sentences has been extended to location-existentials (_Արտակն արդեն մեքենայի մեջ էր_/_Artakn arden mek’enayi meǰ ēr_ “Artak was already in the car”). Hence almost all occurrences of _եմ_/_em_ and _լինել (լինեմ)_/_linel (linem)_ should be now tagged `AUX`. Only pure existentials without location have a non-auxiliary _լինել_/_linel_ and _կամ_/_kam_ which should be tagged `VERB` (_Այն <b>եղել</b> է ու <b>կա</b> որպես հուշ։_/_Ayn <b>eġel</b> ē ow <b>ka</b> orpes howš_ “It <b>has been</b> and <b>is</b> as a memory.”).
