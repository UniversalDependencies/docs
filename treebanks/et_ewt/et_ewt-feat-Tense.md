...
13331 tokens (15%) have a non-empty value of `Tense`.
3684 types (18%) occur at least once with a non-empty value of `Tense`.
1444 lemmas (12%) occur at least once with a non-empty value of `Tense`.
The feature is used with 4 part-of-speech tags: <tt><a href="et_ewt-pos-VERB.html">VERB</a></tt> (7935; 9% instances), <tt><a href="et_ewt-pos-AUX.html">AUX</a></tt> (4516; 5% instances), <tt><a href="et_ewt-pos-ADJ.html">ADJ</a></tt> (825; 1% instances), <tt><a href="et_ewt-pos-NOUN.html">NOUN</a></tt> (55; 0% instances).

### `VERB`

7935 <tt><a href="et_ewt-pos-VERB.html">VERB</a></tt> tokens (73% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (7181; 90%), <tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (7025; 89%), <tt><a href="et_ewt-feat-Connegative.html">Connegative</a></tt><tt>=EMPTY</tt> (6829; 86%), <tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (6227; 78%), <tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4164; 52%).

`VERB` tokens may have the following values of `Tense`:

* `Past` (2504; 32% of non-empty `Tense`): <em>saanud, tuli, läks, sain, ütles, oli, sai, tulnud, kirjutasin, läinud</em>
* `Pres` (5431; 68% of non-empty `Tense`): <em>on, tuleb, saab, tea, läheb, pole, saa, arvan, tahaks, teeb</em>
* `EMPTY` (2946): <em>teha, saada, minna, teada, olemas, öelda, panna, osta, näha, võtta</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="et_ewt-feat-Connegative.html">Connegative</a></tt><tt>=Yes</tt>|<tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-Typo.html">Typo</a></tt><tt>=Yes</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt>|<tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt></tt></td><td><em>sa, sma</em></td><td><em>saand</em></td></tr>
  <tr><td><tt><tt><a href="et_ewt-feat-Connegative.html">Connegative</a></tt><tt>=Yes</tt>|<tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt>|<tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt></tt></td><td><em>saa, saagi</em></td><td><em>saanud</em></td></tr>
  ...
  <tr><td><tt><tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="et_ewt-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt>|<tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt></tt></td><td><em>saan</em></td><td><em>sain, Saingi</em></td></tr>
  ...
  <tr><td><tt><tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="et_ewt-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt>|<tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt></tt></td><td><em>saavad</em></td><td><em>said</em></td></tr>
...
4516 <tt><a href="et_ewt-pos-AUX.html">AUX</a></tt> tokens (74% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (4514; 100%), <tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (4446; 98%), <tt><a href="et_ewt-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (4133; 92%), <tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3860; 85%), <tt><a href="et_ewt-feat-Person.html">Person</a></tt><tt>=3</tt> (2786; 62%), <tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2781; 62%).

`AUX` tokens may have the following values of `Tense`:

* `Past` (607; 13% of non-empty `Tense`): <em>oli, olnud, olid, sai, olin, polnud, pidi, tundus, pidin, võinud</em>
* `Pres` (3909; 87% of non-empty `Tense`): <em>on, pole, oleks, ole, olen, võib, peaks, saab, võiks, peab</em>
* `EMPTY` (1627): <em>ei, olla, olema, olles, mai, olemagi, 2ra, do, e, olemaks</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Cnd</tt>|<tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="et_ewt-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>oleksid</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="et_ewt-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>oled, oledki, ole</em></td><td><em>olid</em></td></tr>
  ...
  <tr><td><tt><tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="et_ewt-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>on, ongi, ole, ons</em></td><td><em>oli, oligi</em></td></tr>
  <tr><td><tt><tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>olen</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="et_ewt-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>olete, oletegi</em></td><td><em>olite</em></td></tr>
...
* `EMPTY` (18017): <em>asi, aasta, teema, aru, auto, inimesed, inimene, aastat, raha, aega</em>
...
<tt>VERB --[<tt><a href="et_ewt-dep-conj.html">conj</a></tt>]--> VERB</tt> (1077; 74%),
<tt>VERB --[<tt><a href="et_ewt-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (91; 53%),
<tt>VERB --[<tt><a href="et_ewt-dep-discourse.html">discourse</a></tt>]--> VERB</tt> (14; 88%),
<tt>AUX --[<tt><a href="et_ewt-dep-conj.html">conj</a></tt>]--> VERB</tt> (2; 67%),
...
<tt>ADJ --[<tt><a href="et_ewt-dep-dep.html">dep</a></tt>]--> AUX</tt> (1; 100%),
