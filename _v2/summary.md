...
2. The guidelines for tags are modified in three cases:
    1. The use of `AUX` is extended from auxiliary verbs in a narrow sense to also include copula verbs and nonverbal TAME particles (tense, aspect, mood, evidentiality, and sometimes also voice or polarity particles).
