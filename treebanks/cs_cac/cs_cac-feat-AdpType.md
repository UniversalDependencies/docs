...
48466 tokens (10%) have a non-empty value of `AdpType`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="cs_cac-pos-ADP.html">ADP</a></tt> (48466; 10% instances).

### `ADP`

48466 <tt><a href="cs_cac-pos-ADP.html">ADP</a></tt> tokens (100% of all `ADP` tokens) have a non-empty value of `AdpType`.

`ADP` tokens may have the following values of `AdpType`:

* `Comprep` (111; 0% of non-empty `AdpType`): <em>vzhledem, nehledě</em>
* `Prep` (44523; 92% of non-empty `AdpType`): <em>v, na, s, z, o, k, pro, do, za, při</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="cs_cac-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="cs_cac-feat-ExtPos.html">ExtPos</a></tt><tt>=ADP</tt></tt></td><td></td><td><em>ve</em></td></tr>
  <tr><td><tt><tt><a href="cs_cac-feat-Case.html">Case</a></tt><tt>=Loc</tt></tt></td><td><em>v</em></td><td><em>ve</em></td></tr>
  <tr><td><tt><tt><a href="cs_cac-feat-Case.html">Case</a></tt><tt>=Loc</tt>|<tt><a href="cs_cac-feat-ExtPos.html">ExtPos</a></tt><tt>=ADP</tt></tt></td><td><em>v</em></td><td><em>ve</em></td></tr>
</table>

## Relations with Agreement in `AdpType`

The 10 most frequent relations where parent and child node agree in `AdpType`:
<tt>ADP --[<tt><a href="cs_cac-dep-fixed.html">fixed</a></tt>]--> ADP</tt> (268; 54%),
