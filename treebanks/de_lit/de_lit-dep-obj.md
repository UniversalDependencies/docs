...
1630 nodes (4%) are attached to their parents as `obj`.

1148 instances of `obj` (70%) are right-to-left (child precedes parent).
Average distance between parent and child is 3.75460122699387.
