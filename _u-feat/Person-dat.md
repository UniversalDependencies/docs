...
layout: feature
title: 'Person[dat]'
shortdef: 'person agreement with the dative argument'
udver: '2'
---
...
### <a name="1">`1`</a>: first person dative argument

Examples: [eu] _dakarkio<b>gu</b>_ `Person[erg]=1`

### <a name="2">`2`</a>: second person dative argument

Examples: [eu] _dakarkio<b>zu</b>_ `Person[erg]=2`

### <a name="3">`3`</a>: third person dative argument
