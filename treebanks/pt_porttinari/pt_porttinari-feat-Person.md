...
19143 tokens (11%) have a non-empty value of `Person`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="pt_porttinari-pos-VERB.html">VERB</a></tt> (10721; 6% instances), <tt><a href="pt_porttinari-pos-AUX.html">AUX</a></tt> (4246; 3% instances), <tt><a href="pt_porttinari-pos-PRON.html">PRON</a></tt> (3164; 2% instances), <tt><a href="pt_porttinari-pos-DET.html">DET</a></tt> (1012; 1% instances).

### `VERB`

10721 <tt><a href="pt_porttinari-pos-VERB.html">VERB</a></tt> tokens (63% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="pt_porttinari-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (10721; 100%), <tt><a href="pt_porttinari-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (10721; 100%), <tt><a href="pt_porttinari-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (10569; 99%), <tt><a href="pt_porttinari-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9781; 91%), <tt><a href="pt_porttinari-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8433; 79%), <tt><a href="pt_porttinari-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5514; 51%).

`VERB` tokens may have the following values of `Person`:

* `1` (988; 9% of non-empty `Person`): <em>consigo, temos, tenho, quero, acho, sei, vejo, posso, vi, queremos</em>
* `2` (9; 0% of non-empty `Person`): <em>beija, olha, Experimenta, Para, Taca, mexe, quebra</em>
* `3` (9724; 91% of non-empty `Person`): <em>diz, tem, há, disse, pode, afirma, deve, teve, afirmou, faz</em>
* `EMPTY` (6383): <em>fazer, ter, ver, dar, feito, partir, dizer, ficar, chegar, entender</em>
...
3164 <tt><a href="pt_porttinari-pos-PRON.html">PRON</a></tt> tokens (50% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="pt_porttinari-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (2511; 79%), <tt><a href="pt_porttinari-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1910; 60%).
...
* `3` (2559; 81% of non-empty `Person`): <em>se, o, ele, ela, eles, a, os, elas, as, lo</em>
* `EMPTY` (3204): <em>que, isso, quem, tudo, nada, algo, ninguém, qual, outro, um</em>
...
<tt>VERB --[<tt><a href="pt_porttinari-dep-conj.html">conj</a></tt>]--> VERB</tt> (767; 76%),
<tt>VERB --[<tt><a href="pt_porttinari-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (433; 54%),
<tt>VERB --[<tt><a href="pt_porttinari-dep-expl.html">expl</a></tt>]--> PRON</tt> (426; 78%),
<tt>VERB --[<tt><a href="pt_porttinari-dep-ccomp-speech.html">ccomp:speech</a></tt>]--> VERB</tt> (269; 56%),
<tt>VERB --[<tt><a href="pt_porttinari-dep-expl-impers.html">expl:impers</a></tt>]--> PRON</tt> (149; 93%),
<tt>VERB --[<tt><a href="pt_porttinari-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (124; 55%),
<tt>PRON --[<tt><a href="pt_porttinari-dep-cop.html">cop</a></tt>]--> AUX</tt> (79; 52%),
<tt>VERB --[<tt><a href="pt_porttinari-dep-discourse.html">discourse</a></tt>]--> AUX</tt> (61; 71%),
<tt>PRON --[<tt><a href="pt_porttinari-dep-conj.html">conj</a></tt>]--> PRON</tt> (7; 88%),
<tt>VERB --[<tt><a href="pt_porttinari-dep-nsubj-outer.html">nsubj:outer</a></tt>]--> PRON</tt> (7; 70%).
