---
layout: base
title:  'Statistics of obl in UD_Swedish_Sign_Language-SSLC'
udver: '2'
---

## Treebank Statistics: UD_Swedish_Sign_Language-SSLC: Relations: `obl`

This relation is universal.

120 nodes (7%) are attached to their parents as `obl`.
...
1	FORM(YYb)+BESKRIVNING@p	_	VERB	VBAV	_	5	obl	_	_
2	FORM(Yb)@p@hd	_	VERB	VBAV	_	1	conj	_	_
