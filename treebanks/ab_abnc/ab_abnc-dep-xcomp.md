...
6	рырымҭеит	а́-ҭара	VERB	V_Dyn_Tr_Fin_Aor_Neg_S:3Pl_DO:3_DO:Ad_IO:3Pl	Dyn=Yes|Mood=Ind|Number[io]=Plur|Number[subj]=Plur|Person[io]=3|Person[obj]=3|Person[subj]=3|Polarity=Neg|Subcat=Tran|Tense=Aor|VerbForm=Fin	0	root	_	LMSeg:а́-ҭа-ра|SpaceAfter=No
