...
2220 types (11%) occur at least once with a non-empty value of `Person`.
796 lemmas (7%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="et_ewt-pos-VERB.html">VERB</a></tt> (5202; 6% instances), <tt><a href="et_ewt-pos-AUX.html">AUX</a></tt> (3284; 4% instances), <tt><a href="et_ewt-pos-PRON.html">PRON</a></tt> (2593; 3% instances).

### `VERB`

5202 <tt><a href="et_ewt-pos-VERB.html">VERB</a></tt> tokens (48% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (5202; 100%), <tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (5193; 100%), <tt><a href="et_ewt-feat-Connegative.html">Connegative</a></tt><tt>=EMPTY</tt> (5182; 100%), <tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (4774; 92%), <tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4133; 79%), <tt><a href="et_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (3884; 75%).

`VERB` tokens may have the following values of `Person`:

* `1` (1259; 24% of non-empty `Person`): <em>sain, arvan, tean, lähen, kirjutasin, saan, panin, loodan, palun, usun</em>
* `2` (722; 14% of non-empty `Person`): <em>saad, tead, teed, vaata, mine, tahad, mõtle, arvad, hakkad, minge</em>
* `3` (3221; 62% of non-empty `Person`): <em>on, tuleb, saab, läheb, tuli, läks, teeb, teab, jääb, ütles</em>
* `EMPTY` (5672): <em>teha, saada, tea, pole, minna, saa, saanud, teada, olemas, öelda</em>
...
3284 <tt><a href="et_ewt-pos-AUX.html">AUX</a></tt> tokens (53% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="et_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (3284; 100%), <tt><a href="et_ewt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (3282; 100%), <tt><a href="et_ewt-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (3259; 99%), <tt><a href="et_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3183; 97%), <tt><a href="et_ewt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (2803; 85%), <tt><a href="et_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2743; 84%).
...
* `3` (2791; 85% of non-empty `Person`): <em>on, oli, võib, saab, peab, olid, ongi, sai, pidi, võivad</em>
* `EMPTY` (2861): <em>ei, pole, oleks, ole, peaks, olla, olema, olnud, võiks, saa</em>
...
* `EMPTY` (3999): <em>see, mis, seda, oma, kes, midagi, mida, keegi, kõik, selle</em>
