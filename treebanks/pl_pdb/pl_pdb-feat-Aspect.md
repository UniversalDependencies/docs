...
57056 tokens (16%) have a non-empty value of `Aspect`.
20857 types (35%) occur at least once with a non-empty value of `Aspect`.
5840 lemmas (21%) occur at least once with a non-empty value of `Aspect`.
The feature is used with 4 part-of-speech tags: <tt><a href="pl_pdb-pos-VERB.html">VERB</a></tt> (39049; 11% instances), <tt><a href="pl_pdb-pos-AUX.html">AUX</a></tt> (7308; 2% instances), <tt><a href="pl_pdb-pos-ADJ.html">ADJ</a></tt> (6789; 2% instances), <tt><a href="pl_pdb-pos-NOUN.html">NOUN</a></tt> (3910; 1% instances).

### `VERB`

39049 <tt><a href="pl_pdb-pos-VERB.html">VERB</a></tt> tokens (98% of all `VERB` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `VERB` and `Aspect` co-occurred: <tt><a href="pl_pdb-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (38927; 100%), <tt><a href="pl_pdb-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (32215; 82%), <tt><a href="pl_pdb-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (31623; 81%), <tt><a href="pl_pdb-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (29825; 76%), <tt><a href="pl_pdb-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (24780; 63%), <tt><a href="pl_pdb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (24084; 62%), <tt><a href="pl_pdb-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (21103; 54%).

`VERB` tokens may have the following values of `Aspect`:

* `Imp` (25005; 64% of non-empty `Aspect`): <em>ma, może, jest, stoi, mówi, siedzi, miał, było, należy, mam</em>
* `Perf` (14044; 36% of non-empty `Aspect`): <em>powiedział, powiedzieć, zrobić, stało, udało, zrobił, zaczął, znaleźć, powiedziała, doszło</em>
* `EMPTY` (695): <em>można, trzeba, wiadomo, widać, warto, oto, wolno, słychać, stać, szkoda</em>
...
`Aspect` seems to be **lexical feature** of `VERB`. 99% lemmas (4850) occur only with one value of `Aspect`.

### `AUX`

7308 <tt><a href="pl_pdb-pos-AUX.html">AUX</a></tt> tokens (83% of all `AUX` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `AUX` and `Aspect` co-occurred: <tt><a href="pl_pdb-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (5982; 82%), <tt><a href="pl_pdb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5256; 72%), <tt><a href="pl_pdb-feat-Clitic.html">Clitic</a></tt><tt>=EMPTY</tt> (5163; 71%), <tt><a href="pl_pdb-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (5163; 71%), <tt><a href="pl_pdb-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (4781; 65%), <tt><a href="pl_pdb-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (4772; 65%), <tt><a href="pl_pdb-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (4179; 57%).

`AUX` tokens may have the following values of `Aspect`:

* `Imp` (6832; 93% of non-empty `Aspect`): <em>jest, em, będzie, m, są, śmy, był, być, było, będą</em>
* `Perf` (476; 7% of non-empty `Aspect`): <em>został, została, zostanie, zostać, zostały, zostaną, zostało, zostali, zostacie, zostanę</em>
* `EMPTY` (1463): <em>to, by, niech, niechaj, Niechby, niechże</em>
...
6789 <tt><a href="pl_pdb-pos-ADJ.html">ADJ</a></tt> tokens (19% of all `ADJ` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `ADJ` and `Aspect` co-occurred: <tt><a href="pl_pdb-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (6789; 100%), <tt><a href="pl_pdb-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (6789; 100%), <tt><a href="pl_pdb-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (6697; 99%), <tt><a href="pl_pdb-feat-Voice.html">Voice</a></tt><tt>=Pass</tt> (4824; 71%), <tt><a href="pl_pdb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3925; 58%), <tt><a href="pl_pdb-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (3564; 52%).

`ADJ` tokens may have the following values of `Aspect`:

* `Imp` (3166; 47% of non-empty `Aspect`): <em>dotyczące, dotyczących, dotyczącego, dotyczący, prowadzone, stojący, dotyczącej, lecącej, stosowane, widziana</em>
* `Perf` (3623; 53% of non-empty `Aspect`): <em>związane, ubrany, określonych, związanych, przeznaczone, przedstawione, przygotowane, ubrana, przyjęta, określone</em>
...
`Aspect` seems to be **lexical feature** of `ADJ`. 99% lemmas (2119) occur only with one value of `Aspect`.

### `NOUN`

3910 <tt><a href="pl_pdb-pos-NOUN.html">NOUN</a></tt> tokens (4% of all `NOUN` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `NOUN` and `Aspect` co-occurred: <tt><a href="pl_pdb-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (3910; 100%), <tt><a href="pl_pdb-feat-Gender.html">Gender</a></tt><tt>=Neut</tt> (3910; 100%), <tt><a href="pl_pdb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3847; 98%).

`NOUN` tokens may have the following values of `Aspect`:

* `Imp` (1806; 46% of non-empty `Aspect`): <em>stosowania, głosowania, stosowanie, działania, tworzenia, prowadzenia, wykonywania, czynienia, pływania, tworzenie</em>
* `Perf` (2104; 54% of non-empty `Aspect`): <em>przyjęcie, wprowadzenia, wykorzystania, zapewnienia, osiągnięcia, przyjęcia, zastosowania, wprowadzenie, zapewnienie, wykonania</em>
...
<tt>VERB --[<tt><a href="pl_pdb-dep-conj.html">conj</a></tt>]--> VERB</tt> (4135; 81%),
<tt>VERB --[<tt><a href="pl_pdb-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (1882; 62%),
<tt>ADJ --[<tt><a href="pl_pdb-dep-aux-pass.html">aux:pass</a></tt>]--> AUX</tt> (902; 64%),
<tt>VERB --[<tt><a href="pl_pdb-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (770; 54%),
<tt>VERB --[<tt><a href="pl_pdb-dep-parataxis-obj.html">parataxis:obj</a></tt>]--> VERB</tt> (713; 54%),
<tt>VERB --[<tt><a href="pl_pdb-dep-aux.html">aux</a></tt>]--> AUX</tt> (633; 82%),
<tt>VERB --[<tt><a href="pl_pdb-dep-csubj.html">csubj</a></tt>]--> VERB</tt> (90; 63%),
<tt>VERB --[<tt><a href="pl_pdb-dep-parataxis-insert.html">parataxis:insert</a></tt>]--> VERB</tt> (66; 52%),
<tt>VERB --[<tt><a href="pl_pdb-dep-advcl-relcl.html">advcl:relcl</a></tt>]--> VERB</tt> (42; 64%),
<tt>VERB --[<tt><a href="pl_pdb-dep-obl-cmpr.html">obl:cmpr</a></tt>]--> VERB</tt> (37; 62%).
