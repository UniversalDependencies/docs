...
There are 7154 `PROPN` lemmas (35%), 7189 `PROPN` types (25%) and 18761 `PROPN` tokens (8%).
...
The form / lemma ratio of `PROPN` is 1.004892 (the average of all parts of speech is 1.423132).
