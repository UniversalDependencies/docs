...
This value marks dependent first or second part of a compound adposition. This word cannot occur alone. Not all compound prepositions contain words marked `Comadp`. Many compound prepositions consist of a normal prepositions and a noun (e.g. _ի սեր_ “for the love of”, _ի պատիվ_ “in honor of” ). Sometimes there are just two words, the second/first one is normal adposition and the first/second one is a secondary adposition (etymologically some other part of speech, but it has been frozen as a preposition).
