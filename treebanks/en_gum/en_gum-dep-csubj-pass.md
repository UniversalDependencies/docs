...
1	It	it	PRON	PRP	Case=Acc|Gender=Neut|Number=Sing|Person=3|PronType=Prs	3	expl	3:expl	Discourse=elaboration:10->9:0|Entity=(event-18-new-1-cata)
2	is	be	AUX	VBZ	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	3	aux:pass	3:aux:pass	_
3	recommend	recommed	VERB	VBN	Tense=Past|Typo=Yes|VerbForm=Part|Voice=Pass	0	root	0:root	XML=<sic></sic>
4	that	that	SCONJ	IN	_	6	mark	6:mark	_
5	you	you	PRON	PRP	Case=Nom|Number=Sing|Person=2|PronType=Prs	6	nsubj	6:nsubj	Entity=(event-18-acc:com-2-coref(person-5-giv:inact-1-ana)
6	use	use	VERB	VBP	Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin	3	csubj:pass	3:csubj:pass	_
7	short	short	ADJ	JJ	Degree=Pos	8	amod	8:amod	Entity=(abstract-19-new-2-coref
8	words	word	NOUN	NNS	Number=Plur	6	obj	6:obj	Entity=19)18)
9	since	since	SCONJ	IN	_	13	mark	13:mark	Discourse=justify:11->10:0
10	they	they	PRON	PRP	Case=Nom|Number=Plur|Person=3|PronType=Prs	13	nsubj:pass	13:nsubj:pass	Entity=(abstract-19-giv:act-1-ana)
...
1	It	it	PRON	PRP	Case=Acc|Gender=Neut|Number=Sing|Person=3|PronType=Prs	4	expl	4:expl	Discourse=elaboration:86->83:1|Entity=(abstract-111-new-1-cata)
...
6	he	he	PRON	PRP	Case=Nom|Gender=Masc|Number=Sing|Person=3|PronType=Prs	15	nsubj	15:nsubj	Entity=(abstract-111-acc:com-6,10-disc(person-103-giv:act-1-ana)
...
10	du	du	PROPN	NNP	Number=Sing	15	nmod:poss	15:nmod:poss	Entity=(person-87-giv:inact-2,6-coref(person-66-giv:inact-1,2-coref
...
16	"	''	PUNCT	''	_	15	punct	15:punct	Entity=87)|XML=</q>
17	at	at	ADP	IN	_	19	case	19:case	_
18	the	the	DET	DT	Definite=Def|PronType=Art	19	det	19:det	Entity=(time-112-acc:com-2-sgl
19	time	time	NOUN	NN	Number=Sing	15	nmod	15:nmod:at	Entity=112)111)
20	(	(	PUNCT	-LRB-	_	23	punct	23:punct	Discourse=background:87->86:0|SpaceAfter=No
21	she	she	PRON	PRP	Case=Nom|Gender=Fem|Number=Sing|Person=3|PronType=Prs	23	nsubj	23:nsubj	Entity=(person-66-giv:act-1-ana)
...
24	someone	someone	NOUN	NN	Number=Sing	23	obj	23:obj	Entity=(person-113-new-1-sgl
...
28	but	but	CCONJ	CC	_	34	cc	34:cc	Discourse=contrast_m:88->86:1
29	no	no	DET	DT	Polarity=Neg	31	det	31:det	_
30	clear	clear	ADJ	JJ	Degree=Pos	31	amod	31:amod	Entity=(abstract-114-new-2-sgl
...
35	supporting	support	VERB	VBG	VerbForm=Ger	31	acl	31:acl	Discourse=elaboration:89->88:0
36	this	this	DET	DT	Number=Sing|PronType=Dem	37	det	37:det	Entity=(abstract-111-giv:act-2-coref
