...
There are 594 `VERB` lemmas (33%), 1236 `VERB` types (47%) and 1776 `VERB` tokens (18%).
...
The form / lemma ratio of `VERB` is 2.080808 (the average of all parts of speech is 1.458263).

The 1st highest number of forms (36) was observed with the lemma “piya”: <em>Ikpiya, Ixpiya, cequimpiya, cpiayaya, cpiyacan, cpiyaya, cpiyayah, ikpia, ikpiyaj, inpiya, itpiya, kimpiyaya, kipixtok, kipiya, kipiyaya, kpixkej, kpiyakan, namechpix, nicpiya, nicpiyaya, nikpix, nikpiyaya, nipiya, nipiyaya, niquimpiya, quimpiya, quimpiyaya, quinpiyaya, sekipiya, ticpixtoque, ticpiyah, tikpiya, tipiyah, tiquimpiyayah, tiquinpiyaz, titlapiyayah</em>.
