...
69970 tokens (6%) have a non-empty value of `Person`.
8033 types (7%) occur at least once with a non-empty value of `Person`.
3123 lemmas (7%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="ru_syntagrus-pos-VERB.html">VERB</a></tt> (40303; 4% instances), <tt><a href="ru_syntagrus-pos-PRON.html">PRON</a></tt> (27585; 2% instances), <tt><a href="ru_syntagrus-pos-AUX.html">AUX</a></tt> (2082; 0% instances).

### `VERB`

40303 <tt><a href="ru_syntagrus-pos-VERB.html">VERB</a></tt> tokens (33% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="ru_syntagrus-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (40303; 100%), <tt><a href="ru_syntagrus-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (40303; 100%), <tt><a href="ru_syntagrus-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (40303; 100%), <tt><a href="ru_syntagrus-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (39293; 97%), <tt><a href="ru_syntagrus-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (34150; 85%), <tt><a href="ru_syntagrus-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (33597; 83%), <tt><a href="ru_syntagrus-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (29633; 74%), <tt><a href="ru_syntagrus-feat-Number.html">Number</a></tt><tt>=Sing</tt> (25988; 64%).
...
* `3` (34761; 86% of non-empty `Person`): <em>может, есть, нет, могут, является, говорит, стоит, идет, имеет, говорят</em>
* `EMPTY` (83415): <em>было, стал, быть, сказал, стало, стали, сделать, сказать, делать, мог</em>
...
27585 <tt><a href="ru_syntagrus-pos-PRON.html">PRON</a></tt> tokens (53% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="ru_syntagrus-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (27585; 100%), <tt><a href="ru_syntagrus-feat-Number.html">Number</a></tt><tt>=Sing</tt> (17113; 62%), <tt><a href="ru_syntagrus-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (14803; 54%).

`PRON` tokens may have the following values of `Person`:

* `1` (7311; 27% of non-empty `Person`): <em>я, мы, нас, мне, меня, нам, нами, мной, мною, мно-ой</em>
* `2` (1592; 6% of non-empty `Person`): <em>вы, ты, вас, вам, тебя, тебе, вами, тобой, тобою</em>
* `3` (18682; 68% of non-empty `Person`): <em>он, его, их, они, ее, она, них, ему, него, им</em>
* `EMPTY` (24204): <em>это, что, которые, то, все, того, том, который, этом, кто</em>
...
* `EMPTY` (6062): <em>было, был, были, была, быть, будучи, бывшие, бывший, бывшем</em>
...
<tt>VERB --[<tt><a href="ru_syntagrus-dep-conj.html">conj</a></tt>]--> VERB</tt> (4032; 69%),
<tt>PRON --[<tt><a href="ru_syntagrus-dep-conj.html">conj</a></tt>]--> PRON</tt> (20; 54%),
<tt>VERB --[<tt><a href="ru_syntagrus-dep-appos.html">appos</a></tt>]--> VERB</tt> (15; 100%),
<tt>AUX --[<tt><a href="ru_syntagrus-dep-cop.html">cop</a></tt>]--> AUX</tt> (5; 100%),
<tt>PRON --[<tt><a href="ru_syntagrus-dep-parataxis.html">parataxis</a></tt>]--> PRON</tt> (5; 56%),
<tt>AUX --[<tt><a href="ru_syntagrus-dep-aux.html">aux</a></tt>]--> AUX</tt> (2; 100%),
<tt>VERB --[<tt><a href="ru_syntagrus-dep-flat-name.html">flat:name</a></tt>]--> VERB</tt> (2; 100%),
<tt>AUX --[<tt><a href="ru_syntagrus-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (1; 100%),
<tt>AUX --[<tt><a href="ru_syntagrus-dep-aux-pass.html">aux:pass</a></tt>]--> AUX</tt> (1; 100%),
