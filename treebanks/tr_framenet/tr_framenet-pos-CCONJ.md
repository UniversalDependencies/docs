...
There are 17 `CCONJ` lemmas (0%), 17 `CCONJ` types (0%) and 260 `CCONJ` tokens (1%).
Out of 15 observed tags, the rank of `CCONJ` is: 9 in number of lemmas, 9 in number of types and 9 in number of tokens.

The 10 most frequent `CCONJ` lemmas: <em>de, ve, da, ama, ne, yoksa, fakat, ancak, ile, hatta</em>
...
* <em>ancak</em>
  * <tt><a href="tr_framenet-pos-CCONJ.html">CCONJ</a></tt> 2: <em>On bin lirayı <b>ancak</b> denkleştirebildik .</em>
  * <tt><a href="tr_framenet-pos-ADV.html">ADV</a></tt> 1: <em>Bu işi <b>ancak</b> sen bitirirsin .</em>
* <em>ile</em>
