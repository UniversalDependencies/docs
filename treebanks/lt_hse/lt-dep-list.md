---
layout: base
title:  'Statistics of list in UD_Lithuanian'
udver: '2'
---

## Treebank Statistics: UD_Lithuanian: Relations: `list`
...
The following 1 pairs of parts of speech are connected with `list`: <tt><a href="lt-pos-PROPN.html">PROPN</a></tt>-<tt><a href="lt-pos-PROPN.html">PROPN</a></tt> (2; 100% instances).
