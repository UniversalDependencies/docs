---
layout: base
title:  'Statistics of nmod:dat in UD_Kurmanji'
udver: '2'
---

## Treebank Statistics: UD_Kurmanji: Relations: `nmod:dat`

This relation is a language-specific subtype of <tt><a href="kmr-dep-nmod.html">nmod</a></tt>.
There are also 1 other language-specific subtypes of `nmod`: <tt><a href="kmr-dep-nmod-poss.html">nmod:poss</a></tt>.

114 nodes (1%) are attached to their parents as `nmod:dat`.

113 instances of `nmod:dat` (99%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.08771929824561.

The following 5 pairs of parts of speech are connected with `nmod:dat`: <tt><a href="kmr-pos-VERB.html">VERB</a></tt>-<tt><a href="kmr-pos-NOUN.html">NOUN</a></tt> (78; 68% instances), <tt><a href="kmr-pos-VERB.html">VERB</a></tt>-<tt><a href="kmr-pos-PRON.html">PRON</a></tt> (16; 14% instances), <tt><a href="kmr-pos-VERB.html">VERB</a></tt>-<tt><a href="kmr-pos-PROPN.html">PROPN</a></tt> (16; 14% instances), <tt><a href="kmr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="kmr-pos-NOUN.html">NOUN</a></tt> (3; 3% instances), <tt><a href="kmr-pos-DET.html">DET</a></tt>-<tt><a href="kmr-pos-NOUN.html">NOUN</a></tt> (1; 1% instances).
...
# visual-style 3 4 nmod:dat	color:blue
1	Şerlok	Şerlok	PROPN	np	Case=Obl|Gender=Masc|Number=Sing	3	nsubj	_	_
2	Holmes	Holmes	PROPN	np	Case=Obl|Gender=Masc|Number=Sing	1	flat	_	_
3	got	gotin	VERB	vblex	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	_
4	banû	banû	NOUN	n	Case=Nom|Definite=Def|Gender=Fem|Number=Sing	3	nmod:dat	_	_
5	Stonêrê	Stonêr	PROPN	np	Case=Con|Gender=Masc|Number=Sing	4	flat	_	SpaceAfter=No
6	:	:	PUNCT	sent	_	13	punct	_	_
7	We	hûn	PRON	prn	Case=Obl|Gender=Fem,Masc|Number=Plur|Person=2|PronType=Prs	13	nsubj	_	_
...
# visual-style 10 11 nmod:dat	color:blue
...
11	Stokmoranê	Stokmoran	PROPN	np	Case=Obl|Definite=Def|Gender=Fem|Number=Sing	10	nmod:dat	_	SpaceAfter=No
