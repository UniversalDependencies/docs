...
3 instances of `obl:arg` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `obl:arg`: <tt><a href="ps_sikaram-pos-VERB.html">VERB</a></tt>-<tt><a href="ps_sikaram-pos-NOUN.html">NOUN</a></tt> (3; 100% instances).
...
19	ژوند	ژوند	NOUN	_	Case=Acc|Gender=Masc|Number=Sing	21	nmod	_	Translit=žwand|LTranslit=žwand|Gloss=life
