...
1	1	1	NUM	CD	NumForm=Digit|NumType=Card	2	nummod	2:nummod	Discourse=restatement-partial:51->45:3:sem-synym-323,367-_+sem-rpt-325-326,365-366-_|Entity=(46-time-giv:inact-sssss-cf2-2-coref
2	week	week	NOUN	NN	Number=Sing	0	root	0:root	Entity=46)
3	asshole	asshole	NOUN	NN	Number=Sing	2	vocative	2:vocative	Entity=(1-person-giv:act-sssss-cf1*-1-coref)|MSeg=ass-hole|SpaceAfter=No
...
3	true	true	ADJ	JJ	Degree=Pos	1	obl	1:obl:at	Entity=(47-abstract-new-nnnnn-cf2-1-sgl)|SpaceAfter=No|XML=<ref target:::"https://en.wiktionary.org/wiki/true"></ref>
4	,	,	PUNCT	,	_	5	punct	5:punct	_
5	tree	tree	NOUN	NN	Number=Sing	1	vocative	1:vocative	Entity=(48-abstract-new-nnnnn-cf1-1-sgl)|SpaceAfter=No|XML=<ref target:::"https://en.wiktionary.org/wiki/tree"></ref>
...
1	My	my	PRON	PRP$	Case=Gen|Number=Sing|Person=1|Poss=Yes|PronType=Prs	4	nmod:poss	4:nmod:poss	Discourse=context-background:8->10:1:_|Entity=(12-abstract-new-nnnnn-cf6-4-coref(1-person-giv:act-ssssn-cf1*-1-ana)|PDTB=Implicit:Expansion.Conjunction:in fact:_:1-60:61-196
...
6	no	no	DET	DT	PronType=Neg	7	det	7:det	Entity=(12-abstract-giv:act-nnnnn-cf6-2-pred|Negation=Yes
7	joke	joke	NOUN	NN	Number=Sing	0	root	0:root	Entity=12)
8	I	I	PRON	PRP	Case=Nom|Number=Sing|Person=1|PronType=Prs	10	nsubj:pass	10:nsubj:pass	Discourse=joint-list_m:9->8:0:sem-lxchn-62,72-gold|Entity=(1-person-giv:act-ssssn-cf1*-1-ana)
...
22	and	and	CCONJ	CC	_	68	cc	68:cc	Discourse=evaluation-comment:10->2:2:lex-indph-66-67-_;mode-manner:10->15:1:1:orp-likewise-133-gold;causal-result:10->8:1:1:orp-and-82-gold|PDTB=Explicit:Contingency.Cause.Result:and:82:61-81:83-129
23	if	if	SCONJ	IN	_	29	mark	29:mark	Discourse=contingency-condition:11->14:0:dm-if then-83,126-gold|PDTB=Explicit:Contingency.Condition.Arg2-as-cond:if then:83,126:82,125,127-129:84-124
...
31	act	act	VERB	VB	VerbForm=Inf	29	xcomp	29:xcomp	Entity=(17-abstract-new-nnnnn-cf3-1-disc
32	racially	racially	ADV	RB	Degree=Pos	33	advmod	33:advmod	MSeg=rac-ial-ly
...
41	dropping	drop	VERB	VBG	Tense=Pres|VerbForm=Part	31	advcl	31:advcl	Discourse=mode-manner:12->11:0:syn-pres-101,119-_|MSeg=dropp-ing|PDTB=Implicit:Expansion.Manner.Arg2-as-manner:by:_:83-100:101-124
...
55	the	the	DET	DT	Definite=Def|PronType=Art	56	det	56:det	Entity=(21-abstract-new-nnnnn-cf8-2-coref-Justice
56	Word	word	NOUN	NN	Number=Sing	44	nmod	44:nmod:of	Entity=21)
57	Justice	justice	NOUN	NN	Number=Sing	56	appos	56:appos	Entity=(21-abstract-giv:act-nnnnn-cf8-1-appos-Justice)20)
58	apparently	apparently	ADV	RB	Degree=Pos	59	advmod	59:advmod	Discourse=joint-list_m:13->12:0:sem-lxchn-116,121-gold|MSeg=apparent-ly
59	raising	raise	VERB	VBG	Tense=Pres|VerbForm=Part	41	advcl	41:advcl	MSeg=rais-ing
60	the	the	DET	DT	Definite=Def|PronType=Art	61	det	61:det	Entity=(22-abstract-new-nnnnn-cf10-2-coref
61	word	word	NOUN	NN	Number=Sing	59	obj	59:obj	Entity=22)
62	"	"	PUNCT	``	_	63	punct	63:punct	SpaceAfter=No
63	Just	just	ADJ	JJ	Degree=Pos	61	appos	61:appos	Entity=(22-abstract-giv:act-nnnnn-cf10-1-appos)|SpaceAfter=No
...
70	Ii	I	PRON	PRP	Case=Nom|Number=Sing|Person=3|PronType=Prs	72	nsubj	72:nsubj	CorrectForm=I|Discourse=organization-preparation:15->20:2:ref-prs-130,167-_+sem-synym-135-136,176-181-_|Entity=(23-abstract-new-nnnnn-cf2-3-disc(1-person-giv:act-ssssn-cf1*-1-ana)|XML=<sic ana:::"I"></sic>
...
75	you	you	PRON	PRP	Case=Acc|Number=Sing|Person=2|PronType=Prs	76	vocative	76:vocative	Entity=(7-person-giv:act-sssss-cf4-2-coref
...
79	Koranic	Koranic	ADJ	NNP	Degree=Pos	82	amod	82:amod	Entity=(25-abstract-new-nnnnn-cf13-1-sgl)|MSeg=Koran-ic
...
88	an	a	DET	DT	Definite=Ind|PronType=Art	89	det	89:det	Entity=(17-abstract-giv:act-nnnnn-cf3-2-coref
89	eye	eye	NOUN	NN	Number=Sing	86	nmod	86:nmod:for	Entity=17)
90	and	and	CCONJ	CC	_	91	cc	91:cc	_
91	life	life	NOUN	NN	Number=Sing	86	conj	86:conj:and	Entity=(23-abstract-giv:act-nnnnn-cf2-1-coref)
92	for	for	ADP	IN	_	94	case	94:case	_
93	a	a	DET	DT	Definite=Ind|PronType=Art	94	det	94:det	Entity=(17-abstract-giv:act-nnnnn-cf3-2-coref
94	life	life	NOUN	NN	Number=Sing	91	nmod	91:nmod:for	Entity=17)
95	which	which	PRON	WDT	PronType=Rel	96	nsubj	86:ref	Discourse=attribution-positive:17->20:1:sem-atsrc-145-146,155-_+lex-indwd-156-_+syn-rpr-157,166-_
96	means	mean	VERB	VBZ	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	86	acl:relcl	86:acl:relcl	MSeg=mean-s
97	if	if	SCONJ	IN	_	102	mark	102:mark	Discourse=contingency-condition:18->20:0:dm-if-157-gold+dm-if-166-gold|PDTB=Explicit:Contingency.Condition.Arg2-as-cond:if:157:176-196:158-175
...
104	this	this	DET	DT	Number=Sing|PronType=Dem	105	det	105:det	Entity=(3-abstract-giv:act-sssss-cf5-2-coref
...
107	I	I	PRON	PRP	Case=Nom|Number=Sing|Person=1|PronType=Prs	109	nsubj	109:nsubj	Entity=(1-person-giv:act-ssssn-cf1*-1-ana)
...
110	sooner	soon	ADV	RBR	Degree=Cmp	109	advmod	109:advmod	Entity=(28-time-new-nnnnn-cf21-1-sgl|MSeg=soon-er
...
114	prison	prison	NOUN	NN	Number=Sing	115	compound	115:compound	Entity=(6-place-giv:act-sssss-cf7-1-coref-Prison)
115	discharge	discharge	NOUN	NN	Number=Sing	110	obj	110:obj	MSeg=dis-charge
116	two	two	NUM	CD	NumForm=Word|NumType=Card	121	nummod	121:nummod	Discourse=joint-other_m:20->2:3:_|Entity=(7-person-giv:act-sssss-cf4-6-coref
...
127	20	20	NUM	CD	NumForm=Digit|NumType=Card	128	compound	128:compound	Entity=(8-object-giv:act-ssnss-cf9-4-coref
...
134	my	my	PRON	PRP$	Case=Gen|Number=Sing|Person=1|Poss=Yes|PronType=Prs	135	nmod:poss	135:nmod:poss	Entity=(3-abstract-giv:act-sssss-cf5-2-coref(1-person-giv:act-ssssn-cf1*-1-ana)
135	case	case	NOUN	NN	Number=Sing	132	nmod	132:nmod:for	Entity=3)|SpaceAfter=No
