---
layout: base
title:  'Statistics of mark:comp in UD_Chinese-GSD'
udver: '2'
---

## Treebank Statistics: UD_Chinese-GSD: Relations: `mark:comp`

This relation is a language-specific subtype of <tt><a href="zh_gsd-dep-mark.html">mark</a></tt>.
There are also 2 other language-specific subtypes of `mark`: <tt><a href="zh_gsd-dep-mark-advb.html">mark:advb</a></tt>, <tt><a href="zh_gsd-dep-mark-relcl.html">mark:relcl</a></tt>.

25 nodes (0%) are attached to their parents as `mark:comp`.

20 instances of `mark:comp` (80%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.56.

The following 2 pairs of parts of speech are connected with `mark:comp`: <tt><a href="zh_gsd-pos-ADJ.html">ADJ</a></tt>-<tt><a href="zh_gsd-pos-PART.html">PART</a></tt> (20; 80% instances), <tt><a href="zh_gsd-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsd-pos-PART.html">PART</a></tt> (5; 20% instances).
...
1	司馬	司馬	PROPN	NNP	_	7	nsubj	_	SpaceAfter=No
2	遹	遹	PROPN	NNP	_	1	flat:name	_	SpaceAfter=No
3	更	更	ADV	RB	_	7	advmod	_	SpaceAfter=No
4	諷刺	諷刺	VERB	VV	_	7	advcl	_	SpaceAfter=No
5	杜	杜	PROPN	NNP	_	4	obj	_	SpaceAfter=No
6	錫	錫	PROPN	NNP	_	5	flat:name	_	SpaceAfter=No
...
12	喜歡	喜歡	VERB	VV	_	19	advcl	_	SpaceAfter=No
...
25	啊	啊	PART	UH	Mood=Inter	19	discourse	_	SpaceAfter=No
