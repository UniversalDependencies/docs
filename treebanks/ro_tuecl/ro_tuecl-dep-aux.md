...
## Treebank Statistics: UD_Romanian-TueCL: Relations: `aux`

This relation is universal.
There are 1 language-specific subtypes of `aux`: <tt><a href="ro_tuecl-dep-aux-pass.html">aux:pass</a></tt>.

99 nodes (2%) are attached to their parents as `aux`.

99 instances of `aux` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.19191919191919.

The following 4 pairs of parts of speech are connected with `aux`: <tt><a href="ro_tuecl-pos-VERB.html">VERB</a></tt>-<tt><a href="ro_tuecl-pos-AUX.html">AUX</a></tt> (92; 93% instances), <tt><a href="ro_tuecl-pos-ADJ.html">ADJ</a></tt>-<tt><a href="ro_tuecl-pos-AUX.html">AUX</a></tt> (3; 3% instances), <tt><a href="ro_tuecl-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ro_tuecl-pos-AUX.html">AUX</a></tt> (3; 3% instances), <tt><a href="ro_tuecl-pos-ADV.html">ADV</a></tt>-<tt><a href="ro_tuecl-pos-AUX.html">AUX</a></tt> (1; 1% instances).
...
1	Degeaba	degeaba	ADV	_	Degree=Pos	2	advmod	_	_
2	ai	avea	VERB	_	Number=Sing|Person=2	0	root	_	_
3	bolid	bolid	NOUN	_	Definite=Ind|Gender=Masc|Number=Sing	2	obj	_	_
4	de	de	ADP	_	AdpType=Prep|Case=Acc	5	case	_	_
5	lux	lux	NOUN	_	Definite=Ind|Gender=Masc|Number=Sing	3	nmod	_	_
6	dacă	dacă	SCONJ	_	Polarity=Pos	13	mark	_	_
7	femeia	femeie	NOUN	_	Case=Acc,Nom|Definite=Def|Gender=Fem|Number=Sing	13	nsubj	_	_
8	de	de	ADP	_	AdpType=Prep|Case=Acc	10	case	_	_
9	lângă	lângă	ADP	_	AdpType=Prep|Case=Acc	8	fixed	_	_
10	tine	tine	PRON	_	Case=Acc|Number=Sing|Person=2|PronType=Prs|Strength=Strong	7	nmod	_	_
11	a	avea	AUX	_	Number=Sing|Person=3	13	aux	_	_
12	fost	fi	AUX	_	Number=Sing|VerbForm=Part	13	cop	_	_
13	taxi	taxi	NOUN	_	Definite=Ind|Gender=Masc|Number=Sing	2	advcl	_	_
14	toată	tot	DET	_	Case=Acc,Nom|Gender=Fem|Number=Sing|Person=3|PronType=Ind	15	det	_	_
15	viața	viață	NOUN	_	Case=Acc,Nom|Definite=Def|Gender=Fem|Number=Sing	13	nmod	_	_
16	ei	lui	DET	_	Number[psor]=Sing|Person=3|Poss=Yes|PronType=Prs	15	det	_	SpaceAfter=No
17	.	.	PUNCT	_	_	2	punct	_	_
18	🤷🏻‍♂️	🤷🏻‍♂️	SYM	_	_	2	discourse:emo	_	_
