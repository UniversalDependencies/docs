...
There are 21 `CCONJ` lemmas (0%), 21 `CCONJ` types (0%) and 5318 `CCONJ` tokens (2%).
...
The form / lemma ratio of `CCONJ` is 1.000000 (the average of all parts of speech is 1.414899).
