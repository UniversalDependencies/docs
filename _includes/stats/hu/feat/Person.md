...
The feature is used with 4 part-of-speech tags: [hu-pos/VERB]() (3535; 8% instances), [hu-pos/PRON]() (1380; 3% instances), [hu-pos/DET]() (115; 0% instances), [hu-pos/AUX]() (38; 0% instances).

### `VERB`

3535 [hu-pos/VERB]() tokens (92% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (3485; 99%), <tt><a href="Voice.html">Voice</a>=Act</tt> (3477; 98%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (2970; 84%), <tt><a href="Number.html">Number</a>=Sing</tt> (2596; 73%), <tt><a href="Definite.html">Definite</a>=Ind</tt> (2183; 62%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (1817; 51%).

`VERB` tokens may have the following values of `Person`:

* `1` (199; 6% of non-empty `Person`): <em>szeretem, tudtuk, vagyok, csináltam, kaptam, akartam, alakítottam, beszámoltunk, dolgoztam, eljutottunk</em>
* `2` (8; 0% of non-empty `Person`): <em>Repülj, Tégy, felejtsd, keveredsz, lásd, megöltétek, énekelsz, őrizd</em>
* `3` (3328; 94% of non-empty `Person`): <em>volt, kell, van, lehet, mondta, lesz, elmondta, kellene, lenne, vannak</em>
...
<table>
  ...
  <tr><td><tt><a href="Definite.html">Definite</a>=Ind|<a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Tense.html">Tense</a>=Past</tt></td><td></td><td></td><td><em>tettek</em></td></tr>
...
1380 [hu-pos/PRON]() tokens (100% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (1220; 88%), <tt><a href="Person[psor].html">Person[psor]</a>=None</tt> (851; 62%), <tt><a href="Number[psor].html">Number[psor]</a>=None</tt> (850; 62%), <tt><a href="Number[psed].html">Number[psed]</a>=None</tt> (850; 62%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Dat|<a href="Number.html">Number</a>=Sing|<a href="Reflex.html">Reflex</a>=Yes</tt></td><td></td><td><em>magának</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Ine|<a href="Number.html">Number</a>=Sing|<a href="Reflex.html">Reflex</a>=Yes</tt></td><td></td><td><em>magában</em></td></tr>
...
115 [hu-pos/DET]() tokens (2% of all `DET` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `DET` and `Person` co-occurred: <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (115; 100%), <tt><a href="PronType.html">PronType</a>=Dem</tt> (115; 100%).
...
* `3` (38; 100% of non-empty `Person`): <em>volna, fog, fogja, fognak, fogják</em>

## Relations with Agreement in `Person`

The 10 most frequent relations where parent and child node agree in `Person`:
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (554; 93%),
<tt>VERB --[<a href="../dep/nsubj.html">nsubj</a>]--> PRON</tt> (266; 100%),
<tt>VERB --[<a href="../dep/advcl.html">advcl</a>]--> VERB</tt> (226; 90%),
<tt>VERB --[<a href="../dep/nmod:obl.html">nmod:obl</a>]--> PRON</tt> (215; 84%),
<tt>VERB --[<a href="../dep/dobj.html">dobj</a>]--> PRON</tt> (168; 80%),
<tt>VERB --[<a href="../dep/ccomp:obj.html">ccomp:obj</a>]--> VERB</tt> (139; 84%),
<tt>VERB --[<a href="../dep/ccomp:obl.html">ccomp:obl</a>]--> VERB</tt> (101; 92%),
<tt>VERB --[<a href="../dep/csubj.html">csubj</a>]--> VERB</tt> (54; 98%),
<tt>VERB --[<a href="../dep/ccomp.html">ccomp</a>]--> VERB</tt> (45; 80%),
<tt>VERB --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (36; 78%).
