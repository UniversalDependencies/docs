...
1	Koozz	koozz	ADV	Adv	Case=Ill|PronType=Int	3	advmod:lmod	_	GTtags=Interj,Ill
2	lee	leeʹd	AUX	V	Mood=Ind|Number=Plur|Person=3|Tense=Pres	3	aux	_	GTtags=Ind,Prs,Pl3
3	vuõʹlǧǧem	vueʹlǧǧed	VERB	V	Mood=Ind|Number=Sing|Person=1|Tense=Prt	0	root	_	GTtags=Ind,Prt,Sg1|SpaceAfter=No
4	,	,	PUNCT	CLB	_	5	punct	_	_
5	koǯǯâm	koǯǯâd	VERB	V	Aspect=Perf|VerbForm=Part	3	conj	_	GTtags=Act,PrfPrc
