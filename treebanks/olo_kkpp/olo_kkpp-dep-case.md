...
## Treebank Statistics: UD_Livvi-KKPP: Relations: `case`
...
1	Nai	naija	VERB	VERB	Mood=Ind|Number=Sing|Person=2|VerbForm=Fin|Voice=Act	0	root	_	_
2	bobuli-briha	bobuli-briha	NOUN	NOUN	Case=Nom|Number=Sing	1	nsubj	_	_
3	da	da	CCONJ	CCONJ	_	4	cc	_	_
4	rubei	ruveta	VERB	VERB	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	1	conj	_	_
5	mučoin	mučoi	NOUN	NOUN	Case=Gen|Number=Sing	4	obl	_	_
6	ker	ker	ADP	X	_	5	case	_	_
7	elämäh	elämy	VERB	VERB	Case=Ill|Number=Sing	4	obl	_	SpaceAfter=No|Deriv=Ma
...
8	sigäläzes	sigäläine	ADJ	ADJ	Case=Ela|Number=Sing	9	amod	_	_
9	kul’tuurutalois	kulʼtuurutalo	NOUN	NOUN	Case=Ela|Number=Sing	10	obl	_	_
10	ezityttih	ezittyö	VERB	VERB	Mood=Ind|Number=Plur|Person=3|Tense=Past|VerbForm=Fin	5	parataxis	_	_
11	jo	jo	ADV	ADV	_	10	advmod	_	_
