...
2	iputurĩ	putury	VERB	XPOS=3SG.M-pular	Gender[subj]=Masc|Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past,Pres|VerbForm=Fin	0	root	_	gloss[pt]=3SG.M-pular
...
7	nerekary	nere	VERB	XPOS=querer-PRED	Gender[obj]=Masc|Mood=Ind|Number[obj]=Sing|Person[obj]=3|Tense=Past,Pres|VerbForm=Fin	2	advcl	_	gloss[pt]=querer-PRED-3SG.M.O
...
11	inhinhiãwa	inhinhiãwa	VERB	XPOS=3SG.M-comer-?ser-REFL	Gender[subj]=Masc|Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past,Pres|VerbForm=Fin	7	xcomp	_	gloss[pt]=3SG.M-comer-?ser-REFL
