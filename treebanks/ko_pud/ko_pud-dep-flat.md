...
1	철도	_	NOUN	NN	_	2	compound	_	Translit=.cheol.do
2	역사에	역사	NOUN	NN+CM	Polite=Form	3	obl	_	MSeg=역사-에|Translit=.yeog.sa.e|LTranslit=.yeog.sa
3	대해	_	VERB	VV	Form=Compl	7	advcl	_	Translit=.dae.hae
4	여러	_	DET	DT	_	5	det	_	Translit=.yeo.reo
...
7	집필한	_	NOUN	NN	_	8	acl:relcl	_	SpaceAfter=No|Translit=.jib.pil.han
8	크리스찬	_	PROPN	NNP	_	17	nsubj	_	Translit=.keu.ri.seu.chan
9	월마	_	PROPN	NNP	_	8	flat:name	_	SpaceAfter=No|Translit=.weol.ma
10	가	가	PART	CM	Case=Nom|Polite=Form	8	case	_	Translit=.ga|LTranslit=.ga
11	12	12	NUM	CD	NumType=Card	12	nummod	_	SpaceAfter=No|Translit=12|LTranslit=12
12	월	_	NOUN	NNB	_	17	obl:tmod	_	Translit=.weol
13	1	1	NUM	CD	NumType=Card	12	nummod	_	SpaceAfter=No|Translit=1|LTranslit=1
14	일	_	NOUN	NNB	_	12	flat	_	Translit=.il
