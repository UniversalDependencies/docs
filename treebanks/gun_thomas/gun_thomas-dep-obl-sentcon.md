---
layout: base
title:  'Statistics of obl:sentcon in UD_Mbya_Guarani-Thomas'
udver: '2'
---

## Treebank Statistics: UD_Mbya_Guarani-Thomas: Relations: `obl:sentcon`

This relation is a language-specific subtype of <tt><a href="gun_thomas-dep-obl.html">obl</a></tt>.

7 nodes (1%) are attached to their parents as `obl:sentcon`.

7 instances of `obl:sentcon` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 9.14285714285714.

The following 1 pairs of parts of speech are connected with `obl:sentcon`: <tt><a href="gun_thomas-pos-VERB.html">VERB</a></tt>-<tt><a href="gun_thomas-pos-PRON.html">PRON</a></tt> (7; 100% instances).
...
# visual-style 8 1 obl:sentcon	color:blue
