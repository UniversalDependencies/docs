...
1915 tokens (3%) have a non-empty value of `NameType`.
864 types (7%) occur at least once with a non-empty value of `NameType`.
557 lemmas (10%) occur at least once with a non-empty value of `NameType`.
The feature is used with 5 part-of-speech tags: <tt><a href="la_udante-pos-PROPN.html">PROPN</a></tt> (998; 2% instances), <tt><a href="la_udante-pos-NOUN.html">NOUN</a></tt> (514; 1% instances), <tt><a href="la_udante-pos-ADJ.html">ADJ</a></tt> (401; 1% instances), <tt><a href="la_udante-pos-VERB.html">VERB</a></tt> (1; 0% instances), <tt><a href="la_udante-pos-X.html">X</a></tt> (1; 0% instances).

### `PROPN`

998 <tt><a href="la_udante-pos-PROPN.html">PROPN</a></tt> tokens (93% of all `PROPN` tokens) have a non-empty value of `NameType`.

The most frequent other feature values with which `PROPN` and `NameType` co-occurred: <tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Sing</tt> (917; 92%), <tt><a href="la_udante-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (695; 70%).
...
514 <tt><a href="la_udante-pos-NOUN.html">NOUN</a></tt> tokens (5% of all `NOUN` tokens) have a non-empty value of `NameType`.

The most frequent other feature values with which `NOUN` and `NameType` co-occurred: <tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Sing</tt> (400; 78%), <tt><a href="la_udante-feat-InflClass.html">InflClass</a></tt><tt>=IndEurO</tt> (282; 55%).
...
* `Rel` (207; 40% of non-empty `NameType`): <em>Dei, Deus, Deo, Deum, Angelos, Domino, El, Musa, Seraphin, Victoria</em>
...
`NameType` seems to be **lexical feature** of `NOUN`. 97% lemmas (58) occur only with one value of `NameType`.

### `ADJ`

401 <tt><a href="la_udante-pos-ADJ.html">ADJ</a></tt> tokens (10% of all `ADJ` tokens) have a non-empty value of `NameType`.

The most frequent other feature values with which `ADJ` and `NameType` co-occurred: <tt><a href="la_udante-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (401; 100%), <tt><a href="la_udante-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (323; 81%), <tt><a href="la_udante-feat-InflClass.html">InflClass</a></tt><tt>=IndEurO</tt> (296; 74%), <tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Plur</tt> (255; 64%).
...
* `Geo` (23; 6% of non-empty `NameType`): <em>Castalias, Adriaci, Adriatici, Adriaticum, Ethnei, Ethneo, Ethnica, Fortunatas, Hyrcane, Pactolida</em>
...
<table>
  <tr><th>Paradigm <i>latius</i></th><th><tt>Geo</tt></th><th><tt>Nat</tt></th></tr>
  <tr><td><tt><tt><a href="la_udante-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="la_udante-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>latium</em></td><td></td></tr>
  <tr><td><tt><tt><a href="la_udante-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="la_udante-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td><em>Latiis</em></td></tr>
  <tr><td><tt><tt><a href="la_udante-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="la_udante-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td><em>Latii</em></td></tr>
</table>

`NameType` seems to be **lexical feature** of `ADJ`. 99% lemmas (144) occur only with one value of `NameType`.
...
<tt>PROPN --[<tt><a href="la_udante-dep-conj.html">conj</a></tt>]--> PROPN</tt> (44; 64%),
