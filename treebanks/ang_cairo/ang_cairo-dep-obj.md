---
layout: base
title:  'Statistics of obj in UD_Old_English-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Old_English-Cairo: Relations: `obj`

This relation is universal.

11 nodes (6%) are attached to their parents as `obj`.

8 instances of `obj` (73%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.63636363636364.

The following 2 pairs of parts of speech are connected with `obj`: <tt><a href="ang_cairo-pos-VERB.html">VERB</a></tt>-<tt><a href="ang_cairo-pos-NOUN.html">NOUN</a></tt> (9; 82% instances), <tt><a href="ang_cairo-pos-VERB.html">VERB</a></tt>-<tt><a href="ang_cairo-pos-PRON.html">PRON</a></tt> (2; 18% instances).
