...
The `iobj:po` relation marks an an object referenced by a potential(is) or involuntative object marker.
...
5	аӡәгьы	аӡәы́	PRON	_	Animacy=Hum|Number=Sing|PronType=Ind	6	iobj:po	_	_
