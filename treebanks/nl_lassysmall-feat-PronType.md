...
2732 tokens (3%) have a non-empty value of `PronType`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="nl_lassysmall-pos-PRON.html">PRON</a></tt> (2732; 3% instances).

### `PRON`

2732 <tt><a href="nl_lassysmall-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="nl_lassysmall-feat-Person.html">Person</a></tt><tt>=3</tt> (1790; 66%), <tt><a href="nl_lassysmall-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (1745; 64%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (207; 8% of non-empty `PronType`): <em>deze, dit, dat, die, zo'n, degenen, degene</em>
* `Ind` (440; 16% of non-empty `PronType`): <em>meer, vele, veel, meeste, minder, meest, enige, beide, alle, alles</em>
* `Int` (55; 2% of non-empty `PronType`): <em>wat, wie, welke</em>
* `Prs` (1525; 56% of non-empty `PronType`): <em>hij, ze, het, zich, zij, men, hem, je, ik, hen</em>
* `Rcp` (23; 1% of non-empty `PronType`): <em>elkaar, mekaar</em>
* `Rel` (482; 18% of non-empty `PronType`): <em>die, dat, hetgeen, hetwelk</em>
