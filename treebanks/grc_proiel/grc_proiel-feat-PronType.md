...
46943 tokens (22%) have a non-empty value of `PronType`.
395 types (1%) occur at least once with a non-empty value of `PronType`.
62 lemmas (1%) occur at least once with a non-empty value of `PronType`.
The feature is used with 4 part-of-speech tags: <tt><a href="grc_proiel-pos-DET.html">DET</a></tt> (28107; 13% instances), <tt><a href="grc_proiel-pos-PRON.html">PRON</a></tt> (17721; 8% instances), <tt><a href="grc_proiel-pos-ADV.html">ADV</a></tt> (1084; 1% instances), <tt><a href="grc_proiel-pos-ADJ.html">ADJ</a></tt> (31; 0% instances).

### `DET`

28107 <tt><a href="grc_proiel-pos-DET.html">DET</a></tt> tokens (89% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="grc_proiel-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (28107; 100%), <tt><a href="grc_proiel-feat-Number.html">Number</a></tt><tt>=Sing</tt> (19674; 70%).

`DET` tokens may have the following values of `PronType`:

* `Dem` (28107; 100% of non-empty `PronType`): <em>ὁ, τοῦ, τὴν, τὸ, τὸν, τῶν, τῆς, οἱ, τῷ, τὰ</em>
* `EMPTY` (3470): <em>πάντα, πάντων, τι, τούτου, τοῦτον, πᾶσαν, πᾶν, τοῦτο, πάντες, οὗτος</em>

### `PRON`

17721 <tt><a href="grc_proiel-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="grc_proiel-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (12768; 72%), <tt><a href="grc_proiel-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11087; 63%).

`PRON` tokens may have the following values of `PronType`:

* `Int` (733; 4% of non-empty `PronType`): <em>τί, τίς, τίνα, τι, τίνι, τίνος, ποίᾳ, πόσῳ, ὅ, τις</em>
* `Prs` (14269; 81% of non-empty `PronType`): <em>αὐτοῦ, αὐτῷ, αὐτὸν, αὐτῶν, ὑμῖν, μου, αὐτοῖς, ὑμῶν, σου, ὑμᾶς</em>
* `Rcp` (123; 1% of non-empty `PronType`): <em>ἀλλήλους, ἀλλήλων, ἀλλήλοις, ἀλλήλοισι, ἀλληλέων, ἀλλήλας, ἀλλήλῃσι, ἄλληλα</em>
* `Rel` (2596; 15% of non-empty `PronType`): <em>ὃς, ὃ, ὃν, οὗ, ᾧ, ἃ, ἣν, τῶν, τὰ, οἳ</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="grc_proiel-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="grc_proiel-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="grc_proiel-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="grc_proiel-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td><em>οἱ, οἳ, οἵ, ὃ</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="grc_proiel-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="grc_proiel-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="grc_proiel-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td><em>τὸ, ὁ, ὅ</em></td></tr>
  ...
  <tr><td><tt><tt><a href="grc_proiel-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="grc_proiel-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="grc_proiel-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td><em>τά, τὰ</em></td></tr>
...
1084 <tt><a href="grc_proiel-pos-ADV.html">ADV</a></tt> tokens (5% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="grc_proiel-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (1084; 100%).

`ADV` tokens may have the following values of `PronType`:

* `Int` (267; 25% of non-empty `PronType`): <em>πῶς, ποῦ, πόθεν, πότε, ὡς, εἰ, κῶς, μήτι, ἱνατί, τῇ</em>
* `Rel` (817; 75% of non-empty `PronType`): <em>ὡς, καθὼς, ὅταν, ὅπου, ὥσπερ, κατά, τῇ, οὗ, ἔνθα, ὅθεν</em>
* `EMPTY` (21638): <em>δὲ, γὰρ, καὶ, μὲν, οὐκ, μὴ, οὐ, δὴ, οὖν, ὡς</em>
...
* `EMPTY` (16490): <em>ταῦτα, τοῦτο, πάντα, τις, τούτων, οὗτοι, οὗτος, τάδε, πρότερον, πάντες</em>
...
<tt>PRON --[<tt><a href="grc_proiel-dep-det.html">det</a></tt>]--> PRON</tt> (11; 85%),
