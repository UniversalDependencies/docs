---
layout: base
title:  'Statistics of advmod:emph in UD_Uyghur-UDT'
udver: '2'
---
...
1	بۇ	بۇ	PRON	P	Case=Nom|PronType=Dem	4	det	_	Translit=bu
2	قۇپقۇرۇق	قۇپقۇرۇق	ADJ	A	_	4	amod	_	Translit=qupquruq
3	ئۆلۈك	ئۆلۈك	NOUN	N	Case=Nom	4	amod	_	Translit=ölük
4	چۆللۈكتە	چۆللۈك	NOUN	N	Case=Loc	9	nmod	_	Translit=chöllükte
5	ھەتتا	_	CCONJ	C	_	8	advmod:emph	_	Translit=hetta|Morf=Missing,1
6	بىر	بىر	NUM	M	_	7	nummod	_	Translit=bir
7	تىنىق	تىنىق	NOUN	N	Case=Nom	8	amod	_	Translit=tiniq
8	ھاۋامۇ	ھاۋا	NOUN	N	Case=Nom	9	nsubj	_	Translit=hawamu
...
1	رىياسەتچى	_	NOUN	N	_	2	nmod	_	Translit=riyasetchi|Morf=Unknown
2	بالا	بالا	NOUN	N	Case=Nom	9	nsubj	_	Translit=bala
3	ئۆزىنى	ئۆز	PRON	P	Case=Acc|Number[psor]=Plur,Sing|Person[psor]=3|Reflex=Yes	9	obj	_	Translit=özini
4	شۇنچە	شۇنچە	ADV	P	_	9	advmod:emph	_	Translit=shunche
5	ئەركىن	ئەركىن	ADJ	A	Case=Nom	9	advmod	_	Translit=erkin
6	ۋە	ۋە	CCONJ	C	_	7	cc	_	Translit=we
7	خوشال	_	ADJ	A	_	5	conj	_	Translit=xoshal|Morf=Unknown
