...
* `Cmp` (226; 2% of non-empty `Degree`): <em>боле, старѣи, старѣишии, старѣишаго, больша, менших, мьнии, старѣишю, болии, болше</em>
* `Pos` (9261; 98% of non-empty `Degree`): <em>ст҃го, много, мало, блаженыи, велика, великъ, мнози, многы, стаг, ст҃ѣи</em>
* `Sup` (1; 0% of non-empty `Degree`): <em>старѣишеи</em>
* `EMPTY` (6143): <em>своѥго, се, то, свои, свою, же, того, мои, си, кто</em>
...
205 <tt><a href="orv_torot-pos-ADV.html">ADV</a></tt> tokens (2% of all `ADV` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADV` and `Degree` co-occurred: <tt><a href="orv_torot-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (205; 100%).

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (47; 23% of non-empty `Degree`): <em>паче, луче, ближе, выше, далѣ, быстрѣѥ, крѣплѣ, лучи, лущи, ниже</em>
* `Pos` (158; 77% of non-empty `Degree`): <em>много, добрѣ, скоро, крѣпко, мало, лютѣ, борзо, злѣ, прилѣжьно, высоко</em>
...
<tt>ADJ --[<tt><a href="orv_torot-dep-conj.html">conj</a></tt>]--> ADJ</tt> (341; 94%),
<tt>ADJ --[<tt><a href="orv_torot-dep-flat.html">flat</a></tt>]--> ADJ</tt> (27; 100%),
<tt>ADJ --[<tt><a href="orv_torot-dep-amod.html">amod</a></tt>]--> ADJ</tt> (26; 59%),
<tt>ADJ --[<tt><a href="orv_torot-dep-advmod.html">advmod</a></tt>]--> ADJ</tt> (7; 100%),
<tt>ADJ --[<tt><a href="orv_torot-dep-advcl.html">advcl</a></tt>]--> ADJ</tt> (5; 100%).
