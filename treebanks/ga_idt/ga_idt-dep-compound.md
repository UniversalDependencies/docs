...
159 nodes (0%) are attached to their parents as `compound`.

159 instances of `compound` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.0188679245283.

The following 3 pairs of parts of speech are connected with `compound`: <tt><a href="ga_idt-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ga_idt-pos-NOUN.html">NOUN</a></tt> (157; 99% instances), <tt><a href="ga_idt-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ga_idt-pos-DET.html">DET</a></tt> (1; 1% instances), <tt><a href="ga_idt-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ga_idt-pos-PROPN.html">PROPN</a></tt> (1; 1% instances).
...
2	an	an	PART	Vb	PartType=Vb	3	mark:prt	_	_
3	bhfuil	bí	VERB	PresInd	Form=Ecl|Mood=Ind|Tense=Pres	0	root	_	_
