...
58164 tokens (13%) have a non-empty value of `PronType`.
454 types (2%) occur at least once with a non-empty value of `PronType`.
83 lemmas (1%) occur at least once with a non-empty value of `PronType`.
The feature is used with 6 part-of-speech tags: <tt><a href="la_ittb-pos-DET.html">DET</a></tt> (27074; 6% instances), <tt><a href="la_ittb-pos-PRON.html">PRON</a></tt> (22591; 5% instances), <tt><a href="la_ittb-pos-SCONJ.html">SCONJ</a></tt> (5249; 1% instances), <tt><a href="la_ittb-pos-ADV.html">ADV</a></tt> (3248; 1% instances), <tt><a href="la_ittb-pos-ADP.html">ADP</a></tt> (1; 0% instances), <tt><a href="la_ittb-pos-CCONJ.html">CCONJ</a></tt> (1; 0% instances).

### `DET`

27074 <tt><a href="la_ittb-pos-DET.html">DET</a></tt> tokens (96% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="la_ittb-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (24165; 89%), <tt><a href="la_ittb-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (24143; 89%), <tt><a href="la_ittb-feat-Form.html">Form</a></tt><tt>=EMPTY</tt> (23712; 88%), <tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (20964; 77%), <tt><a href="la_ittb-feat-InflClass.html">InflClass</a></tt><tt>=LatPron</tt> (20676; 76%).
...
* `Ind` (9529; 35% of non-empty `PronType`): <em>omnia, unum, aliqua, omnes, omnis, quaedam, omne, aliquam, una, omnibus</em>
* `Prs` (2934; 11% of non-empty `PronType`): <em>suam, sua, suum, suae, sui, suo, nostra, noster, suis, nostrae</em>
* `Rel` (503; 2% of non-empty `PronType`): <em>quaecumque, quae, quicumque, quocumque, cuiuscumque, qualis, quam, quodcumque, quem, qua</em>
...
22591 <tt><a href="la_ittb-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="la_ittb-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (20091; 89%), <tt><a href="la_ittb-feat-InflClass.html">InflClass</a></tt><tt>=LatPron</tt> (18926; 84%), <tt><a href="la_ittb-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (17744; 79%), <tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (14134; 63%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (1; 0% of non-empty `PronType`): <em>quod</em>
* `Ind` (2481; 11% of non-empty `PronType`): <em>aliquid, nihil, aliquis, alicuius, aliquo, alicui, aliqua, aliqui, nemo, aliquibus</em>
...
* `Rel` (11319; 50% of non-empty `PronType`): <em>quae, quod, qui, quo, quam, quibus, qua, cuius, quem, quorum</em>
...
5249 <tt><a href="la_ittb-pos-SCONJ.html">SCONJ</a></tt> tokens (22% of all `SCONJ` tokens) have a non-empty value of `PronType`.

`SCONJ` tokens may have the following values of `PronType`:

* `Rel` (5249; 100% of non-empty `PronType`): <em>ut, cum, quando, quod, quam</em>
* `EMPTY` (18111): <em>quod, sicut, quia, si, nisi, quam, inquantum, licet, quamuis, dum</em>

### `ADV`

3248 <tt><a href="la_ittb-pos-ADV.html">ADV</a></tt> tokens (13% of all `ADV` tokens) have a non-empty value of `PronType`.

`ADV` tokens may have the following values of `PronType`:

* `Con` (711; 22% of non-empty `PronType`): <em>solum, aliter, utrum, alias</em>
* `Dem` (689; 21% of non-empty `PronType`): <em>tantum, tam, hinc, ecce, hic, ita, idem, intantum</em>
* `Ind` (9; 0% of non-empty `PronType`): <em>nihil, nil</em>
* `Int` (3; 0% of non-empty `PronType`): <em>numquid, nunquid</em>
* `Rel` (1836; 57% of non-empty `PronType`): <em>unde, ut, quandoque, quare, qualiter, quando, quanto</em>
* `EMPTY` (22497): <em>igitur, etiam, sic, ergo, tamen, supra, ita, magis, uero, adhuc</em>
