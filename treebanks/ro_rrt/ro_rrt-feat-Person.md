...
35061 tokens (16%) have a non-empty value of `Person`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="ro_rrt-pos-VERB.html">VERB</a></tt> (12283; 6% instances), <tt><a href="ro_rrt-pos-PRON.html">PRON</a></tt> (11800; 5% instances), <tt><a href="ro_rrt-pos-AUX.html">AUX</a></tt> (7126; 3% instances), <tt><a href="ro_rrt-pos-DET.html">DET</a></tt> (3852; 2% instances).

### `VERB`

12283 <tt><a href="ro_rrt-pos-VERB.html">VERB</a></tt> tokens (53% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="ro_rrt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (12283; 100%), <tt><a href="ro_rrt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (12283; 100%), <tt><a href="ro_rrt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10465; 85%), <tt><a href="ro_rrt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (8959; 73%).

`VERB` tokens may have the following values of `Person`:

* `1` (624; 5% of non-empty `Person`): <em>știu, putem, avem, cred, rog, spun, așteptam, rugăm, vedem, văd</em>
* `2` (853; 7% of non-empty `Person`): <em>luați, vezi, aveți, utilizați, poți, puteai, spuneți, puteți, știți, lăsați</em>
* `3` (10806; 88% of non-empty `Person`): <em>poate, trebuie, pot, are, avea, era, putea, există, au, face</em>
...
`Person` seems to be **lexical feature** of `PRON`. 100% lemmas (47) occur only with one value of `Person`.

### `AUX`

7126 <tt><a href="ro_rrt-pos-AUX.html">AUX</a></tt> tokens (83% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="ro_rrt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4494; 63%), <tt><a href="ro_rrt-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (4347; 61%), <tt><a href="ro_rrt-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (4345; 61%), <tt><a href="ro_rrt-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (4345; 61%).

`AUX` tokens may have the following values of `Person`:

* `1` (379; 5% of non-empty `Person`): <em>am, aș, vom, eram, sunt, voi, suntem, fiu, -aș, fim</em>
* `2` (167; 2% of non-empty `Person`): <em>ai, ați, veți, sunteți, ești, fii, erai, vei, -ai, oi</em>
* `3` (6580; 92% of non-empty `Person`): <em>a, este, au, sunt, ar, era, va, fie, e, vor</em>
...
3852 <tt><a href="ro_rrt-pos-DET.html">DET</a></tt> tokens (32% of all `DET` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `DET` and `Person` co-occurred: <tt><a href="ro_rrt-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (2841; 74%), <tt><a href="ro_rrt-feat-Case.html">Case</a></tt><tt>=Acc,Nom</tt> (2233; 58%), <tt><a href="ro_rrt-feat-Position.html">Position</a></tt><tt>=EMPTY</tt> (1937; 50%).
...
* `3` (3627; 94% of non-empty `Person`): <em>acest, lui, lor, orice, toate, această, aceste, alte, fiecare, ei</em>
* `EMPTY` (8174): <em>o, un, a, al, ale, lui, unei, unui, cel, unor</em>
...
<tt>VERB --[<tt><a href="ro_rrt-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (1600; 75%),
<tt>VERB --[<tt><a href="ro_rrt-dep-expl-pv.html">expl:pv</a></tt>]--> PRON</tt> (1530; 68%),
<tt>VERB --[<tt><a href="ro_rrt-dep-conj.html">conj</a></tt>]--> VERB</tt> (1275; 76%),
<tt>VERB --[<tt><a href="ro_rrt-dep-expl-pass.html">expl:pass</a></tt>]--> PRON</tt> (879; 78%),
<tt>VERB --[<tt><a href="ro_rrt-dep-obl.html">obl</a></tt>]--> PRON</tt> (461; 55%),
<tt>VERB --[<tt><a href="ro_rrt-dep-expl.html">expl</a></tt>]--> PRON</tt> (306; 57%),
