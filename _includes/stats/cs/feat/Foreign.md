...
* `Foreign` (3684; 100% of non-empty `Foreign`): <em>HZDS, IRA, Floyd, Nature, International, Science, Sinn, Fein, Times, Cup</em>
...
* `Foreign` (2669; 100% of non-empty `Foreign`): <em>New, the, open, US, Pink, la, Le, Deutsche, die, United</em>
...
* `Foreign` (1813; 100% of non-empty `Foreign`): <em>play, managementu, management, CD, s, facto, st, o, homo, neem</em>
...
* `Foreign` (592; 100% of non-empty `Foreign`): <em>de, of, di, van, in, von, versus, ad, Pro, to</em>
...
* `Foreign` (120; 100% of non-empty `Foreign`): <em>off, džambo, not, t, oui, Bienvenue, So, ne, sorry, viva</em>
...
* `Foreign` (120; 100% of non-empty `Foreign`): <em>is, Be, can, est, transit, Check, Come, Habent, Keep, Love</em>
...
The most frequent other feature values with which `ADV` and `Foreign` co-occurred: <tt><a href="Negative.html">Negative</a>=EMPTY</tt> (107; 92%), <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (107; 92%).

`ADV` tokens may have the following values of `Foreign`:

* `Foreign` (116; 100% of non-empty `Foreign`): <em>cca, priori, Today, live, Here, Only, Sic, Very, dove, echt</em>
...
* `Foreign` (80; 100% of non-empty `Foreign`): <em>and, et, und, As, or, ma, So, e, n</em>
...
* `Foreign` (79; 100% of non-empty `Foreign`): <em>it, All, you, I, Me, We, Some, Us, My, She</em>
...
* `Foreign` (29; 100% of non-empty `Foreign`): <em>Four, Twenty, Seven, Six, one, Five, Three, Tre, Tri, seděm</em>
...
* `Foreign` (8; 100% of non-empty `Foreign`): <em>as, If, When, ak, ako, gdyž, kak</em>
...
* `Foreign` (6; 100% of non-empty `Foreign`): <em>O, propos, Bang, Boom, Crash</em>
...
* `Foreign` (1; 100% of non-empty `Foreign`): <em>Notre</em>
...
<tt>PROPN --[<a href="../dep/foreign.html">foreign</a>]--> PROPN</tt> (286; 99%),
<tt>NOUN --[<a href="../dep/foreign.html">foreign</a>]--> NOUN</tt> (163; 99%),
...
<tt>NOUN --[<a href="../dep/foreign.html">foreign</a>]--> PROPN</tt> (27; 87%).
...
The most frequent other feature values with which `NOUN` and `Foreign` co-occurred: <tt><a href="Negative.html">Negative</a>=Pos</tt> (257; 100%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (178; 69%).

`NOUN` tokens may have the following values of `Foreign`:

* `Foreign` (257; 100% of non-empty `Foreign`): <em>luxe, vitro, generis, nepusto, pusto, excellence, homo, lege, peeling, Buch</em>
...
The most frequent other feature values with which `ADJ` and `Foreign` co-occurred: <tt><a href="Negative.html">Negative</a>=Pos</tt> (116; 100%), <tt><a href="Degree.html">Degree</a>=Pos</tt> (113; 97%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (103; 89%), <tt><a href="Case.html">Case</a>=EMPTY</tt> (82; 71%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (80; 69%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (77; 66%).

`ADJ` tokens may have the following values of `Foreign`:

* `Foreign` (116; 100% of non-empty `Foreign`): <em>online, signifiant, super, la, Jazykovedným, New, Telephone, Tonkünstler, ferenda, fit</em>
...
* `Foreign` (64; 100% of non-empty `Foreign`): <em>de, in, a, ad, cross, of, par, Pro, ante, aus</em>
...
The most frequent other feature values with which `PROPN` and `Foreign` co-occurred: <tt><a href="Negative.html">Negative</a>=Pos</tt> (37; 100%), <tt><a href="Abbr.html">Abbr</a>=EMPTY</tt> (36; 97%), <tt><a href="Case.html">Case</a>=EMPTY</tt> (30; 81%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (24; 65%), <tt><a href="Animacy.html">Animacy</a>=EMPTY</tt> (24; 65%).

`PROPN` tokens may have the following values of `Foreign`:

* `Foreign` (37; 100% of non-empty `Foreign`): <em>Combi, Kombi, Manche, Orchester, Bell, Böhmen, Corriere, Fruit, Gaudeamus, George</em>
...
* `Foreign` (14; 100% of non-empty `Foreign`): <em>La, das, des, non, Le, el, quo, Al</em>
...
* `Foreign` (13; 100% of non-empty `Foreign`): <em>priori, explicite, quo, defacto, expost, innuce, ipsofacto, memoriam, theory</em>
...
* `Foreign` (13; 100% of non-empty `Foreign`): <em>sui, eo, ipso, Tous, er, hoc, qua, quem, they</em>
...
* `Foreign` (8; 100% of non-empty `Foreign`): <em>are, data, formo, movere, savoir, singen, singt, vivre</em>
...
* `Foreign` (3; 100% of non-empty `Foreign`): <em>et, and</em>

## Relations with Agreement in `Foreign`

The 10 most frequent relations where parent and child node agree in `Foreign`:
<tt>NOUN --[<a href="../dep/foreign.html">foreign</a>]--> ADJ</tt> (35; 100%),
<tt>NOUN --[<a href="../dep/conj.html">conj</a>]--> NOUN</tt> (23; 57%),
<tt>NOUN --[<a href="../dep/foreign.html">foreign</a>]--> ADP</tt> (18; 100%),
