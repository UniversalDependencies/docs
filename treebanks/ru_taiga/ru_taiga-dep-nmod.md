...
2	гон	гон	NOUN	_	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	5	nsubj	_	_
3	у	у	ADP	_	_	4	case	_	_
4	них	они	PRON	_	Case=Gen|Number=Plur|Person=3|PronType=Prs	2	nmod	_	_
5	летом	лето	NOUN	_	Animacy=Inan|Case=Ins|Gender=Neut|Number=Sing	0	root	_	SpaceAfter=No
