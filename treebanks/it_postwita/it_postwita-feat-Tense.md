...
6716 tokens (10%) have a non-empty value of `Tense`.
2248 types (18%) occur at least once with a non-empty value of `Tense`.
860 lemmas (8%) occur at least once with a non-empty value of `Tense`.
The feature is used with 3 part-of-speech tags: <tt><a href="it_postwita-pos-VERB.html">VERB</a></tt> (4496; 7% instances), <tt><a href="it_postwita-pos-AUX.html">AUX</a></tt> (2218; 3% instances), <tt><a href="it_postwita-pos-X.html">X</a></tt> (2; 0% instances).

### `VERB`

4496 <tt><a href="it_postwita-pos-VERB.html">VERB</a></tt> tokens (76% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3681; 82%), <tt><a href="it_postwita-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (3666; 82%), <tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (3658; 81%), <tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (2980; 66%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (268; 6% of non-empty `Tense`): <em>farà, sarà, andrà, arriverà, toccherà, avrà, faremo, sara', andremo, durerà</em>
* `Imp` (105; 2% of non-empty `Tense`): <em>aveva, era, fosse, diceva, stavi, stavo, conoscevo, dimenticavo, erano, faceva</em>
* `Past` (861; 19% of non-empty `Tense`): <em>fatto, detto, dato, messo, nominato, fatta, iniziato, perso, preso, stata</em>
* `Pres` (3262; 73% of non-empty `Tense`): <em>fa, è, ha, dice, piace, ho, va, parla, so, fanno</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>faccio</em></td><td></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>fa, fa'</em></td><td><em>farà, fara'</em></td><td></td><td><em>faceva</em></td></tr>
  ...
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>fate</em></td><td></td><td></td><td></td></tr>
...
2218 <tt><a href="it_postwita-pos-AUX.html">AUX</a></tt> tokens (97% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (2170; 98%), <tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1946; 88%), <tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1831; 83%), <tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=3</tt> (1560; 70%).

`AUX` tokens may have the following values of `Tense`:

* `Fut` (84; 4% of non-empty `Tense`): <em>sarà, saranno, saremo, sarò, verrà, avrà, potrai, Avrai, Dovrò, Sará</em>
* `Imp` (125; 6% of non-empty `Tense`): <em>era, fosse, ero, erano, avevo, fossi, poteva, aveva, volevo, voleva</em>
* `Past` (52; 2% of non-empty `Tense`): <em>stato, stata, stati, fu, potuto, state, dovuta, dovuto, venne</em>
* `Pres` (1957; 88% of non-empty `Tense`): <em>è, ha, sono, e', ho, può, siamo, sei, hanno, sia</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>sono, son, so</em></td><td><em>sarò</em></td><td></td><td><em>ero</em></td></tr>
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>sei</em></td><td></td><td></td><td><em>eri</em></td></tr>
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>è, e', é, e</em></td><td><em>sarà, sara, Sará</em></td><td><em>fu</em></td><td><em>era</em></td></tr>
  ...
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>sono, son, so', sn</em></td><td><em>saranno</em></td><td></td><td><em>erano</em></td></tr>
  ...
  <tr><td><tt><tt><a href="it_postwita-feat-Mood.html">Mood</a></tt><tt>=Sub</tt>|<tt><a href="it_postwita-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="it_postwita-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="it_postwita-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>sia, si</em></td><td></td><td></td><td><em>fosse</em></td></tr>
...
2 <tt><a href="it_postwita-pos-X.html">X</a></tt> tokens (0% of all `X` tokens) have a non-empty value of `Tense`.

`X` tokens may have the following values of `Tense`:

* `Pres` (2; 100% of non-empty `Tense`): <em>amo, preciso</em>
* `EMPTY` (756): <em>rt, of, Prince, live, a, and, i, cc, on, the</em>

## Relations with Agreement in `Tense`

The 10 most frequent relations where parent and child node agree in `Tense`:
<tt>VERB --[<tt><a href="it_postwita-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (365; 52%),
<tt>VERB --[<tt><a href="it_postwita-dep-conj.html">conj</a></tt>]--> VERB</tt> (288; 63%),
