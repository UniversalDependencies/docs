...
5	_	_	VERB	n:pred	Mood=Ind|Subcat=Intr|VerbForm=Vnoun	0	root	_	_
6	_	_	VERB	n:pred	Mood=Ind|Subcat=Intr|VerbForm=Vnoun	5	compound	_	_
...
3	_	_	VERB	vi:a	Mood=Ind|Subcat=Intr|VerbForm=Inf	2	compound	_	_
...
8	_	_	VERB	vi:a	Mood=Des|Person[subj]=2|Subcat=Intr|VerbForm=Fin	10	parataxis:rep	_	_
