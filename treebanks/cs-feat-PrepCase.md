...
* `Npr` (948; 19% of non-empty `PrepCase`): jež jehož jenž jemuž jímž jimž jimiž jichž jíž již
* `Pre` (3977; 81% of non-empty `PrepCase`): nich ní něj nichž níž něm němž ně nimi ním
...
* `Npr` (1; 100% of non-empty `PrepCase`): kterážto
