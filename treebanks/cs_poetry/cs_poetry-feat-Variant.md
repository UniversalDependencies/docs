---
layout: base
title:  'Statistics of Variant in UD_Czech-Poetry'
udver: '2'
---

## Treebank Statistics: UD_Czech-Poetry: Features: `Variant`
...
158 <tt><a href="cs_poetry-pos-PRON.html">PRON</a></tt> tokens (41% of all `PRON` tokens) have a non-empty value of `Variant`.

The most frequent other feature values with which `PRON` and `Variant` co-occurred: <tt><a href="cs_poetry-feat-PrepCase.html">PrepCase</a></tt><tt>=EMPTY</tt> (158; 100%), <tt><a href="cs_poetry-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (158; 100%), <tt><a href="cs_poetry-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (153; 97%), <tt><a href="cs_poetry-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (148; 94%), <tt><a href="cs_poetry-feat-Case.html">Case</a></tt><tt>=Acc</tt> (119; 75%), <tt><a href="cs_poetry-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (112; 71%), <tt><a href="cs_poetry-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (112; 71%), <tt><a href="cs_poetry-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (112; 71%).

`PRON` tokens may have the following values of `Variant`:

* `Short` (158; 100% of non-empty `Variant`): <em>se, mi, si, tě, ti, ho, mu, mě, tobě</em>
...
* `Short` (52; 100% of non-empty `Variant`): <em>věrni, Vyloupena, otráven, Očištěna, Podťata, Rozcuchán, bičován, hodni, možno, neznáma</em>

`Variant` seems to be **lexical feature** of `ADJ`. 100% lemmas (46) occur only with one value of `Variant`.
...
<tt>ADJ --[<tt><a href="cs_poetry-dep-conj.html">conj</a></tt>]--> ADJ</tt> (4; 80%),
<tt>ADJ --[<tt><a href="cs_poetry-dep-obl-arg.html">obl:arg</a></tt>]--> DET</tt> (1; 100%).
