...
1 lemmas (0%) occur at least once with a non-empty value of `Red`.
...
The most frequent other feature values with which `NOUN` and `Red` co-occurred: <tt><a href="myu_tudet-feat-Rel.html">Rel</a></tt><tt>=EMPTY</tt> (1; 100%).
