...
* `Card` (69961; 100% of non-empty `NumType`): <em>eine, ein, einen, einer, einem, eines, beide, beiden, beider, eins</em>
* `EMPTY` (424406): <em>der, die, dem, den, das, des, diese, keine, ihre, seine</em>
...
* `EMPTY` (257737): <em>neue, neuen, deutschen, deutsche, weitere, eigenen, letzten, nächsten, vergangenen, möglich</em>
...
<tt>DET --[<tt><a href="de_hdt-dep-conj.html">conj</a></tt>]--> NUM</tt> (8; 100%),
<tt>DET --[<tt><a href="de_hdt-dep-nmod.html">nmod</a></tt>]--> NUM</tt> (8; 73%),
...
<tt>NUM --[<tt><a href="de_hdt-dep-conj.html">conj</a></tt>]--> DET</tt> (3; 60%),
