---
layout: base
title:  'Statistics of SCONJ in UD_Uzbek-UzUDT'
udver: '2'
---

## Treebank Statistics: UD_Uzbek-UzUDT: POS Tags: `SCONJ`
...
* <em>deb</em>
  * <tt><a href="uz_uzudt-pos-VERB.html">VERB</a></tt> 19: <em>« bu safar adabingni rosa bermaydigan boʻlsam » <b>deb</b> oʻylabdi boy va :</em>
  * <tt><a href="uz_uzudt-pos-SCONJ.html">SCONJ</a></tt> 3: <em>- sizni keladi <b>deb</b> o'ylab , shu yerda kutib turgan edim .</em>
...
`SCONJ` nodes are attached to their parents using 2 different relations: <tt><a href="uz_uzudt-dep-cc.html">cc</a></tt> (6; 67% instances), <tt><a href="uz_uzudt-dep-mark.html">mark</a></tt> (3; 33% instances)

Parents of `SCONJ` nodes belong to 2 different parts of speech: <tt><a href="uz_uzudt-pos-VERB.html">VERB</a></tt> (6; 67% instances), <tt><a href="uz_uzudt-pos-NOUN.html">NOUN</a></tt> (3; 33% instances)

6 (67%) `SCONJ` nodes are leaves.

3 (33%) `SCONJ` nodes have one child.

The highest child degree of a `SCONJ` node is 1.

Children of `SCONJ` nodes are attached using 1 different relations: <tt><a href="uz_uzudt-dep-punct.html">punct</a></tt> (3; 100% instances)

Children of `SCONJ` nodes belong to 1 different parts of speech: <tt><a href="uz_uzudt-pos-PUNCT.html">PUNCT</a></tt> (3; 100% instances)
