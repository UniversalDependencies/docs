...
168434 tokens (16%) have a non-empty value of `Degree`.
32170 types (29%) occur at least once with a non-empty value of `Degree`.
10588 lemmas (27%) occur at least once with a non-empty value of `Degree`.
The feature is used with 2 part-of-speech tags: [ru-pos/ADJ]() (113392; 11% instances), [ru-pos/ADV]() (55042; 5% instances).

### `ADJ`

113392 [ru-pos/ADJ]() tokens (100% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (74931; 66%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (1135; 1% of non-empty `Degree`): <em>лучше, выше, ниже, больше, хуже, легче, меньше, проще, ближе, труднее</em>
* `Pos` (111782; 99% of non-empty `Degree`): <em>которые, который, один, которых, которая, других, нужно, которой, другой, одной</em>
* `Sup` (475; 0% of non-empty `Degree`): <em>важнейших, важнейшим, крупнейших, крупнейшие, новейшие, ближайших, важнейший, крупнейшей, важнейшая, важнейшие</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing</tt></td><td><em>нового</em></td><td></td><td></td></tr>
...
`Degree` seems to be **lexical feature** of `ADJ`. 98% lemmas (8402) occur only with one value of `Degree`.

### `ADV`

55042 [ru-pos/ADV]() tokens (100% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (1726; 3% of non-empty `Degree`): <em>больше, меньше, раньше, лучше, дальше, чаще, позже, быстрее, выше, точнее</em>
* `Pos` (53316; 97% of non-empty `Degree`): <em>так, уже, еще, можно, более, как, очень, однако, где, сейчас</em>
...
`Degree` seems to be **lexical feature** of `ADV`. 95% lemmas (1889) occur only with one value of `Degree`.

## Relations with Agreement in `Degree`

The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<a href="../dep/advmod.html">advmod</a>]--> ADV</tt> (6718; 95%),
<tt>ADV --[<a href="../dep/advmod.html">advmod</a>]--> ADV</tt> (2821; 89%),
<tt>ADJ --[<a href="../dep/dep.html">dep</a>]--> ADJ</tt> (1422; 98%),
<tt>ADJ --[<a href="../dep/amod.html">amod</a>]--> ADJ</tt> (1415; 100%),
<tt>ADJ --[<a href="../dep/parataxis.html">parataxis</a>]--> ADV</tt> (610; 92%),
<tt>ADJ --[<a href="../dep/compound.html">compound</a>]--> ADJ</tt> (536; 100%),
<tt>ADJ --[<a href="../dep/nsubj.html">nsubj</a>]--> ADJ</tt> (299; 93%),
<tt>ADV --[<a href="../dep/parataxis.html">parataxis</a>]--> ADV</tt> (265; 93%),
<tt>ADV --[<a href="../dep/dep.html">dep</a>]--> ADV</tt> (264; 99%),
<tt>ADJ --[<a href="../dep/nmod.html">nmod</a>]--> ADJ</tt> (195; 76%).
...
169322 tokens (16%) have a non-empty value of `Degree`.
32189 types (29%) occur at least once with a non-empty value of `Degree`.
10589 lemmas (27%) occur at least once with a non-empty value of `Degree`.
The feature is used with 2 part-of-speech tags: [ru-pos/ADJ]() (114280; 11% instances), [ru-pos/ADV]() (55042; 5% instances).

### `ADJ`

114280 [ru-pos/ADJ]() tokens (100% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (75474; 66%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (1135; 1% of non-empty `Degree`): <em>лучше, выше, ниже, больше, хуже, легче, меньше, проще, ближе, труднее</em>
* `Pos` (112670; 99% of non-empty `Degree`): <em>которые, который, один, которых, которая, других, нужно, которой, другой, одной</em>
* `Sup` (475; 0% of non-empty `Degree`): <em>важнейших, важнейшим, крупнейших, крупнейшие, новейшие, ближайших, важнейший, крупнейшей, важнейшая, важнейшие</em>
...
`Degree` seems to be **lexical feature** of `ADJ`. 98% lemmas (8403) occur only with one value of `Degree`.
...
The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<a href="../dep/advmod.html">advmod</a>]--> ADV</tt> (6894; 95%),
<tt>ADJ --[<a href="../dep/conj.html">conj</a>]--> ADJ</tt> (4306; 99%),
<tt>ADV --[<a href="../dep/advmod.html">advmod</a>]--> ADV</tt> (2876; 89%),
<tt>ADJ --[<a href="../dep/amod.html">amod</a>]--> ADJ</tt> (1535; 100%),
<tt>ADV --[<a href="../dep/conj.html">conj</a>]--> ADV</tt> (752; 98%),
<tt>ADJ --[<a href="../dep/parataxis.html">parataxis</a>]--> ADV</tt> (609; 92%),
<tt>ADJ --[<a href="../dep/compound.html">compound</a>]--> ADJ</tt> (536; 100%),
<tt>ADJ --[<a href="../dep/nsubj.html">nsubj</a>]--> ADJ</tt> (299; 93%),
<tt>ADV --[<a href="../dep/parataxis.html">parataxis</a>]--> ADV</tt> (266; 93%),
<tt>ADJ --[<a href="../dep/nmod.html">nmod</a>]--> ADJ</tt> (214; 77%).
