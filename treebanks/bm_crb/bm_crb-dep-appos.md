...
1	jelikè	jèlikɛ	NOUN	n	_	3	nsubj	_	Gloss=griot|Morf=griot,griot,mâle
2	muso	mùso	NOUN	n	_	1	appos	_	Gloss=femme
3	ye	yé	VERB	cop	Polarity=Pos	0	root	_	Gloss=EQU
4	Baninyègènè	ba-ni-ɲɛgɛnɛ	PROPN	n.prop	_	3	obl	_	Gloss=NOM.F|Morf=NOM.F,mère,et,urine|SpaceAfter=No
...
6	kòrò	kɔ̀rɔ	NOUN	n	_	13	vocative	_	Gloss=aîné
...
# visual-style 1	fgColor:white
# visual-style 1 2 appos	color:blue
1	i	í	PRON	pers	PronType=Prs	0	root	_	Gloss=2.SG
2	bataraden	bataraden	NOUN	n	_	1	appos	_	Gloss=inutilité|Morf=inutilité,enfant|SpaceAfter=No
