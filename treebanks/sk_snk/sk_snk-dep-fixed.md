...
4	plánom	plán	NOUN	SSis7	Animacy=Inan|Case=Ins|Gender=Masc|Number=Sing	6	obl	6:obl	_
...
10	krídlach	krídlo	NOUN	SSnp6	Case=Loc|Gender=Neut|Number=Plur	6	obl	6:obl	_
11	šíku	šík	NOUN	SSis2	Animacy=Inan|Case=Gen|Gender=Masc|Number=Sing	10	nmod	10:nmod	SpaceAfter=No
...
2	mi	ja	PRON	PPhs3	Case=Dat|Number=Sing|Person=1|PronType=Prs	3	obj	3:obj	_
...
9	mi	ja	PRON	PPhs3	Case=Dat|Number=Sing|Person=1|PronType=Prs	8	obj	8:obj	SpaceAfter=No
...
14	sebou	seba	PRON	PPhs7	Case=Ins|Number=Sing|PronType=Prs|Reflex=Yes	15	obl	15:obl	_
15	zavrela	zavrieť	VERB	VLdscf+	Aspect=Perf|Gender=Fem|Number=Sing|Polarity=Pos|Tense=Past|VerbForm=Part	8	advcl	8:advcl	SpaceAfter=No
