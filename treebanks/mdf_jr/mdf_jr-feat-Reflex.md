...
* `EMPTY` (202): <em>сон, мон, тя, сонь, синь, минь, ся, тон, мезевок, монь</em>

### `DET`

1 <tt><a href="mdf_jr-pos-DET.html">DET</a></tt> tokens (3% of all `DET` tokens) have a non-empty value of `Reflex`.
