...
## Treebank Statistics: UD_Pashto-Sikaram: Relations: `aux`
...
1	غواړې	غوښتل	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin	0	root	_	Translit=ġwâṛé|LTranslit=ġox̌të́l|Gloss=you-want
2	چې	چې	SCONJ	_	_	3	mark	_	Translit=če|LTranslit=če|Gloss=that
3	لاړ	تلل	VERB	_	Variant=Short|VerbForm=Inf	1	ccomp	_	Translit=lâṛ|LTranslit=tlël|Gloss=go
4	شې	کېدل	AUX	_	Mood=Sub|Number=Sing|Person=2|VerbForm=Fin	3	aux	_	Translit=še|LTranslit=kedë́l|Gloss=you-become|SpaceAfter=No
5	؟	؟	PUNCT	_	_	1	punct	_	Translit=?|LTranslit=?|Gloss=?|SpaceAfter=No
