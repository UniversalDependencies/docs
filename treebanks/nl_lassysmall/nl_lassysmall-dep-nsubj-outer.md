...
6	zijn	zijn	AUX	WW|pv|tgw|mv	Mood=Ind|Number=Plur|Tense=Pres|VerbForm=Fin	12	cop	12:cop	_
...
10	een	een	DET	LID|onbep|stan|agr	Definite=Ind|PronType=Art	11	det	11:det	_
11	gedicht	gedicht	NOUN	N|soort|ev|basis|onz|stan	Gender=Neut|Number=Sing	12	obl	12:obl:voor	_
12	betekent	betekenen	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	SpaceAfter=No
13	,	,	PUNCT	LET	_	14	punct	14:punct	_
14	zei	zeggen	VERB	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	12	parataxis	12:parataxis	_
...
2	is	zijn	AUX	WW|pv|tgw|ev	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	6	cop	6:cop	_
...
6	wil	willen	VERB	WW|pv|tgw|ev	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	_
...
3	doet	doen	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	_
...
8	architect	architect	NOUN	N|soort|ev|basis|zijd|stan	Gender=Com|Number=Sing	3	ccomp	3:ccomp	_
9	is	zijn	AUX	WW|pv|tgw|ev	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	8	cop	8:cop	SpaceAfter=No
