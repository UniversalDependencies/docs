...
9	Одессы	Одесса	PROPN	_	Animacy=Inan|Case=Gen|Gender=Fem|NameType=Geo|Number=Sing	8	nmod	8:nmod:gen	SpaceAfter=No
...
4	чем	что	PRON	_	Animacy=Inan|Case=Loc|Gender=Neut|Number=Sing|PronType=Int,Rel	7	obl	7:obl:в:loc	_
...
9	Запада	Запад	PROPN	_	Animacy=Inan|Case=Gen|Gender=Masc|NameType=Geo|Number=Sing	7	obl	7:obl:от:gen	_
10	-	-	PUNCT	_	_	14	punct	14:punct	_
11	прежде	прежде	ADP	_	ExtPos=ADV	14	advmod	14:advmod	_
12	всего	всё	PRON	_	Animacy=Inan|Case=Gen|Gender=Neut|Number=Sing|PronType=Tot	11	fixed	11:fixed	_
...
1	А	а	CCONJ	_	ExtPos=CCONJ	4	cc	4:cc	_
2	также	также	PART	_	_	1	fixed	1:fixed	_
3	к	к	ADP	_	_	4	case	4:case	_
4	тому	то	PRON	_	Animacy=Inan|Case=Dat|Gender=Neut|Number=Sing|PronType=Dem	0	root	0:root	SpaceAfter=No
...
10	которых	который	DET	_	Case=Loc|Number=Plur|PronType=Rel	15	obl	7:ref	_
...
13	было	быть	AUX	_	Gender=Neut|Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin|Voice=Act	15	cop	15:cop	_
...
17	НАТО	НАТО	PROPN	_	Abbr=Yes|NameType=Com	15	nmod	15:nmod:в:loc	SpaceAfter=No
18	,	,	PUNCT	_	_	15	punct	15:punct	_
19	оно	оно	PRON	_	Case=Nom|Gender=Neut|Number=Sing|Person=3|PronType=Prs	21	nsubj	21:nsubj	_
