...
191 nodes (1%) are attached to their parents as `nummod`.

191 instances of `nummod` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.06806282722513.

The following 3 pairs of parts of speech are connected with `nummod`: <tt><a href="es_pud-pos-NOUN.html">NOUN</a></tt>-<tt><a href="es_pud-pos-NUM.html">NUM</a></tt> (164; 86% instances), <tt><a href="es_pud-pos-SYM.html">SYM</a></tt>-<tt><a href="es_pud-pos-NUM.html">NUM</a></tt> (21; 11% instances), <tt><a href="es_pud-pos-NUM.html">NUM</a></tt>-<tt><a href="es_pud-pos-NUM.html">NUM</a></tt> (6; 3% instances).
...
# visual-style 7	fgColor:white
# visual-style 7 6 nummod	color:blue
1	Ciudades	ciudad	NOUN	NN	Gender=Fem|Number=Plur	4	nsubj	_	_
2	como	como	ADP	IN	_	3	case	_	_
3	Milán	Milán	PROPN	NNP	Number=Sing	1	nmod	_	_
4	dependían	depender	VERB	VBC	Mood=Ind|Number=Plur|Person=3|Tense=Imp|VerbForm=Fin	0	root	_	_
...
6	más	más	ADV	RBR	Degree=Cmp	4	xcomp	_	_
...
10	millones	millón	NOUN	NN	Gender=Masc|Number=Plur	6	obl	_	_
11	de	de	ADP	IN	_	12	case	_	_
12	dólares	dólar	NOUN	NN	Gender=Masc|Number=Plur	10	nmod	_	_
13	y	y	CCONJ	CC	_	14	cc	_	_
14	cuenta	contar	VERB	VBC	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	4	conj	_	_
15	con	con	ADP	IN	_	16	case	_	_
16	más	más	ADV	RBR	Degree=Cmp	14	xcomp	_	_
