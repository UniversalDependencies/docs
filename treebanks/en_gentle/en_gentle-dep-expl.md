...
31 instances of `expl` (91%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.52941176470588.

The following 4 pairs of parts of speech are connected with `expl`: <tt><a href="en_gentle-pos-VERB.html">VERB</a></tt>-<tt><a href="en_gentle-pos-PRON.html">PRON</a></tt> (30; 88% instances), <tt><a href="en_gentle-pos-ADJ.html">ADJ</a></tt>-<tt><a href="en_gentle-pos-PRON.html">PRON</a></tt> (2; 6% instances), <tt><a href="en_gentle-pos-ADV.html">ADV</a></tt>-<tt><a href="en_gentle-pos-PRON.html">PRON</a></tt> (1; 3% instances), <tt><a href="en_gentle-pos-AUX.html">AUX</a></tt>-<tt><a href="en_gentle-pos-PRON.html">PRON</a></tt> (1; 3% instances).
...
1	There	there	PRON	EX	PronType=Dem	2	expl	2:expl	Discourse=joint-list_m:44->39:0:_|PDTB=Implicit:Expansion.Conjunction:and:_:338-359:360-365
...
1	IT	it	PRON	PRP	Case=Nom|Gender=Neut|Number=Sing|Person=3|PronType=Prs	8	expl	8:expl	Discourse=context-background:2->9:3:_|Entity=(2-event-new-nnnnn-cf3-1-cata)
2	was	be	AUX	VBD	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	8	cop	8:cop	_
3	many	many	ADJ	JJ	Degree=Pos	7	amod	7:amod	Entity=(3-time-new-snnnn-cf7-6-sgl
...
7	year	year	NOUN	NN	Number=Sing	8	obl:unmarked	8:obl:unmarked	_
...
11	a	a	DET	DT	Definite=Ind|PronType=Art	12	det	12:det	Entity=(4-place-new-sssnn-cf6-2-coref
12	kingdom	kingdom	NOUN	NN	Number=Sing	8	obl	8:obl:in	MSeg=king-dom
13	by	by	ADP	IN	_	15	case	15:case	_
14	the	the	DET	DT	Definite=Def|PronType=Art	15	det	15:det	Entity=(5-place-acc:com-sssns-cf4-2-coref
15	sea	sea	NOUN	NN	Number=Sing	12	nmod	12:nmod:by	Entity=5)4)|SpaceAfter=No
16	,	,	PUNCT	,	_	21	punct	21:punct	_
17	That	that	SCONJ	IN	_	21	mark	21:mark	Entity=(2-event-acc:com-nnnnn-cf3-5,15-coref
18	a	a	DET	DT	Definite=Ind|PronType=Art	19	det	19:det	Entity=(1-person-giv:act-sssss-cf1*-2-coref
...
27	the	the	DET	DT	Definite=Def|PronType=Art	28	det	28:det	Entity=(7-abstract-new-nnnnn-cf5-2,5-sgl
28	name	name	NOUN	NN	Number=Sing	25	obl	25:obl:by	_
29	of	of	ADP	IN	_	30	case	30:case	_
30	ANNABEL	Annabel	PROPN	NNP	Number=Sing	28	nmod	28:nmod:of	_
31	LEE	Lee	PROPN	NNP	Number=Sing	30	flat	30:flat	Entity=7)2)|SpaceAfter=No
