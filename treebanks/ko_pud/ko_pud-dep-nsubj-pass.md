...
Average distance between parent and child is 4.175.
...
1	하지만	_	CCONJ	CC	_	14	advmod	_	Translit=.ha.ji.man
2	흡연에	흡연	NOUN	NN+CM	Polite=Form	5	obl	_	MSeg=흡연-에|Translit=.heub.yeon.e|LTranslit=.heub.yeon
3	직접	_	ADV	RB	_	5	advmod	_	Translit=.jig.jeob
4	노출되지	_	NOUN	NN	_	5	obl	_	OrigDeprel=aux|SpaceAfter=No|Translit=.no.chul.doe.ji
5	않는	_	VERB	VX	Form=Adn	6	acl:relcl	_	Translit=.anh.neun
6	방광	_	NOUN	NN	_	7	compound	_	Translit=.bang.gwang
7	등의	등	NOUN	NNB+CM	Case=Gen|Polite=Form	8	nmod:poss	_	MSeg=등-의|Translit=.deung.yi|LTranslit=.deung
8	조직에서	조직	NOUN	NN+CM	Polite=Form	14	obl	_	SpaceAfter=No|MSeg=조직-에서|Translit=.jo.jig.e.seo|LTranslit=.jo.jig
9	는	는	PART	AP	_	8	case	_	Translit=.neun|LTranslit=.neun
10	이와	이	PRON	PRD+CM	Polite=Form	11	obl	_	MSeg=이-와|Translit=.i.wa|LTranslit=.i
11	똑같은	_	ADJ	JJ	Form=Adn	12	acl:relcl	_	Translit=.ddog.gat.eun
12	패턴이	패턴	NOUN	NN+CM	Case=Nom|Polite=Form	14	nsubj:pass	_	MSeg=패턴-이|Translit=.pae.teon.i|LTranslit=.pae.teon
13	발견되지	_	NOUN	NN	_	14	obl	_	OrigDeprel=aux|SpaceAfter=No|Translit=.bal.gyeon.doe.ji
14	않았다	_	VERB	VX	Mood=Ind|Tense=Past|VerbForm=Fin	0	root	_	SpaceAfter=No|Translit=.anh.ass.da
...
1	도널드	_	PROPN	NNP	_	4	nsubj:pass	_	Translit=.do.neol.deu
2	트럼프	_	PROPN	NNP	_	1	flat:name	_	SpaceAfter=No|Translit=.teu.reom.peu
3	가	가	PART	CM	Case=Nom|Polite=Form	1	case	_	Translit=.ga|LTranslit=.ga
4	당선되면	_	NOUN	NN	_	13	advcl	_	SpaceAfter=No|Translit=.dang.seon.doe.myeon
5	그	_	DET	DT	_	6	det	_	Translit=.geu
6	즉시	_	NOUN	NN	_	13	obl	_	Translit=.jeug.si
7	세계	_	NOUN	NN	_	8	compound	_	Translit=.se.gye
8	정세가	정세	NOUN	NN+CM	Case=Nom|Polite=Form	13	nsubj:pass	_	MSeg=정세-가|Translit=.jeong.se.ga|LTranslit=.jeong.se
9	지금보다	지금	NOUN	NN+CM	Polite=Form	12	obl	_	MSeg=지금-보다|Translit=.ji.geum.bo.da|LTranslit=.ji.geum
10	더욱	_	ADV	RB	_	12	advmod	_	Translit=.deo.ug
