...
There are 16 `INTJ` lemmas (0%), 16 `INTJ` types (0%) and 1508 `INTJ` tokens (1%).
...
The form / lemma ratio of `INTJ` is 1.000000 (the average of all parts of speech is 1.728233).
