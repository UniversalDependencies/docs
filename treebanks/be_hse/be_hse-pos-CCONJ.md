...
There are 33 `CCONJ` lemmas (0%), 35 `CCONJ` types (0%) and 9001 `CCONJ` tokens (3%).
...
The form / lemma ratio of `CCONJ` is 1.060606 (the average of all parts of speech is 1.756773).
