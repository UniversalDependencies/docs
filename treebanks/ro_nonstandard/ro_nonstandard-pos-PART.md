...
`PART` occurs with 1 features: <tt><a href="ro_nonstandard-feat-PartType.html">PartType</a></tt> (12440; 100% instances)

`PART` occurs with 2 feature-value pairs: `PartType=Inf`, `PartType=Sub`

`PART` occurs with 3 feature combinations.
The most frequent feature combination is `PartType=Sub` (10874 tokens).
...
12449 (100%) `PART` nodes are leaves.

5 (0%) `PART` nodes have one child.

The highest child degree of a `PART` node is 1.

Children of `PART` nodes are attached using 2 different relations: <tt><a href="ro_nonstandard-dep-punct.html">punct</a></tt> (3; 60% instances), <tt><a href="ro_nonstandard-dep-fixed.html">fixed</a></tt> (2; 40% instances)

Children of `PART` nodes belong to 2 different parts of speech: <tt><a href="ro_nonstandard-pos-PUNCT.html">PUNCT</a></tt> (3; 60% instances), <tt><a href="ro_nonstandard-pos-PART.html">PART</a></tt> (2; 40% instances)
