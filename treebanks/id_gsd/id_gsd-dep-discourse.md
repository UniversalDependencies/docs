...
4	bertanya	tanya	VERB	VSA	Voice=Act	0	root	_	SpaceAfter=No|Morf=^ber+tanya<v>_VSA$
...
13	berkulit	kulit	VERB	VSA	Voice=Act	10	acl:relcl	_	Morf=^ber+kulit<n>_VSA$
...
10	lihat	lihat	VERB	VSA	Voice=Act	0	root	_	Morf=^lihat<v>_VSA$
