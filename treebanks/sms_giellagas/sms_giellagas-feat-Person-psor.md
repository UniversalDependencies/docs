...
43 tokens (1%) have a non-empty value of `Person[psor]`.
...
42 <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> tokens (11% of all `NOUN` tokens) have a non-empty value of `Person[psor]`.
