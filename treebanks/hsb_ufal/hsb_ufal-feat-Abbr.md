...
The feature is used with 11 part-of-speech tags: <tt><a href="hsb_ufal-pos-NOUN.html">NOUN</a></tt> (77; 1% instances), <tt><a href="hsb_ufal-pos-ADP.html">ADP</a></tt> (38; 0% instances), <tt><a href="hsb_ufal-pos-DET.html">DET</a></tt> (37; 0% instances), <tt><a href="hsb_ufal-pos-PROPN.html">PROPN</a></tt> (10; 0% instances), <tt><a href="hsb_ufal-pos-X.html">X</a></tt> (8; 0% instances), <tt><a href="hsb_ufal-pos-ADV.html">ADV</a></tt> (6; 0% instances), <tt><a href="hsb_ufal-pos-ADJ.html">ADJ</a></tt> (4; 0% instances), <tt><a href="hsb_ufal-pos-NUM.html">NUM</a></tt> (4; 0% instances), <tt><a href="hsb_ufal-pos-PRON.html">PRON</a></tt> (3; 0% instances), <tt><a href="hsb_ufal-pos-VERB.html">VERB</a></tt> (3; 0% instances), <tt><a href="hsb_ufal-pos-SYM.html">SYM</a></tt> (2; 0% instances).

### `NOUN`

77 <tt><a href="hsb_ufal-pos-NOUN.html">NOUN</a></tt> tokens (3% of all `NOUN` tokens) have a non-empty value of `Abbr`.

The most frequent other feature values with which `NOUN` and `Abbr` co-occurred: <tt><a href="hsb_ufal-feat-Number.html">Number</a></tt><tt>=Sing</tt> (61; 79%), <tt><a href="hsb_ufal-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (51; 66%).

`NOUN` tokens may have the following values of `Abbr`:

* `Yes` (77; 100% of non-empty `Abbr`): <em>l, př, km, m, Mio, CEST, hodź, jan, dr, nakł</em>
* `EMPTY` (2471): <em>město, rěč, woda, rěčow, lěta, stolica, lěće, kilometrow, mócnarstwo, nastawki</em>
...
37 <tt><a href="hsb_ufal-pos-DET.html">DET</a></tt> tokens (12% of all `DET` tokens) have a non-empty value of `Abbr`.
...
* `EMPTY` (274): <em>kotrež, tute, jeho, jich, kotryž, kotraž, tutón, swoje, tuta, wšě</em>
...
* `EMPTY` (533): <em>tež, tak, hišće, zwjetša, wjele, něhdźe, wjace, hižo, tu, najprjedy</em>
...
4 <tt><a href="hsb_ufal-pos-NUM.html">NUM</a></tt> tokens (1% of all `NUM` tokens) have a non-empty value of `Abbr`.

The most frequent other feature values with which `NUM` and `Abbr` co-occurred: <tt><a href="hsb_ufal-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (4; 100%).

`NUM` tokens may have the following values of `Abbr`:

* `Yes` (4; 100% of non-empty `Abbr`): <em>III, 02625</em>
* `EMPTY` (373): <em>2, 1, 6, 4, 3, jedyn, 5, 7, I, 000</em>
...
* `EMPTY` (819): <em>ma, leži, móže, wobsahuje, móžeš, su, hlej, maja, rěči, běchu</em>
...
<tt>ADP --[<tt><a href="hsb_ufal-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (1; 100%),
