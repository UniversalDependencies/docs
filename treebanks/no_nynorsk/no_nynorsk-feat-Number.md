...
14577 <tt><a href="no_nynorsk-pos-NOUN.html">NOUN</a></tt> tokens (26% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="no_nynorsk-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (9830; 67%).
...
<table>
  <tr><th>Paradigm <i>ny</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="no_nynorsk-feat-Definite.html">Definite</a></tt><tt>=Ind</tt>|<tt><a href="no_nynorsk-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td><em>Nytt</em></td><td></td></tr>
  <tr><td><tt></tt></td><td></td><td><em>nye</em></td></tr>
</table>

`Number` seems to be **lexical feature** of `ADJ`. 100% lemmas (1612) occur only with one value of `Number`.

### `PRON`

4609 <tt><a href="no_nynorsk-pos-PRON.html">PRON</a></tt> tokens (24% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="no_nynorsk-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (4605; 100%), <tt><a href="no_nynorsk-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (4375; 95%), <tt><a href="no_nynorsk-feat-Animacy.html">Animacy</a></tt><tt>=Hum</tt> (3903; 85%), <tt><a href="no_nynorsk-feat-Case.html">Case</a></tt><tt>=Nom</tt> (3247; 70%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (4601; 100% of non-empty `Number`): <em>dei, vi, me, oss, sine, alle, våre, de, ingen, kvarandre</em>
* `Sing` (8; 0% of non-empty `Number`): <em>eg, ha, Dette, dét, man</em>
* `EMPTY` (14757): <em>det, han, eg, seg, ein, dette, ho, du, kva, noko</em>

`Number` seems to be **lexical feature** of `PRON`. 100% lemmas (26) occur only with one value of `Number`.
...
<tt>NOUN --[<tt><a href="no_nynorsk-dep-amod.html">amod</a></tt>]--> ADJ</tt> (3864; 77%),
<tt>NOUN --[<tt><a href="no_nynorsk-dep-det.html">det</a></tt>]--> DET</tt> (2389; 94%),
<tt>NOUN --[<tt><a href="no_nynorsk-dep-nummod.html">nummod</a></tt>]--> NUM</tt> (1870; 94%),
<tt>NOUN --[<tt><a href="no_nynorsk-dep-nmod-poss.html">nmod:poss</a></tt>]--> PRON</tt> (370; 98%),
<tt>ADJ --[<tt><a href="no_nynorsk-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (302; 70%),
<tt>ADJ --[<tt><a href="no_nynorsk-dep-conj.html">conj</a></tt>]--> ADJ</tt> (231; 79%),
<tt>ADJ --[<tt><a href="no_nynorsk-dep-det.html">det</a></tt>]--> DET</tt> (213; 74%),
<tt>ADJ --[<tt><a href="no_nynorsk-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (187; 83%),
<tt>NUM --[<tt><a href="no_nynorsk-dep-conj.html">conj</a></tt>]--> NUM</tt> (175; 100%),
<tt>ADJ --[<tt><a href="no_nynorsk-dep-nsubj-pass.html">nsubj:pass</a></tt>]--> NOUN</tt> (117; 66%).
