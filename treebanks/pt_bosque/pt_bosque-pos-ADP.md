...
There are 90 `ADP` lemmas (0%), 89 `ADP` types (0%) and 33788 `ADP` tokens (15%).
...
The form / lemma ratio of `ADP` is 0.988889 (the average of all parts of speech is 1.414631).
