---
layout: base
title:  'Statistics of amod:attlvc in UD_Hungarian'
udver: '2'
---

## Treebank Statistics: UD_Hungarian: Relations: `amod:attlvc`

This relation is a language-specific subtype of .
There are also 3 other language-specific subtypes of `amod`: <tt><a href="hu-dep-amod-att.html">amod:att</a></tt>, <tt><a href="hu-dep-amod-mode.html">amod:mode</a></tt>, <tt><a href="hu-dep-amod-obl.html">amod:obl</a></tt>.
...
The following 1 pairs of parts of speech are connected with `amod:attlvc`: <tt><a href="hu-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hu-pos-ADJ.html">ADJ</a></tt> (3; 100% instances).
