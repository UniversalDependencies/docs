...
There are 46 `DET` lemmas (3%), 51 `DET` types (2%) and 944 `DET` tokens (9%).
...
The form / lemma ratio of `DET` is 1.108696 (the average of all parts of speech is 1.484900).

The 1st highest number of forms (4) was observed with the lemma “_”: <em>Non, n, nicanca, sikih</em>.

The 2nd highest number of forms (3) was observed with the lemma “el”: <em>El, l, las</em>.

The 3rd highest number of forms (3) was observed with the lemma “in”: <em>in, n, nin</em>.
