...
The 10 most frequent `AUX` types:  <em>вӧлі, из, абу, выйым, оз, вӧліс, ог, были, вӧв, он</em>

The 10 most frequent ambiguous lemmas: <em>быть</em> (<tt><a href="kpv_ikdp-pos-AUX.html">AUX</a></tt> 3, <tt><a href="kpv_ikdp-pos-VERB.html">VERB</a></tt> 1), <em>кутны</em> (<tt><a href="kpv_ikdp-pos-AUX.html">AUX</a></tt> 2, <tt><a href="kpv_ikdp-pos-VERB.html">VERB</a></tt> 1)
...
The form / lemma ratio of `AUX` is 2.000000 (the average of all parts of speech is 1.333333).
...
48 (83%) `AUX` nodes are leaves.

9 (16%) `AUX` nodes have one child.

1 (2%) `AUX` nodes have two children.

The highest child degree of a `AUX` node is 2.

Children of `AUX` nodes are attached using 2 different relations: <tt><a href="kpv_ikdp-dep-punct.html">punct</a></tt> (9; 82% instances), <tt><a href="kpv_ikdp-dep-reparandum.html">reparandum</a></tt> (2; 18% instances)

Children of `AUX` nodes belong to 2 different parts of speech: <tt><a href="kpv_ikdp-pos-PUNCT.html">PUNCT</a></tt> (9; 82% instances), <tt><a href="kpv_ikdp-pos-AUX.html">AUX</a></tt> (2; 18% instances)
