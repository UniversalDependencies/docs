...
116424 tokens (42%) have a non-empty value of `Gender`.
12735 types (54%) occur at least once with a non-empty value of `Gender`.
8513 lemmas (54%) occur at least once with a non-empty value of `Gender`.
The feature is used with 14 part-of-speech tags: <tt><a href="it_vit-pos-NOUN.html">NOUN</a></tt> (54628; 20% instances), <tt><a href="it_vit-pos-DET.html">DET</a></tt> (37730; 13% instances), <tt><a href="it_vit-pos-ADJ.html">ADJ</a></tt> (12475; 4% instances), <tt><a href="it_vit-pos-VERB.html">VERB</a></tt> (7831; 3% instances), <tt><a href="it_vit-pos-PRON.html">PRON</a></tt> (2754; 1% instances), <tt><a href="it_vit-pos-AUX.html">AUX</a></tt> (668; 0% instances), <tt><a href="it_vit-pos-ADV.html">ADV</a></tt> (156; 0% instances), <tt><a href="it_vit-pos-NUM.html">NUM</a></tt> (99; 0% instances), <tt><a href="it_vit-pos-X.html">X</a></tt> (59; 0% instances), <tt><a href="it_vit-pos-ADP.html">ADP</a></tt> (8; 0% instances), <tt><a href="it_vit-pos-SCONJ.html">SCONJ</a></tt> (8; 0% instances), <tt><a href="it_vit-pos-CCONJ.html">CCONJ</a></tt> (6; 0% instances), <tt><a href="it_vit-pos-INTJ.html">INTJ</a></tt> (1; 0% instances), <tt><a href="it_vit-pos-PUNCT.html">PUNCT</a></tt> (1; 0% instances).

### `NOUN`

54628 <tt><a href="it_vit-pos-NOUN.html">NOUN</a></tt> tokens (95% of all `NOUN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NOUN` and `Gender` co-occurred: <tt><a href="it_vit-feat-Number.html">Number</a></tt><tt>=Sing</tt> (34465; 63%).

`NOUN` tokens may have the following values of `Gender`:

* `Fem` (24065; 44% of non-empty `Gender`): <em>società, attività, parte, legge, titolarità, provincia, città, sede, domanda, gestione</em>
* `Masc` (30563; 56% of non-empty `Gender`): <em>anni, miliardi, anno, posti, presidente, punto, governo, stato, gruppo, lavoro</em>
* `EMPTY` (3128): <em>n., art., insegnanti, dpr, a, mila, b, docenti, dl, via</em>
...
`Gender` seems to be **lexical feature** of `NOUN`. 99% lemmas (5505) occur only with one value of `Gender`.

### `DET`

37730 <tt><a href="it_vit-pos-DET.html">DET</a></tt> tokens (86% of all `DET` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `DET` and `Gender` co-occurred: <tt><a href="it_vit-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (34988; 93%), <tt><a href="it_vit-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (30875; 82%), <tt><a href="it_vit-feat-Number.html">Number</a></tt><tt>=Sing</tt> (25952; 69%).

`DET` tokens may have the following values of `Gender`:

* `Fem` (15861; 42% of non-empty `Gender`): <em>la, le, una, un', sua, questa, tutte, queste, sue, quella</em>
* `Masc` (21869; 58% of non-empty `Gender`): <em>il, i, un, gli, lo, questo, suo, tutti, questi, uno</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="it_vit-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td><em>le</em></td></tr>
</table>

### `ADJ`

12475 <tt><a href="it_vit-pos-ADJ.html">ADJ</a></tt> tokens (62% of all `ADJ` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `ADJ` and `Gender` co-occurred: <tt><a href="it_vit-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7817; 63%).

`ADJ` tokens may have the following values of `Gender`:

* `Fem` (5641; 45% of non-empty `Gender`): <em>altre, nuova, italiana, altra, nuove, politica, stessa, pubblica, economica, politiche</em>
* `Masc` (6834; 55% of non-empty `Gender`): <em>altri, nuovo, economico, stesso, nuovi, scorso, altro, finanziario, ultimo, italiano</em>
* `EMPTY` (7649): <em>precedente, primo, grande, presente, ex, netto, generale, grandi, nazionale, sociale</em>
...
7831 <tt><a href="it_vit-pos-VERB.html">VERB</a></tt> tokens (37% of all `VERB` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `VERB` and `Gender` co-occurred: <tt><a href="it_vit-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (7831; 100%), <tt><a href="it_vit-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (7831; 100%), <tt><a href="it_vit-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (7770; 99%), <tt><a href="it_vit-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (7770; 99%), <tt><a href="it_vit-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5632; 72%).

`VERB` tokens may have the following values of `Gender`:

* `Fem` (2288; 29% of non-empty `Gender`): <em>prevista, indicate, presentata, comprese, effettuata, fatta, richiesta, data, previste, richieste</em>
* `Masc` (5543; 71% of non-empty `Gender`): <em>fatto, detto, approvato, previsto, avuto, previsti, deciso, ottenuto, visto, dato</em>
* `EMPTY` (13605): <em>è, ha, fare, fa, far, hanno, dice, sono, avere, scade</em>
...
* `EMPTY` (7062): <em>che, si, cui, ci, c', ne, mi, dove, chi, quali</em>
...
* `EMPTY` (6295): <em>due, tre, cento, 15, 1, 1973, 2, quattro, 30, 6</em>
...
* `EMPTY` (347): <em>joint, venture, baby, cd, sitter, rom, condicio, est, facile, news</em>
...
* `EMPTY` (45630): <em>di, a, in, per, da, con, su, tra, ad, come</em>
...
<tt>NOUN --[<tt><a href="it_vit-dep-det.html">det</a></tt>]--> DET</tt> (30332; 83%),
<tt>NOUN --[<tt><a href="it_vit-dep-amod.html">amod</a></tt>]--> ADJ</tt> (9791; 61%),
<tt>NOUN --[<tt><a href="it_vit-dep-conj.html">conj</a></tt>]--> NOUN</tt> (2590; 58%),
<tt>NOUN --[<tt><a href="it_vit-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (1307; 76%),
<tt>VERB --[<tt><a href="it_vit-dep-nsubj-pass.html">nsubj:pass</a></tt>]--> NOUN</tt> (1077; 94%),
...
<tt>NOUN --[<tt><a href="it_vit-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (163; 53%),
