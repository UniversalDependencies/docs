...
The feature is used with 4 part-of-speech tags: [-pos/NOUN]() (27; 0% instances), [-pos/ADJ]() (4; 0% instances), [-pos/ADV]() (3; 0% instances), [-pos/PRON]() (1; 0% instances).

### `NOUN`

27 [-pos/NOUN]() tokens (0% of all `NOUN` tokens) have a non-empty value of `Abbr`.
...
4 [-pos/ADJ]() tokens (0% of all `ADJ` tokens) have a non-empty value of `Abbr`.
...
3 [-pos/ADV]() tokens (0% of all `ADV` tokens) have a non-empty value of `Abbr`.
...
1 [-pos/PRON]() tokens (0% of all `PRON` tokens) have a non-empty value of `Abbr`.
