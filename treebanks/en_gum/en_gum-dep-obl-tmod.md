...
1	Today	today	NOUN	NN	Number=Sing	7	obl:tmod	_	Entity=(time-17)|SpaceAfter=No
2	,	,	PUNCT	,	_	1	punct	_	_
3	textile	textile	NOUN	NN	Number=Sing	6	compound	_	Entity=(place-18(substance-19)
4	and	and	CCONJ	CC	_	5	cc	_	_
5	steel	steel	NOUN	NN	Number=Sing	3	conj	_	Entity=(substance-20)
6	mills	mill	NOUN	NNS	Number=Plur	7	nsubj	_	Entity=place-18)
7	take	take	VERB	VBP	Mood=Ind|Tense=Pres|VerbForm=Fin	0	root	_	_
8	their	their	PRON	PRP$	Number=Plur|Person=3|Poss=Yes|PronType=Prs	9	nmod:poss	_	Entity=(object-16)
...
3	June	June	PROPN	NNP	Number=Sing	4	compound	_	Entity=(time-4(time-5)
4	11	11	NUM	CD	NumType=Card	1	obl:tmod	_	SpaceAfter=No
5	,	,	PUNCT	,	_	6	punct	_	_
6	1988	1988	NUM	CD	NumType=Card	4	nmod:tmod	_	Entity=(time-6)time-4)
7	(	(	PUNCT	-LRB-	_	9	punct	_	SpaceAfter=No
8	age	age	NOUN	NN	Number=Sing	9	nsubj	_	Entity=(abstract-7
9	30	30	NUM	CD	NumType=Card	1	parataxis	_	Entity=abstract-7)|SpaceAfter=No
...
3	the	the	DET	DT	Definite=Def|PronType=Art	4	det	_	Entity=(abstract-91
4	horror	horror	NOUN	NN	Number=Sing	8	nsubj	_	_
5	of	of	ADP	IN	_	6	case	_	_
6	it	it	PRON	PRP	Case=Acc|Gender=Neut|Number=Sing|Person=3|PronType=Prs	4	nmod	_	Entity=(event-81
7	all	all	DET	DT	_	6	det	_	Entity=abstract-91)event-81)
...
15	Sonia	Sonia	PROPN	NNP	Number=Sing	17	vocative	_	Entity=(animal-79)|SpaceAfter=No
