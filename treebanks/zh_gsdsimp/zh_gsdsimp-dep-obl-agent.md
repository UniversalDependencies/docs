---
layout: base
title:  'Statistics of obl:agent in UD_Chinese-GSDSimp'
udver: '2'
---

## Treebank Statistics: UD_Chinese-GSDSimp: Relations: `obl:agent`

This relation is a language-specific subtype of <tt><a href="zh_gsdsimp-dep-obl.html">obl</a></tt>.
There are also 1 other language-specific subtypes of `obl`: <tt><a href="zh_gsdsimp-dep-obl-patient.html">obl:patient</a></tt>.

70 nodes (0%) are attached to their parents as `obl:agent`.

70 instances of `obl:agent` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.05714285714286.

The following 4 pairs of parts of speech are connected with `obl:agent`: <tt><a href="zh_gsdsimp-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsdsimp-pos-NOUN.html">NOUN</a></tt> (44; 63% instances), <tt><a href="zh_gsdsimp-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsdsimp-pos-PART.html">PART</a></tt> (14; 20% instances), <tt><a href="zh_gsdsimp-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsdsimp-pos-PROPN.html">PROPN</a></tt> (11; 16% instances), <tt><a href="zh_gsdsimp-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsdsimp-pos-X.html">X</a></tt> (1; 1% instances).
...
2	其	其	PRON	PRP	Person=3	4	nmod	_	SpaceAfter=No|Translit=qí|LTranslit=qí
3	秘密	秘密	NOUN	NN	_	4	nmod	_	SpaceAfter=No|Translit=mìmì|LTranslit=mìmì
...
11	全	全	ADV	RB	_	12	advmod	_	SpaceAfter=No|Translit=quán|LTranslit=quán
12	遭	遭	VERB	VV	_	8	parataxis	_	SpaceAfter=No|Translit=zāo|LTranslit=zāo
13	冻结	冻结	VERB	VV	_	12	xcomp	_	SpaceAfter=No|Translit=dòngjié|LTranslit=dòngjié
14	，	，	PUNCT	,	_	15	punct	_	SpaceAfter=No|Translit=,|LTranslit=,
15	身败名裂	身败名裂	VERB	VV	_	8	parataxis	_	SpaceAfter=No|Translit=shēnbàimíngliè|LTranslit=shēnbàimíngliè
