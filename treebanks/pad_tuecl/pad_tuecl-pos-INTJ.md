---
layout: base
title:  'Statistics of INTJ in UD_Paumari-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Paumari-TueCL: POS Tags: `INTJ`

There are 1 `INTJ` lemmas (8%), 1 `INTJ` types (0%) and 1 `INTJ` tokens (0%).
Out of 13 observed tags, the rank of `INTJ` is: 6 in number of lemmas, 12 in number of types and 12 in number of tokens.

The 10 most frequent `INTJ` lemmas: <em>_</em>

The 10 most frequent `INTJ` types:  <em>Ha'a</em>
...
The form / lemma ratio of `INTJ` is 1.000000 (the average of all parts of speech is 20.846154).

The 1st highest number of forms (1) was observed with the lemma “_”: <em>Ha'a</em>.
...
`INTJ` nodes are attached to their parents using 1 different relations: <tt><a href="pad_tuecl-dep-obl.html">obl</a></tt> (1; 100% instances)

Parents of `INTJ` nodes belong to 1 different parts of speech: <tt><a href="pad_tuecl-pos-VERB.html">VERB</a></tt> (1; 100% instances)
