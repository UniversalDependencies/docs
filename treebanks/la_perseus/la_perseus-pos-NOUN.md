...
There are 1722 `NOUN` lemmas (35%), 3141 `NOUN` types (31%) and 6253 `NOUN` tokens (21%).
...
The form / lemma ratio of `NOUN` is 1.824042 (the average of all parts of speech is 2.101803).
...
`NOUN` occurs with 4 features: <tt><a href="la_perseus-feat-Gender.html">Gender</a></tt> (6253; 100% instances), <tt><a href="la_perseus-feat-Number.html">Number</a></tt> (6253; 100% instances), <tt><a href="la_perseus-feat-Case.html">Case</a></tt> (6252; 100% instances), <tt><a href="la_perseus-feat-VerbForm.html">VerbForm</a></tt> (1; 0% instances)
