---
layout: base
title:  'Statistics of dislocated in UD_Uyghur-UDT'
udver: '2'
---

## Treebank Statistics: UD_Uyghur-UDT: Relations: `dislocated`
...
1	ئۇ	ئۇ	PRON	P	Case=Nom|Number=Sing|Person=3|PronType=Prs	3	nsubj	_	Translit=u
...
12	غا	_	X	X	_	10	dislocated	_	Translit=gha|Morf=Unknown
13	قىزىقاتتى	_	VERB	V	_	0	root	_	SpaceAfter=No|Translit=qiziqatti|Morf=Unknown
...
# visual-style 16 18 dislocated	color:blue
1	_	_	PUNCT	Y	_	11	punct	_	Translit=_|Morf=Unknown
2	_	_	PUNCT	Y	_	11	punct	_	Translit=_|Morf=Unknown
3	قاراڭ	_	PART	T	_	6	discourse	_	Translit=qarang|Morf=Unknown
4	بۇ	بۇ	PRON	P	Case=Nom|PronType=Dem	5	det	_	Translit=bu
5	رەخت	رەخت	NOUN	N	Case=Nom	6	nsubj	_	Translit=rext
6	چىرايلىقمىكەن	_	NOUN	N	_	10	ccomp	_	SpaceAfter=No|Translit=chirayliqmiken|Morf=Unknown
7	؟	؟	PUNCT	Y	_	6	punct	_	Translit=?
8	_	_	PUNCT	Y	_	6	punct	_	Translit=_|Morf=Unknown
9	_	_	PUNCT	Y	_	6	punct	_	Translit=_|Morf=Unknown
10	دەپ	دە	VERB	V	Aspect=Perf|VerbForm=Conv	11	advcl	_	Translit=dep
...
18	نى	نى	DET	X	_	16	dislocated	_	Translit=ni
19	كۆرسىتىپتۇ	_	VERB	V	_	21	parataxis	_	SpaceAfter=No|Translit=körsitiptu|Morf=Unknown
20	،	،	PUNCT	Y	_	19	punct	_	Translit=,
21	چۈشۈندۈرۈپتۇ	_	VERB	V	_	0	root	_	SpaceAfter=No|Translit=chüshündürüptu|Morf=Unknown
22	.	.	PUNCT	Y	_	21	punct	_	Translit=.
...
7	"	"	PUNCT	Y	_	6	punct	_	Translit="
8	لىرىمىز	_	NOUN	N	_	6	dislocated	_	Translit=lirimiz|Morf=Unknown
9	بار	بار	VERB	A	Mood=Imp|VerbForm=Fin	0	root	_	SpaceAfter=No|Translit=bar
