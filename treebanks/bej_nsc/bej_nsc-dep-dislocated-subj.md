...
There are also 1 other language-specific subtypes of `dislocated`: <tt><a href="bej_nsc-dep-dislocated-det.html">dislocated:det</a></tt>.

2 nodes (0%) are attached to their parents as `dislocated:subj`.

1 instances of `dislocated:subj` (50%) are left-to-right (parent precedes child).
Average distance between parent and child is 11.

The following 2 pairs of parts of speech are connected with `dislocated:subj`: <tt><a href="bej_nsc-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_nsc-pos-NOUN.html">NOUN</a></tt> (1; 50% instances), <tt><a href="bej_nsc-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_nsc-pos-PRON.html">PRON</a></tt> (1; 50% instances).
...
# visual-style 4 8 dislocated:subj	color:blue
...
# visual-style 36 18 dislocated:subj	color:blue
