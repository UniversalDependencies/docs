...
300 tokens (1%) have a non-empty value of `NumType`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="cop_scriptorium-pos-NUM.html">NUM</a></tt> (300; 1% instances).

### `NUM`

300 <tt><a href="cop_scriptorium-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

`NUM` tokens may have the following values of `NumType`:

* `Card` (300; 100% of non-empty `NumType`): ⲟⲩⲁ, ⲥⲛⲁⲩ, ϣⲉ, ϣⲟⲙⲛⲧ, ⲙⲛⲧⲥⲛⲟⲟⲩⲥ, ⲙⲏⲧ, ⲥⲁϣϥ, ⲟⲩⲉⲓ, ⲧⲃⲁ, ⲥⲛⲧⲉ
...
<tt>NUM --[<tt><a href="cop_scriptorium-dep-obl-npmod.html">obl:npmod</a></tt>]--> NUM</tt> (18; 100%),
