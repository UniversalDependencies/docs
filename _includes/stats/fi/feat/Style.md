...
469 [fi-pos/ADV]() tokens (5% of all `ADV` tokens) have a non-empty value of `Style`.
...
* `Arch` (4; 2% of non-empty `Style`): <em>puolustusvoimain, nukkein, seurain</em>
...
* `Coll` (46; 100% of non-empty `Style`): <em>mut, mutt, ja/vai, vaikk</em>
