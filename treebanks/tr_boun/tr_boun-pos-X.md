...
The 10 most frequent `X` lemmas: <em>batıl, tefek, unperiodismo, |, ■</em>

The 10 most frequent `X` types:  <em>batıl, tefek, unperiodismo, |, ■</em>
...
The form / lemma ratio of `X` is 1.000000 (the average of all parts of speech is 2.413877).
...
The 3rd highest number of forms (1) was observed with the lemma “unperiodismo”: <em>unperiodismo</em>.

`X` occurs with 1 features: <tt><a href="tr_boun-feat-Echo.html">Echo</a></tt> (2; 40% instances)

`X` occurs with 1 feature-value pairs: `Echo=Rdp`

`X` occurs with 2 feature combinations.
The most frequent feature combination is `_` (3 tokens).
Examples: <em>unperiodismo, |, ■</em>


## Relations

`X` nodes are attached to their parents using 5 different relations: <tt><a href="tr_boun-dep-compound-redup.html">compound:redup</a></tt> (1; 20% instances), <tt><a href="tr_boun-dep-dep.html">dep</a></tt> (1; 20% instances), <tt><a href="tr_boun-dep-flat.html">flat</a></tt> (1; 20% instances), <tt><a href="tr_boun-dep-list.html">list</a></tt> (1; 20% instances), <tt><a href="tr_boun-dep-nmod.html">nmod</a></tt> (1; 20% instances)

Parents of `X` nodes belong to 3 different parts of speech: <tt><a href="tr_boun-pos-NOUN.html">NOUN</a></tt> (3; 60% instances), <tt><a href="tr_boun-pos-ADJ.html">ADJ</a></tt> (1; 20% instances), <tt><a href="tr_boun-pos-VERB.html">VERB</a></tt> (1; 20% instances)
