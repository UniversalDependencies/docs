...
The feature is used with 3 part-of-speech tags: <tt><a href="gd_arcosg-pos-VERB.html">VERB</a></tt> (8256; 9% instances), <tt><a href="gd_arcosg-pos-AUX.html">AUX</a></tt> (1164; 1% instances), <tt><a href="gd_arcosg-pos-PART.html">PART</a></tt> (220; 0% instances).

### `VERB`

8256 <tt><a href="gd_arcosg-pos-VERB.html">VERB</a></tt> tokens (90% of all `VERB` tokens) have a non-empty value of `Tense`.

`VERB` tokens may have the following values of `Tense`:

* `Fut` (1083; 13% of non-empty `Tense`): <em>bidh, feumaidh, bhios, bi, gheibh, thèid, tèid, nì, faodaidh, bheir</em>
* `Past` (4363; 53% of non-empty `Tense`): <em>bha, robh, chaidh, fhuair, thuirt, ars’, chuir, thàinig, bh', rinn</em>
* `Pres` (2810; 34% of non-empty `Tense`): <em>tha, eil, bheil, th', thà, th’, 'eil, thathar, thathas, 'l</em>
* `EMPTY` (915): <em>bhiodh, biodh, faigheadh, feuch, can, dh’fhaodadh, rachadh, dhèanadh, thigeadh, dèanadh</em>
...
1164 <tt><a href="gd_arcosg-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="gd_arcosg-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (863; 74%).

`AUX` tokens may have the following values of `Tense`:

* `Past` (260; 22% of non-empty `Tense`): <em>b', bu, b’</em>
* `Pres` (904; 78% of non-empty `Tense`): <em>'s, is, gur, as, chan, nach, an, cha, ‘s, gun</em>
* `EMPTY` (2): <em>'s, Is</em>
...
220 <tt><a href="gd_arcosg-pos-PART.html">PART</a></tt> tokens (2% of all `PART` tokens) have a non-empty value of `Tense`.
...
* `EMPTY` (8591): <em>a, a', gu, ag, cha, nach, air, gun, chan, an</em>

## Relations with Agreement in `Tense`

The 10 most frequent relations where parent and child node agree in `Tense`:
<tt>VERB --[<tt><a href="gd_arcosg-dep-conj.html">conj</a></tt>]--> VERB</tt> (891; 72%),
<tt>VERB --[<tt><a href="gd_arcosg-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (288; 62%),
...
<tt>VERB --[<tt><a href="gd_arcosg-dep-obl.html">obl</a></tt>]--> VERB</tt> (5; 63%),
