...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udlzh_kyoto22)<br />
...
<ul>
<li>This corpus contains 11176 sentences and 55026 tokens.</li>
</ul>

<ul>
<li>This corpus contains 54187 tokens (98%) that are not followed by a space.</li>
</ul>
...
<ul>
<li>This corpus uses 12 UPOS tags out of 17 possible: <a>ADP</a>, <a>ADV</a>, <a>AUX</a>, <a>CCONJ</a>, <a>INTJ</a>, <a>NOUN</a>, <a>NUM</a>, <a>PART</a>, <a>PRON</a>, <a>PROPN</a>, <a>SCONJ</a>, <a>VERB</a></li>
<li>This corpus does not use the following tags: ADJ, DET, SYM, PUNCT, X</li>
</ul>

<ul>
<li>This corpus contains 27 word types tagged as particles (PART): 乎, 也, 于, 侯, 兮, 其, 只, 哉, 夫, 如, 已, 思, 所, 攸, 歟, 焉, 然, 爾, 甫, 矣, 者, 而, 耳, 與, 蓋, 載, 逝</li>
</ul>

<ul>
<li>This corpus contains 38 lemmas tagged as pronouns (PRON): 之, 予, 他, 何, 余, 其, 厥, 吾, 夫, 奚, 女, 子, 孰, 它, 害, 己, 彼, 惟, 我, 或, 斯, 是, 時, 朕, 某, 此, 汝, 焉, 爰, 爾, 維, 而, 聿, 自, 茲, 言, 誰, 諸</li>
</ul>
...
<ul>
<li>This corpus contains 9 lemmas tagged as auxiliaries (AUX): 儀, 可, 宜, 得, 敢, 欲, 能, 見, 足</li>
</ul>

<ul>
<li>Out of the above, 7 lemmas occurred sometimes as AUX and sometimes as VERB: 可, 宜, 得, 敢, 欲, 見, 足</li>
</ul>
...
<ul>
  <li>Conv
  <ul>
    <li>VERB: 以, 無, 對, 然, 問, 與, 大, 善, 始, 獨</li>
  </ul>
  </li>
</ul>
...
<ul>
  <li>Part
  <ul>
    <li>VERB: 大, 小, 仁, 賢, 庶, 寡, 長, 有, 善, 終</li>
  </ul>
  </li>
</ul>
...
<ul>
  <li>Loc
    <ul>
      <li>NOUN: 天, 下, 上, 中, 地, 先, 位, 門, 海, 室</li>
      <li>PROPN: 齊, 周, 楚, 魯, 殷, 滕, 衛, 秦, 宋, 燕</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Tem
    <ul>
      <li>NOUN: 今, 後, 日, 時, 年, 古, 昔, 世, 歲, 月</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Pos
    <ul>
      <li>VERB: 大, 然, 仁, 善, 正, 小, 同, 可, 遠, 賢</li>
      <li>VERB-Conv: 然, 大, 善, 獨, 誠, 凡, 多, 難, 博, 亟</li>
      <li>VERB-Part: 大, 小, 仁, 賢, 庶, 寡, 善, 匹, 恆, 良</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Neg
    <ul>
      <li>ADV: 不, 非, 未, 莫, 弗, 勿, 毋</li>
      <li>VERB: 無, 微, 末, 罔, 靡</li>
      <li>VERB-Conv: 無, 罔, 靡</li>
      <li>VERB-Part: 無, 微</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Dem
    <ul>
      <li>PRON: 是, 此, 斯, 彼, 焉, 他, 夫, 惟, 茲, 爰</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>Prs
    <ul>
      <li>PRON: 之, 其, 吾, 我, 諸, 或, 子, 予, 己, 自</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li><a>NameType</a>
    <ul>
      ...
      <li>Giv
        <ul>
          <li>PROPN: 舜, 堯, 子路, 子貢, 湯, 禹, 由, 子夏, 子張, 章</li>
        </ul>
      </li>
      <li>Nat
        <ul>
          <li>PROPN: 齊, 周, 楚, 魯, 殷, 滕, 秦, 衛, 宋, 燕</li>
        </ul>
      </li>
      <li>Prs
        <ul>
          <li>PROPN: 孟子, 孔子, 文, 曾子, 武, 伯夷, 宣, 惠, 柳下, 告子</li>
        </ul>
      </li>
      <li>Sur
        <ul>
...
<ul>
  <li><a>NounType</a>
    <ul>
      <li>Class
        <ul>
          <li>NOUN: 里, 畝, 方, 尺, 寸, 步, 尋, 鎰, 仞, 羽</li>
        </ul>
      </li>
    </ul>
  </li>
...
<ul>
<li>This corpus uses 9 lemmas as auxiliaries (<a>aux</a>). Examples: 可, 能, 欲, 得, 敢, 足, 宜, 見, 儀.</li>
</ul>
...
<ul>
  <li><a>nsubj</a>
    <ul>
      <li>VERB--NOUN (2636)</li>
      <li>VERB--NOUN-ADP(之) (286)</li>
      <li>VERB--NOUN-ADP(也) (9)</li>
      <li>VERB--NOUN-Loc (246)</li>
      <li>VERB--NOUN-Loc-ADP(之) (43)</li>
      <li>VERB--NOUN-Loc-ADP(也) (2)</li>
      <li>VERB--NOUN-Tem (16)</li>
      <li>VERB--NOUN-Tem-ADP(之) (7)</li>
      <li>VERB--PRON (966)</li>
...
<ul>
  <li>This corpus contains 40 lemmas that occur at least once with a reflexive core object (<a>obj</a> or <a>iobj</a>). Examples: 正 己, 脩 己, 以 自, 求 己, 知 己, 使 己, 使 自, 克 己, 如 己, 成 己, 暴 自, 枉 己, 棄 自, 歸 己, 行 己, 伐 自, 侮 自, 勝 己, 厲 己, 好 自, 害 己, 得 己, 怨 自, 恭 己, 愈 己, 拯 己, 施 己, 有 己, 殺 己, 毀 自, 無 己, 由 己, 絜 己, 總 己, 舍 己, 艾 自, 視 己, 訓 己, 謗 己, 辱 己</li>
</ul>
