...
There are 12 `SCONJ` lemmas (0%), 20 `SCONJ` types (0%) and 750 `SCONJ` tokens (1%).
...
* <em>q</em>
  * <tt><a href="pt_dantestocks-pos-SCONJ.html">SCONJ</a></tt> 71: <em>#VALE5 será <b>q</b> hj vc irá repicar Valedita ? ?</em>
  * <tt><a href="pt_dantestocks-pos-PRON.html">PRON</a></tt> 58: <em>RT @BrazilFinance : PETR4 flying like an eagle , p <b>q</b> será não é ?</em>
...
The form / lemma ratio of `SCONJ` is 1.666667 (the average of all parts of speech is 1.238183).
...
`SCONJ` occurs with 2 features: <tt><a href="pt_dantestocks-feat-ExtPos.html">ExtPos</a></tt> (4; 1% instances), <tt><a href="pt_dantestocks-feat-Typo.html">Typo</a></tt> (1; 0% instances)
