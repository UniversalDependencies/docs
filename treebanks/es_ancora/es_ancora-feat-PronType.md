...
* `Int,Rel` (15; 0% of non-empty `PronType`): <em>cuantos, cuántos, cuánto, cuantas, cuánta</em>
...
565 <tt><a href="es_ancora-pos-ADV.html">ADV</a></tt> tokens (3% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="es_ancora-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (565; 100%), <tt><a href="es_ancora-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (565; 100%).

`ADV` tokens may have the following values of `PronType`:

* `Int` (41; 7% of non-empty `PronType`): <em>dónde, cuándo</em>
* `Rel` (524; 93% of non-empty `PronType`): <em>donde, cuando</em>
* `EMPTY` (17786): <em>no, más, también, ya, hoy, ayer, muy, sólo, después, ahora</em>
