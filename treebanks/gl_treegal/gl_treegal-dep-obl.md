...
1	Por	por	ADP	P	AdpType=Prep	3	case	_	_
2	esta	este	DET	Edfs	Gender=Fem|Number=Sing|PronType=Dem	3	det	_	_
3	razón	razón	NOUN	Scfs	Gender=Fem|Number=Sing	7	obl	_	_
4	a	o	DET	Ddfs	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	5	det	_	_
5	guitarra	guitarra	NOUN	Scfs	Gender=Fem|Number=Sing	7	nsubj	_	_
6	é	ser	AUX	Vpi30s	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	7	cop	_	_
