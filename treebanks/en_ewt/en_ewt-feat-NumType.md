...
5566 tokens (2%) have a non-empty value of `NumType`.
1325 types (7%) occur at least once with a non-empty value of `NumType`.
1281 lemmas (8%) occur at least once with a non-empty value of `NumType`.
...
* `EMPTY` (16555): <em>good, great, new, other, best, many, more, last, same, few</em>
...
* `EMPTY` (12352): <em>so, just, when, very, also, how, now, even, then, there</em>
...
* `EMPTY` (43048): <em>time, people, service, place, thanks, food, way, year, day, number</em>
...
* `EMPTY` (20089): <em>the, a, this, an, all, some, any, no, that, these</em>
