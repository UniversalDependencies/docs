---
layout: base
title:  'Statistics of Typo in UD_Irish-Cadhan'
udver: '2'
---

## Treebank Statistics: UD_Irish-Cadhan: Features: `Typo`
...
1 <tt><a href="ga_cadhan-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Typo`.

The most frequent other feature values with which `NOUN` and `Typo` co-occurred: <tt><a href="ga_cadhan-feat-Case.html">Case</a></tt><tt>=Gen</tt> (1; 100%), <tt><a href="ga_cadhan-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (1; 100%), <tt><a href="ga_cadhan-feat-Form.html">Form</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="ga_cadhan-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (1; 100%), <tt><a href="ga_cadhan-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1; 100%), <tt><a href="ga_cadhan-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (1; 100%).
...
* `Yes` (1; 100% of non-empty `Typo`): <em>ndubhairt</em>
