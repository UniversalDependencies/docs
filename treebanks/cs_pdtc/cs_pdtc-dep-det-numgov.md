...
220 nodes (0%) are attached to their parents as `det:numgov`.

210 instances of `det:numgov` (95%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.53181818181818.

The following 3 pairs of parts of speech are connected with `det:numgov`: <tt><a href="cs_pdt-pos-NOUN.html">NOUN</a></tt>-<tt><a href="cs_pdt-pos-DET.html">DET</a></tt> (214; 97% instances), <tt><a href="cs_pdt-pos-PRON.html">PRON</a></tt>-<tt><a href="cs_pdt-pos-DET.html">DET</a></tt> (4; 2% instances), <tt><a href="cs_pdt-pos-PROPN.html">PROPN</a></tt>-<tt><a href="cs_pdt-pos-DET.html">DET</a></tt> (2; 1% instances).
...
3	firmy	firma	NOUN	NNFP1-----A----	Case=Nom|Gender=Fem|Number=Plur	5	nsubj	5:nsubj	Entity=cmpr9415025c48)|Functor=5:ACT
...
10	teritorií	teritorium	NOUN	NNNP2-----A----	Case=Gen|Gender=Neut|Number=Plur	5	obl:arg	5:obl:arg:na:acc	Entity=cmpr9415025c36)|Functor=5:PAT|SpaceAfter=No
...
3	městě	město	NOUN	NNNS6-----A----	Case=Loc|Gender=Neut|Number=Sing	5	obl	5:obl:v:loc	Entity=cmpr9415025c23)|Functor=5:LOC
...
9	centru	centrum	NOUN	NNNS6-----A----	Case=Loc|Gender=Neut|Number=Sing	5	conj	10.1:dep	Functor=5:LOC
10	Prahy	Praha	PROPN	NNFS2-----A----	Case=Gen|Gender=Fem|NameType=Geo|Number=Sing	9	nmod	9:nmod:gen	Bridge=cmpr9415025c23<cmpr9415025c22:subset|Entity=(cmpr9415025c22--1)cmpr9415025c25)|Functor=9:APP
...
15	ulici	ulice	NOUN	NNFS6-----A----	Case=Loc|Gender=Fem|Number=Sing	9	orphan	10.1:dep	Entity=cmpr9415025c24)|Functor=9:LOC|SpaceAfter=No
...
3	rokem	rok	NOUN	NNIS7-----A----	Animacy=Inan|Case=Ins|Gender=Masc|Number=Sing	0	root	0:root	Functor=0:TWHEN
...
8	táborech	tábor	NOUN	NNIP6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Plur	3	obl	3:obl:v:loc	Entity=ln9420959c55)|Functor=3:LOC|LId=tábor-1
...
10	Čechů	Čech	PROPN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|NameType=Giv,Nat|Number=Plur	3	nsubj	3:nsubj|17:nsubj	Functor=3:ACT.cop|SpaceAfter=No
...
15	Německu	Německo	PROPN	NNNS6-----A----	Case=Loc|Gender=Neut|NameType=Geo|Number=Sing	17	obl	17:obl:v:loc	Entity=ln9420959c9)|Functor=17:LOC
...
19	práci	práce	NOUN	NNFS4-----A----	Case=Acc|Gender=Fem|Number=Sing	17	obl	17:obl:na:acc	Entity=ln9420959c53)ln9420959c52)|Functor=17:DIR3|LGloss=(jako_činnost_i_místo)|SpaceAfter=No
