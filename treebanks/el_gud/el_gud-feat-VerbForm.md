...
The feature is used with 2 part-of-speech tags: <tt><a href="el_gud-pos-VERB.html">VERB</a></tt> (3837; 15% instances), <tt><a href="el_gud-pos-AUX.html">AUX</a></tt> (503; 2% instances).

### `VERB`

3837 <tt><a href="el_gud-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="el_gud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3619; 94%), <tt><a href="el_gud-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (3305; 86%), <tt><a href="el_gud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2779; 72%), <tt><a href="el_gud-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (2344; 61%), <tt><a href="el_gud-feat-Person.html">Person</a></tt><tt>=3</tt> (2082; 54%), <tt><a href="el_gud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1995; 52%).
...
* `Fin` (3664; 95% of non-empty `VerbForm`): <em>λέει, λέω, μπορεί, απαντάει, πρέπει, έχει, έχω, κάνει, ξέρω, ρωτάει</em>
...
503 <tt><a href="el_gud-pos-AUX.html">AUX</a></tt> tokens (65% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="el_gud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (503; 100%), <tt><a href="el_gud-feat-Person.html">Person</a></tt><tt>=3</tt> (414; 82%), <tt><a href="el_gud-feat-Voice.html">Voice</a></tt><tt>=Pass</tt> (404; 80%), <tt><a href="el_gud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (373; 74%), <tt><a href="el_gud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (370; 74%), <tt><a href="el_gud-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (279; 55%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (503; 100% of non-empty `VerbForm`): <em>είναι, ήταν, έχει, είμαι, είμαστε, έχουν, είχε, έχω, είχα, είχαν</em>
* `EMPTY` (266): <em>θα, να, ας, ν', θ', Θ, έχει, έχω, είχαν, είχε</em>

## Relations with Agreement in `VerbForm`

The 10 most frequent relations where parent and child node agree in `VerbForm`:
<tt>VERB --[<tt><a href="el_gud-dep-conj.html">conj</a></tt>]--> VERB</tt> (519; 94%),
<tt>VERB --[<tt><a href="el_gud-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (478; 97%),
