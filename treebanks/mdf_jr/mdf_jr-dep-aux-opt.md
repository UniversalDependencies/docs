...
There are also 4 other language-specific subtypes of `aux`: <tt><a href="mdf_jr-dep-aux-cnd.html">aux:cnd</a></tt>, <tt><a href="mdf_jr-dep-aux-nec.html">aux:nec</a></tt>, <tt><a href="mdf_jr-dep-aux-neg.html">aux:neg</a></tt>, <tt><a href="mdf_jr-dep-aux-q.html">aux:q</a></tt>.
...
5	коза	коза	ADV	Adv	_	6	advmod:lmod	_	_
6	серьгядезь	серьгядемс	VERB	V	Mood=Ind|Number[obj]=Sing|Number[subj]=Plur|Person[obj]=3|Person[subj]=3|Tense=Past|VerbForm=Fin	3	ccomp	_	GTtags=Ind,Prt1,ScPl3,OcSg3
...
10	каяйхть	каямс	VERB	V	Mood=Ind|Number[subj]=Plur|Person[subj]=3|Tense=Pres|VerbForm=Fin	3	conj	_	GTtags=Ind,Prs,ScPl3
...
13	лангозонза	ланга	NOUN	N	Case=Ill|NounType=Relat|Number=Plur,Sing|Number[psor]=Sing|Person[psor]=3	10	obl:lmod	_	GTtags=Relator,SP,Ill,PxSg3|SpaceAfter=No
