...
659 types (9%) occur at least once with a non-empty value of `Person`.
385 lemmas (8%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="fi_pud-pos-VERB.html">VERB</a></tt> (971; 6% instances), <tt><a href="fi_pud-pos-AUX.html">AUX</a></tt> (723; 5% instances), <tt><a href="fi_pud-pos-PRON.html">PRON</a></tt> (325; 2% instances).
...
* `0` (7; 1% of non-empty `Person`): <em>Vaikutti, haluaa, hämärtää, kävi, pääsee, saa, tulee</em>
...
`Person` seems to be **lexical feature** of `VERB`. 94% lemmas (355) occur only with one value of `Person`.

### `AUX`

723 <tt><a href="fi_pud-pos-AUX.html">AUX</a></tt> tokens (88% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="fi_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (723; 100%), <tt><a href="fi_pud-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (723; 100%), <tt><a href="fi_pud-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (601; 83%), <tt><a href="fi_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (595; 82%), <tt><a href="fi_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (567; 78%), <tt><a href="fi_pud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (393; 54%).

`AUX` tokens may have the following values of `Person`:

* `0` (2; 0% of non-empty `Person`): <em>Voi, täytyy</em>
* `1` (29; 4% of non-empty `Person`): <em>en, olemme, emme, olen, olin, Voin, voimme</em>
* `3` (692; 96% of non-empty `Person`): <em>on, oli, ei, ovat, olivat, voi, eivät, voisi, olisi, täytyy</em>
...
* `EMPTY` (834): <em>sen, joka, se, jotka, tämä, sitä, jossa, tällä, jonka, siitä</em>
