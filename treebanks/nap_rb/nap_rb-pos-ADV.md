---
layout: base
title:  'Statistics of ADV in UD_Neapolitan-RB'
udver: '2'
---
...
Examples: <em>ajerĕ, arretĕ, nemmancŏ, ppo', sulamentĕ</em>


## Relations

`ADV` nodes are attached to their parents using 1 different relations: <tt><a href="nap_rb-dep-advmod.html">advmod</a></tt> (14; 100% instances)

Parents of `ADV` nodes belong to 4 different parts of speech: <tt><a href="nap_rb-pos-VERB.html">VERB</a></tt> (10; 71% instances), <tt><a href="nap_rb-pos-ADJ.html">ADJ</a></tt> (2; 14% instances), <tt><a href="nap_rb-pos-NOUN.html">NOUN</a></tt> (1; 7% instances), <tt><a href="nap_rb-pos-PROPN.html">PROPN</a></tt> (1; 7% instances)

14 (100%) `ADV` nodes are leaves.
