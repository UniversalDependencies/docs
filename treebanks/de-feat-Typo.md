---
layout: base
title:  'Statistics of Typo in UD_German'
udver: '2'
---

## Treebank Statistics: UD_German: Features: `Typo`
...
The feature is used with 1 part-of-speech tags: <tt><a href="de-pos-PRON.html">PRON</a></tt> (2; 0% instances).
...
* `Yes` (2; 100% of non-empty `Typo`): <em>Mit, in</em>
