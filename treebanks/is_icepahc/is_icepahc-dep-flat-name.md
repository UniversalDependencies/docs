---
layout: base
title:  'Statistics of flat:name in UD_Icelandic-IcePaHC'
udver: '2'
---

## Treebank Statistics: UD_Icelandic-IcePaHC: Relations: `flat:name`
...
1	Styrk	styrkja	VERB	VBI	Mood=Imp|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	IFD_tag=sbg2en
2	oss	ég	PRON	PRO-A	Case=Acc|Number=Plur|Person=1|PronType=Prs	1	obj	_	IFD_tag=fp1fo
3	hér	hér	ADV	ADV	_	1	advmod	_	IFD_tag=aa
4	til	til	ADP	P	_	5	case	_	IFD_tag=aa
5	gæskuríki	gæskuríkur	NOUN	N-G	Case=Nom|Definite=Ind|Gender=Neut|Number=Sing	1	obl	_	IFD_tag=nhen
6	faðir	faðir	NOUN	N-N	Case=Nom|Definite=Ind|Gender=Masc|Number=Sing	1	vocative	_	IFD_tag=nken
7	með	með	ADP	P	_	8	case	_	IFD_tag=aþ
8	krafti	kraftur	NOUN	N-D	Case=Dat|Definite=Ind|Gender=Masc|Number=Sing	1	obl	_	IFD_tag=nkeþ
9	þíns	þinn	PRON	PRO-G	Case=Gen|Gender=Masc|Number=Sing|PronType=Prs	10	nmod:poss	_	IFD_tag=fekee
10	anda	andi	NOUN	N-G	Case=Gen|Definite=Ind|Gender=Masc|Number=Sing	8	nmod:poss	_	IFD_tag=nkee|SpaceAfter=No
11	,	,	PUNCT	,	_	10	punct	_	IFD_tag
12	fyrir	fyrir	ADP	P	_	15	case	_	IFD_tag=aþ
13	Jesú	jesús	X	FW	Foreign=Yes	15	nmod:poss	_	IFD_tag=nkeo-s
14	kristi	kristur	X	FW	Foreign=Yes	13	flat:name	_	IFD_tag=nkeþ
15	forþénustu	forþénusta	NOUN	N-A	Case=Gen|Definite=Ind|Gender=Fem|Number=Sing	1	obl	_	IFD_tag=nvee|SpaceAfter=No
16	,	,	PUNCT	.	_	15	punct	_	IFD_tag
17	amen	amen	INTJ	INTJ	_	1	conj	_	OriginalHead=0|SpaceAfter=No
...
1	Það	það	PRON	PRO-A	Case=Acc|Gender=Neut|Number=Sing|PronType=Prs	2	obj	_	IFD_tag=fpheo
...
11	með	með	ADP	P	_	12	case	_	IFD_tag=aþ
12	Maríu	maría	PROPN	NPR-A	Case=Dat|Definite=Ind|Gender=Fem|Number=Sing	10	obl	_	IFD_tag=nveþ-s
13	á	á	ADP	P	_	14	case	_	IFD_tag=aþ
14	drottinsdegi	drottinsdagur	PROPN	NPR-D	Case=Dat|Definite=Ind|Gender=Masc|Number=Sing	10	obl	_	IFD_tag=nkeþ|SpaceAfter=No
