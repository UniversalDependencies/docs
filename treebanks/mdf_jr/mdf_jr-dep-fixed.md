...
5	ськамот	ськамот	PRON	Pron	Number[psor]=Sing|Person[psor]=2|PronType=Ind	0	root	_	CGdephead=#5-&gt;0|CGdeprel=@X|GTtags=Exclusive,PerifMod,PxSg2
...
3	ашезь	аш	AUX	_	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Polarity=Neg|Tense=Past|VerbForm=Fin|VerbType=Aux	4	aux	_	GTtags=Aux,Neg,Ind,Prt1,ScSg3
...
9	сяка	сяка	DET	Det	Case=Nom|Definite=Ind|Number=Sing|PronType=Dem	10	det	_	GTtags=Sg,Nom,Indef
...
13	Ярхцада	ярхцамс	VERB	V	Mood=Imp|Number[subj]=Plur|Person[subj]=2|VerbForm=Fin	10	appos	_	GTtags=Imprt,ScPl2|SpaceAfter=No
14	,	,	PUNCT	_	_	15	punct	_	_
15	ярхцада	ярхцамс	VERB	V	Mood=Imp|Number[subj]=Plur|Person[subj]=2|VerbForm=Fin	13	conj	_	GTtags=Imprt,ScPl2
...
21	мярьгондяряй	мярьгомс	VERB	V	Derivation=Cond|Mood=Ind|Number[subj]=Sing|Person[subj]=3|VerbForm=Fin	25	advcl	_	GTtags=Cond,ScSg3
