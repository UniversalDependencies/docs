...
There are 13 `PART` lemmas (0%), 13 `PART` types (0%) and 62 `PART` tokens (0%).
Out of 15 observed tags, the rank of `PART` is: 13 in number of lemmas, 14 in number of types and 14 in number of tokens.

The 10 most frequent `PART` lemmas: <em>jen, až, asi, ne, to, bohužel, jenom, ovšem, snad, vůbec</em>

The 10 most frequent `PART` types:  <em>jen, až, asi, ne, to, Bohužel, jenom, ovšem, snad, vůbec</em>
...
The form / lemma ratio of `PART` is 1.000000 (the average of all parts of speech is 1.426064).
...
`PART` nodes are attached to their parents using 6 different relations: <tt><a href="cs_pud-dep-advmod-emph.html">advmod:emph</a></tt> (39; 63% instances), <tt><a href="cs_pud-dep-advmod.html">advmod</a></tt> (12; 19% instances), <tt><a href="cs_pud-dep-fixed.html">fixed</a></tt> (6; 10% instances), <tt><a href="cs_pud-dep-discourse.html">discourse</a></tt> (3; 5% instances), <tt><a href="cs_pud-dep-advcl.html">advcl</a></tt> (1; 2% instances), <tt><a href="cs_pud-dep-orphan.html">orphan</a></tt> (1; 2% instances)

Parents of `PART` nodes belong to 7 different parts of speech: <tt><a href="cs_pud-pos-NOUN.html">NOUN</a></tt> (28; 45% instances), <tt><a href="cs_pud-pos-VERB.html">VERB</a></tt> (10; 16% instances), <tt><a href="cs_pud-pos-ADV.html">ADV</a></tt> (7; 11% instances), <tt><a href="cs_pud-pos-CCONJ.html">CCONJ</a></tt> (6; 10% instances), <tt><a href="cs_pud-pos-ADJ.html">ADJ</a></tt> (5; 8% instances), <tt><a href="cs_pud-pos-DET.html">DET</a></tt> (5; 8% instances), <tt><a href="cs_pud-pos-NUM.html">NUM</a></tt> (1; 2% instances)

60 (97%) `PART` nodes are leaves.
