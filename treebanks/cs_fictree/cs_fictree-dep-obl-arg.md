...
4901 nodes (3%) are attached to their parents as `obl:arg`.

2649 instances of `obl:arg` (54%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.16159967353601.
