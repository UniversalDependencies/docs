...
It occurs with 26 different values: `AdvstO`, `DimKE`, `DimNe`, `Dimin`, `GenAttr`, `Ill`, `Ine`, `J`, `Kaj`, `Njems`, `NomAg`, `OkshnOms`, `Oma`, `Omka`, `OvOms`, `Ovt`, `OvtOms`, `Ozj`, `PrcPrt1`, `PronGak`, `Shka`, `VGen`, `VerbYks`, `Vnoun`, `Voc`, `Y`.

452 tokens (3%) have a non-empty value of `Derivation`.
356 types (7%) occur at least once with a non-empty value of `Derivation`.
277 lemmas (11%) occur at least once with a non-empty value of `Derivation`.
The feature is used with 10 part-of-speech tags: <tt><a href="myv_jr-pos-VERB.html">VERB</a></tt> (334; 2% instances), <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt> (40; 0% instances), <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> (33; 0% instances), <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> (26; 0% instances), <tt><a href="myv_jr-pos-INTJ.html">INTJ</a></tt> (7; 0% instances), <tt><a href="myv_jr-pos-AUX.html">AUX</a></tt> (6; 0% instances), <tt><a href="myv_jr-pos-PROPN.html">PROPN</a></tt> (3; 0% instances), <tt><a href="myv_jr-pos-ADP.html">ADP</a></tt> (1; 0% instances), <tt><a href="myv_jr-pos-PART.html">PART</a></tt> (1; 0% instances), <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> (1; 0% instances).

### `VERB`

334 <tt><a href="myv_jr-pos-VERB.html">VERB</a></tt> tokens (11% of all `VERB` tokens) have a non-empty value of `Derivation`.

The most frequent other feature values with which `VERB` and `Derivation` co-occurred: <tt><a href="myv_jr-feat-Number-obj.html">Number[obj]</a></tt><tt>=EMPTY</tt> (329; 99%), <tt><a href="myv_jr-feat-Person-obj.html">Person[obj]</a></tt><tt>=EMPTY</tt> (329; 99%), <tt><a href="myv_jr-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (285; 85%), <tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=EMPTY</tt> (267; 80%), <tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=EMPTY</tt> (266; 80%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (264; 79%), <tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (261; 78%), <tt><a href="myv_jr-feat-VerbForm.html">VerbForm</a></tt><tt>=Conv</tt> (223; 67%).
...
* `Oma` (6; 2% of non-empty `Derivation`): <em>важодема, карама, самаль, тапама, тейнема, уема</em>
...
* `Ozj` (220; 66% of non-empty `Derivation`): <em>чиезь, пелезь, капшазь, оршазь, пурнавозь, аштезь, кадовозь, каразь, каштмолезь, поволезь</em>
* `PrcPrt1` (1; 0% of non-empty `Derivation`): <em>синдсь</em>
* `VGen` (1; 0% of non-empty `Derivation`): <em>учонь</em>
* `Vnoun` (7; 2% of non-empty `Derivation`): <em>Чачома, изнямот, кулома, кучнемадо, майсемадо, молеманть, урядамонть</em>

<table>
  <tr><th>Paradigm <i>самс</i></th><th><tt>NomAg</tt></th><th><tt>OkshnOms</tt></th><th><tt>Oma</tt></th><th><tt>Ozj</tt></th></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>сыцятненень</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>сыцятнень</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Plur</tt>|<tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=3</tt>|<tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td></td><td><em>сакшность</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt>|<tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=3</tt>|<tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td></td><td><em>сакшнось</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-Mood.html">Mood</a></tt><tt>=Nec</tt>|<tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt>|<tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=3</tt>|<tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=Past</tt>|<tt><a href="myv_jr-feat-VerbForm.html">VerbForm</a></tt><tt>=Conv</tt></tt></td><td></td><td></td><td><em>самаль</em></td><td></td></tr>
  <tr><td><tt><tt><a href="myv_jr-feat-VerbForm.html">VerbForm</a></tt><tt>=Conv</tt></tt></td><td></td><td></td><td></td><td><em>сазь</em></td></tr>
</table>

### `NOUN`

40 <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt> tokens (1% of all `NOUN` tokens) have a non-empty value of `Derivation`.

The most frequent other feature values with which `NOUN` and `Derivation` co-occurred: <tt><a href="myv_jr-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (36; 90%), <tt><a href="myv_jr-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (36; 90%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (23; 57%).

`NOUN` tokens may have the following values of `Derivation`:

* `DimKE` (2; 5% of non-empty `Derivation`): <em>карькскесэ, лазкскеванть</em>
* `DimNe` (4; 10% of non-empty `Derivation`): <em>вирьбулыненть, вирьбулынеть, каштазнэ, каштазнэськак</em>
* `Dimin` (7; 18% of non-empty `Derivation`): <em>Пулинесь, авинем, касовкскесь, корминем, седейбелькскем, сокинесэ, усынеть</em>
* `Kaj` (1; 3% of non-empty `Derivation`): <em>лелякай</em>
* `NomAg` (20; 50% of non-empty `Derivation`): <em>моравтыцятне, азгондицят, ардыцятне, ванстыцявтомо, ванстыцясь, кирдийтнененьгак, л​и​с​и​ц​я​н​т​е​н​ь​-​с​о​в​и​ц​я​н​т​е​н​ь, озныця, пачкодиця, путыцязо</em>
* `Omka` (1; 3% of non-empty `Derivation`): <em>ванстомкат</em>
* `Voc` (4; 10% of non-empty `Derivation`): <em>ялгай, корьмай</em>
* `Y` (1; 3% of non-empty `Derivation`): <em>ванынть</em>

`Derivation` seems to be **lexical feature** of `NOUN`. 100% lemmas (30) occur only with one value of `Derivation`.
...
* `Shka` (4; 12% of non-empty `Derivation`): <em>сатышка, Зярошкаль, Кавкстешкаксть</em>

`Derivation` seems to be **lexical feature** of `ADV`. 100% lemmas (17) occur only with one value of `Derivation`.

### `ADJ`

26 <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> tokens (4% of all `ADJ` tokens) have a non-empty value of `Derivation`.
...
The most frequent other feature values with which `AUX` and `Derivation` co-occurred: <tt><a href="myv_jr-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (6; 100%), <tt><a href="myv_jr-feat-Valency.html">Valency</a></tt><tt>=1</tt> (6; 100%), <tt><a href="myv_jr-feat-VerbType.html">VerbType</a></tt><tt>=EMPTY</tt> (6; 100%), <tt><a href="myv_jr-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (5; 83%), <tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=3</tt> (5; 83%), <tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (5; 83%), <tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt> (4; 67%).
...
<table>
  ...
  <tr><td><tt><tt><a href="myv_jr-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="myv_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt>|<tt><a href="myv_jr-feat-Person-subj.html">Person[subj]</a></tt><tt>=3</tt>|<tt><a href="myv_jr-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td><em>савкшнось</em></td><td><em>савсь</em></td></tr>
</table>
