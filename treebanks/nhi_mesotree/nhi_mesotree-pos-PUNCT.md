...
## Treebank Statistics: UD_Western_Sierra_Puebla_Nahuatl-ITML: POS Tags: `PUNCT`

There are 20 `PUNCT` lemmas (1%), 21 `PUNCT` types (1%) and 1853 `PUNCT` tokens (20%).
Out of 15 observed tags, the rank of `PUNCT` is: 12 in number of lemmas, 12 in number of types and 1 in number of tokens.

The 10 most frequent `PUNCT` lemmas: <em>., ,, —, ?, !, ¿, ¡, :, -, “</em>

The 10 most frequent `PUNCT` types:  <em>., ,, —, ?, !, ¿, ¡, :, -, ”</em>

The 10 most frequent ambiguous lemmas: <em>-</em> (<tt><a href="nhi_itml-pos-PUNCT.html">PUNCT</a></tt> 39, <tt><a href="nhi_itml-pos-PROPN.html">PROPN</a></tt> 1)
...
The form / lemma ratio of `PUNCT` is 1.050000 (the average of all parts of speech is 1.468205).
