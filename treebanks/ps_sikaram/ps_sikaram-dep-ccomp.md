---
layout: base
title:  'Statistics of ccomp in UD_Pashto-Sikaram'
udver: '2'
---
...
10 nodes (0%) are attached to their parents as `ccomp`.

10 instances of `ccomp` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 7.4.

The following 1 pairs of parts of speech are connected with `ccomp`: <tt><a href="ps_sikaram-pos-VERB.html">VERB</a></tt>-<tt><a href="ps_sikaram-pos-VERB.html">VERB</a></tt> (10; 100% instances).
...
5	ورېږي	ورېدل	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	2	ccomp	_	Translit=wëreǧí|LTranslit=wëredë́l|Gloss=rains|SpaceAfter=No
