...
`SCONJ` nodes are attached to their parents using 1 different relations: <tt><a href="pt_gsd-dep-mark.html">mark</a></tt> (2; 100% instances)

Parents of `SCONJ` nodes belong to 1 different parts of speech: <tt><a href="pt_gsd-pos-VERB.html">VERB</a></tt> (2; 100% instances)
