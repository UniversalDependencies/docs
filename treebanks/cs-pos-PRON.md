...
There are 55 `PRON` lemmas (0%), 198 `PRON` types (0%) and 44922 `PRON` tokens (3%).
...
The form / lemma ratio of `PRON` is 3.600000 (the average of all parts of speech is 2.181773).
...
36835 (82%) `PRON` nodes are leaves.
