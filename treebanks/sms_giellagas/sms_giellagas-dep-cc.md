---
layout: base
title:  'Statistics of cc in UD_Skolt_Sami-Giellagas'
udver: '2'
---
...
3	Jeäʹled	ij	AUX	V	Mood=Imp|Number=Plur|Person=2|Polarity=Neg|VerbForm=Fin	4	aux	_	GTtags=Neg,Imprt,Pl2,@+FAUXV
4	cieʹlǩ	ceäʹlǩǩed	VERB	V	Connegative=Yes|Mood=Ind|Tense=Pres|VerbForm=Fin	0	root	_	GTtags=Ind,Prs,ConNeg
...
2	leäi	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt,Sg3|SpaceAfter=No
3	,	,	PUNCT	CLB	_	4	punct	_	_
4	leäi	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	2	conj	_	GTtags=Ind,Prt,Sg3
5	de	de	CCONJ	CC	_	7	cc	_	_
6	ooumaž	ooumaž	NOUN	N	Animacy=Hum|Case=Nom|Number=Sing	7	nsubj	_	GTtags=Sem/Hum,Sg,Nom
7	puõʹđi	pueʹtted	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	2	conj	_	GTtags=Ind,Prt,Sg3|SpaceAfter=No
8	.	.	PUNCT	CLB	_	2	punct	_	_
