...
2	Ein	Ein	DET	ART	Case=Nom|Gender=Masc|Number=Sing|PronType=Art	3	det	_	_
3	Schnitzer	Schnitzer	NOUN	NN	Case=Nom|Gender=Masc|Number=Sing|Person=3	0	root	_	_
4	,	,	PUNCT	$,	PunctType=Comm	10	punct	_	_
5	den	den	PRON	PRELS	Case=Acc|Gender=Masc|Number=Sing|Person=3|PronType=Rel	10	obj	_	_
6	man	man	PRON	PIS	Case=Nom|Number=Sing|Person=3|PronType=Ind,Neg,Tot	10	nsubj	_	_
...
2	dies	dies	PRON	PDS	Case=Nom|Gender=Neut|Number=Sing|Person=3|PronType=Dem	3	nsubj	_	_
...
9	Blumenthals	Blumenthals	PROPN	NE	Case=Gen|Number=Sing|Person=3	10	nmod	_	_
10	Anwalt	Anwalt	NOUN	NN	Gender=Masc|Number=Sing|Person=3	11	nsubj	_	_
11	meint	meinen	VERB	VVFIN	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	3	acl	_	_
12	.	.	PUNCT	$.	PunctType=Peri	3	punct	_	_
