...
493 tokens (2%) have a non-empty value of `NumType`.
150 types (4%) occur at least once with a non-empty value of `NumType`.
142 lemmas (5%) occur at least once with a non-empty value of `NumType`.
The feature is used with 3 part-of-speech tags: <tt><a href="fr_partut-pos-NUM.html">NUM</a></tt> (424; 1% instances), <tt><a href="fr_partut-pos-ADJ.html">ADJ</a></tt> (66; 0% instances), <tt><a href="fr_partut-pos-PRON.html">PRON</a></tt> (3; 0% instances).

### `NUM`

424 <tt><a href="fr_partut-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

`NUM` tokens may have the following values of `NumType`:

* `Card` (424; 100% of non-empty `NumType`): <em>1, 2, deux, 3, 6, 2000, 2002, 1999, 2001, 2005</em>
...
* `EMPTY` (1774): <em>présent, européen, autres, présente, structurels, grande, technique, communautaire, dangereuses, possible</em>
...
* `EMPTY` (1606): <em>qui, nous, il, je, vous, ce, s', se, c', que</em>
