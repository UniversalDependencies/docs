---
layout: base
title:  'Statistics of acl:poss in UD_Kazakh-KTB'
udver: '2'
---

## Treebank Statistics: UD_Kazakh-KTB: Relations: `acl:poss`

This relation is a language-specific subtype of <tt><a href="kk_ktb-dep-acl.html">acl</a></tt>.
There are also 1 other language-specific subtypes of `acl`: <tt><a href="kk_ktb-dep-acl-relcl.html">acl:relcl</a></tt>.
...
The following 1 pairs of parts of speech are connected with `acl:poss`: <tt><a href="kk_ktb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="kk_ktb-pos-VERB.html">VERB</a></tt> (1; 100% instances).
