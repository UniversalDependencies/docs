...
4	sprongen	op_springen	VERB	WW|pv|verl|mv	Mood=Ind|Number=Plur|Tense=Past|VerbForm=Fin	0	root	0:root	_
5	alle	al	DET	VNW|onbep|det|stan|prenom|met-e|agr	PronType=Tot	6	det	6:det	_
...
2	had	hebben	VERB	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	0	root	0:root	_
