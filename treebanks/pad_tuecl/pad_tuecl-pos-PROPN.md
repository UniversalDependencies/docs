...
There are 1 `PROPN` lemmas (8%), 13 `PROPN` types (5%) and 14 `PROPN` tokens (3%).
Out of 13 observed tags, the rank of `PROPN` is: 10 in number of lemmas, 6 in number of types and 9 in number of tokens.
...
The form / lemma ratio of `PROPN` is 13.000000 (the average of all parts of speech is 20.846154).
