...
66 <tt><a href="br_keb-pos-PRON.html">PRON</a></tt> tokens (28% of all `PRON` tokens) have a non-empty value of `Gender`.
...
* `Fem` (37; 56% of non-empty `Gender`): <em>i, hi, anezhi, -hi, he, zi, Honnezh, eben, hounnezh, ni</em>
* `Masc` (29; 44% of non-empty `Gender`): <em>añ, Hemañ, anezhañ, E, Hennezh, egile, nañ, nnañ</em>
* `EMPTY` (173): <em>me, in, o, oc'h, piv, holl, hini, re, a, int</em>

<table>
  <tr><th>Paradigm <i>indirect</i></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th></tr>
  <tr><td><tt></tt></td><td><em>añ, nañ, nnañ</em></td><td><em>i, zi, ni</em></td></tr>
</table>

### `AUX`

39 <tt><a href="br_keb-pos-AUX.html">AUX</a></tt> tokens (3% of all `AUX` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `AUX` and `Gender` co-occurred: <tt><a href="br_keb-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (39; 100%), <tt><a href="br_keb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (39; 100%), <tt><a href="br_keb-feat-Person.html">Person</a></tt><tt>=3</tt> (39; 100%), <tt><a href="br_keb-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (39; 100%), <tt><a href="br_keb-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (33; 85%).
...
* `EMPTY` (195): <em>unan, 2007, 4, 000, 1950, 20, 3, 30, eil, 10</em>
...
2 <tt><a href="br_keb-pos-VERB.html">VERB</a></tt> tokens (0% of all `VERB` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `VERB` and `Gender` co-occurred: <tt><a href="br_keb-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (2; 100%), <tt><a href="br_keb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2; 100%), <tt><a href="br_keb-feat-Person.html">Person</a></tt><tt>=3</tt> (2; 100%), <tt><a href="br_keb-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (2; 100%).
