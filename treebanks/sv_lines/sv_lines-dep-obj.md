...
4857 nodes (5%) are attached to their parents as `obj`.

4504 instances of `obj` (93%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.01605929586164.
