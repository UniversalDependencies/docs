---
layout: base
title:  'Statistics of Polarity in UD_Manx-Cadhan'
udver: '2'
---

## Treebank Statistics: UD_Manx-Cadhan: Features: `Polarity`
...
2 <tt><a href="gv_cadhan-pos-AUX.html">AUX</a></tt> tokens (3% of all `AUX` tokens) have a non-empty value of `Polarity`.

`AUX` tokens may have the following values of `Polarity`:

* `Neg` (2; 100% of non-empty `Polarity`): <em>Cha, Nagh</em>
* `EMPTY` (67): <em>she, s', by, nee, B'</em>
