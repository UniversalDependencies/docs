...
* <em>Isto</em>
  ...
  * <tt><a href="pt_petrogold-pos-CCONJ.html">CCONJ</a></tt> 1: <em><b>Isto</b> , pois quando o campo envelhece , a pressão natural de o reservatório diminui , e o poço pode ter reforço em a forma de compressão , a fim de produzir mais e levar esta produção até a plataforma .</em>

## Morphology

The form / lemma ratio of `CCONJ` is 1.090909 (the average of all parts of speech is 1.452383).

The 1st highest number of forms (2) was observed with the lemma “como”: <em>com, como</em>.

The 2nd highest number of forms (2) was observed with the lemma “porém”: <em>porem, porém</em>.

The 3rd highest number of forms (1) was observed with the lemma “a”: <em>a</em>.

`CCONJ` occurs with 1 features: <tt><a href="pt_petrogold-feat-ExtPos.html">ExtPos</a></tt> (97; 2% instances)

`CCONJ` occurs with 1 feature-value pairs: `ExtPos=CCONJ`

`CCONJ` occurs with 2 feature combinations.
The most frequent feature combination is `_` (6257 tokens).
Examples: <em>e, ou, mas, a, porém, portanto, entretanto, e/ou, quanto, como</em>


## Relations

`CCONJ` nodes are attached to their parents using 2 different relations: <tt><a href="pt_petrogold-dep-cc.html">cc</a></tt> (6188; 97% instances), <tt><a href="pt_petrogold-dep-flat-name.html">flat:name</a></tt> (166; 3% instances)
...
6163 (97%) `CCONJ` nodes are leaves.

27 (0%) `CCONJ` nodes have one child.

77 (1%) `CCONJ` nodes have two children.

87 (1%) `CCONJ` nodes have three or more children.

The highest child degree of a `CCONJ` node is 3.

Children of `CCONJ` nodes are attached using 2 different relations: <tt><a href="pt_petrogold-dep-punct.html">punct</a></tt> (345; 78% instances), <tt><a href="pt_petrogold-dep-fixed.html">fixed</a></tt> (97; 22% instances)

Children of `CCONJ` nodes belong to 2 different parts of speech: <tt><a href="pt_petrogold-pos-PUNCT.html">PUNCT</a></tt> (345; 78% instances), <tt><a href="pt_petrogold-pos-VERB.html">VERB</a></tt> (97; 22% instances)
