...
2	sklizni	sklizeň	NOUN	NNFS6-----A----	Case=Loc|Gender=Fem|Number=Sing|Polarity=Pos	5	obl	5:obl	_
...
4	mně	já	PRON	PP-S6--1-------	Case=Loc|Number=Sing|Person=1|PronType=Prs	1	obl:arg	1:obl:arg	SpaceAfter=No
5	,	,	PUNCT	Z:-------------	_	10	punct	10:punct	_
6	že	že	SCONJ	J,-------------	_	10	mark	10:mark	_
7	mi	já	PRON	PH-S3--1-------	Case=Dat|Number=Sing|Person=1|PronType=Prs|Variant=Short	10	obl	10:obl	_
