---
layout: base
title:  'Statistics of goeswith in UD_English-PUD'
udver: '2'
---

## Treebank Statistics: UD_English-PUD: Relations: `goeswith`
...
The following 1 pairs of parts of speech are connected with `goeswith`: <tt><a href="en_pud-pos-ADP.html">ADP</a></tt>-<tt><a href="en_pud-pos-NOUN.html">NOUN</a></tt> (1; 100% instances).
