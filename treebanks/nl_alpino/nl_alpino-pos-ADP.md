...
There are 102 `ADP` lemmas (0%), 106 `ADP` types (0%) and 26720 `ADP` tokens (13%).
...
The form / lemma ratio of `ADP` is 1.039216 (the average of all parts of speech is 1.213971).
