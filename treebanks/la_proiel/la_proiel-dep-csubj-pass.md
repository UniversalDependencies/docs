...
This relation is a language-specific subtype of <tt><a href="la_proiel-dep-csubj.html">csubj</a></tt>.

209 nodes (0%) are attached to their parents as `csubj:pass`.

169 instances of `csubj:pass` (81%) are left-to-right (parent precedes child).
Average distance between parent and child is 6.06698564593301.

The following 8 pairs of parts of speech are connected with `csubj:pass`: <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-VERB.html">VERB</a></tt> (161; 77% instances), <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-ADJ.html">ADJ</a></tt> (12; 6% instances), <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-NOUN.html">NOUN</a></tt> (11; 5% instances), <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-PRON.html">PRON</a></tt> (9; 4% instances), <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-SCONJ.html">SCONJ</a></tt> (9; 4% instances), <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-AUX.html">AUX</a></tt> (4; 2% instances), <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-ADV.html">ADV</a></tt> (2; 1% instances), <tt><a href="la_proiel-pos-VERB.html">VERB</a></tt>-<tt><a href="la_proiel-pos-PROPN.html">PROPN</a></tt> (1; 0% instances).
...
1	quibus	qui	PRON	Pr	Case=Abl|Number=Plur|PronType=Rel	2	acl	_	ref=1.25
2	rebus	res	NOUN	Nb	Case=Abl|Gender=Fem|Number=Plur	3	advcl	_	ref=1.25
