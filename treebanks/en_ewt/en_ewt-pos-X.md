...
There are 656 `X` lemmas (3%), 660 `X` types (3%) and 1141 `X` tokens (0%).
...
The form / lemma ratio of `X` is 1.006098 (the average of all parts of speech is 1.194181).
