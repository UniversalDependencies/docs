...
4	сяворсь	сяворемс	VERB	V	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Past|Valency=1	0	root	_	CGdephead=#4-&gt;0|CGdeprel=@FMV|GTtags=IV,Ind,Prt1,ScSg3
...
7	оймавтомо	оймавтомс	VERB	V	Case=Loc|Valency=2|VerbForm=Inf	4	xcomp	_	CGdephead=#7-&gt;4|CGdeprel=@IMV|GTtags=TV,Inf,Loc|SpaceAfter=No
