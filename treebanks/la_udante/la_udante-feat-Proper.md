...
788 tokens (1%) have a non-empty value of `Proper`.
243 types (2%) occur at least once with a non-empty value of `Proper`.
154 lemmas (3%) occur at least once with a non-empty value of `Proper`.
The feature is used with 9 part-of-speech tags: <tt><a href="la_udante-pos-NOUN.html">NOUN</a></tt> (651; 1% instances), <tt><a href="la_udante-pos-ADJ.html">ADJ</a></tt> (61; 0% instances), <tt><a href="la_udante-pos-ADP.html">ADP</a></tt> (35; 0% instances), <tt><a href="la_udante-pos-PROPN.html">PROPN</a></tt> (16; 0% instances), <tt><a href="la_udante-pos-DET.html">DET</a></tt> (9; 0% instances), <tt><a href="la_udante-pos-X.html">X</a></tt> (9; 0% instances), <tt><a href="la_udante-pos-PRON.html">PRON</a></tt> (3; 0% instances), <tt><a href="la_udante-pos-VERB.html">VERB</a></tt> (3; 0% instances), <tt><a href="la_udante-pos-NUM.html">NUM</a></tt> (1; 0% instances).

### `NOUN`

651 <tt><a href="la_udante-pos-NOUN.html">NOUN</a></tt> tokens (6% of all `NOUN` tokens) have a non-empty value of `Proper`.

The most frequent other feature values with which `NOUN` and `Proper` co-occurred: <tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Sing</tt> (610; 94%), <tt><a href="la_udante-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (395; 61%), <tt><a href="la_udante-feat-InflClass.html">InflClass</a></tt><tt>=IndEurO</tt> (391; 60%).

`NOUN` tokens may have the following values of `Proper`:

* `Yes` (651; 100% of non-empty `Proper`): <em>Dei, Deus, Deo, Ecclesie, Ecclesia, Imperium, Imperii, Phylosophus, Deum, Ecclesiam</em>

`Proper` seems to be **lexical feature** of `NOUN`. 100% lemmas (107) occur only with one value of `Proper`.

### `ADJ`

61 <tt><a href="la_udante-pos-ADJ.html">ADJ</a></tt> tokens (2% of all `ADJ` tokens) have a non-empty value of `Proper`.

The most frequent other feature values with which `ADJ` and `Proper` co-occurred: <tt><a href="la_udante-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (47; 77%), <tt><a href="la_udante-feat-Number.html">Number</a></tt><tt>=Sing</tt> (44; 72%).

`ADJ` tokens may have the following values of `Proper`:

* `Yes` (61; 100% of non-empty `Proper`): <em>Metaphysicorum, Physicorum, Sancti, Sancto, Sanctum, Apostolice, Ethicorum, Grandi, Prima, Primi</em>
