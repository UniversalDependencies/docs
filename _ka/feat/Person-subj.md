...
`Person[subj]` is feature of [verbs](_ka/pos/VERB). It is an agreement feature that marks the person of the verb's subject. Person[subj] marked on verbs makes it unnecessary to add a personal pronoun as subject and thus subjects may be dropped. 

### <a name="1">`1`</a>: first person subject

#### Examples

* _ვწერ_ 'I write', _ვწერთ_ 'we write' etc.
* _ვხატავ_ 'I draw', _ვხატავთ_ 'we draw' etc.

### <a name="2">`2`</a>: second person subject

#### Examples

* _წერ_ 'you write', _წერთ_ 'you write in plural' etc.
* _ხატავ_ 'you draw', _ხატავთ_ 'you draw in plural' etc.
...
<!-- Interlanguage links updated Po 29. června 2026, 17:58:33 CEST -->
