...
The following 1 pairs of parts of speech are connected with `flat:foreign`: <tt><a href="fr_rhapsodie-pos-X.html">X</a></tt>-<tt><a href="fr_rhapsodie-pos-X.html">X</a></tt> (6; 100% instances).
...
1	on	on	PRON	_	Case=Nom|Emph=No|Gender=Masc|Number=Sing|Person=3|PronType=Ind	2	nsubj	_	AlignBegin=19981|AlignEnd=20116
2	peut	pouvoir	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	AlignBegin=20116|AlignEnd=20306
...
6	exemple	exemple	NOUN	_	_	3	obl:mod	_	AlignBegin=20796|AlignEnd=21326|Gender[lex]=Masc|Number[ctxt]=Sing|SpaceAfter=No
7	,	,	PUNCT	_	_	9	punct	_	AlignBegin=21326|AlignEnd=21326
8	le	le	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	9	det	_	AlignBegin=21326|AlignEnd=21506
9	site	site	NOUN	_	_	3	obj	_	AlignBegin=21506|AlignEnd=21914|Gender[lex]=Masc|Number[ctxt]=Sing
