...
12622 <tt><a href="eu_bdt-pos-NOUN.html">NOUN</a></tt> tokens (42% of all `NOUN` tokens) have a non-empty value of `Animacy`.

The most frequent other feature values with which `NOUN` and `Animacy` co-occurred: <tt><a href="eu_bdt-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (10674; 85%), <tt><a href="eu_bdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8029; 64%).
...
* `Inan` (11421; 90% of non-empty `Animacy`): <em>taldeak, urteko, urte, ondorioz, partidua, aukera, taldea, aurretik, garaipena, igandean</em>
* `EMPTY` (17091): <em>behar, nahi, euskal, talde, uste, lan, jokalari, ezin, estatu, alderdi</em>

`Animacy` seems to be **lexical feature** of `NOUN`. 100% lemmas (2039) occur only with one value of `Animacy`.
...
* `EMPTY` (9773): <em>Europako, Espainiako, Frantziako, Israelgo, Jose, Juan, Euskal, Nafarroako, EEBBetako, Jugoslaviako</em>
...
The most frequent other feature values with which `ADJ` and `Animacy` co-occurred: <tt><a href="eu_bdt-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (9; 100%), <tt><a href="eu_bdt-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (7; 78%), <tt><a href="eu_bdt-feat-Case.html">Case</a></tt><tt>=Abs</tt> (6; 67%), <tt><a href="eu_bdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5; 56%).
...
* `EMPTY` (7012): <em>azken, lehen, bigarren, handia, ona, bakarra, hirugarren, nagusia, zaila, berria</em>

### `DET`

6 <tt><a href="eu_bdt-pos-DET.html">DET</a></tt> tokens (0% of all `DET` tokens) have a non-empty value of `Animacy`.

The most frequent other feature values with which `DET` and `Animacy` co-occurred: <tt><a href="eu_bdt-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (4; 67%), <tt><a href="eu_bdt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (4; 67%).

`DET` tokens may have the following values of `Animacy`:

* `Inan` (6; 100% of non-empty `Animacy`): <em>inguruk, askotakoa, inguru, piloa</em>
* `EMPTY` (4133): <em>bere, beste, hori, hau, horretan, zer, batzuk, guztiak, honetan, horiek</em>
...
1 <tt><a href="eu_bdt-pos-AUX.html">AUX</a></tt> tokens (0% of all `AUX` tokens) have a non-empty value of `Animacy`.

The most frequent other feature values with which `AUX` and `Animacy` co-occurred: <tt><a href="eu_bdt-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="eu_bdt-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="eu_bdt-feat-Number-abs.html">Number[abs]</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="eu_bdt-feat-Number-erg.html">Number[erg]</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="eu_bdt-feat-Person-abs.html">Person[abs]</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="eu_bdt-feat-Person-erg.html">Person[erg]</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="eu_bdt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1; 100%).

`AUX` tokens may have the following values of `Animacy`:

* `Inan` (1; 100% of non-empty `Animacy`): <em>izan</em>
* `EMPTY` (12547): <em>da, zuen, zen, du, dira, izan, dute, zuten, ziren, ditu</em>
