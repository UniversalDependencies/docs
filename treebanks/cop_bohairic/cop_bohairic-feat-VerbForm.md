---
layout: base
title:  'Statistics of VerbForm in UD_Coptic-Bohairic'
udver: '2'
---

## Treebank Statistics: UD_Coptic-Bohairic: Features: `VerbForm`
...
27 <tt><a href="cop_bohairic-pos-AUX.html">AUX</a></tt> tokens (1% of all `AUX` tokens) have a non-empty value of `VerbForm`.

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (27; 100% of non-empty `VerbForm`): ϣ, ⲉϣ
