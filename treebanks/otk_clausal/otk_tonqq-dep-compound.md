---
layout: base
title:  'Statistics of compound in UD_Old_Turkish-Tonqq'
udver: '2'
---

## Treebank Statistics: UD_Old_Turkish-Tonqq: Relations: `compound`

This relation is universal.

6 nodes (4%) are attached to their parents as `compound`.
...
The following 1 pairs of parts of speech are connected with `compound`: <tt><a href="otk_tonqq-pos-NUM.html">NUM</a></tt>-<tt><a href="otk_tonqq-pos-NUM.html">NUM</a></tt> (6; 100% instances).
