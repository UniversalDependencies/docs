---
layout: base
title:  'Statistics of amod in UD_Latin-CIRCSE'
udver: '2'
---

## Treebank Statistics: UD_Latin-CIRCSE: Relations: `amod`

This relation is universal.

2568 nodes (10%) are attached to their parents as `amod`.

1856 instances of `amod` (72%) are right-to-left (child precedes parent).
...
1	communis	communis	ADJ	C4	Case=Nom|Degree=Pos|Gender=Fem|InflClass=IndEurI|Number=Sing	0	root	_	LiLaflcat=n7
2	ista	iste	DET	I	Case=Nom|Gender=Fem|InflClass=LatPron|Number=Sing|PronType=Dem	4	det	_	LiLaflcat=p
3	pluribus	multus	DET	C1	Case=Dat|Degree=Cmp|Gender=Masc|InflClass=IndEurX|Number=Plur|NumType=Card|PronType=Ind	6	amod	_	LiLaflcat=n7
4	causa	causa	NOUN	A1	Case=Nom|Gender=Fem|InflClass=IndEurA|Number=Sing	1	nsubj	_	LiLaflcat=n1
5	est	sum	AUX	B6	Aspect=Imp|InflClass=LatAnom|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	1	cop	_	LASLAVariant=1|LiLaflcat=v6
6	deis	deus	NOUN	A2	Case=Dat|Gender=Masc|InflClass=IndEurO|Number=Plur	1	obl	_	LiLaflcat=n2
