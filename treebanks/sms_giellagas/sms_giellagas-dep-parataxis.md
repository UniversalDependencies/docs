...
The following 5 pairs of parts of speech are connected with `parataxis`: <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt>-<tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> (13; 76% instances), <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt>-<tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> (1; 6% instances), <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt>-<tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> (1; 6% instances), <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt>-<tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> (1; 6% instances), <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt>-<tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> (1; 6% instances).
...
1	Nuʹbb	nuʹbb	PRON	Pron	Case=Nom|Number=Sing|PronType=Ind	2	nsubj	_	GTtags=Sg,Nom
2	ceälkk	ceäʹlǩǩed	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	GTtags=Ind,Prs,Sg3|SpaceAfter=No
...
6	jiõm	ij	AUX	V	Mood=Ind|Number=Sing|Person=1|Polarity=Neg|VerbForm=Fin	7	aux	_	GTtags=Neg,Ind,Sg1
7	kuâddam	kueʹdded	VERB	V	Connegative=Yes|Mood=Ind|Tense=Past|VerbForm=Fin	2	parataxis	_	GTtags=Ind,Prt,ConNeg
...
4	leäi	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	_	GTtags=Ind,Prt,Sg3
5	särnnad	särnnad	VERB	V	VerbForm=Inf	4	advcl	_	GTtags=Inf|SpaceAfter=No
6	,	,	PUNCT	CLB	_	7	punct	_	_
7	ceälkk	ceäʹlǩǩed	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	4	parataxis	_	GTtags=Ind,Prs,Sg3|SpaceAfter=No
...
11	leäi	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	4	conj	_	GTtags=Ind,Prt,Sg3
...
15	leäi	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	16	aux	_	GTtags=Ind,Prt,Sg3
...
21	leʹjjem	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=1|Tense=Past|VerbForm=Fin	23	aux	_	GTtags=Ind,Prt,Sg1
...
26	leäi	leeʹd	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	28	aux	_	GTtags=Ind,Prt,Sg3
...
32	vaaʹldi	väʹldded	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	11	conj	_	GTtags=Ind,Prt,Sg3
...
3	ij	ij	AUX	V	Mood=Ind|Number=Sing|Person=3|Polarity=Neg|VerbForm=Fin	4	aux	_	GTtags=Neg,Ind,Sg3
4	kueʹst	kueʹstted	VERB	V	Connegative=Yes|Mood=Ind|Tense=Pres|VerbForm=Fin	0	root	_	GTtags=Ind,Prs,ConNeg|SpaceAfter=No
5	,	,	PUNCT	CLB	_	7	punct	_	_
6	leäk-a	leeʹd	VERB	V	Clitic=QstA|Mood=Ind|Number=Sing|PartType=Int|Person=2|Tense=Pres|VerbForm=Fin	7	orphan	_	GTtags=Ind,Prs,Sg2,Qst/a
...
10	kuõʹddiǩ	kueʹdded	VERB	V	Mood=Ind|Number=Sing|Person=2|Tense=Past|VerbForm=Fin	4	conj	_	GTtags=Ind,Prt,Sg2
11	jiõk	ij	AUX	V	Mood=Ind|Number=Sing|Person=2|Polarity=Neg|VerbForm=Fin	10	parataxis	_	GTtags=Neg,Ind,Sg2|SpaceAfter=No
