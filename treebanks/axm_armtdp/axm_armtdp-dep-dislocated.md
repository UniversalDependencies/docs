---
layout: base
title:  'Statistics of dislocated in UD_Middle_Armenian-ArmTDP'
udver: '2'
---

## Treebank Statistics: UD_Middle_Armenian-ArmTDP: Relations: `dislocated`
...
The following 1 pairs of parts of speech are connected with `dislocated`: <tt><a href="axm_armtdp-pos-VERB.html">VERB</a></tt>-<tt><a href="axm_armtdp-pos-PRON.html">PRON</a></tt> (1; 100% instances).
...
# visual-style 61 51 dislocated	color:blue
