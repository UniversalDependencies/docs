...
The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="sk-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (407; 100%), <tt><a href="sk-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (407; 100%), <tt><a href="sk-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (407; 100%), <tt><a href="sk-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (406; 100%), <tt><a href="sk-feat-Number.html">Number</a></tt><tt>=Sing</tt> (349; 86%), <tt><a href="sk-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (222; 55%).
