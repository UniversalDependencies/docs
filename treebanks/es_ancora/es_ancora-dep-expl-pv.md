...
Average distance between parent and child is 1.15006226650062.
...
2	Yo	yo	PRON	pp1csn00	Case=Nom|Number=Sing|Person=1|PronType=Prs	4	nsubj	4:nsubj	Entity=(CESSCASTP2001030245c1-person-1-CorefType:ident,gstype:spec)
...
6	me	yo	PRON	pp1cs000	Case=Acc|Number=Sing|Person=1|PrepCase=Npr|PronType=Prs	7	obj	7:obj	Entity=(CESSCASTP2001030245c1-person-1-CorefType:ident,gstype:spec)
...
10	le	él	PRON	pp3csd00	Case=Dat|Number=Sing|Person=3|PronType=Prs	11	iobj	11:iobj	Entity=(CESSCASTP2001030245c11--1-gstype:gen)
...
14	jefe	jefe	NOUN	ncms000	Gender=Masc|Number=Sing	11	iobj	11:iobj	Entity=(CESSCASTP2001030245c11--1-CorefType:ident,gstype:gen,HomoDD
15	policial	policial	ADJ	aq0cs0	Number=Sing	14	amod	14:amod	_
16	que	que	PRON	pr0cn000	PronType=Int,Rel	18	nsubj	18:nsubj	Entity=(CESSCASTP2001030245c11--1-CorefType:ident,gstype:gen)
17	le	él	PRON	pp3csd00	Case=Dat|Number=Sing|Person=3|PronType=Prs	18	iobj	18:iobj	Entity=(CESSCASTP2001030245c1-person-1-CorefType:ident,gstype:spec)
...
23	caminando	caminar	VERB	vmg0000	VerbForm=Ger	22	advcl	22:advcl	SpaceAfter=No|Entity=CESSCASTP2001030245c11)
...
5	53	53	NUM	_	NumForm=Digit|NumType=Card	6	nummod	6:nummod	Entity=(CESSCASTP1999120220s12.sn.69-number-2-gstype:spec
6	años	año	NOUN	ncmp000	Gender=Masc|Number=Plur	7	obl	7:obl	Entity=CESSCASTP1999120220s12.sn.69)
...
14	el	el	DET	da0ms0	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	15	det	15:det	Entity=(CESSCASTP1999120220s12.sn.83--2-gstype:gen,HomoDD
15	apoyo	apoyo	NOUN	ncms000	Gender=Masc|Number=Sing	7	obl	7:obl	SpaceAfter=No|Entity=CESSCASTP1999120220s12.sn.83)
16	,	,	PUNCT	fc	PunctType=Comm	18	punct	18:punct	_
17	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	18	det	18:det	Entity=(CESSCASTP1999120220s12.sn.89--2-gstype:gen,HomoDD
18	comprensión	comprensión	NOUN	ncfs000	Gender=Fem|Number=Sing	15	appos	15:appos	Entity=CESSCASTP1999120220s12.sn.89)
19	y	y	CCONJ	cc	_	21	cc	21:cc	_
20	el	el	DET	da0ms0	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	21	det	21:det	Entity=(CESSCASTP1999120220s12.sn.96--2-gstype:gen,HomoDD
21	afecto	afecto	NOUN	ncms000	Gender=Masc|Number=Sing	15	conj	15:conj	Entity=CESSCASTP1999120220s12.sn.96)
22	de	de	ADP	sps00	_	24	case	24:case	_
23	los	el	DET	da0mp0	Definite=Def|Gender=Masc|Number=Plur|PronType=Art	24	det	24:det	Entity=(CESSCASTP1999120220s12.sn.104--2-gstype:gen,HomoDD
24	tuyos	tuyo	PRON	px2mp000	Gender=Masc|Number=Plur|Person=2|Poss=Yes|PronType=Ind	15	nmod	15:nmod	SpaceAfter=No|ClusterId[1]=CESS-CAST-P-19991202-20-s12.sn.104|ClusterType[1]=Gen|MentionSpan[1]=23-24|MentionMisc[1]=HomoDD|ClusterId[2]=CESS-CAST-P-19991202-20-s12.p.108|ClusterType[2]=Gen|MentionSpan[2]=24|Entity=(CESSCASTP1999120220s12.p.108--1-gstype:gen)CESSCASTP1999120220s12.sn.104)
...
29	momentos	momento	NOUN	ncmp000	Gender=Masc|Number=Plur	28	obj	28:obj	Entity=(CESSCASTP1999120220s12.sn.118--1-gstype:gen
...
33	malos	malo	ADJ	aq0mp0	Gender=Masc|Number=Plur	30	conj	30:conj	SpaceAfter=No|Entity=CESSCASTP1999120220s12.sn.118)
