...
526 tokens (7%) have a non-empty value of `PronType`.
151 types (4%) occur at least once with a non-empty value of `PronType`.
40 lemmas (2%) occur at least once with a non-empty value of `PronType`.
The feature is used with 4 part-of-speech tags: <tt><a href="kpv_lattice-pos-PRON.html">PRON</a></tt> (443; 6% instances), <tt><a href="kpv_lattice-pos-ADV.html">ADV</a></tt> (56; 1% instances), <tt><a href="kpv_lattice-pos-ADJ.html">ADJ</a></tt> (19; 0% instances), <tt><a href="kpv_lattice-pos-DET.html">DET</a></tt> (8; 0% instances).

### `PRON`

443 <tt><a href="kpv_lattice-pos-PRON.html">PRON</a></tt> tokens (83% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="kpv_lattice-feat-Number.html">Number</a></tt><tt>=Sing</tt> (301; 68%), <tt><a href="kpv_lattice-feat-Case.html">Case</a></tt><tt>=Nom</tt> (243; 55%).
...
* `Prs` (312; 70% of non-empty `PronType`): <em>сійӧ, ме, ми, сы, сійӧс, найӧ, тэ, миян, сылӧн, сылы</em>
...
* `EMPTY` (88): <em>быд, став, мукӧд, ставыс, некод, некутшӧм, нинӧм, ставсӧ, ачым, мукӧдъясысь</em>
...
* `EMPTY` (816): <em>нин, жӧ, на, и, сӧмын, сэсся, зэв, пыр, бара, дзик</em>
...
* `EMPTY` (469): <em>ыджыд, кодь, важ, бур, мича, еджыд, ичӧтик, том, выль, кодьӧсь</em>
...
* `EMPTY` (37): <em>став, уна, коймӧдъяс, мӧд, мӧдъяс, ставыс, Кымынкӧ, Уналӧн, быд, кыкнан</em>
