...
2621 nodes (2%) are attached to their parents as `expl:pv`.
...
The following 3 pairs of parts of speech are connected with `expl:pv`: <tt><a href="sk_snk-pos-VERB.html">VERB</a></tt>-<tt><a href="sk_snk-pos-PRON.html">PRON</a></tt> (2588; 99% instances), <tt><a href="sk_snk-pos-ADJ.html">ADJ</a></tt>-<tt><a href="sk_snk-pos-PRON.html">PRON</a></tt> (28; 1% instances), <tt><a href="sk_snk-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sk_snk-pos-PRON.html">PRON</a></tt> (5; 0% instances).
...
3	duše	duša	NOUN	SSfs2	Case=Gen|Gender=Fem|Number=Sing	5	obl	5:obl	_
...
6	atmosférou	atmosféra	NOUN	SSfs7	Case=Ins|Gender=Fem|Number=Sing	4	obj	4:obj	SpaceAfter=No
...
1	Aktom	akt	NOUN	SSis7	Animacy=Inan|Case=Ins|Gender=Masc|Number=Sing	10	obl	10:obl	_
2	spojenia	spojenie	NOUN	SSns2	Case=Gen|Gender=Neut|Number=Sing	1	nmod	1:nmod	_
...
6	bytosťou	bytosť	NOUN	SSfs7	Case=Ins|Gender=Fem|Number=Sing	2	nmod	2:nmod	_
...
12	úroveň	úroveň	NOUN	SSfs4	Case=Acc|Gender=Fem|Number=Sing	10	obl	10:obl	_
13	božských	božský	ADJ	AAmp2x	Animacy=Anim|Case=Gen|Degree=Pos|Gender=Masc|Number=Plur	14	amod	14:amod	_
14	tvorcov	tvorca	NOUN	SSmp2	Animacy=Anim|Case=Gen|Gender=Masc|Number=Plur	12	nmod	12:nmod	SpaceAfter=No
