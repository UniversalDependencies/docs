...
There are 50 `PRON` lemmas (2%), 188 `PRON` types (4%) and 1038 `PRON` tokens (6%).
...
The form / lemma ratio of `PRON` is 3.760000 (the average of all parts of speech is 2.302829).
