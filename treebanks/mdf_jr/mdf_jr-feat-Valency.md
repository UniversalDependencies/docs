...
241 tokens (19%) have a non-empty value of `Valency`.
217 types (29%) occur at least once with a non-empty value of `Valency`.
152 lemmas (27%) occur at least once with a non-empty value of `Valency`.
The feature is used with 2 part-of-speech tags: <tt><a href="mdf_jr-pos-VERB.html">VERB</a></tt> (224; 18% instances), <tt><a href="mdf_jr-pos-AUX.html">AUX</a></tt> (17; 1% instances).

### `VERB`

224 <tt><a href="mdf_jr-pos-VERB.html">VERB</a></tt> tokens (97% of all `VERB` tokens) have a non-empty value of `Valency`.

The most frequent other feature values with which `VERB` and `Valency` co-occurred: <tt><a href="mdf_jr-feat-Number-obj.html">Number[obj]</a></tt><tt>=EMPTY</tt> (190; 85%), <tt><a href="mdf_jr-feat-Person-obj.html">Person[obj]</a></tt><tt>=EMPTY</tt> (190; 85%), <tt><a href="mdf_jr-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (180; 80%), <tt><a href="mdf_jr-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (158; 71%), <tt><a href="mdf_jr-feat-Number-subj.html">Number[subj]</a></tt><tt>=Sing</tt> (148; 66%).

`VERB` tokens may have the following values of `Valency`:

* `1` (125; 56% of non-empty `Valency`): <em>касан, ащи, кенярдсь, корхтай, лездсь, лиссть, лиссь, марявсь, мольсь, няевсь</em>
* `2` (99; 44% of non-empty `Valency`): <em>Арьсян, варжакстсь, сявонь, ёран, Арьсень, Варжакстонь, Ладяйне, Лихтезь, Няить, Панчк-ка</em>
...
`Valency` seems to be **lexical feature** of `VERB`. 98% lemmas (147) occur only with one value of `Valency`.

### `AUX`

17 <tt><a href="mdf_jr-pos-AUX.html">AUX</a></tt> tokens (39% of all `AUX` tokens) have a non-empty value of `Valency`.
...
<tt>VERB --[<tt><a href="mdf_jr-dep-xcomp.html">xcomp</a></tt>]--> VERB</tt> (10; 67%),
<tt>VERB --[<tt><a href="mdf_jr-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (7; 54%),
