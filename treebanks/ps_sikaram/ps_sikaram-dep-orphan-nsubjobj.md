---
layout: base
title:  'Statistics of orphan:nsubjobj in UD_Pashto-Sikaram'
udver: '2'
---
...
3 instances of `orphan:nsubjobj` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.

The following 2 pairs of parts of speech are connected with `orphan:nsubjobj`: <tt><a href="ps_sikaram-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ps_sikaram-pos-NOUN.html">NOUN</a></tt> (2; 67% instances), <tt><a href="ps_sikaram-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ps_sikaram-pos-NOUN.html">NOUN</a></tt> (1; 33% instances).
...
# visual-style 1 2 orphan:nsubjobj	color:blue
1	مریم	مریم	PROPN	_	Case=Acc|Gender=Fem|Number=Sing	0	root	_	Translit=maryám|LTranslit=maryám|Gloss=Mary
2	برونز	برونز	NOUN	_	Case=Nom|Gender=Masc|Number=Sing	1	orphan:nsubjobj	_	Translit=bronz|LTranslit=bronz|Gloss=bronze|SpaceAfter=No
3	،	،	PUNCT	_	_	4	punct	_	Translit=,|LTranslit=,|Gloss=,
4	پیتر	پیتر	PROPN	_	Case=Acc|Gender=Masc|Number=Sing	1	conj	_	Translit=pitr|LTranslit=pitr|Gloss=Peter
5	سپین	سپین	ADJ	_	Case=Nom|Gender=Masc|Number=Sing	6	amod	_	Translit=spin|LTranslit=spin|Gloss=white
6	زر	زر	NOUN	_	Case=Nom|Gender=Masc|Number=Sing	4	orphan:nsubjobj	_	Translit=zar|LTranslit=zar|Gloss=metal
7	او	او	CCONJ	_	_	8	cc	_	Translit=aw|LTranslit=aw|Gloss=and
8	جانې	جانه	PROPN	_	Case=Acc|Gender=Fem|Number=Sing	11	nsubj	_	Translit=jấne|LTranslit=ǰấna|Gloss=Jane
