...
7	cucarachas	cucaracha	NOUN	ncfp000	Gender=Fem|Number=Plur	5	obl	5:obl	Entity=(CESSCASTP20001001136s12.sn.21--1-gstype:gen)
8	como	como	SCONJ	cs	_	10	mark	10:mark	_
9	lo	él	PRON	pp3msa00	Case=Acc|Gender=Masc|Number=Sing|Person=3|PrepCase=Npr|PronType=Prs	10	obj	10:obj	Entity=(CESSCASTP20001001136c7--1-CorefType:dx.token)
10	hice	hacer	VERB	vmis1s0	Mood=Ind|Number=Sing|Person=1|Tense=Past|VerbForm=Fin	5	advcl	5:advcl	Entity=CESSCASTP20001001136c7)
11	y	y	CCONJ	cc	_	28	cc	28:cc	_
12	si	si	SCONJ	cs	_	15	mark	15:mark	_
13	me	yo	PRON	pp1cs000	Case=Dat|Number=Sing|Person=1|PrepCase=Npr|PronType=Prs	15	iobj	15:iobj	Entity=(CESSCASTP20001001136c1-person-1-CorefType:ident,gstype:spec)
...
16	poner	poner	VERB	vmn0000	VerbForm=Inf	15	xcomp	15:xcomp	Entity=(CESSCASTP20001001136c8--1
17	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	18	det	18:det	Entity=(CESSCASTP20001001136s12.sn.49--2-gstype:gen
18	cabeza	cabeza	NOUN	ncfs000	Gender=Fem|Number=Sing	16	obj	16:obj	Entity=CESSCASTP20001001136s12.sn.49)
19	debajo	debajo	ADV	sps00	_	22	case	22:case	MWE=debajo_de|MWEPOS=ADP
20	de	de	ADP	_	_	19	fixed	19:fixed	_
21	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	22	det	22:det	Entity=(CESSCASTP20001001136s12.sn.57--2-gstype:gen,HomoDD
22	pata	pata	NOUN	ncfs000	Gender=Fem|Number=Sing	16	obl	16:obl	_
23	de	de	ADP	sps00	_	25	case	25:case	_
24	un	uno	DET	di0ms0	Definite=Ind|Gender=Masc|Number=Sing|PronType=Art	25	det	25:det	Entity=(CESSCASTP20001001136s12.sn.65--2-gstype:gen
25	elefante	elefante	NOUN	ncms000	Gender=Masc|Number=Sing	22	nmod	22:nmod	Entity=CESSCASTP20001001136s12.sn.65)CESSCASTP20001001136s12.sn.57)CESSCASTP20001001136c8)
26	lo	él	PRON	pp3msa00	Case=Acc|Gender=Masc|Number=Sing|Person=3|PrepCase=Npr|PronType=Prs	28	obj	28:obj	Entity=(CESSCASTP20001001136c8--1-CorefType:dx.token)
...
3	me	yo	PRON	pp1cs000	Case=Dat|Number=Sing|Person=1|PrepCase=Npr|PronType=Prs	4	iobj	4:iobj	Entity=(CESSCASTP2002090211c5-person-1-CorefType:ident,gstype:spec)
4	faltaba	faltar	VERB	vmii3s0	Mood=Ind|Number=Sing|Person=3|Tense=Imp|VerbForm=Fin	44	ccomp	44:ccomp	_
5	el	el	DET	da0ms0	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	6	det	6:det	Entity=(CESSCASTP2002090211s22.sn.13--2-gstype:gen
6	principio	principio	NOUN	ncms000	Gender=Masc|Number=Sing	4	nsubj	4:nsubj	SpaceAfter=No|Entity=CESSCASTP2002090211s22.sn.13)
...
11	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	12	det	12:det	Entity=(CESSCASTP2002090211s22.sn.29--2-gstype:gen,HomoDD
12	radio	radio	NOUN	ncfs000	Gender=Fem|Number=Sing	10	obj	10:obj	Entity=CESSCASTP2002090211s22.sn.29)
...
16	José	José	PROPN	np00000	_	14	obj	14:obj	MWE=José_María_García|MWEPOS=PROPN|Entity=(CESSCASTP2002090211s22.sn.43-person-1-gstype:spec
17	María	María	PROPN	_	_	16	flat	16:flat	_
18	García	García	PROPN	_	_	16	flat	16:flat	Entity=CESSCASTP2002090211s22.sn.43)
...
22	lo	él	PRON	da0ns0	Case=Acc|Definite=Def|Gender=Masc|Number=Sing|Person=3|PrepCase=Npr|PronType=Prs	19	ccomp	19:ccomp	Entity=(CESSCASTP2002090211s22.sn.53--1-gstype:gen
...
32	esquina	esquina	NOUN	ncfs000	Gender=Fem|Number=Sing	25	obl	25:obl	SpaceAfter=No|Entity=CESSCASTP2002090211s22.sn.53)
...
36	me	yo	PRON	pp1cs000	Case=Dat|Number=Sing|Person=1|PrepCase=Npr|PronType=Prs	37	iobj	37:iobj	Entity=(CESSCASTP2002090211c5-person-1-CorefType:ident,gstype:spec)
37	hizo	hacer	VERB	vmis3s0	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	10	conj	10:conj	_
38	mucha	mucho	DET	di0fs0	Gender=Fem|Number=Sing|NumType=Card|PronType=Ind	39	det	39:det	Entity=(CESSCASTP2002090211s22.sn.83--2-gstype:gen
39	gracia	gracia	NOUN	ncfs000	Gender=Fem|Number=Sing	37	obj	37:obj	Entity=CESSCASTP2002090211s22.sn.83)
40	la	el	DET	da0fs0	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	41	det	41:det	Entity=(CESSCASTP2002090211s22.sn.88--2-gstype:gen
41	rima	rima	NOUN	ncfs000	Gender=Fem|Number=Sing	37	nsubj	37:nsubj	SpaceAfter=No|Entity=CESSCASTP2002090211s22.sn.88)
...
1	Los	el	DET	da0mp0	Definite=Def|Gender=Masc|Number=Plur|PronType=Art	2	det	2:det	Entity=(CESSCASTP2002010223s3.sn.3--2-gstype:gen,HomoDD
2	sensacionalistas	sensacionalista	NOUN	nccp000	Number=Plur	6	nsubj	6:nsubj	Entity=CESSCASTP2002010223s3.sn.3)
...
8	The	The	PROPN	np00000	_	10	nsubj	10:nsubj	MWE=The_Sun|MWEPOS=PROPN|Entity=(CESSCASTP2002010223c6-organization-1-gstype:spec
...
11	su	su	DET	dp3cs0	Number=Sing|Person=3|Poss=Yes|PronType=Prs	13	det	13:det	Entity=(CESSCASTP2002010223s3.sn.23--3-gstype:gen(CESSCASTP2002010223c6-organization-1-CorefType:ident,gstype:spec)
12	primera	primero	ADJ	ao0fs0	Gender=Fem|Number=Sing|NumType=Ord	13	amod	13:amod	_
13	portada	portada	NOUN	ncfs000	Gender=Fem|Number=Sing	10	obj	10:obj	_
14	de	de	ADP	spcms	_	16	case	16:case	_
15	el	el	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	16	det	16:det	_
16	2002	2002	NOUN	_	AdvType=Tim	13	nmod	13:nmod	Entity=(CESSCASTP2002010223s3.sn.34-time-1-gstype:spec)CESSCASTP2002010223s3.sn.23)
17	con	con	ADP	sps00	_	22	case	22:case	_
18	"	"	PUNCT	fe	PunctType=Quot	22	punct	22:punct	SpaceAfter=No|Entity=(CESSCASTP2002010223s3.sn.40-other-5-gstype:spec
19	El	el	DET	np00000	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	20	det	20:det	MWE=El_euro_ha_nacido_y_,_gracias_a_Dios_,_el_Reino_Unido_no_forma_parte_de_él|MWEPOS=PROPN
...
37	"	"	PUNCT	fe	PunctType=Quot	22	punct	22:punct	SpaceAfter=No|Entity=CESSCASTP2002010223s3.sn.40)
