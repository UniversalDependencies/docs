...
3	தேதியில்	தேதி	NOUN	NNL-3SN--	Case=Loc|Gender=Neut|Number=Sing|Person=3	5	obl	5:obl	Translit=tētiyil|LTranslit=tēti
4	இந்தியாவுக்குச்	இந்தியா	PROPN	NED-3SN--	Case=Dat|Gender=Neut|Number=Sing|Person=3	5	obl	5:obl	Translit=intiyāvukkuc|LTranslit=intiyā
...
9	செய்யப்படவ்	செய்	VERB	Vu-T---AA	Polarity=Pos|VerbForm=Inf|Voice=Act	0	root	0:root	Translit=ceyyappaṭav|LTranslit=cey
...
1	குரல்	குரல்	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	2	nmod	2:nmod	Translit=kural|LTranslit=kural
2	வாக்கெடுப்பு	வாக்கெடுப்பு	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	7	obl	7:obl	Translit=vākkeṭuppu|LTranslit=vākkeṭuppu
...
6	கூடுதலாக	கூடுதல்	ADV	AA-------	_	7	advmod	7:advmod	Translit=kūṭutalāka|LTranslit=kūṭutal
7	பெற்று	பெறு	VERB	Vt-T---AA	Polarity=Pos|VerbForm=Part|Voice=Act	10	advcl	10:advcl	Translit=perru|LTranslit=peru
8	எடியூரப்பா	எடியூரப்பா	PROPN	NEN-3SH--	Case=Nom|Gender=Com|Number=Sing|Person=3|Polite=Form	9	nmod	9:nmod	Translit=eṭiyūrappā|LTranslit=eṭiyūrappā
...
11	பெற்றுவிட்டத்	பெறு	AUX	VZND3SNAA	Case=Nom|Gender=Neut|Number=Sing|Person=3|Polarity=Pos|Tense=Past|VerbForm=Ger|Voice=Act	10	acl	10:acl	Translit=perruviṭṭat|LTranslit=peru
...
14	சட்ட	சட்டம்	PROPN	NO--3SN--	Gender=Neut|Number=Sing|Person=3	15	nmod	15:nmod	Translit=caṭṭa|LTranslit=caṭṭam
15	விரோதம்	விரோதம்	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	16	nmod	16:nmod	Translit=virōtam|LTranslit=virōtam
...
2	ஆண்டில்	ஆண்டு	NOUN	NNL-3SN--	Case=Loc|Gender=Neut|Number=Sing|Person=3	9	obl	9:obl	Translit=āṇṭil|LTranslit=āṇṭu
3	gஎர்மனியில்	gஎர்மனி	NOUN	NNL-3SN--	Case=Loc|Gender=Neut|Number=Sing|Person=3	9	obl	9:obl	Translit=germaniyil|LTranslit=germani
4	அணுஉலைக்	அணுஉலை	NOUN	NNN-3SN--	Case=Nom|Gender=Neut|Number=Sing|Person=3	5	nmod	5:nmod	Translit=aṇuulaik|LTranslit=aṇuulai
5	கூடங்கள்	கூடம்	NOUN	NNN-3PN--	Case=Nom|Gender=Neut|Number=Plur|Person=3	8	nmod	8:nmod	Translit=kūṭaṅkaḷ|LTranslit=kūṭam
...
9	ஏற்பட	ஏற்படு	VERB	Vu-T---AA	Polarity=Pos|VerbForm=Inf|Voice=Act	13	csubj	13:csubj	Translit=ērpaṭa|LTranslit=ērpaṭu
10	வேண்டும்	வேண்டு	AUX	VR-F3SNAA	Gender=Neut|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Fut|VerbForm=Fin|Voice=Act	9	aux	9:aux	Translit=vēṇṭum|LTranslit=vēṇṭu
