...
37593 tokens (9%) have a non-empty value of `Person`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (13858; 3% instances), <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (12582; 3% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (11153; 3% instances).

### `VERB`

13858 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (43% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13858; 100%), <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13858; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13250; 96%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (11047; 80%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10920; 79%).

`VERB` tokens may have the following values of `Person`:

* `1` (481; 3% of non-empty `Person`): <em>recommande, conseille, ai, trouve, vais, pense, pouvons, aime, devons, peux</em>
* `2` (258; 2% of non-empty `Person`): <em>allez, hésitez, avez, voulez, pouvez, passez, pourrez, êtes, pensez, cherchez</em>
* `3` (13119; 95% of non-empty `Person`): <em>a, peut, fait, est, devient, doit, ont, trouve, permet, faut</em>
...
12582 <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> tokens (70% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (10419; 83%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8359; 66%).

`PRON` tokens may have the following values of `Person`:

* `1` (1135; 9% of non-empty `Person`): <em>nous, je, j', m', me, moi, -je, -nous, -moi, I</em>
* `2` (333; 3% of non-empty `Person`): <em>vous, -vous, tu, -tu, t', te, toi, -toi, you, tien</em>
* `3` (11114; 88% of non-empty `Person`): <em>il, se, s', elle, on, c', en, ils, lui, ce</em>
* `EMPTY` (5444): <em>qui, dont, où, qu', y, que, un, cela, une, celle</em>
...
11153 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (87% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11153; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10808; 97%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9469; 85%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8843; 79%).

`AUX` tokens may have the following values of `Person`:

* `1` (410; 4% of non-empty `Person`): <em>ai, avons, suis, sommes, avais, avions, étais, serais, étions, aurais</em>
* `2` (36; 0% of non-empty `Person`): <em>êtes, avez, es, soyez, as, serez, seriez, ayez, fais, sois</em>
* `3` (10707; 96% of non-empty `Person`): <em>est, a, sont, ont, était, fut, avait, sera, étaient, soit</em>
...
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (4639; 61%),
<tt>VERB --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1242; 67%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl.html">expl</a></tt>]--> PRON</tt> (632; 54%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-pass.html">expl:pass</a></tt>]--> PRON</tt> (577; 75%),
<tt>PRON --[<tt><a href="fr_gsd-dep-acl-relcl.html">acl:relcl</a></tt>]--> VERB</tt> (171; 58%),
<tt>PRON --[<tt><a href="fr_gsd-dep-expl.html">expl</a></tt>]--> PRON</tt> (49; 89%),
...
<tt>PRON --[<tt><a href="fr_gsd-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (2; 67%).
