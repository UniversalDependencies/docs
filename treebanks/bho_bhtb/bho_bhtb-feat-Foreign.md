...
7 tokens (0%) have a non-empty value of `Foreign`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="bho_bhtb-pos-VERB.html">VERB</a></tt> (3; 0% instances), <tt><a href="bho_bhtb-pos-AUX.html">AUX</a></tt> (2; 0% instances), <tt><a href="bho_bhtb-pos-NOUN.html">NOUN</a></tt> (1; 0% instances), <tt><a href="bho_bhtb-pos-X.html">X</a></tt> (1; 0% instances).

### `VERB`

3 <tt><a href="bho_bhtb-pos-VERB.html">VERB</a></tt> tokens (0% of all `VERB` tokens) have a non-empty value of `Foreign`.
...
1 <tt><a href="bho_bhtb-pos-X.html">X</a></tt> tokens (100% of all `X` tokens) have a non-empty value of `Foreign`.
