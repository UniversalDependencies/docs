...
4	Beratung	Beratung	NOUN	NN	Case=Acc|Gender=Fem|Number=Sing	5	nmod	_	_
5	geht	gehen	VERB	VVFIN	Number=Sing|Person=3|VerbForm=Fin	10	advcl	_	_
...
2	Schreine	Schrein	NOUN	NN	Case=Nom|Number=Plur	13	nsubjpass	_	_
3	,	,	PUNCT	$,	_	2	punct	_	_
4	die	der	PRON	ART	Case=Nom|PronType=Dem	8	nsubjpass	_	_
5	Vishnu	Vishnu	PROPN	NN	Case=Dat|Number=Sing	8	iobj	_	_
6	und	und	CONJ	KON	_	5	cc	_	_
7	Brahma	Brahma	PROPN	NN	_	5	conj	_	_
8	gewidmet	widmen	VERB	VVPP	VerbForm=Part	2	advcl	_	_
9	sind	sein	AUX	VAFIN	Mood=Ind|Person=3|Tense=Pres|VerbForm=Fin	8	auxpass	_	_
...
14	werden	werden	AUX	VAINF	VerbForm=Inf	13	auxpass	_	_
