...
There are 35 `SCONJ` lemmas (0%), 36 `SCONJ` types (0%) and 4764 `SCONJ` tokens (3%).
...
* <em>co</em>
  * <tt><a href="cs_fictree-pos-PRON.html">PRON</a></tt> 538: <em>Jednak měla hezké rysy , ovšem to , <b>co</b> jí dodávalo krásu , byl pohled .</em>
  ...
  * <tt><a href="cs_fictree-pos-PART.html">PART</a></tt> 18: <em>" A proč chtěla umřít nahá , <b>co</b> ?</em>
* <em>jen</em>
...
The form / lemma ratio of `SCONJ` is 1.028571 (the average of all parts of speech is 1.968575).
