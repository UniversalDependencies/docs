...
The following 3 pairs of parts of speech are connected with `orphan`: <tt><a href="ab_abnc-pos-PRON.html">PRON</a></tt>-<tt><a href="ab_abnc-pos-NOUN.html">NOUN</a></tt> (4; 67% instances), <tt><a href="ab_abnc-pos-PRON.html">PRON</a></tt>-<tt><a href="ab_abnc-pos-ADV.html">ADV</a></tt> (1; 17% instances), <tt><a href="ab_abnc-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ab_abnc-pos-NOUN.html">NOUN</a></tt> (1; 17% instances).
...
7	иатәын	а-тәы́заара	VERB	V_Stat_Fin_Impf_S:3_IO:3SgNH	Dyn=No|Gender[io]=Neut|Mood=Ind|Number[io]=Sing|Person[io]=3|Person[subj]=3|Tense=Imp|VerbForm=Fin	3	conj	_	LMSeg:а-тәы́-заа-ра|SpaceAfter=No
8	,	,	PUNCT	Punct_Comma	_	9	punct	_	LMSeg:,
9	егьи	егьи́	PRON	Pron_Dem_Sg	Number=Sing|PronType=Dem	3	conj	_	LMSeg:егьи́
10	аҽыкәабарҭа	а-ҽы́кәабарҭа	NOUN	Noun_NH_Sg_Det	Animacy=Nhum|Definite=Def|Number=Sing	9	orphan	_	LMSeg:а-ҽы́кәабарҭа|SpaceAfter=No
...
3	уара	уара́	PRON	Pron_Pers_2SgM	Gender=Masc|Number=Sing|Person=2|PronType=Prs	0	root	_	LMSeg:уара́|SpaceAfter=No
4	?	?	PUNCT	Punct_IntMark	_	3	punct	_	LMSeg:?|SpaceAfter=No
