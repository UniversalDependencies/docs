...
10110 <tt><a href="nl_lassysmall-pos-DET.html">DET</a></tt> tokens (87% of all `DET` tokens) have a non-empty value of `Definite`.

`DET` tokens may have the following values of `Definite`:

* `Def` (8381; 83% of non-empty `Definite`): <em>de, het, der, 's, 't, des, dé</em>
* `Ind` (1729; 17% of non-empty `Definite`): <em>een</em>
* `EMPTY` (1544): <em>zijn, deze, haar, hun, dit, geen, alle, enkele, die, veel</em>
