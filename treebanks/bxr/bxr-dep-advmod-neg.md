---
layout: base
title:  'Statistics of advmod:neg in UD_Buryat'
udver: '2'
---

## Treebank Statistics: UD_Buryat: Relations: `advmod:neg`

This relation is a language-specific subtype of <tt><a href="bxr-dep-advmod.html">advmod</a></tt>.

19 nodes (0%) are attached to their parents as `advmod:neg`.

18 instances of `advmod:neg` (95%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.31578947368421.

The following 6 pairs of parts of speech are connected with `advmod:neg`: <tt><a href="bxr-pos-VERB.html">VERB</a></tt>-<tt><a href="bxr-pos-ADV.html">ADV</a></tt> (6; 32% instances), <tt><a href="bxr-pos-ADV.html">ADV</a></tt>-<tt><a href="bxr-pos-ADV.html">ADV</a></tt> (4; 21% instances), <tt><a href="bxr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="bxr-pos-PART.html">PART</a></tt> (4; 21% instances), <tt><a href="bxr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="bxr-pos-ADV.html">ADV</a></tt> (3; 16% instances), <tt><a href="bxr-pos-ADV.html">ADV</a></tt>-<tt><a href="bxr-pos-PART.html">PART</a></tt> (1; 5% instances), <tt><a href="bxr-pos-VERB.html">VERB</a></tt>-<tt><a href="bxr-pos-NOUN.html">NOUN</a></tt> (1; 5% instances).
...
# visual-style 6 7 advmod:neg	color:blue
1	Юрэ	юрэ	ADV	_	_	6	advmod	_	_
2	хүн	хүн	NOUN	_	Case=Nom	6	nsubj	_	_
3	бүхэн	бүхэ	PRON	_	Case=Nom|PronType=Dem	4	det	_	_
4	газарай	газар	NOUN	_	Case=Gen	5	nmod	_	_
...
12	түүхэтэ	түүхэтэй	ADJ	_	_	13	amod	_	_
13	үйлын	үйлэ	NOUN	_	Case=Gen	19	nmod	_	_
14	ашаар	ашаар	ADV	_	_	13	advmod	_	_
15	нэгэл	нэгэн	NUM	_	NumType=Card	16	nummod	_	_
...
# visual-style 6	bgColor:blue
# visual-style 6	fgColor:white
# visual-style 6 10 advmod:neg	color:blue
1	-	-	PUNCT	_	_	2	punct	_	_
2	Сэхыень	сэхэ	NOUN	_	Case=Acc|Number[psor]=Sing|Person[psor]=3	3	obj	_	_
3	хэлэхэдэ	хэлэ	VERB	_	Case=Dat|VerbForm=Ger	6	advcl	_	SpaceAfter=No
