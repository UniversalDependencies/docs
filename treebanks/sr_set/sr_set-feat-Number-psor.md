---
layout: base
title:  'Statistics of Number[psor] in UD_Serbian-SET'
udver: '2'
---

## Treebank Statistics: UD_Serbian-SET: Features: `Number[psor]`
...
364 tokens (0%) have a non-empty value of `Number[psor]`.
71 types (0%) occur at least once with a non-empty value of `Number[psor]`.
7 lemmas (0%) occur at least once with a non-empty value of `Number[psor]`.
The feature is used with 1 part-of-speech tags: <tt><a href="sr_set-pos-DET.html">DET</a></tt> (364; 0% instances).
