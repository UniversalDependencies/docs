...
8682 tokens (3%) have a non-empty value of `NumType`.
1737 types (3%) occur at least once with a non-empty value of `NumType`.
1688 lemmas (4%) occur at least once with a non-empty value of `NumType`.
The feature is used with 7 part-of-speech tags: <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> (7407; 3% instances), <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> (816; 0% instances), <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> (418; 0% instances), <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> (27; 0% instances), <tt><a href="de_gsd-pos-DET.html">DET</a></tt> (8; 0% instances), <tt><a href="de_gsd-pos-X.html">X</a></tt> (5; 0% instances), <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> (1; 0% instances).

### `NUM`

7407 <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

`NUM` tokens may have the following values of `NumType`:

* `Card` (7407; 100% of non-empty `NumType`): <em>zwei, drei, vier, 2007, fünf, 2006, 2009, sechs, 2010, 2008</em>

`NumType` seems to be **lexical feature** of `NUM`. 100% lemmas (1542) occur only with one value of `NumType`.

### `ADJ`

816 <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> tokens (4% of all `ADJ` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="de_gsd-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (816; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (657; 81%).

`ADJ` tokens may have the following values of `NumType`:

* `Card` (3; 0% of non-empty `NumType`): <em>3, siebenhundert, zehntausend</em>
* `Ord` (813; 100% of non-empty `NumType`): <em>ersten, erste, zweiten, zweite, dritten, erster, dritte, erstes, 5., fünften</em>
* `EMPTY` (19959): <em>später, weitere, anderen, neue, bekannt, neuen, großen, große, deutschen, gut</em>
...
* `EMPTY` (30262): <em>Deutschland, de, of, US, Berlin, the, SPD, St., new, Oktober</em>
...
The most frequent other feature values with which `DET` and `NumType` co-occurred: <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7; 88%).

`DET` tokens may have the following values of `NumType`:

* `Card` (8; 100% of non-empty `NumType`): <em>eine, eins, ein, einem, einen, eines</em>
* `EMPTY` (37653): <em>der, die, dem, den, das, des, eine, ein, einer, einem</em>
