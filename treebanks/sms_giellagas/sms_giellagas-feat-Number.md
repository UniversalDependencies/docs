...
1365 tokens (48%) have a non-empty value of `Number`.
560 types (77%) occur at least once with a non-empty value of `Number`.
320 lemmas (65%) occur at least once with a non-empty value of `Number`.
The feature is used with 9 part-of-speech tags: <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> (524; 18% instances), <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> (369; 13% instances), <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> (287; 10% instances), <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> (136; 5% instances), <tt><a href="sms_giellagas-pos-ADJ.html">ADJ</a></tt> (14; 0% instances), <tt><a href="sms_giellagas-pos-NUM.html">NUM</a></tt> (14; 0% instances), <tt><a href="sms_giellagas-pos-PROPN.html">PROPN</a></tt> (12; 0% instances), <tt><a href="sms_giellagas-pos-DET.html">DET</a></tt> (6; 0% instances), <tt><a href="sms_giellagas-pos-ADV.html">ADV</a></tt> (3; 0% instances).

### `VERB`

524 <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> tokens (82% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (523; 100%), <tt><a href="sms_giellagas-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (475; 91%), <tt><a href="sms_giellagas-feat-Person.html">Person</a></tt><tt>=3</tt> (447; 85%).
...
* `EMPTY` (112): <em>jieʹlled, kooǯǯted, välddam, väʹldded, hiâvted, jååʹtted, kuâddam, mõõnnâd, teâđstam, vueʹtǩǩmen</em>
...
369 <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> tokens (94% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (327; 89%), <tt><a href="sms_giellagas-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (327; 89%), <tt><a href="sms_giellagas-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (268; 73%).
...
* `Sing` (327; 89% of non-empty `Number`): <em>ooumaž, tueʹllj, mieʹccest, heävaš, nijdd, stäʹlmmstääll, ääkka, eččad, niõđ, niõđâž</em>
...
`Number` seems to be **lexical feature** of `NOUN`. 91% lemmas (126) occur only with one value of `Number`.

### `PRON`

287 <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> tokens (96% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-Case.html">Case</a></tt><tt>=Nom</tt> (193; 67%), <tt><a href="sms_giellagas-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (151; 53%).

`PRON` tokens may have the following values of `Number`:

* `Dual` (3; 1% of non-empty `Number`): <em>muännaid, suäna, suännast</em>
* `Plur` (31; 11% of non-empty `Number`): <em>miʹjjid, seeʹst, tõid, tuk, dõõk, jiijj, måttam, sij, tõk, Täk</em>
* `Sing` (253; 88% of non-empty `Number`): <em>son, tõt, tõn, ton, mon, suu, mii, muu, puk, tõt-i</em>
...
136 <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> tokens (88% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="sms_giellagas-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (133; 98%), <tt><a href="sms_giellagas-feat-Valency.html">Valency</a></tt><tt>=EMPTY</tt> (109; 80%), <tt><a href="sms_giellagas-feat-Person.html">Person</a></tt><tt>=3</tt> (94; 69%), <tt><a href="sms_giellagas-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (89; 65%), <tt><a href="sms_giellagas-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (71; 52%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (19; 14% of non-empty `Number`): <em>liâ, jeäʹla, jeäʹp, jiâ, Jeäʹled, lee, leʹjje</em>
* `Sing` (117; 86% of non-empty `Number`): <em>lij, ij, leäi, jiõk, õõk, jiõm, leäk, iʹlla, iʹlleäk, leäm</em>
...
14 <tt><a href="sms_giellagas-pos-ADJ.html">ADJ</a></tt> tokens (47% of all `ADJ` tokens) have a non-empty value of `Number`.
...
<tt>VERB --[<tt><a href="sms_giellagas-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (111; 85%),
<tt>VERB --[<tt><a href="sms_giellagas-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (87; 79%),
<tt>NOUN --[<tt><a href="sms_giellagas-dep-det.html">det</a></tt>]--> PRON</tt> (47; 96%),
<tt>VERB --[<tt><a href="sms_giellagas-dep-obl-lmod.html">obl:lmod</a></tt>]--> NOUN</tt> (25; 64%),
<tt>NOUN --[<tt><a href="sms_giellagas-dep-cop.html">cop</a></tt>]--> AUX</tt> (14; 93%),
<tt>VERB --[<tt><a href="sms_giellagas-dep-obl.html">obl</a></tt>]--> NOUN</tt> (12; 75%),
