...
21 tokens (0%) have a non-empty value of `Number[grnd]`.
...
21 <tt><a href="yrl_complin-pos-ADP.html">ADP</a></tt> tokens (2% of all `ADP` tokens) have a non-empty value of `Number[grnd]`.

The most frequent other feature values with which `ADP` and `Number[grnd]` co-occurred: <tt><a href="yrl_complin-feat-Rel.html">Rel</a></tt><tt>=NCont</tt> (21; 100%).
