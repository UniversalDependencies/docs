...
~~~ sdparse
ROOT Představenstvo podpořilo prosincový požadavek pana Greenwalda vůči Fondu národního majetku , aby prodal společnosti GSR v souladu s usnesením vlády č . 213 / 1993 ze svého držení část akcií a . s . Tatra Kopřivnice .
nsubj(podpořilo-3, Představenstvo-2)
root(ROOT-1, podpořilo-3)
amod(požadavek-5, prosincový-4)
dobj(podpořilo-3, požadavek-5)
nmod(Greenwalda-7, pana-6)
nmod(požadavek-5, Greenwalda-7)
case:auxp(požadavek-5, vůči-8)
nmod(vůči-8, Fondu-9)
amod(majetku-11, národního-10)
nmod(Fondu-9, majetku-11)
punct(aby-13, ,-12)
mark:auxc(požadavek-5, aby-13)
acl(aby-13, prodal-14)
dobj(prodal-14, společnosti-15)
nmod(společnosti-15, GSR-16)
case:auxp(s-19, v-17)
case:auxp(s-19, souladu-18)
case:auxp(prodal-14, s-19)
nmod(s-19, usnesením-20)
nmod(usnesením-20, vlády-21)
nmod(usnesením-20, č-22)
punct(č-22, .-23)
nummod(č-22, 213-24)
punct(1993-26, /-25)
nummod(213-24, 1993-26)
case:auxp(prodal-14, ze-27)
det(držení-29, svého-28)
nmod(ze-27, držení-29)
dobj(prodal-14, část-30)
nmod(část-30, akcií-31)
amod(s-34, a-32)
punct(a-32, .-33)
nmod(akcií-31, s-34)
punct(s-34, .-35)
nmod(s-34, Tatra-36)
nmod(Tatra-36, Kopřivnice-37)
root:auxk(ROOT-1, .-38)
~~~
...
nmod(požadavek-5, Greenwalda-7)
case(Fondu-9, vůči-8)
nmod(požadavek-5, Fondu-9)
amod(majetku-11, národního-10)
nmod(Fondu-9, majetku-11)
punct(prodal-14, ,-12)
mark(prodal-14, aby-13)
acl(požadavek-5, prodal-14)
dobj(prodal-14, společnosti-15)
nmod(společnosti-15, GSR-16)
case(usnesením-20, v-17)
mwe(v-17, souladu-18)
mwe(v-17, s-19)
nmod(prodal-14, usnesením-20)
nmod(usnesením-20, vlády-21)
nmod(usnesením-20, č-22)
punct(č-22, .-23)
nummod(č-22, 213-24)
punct(1993-26, /-25)
nummod(213-24, 1993-26)
case(držení-29, ze-27)
det(držení-29, svého-28)
nmod(prodal-14, držení-29)
dobj(prodal-14, část-30)
nmod(část-30, akcií-31)
amod(s-34, a-32)
punct(a-32, .-33)
