...
2027 nodes (1%) are attached to their parents as `aux:pass`.

2003 instances of `aux:pass` (99%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.11593487913172.

The following 4 pairs of parts of speech are connected with `aux:pass`: <tt><a href="lv_lvtb-pos-VERB.html">VERB</a></tt>-<tt><a href="lv_lvtb-pos-AUX.html">AUX</a></tt> (2022; 100% instances), <tt><a href="lv_lvtb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="lv_lvtb-pos-AUX.html">AUX</a></tt> (3; 0% instances), <tt><a href="lv_lvtb-pos-ADJ.html">ADJ</a></tt>-<tt><a href="lv_lvtb-pos-AUX.html">AUX</a></tt> (1; 0% instances), <tt><a href="lv_lvtb-pos-SCONJ.html">SCONJ</a></tt>-<tt><a href="lv_lvtb-pos-AUX.html">AUX</a></tt> (1; 0% instances).
...
1	Tā	tā	ADV	r0n	PronType=Dem	4	advmod	4:advmod	LvtbNodeId=a-p10683-p20s6w1
2	jau	jau	ADV	r0n	_	4	advmod	4:advmod	LvtbNodeId=a-p10683-p20s6w2
3	ir	būt	AUX	vcnipii30an	Evident=Fh|Mood=Ind|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	4	aux:pass	4:aux:pass	LvtbNodeId=a-p10683-p20s6w3
4	noiets	noiets	NOUN	ncmsn1	Case=Nom|Gender=Masc|Number=Sing	0	root	0:root	LvtbNodeId=a-p10683-p20s6w4
5	etaps	etaps	NOUN	ncmsn1	Case=Nom|Gender=Masc|Number=Sing	4	nsubj:pass	4:nsubj:pass	LvtbNodeId=a-p10683-p20s6w5|SpaceAfter=No
6	,	,	PUNCT	zc	_	8	punct	8:punct	LvtbNodeId=a-p10683-p20s6w6
7	kad	kad	ADV	r0n	PronType=Int	8	advmod	8:advmod	LvtbNodeId=a-p10683-p20s6w7
8	varu	varēt	VERB	vonipi31san	Evident=Fh|Mood=Ind|Number=Sing|Person=1|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	5	acl	5:acl	LvtbNodeId=a-p10683-p20s6w8
...
12	vairāk	daudz	ADV	rcn	Degree=Cmp	15	advmod	15:advmod	LvtbNodeId=a-p10683-p20s6w12
...
1	Vēl	vēl	ADV	r0n	_	3	advmod	3:advmod	LvtbNodeId=a-d198-p73s2w1
2	vienmēr	vienmēr	ADV	r0n	PronType=Tot	3	advmod	3:advmod	LvtbNodeId=a-d198-p73s2w2
...
5	vēl	vēl	ADV	r0n	_	7	advmod	7:advmod	LvtbNodeId=a-d198-p73s2w5
6	vienmēr	vienmēr	ADV	r0n	PronType=Tot	7	advmod	7:advmod	LvtbNodeId=a-d198-p73s2w6
...
15	tuvu	tuvu	ADV	rpn	Degree=Pos	13	conj	15.1:advmod	LvtbNodeId=a-d198-p73s2w15|SpaceAfter=No
