---
layout: base
title:  'Statistics of advmod:emph in UD_Middle_Armenian-ArmTDP'
udver: '2'
---

## Treebank Statistics: UD_Middle_Armenian-ArmTDP: Relations: `advmod:emph`

This relation is a language-specific subtype of <tt><a href="axm_armtdp-dep-advmod.html">advmod</a></tt>.

4 nodes (0%) are attached to their parents as `advmod:emph`.

3 instances of `advmod:emph` (75%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 2 pairs of parts of speech are connected with `advmod:emph`: <tt><a href="axm_armtdp-pos-NOUN.html">NOUN</a></tt>-<tt><a href="axm_armtdp-pos-PART.html">PART</a></tt> (3; 75% instances), <tt><a href="axm_armtdp-pos-NOUN.html">NOUN</a></tt>-<tt><a href="axm_armtdp-pos-ADV.html">ADV</a></tt> (1; 25% instances).
...
# visual-style 44 45 advmod:emph	color:blue
