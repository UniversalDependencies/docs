...
179 nodes (2%) are attached to their parents as `nmod:poss`.

158 instances of `nmod:poss` (88%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.02793296089385.

The following 2 pairs of parts of speech are connected with `nmod:poss`: <tt><a href="cy_ccg-pos-NOUN.html">NOUN</a></tt>-<tt><a href="cy_ccg-pos-PRON.html">PRON</a></tt> (173; 97% instances), <tt><a href="cy_ccg-pos-PRON.html">PRON</a></tt>-<tt><a href="cy_ccg-pos-PRON.html">PRON</a></tt> (6; 3% instances).
...
3	dewch	dod	VERB	verb	Number=Plur|Person=2|Tense=Fut	0	root	_	_
...
8	hun	hun	PRON	refl	PronType=Rcp	6	nmod	_	SpaceAfter=No
