...
5	US-Mobilfunker	US-Mobilfunker	NOUN	NN	Case=Nom|Gender=Masc|Number=Sing	10	nsubj:pass	_	_
...
14	die	der	DET	ART	Case=Nom|Definite=Def|Gender=Masc|Number=Plur|PronType=Art	16	det	_	_
15	meisten	meist	ADV	PIDAT	Degree=Sup|Number=Plur|PronType=Ind	16	advmod	_	_
16	Analysten	Analyst	NOUN	NN	Case=Nom|Gender=Masc|Number=Plur	13	nsubj	_	_
