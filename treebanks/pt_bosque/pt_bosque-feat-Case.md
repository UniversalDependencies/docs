...
The feature is used with 1 part-of-speech tags: <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> (2539; 1% instances).

### `PRON`

2539 <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> tokens (34% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="pt_bosque-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (2538; 100%), <tt><a href="pt_bosque-feat-Person.html">Person</a></tt><tt>=3</tt> (1935; 76%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1621; 64%), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (1364; 54%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (1778; 70% of non-empty `Case`): <em>se, o, me, a, nos, lo, os, la, as, los</em>
...
* `EMPTY` (4927): <em>que, o, isso, onde, quem, tudo, os, isto, nada, a</em>
