...
The feature is used with 2 part-of-speech tags: [ar-pos/VERB]() (21491; 8% instances), [ar-pos/AUX]() (39; 0% instances).

### `VERB`

21491 [ar-pos/VERB]() tokens (100% of all `VERB` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `VERB` and `Voice` co-occurred: <tt><a href="Person.html">Person</a>=3</tt> (21260; 99%), <tt><a href="Number.html">Number</a>=Sing</tt> (20126; 94%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (13516; 63%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (11442; 53%), <tt><a href="VerbForm.html">VerbForm</a>=EMPTY</tt> (11442; 53%), <tt><a href="Aspect.html">Aspect</a>=Perf</tt> (11442; 53%).

`VERB` tokens may have the following values of `Voice`:

* `Act` (20272; 94% of non-empty `Voice`): قال، كان، كانت، أضاف، تم، أكد، يتم، يكون، يمكن، أشار
* `Pass` (1219; 6% of non-empty `Voice`): يذكر، يوجد، قتل، يتوقع، تعد، تعتبر، يعد، أصيب، توجد، يعتبر
...
39 [ar-pos/AUX]() tokens (100% of all `AUX` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `AUX` and `Voice` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (39; 100%), <tt><a href="Person.html">Person</a>=3</tt> (39; 100%), <tt><a href="Aspect.html">Aspect</a>=Perf</tt> (38; 97%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (35; 90%).

`AUX` tokens may have the following values of `Voice`:

* `Act` (39; 100% of non-empty `Voice`): ليس، ليست، ألا، تعد

## Relations with Agreement in `Voice`

The 10 most frequent relations where parent and child node agree in `Voice`:
<tt>VERB --[<a href="../dep/ccomp.html">ccomp</a>]--> VERB</tt> (2358; 92%),
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (2320; 93%),
<tt>VERB --[<a href="../dep/advcl.html">advcl</a>]--> VERB</tt> (1016; 91%),
<tt>VERB --[<a href="../dep/xcomp.html">xcomp</a>]--> VERB</tt> (611; 96%),
<tt>VERB --[<a href="../dep/parataxis.html">parataxis</a>]--> VERB</tt> (224; 95%),
<tt>VERB --[<a href="../dep/csubj.html">csubj</a>]--> VERB</tt> (214; 71%),
...
<tt>VERB --[<a href="../dep/mark.html">mark</a>]--> VERB</tt> (3; 100%).
