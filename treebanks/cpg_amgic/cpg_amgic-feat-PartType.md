...
1 <tt><a href="cpg_amgic-pos-PART.html">PART</a></tt> tokens (5% of all `PART` tokens) have a non-empty value of `PartType`.

The most frequent other feature values with which `PART` and `PartType` co-occurred: <tt><a href="cpg_amgic-feat-Polarity.html">Polarity</a></tt><tt>=Neg</tt> (1; 100%).
