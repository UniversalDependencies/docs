---
layout: base
title:  'Statistics of PUNCT in UD_Czech-Poetry'
udver: '2'
---

## Treebank Statistics: UD_Czech-Poetry: POS Tags: `PUNCT`

There are 14 `PUNCT` lemmas (1%), 14 `PUNCT` types (1%) and 1148 `PUNCT` tokens (18%).
...
The form / lemma ratio of `PUNCT` is 1.000000 (the average of all parts of speech is 1.401136).
