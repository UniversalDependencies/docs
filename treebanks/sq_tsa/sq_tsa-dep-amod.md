---
layout: base
title:  'Statistics of amod in UD_Albanian-TSA'
udver: '2'
---

## Treebank Statistics: UD_Albanian-TSA: Relations: `amod`

This relation is universal.

70 nodes (8%) are attached to their parents as `amod`.

69 instances of `amod` (99%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.68571428571429.

The following 3 pairs of parts of speech are connected with `amod`: <tt><a href="sq_tsa-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sq_tsa-pos-ADJ.html">ADJ</a></tt> (67; 96% instances), <tt><a href="sq_tsa-pos-PROPN.html">PROPN</a></tt>-<tt><a href="sq_tsa-pos-ADJ.html">ADJ</a></tt> (2; 3% instances), <tt><a href="sq_tsa-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sq_tsa-pos-ADV.html">ADV</a></tt> (1; 1% instances).
