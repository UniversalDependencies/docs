---
layout: base
title:  'Statistics of discourse in UD_Galician-PUD'
udver: '2'
---

## Treebank Statistics: UD_Galician-PUD: Relations: `discourse`
...
1	Mais	mais	CCONJ	CC	_	3	discourse	_	_
2	cando	cando	ADV	RG	_	3	advmod	_	_
3	suxiro	suxerir	VERB	VMIP1S0	Mood=Ind|Number=Sing|Person=1|Tense=Pres	0	root	_	_
4	que	que	SCONJ	CS	_	5	mark	_	_
5	use	usar	VERB	VMSP1S0	Mood=Sub|Number=Sing|Person=1|Tense=Pres	3	ccomp	_	_
6	a	a	ADP	SP	AdpType=Prep	7	case	_	_
7	Frank	frank	PROPN	NP00000	_	5	obj	_	_
8	de	de	ADP	SP	AdpType=Prep	9	case	_	_
9	modelo	modelo	NOUN	NCCS000	Gender=Com|Number=Sing	5	obl	_	SpaceAfter=No
10	,	,	PUNCT	Fc	_	12	punct	_	_
...
1	Agora	agora	ADV	RG	_	5	discourse	_	SpaceAfter=No
2	,	,	PUNCT	Fc	_	5	punct	_	_
3	este	este	DET	DD0MS0	Definite=Def|Gender=Masc|Number=Sing|PronType=Dem	4	det	_	_
4	departamento	departamento	NOUN	NCMS000	Gender=Masc|Number=Sing	5	nsubj	_	_
5	enfronta	enfrontar	VERB	VMIP3S0	Mood=Ind|Number=Sing|Person=3|Tense=Pres	0	root	_	_
6	se	se	PRON	PP3CN000	Gender=Com|Person=3|PronType=Prs	5	expl	_	_
7	a	a	ADP	SP	AdpType=Prep	9	case	_	_
8	novos	novo	ADJ	AQ0MP	_	9	amod	_	_
9	desafíos	desafío	NOUN	NCMP000	Gender=Masc|Number=Plur	5	obj	_	SpaceAfter=No
10	.	.	PUNCT	Fp	_	5	punct	_	_
