...
There are 31 `ADP` lemmas (1%), 34 `ADP` types (1%) and 4249 `ADP` tokens (10%).
...
The form / lemma ratio of `ADP` is 1.096774 (the average of all parts of speech is 1.357880).
