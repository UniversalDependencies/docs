...
4	λέγ’ς	λέγου	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
...
11	Βασίλ’	Βασίλς	PROPN	_	Case=Acc|Gender=Masc|Number=Sing	9	appos	_	_
...
8	προυξινήτρα	προυξινήτρα	NOUN	_	Case=Acc|Gender=Fem|Number=Sing	6	appos	_	_
