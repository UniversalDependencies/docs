...
425 nodes (0%) are attached to their parents as `expl`.

326 instances of `expl` (77%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.23058823529412.
