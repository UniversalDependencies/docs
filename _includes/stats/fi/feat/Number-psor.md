...
615 lemmas (3%) occur at least once with a non-empty value of `Number[psor]`.
The feature is used with 8 part-of-speech tags: [fi-pos/NOUN]() (838; 0% instances), [fi-pos/VERB]() (151; 0% instances), [fi-pos/ADV]() (61; 0% instances), [fi-pos/PRON]() (46; 0% instances), [fi-pos/ADJ]() (13; 0% instances), [fi-pos/ADP]() (13; 0% instances), [fi-pos/PROPN]() (5; 0% instances), [fi-pos/AUX]() (3; 0% instances).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Degree.html">Degree</a>=Pos|<a href="Number.html">Number</a>=Sing|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="PartForm.html">PartForm</a>=Pres|<a href="Person[psor].html">Person[psor]</a>=2|<a href="VerbForm.html">VerbForm</a>=Part</tt></td><td></td><td><em>olevasi</em></td></tr>
...
The most frequent other feature values with which `AUX` and `Number[psor]` co-occurred: <tt><a href="Voice.html">Voice</a>=Act</tt> (3; 100%), <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (3; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (3; 100%), <tt><a href="Tense.html">Tense</a>=EMPTY</tt> (3; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (3; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Part</tt> (2; 67%).

`AUX` tokens may have the following values of `Number[psor]`:


<table>
  <tr><th>Paradigm <i>voida</i></th><th><tt>Plur</tt></th><th><tt>Sing</tt></th></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Degree.html">Degree</a>=Pos|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="PartForm.html">PartForm</a>=Pres|<a href="Person[psor].html">Person[psor]</a>=2|<a href="VerbForm.html">VerbForm</a>=Part</tt></td><td></td><td><em>voivasi</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Degree.html">Degree</a>=Pos|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="PartForm.html">PartForm</a>=Pres|<a href="Person[psor].html">Person[psor]</a>=1|<a href="VerbForm.html">VerbForm</a>=Part</tt></td><td></td><td><em>voivani</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Tra|<a href="InfForm.html">InfForm</a>=1|<a href="Number[psor].html">Number[psor]</a>=Plur|<a href="Person[psor].html">Person[psor]</a>=1|<a href="VerbForm.html">VerbForm</a>=Inf</tt></td><td><em>voidaksemme</em></td><td></td></tr>
</table>
...
1052 tokens (1%) have a non-empty value of `Number[psor]`.
...
The feature is used with 8 part-of-speech tags: [fi-pos/NOUN]() (678; 0% instances), [fi-pos/VERB]() (149; 0% instances), [fi-pos/ADV]() (103; 0% instances), [fi-pos/PRON]() (61; 0% instances), [fi-pos/ADP]() (28; 0% instances), [fi-pos/ADJ]() (27; 0% instances), [fi-pos/PROPN]() (5; 0% instances), [fi-pos/NUM]() (1; 0% instances).

### `NOUN`

678 [fi-pos/NOUN]() tokens (2% of all `NOUN` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `NOUN` and `Number[psor]` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (524; 77%).

`NOUN` tokens may have the following values of `Number[psor]`:


<table>
  <tr><th>Paradigm <i>asia</i></th><th><tt>Plur</tt></th><th><tt>Sing</tt></th></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=2</tt></td><td></td><td><em>asiasi</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number[psor].html">Number[psor]</a>=Plur|<a href="Person[psor].html">Person[psor]</a>=1</tt></td><td><em>asiamme</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=2</tt></td><td></td><td><em>asiasi</em></td></tr>
</table>

`Number[psor]` seems to be **lexical feature** of `NOUN`. 91% lemmas (384) occur only with one value of `Number[psor]`.

### `VERB`

149 [fi-pos/VERB]() tokens (0% of all `VERB` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `VERB` and `Number[psor]` co-occurred: <tt><a href="Mood.html">Mood</a>=EMPTY</tt> (149; 100%), <tt><a href="Tense.html">Tense</a>=EMPTY</tt> (149; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (149; 100%), <tt><a href="Voice.html">Voice</a>=Act</tt> (112; 75%), <tt><a href="InfForm.html">InfForm</a>=EMPTY</tt> (77; 52%), <tt><a href="PartForm.html">PartForm</a>=EMPTY</tt> (76; 51%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (76; 51%), <tt><a href="VerbForm.html">VerbForm</a>=Inf</tt> (76; 51%).
...
`Number[psor]` seems to be **lexical feature** of `VERB`. 92% lemmas (76) occur only with one value of `Number[psor]`.

### `ADV`

103 [fi-pos/ADV]() tokens (1% of all `ADV` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `ADV` and `Number[psor]` co-occurred: <tt><a href="PronType.html">PronType</a>=EMPTY</tt> (103; 100%).

`ADV` tokens may have the following values of `Number[psor]`:


<table>
  <tr><th>Paradigm <i>mukana</i></th><th><tt>Plur</tt></th><th><tt>Sing</tt></th></tr>
  <tr><td><tt><a href="Number[psor].html">Number[psor]</a>=Plur</tt></td><td><em>mukanamme</em></td><td></td></tr>
  <tr><td><tt><a href="Number[psor].html">Number[psor]</a>=Sing</tt></td><td></td><td><em>Mukanani</em></td></tr>
</table>

### `PRON`

61 [fi-pos/PRON]() tokens (1% of all `PRON` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `PRON` and `Number[psor]` co-occurred: <tt><a href="Person.html">Person</a>=EMPTY</tt> (61; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (53; 87%), <tt><a href="PronType.html">PronType</a>=Prs</tt> (49; 80%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Ade|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=2</tt></td><td></td><td><em>ittelläs</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Ela|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=1</tt></td><td></td><td><em>itsestäni</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=2</tt></td><td></td><td><em>itsesi</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Par|<a href="Number[psor].html">Number[psor]</a>=Plur|<a href="Person[psor].html">Person[psor]</a>=2</tt></td><td><em>itseänne</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Par|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=1</tt></td><td></td><td><em>itseäni, itteeni</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Par|<a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=2</tt></td><td></td><td><em>itseäsi, ittees</em></td></tr>
</table>

### `ADP`

28 [fi-pos/ADP]() tokens (1% of all `ADP` tokens) have a non-empty value of `Number[psor]`.
...
<table>
  ...
  <tr><td><tt><a href="Number[psor].html">Number[psor]</a>=Sing|<a href="Person[psor].html">Person[psor]</a>=2</tt></td><td></td><td><em>takias</em></td></tr>
</table>

### `ADJ`

27 [fi-pos/ADJ]() tokens (0% of all `ADJ` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `ADJ` and `Number[psor]` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (20; 74%).
...
The most frequent other feature values with which `NUM` and `Number[psor]` co-occurred: <tt><a href="Case.html">Case</a>=Nom</tt> (1; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (1; 100%), <tt><a href="NumType.html">NumType</a>=Card</tt> (1; 100%).
...
The 10 most frequent relations where parent and child node agree in `Number[psor]`:
<tt>NOUN --[<a href="../dep/conj.html">conj</a>]--> NOUN</tt> (13; 65%),
