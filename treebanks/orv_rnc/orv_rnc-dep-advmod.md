...
4	Михаил	Михаилъ	PROPN	OOV|Animacy[lex]=Anim	Case=Nom|Gender=Masc|Number=Sing	3	appos	_	_
5	Федорович	Федоровичь	PROPN	OOV|Animacy[lex]=Anim	Case=Nom|Gender=Masc|Number=Sing	4	flat:name	_	_
6	о	о	ADP	_	_	7	case	_	_
7	том	то	PRON	_	Case=Loc|Gender=Neut|Number=Sing	9	obl	_	_
8	как	какъ	ADV	_	Degree=Pos	9	advmod	_	_
9	укажет	указати	VERB	OOV|Transit=Tran	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin	0	root	_	SpaceAfter=No
...
5	отлагающим	отлагати	VERB	_	Aspect=Imp|Case=Dat|Gender=Masc|Number=Plur|Tense=Pres|Variant=Long|VerbForm=Part|Voice=Act	0	root	_	SpaceAfter=No
