---
layout: base
title:  'Statistics of Tense in UD_Norwegian-Bokmaal'
udver: '2'
---

## Treebank Statistics: UD_Norwegian-Bokmaal: Features: `Tense`
...
15447 <tt><a href="no_bokmaal-pos-AUX.html">AUX</a></tt> tokens (90% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="no_bokmaal-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (15447; 100%), <tt><a href="no_bokmaal-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (15447; 100%).

`AUX` tokens may have the following values of `Tense`:

* `Past` (3460; 22% of non-empty `Tense`): <em>var, ble, hadde, skulle, ville, kunne, måtte, burde, fikk, torde</em>
* `Pres` (11987; 78% of non-empty `Tense`): <em>er, har, kan, vil, skal, må, blir, bør, får, tør</em>
* `EMPTY` (1734): <em>være, vært, ha, bli, blitt, kunne, få, fått, måtte, måttet</em>
...
<tt>VERB --[<tt><a href="no_bokmaal-dep-conj.html">conj</a></tt>]--> VERB</tt> (1523; 66%).
