---
layout: base
title:  'Statistics of advcl in UD_Karo-TuDeT'
udver: '2'
---

## Treebank Statistics: UD_Karo-TuDeT: Relations: `advcl`

This relation is universal.

3 nodes (0%) are attached to their parents as `advcl`.

2 instances of `advcl` (67%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.33333333333333.

The following 3 pairs of parts of speech are connected with `advcl`: <tt><a href="arr_tudet-pos-NOUN.html">NOUN</a></tt>-<tt><a href="arr_tudet-pos-VERB.html">VERB</a></tt> (1; 33% instances), <tt><a href="arr_tudet-pos-PART.html">PART</a></tt>-<tt><a href="arr_tudet-pos-VERB.html">VERB</a></tt> (1; 33% instances), <tt><a href="arr_tudet-pos-VERB.html">VERB</a></tt>-<tt><a href="arr_tudet-pos-VERB.html">VERB</a></tt> (1; 33% instances).
