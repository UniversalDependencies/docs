...
21 tokens (0%) have a non-empty value of `Person[refl]`.
21 types (1%) occur at least once with a non-empty value of `Person[refl]`.
15 lemmas (1%) occur at least once with a non-empty value of `Person[refl]`.
The feature is used with 1 part-of-speech tags: <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> (21; 0% instances).

### `VERB`

21 <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> tokens (1% of all `VERB` tokens) have a non-empty value of `Person[refl]`.
