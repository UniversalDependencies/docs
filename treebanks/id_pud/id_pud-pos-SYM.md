---
layout: base
title:  'Statistics of SYM in UD_Indonesian-PUD'
udver: '2'
---

## Treebank Statistics: UD_Indonesian-PUD: POS Tags: `SYM`

There are 4 `SYM` lemmas (0%), 4 `SYM` types (0%) and 38 `SYM` tokens (0%).
...
The form / lemma ratio of `SYM` is 1.000000 (the average of all parts of speech is 1.138187).
...
`SYM` nodes are attached to their parents using 10 different relations: <tt><a href="id_pud-dep-obl.html">obl</a></tt> (8; 21% instances), <tt><a href="id_pud-dep-nmod.html">nmod</a></tt> (7; 18% instances), <tt><a href="id_pud-dep-obj.html">obj</a></tt> (6; 16% instances), <tt><a href="id_pud-dep-root.html">root</a></tt> (5; 13% instances), <tt><a href="id_pud-dep-flat.html">flat</a></tt> (3; 8% instances), <tt><a href="id_pud-dep-nsubj.html">nsubj</a></tt> (3; 8% instances), <tt><a href="id_pud-dep-conj.html">conj</a></tt> (2; 5% instances), <tt><a href="id_pud-dep-nsubj-pass.html">nsubj:pass</a></tt> (2; 5% instances), <tt><a href="id_pud-dep-advcl.html">advcl</a></tt> (1; 3% instances), <tt><a href="id_pud-dep-ccomp.html">ccomp</a></tt> (1; 3% instances)

Parents of `SYM` nodes belong to 5 different parts of speech: <tt><a href="id_pud-pos-VERB.html">VERB</a></tt> (18; 47% instances), <tt><a href="id_pud-pos-NOUN.html">NOUN</a></tt> (8; 21% instances),  (5; 13% instances), <tt><a href="id_pud-pos-SYM.html">SYM</a></tt> (5; 13% instances), <tt><a href="id_pud-pos-ADJ.html">ADJ</a></tt> (2; 5% instances)
