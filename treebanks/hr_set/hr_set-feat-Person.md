...
21743 tokens (11%) have a non-empty value of `Person`.
2578 types (7%) occur at least once with a non-empty value of `Person`.
1366 lemmas (7%) occur at least once with a non-empty value of `Person`.
The feature is used with 4 part-of-speech tags: <tt><a href="hr_set-pos-AUX.html">AUX</a></tt> (11412; 6% instances), <tt><a href="hr_set-pos-VERB.html">VERB</a></tt> (7914; 4% instances), <tt><a href="hr_set-pos-PRON.html">PRON</a></tt> (1588; 1% instances), <tt><a href="hr_set-pos-DET.html">DET</a></tt> (829; 0% instances).

### `AUX`

11412 <tt><a href="hr_set-pos-AUX.html">AUX</a></tt> tokens (91% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="hr_set-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11412; 100%), <tt><a href="hr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10637; 93%), <tt><a href="hr_set-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (10635; 93%), <tt><a href="hr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8335; 73%).

`AUX` tokens may have the following values of `Person`:

* `1` (593; 5% of non-empty `Person`): <em>smo, sam, ćemo, bismo, nismo, bih, nisam, ću, nećemo, neću</em>
* `2` (200; 2% of non-empty `Person`): <em>ćete, ste, biste, si, bi, niste, Jeste, nećete, ćeš, budite</em>
* `3` (10619; 93% of non-empty `Person`): <em>je, su, će, bi, nije, neće, nisu, bude, jest, hoće</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="hr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="hr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="hr_set-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>sam, Nisam, jesam</em></td><td><em>si, jesi</em></td><td><em>je, bude, jest, Nije, biva</em></td></tr>
  ...
  <tr><td><tt><tt><a href="hr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="hr_set-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="hr_set-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>smo, Nismo, budemo, jesmo</em></td><td><em>ste, Jeste, Niste, budete</em></td><td><em>su, budu, jesu, Nisu</em></td></tr>
</table>

### `VERB`

7914 <tt><a href="hr_set-pos-VERB.html">VERB</a></tt> tokens (46% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="hr_set-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (7914; 100%), <tt><a href="hr_set-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (7914; 100%), <tt><a href="hr_set-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (7914; 100%), <tt><a href="hr_set-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (7695; 97%), <tt><a href="hr_set-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (7688; 97%), <tt><a href="hr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4836; 61%).

`VERB` tokens may have the following values of `Person`:

* `1` (707; 9% of non-empty `Person`): <em>možemo, mislim, imamo, moramo, želimo, mogu, nadamo, vjerujem, nadam, znam</em>
* `2` (481; 6% of non-empty `Person`): <em>možete, želite, kliknite, imate, morate, nemojte, koristite, možeš, nemate, očekujete</em>
* `3` (6726; 85% of non-empty `Person`): <em>može, ima, kaže, treba, mogu, nema, mora, postoji, imaju, radi</em>
* `EMPTY` (9473): <em>izjavio, rekao, kazao, imati, mogli, mogla, dodao, mogao, moglo, trebala</em>
...
1588 <tt><a href="hr_set-pos-PRON.html">PRON</a></tt> tokens (30% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="hr_set-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1588; 100%), <tt><a href="hr_set-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (1588; 100%), <tt><a href="hr_set-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (886; 56%), <tt><a href="hr_set-feat-Number.html">Number</a></tt><tt>=Sing</tt> (812; 51%).
...
* `EMPTY` (3712): <em>se, što, ništa, tko, nešto, nitko, čime, čega, sebe, sebi</em>

`Person` seems to be **lexical feature** of `PRON`. 100% lemmas (10) occur only with one value of `Person`.

### `DET`

829 <tt><a href="hr_set-pos-DET.html">DET</a></tt> tokens (11% of all `DET` tokens) have a non-empty value of `Person`.
...
* `EMPTY` (6855): <em>koji, to, koje, koja, svoje, nekoliko, ove, toga, sve, kojima</em>

## Relations with Agreement in `Person`

The 10 most frequent relations where parent and child node agree in `Person`:
<tt>VERB --[<tt><a href="hr_set-dep-conj.html">conj</a></tt>]--> VERB</tt> (729; 66%),
<tt>AUX --[<tt><a href="hr_set-dep-ccomp.html">ccomp</a></tt>]--> VERB</tt> (17; 77%),
<tt>AUX --[<tt><a href="hr_set-dep-conj.html">conj</a></tt>]--> VERB</tt> (15; 54%),
<tt>AUX --[<tt><a href="hr_set-dep-advcl.html">advcl</a></tt>]--> VERB</tt> (12; 60%),
...
<tt>VERB --[<tt><a href="hr_set-dep-vocative.html">vocative</a></tt>]--> PRON</tt> (1; 100%).
