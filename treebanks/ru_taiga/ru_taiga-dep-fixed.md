...
4	в	в	ADP	_	ExtPos=ADP	7	case	_	_
...
7	дня	день	NOUN	_	Animacy=Inan|Case=Gen|Gender=Masc|Number=Sing	3	obl:tmod	_	SpaceAfter=No
...
3	как	как	ADV	_	Degree=Pos|ExtPos=ADV|PronType=Rel	6	advmod	_	_
...
1	Так	так	ADV	_	Degree=Pos|ExtPos=SCONJ|PronType=Dem	4	mark	_	_
