...
84 tokens (0%) have a non-empty value of `ConjType`.
...
The feature is used with 1 part-of-speech tags: <tt><a href="hyw_armtdp-pos-CCONJ.html">CCONJ</a></tt> (84; 0% instances).

### `CCONJ`

84 <tt><a href="hyw_armtdp-pos-CCONJ.html">CCONJ</a></tt> tokens (2% of all `CCONJ` tokens) have a non-empty value of `ConjType`.

`CCONJ` tokens may have the following values of `ConjType`:

* `Comp` (84; 100% of non-empty `ConjType`): <em>այլ, այլեւ, եւ</em>
