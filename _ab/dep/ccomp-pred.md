...
1	Сара	сара́	PRON	_	Number=Sing|Person=1|PronType=Prs	0	root	_	_
2	соума	а́кә-заа-ра	AUX	_	Dyn=No|Mood=Int|Number[io]=Sing|Person[io]=1|Person[subj]=3|Tense=Pres|VerbForm=NonFin	1	cop	_	_
...
6	иуҧхьаӡо	а́-ҧхьаӡа-ра	VERB	_	Dyn=Yes|Gender[subj]=Masc|Number[subj]=Sing|Person[obj]=Rel|Person[subj]=2|Tense=Pres|Trans=Yes|VerbForm=NonFin	1	csubj	_	_
