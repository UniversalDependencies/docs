...
61191 <tt><a href="ca-pos-DET.html">DET</a></tt> tokens (84% of all `DET` tokens) have a non-empty value of `Gender`.
...
* `Fem` (907; 28% of non-empty `Gender`): <em>la, una, les, aquesta, altra, unes, ella, algunes, totes, elles</em>
