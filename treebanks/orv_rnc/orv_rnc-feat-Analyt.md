...
20 lemmas (1%) occur at least once with a non-empty value of `Analyt`.
...
64 <tt><a href="orv_rnc-pos-AUX.html">AUX</a></tt> tokens (25% of all `AUX` tokens) have a non-empty value of `Analyt`.
...
20 <tt><a href="orv_rnc-pos-SCONJ.html">SCONJ</a></tt> tokens (7% of all `SCONJ` tokens) have a non-empty value of `Analyt`.
