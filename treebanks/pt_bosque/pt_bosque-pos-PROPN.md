...
There are 7226 `PROPN` lemmas (35%), 7255 `PROPN` types (25%) and 19012 `PROPN` tokens (8%).
...
The form / lemma ratio of `PROPN` is 1.004013 (the average of all parts of speech is 1.418361).

The 1st highest number of forms (11) was observed with the lemma “_”: <em>Cuba, Exército, Gorbatchov;, Hussein, Kadhafi, Líbia, Monsenhor, Pérez, Saddam, Santiago, Serantes</em>.
