...
114890 <tt><a href="is_icepahc-pos-PRON.html">PRON</a></tt> tokens (95% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (88526; 77%), <tt><a href="is_icepahc-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (87748; 76%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (4111; 4% of non-empty `PronType`): <em>sjálfur, það, þeim, þeir, sjálfum, slíkt, því, þeirra, sjálfan, þá</em>
* `Ind` (4270; 4% of non-empty `PronType`): <em>annað, öðrum, annan, aðrir, annar, öðru, aðra, annars, önnur, hver</em>
* `Int` (2135; 2% of non-empty `PronType`): <em>hvað, hver, hverju, hvers, hverjir, hverra, hvern, hverja, hverjar, vorar</em>
* `Prs` (104374; 91% of non-empty `PronType`): <em>hann, það, þeir, því, ég, eg, honum, hans, hún, þú</em>
* `EMPTY` (5446): <em>þú, því, þá, hönum, vor, annars, eg, vorum, ér, við</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>honum</em></td><td></td><td><em>þeim, hönum</em></td><td><em>hönum, þeirra</em></td></tr>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>þeirri</em></td><td></td></tr>
...
30412 <tt><a href="is_icepahc-pos-DET.html">DET</a></tt> tokens (68% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (30412; 100%), <tt><a href="is_icepahc-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (30412; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (22070; 73%).

`DET` tokens may have the following values of `PronType`:

* `Dem` (14355; 47% of non-empty `PronType`): <em>þetta, sá, þessi, þann, þessu, það, þessa, þeim, þessum, þá</em>
...
* `Prs` (1384; 5% of non-empty `PronType`): <em>það, þeim, því, þeir, þess, þau, þeirra, þá, þær, minna</em>
* `EMPTY` (14453): <em>einn, mikið, hinn, eitt, mikill, hið, margir, meira, þá, meir</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>þessari</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td></td><td><em>þessum</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>þessarar</em></td><td></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>þessi</em></td><td></td><td><em>þessara</em></td><td></td></tr>
...
871 <tt><a href="is_icepahc-pos-ADV.html">ADV</a></tt> tokens (1% of all `ADV` tokens) have a non-empty value of `PronType`.

`ADV` tokens may have the following values of `PronType`:

* `Dem` (194; 22% of non-empty `PronType`): <em>þá, hvílík, sama, sjálfum, glöggvasta, hvorsu, hvílíka, sjálfa, öðruvís, því</em>
...
823 <tt><a href="is_icepahc-pos-ADJ.html">ADJ</a></tt> tokens (2% of all `ADJ` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADJ` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (823; 100%), <tt><a href="is_icepahc-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (823; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (746; 91%).

`ADJ` tokens may have the following values of `PronType`:

* `Dem` (710; 86% of non-empty `PronType`): <em>sama, sömu, sami, samri, sams, hvílíkur, samur, glöggvasta, hvílík, samt</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>sömu</em></td><td></td></tr>
...
`PronType` seems to be **lexical feature** of `ADJ`. 91% lemmas (30) occur only with one value of `PronType`.

### `NOUN`

261 <tt><a href="is_icepahc-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `NOUN` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (261; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (220; 84%).

`NOUN` tokens may have the following values of `PronType`:

* `Dem` (14; 5% of non-empty `PronType`): <em>sá, þetta, okurið, sjálfa, sjálfan, strendli, Þessir, þessi, þá</em>
...
`PronType` seems to be **lexical feature** of `NOUN`. 95% lemmas (53) occur only with one value of `PronType`.

### `PROPN`

223 <tt><a href="is_icepahc-pos-PROPN.html">PROPN</a></tt> tokens (1% of all `PROPN` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PROPN` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (223; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (205; 92%), <tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Nom</tt> (197; 88%), <tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (121; 54%).
...
<table>
  ...
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td><em>Því</em></td><td></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td><em>Þess</em></td><td></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td></td><td><em>Sá</em></td></tr>
</table>

`PronType` seems to be **lexical feature** of `PROPN`. 96% lemmas (23) occur only with one value of `PronType`.

### `VERB`

203 <tt><a href="is_icepahc-pos-VERB.html">VERB</a></tt> tokens (0% of all `VERB` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `VERB` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (203; 100%), <tt><a href="is_icepahc-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (203; 100%), <tt><a href="is_icepahc-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (203; 100%), <tt><a href="is_icepahc-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (203; 100%), <tt><a href="is_icepahc-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (202; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (168; 83%), <tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (138; 68%).
...
* `Prs` (89; 44% of non-empty `PronType`): <em>sér, minna, vora, ann, bannaða, brennanda, dansandi, fanst, fyltist, gerði</em>
* `EMPTY` (128466): <em>sagði, segir, kom, mælti, fór, tók, varð, gekk, fara, sjá</em>
...
* `EMPTY` (34189): <em>að, sem, er, hvort, eð, ef, at, en, hvert, og</em>
...
153 <tt><a href="is_icepahc-pos-ADP.html">ADP</a></tt> tokens (0% of all `ADP` tokens) have a non-empty value of `PronType`.

`ADP` tokens may have the following values of `PronType`:

* `Dem` (7; 5% of non-empty `PronType`): <em>fyr, Þá, það</em>
* `Ind` (33; 22% of non-empty `PronType`): <em>alls, fyr, eptir, ór</em>
* `Prs` (113; 74% of non-empty `PronType`): <em>við, fyr, því, eftir, Það</em>
* `EMPTY` (111002): <em>í, á, til, af, með, um, fyrir, að, við, upp</em>
...
* `Ind` (55; 100% of non-empty `PronType`): <em>bæði, annað, báðir, hverki</em>
* `EMPTY` (57196): <em>og, en, eða, eður, bæði, né, hvorki, enda, hvörki, ýmist</em>

### `NUM`

44 <tt><a href="is_icepahc-pos-NUM.html">NUM</a></tt> tokens (1% of all `NUM` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `NUM` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (44; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (41; 93%), <tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt> (36; 82%), <tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Nom</tt> (33; 75%).

`NUM` tokens may have the following values of `PronType`:

* `Dem` (1; 2% of non-empty `PronType`): <em>þess</em>
* `Ind` (38; 86% of non-empty `PronType`): <em>hvorttveggja, hvorutveggja, hvorstveggja, Hvort, ein, eina, hver, nokkurt</em>
* `Int` (2; 5% of non-empty `PronType`): <em>hvorutveggja, xij</em>
* `Prs` (3; 7% of non-empty `PronType`): <em>hvorttveggja, þeir, þess</em>
* `EMPTY` (4367): <em>tveir, tólf, tvo, fimm, tvö, sex, þrír, þrjú, sjö, þrjá</em>

<table>
  <tr><th>Paradigm <i>hvortveggja</i></th><th><tt>Prs</tt></th><th><tt>Ind</tt></th></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td><em>hvorttveggja</em></td><td></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td></td><td><em>hvorttveggja, hvorutveggja</em></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Masc</tt></tt></td><td></td><td><em>hvorstveggja</em></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td></td><td><em>hvorstveggja</em></td></tr>
  <tr><td><tt><tt><a href="is_icepahc-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="is_icepahc-feat-Gender.html">Gender</a></tt><tt>=Neut</tt></tt></td><td></td><td><em>hvorttveggja</em></td></tr>
</table>

### `AUX`

19 <tt><a href="is_icepahc-pos-AUX.html">AUX</a></tt> tokens (0% of all `AUX` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `AUX` and `PronType` co-occurred: <tt><a href="is_icepahc-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (19; 100%), <tt><a href="is_icepahc-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (19; 100%), <tt><a href="is_icepahc-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (19; 100%), <tt><a href="is_icepahc-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (19; 100%), <tt><a href="is_icepahc-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (19; 100%), <tt><a href="is_icepahc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (16; 84%).

`AUX` tokens may have the following values of `PronType`:

* `Dem` (4; 21% of non-empty `PronType`): <em>var, vóru</em>
* `Ind` (6; 32% of non-empty `PronType`): <em>mundi, vóru, Myndi</em>
* `Int` (2; 11% of non-empty `PronType`): <em>vildi</em>
* `Prs` (7; 37% of non-empty `PronType`): <em>sér, vorum, meguð, var</em>
* `EMPTY` (51253): <em>var, er, voru, hafði, vera, væri, hafa, eru, mun, verið</em>
...
* `EMPTY` (2270): <em>anno, item, in, domini, et, Dominus, Trankival, Majst, sankti, etc</em>
...
<tt>PRON --[<tt><a href="is_icepahc-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (189; 72%),
<tt>PRON --[<tt><a href="is_icepahc-dep-obl.html">obl</a></tt>]--> PRON</tt> (174; 69%),
<tt>PRON --[<tt><a href="is_icepahc-dep-ccomp.html">ccomp</a></tt>]--> PRON</tt> (100; 86%),
<tt>PRON --[<tt><a href="is_icepahc-dep-xcomp.html">xcomp</a></tt>]--> PRON</tt> (86; 82%),
<tt>PRON --[<tt><a href="is_icepahc-dep-conj.html">conj</a></tt>]--> PRON</tt> (68; 77%),
...
<tt>PRON --[<tt><a href="is_icepahc-dep-advcl.html">advcl</a></tt>]--> PRON</tt> (7; 70%),
