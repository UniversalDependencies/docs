...
3891 <tt><a href="sv_pud-pos-NOUN.html">NOUN</a></tt> tokens (97% of all `NOUN` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `NOUN` and `Definite` co-occurred: <tt><a href="sv_pud-feat-Case.html">Case</a></tt><tt>=Nom</tt> (3766; 97%), <tt><a href="sv_pud-feat-Gender.html">Gender</a></tt><tt>=Com</tt> (2820; 72%), <tt><a href="sv_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2779; 71%).
...
* `Ind` (2538; 65% of non-empty `Definite`): <em>år, personer, fall, miljoner, del, grund, oktober, liv, plats, antal</em>
* `EMPTY` (103): <em>%, f.Kr., md, morse, Mps, nr, AIDS, AKP:s, BA, Business</em>
...
920 <tt><a href="sv_pud-pos-ADJ.html">ADJ</a></tt> tokens (58% of all `ADJ` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `ADJ` and `Definite` co-occurred: <tt><a href="sv_pud-feat-Case.html">Case</a></tt><tt>=Nom</tt> (919; 100%), <tt><a href="sv_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (816; 89%), <tt><a href="sv_pud-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (789; 86%), <tt><a href="sv_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (789; 86%), <tt><a href="sv_pud-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (714; 78%).

`ADJ` tokens may have the following values of `Definite`:

* `Def` (391; 43% of non-empty `Definite`): <em>hela, senaste, nya, sista, högsta, största, södra, andra, bästa, främsta</em>
* `Ind` (529; 57% of non-empty `Definite`): <em>flera, stor, fler, lång, ensam, hög, liten, modern, politisk, sett</em>
* `EMPTY` (656): <em>första, andra, många, nya, stora, olika, större, små, vissa, betydande</em>
...
<tt>NOUN --[<tt><a href="sv_pud-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (363; 58%),
<tt>NOUN --[<tt><a href="sv_pud-dep-conj.html">conj</a></tt>]--> NOUN</tt> (199; 87%),
<tt>NOUN --[<tt><a href="sv_pud-dep-obl.html">obl</a></tt>]--> NOUN</tt> (25; 71%),
...
<tt>NOUN --[<tt><a href="sv_pud-dep-acl-relcl.html">acl:relcl</a></tt>]--> NOUN</tt> (5; 100%).
