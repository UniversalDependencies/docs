...
The feature is used with 1 part-of-speech tags: [CCONJ](cs_cac-pos-CCONJ.html) (2; 0% instances).

### `CCONJ`

2 [CCONJ](cs_cac-pos-CCONJ.html) tokens (0% of all `CCONJ` tokens) have a non-empty value of `ConjType`.
