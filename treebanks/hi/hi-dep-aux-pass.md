---
layout: base
title:  'Statistics of aux:pass in UD_Hindi'
udver: '2'
---

## Treebank Statistics: UD_Hindi: Relations: `aux:pass`

This relation is a language-specific subtype of <tt><a href="hi-dep-aux.html">aux</a></tt>.

11108 nodes (3%) are attached to their parents as `aux:pass`.

11103 instances of `aux:pass` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.00162045372704.

The following 5 pairs of parts of speech are connected with `aux:pass`: <tt><a href="hi-pos-AUX.html">AUX</a></tt>-<tt><a href="hi-pos-AUX.html">AUX</a></tt> (6692; 60% instances), <tt><a href="hi-pos-VERB.html">VERB</a></tt>-<tt><a href="hi-pos-AUX.html">AUX</a></tt> (4411; 40% instances), <tt><a href="hi-pos-ADJ.html">ADJ</a></tt>-<tt><a href="hi-pos-ADJ.html">ADJ</a></tt> (2; 0% instances), <tt><a href="hi-pos-NUM.html">NUM</a></tt>-<tt><a href="hi-pos-NUM.html">NUM</a></tt> (2; 0% instances), <tt><a href="hi-pos-SCONJ.html">SCONJ</a></tt>-<tt><a href="hi-pos-SCONJ.html">SCONJ</a></tt> (1; 0% instances).
...
9	उत्पादों	उत्पाद	NOUN	NN	Case=Acc|Gender=Masc|Number=Plur|Person=3	16	obj	_	Vib=0_को|Tam=0|ChunkId=NP4|ChunkType=head|Translit=utpādoṁ
...
13	में	में	ADP	PSP	AdpType=Post	12	case	_	ChunkId=NP6|ChunkType=child|Translit=meṁ
...
21	रही	रह	AUX	VAUX	Aspect=Perf|Gender=Fem|Number=Sing|VerbForm=Part	20	aux:pass	_	Vib=या|Tam=yA|ChunkId=VGNF|ChunkType=child|Translit=rahī
...
26	बाधाओं	बाधा	NOUN	NN	Case=Acc|Gender=Fem|Number=Plur|Person=3	29	nmod	_	Vib=0_का|Tam=0|ChunkId=NP8|ChunkType=head|Translit=bādhāoṁ
