...
## Treebank Statistics: UD_Georgian-GNC: Relations: `aux`
...
1	ეგებ	ეგებ	ADV	Adv_Comm	_	3	advmod	_	LMSeg:ეგებ
2	ისევე	ისევე	ADV	Adv_Foc	_	3	advmod	_	LMSeg:ისევე
3	მიუღებელი	მიუღებელი	ADJ	A_Part_NegPart_Pv_Nom_Sg_Encl:Aux	Case=Nom|Number=Sing|Polarity=Neg|Tense=Pres|VerbForm=Part	0	root	_	LMSeg:მი·უღებ[ე]ლ·ი/ღ|SpaceAfter=No
4	ა	ყოფნა	AUX	V_MedPass_Pres_S:3Sg_Encl	Mood=Ind|Number[subj]=Sing|Person[subj]=3|Tense=Pres|VerbForm=Fin	3	aux	_	LMSeg:ყოფნ[ა]/არ|SpaceAfter=No
5	,	,	PUNCT	Punct_Comma	_	10	punct	_	LMSeg:,
6	როგორც	როგორც	ADP	Cj_Compar	_	10	mark	_	LMSeg:როგორც
7	სამყაროს	სამყარო	NOUN	N_Gen_Sg	Case=Gen|Number=Sing	9	nmod	_	LMSeg:სამყარო
8	მუდმივად	მუდმივად	ADV	A_Advb_Sg	_	9	advmod	_	LMSeg:მუდმივად
9	არსებობის	არსებობა	NOUN	N_VN_Gen_Sg	Case=Gen|Number=Sing|VerbForm=Vnoun	10	nmod	_	LMSeg:არსებობ[ა]/არსებ
10	იდეა	იდეა	NOUN	N_Nom_Sg	Case=Nom|Number=Sing	3	obl	_	LMSeg:იდე[ა]|SpaceAfter=No
...
1	შეიძლება	შეიძლება	AUX	Modal	_	3	aux	_	LMSeg:შეიძლება|SpaceAfter=No
2	,	,	PUNCT	Punct_Comma	_	3	punct	_	LMSeg:,
3	ასეც	ასე	ADV	Adv_Mann_Encl:ც_Foc	Encl=C	0	root	_	LMSeg:ასე
4	იყოს	ყოფნა	AUX	V_Pass_Opt_S:3Sg	Mood=Sub|Number[subj]=Sing|Person[subj]=3|Tense=Past|VerbForm=Fin	3	cop	_	LMSeg:ყოფნ[ა]/ყ[ავ]|SpaceAfter=No
