...
There are 1232 `VERB` lemmas (11%), 2568 `VERB` types (16%) and 9871 `VERB` tokens (10%).
...
The form / lemma ratio of `VERB` is 2.084416 (the average of all parts of speech is 1.422764).
