---
layout: base
title:  'Statistics of case in UD_Latgalian-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Latgalian-Cairo: Relations: `case`
...
1	Jai	jī	PRON	pp3fsdn	Case=Dat|Gender=Fem|Number=Sing|Person=3|PronType=Prs	2	obl	2:obl:dat	LvtbNodeId=a-ltg-Cairo-p17s1w1
2	vajadzēja	vajadzēt	VERB	vonisi330an	Evident=Fh|Mood=Ind|Person=3|Polarity=Pos|Tense=Past|VerbForm=Fin|Voice=Act	0	root	0:root	LvtbNodeId=a-ltg-Cairo-p17s1w2
3	apgrīzt	apgrīzt	VERB	vmnn0t1000n	Polarity=Pos|VerbForm=Inf	2	xcomp	2:xcomp	LvtbNodeId=a-ltg-Cairo-p17s1w3
...
16	.	.	PUNCT	zs	_	2	punct	2:punct	LvtbNodeId=a-ltg-Cairo-p17s1w16
...
1	Iz	iz	ADP	spsa	_	2	case	2:case	LvtbNodeId=a-ltg-Cairo-p13s1w1
2	kuo	kas	PRON	pr000an	Case=Acc|PronType=Rel	4	obl	4:obl:iz	LvtbNodeId=a-ltg-Cairo-p13s1w2
