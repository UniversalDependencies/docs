...
There are 41 `ADP` lemmas (2%), 36 `ADP` types (1%) and 3470 `ADP` tokens (8%).
...
The form / lemma ratio of `ADP` is 0.878049 (the average of all parts of speech is 1.329287).
...
`ADP` occurs with 1 features: <tt><a href="fr_parisstories-feat-ExtPos.html">ExtPos</a></tt> (163; 5% instances)
