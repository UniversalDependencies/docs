...
2	nipiya	piya	VERB	_	Mood=Ind|Number[subj]=Sing|Person[subj]=1|Subcat=Tran|VerbForm=Fin	0	root	0:root	NormalizedForm=nipiya|NormalizedLemma=piya
...
10	nitiquitoc	tiquiti	VERB	_	Aspect=Prog|Mood=Ind|Number[subj]=Sing|Person[subj]=1|Subcat=Intr|Tense=Pres|VerbForm=Fin	2	advcl	2:advcl	SpaceAfter=No|NormalizedForm=nitikitok|NormalizedLemma=tikiti
...
2	ticatca	catqui	AUX	_	Aspect=Imp|Number[subj]=Plur|Person[subj]=1|Subcat=Intr|Tense=Past	5	cop	5:cop	NormalizedForm=tikatka|NormalizedLemma=katki
...
6	huan	huan	CCONJ	_	_	9	cc	9:cc	NormalizedForm=wan|NormalizedLemma=wan
7	nochi	nochi	PRON	_	_	9	nsubj	9:nsubj	NormalizedForm=nochi|NormalizedLemma=nochi
8	o	o	AUX	_	_	9	aux	9:aux	NormalizedForm=o|NormalizedLemma=o
9	tipanohque	panoa	VERB	_	Aspect=Perf|Mood=Ind|Number[subj]=Plur|Person[subj]=1|Subcat=Intr|Tense=Past|VerbForm=Fin	5	conj	5:conj	NormalizedForm=tipanohke|NormalizedLemma=panoa
...
1	Para	para	ADP	_	Foreign=Yes	3	mark	3:mark	NormalizedForm=Para|NormalizedLemma=para
2	ohcon	ohcon	ADV	_	_	3	advmod	3:advmod	NormalizedForm=ohkon|NormalizedLemma=ohkon
3	techmanteneroz	manteneroa	VERB	_	Mood=Ind|Number[obj]=Plur|Number[subj]=Sing|Person[obj]=1|Person[subj]=3|Subcat=Tran|Tense=Fut|VerbForm=Fin	0	root	0:root	NormalizedForm=techmanteneros|NormalizedLemma=manteneroa
4	tehhuan	tehhuan	PRON	_	Number=Plur|Person=1|PronType=Prs	3	obj	3:obj	NormalizedForm=tehwan|NormalizedLemma=tehwan
5	tiomen	ome	NUM	_	_	4	nummod	4:nummod	NormalizedForm=tiomen|NormalizedLemma=ome
