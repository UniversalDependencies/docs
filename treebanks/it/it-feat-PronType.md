...
58586 tokens (21%) have a non-empty value of `PronType`.
...
The feature is used with 4 part-of-speech tags: <tt><a href="it-pos-DET.html">DET</a></tt> (45942; 16% instances), <tt><a href="it-pos-PRON.html">PRON</a></tt> (10771; 4% instances), <tt><a href="it-pos-ADV.html">ADV</a></tt> (1872; 1% instances), <tt><a href="it-pos-ADJ.html">ADJ</a></tt> (1; 0% instances).

### `DET`

45942 <tt><a href="it-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="it-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (35925; 78%), <tt><a href="it-feat-Number.html">Number</a></tt><tt>=Sing</tt> (33429; 73%).
...
10771 <tt><a href="it-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="it-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (7852; 73%), <tt><a href="it-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (6340; 59%), <tt><a href="it-feat-Clitic.html">Clitic</a></tt><tt>=EMPTY</tt> (6304; 59%), <tt><a href="it-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (6106; 57%).
...
* `Ind` (986; 9% of non-empty `PronType`): <em>uno, tutto, tutti, altri, una, altro, nessuno, più, molti, nulla</em>
...
1872 <tt><a href="it-pos-ADV.html">ADV</a></tt> tokens (17% of all `ADV` tokens) have a non-empty value of `PronType`.
...
<tt>PRON --[<tt><a href="it-dep-conj.html">conj</a></tt>]--> PRON</tt> (32; 82%),
