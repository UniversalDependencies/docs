...
169 tokens (0%) have a non-empty value of `NumType`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="it_markit-pos-ADJ.html">ADJ</a></tt> (98; 0% instances), <tt><a href="it_markit-pos-NUM.html">NUM</a></tt> (70; 0% instances), <tt><a href="it_markit-pos-PRON.html">PRON</a></tt> (1; 0% instances).

### `ADJ`

98 <tt><a href="it_markit-pos-ADJ.html">ADJ</a></tt> tokens (4% of all `ADJ` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `ADJ` and `NumType` co-occurred: <tt><a href="it_markit-feat-Number.html">Number</a></tt><tt>=Sing</tt> (76; 78%), <tt><a href="it_markit-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (59; 60%).

`ADJ` tokens may have the following values of `NumType`:

* `Ord` (98; 100% of non-empty `NumType`): <em>primo, prima, seconda, primi, secondo, ultimo, prime, ultimi, 1°, II</em>
* `EMPTY` (2459): <em>stesso, grande, importante, altri, stessa, altro, possibile, umano, difficile, diverse</em>
...
* `EMPTY` (3118): <em>che, si, ci, lo, questo, la, c', ciò, noi, cui</em>
