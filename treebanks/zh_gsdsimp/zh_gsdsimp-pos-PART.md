...
There are 574 `PART` lemmas (3%), 574 `PART` types (3%) and 9881 `PART` tokens (8%).
...
The form / lemma ratio of `PART` is 1.000000 (the average of all parts of speech is 1.004572).
