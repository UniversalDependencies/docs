...
The most frequent other feature values with which `ADJ` and `Abbr` co-occurred: <tt><a href="orv_rnc-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (6; 86%), <tt><a href="orv_rnc-feat-Gender.html">Gender</a></tt><tt>=Fem</tt> (6; 86%), <tt><a href="orv_rnc-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5; 71%).
