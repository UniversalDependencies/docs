...
2	They	they	PRON	PRP	Case=Nom|Number=Plur|Person=3|PronType=Prs	5	nsubj	_	Entity=(person-37)
...
6	it	it	PRON	PRP	Case=Acc|Gender=Neut|Number=Sing|Person=3|PronType=Prs	5	obj	_	Entity=(abstract-39)|SpaceAfter=No
...
3	the	the	DET	DT	Definite=Def|PronType=Art	4	det	_	Entity=(abstract-12
4	Oath	oath	NOUN	NN	Number=Sing	2	obj	_	Entity=abstract-12)
5	to	to	ADP	IN	_	7	case	_	_
6	our	our	PRON	PRP$	Number=Plur|Person=1|Poss=Yes|PronType=Prs	7	nmod:poss	_	Entity=(abstract-13
7	Constitution	Constitution	PROPN	NNP	Number=Sing	4	nmod	_	Entity=abstract-13)
8	at	at	ADP	IN	_	11	case	_	_
9	22	22	NUM	CD	NumType=Card	10	nummod	_	_
...
3	we	we	PRON	PRP	Case=Nom|Number=Plur|Person=1|PronType=Prs	5	nsubj	_	Entity=(person-55
4	all	all	PRON	DT	_	5	obl:npmod	_	Entity=person-55)
5	learn	learn	VERB	VBP	Mood=Ind|Tense=Pres|VerbForm=Fin	0	root	_	_
6	from	from	ADP	IN	_	8	case	_	_
7	past	past	ADJ	JJ	Degree=Pos	8	amod	_	Entity=(abstract-56
8	mistakes	mistake	NOUN	NNS	Number=Plur	5	obl	_	Entity=abstract-56)|SpaceAfter=No
