...
1	Copilă	copilă	NOUN	Ncfsrn	Case=Acc,Nom|Definite=Ind|Gender=Fem|Number=Sing	10	vocative	_	_
2	din	din	ADP	Spca	AdpType=Prep|Case=Acc|Compound=Yes	4	case	_	_
3	doi	doi	NUM	Mcmp-l	Gender=Masc|Number=Plur|NumForm=Word|NumType=Card	4	nummod	_	_
4	părinți	părinte	NOUN	Ncmprn	Case=Acc,Nom|Definite=Ind|Gender=Masc|Number=Plur	1	nmod	_	Rhyme=ID10|SpaceAfter=No|Type=Paired
5	,	,	PUNCT	COMMA	_	1	punct	_	_
6	La	la	ADP	Spsa	AdpType=Prep|Case=Acc	7	case	_	_
7	ce	ce	PRON	Pw3--r	Case=Acc,Nom|Person=3|PronType=Int,Rel	10	obl	_	_
8	focul	foc	NOUN	Ncmsry	Case=Acc,Nom|Definite=Def|Gender=Masc|Number=Sing	7	appos	_	_
9	te	tu	PRON	Pp2-sa--------w	Case=Acc|Number=Sing|Person=2|PronType=Prs|Strength=Weak	10	expl:pv	_	_
10	măriți	mărita	VERB	Vmip2s	Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin	0	root	_	Rhyme=ID4|SpaceAfter=No|Type=Paired
