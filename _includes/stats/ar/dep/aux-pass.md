...
100 nodes (0%) are attached to their parents as `aux:pass`.

97 instances of `aux:pass` (97%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.04.

The following 1 pairs of parts of speech are connected with `aux:pass`: [ar-pos/VERB]()-[ar-pos/PART]() (100; 100% instances).
...
10	حسين	حسين	X	U---------	_	7	obj	_	Vform=حسين|Translit=Hsyn
