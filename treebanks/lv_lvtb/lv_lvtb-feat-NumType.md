...
6778 tokens (2%) have a non-empty value of `NumType`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="lv_lvtb-pos-NUM.html">NUM</a></tt> (4174; 1% instances), <tt><a href="lv_lvtb-pos-ADJ.html">ADJ</a></tt> (2581; 1% instances), <tt><a href="lv_lvtb-pos-ADV.html">ADV</a></tt> (23; 0% instances).

### `NUM`

4174 <tt><a href="lv_lvtb-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="lv_lvtb-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2210; 53%), <tt><a href="lv_lvtb-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (2209; 53%).

`NUM` tokens may have the following values of `NumType`:

* `Card` (4155; 100% of non-empty `NumType`): <em>viens, trīs, vienu, viena, 20, divas, 3, 10, 30, 2</em>
...
2581 <tt><a href="lv_lvtb-pos-ADJ.html">ADJ</a></tt> tokens (15% of all `ADJ` tokens) have a non-empty value of `NumType`.
...
* `Ord` (2581; 100% of non-empty `NumType`): <em>1., 2., 3., pirmo, 2014., 2012., pirmā, 4., 9., 2010.</em>
* `EMPTY` (14947): <em>iespējams, liela, nepieciešams, liels, jaunu, lielu, galvenais, lielā, jauna, dažādu</em>

`NumType` seems to be **lexical feature** of `ADJ`. 100% lemmas (269) occur only with one value of `NumType`.

### `ADV`

23 <tt><a href="lv_lvtb-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `ADV` and `NumType` co-occurred: <tt><a href="lv_lvtb-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (23; 100%), <tt><a href="lv_lvtb-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (23; 100%).

`ADV` tokens may have the following values of `NumType`:

* `Mult` (23; 100% of non-empty `NumType`): <em>vienreiz, divreiz</em>
* `EMPTY` (18519): <em>kad, jau, kā, tad, vēl, ļoti, kur, tā, vairāk, tik</em>
...
<tt>NUM --[<tt><a href="lv_lvtb-dep-compound.html">compound</a></tt>]--> NUM</tt> (67; 100%),
