...
7	в	в	ADP	Pr	_	9	case	_	Lang=ru
8	Ненецкий	ненецкӧй	ADJ	A	Case=Nom|Number=Sing	9	amod	_	Lang=ru
9	олень-совхоз	олень-совхоз	NOUN	N	Case=Nom|Number=Sing	3	obl	_	Lang=ru|SpaceAfter=No
