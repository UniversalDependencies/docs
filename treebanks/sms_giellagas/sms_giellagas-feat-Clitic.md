...
* `QstA` (2; 25% of non-empty `Clitic`): <em>olgglab-a, koozz-a</em>
...
2 <tt><a href="sms_giellagas-pos-NOUN.html">NOUN</a></tt> tokens (1% of all `NOUN` tokens) have a non-empty value of `Clitic`.
