...
264 lemmas (6%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 5 part-of-speech tags: <tt><a href="tr_pud-pos-NOUN.html">NOUN</a></tt> (441; 3% instances), <tt><a href="tr_pud-pos-AUX.html">AUX</a></tt> (35; 0% instances), <tt><a href="tr_pud-pos-ADV.html">ADV</a></tt> (13; 0% instances), <tt><a href="tr_pud-pos-ADJ.html">ADJ</a></tt> (9; 0% instances), <tt><a href="tr_pud-pos-VERB.html">VERB</a></tt> (5; 0% instances).

### `NOUN`

441 <tt><a href="tr_pud-pos-NOUN.html">NOUN</a></tt> tokens (7% of all `NOUN` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `NOUN` and `VerbForm` co-occurred: <tt><a href="tr_pud-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (426; 97%), <tt><a href="tr_pud-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (243; 55%), <tt><a href="tr_pud-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (243; 55%).

`NOUN` tokens may have the following values of `VerbForm`:

* `Conv` (4; 1% of non-empty `VerbForm`): <em>etmeden, olmadan, oluşmadan, yapılmadan</em>
* `Ger` (432; 98% of non-empty `VerbForm`): <em>büyüme, savunma, edilmesi, soruşturma, çalışma, etmeye, çıkmaya, alma, etmesi, etmesini</em>
...
* `EMPTY` (5938): <em>arasında, tarafından, yıl, şekilde, kuzey, yılında, ortaya, güney, yer, konusunda</em>

`VerbForm` seems to be **lexical feature** of `NOUN`. 98% lemmas (249) occur only with one value of `VerbForm`.

### `AUX`

35 <tt><a href="tr_pud-pos-AUX.html">AUX</a></tt> tokens (6% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="tr_pud-feat-Aspect.html">Aspect</a></tt><tt>=Perf</tt> (35; 100%), <tt><a href="tr_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (35; 100%), <tt><a href="tr_pud-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (35; 100%), <tt><a href="tr_pud-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (35; 100%), <tt><a href="tr_pud-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (35; 100%), <tt><a href="tr_pud-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (35; 100%), <tt><a href="tr_pud-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (22; 63%), <tt><a href="tr_pud-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (22; 63%).

`AUX` tokens may have the following values of `VerbForm`:

* `Conv` (6; 17% of non-empty `VerbForm`): <em>yken, ken</em>
* `Ger` (29; 83% of non-empty `VerbForm`): <em>olmasına, olma, olmakla, olması, olmasının, olmaya, olmak, etmesine, itmeye, olmaktan</em>
* `EMPTY` (505): <em>olarak, olan, dır, dir, değil, oldu, olduğunu, tir, ydı, ydi</em>
...
* `EMPTY` (1007): <em>dedi, etti, ise, başladı, söyledi, çıktı, verdi, ediyor, geldi, aldı</em>
