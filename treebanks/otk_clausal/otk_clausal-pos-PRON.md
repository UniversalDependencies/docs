---
layout: base
title:  'Statistics of PRON in UD_Old_Turkish-Clausal'
udver: '2'
---

## Treebank Statistics: UD_Old_Turkish-Clausal: POS Tags: `PRON`
...
`PRON` nodes are attached to their parents using 1 different relations: <tt><a href="otk_clausal-dep-nsubj.html">nsubj</a></tt> (1; 100% instances)

Parents of `PRON` nodes belong to 1 different parts of speech: <tt><a href="otk_clausal-pos-NUM.html">NUM</a></tt> (1; 100% instances)
...
Children of `PRON` nodes are attached using 1 different relations: <tt><a href="otk_clausal-dep-punct.html">punct</a></tt> (1; 100% instances)

Children of `PRON` nodes belong to 1 different parts of speech: <tt><a href="otk_clausal-pos-PUNCT.html">PUNCT</a></tt> (1; 100% instances)
