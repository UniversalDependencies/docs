...
There are 867 `VERB` lemmas (19%), 1048 `VERB` types (20%) and 17759 `VERB` tokens (13%).
...
The form / lemma ratio of `VERB` is 1.208766 (the average of all parts of speech is 1.162341).
