...
812 nodes (3%) are attached to their parents as `case`.

760 instances of `case` (94%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.35960591133005.

The following 9 pairs of parts of speech are connected with `case`: <tt><a href="la_circse-pos-NOUN.html">NOUN</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (625; 77% instances), <tt><a href="la_circse-pos-PRON.html">PRON</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (77; 9% instances), <tt><a href="la_circse-pos-PROPN.html">PROPN</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (38; 5% instances), <tt><a href="la_circse-pos-DET.html">DET</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (31; 4% instances), <tt><a href="la_circse-pos-ADJ.html">ADJ</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (30; 4% instances), <tt><a href="la_circse-pos-VERB.html">VERB</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (5; 1% instances), <tt><a href="la_circse-pos-NOUN.html">NOUN</a></tt>-<tt><a href="la_circse-pos-INTJ.html">INTJ</a></tt> (4; 0% instances), <tt><a href="la_circse-pos-ADV.html">ADV</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (1; 0% instances), <tt><a href="la_circse-pos-NUM.html">NUM</a></tt>-<tt><a href="la_circse-pos-ADP.html">ADP</a></tt> (1; 0% instances).
...
1	transit	transeo	VERB	B6	Aspect=Imp|InflClass=LatAnom|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	LASLAVariant=1|LiLaflcat=v6
2	Aiacem	aiax	PROPN	A3	Case=Acc|Gender=Masc|InflClass=IndEurX|NameType=Giv|Number=Sing	1	obj	_	LASLAVariant=N|LiLaflcat=n3
3	et	et	CCONJ	S	_	4	cc	_	LASLAVariant=2|LiLaflcat=i
4	ratem	ratis	NOUN	A3	Case=Acc|Gender=Fem|InflClass=IndEurI|Number=Sing	2	conj	_	LiLaflcat=n3
5	ratis	ratis	NOUN	A3	Case=Gen|Gender=Fem|InflClass=IndEurI|Number=Sing	7	nmod	_	LiLaflcat=n3
6	que	que	CCONJ	S	_	12	cc	_	LiLaflcat=i
7	partem	pars	NOUN	A3	Case=Acc|Gender=Fem|InflClass=IndEurI|Number=Sing	12	obj	_	LiLaflcat=n3
8	se	sui	PRON	G	Case=Abl|InflClass=LatAnom|Number=Sing|Person=3|PronType=Prs|Reflex=Yes	12	obl	_	LASLAVariant=1|LiLaflcat=p
9	cum	cum	ADP	R	AdpType=Prep	8	case	_	LASLAVariant=2|LiLaflcat=i
10	et	et	CCONJ	S	_	11	cc	_	LASLAVariant=2|LiLaflcat=i
11	Aiacem	aiax	PROPN	A3	Case=Acc|Gender=Masc|InflClass=IndEurX|NameType=Giv|Number=Sing	7	conj	_	LASLAVariant=N|LiLaflcat=n3
12	tulit	fero	VERB	B6	Aspect=Perf|InflClass=LatAnom|Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin|Voice=Act	1	conj	_	LiLaflcat=v6
