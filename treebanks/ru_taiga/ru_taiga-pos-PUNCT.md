...
There are 100 `PUNCT` lemmas (0%), 100 `PUNCT` types (0%) and 36060 `PUNCT` tokens (18%).
...
* <em>✅</em>
  * <tt><a href="ru_taiga-pos-PUNCT.html">PUNCT</a></tt> 4: <em><b>✅</b> Время ловли : утро , вечер , днем в теплую пасмурную погоду .</em>
  * <tt><a href="ru_taiga-pos-SYM.html">SYM</a></tt> 2: <em>@screened-88 <b>✅</b> взабраться на статую Христа - только что ! 😄</em>
* <em>✔</em>
