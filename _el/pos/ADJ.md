...
Certain adjectives, which are assigned the tag [NOUN]() or [PROPN](), do not form comparatives (of course, there are adjectives that do not allow for comparatives, such as "dead"). These include:
