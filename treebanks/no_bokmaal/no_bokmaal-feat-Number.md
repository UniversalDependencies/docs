...
55823 <tt><a href="no_bokmaal-pos-NOUN.html">NOUN</a></tt> tokens (98% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="no_bokmaal-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (36327; 65%), <tt><a href="no_bokmaal-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (31337; 56%).
...
* `Sing` (40172; 72% of non-empty `Number`): <em>dag, gang, tid, verden, del, år, kirke, landet, grunn, saken</em>
* `EMPTY` (1430): <em>§, går, fjor, juli, tros-, slags, oktober, lov, januar, mars</em>
...
22541 <tt><a href="no_bokmaal-pos-ADJ.html">ADJ</a></tt> tokens (84% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="no_bokmaal-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (21095; 94%), <tt><a href="no_bokmaal-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (13739; 61%).

`ADJ` tokens may have the following values of `Number`:

* `Plur` (5614; 25% of non-empty `Number`): <em>mange, store, nye, norske, siste, gode, få, ulike, ansatte, enkelte</em>
* `Sing` (16927; 75% of non-empty `Number`): <em>mye, første, helt, litt, godt, hele, norske, stor, ny, god</em>
...
20916 <tt><a href="no_bokmaal-pos-PRON.html">PRON</a></tt> tokens (92% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="no_bokmaal-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (20087; 96%), <tt><a href="no_bokmaal-feat-Person.html">Person</a></tt><tt>=3</tt> (12257; 59%), <tt><a href="no_bokmaal-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (11256; 54%).
...
* `EMPTY` (1729): <em>seg, hva, hvem, der, hvis, hvilket, ikkenoe, jag, whatever, you</em>
...
* `Plur` (2984; 22% of non-empty `Number`): <em>de, andre, alle, noen, disse, slike, ingen, egne, begge, hvilke</em>
* `Sing` (10837; 78% of non-empty `Number`): <em>en, et, den, det, denne, noe, annet, dette, annen, ingen</em>
* `EMPTY` (575): <em>selv, samme, neste, forrige, selve, selveste, 135a, II, sjøl, the</em>
...
* `EMPTY` (186): <em>eneste, 1.4, 11.3.1, 2.2, 22.15, 3.2, 01.41, 02.00, 02.30, 09.30</em>
...
The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="no_bokmaal-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1; 100%), <tt><a href="no_bokmaal-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1; 100%), <tt><a href="no_bokmaal-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin,Part</tt> (1; 100%).
...
<tt>ADJ --[<tt><a href="no_bokmaal-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (784; 85%),
