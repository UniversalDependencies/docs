...
There are 624 `X` lemmas (5%), 626 `X` types (3%) and 1272 `X` tokens (1%).
...
The form / lemma ratio of `X` is 1.003205 (the average of all parts of speech is 1.666462).

The 1st highest number of forms (4) was observed with the lemma “_”: <em>celulare, chirurgical, compensarea, jeun</em>.
