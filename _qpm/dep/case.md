...
In general terms, the case relation is used for any case-marking element which is treated as a separate syntactic word (including prepositions, 
...
However, in Pomak case (case marking) is predominantly used to mark an accusative case accompanied by a preposition (morphologically labeled as ADP):
