...
5	Idee	Idee	NOUN	NN	Case=Nom|Gender=Fem|Number=Sing	0	root	_	_
...
12	Diskussion	Diskussion	NOUN	NN	Case=Dat|Gender=Fem|Number=Sing	13	obl	_	_
13	gestellt	stellen	VERB	VVPP	Aspect=Perf|VerbForm=Part	5	acl:relcl	_	_
...
5	existierende	existieren	ADJ	ADJA	Case=Nom|Degree=Pos|Gender=Neut|Number=Sing	6	amod	_	_
6	Handwerkerportal	Handwerkerportal	NOUN	NN	Case=Nom|Gender=Neut|Number=Sing	9	nsubj:pass	_	_
...
5	die	der	DET	ART	Case=Nom|Definite=Def|Gender=Fem|Number=Plur|PronType=Art	7	det	_	_
6	vorhandenen	vorhanden	ADJ	ADJA	Case=Nom|Degree=Pos|Gender=Fem|Number=Plur	7	amod	_	_
7	Fabs	Fab	NOUN	NN	Case=Nom|Gender=Fem|Number=Plur	9	nsubj	_	_
