...
In the case of proper entities named after people, e.g. _Fundação Getúlio Vargas_, the `name` relation should only be used inside the person name, with the rest of the construction analyzed compositionally using normal syntactic relations:
