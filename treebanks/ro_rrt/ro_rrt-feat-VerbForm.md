...
The feature is used with 2 part-of-speech tags: <tt><a href="ro_rrt-pos-VERB.html">VERB</a></tt> (22999; 11% instances), <tt><a href="ro_rrt-pos-AUX.html">AUX</a></tt> (4220; 2% instances).

### `VERB`

22999 <tt><a href="ro_rrt-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="ro_rrt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (15365; 67%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (12280; 53% of non-empty `VerbForm`): <em>poate, trebuie, pot, are, avea, era, putea, există, au, face</em>
...
* `Part` (7634; 33% of non-empty `VerbForm`): <em>avut, prevăzute, făcut, spus, putut, rupt, dat, murit, devenit, luat</em>
...
4220 <tt><a href="ro_rrt-pos-AUX.html">AUX</a></tt> tokens (49% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="ro_rrt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (2911; 69%), <tt><a href="ro_rrt-feat-Person.html">Person</a></tt><tt>=3</tt> (2700; 64%), <tt><a href="ro_rrt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (2567; 61%), <tt><a href="ro_rrt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2464; 58%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (2784; 66% of non-empty `VerbForm`): <em>este, sunt, era, fie, e, erau, fusese, avea, -i, sunteți</em>
...
<tt>VERB --[<tt><a href="ro_rrt-dep-conj.html">conj</a></tt>]--> VERB</tt> (2117; 86%),
...
<tt>VERB --[<tt><a href="ro_rrt-dep-advcl-tcl.html">advcl:tcl</a></tt>]--> VERB</tt> (59; 67%),
