...
3	jednotka	jednotka	NOUN	NNFS1-----A----	Case=Nom|Gender=Fem|Number=Sing	4	nsubj	4:nsubj|13:nsubj	_
...
7	závazku	závazek	NOUN	NNIS6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	4	obl:arg	4:obl:arg:o:loc	_
...
13	pohledávce	pohledávka	NOUN	NNFS6-----A----	Case=Loc|Gender=Fem|Number=Sing	4	conj	13.1:dep	_
14	s	s	ADP	RR--7----------	AdpType=Prep|Case=Ins|ExtPos=ADP	17	case	17:case	LId=s-1
15	ohledem	ohled	NOUN	NNIS7-----A----	Animacy=Inan|Case=Ins|Gender=Masc|Number=Sing	14	fixed	14:fixed	_
16	na	na	ADP	RR--4----------	AdpType=Prep|Case=Acc	14	fixed	14:fixed	LId=na-1
17	zásadu	zásada	NOUN	NNFS4-----A----	Case=Acc|Gender=Fem|Number=Sing	13	orphan	13.1:dep	_
18	opatrnosti	opatrnost	NOUN	NNFS2-----A----	Case=Gen|Gender=Fem|Number=Sing	17	nmod	17:nmod:gen	SpaceAfter=No
...
3	zásobách	zásoba	NOUN	NNFP6-----A----	Case=Loc|Gender=Fem|Number=Plur	5	obl:arg	5:obl:arg:o:loc|10:obl:arg:o:loc	_
...
7	způsobem	způsob	NOUN	NNIS7-----A----	Animacy=Inan|Case=Ins|Gender=Masc|Number=Sing	5	obl	5:obl:ins	_
...
11	způsobem	způsob	NOUN	NNIS7-----A----	Animacy=Inan|Case=Ins|Gender=Masc|Number=Sing	10	orphan	10.1:dep	_
12	B.	B.	NOUN	NNNXX-----A----	Gender=Neut	11	nmod	11:nmod	_
...
23	využitím	využití	NOUN	NNNS7-----A----	Case=Ins|Gender=Neut|Number=Sing	21	obl	21:obl:s:ins	_
24	účtů	účet	NOUN	NNIP2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Plur	23	nmod	23:nmod:gen	_
...
27	třídě	třída	NOUN	NNFS6-----A----	Case=Loc|Gender=Fem|Number=Sing	24	nmod	24:nmod:v:loc	_
28	1	1	NUM	C}-------------	NumForm=Roman|NumType=Card	27	nummod	27:nummod	_
29	Zásoby	zásoba	NOUN	NNFS2-----A----	Case=Gen|Gender=Fem|Number=Sing	27	nmod	27:nmod:gen	SpaceAfter=No
...
3	příloze	příloha	NOUN	NNFS6-----A----	Case=Loc|Gender=Fem|Number=Sing	4	obl	4:obl:v:loc	_
...
6	jednotka	jednotka	NOUN	NNFS1-----A----	Case=Nom|Gender=Fem|Number=Sing	4	nsubj	4:nsubj	_
...
9	počet	počet	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	4	obj	4:obj	_
10	zaměstnanců	zaměstnanec	NOUN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|Number=Plur	9	nmod	9:nmod:gen	_
...
13	období	období	NOUN	NNNS2-----A----	Case=Gen|Gender=Neut|Number=Sing	10	nmod	10:nmod:během:gen	_
...
17	členů	člen	NOUN	NNMP2-----A----	Animacy=Anim|Case=Gen|Gender=Masc|Number=Plur	16	orphan	16.1:dep	_
...
19	orgánů	orgán	NOUN	NNIP2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Plur	17	nmod	17:nmod:gen	SpaceAfter=No
20	,	,	PUNCT	Z:-------------	_	22	punct	22:punct	_
21	s	s	ADP	RR--7----------	AdpType=Prep|Case=Ins	22	case	22:case	LId=s-1
22	uvedením	uvedení	NOUN	NNNS7-----A----	Case=Ins|Gender=Neut|Number=Sing	16	orphan	16.1:dep	_
...
25	nákladů	náklad	NOUN	NNIP2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Plur	23	nmod	23:nmod:gen|29:nsubj:pass	SpaceAfter=No
26	,	,	PUNCT	Z:-------------	_	29	punct	29:punct	_
27	které	který	DET	P4IP1----------	Animacy=Inan|Case=Nom|Gender=Masc|Number=Plur|PronType=Int,Rel	29	nsubj:pass	25:ref	_
28	byly	být	AUX	VpTP---XR-AA---	Animacy=Inan|Aspect=Imp|Gender=Fem,Masc|Number=Plur|Polarity=Pos|Tense=Past|VerbForm=Part|Voice=Act	29	aux:pass	29:aux:pass	_
29	vynaloženy	vynaložený	ADJ	VsTP---XX-AP---	Animacy=Inan|Degree=Pos|Gender=Fem,Masc|Number=Plur|Polarity=Pos|Variant=Short|VerbForm=Part|Voice=Pass	25	acl:relcl	25:acl:relcl	LDeriv=vynaložit
30	na	na	ADP	RR--4----------	AdpType=Prep|Case=Acc	31	case	31:case	LId=na-1
31	zaměstnance	zaměstnanec	NOUN	NNMP4-----A----	Animacy=Anim|Case=Acc|Gender=Masc|Number=Plur	29	obl	29:obl:na:acc	_
32	a	a	CCONJ	J^-------------	_	34	cc	34:cc	LId=a-1
33	z	z	ADP	RR--2----------	AdpType=Prep|Case=Gen	34	case	34:case	LId=z-1
34	toho	ten	DET	PDZS2----------	Case=Gen|Gender=Masc,Neut|Number=Sing|PronType=Dem	29	conj	25:acl:relcl|29:conj	_
35	na	na	ADP	RR--4----------	AdpType=Prep|Case=Acc	36	case	36:case	LId=na-1
36	členy	člen	NOUN	NNMP4-----A----	Animacy=Anim|Case=Acc|Gender=Masc|Number=Plur	29	dep	29:dep|34:dep	_
...
38	orgánů	orgán	NOUN	NNIP2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Plur	36	nmod	36:nmod:gen	SpaceAfter=No
