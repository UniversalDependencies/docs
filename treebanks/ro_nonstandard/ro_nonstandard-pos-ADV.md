...
There are 580 `ADV` lemmas (4%), 952 `ADV` types (3%) and 34596 `ADV` tokens (6%).
...
The form / lemma ratio of `ADV` is 1.641379 (the average of all parts of speech is 2.492163).
