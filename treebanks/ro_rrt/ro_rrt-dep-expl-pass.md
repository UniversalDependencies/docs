...
1111 nodes (1%) are attached to their parents as `expl:pass`.

1093 instances of `expl:pass` (98%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.18901890189019.

The following 1 pairs of parts of speech are connected with `expl:pass`: <tt><a href="ro_rrt-pos-VERB.html">VERB</a></tt>-<tt><a href="ro_rrt-pos-PRON.html">PRON</a></tt> (1111; 100% instances).
