---
layout: base
title:  'Statistics of nsubj:advmod in UD_Old_French-PROFITEROLE'
udver: '2'
---
...
3 nodes (0%) are attached to their parents as `nsubj:advmod`.

3 instances of `nsubj:advmod` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `nsubj:advmod`: <tt><a href="fro_profiterole-pos-VERB.html">VERB</a></tt>-<tt><a href="fro_profiterole-pos-PRON.html">PRON</a></tt> (3; 100% instances).
