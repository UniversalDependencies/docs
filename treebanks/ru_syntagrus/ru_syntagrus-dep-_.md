...
1514 nodes (0%) are attached to their parents as `_`.

1514 instances of `_` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 16.6348745046233.

The following 1 pairs of parts of speech are connected with `_`: -<tt><a href="ru_syntagrus-dep-_.html">_</a></tt> (1514; 100% instances).
