...
There are 54 `SCONJ` lemmas (0%), 74 `SCONJ` types (0%) and 4637 `SCONJ` tokens (2%).
...
The form / lemma ratio of `SCONJ` is 1.370370 (the average of all parts of speech is 1.185132).
