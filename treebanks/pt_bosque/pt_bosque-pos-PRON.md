...
There are 60 `PRON` lemmas (0%), 112 `PRON` types (0%) and 7468 `PRON` tokens (3%).
...
The form / lemma ratio of `PRON` is 1.866667 (the average of all parts of speech is 1.421073).
