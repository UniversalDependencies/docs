...
15939 tokens (16%) have a non-empty value of `VerbForm`.
3541 types (27%) occur at least once with a non-empty value of `VerbForm`.
1588 lemmas (21%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 4 part-of-speech tags: <tt><a href="sl_sst-pos-VERB.html">VERB</a></tt> (10038; 10% instances), <tt><a href="sl_sst-pos-AUX.html">AUX</a></tt> (5237; 5% instances), <tt><a href="sl_sst-pos-ADJ.html">ADJ</a></tt> (663; 1% instances), <tt><a href="sl_sst-pos-ADV.html">ADV</a></tt> (1; 0% instances).

### `VERB`

10038 <tt><a href="sl_sst-pos-VERB.html">VERB</a></tt> tokens (100% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="sl_sst-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (8349; 83%), <tt><a href="sl_sst-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (6990; 70%), <tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6305; 63%), <tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (5838; 58%), <tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5714; 57%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (6292; 63% of non-empty `VerbForm`): <em>je, vem, veš, mislim, recimo, so, ni, ima, pravi, imamo</em>
* `Inf` (651; 6% of non-empty `VerbForm`): <em>biti, iti, narediti, reči, imeti, videti, povedati, priti, pomagati, govoriti</em>
* `Part` (3048; 30% of non-empty `VerbForm`): <em>bilo, rekel, bil, imeli, rekla, bila, imela, šla, imel, rekli</em>
* `Sup` (47; 0% of non-empty `VerbForm`): <em>delat, gledat, nabirat, spat, jest, naredit, pomagat, ponavljat, študirat, žegnat</em>

<table>
  <tr><th>Paradigm <i>reči</i></th><th><tt>Fin</tt></th><th><tt>Inf</tt></th><th><tt>Sup</tt></th><th><tt>Part</tt></th></tr>
  <tr><td><tt></tt></td><td></td><td><em>reči</em></td><td><em>reč</em></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td></td><td><em>rekel</em></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Dual</tt></tt></td><td></td><td></td><td></td><td><em>rekla</em></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td></td><td></td><td><em>rekli</em></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td></td><td><em>rekla</em></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td></td><td></td><td></td><td><em>rekle</em></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Imp</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=2</tt></tt></td><td><em>reci</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Imp</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=1</tt></tt></td><td><em>recimo</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Imp</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=2</tt></tt></td><td><em>recite</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>rečem</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>rečeš</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>reče</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>rečemo</em></td><td></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>rečejo</em></td><td></td><td></td><td></td></tr>
</table>

### `AUX`

5237 <tt><a href="sl_sst-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (4459; 85%), <tt><a href="sl_sst-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (4118; 79%), <tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (3930; 75%), <tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3426; 65%), <tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=3</tt> (3010; 57%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (4865; 93% of non-empty `VerbForm`): <em>je, so, sem, bi, smo, ni, bo, si, ste, bom</em>
* `Inf` (38; 1% of non-empty `VerbForm`): <em>biti</em>
* `Part` (334; 6% of non-empty `VerbForm`): <em>bilo, bila, bil, bili, bile</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="sl_sst-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt>|<tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Imp</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Dual</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=2</tt></tt></td><td><em>bodita</em></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="sl_sst-feat-Polarity.html">Polarity</a></tt><tt>=Neg</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt>|<tt><a href="sl_sst-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td><em>ni</em></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Dual</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="sl_sst-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Fut</tt></tt></td><td><em>bosta</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Dual</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=2</tt>|<tt><a href="sl_sst-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>sta</em></td><td></td><td></td></tr>
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Dual</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="sl_sst-feat-Polarity.html">Polarity</a></tt><tt>=Neg</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>nista</em></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="sl_sst-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="sl_sst-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="sl_sst-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt>|<tt><a href="sl_sst-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>so, sa</em></td><td></td><td></td></tr>
</table>

### `ADJ`

663 <tt><a href="sl_sst-pos-ADJ.html">ADJ</a></tt> tokens (13% of all `ADJ` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `ADJ` and `VerbForm` co-occurred: <tt><a href="sl_sst-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (663; 100%), <tt><a href="sl_sst-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (540; 81%), <tt><a href="sl_sst-feat-Case.html">Case</a></tt><tt>=Nom</tt> (446; 67%), <tt><a href="sl_sst-feat-Number.html">Number</a></tt><tt>=Sing</tt> (394; 59%).

`ADJ` tokens may have the following values of `VerbForm`:

* `Part` (663; 100% of non-empty `VerbForm`): <em>pozdravljeni, določene, spoštovani, ostali, prepričani, določeno, rečeno, znana, narejeno, odprta</em>
* `EMPTY` (4609): <em>drugi, dobro, prvi, drugo, zanimivo, dober, sam, sami, lepa, pomembno</em>

`VerbForm` seems to be **lexical feature** of `ADJ`. 100% lemmas (277) occur only with one value of `VerbForm`.
...
* `EMPTY` (7048): <em>tako, zdaj, lahko, potem, zelo, kako, kar, tam, res, a</em>
...
<tt>VERB --[<tt><a href="sl_sst-dep-parataxis-restart.html">parataxis:restart</a></tt>]--> VERB</tt> (87; 69%),
<tt>VERB --[<tt><a href="sl_sst-dep-reparandum.html">reparandum</a></tt>]--> VERB</tt> (82; 95%),
<tt>AUX --[<tt><a href="sl_sst-dep-reparandum.html">reparandum</a></tt>]--> AUX</tt> (19; 100%),
<tt>VERB --[<tt><a href="sl_sst-dep-discourse.html">discourse</a></tt>]--> VERB</tt> (4; 67%),
<tt>VERB --[<tt><a href="sl_sst-dep-parataxis.html">parataxis</a></tt>]--> AUX</tt> (4; 100%).
