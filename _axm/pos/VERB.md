...
- _կու գնամ/kow gnam, կու գնաս/kow gnas, կու գնա/kow gna, կու գնանք/kow gnank’, կու գնաք/kow gnak’, կու գնան/kow gnan_ &nbsp;“I (will) go, you (will) go, he/she/it (will) go, we (will) go, you (will) go, they (will) go”,
...
- _չգրի/čgri, չգնայ/čgnay_ &nbsp;“I shall not write, I shall not go”, 
- _գրած/graç, խառնուած/xaṙnowaç, գրելոց (գրելոյ)/greloc’ (greloy), կարդալոց (կարդալոյ)/kardaloc’ (kardaloy), գրել (գրեալ)/grel (greal), կարդացել (կարդացեալ)/kardac’el (kardac’eal), գրել (գրեր)/grel (grer), կարդացել (կարդացեր)/kardac’el (kardac’er), գրի, կարդա_ &nbsp;“written, read, while writing, while reading, write, read, (will) write, (will) read, have written, have read, write, read” (participles),
- _գրող, կարդացող_ &nbsp;“writing, reading, smth. to be written, smth. to be read” (verbal adjectives)
...
-	Resultative: _<b>կոտրած</b> ատամ_ “a <b>broken</b> tooth”,
-	Subject: _<b>այրեցող ջերմ</b> շենք_ “<b>scorching</b> temperature”,
-	Perfect: _<b>ծաղկեալ</b> ծառ_ “tree <b>in blossom</b>”
