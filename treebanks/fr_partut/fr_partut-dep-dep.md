---
layout: base
title:  'Statistics of dep in UD_French-ParTUT'
udver: '2'
---

## Treebank Statistics: UD_French-ParTUT: Relations: `dep`
...
The following 1 pairs of parts of speech are connected with `dep`: <tt><a href="fr_partut-pos-VERB.html">VERB</a></tt>-<tt><a href="fr_partut-pos-VERB.html">VERB</a></tt> (1; 100% instances).
