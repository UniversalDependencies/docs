...
The form / lemma ratio of `ADV` is 1.061983 (the average of all parts of speech is 1.381919).
...
8590 (86%) `ADV` nodes are leaves.

1004 (10%) `ADV` nodes have one child.
