...
31 instances of `iobj` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.19354838709677.

The following 1 pairs of parts of speech are connected with `iobj`: <tt><a href="bej_autogramm-pos-VERB.html">VERB</a></tt>-<tt><a href="bej_autogramm-pos-PRON.html">PRON</a></tt> (31; 100% instances).
