...
948 <tt><a href="nl_lassysmall-pos-PRON.html">PRON</a></tt> tokens (28% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="nl_lassysmall-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (926; 98%), <tt><a href="nl_lassysmall-feat-Person.html">Person</a></tt><tt>=3</tt> (846; 89%).
...
* `EMPTY` (2389): <em>zijn, die, ze, het, haar, meer, dat, hun, dit, wat</em>
...
`Case` seems to be **lexical feature** of `PRON`. 95% lemmas (21) occur only with one value of `Case`.
