...
60 <tt><a href="en_pud-pos-ADV.html">ADV</a></tt> tokens (7% of all `ADV` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADV` and `Degree` co-occurred: <tt><a href="en_pud-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (60; 100%).
...
<tt>ADV --[<tt><a href="en_pud-dep-conj.html">conj</a></tt>]--> ADV</tt> (1; 100%).
