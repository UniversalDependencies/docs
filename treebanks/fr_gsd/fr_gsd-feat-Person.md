...
39451 tokens (10%) have a non-empty value of `Person`.
...
The feature is used with 5 part-of-speech tags: <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (14565; 4% instances), <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (13729; 3% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (11151; 3% instances), <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> (4; 0% instances), <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> (2; 0% instances).

### `PRON`

14565 <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> tokens (82% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="fr_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (12098; 83%), <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (11361; 78%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9029; 62%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (7684; 53%).
...
* `3` (13113; 90% of non-empty `Person`): <em>il, se, s', elle, c', on, y, ils, lui, ce</em>
* `EMPTY` (3197): <em>qui, dont, qu', que, lequel, laquelle, lesquels, lesquelles, siens, nôtre</em>

<table>
  <tr><th>Paradigm <i>il</i></th><th><tt>1</tt></th><th><tt>2</tt></th><th><tt>3</tt></th></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td><em>-Tu</em></td><td><em>il, -t-il, -il, Lui, t-il, t'il</em></td></tr>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td></td><td></td><td><em>elle, -elle, -t-elle</em></td></tr>
...
The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13727; 100%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13724; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13136; 96%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (10946; 80%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10813; 79%).
...
* `EMPTY` (18249): <em>né, située, faire, situé, partir, eu, fait, voir, mort, connu</em>
...
11151 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (87% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11151; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10793; 97%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9454; 85%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8842; 79%).
...
* `3` (10706; 96% of non-empty `Person`): <em>est, a, sont, ont, était, fut, avait, sera, étaient, soit</em>
...
* `EMPTY` (23741): <em>premier, première, français, autres, même, française, tous, dernier, grande, grand</em>

### `DET`

2 <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> tokens (0% of all `DET` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `DET` and `Person` co-occurred: <tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (2; 100%).

`DET` tokens may have the following values of `Person`:

* `3` (2; 100% of non-empty `Person`): <em>ce, la</em>
* `EMPTY` (61170): <em>le, la, les, l', un, une, des, son, sa, cette</em>

## Relations with Agreement in `Person`

The 10 most frequent relations where parent and child node agree in `Person`:
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (4296; 62%),
<tt>VERB --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1258; 68%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-pass.html">expl:pass</a></tt>]--> PRON</tt> (576; 75%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-pv.html">expl:pv</a></tt>]--> PRON</tt> (564; 63%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-subj.html">expl:subj</a></tt>]--> PRON</tt> (516; 89%),
<tt>PRON --[<tt><a href="fr_gsd-dep-acl-relcl.html">acl:relcl</a></tt>]--> VERB</tt> (231; 77%),
<tt>PRON --[<tt><a href="fr_gsd-dep-cop.html">cop</a></tt>]--> AUX</tt> (186; 82%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl.html">expl</a></tt>]--> PRON</tt> (172; 82%),
