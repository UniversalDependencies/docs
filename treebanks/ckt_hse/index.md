...
Language: [Chukchi](/ckt/index.html) (code: `ckt`)<br/>
...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udckt_hse214)<br />
...
Questions, comments?
General annotation questions (either Chukchi-specific or cross-linguistic) can be raised in the [main UD issue tracker](https://github.com/UniversalDependencies/docs/issues).
You can report bugs in this treebank in the [treebank-specific issue tracker on Github](https://github.com/UniversalDependencies/UD_Chukchi-HSE/issues).
...
[ADJ](ckt_hse-pos-ADJ.html) – [ADP](ckt_hse-pos-ADP.html) – [ADV](ckt_hse-pos-ADV.html) – [AUX](ckt_hse-pos-AUX.html) – [CCONJ](ckt_hse-pos-CCONJ.html) – [DET](ckt_hse-pos-DET.html) – [INTJ](ckt_hse-pos-INTJ.html) – [NOUN](ckt_hse-pos-NOUN.html) – [NUM](ckt_hse-pos-NUM.html) – [PART](ckt_hse-pos-PART.html) – [PRON](ckt_hse-pos-PRON.html) – [PROPN](ckt_hse-pos-PROPN.html) – [PUNCT](ckt_hse-pos-PUNCT.html) – [SCONJ](ckt_hse-pos-SCONJ.html) – [VERB](ckt_hse-pos-VERB.html) – [X](ckt_hse-pos-X.html)
...
<ul>
<li>This corpus contains 1004 sentences, 5389 tokens and 6124 syntactic words.</li>
</ul>

<ul>
<li>This corpus contains 1004 tokens (19%) that are not followed by a space.</li>
</ul>
...
<ul>
<li>This corpus contains 3 types of words that contain both letters and punctuation. Examples: Санкт-Петербург, Санкт-Петербургэты, по-русски</li>
</ul>
...
<ul>
<li>This corpus contains 52 word types tagged as particles (PART): Аны, Аԓым, Кытвыԓӄун, Мытив, Нука, Нӄэн, Пԓевыт, Тэӈуйӈэ, Ынӄэӄ, Ынӈин, Ытԓён, а, амвынэ, аԓымы, ва, вай, ванэ, вынэ, вэнԓыги, вэчьым, е, иʼм, итык, китаӄун, м, мачынан, уйӈэ, ъы, ъым, ъыма, ъэм, ы, ыʼм, ынръам, ынӄэ, ынӄэн, ьым, э, эʼм, эвын, энмэн, это, ӄаӈан, ӄун, ӄытԓыги, Ӈуттэԓв, ӈ, ӈа, ӈан, ӈэ, ӈэвэӄ, ԓыгэн</li>
</ul>
