...
The most frequent other feature values with which `VERB` and `Voice` co-occurred: <tt><a href="aqz_tudet-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (2; 100%), <tt><a href="aqz_tudet-feat-Tv.html">Tv</a></tt><tt>=Yes</tt> (2; 100%).

`VERB` tokens may have the following values of `Voice`:

* `Cau` (2; 100% of non-empty `Voice`): <em>mõatʃoa</em>
* `EMPTY` (203): <em>koa, ata, teita, tʃopa, at, put, aj, ko, mãpara, apeka</em>
