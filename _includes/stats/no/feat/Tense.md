...
The feature is used with 2 part-of-speech tags: [no-pos/VERB]() (25443; 8% instances), [no-pos/AUX]() (9151; 3% instances).
...
* `Past` (6842; 27% of non-empty `Tense`): <em>var, ble, hadde, kom, fikk, sa, gikk, tok, gjorde, så</em>
* `Pres` (18601; 73% of non-empty `Tense`): <em>er, har, sier, blir, kommer, går, mener, får, ser, gjør</em>
* `EMPTY` (15125): <em>være, vært, ha, få, bli, ta, gjøre, se, si, gå</em>
...
* `Past` (2063; 23% of non-empty `Tense`): <em>ble, hadde, skulle, ville, kunne, måtte, var, burde, fikk, torde</em>
* `Pres` (7088; 77% of non-empty `Tense`): <em>har, kan, vil, skal, er, må, blir, bør, får, tør</em>
* `EMPTY` (813): <em>ha, bli, blitt, kunne, få, vært, fått, være, måtte, måttet</em>
...
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (1518; 66%).
