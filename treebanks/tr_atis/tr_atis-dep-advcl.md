...
2	Philadelphia'dan	philadelphia	PROPN	_	Case=Abl|Number=Sing	3	obl	_	_
3	ayrılıp	ayrıl	ADV	_	_	5	advcl	_	_
4	Dallas'a	dallas	PROPN	_	Case=Dat|Number=Sing	5	obl	_	_
5	giden	git	ADJ	_	_	6	acl	_	_
6	uçuşları	uç	NOUN	_	Case=Nom|Number=Plur|Number[psor]=Sing|Person=3|Person[psor]=3	7	obj	_	_
7	söyle	söyle	VERB	_	Mood=Imp|Number=Sing|Person=2|Polarity=Pos|Tense=Pres|VerbForm=Fin	0	root	_	_
...
# visual-style 5	fgColor:white
# visual-style 5 3 advcl	color:blue
1	S	s	NOUN	_	Case=Nom|Number=Sing|Person=3	5	nsubj	_	_
2	yemek	yemek	NOUN	_	Case=Nom|Number=Sing|Person=3	3	xcomp	_	_
3	olarak	ol	ADV	_	_	5	advcl	_	_
4	neyi	ne	PRON	_	PronType=Int	5	obj	_	_
5	belirtir	belirt	VERB	_	Aspect=Hab|Mood=Gen|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin	0	root	_	_
