...
# visual-style 2	fgColor:white
# visual-style 2 1 nummod	color:blue
1	22	22	NUM	_	_	2	nummod	_	CSID=DE|Lang=de
2	Februar	Februar	PROPN	_	Case=Dat|Gender=Masc|Number=Sing	8	obl	_	CSID=DE|Lang=de
3	nein	nein	INTJ	_	_	8	discourse	_	CSID=DE|Lang=de
4	28	28	NUM	_	_	5	nummod	_	CSID=DE|Lang=de
5	Februar	Februar	PROPN	_	Case=Dat|Gender=Masc|Number=Sing	8	obl	_	CSID=DE|Lang=de
6	mesleğim	meslek	NOUN	_	Case=Nom|Number=Sing|Number[psor]=Sing|Person[psor]=1	8	obl	_	CSID=TR|Lang=tr
7	ile	ile	ADP	_	_	6	case	_	CSID=TR|Lang=tr
8	bitiyorum	bit	VERB	_	Aspect=Prog|Evident=Fh|Mood=Ind|Number=Sing|Person=1|Tense=Pres	0	root	_	CSID=TR|Lang=tr|SpaceAfter=No
