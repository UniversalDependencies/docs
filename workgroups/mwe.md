...
<span style="color:green">**Agata**: In this discussion we will probably mainly (constructively) critisize the current proposal. So let me start by saying that I highly appreciate what has already been done, and I'm grateful for all these efforts that so substantially benefit a very large community, including PARSEME.</span>
