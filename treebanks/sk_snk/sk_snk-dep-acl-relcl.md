...
727 nodes (1%) are attached to their parents as `acl:relcl`.

722 instances of `acl:relcl` (99%) are left-to-right (parent precedes child).
Average distance between parent and child is 4.80880330123796.
