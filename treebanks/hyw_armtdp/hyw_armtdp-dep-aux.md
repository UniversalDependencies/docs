...
## Treebank Statistics: UD_Western_Armenian-ArmTDP: Relations: `aux`
...
6	յղի	յղի	ADJ	_	_	0	root	_	Translit=yġi|LTranslit=yġi
7	եղեր	ըլլալ	AUX	_	Aspect=Perf|VerbForm=Part	6	aux	_	Translit=eġer|LTranslit=ëllal
8	էր	եմ	AUX	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Imp|VerbForm=Fin	6	cop	_	Translit=ēr|LTranslit=em|SpaceAfter=No
9	:	:	PUNCT	_	Foreign=Yes	6	punct	_	Translit=.|LTranslit=.
...
1	Դատակազմին	դատակազմ	NOUN	_	Animacy=Hum|Case=Dat|Definite=Def|Number=Sing	3	nmod:poss	_	Translit=Datakazmin|LTranslit=datakazm
2	բոլոր	բոլոր	DET	_	PronType=Tot	3	det	_	Translit=bolor|LTranslit=bolor
3	անդամները	անդամ	NOUN	_	Animacy=Hum|Case=Nom|Definite=Def|Number=Plur	4	nsubj	_	Translit=andamnerë|LTranslit=andam
4	շուէտացիներ	շուէտացի	NOUN	_	Animacy=Hum|Case=Nom|Definite=Ind|Number=Plur	0	root	_	Translit=šowētac’iner|LTranslit=šowētac’i
5	կ՚	կը	AUX	_	Aspect=Imp|Mood=Ind	4	aux	_	Translit=k,|LTranslit=kë|SpaceAfter=No
6	ըլլան	ըլլալ	AUX	_	Aspect=Prosp|Mood=Sub|Number=Plur|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin	4	cop	_	Translit=ëllan|LTranslit=ëllal|SpaceAfter=No
