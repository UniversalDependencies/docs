---
layout: base
title:  'Statistics of nsubj:pass in UD_Marathi'
udver: '2'
---

## Treebank Statistics: UD_Marathi: Relations: `nsubj:pass`

This relation is a language-specific subtype of <tt><a href="mr-dep-nsubj.html">nsubj</a></tt>.
There are also 1 other language-specific subtypes of `nsubj`: <tt><a href="mr-dep-nsubj-own.html">nsubj:own</a></tt>.
...
The following 1 pairs of parts of speech are connected with `nsubj:pass`: <tt><a href="mr-pos-VERB.html">VERB</a></tt>-<tt><a href="mr-pos-NOUN.html">NOUN</a></tt> (7; 100% instances).
...
9	आला	येणे	AUX	_	Aspect=Perf|Gender=Masc|Number=Sing|Person=3|VerbForm=Fin	8	aux:pass	_	_
