...
6	რა	რა	PRON	Pron_Int_Nonhum_Nom_Att	Case=Nom|PronType=Int	7	amod	_	LMSeg:რ[ა]
...
6	ვინმეს	ვინმე	PRON	Pron_SIndef_Hum_Dat_PP_PP:თან	Animacy=Anim|Case=Dat|PronType=Ind	8	nmod	_	LMSeg:ვინმე|SpaceAfter=No
...
2	არაფერს	არაფერი	PRON	Pron_Neg_Nonhum_Dat_Sg	Case=Dat|Number=Sing|PronType=Neg	3	obj	_	LMSeg:არაფ[ე]რ·ი
...
8	ვინ	ვინ	PRON	Pron_Int_Hum_Nom	Animacy=Anim|Case=Nom|PronType=Int	4	acl	_	LMSeg:ვინ
