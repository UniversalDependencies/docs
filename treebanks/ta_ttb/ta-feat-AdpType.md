---
layout: base
title:  'Statistics of AdpType in UD_Tamil'
udver: '2'
---

## Treebank Statistics: UD_Tamil: Features: `AdpType`
...
The feature is used with 1 part-of-speech tags: <tt><a href="ta-pos-ADP.html">ADP</a></tt> (288; 3% instances).

### `ADP`

288 <tt><a href="ta-pos-ADP.html">ADP</a></tt> tokens (100% of all `ADP` tokens) have a non-empty value of `AdpType`.
