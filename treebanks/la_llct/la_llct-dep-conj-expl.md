...
40	qui	qui	DET	p|p|-|s|-|-|-|m|n|-	Case=Nom|ExtPos=DET|Gender=Masc|Number=Sing|PronType=Ind	42	det	_	_
...
43	una	una	ADV	d|d|-|-|-|-|-|-|-|-	ExtPos=ADP	46	cc	_	_
...
49	qui	qui	DET	p|p|-|s|-|-|-|m|n|-	Case=Nom|ExtPos=DET|Gender=Masc|Number=Sing|PronType=Ind	51	det	_	_
