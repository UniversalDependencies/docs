...
27470 tokens (39%) have a non-empty value of `Gender`.
6021 types (64%) occur at least once with a non-empty value of `Gender`.
4330 lemmas (64%) occur at least once with a non-empty value of `Gender`.
The feature is used with 9 part-of-speech tags: <tt><a href="fr_sequoia-pos-NOUN.html">NOUN</a></tt> (14146; 20% instances), <tt><a href="fr_sequoia-pos-DET.html">DET</a></tt> (5927; 8% instances), <tt><a href="fr_sequoia-pos-ADJ.html">ADJ</a></tt> (2774; 4% instances), <tt><a href="fr_sequoia-pos-VERB.html">VERB</a></tt> (2195; 3% instances), <tt><a href="fr_sequoia-pos-PROPN.html">PROPN</a></tt> (1589; 2% instances), <tt><a href="fr_sequoia-pos-PRON.html">PRON</a></tt> (820; 1% instances), <tt><a href="fr_sequoia-pos-AUX.html">AUX</a></tt> (10; 0% instances), <tt><a href="fr_sequoia-pos-ADP.html">ADP</a></tt> (7; 0% instances), <tt><a href="fr_sequoia-pos-NUM.html">NUM</a></tt> (2; 0% instances).

### `NOUN`

14146 <tt><a href="fr_sequoia-pos-NOUN.html">NOUN</a></tt> tokens (94% of all `NOUN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NOUN` and `Gender` co-occurred: <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9947; 70%).

`NOUN` tokens may have the following values of `Gender`:

* `Fem` (6655; 47% of non-empty `Gender`): <em>affaire, bivalirudine, perfusion, administration, solution, dose, étude, fois, maladie, guerre</em>
* `Masc` (7491; 53% of non-empty `Gender`): <em>%, patients, mg, ans, cas, traitement, président, effets, M., cours</em>
* `EMPTY` (884): <em>h, enfants, kg, HLM, hui, ICP, D, collègues, ACT, °C</em>
...
2774 <tt><a href="fr_sequoia-pos-ADJ.html">ADJ</a></tt> tokens (63% of all `ADJ` tokens) have a non-empty value of `Gender`.
...
* `Masc` (1485; 54% of non-empty `Gender`): <em>français, ancien, osseux, tous, premier, nombreux, dernier, compris, faux, général</em>
...
The most frequent other feature values with which `VERB` and `Gender` co-occurred: <tt><a href="fr_sequoia-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (2195; 100%), <tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (2195; 100%), <tt><a href="fr_sequoia-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (2195; 100%), <tt><a href="fr_sequoia-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (2195; 100%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1537; 70%), <tt><a href="fr_sequoia-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (1451; 66%).
...
* `EMPTY` (3711): <em>doit, voir, a, peut, est, doivent, faire, faut, peuvent, concernant</em>
...
1589 <tt><a href="fr_sequoia-pos-PROPN.html">PROPN</a></tt> tokens (45% of all `PROPN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PROPN` and `Gender` co-occurred: <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1554; 98%).

`PROPN` tokens may have the following values of `Gender`:

* `Fem` (465; 29% of non-empty `Gender`): <em>commission, France, Paget, Europe, Christine, Denise, Afrique, Chine, Jean, Blanche</em>
* `Masc` (1124; 71% of non-empty `Gender`): <em>paris, Jacques, Chirac, Taïwan, conseil, Michel, Hauts-de-Seine, Parlement, Didier, Alain</em>
* `EMPTY` (1948): <em>Aclasta, Angiox, Union, RPR, Halphen, Jean-Claude, Parlement, Méry, Schuller, Thomson</em>
...
820 <tt><a href="fr_sequoia-pos-PRON.html">PRON</a></tt> tokens (28% of all `PRON` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PRON` and `Gender` co-occurred: <tt><a href="fr_sequoia-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (820; 100%), <tt><a href="fr_sequoia-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (701; 85%), <tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt> (659; 80%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (647; 79%).

`PRON` tokens may have the following values of `Gender`:

* `Fem` (178; 22% of non-empty `Gender`): <em>elle, laquelle, elles, la, lesquelles, une, celle-ci, chacune, celles, celle</em>
* `Masc` (642; 78% of non-empty `Gender`): <em>il, ils, un, le, -il, lui, eux, ceux, chacun, tous</em>
...
7 <tt><a href="fr_sequoia-pos-ADP.html">ADP</a></tt> tokens (0% of all `ADP` tokens) have a non-empty value of `Gender`.
...
<tt>NOUN --[<tt><a href="fr_sequoia-dep-det.html">det</a></tt>]--> DET</tt> (5108; 56%),
<tt>NOUN --[<tt><a href="fr_sequoia-dep-amod.html">amod</a></tt>]--> ADJ</tt> (2172; 61%),
<tt>NOUN --[<tt><a href="fr_sequoia-dep-acl.html">acl</a></tt>]--> VERB</tt> (618; 62%),
<tt>NOUN --[<tt><a href="fr_sequoia-dep-conj.html">conj</a></tt>]--> NOUN</tt> (558; 56%),
<tt>PROPN --[<tt><a href="fr_sequoia-dep-det.html">det</a></tt>]--> DET</tt> (372; 65%),
<tt>VERB --[<tt><a href="fr_sequoia-dep-nsubj-pass.html">nsubj:pass</a></tt>]--> NOUN</tt> (337; 90%),
<tt>NOUN --[<tt><a href="fr_sequoia-dep-appos.html">appos</a></tt>]--> NOUN</tt> (132; 54%),
...
<tt>PROPN --[<tt><a href="fr_sequoia-dep-conj.html">conj</a></tt>]--> PROPN</tt> (80; 52%).
