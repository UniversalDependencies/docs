...
5	τὸ	ὁ	DET	_	Case=Acc,Nom|Definite=Def|Gender=Neut|Number=Sing|PronType=Art	6	det	_	Gloss=the
6	κόνδυ	κόνδυ	NOUN	_	Case=Acc,Nom|Gender=Neut|Number=Sing	4	obl	_	Gloss=drinking-cup
7	τῶν	ὁ	DET	_	Case=Gen|Definite=Def|Gender=Fem,Masc,Neut|Number=Plur|PronType=Art	8	det	_	Gloss=the
8	παίδων	παῖς	NOUN	_	Case=Gen|Gender=Fem,Masc|Number=Plur	6	nmod:poss	_	Gloss=child
9	σου	σύ	PRON	_	Case=Gen|Number=Sing|Person=2|PronType=Prs	8	nmod:poss	_	Gloss=you,your|SpaceAfter=No
...
18	τῷ	ὁ	DET	_	Case=Dat|Definite=Def|Gender=Masc,Neut|Number=Sing|PronType=Art	19	det	_	Gloss=the
19	κυρίῳ	κύριος	NOUN	_	Case=Dat|Gender=Masc|Number=Sing	17	iobj	_	Gloss=lord
20	ἡμῶν	ἡμεῖς	PRON	_	Case=Gen|Number=Plur|Person=1|PronType=Prs	19	nmod:poss	_	Gloss=us,our|SpaceAfter=No
...
3	Νωεμὶν	Νωεμίν	PROPN	_	Gender=Fem|Number=Sing	2	nsubj	_	Gloss=Naomi
4	πρὸς	πρός	ADP	_	_	5	case	_	Gloss=+D=at;-+A=to,toward
5	Ῥοὺθ	Ῥούθ	PROPN	_	Gender=Fem|Number=Sing	2	obl	_	Gloss=Ruth
...
8	αὐτῆς	αὐτός	PRON	_	Case=Gen|Gender=Fem|Number=Sing|PronType=Prs	7	nmod:poss	_	Gloss=she,-self,same|SpaceAfter=No
...
15	ἐπορεύθης	πορεύομαι	VERB	_	Aspect=Perf|Mood=Ind|Number=Sing|Person=2|Tense=Past|VerbForm=Fin|Voice=Pass	10	csubj	_	Gloss=to-proceed,go,depart
16	μετὰ	μετά	ADP	_	_	18	case	_	Gloss=+G=with;-+A=after
17	τῶν	ὁ	DET	_	Case=Gen|Definite=Def|Gender=Fem,Masc,Neut|Number=Plur|PronType=Art	18	det	_	Gloss=the
18	κορασίων	κοράσιον	NOUN	_	Case=Gen|Gender=Neut|Number=Plur	15	obl	_	Gloss=girl
19	αὐτοῦ	αὐτός	PRON	_	Case=Gen|Gender=Masc,Neut|Number=Sing|PronType=Prs	18	nmod:poss	_	Gloss=he,she,it,-self,same|SpaceAfter=No
...
23	ἀπαντήσονταί	ἀπαντάω	VERB	_	Aspect=Imp|Mood=Ind|Number=Plur|Person=3|Tense=Fut|VerbForm=Fin|Voice=Mid	15	conj	_	Gloss=to-meet,encounter
...
6	οἱ	ὁ	DET	_	Case=Nom|Gender=Masc|Number=Plur|PronType=Art	7	det	_	Gloss=the
...
10	τοὺς	ὁ	DET	_	Case=Acc|Definite=Def|Gender=Masc|Number=Plur|PronType=Art	12	det	_	Gloss=the
11	ἑπτὰ	ἑπτά	NUM	_	NumType=Card	12	nummod	_	Gloss=seven
12	στάχυας	στάχυς	NOUN	_	Case=Acc|Gender=Masc|Number=Plur	2	obj	_	Gloss=head-of-grain
13	τοὺς	ὁ	DET	_	Case=Acc|Definite=Def|Gender=Masc|Number=Plur|PronType=Art	14	det	_	Gloss=the
...
21	τοῖς	ὁ	DET	_	Case=Dat|Definite=Def|Gender=Masc,Neut|Number=Plur|PronType=Art	22	det	_	Gloss=the
...
27	ὁ	ὁ	DET	_	Case=Nom|Gender=Masc|Number=Sing|PronType=Art	28	nsubj	_	Gloss=the;-oh
