...
2	membedakan	beda	VERB	VSA	Voice=Act	9	csubj	_	Morf=^meN+beda<a>+kan_VSA$
...
2	mengetik	ketik	VERB	VSA	Voice=Act	14	xcomp	_	Morf=^meN+ketik<v>_VSA$
...
10	diketik	ketik	VERB	VSP	Voice=Pass	6	acl:relcl	_	Morf=^di+ketik<v>_VSP$
...
24	diketik	ketik	VERB	VSP	Voice=Pass	19	acl:relcl	_	Morf=^di+ketik<v>_VSP$
