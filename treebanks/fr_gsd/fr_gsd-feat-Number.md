...
223696 tokens (56%) have a non-empty value of `Number`.
29169 types (68%) occur at least once with a non-empty value of `Number`.
19372 lemmas (59%) occur at least once with a non-empty value of `Number`.
The feature is used with 12 part-of-speech tags: <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> (74741; 19% instances), <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> (61091; 15% instances), <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (24711; 6% instances), <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> (23655; 6% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (12097; 3% instances), <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (11262; 3% instances), <tt><a href="fr_gsd-pos-NUM.html">NUM</a></tt> (10407; 3% instances), <tt><a href="fr_gsd-pos-PROPN.html">PROPN</a></tt> (5276; 1% instances), <tt><a href="fr_gsd-pos-SYM.html">SYM</a></tt> (413; 0% instances), <tt><a href="fr_gsd-pos-ADV.html">ADV</a></tt> (28; 0% instances), <tt><a href="fr_gsd-pos-X.html">X</a></tt> (10; 0% instances), <tt><a href="fr_gsd-pos-ADP.html">ADP</a></tt> (5; 0% instances).

### `NOUN`

74741 <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> tokens (100% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (41535; 56%).

`NOUN` tokens may have the following values of `Number`:

* `Plur` (18553; 25% of non-empty `Number`): <em>ans, années, enfants, pays, habitants, personnes, jours, droits, points, hommes</em>
* `Sing` (56188; 75% of non-empty `Number`): <em>ville, partie, nom, monde, région, commune, groupe, temps, famille, année</em>
* `EMPTY` (310): <em>grâce, peu, suite, face, contre, Hc, IP, NO, PSF, al-mu</em>
...
61091 <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (53466; 88%), <tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (43344; 71%).

`DET` tokens may have the following values of `Number`:

* `Plur` (14168; 23% of non-empty `Number`): <em>les, des, ses, ces, de, plusieurs, leurs, quelques, d', certains</em>
* `Sing` (46923; 77% of non-empty `Number`): <em>le, la, l', un, une, son, sa, cette, ce, leur</em>
* `EMPTY` (45): <em>d', de, ce</em>

<table>
  <tr><th>Paradigm <i>le</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>le, L'</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>l', l</em></td><td><em>les</em></td></tr>
...
24711 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (77% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13680; 55%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13678; 55%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13084; 53%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (12942; 52%).

`VERB` tokens may have the following values of `Number`:

* `Plur` (5075; 21% of non-empty `Number`): <em>ont, peuvent, font, doivent, prennent, sont, trouvent, vont, permettent, utilisés</em>
* `Sing` (19636; 79% of non-empty `Number`): <em>a, fait, peut, né, située, est, situé, trouve, devient, doit</em>
* `EMPTY` (7200): <em>faire, partir, voir, prendre, avoir, mettre, passer, trouver, aller, mis</em>
...
23655 <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> tokens (99% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (12506; 53%).

`ADJ` tokens may have the following values of `Number`:

* `Plur` (6610; 28% of non-empty `Number`): <em>autres, tous, nombreux, toutes, nombreuses, premiers, grands, premières, grandes, derniers</em>
* `Sing` (17045; 72% of non-empty `Number`): <em>premier, première, même, français, française, dernier, grande, grand, nouveau, autre</em>
* `EMPTY` (126): <em>super, vidéo, heureux, chaleureux, amoureux, audio, bas, coûteux, frais, marron</em>
...
12097 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11196; 93%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10838; 90%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (10746; 89%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9481; 78%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (2321; 19% of non-empty `Number`): <em>sont, ont, étaient, avons, furent, avaient, seront, sommes, soient, auraient</em>
* `Sing` (9776; 81% of non-empty `Number`): <em>est, a, été, était, fut, avait, ai, sera, fait, soit</em>
* `EMPTY` (849): <em>être, avoir, étant, faire, ayant, faisant, Etant, -être, etre</em>
...
11262 <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> tokens (63% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (11134; 99%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9548; 85%), <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (8204; 73%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (7519; 67%).
...
* `EMPTY` (6532): <em>qui, se, s', y, dont, ce, en, qu', que, quoi</em>
...
10407 <tt><a href="fr_gsd-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `Number`.

`NUM` tokens may have the following values of `Number`:

* `Plur` (9186; 88% of non-empty `Number`): <em>deux, trois, 2, quatre, 2010, 2009, 2008, 2011, 3, 5</em>
* `Sing` (1221; 12% of non-empty `Number`): <em>un, 6, 7, 18, 1er, 11, 25, 15, 20, 5</em>
* `EMPTY` (12): <em>I, 1er, 100, 1919, 1920, 2., 4ème, 7, 7400</em>
...
`Number` seems to be **lexical feature** of `NUM`. 97% lemmas (1834) occur only with one value of `Number`.

### `PROPN`

5276 <tt><a href="fr_gsd-pos-PROPN.html">PROPN</a></tt> tokens (19% of all `PROPN` tokens) have a non-empty value of `Number`.
...
* `Sing` (4222; 80% of non-empty `Number`): <em>Europe, Maroc, France, ONU, Espagne, Algérie, Sahara, Canada, UE, Afrique</em>
* `EMPTY` (23029): <em>France, Paris, Jean, Europe, York, New, Pierre, Charles, Louis, Italie</em>
...
`Number` seems to be **lexical feature** of `PROPN`. 99% lemmas (3037) occur only with one value of `Number`.

### `SYM`

413 <tt><a href="fr_gsd-pos-SYM.html">SYM</a></tt> tokens (58% of all `SYM` tokens) have a non-empty value of `Number`.
...
28 <tt><a href="fr_gsd-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADV` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (26; 93%).

`ADV` tokens may have the following values of `Number`:

* `Plur` (11; 39% of non-empty `Number`): <em>moins, Combien, plus</em>
* `Sing` (17; 61% of non-empty `Number`): <em>peu, delà, NON, juste, pas, point, pré-</em>
* `EMPTY` (14526): <em>plus, pas, n', ne, très, aussi, où, ainsi, alors, bien</em>

`Number` seems to be **lexical feature** of `ADV`. 100% lemmas (10) occur only with one value of `Number`.

### `X`

10 <tt><a href="fr_gsd-pos-X.html">X</a></tt> tokens (0% of all `X` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `X` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Foreign.html">Foreign</a></tt><tt>=EMPTY</tt> (9; 90%).

`X` tokens may have the following values of `Number`:

* `Plur` (1; 10% of non-empty `Number`): <em>papiri</em>
* `Sing` (9; 90% of non-empty `Number`): <em>anchicho, incienso, FDLP, KS360, a, arc, ego, end, guayaibí</em>
* `EMPTY` (2422): <em>the, of, de, etc., and, in, del, for, von, a</em>
...
* `EMPTY` (63685): <em>de, à, en, d', dans, pour, par, sur, avec, comme</em>

## Relations with Agreement in `Number`

The 10 most frequent relations where parent and child node agree in `Number`:
<tt>NOUN --[<tt><a href="fr_gsd-dep-det.html">det</a></tt>]--> DET</tt> (53200; 100%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-amod.html">amod</a></tt>]--> ADJ</tt> (19278; 99%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (13238; 64%),
<tt>VERB --[<tt><a href="fr_gsd-dep-obl-mod.html">obl:mod</a></tt>]--> NOUN</tt> (5760; 59%),
<tt>PROPN --[<tt><a href="fr_gsd-dep-det.html">det</a></tt>]--> DET</tt> (5063; 99%),
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (5062; 72%),
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (4826; 92%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> NOUN</tt> (4232; 81%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-nummod.html">nummod</a></tt>]--> NUM</tt> (3074; 99%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-acl.html">acl</a></tt>]--> VERB</tt> (3052; 72%).
