...
3	zegt	zeggen	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	_
4	ben	zijn	AUX	WW|pv|tgw|ev	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	3	cop	3:cop	_
...
1	Een	een	NUM	LID|onbep|stan|agr	_	2	nummod	2:nummod	_
...
5	is	zijn	AUX	WW|pv|tgw|ev	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	11	cop	11:cop	_
...
11	heeft	hebben	VERB	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	0	root	0:root	SpaceAfter=No
...
4	de	de	DET	LID|bep|stan|rest	Definite=Def|PronType=Art	6	det	6:det	_
