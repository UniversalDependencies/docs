---
layout: base
title:  'Statistics of CCONJ in UD_Turkish_English-BUTR'
udver: '2'
---
...
1 (8%) `CCONJ` nodes have two children.

The highest child degree of a `CCONJ` node is 2.

Children of `CCONJ` nodes are attached using 2 different relations: <tt><a href="qti_butr-dep-advmod.html">advmod</a></tt> (1; 50% instances), <tt><a href="qti_butr-dep-punct.html">punct</a></tt> (1; 50% instances)

Children of `CCONJ` nodes belong to 2 different parts of speech: <tt><a href="qti_butr-pos-ADV.html">ADV</a></tt> (1; 50% instances), <tt><a href="qti_butr-pos-PUNCT.html">PUNCT</a></tt> (1; 50% instances)
