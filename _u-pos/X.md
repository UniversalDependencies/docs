...
- __Unanalyzed foreign words:__ Cases of code-switching where it is not possible 
(or meaningful) to analyze the intervening language grammatically. 
See the page on [Foreign Expressions and Code-Switching](/foreign.html).
