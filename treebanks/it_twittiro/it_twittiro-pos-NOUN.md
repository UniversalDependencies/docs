...
There are 1790 `NOUN` lemmas (35%), 2050 `NOUN` types (31%) and 4455 `NOUN` tokens (15%).
...
The form / lemma ratio of `NOUN` is 1.145251 (the average of all parts of speech is 1.274961).

The 1st highest number of forms (6) was observed with the lemma “professore”: <em>prof, prof., professor, professore, professori, proof</em>.
