...
The most frequent other feature values with which `NUM` and `NumForm` co-occurred: <tt><a href="cs_cltt-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (440; 100%), <tt><a href="cs_cltt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (394; 90%), <tt><a href="cs_cltt-feat-NumValue.html">NumValue</a></tt><tt>=EMPTY</tt> (382; 87%), <tt><a href="cs_cltt-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (371; 84%), <tt><a href="cs_cltt-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (371; 84%).
