...
`ADP` occurs with 36 feature combinations.
...
Children of `ADP` nodes are attached using 2 different relations: <tt><a href="mdf_jr-dep-nmod.html">nmod</a></tt> (1; 50% instances), <tt><a href="mdf_jr-dep-punct.html">punct</a></tt> (1; 50% instances)

Children of `ADP` nodes belong to 2 different parts of speech: <tt><a href="mdf_jr-pos-NOUN.html">NOUN</a></tt> (1; 50% instances), <tt><a href="mdf_jr-pos-PUNCT.html">PUNCT</a></tt> (1; 50% instances)
