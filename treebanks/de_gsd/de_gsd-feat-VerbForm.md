...
31854 tokens (11%) have a non-empty value of `VerbForm`.
5325 types (11%) occur at least once with a non-empty value of `VerbForm`.
2807 lemmas (7%) occur at least once with a non-empty value of `VerbForm`.
The feature is used with 15 part-of-speech tags: <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> (19617; 7% instances), <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> (11375; 4% instances), <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> (663; 0% instances), <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> (72; 0% instances), <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> (63; 0% instances), <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> (27; 0% instances), <tt><a href="de_gsd-pos-X.html">X</a></tt> (18; 0% instances), <tt><a href="de_gsd-pos-ADP.html">ADP</a></tt> (5; 0% instances), <tt><a href="de_gsd-pos-CCONJ.html">CCONJ</a></tt> (4; 0% instances), <tt><a href="de_gsd-pos-PART.html">PART</a></tt> (4; 0% instances), <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> (2; 0% instances), <tt><a href="de_gsd-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-PUNCT.html">PUNCT</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-SCONJ.html">SCONJ</a></tt> (1; 0% instances).

### `VERB`

19617 <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> tokens (98% of all `VERB` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `VERB` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (11603; 59%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (11402; 58%).

`VERB` tokens may have the following values of `VerbForm`:

* `Fin` (11825; 60% of non-empty `VerbForm`): <em>gibt, hat, kam, liegt, hatte, gab, war, erhielt, befindet, ist</em>
* `Inf` (2932; 15% of non-empty `VerbForm`): <em>empfehlen, lassen, machen, erreichen, finden, haben, sehen, kommen, arbeiten, gehen</em>
* `Part` (4860; 25% of non-empty `VerbForm`): <em>gegründet, verwendet, eingesetzt, genutzt, gebaut, aufgenommen, errichtet, erwähnt, geboren, veröffentlicht</em>
* `EMPTY` (305): <em>was, folgend, bestehend, ausgehend, bekannt, entfernt, überzeugt, bedingt, beeindruckt, bereut</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Past</tt></tt></td><td><em>hatte</em></td><td></td><td></td></tr>
...
11375 <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> tokens (100% of all `AUX` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `AUX` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9846; 87%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9772; 86%), <tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (8246; 72%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7752; 68%), <tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (5726; 50%).

`AUX` tokens may have the following values of `VerbForm`:

* `Fin` (10349; 91% of non-empty `VerbForm`): <em>ist, wurde, war, sind, wird, wurden, kann, werden, hat, waren</em>
* `Inf` (668; 6% of non-empty `VerbForm`): <em>werden, sein, können, haben, lassen, müssen, wollen, bleiben, dürfen, anzusehen</em>
* `Part` (358; 3% of non-empty `VerbForm`): <em>worden, gewesen, bezeichnet, genannt, geworden, ernannt, gewählt, geblieben, gemacht, umbenannt</em>
* `EMPTY` (21): <em>Bin, Hab, be, Saarinen, WERDEN, Zu, abgekürzt, could, daneben, den</em>

<table>
  <tr><th>Paradigm <i>sein</i></th><th><tt>Fin</tt></th><th><tt>Inf</tt></th><th><tt>Part</tt></th></tr>
  <tr><td><tt>_</tt></td><td></td><td><em>sein, seien</em></td><td><em>gewesen</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>ist</em></td><td></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Sub</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="de_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td><em>sei</em></td><td></td><td></td></tr>
...
663 <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> tokens (3% of all `ADJ` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `ADJ` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (663; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (663; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (585; 88%).
...
`VerbForm` seems to be **lexical feature** of `ADJ`. 98% lemmas (393) occur only with one value of `VerbForm`.

### `NOUN`

72 <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `NOUN` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (72; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (72; 100%).
...
`VerbForm` seems to be **lexical feature** of `NOUN`. 98% lemmas (56) occur only with one value of `VerbForm`.

### `PROPN`

63 <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> tokens (0% of all `PROPN` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `PROPN` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (63; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (63; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (43; 68%).
...
* `EMPTY` (14732): <em>auch, nur, noch, sehr, so, dort, wieder, hier, mehr, heute</em>
...
The most frequent other feature values with which `X` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (18; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (18; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (12; 67%).
...
* `EMPTY` (351): <em>z.B., u.a., =, %, B., etc., †, &amp;, *, a</em>
...
* `EMPTY` (31684): <em>in, von, mit, zu, an, auf, für, als, nach, bei</em>
...
The most frequent other feature values with which `PART` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (4; 100%).
...
1 <tt><a href="de_gsd-pos-DET.html">DET</a></tt> tokens (0% of all `DET` tokens) have a non-empty value of `VerbForm`.

The most frequent other feature values with which `DET` and `VerbForm` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (1; 100%).
...
<tt>VERB --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1559; 70%),
<tt>VERB --[<tt><a href="de_gsd-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (132; 53%),
...
<tt>VERB --[<tt><a href="de_gsd-dep-cc.html">cc</a></tt>]--> VERB</tt> (1; 100%),
