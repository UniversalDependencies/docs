...
* Some nouns ([NOUN](https://universaldependencies.org/u/pos/all.html#al-u-pos/NOUN)) and adjectives ([ADJ](https://universaldependencies.org/u/pos/all.html#al-u-pos/ADJ)) have [Gender](https://universaldependencies.org/u/feat/all.html#al-u-feat/Gender) with 2 possible values: `Masc`, `Fem`. These are usually loanwords from Spanish. Names of people and certain nouns that have implied gender (e.g. *baye* "girl") also have  `Gender`. Other nouns or adjectives do not have this feature.
