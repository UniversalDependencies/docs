...
The feature is used with 2 part-of-speech tags: <tt><a href="zh_gsd-pos-PART.html">PART</a></tt> (956; 1% instances), <tt><a href="zh_gsd-pos-X.html">X</a></tt> (1; 0% instances).

### `PART`

956 <tt><a href="zh_gsd-pos-PART.html">PART</a></tt> tokens (7% of all `PART` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `PART` and `Aspect` co-occurred: <tt><a href="zh_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (956; 100%).
...
1 <tt><a href="zh_gsd-pos-X.html">X</a></tt> tokens (0% of all `X` tokens) have a non-empty value of `Aspect`.
