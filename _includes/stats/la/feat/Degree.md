...
330 tokens (1%) have a non-empty value of `Degree`.
233 types (2%) occur at least once with a non-empty value of `Degree`.
149 lemmas (2%) occur at least once with a non-empty value of `Degree`.
The feature is used with 3 part-of-speech tags: [la-pos/ADJ]() (276; 1% instances), [la-pos/ADV]() (47; 0% instances), [la-pos/VERB]() (7; 0% instances).

### `ADJ`

276 [la-pos/ADJ]() tokens (6% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (209; 76%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (175; 63% of non-empty `Degree`): <em>maior, melior, amplius, maiore, maiora, minor, minores, minus, certior, citeriore</em>
* `Pos` (3; 1% of non-empty `Degree`): <em>Aliam, Alium, Attici</em>
* `Sup` (98; 36% of non-empty `Degree`): <em>carissime, celeberrima, acutissima, gravissimo, minuma, nequissimus, novissimus, paucissimis, taeterrima, Maximo</em>
* `EMPTY` (4534): <em>magna, omnes, omnia, sua, mea, omnis, suis, publicae, tua, suo</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Abl|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Sing</tt></td><td><em>maiore</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Abl|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Plur</tt></td><td><em>maioribus</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td><em>maiorem</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Plur</tt></td><td><em>maiores</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Plur</tt></td><td><em>maiorum</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td><em>maior</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing</tt></td><td><em>maius</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Plur</tt></td><td><em>maiora</em></td><td></td></tr>
</table>

### `ADV`

47 [la-pos/ADV]() tokens (1% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (33; 70% of non-empty `Degree`): <em>prius, amplius, diutius, facilius, magis, minus, plus, potius, validius, celerius</em>
* `Sup` (14; 30% of non-empty `Degree`): <em>Novissime, maxime, aegerrime, cupidissume, minime, minimum, optimemanu, plurimum, pulcherrime, seuerissime</em>
* `EMPTY` (3651): <em>non, ne, iam, tamen, quam, etiam, sic, nunc, ita, modo</em>
...
* `Cmp` (7; 100% of non-empty `Degree`): <em>amantior, audentior, celebratior, conuenientius, doctior, metuentior, patientior</em>
* `EMPTY` (10534): <em>est, sunt, esse, erat, inquit, fuit, sit, habet, vidi, sum</em>
...
The feature is used with 9 part-of-speech tags: [la-pos/NOUN]() (56058; 19% instances), [la-pos/PRON]() (28468; 10% instances), [la-pos/ADJ]() (22317; 8% instances), [la-pos/VERB]() (10857; 4% instances), [la-pos/PROPN]() (3657; 1% instances), [la-pos/DET]() (3138; 1% instances), [la-pos/NUM]() (1321; 0% instances), [la-pos/X]() (5; 0% instances), [la-pos/ADP]() (1; 0% instances).

### `NOUN`

56058 [la-pos/NOUN]() tokens (98% of all `NOUN` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `NOUN` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (47154; 84%), <tt><a href="Gender.html">Gender</a>=Fem</tt> (33614; 60%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing</tt></td><td><em>perfectum</em></td><td><em>perfectius</em></td><td><em>perfectissimum</em></td></tr>
...
28468 [la-pos/PRON]() tokens (99% of all `PRON` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `PRON` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (21684; 76%), <tt><a href="Gender.html">Gender</a>=Neut</tt> (14545; 51%).

`PRON` tokens may have the following values of `Degree`:

* `Pos` (28468; 100% of non-empty `Degree`): <em>quae, quod, hoc, se, aliquid, eius, qui, quo, aliqua, ipsum</em>
* `EMPTY` (372): <em>nihil, quot, tot, nil</em>

`Degree` seems to be **lexical feature** of `PRON`. 100% lemmas (56) occur only with one value of `Degree`.

### `ADJ`

22317 [la-pos/ADJ]() tokens (99% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (17448; 78%).
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Sing</tt></td><td><em>verae</em></td><td></td><td></td></tr>
...
* `Pos` (10798; 99% of non-empty `Degree`): <em>ostensum, dicendum, movens, separatae, dictum, essendi, agens, probatum, separata, separatas</em>
...
* `EMPTY` (41658): <em>est, esse, sit, sunt, potest, oportet, habet, dicitur, patet, dicit</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Sing</tt></td><td><em>conveniens</em></td><td><em>convenientior</em></td><td></td></tr>
...
`Degree` seems to be **lexical feature** of `VERB`. 97% lemmas (660) occur only with one value of `Degree`.

### `PROPN`

3657 [la-pos/PROPN]() tokens (99% of all `PROPN` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `PROPN` and `Degree` co-occurred: <tt><a href="Gender.html">Gender</a>=Masc</tt> (3499; 96%), <tt><a href="Number.html">Number</a>=Sing</tt> (3483; 95%).
...
* `Pos` (3137; 100% of non-empty `Degree`): <em>suam, sua, omnis, suum, omnes, omne, suae, omnia, omnibus, omnium</em>
...
5 [la-pos/X]() tokens (1% of all `X` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `X` and `Degree` co-occurred: <tt><a href="Abbr.html">Abbr</a>=EMPTY</tt> (3; 60%).
...
The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>NOUN --[<a href="../dep/nmod.html">nmod</a>]--> NOUN</tt> (9652; 95%),
<tt>NOUN --[<a href="../dep/amod.html">amod</a>]--> ADJ</tt> (9156; 90%),
<tt>NOUN --[<a href="../dep/nmod.html">nmod</a>]--> PRON</tt> (8191; 97%),
<tt>NOUN --[<a href="../dep/acl.html">acl</a>]--> VERB</tt> (3877; 62%),
<tt>NOUN --[<a href="../dep/conj.html">conj</a>]--> NOUN</tt> (3045; 97%),
<tt>NOUN --[<a href="../dep/det.html">det</a>]--> DET</tt> (2730; 94%),
<tt>NOUN --[<a href="../dep/nsubj.html">nsubj</a>]--> NOUN</tt> (1535; 92%),
<tt>NOUN --[<a href="../dep/nsubj.html">nsubj</a>]--> PRON</tt> (983; 93%),
<tt>ADJ --[<a href="../dep/conj.html">conj</a>]--> ADJ</tt> (737; 94%),
<tt>ADJ --[<a href="../dep/nsubj.html">nsubj</a>]--> NOUN</tt> (737; 75%).
...
9612 tokens (6%) have a non-empty value of `Degree`.
3019 types (13%) occur at least once with a non-empty value of `Degree`.
1234 lemmas (18%) occur at least once with a non-empty value of `Degree`.
The feature is used with 2 part-of-speech tags: [la-pos/ADJ]() (7885; 5% instances), [la-pos/ADV]() (1727; 1% instances).

### `ADJ`

7885 [la-pos/ADJ]() tokens (57% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="Number.html">Number</a>=Sing</tt> (4892; 62%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (680; 9% of non-empty `Degree`): <em>maior, maiore, seniores, plus, plura, senioribus, certiorem, certior, superioribus, maiorem</em>
* `Pos` (6839; 87% of non-empty `Degree`): <em>multa, magna, sanctus, multi, magno, multis, publica, romani, magnum, sancti</em>
* `Sup` (366; 5% of non-empty `Degree`): <em>maxima, plurima, maximum, maximo, plurimum, plurimi, maximam, maximas, optimo, optimum</em>
* `EMPTY` (5927): <em>haec, hoc, illi, illis, illum, his, ille, hic, illo, illa</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Abl|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td><em>magno</em></td><td><em>maiori</em></td><td><em>maximo</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Abl|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Plur</tt></td><td><em>magnis</em></td><td><em>maioribus</em></td><td></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Abl|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing</tt></td><td><em>magno</em></td><td><em>maiori</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Fem,Masc|<a href="Number.html">Number</a>=Plur</tt></td><td></td><td><em>maiores</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Dat|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Sing</tt></td><td></td><td></td><td><em>maximae</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Gender.html">Gender</a>=Masc,Neut|<a href="Number.html">Number</a>=Plur</tt></td><td><em>magnorum</em></td><td><em>maiorum</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Plur</tt></td><td></td><td><em>maiorum</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Masc|<a href="Number.html">Number</a>=Sing</tt></td><td><em>magnus</em></td><td><em>maior</em></td><td><em>maximus</em></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Fem,Masc|<a href="Number.html">Number</a>=Plur</tt></td><td></td><td><em>maiores</em></td><td></td></tr>
...
1727 [la-pos/ADV]() tokens (10% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (452; 26% of non-empty `Degree`): <em>magis, minus, amplius, prius, longius, plus, diutius, facilius, diligentius, melius</em>
* `Pos` (1111; 64% of non-empty `Degree`): <em>similiter, satis, valde, longe, saepe, bene, celeriter, facile, vere, prope</em>
* `Sup` (164; 9% of non-empty `Degree`): <em>maxime, minime, diligentissime, plurimum, proxime, novissime, saepissime, fortissime, longissime, optime</em>
* `EMPTY` (16076): <em>non, autem, ne, enim, et, ergo, etiam, quam, ut, ubi</em>
...
The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<a href="../dep/conj.html">conj</a>]--> ADJ</tt> (311; 89%),
<tt>ADV --[<a href="../dep/conj.html">conj</a>]--> ADV</tt> (34; 65%),
<tt>ADJ --[<a href="../dep/advmod.html">advmod</a>]--> ADJ</tt> (22; 67%),
<tt>ADJ --[<a href="../dep/remnant.html">remnant</a>]--> ADJ</tt> (21; 95%),
<tt>ADJ --[<a href="../dep/advcl.html">advcl</a>]--> ADJ</tt> (12; 67%).
