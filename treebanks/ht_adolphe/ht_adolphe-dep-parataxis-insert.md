---
layout: base
title:  'Statistics of parataxis:insert in UD_Haitian_Creole-Adolphe'
udver: '2'
---

## Treebank Statistics: UD_Haitian_Creole-Adolphe: Relations: `parataxis:insert`

This relation is a language-specific subtype of <tt><a href="ht_adolphe-dep-parataxis.html">parataxis</a></tt>.
...
The following 3 pairs of parts of speech are connected with `parataxis:insert`: <tt><a href="ht_adolphe-pos-VERB.html">VERB</a></tt>-<tt><a href="ht_adolphe-pos-VERB.html">VERB</a></tt> (2; 50% instances), <tt><a href="ht_adolphe-pos-INTJ.html">INTJ</a></tt>-<tt><a href="ht_adolphe-pos-VERB.html">VERB</a></tt> (1; 25% instances), <tt><a href="ht_adolphe-pos-VERB.html">VERB</a></tt>-<tt><a href="ht_adolphe-pos-PROPN.html">PROPN</a></tt> (1; 25% instances).
...
# visual-style 11 4 parataxis:insert	color:blue
1	"	"	PUNCT	_	_	4	punct	_	SpaceAfter=No
2	Wi	wi	INTJ	_	_	4	discourse	_	Gloss=oui|SpaceAfter=No
3	,	,	PUNCT	_	_	2	punct	_	_
4	avanse	avanse	VERB	_	_	11	parataxis:insert	_	Gloss=avancer
...
9	klas	klas	NOUN	_	_	11	nsubj	_	Gloss=classe
10	la	la	DET	_	Definite=Def|Number=Sing|PronType=Art	9	det	_	Gloss=le
11	reponn	reponn	VERB	_	_	0	root	_	Gloss=répondre|SpaceAfter=No
...
15	Ayiti	Ayiti	PROPN	_	_	12	obl:mod	_	Gloss=Haïti|SpaceAfter=No
