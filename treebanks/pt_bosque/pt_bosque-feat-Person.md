...
18621 tokens (8%) have a non-empty value of `Person`.
4331 types (17%) occur at least once with a non-empty value of `Person`.
1342 lemmas (7%) occur at least once with a non-empty value of `Person`.
The feature is used with 3 part-of-speech tags: <tt><a href="pt_bosque-pos-VERB.html">VERB</a></tt> (12001; 5% instances), <tt><a href="pt_bosque-pos-AUX.html">AUX</a></tt> (4190; 2% instances), <tt><a href="pt_bosque-pos-PRON.html">PRON</a></tt> (2430; 1% instances).

### `VERB`

12001 <tt><a href="pt_bosque-pos-VERB.html">VERB</a></tt> tokens (58% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (12000; 100%), <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11700; 97%), <tt><a href="pt_bosque-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10726; 89%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9101; 76%), <tt><a href="pt_bosque-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (6104; 51%).
...
* `3` (11241; 94% of non-empty `Person`): <em>tem, há, disse, pode, diz, é, deve, está, fez, têm</em>
* `EMPTY` (8778): <em>fazer, ter, ver, dar, feito, dizer, partir, falar, feita, manter</em>
...
4190 <tt><a href="pt_bosque-pos-AUX.html">AUX</a></tt> tokens (83% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="pt_bosque-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (4099; 98%), <tt><a href="pt_bosque-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (3750; 89%), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3143; 75%), <tt><a href="pt_bosque-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (2443; 58%).
...
* `3` (4031; 96% of non-empty `Person`): <em>é, foi, são, está, foram, vai, era, será, estão, tem</em>
...
<tt>VERB --[<tt><a href="pt_bosque-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (198; 61%),
