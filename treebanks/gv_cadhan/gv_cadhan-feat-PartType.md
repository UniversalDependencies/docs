...
462 tokens (2%) have a non-empty value of `PartType`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="gv_cadhan-pos-PART.html">PART</a></tt> (429; 2% instances), <tt><a href="gv_cadhan-pos-ADP.html">ADP</a></tt> (33; 0% instances).

### `PART`

429 <tt><a href="gv_cadhan-pos-PART.html">PART</a></tt> tokens (93% of all `PART` tokens) have a non-empty value of `PartType`.
...
* `Vb` (185; 43% of non-empty `PartType`): <em>cha, Ny, nagh, dy, N'</em>
