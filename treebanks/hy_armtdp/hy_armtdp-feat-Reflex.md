...
226 tokens (0%) have a non-empty value of `Reflex`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="hy_armtdp-pos-DET.html">DET</a></tt> (178; 0% instances), <tt><a href="hy_armtdp-pos-PRON.html">PRON</a></tt> (48; 0% instances).
...
* `Yes` (178; 100% of non-empty `Reflex`): <em>իր, իրենց, յուր</em>
* `EMPTY` (1755): <em>մի, այդ, մեր, այս, նրա, այն, ինչ, ամեն, իմ, բոլոր</em>
...
* `Yes` (48; 100% of non-empty `Reflex`): <em>իր, իրեն, իրենց, իրենից, իրենն</em>
* `EMPTY` (1893): <em>նա, ես, մենք, ինչ, դա, այն, ինձ, նրանք, նրան, որը</em>
