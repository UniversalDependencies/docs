...
There are 824 `ADJ` lemmas (17%), 1520 `ADJ` types (15%) and 2131 `ADJ` tokens (7%).
...
The form / lemma ratio of `ADJ` is 1.844660 (the average of all parts of speech is 2.101803).
