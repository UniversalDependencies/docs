...
6 <tt><a href="pt_gsd-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Number`.
...
<table>
  ...
  <tr><td><tt></tt></td><td><em>amigo</em></td><td><em>amigos</em></td></tr>
</table>

### `ADJ`

2 <tt><a href="pt_gsd-pos-ADJ.html">ADJ</a></tt> tokens (0% of all `ADJ` tokens) have a non-empty value of `Number`.
...
2 <tt><a href="pt_gsd-pos-VERB.html">VERB</a></tt> tokens (0% of all `VERB` tokens) have a non-empty value of `Number`.
...
1 <tt><a href="pt_gsd-pos-PRON.html">PRON</a></tt> tokens (0% of all `PRON` tokens) have a non-empty value of `Number`.
...
<tt>NOUN --[<tt><a href="pt_gsd-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (1; 100%),
<tt>VERB --[<tt><a href="pt_gsd-dep-obj.html">obj</a></tt>]--> ADJ</tt> (1; 100%),
<tt>VERB --[<tt><a href="pt_gsd-dep-xcomp.html">xcomp</a></tt>]--> NOUN</tt> (1; 100%).
