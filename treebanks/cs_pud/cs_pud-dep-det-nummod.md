...
4	artefaktů	artefakt	NOUN	NNIP2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Plur	1	nsubj	1:nsubj	SpaceAfter=No
...
9	menhirů	menhir	NOUN	NNIP2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Plur	4	nmod	4:nmod:včetně:gen	_
10	a	a	CCONJ	J^-------------	_	11	cc	11:cc	LId=a-1
11	dolmenů	dolmen	NOUN	NNIP2-----A----	Animacy=Inan|Case=Gen|Gender=Masc|Number=Plur	9	conj	4:nmod:včetně:gen|9:conj	SpaceAfter=No
