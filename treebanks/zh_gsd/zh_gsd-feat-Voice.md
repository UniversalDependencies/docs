...
The feature is used with 3 part-of-speech tags: <tt><a href="zh_gsd-pos-VERB.html">VERB</a></tt> (492; 0% instances), <tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> (425; 0% instances), <tt><a href="zh_gsd-pos-ADP.html">ADP</a></tt> (1; 0% instances).

### `VERB`

492 <tt><a href="zh_gsd-pos-VERB.html">VERB</a></tt> tokens (3% of all `VERB` tokens) have a non-empty value of `Voice`.
...
425 <tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> tokens (11% of all `AUX` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `AUX` and `Voice` co-occurred: <tt><a href="zh_gsd-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (425; 100%).
