...
Out of 14 observed tags, the rank of `SCONJ` is: 9 in number of lemmas, 10 in number of types and 10 in number of tokens.
...
The form / lemma ratio of `SCONJ` is 1.000000 (the average of all parts of speech is 1.749612).
