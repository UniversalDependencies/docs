...
3	jitru	jitro	NOUN	NNNS6-----A----	Case=Loc|Gender=Neut|Number=Sing	10	orphan	_	_
4	mi	já	PRON	PH-S3--1-------	Case=Dat|Number=Sing|Person=1|PronType=Prs|Variant=Short	3	conj	_	_
5	lásky	láska	NOUN	NNFP1-----A----	Case=Nom|Gender=Fem|Number=Plur	3	conj	_	SpaceAfter=No
6	,	,	PUNCT	Z:-------------	_	10	punct	_	_
7	ať	ať	PART	TT-------------	_	10	mark	_	_
8	na	na	ADP	RR--6----------	AdpType=Prep|Case=Loc	9	case	_	_
9	hrobech	hrob	NOUN	NNIP6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Plur	10	obl	_	_
...
1	Meč	meč	NOUN	NNIS1-----A----	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	0	root	_	_
2	samý	samý	DET	PLYS1----------	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing|PronType=Emp	3	det	_	_
3	zub	zub	NOUN	NNIS1-----A----	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	1	nmod	_	SpaceAfter=No
4	,	,	PUNCT	Z:-------------	_	3	punct	_	_
5	tvář	tvář	NOUN	NNFS1-----A----	Case=Nom|Gender=Fem|Number=Sing	3	conj	_	_
6	zjizvena	zjizvený	ADJ	VsQW---XX-AP---	Aspect=Perf|Degree=Pos|Gender=Fem|Number=Sing|Polarity=Pos|Variant=Short|VerbForm=Part|Voice=Pass	5	amod	_	SpaceAfter=No
7	,	,	PUNCT	Z:-------------	_	5	punct	_	_
8	kde	kde	ADV	Db-------------	PronType=Int	5	conj	_	_
9	chlup	chlup	NOUN	NNIS1-----A----	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	8	orphan	_	SpaceAfter=No
10	,	,	PUNCT	Z:-------------	_	9	punct	_	_
11	tam	tam	ADV	Db-------------	PronType=Dem	5	orphan	_	_
12	chlup	chlup	NOUN	NNIS1-----A----	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	5	orphan	_	SpaceAfter=No
