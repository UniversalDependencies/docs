...
Average distance between parent and child is 4.975.

The following 4 pairs of parts of speech are connected with `expl`: <tt><a href="nl_lassysmall-pos-VERB.html">VERB</a></tt>-<tt><a href="nl_lassysmall-pos-PRON.html">PRON</a></tt> (160; 57% instances), <tt><a href="nl_lassysmall-pos-ADJ.html">ADJ</a></tt>-<tt><a href="nl_lassysmall-pos-PRON.html">PRON</a></tt> (68; 24% instances), <tt><a href="nl_lassysmall-pos-NOUN.html">NOUN</a></tt>-<tt><a href="nl_lassysmall-pos-PRON.html">PRON</a></tt> (44; 16% instances), <tt><a href="nl_lassysmall-pos-ADV.html">ADV</a></tt>-<tt><a href="nl_lassysmall-pos-PRON.html">PRON</a></tt> (8; 3% instances).
...
1	Ik	ik	PRON	VNW|pers|pron|nomin|vol|1|ev	Case=Nom|Person=1|PronType=Prs	2	nsubj	2:nsubj|10:nsubj:xsubj	_
2	hield	houden	VERB	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	0	root	0:root	_
...
10	rijden	mee_rijden	VERB	WW|inf|vrij|zonder	VerbForm=Inf	2	xcomp	2:xcomp	SpaceAfter=No
...
6	bruine	bruin	ADJ	ADJ|prenom|basis|met-e|stan	Degree=Pos	9	amod	9:amod	_
7	of	of	CCONJ	VG|neven	_	8	cc	8:cc	_
8	parboiled	parboiled	X	SPEC|vreemd	Foreign=Yes	6	conj	6:conj:of|9:amod	_
...
4	was	zijn	AUX	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	3	cop	3:cop	_
...
11	de	de	DET	LID|bep|stan|rest	Definite=Def|PronType=Art	12	det	12:det	_
