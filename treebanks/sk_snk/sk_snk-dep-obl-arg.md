...
2796 nodes (3%) are attached to their parents as `obl:arg`.

1707 instances of `obl:arg` (61%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.13698140200286.
