...
The form / lemma ratio of `DET` is 1.948718 (the average of all parts of speech is 1.481835).
...
`DET` occurs with 5 features: <tt><a href="it_isdt-feat-PronType.html">PronType</a></tt> (48642; 100% instances), <tt><a href="it_isdt-feat-Number.html">Number</a></tt> (47998; 99% instances), <tt><a href="it_isdt-feat-Definite.html">Definite</a></tt> (42720; 88% instances), <tt><a href="it_isdt-feat-Gender.html">Gender</a></tt> (41724; 86% instances), <tt><a href="it_isdt-feat-Poss.html">Poss</a></tt> (1829; 4% instances)
...
The most frequent feature combination is `Definite=Def|Gender=Masc|Number=Sing|PronType=Art` (12877 tokens).
