---
layout: base
title:  'Statistics of advmod:lfrom in UD_Komi_Zyrian-IKDP'
udver: '2'
---

## Treebank Statistics: UD_Komi_Zyrian-IKDP: Relations: `advmod:lfrom`
...
1 nodes (0%) are attached to their parents as `advmod:lfrom`.

1 instances of `advmod:lfrom` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.

The following 1 pairs of parts of speech are connected with `advmod:lfrom`: <tt><a href="kpv_ikdp-pos-VERB.html">VERB</a></tt>-<tt><a href="kpv_ikdp-pos-ADV.html">ADV</a></tt> (1; 100% instances).
...
# visual-style 6 4 advmod:lfrom	color:blue
