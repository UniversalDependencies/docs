...
There are 6061 `ADJ` lemmas (16%), 12296 `ADJ` types (17%) and 37161 `ADJ` tokens (4%).
...
The form / lemma ratio of `ADJ` is 2.028708 (the average of all parts of speech is 1.857072).
