...
15332 tokens (27%) have a non-empty value of `Person`.
2850 types (32%) occur at least once with a non-empty value of `Person`.
927 lemmas (28%) occur at least once with a non-empty value of `Person`.
The feature is used with 2 part-of-speech tags: [got-pos/VERB]() (9396; 17% instances), [got-pos/PRON]() (5936; 11% instances).

### `VERB`

9396 [got-pos/VERB]() tokens (73% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="Strength.html">Strength</a>=EMPTY</tt> (9396; 100%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (9396; 100%), <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (9396; 100%), <tt><a href="Case.html">Case</a>=EMPTY</tt> (9396; 100%), <tt><a href="Voice.html">Voice</a>=Act</tt> (9119; 97%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (7486; 80%), <tt><a href="Number.html">Number</a>=Sing</tt> (6381; 68%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (5338; 57%).

`VERB` tokens may have the following values of `Person`:

* `1` (1525; 16% of non-empty `Person`): <em>qiþa, im, qaþ, sijum, wiljau, bidja, gagga, was, wait, qam</em>
* `2` (1709; 18% of non-empty `Person`): <em>sijuþ, is, gagg, habaiþ, saiƕiþ, wituþ, qiþiþ, sijaiþ, wairþaiþ, galaubeiþ</em>
* `3` (6162; 66% of non-empty `Person`): <em>ist, qaþ, was, warþ, qeþun, sind, wairþiþ, sijai, nist, wesun</em>
* `EMPTY` (3528): <em>qiþands, qiþandans, wisan, andhafjands, gameliþ, taujan, qiþan, gasaiƕands, habandans, qimands</em>
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number.html">Number</a>=Plur|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>sijum, sium</em></td><td><em>sijuþ, siuþ, siud</em></td><td><em>sind</em></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Opt|<a href="Number.html">Number</a>=Sing|<a href="Tense.html">Tense</a>=Past</tt></td><td><em>wesjau</em></td><td><em>weseis, weiseis</em></td><td><em>wesi</em></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Opt|<a href="Number.html">Number</a>=Sing|<a href="Tense.html">Tense</a>=Pres</tt></td><td><em>sijau, siau</em></td><td><em>sijais, wisais, siais</em></td><td><em>sijai, siai</em></td></tr>
...
5936 [got-pos/PRON]() tokens (73% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="PronType.html">PronType</a>=Prs</tt> (5936; 100%), <tt><a href="Poss.html">Poss</a>=EMPTY</tt> (4779; 81%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (4580; 77%), <tt><a href="Number.html">Number</a>=Sing</tt> (3799; 64%).

`PRON` tokens may have the following values of `Person`:

* `1` (1557; 26% of non-empty `Person`): <em>mis, ik, mik, uns, weis, meina, unsis, meinamma, meinai, unsaris</em>
* `2` (1694; 29% of non-empty `Person`): <em>izwis, jus, þus, þuk, þu, izwara, þeina, þeinamma, izwar, þeinai</em>
* `3` (2685; 45% of non-empty `Person`): <em>imma, ina, is, im, sik, sis, ize, ins, seinamma, eis</em>
* `EMPTY` (2221): <em>saei, ƕa, þatei, ƕas, allai, allaim, alla, all, þammei, þoei</em>
...
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (1381; 87%),
<tt>VERB --[<a href="../dep/nsubj.html">nsubj</a>]--> VERB</tt> (106; 51%),
<tt>VERB --[<a href="../dep/mark.html">mark</a>]--> PRON</tt> (78; 76%),
<tt>VERB --[<a href="../dep/aux.html">aux</a>]--> PRON</tt> (43; 91%),
<tt>VERB --[<a href="../dep/nsubjpass.html">nsubjpass</a>]--> VERB</tt> (11; 61%),
<tt>VERB --[<a href="../dep/vocative.html">vocative</a>]--> PRON</tt> (5; 71%),
<tt>VERB --[<a href="../dep/remnant.html">remnant</a>]--> VERB</tt> (2; 100%),
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> PRON</tt> (2; 67%),
