...
5109 <tt><a href="el_gdt-pos-ADJ.html">ADJ</a></tt> tokens (100% of all `ADJ` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `ADJ` and `Case` co-occurred: <tt><a href="el_gdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3202; 63%), <tt><a href="el_gdt-feat-Gender.html">Gender</a></tt><tt>=Fem</tt> (2714; 53%).

`ADJ` tokens may have the following values of `Case`:

* `Acc` (2393; 47% of non-empty `Case`): <em>ευρωπαϊκή, ευρωπαϊκό, νέα, πρώτη, όλους, όλες, μεγάλη, πολλές, όλα, μεγάλο</em>
* `Dat` (6; 0% of non-empty `Case`): <em>πάση</em>
* `Gen` (1118; 22% of non-empty `Case`): <em>ευρωπαϊκής, ευρωπαϊκού, Ηνωμένων, νέας, Αγίου, νέων, οικονομικής, πολιτικών, όλων, εθνικών</em>
* `Nom` (1579; 31% of non-empty `Case`): <em>ευρωπαϊκή, σημαντικό, ευρωπαϊκό, πολλοί, όλα, νέα, όλοι, πρώτη, όλες, σαφές</em>
...
322 <tt><a href="el_gdt-pos-NUM.html">NUM</a></tt> tokens (41% of all `NUM` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `NUM` and `Case` co-occurred: <tt><a href="el_gdt-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (306; 95%), <tt><a href="el_gdt-feat-Number.html">Number</a></tt><tt>=Plur</tt> (267; 83%).

`NUM` tokens may have the following values of `Case`:

* `Acc` (178; 55% of non-empty `Case`): <em>δύο, τρεις, ένα, δέκα, μία, πέντε, τρία, έναν, έξι, μια</em>
* `Gen` (43; 13% of non-empty `Case`): <em>δύο, πέντε, τεσσάρων, τριών, επτά, χιλιάδων, έξι, δεκαπέντε, δυόμισι, είκοσι</em>
* `Nom` (101; 31% of non-empty `Case`): <em>δύο, τρεις, πέντε, ένα, ένας, μία, Δεκαεννέα, έξι, δεκάδες, μια</em>
