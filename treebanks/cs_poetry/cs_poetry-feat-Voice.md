...
843 tokens (13%) have a non-empty value of `Voice`.
650 types (24%) occur at least once with a non-empty value of `Voice`.
491 lemmas (26%) occur at least once with a non-empty value of `Voice`.
The feature is used with 3 part-of-speech tags: <tt><a href="cs_poetry-pos-VERB.html">VERB</a></tt> (637; 10% instances), <tt><a href="cs_poetry-pos-AUX.html">AUX</a></tt> (104; 2% instances), <tt><a href="cs_poetry-pos-ADJ.html">ADJ</a></tt> (102; 2% instances).

### `VERB`

637 <tt><a href="cs_poetry-pos-VERB.html">VERB</a></tt> tokens (86% of all `VERB` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `VERB` and `Voice` co-occurred: <tt><a href="cs_poetry-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (599; 94%), <tt><a href="cs_poetry-feat-Number.html">Number</a></tt><tt>=Sing</tt> (503; 79%), <tt><a href="cs_poetry-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (433; 68%), <tt><a href="cs_poetry-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (405; 64%), <tt><a href="cs_poetry-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (401; 63%), <tt><a href="cs_poetry-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (399; 63%), <tt><a href="cs_poetry-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (397; 62%).
...
102 <tt><a href="cs_poetry-pos-ADJ.html">ADJ</a></tt> tokens (17% of all `ADJ` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `ADJ` and `Voice` co-occurred: <tt><a href="cs_poetry-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (102; 100%), <tt><a href="cs_poetry-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (98; 96%), <tt><a href="cs_poetry-feat-Degree.html">Degree</a></tt><tt>=Pos</tt> (82; 80%), <tt><a href="cs_poetry-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (80; 78%), <tt><a href="cs_poetry-feat-Number.html">Number</a></tt><tt>=Sing</tt> (70; 69%).

`ADJ` tokens may have the following values of `Voice`:

* `Act` (23; 23% of non-empty `Voice`): <em>Kypící, Oněmlé, Zsinalá, bijící, budoucí, drtící, hořícího, hořícím, hynoucími, kající</em>
* `Pass` (79; 77% of non-empty `Voice`): <em>Vyloupena, otráven, rozvodněná, skrytých, umdlená, zamračený, Drážděné, Neslýchané, Očištěna, Podťata</em>
* `EMPTY` (495): <em>věčné, bílé, celý, plný, bílý, jiné, kamenném, nové, tiché, tmavou</em>

`Voice` seems to be **lexical feature** of `ADJ`. 100% lemmas (90) occur only with one value of `Voice`.
