...
The form / lemma ratio of `CCONJ` is 1.071429 (the average of all parts of speech is 1.238183).
...
`CCONJ` occurs with 2 features: <tt><a href="pt_dantestocks-feat-ExtPos.html">ExtPos</a></tt> (7; 0% instances), <tt><a href="pt_dantestocks-feat-Typo.html">Typo</a></tt> (1; 0% instances)

`CCONJ` occurs with 3 feature-value pairs: `ExtPos=CCONJ`, `ExtPos=SCONJ`, `Typo=Yes`

`CCONJ` occurs with 4 feature combinations.
The most frequent feature combination is `_` (1688 tokens).
