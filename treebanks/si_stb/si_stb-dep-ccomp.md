---
layout: base
title:  'Statistics of ccomp in UD_Sinhala-STB'
udver: '2'
---

## Treebank Statistics: UD_Sinhala-STB: Relations: `ccomp`
...
The following 1 pairs of parts of speech are connected with `ccomp`: <tt><a href="si_stb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="si_stb-pos-VERB.html">VERB</a></tt> (1; 100% instances).
