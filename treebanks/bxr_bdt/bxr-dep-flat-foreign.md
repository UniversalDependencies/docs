---
layout: base
title:  'Statistics of flat:foreign in UD_Buryat'
udver: '2'
---

## Treebank Statistics: UD_Buryat: Relations: `flat:foreign`

This relation is a language-specific subtype of <tt><a href="bxr-dep-flat.html">flat</a></tt>.

2 nodes (0%) are attached to their parents as `flat:foreign`.

2 instances of `flat:foreign` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 2 pairs of parts of speech are connected with `flat:foreign`: <tt><a href="bxr-pos-ADJ.html">ADJ</a></tt>-<tt><a href="bxr-pos-ADJ.html">ADJ</a></tt> (1; 50% instances), <tt><a href="bxr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="bxr-pos-ADJ.html">ADJ</a></tt> (1; 50% instances).
...
2	Лучший	лучший	ADJ	_	_	3	flat:foreign	_	_
3	полнометражный	полнометражный	ADJ	_	_	4	flat:foreign	_	_
4	фильм	фильм	NOUN	_	Case=Nom	7	compound	_	SpaceAfter=No
...
# visual-style 4 3 flat:foreign	color:blue
1	«	«	PUNCT	_	_	2	punct	_	SpaceAfter=No
2	Лучший	лучший	ADJ	_	_	3	flat:foreign	_	_
3	полнометражный	полнометражный	ADJ	_	_	4	flat:foreign	_	_
4	фильм	фильм	NOUN	_	Case=Nom	7	compound	_	SpaceAfter=No
