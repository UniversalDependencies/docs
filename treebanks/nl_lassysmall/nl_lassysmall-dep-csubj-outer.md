...
There are also 1 other language-specific subtypes of `csubj`: <tt><a href="nl_lassysmall-dep-csubj-pass.html">csubj:pass</a></tt>.
...
5	kon	kunnen	AUX	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	6	aux	6:aux	_
6	zien	zien	VERB	WW|inf|vrij|zonder	VerbForm=Inf	0	root	0:root	SpaceAfter=No
7	,	,	PUNCT	LET	_	8	punct	8:punct	_
8	was	zijn	AUX	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	6	cop	6:cop	_
...
17	zelf	zelf	ADV	BW	_	16	advmod	16:advmod	_
18	ging	gaan	VERB	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	6	csubj:outer	6:csubj:outer	SpaceAfter=No
...
5	dat	dat	DET	VNW|aanw|det|stan|prenom|zonder|evon	PronType=Dem	6	det	6:det	_
...
9	wisten	weten	VERB	WW|pv|verl|mv	Mood=Ind|Number=Plur|Tense=Past|VerbForm=Fin	0	root	0:root	_
10	was	zijn	AUX	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	9	cop	9:cop	_
11	dat	dat	SCONJ	VG|onder	_	22	mark	22:mark	_
12	de	de	DET	LID|bep|stan|rest	Definite=Def|PronType=Art	13	det	13:det	_
...
15	de	de	DET	LID|bep|stan|rest	Definite=Def|PronType=Art	16	det	16:det	_
...
18	het	het	DET	LID|bep|stan|evon	Definite=Def|PronType=Art	19	det	19:det	_
...
23	waren	zijn	AUX	WW|pv|verl|mv	Mood=Ind|Number=Plur|Tense=Past|VerbForm=Fin	22	cop	22:cop	SpaceAfter=No
