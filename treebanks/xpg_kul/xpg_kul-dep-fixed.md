---
layout: base
title:  'Statistics of fixed in UD_Phrygian-KUL'
udver: '2'
---

## Treebank Statistics: UD_Phrygian-KUL: Relations: `fixed`

This relation is universal.

82 nodes (5%) are attached to their parents as `fixed`.

82 instances of `fixed` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 2 pairs of parts of speech are connected with `fixed`: <tt><a href="xpg_kul-pos-PRON.html">PRON</a></tt>-<tt><a href="xpg_kul-pos-PART.html">PART</a></tt> (69; 84% instances), <tt><a href="xpg_kul-pos-DET.html">DET</a></tt>-<tt><a href="xpg_kul-pos-PART.html">PART</a></tt> (13; 16% instances).
