---
layout: base
title:  'Statistics of obj in UD_Portuguese-PetroGold'
udver: '2'
---

## Treebank Statistics: UD_Portuguese-PetroGold: Relations: `obj`

This relation is universal.

5807 nodes (2%) are attached to their parents as `obj`.

5742 instances of `obj` (99%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.10780092991217.
...
5	custo	custo	NOUN	_	Gender=Masc|Number=Sing	9	obl	_	_
6	de	de	ADP	_	_	8	case	_	_
7	o	o	DET	_	Definite=Def|Gender=Masc|Number=Sing|PronType=Art	8	det	_	_
8	catalisador	catalisador	NOUN	_	Gender=Masc|Number=Sing	5	nmod	_	_
9	torna	tornar	VERB	_	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	_
10	o	o	PRON	_	Case=Acc|Gender=Masc|Number=Sing|Person=3|PronType=Prs	9	obj	_	_
11	competitivo	competitivo	ADJ	_	Gender=Masc|Number=Sing	9	xcomp	_	SpaceAfter=No
...
3	Adaptado	adaptar	VERB	_	Gender=Masc|Number=Sing|VerbForm=Part	1	parataxis	_	_
4	Comsol	Comsol	PROPN	_	Gender=Masc|Number=Sing	3	obj	_	_
5	(	(	PUNCT	_	_	6	punct	_	SpaceAfter=No
6	2013	2013	NUM	_	NumType=Card	4	appos	_	SpaceAfter=No
