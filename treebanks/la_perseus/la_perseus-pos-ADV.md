...
There are 364 `ADV` lemmas (7%), 386 `ADV` types (4%) and 1851 `ADV` tokens (6%).
...
* <em>minus</em>
  * <tt><a href="la_perseus-pos-ADV.html">ADV</a></tt> 12: <em>Ingerebat nihilo <b>minus</b> Trimalchio lentissima voce :</em>
  * <tt><a href="la_perseus-pos-ADJ.html">ADJ</a></tt> 4: <em>si quo <b>minus</b> venio tibi cito et pugnabo cum illis in gladio oris mei .</em>

## Morphology

The form / lemma ratio of `ADV` is 1.060440 (the average of all parts of speech is 2.102438).
