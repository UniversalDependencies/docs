...
7325 tokens (15%) have a non-empty value of `PronType`.
...
The feature is used with 3 part-of-speech tags: <tt><a href="en_partut-pos-DET.html">DET</a></tt> (5315; 11% instances), <tt><a href="en_partut-pos-PRON.html">PRON</a></tt> (1992; 4% instances), <tt><a href="en_partut-pos-ADV.html">ADV</a></tt> (18; 0% instances).

### `DET`

5315 <tt><a href="en_partut-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="en_partut-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (4675; 88%), <tt><a href="en_partut-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (3781; 71%), <tt><a href="en_partut-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (2960; 56%).

`DET` tokens may have the following values of `PronType`:

* `Art` (3934; 74% of non-empty `PronType`): <em>the, a, an, another, ’s, Le, les, une</em>
...
1992 <tt><a href="en_partut-pos-PRON.html">PRON</a></tt> tokens (97% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="en_partut-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1769; 89%).
...
* `Prs` (1264; 63% of non-empty `PronType`): <em>it, I, we, he, you, they, them, him, everyone, us</em>
