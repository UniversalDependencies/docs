...
There are 4570 `PROPN` lemmas (17%), 5946 `PROPN` types (11%) and 12121 `PROPN` tokens (6%).
...
The form / lemma ratio of `PROPN` is 1.301094 (the average of all parts of speech is 2.067974).
