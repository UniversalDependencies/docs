...
2711 tokens (5%) have a non-empty value of `Degree`.
757 types (6%) occur at least once with a non-empty value of `Degree`.
630 lemmas (9%) occur at least once with a non-empty value of `Degree`.
The feature is used with 2 part-of-speech tags: <tt><a href="hy_armtdp-pos-ADJ.html">ADJ</a></tt> (2438; 5% instances), <tt><a href="hy_armtdp-pos-ADV.html">ADV</a></tt> (273; 1% instances).

### `ADJ`

2438 <tt><a href="hy_armtdp-pos-ADJ.html">ADJ</a></tt> tokens (58% of all `ADJ` tokens) have a non-empty value of `Degree`.

`ADJ` tokens may have the following values of `Degree`:

* `Pos` (2400; 98% of non-empty `Degree`): <em>կարող, նոր, մեծ, պետական, ազգային, հայ, քաղաքական, սահմանադրական, վերջին, նման</em>
...
* `EMPTY` (1756): <em>պետք, տնտեսական, արտաքին, կարելի, ընտրական, նախընտրական, 1-ին, երկրորդ, 5-րդ, ներդրումային</em>
...
`Degree` seems to be **lexical feature** of `ADJ`. 97% lemmas (592) occur only with one value of `Degree`.
...
<tt>ADJ --[<tt><a href="hy_armtdp-dep-conj.html">conj</a></tt>]--> ADJ</tt> (154; 66%),
