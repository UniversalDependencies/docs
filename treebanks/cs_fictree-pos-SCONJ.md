...
There are 37 `SCONJ` lemmas (0%), 38 `SCONJ` types (0%) and 4769 `SCONJ` tokens (3%).
...
* <em>co</em>
  * <tt><a href="cs_fictree-pos-PRON.html">PRON</a></tt> 538: <em>" Ale tohle je jediný cenný klenot , <b>co</b> mám . "</em>
  * <tt><a href="cs_fictree-pos-ADV.html">ADV</a></tt> 46: <em>Žasl jsem , <b>co</b> jsem měl v životě těch příště .</em>
  * <tt><a href="cs_fictree-pos-SCONJ.html">SCONJ</a></tt> 21: <em>Jenže od chvíle , <b>co</b> jsem to měl doma , byl jsem rozčilený .</em>
  * <tt><a href="cs_fictree-pos-PART.html">PART</a></tt> 17: <em>" Co si to dovoluješ , kdo tě učí takhle mluvit , kdo , <b>co</b> ? "</em>
* <em>jen</em>
  * <tt><a href="cs_fictree-pos-PART.html">PART</a></tt> 381: <em>V městečku byla <b>jen</b> jedna hospoda a s kůlnou jsem se taky nemohl splést .</em>
...
* <em>sotva</em>
  * <tt><a href="cs_fictree-pos-ADV.html">ADV</a></tt> 16: <em>Ivan tam stál v pyžamu a sahal tomu pořezovi <b>sotva</b> po ramena .</em>
  * <tt><a href="cs_fictree-pos-PART.html">PART</a></tt> 4: <em>Byl jsem <b>sotva</b> pár metrů od její tváře a nespouštěl z ní oči .</em>
  * <tt><a href="cs_fictree-pos-SCONJ.html">SCONJ</a></tt> 1: <em>Ale <b>sotva</b> ušel pár kroků , zavolal ho muž zpátky .</em>

## Morphology

The form / lemma ratio of `SCONJ` is 1.027027 (the average of all parts of speech is 1.966826).
