---
layout: base
title:  'Statistics of nmod in UD_North_Sami'
udver: '2'
---

## Treebank Statistics: UD_North_Sami: Relations: `nmod`
...
1	Muhto	muhto	CCONJ	CC	_	4	cc	_	_
2	lei	leat	AUX	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	4	cop	_	_
3	nu	nu	ADV	Adv	_	4	advmod	_	_
4	váttis	váttis	ADJ	A	Case=Nom|Number=Sing	0	root	_	_
5	rehkenastit	rehkenastit	VERB	V	VerbForm=Inf	4	csubj	_	_
6	tálaiguin	tálla	NOUN	N	Case=Com|Number=Plur	5	nmod	_	_
7	ja	ja	CCONJ	CC	_	6	cc	_	_
8	bustávaiguin	bustávva	NOUN	N	Case=Com|Number=Plur	5	nmod	_	SpaceAfter=No
