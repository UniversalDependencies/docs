...
The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9898; 64%), <tt><a href="en_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9897; 64%).
...
* `EMPTY` (12929): <em>have, get, know, go, do, see, take, let, make, give</em>
...
9610 <tt><a href="en_ewt-pos-AUX.html">AUX</a></tt> tokens (62% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="en_ewt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9202; 96%), <tt><a href="en_ewt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9202; 96%), <tt><a href="en_ewt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5239; 55%), <tt><a href="en_ewt-feat-Person.html">Person</a></tt><tt>=3</tt> (4872; 51%).

`AUX` tokens may have the following values of `Tense`:

* `Past` (2654; 28% of non-empty `Tense`): <em>was, were, been, did, had, got, 'd, wase</em>
* `Pres` (6956; 72% of non-empty `Tense`): <em>is, are, do, have, has, 's, am, 'm, does, 've</em>
* `EMPTY` (5803): <em>be, will, can, would, could, should, may, 'll, being, have</em>
...
<tt>VERB --[<tt><a href="en_ewt-dep-conj.html">conj</a></tt>]--> VERB</tt> (1154; 61%),
