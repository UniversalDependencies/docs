...
## Treebank Statistics: UD_Spanish-COSER: POS Tags: `PUNCT`

There are 12 `PUNCT` lemmas (1%), 12 `PUNCT` types (1%) and 1615 `PUNCT` tokens (20%).
...
`PUNCT` occurs with 2 features: <tt><a href="es_coser-feat-PunctType.html">PunctType</a></tt> (1615; 100% instances), <tt><a href="es_coser-feat-PunctSide.html">PunctSide</a></tt> (360; 22% instances)

`PUNCT` occurs with 10 feature-value pairs: `PunctSide=Fin`, `PunctSide=Ini`, `PunctType=Brck`, `PunctType=Colo`, `PunctType=Comm`, `PunctType=Excl`, `PunctType=Peri`, `PunctType=Qest`, `PunctType=Quot`, `PunctType=Semi`

`PUNCT` occurs with 13 feature combinations.
The most frequent feature combination is `PunctType=Comm` (899 tokens).
Examples: <em>,, ...</em>
