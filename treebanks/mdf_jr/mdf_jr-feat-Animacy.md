...
27 <tt><a href="mdf_jr-pos-PROPN.html">PROPN</a></tt> tokens (31% of all `PROPN` tokens) have a non-empty value of `Animacy`.
...
* `EMPTY` (59): <em>Петя, Иван, Игорь, Марья, Пашуть, Алда-баба, Алдуван, Анна, Архипонь, Браун</em>
...
* `EMPTY` (235): <em>сон, мон, сонь, тя, синь, минь, ся, мезе, тон, тейнза</em>
