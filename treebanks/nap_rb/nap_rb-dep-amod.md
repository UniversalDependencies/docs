---
layout: base
title:  'Statistics of amod in UD_Neapolitan-RB'
udver: '2'
---

## Treebank Statistics: UD_Neapolitan-RB: Relations: `amod`

This relation is universal.

5 nodes (2%) are attached to their parents as `amod`.

5 instances of `amod` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `amod`: <tt><a href="nap_rb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="nap_rb-pos-ADJ.html">ADJ</a></tt> (5; 100% instances).
