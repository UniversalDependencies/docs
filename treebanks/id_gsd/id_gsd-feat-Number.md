...
21243 <tt><a href="id_gsd-pos-NOUN.html">NOUN</a></tt> tokens (80% of all `NOUN` tokens) have a non-empty value of `Number`.
...
* `Sing` (20551; 97% of non-empty `Number`): <em>tahun, orang, desa, nama, kota, bagian, bahasa, wilayah, saat, film</em>
* `EMPTY` (5193): <em>tanggal, sepak, luas, band, atas, pusat, gelar, km, serial, sekarang</em>
