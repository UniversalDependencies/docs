...
1	ከ	ከ	ADP	ADP	Case=Abl	2	case	_	LTranslit=kä|Translit=kä
2	ሱቅ	ሱቅ	NOUN	NOUN	_	6	obl	_	LTranslit=suqə|Translit=suqə
3	ሱቅ	ሱቅ	NOUN	NOUN	_	6	obl	_	Translit=suqə|LTranslit=suqə
4	ስ	ስ	SCONJ	SCONJ	_	6	mark	_	LTranslit=sə|Translit=sə
5	ይ	እሱ	PRON	SUBJC	Gender=Masc|Number=Sing|Person=3|PronType=Prs	6	nsubj	_	LTranslit='əsu|Translit=jə
6	ዞር	ዞር	VERB	VERB	Mood=Ind|VerbForm=Fin	7	advcl	_	LTranslit=zorə|Translit=zorə
7	አስመሽ	አስመሽ	VERB	VERB	Mood=Ind|VerbForm=Fin|Voice=Cau	0	root	_	LTranslit='äsəmäšə|Translit='äsəmäšə
