...
There are 72 `ADP` lemmas (1%), 72 `ADP` types (1%) and 8255 `ADP` tokens (10%).
...
The form / lemma ratio of `ADP` is 1.000000 (the average of all parts of speech is 1.244910).
...
The most frequent feature combination is `_` (8216 tokens).
Examples: <em>of, in, to, for, with, on, at, from, by, as</em>


## Relations

`ADP` nodes are attached to their parents using 14 different relations: <tt><a href="en_lines-dep-case.html">case</a></tt> (7630; 92% instances), <tt><a href="en_lines-dep-mark.html">mark</a></tt> (336; 4% instances), <tt><a href="en_lines-dep-fixed.html">fixed</a></tt> (122; 1% instances), <tt><a href="en_lines-dep-advmod.html">advmod</a></tt> (76; 1% instances), <tt><a href="en_lines-dep-obl.html">obl</a></tt> (34; 0% instances), <tt><a href="en_lines-dep-acl.html">acl</a></tt> (24; 0% instances), <tt><a href="en_lines-dep-compound-prt.html">compound:prt</a></tt> (11; 0% instances), <tt><a href="en_lines-dep-amod.html">amod</a></tt> (6; 0% instances), <tt><a href="en_lines-dep-conj.html">conj</a></tt> (6; 0% instances), <tt><a href="en_lines-dep-nmod.html">nmod</a></tt> (5; 0% instances), <tt><a href="en_lines-dep-orphan.html">orphan</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-ccomp.html">ccomp</a></tt> (1; 0% instances), <tt><a href="en_lines-dep-flat.html">flat</a></tt> (1; 0% instances), <tt><a href="en_lines-dep-root.html">root</a></tt> (1; 0% instances)

Parents of `ADP` nodes belong to 17 different parts of speech: <tt><a href="en_lines-pos-NOUN.html">NOUN</a></tt> (6057; 73% instances), <tt><a href="en_lines-pos-PRON.html">PRON</a></tt> (740; 9% instances), <tt><a href="en_lines-pos-PROPN.html">PROPN</a></tt> (579; 7% instances), <tt><a href="en_lines-pos-VERB.html">VERB</a></tt> (430; 5% instances), <tt><a href="en_lines-pos-ADJ.html">ADJ</a></tt> (142; 2% instances), <tt><a href="en_lines-pos-ADP.html">ADP</a></tt> (93; 1% instances), <tt><a href="en_lines-pos-NUM.html">NUM</a></tt> (92; 1% instances), <tt><a href="en_lines-pos-ADV.html">ADV</a></tt> (77; 1% instances), <tt><a href="en_lines-pos-AUX.html">AUX</a></tt> (20; 0% instances), <tt><a href="en_lines-pos-CCONJ.html">CCONJ</a></tt> (11; 0% instances), <tt><a href="en_lines-pos-DET.html">DET</a></tt> (5; 0% instances), <tt><a href="en_lines-pos-PART.html">PART</a></tt> (2; 0% instances), <tt><a href="en_lines-pos-SYM.html">SYM</a></tt> (2; 0% instances), <tt><a href="en_lines-pos-X.html">X</a></tt> (2; 0% instances), <tt><a href="en_lines-pos-INTJ.html">INTJ</a></tt> (1; 0% instances), <tt><a href="en_lines-pos-PUNCT.html">PUNCT</a></tt> (1; 0% instances),  (1; 0% instances)

7895 (96%) `ADP` nodes are leaves.

313 (4%) `ADP` nodes have one child.

42 (1%) `ADP` nodes have two children.

5 (0%) `ADP` nodes have three or more children.

The highest child degree of a `ADP` node is 6.

Children of `ADP` nodes are attached using 22 different relations: <tt><a href="en_lines-dep-punct.html">punct</a></tt> (168; 40% instances), <tt><a href="en_lines-dep-fixed.html">fixed</a></tt> (98; 24% instances), <tt><a href="en_lines-dep-nmod.html">nmod</a></tt> (35; 8% instances), <tt><a href="en_lines-dep-advmod.html">advmod</a></tt> (31; 7% instances), <tt><a href="en_lines-dep-case.html">case</a></tt> (12; 3% instances), <tt><a href="en_lines-dep-conj.html">conj</a></tt> (12; 3% instances), <tt><a href="en_lines-dep-advcl.html">advcl</a></tt> (10; 2% instances), <tt><a href="en_lines-dep-nsubj.html">nsubj</a></tt> (10; 2% instances), <tt><a href="en_lines-dep-appos.html">appos</a></tt> (9; 2% instances), <tt><a href="en_lines-dep-cc.html">cc</a></tt> (5; 1% instances), <tt><a href="en_lines-dep-det.html">det</a></tt> (4; 1% instances), <tt><a href="en_lines-dep-obj.html">obj</a></tt> (4; 1% instances), <tt><a href="en_lines-dep-acl.html">acl</a></tt> (3; 1% instances), <tt><a href="en_lines-dep-amod.html">amod</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-aux.html">aux</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-compound.html">compound</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-cop.html">cop</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-mark.html">mark</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-nummod.html">nummod</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-parataxis.html">parataxis</a></tt> (2; 0% instances), <tt><a href="en_lines-dep-discourse.html">discourse</a></tt> (1; 0% instances), <tt><a href="en_lines-dep-vocative.html">vocative</a></tt> (1; 0% instances)

Children of `ADP` nodes belong to 15 different parts of speech: <tt><a href="en_lines-pos-PUNCT.html">PUNCT</a></tt> (168; 40% instances), <tt><a href="en_lines-pos-ADP.html">ADP</a></tt> (93; 22% instances), <tt><a href="en_lines-pos-NOUN.html">NOUN</a></tt> (60; 14% instances), <tt><a href="en_lines-pos-ADV.html">ADV</a></tt> (34; 8% instances), <tt><a href="en_lines-pos-VERB.html">VERB</a></tt> (18; 4% instances), <tt><a href="en_lines-pos-ADJ.html">ADJ</a></tt> (8; 2% instances), <tt><a href="en_lines-pos-PRON.html">PRON</a></tt> (8; 2% instances), <tt><a href="en_lines-pos-CCONJ.html">CCONJ</a></tt> (6; 1% instances), <tt><a href="en_lines-pos-PROPN.html">PROPN</a></tt> (6; 1% instances), <tt><a href="en_lines-pos-AUX.html">AUX</a></tt> (4; 1% instances), <tt><a href="en_lines-pos-DET.html">DET</a></tt> (4; 1% instances), <tt><a href="en_lines-pos-INTJ.html">INTJ</a></tt> (2; 0% instances), <tt><a href="en_lines-pos-NUM.html">NUM</a></tt> (2; 0% instances), <tt><a href="en_lines-pos-PART.html">PART</a></tt> (2; 0% instances), <tt><a href="en_lines-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances)
