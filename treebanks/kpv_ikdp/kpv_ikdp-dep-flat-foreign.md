---
layout: base
title:  'Statistics of flat:foreign in UD_Komi_Zyrian-IKDP'
udver: '2'
---

## Treebank Statistics: UD_Komi_Zyrian-IKDP: Relations: `flat:foreign`

This relation is a language-specific subtype of .
There are also 1 other language-specific subtypes of `flat`: <tt><a href="kpv_ikdp-dep-flat-name.html">flat:name</a></tt>.

4 nodes (0%) are attached to their parents as `flat:foreign`.

4 instances of `flat:foreign` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.75.

The following 3 pairs of parts of speech are connected with `flat:foreign`: <tt><a href="kpv_ikdp-pos-ADJ.html">ADJ</a></tt>-<tt><a href="kpv_ikdp-pos-NOUN.html">NOUN</a></tt> (2; 50% instances), <tt><a href="kpv_ikdp-pos-ADJ.html">ADJ</a></tt>-<tt><a href="kpv_ikdp-pos-ADJ.html">ADJ</a></tt> (1; 25% instances), <tt><a href="kpv_ikdp-pos-X.html">X</a></tt>-<tt><a href="kpv_ikdp-pos-X.html">X</a></tt> (1; 25% instances).
...
# visual-style 17 20 flat:foreign	color:blue
...
# visual-style 17	bgColor:blue
# visual-style 17	fgColor:white
# visual-style 17 18 flat:foreign	color:blue
1	Но	но	CCONJ	CC	_	6	cc	_	_
2	вот	вот	ADV	Adv	_	6	discourse	_	GTtags=Parenthetic
3	сыа	сійӧ	PRON	Pron	PronType=Dem	6	nsubj	_	GTtags=Err/Dial,Dem
4	сэтысь	сэтысь	ADV	Adv	Case=Ela	6	advmod:lfrom	_	GTtags=Ela
