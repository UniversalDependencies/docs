...
Average distance between parent and child is 2.04235294117647.

The following 1 pairs of parts of speech are connected with `aux:pass`: <tt><a href="zh_gsd-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> (425; 100% instances).
