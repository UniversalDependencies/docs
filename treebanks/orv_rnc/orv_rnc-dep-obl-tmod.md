...
There are also 1 other language-specific subtypes of `obl`: <tt><a href="orv_rnc-dep-obl-agent.html">obl:agent</a></tt>.

5 nodes (0%) are attached to their parents as `obl:tmod`.

5 instances of `obl:tmod` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 3.2.

The following 1 pairs of parts of speech are connected with `obl:tmod`: <tt><a href="orv_rnc-pos-VERB.html">VERB</a></tt>-<tt><a href="orv_rnc-pos-NOUN.html">NOUN</a></tt> (5; 100% instances).
