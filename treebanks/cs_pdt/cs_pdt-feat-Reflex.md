---
layout: base
title:  'Statistics of Reflex in UD_Czech-PDT'
udver: '2'
---

## Treebank Statistics: UD_Czech-PDT: Features: `Reflex`
...
The feature is used with 2 part-of-speech tags: <tt><a href="cs_pdt-pos-PRON.html">PRON</a></tt> (25786; 2% instances), <tt><a href="cs_pdt-pos-DET.html">DET</a></tt> (4883; 0% instances).
...
* `EMPTY` (19134): <em>co, nás, je, nám, nich, kdo, což, mu, ji, ho</em>

### `DET`

4883 <tt><a href="cs_pdt-pos-DET.html">DET</a></tt> tokens (9% of all `DET` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `DET` and `Reflex` co-occurred: <tt><a href="cs_pdt-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (4883; 100%), <tt><a href="cs_pdt-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (4883; 100%), <tt><a href="cs_pdt-feat-Poss.html">Poss</a></tt><tt>=Yes</tt> (4883; 100%), <tt><a href="cs_pdt-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (4883; 100%), <tt><a href="cs_pdt-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (4304; 88%), <tt><a href="cs_pdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3423; 70%).

`DET` tokens may have the following values of `Reflex`:

* `Yes` (4883; 100% of non-empty `Reflex`): <em>své, svou, svého, svých, svůj, svým, svém, svými, svoji, svému</em>
* `EMPTY` (51587): <em>to, které, který, jeho, která, jejich, tím, kteří, tom, této</em>

## Relations with Agreement in `Reflex`

The 10 most frequent relations where parent and child node agree in `Reflex`:
<tt>DET --[<tt><a href="cs_pdt-dep-conj.html">conj</a></tt>]--> DET</tt> (3; 75%),
<tt>PRON --[<tt><a href="cs_pdt-dep-conj.html">conj</a></tt>]--> PRON</tt> (3; 60%).
