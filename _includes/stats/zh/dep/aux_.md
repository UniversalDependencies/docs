...
There are 2 language-specific subtypes of `aux`: [aux:caus](), [aux:pass]().

789 nodes (1%) are attached to their parents as `aux`.

789 instances of `aux` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.60076045627376.

The following 5 pairs of parts of speech are connected with `aux`: [zh-pos/VERB]()-[zh-pos/AUX]() (748; 95% instances), [zh-pos/ADJ]()-[zh-pos/AUX]() (25; 3% instances), [zh-pos/NOUN]()-[zh-pos/AUX]() (10; 1% instances), [zh-pos/PART]()-[zh-pos/AUX]() (4; 1% instances), [zh-pos/ADP]()-[zh-pos/AUX]() (2; 0% instances).
