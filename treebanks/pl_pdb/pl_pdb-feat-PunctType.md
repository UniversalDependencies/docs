...
The feature is used with 1 part-of-speech tags: <tt><a href="pl_pdb-pos-PUNCT.html">PUNCT</a></tt> (57891; 17% instances).

### `PUNCT`

57891 <tt><a href="pl_pdb-pos-PUNCT.html">PUNCT</a></tt> tokens (100% of all `PUNCT` tokens) have a non-empty value of `PunctType`.
...
* `Slsh` (27; 0% of non-empty `PunctType`): <em>/</em>
