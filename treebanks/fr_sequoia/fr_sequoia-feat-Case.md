...
## Treebank Statistics: UD_French-Sequoia: Features: `Case`
...
1271 <tt><a href="fr_sequoia-pos-PRON.html">PRON</a></tt> tokens (46% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="fr_sequoia-feat-Emph.html">Emph</a></tt><tt>=No</tt> (1271; 100%), <tt><a href="fr_sequoia-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (1253; 99%), <tt><a href="fr_sequoia-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1232; 97%), <tt><a href="fr_sequoia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (839; 66%), <tt><a href="fr_sequoia-feat-Person.html">Person</a></tt><tt>=3</tt> (709; 56%), <tt><a href="fr_sequoia-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (671; 53%).
