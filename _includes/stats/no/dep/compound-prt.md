...
2541 nodes (1%) are attached to their parents as `compound:prt`.

2445 instances of `compound:prt` (96%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.61707988980716.

The following 1 pairs of parts of speech are connected with `compound:prt`: [no-pos/VERB]()-[no-pos/ADP]() (2541; 100% instances).
