---
layout: base
title:  'Statistics of punct in UD_Kadiweu-Unicamp'
udver: '2'
---

## Treebank Statistics: UD_Kadiweu-Unicamp: Relations: `punct`

This relation is universal.

71 nodes (22%) are attached to their parents as `punct`.

71 instances of `punct` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.73239436619718.

The following 3 pairs of parts of speech are connected with `punct`: <tt><a href="kbc_unicamp-pos-VERB.html">VERB</a></tt>-<tt><a href="kbc_unicamp-pos-PUNCT.html">PUNCT</a></tt> (45; 63% instances), <tt><a href="kbc_unicamp-pos-NOUN.html">NOUN</a></tt>-<tt><a href="kbc_unicamp-pos-PUNCT.html">PUNCT</a></tt> (23; 32% instances), <tt><a href="kbc_unicamp-pos-ADJ.html">ADJ</a></tt>-<tt><a href="kbc_unicamp-pos-PUNCT.html">PUNCT</a></tt> (3; 4% instances).
