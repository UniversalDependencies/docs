...
There are 5 `DET` lemmas (1%), 6 `DET` types (1%) and 64 `DET` tokens (5%).
Out of 14 observed tags, the rank of `DET` is: 9 in number of lemmas, 8 in number of types and 7 in number of tokens.
...
The form / lemma ratio of `DET` is 1.200000 (the average of all parts of speech is 1.506266).
...
`DET` occurs with 2 features: <tt><a href="sah_yktdt-feat-PronType.html">PronType</a></tt> (28; 44% instances), <tt><a href="sah_yktdt-feat-Case.html">Case</a></tt> (1; 2% instances)
...
Examples: <em>бу, Ити, аайы, ханнык</em>


## Relations

`DET` nodes are attached to their parents using 2 different relations: <tt><a href="sah_yktdt-dep-det.html">det</a></tt> (63; 98% instances), <tt><a href="sah_yktdt-dep-obj.html">obj</a></tt> (1; 2% instances)

Parents of `DET` nodes belong to 2 different parts of speech: <tt><a href="sah_yktdt-pos-NOUN.html">NOUN</a></tt> (63; 98% instances), <tt><a href="sah_yktdt-pos-VERB.html">VERB</a></tt> (1; 2% instances)
