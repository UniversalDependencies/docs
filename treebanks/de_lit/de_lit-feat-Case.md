...
7607 tokens (19%) have a non-empty value of `Case`.
...
The feature is used with 7 part-of-speech tags: <tt><a href="de_lit-pos-NOUN.html">NOUN</a></tt> (4406; 11% instances), <tt><a href="de_lit-pos-PRON.html">PRON</a></tt> (2349; 6% instances), <tt><a href="de_lit-pos-DET.html">DET</a></tt> (533; 1% instances), <tt><a href="de_lit-pos-PROPN.html">PROPN</a></tt> (158; 0% instances), <tt><a href="de_lit-pos-ADJ.html">ADJ</a></tt> (152; 0% instances), <tt><a href="de_lit-pos-NUM.html">NUM</a></tt> (7; 0% instances), <tt><a href="de_lit-pos-ADP.html">ADP</a></tt> (2; 0% instances).

### `NOUN`

4406 <tt><a href="de_lit-pos-NOUN.html">NOUN</a></tt> tokens (60% of all `NOUN` tokens) have a non-empty value of `Case`.

`NOUN` tokens may have the following values of `Case`:

* `Acc` (1274; 29% of non-empty `Case`): <em>Sinn, Geist, Philosophie, Menschen, Witz, Poesie, Kraft, Welt, Leben, Kunst</em>
* `Dat` (869; 20% of non-empty `Case`): <em>Sinn, Geist, Philosophie, Art, Mangel, Menschen, Natur, Zeit, Form, Gedanken</em>
* `Gen` (324; 7% of non-empty `Case`): <em>Geistes, Dichters, Menschen, Altertums, Ganzen, Genies, Zeitalters, Individuums, Lebens, Witzes</em>
* `Nom` (1939; 44% of non-empty `Case`): <em>Mensch, Philosophie, Geist, Poesie, Witz, Natur, Menschen, Kunst, Künstler, Sinn</em>
* `EMPTY` (2969): <em>philosophie, poesie, Kunst, Art, Welt, Natur, Wissenschaft, Geist, Sinn, Bildung</em>
...
2349 <tt><a href="de_lit-pos-PRON.html">PRON</a></tt> tokens (86% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="de_lit-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (2044; 87%), <tt><a href="de_lit-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1605; 68%), <tt><a href="de_lit-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1380; 59%), <tt><a href="de_lit-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1206; 51%), <tt><a href="de_lit-feat-Person.html">Person</a></tt><tt>=3</tt> (1183; 50%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (611; 26% of non-empty `Case`): <em>sich, es, was, ihn, sie, nichts, die, mich, den, uns</em>
...
533 <tt><a href="de_lit-pos-DET.html">DET</a></tt> tokens (9% of all `DET` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `DET` and `Case` co-occurred: <tt><a href="de_lit-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (480; 90%), <tt><a href="de_lit-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (386; 72%).

`DET` tokens may have the following values of `Case`:

* `Acc` (122; 23% of non-empty `Case`): <em>alles, die, welche, dies, diese, andre, einen, alle, beides, den</em>
* `Dat` (131; 25% of non-empty `Case`): <em>dem, der, ihr, den, einem, allem, allen, beiden, dieser, jenem</em>
* `Gen` (14; 3% of non-empty `Case`): <em>der, des, ihres, mancher, meisten</em>
* `Nom` (266; 50% of non-empty `Case`): <em>welche, alles, welches, die, diese, dies, jeder, andre, einer, welcher</em>
* `EMPTY` (5348): <em>der, die, ein, das, den, eine, des, dem, einen, einer</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_lit-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_lit-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>das</em></td><td><em>das</em></td><td><em>dem</em></td><td><em>des</em></td></tr>
...
* `EMPTY` (3325): <em>große, alten, erste, ganze, großen, möglich, neue, eignen, ersten, gleichsam</em>
