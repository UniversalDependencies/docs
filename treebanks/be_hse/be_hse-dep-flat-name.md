...
2	вашай	ваш	DET	PRP$	Case=Dat|Gender=Fem|Number=Sing|Poss=Yes|PronType=Prs	3	det	_	_
3	увазе	увага	NOUN	NN	Animacy=Inan|Case=Dat|Gender=Fem|Number=Sing	5	iobj	_	_
4	мы	мы	PRON	PRP	Case=Nom|Number=Plur|Person=1|PronType=Prs	5	nsubj	_	_
5	прапануем	прапановаць	VERB	VBC	Aspect=Imp|Mood=Ind|Number=Plur|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
6	інтэрв'ю	інтэрв'ю	NOUN	NN	Animacy=Inan|Case=Acc|Gender=Neut|Number=Sing	5	obj	_	_
7	чэшскай	чэшскi	ADJ	JJL	Case=Gen|Degree=Pos|Gender=Fem|Number=Sing	8	amod	_	_
8	перакладчыцы	перакладчыца	NOUN	NN	Animacy=Anim|Case=Gen|Gender=Fem|Number=Sing	6	nmod	_	SpaceAfter=No
9	,	,	PUNCT	PUNCT	_	10	punct	_	_
10	арнітолага	арнітолаг	NOUN	NN	Animacy=Anim|Case=Gen|Gender=Masc|Number=Sing	8	conj	_	_
11	Святланы	Святлана	PROPN	NNP	Animacy=Anim|Case=Gen|Gender=Fem|Number=Sing	8	appos	_	_
12	Уранавай	Уранава	PROPN	NNP	Animacy=Anim|Case=Gen|Gender=Fem|Number=Sing	11	flat:name	_	_
13	(	(	PUNCT	PUNCT	_	14	punct	_	SpaceAfter=No
14	Světlana	světlana	X	X	Foreign=Yes	11	appos	_	_
15	Vránová	vránová	X	X	Foreign=Yes	14	flat:name	_	SpaceAfter=No
16	)	)	PUNCT	PUNCT	_	14	punct	_	SpaceAfter=No
