---
layout: base
title:  'Statistics of Tense in UD_Warlpiri-UFAL'
udver: '2'
---

## Treebank Statistics: UD_Warlpiri-UFAL: Features: `Tense`
...
55 <tt><a href="wbp_ufal-pos-VERB.html">VERB</a></tt> tokens (80% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="wbp_ufal-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (45; 82%), <tt><a href="wbp_ufal-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (45; 82%).

`VERB` tokens may have the following values of `Tense`:

* `Past` (8; 15% of non-empty `Tense`): <em>nyangu, panturnu, Yungurnarla</em>
* `Pres` (47; 85% of non-empty `Tense`): <em>wajilipinyi, nyanyi, jarntirni, parnkami, purlami, yinyi, marrijarrimi, milkiyirrarni, ngunami, pantirni</em>
* `EMPTY` (14): <em>ngunanjakurra, ngunanjakurraku, purlanyjarlarni, wajilipinyjarlarni, yinyjarlarni, ngarninjakurra, pantirninjakurra, wantinjakurra</em>

<table>
  <tr><th>Paradigm <i>nya</i></th><th><tt>Pres</tt></th><th><tt>Past</tt></th></tr>
  <tr><td><tt></tt></td><td><em>nyanyi</em></td><td><em>nyangu</em></td></tr>
</table>

`Tense` seems to be **lexical feature** of `VERB`. 96% lemmas (22) occur only with one value of `Tense`.
...
<table>
  ...
  <tr><td><tt><tt><a href="wbp_ufal-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="wbp_ufal-feat-Person.html">Person</a></tt><tt>=1</tt></tt></td><td><em>karna</em></td><td><em>kapirna</em></td></tr>
  <tr><td><tt><tt><a href="wbp_ufal-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="wbp_ufal-feat-Person.html">Person</a></tt><tt>=1</tt>|<tt><a href="wbp_ufal-feat-Person-dat.html">Person[dat]</a></tt><tt>=3</tt></tt></td><td></td><td><em>kapirnarla</em></td></tr>
  <tr><td><tt><tt><a href="wbp_ufal-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="wbp_ufal-feat-Person.html">Person</a></tt><tt>=2</tt></tt></td><td><em>kanpa</em></td><td></td></tr>
  <tr><td><tt><tt><a href="wbp_ufal-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="wbp_ufal-feat-Number-obj.html">Number[obj]</a></tt><tt>=Plur</tt>|<tt><a href="wbp_ufal-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="wbp_ufal-feat-Person-obj.html">Person[obj]</a></tt><tt>=3</tt></tt></td><td><em>kalujana</em></td><td></td></tr>
