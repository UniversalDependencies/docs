...
There are 25 `SCONJ` lemmas (0%), 25 `SCONJ` types (0%) and 8179 `SCONJ` tokens (2%).
...
The form / lemma ratio of `SCONJ` is 1.000000 (the average of all parts of speech is 1.291521).
