---
layout: base
title:  'Statistics of root in UD_Classical_Armenian-CAVaL'
udver: '2'
---

## Treebank Statistics: UD_Classical_Armenian-CAVaL: Relations: `root`

This relation is universal.

4781 nodes (5%) are attached to their parents as `root`.

4781 instances of `root` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 5.06734992679356.

The following 11 pairs of parts of speech are connected with `root`: -<tt><a href="xcl_caval-pos-VERB.html">VERB</a></tt> (3995; 84% instances), -<tt><a href="xcl_caval-pos-NOUN.html">NOUN</a></tt> (254; 5% instances), -<tt><a href="xcl_caval-pos-ADJ.html">ADJ</a></tt> (176; 4% instances), -<tt><a href="xcl_caval-pos-PROPN.html">PROPN</a></tt> (100; 2% instances), -<tt><a href="xcl_caval-pos-PRON.html">PRON</a></tt> (89; 2% instances), -<tt><a href="xcl_caval-pos-ADV.html">ADV</a></tt> (72; 2% instances), -<tt><a href="xcl_caval-pos-AUX.html">AUX</a></tt> (48; 1% instances), -<tt><a href="xcl_caval-pos-INTJ.html">INTJ</a></tt> (26; 1% instances), -<tt><a href="xcl_caval-pos-ADP.html">ADP</a></tt> (12; 0% instances), -<tt><a href="xcl_caval-pos-NUM.html">NUM</a></tt> (6; 0% instances), -<tt><a href="xcl_caval-pos-DET.html">DET</a></tt> (3; 0% instances).
...
3	ձայն	ձայն	NOUN	_	Case=Nom|Number=Sing	0	root	_	Translit=jayn|LTranslit=jayn|Gloss=sound
4	յ	ի	ADP	_	_	5	case	_	SpaceAfter=No|Translit=y|LTranslit=i|LId=ի-3|Gloss=from
5	երկնից	երկին	NOUN	_	Case=Abl|Number=Plur	3	obl	_	Translit=erknicʻ|LTranslit=erkin|Gloss=heaven
6	որ	որ	PRON	_	Case=Nom|Number=Sing|PronType=Rel	7	nsubj	_	Translit=or|LTranslit=or|Gloss=who
7	ասէր	ասել	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	3	acl	_	SpaceAfter=No|Translit=asēr|LTranslit=asel|Gloss=say
8	,	,	PUNCT	_	_	11	punct	_	Translit=,|LTranslit=,
9	դա	դա	PRON	_	Case=Nom|Deixis=Med|Number=Sing|PronType=Dem	11	nsubj	_	Translit=da|LTranslit=da|Gloss=that_one
10	է	եմ	AUX	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	11	cop	_	Translit=ē|LTranslit=em|Gloss=be
11	որդի	որդի	NOUN	_	Case=Nom|Number=Sing	7	ccomp	_	Translit=ordi|LTranslit=ordi|Gloss=son
12	իմ	ես	PRON	_	Case=Gen|Number=Sing|Person=1|PronType=Prs	11	nmod	_	Translit=im|LTranslit=es|Gloss=I
13	սիրելի	սիրելի	ADJ	_	Case=Nom|Number=Sing	11	amod	_	SpaceAfter=No|Translit=sireli|LTranslit=sireli|Gloss=beloved
14	.	.	PUNCT	_	_	17	punct	_	Translit=:|LTranslit=:
15	ընդ	ընդ	ADP	_	_	16	case	_	Translit=ənd|LTranslit=ənd|Gloss=with/during/for
16	որ	որ	PRON	_	Case=Acc|Number=Sing|PronType=Rel	17	obl	_	Translit=or|LTranslit=or|Gloss=who
17	հաճեցա	հաճել	VERB	_	Aspect=Perf|Mood=Ind|Number=Sing|Person=1|Tense=Past|VerbForm=Fin	11	acl	_	SpaceAfter=No|Translit=hačecʻa|LTranslit=hačel|Gloss=please
