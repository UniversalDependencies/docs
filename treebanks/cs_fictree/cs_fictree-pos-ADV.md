...
There are 1088 `ADV` lemmas (8%), 1184 `ADV` types (4%) and 10831 `ADV` tokens (6%).
...
The form / lemma ratio of `ADV` is 1.088235 (the average of all parts of speech is 1.968575).
