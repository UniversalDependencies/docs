...
56 nodes (0%) are attached to their parents as `aux`.

33 instances of `aux` (59%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.19642857142857.

The following 3 pairs of parts of speech are connected with `aux`: <tt><a href="ru_gsd-pos-VERB.html">VERB</a></tt>-<tt><a href="ru_gsd-pos-AUX.html">AUX</a></tt> (40; 71% instances), <tt><a href="ru_gsd-pos-ADJ.html">ADJ</a></tt>-<tt><a href="ru_gsd-pos-AUX.html">AUX</a></tt> (15; 27% instances), <tt><a href="ru_gsd-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ru_gsd-pos-AUX.html">AUX</a></tt> (1; 2% instances).
...
2	эту	этот	DET	DT	Case=Acc|Gender=Fem|Number=Sing	3	det	_	_
...
6	посмертно	посмертно	ADV	RB	Degree=Pos	7	advmod	_	_
...
9	Оскаром	Оскар	PROPN	NNP	Animacy=Anim|Case=Ins|Gender=Masc|Number=Sing	7	iobj	_	SpaceAfter=No
...
13	получила	получить	VERB	VBC	Aspect=Perf|Gender=Fem|Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin|Voice=Act	9	acl:relcl	_	_
14	его	его	DET	PRP$	_	15	det	_	_
...
2	должна	должен	ADJ	JJH	Case=Nom|Degree=Pos|Gender=Fem|Number=Sing|Variant=Short	0	root	_	_
3	была	быть	AUX	VBC	Aspect=Imp|Gender=Fem|Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	2	aux	_	_
4	спать	спать	VERB	VB	Aspect=Imp|VerbForm=Inf|Voice=Act	2	xcomp	_	_
5	в	в	ADP	IN	_	6	case	_	_
6	крио-камере	крио-камера	NOUN	NN	Animacy=Inan|Case=Loc|Gender=Fem|Number=Sing	4	obl	_	_
7	до	до	ADP	IN	_	9	case	_	_
8	тех	тот	DET	DT	Case=Gen|Number=Plur	9	det	_	_
9	пор	пора	NOUN	NN	Animacy=Inan|Case=Gen|Gender=Fem|Number=Plur	4	obl	_	SpaceAfter=No
...
2	данного	данный	ADJ	JJL	Case=Gen|Degree=Pos|Gender=Neut|Number=Sing	3	amod	_	_
...
7	последнюю	последний	ADJ	JJL	Case=Acc|Degree=Pos|Gender=Fem|Number=Sing	8	amod	_	_
...
13	его	его	DET	PRP$	_	15	det	_	_
14	бывшая	бывший	ADJ	JJL	Case=Nom|Degree=Pos|Gender=Fem|Number=Sing	15	amod	_	_
...
22	плохо	плохо	ADV	RB	Degree=Pos	23	advmod	_	_
23	говорила	говорить	VERB	VBC	Aspect=Imp|Gender=Fem|Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin|Voice=Act	18	conj	_	_
24	по-английски	по-английски	ADV	RB	Degree=Pos	23	advmod	_	SpaceAfter=No
