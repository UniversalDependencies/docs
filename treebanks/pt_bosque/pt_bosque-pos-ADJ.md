...
There are 2652 `ADJ` lemmas (13%), 3871 `ADJ` types (13%) and 11338 `ADJ` tokens (5%).
...
The 10 most frequent `ADJ` types:  <em>maior, primeiro, grande, primeira, novo, nova, mesmo, grandes, nacional, melhor</em>
...
The form / lemma ratio of `ADJ` is 1.459653 (the average of all parts of speech is 1.414899).
