...
* `EMPTY` (286): <em>âʹtte, âʹpet, kâʹl, de, mäʹhtt, tok, pâi, teâđast, še, tõʹst</em>
...
The most frequent other feature values with which `DET` and `Case` co-occurred: <tt><a href="sms_giellagas-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6; 86%), <tt><a href="sms_giellagas-feat-PronType.html">PronType</a></tt><tt>=Dem</tt> (4; 57%).

`DET` tokens may have the following values of `Case`:

* `Acc` (2; 29% of non-empty `Case`): <em>jiijjâs, määŋg</em>
* `Gen` (2; 29% of non-empty `Case`): <em>tõn</em>
* `Nom` (3; 43% of non-empty `Case`): <em>Tät, Tõt, tok</em>
...
<tt>NOUN --[<tt><a href="sms_giellagas-dep-det.html">det</a></tt>]--> PRON</tt> (34; 68%),
...
<tt>NOUN --[<tt><a href="sms_giellagas-dep-det.html">det</a></tt>]--> DET</tt> (5; 83%),
