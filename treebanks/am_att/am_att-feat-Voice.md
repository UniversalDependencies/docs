---
layout: base
title:  'Statistics of Voice in UD_Amharic-ATT'
udver: '2'
---

## Treebank Statistics: UD_Amharic-ATT: Features: `Voice`

This feature is universal but the values `Trans` are language-specific.
It occurs with 4 different values: `Cau`, `Pass`, `Rcp`, `Trans`.

252 tokens (3%) have a non-empty value of `Voice`.
178 types (12%) occur at least once with a non-empty value of `Voice`.
178 lemmas (12%) occur at least once with a non-empty value of `Voice`.
The feature is used with 1 part-of-speech tags: <tt><a href="am_att-pos-VERB.html">VERB</a></tt> (252; 3% instances).
