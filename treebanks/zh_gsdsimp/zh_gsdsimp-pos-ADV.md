...
There are 468 `ADV` lemmas (2%), 468 `ADV` types (2%) and 3082 `ADV` tokens (2%).
...
* 将
  ...
  * <tt><a href="zh_gsdsimp-pos-ADV.html">ADV</a></tt> 51: 在 平原 、 塔 、 洞窟 、 海 或 迷宫 中 移动 时 ， 玩家 <b>将</b> 会 和 随机 遇到 的 敌人 作战 。
...
The form / lemma ratio of `ADV` is 1.000000 (the average of all parts of speech is 1.004572).
