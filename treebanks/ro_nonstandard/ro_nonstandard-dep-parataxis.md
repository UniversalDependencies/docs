...
1	Eu	eu	PRON	Pp1-sr	Case=Nom|Number=Sing|Person=1|PronType=Prs	3	nsubj	_	_
2	sunt	fi	AUX	Vaip1s	Mood=Ind|Number=Sing|Person=1|Tense=Pres	3	cop	_	_
3	floare	floare	NOUN	Ncfsrn	Case=Acc,Nom|Definite=Ind|Gender=Fem|Number=Sing	0	root	_	_
4	din	din	ADP	Spca	AdpType=Prep|Case=Acc|Compound=Yes	5	case	_	_
5	grădină	grădină	NOUN	Ncfsrn	Case=Acc,Nom|Definite=Ind|Gender=Fem|Number=Sing	3	nmod	_	Rhyme=ID9|SpaceAfter=No|Type=Paired
6	,	,	PUNCT	COMMA	_	9	punct	_	_
7	Cine	cine	PRON	Pw3--r	Case=Acc,Nom|Person=3|PronType=Int,Rel	8	nsubj	_	_
8	miroase	mirosi	VERB	Vmip3s	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	9	csubj	_	_
9	suspină	suspina	VERB	Vmis3s	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	3	parataxis	_	Rhyme=ID5|SpaceAfter=No|Type=Paired
