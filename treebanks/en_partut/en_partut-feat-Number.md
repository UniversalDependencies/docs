...
15829 tokens (32%) have a non-empty value of `Number`.
3751 types (55%) occur at least once with a non-empty value of `Number`.
2744 lemmas (49%) occur at least once with a non-empty value of `Number`.
The feature is used with 5 part-of-speech tags: <tt><a href="en_partut-pos-NOUN.html">NOUN</a></tt> (10498; 21% instances), <tt><a href="en_partut-pos-DET.html">DET</a></tt> (1534; 3% instances), <tt><a href="en_partut-pos-PRON.html">PRON</a></tt> (1314; 3% instances), <tt><a href="en_partut-pos-AUX.html">AUX</a></tt> (1245; 3% instances), <tt><a href="en_partut-pos-VERB.html">VERB</a></tt> (1238; 2% instances).

### `NOUN`

10498 <tt><a href="en_partut-pos-NOUN.html">NOUN</a></tt> tokens (99% of all `NOUN` tokens) have a non-empty value of `Number`.
...
* `Sing` (7598; 72% of non-empty `Number`): <em>work, Commission, time, Parliament, President, member, Mr, license, growth, Directive</em>
* `EMPTY` (66): <em>No, South, design, gas, greenhouse, manufacturing, European, Measure, information, living</em>
...
1534 <tt><a href="en_partut-pos-DET.html">DET</a></tt> tokens (29% of all `DET` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="en_partut-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (1394; 91%), <tt><a href="en_partut-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (967; 63%), <tt><a href="en_partut-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (963; 63%).

`DET` tokens may have the following values of `Number`:

* `Plur` (103; 7% of non-empty `Number`): <em>these, those, Many, les</em>
* `Sing` (1431; 93% of non-empty `Number`): <em>a, this, an, its, my, that, another, each, every, one</em>
* `EMPTY` (3781): <em>the, his, their, any, our, no, all, such, your, some</em>
...
1314 <tt><a href="en_partut-pos-PRON.html">PRON</a></tt> tokens (64% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="en_partut-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1116; 85%), <tt><a href="en_partut-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1091; 83%), <tt><a href="en_partut-feat-Person.html">Person</a></tt><tt>=3</tt> (701; 53%).
...
* `EMPTY` (740): <em>which, that, you, there, who, all, some, what, his, where</em>
...
1245 <tt><a href="en_partut-pos-AUX.html">AUX</a></tt> tokens (51% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="en_partut-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1238; 99%), <tt><a href="en_partut-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1231; 99%), <tt><a href="en_partut-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (985; 79%), <tt><a href="en_partut-feat-Person.html">Person</a></tt><tt>=3</tt> (773; 62%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (402; 32% of non-empty `Number`): <em>are, have, were, do, 're, 've, be</em>
* `Sing` (843; 68% of non-empty `Number`): <em>is, was, has, does, were, 's, have, am, do, being</em>
...
The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="en_partut-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1226; 99%), <tt><a href="en_partut-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1017; 82%), <tt><a href="en_partut-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (1010; 82%), <tt><a href="en_partut-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (690; 56%).
...
* `EMPTY` (3490): <em>like, make, made, given, wrote, based, take, had, have, taken</em>
...
<tt>NOUN --[<tt><a href="en_partut-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (1946; 60%),
...
<tt>NOUN --[<tt><a href="en_partut-dep-appos.html">appos</a></tt>]--> NOUN</tt> (39; 78%),
