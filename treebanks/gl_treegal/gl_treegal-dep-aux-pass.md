---
layout: base
title:  'Statistics of aux:pass in UD_Galician-TreeGal'
udver: '2'
---

## Treebank Statistics: UD_Galician-TreeGal: Relations: `aux:pass`

This relation is a language-specific subtype of <tt><a href="gl_treegal-dep-aux.html">aux</a></tt>.

37 nodes (0%) are attached to their parents as `aux:pass`.

37 instances of `aux:pass` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.02702702702703.

The following 2 pairs of parts of speech are connected with `aux:pass`: <tt><a href="gl_treegal-pos-VERB.html">VERB</a></tt>-<tt><a href="gl_treegal-pos-AUX.html">AUX</a></tt> (36; 97% instances), <tt><a href="gl_treegal-pos-ADJ.html">ADJ</a></tt>-<tt><a href="gl_treegal-pos-AUX.html">AUX</a></tt> (1; 3% instances).
