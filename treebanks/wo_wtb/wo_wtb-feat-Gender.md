---
layout: base
title:  'Statistics of Gender in UD_Wolof-WTB'
udver: '2'
---

## Treebank Statistics: UD_Wolof-WTB: Features: `Gender`
...
51 <tt><a href="wo_wtb-pos-NOUN.html">NOUN</a></tt> tokens (1% of all `NOUN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NOUN` and `Gender` co-occurred: <tt><a href="wo_wtb-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (51; 100%), <tt><a href="wo_wtb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (37; 73%).

`NOUN` tokens may have the following values of `Gender`:

* `Fem` (25; 49% of non-empty `Gender`): <em>crise, fistule, Assises, Aternative, Coalition, Laicite, administration, athérosclérose, autonomie, civilisation</em>
* `Masc` (26; 51% of non-empty `Gender`): <em>Africains, Livres, Monde, adolescents, animisme, bourreaux, centre, conseils, croissants, cœur</em>
* `EMPTY` (7083): <em>réew, nit, nguur, àdduna, làkk, yoon, askan, at, waa, jamono</em>

`Gender` seems to be **lexical feature** of `NOUN`. 100% lemmas (46) occur only with one value of `Gender`.
...
8 <tt><a href="wo_wtb-pos-ADJ.html">ADJ</a></tt> tokens (67% of all `ADJ` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `ADJ` and `Gender` co-occurred: <tt><a href="wo_wtb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (5; 63%).

`ADJ` tokens may have the following values of `Gender`:

* `Fem` (7; 88% of non-empty `Gender`): <em>obstétrique, Nationales, cardiaque, humaine, négre, orales</em>
* `Masc` (1; 13% of non-empty `Gender`): <em>verts</em>
* `EMPTY` (4): <em>Africaine, francaise, juvénile, linguistique</em>

### `ADP`

1 <tt><a href="wo_wtb-pos-ADP.html">ADP</a></tt> tokens (0% of all `ADP` tokens) have a non-empty value of `Gender`.

`ADP` tokens may have the following values of `Gender`:

* `Masc` (1; 100% of non-empty `Gender`): <em>des</em>
