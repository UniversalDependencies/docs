...
1311 nodes (0%) are attached to their parents as `_`.

1311 instances of `_` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 16.5570556826849.

The following 1 pairs of parts of speech are connected with `_`: [ru-pos/ROOT]()-[ru-pos/_]() (1311; 100% instances).
