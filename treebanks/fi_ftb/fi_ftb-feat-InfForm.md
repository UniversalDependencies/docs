...
The feature is used with 2 part-of-speech tags: <tt><a href="fi_ftb-pos-VERB.html">VERB</a></tt> (5096; 3% instances), <tt><a href="fi_ftb-pos-AUX.html">AUX</a></tt> (229; 0% instances).

### `VERB`

5096 <tt><a href="fi_ftb-pos-VERB.html">VERB</a></tt> tokens (19% of all `VERB` tokens) have a non-empty value of `InfForm`.

The most frequent other feature values with which `VERB` and `InfForm` co-occurred: <tt><a href="fi_ftb-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (5096; 100%), <tt><a href="fi_ftb-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (5096; 100%), <tt><a href="fi_ftb-feat-PartForm.html">PartForm</a></tt><tt>=EMPTY</tt> (5096; 100%), <tt><a href="fi_ftb-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (5096; 100%), <tt><a href="fi_ftb-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (5096; 100%), <tt><a href="fi_ftb-feat-VerbForm.html">VerbForm</a></tt><tt>=Inf</tt> (5096; 100%), <tt><a href="fi_ftb-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (5058; 99%), <tt><a href="fi_ftb-feat-Case.html">Case</a></tt><tt>=Lat</tt> (3196; 63%).

`VERB` tokens may have the following values of `InfForm`:

* `1` (3318; 65% of non-empty `InfForm`): <em>olla, tehdä, mennä, tulla, lähteä, ottaa, sanoa, saada, käydä, käyttää</em>
...
229 <tt><a href="fi_ftb-pos-AUX.html">AUX</a></tt> tokens (2% of all `AUX` tokens) have a non-empty value of `InfForm`.

The most frequent other feature values with which `AUX` and `InfForm` co-occurred: <tt><a href="fi_ftb-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (229; 100%), <tt><a href="fi_ftb-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (229; 100%), <tt><a href="fi_ftb-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (229; 100%), <tt><a href="fi_ftb-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (229; 100%), <tt><a href="fi_ftb-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (229; 100%), <tt><a href="fi_ftb-feat-VerbForm.html">VerbForm</a></tt><tt>=Inf</tt> (229; 100%), <tt><a href="fi_ftb-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (229; 100%).

`AUX` tokens may have the following values of `InfForm`:

* `1` (205; 90% of non-empty `InfForm`): <em>olla, saada, jättää, ruveta, voida, ryhtyä, ollakseen, ollapa, täytyä, Ollaksesi</em>
* `2` (8; 3% of non-empty `InfForm`): <em>ollen, ollessa, ollessani, ollessaan</em>
* `3` (16; 7% of non-empty `InfForm`): <em>olemaan, olemasta, oleen</em>
...
`InfForm` seems to be **lexical feature** of `AUX`. 91% lemmas (10) occur only with one value of `InfForm`.
