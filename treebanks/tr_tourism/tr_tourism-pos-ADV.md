...
There are 177 `ADV` lemmas (6%), 201 `ADV` types (4%) and 7281 `ADV` tokens (8%).
...
The form / lemma ratio of `ADV` is 1.135593 (the average of all parts of speech is 1.824721).
...
`ADV` occurs with 2 features: <tt><a href="tr_tourism-feat-Degree.html">Degree</a></tt> (512; 7% instances), <tt><a href="tr_tourism-feat-PronType.html">PronType</a></tt> (99; 1% instances)
