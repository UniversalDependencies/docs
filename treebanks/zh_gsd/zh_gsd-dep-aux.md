...
The following 5 pairs of parts of speech are connected with `aux`: <tt><a href="zh_gsd-pos-VERB.html">VERB</a></tt>-<tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> (1788; 98% instances), <tt><a href="zh_gsd-pos-ADJ.html">ADJ</a></tt>-<tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> (21; 1% instances), <tt><a href="zh_gsd-pos-NOUN.html">NOUN</a></tt>-<tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> (10; 1% instances), <tt><a href="zh_gsd-pos-PART.html">PART</a></tt>-<tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> (6; 0% instances), <tt><a href="zh_gsd-pos-ADP.html">ADP</a></tt>-<tt><a href="zh_gsd-pos-AUX.html">AUX</a></tt> (2; 0% instances).
...
1	爪部	爪部	NOUN	NN	_	3	nsubj	_	SpaceAfter=No|Translit=zhǎobù|LTranslit=zhǎobù
2	通常	通常	ADV	RB	_	3	advmod	_	SpaceAfter=No|Translit=tōngcháng|LTranslit=tōngcháng
3	是	是	VERB	VC	_	0	root	_	SpaceAfter=No|Translit=shì|LTranslit=shì
4	從	從	ADP	IN	_	5	case	_	SpaceAfter=No|Translit=cóng|LTranslit=cóng
5	上	上	NOUN	NN	_	13	nmod	_	SpaceAfter=No|Translit=shàng|LTranslit=shàng
6	、	、	PUNCT	EC	_	7	punct	_	SpaceAfter=No|Translit=,|LTranslit=,
7	左	左	NOUN	NN	_	5	conj	_	SpaceAfter=No|Translit=zuǒ|LTranslit=zuǒ
8	、	、	PUNCT	EC	_	9	punct	_	SpaceAfter=No|Translit=,|LTranslit=,
9	右方	右方	NOUN	NN	_	5	conj	_	SpaceAfter=No|Translit=yòufāng|LTranslit=yòufāng
10	均	均	ADV	RB	_	13	advmod	_	SpaceAfter=No|Translit=jūn|LTranslit=jūn
11	可	可	AUX	MD	_	13	aux	_	SpaceAfter=No|Translit=kě|LTranslit=kě
12	為	為	AUX	VC	_	13	cop	_	SpaceAfter=No|Translit=wèi|LTranslit=wèi
13	部字	部字	NOUN	NN	_	3	xcomp	_	SpaceAfter=No|Translit=bùzì|LTranslit=bùzì
