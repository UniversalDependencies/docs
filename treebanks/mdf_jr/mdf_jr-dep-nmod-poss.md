...
There are also 2 other language-specific subtypes of `nmod`: <tt><a href="mdf_jr-dep-nmod-bahuv.html">nmod:bahuv</a></tt>, <tt><a href="mdf_jr-dep-nmod-part.html">nmod:part</a></tt>.
...
The following 2 pairs of parts of speech are connected with `nmod:poss`: <tt><a href="mdf_jr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="mdf_jr-pos-PRON.html">PRON</a></tt> (3; 60% instances), <tt><a href="mdf_jr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="mdf_jr-pos-NOUN.html">NOUN</a></tt> (2; 40% instances).
...
6	омбоце	кафта	ADJ	A	Case=Nom|Definite=Ind|Derivation=Ord|Number=Sing|NumType=Ord	8	amod	_	GTtags=Der/Ord,A,Ord,Sg,Nom,Indef
