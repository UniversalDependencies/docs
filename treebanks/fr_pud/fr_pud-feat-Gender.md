...
12662 tokens (51%) have a non-empty value of `Gender`.
4400 types (74%) occur at least once with a non-empty value of `Gender`.
3535 lemmas (77%) occur at least once with a non-empty value of `Gender`.
The feature is used with 9 part-of-speech tags: <tt><a href="fr_pud-pos-NOUN.html">NOUN</a></tt> (4672; 19% instances), <tt><a href="fr_pud-pos-DET.html">DET</a></tt> (3873; 16% instances), <tt><a href="fr_pud-pos-ADJ.html">ADJ</a></tt> (1618; 7% instances), <tt><a href="fr_pud-pos-PROPN.html">PROPN</a></tt> (970; 4% instances), <tt><a href="fr_pud-pos-VERB.html">VERB</a></tt> (837; 3% instances), <tt><a href="fr_pud-pos-PRON.html">PRON</a></tt> (588; 2% instances), <tt><a href="fr_pud-pos-AUX.html">AUX</a></tt> (99; 0% instances), <tt><a href="fr_pud-pos-NUM.html">NUM</a></tt> (4; 0% instances), <tt><a href="fr_pud-pos-X.html">X</a></tt> (1; 0% instances).
...
* `Masc` (823; 51% of non-empty `Gender`): <em>autres, grand, dernier, derniers, général, nouveaux, plusieurs, certains, nouveau, chaque</em>
...
837 <tt><a href="fr_pud-pos-VERB.html">VERB</a></tt> tokens (37% of all `VERB` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `VERB` and `Gender` co-occurred: <tt><a href="fr_pud-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (837; 100%), <tt><a href="fr_pud-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (837; 100%), <tt><a href="fr_pud-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (837; 100%), <tt><a href="fr_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (837; 100%), <tt><a href="fr_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (691; 83%).
...
588 <tt><a href="fr_pud-pos-PRON.html">PRON</a></tt> tokens (54% of all `PRON` tokens) have a non-empty value of `Gender`.
...
* `EMPTY` (509): <em>qui, y, on, ce, nous, je, où, c', cela, c’</em>
