...
3	söylüyorum	söyle	VERB	_	Aspect=Prog|Mood=Ind|Number=Sing|Person=1|Tense=Pres	0	root	_	_
4	ki	ki	SCONJ	_	_	6	mark	_	_
5	sonradan	sonradan	ADV	_	_	6	advmod	_	_
6	şaşırmayasın	şaşır	VERB	_	Mood=Opt|Number=Sing|Person=2|Polarity=Neg|Tense=Pres	3	advcl	_	SpaceAfter=No
...
3	görmedim	gör	VERB	_	Aspect=Perf|Mood=Ind|Number=Sing|Person=1|Polarity=Neg|Tense=Past	0	root	_	SpaceAfter=No
