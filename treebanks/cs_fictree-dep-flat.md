...
The following 1 pairs of parts of speech are connected with `flat`: <tt><a href="cs_fictree-pos-PROPN.html">PROPN</a></tt>-<tt><a href="cs_fictree-pos-PROPN.html">PROPN</a></tt> (3; 100% instances).
...
1	Představil	představit	VERB	VpMS----R-AA---	Animacy=Anim|Gender=Masc|Number=Sing|Polarity=Pos|Tense=Past|VerbForm=Part|Voice=Act	0	root	_	_
...
16	moje	můj	DET	PSIP4-S1-------	Animacy=Inan|Case=Acc|Gender=Masc|Number=Plur|Number[psor]=Sing|Person=1|Poss=Yes|PronType=Prs	17	det	_	_
17	papíry	papír	NOUN	NNIP4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Plur|Polarity=Pos	15	obj	_	_
18	a	a	CCONJ	J^-------------	_	19	cc	_	_
19	neví	vědět	VERB	VB-S---3P-NA---	Mood=Ind|Number=Sing|Person=3|Polarity=Neg|Tense=Pres|VerbForm=Fin|Voice=Act	15	conj	_	_
20	nic	nic	PRON	PW--4----------	Case=Acc|PronType=Neg	19	obj	_	_
...
24	dnech	den	NOUN	NNIP6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Plur|Polarity=Pos	19	iobj	_	_
