---
layout: base
title:  'Statistics of nummod in UD_Middle_Armenian-ArmTDP'
udver: '2'
---

## Treebank Statistics: UD_Middle_Armenian-ArmTDP: Relations: `nummod`
...
The following 1 pairs of parts of speech are connected with `nummod`: <tt><a href="axm_armtdp-pos-NOUN.html">NOUN</a></tt>-<tt><a href="axm_armtdp-pos-NUM.html">NUM</a></tt> (10; 100% instances).
