...
There are 17 `PART` lemmas (0%), 18 `PART` types (0%) and 477 `PART` tokens (2%).
Out of 16 observed tags, the rank of `PART` is: 10 in number of lemmas, 12 in number of types and 12 in number of tokens.

The 10 most frequent `PART` lemmas: <em>non, nam, autem, enim, quoque, quidem, igitur, haud, o, ecce</em>

The 10 most frequent `PART` types:  <em>non, nam, autem, enim, quoque, quidem, igitur, haud, o, ecce</em>
...
The form / lemma ratio of `PART` is 1.058824 (the average of all parts of speech is 2.101598).
...
`PART` occurs with 3 features: <tt><a href="la_perseus-feat-Form.html">Form</a></tt> (24; 5% instances), <tt><a href="la_perseus-feat-PartType.html">PartType</a></tt> (3; 1% instances), <tt><a href="la_perseus-feat-Polarity.html">Polarity</a></tt> (3; 1% instances)

`PART` occurs with 3 feature-value pairs: `Form=Emp`, `PartType=Int`, `Polarity=Neg`
...
`PART` nodes are attached to their parents using 3 different relations: <tt><a href="la_perseus-dep-advmod-neg.html">advmod:neg</a></tt> (274; 57% instances), <tt><a href="la_perseus-dep-discourse.html">discourse</a></tt> (171; 36% instances), <tt><a href="la_perseus-dep-advmod-emph.html">advmod:emph</a></tt> (32; 7% instances)

Parents of `PART` nodes belong to 10 different parts of speech: <tt><a href="la_perseus-pos-VERB.html">VERB</a></tt> (340; 71% instances), <tt><a href="la_perseus-pos-ADJ.html">ADJ</a></tt> (40; 8% instances), <tt><a href="la_perseus-pos-NOUN.html">NOUN</a></tt> (31; 6% instances), <tt><a href="la_perseus-pos-ADV.html">ADV</a></tt> (27; 6% instances), <tt><a href="la_perseus-pos-DET.html">DET</a></tt> (14; 3% instances), <tt><a href="la_perseus-pos-PRON.html">PRON</a></tt> (10; 2% instances), <tt><a href="la_perseus-pos-ADP.html">ADP</a></tt> (9; 2% instances), <tt><a href="la_perseus-pos-CCONJ.html">CCONJ</a></tt> (2; 0% instances), <tt><a href="la_perseus-pos-PROPN.html">PROPN</a></tt> (2; 0% instances), <tt><a href="la_perseus-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances)

466 (98%) `PART` nodes are leaves.

11 (2%) `PART` nodes have one child.

The highest child degree of a `PART` node is 1.

Children of `PART` nodes are attached using 3 different relations: <tt><a href="la_perseus-dep-punct.html">punct</a></tt> (7; 64% instances), <tt><a href="la_perseus-dep-advmod.html">advmod</a></tt> (2; 18% instances), <tt><a href="la_perseus-dep-cc.html">cc</a></tt> (2; 18% instances)

Children of `PART` nodes belong to 3 different parts of speech: <tt><a href="la_perseus-pos-PUNCT.html">PUNCT</a></tt> (7; 64% instances), <tt><a href="la_perseus-pos-ADV.html">ADV</a></tt> (2; 18% instances), <tt><a href="la_perseus-pos-CCONJ.html">CCONJ</a></tt> (2; 18% instances)
