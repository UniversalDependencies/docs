...
There are 2445 `ADJ` lemmas (21%), 4293 `ADJ` types (12%) and 15057 `ADJ` tokens (5%).
...
The form / lemma ratio of `ADJ` is 1.755828 (the average of all parts of speech is 3.034474).
