---
layout: base
title:  'Statistics of ExtPos in UD_Coptic-Scriptorium'
udver: '2'
---

## Treebank Statistics: UD_Coptic-Scriptorium: Features: `ExtPos`
...
<table>
  ...
  <tr><td><tt></tt></td><td>ⲉⲃⲟⲗ</td><td>ⲉⲃⲟⲗ</td></tr>
</table>
...
* `ADV` (15; 100% of non-empty `ExtPos`): ⲉⲓⲥ

### `ADP`

12 <tt><a href="cop_scriptorium-pos-ADP.html">ADP</a></tt> tokens (0% of all `ADP` tokens) have a non-empty value of `ExtPos`.

`ADP` tokens may have the following values of `ExtPos`:

* `ADP` (3; 25% of non-empty `ExtPos`): ⲉⲧⲃⲉ, ϣⲁ
* `ADV` (2; 17% of non-empty `ExtPos`): ϣⲁ
* `SCONJ` (7; 58% of non-empty `ExtPos`): ⲉⲧⲃⲉ, ⲉ, ⲛ

<table>
  <tr><th>Paradigm <i>ⲉⲧⲃⲉ</i></th><th><tt>ADP</tt></th><th><tt>SCONJ</tt></th></tr>
  <tr><td><tt></tt></td><td>ⲉⲧⲃⲉ</td><td>ⲉⲧⲃⲉ</td></tr>
</table>

### `CCONJ`

1 <tt><a href="cop_scriptorium-pos-CCONJ.html">CCONJ</a></tt> tokens (0% of all `CCONJ` tokens) have a non-empty value of `ExtPos`.

The most frequent other feature values with which `CCONJ` and `ExtPos` co-occurred: <tt><a href="cop_scriptorium-feat-Foreign.html">Foreign</a></tt><tt>=Yes</tt> (1; 100%).

`CCONJ` tokens may have the following values of `ExtPos`:

* `ADV` (1; 100% of non-empty `ExtPos`): ⲕⲁⲓ
