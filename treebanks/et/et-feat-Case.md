...
* `Tra` (461; 2% of non-empty `Case`): <em>lisaks, põhjuseks, juhuks, ajaks, kasuks, osaks, õnneks, hetkeks, vastuseks, aastaks</em>
...
* `Ade` (3; 20% of non-empty `Case`): <em>samal, Igal</em>
