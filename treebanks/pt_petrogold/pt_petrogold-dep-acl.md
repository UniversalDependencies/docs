...
4707 nodes (2%) are attached to their parents as `acl`.

4632 instances of `acl` (98%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.61822817080943.
