---
layout: base
title:  'Statistics of Polarity in UD_English-LinES'
udver: '2'
---

## Treebank Statistics: UD_English-LinES: Features: `Polarity`
...
20 <tt><a href="en_lines-pos-CCONJ.html">CCONJ</a></tt> tokens (1% of all `CCONJ` tokens) have a non-empty value of `Polarity`.
...
<tt>PART --[<tt><a href="en_lines-dep-discourse.html">discourse</a></tt>]--> INTJ</tt> (1; 100%).
