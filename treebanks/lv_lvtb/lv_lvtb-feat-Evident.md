...
11871 tokens (11%) have a non-empty value of `Evident`.
3928 types (16%) occur at least once with a non-empty value of `Evident`.
2118 lemmas (16%) occur at least once with a non-empty value of `Evident`.
The feature is used with 2 part-of-speech tags: <tt><a href="lv_lvtb-pos-VERB.html">VERB</a></tt> (9160; 8% instances), <tt><a href="lv_lvtb-pos-AUX.html">AUX</a></tt> (2711; 2% instances).

### `VERB`

9160 <tt><a href="lv_lvtb-pos-VERB.html">VERB</a></tt> tokens (56% of all `VERB` tokens) have a non-empty value of `Evident`.

The most frequent other feature values with which `VERB` and `Evident` co-occurred: <tt><a href="lv_lvtb-feat-Aspect.html">Aspect</a></tt><tt>=EMPTY</tt> (9160; 100%), <tt><a href="lv_lvtb-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (9160; 100%), <tt><a href="lv_lvtb-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (9160; 100%), <tt><a href="lv_lvtb-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (9160; 100%), <tt><a href="lv_lvtb-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (9160; 100%), <tt><a href="lv_lvtb-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (9160; 100%), <tt><a href="lv_lvtb-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (9160; 100%), <tt><a href="lv_lvtb-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9073; 99%), <tt><a href="lv_lvtb-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (8200; 90%), <tt><a href="lv_lvtb-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (7510; 82%).

`VERB` tokens may have the following values of `Evident`:

* `Fh` (9073; 99% of non-empty `Evident`): <em>ir, var, nav, bija, teica, nevar, notiek, saka, būs, nebija</em>
* `Nfh` (87; 1% of non-empty `Evident`): <em>esot, neesot, nevarot, mīlot, nezinot, notikšot, spriežot, strādājot, varot, zinot</em>
* `EMPTY` (7086): <em>varētu, iet, runāt, būt, strādāt, izmantot, teikt, atrast, darīt, dzīvot</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="lv_lvtb-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="lv_lvtb-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="lv_lvtb-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt>|<tt><a href="lv_lvtb-feat-Tense.html">Tense</a></tt><tt>=Pres</tt></tt></td><td></td><td><em>ir, bij, Tr</em></td></tr>
...
`Evident` seems to be **lexical feature** of `VERB`. 97% lemmas (2064) occur only with one value of `Evident`.

### `AUX`

2711 <tt><a href="lv_lvtb-pos-AUX.html">AUX</a></tt> tokens (89% of all `AUX` tokens) have a non-empty value of `Evident`.

The most frequent other feature values with which `AUX` and `Evident` co-occurred: <tt><a href="lv_lvtb-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (2711; 100%), <tt><a href="lv_lvtb-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (2711; 100%), <tt><a href="lv_lvtb-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (2651; 98%), <tt><a href="lv_lvtb-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (2457; 91%), <tt><a href="lv_lvtb-feat-Person.html">Person</a></tt><tt>=3</tt> (2397; 88%), <tt><a href="lv_lvtb-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (2305; 85%), <tt><a href="lv_lvtb-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1923; 71%).

`AUX` tokens may have the following values of `Evident`:

* `Fh` (2651; 98% of non-empty `Evident`): <em>ir, bija, nav, tiek, būs, esmu, tika, nebija, esam, tiks</em>
* `Nfh` (60; 2% of non-empty `Evident`): <em>esot, neesot, būšot, kļūšot, nebūšot, tikšot</em>
* `EMPTY` (323): <em>būtu, būt, bijis, jābūt, kļūt, nebūtu, kļuvusi, kļuvis, tikt, bijusi</em>
...
<tt>VERB --[<tt><a href="lv_lvtb-dep-conj.html">conj</a></tt>]--> VERB</tt> (1735; 82%),
<tt>VERB --[<tt><a href="lv_lvtb-dep-parataxis.html">parataxis</a></tt>]--> VERB</tt> (128; 60%),
<tt>VERB --[<tt><a href="lv_lvtb-dep-csubj.html">csubj</a></tt>]--> VERB</tt> (49; 55%),
