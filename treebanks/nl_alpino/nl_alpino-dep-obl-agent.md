...
3	werd	worden	AUX	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	5	aux:pass	5:aux:pass	_
...
3	hebben	hebben	VERB	WW|pv|tgw|mv	Mood=Ind|Number=Plur|Tense=Pres|VerbForm=Fin	0	root	0:root	_
...
8	werk	werken	VERB	WW|pv|tgw|ev	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	4	acl	4:acl:dat	SpaceAfter=No
9	''	''	PUNCT	LET	_	3	punct	3:punct	SpaceAfter=No
10	,	,	PUNCT	LET	_	11	punct	11:punct	_
11	zei	zeggen	VERB	WW|pv|verl|ev	Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin	3	parataxis	3:parataxis	_
...
15	wiens	wie	DET	VNW|vb|pron|gen|vol|3m|ev	PronType=Rel	17	det	17:det	_
...
20	alle	al	DET	VNW|onbep|det|stan|prenom|met-e|agr	PronType=Tot	21	det	21:det	_
21	aanwezigen	aanwezig	ADJ	ADJ|nom|basis|met-e|mv-n	Degree=Pos	23	obl:agent	23:obl:agent	_
22	wordt	worden	AUX	WW|pv|tgw|met-t	Mood=Ind|Number=Sing|Tense=Pres|VerbForm=Fin	23	aux:pass	23:aux:pass	_
