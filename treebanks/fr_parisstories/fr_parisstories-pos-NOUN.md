...
There are 1132 `NOUN` lemmas (44%), 1277 `NOUN` types (37%) and 4429 `NOUN` tokens (10%).
...
The form / lemma ratio of `NOUN` is 1.128092 (the average of all parts of speech is 1.353739).
