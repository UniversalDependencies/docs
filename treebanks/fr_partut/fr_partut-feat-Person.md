...
2918 tokens (10%) have a non-empty value of `Person`.
605 types (15%) occur at least once with a non-empty value of `Person`.
330 lemmas (11%) occur at least once with a non-empty value of `Person`.
The feature is used with 5 part-of-speech tags: <tt><a href="fr_partut-pos-PRON.html">PRON</a></tt> (1091; 4% instances), <tt><a href="fr_partut-pos-AUX.html">AUX</a></tt> (929; 3% instances), <tt><a href="fr_partut-pos-VERB.html">VERB</a></tt> (894; 3% instances), <tt><a href="fr_partut-pos-DET.html">DET</a></tt> (3; 0% instances), <tt><a href="fr_partut-pos-ADP.html">ADP</a></tt> (1; 0% instances).

### `PRON`

1091 <tt><a href="fr_partut-pos-PRON.html">PRON</a></tt> tokens (67% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="fr_partut-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (954; 87%), <tt><a href="fr_partut-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (740; 68%), <tt><a href="fr_partut-feat-Number.html">Number</a></tt><tt>=Sing</tt> (597; 55%).
...
* `3` (619; 57% of non-empty `Person`): <em>il, ce, s', se, on, ils, l', le, elle, elles</em>
...
929 <tt><a href="fr_partut-pos-AUX.html">AUX</a></tt> tokens (85% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="fr_partut-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (927; 100%), <tt><a href="fr_partut-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (853; 92%), <tt><a href="fr_partut-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (776; 84%), <tt><a href="fr_partut-feat-Number.html">Number</a></tt><tt>=Sing</tt> (599; 64%).

`AUX` tokens may have the following values of `Person`:

* `1` (131; 14% of non-empty `Person`): <em>voudrais, suis, devons, sommes, ai, avons, devrions, allons, pouvons, vais</em>
* `2` (31; 3% of non-empty `Person`): <em>pouvez, avez, êtes, devez, pourrez, va, voulez</em>
* `3` (767; 83% of non-empty `Person`): <em>est, a, sont, ont, peut, doit, devrait, sera, soit, peuvent</em>
* `EMPTY` (170): <em>être, été, étant, avoir, ayant, pouvoir, aller, pu, dû</em>
...
894 <tt><a href="fr_partut-pos-VERB.html">VERB</a></tt> tokens (36% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="fr_partut-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (894; 100%), <tt><a href="fr_partut-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (893; 100%), <tt><a href="fr_partut-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (812; 91%), <tt><a href="fr_partut-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (787; 88%), <tt><a href="fr_partut-feat-Number.html">Number</a></tt><tt>=Sing</tt> (569; 64%).

`VERB` tokens may have the following values of `Person`:

* `1` (174; 19% of non-empty `Person`): <em>pense, espérons, tiens, crois, avons, demandons, pensons, voyons, ai, espère</em>
* `2` (67; 7% of non-empty `Person`): <em>choisissez, cliquez, utilisez, avez, permettez, souhaitez, connaissez, publiez, saisissez, voyez</em>
* `3` (653; 73% of non-empty `Person`): <em>a, est, convient, ont, fait, concerne, font, faut, agit, apporte</em>
...
<tt>VERB --[<tt><a href="fr_partut-dep-expl.html">expl</a></tt>]--> PRON</tt> (108; 58%),
