...
There are 15 `SCONJ` lemmas (0%), 15 `SCONJ` types (0%) and 261 `SCONJ` tokens (1%).
...
The form / lemma ratio of `SCONJ` is 1.000000 (the average of all parts of speech is 1.314341).
...
`SCONJ` nodes are attached to their parents using 1 different relations: <tt><a href="es_pud-dep-mark.html">mark</a></tt> (261; 100% instances)

Parents of `SCONJ` nodes belong to 4 different parts of speech: <tt><a href="es_pud-pos-VERB.html">VERB</a></tt> (222; 85% instances), <tt><a href="es_pud-pos-ADJ.html">ADJ</a></tt> (22; 8% instances), <tt><a href="es_pud-pos-NOUN.html">NOUN</a></tt> (16; 6% instances), <tt><a href="es_pud-pos-SYM.html">SYM</a></tt> (1; 0% instances)
