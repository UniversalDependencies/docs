...
5463 tokens (4%) have a non-empty value of `Case`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="he_iahltwiki-pos-ADP.html">ADP</a></tt> (3275; 2% instances), <tt><a href="he_iahltwiki-pos-PRON.html">PRON</a></tt> (2188; 2% instances).

### `ADP`

3275 <tt><a href="he_iahltwiki-pos-ADP.html">ADP</a></tt> tokens (14% of all `ADP` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `ADP` and `Case` co-occurred: <tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (3275; 100%), <tt><a href="he_iahltwiki-feat-PronType.html">PronType</a></tt><tt>=EMPTY</tt> (3275; 100%).

`ADP` tokens may have the following values of `Case`:

* `Acc` (800; 24% of non-empty `Case`): את, אות, אֶת, אֹת, של
* `Gen` (2475; 76% of non-empty `Case`): של
* `EMPTY` (19734): ב, ל, מ, על, את, כ, עם, בין, לאחר, עד

### `PRON`

2188 <tt><a href="he_iahltwiki-pos-PRON.html">PRON</a></tt> tokens (39% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="he_iahltwiki-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (2181; 100%), <tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (2152; 98%), <tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt> (2145; 98%), <tt><a href="he_iahltwiki-feat-Poss.html">Poss</a></tt><tt>=Yes</tt> (2132; 97%), <tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1678; 77%), <tt><a href="he_iahltwiki-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (1552; 71%).
...
<table>
  ...
  <tr><td><tt><tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="he_iahltwiki-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="he_iahltwiki-feat-Poss.html">Poss</a></tt><tt>=Yes</tt></tt></td><td></td><td>ו, ם, הם, וֹ, י, ן</td></tr>
  <tr><td><tt><tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="he_iahltwiki-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td>ו</td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="he_iahltwiki-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="he_iahltwiki-feat-Poss.html">Poss</a></tt><tt>=Yes</tt></tt></td><td></td><td>ה, הּ, ך, ם</td></tr>
  ...
  <tr><td><tt><tt><a href="he_iahltwiki-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="he_iahltwiki-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="he_iahltwiki-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="he_iahltwiki-feat-Poss.html">Poss</a></tt><tt>=Yes</tt></tt></td><td></td><td>ה</td></tr>
