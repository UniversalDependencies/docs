...
The feature is used with 2 part-of-speech tags: <tt><a href="da_ddt-pos-PRON.html">PRON</a></tt> (6040; 6% instances), <tt><a href="da_ddt-pos-DET.html">DET</a></tt> (5504; 5% instances).

### `PRON`

6040 <tt><a href="da_ddt-pos-PRON.html">PRON</a></tt> tokens (89% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="da_ddt-feat-PartType.html">PartType</a></tt><tt>=EMPTY</tt> (6040; 100%), <tt><a href="da_ddt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4001; 66%), <tt><a href="da_ddt-feat-Person.html">Person</a></tt><tt>=3</tt> (3321; 55%), <tt><a href="da_ddt-feat-Gender.html">Gender</a></tt><tt>=Com</tt> (3307; 55%).
...
<tt>PRON --[<tt><a href="da_ddt-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (30; 54%),
