...
* `VERB-VERB`: _PF <b>prende</b> dois por <b>cobrar</b> ágio_
...
* `ADJ-VERB`: _« Era um <b>miserável</b> quando <b>chegou</b> ._
...
* `ADV-VERB`: _A energia nuclear é usada <b>só</b> para <b>movimentar</b> a embarcação ._
