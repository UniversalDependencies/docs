---
layout: base
title:  'Statistics of flat in UD_Turkish-TueCL'
udver: '2'
---

## Treebank Statistics: UD_Turkish-TueCL: Relations: `flat`
...
The following 1 pairs of parts of speech are connected with `flat`: <tt><a href="tr_tuecl-pos-PROPN.html">PROPN</a></tt>-<tt><a href="tr_tuecl-pos-PROPN.html">PROPN</a></tt> (2; 100% instances).
