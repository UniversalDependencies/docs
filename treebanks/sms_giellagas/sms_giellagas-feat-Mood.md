...
692 tokens (24%) have a non-empty value of `Mood`.
281 types (38%) occur at least once with a non-empty value of `Mood`.
147 lemmas (30%) occur at least once with a non-empty value of `Mood`.
The feature is used with 2 part-of-speech tags: <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> (547; 19% instances), <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> (145; 5% instances).

### `VERB`

547 <tt><a href="sms_giellagas-pos-VERB.html">VERB</a></tt> tokens (86% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="sms_giellagas-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (547; 100%), <tt><a href="sms_giellagas-feat-Person.html">Person</a></tt><tt>=3</tt> (447; 82%), <tt><a href="sms_giellagas-feat-Number.html">Number</a></tt><tt>=Sing</tt> (434; 79%).
...
* `EMPTY` (89): <em>jieʹlled, kooǯǯted, väʹldded, hiâvted, jååʹtted, mõõnnâd, teâđstam, vueʹtǩǩmen, välddam, kaunnâm</em>
...
`Mood` seems to be **lexical feature** of `VERB`. 92% lemmas (132) occur only with one value of `Mood`.

### `AUX`

145 <tt><a href="sms_giellagas-pos-AUX.html">AUX</a></tt> tokens (94% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="sms_giellagas-feat-Valency.html">Valency</a></tt><tt>=EMPTY</tt> (118; 81%), <tt><a href="sms_giellagas-feat-Number.html">Number</a></tt><tt>=Sing</tt> (117; 81%), <tt><a href="sms_giellagas-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (98; 68%), <tt><a href="sms_giellagas-feat-Person.html">Person</a></tt><tt>=3</tt> (93; 64%), <tt><a href="sms_giellagas-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (80; 55%).

`AUX` tokens may have the following values of `Mood`:

* `Imp` (1; 1% of non-empty `Mood`): <em>Jeäʹled</em>
* `Ind` (143; 99% of non-empty `Mood`): <em>lij, ij, leäi, jiõk, liâ, õõk, õõlǥ, jiõm, leäk, leäkku</em>
* `Pot` (1; 1% of non-empty `Mood`): <em>leežž</em>
* `EMPTY` (10): <em>i-ǥõl, leeʹd, jeäʹla, leäkku, leämmaž, õlggâm, õõk</em>
...
<tt>VERB --[<tt><a href="sms_giellagas-dep-aux-neg.html">aux:neg</a></tt>]--> AUX</tt> (23; 66%),
