...
There are 30 `PUNCT` lemmas (1%), 31 `PUNCT` types (1%) and 4606 `PUNCT` tokens (13%).
...
The form / lemma ratio of `PUNCT` is 1.033333 (the average of all parts of speech is 1.726345).
