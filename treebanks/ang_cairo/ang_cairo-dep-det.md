...
## Treebank Statistics: UD_Old_English-Cairo: Relations: `det`

This relation is universal.

9 nodes (5%) are attached to their parents as `det`.

9 instances of `det` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `det`: <tt><a href="ang_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ang_cairo-pos-DET.html">DET</a></tt> (9; 100% instances).
