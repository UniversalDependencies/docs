...
The feature is used with 1 part-of-speech tags: <tt><a href="sl_ssj-pos-VERB.html">VERB</a></tt> (12461; 9% instances).

### `VERB`

12461 <tt><a href="sl_ssj-pos-VERB.html">VERB</a></tt> tokens (86% of all `VERB` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `VERB` and `Aspect` co-occurred: <tt><a href="sl_ssj-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (7725; 62%), <tt><a href="sl_ssj-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (7477; 60%), <tt><a href="sl_ssj-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (7477; 60%), <tt><a href="sl_ssj-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6738; 54%), <tt><a href="sl_ssj-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (6255; 50%).
