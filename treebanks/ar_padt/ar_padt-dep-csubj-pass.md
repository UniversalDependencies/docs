...
3	الوقائع	وَقِيعَة	NOUN	N------P2D	Case=Gen|Definite=Def|Number=Plur	1	nmod	1:nmod	Vform=اَلوَقَائِعِ|Gloss=incident,event|Root=w_q_`|Translit=al-waqāʾiʿi|LTranslit=waqīʿat
4	و	وَ	CCONJ	C---------	_	5	cc	5:cc	Vform=وَ|Gloss=and|Root=wa|Translit=wa|LTranslit=wa
5	الأرقام	رَقم	NOUN	N------P1D	Case=Nom|Definite=Def|Number=Plur	3	conj	1:nmod|3:conj	Vform=اَلأَرقَامُ|Gloss=number,numeral,record|Root=r_q_m|Translit=al-ʾarqāmu|LTranslit=raqm
...
8	مقدمات	مُقَدَّمَة	NOUN	N------P2I	Case=Gen|Definite=Ind|Number=Plur	6	obl:arg	6:obl:arg	Vform=مُقَدَّمَاتٍ|Gloss=preface,introduction,front_part|Root=q_d_m|Translit=muqaddamātin|LTranslit=muqaddamat
...
19	ذات	ذَات	NOUN	N------S2R	Case=Gen|Definite=Cons|Number=Sing	18	nmod	18:nmod	Vform=ذَاتِ|Gloss=self,being,essence|Root=_d|Translit=ḏāti|LTranslit=ḏāt
20	سيادة	سِيَادَة	NOUN	N------S2I	Case=Gen|Definite=Ind|Number=Sing	19	nmod	19:nmod	SpaceAfter=No|Vform=سِيَادَةٍ|Gloss=sovereignty,supremacy,Excellency|Root=s_w_d|Translit=siyādatin|LTranslit=siyādat
...
23	الأرض	أَرض	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	22	nmod	22:nmod	Vform=اَلأَرضِ|Gloss=earth,territory,land|Root='_r_.d|Translit=al-ʾarḍi|LTranslit=ʾarḍ
24	التي	اَلَّذِي	DET	SR----FS2-	Case=Gen|Gender=Fem|Number=Sing|PronType=Rel	25	nsubj:pass	25:nsubj:pass	Vform=اَلَّتِي|Gloss=that,which|Root=l|Translit=allatī|LTranslit=allaḏī
...
29	ها	هُوَ	PRON	SP---3FS2-	Case=Gen|Gender=Fem|Number=Sing|Person=3|PronType=Prs	28	nmod	28:nmod	Vform=هَا|Gloss=he,she,it|Translit=hā|LTranslit=huwa
...
35	نشر	نَشر	NOUN	N------S2R	Case=Gen|Definite=Cons|Number=Sing	32	nmod	32:nmod	Vform=نَشرِ|Gloss=spreading,propagation|Root=n_^s_r|Translit=našri|LTranslit=našr
36	السلطة	سُلطَة	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	35	nmod	35:nmod	Vform=اَلسُّلطَةِ|Gloss=power,authority,rule|Root=s_l_.t|Translit=as-sulṭati|LTranslit=sulṭat
...
38	ها	هُوَ	PRON	SP---3FS2-	Case=Gen|Gender=Fem|Number=Sing|Person=3|PronType=Prs	35	nmod	35:nmod	Vform=هَا|Gloss=he,she,it|Translit=hā|LTranslit=huwa
39	و	وَ	CCONJ	C---------	_	40	cc	40:cc	Vform=وَ|Gloss=and|Root=wa|Translit=wa|LTranslit=wa
40	ربط	رَبط	NOUN	N------S1R	Case=Nom|Definite=Cons|Number=Sing	35	conj	32:nmod|35:conj	Vform=رَبطُ|Gloss=tying,connecting|Root=r_b_.t|Translit=rabṭu|LTranslit=rabṭ
41	ها	هُوَ	PRON	SP---3FS2-	Case=Gen|Gender=Fem|Number=Sing|Person=3|PronType=Prs	40	nmod	40:nmod	Vform=هَا|Gloss=he,she,it|Translit=hā|LTranslit=huwa
...
51	الحياة	حَيَاة	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	45	nmod	45:nmod	Vform=اَلحَيَاةِ|Gloss=life|Root=.h_y_y|Translit=al-ḥayāti|LTranslit=ḥayāt
...
56	السلاح	سِلَاح	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	55	nmod	55:nmod	Vform=اَلسِّلَاحِ|Gloss=weapon|Root=s_l_.h|Translit=as-silāḥi|LTranslit=silāḥ
57	و	وَ	CCONJ	C---------	_	58	cc	58:cc	Vform=وَ|Gloss=and|Root=wa|Translit=wa|LTranslit=wa
58	التعبئة	تَعبِئَة	NOUN	N------S1D	Case=Nom|Definite=Def|Number=Sing	56	conj	55:nmod|56:conj	Vform=اَلتَّعبِئَةُ|Gloss=mobilization,alert|Root=`_b_'|Translit=at-taʿbiʾatu|LTranslit=taʿbiʾat
...
62	تحسين	تَحسِين	NOUN	N------S2R	Case=Gen|Definite=Cons|Number=Sing	60	nmod	60:nmod	Vform=تَحسِينِ|Gloss=improving,making_better|Root=.h_s_n|Translit=taḥsīni|LTranslit=taḥsīn
63	الاقتصاد	اِقتِصَاد	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	62	nmod	62:nmod	Vform=اَلِاقتِصَادِ|Gloss=economy,saving|Root=q_.s_d|Translit=al-i-ʼqtiṣādi|LTranslit=iqtiṣād
64	و	وَ	CCONJ	C---------	_	65	cc	65:cc	Vform=وَ|Gloss=and|Root=wa|Translit=wa|LTranslit=wa
65	التعليم	تَعلِيم	NOUN	N------S2D	Case=Gen|Definite=Def|Number=Sing	63	conj	62:nmod|63:conj	Vform=اَلتَّعلِيمِ|Gloss=education,teaching,instructions,precepts|Root=`_l_m|Translit=at-taʿlīmi|LTranslit=taʿlīm
66	و	وَ	CCONJ	C---------	_	67	cc	67:cc	Vform=وَ|Gloss=and|Root=wa|Translit=wa|LTranslit=wa
67	الطبابة	طِبَابَة	NOUN	N------S1D	Case=Nom|Definite=Def|Number=Sing	63	conj	62:nmod|63:conj	Vform=اَلطِّبَابَةُ|Gloss=medical_profession,medical_treatment|Root=.t_b_b|Translit=aṭ-ṭibābatu|LTranslit=ṭibābat
68	و	وَ	CCONJ	C---------	_	69	cc	69:cc	Vform=وَ|Gloss=and|Root=wa|Translit=wa|LTranslit=wa
69	المؤسسات	مُؤَسَّسَة	NOUN	N------P2D	Case=Gen|Definite=Def|Number=Plur	63	conj	62:nmod|63:conj	Vform=اَلمُؤَسَّسَاتِ|Gloss=institution,organization,foundation|Root='_s_s|Translit=al-muʾassasāti|LTranslit=muʾassasat
70	على	عَلَى	ADP	P---------	AdpType=Prep	71	case	71:case	Vform=عَلَى|Gloss=on,above|Root=`_l_w|Translit=ʿalā|LTranslit=ʿalā
71	أنواع	نَوع	NOUN	N------P2R	Case=Gen|Definite=Cons|Number=Plur	69	nmod	69:nmod	Vform=أَنوَاعِ|Gloss=type,kind,form|Root=n_w_`|Translit=ʾanwāʿi|LTranslit=nawʿ
72	ها	هُوَ	PRON	SP---3FS2-	Case=Gen|Gender=Fem|Number=Sing|Person=3|PronType=Prs	71	nmod	71:nmod	Vform=هَا|Gloss=he,she,it|Translit=hā|LTranslit=huwa
