---
layout: base
title:  'Statistics of Poss in UD_Phrygian-KUL'
udver: '2'
---

## Treebank Statistics: UD_Phrygian-KUL: Features: `Poss`
...
3 <tt><a href="xpg_kul-pos-PRON.html">PRON</a></tt> tokens (2% of all `PRON` tokens) have a non-empty value of `Poss`.

The most frequent other feature values with which `PRON` and `Poss` co-occurred: <tt><a href="xpg_kul-feat-ExtPos.html">ExtPos</a></tt><tt>=EMPTY</tt> (3; 100%), <tt><a href="xpg_kul-feat-Number.html">Number</a></tt><tt>=Sing</tt> (3; 100%), <tt><a href="xpg_kul-feat-Gender.html">Gender</a></tt><tt>=Fem</tt> (2; 67%), <tt><a href="xpg_kul-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (2; 67%).
