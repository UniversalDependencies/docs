...
`ADJ` occurs with 4 features: <tt><a href="gl_treegal-feat-Number.html">Number</a></tt> (1700; 99% instances), <tt><a href="gl_treegal-feat-Gender.html">Gender</a></tt> (1695; 98% instances), <tt><a href="gl_treegal-feat-Degree.html">Degree</a></tt> (40; 2% instances), <tt><a href="gl_treegal-feat-ExtPos.html">ExtPos</a></tt> (1; 0% instances)

`ADJ` occurs with 8 feature-value pairs: `Degree=Cmp`, `Degree=Sup`, `ExtPos=ADP`, `Gender=Com`, `Gender=Fem`, `Gender=Masc`, `Number=Plur`, `Number=Sing`
