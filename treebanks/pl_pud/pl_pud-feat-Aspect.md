...
387 <tt><a href="pl_pud-pos-AUX.html">AUX</a></tt> tokens (85% of all `AUX` tokens) have a non-empty value of `Aspect`.

The most frequent other feature values with which `AUX` and `Aspect` co-occurred: <tt><a href="pl_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (345; 89%), <tt><a href="pl_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (345; 89%), <tt><a href="pl_pud-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (331; 86%), <tt><a href="pl_pud-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (304; 79%), <tt><a href="pl_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (280; 72%), <tt><a href="pl_pud-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (228; 59%).

`AUX` tokens may have the following values of `Aspect`:

* `Imp` (310; 80% of non-empty `Aspect`): <em>jest, był, są, będzie, było, była, były, em, być, będą</em>
