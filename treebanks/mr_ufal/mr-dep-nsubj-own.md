---
layout: base
title:  'Statistics of nsubj:own in UD_Marathi'
udver: '2'
---

## Treebank Statistics: UD_Marathi: Relations: `nsubj:own`

This relation is a language-specific subtype of <tt><a href="mr-dep-nsubj.html">nsubj</a></tt>.
There are also 1 other language-specific subtypes of `nsubj`: <tt><a href="mr-dep-nsubj-pass.html">nsubj:pass</a></tt>.
...
The following 2 pairs of parts of speech are connected with `nsubj:own`: <tt><a href="mr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="mr-pos-PROPN.html">PROPN</a></tt> (3; 75% instances), <tt><a href="mr-pos-NOUN.html">NOUN</a></tt>-<tt><a href="mr-pos-PRON.html">PRON</a></tt> (1; 25% instances).
...
8	आहे	असणे	AUX	_	Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	4	cop	_	_
...
1	नाही	नाही	INTJ	_	_	5	vocative	_	_
...
7	आहे	असणे	AUX	_	Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	5	cop	_	_
