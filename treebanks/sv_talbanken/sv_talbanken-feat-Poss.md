---
layout: base
title:  'Statistics of Poss in UD_Swedish-Talbanken'
udver: '2'
---

## Treebank Statistics: UD_Swedish-Talbanken: Features: `Poss`
...
The feature is used with 1 part-of-speech tags: <tt><a href="sv_talbanken-pos-PRON.html">PRON</a></tt> (703; 1% instances).
...
* `EMPTY` (5969): <em>det, som, man, de, sig, vi, den, du, detta, dem</em>
...
<tt>PRON --[<tt><a href="sv_talbanken-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (2; 100%).
