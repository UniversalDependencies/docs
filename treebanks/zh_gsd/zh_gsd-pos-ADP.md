...
There are 170 `ADP` lemmas (1%), 170 `ADP` types (1%) and 5629 `ADP` tokens (5%).
...
The form / lemma ratio of `ADP` is 1.000000 (the average of all parts of speech is 1.004819).
