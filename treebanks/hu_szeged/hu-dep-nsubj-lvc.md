---
layout: base
title:  'Statistics of nsubj:lvc in UD_Hungarian'
udver: '2'
---

## Treebank Statistics: UD_Hungarian: Relations: `nsubj:lvc`

This relation is a language-specific subtype of <tt><a href="hu-dep-nsubj.html">nsubj</a></tt>.
...
The following 1 pairs of parts of speech are connected with `nsubj:lvc`: <tt><a href="hu-pos-VERB.html">VERB</a></tt>-<tt><a href="hu-pos-NOUN.html">NOUN</a></tt> (3; 100% instances).
