---
layout: base
title:  'Statistics of discourse in UD_Polish-PDB'
udver: '2'
---

## Treebank Statistics: UD_Polish-PDB: Relations: `discourse`

This relation is universal.
There are 1 language-specific subtypes of `discourse`: <tt><a href="pl_pdb-dep-discourse-intj.html">discourse:intj</a></tt>.

8 nodes (0%) are attached to their parents as `discourse`.

8 instances of `discourse` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 7.625.

The following 2 pairs of parts of speech are connected with `discourse`: <tt><a href="pl_pdb-pos-VERB.html">VERB</a></tt>-<tt><a href="pl_pdb-pos-SYM.html">SYM</a></tt> (6; 75% instances), <tt><a href="pl_pdb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="pl_pdb-pos-SYM.html">SYM</a></tt> (2; 25% instances).
...
9	:-)	:-)	SYM	sym	_	2	discourse	2:discourse|6:discourse	_
...
# visual-style 18 23 discourse	color:blue
...
23	:)))))))))	:)	SYM	sym	_	18	discourse	18:discourse	_
