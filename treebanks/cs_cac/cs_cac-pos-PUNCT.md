...
There are 11 `PUNCT` lemmas (0%), 10 `PUNCT` types (0%) and 60208 `PUNCT` tokens (12%).
Out of 17 observed tags, the rank of `PUNCT` is: 13 in number of lemmas, 14 in number of types and 3 in number of tokens.

The 10 most frequent `PUNCT` lemmas: <em>,, ., -, ", ?, :, (, ), že, '</em>

The 10 most frequent `PUNCT` types:  <em>,, ., -, ", ?, :, (, ), ', /</em>

The 10 most frequent ambiguous lemmas: <em>že</em> (<tt><a href="cs_cac-pos-SCONJ.html">SCONJ</a></tt> 2876, <tt><a href="cs_cac-pos-PUNCT.html">PUNCT</a></tt> 3)
