---
layout: base
title:  'Statistics of ccomp in UD_Upper_Sorbian'
udver: '2'
---

## Treebank Statistics: UD_Upper_Sorbian: Relations: `ccomp`

This relation is universal.

13 nodes (0%) are attached to their parents as `ccomp`.

12 instances of `ccomp` (92%) are left-to-right (parent precedes child).
Average distance between parent and child is 7.61538461538461.

The following 3 pairs of parts of speech are connected with `ccomp`: <tt><a href="hsb-pos-VERB.html">VERB</a></tt>-<tt><a href="hsb-pos-VERB.html">VERB</a></tt> (11; 85% instances), <tt><a href="hsb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hsb-pos-VERB.html">VERB</a></tt> (1; 8% instances), <tt><a href="hsb-pos-VERB.html">VERB</a></tt>-<tt><a href="hsb-pos-ADJ.html">ADJ</a></tt> (1; 8% instances).
