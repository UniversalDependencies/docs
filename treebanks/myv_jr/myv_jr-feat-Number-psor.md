...
988 tokens (5%) have a non-empty value of `Number[psor]`.
640 types (10%) occur at least once with a non-empty value of `Number[psor]`.
353 lemmas (11%) occur at least once with a non-empty value of `Number[psor]`.
...
805 <tt><a href="myv_jr-pos-NOUN.html">NOUN</a></tt> tokens (16% of all `NOUN` tokens) have a non-empty value of `Number[psor]`.

The most frequent other feature values with which `NOUN` and `Number[psor]` co-occurred: <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (797; 99%), <tt><a href="myv_jr-feat-Person-psor.html">Person[psor]</a></tt><tt>=3</tt> (623; 77%).
...
`Number[psor]` seems to be **lexical feature** of `VERB`. 94% lemmas (33) occur only with one value of `Number[psor]`.
