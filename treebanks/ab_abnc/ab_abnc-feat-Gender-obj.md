...
70 tokens (1%) have a non-empty value of `Gender[obj]`.
66 types (2%) occur at least once with a non-empty value of `Gender[obj]`.
42 lemmas (2%) occur at least once with a non-empty value of `Gender[obj]`.
The feature is used with 1 part-of-speech tags: <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> (70; 1% instances).

### `VERB`

70 <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> tokens (2% of all `VERB` tokens) have a non-empty value of `Gender[obj]`.

The most frequent other feature values with which `VERB` and `Gender[obj]` co-occurred: <tt><a href="ab_abnc-feat-Dyn.html">Dyn</a></tt><tt>=Yes</tt> (69; 99%), <tt><a href="ab_abnc-feat-Person-io.html">Person[io]</a></tt><tt>=EMPTY</tt> (68; 97%), <tt><a href="ab_abnc-feat-Gender-lo.html">Gender[lo]</a></tt><tt>=EMPTY</tt> (63; 90%), <tt><a href="ab_abnc-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (63; 90%), <tt><a href="ab_abnc-feat-Number-lo.html">Number[lo]</a></tt><tt>=EMPTY</tt> (62; 89%), <tt><a href="ab_abnc-feat-Person-lo.html">Person[lo]</a></tt><tt>=EMPTY</tt> (61; 87%), <tt><a href="ab_abnc-feat-RelType.html">RelType</a></tt><tt>=EMPTY</tt> (58; 83%), <tt><a href="ab_abnc-feat-Subcat.html">Subcat</a></tt><tt>=Tran</tt> (57; 81%), <tt><a href="ab_abnc-feat-Person-obj.html">Person[obj]</a></tt><tt>=3</tt> (47; 67%), <tt><a href="ab_abnc-feat-Gender-subj.html">Gender[subj]</a></tt><tt>=EMPTY</tt> (42; 60%).
