...
26239 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (83% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (19517; 74%), <tt><a href="fr_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (15071; 57%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (15070; 57%), <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13555; 52%).
...
* `Pres` (12322; 47% of non-empty `Tense`): <em>a, peut, fait, trouve, devient, doit, ont, permet, agit, faut</em>
* `EMPTY` (5534): <em>faire, partir, voir, prendre, avoir, mettre, passer, trouver, aller, dire</em>
