---
layout: base
title:  'Statistics of compound:lvc in UD_Pashto-Sikaram'
udver: '2'
---
...
# visual-style 1 4 compound:lvc	color:blue
1	نو	نو	ADV	_	_	5	advmod	_	Translit=no|LTranslit=no|Gloss=so
2	که	کۀ	SCONJ	_	_	5	mark	_	Translit=kë|LTranslit=kë|Gloss=if
3	وحید	وحید	PROPN	_	Case=Nom|Gender=Masc|Number=Sing	5	nsubj	_	Translit=wahíd|LTranslit=wahíd|Gloss=Wahid
4	اوچت	اوچت	ADJ	_	Case=Nom|Gender=Masc|Number=Sing	1	compound:lvc	_	Translit=učát|LTranslit=učát|Gloss=lifted
5	کېږي	کېدل	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	12	advcl	_	Translit=kéǧi|LTranslit=kedë́l|Gloss=becomes
6	او	او	CCONJ	_	_	8	cc	_	Translit=aw|LTranslit=aw|Gloss=and
7	احمد	احمد	PROPN	_	Case=Nom|Gender=Masc|Number=Sing	8	obj	_	Translit=ahmád|LTranslit=ahmád|Gloss=Ahmad
8	وهي	وهل	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	5	conj	_	Translit=wahí|LTranslit=wahë́l|Gloss=beat|SpaceAfter=No
9	،	،	PUNCT	_	_	5	punct	_	Translit=,|LTranslit=,|Gloss=,
10	بايد	بايد	PART	_	_	12	advmod	_	Translit=bâyád|LTranslit=bâyád|Gloss=should
11	داسې	داسې	ADV	_	Deixis=Prox|PronType=Dem	12	advmod	_	Translit=dấse|LTranslit=dấse|Gloss=so
12	ولیکل	لیکل	VERB	_	Aspect=Perf|Case=Nom|VerbForm=Inf	0	root	_	Translit=wë́likël|LTranslit=likë́l|Gloss=written
13	شي	کېدل	AUX	_	Mood=Sub|Number=Sing|Person=3|VerbForm=Fin	12	aux:pass	_	Translit=ši|LTranslit=kedë́l|Gloss=is|SpaceAfter=No
14	:	:	PUNCT	_	_	12	punct	_	Translit=:|LTranslit=:|Gloss=:|SpaceAfter=No
