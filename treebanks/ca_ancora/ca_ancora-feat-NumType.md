...
9233 <tt><a href="ca_ancora-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

The most frequent other feature values with which `NUM` and `NumType` co-occurred: <tt><a href="ca_ancora-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (7876; 85%), <tt><a href="ca_ancora-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (6579; 71%), <tt><a href="ca_ancora-feat-NumForm.html">NumForm</a></tt><tt>=Digit</tt> (6067; 66%).

`NUM` tokens may have the following values of `NumType`:

* `Card` (9219; 100% of non-empty `NumType`): <em>dos, tres, cent, dues, quatre, un, cinc, nou, 10, sis</em>
...
580 <tt><a href="ca_ancora-pos-SYM.html">SYM</a></tt> tokens (71% of all `SYM` tokens) have a non-empty value of `NumType`.
...
<tt>NUM --[<tt><a href="ca_ancora-dep-conj.html">conj</a></tt>]--> NUM</tt> (241; 98%),
