...
42716 tokens (14%) have a non-empty value of `Definite`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="it_isdt-pos-DET.html">DET</a></tt> (42714; 14% instances), <tt><a href="it_isdt-pos-PRON.html">PRON</a></tt> (2; 0% instances).

### `DET`

42714 <tt><a href="it_isdt-pos-DET.html">DET</a></tt> tokens (88% of all `DET` tokens) have a non-empty value of `Definite`.

The most frequent other feature values with which `DET` and `Definite` co-occurred: <tt><a href="it_isdt-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (42711; 100%), <tt><a href="it_isdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (31966; 75%), <tt><a href="it_isdt-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (22074; 52%).
