...
There are 88 `ADP` lemmas (0%), 87 `ADP` types (0%) and 33792 `ADP` tokens (15%).
...
The form / lemma ratio of `ADP` is 0.988636 (the average of all parts of speech is 1.414899).
