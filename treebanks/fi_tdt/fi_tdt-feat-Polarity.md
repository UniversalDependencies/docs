...
2383 <tt><a href="fi_tdt-pos-AUX.html">AUX</a></tt> tokens (20% of all `AUX` tokens) have a non-empty value of `Polarity`.

The most frequent other feature values with which `AUX` and `Polarity` co-occurred: <tt><a href="fi_tdt-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (2383; 100%), <tt><a href="fi_tdt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (2383; 100%), <tt><a href="fi_tdt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (2383; 100%), <tt><a href="fi_tdt-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (2351; 99%), <tt><a href="fi_tdt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2070; 87%), <tt><a href="fi_tdt-feat-Person.html">Person</a></tt><tt>=3</tt> (1940; 81%).

`AUX` tokens may have the following values of `Polarity`:

* `Neg` (2383; 100% of non-empty `Polarity`): <em>ei, en, eivät, eikä, emme, et, enkä, älä, eikö, eivätkä</em>
* `EMPTY` (9727): <em>on, oli, ovat, ole, voi, olisi, olla, ollut, olivat, voidaan</em>
