...
9	la	él	PRON	PRON	Case=Acc|Gender=Fem|Number=Sing|Person=3|PrepCase=Npr|PronType=Prs	10	obj	_	_
...
27	tono	tono	NOUN	NOUN	Gender=Masc|Number=Sing	25	obl	_	_
...
32	Qué	qué	PRON	PRON	Number=Sing|PronType=Int,Rel	35	nsubj	_	_
...
35	zoco	zoco	NOUN	NOUN	Gender=Masc|Number=Sing	25	ccomp	_	SpaceAfter=No
36	?	?	PUNCT	PUNCT	PunctSide=Fin|PunctType=Qest	35	punct	_	_
37	Todo	todo	DET	DET	Gender=Masc|Number=Sing|PronType=Tot	38	det	_	_
