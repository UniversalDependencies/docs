...
The most frequent other feature values with which `DET` and `Poss` co-occurred: <tt><a href="PronType.html">PronType</a>=Prs</tt> (1735; 100%), <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (1735; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (1078; 62%).

`DET` tokens may have the following values of `Poss`:

* `Yes` (1735; 100% of non-empty `Poss`): <em>sua, suo, loro, suoi, sue, proprio, nostra, mio, nostro, propria</em>
* `EMPTY` (41966): <em>il, la, l', i, le, un, una, gli, lo, quale</em>
...
The most frequent other feature values with which `PRON` and `Poss` co-occurred: <tt><a href="PronType.html">PronType</a>=Prs</tt> (33; 100%), <tt><a href="Person.html">Person</a>=EMPTY</tt> (33; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (23; 70%), <tt><a href="Gender.html">Gender</a>=Masc</tt> (22; 67%).

`PRON` tokens may have the following values of `Poss`:

* `Yes` (33; 100% of non-empty `Poss`): <em>sua, suo, suoi, proprio, tuo, mia, miei, mio, nostro, tua</em>
* `EMPTY` (10801): <em>si, che, chi, cui, ci, lo, ne, qual, quanto, mi</em>
