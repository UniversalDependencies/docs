---
layout: base
title:  'Statistics of X in UD_Mbya_Guarani-Dooley'
udver: '2'
---

## Treebank Statistics: UD_Mbya_Guarani-Dooley: POS Tags: `X`

There are 1 `X` lemmas (1%), 1 `X` types (1%) and 8 `X` tokens (0%).
Out of 16 observed tags, the rank of `X` is: 16 in number of lemmas, 16 in number of types and 15 in number of tokens.
...
The form / lemma ratio of `X` is 1.000000 (the average of all parts of speech is 1.056452).
...
`X` nodes are attached to their parents using 2 different relations: <tt><a href="gun_dooley-dep-dep.html">dep</a></tt> (7; 88% instances), <tt><a href="gun_dooley-dep-parataxis-rep.html">parataxis:rep</a></tt> (1; 13% instances)

Parents of `X` nodes belong to 2 different parts of speech: <tt><a href="gun_dooley-pos-X.html">X</a></tt> (7; 88% instances), <tt><a href="gun_dooley-pos-VERB.html">VERB</a></tt> (1; 13% instances)
...
Children of `X` nodes are attached using 3 different relations: <tt><a href="gun_dooley-dep-dep.html">dep</a></tt> (7; 70% instances), <tt><a href="gun_dooley-dep-punct.html">punct</a></tt> (2; 20% instances), <tt><a href="gun_dooley-dep-parataxis.html">parataxis</a></tt> (1; 10% instances)

Children of `X` nodes belong to 3 different parts of speech: <tt><a href="gun_dooley-pos-X.html">X</a></tt> (7; 70% instances), <tt><a href="gun_dooley-pos-PUNCT.html">PUNCT</a></tt> (2; 20% instances), <tt><a href="gun_dooley-pos-VERB.html">VERB</a></tt> (1; 10% instances)
