...
1	a	à	PRON	pers	Number=Sing|Person=3|PronType=Prs	5	nsubj	_	Gloss=3SG
2	ye	ye	AUX	pm	Aspect=Perf|Polarity=Pos|Valency=2	5	aux	_	Gloss=PFV.TR
3	muso	mùso	NOUN	n	_	5	obj	_	Gloss=femme
4	kònòntò	kɔ̀nɔntɔn	NUM	num	_	3	nummod	_	Gloss=neuf
5	furu	fúru	VERB	v	_	0	root	_	Gloss=épouser|SpaceAfter=No
...
2	o	ò	PRON	prn	_	5	nsubj	_	Gloss=ce
3	kelen	kélen	NUM	num	_	2	nummod	_	Gloss=un
...
3	na	ná	ADP	pp	_	2	case	_	Gloss=dans|SpaceAfter=No
4	,	,	PUNCT	_	_	2	punct	_	Gloss=,
5	Amadu	Ámadù	PROPN	n.prop	_	8	nsubj	_	Gloss=NOM.M
6	Tara	Tara	PROPN	n.prop	_	5	flat	_	Gloss=NOM.CL
7	kelen	kélen	NUM	num	_	5	nummod	_	Gloss=un
8	tora	tora	VERB	v	Aspect=Perf|Polarity=Pos|Valency=1	0	root	_	Gloss=rester|Morf=rester,PFV.INTR
9	a	à	PRON	pers	Number=Sing|Person=3|PronType=Prs	10	nmod:poss	_	Gloss=3SG
10	fa	fà	NOUN	n	_	8	obl	_	Gloss=père
11	bolo	bólo	ADP	pp	_	10	case	_	Gloss=POSS|SpaceAfter=No
