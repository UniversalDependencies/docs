---
layout: base
title:  'Statistics of xcomp:lo in UD_Abkhaz-AbNC'
udver: '2'
---

## Treebank Statistics: UD_Abkhaz-AbNC: Relations: `xcomp:lo`

This relation is a language-specific subtype of <tt><a href="ab_abnc-dep-xcomp.html">xcomp</a></tt>.
There are also 1 other language-specific subtypes of `xcomp`: <tt><a href="ab_abnc-dep-xcomp-obj.html">xcomp:obj</a></tt>.

24 nodes (1%) are attached to their parents as `xcomp:lo`.

24 instances of `xcomp:lo` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `xcomp:lo`: <tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt>-<tt><a href="ab_abnc-pos-VERB.html">VERB</a></tt> (24; 100% instances).
...
# visual-style 7 6 xcomp:lo	color:blue
