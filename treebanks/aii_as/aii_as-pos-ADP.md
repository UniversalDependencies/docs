---
layout: base
title:  'Statistics of ADP in UD_Assyrian-AS'
udver: '2'
---

## Treebank Statistics: UD_Assyrian-AS: POS Tags: `ADP`

There are 14 `ADP` lemmas (6%), 13 `ADP` types (5%) and 38 `ADP` tokens (8%).
Out of 13 observed tags, the rank of `ADP` is: 6 in number of lemmas, 7 in number of types and 6 in number of tokens.

The 10 most frequent `ADP` lemmas: <em>ܠ, ܡܼܢ, ܕ, ܒ, ܓܵܘ, ܩܵܐ, ܒܸ, ܒܘܕ, ܒܘܼܬ, ܒܵܬܪ</em>
...
The form / lemma ratio of `ADP` is 0.928571 (the average of all parts of speech is 1.044000).

The 1st highest number of forms (2) was observed with the lemma “ܡܼܢ”: <em>ܡ̣ܢ, ܡܼܢ</em>.

The 2nd highest number of forms (1) was observed with the lemma “ܒ”: <em>ܒ</em>.

The 3rd highest number of forms (1) was observed with the lemma “ܒܘܕ”: <em>ܒܘܕ</em>.
...
`ADP` nodes are attached to their parents using 1 different relations: <tt><a href="aii_as-dep-case.html">case</a></tt> (38; 100% instances)

Parents of `ADP` nodes belong to 4 different parts of speech: <tt><a href="aii_as-pos-NOUN.html">NOUN</a></tt> (28; 74% instances), <tt><a href="aii_as-pos-PRON.html">PRON</a></tt> (5; 13% instances), <tt><a href="aii_as-pos-ADV.html">ADV</a></tt> (3; 8% instances), <tt><a href="aii_as-pos-PROPN.html">PROPN</a></tt> (2; 5% instances)

38 (100%) `ADP` nodes are leaves.
