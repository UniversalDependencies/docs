...
1	@screened-15	@screened-15	PROPN	_	NameType=Prs	4	vocative	_	_
2	вот	вот	PART	_	_	4	advmod	_	_
3	это	это	PRON	_	Animacy=Inan|Case=Nom|Gender=Neut|Number=Sing|PronType=Dem	4	nsubj	_	_
...
1	Расшарьте	расшарить	VERB	_	Aspect=Perf|Mood=Imp|Number=Plur|Person=2|VerbForm=Fin|Voice=Act	0	root	_	SpaceAfter=No
2	,	,	PUNCT	_	_	3	punct	_	SpaceAfter=No
3	пожалуйста	пожалуйста	PART	_	_	1	discourse	_	SpaceAfter=No
