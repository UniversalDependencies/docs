...
61 tokens (0%) have a non-empty value of `Gender`.
33 types (0%) occur at least once with a non-empty value of `Gender`.
8 lemmas (0%) occur at least once with a non-empty value of `Gender`.
The feature is used with 2 part-of-speech tags: [eu-pos/AUX]() (32; 0% instances), [eu-pos/VERB]() (29; 0% instances).

### `AUX`

32 [eu-pos/AUX]() tokens (0% of all `AUX` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `AUX` and `Gender` co-occurred: <tt><a href="Mood.html">Mood</a>=Ind</tt> (31; 97%), <tt><a href="Number[abs].html">Number[abs]</a>=Sing</tt> (30; 94%), <tt><a href="Person[abs].html">Person[abs]</a>=3</tt> (28; 88%), <tt><a href="Aspect.html">Aspect</a>=EMPTY</tt> (23; 72%), <tt><a href="Number[erg].html">Number[erg]</a>=Sing</tt> (17; 53%).

`AUX` tokens may have the following values of `Gender`:

* `Fem` (19; 59% of non-empty `Gender`): <em>dinat, dun, din, naun, zion, ditin, gintunan, zaidan, zezaken, zien</em>
* `Masc` (13; 41% of non-empty `Gender`): <em>duk, diat, nian, nauk, zegoan, zegok</em>
* `EMPTY` (9956): <em>da, zuen, zen, du, dira, dute, izan, zuten, ziren, ditu</em>

<table>
  <tr><th>Paradigm <i>*edun</i></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th></tr>
  <tr><td><tt><a href="Number[abs].html">Number[abs]</a>=Plur|<a href="Number[erg].html">Number[erg]</a>=Sing|<a href="Person[abs].html">Person[abs]</a>=3|<a href="Person[erg].html">Person[erg]</a>=3</tt></td><td></td><td><em>ditin</em></td></tr>
  <tr><td><tt><a href="Number[abs].html">Number[abs]</a>=Plur|<a href="Person[abs].html">Person[abs]</a>=1</tt></td><td></td><td><em>gintunan</em></td></tr>
  ...
  <tr><td><tt><a href="Number[abs].html">Number[abs]</a>=Sing|<a href="Number[erg].html">Number[erg]</a>=Sing|<a href="Person[abs].html">Person[abs]</a>=3|<a href="Person[erg].html">Person[erg]</a>=3</tt></td><td></td><td><em>din, zinan</em></td></tr>
...
* `Fem` (18; 62% of non-empty `Gender`): <em>dun, dinat, niken, baditinagu, baditinat, bazaukan, dakinat, din, dinagu, naun</em>
* `Masc` (11; 38% of non-empty `Gender`): <em>duk, zekiat, dik, ditik, dituk, gaudek, zeramatzaan, zeramatzak, zian</em>
* `EMPTY` (15246): <em>egin, izan, esan, egiten, du, izango, eman, da, dago, joan</em>

<table>
  <tr><th>Paradigm <i>ukan</i></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Cnd|<a href="Number[abs].html">Number[abs]</a>=Sing|<a href="Number[erg].html">Number[erg]</a>=Sing|<a href="Person[abs].html">Person[abs]</a>=3|<a href="Person[erg].html">Person[erg]</a>=1</tt></td><td></td><td><em>niken</em></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number[abs].html">Number[abs]</a>=Plur|<a href="Number[erg].html">Number[erg]</a>=Plur|<a href="Person[abs].html">Person[abs]</a>=3|<a href="Person[erg].html">Person[erg]</a>=1|<a href="Polarity.html">Polarity</a>=Pos</tt></td><td></td><td><em>baditinagu</em></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number[abs].html">Number[abs]</a>=Plur|<a href="Number[erg].html">Number[erg]</a>=Sing|<a href="Person[abs].html">Person[abs]</a>=3|<a href="Person[erg].html">Person[erg]</a>=1|<a href="Polarity.html">Polarity</a>=Pos</tt></td><td></td><td><em>baditinat</em></td></tr>
  <tr><td><tt><a href="Mood.html">Mood</a>=Ind|<a href="Number[abs].html">Number[abs]</a>=Plur|<a href="Number[erg].html">Number[erg]</a>=Sing|<a href="Person[abs].html">Person[abs]</a>=3|<a href="Person[erg].html">Person[erg]</a>=3</tt></td><td><em>ditik</em></td><td></td></tr>
