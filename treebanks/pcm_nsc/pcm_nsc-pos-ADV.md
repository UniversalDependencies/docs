...
There are 171 `ADV` lemmas (4%), 176 `ADV` types (3%) and 6160 `ADV` tokens (4%).
...
The form / lemma ratio of `ADV` is 1.029240 (the average of all parts of speech is 1.162049).
