...
48217 tokens (11%) have a non-empty value of `Person`.
5876 types (7%) occur at least once with a non-empty value of `Person`.
1822 lemmas (4%) occur at least once with a non-empty value of `Person`.
The feature is used with 6 part-of-speech tags: <tt><a href="et_edt-pos-VERB.html">VERB</a></tt> (25086; 6% instances), <tt><a href="et_edt-pos-AUX.html">AUX</a></tt> (14188; 3% instances), <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> (8940; 2% instances), <tt><a href="et_edt-pos-DET.html">DET</a></tt> (1; 0% instances), <tt><a href="et_edt-pos-NOUN.html">NOUN</a></tt> (1; 0% instances), <tt><a href="et_edt-pos-PROPN.html">PROPN</a></tt> (1; 0% instances).

### `VERB`

25086 <tt><a href="et_edt-pos-VERB.html">VERB</a></tt> tokens (53% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="et_edt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (25086; 100%), <tt><a href="et_edt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (25085; 100%), <tt><a href="et_edt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (24301; 97%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (19397; 77%), <tt><a href="et_edt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (13935; 56%).

`VERB` tokens may have the following values of `Person`:

* `1` (2830; 11% of non-empty `Person`): <em>arvan, sain, mõtlesin, tean, ütlesin, nägin, tegin, mäletan, vaatan, läksin</em>
* `2` (1114; 4% of non-empty `Person`): <em>vaata, tule, tahad, mine, tead, lähed, kuule, saad, näe, pane</em>
* `3` (21142; 84% of non-empty `Person`): <em>on, tuleb, ütles, sai, tuli, jääb, saab, läks, jäi, ütleb</em>
* `EMPTY` (22588): <em>teha, saada, saanud, teada, võtta, näha, pole, öelda, jäänud, kasutada</em>
...
14188 <tt><a href="et_edt-pos-AUX.html">AUX</a></tt> tokens (65% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="et_edt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (14188; 100%), <tt><a href="et_edt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (14188; 100%), <tt><a href="et_edt-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (14151; 100%), <tt><a href="et_edt-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13914; 98%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (11228; 79%), <tt><a href="et_edt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (11153; 79%).

`AUX` tokens may have the following values of `Person`:

* `1` (671; 5% of non-empty `Person`): <em>olen, oleme, olin, pean, peame, olime, võime, saame, peaksime, oleksin</em>
* `2` (259; 2% of non-empty `Person`): <em>oled, olete, olid, ära, võid, ole, pead, ärge, võite, peate</em>
* `3` (13258; 93% of non-empty `Person`): <em>on, oli, võib, olid, saab, peab, võivad, ongi, pidi, võis</em>
* `EMPTY` (7799): <em>ei, pole, ole, oleks, olnud, olla, peaks, saa, olema, polnud</em>
...
8940 <tt><a href="et_edt-pos-PRON.html">PRON</a></tt> tokens (39% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="et_edt-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (8940; 100%), <tt><a href="et_edt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (6232; 70%), <tt><a href="et_edt-feat-Case.html">Case</a></tt><tt>=Nom</tt> (4696; 53%).

`PRON` tokens may have the following values of `Person`:

* `1` (3241; 36% of non-empty `Person`): <em>ma, meie, me, minu, mul, mind, mina, meil, mulle, mu</em>
* `2` (821; 9% of non-empty `Person`): <em>sa, te, teie, sinu, sul, sulle, sind, sina, su, teid</em>
* `3` (4878; 55% of non-empty `Person`): <em>ta, tema, nad, nende, talle, tal, teda, neid, neil, neile</em>
* `EMPTY` (13841): <em>see, mis, oma, kes, seda, mida, selle, midagi, mille, nende</em>
...
* `EMPTY` (114702): <em>aasta, aastal, aastat, raha, osa, krooni, korda, ajal, sissetulekute, mõju</em>
...
* `EMPTY` (26402): <em>eesti, Eestis, Euroopa, Tartu, Tallinna, Peeter, Maa, Vene, Jan, Venemaa</em>

## Relations with Agreement in `Person`

The 10 most frequent relations where parent and child node agree in `Person`:
<tt>VERB --[<tt><a href="et_edt-dep-conj.html">conj</a></tt>]--> VERB</tt> (2549; 61%),
