...
10081 <tt><a href="ar_padt-pos-VERB.html">VERB</a></tt> tokens (47% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="ar_padt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (10081; 100%), <tt><a href="ar_padt-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (10029; 99%), <tt><a href="ar_padt-feat-Person.html">Person</a></tt><tt>=3</tt> (9750; 97%), <tt><a href="ar_padt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (9323; 92%), <tt><a href="ar_padt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9299; 92%), <tt><a href="ar_padt-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (5932; 59%).
...
197 <tt><a href="ar_padt-pos-AUX.html">AUX</a></tt> tokens (9% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="ar_padt-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (195; 99%), <tt><a href="ar_padt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (195; 99%), <tt><a href="ar_padt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (193; 98%), <tt><a href="ar_padt-feat-Person.html">Person</a></tt><tt>=3</tt> (189; 96%), <tt><a href="ar_padt-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (113; 57%).
...
<tt>VERB --[<tt><a href="ar_padt-dep-conj.html">conj</a></tt>]--> VERB</tt> (745; 56%),
