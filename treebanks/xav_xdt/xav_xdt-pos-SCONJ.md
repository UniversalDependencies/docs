...
There are 5 `SCONJ` lemmas (1%), 5 `SCONJ` types (1%) and 13 `SCONJ` tokens (1%).
Out of 15 observed tags, the rank of `SCONJ` is: 9 in number of lemmas, 11 in number of types and 12 in number of tokens.

The 10 most frequent `SCONJ` lemmas: <em>tahawa, wamhã, wa, dzarina, dzô</em>
...
The 2nd highest number of forms (1) was observed with the lemma “dzô”: <em>dzô</em>.

The 3rd highest number of forms (1) was observed with the lemma “tahawa”: <em>Tahawa</em>.
...
`SCONJ` nodes are attached to their parents using 1 different relations: <tt><a href="xav_xdt-dep-mark.html">mark</a></tt> (13; 100% instances)

Parents of `SCONJ` nodes belong to 3 different parts of speech: <tt><a href="xav_xdt-pos-VERB.html">VERB</a></tt> (7; 54% instances), <tt><a href="xav_xdt-pos-NOUN.html">NOUN</a></tt> (5; 38% instances), <tt><a href="xav_xdt-pos-ADV.html">ADV</a></tt> (1; 8% instances)
