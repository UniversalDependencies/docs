...
The feature is used with 3 part-of-speech tags: <tt><a href="cs-pos-DET.html">DET</a></tt> (56465; 4% instances), <tt><a href="cs-pos-PRON.html">PRON</a></tt> (44925; 3% instances), <tt><a href="cs-pos-ADV.html">ADV</a></tt> (12441; 1% instances).

### `DET`

56465 <tt><a href="cs-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="cs-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (49478; 88%), <tt><a href="cs-feat-Number-psor.html">Number[psor]</a></tt><tt>=EMPTY</tt> (47050; 83%), <tt><a href="cs-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (47048; 83%), <tt><a href="cs-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (42148; 75%), <tt><a href="cs-feat-Number.html">Number</a></tt><tt>=Sing</tt> (36210; 64%).
...
* `Neg` (831; 1% of non-empty `PronType`): <em>žádné, žádný, žádná, žádnou, žádném, žádným, žádného, žádnému, žádných, žádnými</em>
...
The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="cs-feat-PrepCase.html">PrepCase</a></tt><tt>=EMPTY</tt> (40000; 89%), <tt><a href="cs-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (36993; 82%), <tt><a href="cs-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (33795; 75%), <tt><a href="cs-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (31316; 70%), <tt><a href="cs-feat-Case.html">Case</a></tt><tt>=Acc</tt> (27397; 61%), <tt><a href="cs-feat-Variant.html">Variant</a></tt><tt>=Short</tt> (27181; 61%), <tt><a href="cs-feat-Reflex.html">Reflex</a></tt><tt>=Yes</tt> (25786; 57%).
