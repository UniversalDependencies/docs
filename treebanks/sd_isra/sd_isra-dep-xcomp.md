---
layout: base
title:  'Statistics of xcomp in UD_Sindhi-Isra'
udver: '2'
---

## Treebank Statistics: UD_Sindhi-Isra: Relations: `xcomp`
...
1	منجهانئس	منجهان	ADP	PSPX	Case=Acc|Number=Sing|Person=3	6	obl	_	_
...
1	تنهن	تنهن	PRON	PRP	Case=Acc|Number=Sing|Person=2	7	nsubj	_	_
2	يڪدم	يڪدم	ADV	ADM	_	3	advmod	_	_
3	کڻي	کڻي	VERB	VM	Aspect=Perf|VerbForm=Conv	7	advcl	_	_
4	پاڻيءَ	پاڻيءَ	NOUN	NN	Case=Acc|Gender=Masc|Number=Sing	7	obl	_	_
5	۾	۾	ADP	PSPL	_	4	case	_	_
6	منهن	منهن	NOUN	NN	Case=Nom|Gender=Masc|Number=Sing	7	xcomp	_	_
7	هنيو	ھڻ	VERB	VM	Aspect=Perf|Gender=Masc|Number=Sing|Person=3	0	root	_	_
