...
The form / lemma ratio of `ADJ` is 1.250000 (the average of all parts of speech is 1.992447).
...
383 (66%) `ADJ` nodes are leaves.

76 (13%) `ADJ` nodes have one child.
