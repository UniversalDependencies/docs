...
-	Auxiliary use of *είμαι*  “to be” when a participle depends on it: *Το κείμενο <b>είναι γραμμένο</b> στην κυπριακή διάλεκτο* "the text is written in the Cypriot dialect"
