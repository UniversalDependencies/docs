---
layout: base
title:  'Statistics of flat:range in UD_Western_Armenian-ArmTDP'
udver: '2'
---

## Treebank Statistics: UD_Western_Armenian-ArmTDP: Relations: `flat:range`
...
# visual-style 3 4 flat:range	color:blue
...
6	նախորդ	նախորդ	ADJ	_	_	7	amod	_	Translit=naxord|LTranslit=naxord
7	տարուայ	տարի	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Sing	8	nmod:poss	_	Translit=taroway|LTranslit=tari
8	Սեպտեմբեր	Սեպտեմբեր	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Sing	9	nmod	_	Translit=September|LTranslit=September
9	ամսուն	ամիս	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Def|Number=Sing	10	obl	_	Translit=amsown|LTranslit=amis
10	սկսած	սկսիլ	VERB	_	Aspect=Perf|Polarity=Pos|Subcat=Intr|VerbForm=Part|Voice=Mid	14	acl	_	Translit=sksaç|LTranslit=sksil
11	Հայաստան	Հայաստան	PROPN	_	Animacy=Nhum|Case=Nom|Definite=Ind|NameType=Geo|Number=Sing	14	nmod	_	Translit=Hayastan|LTranslit=Hayastan|SpaceAfter=No
12	-	-	PUNCT	_	_	13	punct	_	Translit=-|LTranslit=-|SpaceAfter=No
13	Ատրպէյճան	Ատրպէյճան	PROPN	_	Animacy=Nhum|Case=Nom|Definite=Ind|NameType=Geo|Number=Sing	11	flat:range	_	Translit=Atrpēyč̣an|LTranslit=Atrpēyč̣an
14	պատերազմի	պատերազմ	NOUN	_	Animacy=Nhum|Case=Dat|Definite=Ind|Number=Sing	16	nmod:npmod	_	Translit=paterazmi|LTranslit=paterazm
15	մասին	մասին	ADP	_	AdpType=Post	14	case	_	Translit=masin|LTranslit=masin
16	յօդուածիս	յօդուած	NOUN	_	Animacy=Nhum|Case=Dat|Number=Sing|Number[psor]=Sing|Person[psor]=1	4	obl	_	Translit=yòdowaçis|LTranslit=yòdowaç
17	վրայ	վրայ	ADP	_	AdpType=Post	16	case	_	Translit=vray|LTranslit=vray|SpaceAfter=No
...
# visual-style 6 7 flat:range	color:blue
1	«	«	PUNCT	_	_	2	punct	_	Translit=«|LTranslit=«|SpaceAfter=No
2	Ակուլ	Ակուլ	X	_	_	8	nsubj	_	Translit=Akowl|LTranslit=Akowl
3	Տուկուլ	Տուկուլ	X	_	_	2	compound:redup	_	Translit=Towkowl|LTranslit=Towkowl|SpaceAfter=No
4	»	»	PUNCT	_	_	2	punct	_	Translit=»|LTranslit=»|SpaceAfter=No
5	ը	ը	NOUN	_	Animacy=Hum|Case=Nom|Definite=Def|Hyph=Yes|Number=Sing	2	dep	_	Translit=ë|LTranslit=ë
6	երկուքէն	երկուք	NOUN	_	Animacy=Nhum|Case=Abl|Definite=Def|Number=Coll	8	nmod:npmod	_	Translit=erkowk’ēn|LTranslit=erkowk’
7	վեց	վեց	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Ind|Number=Coll	6	flat:range	_	Translit=vec’|LTranslit=vec’
8	տարեկաններու	տարեկան	NOUN	_	Animacy=Hum|Case=Dat|Definite=Ind|Number=Plur	0	root	_	Translit=tarekannerow|LTranslit=tarekan
9	համար	համար	ADP	_	AdpType=Post	8	case	_	Translit=hamar|LTranslit=hamar
