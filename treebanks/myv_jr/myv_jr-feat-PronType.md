...
1117 tokens (7%) have a non-empty value of `PronType`.
240 types (4%) occur at least once with a non-empty value of `PronType`.
75 lemmas (3%) occur at least once with a non-empty value of `PronType`.
The feature is used with 5 part-of-speech tags: <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> (841; 5% instances), <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> (160; 1% instances), <tt><a href="myv_jr-pos-DET.html">DET</a></tt> (82; 0% instances), <tt><a href="myv_jr-pos-ADJ.html">ADJ</a></tt> (32; 0% instances), <tt><a href="myv_jr-pos-SCONJ.html">SCONJ</a></tt> (2; 0% instances).

### `PRON`

841 <tt><a href="myv_jr-pos-PRON.html">PRON</a></tt> tokens (89% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Variant.html">Variant</a></tt><tt>=EMPTY</tt> (742; 88%), <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (563; 67%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (548; 65%), <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=Nom</tt> (504; 60%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (117; 14% of non-empty `PronType`): <em>те, истямо, неть, тень, теке, тона, истят, теде, нетне, се</em>
* `Ind` (44; 5% of non-empty `PronType`): <em>кияк, мезеяк, киненьгак, киньгак, мень-бути, кодамо, конат, мезде-бути, мезе-бути, мезтькак</em>
* `Int` (97; 12% of non-empty `PronType`): <em>мезе, кие, ки, месть, мейсь, кинь, мезень, мезть, мезес, кинень</em>
* `Prs` (446; 53% of non-empty `PronType`): <em>сон, мон, сонзэ, сонсь, минь, тензэ, сынь, минек, тон, сынст</em>
* `Rcp` (6; 1% of non-empty `PronType`): <em>вейке-вейке, вейкест, вейкест-вейкест, вейкенек-вейкенек</em>
* `Refl` (6; 1% of non-empty `PronType`): <em>сонсь, эсензэ, Эсень, эстензэ</em>
* `Rel` (46; 5% of non-empty `PronType`): <em>конань, кона, конат, мезе, конатань, Конатнень, кить, конадонть, конанень, конась</em>
* `Tot` (79; 9% of non-empty `PronType`): <em>весе, весенень, весень, эрьвейке, весеменень, весемень, Эрьвейкень, вейкест, весемеде, веси</em>
* `EMPTY` (103): <em>кавонест, эрьва, эсь, кона, конат, сь, Весе, вейкесь, весемень, мельганзо</em>
...
160 <tt><a href="myv_jr-pos-ADV.html">ADV</a></tt> tokens (11% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (95; 59%).
...
* `Int` (98; 61% of non-empty `PronType`): <em>кода, ков, косто, косо, зняро, зярдо, мекс, козонь, Мезекс, зяро</em>
* `Rel` (27; 17% of non-empty `PronType`): <em>зярдо, кода, козонь, зняро, косо, кува, знярдо, зярс, ков, мекс</em>
* `Tot` (6; 4% of non-empty `PronType`): <em>свал</em>
* `EMPTY` (1303): <em>ансяк, пек, истя, мейле, ней, уш, седе, прок, яла, курок</em>
...
82 <tt><a href="myv_jr-pos-DET.html">DET</a></tt> tokens (42% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="myv_jr-feat-Number.html">Number</a></tt><tt>=Sing</tt> (66; 80%), <tt><a href="myv_jr-feat-Definite.html">Definite</a></tt><tt>=EMPTY</tt> (45; 55%).

`DET` tokens may have the following values of `PronType`:

* `Dem` (57; 70% of non-empty `PronType`): <em>те, не, се, истямо, Нона, васенце, некень, теке</em>
* `Int` (6; 7% of non-empty `PronType`): <em>кона, Зяро, Конась</em>
* `Prs` (1; 1% of non-empty `PronType`): <em>эсинзэ</em>
* `Refl` (3; 4% of non-empty `PronType`): <em>эсь</em>
* `Rel` (4; 5% of non-empty `PronType`): <em>конань, конат</em>
* `Tot` (11; 13% of non-empty `PronType`): <em>эрьва</em>
* `EMPTY` (113): <em>эрьва, те, ве, лия, ламо, эсь, аламо, зяро, кона, ламотне</em>
...
* `EMPTY` (626): <em>од, паро, покш, якстере, мазый, сэрей, пиже, васень, омбоце, тусто</em>
...
* `EMPTY` (59): <em>зярдо, бути, теке, што, кода, штобу, куш, прок, хоть, Коли</em>
