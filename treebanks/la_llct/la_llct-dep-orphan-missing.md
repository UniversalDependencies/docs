...
31	intentionare	intentiono	VERB	v|v|-|-|p|n|a|-|-|-	Aspect=Imp|VerbForm=Vnoun|Voice=Act	34	xcomp	_	TraditionalMood=Infinitivus|TraditionalTense=Praesens
32	aut	aut	CCONJ	c|c|-|-|-|-|-|-|-|-	_	33	cc	_	_
33	retolli	retollo	VERB	v|v|-|-|p|n|p|-|-|-	Aspect=Imp|VerbForm=Vnoun|Voice=Pass	31	conj	_	TraditionalMood=Infinitivus|TraditionalTense=Praesens
34	quesierimus	quaero	VERB	v|v|1|p|t|i|a|-|-|-	Aspect=Perf|Mood=Ind|Number=Plur|Person=1|Tense=Fut|VerbForm=Fin|Voice=Act	45	advcl	_	SpaceAfter=No|TraditionalMood=Indicativus|TraditionalTense=FuturumExactum
...
41	defendere	defendo	VERB	v|v|-|-|p|n|a|-|-|-	Aspect=Imp|VerbForm=Vnoun|Voice=Act	43	xcomp	_	TraditionalMood=Infinitivus|TraditionalTense=Praesens
42	non	non	PART	d|d|-|-|-|-|-|-|-|-	Polarity=Neg	43	advmod:neg	_	_
43	potuerimus	possum	VERB	v|v|1|p|t|i|a|-|-|-	Aspect=Perf|Mood=Ind|Number=Plur|Person=1|Tense=Fut|VerbForm=Fin|Voice=Act	34	conj	_	SpaceAfter=No|TraditionalMood=Indicativus|TraditionalTense=FuturumExactum
...
46	componere	compono	VERB	v|v|-|-|p|n|a|-|-|-	Aspect=Imp|VerbForm=Vnoun|Voice=Act	45	xcomp	_	TraditionalMood=Infinitivus|TraditionalTense=Praesens
...
63	quales	qualis	DET	a|a|-|s|-|-|-|f|a|-	Case=Acc|Gender=Fem|Number=Sing|PronType=Rel	61	acl	_	_
64	tunc	tunc	ADV	d|d|-|-|-|-|-|-|-|-	_	63	advmod	_	_
65	fuerit	sum	AUX	v|v|3|s|t|i|a|-|-|-	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Fin	63	cop	_	SpaceAfter=No|TraditionalMood=Indicativus|TraditionalTense=FuturumExactum
