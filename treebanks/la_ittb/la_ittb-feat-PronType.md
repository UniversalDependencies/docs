...
It occurs with 9 different values: `Art`, `Con`, `Dem`, `Ind`, `Int`, `Prs`, `Rcp`, `Rel`, `Tot`.

61490 tokens (14%) have a non-empty value of `PronType`.
508 types (3%) occur at least once with a non-empty value of `PronType`.
93 lemmas (2%) occur at least once with a non-empty value of `PronType`.
The feature is used with 7 part-of-speech tags: <tt><a href="la_ittb-pos-DET.html">DET</a></tt> (28678; 6% instances), <tt><a href="la_ittb-pos-PRON.html">PRON</a></tt> (23610; 5% instances), <tt><a href="la_ittb-pos-SCONJ.html">SCONJ</a></tt> (5879; 1% instances), <tt><a href="la_ittb-pos-ADV.html">ADV</a></tt> (3312; 1% instances), <tt><a href="la_ittb-pos-PART.html">PART</a></tt> (9; 0% instances), <tt><a href="la_ittb-pos-ADP.html">ADP</a></tt> (1; 0% instances), <tt><a href="la_ittb-pos-CCONJ.html">CCONJ</a></tt> (1; 0% instances).

### `DET`

28678 <tt><a href="la_ittb-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="la_ittb-feat-Person-psor.html">Person[psor]</a></tt><tt>=EMPTY</tt> (25745; 90%), <tt><a href="la_ittb-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (25745; 90%), <tt><a href="la_ittb-feat-Form.html">Form</a></tt><tt>=EMPTY</tt> (25316; 88%), <tt><a href="la_ittb-feat-Compound.html">Compound</a></tt><tt>=EMPTY</tt> (24747; 86%), <tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (21170; 74%), <tt><a href="la_ittb-feat-InflClass.html">InflClass</a></tt><tt>=LatPron</tt> (20800; 73%).

`DET` tokens may have the following values of `PronType`:

* `Art` (8; 0% of non-empty `PronType`): <em>ly</em>
* `Con` (3497; 12% of non-empty `PronType`): <em>alia, aliud, aliis, alio, alterius, aliam, alii, sola, aliorum, utrumque</em>
* `Dem` (11401; 40% of non-empty `PronType`): <em>hoc, huiusmodi, ipsum, haec, illud, his, ipsa, ipse, ipsius, ipso</em>
* `Ind` (6540; 23% of non-empty `PronType`): <em>aliqua, unum, quaedam, aliquam, una, aliquod, alicuius, quidam, nulla, unus</em>
* `Prs` (2933; 10% of non-empty `PronType`): <em>suam, sua, suum, suae, sui, suo, nostra, noster, suis, nostrae</em>
* `Rel` (360; 1% of non-empty `PronType`): <em>quaecumque, quicumque, quocumque, cuiuscumque, qualis, quodcumque, quacumque, quamcumque, quibuscumque, cuicumque</em>
* `Tot` (3939; 14% of non-empty `PronType`): <em>omnia, omnes, omnis, omne, omnibus, omnium, totum, totius, unumquodque, omni</em>
* `EMPTY` (4): <em>cuiusmodi, minus</em>

`PronType` seems to be **lexical feature** of `DET`. 100% lemmas (52) occur only with one value of `PronType`.

### `PRON`

23610 <tt><a href="la_ittb-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="la_ittb-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (21082; 89%), <tt><a href="la_ittb-feat-Compound.html">Compound</a></tt><tt>=EMPTY</tt> (20831; 88%), <tt><a href="la_ittb-feat-InflClass.html">InflClass</a></tt><tt>=LatPron</tt> (19805; 84%), <tt><a href="la_ittb-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (15143; 64%), <tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt> (14901; 63%).

`PRON` tokens may have the following values of `PronType`:

* `Ind` (2567; 11% of non-empty `PronType`): <em>aliquid, nihil, aliquis, alicuius, aliquo, alicui, aliqua, aliqui, nemo, nihilo</em>
* `Int` (361; 2% of non-empty `PronType`): <em>quid, quis, numquid, cui, nunquid, quem, quo</em>
* `Prs` (8469; 36% of non-empty `PronType`): <em>se, eius, eo, ea, ei, id, nobis, eorum, sibi, eis</em>
* `Rcp` (120; 1% of non-empty `PronType`): <em>inuicem</em>
* `Rel` (12093; 51% of non-empty `PronType`): <em>quod, quae, qui, quo, quam, quibus, qua, cuius, quem, quorum</em>

<table>
  <tr><th>Paradigm <i>qui</i></th><th><tt>Rel</tt></th><th><tt>Ind</tt></th></tr>
  ...
  <tr><td><tt><tt><a href="la_ittb-feat-Case.html">Case</a></tt><tt>=Abl</tt>|<tt><a href="la_ittb-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="la_ittb-feat-InflClass.html">InflClass</a></tt><tt>=LatPron</tt>|<tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>qua</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="la_ittb-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="la_ittb-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="la_ittb-feat-InflClass.html">InflClass</a></tt><tt>=LatPron</tt>|<tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>quod, quae, qui</em></td><td><em>quod</em></td></tr>
  ...
  <tr><td><tt><tt><a href="la_ittb-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="la_ittb-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>quod</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="la_ittb-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="la_ittb-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="la_ittb-feat-InflClass.html">InflClass</a></tt><tt>=LatPron</tt>|<tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>quod, qui</em></td><td><em>quod</em></td></tr>
  ...
  <tr><td><tt><tt><a href="la_ittb-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="la_ittb-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="la_ittb-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>quod</em></td><td></td></tr>
</table>
...
5879 <tt><a href="la_ittb-pos-SCONJ.html">SCONJ</a></tt> tokens (26% of all `SCONJ` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `SCONJ` and `PronType` co-occurred: <tt><a href="la_ittb-feat-Compound.html">Compound</a></tt><tt>=EMPTY</tt> (5879; 100%).

`SCONJ` tokens may have the following values of `PronType`:

* `Rel` (5879; 100% of non-empty `PronType`): <em>ut, cum, quam, quando, quod</em>
* `EMPTY` (17069): <em>quod, sicut, quia, si, nisi, inquantum, licet, quamuis, dum, quasi</em>

### `ADV`

3312 <tt><a href="la_ittb-pos-ADV.html">ADV</a></tt> tokens (15% of all `ADV` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADV` and `PronType` co-occurred: <tt><a href="la_ittb-feat-Compound.html">Compound</a></tt><tt>=EMPTY</tt> (3296; 100%), <tt><a href="la_ittb-feat-AdvType.html">AdvType</a></tt><tt>=EMPTY</tt> (1669; 50%).

`ADV` tokens may have the following values of `PronType`:

* `Con` (763; 23% of non-empty `PronType`): <em>solum, aliter, utrum, alias</em>
* `Dem` (687; 21% of non-empty `PronType`): <em>tantum, tam, hinc, hic, ecce, ita, idem, intantum</em>
* `Ind` (20; 1% of non-empty `PronType`): <em>aliquatenus, nihil, nil, plus</em>
* `Int` (3; 0% of non-empty `PronType`): <em>numquid, nunquid</em>
* `Rel` (1839; 56% of non-empty `PronType`): <em>unde, ut, quandoque, qualiter, quatenus, quando, quanto, quare, quantum</em>
* `EMPTY` (19368): <em>etiam, sic, ergo, tamen, uero, supra, ita, magis, adhuc, item</em>

`PronType` seems to be **lexical feature** of `ADV`. 100% lemmas (27) occur only with one value of `PronType`.

### `PART`

9 <tt><a href="la_ittb-pos-PART.html">PART</a></tt> tokens (0% of all `PART` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PART` and `PronType` co-occurred: <tt><a href="la_ittb-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (9; 100%).

`PART` tokens may have the following values of `PronType`:

* `Dem` (9; 100% of non-empty `PronType`): <em>ecce</em>
* `EMPTY` (22165): <em>non, autem, igitur, enim, nam, quidem, namque, an, itaque, o</em>
...
* `EMPTY` (39717): <em>in, ad, per, ex, secundum, a, de, ab, propter, cum</em>
...
* `Rel` (1; 100% of non-empty `PronType`): <em>ut</em>
* `EMPTY` (19148): <em>et, sed, uel, nec, scilicet, neque, aut, siue, idest, ac</em>
...
<tt>DET --[<tt><a href="la_ittb-dep-csubj-relcl.html">csubj:relcl</a></tt>]--> DET</tt> (3; 75%),
<tt>DET --[<tt><a href="la_ittb-dep-csubj.html">csubj</a></tt>]--> DET</tt> (2; 67%),
<tt>PRON --[<tt><a href="la_ittb-dep-advcl-cmp.html">advcl:cmp</a></tt>]--> PRON</tt> (2; 100%),
<tt>DET --[<tt><a href="la_ittb-dep-ccomp-relcl.html">ccomp:relcl</a></tt>]--> DET</tt> (1; 100%),
<tt>PRON --[<tt><a href="la_ittb-dep-obl-arg.html">obl:arg</a></tt>]--> PRON</tt> (1; 100%).
