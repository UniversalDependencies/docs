...
96 types (1%) occur at least once with a non-empty value of `Definite`.
39 lemmas (1%) occur at least once with a non-empty value of `Definite`.
The feature is used with 1 part-of-speech tags: <tt><a href="de_pud-pos-DET.html">DET</a></tt> (2840; 13% instances).
...
* `Def` (2246; 79% of non-empty `Definite`): <em>der, die, dem, den, das, des, diese, dieser, dies, dieses</em>
