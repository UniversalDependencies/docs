...
5501 tokens (3%) have a non-empty value of `NumForm`.
1037 types (3%) occur at least once with a non-empty value of `NumForm`.
940 lemmas (5%) occur at least once with a non-empty value of `NumForm`.
The feature is used with 1 part-of-speech tags: <tt><a href="ro_rrt-pos-NUM.html">NUM</a></tt> (5501; 3% instances).

### `NUM`

5501 <tt><a href="ro_rrt-pos-NUM.html">NUM</a></tt> tokens (99% of all `NUM` tokens) have a non-empty value of `NumForm`.

The most frequent other feature values with which `NUM` and `NumForm` co-occurred: <tt><a href="ro_rrt-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (4771; 87%), <tt><a href="ro_rrt-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (4612; 84%), <tt><a href="ro_rrt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (4411; 80%).

`NUM` tokens may have the following values of `NumForm`:

* `Combi` (156; 3% of non-empty `NumForm`): <em>1999/468/CE, 3.2, 3.4.1.5, 3.4.2.2., 72/462/CEE, 1.1.1, 1720/1999/CE, 2.1.2, 2002/96/CE, 2003/390/CE</em>
* `Digit` (3780; 69% of non-empty `NumForm`): <em>1, 2, 3, 4, 5, 6, 7, 8, 2004, 10</em>
* `Roman` (249; 5% of non-empty `NumForm`): <em>i, ii, iii, iv, V, XX, XIX, VI, VII, VIII</em>
* `Word` (1316; 24% of non-empty `NumForm`): <em>două, trei, primul, doi, prima, patru, cinci, doilea, primele, doua</em>
...
`NumForm` seems to be **lexical feature** of `NUM`. 96% lemmas (907) occur only with one value of `NumForm`.

## Relations with Agreement in `NumForm`

The 10 most frequent relations where parent and child node agree in `NumForm`:
<tt>NUM --[<tt><a href="ro_rrt-dep-conj.html">conj</a></tt>]--> NUM</tt> (271; 99%),
<tt>NUM --[<tt><a href="ro_rrt-dep-nummod.html">nummod</a></tt>]--> NUM</tt> (73; 66%),
