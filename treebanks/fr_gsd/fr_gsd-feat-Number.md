...
221890 tokens (55%) have a non-empty value of `Number`.
28948 types (68%) occur at least once with a non-empty value of `Number`.
19241 lemmas (58%) occur at least once with a non-empty value of `Number`.
The feature is used with 12 part-of-speech tags: <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> (73929; 18% instances), <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> (61086; 15% instances), <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (24559; 6% instances), <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> (22813; 6% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (12100; 3% instances), <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (11219; 3% instances), <tt><a href="fr_gsd-pos-NUM.html">NUM</a></tt> (10419; 3% instances), <tt><a href="fr_gsd-pos-PROPN.html">PROPN</a></tt> (5220; 1% instances), <tt><a href="fr_gsd-pos-SYM.html">SYM</a></tt> (413; 0% instances), <tt><a href="fr_gsd-pos-X.html">X</a></tt> (106; 0% instances), <tt><a href="fr_gsd-pos-ADV.html">ADV</a></tt> (21; 0% instances), <tt><a href="fr_gsd-pos-ADP.html">ADP</a></tt> (5; 0% instances).

### `NOUN`

73929 <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> tokens (98% of all `NOUN` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `NOUN` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (40756; 55%).

`NOUN` tokens may have the following values of `Number`:

* `Plur` (18548; 25% of non-empty `Number`): <em>ans, années, enfants, pays, habitants, personnes, jours, droits, points, hommes</em>
* `Sing` (55381; 75% of non-empty `Number`): <em>ville, partie, nom, monde, région, commune, groupe, famille, année, siècle</em>
* `EMPTY` (1315): <em>mars, grâce, peu, suite, temps, face, anglais, travers, français, cours</em>
...
61086 <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `DET` and `Number` co-occurred: <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (53462; 88%), <tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (43340; 71%).

`DET` tokens may have the following values of `Number`:

* `Plur` (14169; 23% of non-empty `Number`): <em>les, des, ses, ces, de, plusieurs, leurs, quelques, d', certains</em>
* `Sing` (46917; 77% of non-empty `Number`): <em>le, la, l', un, une, son, sa, cette, ce, leur</em>
* `EMPTY` (45): <em>d', de, ce</em>

<table>
  <tr><th>Paradigm <i>le</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>le</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>la</em></td><td></td></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt>|<tt><a href="fr_gsd-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td><em>la, là</em></td><td></td></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>l', l, Le</em></td><td><em>les</em></td></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt>|<tt><a href="fr_gsd-feat-Typo.html">Typo</a></tt><tt>=Yes</tt></tt></td><td><em>L</em></td><td><em>les</em></td></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt></tt></td><td><em>la</em></td><td></td></tr>
</table>

### `VERB`

24559 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (77% of all `VERB` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `VERB` and `Number` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13673; 56%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13666; 56%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13079; 53%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (12938; 53%).

`VERB` tokens may have the following values of `Number`:

* `Plur` (5069; 21% of non-empty `Number`): <em>ont, peuvent, font, doivent, prennent, sont, trouvent, vont, permettent, utilisés</em>
* `Sing` (19490; 79% of non-empty `Number`): <em>a, fait, peut, né, située, est, situé, trouve, devient, doit</em>
* `EMPTY` (7350): <em>faire, partir, voir, prendre, avoir, mis, pris, mettre, passer, trouver</em>

<table>
  <tr><th>Paradigm <i>avoir</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Past</tt>|<tt><a href="fr_gsd-feat-Typo.html">Typo</a></tt><tt>=Yes</tt>|<tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt></tt></td><td><em>eu</em></td><td></td></tr>
...
22813 <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> tokens (96% of all `ADJ` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADJ` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (11679; 51%).

`ADJ` tokens may have the following values of `Number`:

* `Plur` (6361; 28% of non-empty `Number`): <em>autres, tous, nombreux, toutes, nombreuses, premiers, grands, premières, grandes, derniers</em>
* `Sing` (16452; 72% of non-empty `Number`): <em>premier, première, même, française, dernier, grande, grand, nouveau, autre, politique</em>
* `EMPTY` (946): <em>français, anglais, chaleureux, religieux, super, vieux, gros, divers, japonais, néerlandais</em>
...
12100 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (93% of all `AUX` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `AUX` and `Number` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11199; 93%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10841; 90%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (10749; 89%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9485; 78%).

`AUX` tokens may have the following values of `Number`:

* `Plur` (2324; 19% of non-empty `Number`): <em>sont, ont, étaient, avons, furent, avaient, seront, sommes, soient, auraient</em>
* `Sing` (9776; 81% of non-empty `Number`): <em>est, a, été, était, fut, avait, ai, sera, fait, soit</em>
* `EMPTY` (848): <em>être, avoir, étant, faire, ayant, faisant, Etant, -être, etre</em>

<table>
  <tr><th>Paradigm <i>être</i></th><th><tt>Sing</tt></th><th><tt>Plur</tt></th></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt>|<tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt></tt></td><td><em>est</em></td><td></td></tr>
...
11219 <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> tokens (63% of all `PRON` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `PRON` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (11091; 99%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9544; 85%), <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (8204; 73%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (7477; 67%).

`PRON` tokens may have the following values of `Number`:

* `Plur` (2034; 18% of non-empty `Number`): <em>ils, nous, vous, les, elles, autres, ceux, eux, leur, tous</em>
* `Sing` (9185; 82% of non-empty `Number`): <em>il, elle, c', on, lui, je, le, j', l', un</em>
* `EMPTY` (6530): <em>qui, se, s', y, dont, ce, en, qu', que, quoi</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td><em>il, -t-il, -il, Lui, t-il, t'il</em></td><td><em>ils, -ils</em></td></tr>
  ...
  <tr><td><tt><tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=2</tt></tt></td><td><em>tu, -tu</em></td><td><em>vous, -vous</em></td></tr>
  <tr><td><tt><tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td><em>l'</em></td><td></td></tr>
</table>

### `NUM`

10419 <tt><a href="fr_gsd-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `Number`.

`NUM` tokens may have the following values of `Number`:

* `Plur` (9191; 88% of non-empty `Number`): <em>deux, trois, 2, quatre, 2010, 2009, 2008, 2011, 3, 5</em>
* `Sing` (1228; 12% of non-empty `Number`): <em>un, 6, 7, 18, 1er, 11, 25, 15, 20, 5</em>
* `EMPTY` (9): <em>I, 1er, 1919, 1920, 4ème, 7</em>
...
`Number` seems to be **lexical feature** of `NUM`. 97% lemmas (1839) occur only with one value of `Number`.

### `PROPN`

5220 <tt><a href="fr_gsd-pos-PROPN.html">PROPN</a></tt> tokens (19% of all `PROPN` tokens) have a non-empty value of `Number`.

`PROPN` tokens may have the following values of `Number`:

* `Plur` (1054; 20% of non-empty `Number`): <em>États-Unis, Etats-Unis, Pays-Bas, Pyrénées, îles, Vosges, Romains, Grecs, Hautes-Pyrénées, Rangers</em>
* `Sing` (4166; 80% of non-empty `Number`): <em>Europe, Maroc, France, ONU, Espagne, Algérie, Sahara, Canada, UE, Afrique</em>
* `EMPTY` (22983): <em>France, Paris, Jean, Europe, York, New, Pierre, Charles, Louis, Italie</em>
...
`Number` seems to be **lexical feature** of `PROPN`. 99% lemmas (2991) occur only with one value of `Number`.

### `SYM`

413 <tt><a href="fr_gsd-pos-SYM.html">SYM</a></tt> tokens (59% of all `SYM` tokens) have a non-empty value of `Number`.
...
The most frequent other feature values with which `X` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Foreign.html">Foreign</a></tt><tt>=EMPTY</tt> (106; 100%).

`X` tokens may have the following values of `Number`:

* `Plur` (2; 2% of non-empty `Number`): <em>agnolotti, cevapcici</em>
* `Sing` (104; 98% of non-empty `Number`): <em>A, ARNm, DKK, ECCU, EFEO, Espírito, GPU, IRT, OCL, OLP</em>
* `EMPTY` (2266): <em>the, of, etc., and, in, a, de, for, Company, me</em>

`Number` seems to be **lexical feature** of `X`. 100% lemmas (104) occur only with one value of `Number`.

### `ADV`

21 <tt><a href="fr_gsd-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Number`.

The most frequent other feature values with which `ADV` and `Number` co-occurred: <tt><a href="fr_gsd-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (19; 90%).

`ADV` tokens may have the following values of `Number`:

* `Plur` (11; 52% of non-empty `Number`): <em>moins, Combien, plus</em>
* `Sing` (10; 48% of non-empty `Number`): <em>delà, juste, NON, début, pas, point, pré-</em>
* `EMPTY` (14565): <em>plus, pas, n', ne, très, aussi, où, ainsi, alors, bien</em>

`Number` seems to be **lexical feature** of `ADV`. 100% lemmas (10) occur only with one value of `Number`.

### `ADP`

5 <tt><a href="fr_gsd-pos-ADP.html">ADP</a></tt> tokens (0% of all `ADP` tokens) have a non-empty value of `Number`.

`ADP` tokens may have the following values of `Number`:

* `Plur` (1; 20% of non-empty `Number`): <em>d'</em>
* `Sing` (4; 80% of non-empty `Number`): <em>après, à, apres, début</em>
* `EMPTY` (63703): <em>de, à, en, d', dans, pour, par, sur, avec, comme</em>

## Relations with Agreement in `Number`

The 10 most frequent relations where parent and child node agree in `Number`:
<tt>NOUN --[<tt><a href="fr_gsd-dep-det.html">det</a></tt>]--> DET</tt> (53185; 100%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-amod.html">amod</a></tt>]--> ADJ</tt> (18524; 95%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-nmod.html">nmod</a></tt>]--> NOUN</tt> (12963; 63%),
<tt>VERB --[<tt><a href="fr_gsd-dep-obl-mod.html">obl:mod</a></tt>]--> NOUN</tt> (5631; 58%),
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (5046; 72%),
<tt>PROPN --[<tt><a href="fr_gsd-dep-det.html">det</a></tt>]--> DET</tt> (5017; 100%),
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> NOUN</tt> (4794; 91%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> NOUN</tt> (4172; 80%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-nummod.html">nummod</a></tt>]--> NUM</tt> (3074; 99%),
<tt>NOUN --[<tt><a href="fr_gsd-dep-acl.html">acl</a></tt>]--> VERB</tt> (3049; 72%).
