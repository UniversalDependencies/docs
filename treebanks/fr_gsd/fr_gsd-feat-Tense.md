...
38895 tokens (10%) have a non-empty value of `Tense`.
7052 types (17%) occur at least once with a non-empty value of `Tense`.
2019 lemmas (6%) occur at least once with a non-empty value of `Tense`.
The feature is used with 3 part-of-speech tags: <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (26668; 7% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (12224; 3% instances), <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> (3; 0% instances).

### `VERB`

26668 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (82% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (19952; 75%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (15433; 58%), <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13858; 52%).

`VERB` tokens may have the following values of `Tense`:

* `Fut` (621; 2% of non-empty `Tense`): <em>aura, fera, pourra, permettra, restera, sera, feront, deviendra, permettront, devra</em>
* `Imp` (1113; 4% of non-empty `Tense`): <em>avait, était, devait, comptait, pouvait, faisait, allait, avaient, portait, disait</em>
* `Past` (12312; 46% of non-empty `Tense`): <em>né, située, situé, eu, fait, mort, connu, nommé, née, réalisé</em>
* `Pres` (12622; 47% of non-empty `Tense`): <em>a, peut, fait, est, trouve, devient, doit, ont, permet, faut</em>
* `EMPTY` (5662): <em>faire, partir, voir, prendre, avoir, mettre, passer, trouver, aller, dire</em>
...
12224 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (95% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11153; 91%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10808; 88%), <tt><a href="fr_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (10707; 88%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9735; 80%).

`AUX` tokens may have the following values of `Tense`:

* `Fut` (237; 2% of non-empty `Tense`): <em>sera, seront, aura, auront, fera, feront, serez, aurons</em>
* `Imp` (930; 8% of non-empty `Tense`): <em>était, avait, étaient, avaient, avais, avions, faisait, étais, étions, fût</em>
* `Past` (1409; 12% of non-empty `Tense`): <em>été, fut, furent, fait, fit, eut, firent, faite</em>
* `Pres` (9648; 79% of non-empty `Tense`): <em>est, a, sont, ont, ai, étant, soit, avons, aurait, suis</em>
* `EMPTY` (659): <em>être, avoir, faire, be, 'll, 's, Do, can, -être, cant</em>
...
3 <tt><a href="fr_gsd-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `NOUN` and `Tense` co-occurred: <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt> (2; 67%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (2; 67%).

`NOUN` tokens may have the following values of `Tense`:

* `Past` (3; 100% of non-empty `Tense`): <em>Fermée, aéroportée, séquestrés</em>
* `EMPTY` (75193): <em>ans, ville, pays, partie, nom, monde, fois, région, commune, temps</em>

## Relations with Agreement in `Tense`

The 10 most frequent relations where parent and child node agree in `Tense`:
<tt>VERB --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (2026; 75%),
<tt>VERB --[<tt><a href="fr_gsd-dep-appos.html">appos</a></tt>]--> VERB</tt> (6; 86%),
...
<tt>VERB --[<tt><a href="fr_gsd-dep-mark.html">mark</a></tt>]--> VERB</tt> (1; 100%).
