---
layout: base
title:  'Statistics of SCONJ in UD_Assyrian-AS'
udver: '2'
---

## Treebank Statistics: UD_Assyrian-AS: POS Tags: `SCONJ`

There are 3 `SCONJ` lemmas (1%), 3 `SCONJ` types (1%) and 5 `SCONJ` tokens (1%).
Out of 13 observed tags, the rank of `SCONJ` is: 13 in number of lemmas, 13 in number of types and 13 in number of tokens.

The 10 most frequent `SCONJ` lemmas: <em>ܕ, ܐܸܢ, ܗܲܠ</em>

The 10 most frequent `SCONJ` types:  <em>ܕ, ܐܸܢ, ܗܲܠ</em>
...
The form / lemma ratio of `SCONJ` is 1.000000 (the average of all parts of speech is 1.039841).

The 1st highest number of forms (1) was observed with the lemma “ܐܸܢ”: <em>ܐܸܢ</em>.

The 2nd highest number of forms (1) was observed with the lemma “ܕ”: <em>ܕ</em>.

The 3rd highest number of forms (1) was observed with the lemma “ܗܲܠ”: <em>ܗܲܠ</em>.
...
`SCONJ` nodes are attached to their parents using 2 different relations: <tt><a href="aii_as-dep-mark.html">mark</a></tt> (4; 80% instances), <tt><a href="aii_as-dep-nsubj.html">nsubj</a></tt> (1; 20% instances)

Parents of `SCONJ` nodes belong to 3 different parts of speech: <tt><a href="aii_as-pos-VERB.html">VERB</a></tt> (3; 60% instances), <tt><a href="aii_as-pos-ADJ.html">ADJ</a></tt> (1; 20% instances), <tt><a href="aii_as-pos-PRON.html">PRON</a></tt> (1; 20% instances)
