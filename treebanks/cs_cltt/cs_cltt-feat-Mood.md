...
1936 tokens (5%) have a non-empty value of `Mood`.
347 types (7%) occur at least once with a non-empty value of `Mood`.
224 lemmas (8%) occur at least once with a non-empty value of `Mood`.
The feature is used with 2 part-of-speech tags: <tt><a href="cs_cltt-pos-VERB.html">VERB</a></tt> (1411; 4% instances), <tt><a href="cs_cltt-pos-AUX.html">AUX</a></tt> (525; 1% instances).

### `VERB`

1411 <tt><a href="cs_cltt-pos-VERB.html">VERB</a></tt> tokens (77% of all `VERB` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `VERB` and `Mood` co-occurred: <tt><a href="cs_cltt-feat-Person.html">Person</a></tt><tt>=3</tt> (1411; 100%), <tt><a href="cs_cltt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (1411; 100%), <tt><a href="cs_cltt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (1411; 100%), <tt><a href="cs_cltt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (1411; 100%), <tt><a href="cs_cltt-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (1208; 86%), <tt><a href="cs_cltt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (970; 69%).

`VERB` tokens may have the following values of `Mood`:

* `Ind` (1411; 100% of non-empty `Mood`): <em>obsahuje, rozumí, může, uvede, mohou, použijí, stanoví, musí, účtuje, lze</em>
* `EMPTY` (430): <em>vést, použít, mít, účtovat, došlo, odpisovat, uvést, sestavit, zajistit, provést</em>

`Mood` seems to be **lexical feature** of `VERB`. 100% lemmas (223) occur only with one value of `Mood`.

### `AUX`

525 <tt><a href="cs_cltt-pos-AUX.html">AUX</a></tt> tokens (83% of all `AUX` tokens) have a non-empty value of `Mood`.

The most frequent other feature values with which `AUX` and `Mood` co-occurred: <tt><a href="cs_cltt-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (525; 100%), <tt><a href="cs_cltt-feat-Person.html">Person</a></tt><tt>=3</tt> (515; 98%), <tt><a href="cs_cltt-feat-Voice.html">Voice</a></tt><tt>=Act</tt> (499; 95%), <tt><a href="cs_cltt-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (477; 91%), <tt><a href="cs_cltt-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (424; 81%), <tt><a href="cs_cltt-feat-Number.html">Number</a></tt><tt>=Sing</tt> (286; 54%).

`AUX` tokens may have the following values of `Mood`:

* `Cnd` (26; 5% of non-empty `Mood`): <em>by</em>
* `Ind` (499; 95% of non-empty `Mood`): <em>je, jsou, není, nejsou, bude, budou</em>
* `EMPTY` (107): <em>být, byly, byl, bylo, nebyly, byla, nebyla, nebyl</em>
