...
4	אִ֑ישׁ	אישׁ	NOUN	subs	Gender=Masc|Number=Sing	2	nsubj	_	Gloss=man|Ref=GEN_26.13
...
9	גָדֵ֔ל	גדל	ADJ	adjv	Gender=Masc|Number=Sing	6	obl	_	Gloss=growing|Ref=GEN_26.13
10	עַ֥ד	עד	SCONJ	prep	_	13	mark	_	Gloss=unto|Ref=GEN_26.13
...
13	גָדַ֖ל	גדל	VERB	verb	Aspect=Perf|Gender=Masc|HebBinyan=PAAL|Mood=Ind|Number=Sing|Person=3|VerbForm=Fin	2	advcl	_	Gloss=be strong|Ref=GEN_26.13
