...
1	Das	_	DET	DT	Case=Nom|Definite=Def|Gender=Neut|Number=Sing|Person=3	2	nsubj	_	_
2	ist	_	VERB	VBC	Mood=Ind|Number=Sing|Person=3|Tense=Pres	0	root	_	_
3	es	_	PRON	PRP	Case=Nom|Gender=Neut|Number=Sing|Person=3	2	expl	_	SpaceAfter=No
4	,	_	PUNCT	,	_	8	punct	_	_
5	was	_	PRON	REL	Case=Nom|Gender=Neut|Number=Sing|Person=3	8	nsubj	_	_
6	uns	_	PRON	PRP	Case=Acc|Number=Plur|Person=1	8	obj	_	_
7	süchtig	_	ADV	RB	Degree=Pos	8	advmod	_	_
8	macht	_	VERB	VBC	Mood=Ind|Number=Sing|Person=3|Tense=Pres	2	acl:relcl	_	SpaceAfter=No
...
1	Vor	_	ADP	IN	_	3	case	_	_
2	diesem	_	DET	DT	Case=Dat|Definite=Def|Gender=Masc|Number=Sing|Person=3	3	det	_	_
3	Hintergrund	_	NOUN	NN	Case=Dat|Gender=Masc|Number=Sing|Person=3	6	obl	_	_
4	ist	_	AUX	VBC	Mood=Ind|Number=Sing|Person=3|Tense=Pres	6	cop	_	_
5	es	_	PRON	PRP	Case=Nom|Gender=Neut|Number=Sing|Person=3	6	expl	_	_
6	sinnvoll	_	ADJ	JJ	Degree=Pos	0	root	_	SpaceAfter=No
7	,	_	PUNCT	,	_	12	punct	_	_
8	über	_	ADP	IN	_	10	case	_	_
9	den	_	DET	DT	Case=Acc|Definite=Def|Gender=Masc|Number=Sing|Person=3	10	det	_	_
10	Handel	_	NOUN	NN	Case=Acc|Gender=Masc|Number=Sing|Person=3	12	obl	_	_
11	zu	_	PART	RP	_	12	mark	_	_
12	schimpfen	_	VERB	VB	_	6	csubj	_	SpaceAfter=No
