...
There are 17 `PRON` lemmas (4%), 32 `PRON` types (6%) and 85 `PRON` tokens (9%).
Out of 15 observed tags, the rank of `PRON` is: 6 in number of lemmas, 4 in number of types and 4 in number of tokens.

The 10 most frequent `PRON` lemmas: <em>сія, ме, тэ, мый, эта, ас, мыйкӧ, эна, быд, кин</em>

The 10 most frequent `PRON` types:  <em>сія, ме, менам, тэ, мый, сійӧ, тэнат, меным, сылӧ, сылӧн</em>
...
The form / lemma ratio of `PRON` is 1.882353 (the average of all parts of speech is 1.228365).

The 1st highest number of forms (7) was observed with the lemma “ме”: <em>Ми, ме, мекӧт, мелань, менам, меным, менӧ</em>.

The 2nd highest number of forms (7) was observed with the lemma “сія”: <em>Сiя, Сы, нія, сылӧ, сылӧн, сійӧ, сія</em>.

The 3rd highest number of forms (3) was observed with the lemma “тэ”: <em>тэ, тэнат, ті</em>.

`PRON` occurs with 8 features: <tt><a href="koi_uh-feat-PronType.html">PronType</a></tt> (83; 98% instances), <tt><a href="koi_uh-feat-Case.html">Case</a></tt> (80; 94% instances), <tt><a href="koi_uh-feat-Number.html">Number</a></tt> (77; 91% instances), <tt><a href="koi_uh-feat-Person.html">Person</a></tt> (63; 74% instances), <tt><a href="koi_uh-feat-Animacy.html">Animacy</a></tt> (3; 4% instances), <tt><a href="koi_uh-feat-Number-psor.html">Number[psor]</a></tt> (2; 2% instances), <tt><a href="koi_uh-feat-Person-psor.html">Person[psor]</a></tt> (2; 2% instances), <tt><a href="koi_uh-feat-Reflex.html">Reflex</a></tt> (2; 2% instances)

`PRON` occurs with 23 feature-value pairs: `Animacy=Nhum`, `Case=Acc`, `Case=Apr`, `Case=Com`, `Case=Dat`, `Case=Gen`, `Case=Ine`, `Case=Nom`, `Number=Plur`, `Number=Sing`, `Number[psor]=Plur`, `Number[psor]=Sing`, `Person=1`, `Person=2`, `Person=3`, `Person[psor]=3`, `PronType=Dem`, `PronType=Ind`, `PronType=Int`, `PronType=Prs`, `PronType=Rel`, `PronType=Tot`, `Reflex=Yes`

`PRON` occurs with 31 feature combinations.
The most frequent feature combination is `Case=Nom|Number=Sing|Person=3|PronType=Prs` (18 tokens).
Examples: <em>сія, Сiя</em>


## Relations

`PRON` nodes are attached to their parents using 12 different relations: <tt><a href="koi_uh-dep-nsubj.html">nsubj</a></tt> (35; 41% instances), <tt><a href="koi_uh-dep-nmod.html">nmod</a></tt> (11; 13% instances), <tt><a href="koi_uh-dep-obl.html">obl</a></tt> (11; 13% instances), <tt><a href="koi_uh-dep-obj.html">obj</a></tt> (8; 9% instances), <tt><a href="koi_uh-dep-det.html">det</a></tt> (6; 7% instances), <tt><a href="koi_uh-dep-nsubj-cop.html">nsubj:cop</a></tt> (5; 6% instances), <tt><a href="koi_uh-dep-obl-lmod.html">obl:lmod</a></tt> (3; 4% instances), <tt><a href="koi_uh-dep-nmod-poss.html">nmod:poss</a></tt> (2; 2% instances), <tt><a href="koi_uh-dep-appos.html">appos</a></tt> (1; 1% instances), <tt><a href="koi_uh-dep-conj.html">conj</a></tt> (1; 1% instances), <tt><a href="koi_uh-dep-obl-tmod.html">obl:tmod</a></tt> (1; 1% instances), <tt><a href="koi_uh-dep-root.html">root</a></tt> (1; 1% instances)

Parents of `PRON` nodes belong to 6 different parts of speech: <tt><a href="koi_uh-pos-VERB.html">VERB</a></tt> (54; 64% instances), <tt><a href="koi_uh-pos-NOUN.html">NOUN</a></tt> (22; 26% instances), <tt><a href="koi_uh-pos-ADV.html">ADV</a></tt> (4; 5% instances), <tt><a href="koi_uh-pos-ADJ.html">ADJ</a></tt> (3; 4% instances), <tt><a href="koi_uh-pos-NUM.html">NUM</a></tt> (1; 1% instances),  (1; 1% instances)

72 (85%) `PRON` nodes are leaves.
