...
1	Asal	asal	NOUN	NSD	Number=Sing	8	nsubj:pass	_	Morf=^asal<n>_NSD$
2	-	-	PUNCT	Z--	_	3	punct	_	Morf=^-<z>_Z--$
3	usul	usul	NOUN	VSA	_	1	nmod	_	Morf=^usul<v>_VSA$
...
1	Sebaliknya	sebaliknya	SCONJ	S--	_	6	mark	_	SpaceAfter=No|Morf=^sebaliknya<s>_S--$
...
12	transparan	transparan	ADJ	ASP	_	10	conj	_	SpaceAfter=No|Morf=^transparan<a>_ASP$
13	.	.	PUNCT	Z--	_	3	punct	_	Morf=^.<z>_Z--$
