...
There are 840 `NUM` lemmas (4%), 853 `NUM` types (3%) and 4647 `NUM` tokens (2%).
...
* <em>sete</em>
  * <tt><a href="pt_bosque-pos-NUM.html">NUM</a></tt> 34: <em>A greve « por empresa » atingia ontem <b>sete</b> empresas e 12 mil empregados .</em>
...
The form / lemma ratio of `NUM` is 1.015476 (the average of all parts of speech is 1.420809).
...
`NUM` occurs with 4 features: <tt><a href="pt_bosque-feat-NumType.html">NumType</a></tt> (4641; 100% instances), <tt><a href="pt_bosque-feat-Number.html">Number</a></tt> (173; 4% instances), <tt><a href="pt_bosque-feat-Gender.html">Gender</a></tt> (163; 4% instances), <tt><a href="pt_bosque-feat-ExtPos.html">ExtPos</a></tt> (13; 0% instances)
