...
<ul>
<li>This corpus uses 71 lemmas as copulas (<a>cop</a>): 22926, abrir, aceite, además, arrancar, autodefinirse, autoproclamar, caracterizar, cobrar, considerar, costar, dar, donde, el, empatar, en, encontrar, entrar, es, esperar, estar, estilo, esto, explotar, faltar, formar, fue, ganar, garantizar, haber, hablar, hacer, hecho, igual, impedir, iniciar, ir, ligado, mantener, margarina, montar, más, no, notar, o, otro, parecer, pasar, pensar, permanecer, permitir, posponer, producir, que, querer, relajado, representar, resultar, saber, seguir, ser, sufrir, sumar, suponer, tener, terminar, unir, uno, utilizar, ver, vivir.</li>
<li>This corpus uses 327 lemmas as auxiliaries (<a>aux</a>): a, abandonar, abrir, acabar, acampar, acarrear, accidentar, aceptar, acercar, acertar, aclarar, acompañar, acordar, acostumbrar, actuar, acudir, adaptar, adecuar, admitir, advertir, afirmar, agradecer, agresivo, al, alcanzar, alegar, amenazar, ampliar, analizar, anclar, andar, anunciar, aparecer, aplicar, aportar, apostar, apreciar, aprovechar, apuntar, argumentar, armar, asegurar, asumir, avanzar, averiguar, avisar, ayudar, añadir, bandarse, barruntar, batir, buscar, caber, caer, caerse, calcular, cambiar, capitular, ceder, cesar, cifrar, colaborar, colar, colocar, comentar, comenzar, comer, componer, comprender, comprobar, compuesto, comunicar, concentrar, concluir, conducir, confirmar, confundir, conmover, conocer, conseguir, conservar, considerar, constar, constatar, consultar, contentar, contestar, continuar, contrastar, controlar, copular, correr, costear, crecer, creer, dar, dar_parte, de, debe, deber, decidir, decir, declarar, defender, definir, dejar, demoler, demostrar, denunciar, derrotar, desalojar, desaprender, descubrir, desmentir, despedir, destacar, destapar, determinar, devolver, diferenciar, discutir, diseñar, disfrutar, disponer, divertir, echar, echar_leña, ejercer, elevar, emitir, empezar, emplear, en, enarbolar, encontrar, enfrentar, enjugar, ensanchar, entender, entorpecer, entrar, entregar, escribir, escuchar, esgrimir, esperar, establecer, estar, estimar, estudiar, evacuar, evitar, examinar, exigir, expandir, explicar, exponer, expulsar, extender, facilitar, fijar, formar, forzar, fotografiar, ganar, garantizar, generar, gritar, haber, hablar, hacer, hacer_alusión, hacer_hincapié, hallar, han, haver, hinchar, humillar, identificar, ignorar, imaginar, impedir, imponer, incentivar, increpar, indicar, informar, iniciar, insinuar, insistir, intensificar, intentar, interpretar, introducir, investigar, ir, jugar, justificar, lamentar, leer, limpiar, llegar, llevar, lograr, manipular, mantener, marcar, matar, medir, mentir, notar, observar, ocupar, olvidar, opinar, ordenar, oír, pactar, pagar, paralizar, parar, parecer, parte, participar, pasar, patrocinar, pedir, pensar, percibir, permanecer, permitir, podel, poder, poner, precisar, preguntar, presentar, presionar, pretender, probar, proclamar, procurar, progresar, prohibir, promocionar, promulgar, pronosticar, proponer, puntualizar, que, quedar, querer, rasgar, recalcar, recibir, reclamar, reconocer, recordar, rectificar, recuperar, recurrir, reducir, referir, registrar, rehacer, reiterar, reivindicar, relanzar, rematar, remitir, repatriar, repetir, resolver, respaldar, responder, restar, resultar, reunir, revelar, robar, roblar, rodar, romper, rozar, saber, saldar, salir, saltar, salvar, sanear, saquear, seguir, sentar, sentir, ser, señalar, soler, solicitar, solucionar, solventar, someter, sonar, soportar, sostener, subrayar, sufrir, sugerir, suplicar, suponer, temer, tender, tener, tener_que_ver, terminar, tomar, trabajar, trascender, tratar, usar, utilizar, vengar, venir, ver, viajar, vivir, volar, volver.</li>
</ul>
...
<ul>
<li>This corpus uses 1 lemmas as copulas (<a>cop</a>): _.</li>
<li>This corpus uses 1 lemmas as auxiliaries (<a>aux</a>): _.</li>
<li>This corpus uses 1 lemmas as passive auxiliaries (<a>aux:pass</a>): _.</li>
</ul>
