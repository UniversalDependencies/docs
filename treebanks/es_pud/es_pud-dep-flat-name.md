...
2	a	_	DET	DT	Number=Sing|PronType=Ind	3	det	_	Proper=True
3	Wing	_	NOUN	NN	Number=Sing	1	obj	_	Proper=True
4	and	_	CCONJ	CC	_	6	cc	_	Proper=True
5	a	_	DET	DT	Number=Sing|PronType=Ind	6	det	_	Proper=True
6	Prayer	_	NOUN	NN	Number=Sing	3	conj	_	Proper=True
7	(	_	PUNCT	(	_	8	punct	_	SpaceAfter=No
8	1992	_	NUM	CD	Gender=Masc|NumType=Card	1	appos	_	SpaceAfter=No
...
18	su	_	PRON	DTP$	Gender=Masc|Number=Sing|Person=3|Poss=Yes|PronType=Prs	19	det	_	_
...
23	Wheel	_	NOUN	NN	Number=Sing	22	flat:name	_	SpaceAfter=No|Proper=True
