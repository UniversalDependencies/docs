---
layout: base
title:  'Statistics of acl:relcl in UD_Armenian-BSUT'
udver: '2'
---

## Treebank Statistics: UD_Armenian-BSUT: Relations: `acl:relcl`
...
1	Սովորաբար	սովորաբար	ADV	_	_	4	advmod	_	Translit=Sovorabar|LTranslit=sovorabar|SpaceAfter=No
2	,	,	PUNCT	_	_	4	punct	_	Translit=,|LTranslit=,
3	մենք	մենք	PRON	_	Case=Nom|Number=Plur|Person=1|PronType=Prs	4	nsubj	_	Translit=menk’|LTranslit=menk’
4	տեսնում	տեսնել	VERB	_	Aspect=Imp|Subcat=Tran|VerbForm=Part|Voice=Act	0	root	_	Translit=tesnowm|LTranslit=tesnel
...
2	ընդունում	ընդունել	VERB	_	Aspect=Imp|Subcat=Tran|VerbForm=Part|Voice=Act	0	root	_	Translit=ëndownowm|LTranslit=ëndownel
3	ենք	եմ	AUX	_	Aspect=Imp|Mood=Ind|Number=Plur|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin	2	aux	_	Translit=enk’|LTranslit=em
4	այն	այն	DET	_	Deixis=Remt|PronType=Dem	5	det	_	Translit=ayn|LTranslit=ayn
5	կողմը	կողմ	NOUN	_	Animacy=Nhum|Case=Nom|Definite=Def|Number=Sing	2	obj	_	Translit=koġmë|LTranslit=koġm|SpaceAfter=No
6	,	,	PUNCT	_	_	9	punct	_	Translit=,|LTranslit=,
7	որի	որ	PRON	_	Case=Dat|Definite=Ind|Number=Sing|PronType=Rel	9	obl	_	Translit=ori|LTranslit=or
8	հետ	հետ	ADP	_	AdpType=Post	7	case	_	Translit=het|LTranslit=het
9	պատրաստ	պատրաստ	ADJ	_	_	5	acl:relcl	_	Translit=patrast|LTranslit=patrast
...
11	մեզ	մենք	PRON	_	Case=Dat|Number=Plur|Person=1|PronType=Prs	12	obj	_	Translit=mez|LTranslit=menk’
12	նույնացնել	նույնացնել	VERB	_	Polarity=Pos|Subcat=Tran|VerbForm=Inf|Voice=Act	9	xcomp	_	Translit=nowynac’nel|LTranslit=nowynac’nel|SpaceAfter=No
