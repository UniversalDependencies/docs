...
There are 17 `PART` lemmas (2%), 17 `PART` types (2%) and 65 `PART` tokens (3%).
Out of 16 observed tags, the rank of `PART` is: 9 in number of lemmas, 9 in number of types and 9 in number of tokens.
...
The form / lemma ratio of `PART` is 1.000000 (the average of all parts of speech is 1.342857).
...
Children of `PART` nodes are attached using 4 different relations: <tt><a href="kpv_ikdp-dep-punct.html">punct</a></tt> (20; 80% instances), <tt><a href="kpv_ikdp-dep-fixed.html">fixed</a></tt> (3; 12% instances), <tt><a href="kpv_ikdp-dep-advmod.html">advmod</a></tt> (1; 4% instances), <tt><a href="kpv_ikdp-dep-discourse.html">discourse</a></tt> (1; 4% instances)
