...
2	éši	éχu	VERB	VERB	Aspect=Imp|Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
...
5	ci	ci	ADV	ADV	_	2	advmod:emph	_	LC=Yes|MorphSynC=FrGrM|MorphSynSC=EmphPart|OrigLang=tr|SpaceAfter=No
...
2	ci	ci	ADV	_	_	1	advmod:emph	_	LC=Yes|MorphSynC=MorphIn|MorphSynSC=DiscM
...
13	staχtiǰí	staχtiǰís	NOUN	NOUN	Case=Acc|Gender=Masc|Number=Sing	11	obj	_	LC=Yes|MorphSynC=BGrEl|MorphSynSC=DerBouM|SpaceAfter=No
...
7	χič	χič	ADV	ADV	_	9	advmod	_	LC=Yes|MorphSynC=FrGrEl|MorphSynSC=NegQ|Orig=hiç|OrigLang=tr
...
12	éχu	éχu	VERB	VERB	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	3	ccomp	_	LC=Yes|MorphSynC=SynIn|MorphSynSC=HFinVFin|SpaceAfter=No
...
16	rúχa	(rúχu)	NOUN	NOUN	Case=Acc|Gender=Neut|Number=Plur	15	obj	_	_
17	ren	ren	PART	Neg	_	18	advmod	_	_
18	éχu	éχu	VERB	VERB	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	3	ccomp	_	LC=Yes|MorphSynC=SynIn|MorphSynSC=HFinVFin|SpaceAfter=No
19	;	;	PUNCT	PUNCT	_	18	punct	_	_
20	náχala	náχala	ADV	_	_	22	advmod	_	LC=Yes|MorphSynC=FrGrEl|MorphSynSC=WhW|OrigLang=tr
