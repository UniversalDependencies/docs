---
layout: base
title:  'Statistics of csubj:pass in UD_Spanish'
udver: '2'
---

## Treebank Statistics: UD_Spanish: Relations: `csubj:pass`

This relation is a language-specific subtype of <tt><a href="es-dep-csubj.html">csubj</a></tt>.
...
The following 2 pairs of parts of speech are connected with `csubj:pass`: <tt><a href="es-pos-VERB.html">VERB</a></tt>-<tt><a href="es-pos-VERB.html">VERB</a></tt> (6; 86% instances), <tt><a href="es-pos-VERB.html">VERB</a></tt>-<tt><a href="es-pos-ADJ.html">ADJ</a></tt> (1; 14% instances).
