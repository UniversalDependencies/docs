...
10	bir	bir	DET	DT	Definite=Ind|Polarity=Pos	12	det	_	_
...
14	bir	bir	DET	DT	Definite=Ind|Polarity=Pos	16	det	_	_
...
5	önleme	önle	VERB	VN	Aspect=Perf|Mood=Ind|Tense=Pres|VerbForm=Vnoun	6	nmod:poss	_	_
...
6	etmek	et	VERB	VN	Aspect=Perf|Mood=Ind|Number=Sing|Person=3|Tense=Fut|VerbForm=Vnoun	5	compound:lvc	_	_
...
16	inanılmaz	inan	VERB	VJ	Aspect=Hab|Mood=Gen|Number=Sing|Person=3|Polarity=Neg|Tense=Pres|VerbForm=Part|Voice=Pass	18	acl	_	_
