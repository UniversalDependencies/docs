...
2	миян	ми	PRON	Pron	Person=1|PronType=Prs	3	nmod	_	_
3	ае-маме	ае-маме	NOUN	N	Case=Nom|Number=Sing|Number[psor]=Sing|Person[psor]=1	4	nsubj	_	_
4	вӧрзисныс	вӧрзисныс	VERB	V	Mood=Ind|Person=3|Tense=Past|VerbForm=Fin	13	advcl	_	SpaceAfter=No
...
9	миян	ми	PRON	Pron	Person=1|PronType=Prs	8	nmod	_	SpaceAfter=No
