...
7006 tokens (3%) have a non-empty value of `NumType`.
1379 types (6%) occur at least once with a non-empty value of `NumType`.
1338 lemmas (9%) occur at least once with a non-empty value of `NumType`.
The feature is used with 3 part-of-speech tags: <tt><a href="it_vit-pos-NUM.html">NUM</a></tt> (6388; 2% instances), <tt><a href="it_vit-pos-ADJ.html">ADJ</a></tt> (617; 0% instances), <tt><a href="it_vit-pos-NOUN.html">NOUN</a></tt> (1; 0% instances).

### `NUM`

6388 <tt><a href="it_vit-pos-NUM.html">NUM</a></tt> tokens (100% of all `NUM` tokens) have a non-empty value of `NumType`.

`NUM` tokens may have the following values of `NumType`:

* `Card` (6358; 100% of non-empty `NumType`): <em>due, tre, cento, 15, 1, 5, 1973, 2, 20, 30</em>
...
`NumType` seems to be **lexical feature** of `NUM`. 100% lemmas (1302) occur only with one value of `NumType`.
...
* `EMPTY` (19506): <em>precedente, altri, nuovo, grande, economico, stesso, altre, nuova, nuovi, ex</em>
...
<tt>NUM --[<tt><a href="it_vit-dep-flat.html">flat</a></tt>]--> NUM</tt> (256; 100%),
