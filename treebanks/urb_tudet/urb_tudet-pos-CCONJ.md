...
There are 1 `CCONJ` lemmas (0%), 1 `CCONJ` types (0%) and 4 `CCONJ` tokens (1%).
...
The form / lemma ratio of `CCONJ` is 1.000000 (the average of all parts of speech is 1.154229).
