---
layout: base
title:  'Statistics of amod in UD_Latvian-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Latvian-Cairo: Relations: `amod`
...
The following 1 pairs of parts of speech are connected with `amod`: <tt><a href="lv_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="lv_cairo-pos-ADJ.html">ADJ</a></tt> (2; 100% instances).
