---
layout: base
title:  'Statistics of amod:attlvc in UD_Hungarian-Szeged'
udver: '2'
---

## Treebank Statistics: UD_Hungarian-Szeged: Relations: `amod:attlvc`

This relation is a language-specific subtype of .
There are also 1 other language-specific subtypes of `amod`: <tt><a href="hu_szeged-dep-amod-att.html">amod:att</a></tt>.
...
The following 1 pairs of parts of speech are connected with `amod:attlvc`: <tt><a href="hu_szeged-pos-NOUN.html">NOUN</a></tt>-<tt><a href="hu_szeged-pos-ADJ.html">ADJ</a></tt> (3; 100% instances).
...
2	LB-n	LB	PROPN	_	Case=Sup|Number=Sing	6	obl	_	_
3	ugyanis	ugyanis	CCONJ	_	_	6	cc	_	_
4	jogegységi	jogegységi	ADJ	_	Case=Nom|Degree=Pos|Number=Sing	5	amod:att	_	_
5	eljárás	eljárás	NOUN	_	Case=Nom|Number=Sing	6	nsubj	_	_
6	van	van	VERB	_	Definite=Ind|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
7	folyamatban	folyamat	NOUN	_	Case=Ine|Number=Sing	6	obl	_	_
8	avval	az	PRON	_	Case=Ins|Number=Sing|Person=3|PronType=Dem	9	nmod:obl	_	_
9	kapcsolatban	kapcsolat	NOUN	_	Case=Ine|Number=Sing	6	obl	_	SpaceAfter=No
10	,	,	PUNCT	_	_	16	punct	_	_
11	hogy	hogy	SCONJ	_	_	16	mark	_	_
12	egy	egy	DET	_	Definite=Ind|PronType=Art	15	det	_	_
13	pályázaton	pályázat	NOUN	_	Case=Sup|Number=Sing	14	obl	_	_
14	vesztes	vesztes	ADJ	_	Case=Nom|Degree=Pos|Number=Sing	15	amod:att	_	_
15	fél	fél	NOUN	_	Case=Nom|Number=Sing	16	nsubj	_	_
...
26	felbontását	felbontás	NOUN	_	Case=Acc|Number=Sing|Number[psor]=Sing|Person[psor]=3	16	obj	_	SpaceAfter=No
