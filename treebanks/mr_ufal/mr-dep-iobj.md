---
layout: base
title:  'Statistics of iobj in UD_Marathi'
udver: '2'
---

## Treebank Statistics: UD_Marathi: Relations: `iobj`
...
The following 4 pairs of parts of speech are connected with `iobj`: <tt><a href="mr-pos-VERB.html">VERB</a></tt>-<tt><a href="mr-pos-NOUN.html">NOUN</a></tt> (18; 60% instances), <tt><a href="mr-pos-VERB.html">VERB</a></tt>-<tt><a href="mr-pos-PRON.html">PRON</a></tt> (9; 30% instances), <tt><a href="mr-pos-VERB.html">VERB</a></tt>-<tt><a href="mr-pos-ADV.html">ADV</a></tt> (2; 7% instances), <tt><a href="mr-pos-AUX.html">AUX</a></tt>-<tt><a href="mr-pos-PRON.html">PRON</a></tt> (1; 3% instances).
...
4	नकोस	नकोस	AUX	_	Number=Sing|Person=2|Polarity=Neg|VerbForm=Fin	3	aux	_	_
5	,	,	PUNCT	_	_	3	punct	_	_
6	ती	तो	PRON	_	Case=Nom|Distance=Dist|Gender=Fem|Number=Sing|Person=3	7	nsubj	_	_
7	म्हणाली	म्हणणे	VERB	_	Aspect=Perf|Gender=Fem|Number=Sing|Person=3|VerbForm=Fin	3	parataxis	_	_
...
3	ठेवा	ठेवणे	VERB	_	Mood=Imp|Number=Plur|Person=2|VerbForm=Fin	0	root	_	_
...
13	पाठवा	पाठवणे	VERB	_	Mood=Imp|Number=Plur|Person=2|VerbForm=Fin	3	ccomp	_	_
