---
layout: base
title:  'Statistics of Person[dat] in UD_Warlpiri-UFAL'
udver: '2'
---

## Treebank Statistics: UD_Warlpiri-UFAL: Features: `Person[dat]`
...
2 lemmas (3%) occur at least once with a non-empty value of `Person[dat]`.
The feature is used with 2 part-of-speech tags: <tt><a href="wbp_ufal-pos-AUX.html">AUX</a></tt> (5; 2% instances), <tt><a href="wbp_ufal-pos-VERB.html">VERB</a></tt> (1; 0% instances).
...
1 <tt><a href="wbp_ufal-pos-VERB.html">VERB</a></tt> tokens (1% of all `VERB` tokens) have a non-empty value of `Person[dat]`.

The most frequent other feature values with which `VERB` and `Person[dat]` co-occurred: <tt><a href="wbp_ufal-feat-Mood.html">Mood</a></tt><tt>=EMPTY</tt> (1; 100%), <tt><a href="wbp_ufal-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (1; 100%), <tt><a href="wbp_ufal-feat-VerbForm.html">VerbForm</a></tt><tt>=EMPTY</tt> (1; 100%).
