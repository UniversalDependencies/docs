...
The following 1 pairs of parts of speech are connected with `csubj:pass`: <tt><a href="fr_pud-pos-VERB.html">VERB</a></tt>-<tt><a href="fr_pud-pos-VERB.html">VERB</a></tt> (2; 100% instances).
...
13	ceux	celui	PRON	PDEM	Gender=Masc|Number=Plur|PronType=Dem	11	obl	_	_
14	qui	qui	PRON	WP	PronType=Rel	15	nsubj	_	_
...
18	l'	le	DET	DT	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	19	det	_	SpaceAfter=No
