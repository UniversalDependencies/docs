...
There are 489 `ADV` lemmas (9%), 562 `ADV` types (7%) and 1978 `ADV` tokens (10%).
...
The form / lemma ratio of `ADV` is 1.149284 (the average of all parts of speech is 1.566190).
