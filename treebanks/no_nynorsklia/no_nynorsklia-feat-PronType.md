...
The feature is used with 2 part-of-speech tags: <tt><a href="no_nynorsklia-pos-PRON.html">PRON</a></tt> (1994; 15% instances), <tt><a href="no_nynorsklia-pos-DET.html">DET</a></tt> (427; 3% instances).

### `PRON`

1994 <tt><a href="no_nynorsklia-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="no_nynorsklia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (1422; 71%), <tt><a href="no_nynorsklia-feat-Person.html">Person</a></tt><tt>=3</tt> (1130; 57%), <tt><a href="no_nynorsklia-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (1122; 56%), <tt><a href="no_nynorsklia-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (1121; 56%), <tt><a href="no_nynorsklia-feat-Case.html">Case</a></tt><tt>=Nom</tt> (1026; 51%).
...
* `Prs` (1770; 89% of non-empty `PronType`): <em>det, eg, dei, du, vi, han, den, de, ho, seg</em>
...
427 <tt><a href="no_nynorsklia-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `DET` and `PronType` co-occurred: <tt><a href="no_nynorsklia-feat-Number.html">Number</a></tt><tt>=Sing</tt> (321; 75%).

`DET` tokens may have the following values of `PronType`:

* `Art` (135; 32% of non-empty `PronType`): <em>ein, ei, eit, eitt</em>
* `Dem` (199; 47% of non-empty `PronType`): <em>den, dei, andre, det, same, sånn, anna, annan, sånne, desse</em>
* `Ind` (42; 10% of non-empty `PronType`): <em>noko, nokon, nokre, noka</em>
* `Int` (9; 2% of non-empty `PronType`): <em>kva</em>
* `Neg` (1; 0% of non-empty `PronType`): <em>ingen</em>
* `Prs` (3; 1% of non-empty `PronType`): <em>eigen, eige</em>
* `Tot` (38; 9% of non-empty `PronType`): <em>alle, kvar, alt, begge, kvart, all</em>
