...
1	Ya	ya	INTJ	_	_	2	discourse	_	CSID=TR|Lang=tr
2	değil	değil	PART	_	_	0	root	_	CSID=TR|Lang=tr
3	mi	mi	AUX	_	Number=Sing|Person=3	2	aux:q	_	CSID=TR|Lang=tr
4	bir	bir	ADV	_	_	8	advmod	_	CSID=TR|Lang=tr
5	de	de	ADV	_	_	4	advmod:emph	_	CSID=TR|Lang=tr
6	işte	işte	INTJ	_	_	8	discourse	_	CSID=TR|Lang=tr
7	Hausarbeit	Hausarbeit	NOUN	_	Case=Acc|Gender=Fem|Number=Sing	8	obj	_	CSID=DE|Lang=de
8	yazmıştım	yaz	VERB	_	Aspect=Perf|Evident=Nfh|Mood=Ind|Number=Sing|Person=1|Tense=Pqp	2	parataxis	_	CSID=TR|Lang=tr
9	für	für	ADP	_	_	10	case	_	CSID=DE|Lang=de
10	Sprache	Sprache	NOUN	_	Case=Acc|Gender=Fem|Number=Sing	8	obl	_	CSID=DE|Lang=de
11	Gehirn	Gehirn	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	10	appos	_	CSID=DE|Lang=de|SpaceAfter=No
...
2	bu	bu	PRON	_	Case=Nom|Number=Sing|PronType=Dem	5	nsubj	_	CSID=TR|Lang=tr
3	en	en	ADV	_	_	4	advmod	_	CSID=TR|Lang=tr
4	kolay	kolay	ADJ	_	_	5	amod	_	CSID=TR|Lang=tr
5	şeyler	şey	NOUN	_	Case=Nom|Number=Plur	0	root	_	CSID=TR|Lang=tr
6	daha	daha	ADV	_	_	5	advmod	_	CSID=TR|Lang=tr
7	çok	çok	ADV	_	_	5	advmod	_	CSID=TR|Lang=tr
8	ben	ben	PRON	_	Case=Nom|Number=Sing|Person=1|PronType=Prs	11	nsubj	_	CSID=TR|Lang=tr
9	Statistik	Statistik	NOUN	_	Case=Nom|Gender=Fem|Number=Sing	11	obl	_	CSID=DE|Lang=de
