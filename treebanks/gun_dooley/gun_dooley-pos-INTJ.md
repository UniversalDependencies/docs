---
layout: base
title:  'Statistics of INTJ in UD_Mbya_Guarani-Dooley'
udver: '2'
---

## Treebank Statistics: UD_Mbya_Guarani-Dooley: POS Tags: `INTJ`

There are 2 `INTJ` lemmas (2%), 2 `INTJ` types (2%) and 16 `INTJ` tokens (0%).
Out of 16 observed tags, the rank of `INTJ` is: 12 in number of lemmas, 12 in number of types and 13 in number of tokens.

The 10 most frequent `INTJ` lemmas: <em>_, toko</em>

The 10 most frequent `INTJ` types:  <em>_, toko</em>
...
The form / lemma ratio of `INTJ` is 1.000000 (the average of all parts of speech is 1.056452).

The 1st highest number of forms (1) was observed with the lemma “_”: <em>_</em>.

The 2nd highest number of forms (1) was observed with the lemma “toko”: <em>toko</em>.
...
`INTJ` nodes are attached to their parents using 5 different relations: <tt><a href="gun_dooley-dep-conj.html">conj</a></tt> (5; 31% instances), <tt><a href="gun_dooley-dep-flat.html">flat</a></tt> (4; 25% instances), <tt><a href="gun_dooley-dep-parataxis-rep.html">parataxis:rep</a></tt> (4; 25% instances), <tt><a href="gun_dooley-dep-parataxis.html">parataxis</a></tt> (2; 13% instances), <tt><a href="gun_dooley-dep-discourse.html">discourse</a></tt> (1; 6% instances)

Parents of `INTJ` nodes belong to 3 different parts of speech: <tt><a href="gun_dooley-pos-INTJ.html">INTJ</a></tt> (7; 44% instances), <tt><a href="gun_dooley-pos-VERB.html">VERB</a></tt> (5; 31% instances), <tt><a href="gun_dooley-pos-NOUN.html">NOUN</a></tt> (4; 25% instances)

4 (25%) `INTJ` nodes are leaves.

5 (31%) `INTJ` nodes have one child.

3 (19%) `INTJ` nodes have two children.

4 (25%) `INTJ` nodes have three or more children.

The highest child degree of a `INTJ` node is 3.

Children of `INTJ` nodes are attached using 4 different relations: <tt><a href="gun_dooley-dep-punct.html">punct</a></tt> (15; 65% instances), <tt><a href="gun_dooley-dep-conj.html">conj</a></tt> (5; 22% instances), <tt><a href="gun_dooley-dep-parataxis.html">parataxis</a></tt> (2; 9% instances), <tt><a href="gun_dooley-dep-fixed.html">fixed</a></tt> (1; 4% instances)

Children of `INTJ` nodes belong to 3 different parts of speech: <tt><a href="gun_dooley-pos-PUNCT.html">PUNCT</a></tt> (15; 65% instances), <tt><a href="gun_dooley-pos-INTJ.html">INTJ</a></tt> (7; 30% instances), <tt><a href="gun_dooley-pos-PART.html">PART</a></tt> (1; 4% instances)
