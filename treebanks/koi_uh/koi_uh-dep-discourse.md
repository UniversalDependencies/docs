...
5	эн	оз	AUX	V	Mood=Ind|Number=Sing|Person=2|Polarity=Neg|Tense=Past|VerbForm=Fin	6	aux	_	GTtags=Neg,Ind,Prt1,Sg2
...
13	юаліс	юавны	VERB	V	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	6	parataxis	_	GTtags=Ind,Prt1,Sg3
