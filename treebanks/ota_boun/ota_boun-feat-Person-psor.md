...
1303 tokens (15%) have a non-empty value of `Person[psor]`.
1031 types (24%) occur at least once with a non-empty value of `Person[psor]`.
671 lemmas (26%) occur at least once with a non-empty value of `Person[psor]`.
The feature is used with 7 part-of-speech tags: <tt><a href="ota_boun-pos-NOUN.html">NOUN</a></tt> (985; 11% instances), <tt><a href="ota_boun-pos-VERB.html">VERB</a></tt> (195; 2% instances), <tt><a href="ota_boun-pos-PRON.html">PRON</a></tt> (60; 1% instances), <tt><a href="ota_boun-pos-ADJ.html">ADJ</a></tt> (42; 0% instances), <tt><a href="ota_boun-pos-PROPN.html">PROPN</a></tt> (16; 0% instances), <tt><a href="ota_boun-pos-AUX.html">AUX</a></tt> (3; 0% instances), <tt><a href="ota_boun-pos-NUM.html">NUM</a></tt> (2; 0% instances).

### `NOUN`

985 <tt><a href="ota_boun-pos-NOUN.html">NOUN</a></tt> tokens (31% of all `NOUN` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `NOUN` and `Person[psor]` co-occurred: <tt><a href="ota_boun-feat-Person.html">Person</a></tt><tt>=3</tt> (985; 100%), <tt><a href="ota_boun-feat-Number-psor.html">Number[psor]</a></tt><tt>=Sing</tt> (910; 92%), <tt><a href="ota_boun-feat-Number.html">Number</a></tt><tt>=Sing</tt> (727; 74%).
...
`Person[psor]` seems to be **lexical feature** of `NOUN`. 94% lemmas (509) occur only with one value of `Person[psor]`.

### `VERB`

195 <tt><a href="ota_boun-pos-VERB.html">VERB</a></tt> tokens (14% of all `VERB` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `VERB` and `Person[psor]` co-occurred: <tt><a href="ota_boun-feat-Evident.html">Evident</a></tt><tt>=EMPTY</tt> (195; 100%), <tt><a href="ota_boun-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (180; 92%), <tt><a href="ota_boun-feat-Polarity.html">Polarity</a></tt><tt>=Pos</tt> (173; 89%), <tt><a href="ota_boun-feat-Number-psor.html">Number[psor]</a></tt><tt>=Sing</tt> (165; 85%), <tt><a href="ota_boun-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt> (157; 81%), <tt><a href="ota_boun-feat-Aspect.html">Aspect</a></tt><tt>=Perf</tt> (140; 72%), <tt><a href="ota_boun-feat-Tense.html">Tense</a></tt><tt>=Past</tt> (140; 72%), <tt><a href="ota_boun-feat-Person.html">Person</a></tt><tt>=3</tt> (111; 57%).
...
<table>
  ...
  <tr><td><tt><tt><a href="ota_boun-feat-Aspect.html">Aspect</a></tt><tt>=Perf</tt>|<tt><a href="ota_boun-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="ota_boun-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="ota_boun-feat-Number-psor.html">Number[psor]</a></tt><tt>=Sing</tt>|<tt><a href="ota_boun-feat-Person.html">Person</a></tt><tt>=3</tt>|<tt><a href="ota_boun-feat-Person-psor.html">Person[psor]</a></tt><tt>=3</tt>|<tt><a href="ota_boun-feat-Polarity.html">Polarity</a></tt><tt>=Neg</tt>|<tt><a href="ota_boun-feat-Tense.html">Tense</a></tt><tt>=Past</tt>|<tt><a href="ota_boun-feat-VerbForm.html">VerbForm</a></tt><tt>=Part</tt></tt></td><td></td><td></td><td><em>olmadığını</em></td></tr>
...
42 <tt><a href="ota_boun-pos-ADJ.html">ADJ</a></tt> tokens (5% of all `ADJ` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `ADJ` and `Person[psor]` co-occurred: <tt><a href="ota_boun-feat-Person.html">Person</a></tt><tt>=3</tt> (42; 100%), <tt><a href="ota_boun-feat-Number.html">Number</a></tt><tt>=Sing</tt> (36; 86%).
...
`Person[psor]` seems to be **lexical feature** of `ADJ`. 97% lemmas (34) occur only with one value of `Person[psor]`.

### `PROPN`

16 <tt><a href="ota_boun-pos-PROPN.html">PROPN</a></tt> tokens (6% of all `PROPN` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `PROPN` and `Person[psor]` co-occurred: <tt><a href="ota_boun-feat-Person.html">Person</a></tt><tt>=3</tt> (16; 100%), <tt><a href="ota_boun-feat-Number.html">Number</a></tt><tt>=Sing</tt> (14; 88%).
...
2 <tt><a href="ota_boun-pos-NUM.html">NUM</a></tt> tokens (2% of all `NUM` tokens) have a non-empty value of `Person[psor]`.

The most frequent other feature values with which `NUM` and `Person[psor]` co-occurred: <tt><a href="ota_boun-feat-NumType.html">NumType</a></tt><tt>=EMPTY</tt> (2; 100%).
...
<tt>NOUN --[<tt><a href="ota_boun-dep-conj.html">conj</a></tt>]--> NOUN</tt> (53; 53%),
<tt>VERB --[<tt><a href="ota_boun-dep-conj.html">conj</a></tt>]--> VERB</tt> (7; 88%),
...
<tt>PRON --[<tt><a href="ota_boun-dep-nmod.html">nmod</a></tt>]--> ADJ</tt> (1; 100%),
