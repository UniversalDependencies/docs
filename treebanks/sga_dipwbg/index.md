...
Search this treebank on-line: [PML-TQ](https://lindat.mff.cuni.cz/services/pmltq/#!/treebank/udsga_dipwbg213)<br />
...
You can report bugs in this treebank in the [treebank-specific issue tracker on Github](https://github.com/UniversalDependencies/UD_Old_Irish-DipWBG/issues).
...
[Abbr](sga_dipwbg-feat-Abbr.html) – [AdpType](sga_dipwbg-feat-AdpType.html) – [Aspect](sga_dipwbg-feat-Aspect.html) – [Case](sga_dipwbg-feat-Case.html) – [Definite](sga_dipwbg-feat-Definite.html) – [Degree](sga_dipwbg-feat-Degree.html) – [Foreign](sga_dipwbg-feat-Foreign.html) – [Gender](sga_dipwbg-feat-Gender.html) – [Mood](sga_dipwbg-feat-Mood.html) – [Number](sga_dipwbg-feat-Number.html) – [PartType](sga_dipwbg-feat-PartType.html) – [Person](sga_dipwbg-feat-Person.html) – [Polarity](sga_dipwbg-feat-Polarity.html) – [Poss](sga_dipwbg-feat-Poss.html) – [Prefix](sga_dipwbg-feat-Prefix.html) – [PronClass](sga_dipwbg-feat-PronClass.html) – [PronType](sga_dipwbg-feat-PronType.html) – [Tense](sga_dipwbg-feat-Tense.html) – [VerbType](sga_dipwbg-feat-VerbType.html) – [Voice](sga_dipwbg-feat-Voice.html)
