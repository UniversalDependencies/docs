...
The feature is used with 2 part-of-speech tags: [-pos/DET]() (111; 0% instances), [-pos/ADJ]() (1; 0% instances).

### `DET`

111 [-pos/DET]() tokens (19% of all `DET` tokens) have a non-empty value of `Gender[psor]`.
...
1 [-pos/ADJ]() tokens (0% of all `ADJ` tokens) have a non-empty value of `Gender[psor]`.
