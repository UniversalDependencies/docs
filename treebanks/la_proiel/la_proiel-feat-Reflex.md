---
layout: base
title:  'Statistics of Reflex in UD_Latin-PROIEL'
udver: '2'
---

## Treebank Statistics: UD_Latin-PROIEL: Features: `Reflex`
...
1004 <tt><a href="la_proiel-pos-PRON.html">PRON</a></tt> tokens (5% of all `PRON` tokens) have a non-empty value of `Reflex`.

The most frequent other feature values with which `PRON` and `Reflex` co-occurred: <tt><a href="la_proiel-feat-Person.html">Person</a></tt><tt>=3</tt> (1004; 100%), <tt><a href="la_proiel-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (1004; 100%), <tt><a href="la_proiel-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (875; 87%), <tt><a href="la_proiel-feat-Case.html">Case</a></tt><tt>=Acc</tt> (695; 69%), <tt><a href="la_proiel-feat-Number.html">Number</a></tt><tt>=Sing</tt> (605; 60%).

`PRON` tokens may have the following values of `Reflex`:

* `Yes` (1004; 100% of non-empty `Reflex`): <em>se, sibi, sese, sui</em>
* `EMPTY` (17502): <em>qui, me, quae, eum, eius, quod, te, vobis, vos, ego</em>
