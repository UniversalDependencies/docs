...
8948 tokens (18%) have a non-empty value of `PronType`.
...
The feature is used with 2 part-of-speech tags: <tt><a href="af_afribooms-pos-DET.html">DET</a></tt> (5341; 11% instances), <tt><a href="af_afribooms-pos-PRON.html">PRON</a></tt> (3607; 7% instances).
...
3607 <tt><a href="af_afribooms-pos-PRON.html">PRON</a></tt> tokens (100% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="af_afribooms-feat-Poss.html">Poss</a></tt><tt>=EMPTY</tt> (2970; 82%), <tt><a href="af_afribooms-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (2137; 59%).
...
* `Rel` (1115; 31% of non-empty `PronType`): <em>wat, daarvan, waar, wanneer, watter, daartoe, wie, daarop, hoe, waarin</em>
