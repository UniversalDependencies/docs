...
There are 1087 `ADV` lemmas (8%), 1183 `ADV` types (4%) and 10830 `ADV` tokens (6%).
...
The form / lemma ratio of `ADV` is 1.088316 (the average of all parts of speech is 1.973298).
