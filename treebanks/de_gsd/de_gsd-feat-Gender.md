...
50882 <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> tokens (97% of all `NOUN` tokens) have a non-empty value of `Gender`.
...
* `Masc` (18403; 36% of non-empty `Gender`): <em>Teil, Ort, Menschen, Platz, Sohn, km, Namen, Anfang, Titel, Meter</em>
* `Neut` (11320; 22% of non-empty `Gender`): <em>jahr, Jahre, Jahren, Prozent, Ende, %, Unternehmen, Kinder, Leben, Mitglied</em>
* `EMPTY` (1320): <em>mm, Eltern, Jahrhundert, Leute, Kosten, °, m, mal, Deutschen, Beschäftigten</em>
...
36989 <tt><a href="de_gsd-pos-DET.html">DET</a></tt> tokens (98% of all `DET` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `DET` and `Gender` co-occurred: <tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (34028; 92%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (32082; 87%), <tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (28840; 78%).

`DET` tokens may have the following values of `Gender`:

* `Fem` (15686; 42% of non-empty `Gender`): <em>der, die, eine, einer, den, seine, seiner, ihre, ihrer, meine</em>
* `Masc` (13242; 36% of non-empty `Gender`): <em>dem, der, den, des, die, ein, einen, einem, eines, seinen</em>
* `Neut` (8061; 22% of non-empty `Gender`): <em>dem, das, ein, des, die, den, einem, der, sein, eines</em>
* `EMPTY` (672): <em>die, den, der, deren, viel, viele, seine, weniger, genügend, anderen</em>

<table>
  <tr><th>Paradigm <i>der</i></th><th><tt>Masc</tt></th><th><tt>Fem</tt></th><th><tt>Neut</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>den</em></td><td><em>die, der</em></td><td><em>das, 's</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>des</em></td><td><em>der, Die</em></td><td><em>des, der</em></td></tr>
...
26292 <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> tokens (86% of all `PROPN` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PROPN` and `Gender` co-occurred: <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (25145; 96%).

`PROPN` tokens may have the following values of `Gender`:

* `Fem` (5759; 22% of non-empty `Gender`): <em>SPD, Mark, Universität, Schweiz, US, Maria, DDR, Deutschen, CDU, Straße</em>
* `Masc` (12812; 49% of non-empty `Gender`): <em>Oktober, US, August, Mai, November, September, Juli, Peter, Weltkrieg, Johann</em>
* `Neut` (7721; 29% of non-empty `Gender`): <em>Deutschland, Berlin, Frankreich, München, New, Wien, London, Paris, St., Italien</em>
* `EMPTY` (4388): <em>of, de, the, a, la, University, II, Wiener, Berliner, 1</em>
...
* `Fem` (6463; 45% of non-empty `Gender`): <em>erste, ersten, neue, weitere, große, gute, deutschen, anderen, andere, verschiedenen</em>
* `Masc` (4773; 33% of non-empty `Gender`): <em>ersten, zweiten, anderen, neuen, großen, erste, weiteren, weitere, heutigen, amerikanischen</em>
* `Neut` (3020; 21% of non-empty `Gender`): <em>ersten, erste, anderen, letzten, weitere, neuen, gleichen, andere, neues, gutes</em>
* `EMPTY` (6519): <em>später, bekannt, gut, kurz, freundlich, lang, möglich, neu, stark, tätig</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>ersten</em></td><td><em>ersten, erster</em></td><td><em>ersten</em></td></tr>
...
8962 <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> tokens (63% of all `PRON` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `PRON` and `Gender` co-occurred: <tt><a href="de_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (8961; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7925; 88%), <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt> (5983; 67%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (4753; 53%).

`PRON` tokens may have the following values of `Gender`:

* `Fem` (2307; 26% of non-empty `Gender`): <em>sie, die, diese, dieser, keine, der, ihr, alle, beiden, eine</em>
* `Masc` (3956; 44% of non-empty `Gender`): <em>er, der, ihm, ihn, diesem, dieser, dem, diesen, einer, beiden</em>
* `Neut` (2699; 30% of non-empty `Gender`): <em>es, das, was, dies, dieses, allem, alles, anderem, dem, diesem</em>
* `EMPTY` (5241): <em>sich, ich, die, sie, man, wir, uns, mir, mich, denen</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>den, der</em></td><td><em>die</em></td><td><em>das</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Acc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>die</em></td><td><em>die</em></td><td><em>die</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>dem</em></td><td><em>der</em></td><td><em>dem</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-Poss.html">Poss</a></tt><tt>=Yes</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td></td><td></td><td><em>deren</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Dat</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>denen</em></td><td><em>denen, den</em></td><td><em>denen</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Dem</tt></tt></td><td><em>dessen</em></td><td><em>deren</em></td><td><em>dessen</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Gen</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>dessen</em></td><td><em>der, deren, derer</em></td><td><em>die</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>der, die</em></td><td><em>die</em></td><td><em>das</em></td></tr>
...
175 <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> tokens (2% of all `NUM` tokens) have a non-empty value of `Gender`.

The most frequent other feature values with which `NUM` and `Gender` co-occurred: <tt><a href="de_gsd-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (175; 100%).

`NUM` tokens may have the following values of `Gender`:

* `Fem` (67; 38% of non-empty `Gender`): <em>eine, einer, Millionen, zweier, 15, Million, 30, 35, 6, 1.681.469</em>
* `Masc` (54; 31% of non-empty `Gender`): <em>ein, einem, einen, 50, 10, 28, 7, -10, -2288,9, -60</em>
* `Neut` (54; 31% of non-empty `Gender`): <em>ein, 3, einem, 10, 1:1, ², +7,6, 100, 1000, 17</em>
* `EMPTY` (7232): <em>zwei, drei, vier, 2007, 2006, fünf, 2009, 2010, sechs, 2008</em>
...
* `EMPTY` (255): <em>'s, u.a., etc., z.B., z., a, z, †, u, *</em>
...
* `Fem` (17; 27% of non-empty `Gender`): <em>lange, super, Allzeit, Kehrt, Nahe, Wenige, Zügig, absolute, aka, ca</em>
* `Masc` (21; 33% of non-empty `Gender`): <em>Abends, Anfangs, ECHT, EINFACH, Ex, Gottlob, Katzelmacher, Křižanov, NIE, NIEMALS</em>
* `Neut` (26; 41% of non-empty `Gender`): <em>was, allem, ca, alles, anderem, Dort, How, Mal, PMMA, Rääts</em>
* `EMPTY` (14780): <em>auch, nur, noch, sehr, so, dort, wieder, hier, mehr, heute</em>
...
<tt>NOUN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (27006; 95%),
<tt>NOUN --[<tt><a href="de_gsd-dep-amod.html">amod</a></tt>]--> ADJ</tt> (12061; 91%),
<tt>PROPN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (4882; 87%),
<tt>PROPN --[<tt><a href="de_gsd-dep-flat.html">flat</a></tt>]--> PROPN</tt> (4779; 82%),
<tt>NOUN --[<tt><a href="de_gsd-dep-det-poss.html">det:poss</a></tt>]--> DET</tt> (2159; 95%),
<tt>NOUN --[<tt><a href="de_gsd-dep-appos.html">appos</a></tt>]--> PROPN</tt> (1765; 55%),
<tt>NOUN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> PRON</tt> (1584; 88%),
<tt>PROPN --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> PROPN</tt> (1307; 63%),
<tt>PROPN --[<tt><a href="de_gsd-dep-amod.html">amod</a></tt>]--> PROPN</tt> (1075; 75%),
<tt>NOUN --[<tt><a href="de_gsd-dep-compound.html">compound</a></tt>]--> NOUN</tt> (668; 78%).
