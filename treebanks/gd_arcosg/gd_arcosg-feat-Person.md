...
The feature is used with 3 part-of-speech tags: <tt><a href="gd_arcosg-pos-PRON.html">PRON</a></tt> (7991; 9% instances), <tt><a href="gd_arcosg-pos-DET.html">DET</a></tt> (884; 1% instances), <tt><a href="gd_arcosg-pos-VERB.html">VERB</a></tt> (344; 0% instances).
...
* `EMPTY` (1616): <em>sin, fhèin, seo, dè, fhéin, cò, siud, dé, chèile, dhà</em>
...
344 <tt><a href="gd_arcosg-pos-VERB.html">VERB</a></tt> tokens (4% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="gd_arcosg-feat-Tense.html">Tense</a></tt><tt>=EMPTY</tt> (208; 60%).

`VERB` tokens may have the following values of `Person`:

* `0` (164; 48% of non-empty `Person`): <em>rinneadh, thathar, thugadh, chuireadh, thathas, dh'fhaoidte, faodar, feumar, fhuaras, rugadh</em>
...
* `EMPTY` (8827): <em>tha, bha, robh, eil, bheil, chaidh, bhiodh, fhuair, thuirt, ars’</em>
