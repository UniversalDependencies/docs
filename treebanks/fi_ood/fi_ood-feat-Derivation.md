...
1106 tokens (6%) have a non-empty value of `Derivation`.
891 types (11%) occur at least once with a non-empty value of `Derivation`.
683 lemmas (13%) occur at least once with a non-empty value of `Derivation`.
The feature is used with 5 part-of-speech tags: <tt><a href="fi_ood-pos-NOUN.html">NOUN</a></tt> (476; 2% instances), <tt><a href="fi_ood-pos-ADJ.html">ADJ</a></tt> (435; 2% instances), <tt><a href="fi_ood-pos-ADV.html">ADV</a></tt> (192; 1% instances), <tt><a href="fi_ood-pos-PRON.html">PRON</a></tt> (2; 0% instances), <tt><a href="fi_ood-pos-PROPN.html">PROPN</a></tt> (1; 0% instances).

### `NOUN`

476 <tt><a href="fi_ood-pos-NOUN.html">NOUN</a></tt> tokens (9% of all `NOUN` tokens) have a non-empty value of `Derivation`.

The most frequent other feature values with which `NOUN` and `Derivation` co-occurred: <tt><a href="fi_ood-feat-Number.html">Number</a></tt><tt>=Sing</tt> (388; 82%).
...
`Derivation` seems to be **lexical feature** of `NOUN`. 99% lemmas (322) occur only with one value of `Derivation`.
