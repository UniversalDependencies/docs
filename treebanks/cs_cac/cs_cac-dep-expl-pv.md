...
2	zásadu	zásada	NOUN	NNFS4-----A----	Case=Acc|Gender=Fem|Number=Sing	3	obj	3:obj	_
...
6	opatření	opatření	NOUN	NNNP2-----A----	Case=Gen|Gender=Neut|Number=Plur|VerbForm=Vnoun	3	obl	3:obl:do:gen	LDeriv=opatřit
...
10	sféry	sféra	NOUN	NNFS2-----A----	Case=Gen|Gender=Fem|Number=Sing	7	obl:arg	7:obl:arg:gen	SpaceAfter=No
...
1	Učení	učení	NOUN	NNNS1-----A----	Case=Nom|Gender=Neut|Number=Sing|VerbForm=Vnoun	5	nsubj	5:nsubj	LDeriv=učit
...
4	odpovědím	odpověď	NOUN	NNFP3-----A----	Case=Dat|Gender=Fem|Number=Plur	1	nmod	1:nmod:dat	_
...
8	uplatnění	uplatnění	NOUN	NNNS6-----A----	Case=Loc|Gender=Neut|Number=Sing|VerbForm=Vnoun	5	obl:arg	5:obl:arg:na:loc	SpaceAfter=No|LDeriv=uplatnit
