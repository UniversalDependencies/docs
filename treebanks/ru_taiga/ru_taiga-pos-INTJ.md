...
There are 97 `INTJ` lemmas (0%), 107 `INTJ` types (0%) and 279 `INTJ` tokens (0%).
...
* <em>ту</em>
  * <tt><a href="ru_taiga-pos-DET.html">DET</a></tt> 11: <em>Она стояла По <b>ту</b> сторону Поля</em>
  * <tt><a href="ru_taiga-pos-ADV.html">ADV</a></tt> 1: <em>Я верю в просто общение / дружбу между м и ж , но <b>ту</b> вообще не поверила .</em>
  * <tt><a href="ru_taiga-pos-INTJ.html">INTJ</a></tt> 1: <em>Я конечно понимаю что это прозвучит глупо ???? , но её бит напоминает что-то типо тун тун туру <b>ту</b> тун и в ней нет слов ( ну по крайней мере нет слов в тех коротких видео которые я посмотрела в тик токе )</em>

## Morphology

The form / lemma ratio of `INTJ` is 1.103093 (the average of all parts of speech is 1.875784).
