---
layout: base
title:  'Statistics of flat:name in UD_Chinese-GSDSimp'
udver: '2'
---

## Treebank Statistics: UD_Chinese-GSDSimp: Relations: `flat:name`

This relation is a language-specific subtype of .
There are also 1 other language-specific subtypes of `flat`: <tt><a href="zh_gsdsimp-dep-flat-foreign.html">flat:foreign</a></tt>.
...
The following 1 pairs of parts of speech are connected with `flat:name`: <tt><a href="zh_gsdsimp-pos-PROPN.html">PROPN</a></tt>-<tt><a href="zh_gsdsimp-pos-PROPN.html">PROPN</a></tt> (1216; 100% instances).
