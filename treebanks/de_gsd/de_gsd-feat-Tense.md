...
22351 tokens (8%) have a non-empty value of `Tense`.
2897 types (6%) occur at least once with a non-empty value of `Tense`.
1546 lemmas (4%) occur at least once with a non-empty value of `Tense`.
The feature is used with 13 part-of-speech tags: <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> (11788; 4% instances), <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> (10349; 4% instances), <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> (78; 0% instances), <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> (53; 0% instances), <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> (47; 0% instances), <tt><a href="de_gsd-pos-X.html">X</a></tt> (15; 0% instances), <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> (8; 0% instances), <tt><a href="de_gsd-pos-PART.html">PART</a></tt> (4; 0% instances), <tt><a href="de_gsd-pos-ADP.html">ADP</a></tt> (3; 0% instances), <tt><a href="de_gsd-pos-CCONJ.html">CCONJ</a></tt> (3; 0% instances), <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-PUNCT.html">PUNCT</a></tt> (1; 0% instances), <tt><a href="de_gsd-pos-SCONJ.html">SCONJ</a></tt> (1; 0% instances).

### `VERB`

11788 <tt><a href="de_gsd-pos-VERB.html">VERB</a></tt> tokens (59% of all `VERB` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `VERB` and `Tense` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11788; 100%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (11603; 98%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (11402; 97%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9262; 79%).

`VERB` tokens may have the following values of `Tense`:

* `Past` (6041; 51% of non-empty `Tense`): <em>kam, hatte, gab, war, erhielt, ging, begann, führte, nahm, spielte</em>
* `Pres` (5747; 49% of non-empty `Tense`): <em>gibt, hat, liegt, befindet, ist, gehört, besteht, steht, kommt, haben</em>
* `EMPTY` (8134): <em>empfehlen, gegründet, lassen, machen, verwendet, eingesetzt, genutzt, gebaut, aufgenommen, errichtet</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td><em>hat</em></td><td><em>hatte</em></td></tr>
...
10349 <tt><a href="de_gsd-pos-AUX.html">AUX</a></tt> tokens (91% of all `AUX` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `AUX` and `Tense` co-occurred: <tt><a href="de_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (10349; 100%), <tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt> (9846; 95%), <tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (9772; 94%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (7752; 75%), <tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=EMPTY</tt> (7703; 74%).

`AUX` tokens may have the following values of `Tense`:

* `Past` (4623; 45% of non-empty `Tense`): <em>wurde, war, wurden, waren, hatte, konnte, sollte, musste, hatten, konnten</em>
* `Pres` (5726; 55% of non-empty `Tense`): <em>ist, sind, wird, kann, werden, hat, haben, habe, können, sei</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-Person.html">Person</a></tt><tt>=3</tt></tt></td><td><em>ist</em></td><td><em>war</em></td></tr>
...
78 <tt><a href="de_gsd-pos-ADJ.html">ADJ</a></tt> tokens (0% of all `ADJ` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `ADJ` and `Tense` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (78; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (78; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (55; 71%).
...
<table>
  ...
  <tr><td><tt></tt></td><td><em>weiß</em></td><td><em>wusste</em></td></tr>
</table>

`Tense` seems to be **lexical feature** of `ADJ`. 99% lemmas (70) occur only with one value of `Tense`.

### `NOUN`

53 <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> tokens (0% of all `NOUN` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `NOUN` and `Tense` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (53; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (53; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (35; 66%).
...
47 <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> tokens (0% of all `PROPN` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `PROPN` and `Tense` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (47; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (47; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (38; 81%).
...
`Tense` seems to be **lexical feature** of `PROPN`. 97% lemmas (38) occur only with one value of `Tense`.

### `X`

15 <tt><a href="de_gsd-pos-X.html">X</a></tt> tokens (4% of all `X` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `X` and `Tense` co-occurred: <tt><a href="de_gsd-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (15; 100%), <tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (15; 100%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10; 67%).

`X` tokens may have the following values of `Tense`:

* `Past` (11; 73% of non-empty `Tense`): <em>wurde, wurden, og, registrierten, sog, vergl</em>
* `Pres` (4; 27% of non-empty `Tense`): <em>wird, DasFahren, z</em>
* `EMPTY` (354): <em>z.B., u.a., =, %, B., etc., †, &amp;, *, a</em>

<table>
  <tr><th>Paradigm <i>werden</i></th><th><tt>Pres</tt></th><th><tt>Past</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>Wird</em></td><td><em>wurde</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=Pass</tt></tt></td><td><em>wird</em></td><td><em>wurde</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-Voice.html">Voice</a></tt><tt>=Pass</tt></tt></td><td></td><td><em>wurden</em></td></tr>
</table>

### `ADV`

8 <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Tense`.
...
4 <tt><a href="de_gsd-pos-PART.html">PART</a></tt> tokens (0% of all `PART` tokens) have a non-empty value of `Tense`.

The most frequent other feature values with which `PART` and `Tense` co-occurred: <tt><a href="de_gsd-feat-Polarity.html">Polarity</a></tt><tt>=EMPTY</tt> (4; 100%).

`PART` tokens may have the following values of `Tense`:

* `Past` (3; 75% of non-empty `Tense`): <em>einnahm, auflief</em>
* `Pres` (1; 25% of non-empty `Tense`): <em>wehe</em>
* `EMPTY` (2162): <em>nicht, zu, aus, an, ja, nein, 's, Hallo, hin, her</em>

### `ADP`

3 <tt><a href="de_gsd-pos-ADP.html">ADP</a></tt> tokens (0% of all `ADP` tokens) have a non-empty value of `Tense`.

`ADP` tokens may have the following values of `Tense`:

* `Past` (3; 100% of non-empty `Tense`): <em>empfahl, liess, schrieb</em>
* `EMPTY` (31686): <em>in, von, mit, zu, an, auf, für, als, nach, bei</em>

### `CCONJ`

3 <tt><a href="de_gsd-pos-CCONJ.html">CCONJ</a></tt> tokens (0% of all `CCONJ` tokens) have a non-empty value of `Tense`.
...
1 <tt><a href="de_gsd-pos-PUNCT.html">PUNCT</a></tt> tokens (0% of all `PUNCT` tokens) have a non-empty value of `Tense`.

`PUNCT` tokens may have the following values of `Tense`:

* `Past` (1; 100% of non-empty `Tense`): <em>wurde</em>
* `EMPTY` (38508): <em>., ,, -, ", ), (, !, :, ``, ''</em>

### `SCONJ`

1 <tt><a href="de_gsd-pos-SCONJ.html">SCONJ</a></tt> tokens (0% of all `SCONJ` tokens) have a non-empty value of `Tense`.

`SCONJ` tokens may have the following values of `Tense`:

* `Pres` (1; 100% of non-empty `Tense`): <em>sonden</em>
* `EMPTY` (1801): <em>dass, da, wenn, als, daß, nachdem, weil, wie, während, ob</em>

## Relations with Agreement in `Tense`

The 10 most frequent relations where parent and child node agree in `Tense`:
<tt>VERB --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (948; 60%),
