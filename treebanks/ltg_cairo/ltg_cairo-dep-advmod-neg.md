---
layout: base
title:  'Statistics of advmod:neg in UD_Latgalian-Cairo'
udver: '2'
---

## Treebank Statistics: UD_Latgalian-Cairo: Relations: `advmod:neg`

This relation is a language-specific subtype of <tt><a href="ltg_cairo-dep-advmod.html">advmod</a></tt>.
There are also 1 other language-specific subtypes of `advmod`: <tt><a href="ltg_cairo-dep-advmod-emph.html">advmod:emph</a></tt>.
...
The following 1 pairs of parts of speech are connected with `advmod:neg`: <tt><a href="ltg_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ltg_cairo-pos-PART.html">PART</a></tt> (1; 100% instances).
