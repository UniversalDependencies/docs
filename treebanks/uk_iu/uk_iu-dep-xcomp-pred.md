...
2	його	воно	PRON	Pp-3n-san	Case=Acc|Gender=Neut|Number=Sing|Person=3|PronType=Prs	3	obj	3:obj|4:nsubj:pred	Id=13ue|LTranslit=vono|Translit=joho
...
4	срібним	срібний	ADJ	Ao-nsif	Case=Ins|Gender=Neut|Number=Sing	3	xcomp:pred	3:xcomp:pred	Id=13ug|LTranslit=sribnyj|SpaceAfter=No|Translit=sribnym
...
6	Google	Google	X	X	Foreign=Yes	5	flat:title	5:flat:title|7:nsubj:pred	Id=1pec|LTranslit=Google|Translit=Google
7	такою	такий	DET	Pd--f-sia	Case=Ins|Gender=Fem|Number=Sing|PronType=Dem	4	xcomp:pred	4:xcomp:pred	Id=1ped|LTranslit=takyj|SpaceAfter=No|Translit=takoju
