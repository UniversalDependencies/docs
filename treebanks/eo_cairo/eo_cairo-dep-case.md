...
## Treebank Statistics: UD_Esperanto-Cairo: Relations: `case`

This relation is universal.

6 nodes (3%) are attached to their parents as `case`.

6 instances of `case` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.16666666666667.

The following 3 pairs of parts of speech are connected with `case`: <tt><a href="eo_cairo-pos-PROPN.html">PROPN</a></tt>-<tt><a href="eo_cairo-pos-ADP.html">ADP</a></tt> (3; 50% instances), <tt><a href="eo_cairo-pos-NOUN.html">NOUN</a></tt>-<tt><a href="eo_cairo-pos-ADP.html">ADP</a></tt> (2; 33% instances), <tt><a href="eo_cairo-pos-PRON.html">PRON</a></tt>-<tt><a href="eo_cairo-pos-ADV.html">ADV</a></tt> (1; 17% instances).
