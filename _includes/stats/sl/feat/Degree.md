...
21722 tokens (15%) have a non-empty value of `Degree`.
9593 types (30%) occur at least once with a non-empty value of `Degree`.
4709 lemmas (28%) occur at least once with a non-empty value of `Degree`.
The feature is used with 3 part-of-speech tags: [sl-pos/ADJ]() (14346; 10% instances), [sl-pos/ADV]() (6921; 5% instances), [sl-pos/DET]() (455; 0% instances).

### `ADJ`

14346 [sl-pos/ADJ]() tokens (95% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=EMPTY</tt> (12417; 87%), <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (12304; 86%), <tt><a href="Number.html">Number</a>=Sing</tt> (9670; 67%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (343; 2% of non-empty `Degree`): <em>boljše, večji, večja, večje, boljši, močnejši, večjih, boljša, daljši, starejši</em>
* `Pos` (13768; 96% of non-empty `Degree`): <em>mogoče, sam, novo, nove, različnih, slovenski, veliko, velika, veliki, novega</em>
* `Sup` (235; 2% of non-empty `Degree`): <em>največji, najboljši, največja, največjih, najboljša, najboljših, najpomembnejši, največje, najprimernejše, največjo</em>
* `EMPTY` (681): <em>drugi, prvi, druge, drugih, drugo, drugim, druga, drugega, prva, prvo</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Gen|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing</tt></td><td><em>velikega</em></td><td><em>večjega</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Loc|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Plur</tt></td><td></td><td><em>večjih</em></td><td></td></tr>
...
`Degree` seems to be **lexical feature** of `ADJ`. 98% lemmas (3757) occur only with one value of `Degree`.

### `ADV`

6921 [sl-pos/ADV]() tokens (100% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (437; 6% of non-empty `Degree`): <em>bolj, več, manj, prej, večkrat, bolje, pozneje, raje, kasneje, dlje</em>
* `Pos` (6294; 91% of non-empty `Degree`): <em>lahko, tako, zelo, kako, vedno, potem, kar, zdaj, treba, ali</em>
* `Sup` (190; 3% of non-empty `Degree`): <em>najbolj, najprej, najmanj, najbolje, največ, najpogosteje, največkrat, najverjetneje, Najhuje, najdlje</em>
...
`Degree` seems to be **lexical feature** of `ADV`. 96% lemmas (825) occur only with one value of `Degree`.
...
* `Cmp` (142; 31% of non-empty `Degree`): <em>več, manj</em>
* `Pos` (302; 66% of non-empty `Degree`): <em>nekaj, veliko, dovolj, malo, pol, toliko, mnogo, par, preveč, koliko</em>
* `Sup` (11; 2% of non-empty `Degree`): <em>največ</em>
* `EMPTY` (2855): <em>ta, svoje, tem, te, svojo, vse, to, vseh, svoj, vsak</em>

`Degree` seems to be **lexical feature** of `DET`. 100% lemmas (18) occur only with one value of `Degree`.

## Relations with Agreement in `Degree`

The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<a href="../dep/advmod.html">advmod</a>]--> ADV</tt> (991; 78%),
<tt>ADJ --[<a href="../dep/conj.html">conj</a>]--> ADJ</tt> (626; 94%),
<tt>ADV --[<a href="../dep/advmod.html">advmod</a>]--> ADV</tt> (244; 65%),
<tt>ADV --[<a href="../dep/conj.html">conj</a>]--> ADV</tt> (70; 95%),
<tt>ADJ --[<a href="../dep/parataxis.html">parataxis</a>]--> ADJ</tt> (24; 89%),
<tt>ADJ --[<a href="../dep/mark.html">mark</a>]--> ADV</tt> (21; 95%),
<tt>ADJ --[<a href="../dep/amod.html">amod</a>]--> ADJ</tt> (20; 80%),
<tt>ADJ --[<a href="../dep/advcl.html">advcl</a>]--> ADJ</tt> (19; 95%),
<tt>ADV --[<a href="../dep/mwe.html">mwe</a>]--> ADJ</tt> (18; 100%),
<tt>ADJ --[<a href="../dep/nmod.html">nmod</a>]--> ADJ</tt> (16; 59%).
...
4608 tokens (16%) have a non-empty value of `Degree`.
1380 types (23%) occur at least once with a non-empty value of `Degree`.
1036 lemmas (26%) occur at least once with a non-empty value of `Degree`.
The feature is used with 3 part-of-speech tags: [sl-pos/ADV]() (3050; 10% instances), [sl-pos/ADJ]() (1506; 5% instances), [sl-pos/DET]() (52; 0% instances).

### `ADV`

3050 [sl-pos/ADV]() tokens (100% of all `ADV` tokens) have a non-empty value of `Degree`.

`ADV` tokens may have the following values of `Degree`:

* `Cmp` (127; 4% of non-empty `Degree`): <em>bolj, prej, več, manj, rajši, kasneje, večkrat, bolje, boljše, ceneje</em>
* `Pos` (2887; 95% of non-empty `Degree`): <em>tako, zdaj, a, pol, kako, lahko, tam, kar, potem, res</em>
* `Sup` (36; 1% of non-empty `Degree`): <em>najprej, najbolj, najmanj, najrajši, največ, najboljše</em>
* `EMPTY` (1): <em>rekoč</em>
...
`Degree` seems to be **lexical feature** of `ADV`. 98% lemmas (356) occur only with one value of `Degree`.

### `ADJ`

1506 [sl-pos/ADJ]() tokens (90% of all `ADJ` tokens) have a non-empty value of `Degree`.

The most frequent other feature values with which `ADJ` and `Degree` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=EMPTY</tt> (1320; 88%), <tt><a href="Definite.html">Definite</a>=EMPTY</tt> (1208; 80%), <tt><a href="Number.html">Number</a>=Sing</tt> (1124; 75%), <tt><a href="Case.html">Case</a>=Nom</tt> (820; 54%).

`ADJ` tokens may have the following values of `Degree`:

* `Cmp` (49; 3% of non-empty `Degree`): <em>mlajši, bogatejši, boljše, boljši, manjše, manjši, večja, večji, večje, boljša</em>
* `Pos` (1443; 96% of non-empty `Degree`): <em>dobro, dober, zanimivo, glavnem, lep, lepa, mali, rdeča, sam, stari</em>
...
<table>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Acc|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Sing</tt></td><td><em>dobro</em></td><td><em>boljšo</em></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Loc|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Sing</tt></td><td><em>dobri</em></td><td></td><td></td></tr>
  ...
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Fem|<a href="Number.html">Number</a>=Sing</tt></td><td><em>dobra</em></td><td><em>boljša</em></td><td><em>najboljša</em></td></tr>
  <tr><td><tt><a href="Case.html">Case</a>=Nom|<a href="Gender.html">Gender</a>=Neut|<a href="Number.html">Number</a>=Sing</tt></td><td><em>dobro</em></td><td><em>boljše</em></td><td><em>najboljše</em></td></tr>
</table>

`Degree` seems to be **lexical feature** of `ADJ`. 97% lemmas (660) occur only with one value of `Degree`.
...
* `Cmp` (9; 17% of non-empty `Degree`): <em>več</em>
* `Pos` (42; 81% of non-empty `Degree`): <em>nekaj, veliko, koliko, pol, toliko, malo, par, dosti, dovolj, malce</em>
* `Sup` (1; 2% of non-empty `Degree`): <em>največ</em>
* `EMPTY` (660): <em>ta, to, te, tem, teh, vse, tega, tej, neko, take</em>

`Degree` seems to be **lexical feature** of `DET`. 100% lemmas (13) occur only with one value of `Degree`.

## Relations with Agreement in `Degree`

The 10 most frequent relations where parent and child node agree in `Degree`:
<tt>ADJ --[<a href="../dep/advmod.html">advmod</a>]--> ADV</tt> (211; 80%),
...
<tt>ADV --[<a href="../dep/mwe.html">mwe</a>]--> ADJ</tt> (5; 100%).
