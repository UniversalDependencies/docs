...
There are 49 `PRON` lemmas (0%), 73 `PRON` types (0%) and 25955 `PRON` tokens (8%).
...
The form / lemma ratio of `PRON` is 1.489796 (the average of all parts of speech is 1.381975).
