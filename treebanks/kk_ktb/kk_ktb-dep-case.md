...
## Treebank Statistics: UD_Kazakh-KTB: Relations: `case`
...
1	Қазіргі	қазіргі	ADJ	adj	_	3	amod	_	_
2	уақыттағы	уақыт	NOUN	n	Case=Loc	3	amod	_	_
3	дағдарыс	дағдарыс	NOUN	n	Case=Nom	7	nsubj	_	_
4	біз	біз	PRON	prn	Case=Nom|Number=Plur|Person=1|PronType=Prs	7	obl	_	_
5	үшін	үшін	ADP	post	_	4	case	_	_
6	нағыз	нағыз	ADJ	adj	_	7	amod	_	_
7	сынақ	сынақ	NOUN	n	Case=Nom	0	root	_	_
8	болды	бол	AUX	v	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	7	cop	_	SpaceAfter=No
...
1	Бұл	бұл	PRON	prn	Case=Nom|PronType=Dem	8	nsubj	_	_
2	тұрақтылық	тұрақтылық	NOUN	n	Case=Nom	5	obj	_	_
3	пен	мен	CCONJ	cnjcoo	_	4	cc	_	_
4	бейбітшілікті	бейбітшілік	NOUN	n	Case=Acc	2	conj	_	_
5	сақтау	сақта	VERB	v	Case=Nom|VerbForm=Ger	8	advcl	_	_
6	үшін	үшін	ADP	post	_	5	case	_	_
7	басты	басты	ADJ	adj	_	8	amod	_	_
8	шарт	шарт	NOUN	n	Case=Nom	0	root	_	SpaceAfter=No
