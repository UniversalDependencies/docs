...
[NumType](id-feat-NumType.html) – [Polarity](id-feat-Polarity.html)
...
<li>This corpus contains 16357 tokens (13%) that are not followed by a space.</li>
...
<ul>
  <li><a>nsubj</a>
    <ul>
      <li>VERB--NOUN (1623)</li>
      <li>VERB--NOUN-ADP(_) (5)</li>
      <li>VERB--NOUN-ADP(_)-ADP(_) (1)</li>
      <li>VERB--PRON (2018)</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li><a>obj</a>
    <ul>
      <li>VERB--NOUN (4399)</li>
      <li>VERB--NOUN-ADP(_) (30)</li>
      <li>VERB--NOUN-ADP(_)-ADP(_) (1)</li>
      <li>VERB--PRON (297)</li>
    </ul>
  </li>
