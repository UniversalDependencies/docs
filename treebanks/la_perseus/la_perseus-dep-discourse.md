...
240 nodes (1%) are attached to their parents as `discourse`.

208 instances of `discourse` (87%) are right-to-left (child precedes parent).
Average distance between parent and child is 4.5375.
