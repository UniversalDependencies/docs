...
The `cc` relation is used for coordinating conjunctions, i.e conjunctions which link together conjunct elements. The governor of the conjunction if the first conjunct in the paradigm.
...
7	wata	wata	NOUN	NOUN	_	5	conj	_	_
