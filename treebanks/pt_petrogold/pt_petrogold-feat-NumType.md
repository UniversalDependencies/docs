...
7553 tokens (3%) have a non-empty value of `NumType`.
1391 types (9%) occur at least once with a non-empty value of `NumType`.
1373 lemmas (13%) occur at least once with a non-empty value of `NumType`.
The feature is used with 3 part-of-speech tags: <tt><a href="pt_petrogold-pos-NUM.html">NUM</a></tt> (7244; 3% instances), <tt><a href="pt_petrogold-pos-ADJ.html">ADJ</a></tt> (308; 0% instances), <tt><a href="pt_petrogold-pos-NOUN.html">NOUN</a></tt> (1; 0% instances).

### `NUM`

7244 <tt><a href="pt_petrogold-pos-NUM.html">NUM</a></tt> tokens (99% of all `NUM` tokens) have a non-empty value of `NumType`.

`NUM` tokens may have the following values of `NumType`:

* `Card` (7207; 99% of non-empty `NumType`): <em>dois, 1, 3, 2, 5, 10, duas, três, 4, 2005</em>
...
`NumType` seems to be **lexical feature** of `NUM`. 100% lemmas (1327) occur only with one value of `NumType`.
...
* `EMPTY` (57559): <em>óleo, água, figura, fluido, petróleo, gás, fluidos, produção, área, argila</em>
