...
There are 499 `ADJ` lemmas (14%), 646 `ADJ` types (13%) and 1573 `ADJ` tokens (4%).
...
The form / lemma ratio of `ADJ` is 1.294589 (the average of all parts of speech is 1.355420).
...
The most frequent feature combination is `Gender=Masc|Number=Sing` (752 tokens).
