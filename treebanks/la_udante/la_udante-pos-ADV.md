...
There are 412 `ADV` lemmas (7%), 458 `ADV` types (4%) and 3085 `ADV` tokens (6%).
...
The form / lemma ratio of `ADV` is 1.111650 (the average of all parts of speech is 2.130133).
