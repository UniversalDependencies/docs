...
Repository: [UD_Swedish-LinES](https://github.com/UniversalDependencies/UD_Swedish-LinES)
...
<li>This corpus contains 4 word types tagged as particles (PART): att, inte, så, to</li>
</ul>

<ul>
<li>This corpus contains 54 lemmas tagged as pronouns (PRON): all, alla, allesammans, allihop, allihopa, allt, alltihop, allting, alltsammans, andra, annan, bägge, båda, bådadera, de, den, denna, densamma, dessa, det, detsamma, detta, du, en, enda, han, hon, ingen, ingenting, inget, intet, jag, litet, man, mycket, mången, ni, någon, någondera, någonting, något, sig, sin, somliga, sådan, sådant, te, vad, var, varandra, vars, vem, vi, vilken</li>
</ul>

<ul>
<li>This corpus contains 23 lemmas tagged as determiners (DET): all, bägge, båda, de, den, denna, dessa, det, detta, du, en, en-mängd, ingen, intet, la, le, någon, samtlig, the, vad, varenda, varje, vilken</li>
</ul>

<ul>
<li>Out of the above, 16 lemmas occurred sometimes as PRON and sometimes as DET: all, bägge, båda, de, den, denna, dessa, det, detta, du, en, ingen, intet, någon, vad, vilken</li>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <li>VERB: var, har, sa, hade, gick, såg, kom, sade, är, vet</li>
  </ul>
  </li>
  <li>Inf
  <ul>
    <li>AUX: vara, ha, kunna, få, bli, vilja, komma, ombedd</li>
    <li>VERB: göra, ta, se, gå, använda, få, komma, ha, säga, bli</li>
  </ul>
  </li>
  <li>Part
  <ul>
    <li>ADJ: följande, särskilt, motsvarande, nuvarande, grundläggande, beredd, dolda, intresserad, liknande, omfattande</li>
    <li>VERB: leende, tvungen, dansande, flåsande, sittande, svävande, tröstande, överraskande, baserat, dinglande</li>
  </ul>
  </li>
  <li>Sup
  <ul>
  ...
  <ul>
    <li>Com
      <ul>
        ...
        <li>ADJ-Part: beredd, intresserad, bestämd, gift, komplicerad, känd, särskild, ökad, begränsad, upptagen</li>
...
<li><a>Number</a>
  <ul>
    <li>Plur
      <ul>
        <li>ADJ: flera, många, vita, nya, olika, egna, stora, långa, små, själva</li>
    ...
    <li>Sing
      <ul>
        <li>ADJ: själv, hela, annat, stor, annan, liten, ena, egen, vit, sådan</li>
        <li>ADJ-Part: särskilt, beredd, dolda, intresserad, bestämd, gift, komplicerad, känd, särskild, ökad</li>
        <li>ADV: mitt</li>
  ...
  <ul>
    ...
    <li>Nom
      <ul>
        ...
        <li>DET: båda, denne, du, vad, La, samtliga</li>
        ...
        <li>VERB: taget, beroende, närvarande, förfogande, följande, gillande, gående, betydande, fantasieggande, flytande</li>
      </ul>
    </li>
  </ul>
</li>
...
<li><a>Definite</a>
  <ul>
    <li>Def
      <ul>
        <li>ADJ: hela, ena, europeiska, gamla, lilla, själva, unge, egna, sista, närmaste</li>
    ...
    <li>Ind
      <ul>
        <li>ADJ: själv, samma, annat, flera, många, stor, olika, annan, liten, vita</li>
        <li>ADJ-Part: särskilt, beredd, intresserad, bestämd, gift, komplicerad, känd, särskild, ökad, begränsad</li>
...
<li><a>Degree</a>
  <ul>
    <li>Cmp
      <ul>
        <li>ADJ: andra, mer, inre, yttre, bättre, äldre, större, ytterligare, högre, mindre</li>
        <li>ADV: senare, mer, tidigare, vidare, längre, mindre, mera, bättre, närmare, ytterligare</li>
      </ul>
    </li>
    <li>Pos
      <ul>
        <li>ADJ: själv, hela, annat, flera, många, nya, stor, enda, vita, egna</li>
...
<li><a>Polarity</a>
  <ul>
    <li>Neg
      <ul>
        <li>ADV: aldrig, ej, icke, ingalunda, knappast, Inte</li>
      </ul>
    </li>
  </ul>
</li>
  ...
  <ul>
    ...
    <li>Ind
      <ul>
        ...
        <li>VERB-Inf: tvungen, taget, lyckas, fyllt, inställd, klädd, avslutad, installerat, skuggad, tvungna</li>
        <li>VERB-Part: leende, tvungen, dansande, flåsande, sittande, svävande, tröstande, överraskande, baserat, dinglande</li>
  ...
  <ul>
    <li>Act
      <ul>
        ...
        <li>VERB-Fin: var, har, sa, hade, gick, såg, kom, sade, är, vet</li>
        <li>VERB-Inf: göra, ta, se, gå, använda, få, komma, ha, säga, bli</li>
        <li>VERB-Part: leende, dansande, flåsande, sittande, svävande, tröstande, överraskande, dinglande, fastställande, flämtande</li>
    ...
    <li>Pass
      <ul>
        ...
        <li>VERB-Inf: tvungen, taget, talas, användas, fyllt, inställd, klädd, visas, avslutad, installerat</li>
        <li>VERB-Part: tvungen, baserat, försvunnen, kallad, omgiven, Förundrad, betitlad, bokförd, böjd, böjt</li>
  ...
  <ul>
    ...
    <li>Dem
      <ul>
        ...
        <li>PRON: detta, dessa, denne, denna, dennes</li>
      </ul>
    </li>
    <li>Ind
      <ul>
        ...
        <li>PRON: man, någon, en, andra, något, mycket, detsamma, ens, några, många</li>
      </ul>
    </li>
    <li>Int
      <ul>
    ...
    <li>Rel
      <ul>
        <li>PRON: något, vilket, vilka, vars, vilken, vilkas</li>
      </ul>
    </li>
    <li>Tot
      <ul>
...
<li>This corpus uses 14 lemmas as auxiliaries (<a>aux</a>). Examples: ha, kunna, skola, måste, vilja, få, komma, böra, vara, må, hålla, bli, bruka, lär.</li>
...
<ul>
  <li><a>nsubj</a>
    <ul>
      ...
      <li>VERB-Fin--PRON-Nom (2135)</li>
      <li>VERB-Inf--NOUN (1)</li>
      <li>VERB-Inf--NOUN-Nom (177)</li>
      <li>VERB-Inf--NOUN-Nom-ADP(med) (1)</li>
      <li>VERB-Inf--PRON (67)</li>
      <li>VERB-Inf--PRON-Acc (1)</li>
      <li>VERB-Inf--PRON-Nom (674)</li>
      <li>VERB-Part--NOUN-Nom (9)</li>
      <li>VERB-Part--PRON (7)</li>
      <li>VERB-Part--PRON-Nom (6)</li>
      <li>VERB-Sup--NOUN-Nom (137)</li>
      <li>VERB-Sup--PRON (51)</li>
      <li>VERB-Sup--PRON-Nom (333)</li>
    </ul>
  </li>
</ul>
