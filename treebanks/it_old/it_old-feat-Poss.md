...
The most frequent other feature values with which `PRON` and `Poss` co-occurred: <tt><a href="it_old-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (2605; 100%), <tt><a href="it_old-feat-Clitic.html">Clitic</a></tt><tt>=EMPTY</tt> (2604; 100%), <tt><a href="it_old-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (2568; 99%), <tt><a href="it_old-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (2566; 99%), <tt><a href="it_old-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (2272; 87%), <tt><a href="it_old-feat-Person.html">Person</a></tt><tt>=1</tt> (1816; 70%).

`PRON` tokens may have the following values of `Poss`:

* `Yes` (2605; 100% of non-empty `Poss`): <em>io, mi, tu, ti, me, m', te, i', sé, t'</em>
* `EMPTY` (11578): <em>che, si, ch', io, mi, s', noi, lui, ne, tu</em>
...
* `EMPTY` (12869): <em>il, la, l', 'l, le, li, lo, un, i, quel</em>

## Relations with Agreement in `Poss`

The 10 most frequent relations where parent and child node agree in `Poss`:
<tt>DET --[<tt><a href="it_old-dep-conj.html">conj</a></tt>]--> DET</tt> (2; 100%),
<tt>PRON --[<tt><a href="it_old-dep-flat-redup.html">flat:redup</a></tt>]--> PRON</tt> (1; 100%).
