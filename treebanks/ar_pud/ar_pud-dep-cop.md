...
95 nodes (0%) are attached to their parents as `cop`.

95 instances of `cop` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.46315789473684.

The following 4 pairs of parts of speech are connected with `cop`: <tt><a href="ar_pud-pos-ADJ.html">ADJ</a></tt>-<tt><a href="ar_pud-pos-AUX.html">AUX</a></tt> (53; 56% instances), <tt><a href="ar_pud-pos-NOUN.html">NOUN</a></tt>-<tt><a href="ar_pud-pos-AUX.html">AUX</a></tt> (39; 41% instances), <tt><a href="ar_pud-pos-PROPN.html">PROPN</a></tt>-<tt><a href="ar_pud-pos-AUX.html">AUX</a></tt> (2; 2% instances), <tt><a href="ar_pud-pos-PRON.html">PRON</a></tt>-<tt><a href="ar_pud-pos-AUX.html">AUX</a></tt> (1; 1% instances).
...
1	محطت	مَحَطَّة	NOUN	NN	Case=Nom|Definite=Def|Gender=Fem|Number=Sing	5	nsubj	_	LId=مَحَطَّة_1|SpaceAfter=No
2	ي	هُوَ	PRON	PRP	Case=Gen|Number=Sing|Person=1|PronType=Prs	1	nmod	_	_
3	التالية	تَالِي	ADJ	JJ	Case=Nom|Definite=Def|Gender=Fem|Number=Sing	1	amod	_	LId=تالِي_1
4	كانت	كَان	AUX	VBC	Aspect=Perf|Gender=Fem|Number=Sing|Person=3|Tense=Past|Voice=Act	5	cop	_	LId=كان-ُ_1
5	بيلينغهام	بيلينغهام	PROPN	NNP	Gender=Fem|Number=Sing	0	root	_	LId=بيلينغهام_0|SpaceAfter=No
6	,	,	PUNCT	,	_	7	punct	_	LId=,_0
7	المحاذية	مُحَاذِي	ADJ	VBN	Case=Nom|Definite=Def|Gender=Fem|Number=Sing|VerbForm=Part|Voice=Act	5	ccomp	_	LId=مُحاذِي_1
8	ل	لِ	ADP	IN	_	9	case	_	SpaceAfter=No
9	لحدود	حَدّ	NOUN	NN	Case=Gen|Definite=Def|Gender=Masc|Number=Plur	7	obl	_	LId=حَدّ_2
10	الكندية	كَنَدِيّ	ADJ	JJ	Case=Gen|Definite=Def|Gender=Fem|Number=Sing	9	amod	_	LId=كَنَدِيّ_1|SpaceAfter=No
11	.	.	PUNCT	.	_	5	punct	_	LId=._0
