...
1	Neither	neither	CCONJ	CC	_	2	cc:preconj	2:cc:preconj	Discourse=joint-other_m:91->89:2
...
6	commensurable	commensurable	ADJ	JJ	Degree=Pos	0	root	0:root	XML=<ref target:::"https://proofwiki.org/wiki/Definition:Commensurable_in_Length">
7	in	in	ADP	IN	_	8	case	8:case	_
8	length	length	NOUN	NN	Number=Sing	6	obl	6:obl:in	Entity=(47-abstract-giv:inact-cf3-1-coref)|XML=</ref>
...
1	He	he	PRON	PRP	Case=Nom|Gender=Masc|Number=Sing|Person=3|PronType=Prs	3	nsubj	3:nsubj|6:nsubj:xsubj|7:nsubj:xsubj	Discourse=elaboration-additional:24->22:1|Entity=(11-person-giv:inact-cf2-1-ana)
2	also	also	ADV	RB	_	3	advmod	3:advmod	_
3	appeared	appear	VERB	VBD	Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin	0	root	0:root	_
4	to	to	PART	TO	_	6	mark	6:mark	_
5	have	have	AUX	VB	VerbForm=Inf	6	aux	6:aux	_
6	become	become	VERB	VBN	Tense=Past|VerbForm=Part	3	xcomp	3:xcomp	_
7	disoriented	disoriented	ADJ	JJ	Degree=Pos	6	xcomp	6:xcomp	_
8	either	either	CCONJ	CC	_	9	cc:preconj	9:cc:preconj	_
9	secondary	secondary	ADJ	JJ	Degree=Pos	7	advmod	7:advmod	_
...
1	Submission	submission	NOUN	NN	Number=Sing	13	nsubj	13:nsubj	Discourse=organization-preparation:181->183:3|Entity=(270-abstract-new-cf3-1-sgl
...
5	that	that	PRON	WDT	PronType=Rel	8	nsubj	4:ref	Discourse=elaboration-attribute:182->181:0
6	is	be	AUX	VBZ	Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin	8	cop	8:cop	_
7	in	in	ADP	IN	_	8	case	8:case	_
8	violation	violation	NOUN	NN	Number=Sing	4	acl:relcl	4:acl:relcl	_
...
15	(1)	(1)	X	LS	_	21	dep	21:dep	Discourse=adversative-contrast_m:183->177:2
16	an	a	DET	DT	Definite=Ind|PronType=Art	21	det	21:det	Entity=(272-abstract-new-cf13-6-sgl
17	academic	academic	ADJ	JJ	Degree=Pos	21	amod	21:amod	_
18	(	(	PUNCT	-LRB-	_	19	punct	19:punct	Discourse=elaboration-additional:184->183:0|SpaceAfter=No
...
21	penalty	penalty	NOUN	NN	Number=Sing	13	obl	13:obl:in	Discourse=same-unit_m:185->183:1|Entity=272)
22	and	and	CCONJ	CC	_	24	cc	24:cc	Discourse=joint-list_m:186->183:2
23	(2)	(2)	X	LS	_	24	dep	24:dep	_
24	reporting	report	VERB	VBG	VerbForm=Ger	21	conj	13:obl:in|21:conj:and	_
...
37	(	(	PUNCT	-LRB-	_	39	punct	39:punct	Discourse=elaboration-additional:187->186:0|SpaceAfter=No
38	for	for	ADP	IN	_	39	case	39:case	_
39	Undergraduates	Undergraduate	PROPN	NNPS	Number=Plur	34	orphan	34:orphan	Entity=(279-person-new-cf9-1-sgl)|SpaceAfter=No
40	)	)	PUNCT	-RRB-	_	39	punct	39:punct	_
41	or	or	CCONJ	CC	_	43	cc	43:cc	Discourse=same-unit_m:188->186:1
...
46	Education	Education	PROPN	NNP	Number=Sing	43	nmod	43:nmod:of	Entity=281)280)
47	(	(	PUNCT	-LRB-	_	50	punct	50:punct	Discourse=elaboration-additional:189->188:0|SpaceAfter=No
...
50	students	student	NOUN	NNS	Number=Plur	43	orphan	43:orphan	Entity=256)|SpaceAfter=No
