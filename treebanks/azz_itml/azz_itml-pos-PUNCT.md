---
layout: base
title:  'Statistics of PUNCT in UD_Highland_Puebla_Nahuatl-ITML'
udver: '2'
---

## Treebank Statistics: UD_Highland_Puebla_Nahuatl-ITML: POS Tags: `PUNCT`

There are 17 `PUNCT` lemmas (1%), 17 `PUNCT` types (1%) and 2068 `PUNCT` tokens (20%).
...
The 10 most frequent ambiguous types:  <em>nitokay</em> (<tt><a href="azz_itml-pos-NOUN.html">NOUN</a></tt> 2, <tt><a href="azz_itml-pos-PUNCT.html">PUNCT</a></tt> 1)
