...
There are 39 `DET` lemmas (0%), 94 `DET` types (1%) and 36349 `DET` tokens (15%).
...
* <em>o</em>
  * <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> 9847: <em>4.5 Dados referentes a <b>o</b> trabalho de campo</em>
  * <tt><a href="pt_petrogold-pos-PRON.html">PRON</a></tt> 283: <em>Devido a o baixo custo de o catalisador torna <b>o</b> competitivo .</em>
* <em>os</em>
  * <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> 3084: <em>O resultado de <b>os</b> ensaios para a temperatura também foi satisfatório .</em>
...
* <em>as</em>
  * <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> 2591: <em>Tabela 3 . Tabela de <b>as</b> fácies descritas em o trabalho .</em>
...
* <em>este</em>
  * <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> 635: <em>Foi possível verificar <b>este</b> fato através de o gráfico de a Figura V.16 .</em>
...
* <em>esta</em>
  * <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> 468: <em>Diversos autores desenvolveram métodos para lidar com <b>esta</b> limitação .</em>
...
* <em>estes</em>
  * <tt><a href="pt_petrogold-pos-DET.html">DET</a></tt> 207: <em>Portanto as isotermas de <b>estes</b> materiais não estão mostradas .</em>
...
The form / lemma ratio of `DET` is 2.410256 (the average of all parts of speech is 1.452352).
...
`DET` occurs with 4 features: <tt><a href="pt_petrogold-feat-Gender.html">Gender</a></tt> (36349; 100% instances), <tt><a href="pt_petrogold-feat-Number.html">Number</a></tt> (36349; 100% instances), <tt><a href="pt_petrogold-feat-PronType.html">PronType</a></tt> (36348; 100% instances), <tt><a href="pt_petrogold-feat-Definite.html">Definite</a></tt> (31789; 87% instances)
