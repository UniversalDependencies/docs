...
There are 3 language-specific subtypes of `flat`: <tt><a href="ru_taiga-dep-flat-foreign.html">flat:foreign</a></tt>, <tt><a href="ru_taiga-dep-flat-goeswith.html">flat:goeswith</a></tt>, <tt><a href="ru_taiga-dep-flat-name.html">flat:name</a></tt>.
...
1	Каждый	каждый	DET	_	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing|PronType=Tot	2	det	_	_
2	год	год	NOUN	_	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	4	obl:tmod	_	_
...
8	то	тот	DET	_	Case=Acc|ExtPos=DET|Gender=Neut|Number=Sing|PronType=Dem	6	det	_	_
9	же	же	PART	_	_	8	fixed	_	_
10	время	время	NOUN	_	Animacy=Inan|Case=Acc|Gender=Neut|Number=Sing	4	obl:tmod	_	_
11	—	—	PUNCT	_	_	12	punct	_	_
12	19	19	ADJ	_	NumForm=Digit|NumType=Ord	10	appos	_	_
...
2	Эй	эй	INTJ	_	_	0	root	_	_
3	ты	ты	PRON	_	Case=Nom|Number=Sing|Person=2|PronType=Prs	2	flat	_	SpaceAfter=No
4	,	,	PUNCT	_	_	5	punct	_	_
5	шляпа	шляпа	NOUN	_	Animacy=Inan|Case=Nom|Gender=Fem|Number=Sing	3	vocative	_	SpaceAfter=No
6	!	!	PUNCT	_	_	5	punct	_	SpaceAfter=No
7	»	»	PUNCT	_	_	5	punct	_	_
8	--	--	PUNCT	_	_	9	punct	_	_
9	слышится	слышаться	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|Voice=Mid	5	parataxis	_	feat="Transit=Intr"|_
10	пропитой	пропитой	ADJ	_	Case=Nom|Degree=Pos|Gender=Masc|Number=Sing	11	amod	_	_
11	голос	голос	NOUN	_	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	9	nsubj	_	SpaceAfter=No
...
11	узелке	узелок	NOUN	_	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	5	conj	_	SpaceAfter=No
