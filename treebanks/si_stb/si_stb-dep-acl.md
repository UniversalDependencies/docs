---
layout: base
title:  'Statistics of acl in UD_Sinhala-STB'
udver: '2'
---

## Treebank Statistics: UD_Sinhala-STB: Relations: `acl`

This relation is universal.

16 nodes (2%) are attached to their parents as `acl`.

16 instances of `acl` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.875.

The following 4 pairs of parts of speech are connected with `acl`: <tt><a href="si_stb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="si_stb-pos-VERB.html">VERB</a></tt> (12; 75% instances), <tt><a href="si_stb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="si_stb-pos-ADJ.html">ADJ</a></tt> (2; 13% instances), <tt><a href="si_stb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="si_stb-pos-AUX.html">AUX</a></tt> (1; 6% instances), <tt><a href="si_stb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="si_stb-pos-NOUN.html">NOUN</a></tt> (1; 6% instances).
...
# visual-style 4	fgColor:white
# visual-style 4 2 acl	color:blue
1	රටට	රට	NOUN	_	Case=Cns|Definite=Def|Gender=Neut|Number=Sing	2	nsubj	_	Translit=raṭaṭa|LTranslit=raṭa
2	හිතැති	හිතැති	ADJ	_	Degree=Pos	4	acl	_	Translit=hitæti|LTranslit=hitæti
3	හමුදා	හමුදා	NOUN	_	Animacy=Anim|Case=Nom	4	nmod	_	Translit=hamudā|LTranslit=hamudā
4	ප්‍රධානයකු	ප්‍රධාන	NOUN	_	Animacy=Anim|Case=Acc|Definite=Ind|Gender=Masc|Number=Sing|Person=3	6	nsubj	_	Translit=pradhānayaku|LTranslit=pradhāna
5	කොමිස්වලට	කොමිස්	NOUN	_	Animacy=Inan|Case=Cns|Gender=Neut|Number=Plur	6	obj	_	Translit=komisvalaṭa|LTranslit=komis
6	යට	යට	NOUN	_	_	0	root	_	Translit=yaṭa|LTranslit=yaṭa
7	වන්නේ	වෙ	VERB	_	Mood=Ind|Tense=Pres|VerbForm=Part|Voice=Act	6	compound:lvc	_	Translit=vannē|LTranslit=ve
8	නැත	නැත	AUX	_	Aspect=Prosp|Polarity=Neg|VerbForm=Fin	6	aux	_	Translit=næta|LTranslit=næta
9	.	_	PUNCT	_	_	6	punct	_	Translit=.
