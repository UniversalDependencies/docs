...
51320 <tt><a href="de_gsd-pos-NOUN.html">NOUN</a></tt> tokens (98% of all `NOUN` tokens) have a non-empty value of `Case`.
...
* `Dat` (16866; 33% of non-empty `Case`): <em>Jahr, Jahren, Zeit, Jahre, Saison, Ende, Familie, Teil, Ort, Seite</em>
* `Gen` (5804; 11% of non-empty `Case`): <em>Stadt, Jahre, Jahres, Zeit, Landes, Gemeinde, Familie, Bevölkerung, Vaters, Saison</em>
* `Nom` (15696; 31% of non-empty `Case`): <em>Teil, Sohn, Mitglied, Stadt, Menschen, Ort, Gemeinde, Frau, Unternehmen, Präsident</em>
* `EMPTY` (882): <em>Prozent, Jahrhundert, mm, Mark, °, m, mal, ², ', Wohn</em>
...
37592 <tt><a href="de_gsd-pos-DET.html">DET</a></tt> tokens (100% of all `DET` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `DET` and `Case` co-occurred: <tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt> (34494; 92%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (32082; 85%), <tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt> (29306; 78%).

`DET` tokens may have the following values of `Case`:

* `Acc` (7984; 21% of non-empty `Case`): <em>die, den, eine, das, einen, ein, seine, ihre, seinen, sein</em>
* `Dat` (12825; 34% of non-empty `Case`): <em>dem, der, den, einem, einer, seiner, seinem, ihrem, seinen, ihrer</em>
* `Gen` (6384; 17% of non-empty `Case`): <em>der, des, eines, einer, seiner, dessen, seines, deren, ihrer, ihres</em>
* `Nom` (10399; 28% of non-empty `Case`): <em>die, der, das, ein, eine, sein, seine, ihre, mein, ihr</em>
* `EMPTY` (69): <em>viel, weniger, genügend, ein, mehr, reichlich, all, der, ihrer, seiner</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Definite.html">Definite</a></tt><tt>=Def</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Art</tt></tt></td><td><em>die, Des</em></td><td><em>die</em></td><td><em>den</em></td><td><em>der</em></td></tr>
...
27216 <tt><a href="de_gsd-pos-PROPN.html">PROPN</a></tt> tokens (89% of all `PROPN` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PROPN` and `Case` co-occurred: <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (25880; 95%).

`PROPN` tokens may have the following values of `Case`:

* `Acc` (2900; 11% of non-empty `Case`): <em>US, USA, Euro, Deutschland, Mai, Oktober, Award, März, Cup, Deutsche</em>
* `Dat` (10640; 39% of non-empty `Case`): <em>Deutschland, Berlin, Frankreich, Oktober, Weltkrieg, Paris, München, New, Mai, November</em>
* `Gen` (3735; 14% of non-empty `Case`): <em>Deutschen, US, Deutschlands, Europäischen, Weltkrieges, St., Weltkriegs, Frankreichs, Union, Gesellschaft</em>
* `Nom` (9941; 37% of non-empty `Case`): <em>SPD, US, Hans, Peter, Paul, Deutschland, Johann, Juli, Wilhelm, Karl</em>
* `EMPTY` (3464): <em>of, de, the, a, la, University, II, Wiener, Berliner, 1</em>
...
* `Acc` (3888; 27% of non-empty `Case`): <em>neue, große, weitere, erste, gute, verschiedene, andere, ersten, eigene, neuen</em>
* `Dat` (4288; 30% of non-empty `Case`): <em>ersten, anderen, zweiten, weiteren, großen, verschiedenen, neuen, letzten, deutschen, gleichen</em>
* `Gen` (1838; 13% of non-empty `Case`): <em>ersten, deutschen, zweiten, ehemaligen, neuen, großen, amerikanischen, französischen, heutigen, besten</em>
* `Nom` (4353; 30% of non-empty `Case`): <em>erste, weitere, neue, deutsche, große, andere, kleine, gute, letzte, zweite</em>
* `EMPTY` (6408): <em>später, bekannt, gut, kurz, freundlich, lang, möglich, neu, stark, tätig</em>

<table>
  <tr><th>Paradigm <i>erst</i></th><th><tt>Nom</tt></th><th><tt>Acc</tt></th><th><tt>Dat</tt></th><th><tt>Gen</tt></th></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>erste, erster</em></td><td><em>ersten</em></td><td><em>ersten</em></td><td><em>ersten</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>ersten, erste</em></td><td><em>ersten, erste</em></td><td><em>ersten</em></td><td><em>ersten</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>erste</em></td><td><em>erste</em></td><td><em>ersten, erster</em></td><td><em>ersten, erster</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>ersten, erste</em></td><td><em>erste, ersten</em></td><td><em>ersten</em></td><td><em>ersten</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>erste, erstes</em></td><td><em>erste, erstes</em></td><td><em>ersten</em></td><td><em>ersten</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>ersten, Erste</em></td><td><em>erste, ersten</em></td><td><em>ersten</em></td><td><em>ersten</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>ersten</em></td><td></td><td></td><td></td></tr>
</table>

### `PRON`

13709 <tt><a href="de_gsd-pos-PRON.html">PRON</a></tt> tokens (97% of all `PRON` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `PRON` and `Case` co-occurred: <tt><a href="de_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (12012; 88%), <tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10414; 76%), <tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (7601; 55%).

`PRON` tokens may have the following values of `Case`:

* `Acc` (3141; 23% of non-empty `Case`): <em>sich, ihn, diese, die, keine, es, mich, sie, das, alle</em>
* `Dat` (1835; 13% of non-empty `Case`): <em>ihm, diesem, dem, dieser, sich, allem, mir, denen, der, anderem</em>
* `Gen` (292; 2% of non-empty `Case`): <em>dieser, aller, dieses, beiden, deren, dessen, der, mehrerer, vieler, beider</em>
* `Nom` (8441; 62% of non-empty `Case`): <em>er, sie, es, die, ich, man, der, wir, das, diese</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>der, die</em></td><td><em>den, der</em></td><td><em>dem</em></td><td><em>dessen</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>die</em></td><td><em>die</em></td><td><em>denen</em></td><td><em>deren</em></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>die</em></td><td><em>die</em></td><td><em>der</em></td><td><em>der, deren, derer</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Fem</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>die</em></td><td><em>die</em></td><td><em>denen, den</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td><em>das</em></td><td><em>das</em></td><td><em>dem</em></td><td><em>die</em></td></tr>
  <tr><td><tt><tt><a href="de_gsd-feat-Gender.html">Gender</a></tt><tt>=Neut</tt>|<tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Plur</tt>|<tt><a href="de_gsd-feat-Poss.html">Poss</a></tt><tt>=Yes</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td></td><td></td><td><em>deren</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="de_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt>|<tt><a href="de_gsd-feat-PronType.html">PronType</a></tt><tt>=Rel</tt></tt></td><td></td><td></td><td><em>dem</em></td><td></td></tr>
...
181 <tt><a href="de_gsd-pos-NUM.html">NUM</a></tt> tokens (2% of all `NUM` tokens) have a non-empty value of `Case`.

The most frequent other feature values with which `NUM` and `Case` co-occurred: <tt><a href="de_gsd-feat-NumType.html">NumType</a></tt><tt>=Card</tt> (181; 100%).

`NUM` tokens may have the following values of `Case`:

* `Acc` (62; 34% of non-empty `Case`): <em>ein, eine, einen, 15, 3, Millionen, ², 0:2, 10, 100</em>
* `Dat` (60; 33% of non-empty `Case`): <em>einer, einem, 1:1, 8, Millionen, ², +7,6, -10, -2288,9, -60</em>
* `Gen` (12; 7% of non-empty `Case`): <em>zweier, 7, 1846-1925, 35, 50, Mio, dreier, einer</em>
* `Nom` (47; 26% of non-empty `Case`): <em>ein, 10, Millionen, 20, 28, 35, 6, eine, -9, 1</em>
...
* `EMPTY` (238): <em>'s, u.a., etc., z.B., z., a, z, †, *, u</em>
...
67 <tt><a href="de_gsd-pos-ADV.html">ADV</a></tt> tokens (0% of all `ADV` tokens) have a non-empty value of `Case`.

`ADV` tokens may have the following values of `Case`:

* `Acc` (27; 40% of non-empty `Case`): <em>was, ca, EINFACH, How, Katzelmacher, Kehrt, Mal, NIEMALS, NOCH, Revue</em>
* `Dat` (15; 22% of non-empty `Case`): <em>allem, anderem, ca, Anfangs, Dort, Ex, Křižanov, PMMA, allen, meisten</em>
* `Gen` (4; 6% of non-empty `Case`): <em>Abends, NIE, Zügig, längerer</em>
* `Nom` (21; 31% of non-empty `Case`): <em>SEHR, alles, super, Allzeit, ECHT, Gottlob, Nahe, Rääts, Vorallem, aka</em>
* `EMPTY` (14777): <em>auch, nur, noch, sehr, so, dort, wieder, hier, mehr, heute</em>
...
`Case` seems to be **lexical feature** of `ADV`. 92% lemmas (47) occur only with one value of `Case`.
...
* `EMPTY` (32099): <em>in, von, mit, zu, an, auf, für, als, nach, bei</em>

## Relations with Agreement in `Case`

The 10 most frequent relations where parent and child node agree in `Case`:
<tt>NOUN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (27516; 96%),
<tt>NOUN --[<tt><a href="de_gsd-dep-amod.html">amod</a></tt>]--> ADJ</tt> (12158; 91%),
<tt>PROPN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> DET</tt> (5240; 92%),
<tt>PROPN --[<tt><a href="de_gsd-dep-flat.html">flat</a></tt>]--> PROPN</tt> (5154; 87%),
<tt>NOUN --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> NOUN</tt> (3036; 74%),
<tt>NOUN --[<tt><a href="de_gsd-dep-appos.html">appos</a></tt>]--> PROPN</tt> (2474; 77%),
<tt>NOUN --[<tt><a href="de_gsd-dep-det-poss.html">det:poss</a></tt>]--> DET</tt> (2185; 95%),
<tt>NOUN --[<tt><a href="de_gsd-dep-det.html">det</a></tt>]--> PRON</tt> (1633; 90%),
<tt>PROPN --[<tt><a href="de_gsd-dep-conj.html">conj</a></tt>]--> PROPN</tt> (1563; 74%),
<tt>PROPN --[<tt><a href="de_gsd-dep-amod.html">amod</a></tt>]--> PROPN</tt> (1140; 79%).
