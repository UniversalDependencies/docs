...
6	pozor	pozor	NOUN	NNIS4-----A----	Animacy=Inan|Case=Acc|Gender=Masc|Number=Sing	10	obj	_	_
...
9	slova	slovo	NOUN	NNNP4-----A----	Case=Acc|Gender=Neut|Number=Plur	6	nmod	_	_
...
15	věci	věc	NOUN	NNFP4-----A----	Case=Acc|Gender=Fem|Number=Plur	16	amod	_	_
...
3	nutno	nutný	ADJ	ACNS------A----	Degree=Pos|Gender=Neut|Number=Sing|Polarity=Pos|Variant=Short	0	root	_	SpaceAfter=No
4	,	,	PUNCT	Z:-------------	_	5	punct	_	_
5	přečkat	přečkat	VERB	Vf--------A----	Aspect=Perf|Polarity=Pos|VerbForm=Inf	3	csubj	_	_
6	bouři	bouře	NOUN	NNFS4-----A----	Case=Acc|Gender=Fem|Number=Sing	5	obj	_	_
...
11	pohody	pohoda	NOUN	NNFS2-----A----	Case=Gen|Gender=Fem|Number=Sing	21	obl	_	SpaceAfter=No
12	,	,	PUNCT	Z:-------------	_	14	punct	_	_
13	v	v	ADP	RR--6----------	AdpType=Prep|Case=Loc	14	case	_	_
14	čase	čas	NOUN	NNIS6-----A----	Animacy=Inan|Case=Loc|Gender=Masc|Number=Sing	11	appos	_	_
...
17	hnízdo	hnízdo	NOUN	NNNS4-----A----	Case=Acc|Gender=Neut|Number=Sing	20	obj	_	_
