...
2	conteur	conteur	NOUN	_	Gender=Masc|Number=Sing	5	nsubj:caus	_	Exponence[Gender]=Inherent
...
4	lieu	lieu	NOUN	_	Gender=Masc|Number=Sing	0	root	_	Exponence[Gender]=Inherent
...
9	l'	le	DET	_	Definite=Def|Gender=Fem|Number=Sing|PronType=Art	10	det	_	Exponence[Gender]=Absent|SpaceAfter=No
10	Union	union	NOUN	_	Gender=Fem|Number=Sing	25	nsubj	_	Exponence[Gender]=Inherent
...
15	elle	lui	PRON	_	Case=Nom|Emph=No|Gender=Fem|Number=Sing|Person=3|PronType=Prs	16	nsubj	_	_
...
19	face	face	NOUN	_	ExtPos=ADV|Gender=Fem|Number=Sing	25	advmod	_	Exponence[Gender]=Inherent
20	à	à	ADP	_	_	23	case	_	_
21	tous	tout	ADJ	_	Gender=Masc|Number=Plur	23	amod	_	_
22	ces	ce	DET	_	Number=Plur|PronType=Dem	23	det	_	_
23	défis	défi	NOUN	_	Gender=Masc|Number=Plur	19	obl:arg	_	Exponence[Gender]=Inherent|SpaceAfter=No
...
27	certaines	certains	DET	_	Gender=Fem|Number=Plur|PronType=Ind	28	det	_	Exponence[Number]=Inherent
28	transformations	transformation	NOUN	_	Gender=Fem|Number=Plur	25	obj	_	Exponence[Gender]=Inherent|SpaceAfter=No
29	,	,	PUNCT	_	_	31	punct	_	_
30	des	un	DET	_	Definite=Ind|Number=Plur|PronType=Art	31	det	_	_
31	transformations	transformation	NOUN	_	Gender=Fem|Number=Plur	28	appos	_	Exponence[Gender]=Inherent
...
35	but	but	NOUN	_	Gender=Masc|Number=Sing	33	xcomp	_	Exponence[Gender]=Inherent
...
44	base	base	NOUN	_	Gender=Fem|Number=Sing	41	obl:mod	_	Exponence[Gender]=Inherent
...
49	nous	nous	PRON	_	Case=Nom|Emph=No|Number=Plur|Person=1|PronType=Prs	54	dislocated	_	_
50	tous	tout	ADJ	_	Gender=Masc|Number=Plur	49	amod	_	SpaceAfter=No
51	,	,	PUNCT	_	_	49	punct	_	_
52	nous	nous	PRON	_	Case=Nom|Emph=No|Number=Plur|Person=1|PronType=Prs	54	nsubj	_	_
53	avons	avoir	AUX	_	Mood=Ind|Number=Plur|Person=1|Tense=Pres|VerbForm=Fin	54	aux:tense	_	_
54	admis	admettre	VERB	_	Gender=Masc|VerbForm=Part|Voice=Act	47	acl:relcl	_	Tense[denom]=Past
...
58	jour	jour	NOUN	_	Gender=Masc|Number=Sing	54	obl:mod	_	Exponence[Gender]=Inherent|SpaceAfter=No
