...
There are 46 `DET` lemmas (0%), 66 `DET` types (0%) and 25074 `DET` tokens (12%).
...
The form / lemma ratio of `DET` is 1.434783 (the average of all parts of speech is 1.213971).
...
`DET` occurs with 1 features: <tt><a href="nl_alpino-feat-Definite.html">Definite</a></tt> (21869; 87% instances)
