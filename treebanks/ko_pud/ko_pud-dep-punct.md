...
2	다음에	다음	NOUN	NN+CM	Case=Advb|Polite=Form	3	advmod	_	MSeg=다음-에|Translit=.da.eum.e|LTranslit=.da.eum
...
7	근처에	근처	NOUN	NN+CM	Case=Advb|Polite=Form	8	advmod	_	MSeg=근처-에|Translit=.geun.cheo.e|LTranslit=.geun.cheo
