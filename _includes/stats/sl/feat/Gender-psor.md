...
The most frequent other feature values with which `DET` and `Gender[psor]` co-occurred: <tt><a href="Degree.html">Degree</a>=EMPTY</tt> (379; 100%), <tt><a href="Number[psor].html">Number[psor]</a>=Sing</tt> (379; 100%), <tt><a href="PronType.html">PronType</a>=EMPTY</tt> (379; 100%), <tt><a href="Poss.html">Poss</a>=Yes</tt> (379; 100%), <tt><a href="Person.html">Person</a>=3</tt> (379; 100%), <tt><a href="Number.html">Number</a>=Sing</tt> (287; 76%).
...
The most frequent other feature values with which `PRON` and `Gender[psor]` co-occurred: <tt><a href="Variant.html">Variant</a>=EMPTY</tt> (11; 100%), <tt><a href="PronType.html">PronType</a>=EMPTY</tt> (10; 91%), <tt><a href="Person.html">Person</a>=3</tt> (10; 91%), <tt><a href="Number.html">Number</a>=Sing</tt> (8; 73%), <tt><a href="Case.html">Case</a>=Loc</tt> (6; 55%).
