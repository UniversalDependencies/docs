...
det(stav-7, svůj-5)
amod(stav-7, zdravotní-6)
dobj(,-8, stav-7)
punct:coord(na-4, ,-8)
dobj(,-8, nemoci-9)
punct(nebo-16, ,-10)
case:auxp(nebo-16, pro-11)
advmod(pro-11, které-12)
aux(léčil-15, jsem-13)
auxpass:reflex(léčil-15, se-14)
acl(nebo-16, léčil-15)
cc:coord(nemoci-9, nebo-16)
case:auxp(léčím-20, v-17)
amod(době-19, současné-18)
nmod(v-17, době-19)
acl(nebo-16, léčím-20)
punct(nebo-16, ,-21)
root:coord(ROOT-0, a-22)
advmod:emph(je-24, dokonce-23)
parataxis(a-22, je-24)
advmod(je-24, zde-25)
nsubj(je-24, otázka-26)
punct(zda-28, ,-27)
mark:auxc(otázka-26, zda-28)
aux(podrobil-31, jsem-29)
compound:reflex(podrobil-31, se-30)
acl(a-35, podrobil-31)
dobj(podrobil-31, testu-32)
case:auxp(testu-32, na-33)
nmod(na-33, AIDS-34)
cc:coord(zda-28, a-35)
case:auxp(a-35, s-36)
det(výsledkem-38, jakým-37)
dep(s-36, výsledkem-38)
root:auxk(ROOT-0, .-39)
~~~
