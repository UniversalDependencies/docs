---
layout: base
title:  'Statistics of obl in UD_English-Pronouns'
udver: '2'
---

## Treebank Statistics: UD_English-Pronouns: Relations: `obl`

This relation is universal.

55 nodes (3%) are attached to their parents as `obl`.

45 instances of `obl` (82%) are left-to-right (parent precedes child).
Average distance between parent and child is 2.72727272727273.

The following 1 pairs of parts of speech are connected with `obl`: <tt><a href="en_pronouns-pos-VERB.html">VERB</a></tt>-<tt><a href="en_pronouns-pos-PRON.html">PRON</a></tt> (55; 100% instances).
