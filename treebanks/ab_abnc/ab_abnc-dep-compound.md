...
1	Ҳвожд	а-во́жд	NOUN	Noun_H_Sg_Poss:1Pl	Animacy=Hum|Number=Sing|Number[psor]=Plur|Person[psor]=1	2	compound	_	LMSeg:а-во́жд
2	иарҕьажәҩа	а́рҕьажәҩа	NOUN	Noun_H_Sg_Poss:3SgM	Animacy=Hum|Gender[psor]=Masc|Number=Sing|Number[psor]=Sing|Person[psor]=3	4	nmod:poss	_	LMSeg:а́рҕьажәҩа
3	Бериа	Бериа	PROPN	Noun_Prop_Anthr_LastName	NameType=Prs	2	appos	_	LMSeg:Бериа
...
4	ҩным	а-ҩны́	VERB	Noun_NH_Sg_Pred_Fin_Pres_Neg_S:3_S:Ad	Animacy=Nhum|Dyn=No|Mood=Ind|Number=Sing|Person[subj]=3|Polarity=Neg|Tense=Pres|VerbForm=Fin	0	root	_	LMSeg:а-ҩны́|SpaceAfter=No
...
11	ауп	а́кәзаара	AUX	V_Stat_Fin_Pres_S:3_IO:3SgNH_Cop	Dyn=No|Gender[io]=Neut|Mood=Ind|Number[io]=Sing|Person[io]=3|Person[subj]=3|Tense=Pres|VerbForm=Fin	10	cop	_	LMSeg:а́кә-заа-ра|SpaceAfter=No
