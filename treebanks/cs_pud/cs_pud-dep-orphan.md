...
1	Federico	Federico	PROPN	NNMS1-----A----	Animacy=Anim|Case=Nom|Foreign=Yes|Gender=Masc|NameType=Giv|Number=Sing	4	nsubj	4:nsubj	_
2	Fellini	Fellini	PROPN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|NameType=Sur|Number=Sing	1	flat	1:flat	_
...
5	:	:	PUNCT	Z:-------------	_	10	punct	8:punct	_
6	„	"	PUNCT	Z:-------------	_	10	punct	8:punct	SpaceAfter=No
7	Klaun	klaun	NOUN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|Number=Sing	10	nsubj	8:nsubj	_
8	je	být	AUX	VB-S---3P-AA---	Aspect=Imp|Mood=Ind|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin|Voice=Act	10	cop	4:ccomp	_
9	pro	pro	ADP	RR--4----------	AdpType=Prep|Case=Acc	10	case	10:case	LId=pro-1
10	lidstvo	lidstvo	NOUN	NNNS4-----A----	Case=Acc|Gender=Neut|Number=Sing	4	ccomp	8:obl:pro:acc	_
11	jako	jako	SCONJ	J,-------------	_	12	mark	10.1:mark	LId=jako-1
12	stín	stín	NOUN	NNIS1-----A----	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	10	advcl	10.1:dep	_
13	pro	pro	ADP	RR--4----------	AdpType=Prep|Case=Acc	14	case	14:case	LId=pro-1
14	člověka	člověk	NOUN	NNMS4-----A----	Animacy=Anim|Case=Acc|Gender=Masc|Number=Sing	12	orphan	10.1:dep	SpaceAfter=No
15	“	"	PUNCT	Z:-------------	_	10	punct	8:punct	SpaceAfter=No
...
3	postoj	postoj	NOUN	NNIS1-----A----	Animacy=Inan|Case=Nom|Gender=Masc|Number=Sing	0	root	0.1:dep	_
4	Austrálie	Austrálie	PROPN	NNFS2-----A----	Case=Gen|Gender=Fem|NameType=Geo|Number=Sing	3	nmod	3:nmod:gen	SpaceAfter=No
...
1	Durán	Durán	PROPN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|NameType=Sur|Number=Sing	2	nsubj	2:nsubj	_
...
4	mluvčí	mluvčí	NOUN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|Number=Sing	2	obl	2:obl:jako	_
5	a	a	CCONJ	J^-------------	_	6	cc	4.1:cc	LId=a-1
6	Ángel	Ángel	PROPN	NNMS1-----A----	Animacy=Anim|Case=Nom|Foreign=Yes|Gender=Masc|NameType=Giv|Number=Sing	2	conj	4.1:dep	_
7	Pintado	Pintado	PROPN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|NameType=Sur|Number=Sing	6	flat	6:flat	_
8	jako	jako	SCONJ	J,-------------	_	9	case	9:case	LId=jako-1
9	pokladník	pokladník	NOUN	NNMS1-----A----	Animacy=Anim|Case=Nom|Gender=Masc|Number=Sing	6	orphan	4.1:dep	SpaceAfter=No
