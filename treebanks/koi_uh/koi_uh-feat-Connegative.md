...
12 types (2%) occur at least once with a non-empty value of `Connegative`.
...
10 <tt><a href="koi_uh-pos-VERB.html">VERB</a></tt> tokens (6% of all `VERB` tokens) have a non-empty value of `Connegative`.
...
4 <tt><a href="koi_uh-pos-AUX.html">AUX</a></tt> tokens (14% of all `AUX` tokens) have a non-empty value of `Connegative`.
