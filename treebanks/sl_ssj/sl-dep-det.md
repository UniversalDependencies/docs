---
layout: base
title:  'Statistics of det in UD_Slovenian'
udver: '2'
---

## Treebank Statistics: UD_Slovenian: Relations: `det`

This relation is universal.

3311 nodes (2%) are attached to their parents as `det`.

3311 instances of `det` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.31138628813047.

The following 2 pairs of parts of speech are connected with `det`: <tt><a href="sl-pos-NOUN.html">NOUN</a></tt>-<tt><a href="sl-pos-DET.html">DET</a></tt> (3289; 99% instances), <tt><a href="sl-pos-PROPN.html">PROPN</a></tt>-<tt><a href="sl-pos-DET.html">DET</a></tt> (22; 1% instances).
