...
* `EMPTY` (184196): <em>další, české, nové, poslední, státní, dalších, možné, vlastní, jiné, velké</em>
...
* `EMPTY` (79368): <em>tak, už, také, jak, včera, ještě, již, tedy, dnes, pak</em>
...
<tt>NUM --[<tt><a href="cs_pdt-dep-conj.html">conj</a></tt>]--> NUM</tt> (3260; 100%),
<tt>NUM --[<tt><a href="cs_pdt-dep-compound.html">compound</a></tt>]--> NUM</tt> (2800; 100%),
<tt>NUM --[<tt><a href="cs_pdt-dep-orphan.html">orphan</a></tt>]--> NUM</tt> (77; 100%),
