...
and names of months _(յունուարիոս/yownowarios, փետրվար (փեբրուարիոս)/p’etrvar (p’ebrowarios), մարտ/mart, ապրիլիոս/aprilios, մայիս/mayis, հունիս/hownis, յուլիս (յուլիոս)/yowlis (yowlios), յաղւեստոս/yaġwestos, գերմանիկոս (սեխտեմբռ, սեխտեմպեր)/germanikos (sextembṙ,  sextemper), հոկտընբեր/hoktënber, նոյեմբեր/noyember, դեկտեմբեր (դեկտեմբռ, դեկտեմպեր, դեկտընբեր))&nbsp;_ are not written capitalized (unlike English) and are not considered proper nouns.
