---
layout: base
title:  'Statistics of aux:pass in UD_Slovak'
udver: '2'
---

## Treebank Statistics: UD_Slovak: Relations: `aux:pass`

This relation is a language-specific subtype of <tt><a href="sk-dep-aux.html">aux</a></tt>.
...
The following 1 pairs of parts of speech are connected with `aux:pass`: <tt><a href="sk-pos-ADJ.html">ADJ</a></tt>-<tt><a href="sk-pos-AUX.html">AUX</a></tt> (102; 100% instances).
