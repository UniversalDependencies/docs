...
2	Latio	Latium	NOUN	n-s---nb-	Case=Abl|Gender=Neut|Number=Sing	4	advmod	_	LId=Latium1
...
1	Nocte	nox	NOUN	n-s---fb-	Case=Abl|Gender=Fem|Number=Sing	5	advmod	_	LId=nox1
2	gravem	gravis	ADJ	a-s---ma-	Case=Acc|Gender=Masc|Number=Sing	7	amod	_	LId=gravis1
3	somno	somnus	NOUN	n-s---mb-	Case=Abl|Gender=Masc|Number=Sing	2	advmod	_	LId=somnus1
...
6	morte	mors	NOUN	n-s---fb-	Case=Abl|Gender=Fem|Number=Sing	5	advmod	_	LId=mors1
