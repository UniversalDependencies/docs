...
There are 48 `SCONJ` lemmas (0%), 49 `SCONJ` types (0%) and 4317 `SCONJ` tokens (3%).
...
The form / lemma ratio of `SCONJ` is 1.020833 (the average of all parts of speech is 1.479540).
