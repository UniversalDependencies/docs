...
39427 tokens (10%) have a non-empty value of `Person`.
3600 types (8%) occur at least once with a non-empty value of `Person`.
1383 lemmas (4%) occur at least once with a non-empty value of `Person`.
The feature is used with 5 part-of-speech tags: <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> (14553; 4% instances), <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> (13669; 3% instances), <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> (11199; 3% instances), <tt><a href="fr_gsd-pos-ADJ.html">ADJ</a></tt> (4; 0% instances), <tt><a href="fr_gsd-pos-DET.html">DET</a></tt> (2; 0% instances).

### `PRON`

14553 <tt><a href="fr_gsd-pos-PRON.html">PRON</a></tt> tokens (82% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="fr_gsd-feat-Reflex.html">Reflex</a></tt><tt>=EMPTY</tt> (12088; 83%), <tt><a href="fr_gsd-feat-PronType.html">PronType</a></tt><tt>=Prs</tt> (11360; 78%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (9018; 62%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=Masc</tt> (7673; 53%).
...
* `3` (13101; 90% of non-empty `Person`): <em>il, se, s', elle, c', on, y, ils, lui, ce</em>
* `EMPTY` (3196): <em>qui, dont, qu', que, lequel, laquelle, lesquels, lesquelles, siens, nôtre</em>
...
<table>
  ...
  <tr><td><tt></tt></td><td></td><td><em>-vous</em></td><td></td></tr>
</table>

### `VERB`

13669 <tt><a href="fr_gsd-pos-VERB.html">VERB</a></tt> tokens (43% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (13667; 100%), <tt><a href="fr_gsd-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (13665; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (13078; 96%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (10903; 80%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (10770; 79%).
...
* `3` (12938; 95% of non-empty `Person`): <em>a, peut, fait, est, devient, doit, ont, trouve, permet, agit</em>
* `EMPTY` (18240): <em>né, située, faire, situé, partir, eu, fait, voir, mort, connu</em>
...
11199 <tt><a href="fr_gsd-pos-AUX.html">AUX</a></tt> tokens (86% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="fr_gsd-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (11199; 100%), <tt><a href="fr_gsd-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (10841; 97%), <tt><a href="fr_gsd-feat-Tense.html">Tense</a></tt><tt>=Pres</tt> (9485; 85%), <tt><a href="fr_gsd-feat-Number.html">Number</a></tt><tt>=Sing</tt> (8875; 79%).
...
* `3` (10749; 96% of non-empty `Person`): <em>est, a, sont, ont, était, fut, avait, sera, étaient, soit</em>
* `EMPTY` (1749): <em>été, être, avoir, étant, faire, ayant, fait, faisant, Etant, -être</em>
...
* `EMPTY` (23755): <em>premier, première, français, autres, même, française, tous, dernier, grande, grand</em>
...
* `EMPTY` (61129): <em>le, la, les, l', un, une, des, son, sa, cette</em>

## Relations with Agreement in `Person`

The 10 most frequent relations where parent and child node agree in `Person`:
<tt>VERB --[<tt><a href="fr_gsd-dep-nsubj.html">nsubj</a></tt>]--> PRON</tt> (4271; 63%),
<tt>VERB --[<tt><a href="fr_gsd-dep-conj.html">conj</a></tt>]--> VERB</tt> (1253; 68%),
<tt>VERB --[<tt><a href="fr_gsd-dep-expl-pv.html">expl:pv</a></tt>]--> PRON</tt> (662; 66%),
