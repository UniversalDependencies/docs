...
15598 tokens (17%) have a non-empty value of `PronType`.
...
The feature is used with 7 part-of-speech tags: <tt><a href="sv_lines-pos-PRON.html">PRON</a></tt> (10636; 12% instances), <tt><a href="sv_lines-pos-DET.html">DET</a></tt> (4662; 5% instances), <tt><a href="sv_lines-pos-ADV.html">ADV</a></tt> (214; 0% instances), <tt><a href="sv_lines-pos-ADJ.html">ADJ</a></tt> (77; 0% instances), <tt><a href="sv_lines-pos-NOUN.html">NOUN</a></tt> (5; 0% instances), <tt><a href="sv_lines-pos-SCONJ.html">SCONJ</a></tt> (3; 0% instances), <tt><a href="sv_lines-pos-VERB.html">VERB</a></tt> (1; 0% instances).
...
* `Ind` (391; 4% of non-empty `PronType`): <em>man, någon, en, andra, något, mycket, ens, detsamma, några, många</em>
...
* `Prs` (8418; 79% of non-empty `PronType`): <em>han, det, jag, sig, du, de, vi, hon, honom, mig</em>
...
* `Int` (40; 1% of non-empty `PronType`): <em>vilka, vilken, vilket</em>
* `Neg` (91; 2% of non-empty `PronType`): <em>ingen, inget, inga</em>
* `Rel` (1; 0% of non-empty `PronType`): <em>vilken</em>
* `Tot` (224; 5% of non-empty `PronType`): <em>alla, varje, all, allt, var, varenda, bägge</em>
...
<table>
  ...
  <tr><td><tt><tt><a href="sv_lines-feat-Case.html">Case</a></tt><tt>=Nom</tt>|<tt><a href="sv_lines-feat-Number.html">Number</a></tt><tt>=Plur</tt></tt></td><td><em>de</em></td><td></td></tr>
  ...
  <tr><td><tt><tt><a href="sv_lines-feat-Number.html">Number</a></tt><tt>=Sing</tt></tt></td><td><em>den, det</em></td><td></td></tr>
...
* `EMPTY` (6559): <em>så, ut, där, upp, in, bara, här, också, till, fram</em>
...
77 <tt><a href="sv_lines-pos-ADJ.html">ADJ</a></tt> tokens (1% of all `ADJ` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `ADJ` and `PronType` co-occurred: <tt><a href="sv_lines-feat-Definite.html">Definite</a></tt><tt>=Ind</tt> (77; 100%), <tt><a href="sv_lines-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (77; 100%), <tt><a href="sv_lines-feat-Case.html">Case</a></tt><tt>=EMPTY</tt> (74; 96%), <tt><a href="sv_lines-feat-Degree.html">Degree</a></tt><tt>=EMPTY</tt> (74; 96%), <tt><a href="sv_lines-feat-Number.html">Number</a></tt><tt>=EMPTY</tt> (74; 96%).

`ADJ` tokens may have the following values of `PronType`:

* `Ind` (74; 96% of non-empty `PronType`): <em>samma, beslutsamma</em>
* `Int` (3; 4% of non-empty `PronType`): <em>hurdan, Hurdana</em>
* `EMPTY` (6170): <em>andra, själv, hela, första, annat, flera, många, stor, nya, enda</em>
...
* `EMPTY` (15960): <em>sätt, år, far, fält, gång, man, sidan, del, data, mor</em>
...
<tt>ADJ --[<tt><a href="sv_lines-dep-conj.html">conj</a></tt>]--> ADJ</tt> (1; 100%),
