...
137 tokens (0%) have a non-empty value of `Foreign`.
70 types (1%) occur at least once with a non-empty value of `Foreign`.
73 lemmas (1%) occur at least once with a non-empty value of `Foreign`.
The feature is used with 1 part-of-speech tags: <tt><a href="en_partut-pos-X.html">X</a></tt> (137; 0% instances).
...
<tt>X --[<tt><a href="en_partut-dep-flat-foreign.html">flat:foreign</a></tt>]--> X</tt> (88; 100%),
