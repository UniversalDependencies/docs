---
layout: base
title:  'Statistics of expl in UD_Albanian-TSA'
udver: '2'
---

## Treebank Statistics: UD_Albanian-TSA: Relations: `expl`

This relation is universal.

6 nodes (1%) are attached to their parents as `expl`.

6 instances of `expl` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 1.

The following 1 pairs of parts of speech are connected with `expl`: <tt><a href="sq_tsa-pos-VERB.html">VERB</a></tt>-<tt><a href="sq_tsa-pos-PRON.html">PRON</a></tt> (6; 100% instances).
