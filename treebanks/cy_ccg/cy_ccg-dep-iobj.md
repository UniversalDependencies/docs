---
layout: base
title:  'Statistics of iobj in UD_Welsh-CCG'
udver: '2'
---

## Treebank Statistics: UD_Welsh-CCG: Relations: `iobj`
...
The following 1 pairs of parts of speech are connected with `iobj`: <tt><a href="cy_ccg-pos-VERB.html">VERB</a></tt>-<tt><a href="cy_ccg-pos-PROPN.html">PROPN</a></tt> (1; 100% instances).
...
5	de	De	PROPN	person	Gender=Masc|Number=Sing	1	iobj	_	_
6	Gaulle	Gaulle	PROPN	person	_	5	flat:name	_	_
7	yn	yn	ADP	prep	_	8	case	_	_
8	nhrafodaethau	trafodaeth	NOUN	noun	Gender=Fem|Mutation=NM|Number=Plur	1	obl	_	_
