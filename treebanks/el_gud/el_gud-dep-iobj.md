...
1	Παίρνω	παίρνω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
2	τηλέφωνο	τηλέφωνο	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	1	obj	_	_
3	τον	ο	DET	_	Case=Acc|Definite=Def|Gender=Masc|Number=Sing|PronType=Art	4	det	_	_
4	Χαρικάκη	Χαρικάκης	PROPN	_	Case=Acc|Gender=Masc|Number=Sing	1	iobj	_	_
5	της	ο	DET	_	Case=Gen|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	6	det	_	_
6	Αρχής	αρχή	NOUN	_	Case=Gen|Gender=Fem|Number=Sing	4	nmod	_	_
7	και	και	CCONJ	_	_	9	cc	_	_
8	τον	εγώ	PRON	_	Case=Acc|Gender=Masc|Number=Sing|Person=3|PronType=Prs	9	obj	_	_
9	ενημερώνω	ενημερώνω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	1	conj	_	SpaceAfter=No
10	.	.	PUNCT	_	_	1	punct	_	PunctType=Peri
...
3	μεταξύ	μεταξύ	ADV	_	_	4	obl	_	_
4	παίρνω	παίρνω	VERB	_	Aspect=Imp|Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin|Voice=Act	0	root	_	_
5	τηλέφωνο	τηλέφωνο	NOUN	_	Case=Acc|Gender=Neut|Number=Sing	4	obj	_	_
6	έναν	ένας	DET	_	Case=Acc|Definite=Ind|Gender=Masc|Number=Sing|PronType=Art	7	det	_	_
7	γνωστό	γνωστός	ADJ	_	Case=Acc|Gender=Masc|Number=Sing	4	iobj	_	_
8	μου	εγώ	PRON	_	Case=Gen|Number=Sing|Person=1|Poss=Yes|PronType=Prs	7	nmod	_	_
9	σ	σε	ADP	_	_	11	case	_	_
10	την	ο	DET	_	Case=Acc|Definite=Def|Gender=Fem|Number=Sing|PronType=Art	11	det	_	_
11	τροχαία	τροχαία	NOUN	_	Case=Acc|Gender=Fem|Number=Sing	7	nmod	_	SpaceAfter=No
