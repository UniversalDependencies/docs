...
2421 lemmas (16%) occur at least once with a non-empty value of `Degree`.
...
`Degree` seems to be **lexical feature** of `ADJ`. 97% lemmas (2344) occur only with one value of `Degree`.
