...
The feature is used with 1 part-of-speech tags: <tt><a href="mdf_jr-pos-PART.html">PART</a></tt> (3; 0% instances).

### `PART`

3 <tt><a href="mdf_jr-pos-PART.html">PART</a></tt> tokens (43% of all `PART` tokens) have a non-empty value of `Degree`.
