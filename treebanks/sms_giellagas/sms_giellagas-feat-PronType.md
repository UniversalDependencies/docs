...
251 tokens (9%) have a non-empty value of `PronType`.
59 types (8%) occur at least once with a non-empty value of `PronType`.
15 lemmas (3%) occur at least once with a non-empty value of `PronType`.
The feature is used with 3 part-of-speech tags: <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> (243; 9% instances), <tt><a href="sms_giellagas-pos-DET.html">DET</a></tt> (5; 0% instances), <tt><a href="sms_giellagas-pos-ADV.html">ADV</a></tt> (3; 0% instances).

### `PRON`

243 <tt><a href="sms_giellagas-pos-PRON.html">PRON</a></tt> tokens (90% of all `PRON` tokens) have a non-empty value of `PronType`.

The most frequent other feature values with which `PRON` and `PronType` co-occurred: <tt><a href="sms_giellagas-feat-Number.html">Number</a></tt><tt>=Sing</tt> (212; 87%), <tt><a href="sms_giellagas-feat-Case.html">Case</a></tt><tt>=Nom</tt> (154; 63%).

`PRON` tokens may have the following values of `PronType`:

* `Dem` (78; 32% of non-empty `PronType`): <em>tõn, tõt, tõid, tuk, tut, tän, tät, tõt-i, Täk, dõõk</em>
* `Int` (9; 4% of non-empty `PronType`): <em>mâiʹd, Mii</em>
* `Prs` (142; 58% of non-empty `PronType`): <em>son, ton, mon, suu, muu, miʹjjid, seeʹst, suʹst, tuu, jiijj</em>
* `Rel` (11; 5% of non-empty `PronType`): <em>mii, kååʹtt, mõin, mõõn, ǩeäzz</em>
* `Tot` (3; 1% of non-empty `PronType`): <em>puk</em>
* `EMPTY` (27): <em>mâiʹd, nåkkam, puk, måttam, dõõn, dõõt, dââʹst, dõõk, jeeʹres, jiânnai-a</em>
