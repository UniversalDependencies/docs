---
layout: base
title:  'Statistics of parataxis in UD_Old_East_Slavic-Birchbark'
udver: '2'
---

## Treebank Statistics: UD_Old_East_Slavic-Birchbark: Relations: `parataxis`
...
1	мꙑ·сливсѧ	промыслитисѧ	VERB	_	Case=Nom|Gender=Masc|Number=Sing|Tense=Past|VerbForm=Part|Voice=Act	0	root	_	wf="мꙑ·сливсѧ"|addr="059:4"|line_id=4|SpaceAfter=Yes
2	·	·	PUNCT	_	_	4	punct	_	wf="·"|SpaceAfter=Yes
3	та·ко	тако	ADV	_	_	4	advmod	_	wf="та·ко"|addr="059:4"|SpaceAfter=Yes
4	бꙋдꙋ	быти	VERB	_	Number=Sing|Person=1|Tense=Fut|VerbForm=Fin|Voice=Act	1	parataxis	_	wf="бꙋдꙋ"|addr="059:4"|SpaceAfter=Yes
5	к	къ	ADP	_	_	6	case	_	wf="к"|addr="059:4"|SpaceAfter=Yes
6	тоби	ты	PRON	_	Case=Dat|Number=Sing|Person=2	4	obl	_	wf="тоби"|comment="clitic_ton"|addr="059:4"|SpaceAfter=Yes
7	:	:	PUNCT	_	_	11	punct	_	wf=":"|SpaceAfter=Yes
8	а	а	CCONJ	_	_	11	cc	_	wf="а"|addr="059:4"|SpaceAfter=Yes
9	тꙑ	ты	PRON	_	Case=Nom|Number=Sing|Person=2	11	nsubj	_	wf="тꙑ"|addr="059:4"|SpaceAfter=Yes
10	·	·	PUNCT	_	_	11	punct	_	wf="·"|SpaceAfter=Yes
11	видаеши	вѣдати	VERB	_	Number=Sing|Person=2|Tense=Pres|VerbForm=Fin|Voice=Act	1	conj	_	wf="видаеши"|comment="tense_nonpast"|addr="059:4"|SpaceAfter=Yes
12	а…	а…	X	_	_	11	dep	_	wf="а…"|addr="059:4"|SpaceAfter=Yes
...
1	+	+	SYM	_	_	5	parataxis	_	wf="+"|line_id=1|SpaceAfter=Yes
2	ѿ	отъ	ADP	_	_	3	case	_	wf="ѿ"|addr="115:1"|SpaceAfter=Yes
3	прокошь	Прокша	PROPN	_	Case=Gen|Gender=Masc|NameType=Giv|Number=Sing	5	orphan	_	wf="прокошь"|addr="115:1"|SpaceAfter=Yes
4	къ	къ	ADP	_	_	5	case	_	wf="къ"|addr="115:1"|SpaceAfter=Yes
5	ньстьрѹ	Нестеръ	PROPN	_	Case=Dat|Gender=Masc|NameType=Giv|Number=Sing	0	root	_	wf="ньстьрѹ"|addr="115:1"|SpaceAfter=Yes
