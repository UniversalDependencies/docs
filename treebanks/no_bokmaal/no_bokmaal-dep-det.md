...
1	Fem	fem	NUM	det	Number=Plur|NumType=Card	2	nummod	_	_
2	uker	uke	NOUN	subst	Definite=Ind|Gender=Fem|Number=Plur	7	nsubj	_	_
3	i	i	ADP	prep	_	5	case	_	_
4	valgseierens	valgseier	NOUN	subst	Case=Gen|Definite=Def|Gender=Masc|Number=Sing	5	nmod	_	_
5	glans	glans	NOUN	subst	Definite=Ind|Gender=Masc|Number=Sing	2	nmod	_	_
