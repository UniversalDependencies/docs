---
layout: base
title:  'Statistics of punct in UD_Greek-Messinian'
udver: '2'
---

## Treebank Statistics: UD_Greek-Messinian: Relations: `punct`

This relation is universal.

149 nodes (17%) are attached to their parents as `punct`.

118 instances of `punct` (79%) are left-to-right (parent precedes child).
Average distance between parent and child is 3.95302013422819.

The following 8 pairs of parts of speech are connected with `punct`: <tt><a href="el_messinian-pos-VERB.html">VERB</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (102; 68% instances), <tt><a href="el_messinian-pos-NOUN.html">NOUN</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (20; 13% instances), <tt><a href="el_messinian-pos-ADJ.html">ADJ</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (11; 7% instances), <tt><a href="el_messinian-pos-DET.html">DET</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (6; 4% instances), <tt><a href="el_messinian-pos-INTJ.html">INTJ</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (4; 3% instances), <tt><a href="el_messinian-pos-PROPN.html">PROPN</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (3; 2% instances), <tt><a href="el_messinian-pos-ADV.html">ADV</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (2; 1% instances), <tt><a href="el_messinian-pos-X.html">X</a></tt>-<tt><a href="el_messinian-pos-PUNCT.html">PUNCT</a></tt> (1; 1% instances).
