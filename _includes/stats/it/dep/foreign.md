...
55 nodes (0%) are attached to their parents as `foreign`.

55 instances of `foreign` (100%) are left-to-right (parent precedes child).
Average distance between parent and child is 1.76363636363636.

The following 4 pairs of parts of speech are connected with `foreign`: [it-pos/X]()-[it-pos/X]() (51; 93% instances), [it-pos/PROPN]()-[it-pos/X]() (2; 4% instances), [it-pos/NOUN]()-[it-pos/X]() (1; 2% instances), [it-pos/X]()-[it-pos/NUM]() (1; 2% instances).
...
10	no	no	PROPN	SP	_	5	xcomp	_	PRED
...
22	ambigua	ambiguo	ADJ	A	Gender=Fem|Number=Sing	18	xcomp	_	PRED
...
4	soglia	soglia	NOUN	S	Gender=Fem|Number=Sing	2	nmod	_	_
...
17	ppb	ppb	X	SW	_	11	foreign	_	_
18	)	)	PUNCT	FB	_	11	punct	_	_
...
47	giorni	giorno	NOUN	S	Gender=Masc|Number=Plur	44	nmod	_	_
