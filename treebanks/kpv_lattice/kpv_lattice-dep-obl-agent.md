...
1	Кӧсъян	кӧсйыны	VERB	V	Mood=Ind|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin	12	advcl	_	GTtags=TV,Ind,Prs,Sg2
2	кӧ	кӧ	SCONJ	CS	_	1	mark	_	SpaceAfter=No
3	,	,	PUNCT	CLB	_	6	punct	_	_
4	оз	оз	AUX	V	Mood=Ind|Number=Sing|Person=3|Polarity=Neg|Tense=Pres|VerbForm=Fin	6	aux	_	GTtags=Neg,Ind,Prs,Sg3
...
12	висьтала	висьтавны	VERB	V	Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin	0	root	_	GTtags=TV,Ind,Prs,Sg1
