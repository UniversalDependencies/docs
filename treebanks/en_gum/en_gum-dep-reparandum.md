...
9	cycle	cycle	NOUN	NN	Number=Sing	6	nmod	_	Entity=abstract-58)|SpaceAfter=No
10	,	,	PUNCT	,	_	2	punct	_	_
11	shake	shake	VERB	VB	Mood=Imp|VerbForm=Fin	0	root	_	_
12	all	all	DET	DT	_	13	det	_	Entity=(object-57
13	bottles	bottle	NOUN	NNS	Number=Plur	11	obj	_	Entity=object-57)
...
2	you	you	PRON	PRP	Case=Nom|Person=2|PronType=Prs	5	nsubj	_	Entity=(event-57(person-17)
...
6	ballet	ballet	NOUN	NN	Number=Sing	7	compound	_	Entity=(object-58(abstract-1)
7	shoes	shoe	NOUN	NNS	Number=Plur	5	obj	_	Entity=event-57)object-58)|SpaceAfter=No
8	,	,	PUNCT	,	_	5	punct	_	_
9	that	that	PRON	DT	Number=Sing|PronType=Dem	10	reparandum	_	Typo=Yes
10	it	it	PRON	PRP	Case=Nom|Gender=Neut|Number=Sing|Person=3|PronType=Prs	12	nsubj	_	Entity=(event-57)|Typo=Yes
