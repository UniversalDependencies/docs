...
5 nodes (0%) are attached to their parents as `obl:lmod`.

5 instances of `obl:lmod` (100%) are right-to-left (child precedes parent).
Average distance between parent and child is 2.6.

The following 2 pairs of parts of speech are connected with `obl:lmod`: <tt><a href="la_ittb-pos-VERB.html">VERB</a></tt>-<tt><a href="la_ittb-pos-NOUN.html">NOUN</a></tt> (4; 80% instances), <tt><a href="la_ittb-pos-NOUN.html">NOUN</a></tt>-<tt><a href="la_ittb-pos-NOUN.html">NOUN</a></tt> (1; 20% instances).
