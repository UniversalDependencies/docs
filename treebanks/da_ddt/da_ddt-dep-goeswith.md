---
layout: base
title:  'Statistics of goeswith in UD_Danish-DDT'
udver: '2'
---

## Treebank Statistics: UD_Danish-DDT: Relations: `goeswith`
...
The following 2 pairs of parts of speech are connected with `goeswith`: <tt><a href="da_ddt-pos-NUM.html">NUM</a></tt>-<tt><a href="da_ddt-pos-SYM.html">SYM</a></tt> (7; 88% instances), <tt><a href="da_ddt-pos-SYM.html">SYM</a></tt>-<tt><a href="da_ddt-pos-SYM.html">SYM</a></tt> (1; 13% instances).
...
6	kvm.	kvadratmeter	NOUN	_	Definite=Ind|Gender=Com|Number=Plur	1	obj	_	SpaceAfter=No
...
19	kvm.	kvadratmeter	NOUN	_	Definite=Ind|Gender=Com|Number=Plur	8	obl	_	SpaceAfter=No
