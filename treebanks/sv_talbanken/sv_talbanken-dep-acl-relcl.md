...
6	håller	hålla	VERB	VB|PRS|AKT	Mood=Ind|Tense=Pres|VerbForm=Fin|Voice=Act	4	acl:relcl	4:acl:relcl	ParsemeMWE=1:IVPC.semi
7	produktionen	produktion	NOUN	NN|UTR|SIN|DEF|NOM	Case=Nom|Definite=Def|Gender=Com|Number=Sing	6	obj	6:obj	_
8	uppe	uppe	ADV	PL	_	6	compound:prt	6:compound:prt	SpaceAfter=No|ParsemeMWE=1
...
6	säkert	säkert	ADV	AB|POS	Degree=Pos	8	advmod	8:advmod	_
