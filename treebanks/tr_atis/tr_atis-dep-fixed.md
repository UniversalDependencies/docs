...
8	tek	tek	ADJ	_	ExtPos=ADJ	10	amod	_	_
9	bir	bir	DET	_	Definite=Ind|PronType=Art	8	fixed	_	_
10	havayoluyla	havayol	NOUN	_	Case=Ins|Number=Sing|Number[psor]=Sing|Person[psor]=3	11	obl	_	_
11	gidebilir	git	VERB	_	Evident=Fh|Mood=GenPot|Number=Sing|Person=3|Polarity=Pos|Tense=Pres|VerbForm=Fin	0	root	_	_
12	miyim	mi	AUX	_	Number=Sing|Person=1|PronType=Int|Tense=Pres	11	aux:q	_	_
...
5	olan	ol	VERB	_	Polarity=Pos|Tense=Pres|VerbForm=Part	4	fixed	_	_
6	en	en	ADV	_	Degree=Sup	7	advmod	_	_
7	erken	erken	ADJ	_	_	8	amod	_	_
8	uçuşu	uçuş	NOUN	_	Case=Acc|Number=Sing	9	obj	_	_
9	bulun	bul	VERB	_	Mood=Imp|Number=Plur|Person=2|Polarity=Pos|VerbForm=Fin	0	root	_	_
...
1	Peki	peki	ADV	_	ExtPos=ADV	5	discourse	_	_
2	ya	ya	INTJ	_	_	1	fixed	_	_
3	Denver'de	denver	PROPN	_	Case=Loc|Number=Sing	5	nmod	_	_
4	araba	araba	NOUN	_	Case=Nom|Number=Sing	5	nmod	_	_
5	kiralama	kiralama	NOUN	_	Case=Nom|Number=Sing	0	root	_	_
