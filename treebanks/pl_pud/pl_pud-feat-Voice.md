...
`Voice` seems to be **lexical feature** of `ADJ`. 98% lemmas (294) occur only with one value of `Voice`.

### `AUX`

331 <tt><a href="pl_pud-pos-AUX.html">AUX</a></tt> tokens (73% of all `AUX` tokens) have a non-empty value of `Voice`.

The most frequent other feature values with which `AUX` and `Voice` co-occurred: <tt><a href="pl_pud-feat-Mood.html">Mood</a></tt><tt>=Ind</tt> (315; 95%), <tt><a href="pl_pud-feat-VerbForm.html">VerbForm</a></tt><tt>=Fin</tt> (315; 95%), <tt><a href="pl_pud-feat-Aspect.html">Aspect</a></tt><tt>=Imp</tt> (254; 77%), <tt><a href="pl_pud-feat-Animacy.html">Animacy</a></tt><tt>=EMPTY</tt> (248; 75%), <tt><a href="pl_pud-feat-Number.html">Number</a></tt><tt>=Sing</tt> (237; 72%), <tt><a href="pl_pud-feat-Person.html">Person</a></tt><tt>=EMPTY</tt> (175; 53%), <tt><a href="pl_pud-feat-Gender.html">Gender</a></tt><tt>=EMPTY</tt> (172; 52%).

`AUX` tokens may have the following values of `Voice`:

* `Act` (331; 100% of non-empty `Voice`): <em>jest, był, są, został, było, była, zostały, były, została, być</em>
