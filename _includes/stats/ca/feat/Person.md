...
4640 types (14%) occur at least once with a non-empty value of `Person`.
1376 lemmas (6%) occur at least once with a non-empty value of `Person`.
The feature is used with 4 part-of-speech tags: [ca-pos/AUX]() (19267; 4% instances), [ca-pos/VERB]() (19018; 3% instances), [ca-pos/PRON]() (7404; 1% instances), [ca-pos/DET]() (3140; 1% instances).

### `AUX`

19267 [ca-pos/AUX]() tokens (86% of all `AUX` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `AUX` and `Person` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (19267; 100%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (18214; 95%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (17118; 89%), <tt><a href="Number.html">Number</a>=Sing</tt> (14568; 76%).

`AUX` tokens may have the following values of `Person`:

* `1` (508; 3% of non-empty `Person`): <em>hem, he, vaig, podem, som, estem, sóc, vam, puc, podrem</em>
* `2` (21; 0% of non-empty `Person`): <em>has, pots, esteu, heu, acabes, ets, feu, gosa, haureu, podeu</em>
* `3` (18738; 97% of non-empty `Person`): <em>va, ha, és, van, han, són, havia, pot, fa, serà</em>
* `EMPTY` (3222): <em>ser, estat, haver, poder, fer, tornar, pogut, començar, deixar, intentar</em>
...
19018 [ca-pos/VERB]() tokens (46% of all `VERB` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `VERB` and `Person` co-occurred: <tt><a href="VerbForm.html">VerbForm</a>=Fin</tt> (19018; 100%), <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (19018; 100%), <tt><a href="Mood.html">Mood</a>=Ind</tt> (16681; 88%), <tt><a href="Number.html">Number</a>=Sing</tt> (13740; 72%), <tt><a href="Tense.html">Tense</a>=Pres</tt> (13488; 71%).

`VERB` tokens may have the following values of `Person`:

* `1` (823; 4% of non-empty `Person`): <em>tenim, crec, estem, volem, sé, tinc, estic, vull, dic, penso</em>
* `2` (40; 0% of non-empty `Person`): <em>fas, estrena, voleu, Escolta, Obres, acuses, afirma, aturis, busqueu, cantes</em>
* `3` (18155; 95% of non-empty `Person`): <em>té, ha, està, és, tenen, fa, considera, cal, estan, farà</em>
* `EMPTY` (22433): <em>fer, fet, tenir, donar, dir, explicat, dit, arribar, aconseguir, passar</em>
...
<table>
  ...
  <tr><td><tt><a href="Mood.html">Mood</a>=Cnd|<a href="Number.html">Number</a>=Plur</tt></td><td><em>faríem</em></td><td></td><td><em>farien</em></td></tr>
...
7404 [ca-pos/PRON]() tokens (32% of all `PRON` tokens) have a non-empty value of `Person`.

The most frequent other feature values with which `PRON` and `Person` co-occurred: <tt><a href="Gender.html">Gender</a>=EMPTY</tt> (6363; 86%), <tt><a href="PronType.html">PronType</a>=Prs</tt> (4762; 64%), <tt><a href="Number.html">Number</a>=EMPTY</tt> (4640; 63%).

`PRON` tokens may have the following values of `Person`:

* `1` (568; 8% of non-empty `Person`): <em>ens, nosaltres, em, jo, m', -nos, -me, mi, 'ns, me</em>
* `2` (61; 1% of non-empty `Person`): <em>vostè, et, t', vostès, us, tu, vosaltres, -te, vostre</em>
* `3` (6775; 92% of non-empty `Person`): <em>es, s', hi, -se, li, se, ho, els, el, l'</em>
* `EMPTY` (15965): <em>que, es, s', un, tot, on, què, això, qual, qui</em>

<table>
  <tr><th>Paradigm <i>es</i></th><th><tt>1</tt></th><th><tt>3</tt></th></tr>
  <tr><td><tt>_</tt></td><td></td><td><em>es, s', -s, -se</em></td></tr>
  <tr><td><tt><a href="Number.html">Number</a>=Plur</tt></td><td><em>'ns</em></td><td></td></tr>
...
<tt>VERB --[<a href="../dep/conj.html">conj</a>]--> VERB</tt> (1052; 60%),
<tt>VERB --[<a href="../dep/compound.html">compound</a>]--> VERB</tt> (24; 73%),
<tt>AUX --[<a href="../dep/ccomp.html">ccomp</a>]--> VERB</tt> (5; 63%),
